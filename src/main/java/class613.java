...
public class class613 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Z)Lgs;")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(Lfca;I)V")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILfca;)Luo;")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BLfca;I)V")
