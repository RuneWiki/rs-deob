...
public class class613 extends class484 {
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ZI)I", line = 15)
    ...
    @OriginalMember(owner = "client!mfa", name = "c", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lgt;II[B)V", line = 66)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lgt;II[I)V", line = 78)
