...
public class class613 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lga;Z)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lfh;I)Z")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IBZLin;III)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lwaa;B)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILke;)I")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(Lvo;I)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILga;)V")
    ...
    @OriginalMember(owner = "client!cia", name = "b", descriptor = "(I)Lcm;")
