...
public class class613 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILjo;ZIII)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILiaa;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Liaa;B)V")
