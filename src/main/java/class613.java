...
public class class613 extends class277 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/awt/Canvas;I)Lfea;")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILwca;Z)V")
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lcm;)V")
