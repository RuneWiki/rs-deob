...
public abstract class class189 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 7)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZII)Z", line = 41)
