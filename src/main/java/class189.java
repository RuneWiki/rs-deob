...
public abstract class class189 extends class86 {
    ...
    @OriginalMember(owner = "client!av", name = "d", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(I)V", line = 27)
    public class189(int arg0) {
        this.field2650 = arg0;
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IB)V", line = 36)
