...
public class class189 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 4)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 70)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IJ)V", line = 114)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)I", line = 135)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BI)V", line = 185)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Z)I", line = 238)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(JLjava/lang/Object;I)V", line = 263)
    ...
    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 291)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(I)V", line = 345)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IZII)V", line = 330)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILps;BIILud;IILii;)V", line = 361)
