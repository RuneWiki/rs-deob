...
public class class189 extends class210 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 12)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIII)Z", line = 31)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "()V", line = 90)
    public class189() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)[[I", line = 93)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IILat;)V", line = 156)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIZI)V", line = 200)
    ...
    @OriginalMember(owner = "client!cj", name = "g", descriptor = "(I)V", line = 383)
