...
public class class189 implements Runnable {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(ILag;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Ljava/lang/String;I)Lid;", line = 69)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "()V", line = 92)
    public class189() {
        this.field2706.setDaemon(true);
        this.field2706.start();
    }

    @OriginalMember(owner = "client!qq", name = "run", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(I)V", line = 146)
