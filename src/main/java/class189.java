...
public class class189 extends class379 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lya;J[Lbu;[Lpf;Z)V")
    ...
    @OriginalMember(owner = "client!ao", name = "f", descriptor = "()Lmc;")
    public final class88 method1331() {
        return this.field2792;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lya;J)Z")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([Lpf;Z)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lya;[Lbu;Z)V")
