...
public abstract class class189 extends class447 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BD)V", line = 13)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BIIIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lpo;Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!cs", name = "e", descriptor = "(B)V", line = 88)
