...
public class class189 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(Loa;ILep;IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIILjo;)Lqda;", line = 327)
    ...
    @OriginalMember(owner = "client!hi", name = "b", descriptor = "(I)I", line = 344)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BI)I", line = 359)
