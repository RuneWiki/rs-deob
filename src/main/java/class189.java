...
public class class189 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILkn;)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)Lge;")
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)Lge;")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lkn;)V")
