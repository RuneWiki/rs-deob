...
public class class189 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lfm;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(BI)Lsk;", line = 43)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIIIB)V", line = 98)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(ILpc;Lpc;)V", line = 117)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIILcr;)V", line = 140)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(III)Z", line = 163)
