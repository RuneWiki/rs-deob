...
public class class189 extends class627 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(IIIIIZ)V", line = 57)
