...
public class class189 extends class264 {
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lmfa;)V", line = 4)
    public class189(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BI)I", line = 11)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZC)C", line = 25)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)I", line = 419)
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(I)Z", line = 433)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(B)V", line = 451)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(ILmfa;)V", line = 488)
    public class189(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(B)I", line = 493)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(I)V", line = 504)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(BI)V", line = 521)
