...
public class class189 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIILt;)Lt;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BILhp;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILhp;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lt;IIIBIII)Lt;")
