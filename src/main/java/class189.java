...
public class class189 extends class188 {
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IBLbm;)V", line = 5)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Lor;BLor;)V", line = 20)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!dca", name = "d", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(I)Z", line = 69)
    public final boolean method956(int arg0) {
        ++field2521;
        return arg0 <= 53 ? true : this.field2522;
    }

    @OriginalMember(owner = "client!dca", name = "f", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(Ljava/lang/Object;Lqn;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lpa;Laj;Llja;)V", line = 138)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(ZI)V", line = 158)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(IIZ)V", line = 188)
