...
public class class189 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 33)
