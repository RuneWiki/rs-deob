...
public class class189 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "([Lqs;B)I")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IJLqs;)V")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BJ)Lqs;")
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Z)Lqs;")
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)Lqs;")
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(I)Lqs;")
