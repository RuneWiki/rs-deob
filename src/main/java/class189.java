...
public class class189 {
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(II)Lda;")
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)[Lpi;")
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "(Lgt;ILdn;)V")
