...
public class class189 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lc;II)V")
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)[Lfja;")
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lcn;ILc;I)V")
