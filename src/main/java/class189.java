...
public class class189 extends class657 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIILfha;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILdu;I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lbga;Lin;Lur;)V", line = 67)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZB)V", line = 83)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ov", name = "g", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(III)V", line = 122)
    ...
    @OriginalMember(owner = "client!ov", name = "e", descriptor = "(I)Z", line = 147)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 160)
