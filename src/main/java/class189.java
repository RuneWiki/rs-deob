...
public class class189 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(III)Z", line = 13)
    ...
    @OriginalMember(owner = "client!m", name = "f", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIBII)V", line = 47)
    ...
    @OriginalMember(owner = "client!m", name = "g", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 127)
