...
public class class189 extends class190 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IFII[FI[FIIFIFII)V", line = 93)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lrs;Lah;)V", line = 179)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Z)V", line = 190)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)Z", line = 232)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILnba;I)V", line = 293)
