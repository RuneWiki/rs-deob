...
public class class189 extends class480 {
    ...
    @OriginalMember(owner = "client!bq", name = "c", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)[B", line = 24)
    ...
    @OriginalMember(owner = "client!bq", name = "d", descriptor = "(B)V", line = 48)
    public static void method1292(byte arg0) {
        field2793 = null;
        int var1 = -9 % ((arg0 - 58) / 48);
    }

    @OriginalMember(owner = "client!bq", name = "f", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Ljava/awt/Canvas;BIILji;Lm;)Lqa;", line = 85)
