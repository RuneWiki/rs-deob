...
public class class189 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lui;Lmo;Lsm;Lmf;Lwn;Lpo;Lg;)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)Lfo;")
    public static final class12 method1304(int arg0) {
        return (class12) field2882.method2305((long) arg0, (byte) 114);
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(II)Lfo;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;Lre;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lcp;II)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;IIII)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lcp;III)I")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;II)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(Ltq;)Lat;")
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ltq;Llk;IIII)V")
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(Ltq;IIII)Lat;")
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(II)Loa;")
