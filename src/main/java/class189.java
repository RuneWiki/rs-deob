...
public abstract class class189 extends class95 {
    ...
    @OriginalMember(owner = "client!ue", name = "vb", descriptor = "[J")
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(Z)Lue;")
    ...
    @OriginalMember(owner = "client!ue", name = "d", descriptor = "(Z)Lue;")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ltd;ILtd;I[I)V")
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ltd;I)V")
    public abstract void method425(class179 arg0, int arg1);

    @OriginalMember(owner = "client!ue", name = "a", descriptor = "([[IIIIZI)Lue;")
