...
public class class189 extends class192 {
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIIIIIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIIZ[III)V", line = 18)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIIIZ[BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!m", name = "e", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIII)V", line = 109)
    ...
    @OriginalMember(owner = "client!m", name = "b", descriptor = "(Z)V", line = 132)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIIIIZ)V", line = 234)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIII[I)V", line = 256)
    public class189(class594 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!m", name = "f", descriptor = "(I)[Lqe;", line = 271)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Loea;IIIII[BI)V", line = 283)
