...
public class class189 extends class294 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)[B", line = 6)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IBI)[B", line = 19)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "([BI)V", line = 34)
