...
public class class189 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IZLgga;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Lgga;B)V", line = 148)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(II)V", line = 175)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Z)V", line = 272)
    ...
    @OriginalMember(owner = "client!pv", name = "b", descriptor = "(I)V", line = 369)
