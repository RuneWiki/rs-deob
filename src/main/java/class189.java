...
public class class189 extends class170 {
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(CB)I", line = 48)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILrg;)V", line = 72)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(CB)I", line = 92)
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILrg;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(CI)Z", line = 216)
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "(I)V", line = 235)
