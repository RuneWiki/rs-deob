...
public class class189 extends class142 implements class342 {
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lmba;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(Lgv;I)V", line = 55)
    public final void method1071(class39 arg0, int arg1) {
        super.method1071(arg0, arg1);
    }

    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 62)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(I)V", line = 74)
