...
public class class189 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(II)Z", line = 35)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLia;)V", line = 47)
