...
public class class189 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IB)V", line = 9)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lgda;III)V", line = 30)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(III)V", line = 41)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(IB)I", line = 91)
