...
public abstract class class189 {
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lih;)V")
    public class189(class503 arg0) {
        this.field2702 = arg0;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZLhm;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZZLet;)V")
