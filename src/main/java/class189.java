...
public class class189 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Lrda;BIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(B)Lwa;", line = 102)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Lun;B)Lkda;", line = 133)
