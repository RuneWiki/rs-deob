...
public class class189 extends class530 {
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(ILah;)V")
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(Lah;)V")
    public class189(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Lib;BLib;)V")
