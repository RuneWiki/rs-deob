...
public class class189 extends class41 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Loga;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ILes;)V", line = 38)
