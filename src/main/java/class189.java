...
public class class189 extends class107 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILps;)Lki;", line = 23)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIB)[B", line = 39)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILhca;IBLno;)V", line = 51)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BII)I", line = 387)
    ...
    @OriginalMember(owner = "client!be", name = "e", descriptor = "(I)V", line = 412)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 427)
    public class189() {
