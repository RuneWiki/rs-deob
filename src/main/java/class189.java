...
public class class189 extends class104 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 5)
    ...
    @OriginalMember(owner = "client!ov", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 40)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field2855++;
        this.method1295(-1, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ov", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 59)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Z)Z", line = 70)
    ...
    @OriginalMember(owner = "client!ov", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ov", name = "e", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(Z)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ov", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 135)
    ...
    @OriginalMember(owner = "client!ov", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 166)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIIZ)V", line = 191)
    ...
    @OriginalMember(owner = "client!ov", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 210)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method1295(-1, arg0.getX(), arg0.getY());
        field2835++;
    }

    @OriginalMember(owner = "client!ov", name = "f", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!ov", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 234)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field2838++;
        this.method1295(-1, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(B)Lqg;", line = 242)
    ...
    @OriginalMember(owner = "client!ov", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 255)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field2837++;
        this.method1295(-1, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!ov", name = "d", descriptor = "(B)I", line = 263)
    ...
    @OriginalMember(owner = "client!ov", name = "c", descriptor = "(B)Z", line = 274)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 290)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 361)
    public class189(Component arg0, boolean arg1) {
        this.method1294(-48, arg0);
        this.field2863 = arg1;
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(III)V", line = 317)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)I", line = 335)
    public final int method772(int arg0) {
        field2843++;
        return arg0 < 38 ? -86 : this.field2847;
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(B)V", line = 346)
