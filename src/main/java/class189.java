...
public class class189 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BJ)Lra;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)Lra;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(JLra;I)V")
