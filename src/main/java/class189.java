...
public class class189 extends class83 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B[B)[B", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)[I", line = 60)
    ...
    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(III)Z", line = 114)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIIIIBIIIIIII)V", line = 133)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "()V", line = 161)
    public class189() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Z)V", line = 180)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IBLtq;)V", line = 191)
    ...
    @OriginalMember(owner = "client!cr", name = "e", descriptor = "(III)Z", line = 284)
