...
public class class189 extends class192 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lod;)Lbq;", line = 7)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
