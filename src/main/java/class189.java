...
public class class189 extends class478 {
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(I)V", line = 3)
    public static void method1147(int arg0) {
        int var1 = -57 / ((46 - arg0) / 57);
        field2176 = null;
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "()V", line = 23)
    public class189() {
        super(1, true);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLnp;)V", line = 27)
    ...
    @OriginalMember(owner = "client!tp", name = "f", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IBIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(II)[I", line = 276)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILnp;I)V", line = 347)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILvj;BII)Lbr;", line = 398)
