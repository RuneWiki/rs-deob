...
public class class189 extends class97 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIBLjava/awt/Graphics;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!tp", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 38)
    public final void startProduction(ImageConsumer arg0) {
        ++field2560;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!tp", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 53)
    ...
    @OriginalMember(owner = "client!tp", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 67)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field2574;
        return this.field2566 == arg0;
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!tp", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 92)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!tp", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 116)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field2565;
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 127)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIZI)I", line = 141)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 170)
