...
public abstract class class189 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Z[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!bq", name = "finalize", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(III)Loe;", line = 48)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lqg;I[BIZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "(Lqg;ILjaggl/memory/NativeBuffer;IZ)V", line = 87)
