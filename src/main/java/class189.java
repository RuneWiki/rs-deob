...
public class class189 extends class435 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IBLpt;)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lol;I)I")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIILjo;)Luda;")
