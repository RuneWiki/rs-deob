...
public class class457 extends class271 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIILac;Z[BI)Liaa;", line = 77)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIB)V", line = 96)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(IIIIIFFF)V", line = 107)
    ...
    @OriginalMember(owner = "client!gt", name = "f", descriptor = "(I)V", line = 118)
