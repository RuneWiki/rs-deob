...
public class class457 extends class71 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIZILdw;II[B)Lgv;", line = 7)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Z)V", line = 184)
