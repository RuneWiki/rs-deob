...
public class class457 extends class523 {
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ZIIZI)Lum;", line = 16)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!oh", name = "c", descriptor = "(I)V", line = 70)
