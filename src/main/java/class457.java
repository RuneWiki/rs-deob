...
public class class457 extends class203 implements class226 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIILha;Lnfa;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(BLha;)Lmg;", line = 39)
    ...
    @OriginalMember(owner = "client!mf", name = "f", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILpe;)V", line = 65)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILha;)V", line = 82)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lha;I)Luh;", line = 94)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(Z)I", line = 146)
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(B)I", line = 158)
    ...
    @OriginalMember(owner = "client!mf", name = "f", descriptor = "(B)Z", line = 168)
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(I)Z", line = 180)
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZII)V", line = 241)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(B)I", line = 194)
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(ILha;)V", line = 205)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(ILha;)V", line = 216)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BIILha;)Z", line = 251)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!mf", name = "h", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!mf", name = "e", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(Z)Z", line = 306)
