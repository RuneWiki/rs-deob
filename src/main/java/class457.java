...
public class class457 implements class515 {
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(IZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(IZILgj;III)V", line = 60)
    ...
    @OriginalMember(owner = "client!nja", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!nja", name = "b", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!nja", name = "a", descriptor = "(ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!nja", name = "b", descriptor = "(IZ)Z", line = 136)
    ...
    @OriginalMember(owner = "client!nja", name = "<init>", descriptor = "(Lgj;Lne;)V", line = 163)
