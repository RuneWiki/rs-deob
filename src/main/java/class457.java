...
public class class457 {
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(BI)Z", line = 11)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IIIIIIZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!pea", name = "<init>", descriptor = "(Lep;)V", line = 334)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(IZIIIZ)V", line = 252)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(Lhl;II)Z", line = 312)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(I)V", line = 360)
