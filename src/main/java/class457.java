...
public class class457 implements class633 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 6)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 27)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)I", line = 63)
    public final int method590(int arg0) {
        return arg0 == -1 ? this.field6250 : -117;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)I", line = 75)
    public final int method2602(byte arg0) {
        return arg0 > -41 ? 18 : this.field6253;
    }

    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lmh;Z)V", line = 146)
    public class457(class632 arg0, boolean arg1) {
        this.field6248 = arg1;
        this.field6252 = arg0;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(III)Z", line = 90)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 129)
