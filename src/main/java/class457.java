...
public class class457 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lks;I)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Li;I)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lhq;II)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Li;)V")
