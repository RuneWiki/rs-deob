...
public class class457 extends class11 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IIB)Lgba;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(III)Lfba;")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lefa;Lhv;)V")
