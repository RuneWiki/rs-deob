...
public class class457 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II[II)Lnp;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "([III)Lnp;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II[IB)Lnp;")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIILdha;)V")
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II[I)Lnp;")
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lfp;Lfp;)V")
