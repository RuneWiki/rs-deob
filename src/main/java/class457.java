...
public class class457 extends class125 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILhe;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZI)Lwi;", line = 26)
    ...
    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)Z", line = 64)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lur;)V", line = 75)
    public class457(class377 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lug;I)Lgd;", line = 104)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(ZI)V", line = 141)
