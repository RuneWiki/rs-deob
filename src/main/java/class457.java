...
public class class457 extends class85 {
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!pl", name = "e", descriptor = "(B)V", line = 57)
