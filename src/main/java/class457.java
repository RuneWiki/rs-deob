...
public abstract class class457 extends class39 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IBII)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)Ljg;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZLq;ILoa;[Lba;)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZIBII)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lba;I)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIZ)V")
