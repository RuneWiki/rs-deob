...
public class class457 implements class166 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZLjava/awt/Component;II)V", line = 85)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "()V", line = 189)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I[I)V", line = 134)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(II)V", line = 173)
