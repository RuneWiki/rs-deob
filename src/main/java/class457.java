...
public class class457 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)V", line = 199)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(I)I", line = 229)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II[FIBII)V", line = 247)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(B)I", line = 345)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "()V", line = 364)
    private class457() {
    }

    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "([I)V", line = 366)
