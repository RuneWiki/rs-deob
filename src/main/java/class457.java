...
public class class457 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIIII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IILce;)V", line = 25)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BI[F)[F", line = 344)
