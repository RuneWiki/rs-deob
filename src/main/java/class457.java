...
public class class457 extends class55 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)I", line = 6)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 146)
