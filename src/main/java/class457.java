...
public class class457 extends class329 implements class249 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ta", name = "finalize", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "()V", line = 60)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Ll;Ljava/awt/Canvas;)V", line = 71)
