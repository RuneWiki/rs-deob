...
public class class457 extends class330 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "()V", line = 80)
    public class457() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lvt;Ljava/lang/String;II)Lfe;", line = 84)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(B)V", line = 163)
    public static void method2752(byte arg0) {
        int var1 = 48 % ((-80 - arg0) / 34);
        field6388 = null;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)[[I", line = 177)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lgga;IB)V", line = 246)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Z)V", line = 292)
