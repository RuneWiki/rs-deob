...
public class class457 extends class31 {
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 4)
    public class457(Object arg0, int arg1) {
        super(arg1);
        this.field6321 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!eg", name = "f", descriptor = "(I)Z", line = 13)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 24)
