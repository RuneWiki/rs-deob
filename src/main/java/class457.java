...
public class class457 extends class361 {
    ...
    @OriginalMember(owner = "client!ph", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IBI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZIILqn;)Lmb;", line = 28)
