...
public class class457 extends class30 {
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "()Z", line = 4)
    public final boolean method262() {
        return true;
    }

    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lap;)V", line = 17)
    public final void method266(class26 arg0) {
        this.field405.method1653(arg0);
    }

    @OriginalMember(owner = "client!on", name = "c", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)V", line = 125)
    public final void method263(boolean arg0) {
        this.field405.method1679(8448, 7681);
    }

    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lnm;)V", line = 131)
