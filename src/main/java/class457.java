...
public class class457 extends class14 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lvj;)V")
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lbv;II[BI)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIZLjb;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lj;III[Z)Z")
