...
public class class457 extends class345 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(CIIIZLkf;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lj;Lvi;[Ldk;[I[I)V", line = 124)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "([B[IIIIIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "([B[IIIIIIIIIIILkf;II)V", line = 184)
