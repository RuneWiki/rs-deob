...
public class class457 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IB)Lrw;")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)Lkg;")
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lsn;ILci;Lci;Lci;)V")
