...
public class class457 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILlp;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I[BIZ)V", line = 144)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lrl;Lm;Lgb;IIIII)V", line = 198)
