...
public class class457 extends class386 {
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(ZLun;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(BLjava/lang/String;ZLjn;)Ldba;")
    ...
    @OriginalMember(owner = "client!mw", name = "a", descriptor = "(IBLun;)V")
