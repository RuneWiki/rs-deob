...
public class class457 extends class34 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "e", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lsv;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "()V", line = 111)
    public class457() {
        super(3, false);
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IFIFF)F", line = 118)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(BI)[[I", line = 133)
    ...
    @OriginalMember(owner = "client!sf", name = "f", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!sf", name = "g", descriptor = "(I)V", line = 204)
