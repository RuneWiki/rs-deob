...
public class class457 {
    ...
    @OriginalMember(owner = "client!ss", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field6336++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(BI)[I", line = 42)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIB)V", line = 60)
