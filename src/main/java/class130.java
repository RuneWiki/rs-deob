...
public class class130 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Llh;)V")
