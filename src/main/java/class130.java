...
public class class130 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IILiu;)Z")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILjava/awt/Canvas;)Lan;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Lqa;IIBIII)V")
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lqa;Lwn;I)V")
