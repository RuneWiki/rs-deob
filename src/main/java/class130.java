...
public class class130 {
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dd", name = "d", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BI)V", line = 66)
    ...
    @OriginalMember(owner = "client!dd", name = "e", descriptor = "(I)Z", line = 93)
