...
public class class130 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!qea", name = "c", descriptor = "(I)V", line = 50)
