...
public class class130 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IJ)Lno;", line = 4)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IILha;ZII)V", line = 34)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)I", line = 137)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(B)Lno;", line = 148)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B[Lno;)I", line = 212)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)Lno;", line = 246)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(JBLno;)V", line = 311)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!baa", name = "d", descriptor = "(B)Lno;", line = 363)
    ...
    @OriginalMember(owner = "client!baa", name = "e", descriptor = "(B)[Lww;", line = 380)
