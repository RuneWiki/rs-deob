...
public class class130 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BI)Lul;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BLmq;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Loq;ILbu;)V")
