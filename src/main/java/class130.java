...
public class class130 extends class359 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIIIBII)V", line = 8)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "([B)V", line = 132)
    public class130(byte[] arg0) {
        this.field1797 = arg0;
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZI)V", line = 141)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IIIIIII)V", line = 189)
