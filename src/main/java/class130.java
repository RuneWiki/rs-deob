...
public class class130 extends class312 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILlaa;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLtk;)I")
    ...
    @OriginalMember(owner = "client!ui", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Le;Lpq;Ljava/lang/Integer;)Loa;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILjagdx/D3DPRESENT_PARAMETERS;IILjagdx/IDirect3D;I)Z")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lcv;I)I")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I[BILnl;ZZII)Lsd;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILll;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZIILnl;BII[F)Lsd;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ltd;B)I")
    ...
    @OriginalMember(owner = "client!ui", name = "l", descriptor = "()Lru;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Laq;Laq;FLaq;)Laq;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IZ)Lqr;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIILnl;[BI)Lgp;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Leea;Lnl;I)I")
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/vo;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lre;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Le;Lpq;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILeea;IILnl;)Lsd;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZIZILtk;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lnl;ILeea;)Z")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILvp;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "([Loh;I)Lqca;")
    public final class547 method813(class401[] arg0, int arg1) {
        return arg1 <= 20 ? (class547) null : new dxVertexLayout(this, arg0);
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZIILtk;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILgo;IILfo;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZB)Lvp;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lkca;I)I")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lnl;Leea;Z)Z")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lrg;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lvn;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "([IIIIZII)Lsd;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BZI[[I)Lvea;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLqca;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZZ)Lgo;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILfo;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lfo;I)I")
