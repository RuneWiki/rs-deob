...
public class class130 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/awt/Canvas;Lml;ILci;II)Lwm;", line = 205)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Ljf;I)V", line = 242)
