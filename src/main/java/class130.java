...
public class class130 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lre;B)V", line = 63)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)Lff;", line = 84)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZILre;)V", line = 123)
