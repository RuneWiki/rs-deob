...
public class class130 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILdt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILdt;)V", line = 56)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(JB)I", line = 81)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BI)V", line = 114)
