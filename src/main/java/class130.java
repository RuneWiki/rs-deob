...
public class class130 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Lne;Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(II)V", line = 76)
