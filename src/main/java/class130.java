...
public class class130 extends class736 implements class362 {
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(Lha;B)Lpw;", line = 3)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;B)Lhq;", line = 15)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 67)
    ...
    @OriginalMember(owner = "client!laa", name = "h", descriptor = "(I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IZLha;I)Z", line = 111)
    ...
    @OriginalMember(owner = "client!laa", name = "j", descriptor = "(I)I", line = 133)
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Z)I", line = 154)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lpi;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!laa", name = "g", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILsf;Lha;BIIZ)V", line = 199)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(ILha;)V", line = 210)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)I", line = 220)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IC)Z", line = 234)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)I", line = 260)
    public final int method646(byte arg0) {
        ++field1715;
        return arg0 != 45 ? -106 : this.field1706.field5323;
    }

    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(Z)V", line = 286)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Lha;Ldja;IIIIIZII)V", line = 337)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(B)Z", line = 325)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILha;)V", line = 358)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lha;I)V", line = 370)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(B)Z", line = 394)
    ...
    @OriginalMember(owner = "client!laa", name = "i", descriptor = "(I)V", line = 409)
