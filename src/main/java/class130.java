...
public class class130 extends class457 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lgj;Lla;)V", line = 468)
    public class130(class662 arg0, class478 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIILjo;ZIIIII)Z", line = 24)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIIILkh;Laa;ILha;)V", line = 271)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZI)V", line = 448)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(B)V", line = 481)
