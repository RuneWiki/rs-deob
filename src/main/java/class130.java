...
public abstract class class130 extends class345 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIII[BB)V", line = 8)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IZ)V", line = 49)
