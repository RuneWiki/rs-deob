...
public class class130 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ljava/awt/Component;IIZLtq;)Lmca;", line = 6)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ltt;B)V", line = 108)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 147)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BZ)V", line = 173)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 219)
