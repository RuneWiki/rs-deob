...
public class class130 extends class121 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIIILdda;IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!aca", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Ldda;II)Lcb;", line = 40)
    ...
    @OriginalMember(owner = "client!aca", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!aca", name = "d", descriptor = "(B)V", line = 79)
