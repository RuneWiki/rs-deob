...
public class class130 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)Lhn;", line = 4)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIII)Z", line = 77)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIZLpp;)V", line = 413)
