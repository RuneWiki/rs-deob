...
public class class130 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIIIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 372)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)[Lso;", line = 405)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BIII)V", line = 418)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIIBIIII)Z", line = 430)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IZIIZIZ)V", line = 474)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIIIIIIII)Z", line = 787)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(III)V", line = 886)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(III)V", line = 899)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZBIIZII)V", line = 923)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(ZIIBIIIZ)V", line = 1232)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIZIIZ)V", line = 1295)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(IIIIIIII)Z", line = 1342)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIZ)V", line = 1529)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIII)V", line = 1542)
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(III)V", line = 1559)
