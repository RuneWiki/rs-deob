...
public class class130 extends class413 {
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILd;Ljava/awt/Canvas;I)Lha;", line = 20)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(I)V", line = 46)
