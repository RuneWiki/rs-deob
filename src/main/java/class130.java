...
public class class130 extends class533 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IIII)[B", line = 3)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IIB)V", line = 17)
    ...
    @OriginalMember(owner = "client!rw", name = "d", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "()V", line = 49)
    public class130() {
