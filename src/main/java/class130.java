...
public class class130 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()V", line = 3)
    public final void method922() {
        this.field1870 = null;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lr;IIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lr;Lfq;)Z", line = 38)
    public final boolean method925(class98 arg0, class130 arg1) {
        return this.field1870 != null || this.method932(arg0, arg1);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lr;)V", line = 41)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIII)Z", line = 123)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(Lr;Lfq;)V", line = 185)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(Lr;)V", line = 275)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(Lr;Lfq;)V", line = 337)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "()V", line = 428)
    public static final void method931() {
        field1871 = null;
        field1863 = null;
    }

    @OriginalMember(owner = "client!fq", name = "d", descriptor = "(Lr;Lfq;)Z", line = 438)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
