...
public class class130 extends class424 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IBII)I", line = 6)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lrg;BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IZ)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(ZLij;)V", line = 145)
    ...
    @OriginalMember(owner = "client!ss", name = "g", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(IB)[I", line = 168)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "()V", line = 228)
    public class130() {
        super(1, false);
    }
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lne;I)[Lip;", line = 232)
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "(B)V", line = 274)
