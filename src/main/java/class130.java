...
public class class130 extends class429 {
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!jfa", name = "d", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(B)Z", line = 37)
    public final boolean method48(byte arg0) {
        return arg0 == -128 ? this.field2199 : false;
    }

    @OriginalMember(owner = "client!jfa", name = "e", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!jfa", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!jfa", name = "b", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(Len;ZI)V", line = 177)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(IZ)V", line = 212)
    ...
    @OriginalMember(owner = "client!jfa", name = "h", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!jfa", name = "f", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!jfa", name = "a", descriptor = "(III)V", line = 273)
    ...
    @OriginalMember(owner = "client!jfa", name = "<init>", descriptor = "(Llj;Lgga;)V", line = 285)
