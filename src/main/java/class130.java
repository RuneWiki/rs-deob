...
public abstract class class130 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ZIBLjava/lang/String;)I", line = 23)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)Ljs;", line = 101)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 112)
