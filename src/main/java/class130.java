...
public class class130 extends class264 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BLkk;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!ku", name = "h", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 467)
    public class130() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lkk;B)V", line = 146)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)[I", line = 187)
    ...
    @OriginalMember(owner = "client!ku", name = "f", descriptor = "(I)V", line = 398)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I[S[Ljava/lang/String;II)V", line = 410)
