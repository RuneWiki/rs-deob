...
public class class130 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIIIII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ILlk;B)Ljava/lang/String;", line = 76)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 119)
