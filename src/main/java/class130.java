...
public class class130 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "finalize", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILac;III)Liaa;", line = 39)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Lhl;J[Lon;)V", line = 71)
