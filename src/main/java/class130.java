...
public class class130 extends class287 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)V", line = 11)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BC)I", line = 40)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "([BB)[B", line = 63)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IC)I", line = 78)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLsv;I)V", line = 117)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILdk;B)Lkt;", line = 182)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLsv;)V", line = 204)
