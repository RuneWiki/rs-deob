...
public class class130 implements class547 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Z[Lf;)V", line = 12)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(I)Lwea;", line = 43)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lct;Lrc;IIIIIII)V", line = 67)
