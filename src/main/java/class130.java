...
public class class130 extends class115 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "()V", line = 53)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lie;Lfh;)V", line = 70)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lwq;)V", line = 79)
    public final synchronized void method879(class115 arg0) {
        this.field1745.method448(-123, arg0);
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "()I", line = 82)
    public final int method709() {
        return 0;
    }

    @OriginalMember(owner = "client!ru", name = "d", descriptor = "()Lwq;", line = 85)
    public final class115 method714() {
        return (class115) this.field1745.method445(33);
    }

    @OriginalMember(owner = "client!ru", name = "f", descriptor = "()I", line = 89)
    public final synchronized int method880() {
        return this.field1745.method446(4090);
    }

    @OriginalMember(owner = "client!ru", name = "f", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Lfh;)V", line = 107)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "()Lwq;", line = 121)
    public final class115 method710() {
        return (class115) this.field1745.method451(false);
    }

    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(Lwq;)V", line = 125)
    public final synchronized void method883(class115 arg0) {
        arg0.method25(-13489);
    }

    @OriginalMember(owner = "client!ru", name = "c", descriptor = "([III)V", line = 135)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "([III)V", line = 153)
