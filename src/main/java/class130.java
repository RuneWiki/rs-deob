...
public class class130 implements class146 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILca;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "()V", line = 33)
    public final void method904() {
        this.field2119.field1604.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!jd", name = "c", descriptor = "()I", line = 37)
    public final int method898() {
        return this.field2112;
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILca;I)V", line = 40)
    public final void method1093(int arg0, class414 arg1, int arg2) {
        this.method1091(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILcl;)V", line = 44)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lge;)V", line = 134)
    ...
    @OriginalMember(owner = "client!jd", name = "d", descriptor = "()Z", line = 80)
    public final boolean method1096() {
        int var1 = this.field2119.field1604.glCheckFramebufferStatusEXT(36160);
        return var1 == 36053;
    }

    @OriginalMember(owner = "client!jd", name = "finalize", descriptor = "()V", line = 91)
    protected final void finalize() throws Throwable {
        this.field2119.method893(this.field2114);
        super.finalize();
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILlb;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "()V", line = 121)
    public final void method860() {
        this.field2119.field1604.glBindFramebufferEXT(36160, this.field2114);
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILlb;)V", line = 127)
