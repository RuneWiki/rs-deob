...
public class class130 extends Canvas {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Z)Lvb;", line = 25)
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!ct", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 55)
    public final void paint(Graphics arg0) {
        this.field1926.paint(arg0);
        field1922++;
    }

    @OriginalMember(owner = "client!ct", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 66)
    public final void update(Graphics arg0) {
        this.field1926.update(arg0);
        field1924++;
    }

    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 90)
