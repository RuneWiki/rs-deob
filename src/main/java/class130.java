...
public class class130 extends class262 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILoa;B)V", line = 25)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!pj", name = "g", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lkaa;Ljn;)V", line = 150)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IZI)V", line = 179)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)Z", line = 189)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZI)V", line = 200)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!pj", name = "f", descriptor = "(I)V", line = 255)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Z)V", line = 275)
