...
public class class130 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(II)Lce;", line = 6)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 111)
    public class130(class234 arg0, int arg1, class473 arg2) {
        this.field1893 = arg2;
        this.field1893.method2710(26, (byte) -105);
    }

    @OriginalMember(owner = "client!vb", name = "c", descriptor = "(I)V", line = 101)
