...
public class class130 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IILi;I)Z")
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IBILi;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(IBILi;)V")
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(Lur;Lsp;)V")
