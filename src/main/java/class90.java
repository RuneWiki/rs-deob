...
public class class90 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "()I", line = 9)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lpj;II)Ljt;", line = 55)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Ljr;)V", line = 70)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "()V", line = 90)
    private class90() {
    }

    @OriginalMember(owner = "client!jt", name = "b", descriptor = "()Lqr;", line = 66)
    ...
    @OriginalMember(owner = "client!jt", name = "c", descriptor = "()[B", line = 94)
