...
public abstract class class90 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjava/lang/String;[Lha;IIII[I)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BILjava/lang/String;Lpa;II[Lha;[II)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([II[Lha;Ljava/lang/String;IILjava/util/Random;III)I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;III[I[I[ILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(ILjava/lang/String;IBI[I[IIIIII[Lha;Ljava/util/Random;I)I")
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lpa;I[Lha;IIIIILjava/lang/String;II[IIIIII)I")
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lqa;Lfc;)V")
    public class90(class206 arg0, class216 arg1) {
        this.field1113 = arg0;
        this.field1108 = arg1;
    }

    @OriginalMember(owner = "client!ra", name = "a", descriptor = "([Lha;I[IILpa;Ljava/lang/String;IIIZIIIIII)I")
