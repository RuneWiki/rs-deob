...
public class class90 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Lcea;Lra;)V")
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(F)F")
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "()V")
