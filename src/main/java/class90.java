...
public class class90 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Z)I", line = 60)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([Lgk;I)I", line = 71)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)Lgk;", line = 104)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIB)V", line = 136)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILgk;J)V", line = 162)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 179)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)Lgk;", line = 385)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(JI)Lgk;", line = 398)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(I)V", line = 433)
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(I)Lgk;", line = 510)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(I)V", line = 541)
    ...
    @OriginalMember(owner = "client!dq", name = "e", descriptor = "(I)I", line = 562)
