...
public class class90 extends class180 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BICI)V", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 27)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method792((byte) -127, -1, '\u0000', 0);
        field1238++;
    }

    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(III)I", line = 43)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)Lri;", line = 124)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)Z", line = 145)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;BI)V", line = 171)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 207)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!vr", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 264)
    public final void focusGained(FocusEvent arg0) {
        field1237++;
    }

    @OriginalMember(owner = "client!vr", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 282)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method798(arg0, (byte) -105, 1);
        field1242++;
    }

    @OriginalMember(owner = "client!vr", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 290)
    ...
    @OriginalMember(owner = "client!vr", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 310)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method798(arg0, (byte) -116, 0);
        field1227++;
    }

    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 321)
    public class90(Component arg0) {
        class126.method988((byte) -106);
        this.method799(0, arg0);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FFIIF)F", line = 330)
