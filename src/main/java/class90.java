...
public class class90 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lts;I)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILmd;I)V")
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(II)Ldg;")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lci;IZLhe;Lhe;)V")
