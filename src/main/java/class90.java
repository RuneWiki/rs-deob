...
public class class90 extends class719 {
    ...
    @OriginalMember(owner = "client!gv", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIILlf;[I[I)Laca;")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lee;Lgaa;)V")
    public class90(class703 arg0, class314 arg1) {
        super(arg0);
        this.field1272 = arg1;
    }

    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(IIB)Lofa;")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZLb;I)V")
