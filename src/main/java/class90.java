...
public class class90 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Lqa;BLm;)V")
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IB)Lrg;")
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(ILbu;Lbu;)V")
