...
public class class90 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIILer;II)Lcea;", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)V", line = 40)
