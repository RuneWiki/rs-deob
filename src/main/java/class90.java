...
public class class90 extends class552 implements class459 {
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)I", line = 5)
    public final int method517(int arg0) {
        return arg0 == -3537 ? this.field1269 : -118;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(FB)F", line = 15)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Z)Z", line = 25)
    public final boolean method519(boolean arg0) {
        return arg0;
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IBI[IIIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lmv;I)V", line = 76)
    public final void method521(class688 arg0, int arg1) {
        super.method521(arg0, arg1);
    }

    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZF)F", line = 83)
    public final float method522(boolean arg0, float arg1) {
        return arg0 ? 1.6255823F : arg1 / (float) this.field1267;
    }

    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lgaa;Lec;IIZ[BII)V", line = 93)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I[BLec;IIIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 192)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BZZ)V", line = 202)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lgaa;Lec;Lbt;II)V", line = 213)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)I", line = 233)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lgaa;IIZ[III)V", line = 242)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 299)
