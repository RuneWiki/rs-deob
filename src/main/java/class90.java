...
public class class90 extends class263 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZI)Lmj;", line = 3)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lqh;BIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lh;III[Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ZB)V", line = 136)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lce;IZ)V", line = 165)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lbl;)V", line = 178)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIIIII)V", line = 196)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(III)V", line = 299)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)Z", line = 334)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(B)V", line = 346)
