...
public class class90 {
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BLfp;)V", line = 73)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)V", line = 97)
