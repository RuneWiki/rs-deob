...
public class class90 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Ljava/lang/Object;ZZ)[B", line = 3)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)Ltj;", line = 55)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)V", line = 69)
