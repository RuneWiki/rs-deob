...
public class class90 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IBIII[Lrr;IIII)V")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lkf;IILkf;)Lrg;")
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lkf;Lkf;IIZ)Lrg;")
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Ljt;Lcs;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
