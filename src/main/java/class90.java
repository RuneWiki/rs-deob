...
public abstract class class90 extends class352 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(B)Z", line = 51)
