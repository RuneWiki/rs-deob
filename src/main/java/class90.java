...
public abstract class class90 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 10)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(II)V", line = 77)
