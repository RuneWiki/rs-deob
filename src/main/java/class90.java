...
public class class90 extends class184 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BILfh;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILpc;ZZLjava/lang/String;)V")
