...
public class class90 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIIIB[BI[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(I)V", line = 125)
    public class90(int arg0) {
        this.field1604 = arg0;
    }

    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(IIIIII)V", line = 595)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)Ltq;", line = 80)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILtq;)V", line = 110)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)V", line = 133)
