...
public class class90 extends class291 {
    ...
    @OriginalMember(owner = "client!aq", name = "c", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 16)
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 91)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "()V", line = 125)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "()I", line = 139)
