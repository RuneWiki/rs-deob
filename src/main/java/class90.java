...
public abstract class class90 extends class291 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IB)Z", line = 11)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(IIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILdr;)[Ljt;", line = 104)
