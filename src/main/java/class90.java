...
public class class90 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lya;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lya;IIIIII)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lya;Lmc;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(Lya;)V")
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(Lya;Lmc;)Z")
    public final boolean method740(class38 arg0, class90 arg1) {
        return this.field1288 != null || this.method741(arg0, arg1);
    }

    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(Lya;Lmc;)Z")
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(Lya;Lmc;)V")
