...
public class class90 extends class258 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BLmc;)V", line = 97)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lim;B)V", line = 113)
