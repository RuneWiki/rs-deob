...
public class class90 implements Runnable {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IILuaa;)Lms;", line = 8)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ILms;)V", line = 23)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "([BILuaa;I)Lms;", line = 38)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Luaa;II)Lms;", line = 57)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Ljava/lang/String;IZZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Ltd;)V", line = 1171)
    ...
    @OriginalMember(owner = "client!rf", name = "run", descriptor = "()V", line = 1116)
