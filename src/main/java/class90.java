...
public class class90 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BII)Z", line = 10)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 36)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)Lls;", line = 205)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 244)
