...
public class class90 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BLr;II)V", line = 12)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IILr;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "([[ZIIBIZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IBIII)V", line = 400)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)V", line = 442)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 452)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IZI)Z", line = 470)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIILr;)Z", line = 482)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(Lch;Lcj;)V", line = 554)
