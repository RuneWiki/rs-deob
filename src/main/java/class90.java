...
public class class90 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "Llf;")
    private static class109 field1848 = class35.method275("Players", 2);

    @OriginalMember(owner = "client!je", name = "d", descriptor = "Llf;")
    public static class109 field1851 = field1848;

    @OriginalMember(owner = "client!je", name = "g", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!je", name = "h", descriptor = "Ljava/util/Random;")
    public static Random field1855 = new Random();

    @OriginalMember(owner = "client!je", name = "l", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!je", name = "j", descriptor = "Lqh;")
    public static class156 field1857;

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Ldb;ILdb;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BIILbg;Lbg;)Ldb;")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIBII)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Lkc;Z)V")
