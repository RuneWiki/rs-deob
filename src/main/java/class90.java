...
public class class90 extends class192 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)J", line = 6)
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(I)J", line = 52)
    public final long method458(int arg0) {
        int var2 = 14 / ((arg0 - 77) / 35);
        return this.field1272;
    }

    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "()V", line = 102)
    public class90() {
        this.field1272 = System.nanoTime();
        this.field1273 = System.nanoTime();
    }

    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BI)I", line = 64)
