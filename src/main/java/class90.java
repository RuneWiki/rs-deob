...
public class class90 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(III)B", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BLgk;)Ljava/lang/String;", line = 39)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)S", line = 51)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(II)Lb;", line = 114)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(BI)V", line = 147)
    ...
    @OriginalMember(owner = "client!ed", name = "c", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(III)V", line = 178)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lkr;ILok;Lok;)V", line = 206)
