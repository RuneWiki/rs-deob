...
public class class90 extends class85 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lot;Lwp;)V", line = 93)
