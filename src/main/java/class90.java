...
public class class90 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILpl;Laq;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BLuo;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)Lpl;")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(B)Lpl;")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Laq;I)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIILjo;)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lpl;Z)V")
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(Z)Lpl;")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Luo;Lms;IIB)V")
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lpl;I)V")
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)Lpl;")
    ...
    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(I)Lpl;")
