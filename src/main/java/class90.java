...
public class class90 extends class251 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(II[Ljava/lang/String;Z)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!oia", name = "d", descriptor = "(I)V", line = 95)
