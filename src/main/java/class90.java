...
public class class90 {
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(B)Z", line = 120)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Z)V", line = 139)
