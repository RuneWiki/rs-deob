...
public class class90 extends class179 {
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IBI)I", line = 36)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(Z)Ljava/lang/String;", line = 59)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lbg;[II)V", line = 86)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILbg;I)V", line = 117)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILbg;)V", line = 204)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lbg;Z)Ljava/lang/String;", line = 237)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(I)I", line = 267)
