...
public class class90 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lza;Lmc;)Z", line = 8)
    public final boolean method813(class288 arg0, class90 arg1) {
        return this.field1800 != null || this.method814(arg0, arg1);
    }

    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(Lza;Lmc;)Z", line = 14)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lza;)V", line = 48)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "()V", line = 111)
    public final void method816() {
        this.field1800 = null;
    }

    @OriginalMember(owner = "client!mc", name = "b", descriptor = "()V", line = 114)
    public static final void method817() {
        field1804 = null;
        field1797 = null;
    }

    @OriginalMember(owner = "client!mc", name = "c", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(Lza;Lmc;)V", line = 129)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIII)Z", line = 226)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(Lza;Lmc;)V", line = 287)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(Lza;)V", line = 372)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 451)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lza;IIIIII)V", line = 466)
