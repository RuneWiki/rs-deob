...
public class class90 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(Liu;IIBII)Luh;", line = 3)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(II)Lse;", line = 73)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Lrb;ILpc;)V", line = 114)
