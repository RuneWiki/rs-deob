...
public class class90 extends class349 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lcja;ILcja;)V")
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lib;I)Lcf;")
