...
public class class90 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lcp;IBLha;Lhn;ILun;ILpv;ILsd;Ldk;)Lka;", line = 20)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IBLsd;ILha;IIILun;Lhn;II)Lka;", line = 222)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BIILpv;)V", line = 414)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIB)V", line = 439)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILun;II)V", line = 455)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)V", line = 474)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZIB[I[II)V", line = 487)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III[Llfa;IILhn;ILcp;[ILdk;Lsd;ILgw;ZILun;Lha;ILhn;Lpv;)Lka;", line = 514)
