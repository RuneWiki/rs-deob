...
public class class90 extends class432 {
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIII)I", line = 455)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BII)I", line = 475)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIIZ)V", line = 525)
    ...
    @OriginalMember(owner = "client!gv", name = "c", descriptor = "(I)V", line = 538)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 554)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BI)V", line = 566)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(I)V", line = 584)
    public class90(int arg0) {
        this.field1166 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(III)V", line = 598)
