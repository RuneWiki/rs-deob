...
public class class90 extends class424 {
    ...
    @OriginalMember(owner = "client!ja", name = "c", descriptor = "(IB)Lmc;")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lij;B)V")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lrg;BI)V")
