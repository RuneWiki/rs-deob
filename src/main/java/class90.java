...
public class class90 {
    ...
    @OriginalMember(owner = "client!wea", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    public final String toString() {
        field1334++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(Z)Z", line = 29)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZLek;)La;", line = 48)
