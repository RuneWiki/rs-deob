...
public class class90 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ILjm;)I", line = 25)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(III)Z", line = 112)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lvj;B)Lnd;", line = 135)
