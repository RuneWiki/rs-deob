...
public class class90 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II)Llm;", line = 7)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Ltn;I)Ljh;", line = 153)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Ldh;ILkha;)V", line = 1045)
    public class90(class286 arg0, int arg1, class687 arg2) {
        this.field1145 = arg2;
        this.field1139 = this.field1145.method3812(0, 19);
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIIII[Lgaa;ZIIB)V", line = 187)
