...
public class class90 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILha;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I[[ZBZII)V", line = 110)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIILha;)V", line = 319)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIII)V", line = 392)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BILha;I)Z", line = 435)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lqq;Ljba;)V", line = 506)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)V", line = 524)
