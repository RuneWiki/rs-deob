...
public class class96 extends class136 {
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "()V", line = 79)
    public class96() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIIIIZZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!mr", name = "f", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(II)[I", line = 98)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IILiv;)V", line = 202)
