...
public class class96 extends class312 implements class66 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lid;Ljp;Lpg;Lcd;I)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILjava/nio/ByteBuffer;Z)Leb;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lka;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II[I[I)Lq;")
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(IIIIII)Lma;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIIILq;II)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lqd;Lqd;Lqd;Lqd;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "Y", descriptor = "()Lhh;")
    public final class66 method611() {
        return this.field1176;
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lgh;[Lvp;Z)Lmp;")
    public final class452 method612(class325 arg0, class100[] arg1, boolean arg2) {
        return new class20(this, arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I[Lej;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II[[I[[IIII)Llf;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ljp;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Leb;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ILq;II)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lmq;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lg;IIII)Lid;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lvp;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I[BIZ)Leb;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lmq;III)V")
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(I[BIZ)Lmq;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([Lid;Lpg;[Lcd;I)V")
    ...
    @OriginalMember(owner = "client!sq", name = "ib", descriptor = "()Lrj;")
    public final class352 method678() {
        return this.field1210 == null ? null : this.field1210.method900(16057);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lhh;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIZ)Lgl;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lod;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lma;Lma;FLma;)Lma;")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lpg;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lma;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)Lka;")
    public final class275 method696(int arg0) {
        return null;
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Llq;)V")
    public final void method697(class327 arg0) {
        this.field1156.glPushMatrix();
        this.field1156.glMultMatrixf(arg0.method2173(-19), 0);
    }

    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(Lhh;)V")
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "([IIIII)Lgl;")
    ...
    @OriginalMember(owner = "client!sq", name = "K", descriptor = "()Lpg;")
    ...
    @OriginalMember(owner = "client!sq", name = "w", descriptor = "()Lpg;")
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lah;IILap;)V")
