...
public class class96 implements Runnable {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZLrn;)V", line = 41)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lnk;II)Lrn;", line = 56)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BILnk;)Lrn;", line = 75)
    ...
    @OriginalMember(owner = "client!fb", name = "run", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Ldq;)V", line = 195)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B[BILnk;)Lrn;", line = 162)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lpf;B)I", line = 218)
