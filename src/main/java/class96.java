...
public class class96 implements class703 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BZ)I", line = 8)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BII)V", line = 46)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(II)I", line = 69)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IIIIBIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Z)V", line = 150)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ILha;)V", line = 166)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BLcea;)Ljca;", line = 192)
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(BII)V", line = 205)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(B)V", line = 232)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IB)I", line = 263)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!pia", name = "c", descriptor = "(BII)V", line = 301)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IBI)Z", line = 329)
    ...
    @OriginalMember(owner = "client!pia", name = "b", descriptor = "(I)V", line = 346)
