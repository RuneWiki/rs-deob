...
public class class96 implements class496 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIZII)V", line = 35)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)Ljea;", line = 50)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BLd;Ljava/awt/Canvas;Lae;I)Lha;", line = 65)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lae;Ljava/lang/String;)V", line = 94)
