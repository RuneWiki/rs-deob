...
public class class96 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZLha;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(JJ)J", line = 110)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(I[Luja;IIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IILha;IIIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 245)
