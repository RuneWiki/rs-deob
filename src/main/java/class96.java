...
public class class96 extends class489 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)[Lwaa;", line = 18)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lij;II[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(Lij;II[I)V", line = 55)
