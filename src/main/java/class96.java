...
public class class96 extends class149 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BI)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IBLtl;)V", line = 64)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(III)V", line = 78)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "()V", line = 154)
    public class96() {
        super(1, false);
    }

    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II)[I", line = 167)
