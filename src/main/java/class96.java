...
public class class96 extends class121 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lqa;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lqa;J)Z", line = 16)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "()V", line = 73)
    public final void method546() {
        this.field1196 = true;
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lqa;J[Lmm;[Lkv;Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "()V", line = 87)
    private final void method548() {
        this.field1186 = false;
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([Lkv;Z)V", line = 92)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "()Loaa;", line = 177)
    public final class510 method550() {
        return this.field1199;
    }

    @OriginalMember(owner = "client!qv", name = "d", descriptor = "()V", line = 180)
    public static void method551() {
        field1184 = null;
        field1189 = null;
    }

    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)Lqv;", line = 184)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(J)V", line = 197)
    public final void method553(long arg0) {
        this.field1190 = arg0;
    }

    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(I)V", line = 365)
    private class96(int arg0) {
        this.method545(arg0);
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lqa;[Lmm;Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!qv", name = "e", descriptor = "()V", line = 286)
    ...
    @OriginalMember(owner = "client!qv", name = "f", descriptor = "()V", line = 322)
    public final void method556() {
        this.field1186 = true;
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IIIII)V", line = 326)
