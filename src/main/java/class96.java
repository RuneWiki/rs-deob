...
public class class96 extends class305 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZI)Ldv;", line = 8)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(II)V", line = 141)
    ...
    @OriginalMember(owner = "client!bk", name = "e", descriptor = "(B)V", line = 155)
    public static void method808(byte arg0) {
        int var1 = 31 / ((-27 - arg0) / 57);
        field1517 = null;
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILfh;B)V", line = 171)
