...
public class class96 extends class90 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILtq;B)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lre;II)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lre;I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lfc;IILlk;Ltq;IBLgu;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIBLnd;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILtf;IIIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLre;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lre;I[I)V")
