...
public class class96 extends class287 {
    ...
    @OriginalMember(owner = "client!bk", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bk", name = "g", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Lqe;Lbv;)V", line = 43)
