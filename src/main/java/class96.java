...
public class class96 extends class62 {
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "()V", line = 4)
    public class96() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bm", name = "c", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!bm", name = "h", descriptor = "(I)V", line = 35)
