...
public class class96 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)[Lnc;", line = 10)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 100)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BLak;)Ljava/lang/String;", line = 111)
