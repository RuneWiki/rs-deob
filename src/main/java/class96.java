...
public class class96 extends class158 {
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lkw;IIZ[[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lkw;IIZ[[BI)V", line = 48)
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(B)V", line = 67)
    public static void method736(byte arg0) {
        field1385 = null;
        int var1 = -88 % ((arg0 - 25) / 54);
    }

    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lkw;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(I)I", line = 122)
