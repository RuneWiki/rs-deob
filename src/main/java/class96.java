...
public class class96 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lqq;)V", line = 419)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IIBIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)Z", line = 335)
