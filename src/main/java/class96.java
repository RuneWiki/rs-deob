...
public class class96 implements class118 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(II)Loa;")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IILsg;I)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IILsg;)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lkd;IZ)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIBLsl;I)V")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Lbl;)V")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIILsl;)V")
