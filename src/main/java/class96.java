...
public class class96 extends class56 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Ljava/awt/Canvas;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I[SI[Ljava/lang/String;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ZLjava/awt/Graphics;II)V", line = 96)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([I[ILpn;[IB)V", line = 125)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(II)V", line = 221)
    ...
    @OriginalMember(owner = "client!ei", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 231)
    ...
    @OriginalMember(owner = "client!ei", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 242)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIZ)V", line = 262)
    ...
    @OriginalMember(owner = "client!ei", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 282)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1210;
    }

    @OriginalMember(owner = "client!ei", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 293)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field1221;
    }

    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(B)V", line = 302)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 320)
    ...
    @OriginalMember(owner = "client!ei", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 344)
