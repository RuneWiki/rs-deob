...
public class class96 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lld;B)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Ljava/lang/String;Lkk;I)I")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Ljd;I)Z")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Llo;ILnl;)V")
