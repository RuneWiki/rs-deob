...
public class class96 extends class316 {
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lug;Lli;[Lqv;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mr", name = "OA", descriptor = "(CIIIZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(CIIIZLma;II)V", line = 230)
