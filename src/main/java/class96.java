...
public abstract class class96 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "([II[J)V", line = 17)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lml;)V", line = 31)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(B)[Lofa;", line = 40)
