...
public class class96 extends class769 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(ILjava/net/Proxy;)Ljava/net/Socket;", line = 12)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 34)
    ...
    @OriginalMember(owner = "client!oia", name = "b", descriptor = "(I)Ljava/net/Socket;", line = 89)
    ...
    @OriginalMember(owner = "client!oia", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 162)
