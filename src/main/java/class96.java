...
public class class96 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)Ltk;", line = 5)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIB)Lqm;", line = 43)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(JZ)Ljava/lang/String;", line = 58)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIIIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)Laf;", line = 146)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II)Lsn;", line = 175)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lbi;Lht;)V", line = 203)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "([BIII)I", line = 1322)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 1348)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(IIIIB)V", line = 1395)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lqm;I)V", line = 1406)
