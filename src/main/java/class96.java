...
public class class96 implements class655 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIII)I", line = 12)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)Lmh;", line = 80)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Ljava/lang/String;Ltca;Lvea;IIIIIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(I)I", line = 136)
