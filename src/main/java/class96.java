...
public class class96 extends class194 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIZIZIILbg;IIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!fd", name = "c", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BII)V", line = 142)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II)[I", line = 160)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "()V", line = 644)
    public class96() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZIIILjava/util/Random;I[[I)V", line = 422)
    ...
    @OriginalMember(owner = "client!fd", name = "h", descriptor = "(I)V", line = 620)
    ...
    @OriginalMember(owner = "client!fd", name = "f", descriptor = "(I)V", line = 634)
    public final void method280(int arg0) {
        int var2 = 105 / ((28 - arg0) / 63);
        ++field1130;
    }

    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IILbg;)V", line = 678)
