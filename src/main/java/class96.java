...
public class class96 extends class236 implements class253 {
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lkd;I[BI)V", line = 4)
    public class96(class188 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1383 = arg1;
    }

    @OriginalMember(owner = "client!hc", name = "c", descriptor = "(I)V", line = 16)
    public static void method778(int arg0) {
        field1379 = null;
        int var1 = -73 % ((34 - arg0) / 63);
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IIIILpj;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Z)I", line = 156)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([BIIZ)V", line = 167)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)I", line = 183)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lkd;ILjaggl/memory/NativeBuffer;)V", line = 194)
    public class96(class188 arg0, int arg1, NativeBuffer arg2) {
        super(arg0, arg2);
        this.field1383 = arg1;
    }

    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)J", line = 250)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILuq;ILma;IJIII)V", line = 261)
