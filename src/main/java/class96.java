...
public class class96 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lij;II)Ljf;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lij;I)Ljf;")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "([B)[Ljf;")
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(Lij;II)[Ljf;")
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(Lij;I)[Ljf;")
