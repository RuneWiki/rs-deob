...
public class class96 extends class601 {
    ...
    @OriginalMember(owner = "client!pia", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Lee;BI)V", line = 30)
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "()V", line = 623)
    public class96() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BI)[I", line = 134)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)V", line = 390)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "([[IIIILjava/util/Random;II)V", line = 411)
