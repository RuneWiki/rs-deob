...
public class class96 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([JI[Ljava/lang/Object;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIII)Z", line = 79)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "([BZ)[B", line = 129)
