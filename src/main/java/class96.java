...
public class class96 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(BLns;)V", line = 5)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Z)V", line = 470)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ZII)Z", line = 480)
