...
public class class96 extends class624 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Loa;IILq;III[[[B[I[I[I[I[IIBIIZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(III)V", line = 179)
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(B)[B", line = 191)
    ...
    @OriginalMember(owner = "client!bm", name = "c", descriptor = "(B)V", line = 211)
