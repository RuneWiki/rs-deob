...
public class class96 extends class260 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(BLqfa;III)Lcw;")
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(ILgn;)V")
    public class96(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(Lgn;)V")
