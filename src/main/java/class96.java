...
public class class96 extends class417 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(III[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(III)V", line = 72)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "()Lei;", line = 78)
    ...
    @OriginalMember(owner = "client!ei", name = "f", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lic;)V", line = 103)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(III)V", line = 134)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "([I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(I)V", line = 156)
