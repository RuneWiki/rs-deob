...
public class class96 extends class548 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ZZ)V", line = 64)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Llf;Ltf;)V", line = 83)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)V", line = 116)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Z)Z", line = 129)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(B)Lsu;", line = 140)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ZI)V", line = 167)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lru;II)V", line = 198)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ZZZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(I)V", line = 237)
