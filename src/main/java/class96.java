...
public class class96 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ILmda;I)V")
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lcb;IB)Lkf;")
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lts;IIZ)V")
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lkv;Lat;Lwr;IIIII)V")
