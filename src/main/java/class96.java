...
public class class96 extends class263 {
    ...
    @OriginalMember(owner = "client!bk", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I[II)V", line = 74)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "()V", line = 541)
    public class96() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZLgk;)V", line = 242)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IB)[I", line = 335)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIIIII)I", line = 360)
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ZI)I", line = 445)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(I[I[Ljava/lang/Object;IB)V", line = 483)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(IBI)V", line = 558)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(II)I", line = 575)
