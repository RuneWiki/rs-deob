...
public class class96 extends class513 {
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIIIII)V", line = 92)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILag;I)Z", line = 189)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(III)V", line = 358)
    ...
    @OriginalMember(owner = "client!qu", name = "g", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 402)
    ...
    @OriginalMember(owner = "client!qu", name = "d", descriptor = "(I)V", line = 420)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Ljava/io/File;Ljava/lang/String;B)V", line = 447)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lnga;)V", line = 464)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III[I)V", line = 486)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "([I)V", line = 499)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)V", line = 534)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(III[I)V", line = 567)
    ...
    @OriginalMember(owner = "client!qu", name = "f", descriptor = "(I)V", line = 582)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(III[I)V", line = 599)
    ...
    @OriginalMember(owner = "client!qu", name = "e", descriptor = "(I)V", line = 611)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "()Lnga;", line = 649)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "()V", line = 676)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "()V", line = 689)
    public class96() {
        this.method351();
    }
}
