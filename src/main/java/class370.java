...
public class class370 extends class96 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIILdn;)Luu;", line = 6)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "()V", line = 27)
    public class370() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nt", name = "e", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IB)[[[B", line = 51)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(II)[I", line = 832)
    ...
    @OriginalMember(owner = "client!nt", name = "e", descriptor = "(B)V", line = 935)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(IB)I", line = 999)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIII)V", line = 1010)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IILbt;)V", line = 1032)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lbt;I)V", line = 1125)
    ...
    @OriginalMember(owner = "client!nt", name = "g", descriptor = "(I)V", line = 1158)
