...
public class class370 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIILha;IIII)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lha;BI)Z")
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(I[Lcfa;IIII)V")
