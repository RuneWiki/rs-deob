...
public class class370 implements class278 {
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIILrd;)V")
    ...
    @OriginalMember(owner = "client!pt", name = "b", descriptor = "(II)Lhi;")
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IB)Lop;")
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lqn;Lqn;Lqn;)V")
