...
public class class370 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IILwia;IBZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 29)
