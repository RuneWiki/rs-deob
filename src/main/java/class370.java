...
public class class370 extends class190 implements class599 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lr;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILir;ZILr;IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!ufa", name = "n", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Lr;Ltc;IIIIIZIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ufa", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ZLr;II)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ufa", name = "i", descriptor = "(I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lr;B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(B)I", line = 123)
    public final int method710(byte arg0) {
        ++field4855;
        return arg0 <= 55 ? 125 : this.field4871.field131;
    }

    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ufa", name = "j", descriptor = "(I)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLr;)Lqw;", line = 171)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(B)I", line = 225)
    ...
    @OriginalMember(owner = "client!ufa", name = "l", descriptor = "(I)I", line = 236)
    ...
    @OriginalMember(owner = "client!ufa", name = "f", descriptor = "(I)Z", line = 248)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lr;Z)V", line = 259)
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(Lr;I)Lcu;", line = 286)
    public final class475 method174(class562 arg0, int arg1) {
        ++field4851;
        return arg1 != -14700 ? null : this.field4865;
    }

    @OriginalMember(owner = "client!ufa", name = "d", descriptor = "(B)I", line = 300)
