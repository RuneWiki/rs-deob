...
public class class370 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZILnr;ILnr;)Ltj;")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZLmea;II)Llc;")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ZLnr;Lnr;I)Ltj;")
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Loaa;Ljq;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
