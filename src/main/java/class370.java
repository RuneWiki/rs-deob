...
public class class370 implements class775 {
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(I)V", line = 7)
    public final void method880(int arg0) {
        field5032++;
        int var2 = -111 / ((arg0 + 86) / 35);
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(JB)Z", line = 215)
    public final boolean method877(long arg0, byte arg1) {
        field5016++;
        return arg1 == -58;
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(II)I", line = 229)
    ...
    @OriginalMember(owner = "client!tu", name = "d", descriptor = "(I)V", line = 245)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Ljava/lang/Object;", line = 257)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 272)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Z)I", line = 313)
    public final int method876(boolean arg0) {
        field5036++;
        return arg0 ? 100 : -106;
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Class;Z)Z", line = 324)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(I)V", line = 341)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(Z)V", line = 352)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)V", line = 363)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZLjava/lang/Object;Ljava/lang/String;Ljava/lang/Class;)I", line = 376)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)I", line = 391)
    public final int method881(int arg0) {
        field5027++;
        return arg0 == -10641 ? 0 : -74;
    }

    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(II)I", line = 412)
