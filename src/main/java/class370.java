...
public class class370 extends class322 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BLeq;)V", line = 27)
    ...
    @OriginalMember(owner = "client!lq", name = "e", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(IIIIIFFF)V", line = 100)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(III)V", line = 129)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BIZ)V", line = 176)
