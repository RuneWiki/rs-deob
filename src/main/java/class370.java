...
public class class370 extends class377 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IILji;)V", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "()V", line = 84)
    public class370() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sg", name = "f", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BII)Z", line = 106)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(III)Z", line = 124)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)[I", line = 174)
