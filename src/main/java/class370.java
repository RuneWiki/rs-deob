...
public class class370 extends class60 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!hg", name = "c", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lya;IIILfr;)V", line = 81)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(IIIIIII)V", line = 118)
