...
public class class370 extends class457 {
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "(Lef;)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILem;)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Lmk;II)V")
