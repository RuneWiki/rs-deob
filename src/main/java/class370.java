...
public abstract class class370 extends class656 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IILee;)Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 68)
