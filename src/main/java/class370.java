...
public class class370 implements class695 {
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)Lhs;", line = 25)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Ljava/lang/String;Lfw;Ldg;IIII)V", line = 36)
