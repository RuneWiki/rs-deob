...
public class class370 extends IOException {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)V", line = 890)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 902)
    public class370(String arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(IB)I", line = 908)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 924)
