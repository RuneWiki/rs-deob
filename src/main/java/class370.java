...
public class class370 {
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lza;ILgs;ZIILgv;Ljv;IIII)Le;", line = 7)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lgs;Lcg;Lza;ILhp;ILjv;Lwu;IILgv;B)Le;", line = 158)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(ZB)V", line = 359)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(III)V", line = 371)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 386)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lgv;III)V", line = 486)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(II[I[IZI)V", line = 509)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(IIIIIIB)I", line = 531)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Z)V", line = 562)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(B)V", line = 574)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljv;Ljv;Lgs;ILwu;BLsi;ILgv;IILza;ILcg;ZLhp;[Lgj;II)Le;", line = 614)
