...
public class class370 extends class512 {
    ...
    @OriginalMember(owner = "client!tc", name = "c", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lffa;II[B)V", line = 49)
