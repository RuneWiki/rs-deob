...
public class class370 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)V", line = 916)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IBI)Z", line = 929)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIIIIIII)V", line = 942)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lpea;II)V", line = 991)
