...
public class class370 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ZZLvh;III)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILlh;)V")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Llh;IB)V")
