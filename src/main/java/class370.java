...
public abstract class class370 extends class41 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIZZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(B)V", line = 236)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 279)
