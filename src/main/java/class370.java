...
public class class370 extends class510 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILuf;ZI)V")
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)Lhl;")
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lmp;Lfe;IIIIIIIIIIIIII)V")
