...
public class class370 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILdg;)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Ltq;B)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIIII[[BLda;[[BILor;I[[BLae;[Z)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILwl;)Lrp;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILae;Lon;B)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Ldg;B)V")
