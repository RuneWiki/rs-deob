...
public class class370 extends class443 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILfb;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILfb;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILps;)V")
