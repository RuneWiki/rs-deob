...
public class class370 extends class509 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZB)V", line = 47)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lkw;)V", line = 72)
    public class370(class174 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IBI)V", line = 76)
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZILmn;)V", line = 127)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IZ)V", line = 153)
