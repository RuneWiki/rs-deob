...
public class class370 extends class393 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 7)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I[IIII)V", line = 81)
