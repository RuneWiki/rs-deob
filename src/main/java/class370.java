...
public class class370 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BLac;)Lqfa;", line = 7)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(II)V", line = 26)
    public class370(int arg0, int arg1) {
        this.field4988 = arg1;
    }

    @OriginalMember(owner = "client!oh", name = "toString", descriptor = "()Ljava/lang/String;", line = 36)
