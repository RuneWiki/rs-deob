...
public class class370 extends class5 {
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "()V", line = 3)
    public class370() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILkp;IZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(II[BI[BIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ic", name = "i", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILes;I)V", line = 162)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(II)[I", line = 214)
