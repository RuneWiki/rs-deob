...
public class class370 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IIIZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "([Lbc;Lpg;Z)Lie;", line = 31)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(ILdc;Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BLor;)[Ltv;", line = 447)
