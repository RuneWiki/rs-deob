...
public class class370 extends class28 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IILfd;)V", line = 41)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(BLjava/lang/String;Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "()V", line = 209)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(JJ)J", line = 223)
    public static long method2131(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!bga", name = "d", descriptor = "(B)V", line = 230)
    public static void method2132(byte arg0) {
        field4767 = null;
        int var1 = -13 / ((arg0 + 10) / 45);
    }

    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(BC)I", line = 240)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(CB)I", line = 271)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Le;ZLpe;)V", line = 294)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "([ILdg;IB)V", line = 306)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lfd;I)V", line = 391)
