...
public class class370 {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "()V", line = 286)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lvt;)V", line = 313)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(III)I", line = 378)
