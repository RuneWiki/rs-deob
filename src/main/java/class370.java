...
public class class370 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 127)
