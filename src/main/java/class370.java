...
public class class370 extends class1 {
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(Lwm;ZLjava/lang/String;I)Lff;", line = 6)
    ...
    @OriginalMember(owner = "client!bo", name = "a", descriptor = "(B)Lgp;", line = 52)
    ...
    @OriginalMember(owner = "client!bo", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!bo", name = "<init>", descriptor = "(ILpf;Ldg;III)V", line = 82)
