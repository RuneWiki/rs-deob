...
public class class370 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(II)I", line = 33)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "([BB)[B", line = 70)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(II)V", line = 140)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IIBIIIIIIIIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 224)
