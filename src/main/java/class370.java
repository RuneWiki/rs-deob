...
public class class370 extends class427 {
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IBIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILjava/lang/String;I[BII)I", line = 150)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Luo;ZIIILak;IZLuo;ILeq;I)Lc;", line = 286)
