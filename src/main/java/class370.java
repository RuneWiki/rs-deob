...
public class class370 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZIILoa;)Lxa;")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Liaa;B)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILiaa;I)V")
