...
public class class370 extends class745 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lria;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!bfa", name = "H", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lkf;IBZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!bfa", name = "na", descriptor = "(IIII)[I", line = 78)
    ...
    @OriginalMember(owner = "client!bfa", name = "j", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILnp;)V", line = 129)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lhj;B)I", line = 140)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILkt;)V", line = 173)
    ...
    @OriginalMember(owner = "client!bfa", name = "j", descriptor = "(B)V", line = 198)
    ...
    @OriginalMember(owner = "client!bfa", name = "v", descriptor = "()V", line = 207)
    public final void method337() {
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IILwq;ZI[B)Lir;", line = 210)
    ...
    @OriginalMember(owner = "client!bfa", name = "g", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!bfa", name = "t", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(BZ)V", line = 267)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZZILkf;Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!bfa", name = "x", descriptor = "(I)V", line = 329)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(II)Lvm;", line = 340)
    public final class686 method273(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILsia;)I", line = 347)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(BI)V", line = 376)
    ...
    @OriginalMember(owner = "client!bfa", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Lin;Ljava/lang/Integer;)Lha;", line = 387)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljava/awt/Canvas;ILjava/lang/Object;)V", line = 483)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(BLcg;)V", line = 492)
    ...
    @OriginalMember(owner = "client!bfa", name = "d", descriptor = "(II)Lhe;", line = 531)
    public final class372 method353(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!bfa", name = "c", descriptor = "(Z)V", line = 540)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;B)V", line = 553)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lhj;ILuq;IIII)V", line = 566)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lhe;Lvm;)Lis;", line = 585)
    public final class503 method319(class372 arg0, class686 arg1) {
        return null;
    }

    @OriginalMember(owner = "client!bfa", name = "p", descriptor = "()V", line = 594)
    public final void method213() {
    }

    @OriginalMember(owner = "client!bfa", name = "w", descriptor = "(I)V", line = 598)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 608)
    public final void method344(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class721 {
        this.method348(arg2, arg3);
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ZLwq;Lbaa;)Z", line = 616)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljava/lang/Object;BLjava/awt/Canvas;)V", line = 627)
    ...
    @OriginalMember(owner = "client!bfa", name = "h", descriptor = "(Z)V", line = 638)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILbaa;Lwq;)I", line = 653)
    ...
    @OriginalMember(owner = "client!bfa", name = "m", descriptor = "()Z", line = 691)
    public final boolean method328() {
        return false;
    }

    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "()V", line = 699)
    ...
    @OriginalMember(owner = "client!bfa", name = "F", descriptor = "(II)V", line = 722)
    public final void method301(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!bfa", name = "P", descriptor = "(I)V", line = 728)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lwh;Lwh;FLwh;)Lwh;", line = 738)
    public final class149 method340(class149 arg0, class149 arg1, float arg2, class149 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(Z)V", line = 744)
    public final void method325(boolean arg0) {
    }

    @OriginalMember(owner = "client!bfa", name = "e", descriptor = "(B)V", line = 749)
    ...
    @OriginalMember(owner = "client!bfa", name = "d", descriptor = "(B)V", line = 785)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/hb;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lje;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Lin;I)V", line = 801)
    ...
    @OriginalMember(owner = "client!bfa", name = "z", descriptor = "(I)V", line = 851)
    ...
    @OriginalMember(owner = "client!bfa", name = "h", descriptor = "()V", line = 887)
    public final void method251() {
        this.field5260.method3800((byte) 13);
        super.method251();
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IZ)Luq;", line = 895)
    ...
    @OriginalMember(owner = "client!bfa", name = "GA", descriptor = "(I)V", line = 907)
    public final void method220(int arg0) {
        this.field5282.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!bfa", name = "I", descriptor = "()I", line = 914)
    public final int method315() {
        return 0;
    }

    @OriginalMember(owner = "client!bfa", name = "o", descriptor = "(I)V", line = 922)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lwq;II[FZIII)Lwfa;", line = 939)
    ...
    @OriginalMember(owner = "client!bfa", name = "r", descriptor = "(B)V", line = 950)
    ...
    @OriginalMember(owner = "client!bfa", name = "o", descriptor = "()Z", line = 970)
    public final boolean method291() {
        return false;
    }

    @OriginalMember(owner = "client!bfa", name = "D", descriptor = "(B)V", line = 977)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILnc;)V", line = 987)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IILhj;Z)V", line = 1011)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIII)V", line = 1024)
    public final void method350(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!bfa", name = "d", descriptor = "(Z)V", line = 1027)
    ...
    @OriginalMember(owner = "client!bfa", name = "q", descriptor = "()V", line = 1037)
    public final void method252() {
    }

    @OriginalMember(owner = "client!bfa", name = "Q", descriptor = "(I)V", line = 1041)
    ...
    @OriginalMember(owner = "client!bfa", name = "p", descriptor = "(I)V", line = 1052)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IIII[BLwq;IZ)Lwfa;", line = 1062)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(I)V", line = 1073)
    public final synchronized void method233(int arg0) {
        this.field5260.method3803((byte) -82);
        super.method233(arg0);
    }

    @OriginalMember(owner = "client!bfa", name = "i", descriptor = "(Z)F", line = 1082)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILjava/awt/Canvas;)Ljava/lang/Object;", line = 1092)
    public final Object method2268(int arg0, Canvas arg1) {
        return arg0 == -1 ? null : (Object) null;
    }

    @OriginalMember(owner = "client!bfa", name = "q", descriptor = "(Z)Z", line = 1106)
    ...
    @OriginalMember(owner = "client!bfa", name = "F", descriptor = "(I)V", line = 1154)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I[IZBIII)Lwfa;", line = 1166)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lis;)V", line = 1173)
    public final void method302(class503 arg0) {
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "([[IZII)Lnj;", line = 1176)
    ...
    @OriginalMember(owner = "client!bfa", name = "E", descriptor = "(B)V", line = 1187)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lkf;I)I", line = 1199)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I[Ljl;)Lnp;", line = 1224)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILjagdx/IDirect3DPixelShader;)V", line = 1235)
    ...
    @OriginalMember(owner = "client!bfa", name = "A", descriptor = "()V", line = 1245)
    public final void method257() {
    }

    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(ZI)Ltc;", line = 1248)
    public final class353 method2300(boolean arg0, int arg1) {
        return arg1 == 16711680 ? new class92(this, arg0) : (class353) null;
    }

    @OriginalMember(owner = "client!bfa", name = "G", descriptor = "(I)V", line = 1258)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(IIIID)V", line = 1267)
    public final void method235(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IB)Lfj;", line = 1271)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(FFF)V", line = 1318)
    public final void method244(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(ILtr;)I", line = 1324)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lbf;I)V", line = 1355)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Lbaa;Lwq;B)Z", line = 1375)
    ...
    @OriginalMember(owner = "client!bfa", name = "q", descriptor = "(B)V", line = 1387)
    ...
    @OriginalMember(owner = "client!bfa", name = "c", descriptor = "()Lfia;", line = 1427)
    ...
    @OriginalMember(owner = "client!bfa", name = "K", descriptor = "(I)V", line = 1436)
    ...
    @OriginalMember(owner = "client!bfa", name = "M", descriptor = "(I)V", line = 1452)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IBILbaa;Lwq;)Lwfa;", line = 1484)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILjava/awt/Canvas;Ljava/lang/Object;)V", line = 1494)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(Ljagdx/D3DPRESENT_PARAMETERS;IILjagdx/IDirect3D;II)Z", line = 1522)
    ...
    @OriginalMember(owner = "client!bfa", name = "u", descriptor = "(I)V", line = 1625)
    public final void method2273(int arg0) {
        int var2 = 60 % ((arg0 - 20) / 36);
        this.field5282.method2840(137, this.field10259 && !this.field10263);
    }

    @OriginalMember(owner = "client!bfa", name = "S", descriptor = "(I)V", line = 1633)
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(II)V", line = 1663)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(ILtc;I)V", line = 1690)
    ...
    @OriginalMember(owner = "client!bfa", name = "ya", descriptor = "()V", line = 1700)
