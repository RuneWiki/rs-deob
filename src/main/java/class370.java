...
public class class370 extends class459 {
    ...
    @OriginalMember(owner = "client!ga", name = "b", descriptor = "(ILr;)Lod;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lr;Lda;Lq;B)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lpn;IIIII)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ZILr;I)Z")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIILr;)Lda;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(BLr;)Lll;")
    public final class334 method408(byte arg0, class167 arg1) {
        ++field5811;
        return arg0 != 111 ? null : null;
    }

    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IILvca;Lkt;ILr;)Z")
