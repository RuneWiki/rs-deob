...
public class class370 extends class241 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()Leia;")
    ...
    @OriginalMember(owner = "client!he", name = "g", descriptor = "(I)Lmda;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BLmda;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IBD)Lmda;")
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "()Leia;")
