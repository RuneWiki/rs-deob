...
public class class370 extends class330 implements class678 {
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Luda;Lg;IIZ[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)I", line = 62)
    public final int method627(int arg0) {
        return arg0 == -7840 ? this.field5403 : -1;
    }

    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 73)
    public final IDirect3DBaseTexture method2137(boolean arg0) {
        return arg0 ? (IDirect3DBaseTexture) null : this.field5401;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)I", line = 83)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZZZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIII[III)V", line = 164)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(FZ)F", line = 204)
    public final float method617(float arg0, boolean arg1) {
        return arg1 ? -1.8452852F : arg0 / (float) this.field5402;
    }

    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Luda;IIZ[III)V", line = 213)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)Z", line = 270)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Luda;Lg;Lwj;II)V", line = 279)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I[IIIIII)V", line = 299)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(BLag;)V", line = 339)
