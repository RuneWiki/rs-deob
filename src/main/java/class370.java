...
public class class370 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ZILjava/lang/String;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLwk;II)V", line = 89)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 102)
