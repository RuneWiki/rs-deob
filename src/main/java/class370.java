...
public class class370 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZIIIIZIJLjava/lang/String;JIZLjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(II)Lhq;", line = 41)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZI)V", line = 123)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 155)
