...
public class class69 implements Runnable {
    ...
    @OriginalMember(owner = "client!YQNDWKQR", name = "g", descriptor = "LAMZQHNGA;")
    ...
    @OriginalMember(owner = "client!YQNDWKQR", name = "<init>", descriptor = "(ILAMZQHNGA;Ljava/net/Socket;)V")
