...
public class class69 extends class145 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kh", name = "e", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(III)V", line = 72)
    ...
    @OriginalMember(owner = "client!kh", name = "f", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "()V", line = 280)
    public class69() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lap;BI)V", line = 145)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZI)[[I", line = 189)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lap;I)Lsd;", line = 267)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIIIIB)V", line = 288)
    ...
    @OriginalMember(owner = "client!kh", name = "g", descriptor = "(I)V", line = 393)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(II)V", line = 408)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(IIII)V", line = 422)
    ...
    @OriginalMember(owner = "client!kh", name = "e", descriptor = "(B)V", line = 531)
