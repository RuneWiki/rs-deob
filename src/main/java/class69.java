...
public class class69 {
    ...
    @OriginalMember(owner = "client!ZPNSJLZE", name = "e", descriptor = "LKWULTEKW;")
    private class28 field1701 = new class28();

    @OriginalMember(owner = "client!ZPNSJLZE", name = "i", descriptor = "LYGUBUIIU;")
    ...
    @OriginalMember(owner = "client!ZPNSJLZE", name = "h", descriptor = "LXWMRKIHQ;")
    ...
    @OriginalMember(owner = "client!ZPNSJLZE", name = "a", descriptor = "(J)LKWULTEKW;")
    ...
    @OriginalMember(owner = "client!ZPNSJLZE", name = "a", descriptor = "(LKWULTEKW;IJ)V")
