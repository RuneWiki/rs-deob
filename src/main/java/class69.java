...
@OriginalClass("client!YPPCWCLI")
public class class69 {

    @OriginalMember(owner = "client!YPPCWCLI", name = "a", descriptor = "B")
    private byte field1625 = 44;

    @OriginalMember(owner = "client!YPPCWCLI", name = "b", descriptor = "Z")
    private boolean field1626 = true;

    @OriginalMember(owner = "client!YPPCWCLI", name = "d", descriptor = "Z")
    private boolean field1628 = true;

    @OriginalMember(owner = "client!YPPCWCLI", name = "m", descriptor = "[I")
    private int[] field1637 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "n", descriptor = "[I")
    private int[] field1638 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "o", descriptor = "[I")
    private int[] field1639 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "q", descriptor = "I")
    private int field1641 = 100;

    @OriginalMember(owner = "client!YPPCWCLI", name = "t", descriptor = "I")
    public int field1644 = 500;

    @OriginalMember(owner = "client!YPPCWCLI", name = "c", descriptor = "I")
    private static int field1627 = -10185;

    @OriginalMember(owner = "client!YPPCWCLI", name = "y", descriptor = "[I")
    private static int[] field1649 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "z", descriptor = "[I")
    private static int[] field1650 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "A", descriptor = "[I")
    private static int[] field1651 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "B", descriptor = "[I")
    private static int[] field1652 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "C", descriptor = "[I")
    private static int[] field1653 = new int[5];

    @OriginalMember(owner = "client!YPPCWCLI", name = "p", descriptor = "I")
    private int field1640;

    @OriginalMember(owner = "client!YPPCWCLI", name = "u", descriptor = "I")
    public int field1645;

    @OriginalMember(owner = "client!YPPCWCLI", name = "r", descriptor = "LECVTLYGP;")
    private class16 field1642;

    @OriginalMember(owner = "client!YPPCWCLI", name = "e", descriptor = "LNSRSHTPL;")
    private class38 field1629;

    @OriginalMember(owner = "client!YPPCWCLI", name = "f", descriptor = "LNSRSHTPL;")
    private class38 field1630;

    @OriginalMember(owner = "client!YPPCWCLI", name = "g", descriptor = "LNSRSHTPL;")
    private class38 field1631;

    @OriginalMember(owner = "client!YPPCWCLI", name = "h", descriptor = "LNSRSHTPL;")
    private class38 field1632;

    @OriginalMember(owner = "client!YPPCWCLI", name = "i", descriptor = "LNSRSHTPL;")
    private class38 field1633;

    @OriginalMember(owner = "client!YPPCWCLI", name = "j", descriptor = "LNSRSHTPL;")
    private class38 field1634;

    @OriginalMember(owner = "client!YPPCWCLI", name = "k", descriptor = "LNSRSHTPL;")
    private class38 field1635;

    @OriginalMember(owner = "client!YPPCWCLI", name = "l", descriptor = "LNSRSHTPL;")
    private class38 field1636;

    @OriginalMember(owner = "client!YPPCWCLI", name = "s", descriptor = "LNSRSHTPL;")
    private class38 field1643;

    @OriginalMember(owner = "client!YPPCWCLI", name = "v", descriptor = "[I")
    private static int[] field1646;

    @OriginalMember(owner = "client!YPPCWCLI", name = "w", descriptor = "[I")
    private static int[] field1647;

    @OriginalMember(owner = "client!YPPCWCLI", name = "x", descriptor = "[I")
    private static int[] field1648;

    @OriginalMember(owner = "client!YPPCWCLI", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!YPPCWCLI", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!YPPCWCLI", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!YPPCWCLI", name = "a", descriptor = "(BLYOXDZEVD;)V")
