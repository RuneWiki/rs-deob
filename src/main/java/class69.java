...
public class class69 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BLtm;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Llh;ZILjava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!rh", name = "d", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(B)Ltm;")
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(I)Ltm;")
