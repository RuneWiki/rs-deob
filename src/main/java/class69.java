...
public class class69 extends class401 {
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(III)Z", line = 16)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "(Lwp;)V", line = 71)
