...
public class class69 implements Runnable {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Ljava/lang/String;I)Ljq;", line = 5)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 27)
    ...
    @OriginalMember(owner = "client!og", name = "run", descriptor = "()V", line = 78)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IZ)I", line = 119)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "()V", line = 134)
    public class69() {
        this.field936.setDaemon(true);
        this.field936.start();
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILfi;)V", line = 149)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 166)
