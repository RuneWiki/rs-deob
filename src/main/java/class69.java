...
public abstract class class69 extends class420 {
    ...
    @OriginalMember(owner = "client!mia", name = "d", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I[IB[Ljava/lang/Object;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Ldf;IZIIILha;)V", line = 70)
    ...
    @OriginalMember(owner = "client!mia", name = "i", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!mia", name = "k", descriptor = "(I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "([Luf;Z)I", line = 115)
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(IIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!mia", name = "d", descriptor = "(ILha;)Z", line = 145)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(I)V", line = 171)
