...
public class class69 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lvd;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lvd;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BI)V", line = 96)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILpv;Lvd;)V", line = 111)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I)V", line = 395)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ZLvd;)V", line = 412)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(BILvd;)V", line = 435)
