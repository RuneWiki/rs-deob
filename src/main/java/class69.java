...
public class class69 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLqa;IIIIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILqa;)Z", line = 116)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(I[Lkf;IIII)V", line = 202)
