...
public class class69 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIIIZZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lgt;ZLjava/lang/String;ZI)V", line = 89)
