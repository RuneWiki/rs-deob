...
@OriginalClass("client!WUVIEXOA")
public class class69 {

    @OriginalMember(owner = "client!WUVIEXOA", name = "a", descriptor = "B")
    private byte field1696 = 7;

    @OriginalMember(owner = "client!WUVIEXOA", name = "b", descriptor = "Z")
    private boolean field1697 = true;

    @OriginalMember(owner = "client!WUVIEXOA", name = "c", descriptor = "LOGKECTLC;")
    public class45 field1698 = new class45();

    @OriginalMember(owner = "client!WUVIEXOA", name = "d", descriptor = "LOGKECTLC;")
    private class45 field1699;

    @OriginalMember(owner = "client!WUVIEXOA", name = "<init>", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "a", descriptor = "(LOGKECTLC;)V")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "a", descriptor = "(BLOGKECTLC;)V")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "a", descriptor = "()LOGKECTLC;")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "b", descriptor = "()LOGKECTLC;")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "a", descriptor = "(B)LOGKECTLC;")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "a", descriptor = "(I)LOGKECTLC;")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "b", descriptor = "(I)LOGKECTLC;")
    ...
    @OriginalMember(owner = "client!WUVIEXOA", name = "c", descriptor = "()V")
