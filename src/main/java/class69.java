...
public class class69 extends class328 {
    ...
    @OriginalMember(owner = "client!qs", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "()V", line = 18)
    public class69() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IIIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "([BZ)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II)[I", line = 112)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "([BI)Lah;", line = 123)
