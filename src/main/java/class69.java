...
public class class69 extends class320 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(BI[F)[F", line = 11)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!eg", name = "d", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "([BIB)I", line = 149)
