...
public abstract class class69 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IZZ)V", line = 138)
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(IIIII)V", line = 377)
    ...
    @OriginalMember(owner = "client!wf", name = "d", descriptor = "(I)V", line = 170)
    public static void method397(int arg0) {
        int var1 = -14 % ((arg0 + 69) / 52);
        field796 = null;
    }

    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IIII)V", line = 182)
