...
public class class69 implements Runnable {
    ...
    @OriginalMember(owner = "client!h", name = "o", descriptor = "[Lah;")
    ...
    @OriginalMember(owner = "client!h", name = "k", descriptor = "Llf;")
    public static class109 field1342 = class35.method275(" <col=00ff80>", 2);

    @OriginalMember(owner = "client!h", name = "p", descriptor = "Llf;")
    public static class109 field1347 = class35.method275("<img=0>", 2);

    @OriginalMember(owner = "client!h", name = "q", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "Lke;")
