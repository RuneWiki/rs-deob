...
@OriginalClass("client!YTVETJJL")
public class class69 {

    @OriginalMember(owner = "client!YTVETJJL", name = "c", descriptor = "B")
    private byte field1667 = -122;

    @OriginalMember(owner = "client!YTVETJJL", name = "h", descriptor = "I")
    public int field1672 = -1;

    @OriginalMember(owner = "client!YTVETJJL", name = "i", descriptor = "Z")
    public boolean field1673 = false;

    @OriginalMember(owner = "client!YTVETJJL", name = "j", descriptor = "Z")
    public boolean field1674 = true;

    @OriginalMember(owner = "client!YTVETJJL", name = "a", descriptor = "I")
    private static int field1665 = 8;

    @OriginalMember(owner = "client!YTVETJJL", name = "b", descriptor = "Z")
    private static boolean field1666 = true;

    @OriginalMember(owner = "client!YTVETJJL", name = "d", descriptor = "I")
    public static int field1668;

    @OriginalMember(owner = "client!YTVETJJL", name = "g", descriptor = "I")
    public int field1671;

    @OriginalMember(owner = "client!YTVETJJL", name = "k", descriptor = "I")
    public int field1675;

    @OriginalMember(owner = "client!YTVETJJL", name = "l", descriptor = "I")
    public int field1676;

    @OriginalMember(owner = "client!YTVETJJL", name = "m", descriptor = "I")
    public int field1677;

    @OriginalMember(owner = "client!YTVETJJL", name = "n", descriptor = "I")
    public int field1678;

    @OriginalMember(owner = "client!YTVETJJL", name = "o", descriptor = "I")
    public int field1679;

    @OriginalMember(owner = "client!YTVETJJL", name = "p", descriptor = "I")
    public int field1680;

    @OriginalMember(owner = "client!YTVETJJL", name = "f", descriptor = "Ljava/lang/String;")
    public String field1670;

    @OriginalMember(owner = "client!YTVETJJL", name = "e", descriptor = "[LYTVETJJL;")
    public static class69[] field1669;

    @OriginalMember(owner = "client!YTVETJJL", name = "a", descriptor = "(LFIGUVTWB;Z)V")
    ...
    @OriginalMember(owner = "client!YTVETJJL", name = "a", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!YTVETJJL", name = "a", descriptor = "(IB)V")
    ...
    @OriginalMember(owner = "client!YTVETJJL", name = "a", descriptor = "(III)I")
