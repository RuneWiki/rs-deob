...
public class class69 extends class512 {
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(II)Lnp;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZILia;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(III)Lql;")
