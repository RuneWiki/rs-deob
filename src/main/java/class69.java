...
public class class69 extends class136 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfs;ZLya;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILiv;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfs;I)I")
