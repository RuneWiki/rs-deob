...
public class class69 implements IEnumModesCallback {
    ...
    @OriginalMember(owner = "client!qn", name = "callbackEnumModes", descriptor = "(Lcom/ms/directX/DDSurfaceDesc;Lcom/ms/com/IUnknown;)V", line = 13)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(BLjava/awt/Frame;)V", line = 29)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)[I", line = 41)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIIILjava/awt/Frame;I)V", line = 58)
