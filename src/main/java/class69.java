...
public class class69 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)Lm;", line = 10)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IBI)Z", line = 42)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)Lm;", line = 56)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "()V", line = 109)
    public class69() {
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lkk;)V", line = 112)
    public class69(class188 arg0) {
        this.field848 = arg0;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)V", line = 98)
