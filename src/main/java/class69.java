...
public class class69 extends class735 {
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Lrh;Z)V")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ZLwda;)I")
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ILfca;)V")
