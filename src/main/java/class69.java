...
public class class69 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "([IBLmt;J)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lnb;I)Lgs;")
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(II)Ltr;")
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(ILaj;Laj;Laea;)V")
