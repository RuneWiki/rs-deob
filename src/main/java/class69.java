...
public class class69 {
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I[Lac;)I", line = 60)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(B)I", line = 93)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)Lac;", line = 129)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(I)Lac;", line = 163)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)Z", line = 176)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BJ)Lac;", line = 187)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lac;JI)V", line = 222)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(Z)Lac;", line = 242)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(I)V", line = 272)
