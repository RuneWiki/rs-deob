...
public class class69 extends class299 implements class28 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I[Lrd;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lbn;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lvm;Lc;[Lwg;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "u", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lap;[Lrr;Z)Lla;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lbn;Lbn;FLbn;)Lbn;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lfe;IIII)Le;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lvm;Z)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Lgt;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIF)Lrd;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lrr;Z)Lo;")
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(IIIIII)Lbn;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lvm;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lc;[Lwg;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I)Ln;")
