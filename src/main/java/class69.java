...
public class class69 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(II)Lug;", line = 32)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(ILin;Lin;)V", line = 100)
