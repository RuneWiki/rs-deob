...
public class class69 extends class220 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IBLil;)V", line = 5)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "()V", line = 62)
    public class69() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(II)[[I", line = 87)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(II)[I", line = 134)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(BI)Lf;", line = 177)
