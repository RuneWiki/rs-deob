...
public class class69 extends class295 implements class194 {
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lvk;Z)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lc;[Lrr;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lks;Lks;FLks;)Lks;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lks;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "([Le;Lvk;Lc;[Lrr;I)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;Lor;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lqq;IIII)Le;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(I[Lsa;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIIF)Lsa;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lkt;[Lau;Z)Lla;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lvk;)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IIIIII)Lks;")
    public final class23 method540(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!w", name = "q", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Lau;Z)Lo;")
