...
@OriginalClass("client!YHTUMUXE")
public class class69 extends class66 {

    @OriginalMember(owner = "client!YHTUMUXE", name = "o", descriptor = "Z")
    public boolean field1620 = false;

    @OriginalMember(owner = "client!YHTUMUXE", name = "s", descriptor = "I")
    private int field1624 = 8;

    @OriginalMember(owner = "client!YHTUMUXE", name = "t", descriptor = "B")
    private byte field1625 = 29;

    @OriginalMember(owner = "client!YHTUMUXE", name = "u", descriptor = "I")
    private int field1626 = -503;

    @OriginalMember(owner = "client!YHTUMUXE", name = "r", descriptor = "LTGIKVGNH;")
    private class55 field1623;

    @OriginalMember(owner = "client!YHTUMUXE", name = "k", descriptor = "I")
    public int field1616;

    @OriginalMember(owner = "client!YHTUMUXE", name = "l", descriptor = "I")
    public int field1617;

    @OriginalMember(owner = "client!YHTUMUXE", name = "m", descriptor = "I")
    public int field1618;

    @OriginalMember(owner = "client!YHTUMUXE", name = "n", descriptor = "I")
    public int field1619;

    @OriginalMember(owner = "client!YHTUMUXE", name = "v", descriptor = "I")
    public int field1627;

    @OriginalMember(owner = "client!YHTUMUXE", name = "p", descriptor = "I")
    private int field1621;

    @OriginalMember(owner = "client!YHTUMUXE", name = "q", descriptor = "I")
    private int field1622;

    @OriginalMember(owner = "client!YHTUMUXE", name = "a", descriptor = "(I)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!YHTUMUXE", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!YHTUMUXE", name = "<init>", descriptor = "(IIIZIIII)V")
