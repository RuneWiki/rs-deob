...
public class class69 extends class398 {
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "()V", line = 26)
    public class69() {
        super(1, true);
    }

    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!kh", name = "f", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lnj;II)V", line = 234)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(II)[I", line = 264)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(Z)V", line = 278)
    ...
    @OriginalMember(owner = "client!kh", name = "d", descriptor = "(II)V", line = 359)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIII)I", line = 385)
    ...
    @OriginalMember(owner = "client!kh", name = "g", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Llm;B)V", line = 427)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(II)[I", line = 446)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(III)I", line = 494)
