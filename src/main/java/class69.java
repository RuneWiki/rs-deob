...
public class class69 extends class24 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(FFFFFFLta;II)V")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IILta;II)V")
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lur;IIII)V")
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Lur;II[III)V")
