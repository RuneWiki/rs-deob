...
public class class69 {
    ...
    @OriginalMember(owner = "client!sja", name = "d", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sja", name = "e", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!sja", name = "f", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!sja", name = "c", descriptor = "(B)Z", line = 46)
