...
public class class69 {
    ...
    @OriginalMember(owner = "client!XESCWZPS", name = "c", descriptor = "[LXESCWZPS;")
    public static class69[] field1636;

    @OriginalMember(owner = "client!XESCWZPS", name = "a", descriptor = "(ILTXPLZUUI;)V")
    ...
    @OriginalMember(owner = "client!XESCWZPS", name = "a", descriptor = "(ILPKHWFJLM;I)V")
