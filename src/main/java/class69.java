...
public class class69 extends class449 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BC)Z", line = 45)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ID)V", line = 82)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "()V", line = 138)
    public class69() {
    }

    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 140)
