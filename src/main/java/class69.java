...
public class class69 extends class413 {
    ...
    @OriginalMember(owner = "client!il", name = "OA", descriptor = "(CIIIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "(Lvj;Lho;[Lqo;Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(CIIIZLua;II)V", line = 263)
