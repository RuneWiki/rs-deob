...
public class class69 extends class12 {
    ...
    @OriginalMember(owner = "client!ZQANNJZE", name = "Gb", descriptor = "LZYLCKQCD;")
    ...
    @OriginalMember(owner = "client!ZQANNJZE", name = "xb", descriptor = "LPOJFANDE;")
    public class43 field1694;

    @OriginalMember(owner = "client!ZQANNJZE", name = "Ab", descriptor = "LWZSDIPBR;")
    public class58 field1697;

    @OriginalMember(owner = "client!ZQANNJZE", name = "Lb", descriptor = "Ljava/lang/String;")
    public String field1708;

    @OriginalMember(owner = "client!ZQANNJZE", name = "a", descriptor = "(ILPGNBHFUF;)V")
    ...
    @OriginalMember(owner = "client!ZQANNJZE", name = "c", descriptor = "(Z)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!ZQANNJZE", name = "a", descriptor = "(Z)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!ZQANNJZE", name = "a", descriptor = "(I)LPOJFANDE;")
