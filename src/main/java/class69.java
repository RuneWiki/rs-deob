...
public class class69 extends class626 implements class24 {
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Lad;Lkca;III[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!lea", name = "d", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 77)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ZLui;)V", line = 87)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(B)V", line = 98)
