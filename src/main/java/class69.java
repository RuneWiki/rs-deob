...
public class class69 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Leb;I)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIIILaa;I)Lhc;")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILke;II)V")
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Leb;II)V")
