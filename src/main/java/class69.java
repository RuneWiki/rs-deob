...
public class class69 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BILlk;)V", line = 38)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Llk;B)V", line = 136)
