...
public class class69 extends class293 {
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "([III)V", line = 7)
    ...
    @OriginalMember(owner = "client!er", name = "e", descriptor = "()I", line = 51)
    public final synchronized int method577() {
        return this.field932.method2806((byte) 56);
    }

    @OriginalMember(owner = "client!er", name = "c", descriptor = "()Lad;", line = 54)
    public final class293 method550() {
        return (class293) this.field932.method2818((byte) 123);
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "()I", line = 58)
    public final int method538() {
        return 0;
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Luj;Lbp;)V", line = 62)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lbp;)V", line = 70)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "([III)V", line = 90)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "()Lad;", line = 101)
    public final class293 method521() {
        return (class293) this.field932.method2820((byte) -58);
    }

    @OriginalMember(owner = "client!er", name = "f", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lad;)V", line = 121)
    public final synchronized void method582(class293 arg0) {
        arg0.method1565(0);
    }

    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(Lad;)V", line = 180)
    public final synchronized void method583(class293 arg0) {
        this.field932.method2817(arg0, true);
    }

    @OriginalMember(owner = "client!er", name = "d", descriptor = "(I)V", line = 187)
