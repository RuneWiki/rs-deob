...
public abstract class class69 extends class446 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(CI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILep;Lms;IIBLsg;I)V", line = 62)
