...
@OriginalClass("client!YVZOKMUV")
public class class69 extends class1 {

    @OriginalMember(owner = "client!YVZOKMUV", name = "n", descriptor = "Z")
    private boolean field1549 = false;

    @OriginalMember(owner = "client!YVZOKMUV", name = "p", descriptor = "I")
    private int field1551 = -723;

    @OriginalMember(owner = "client!YVZOKMUV", name = "s", descriptor = "Z")
    public boolean field1554 = false;

    @OriginalMember(owner = "client!YVZOKMUV", name = "r", descriptor = "LOQOGSGFM;")
    private class37 field1553;

    @OriginalMember(owner = "client!YVZOKMUV", name = "t", descriptor = "I")
    public int field1555;

    @OriginalMember(owner = "client!YVZOKMUV", name = "u", descriptor = "I")
    public int field1556;

    @OriginalMember(owner = "client!YVZOKMUV", name = "v", descriptor = "I")
    public int field1557;

    @OriginalMember(owner = "client!YVZOKMUV", name = "w", descriptor = "I")
    public int field1558;

    @OriginalMember(owner = "client!YVZOKMUV", name = "m", descriptor = "I")
    public int field1548;

    @OriginalMember(owner = "client!YVZOKMUV", name = "k", descriptor = "I")
    private int field1546;

    @OriginalMember(owner = "client!YVZOKMUV", name = "l", descriptor = "I")
    private int field1547;

    @OriginalMember(owner = "client!YVZOKMUV", name = "o", descriptor = "I")
    private int field1550;

    @OriginalMember(owner = "client!YVZOKMUV", name = "q", descriptor = "I")
    private int field1552;

    @OriginalMember(owner = "client!YVZOKMUV", name = "a", descriptor = "(Z)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!YVZOKMUV", name = "<init>", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!YVZOKMUV", name = "a", descriptor = "(IZ)V")
