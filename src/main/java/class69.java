...
public class class69 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)V", line = 8)
    public static void method403(int arg0) {
        field1078 = null;
        int var1 = -16 % ((-arg0 - 59) / 54);
    }

    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)V", line = 33)
