...
public class class69 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)Lkq;", line = 16)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)Ljh;", line = 32)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIBI)V", line = 89)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lbp;ZI)V", line = 146)
