...
public class class69 extends class535 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(II)[[I", line = 107)
    ...
    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(II)V", line = 159)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "()V", line = 412)
    public class69() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jt", name = "e", descriptor = "(B)V", line = 415)
    ...
    @OriginalMember(owner = "client!jt", name = "f", descriptor = "(B)V", line = 429)
    ...
    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(I)V", line = 458)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ZII)I", line = 472)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILwn;I)V", line = 490)
