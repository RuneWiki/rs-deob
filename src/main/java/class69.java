...
public class class69 extends class22 {
    ...
    @OriginalMember(owner = "client!YGMSKJOQ", name = "<init>", descriptor = "(LQKFGLETG;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!YGMSKJOQ", name = "a", descriptor = "(LDEITBGVL;III)V")
