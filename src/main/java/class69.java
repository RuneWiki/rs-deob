...
public class class69 extends class62 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Luo;J[Lun;[Lkh;Z)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Luo;J)Z")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "([Lkh;Z)V")
    ...
    @OriginalMember(owner = "client!kq", name = "e", descriptor = "()Lsk;")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Luo;[Lun;Z)V")
