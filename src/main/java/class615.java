...
public class class615 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BI)Lwp;", line = 5)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZIII)Lla;", line = 69)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lkd;Ld;)V", line = 91)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 101)
