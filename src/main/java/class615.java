...
public class class615 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lvc;[[BB)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II)Lrn;")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Loda;ILdda;)V")
