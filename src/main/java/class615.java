...
public class class615 implements class681 {
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(I)Lwea;", line = 5)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lla;Ljava/lang/String;)V", line = 45)
