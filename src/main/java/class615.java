...
public class class615 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IILhca;IIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "([BB)[B", line = 67)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(BII)V", line = 88)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(III)Z", line = 107)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lio;[BB)V", line = 120)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ZII)Z", line = 146)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "()V", line = 174)
    public class615() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(III)V", line = 176)
