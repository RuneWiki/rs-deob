...
public class class615 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILdi;Lqa;IIILdj;Lwt;)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ZLos;)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IZLqa;I)Lha;")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Los;IZ)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Llw;BZZ)V")
