...
public class class615 extends class210 {
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Leea;IIII)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II[IZIIIII)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Ljava/lang/String;IBZ)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ZIII)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Leea;IIIII)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Leea;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Leea;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Leea;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(ZZI)V")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IZIZI[BIIII)V")
