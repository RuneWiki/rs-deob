...
public class class615 {
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lhea;Lwp;Lni;IIIII)V", line = 401)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IIIIZ[ILcp;IZIIII[II)I", line = 185)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 362)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(Lrn;BI)V", line = 380)
