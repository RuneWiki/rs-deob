...
public class class615 extends class212 {
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Ldh;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(ILdh;)V")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILha;BZ)Lel;")
