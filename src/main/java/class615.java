...
public class class615 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIBLha;III)V", line = 223)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "([Lci;BLeq;)Lua;", line = 259)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IBIII)V", line = 329)
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(B)V", line = 343)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "()V", line = 353)
    protected class615() {
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lha;Ltn;I)V", line = 363)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIZ)V", line = 420)
