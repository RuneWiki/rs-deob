...
public abstract class class615 extends class504 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IB)[I", line = 35)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BILeh;)V", line = 81)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)[[I", line = 95)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(B)I", line = 128)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(III)[I", line = 139)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(Ldw;Lfba;)V", line = 164)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ZII)[[I", line = 1260)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IIII)Lrba;", line = 1304)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(IZ)V", line = 1333)
    public class615(int arg0, boolean arg1) {
        this.field8135 = new class615[arg0];
        this.field8118 = arg1;
    }

    @OriginalMember(owner = "client!qp", name = "c", descriptor = "(I)V", line = 1342)
