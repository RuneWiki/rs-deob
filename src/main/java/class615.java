...
public class class615 extends class748 {
    ...
    @OriginalMember(owner = "client!wg", name = "h", descriptor = "(I)Lbi;")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lcw;BIIILaa;ILpaa;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IZLvj;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZILam;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lkf;I)I")
