...
public class class615 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ZIII)Lvd;", line = 49)
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 70)
