...
public abstract class class615 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)Lma;")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ILoh;)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "d", descriptor = "(I)Lej;")
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(Z)Luea;")
    ...
    @OriginalMember(owner = "client!aaa", name = "d", descriptor = "(B)Lis;")
    ...
    @OriginalMember(owner = "client!aaa", name = "e", descriptor = "(B)V")
