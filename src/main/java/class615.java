...
public class class615 extends class232 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ILdr;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZB)V", line = 13)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZI)V", line = 45)
    ...
    @OriginalMember(owner = "client!vs", name = "e", descriptor = "(I)Z", line = 55)
    public final boolean method571(int arg0) {
        return arg0 == -30998 ? this.field8681 : true;
    }

    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Lki;Lcb;Llo;)V", line = 66)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!vs", name = "b", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!vs", name = "c", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III)V", line = 199)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 227)
