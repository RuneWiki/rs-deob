...
public abstract class class615 implements class54 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "([BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lqj;IIIZ)V", line = 219)
    ...
    @OriginalMember(owner = "client!rg", name = "finalize", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)V", line = 118)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)Z", line = 132)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ZI)V", line = 156)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(ZI)V", line = 182)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 198)
