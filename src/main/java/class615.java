...
public class class615 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lpq;B)V", line = 24)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Lrd;", line = 36)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Luea;ILpq;)V", line = 78)
