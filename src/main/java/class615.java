...
public class class615 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)V", line = 47)
    ...
    @OriginalMember(owner = "client!ij", name = "toString", descriptor = "()Ljava/lang/String;", line = 69)
    public final String toString() {
        field8659++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(IILrt;)V", line = 86)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(II)Lij;", line = 101)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIII)Z", line = 175)
