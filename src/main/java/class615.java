...
public class class615 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "()V", line = 21)
    public class615() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!dr", name = "a", descriptor = "([BLgw;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lqa;Lvp;III)V", line = 53)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIII)Z", line = 375)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(III)V", line = 396)
