...
public abstract class class11 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(III)V", line = 40)
    ...
    @OriginalMember(owner = "client!ya", name = "b", descriptor = "(I)V", line = 57)
