...
public class class11 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IIIILka;I)Lka;")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(BILmc;)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IBIILka;III)Lka;")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lmc;I)V")
