...
public class class11 extends class194 {
    ...
    @OriginalMember(owner = "client!cn", name = "h", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IILbg;)V", line = 33)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!cn", name = "d", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!cn", name = "i", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "()V", line = 168)
    public class11() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILjava/lang/String;)J", line = 172)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(II)[[I", line = 194)
