...
public class class11 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILmaa;)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Ldc;II)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(BLdc;)V")
