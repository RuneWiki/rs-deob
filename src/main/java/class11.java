...
public class class11 extends class434 implements class101 {
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lnm;ILjava/nio/ByteBuffer;)V", line = 4)
    public class11(class254 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field156 = arg1;
    }

    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lnm;I[BI)V", line = 8)
    public class11(class254 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field156 = arg1;
    }

    @OriginalMember(owner = "client!cn", name = "d", descriptor = "(Ljt;)V", line = 12)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(Ljt;)V", line = 16)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(Ljt;)V", line = 19)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "()I", line = 22)
    public final int method114() {
        return 0;
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I[BI)V", line = 26)
    public final void method115(int arg0, byte[] arg1, int arg2) {
        this.method2538(arg1, arg2);
        this.field156 = arg0;
    }

    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Ljt;)V", line = 30)
