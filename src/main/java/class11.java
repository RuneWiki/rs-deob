...
public class class11 extends class22 {
    ...
    @OriginalMember(owner = "client!DROEXFTE", name = "r", descriptor = "LUVDKTGZK;")
    ...
    @OriginalMember(owner = "client!DROEXFTE", name = "q", descriptor = "Lclient;")
    public static client field690;

    @OriginalMember(owner = "client!DROEXFTE", name = "a", descriptor = "(I)LCADBNSXE;")
    ...
    @OriginalMember(owner = "client!DROEXFTE", name = "a", descriptor = "(B)LLYSBQDHB;")
