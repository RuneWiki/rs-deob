...
public class class11 extends class78 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILjo;Ljo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "()I", line = 158)
    public final int method48() {
        return 1;
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "()Z", line = 162)
    ...
    @OriginalMember(owner = "client!bh", name = "e", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "()Z", line = 202)
    public final boolean method51() {
        return this.field95 != null;
    }

    @OriginalMember(owner = "client!bh", name = "e", descriptor = "()Z", line = 208)
    public final boolean method52() {
        return this.field879.field4754 && this.field879.field4740 && this.field879.field4747;
    }

    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(II)V", line = 218)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lql;)V", line = 285)
    public class11(class346 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bh", name = "c", descriptor = "()V", line = 289)
