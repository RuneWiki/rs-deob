...
public class class11 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IILlk;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Llk;I)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(III)Lui;")
