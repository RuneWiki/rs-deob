...
public class class11 {
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(I)V", line = 6)
    public static void method75(int arg0) {
        field126 = null;
        int var1 = 25 % (-arg0 / 37);
    }

    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(IJ)Lgj;", line = 15)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(I[I[I)V", line = 39)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(JB)V", line = 73)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(Lgj;JZ)V", line = 100)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!sja", name = "<init>", descriptor = "(I)V", line = 164)
