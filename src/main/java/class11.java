...
public class class11 extends class322 {
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!daa", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(II)V", line = 95)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(ILch;)V", line = 106)
    public class11(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lch;)V", line = 111)
