...
public class class11 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lr;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lq;ILda;ILr;ZIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ILr;)V", line = 132)
    ...
    @OriginalMember(owner = "client!sw", name = "d", descriptor = "(I)Ljo;", line = 142)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(Lr;Ltc;IIIIIIZI)V", line = 593)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ZIIZLr;II)Lda;", line = 167)
    ...
    @OriginalMember(owner = "client!sw", name = "finalize", descriptor = "()V", line = 310)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(III)V", line = 325)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(II)V", line = 430)
    ...
    @OriginalMember(owner = "client!sw", name = "e", descriptor = "(I)V", line = 558)
