...
public class class11 extends class578 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lac;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BLjava/awt/Component;)Ljt;", line = 66)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IC)I", line = 78)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!daa", name = "d", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(CB)I", line = 144)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lac;I)V", line = 175)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IZIIIIII)V", line = 203)
