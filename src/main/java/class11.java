...
public class class11 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIIIIII)V", line = 43)
