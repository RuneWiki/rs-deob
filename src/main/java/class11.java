...
@OriginalClass("client!CYFJILLF")
public class class11 {

    @OriginalMember(owner = "client!CYFJILLF", name = "a", descriptor = "Z")
    private boolean field651 = true;

    @OriginalMember(owner = "client!CYFJILLF", name = "j", descriptor = "[I")
    private int[] field660 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "k", descriptor = "[I")
    private int[] field661 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "l", descriptor = "[I")
    private int[] field662 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "n", descriptor = "I")
    private int field664 = 100;

    @OriginalMember(owner = "client!CYFJILLF", name = "q", descriptor = "I")
    public int field667 = 500;

    @OriginalMember(owner = "client!CYFJILLF", name = "v", descriptor = "[I")
    private static int[] field672 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "w", descriptor = "[I")
    private static int[] field673 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "x", descriptor = "[I")
    private static int[] field674 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "y", descriptor = "[I")
    private static int[] field675 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "z", descriptor = "[I")
    private static int[] field676 = new int[5];

    @OriginalMember(owner = "client!CYFJILLF", name = "m", descriptor = "I")
    private int field663;

    @OriginalMember(owner = "client!CYFJILLF", name = "r", descriptor = "I")
    public int field668;

    @OriginalMember(owner = "client!CYFJILLF", name = "b", descriptor = "LRRWCTNMK;")
    private class50 field652;

    @OriginalMember(owner = "client!CYFJILLF", name = "c", descriptor = "LRRWCTNMK;")
    private class50 field653;

    @OriginalMember(owner = "client!CYFJILLF", name = "d", descriptor = "LRRWCTNMK;")
    private class50 field654;

    @OriginalMember(owner = "client!CYFJILLF", name = "e", descriptor = "LRRWCTNMK;")
    private class50 field655;

    @OriginalMember(owner = "client!CYFJILLF", name = "f", descriptor = "LRRWCTNMK;")
    private class50 field656;

    @OriginalMember(owner = "client!CYFJILLF", name = "g", descriptor = "LRRWCTNMK;")
    private class50 field657;

    @OriginalMember(owner = "client!CYFJILLF", name = "h", descriptor = "LRRWCTNMK;")
    private class50 field658;

    @OriginalMember(owner = "client!CYFJILLF", name = "i", descriptor = "LRRWCTNMK;")
    private class50 field659;

    @OriginalMember(owner = "client!CYFJILLF", name = "p", descriptor = "LRRWCTNMK;")
    private class50 field666;

    @OriginalMember(owner = "client!CYFJILLF", name = "o", descriptor = "LUVAKRMXV;")
    private class61 field665;

    @OriginalMember(owner = "client!CYFJILLF", name = "s", descriptor = "[I")
    private static int[] field669;

    @OriginalMember(owner = "client!CYFJILLF", name = "t", descriptor = "[I")
    private static int[] field670;

    @OriginalMember(owner = "client!CYFJILLF", name = "u", descriptor = "[I")
    private static int[] field671;

    @OriginalMember(owner = "client!CYFJILLF", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!CYFJILLF", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!CYFJILLF", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!CYFJILLF", name = "a", descriptor = "(LEILHLJCE;B)V")
