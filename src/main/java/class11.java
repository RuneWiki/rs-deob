...
public class class11 extends class349 {
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IC)Z", line = 16)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(BI)[I", line = 27)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IILdga;)V", line = 110)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "()V", line = 137)
    public class11() {
        super(0, true);
    }
}
