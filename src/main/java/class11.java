...
public class class11 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lfp;IIZLdf;Ltq;ILfp;ZIIZ)Lae;", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BI)Lca;", line = 73)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)V", line = 148)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZB)V", line = 178)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IILfp;ILtq;III)Lae;", line = 226)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(BI)V", line = 266)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "([SB)[S", line = 281)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(B)V", line = 301)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lhj;IZLct;Lct;)V", line = 346)
