...
public class class11 extends class17 implements Runnable {
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "m", descriptor = "LURASIGRB;")
    private class58 field666 = new class58(41824);

    @OriginalMember(owner = "client!ELICEBAH", name = "n", descriptor = "LURASIGRB;")
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "s", descriptor = "LODYOEFFK;")
    private class39 field672 = new class39(889);

    @OriginalMember(owner = "client!ELICEBAH", name = "u", descriptor = "LURASIGRB;")
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "z", descriptor = "LURASIGRB;")
    private class58 field679 = new class58(41824);

    @OriginalMember(owner = "client!ELICEBAH", name = "I", descriptor = "LURASIGRB;")
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "A", descriptor = "LVVUONHHF;")
    private class63 field680;

    @OriginalMember(owner = "client!ELICEBAH", name = "R", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "a", descriptor = "(ILVVUONHHF;)V")
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "a", descriptor = "(LRVLWVPJQ;Lclient;)V")
    ...
    @OriginalMember(owner = "client!ELICEBAH", name = "b", descriptor = "()LVVUONHHF;")
