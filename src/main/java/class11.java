...
public class class11 extends class402 {
    ...
    @OriginalMember(owner = "client!sja", name = "b", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!sja", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(IIIIIBIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(IBLfha;)V", line = 85)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!sja", name = "c", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(III)V", line = 184)
    ...
    @OriginalMember(owner = "client!sja", name = "<init>", descriptor = "(Lpc;)V", line = 195)
    ...
    @OriginalMember(owner = "client!sja", name = "c", descriptor = "(IZ)V", line = 223)
