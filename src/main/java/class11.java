...
public class class11 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILqr;IB)V", line = 118)
