...
public class class11 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(B)V", line = 56)
