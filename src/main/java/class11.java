...
public class class11 implements Runnable {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILst;I)Llf;", line = 3)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lst;II)Llf;", line = 18)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!vl", name = "run", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILlf;)V", line = 121)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II[BLst;)Llf;", line = 136)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IBI)Z", line = 165)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II)V", line = 213)
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(I)Z", line = 249)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Let;)V", line = 278)
