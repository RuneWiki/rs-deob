...
public class class11 extends class425 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "([I)Lbg;", line = 11)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "([B)V", line = 72)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Ltj;)Z", line = 116)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "()I", line = 133)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)[F", line = 141)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(I)F", line = 556)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "([B)V", line = 568)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "()V", line = 723)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Ltj;II)Lkh;", line = 741)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(I)I", line = 765)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "([BI)V", line = 795)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "([B)V", line = 803)
