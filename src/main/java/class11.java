...
public class class11 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(JB)Ljava/lang/Object;", line = 83)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)I", line = 125)
    public final int method79(int arg0) {
        field174++;
        return arg0 < 28 ? 29 : this.field178;
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)V", line = 142)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lqt;B)V", line = 190)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 231)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(JI)V", line = 262)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Z)I", line = 297)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)I", line = 308)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljo;I)V", line = 338)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(JILjava/lang/Object;)V", line = 357)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IBLjava/lang/Object;J)V", line = 370)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(B)V", line = 399)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(I)V", line = 421)
    ...
    @OriginalMember(owner = "client!ad", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 436)
