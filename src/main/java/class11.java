...
public class class11 {
    ...
    @OriginalMember(owner = "client!DKRLEWQI", name = "e", descriptor = "[LOZVKRYKO;")
    ...
    @OriginalMember(owner = "client!DKRLEWQI", name = "a", descriptor = "(J)LOZVKRYKO;")
    ...
    @OriginalMember(owner = "client!DKRLEWQI", name = "a", descriptor = "(IJLOZVKRYKO;)V")
