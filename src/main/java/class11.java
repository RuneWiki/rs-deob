...
public class class11 extends class220 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILsn;IIBILro;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IBLil;)V", line = 55)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(II)[I", line = 133)
    ...
    @OriginalMember(owner = "client!bh", name = "d", descriptor = "(II)I", line = 156)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "()V", line = 167)
    public class11() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(II)[[I", line = 171)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljava/lang/String;Lud;BI)Lor;", line = 232)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I[[I)V", line = 309)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(IIII)V", line = 363)
    ...
    @OriginalMember(owner = "client!bh", name = "f", descriptor = "(B)V", line = 379)
