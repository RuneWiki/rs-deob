...
public class class11 extends class260 {
    ...
    @OriginalMember(owner = "client!sja", name = "<init>", descriptor = "(ILgn;)V")
    public class11(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(III)Z")
    ...
    @OriginalMember(owner = "client!sja", name = "<init>", descriptor = "(Lgn;)V")
