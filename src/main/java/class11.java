...
public class class11 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lza;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lza;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lza;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Lza;IZLjava/awt/Component;)V")
