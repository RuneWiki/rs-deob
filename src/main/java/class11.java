...
public abstract class class11 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ya", name = "b", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(III)V", line = 69)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(FFZF)I", line = 85)
