...
public abstract class class11 extends class140 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(IIIIIII)V", line = 58)
