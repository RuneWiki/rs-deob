...
public class class11 {
    ...
    @OriginalMember(owner = "client!FXNZCBPL", name = "o", descriptor = "LZPNSJLZE;")
    ...
    @OriginalMember(owner = "client!FXNZCBPL", name = "g", descriptor = "LPNPNYEVW;")
    public class42 field702;

    @OriginalMember(owner = "client!FXNZCBPL", name = "c", descriptor = "[LFXNZCBPL;")
    public static class11[] field698;

    @OriginalMember(owner = "client!FXNZCBPL", name = "a", descriptor = "(ILINOFEYKQ;)V")
    ...
    @OriginalMember(owner = "client!FXNZCBPL", name = "a", descriptor = "(ZLNHEPCMLW;)V")
    ...
    @OriginalMember(owner = "client!FXNZCBPL", name = "a", descriptor = "()LCSGBDGDY;")
