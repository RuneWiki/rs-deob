...
public class class11 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILjc;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(I)V", line = 343)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILjc;)V", line = 363)
