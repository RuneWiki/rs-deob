...
public class class11 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)Llha;")
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(B)Llha;")
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Ltp;B)V")
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lsc;)V")
