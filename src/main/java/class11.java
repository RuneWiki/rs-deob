...
public class class11 {
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(ILec;)I")
    ...
    @OriginalMember(owner = "client!sja", name = "a", descriptor = "(IB)Lvh;")
    ...
    @OriginalMember(owner = "client!sja", name = "<init>", descriptor = "(Lto;ILla;)V")
