...
public class class11 {
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Z)V", line = 50)
