...
public class class11 extends class279 implements class407 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIIILiq;)V", line = 33)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ZIIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Z)J", line = 334)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I[BII)V", line = 349)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II)I", line = 362)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(B)I", line = 462)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(Los;I[BI)V", line = 472)
    public class11(class468 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field105 = arg1;
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "([FIIIIIFFIIIIF)V", line = 481)
