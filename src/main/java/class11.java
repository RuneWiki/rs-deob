...
public abstract class class11 extends class307 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "()I", line = 19)
    public final int method85() {
        return this.field181;
    }

    @OriginalMember(owner = "client!vl", name = "d", descriptor = "()I", line = 37)
    public final int method87() {
        return this.field167 + this.field156 + this.field159;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(FFFFFFIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(FFFFFFLfs;II)V", line = 139)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(IIIIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "()I", line = 207)
    public final int method93() {
        return this.field167;
    }

    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(Llg;II)V", line = 216)
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "()I", line = 223)
    public final int method94() {
        return this.field181 + this.field161 + this.field164;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(FFFFFF)V", line = 231)
