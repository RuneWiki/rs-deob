...
public class class11 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IIZBIIIII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IIIIIIZII)Z", line = 59)
