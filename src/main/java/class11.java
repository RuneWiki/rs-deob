...
public class class11 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BLrg;)V")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(II)Ljr;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)Lfc;")
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ILrg;I)V")
