...
public class class11 extends class627 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(II)V", line = 73)
    public class11(int arg0, int arg1) {
        this.field127 = arg0;
        this.field122 = arg1;
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)V", line = 83)
