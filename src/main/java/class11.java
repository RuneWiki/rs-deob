...
public class class11 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ILeg;IBILqa;Lo;IIZIILo;I)Lka;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IZILo;ILeg;Lqa;IILo;III)Lka;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lnj;B)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIILqa;ILeg;)Lka;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lqa;IIIILeg;B)Lka;")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BLnj;I)V")
