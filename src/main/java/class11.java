...
public class class11 extends class80 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)Lhs;", line = 7)
    public final class295 method52(int arg0) {
        field213++;
        return arg0 == -14151 ? class389.field5463 : null;
    }

    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lfw;Ldg;IIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IBIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(B)V", line = 78)
