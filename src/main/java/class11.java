...
public class class11 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)I", line = 11)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(III)V", line = 27)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 36)
    ...
    @OriginalMember(owner = "client!kh", name = "b", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IB)V", line = 83)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IC)Z", line = 138)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(IIIIB)V", line = 164)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lkh;I)V", line = 178)
