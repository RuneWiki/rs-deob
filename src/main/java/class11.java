...
public class class11 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II)I", line = 105)
