...
public class class11 {
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(II)Ldaa;")
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BLdb;II)V")
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(IILbaa;)V")
