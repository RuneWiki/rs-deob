...
public class class11 extends class460 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IILtj;)V", line = 23)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IIB)V", line = 44)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "([BB)[B", line = 103)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Ljaa;Ldk;)V", line = 143)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(I)Z", line = 187)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IIILpd;IIIIBIILtl;)V", line = 199)
