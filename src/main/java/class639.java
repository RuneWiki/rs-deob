...
public class class639 extends class184 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II[[ZIB)V", line = 203)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IS)V", line = 265)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(I)V", line = 287)
    public static void method3672(int arg0) {
        field8976 = null;
        int var1 = -90 % ((67 - arg0) / 49);
    }

    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)[I", line = 301)
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lwu;Llw;Lraa;[I)V", line = 311)
