...
public class class639 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IC)C", line = 7)
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(B)V", line = 407)
    ...
    @OriginalMember(owner = "client!lea", name = "b", descriptor = "(B)V", line = 418)
