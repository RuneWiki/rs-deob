...
public class class639 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I[Lf;)V", line = 19)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Ltf;Ltf;Ltf;Ltf;Z)V", line = 47)
