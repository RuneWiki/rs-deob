...
public class class639 {
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "([Ljava/lang/Object;[JZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(II)V", line = 27)
    ...
    @OriginalMember(owner = "client!nca", name = "a", descriptor = "(Z)V", line = 60)
