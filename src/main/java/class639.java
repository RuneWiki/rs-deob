...
public class class639 extends class134 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZII)V", line = 28)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(ILkda;)V", line = 75)
    public class639(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!av", name = "b", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lkda;)V", line = 92)
    public class639(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BI)I", line = 95)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lgg;IIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)V", line = 243)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(B)V", line = 255)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(II)I", line = 273)
