...
public class class639 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIIJ)V", line = 4)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IIII)I", line = 49)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZI)V", line = 75)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(III)Lvg;", line = 175)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BI)Loi;", line = 222)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 268)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lhea;Lfa;)V", line = 281)
