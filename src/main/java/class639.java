...
public class class639 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)V", line = 206)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lha;IIIILiba;ILre;Lcl;)V", line = 219)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIZ)V", line = 272)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(III)I", line = 349)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIILha;III)V", line = 368)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIII)V", line = 382)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "()V", line = 397)
    protected class639() {
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lha;Lofa;I)V", line = 407)
