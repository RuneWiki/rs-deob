...
public class class639 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B[B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(II)Lgk;")
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lwj;ILwu;)V")
