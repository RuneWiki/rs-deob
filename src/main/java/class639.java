...
public class class639 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "([BI[BIII)I", line = 27)
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(III[BI[B)I", line = 173)
    ...
    @OriginalMember(owner = "client!wda", name = "b", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "([B)V", line = 269)
