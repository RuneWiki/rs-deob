...
public class class639 extends class314 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ldw;B)V")
    ...
    @OriginalMember(owner = "client!bw", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BLie;I)V")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lpba;B)V")
