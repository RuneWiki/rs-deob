...
public class class639 extends class454 {
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(II)Lnk;", line = 17)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIBI)Z", line = 37)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Lhc;)V", line = 60)
