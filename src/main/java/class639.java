...
public abstract class class639 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)Z", line = 32)
