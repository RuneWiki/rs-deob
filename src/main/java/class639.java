...
public class class639 extends class69 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Llr;[III)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Llr;II)V")
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Llr;[IIIIIZ)V")
