...
public class class639 implements class753 {
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Lkia;II)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILdka;II)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(IIILkia;)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(Ldka;IIBI)V")
    ...
    @OriginalMember(owner = "client!lea", name = "a", descriptor = "(ILad;I)V")
    ...
    @OriginalMember(owner = "client!lea", name = "<init>", descriptor = "(Lvf;)V")
