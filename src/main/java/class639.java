...
public class class639 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIZLw;)Z")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IBILw;)V")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lw;III)V")
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Ltu;Lha;)V")
