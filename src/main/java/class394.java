...
public class class394 extends class438 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!ii", name = "f", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(BLvd;IIII)Lwq;", line = 100)
    ...
    @OriginalMember(owner = "client!ii", name = "e", descriptor = "(I)Z", line = 120)
    ...
    @OriginalMember(owner = "client!ii", name = "c", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Lrb;Ljava/lang/Object;I)V", line = 143)
