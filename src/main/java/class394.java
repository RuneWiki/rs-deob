...
public class class394 extends class634 {
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(BI)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILig;Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!wj", name = "d", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(BI)[I", line = 130)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIII)I", line = 180)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "()V", line = 206)
    public class394() {
        super(3, false);
    }
}
