...
public class class394 extends class102 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I[ILhs;III)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BILhs;)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "()Laf;")
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "()Laf;")
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lhb;)V")
