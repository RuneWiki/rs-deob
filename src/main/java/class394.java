...
public class class394 {
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)Lqh;", line = 36)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "([IIILpq;IIIZ)Liq;", line = 99)
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Ljk;ILae;)V", line = 127)
