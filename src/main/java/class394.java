...
public class class394 extends class430 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILip;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(ILhda;IZ)V", line = 85)
