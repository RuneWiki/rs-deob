...
public abstract class class394 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(II)I", line = 4)
    public static int method2529(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lnb;Ldh;)V", line = 32)
