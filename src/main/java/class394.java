...
public class class394 extends class627 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Ljava/awt/Canvas;Ld;II)Lha;", line = 3)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lkha;IIIIJZI)V", line = 83)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "()V", line = 105)
    public class394() {
    }

    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(I)V", line = 107)
