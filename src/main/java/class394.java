...
public class class394 extends class297 {
    ...
    @OriginalMember(owner = "client!ps", name = "d", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ps", name = "e", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IC)C", line = 114)
