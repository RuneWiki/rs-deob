...
public class class394 extends class557 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Ltn;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BLdt;)V", line = 63)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(Z)V", line = 81)
