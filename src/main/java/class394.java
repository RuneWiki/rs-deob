...
public abstract class class394 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!qu", name = "d", descriptor = "(I)Z", line = 62)
