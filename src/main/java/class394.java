...
public class class394 extends class145 {
    ...
    @OriginalMember(owner = "client!pj", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 17)
    public class394() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)[I", line = 42)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BIIIILoa;IIIII)Z", line = 112)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lap;BI)V", line = 473)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(II)Lsk;", line = 516)
