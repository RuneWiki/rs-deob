...
public class class394 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lwm;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lwm;[II)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lwm;[II[I[I)V")
