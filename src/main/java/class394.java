...
public abstract class class394 extends class200 {
    ...
    @OriginalMember(owner = "client!wm", name = "e", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(III)Liq;", line = 24)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Lue;I)V", line = 40)
