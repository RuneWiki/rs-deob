...
public class class394 extends class1 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(IIIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIZBII)V", line = 78)
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(III)V", line = 141)
