...
public class class394 extends class112 {
    ...
    @OriginalMember(owner = "client!mea", name = "h", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lqj;Ljava/lang/Object;I)V", line = 15)
    public class394(class572 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5463 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 24)
