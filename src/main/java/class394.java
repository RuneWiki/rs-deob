...
public class class394 extends class10 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Lr;IIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(II[I[I)V", line = 184)
    public class394(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field5791 = arg3;
        this.field5792 = arg2;
    }

    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IB)V", line = 200)
