...
public class class394 extends class154 {
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 16)
    public class394(String arg0) {
        this.field5443 = arg0;
    }
}
