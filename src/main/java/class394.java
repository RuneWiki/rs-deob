...
public class class394 extends class224 {
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lmo;ILmo;Lmo;)V", line = 30)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IB)C", line = 78)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(III)V", line = 115)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(BLjava/lang/String;)V", line = 126)
