...
public class class394 extends class325 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Loh;Lqp;IIIILwn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(III)Z", line = 95)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Lvj;II[BI)V", line = 120)
    ...
    @OriginalMember(owner = "client!ffa", name = "f", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 149)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IZ)V", line = 199)
