...
public abstract class class394 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljava/lang/String;ZZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILgda;ZIIILn;ILua;Lla;Ljava/lang/String;)V", line = 84)
