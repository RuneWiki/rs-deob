...
public class class394 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)Ldba;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lwea;III)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lee;)V")
    public class394(class706 arg0) {
        this.field5812 = arg0;
    }

    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(I)Ldba;")
