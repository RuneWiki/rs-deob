...
public class class394 extends class184 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILvk;Ljava/awt/Frame;)V", line = 4)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Loea;Lqr;)V", line = 56)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IZ)V", line = 148)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(I)I", line = 169)
    public static final int method2447(int arg0) {
        ++field5512;
        return ~class435.field6079 == arg0 ? class584.field8240 : class198.field2843;
    }

    @OriginalMember(owner = "client!mt", name = "c", descriptor = "(I)Llda;", line = 180)
    ...
    @OriginalMember(owner = "client!mt", name = "d", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Liia;ZI)V", line = 204)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Z)V", line = 216)
