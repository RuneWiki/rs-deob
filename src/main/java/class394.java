...
public class class394 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I[Lep;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)Z", line = 99)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ZI)V", line = 113)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(IIIIIIIIII)V", line = 141)
    ...
    @OriginalMember(owner = "client!rba", name = "c", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!rba", name = "<init>", descriptor = "(Z)V", line = 197)
