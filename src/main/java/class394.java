...
public class class394 extends class193 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZZ)V", line = 93)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(B)[Lni;", line = 128)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lsq;II)V", line = 186)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIB)Z", line = 199)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(ZZ)V", line = 215)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILta;)V", line = 226)
    public static final void method2268(int arg0, class143 arg1) {
        class520.field7520[arg0] = arg1;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)Z", line = 230)
    public final boolean method93(boolean arg0) {
        ++field5294;
        return !arg0;
    }

    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lug;Lpl;)V", line = 241)
