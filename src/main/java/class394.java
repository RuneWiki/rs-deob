...
public class class394 extends class739 {
    ...
    @OriginalMember(owner = "client!fu", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 16)
    public class394() {
        super(3, false);
    }

    @OriginalMember(owner = "client!fu", name = "a", descriptor = "([BIZI)I", line = 21)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BI)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(II)V", line = 101)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(BI)I", line = 115)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lsl;II)V", line = 129)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)[I", line = 168)
    ...
    @OriginalMember(owner = "client!fu", name = "e", descriptor = "(I)V", line = 236)
