...
public class class394 extends class204 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Ldga;I)Lafa;", line = 31)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(IILfca;)I", line = 119)
    ...
    @OriginalMember(owner = "client!ti", name = "c", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 163)
