...
public class class394 implements class472 {
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(II)Ltg;")
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(BI)Lsm;")
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lgp;Lgp;Lgp;)V")
