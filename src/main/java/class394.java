...
public class class394 extends class145 {
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "()V", line = 3)
    public class394() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZI)[I", line = 16)
    ...
    @OriginalMember(owner = "client!sl", name = "i", descriptor = "(I)V", line = 70)
    public static void method2535(int arg0) {
        int var1 = -53 % ((arg0 - 12) / 54);
        field6025 = null;
    }

    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IILrt;)V", line = 85)
