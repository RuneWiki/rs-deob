...
public class class394 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(III)I", line = 83)
