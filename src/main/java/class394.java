...
public class class394 extends class130 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILfi;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lfh;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)V", line = 80)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I[III)V", line = 94)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(III)Z", line = 119)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIB)Z", line = 135)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I[III)V", line = 150)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZII)Z", line = 163)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lum;BLum;)I", line = 186)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(IIIIIIIII)V", line = 226)
