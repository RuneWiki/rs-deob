...
public class class394 extends class243 {
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BLha;)V", line = 20)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ILji;B)V", line = 48)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(II)[I", line = 119)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "()V", line = 261)
    public class394() {
        super(0, true);
    }

    @OriginalMember(owner = "client!lp", name = "d", descriptor = "(B)V", line = 276)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZIIIIII)V", line = 287)
