...
public class class394 extends class170 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILrg;)V", line = 25)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(II)Ljava/lang/String;", line = 45)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BI)I", line = 70)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BILrg;)V", line = 97)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 151)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ZI)Z", line = 181)
    ...
    @OriginalMember(owner = "client!o", name = "f", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!o", name = "g", descriptor = "(I)V", line = 231)
