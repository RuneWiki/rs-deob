...
public class class394 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "([BB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IB)V", line = 33)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIBII)V", line = 45)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "()V", line = 86)
    public static final void method2352() {
        class54.method424(1, class109.field1542);
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lfc;Lfc;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(CI)Z", line = 104)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lfc;B)V", line = 133)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(IB)Llq;", line = 146)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)V", line = 178)
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(IB)I", line = 207)
    ...
    @OriginalMember(owner = "client!u", name = "c", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "(Ldk;ILfc;)V", line = 239)
