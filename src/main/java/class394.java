...
public abstract class class394 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILph;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([ZIILph;IILph;ZLph;ILph;IIIZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II[II[IIIZII)V", line = 115)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILph;Lph;IIII[IZII)V", line = 214)
    ...
    @OriginalMember(owner = "client!mj", name = "e", descriptor = "(I)Ljava/lang/String;", line = 250)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILph;ZIBLph;III)V", line = 297)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lij;IIIIII)V", line = 340)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IZ[ZIZIILbm;[ILwb;ILbm;)V", line = 418)
    ...
    @OriginalMember(owner = "client!mj", name = "h", descriptor = "(I)V", line = 617)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "([[B[[B[BI[I[IIB)I", line = 638)
