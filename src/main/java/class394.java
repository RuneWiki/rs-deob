...
public class class394 extends class190 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lih;IIII)V")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILqa;)Llb;")
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BLqa;)Led;")
