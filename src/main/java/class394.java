...
public class class394 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILsp;)V")
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(B)Lsp;")
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(I)Lsp;")
