...
public class class126 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)I", line = 13)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([BI)[B", line = 31)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZI)I", line = 117)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(II)Z", line = 131)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)V", line = 152)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(II)V", line = 163)
