...
public class class126 implements Runnable {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BLaca;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Llda;BJILjava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)J", line = 52)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z)Z", line = 64)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(B)Llda;", line = 90)
    ...
    @OriginalMember(owner = "client!jl", name = "d", descriptor = "(B)Ljava/lang/String;", line = 101)
    ...
    @OriginalMember(owner = "client!jl", name = "c", descriptor = "(I)I", line = 115)
    ...
    @OriginalMember(owner = "client!jl", name = "run", descriptor = "()V", line = 146)
    ...
    @OriginalMember(owner = "client!jl", name = "e", descriptor = "(B)I", line = 237)
