...
public class class126 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(II)Lpv;", line = 3)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "()V", line = 59)
    public static final void method1063() {
        class545.field7511 = class545.field7513;
    }

    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lsj;ILin;)V", line = 66)
