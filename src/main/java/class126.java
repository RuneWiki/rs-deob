...
public class class126 implements class338 {
    ...
    @OriginalMember(owner = "client!ls", name = "b", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZI)V", line = 61)
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!ls", name = "c", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Ljo;Lkc;)V", line = 126)
