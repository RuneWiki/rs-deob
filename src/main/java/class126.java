...
public class class126 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lbi;IIIIILfp;IIII)Lbi;", line = 11)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(B)V", line = 67)
