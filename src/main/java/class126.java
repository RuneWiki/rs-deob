...
public class class126 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)I", line = 78)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILjava/lang/String;)I", line = 110)
    ...
    @OriginalMember(owner = "client!jj", name = "toString", descriptor = "()Ljava/lang/String;", line = 121)
