...
public class class126 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIILqa;BLn;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILbk;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)Lbk;")
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)Lbk;")
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)Lbk;")
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(I)Lbk;")
