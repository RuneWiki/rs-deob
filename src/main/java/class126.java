...
public abstract class class126 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILjava/lang/String;IIIZJZLjava/lang/String;IZ)V", line = 48)
