...
public class class126 extends class139 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lkea;)V", line = 65)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 184)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(BILgl;)V", line = 289)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)Z", line = 302)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)V", line = 313)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(I)V", line = 331)
