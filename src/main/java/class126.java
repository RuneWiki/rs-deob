...
public class class126 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(B)Lvn;", line = 9)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)Z", line = 70)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)V", line = 98)
    public static void method874(byte arg0) {
        int var1 = -40 / ((-arg0 - 57) / 50);
        field1721 = null;
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lre;BI)V", line = 109)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)Lvn;", line = 199)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)Z", line = 272)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lre;I)V", line = 299)
