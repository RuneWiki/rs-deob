...
public class class126 extends class284 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(B)Lfi;", line = 21)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;Z)I", line = 31)
    ...
    @OriginalMember(owner = "client!uc", name = "h", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!uc", name = "g", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(B)Z", line = 120)
    ...
    @OriginalMember(owner = "client!uc", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 131)
    ...
    @OriginalMember(owner = "client!uc", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 158)
    ...
    @OriginalMember(owner = "client!uc", name = "d", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!uc", name = "i", descriptor = "(I)I", line = 206)
    ...
    @OriginalMember(owner = "client!uc", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 223)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method801(5733, arg0.getX(), arg0.getY());
        field1712++;
    }

    @OriginalMember(owner = "client!uc", name = "f", descriptor = "(I)Z", line = 231)
    ...
    @OriginalMember(owner = "client!uc", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 242)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 253)
    ...
    @OriginalMember(owner = "client!uc", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 267)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method801(5733, arg0.getX(), arg0.getY());
        field1724++;
    }

    @OriginalMember(owner = "client!uc", name = "j", descriptor = "(I)V", line = 283)
    ...
    @OriginalMember(owner = "client!uc", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 295)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method801(5733, arg0.getX(), arg0.getY());
        field1730++;
    }

    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ZII)Lbi;", line = 306)
    ...
    @OriginalMember(owner = "client!uc", name = "e", descriptor = "(I)Z", line = 323)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IIIII)V", line = 335)
    ...
    @OriginalMember(owner = "client!uc", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 358)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method801(5733, arg0.getX(), arg0.getY());
        field1726++;
    }

    @OriginalMember(owner = "client!uc", name = "k", descriptor = "(I)V", line = 367)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 408)
