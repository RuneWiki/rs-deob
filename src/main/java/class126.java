...
public class class126 extends class279 {
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lpj;)V")
    public class126(class38 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BILpe;)V")
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IZLiu;)V")
