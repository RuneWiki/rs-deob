...
public class class126 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BI)Ldr;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lnj;Z)Lph;")
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Liv;ILuu;)V")
    public class126(class65 arg0, int arg1, class191 arg2) {
        this.field1708 = arg2;
        this.field1708.method1290(false, 26);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lwj;IIIIIZ)V")
