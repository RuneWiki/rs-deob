...
public class class126 extends class406 {
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)Lof;", line = 17)
    public class475 method473(int arg0) {
        field1641++;
        return arg0 == 6 ? class86.field1037 : null;
    }

    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lada;Loe;IIIIIIIIIIIII)V", line = 46)
