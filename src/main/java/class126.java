...
public class class126 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(Lfca;I)V")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ILfca;I)V")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZLfca;)Lla;")
