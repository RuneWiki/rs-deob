...
public class class126 extends class245 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IB)V", line = 3)
    public void method887(int arg0, byte arg1) {
        this.field1630[arg0] = arg1;
        field1631++;
    }

    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!nk", name = "d", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIIIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ZZBII)Lir;", line = 177)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(Z)V", line = 204)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BII)V", line = 217)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(IIIIIFFF)V", line = 254)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILir;ZLir;)V", line = 271)
