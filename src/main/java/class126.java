...
public class class126 extends class389 {
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III)V", line = 28)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(Z)V", line = 41)
