...
public class class126 extends class197 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIFLfo;Z)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Loh;I)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(BLoh;)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lqq;B)V")
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(Loh;I)V")
