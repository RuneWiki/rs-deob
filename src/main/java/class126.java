...
public abstract class class126 extends class260 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(B)I", line = 125)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "()V", line = 138)
    public static final void method870() {
        class472.method2780(1, class253.field3523);
    }

    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!kk", name = "d", descriptor = "(B)I", line = 162)
    public int method874(byte arg0) {
        field1878++;
        return arg0 == 80 ? 0 : -43;
    }

    @OriginalMember(owner = "client!kk", name = "e", descriptor = "(I)Z", line = 179)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lef;)V", line = 190)
    public class126(class338 arg0) {
        this.field1881 = arg0;
    }

    @OriginalMember(owner = "client!kk", name = "f", descriptor = "(I)Z", line = 199)
