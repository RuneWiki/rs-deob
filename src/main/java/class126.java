...
public class class126 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "([I[I[I[[F)V", line = 73)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lha;Lnga;B)I", line = 84)
