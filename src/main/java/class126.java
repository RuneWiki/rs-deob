...
public class class126 extends class301 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 52)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Lck;Lwo;)V", line = 80)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lwj;II)V", line = 100)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIIZI)V", line = 122)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(IZ)V", line = 162)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IZ)V", line = 173)
