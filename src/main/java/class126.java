...
public class class126 extends class225 implements class722 {
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(Lha;B)Liha;")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(IZLha;)Lka;")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;I)Lua;")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(BZILha;)Lcn;")
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lha;Lts;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Lha;B)V")
