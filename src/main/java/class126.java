...
public class class126 extends class290 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!hc", name = "d", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(IIIIIF)V", line = 76)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(IZB)V", line = 106)
