...
public abstract class class126 extends class215 {
    ...
    @OriginalMember(owner = "client!fea", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(Z)Z", line = 22)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IBI[B)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(I[Lrc;)I", line = 77)
    ...
    @OriginalMember(owner = "client!fea", name = "j", descriptor = "(I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!fea", name = "k", descriptor = "(I)Z", line = 100)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IZLr;Lrga;IIZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(IIIIIII)V", line = 123)
