...
public class class126 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ILf;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ZLkf;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lkf;B)V")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)Lva;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(Lre;Z)V")
