...
public class class126 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lnr;ILkb;Llo;)V", line = 43)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lil;Lud;IB)V", line = 202)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BI)Z", line = 317)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 381)
