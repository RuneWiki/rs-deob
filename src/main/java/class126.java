...
public class class126 extends class253 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BLie;I)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)I", line = 31)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(II)V", line = 119)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(Z)V", line = 174)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "([IIIIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 301)
