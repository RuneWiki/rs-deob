...
public class class126 extends class525 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(CB)I", line = 4)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lwn;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ILwn;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(IB)I", line = 121)
    public static final int method935(int arg0, byte arg1) {
        field1978++;
        return arg1 == 86 ? arg0 & 0x7F : 78;
    }

    @OriginalMember(owner = "client!ov", name = "d", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(ZLsw;ZZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!ov", name = "e", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IC)I", line = 239)
