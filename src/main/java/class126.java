...
public class class126 extends class89 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lga;IIDZBZLqn;)[I", line = 4)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lqn;BLga;)Z", line = 142)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILya;)V", line = 194)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IZILqn;ILga;)[F", line = 297)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 410)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILga;IDLqn;ZI)[I", line = 436)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I[Lhd;IIZI)V", line = 580)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 632)
    public class126() {
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lfh;)V", line = 649)
