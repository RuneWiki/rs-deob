...
public class class126 extends class13 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lkh;BI)V", line = 32)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "()V", line = 158)
    public class126() {
        super(0, false);
    }

    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(IILuo;Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!tg", name = "c", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)V", line = 162)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lms;B)V", line = 172)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!tg", name = "e", descriptor = "(B)V", line = 198)
