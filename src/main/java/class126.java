...
public class class126 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([[ILaa;II[[BLsm;Lsm;ZII[[B[[B[[B)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Laa;III)V")
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
