...
public class class222 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/String;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILha;)V", line = 85)
