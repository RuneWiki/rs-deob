...
public class class222 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILos;I)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Los;B)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IILkj;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIIILqa;I)Lr;")
