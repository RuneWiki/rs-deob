...
public class class222 {
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qs", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!qs", name = "d", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II)Lh;", line = 81)
    ...
    @OriginalMember(owner = "client!qs", name = "<init>", descriptor = "(Ldk;ILfc;Lfc;)V", line = 136)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IB)V", line = 113)
