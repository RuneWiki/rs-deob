...
public class class222 extends class60 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(Lhd;)V", line = 27)
    public class222(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(ILhd;)V", line = 30)
    public class222(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Z)I", line = 38)
    ...
    @OriginalMember(owner = "client!uga", name = "c", descriptor = "(B)Z", line = 49)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(II)I", line = 86)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(B)V", line = 107)
