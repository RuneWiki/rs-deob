...
public class class222 extends class139 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BILgl;)V")
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lkea;Ltca;)V")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ILpfa;I)Ljv;")
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/String;ZZILqj;)V")
