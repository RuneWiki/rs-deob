...
public class class222 extends class96 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lwk;III)J", line = 18)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "()V", line = 53)
    public class222() {
        super(1, true);
    }

    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(II)[I", line = 57)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIZ)V", line = 111)
    ...
    @OriginalMember(owner = "client!rv", name = "g", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IILbt;)V", line = 195)
    ...
    @OriginalMember(owner = "client!rv", name = "h", descriptor = "(I)V", line = 217)
