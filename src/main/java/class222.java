...
public class class222 extends class446 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILnq;Lja;ZII)[F", line = 4)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZLnq;IZIDLja;)[I", line = 309)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(I)V", line = 445)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ZILnq;DLja;BIZ)[I", line = 471)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lja;Lnq;I)Z", line = 609)
    ...
    @OriginalMember(owner = "client!pp", name = "e", descriptor = "(B)V", line = 664)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILuo;IILhh;III)V", line = 767)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "()V", line = 849)
    public class222() {
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lkh;)V", line = 865)
