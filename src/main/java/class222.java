...
public class class222 extends class198 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILlm;)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ZLol;)V")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IZLof;)V")
