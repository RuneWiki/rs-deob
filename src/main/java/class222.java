...
public class class222 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIILna;)V", line = 9)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lnh;Z)Z", line = 16)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 43)
