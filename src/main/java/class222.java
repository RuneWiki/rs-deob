...
public class class222 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(J[IILef;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZI)Luc;")
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(ILbu;Lbu;Lim;)V")
