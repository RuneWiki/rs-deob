...
public class class222 implements class134 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(III)Lcq;")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IBLft;II)V")
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ljn;Lsea;)V")
