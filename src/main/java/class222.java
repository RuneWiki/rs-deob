...
public class class222 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IIILr;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Lr;BI)Z")
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(I[Lvs;IIII)V")
