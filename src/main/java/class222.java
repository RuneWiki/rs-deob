...
public class class222 extends class418 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lsca;[I)V")
    ...
    @OriginalMember(owner = "client!bda", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Lpq;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IILgea;I)V")
    ...
    @OriginalMember(owner = "client!bda", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!bda", name = "CA", descriptor = "(Lr;IIIIZ)V")
