...
public class class222 {
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lvm;II)V", line = 560)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([BB)V", line = 67)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "([BIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(JZ)V", line = 291)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(II[BI)V", line = 310)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(I)Ljava/io/File;", line = 436)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BI)I", line = 451)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Z)V", line = 465)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(Z)J", line = 543)
