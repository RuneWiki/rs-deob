...
public class class222 extends class346 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I[[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(II)[[I", line = 55)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lfb;ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "()V", line = 194)
    public class222() {
        super(0, true);
    }

    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 199)
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(B)V", line = 215)
    public static void method1453(byte arg0) {
        field3064 = null;
        int var1 = -65 % ((arg0 - -4) / 61);
    }

    @OriginalMember(owner = "client!re", name = "b", descriptor = "(II)[I", line = 231)
