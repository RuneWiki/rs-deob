...
public class class222 extends class210 {
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 14)
    public class222() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IB)[I", line = 38)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IILat;)V", line = 137)
