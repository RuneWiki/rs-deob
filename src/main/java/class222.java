...
public abstract class class222 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BI)V", line = 55)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IBIIIIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIII)I", line = 109)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IZIIIIIIII)V", line = 157)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(III)V", line = 201)
