...
public abstract class class222 extends class444 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILjava/lang/String;)I", line = 5)
    ...
    @OriginalMember(owner = "client!bb", name = "f", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IBI)Z", line = 54)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lou;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(Z)Lnv;", line = 97)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILa;IIILqa;Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 128)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIIILqa;BLvr;IIIIIILka;)Lka;", line = 144)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Z)Z", line = 363)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(Z)V", line = 379)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/lang/String;Lnq;IB)Lpb;", line = 391)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(IIIIIII)V", line = 432)
