...
public class class222 implements class450 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!rha", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!rha", name = "<init>", descriptor = "(Lvd;Lhba;)V", line = 78)
    public class222(class39 arg0, class10 arg1) {
        this.field3266 = arg0;
        this.field3263 = arg1;
    }

    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(I)Z", line = 87)
