...
public class class222 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILkf;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(ILkf;)Z")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZI)Lbs;")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lih;)V")
