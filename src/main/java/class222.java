...
public class class222 extends class296 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(FI)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(IIIIIF)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(BIII)V")
