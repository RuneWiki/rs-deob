...
public class class222 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIZZI)I")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZI)Lrha;")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lsaa;ILfp;)V")
