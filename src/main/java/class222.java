...
public class class222 extends class425 {
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 155)
    public class222(String arg0) {
        this.field3184 = arg0;
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IIIIBFZII)[[I", line = 119)
