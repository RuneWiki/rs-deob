...
public class class222 extends class98 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILdg;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIBLjava/lang/String;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(II)[I", line = 172)
    ...
    @OriginalMember(owner = "client!br", name = "f", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "()V", line = 289)
    public class222() {
        super(1, true);
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(BI)V", line = 305)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 320)
    ...
    @OriginalMember(owner = "client!br", name = "e", descriptor = "(I)V", line = 331)
