...
public class class222 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(B[BII)Ljava/lang/String;", line = 21)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(III)Llf;", line = 76)
