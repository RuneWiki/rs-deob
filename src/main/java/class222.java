...
public class class222 extends class151 {
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(III)Lat;")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(III)Loa;")
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lza;BLdk;)V")
