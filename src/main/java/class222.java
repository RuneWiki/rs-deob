...
public class class222 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILa;)V", line = 24)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(II)V", line = 57)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(II)Lgt;", line = 91)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Llf;ILvh;)V", line = 122)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 144)
