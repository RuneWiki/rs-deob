...
public class class222 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!er", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field2912++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 29)
