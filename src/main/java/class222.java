...
public class class222 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 48)
