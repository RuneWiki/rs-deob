...
public class class222 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZLvg;)Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II)I", line = 95)
