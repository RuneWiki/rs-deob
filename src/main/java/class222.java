...
public class class222 extends class325 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Ln;Lvc;B)V")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILvc;B)Ln;")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZILvc;IILuq;I)V")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZLfo;Z)V")
