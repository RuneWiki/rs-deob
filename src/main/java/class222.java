...
public class class222 extends class694 {
    ...
    @OriginalMember(owner = "client!dea", name = "d", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!dea", name = "<init>", descriptor = "()V", line = 25)
    public class222() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dea", name = "e", descriptor = "(III)Z", line = 29)
    ...
    @OriginalMember(owner = "client!dea", name = "g", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!dea", name = "f", descriptor = "(III)Z", line = 69)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILjr;B)V", line = 108)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(II)[I", line = 193)
