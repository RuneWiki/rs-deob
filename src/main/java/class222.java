...
public class class222 extends class283 {
    ...
    @OriginalMember(owner = "client!nj", name = "d", descriptor = "()Lcd;")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lwaa;I[IIII)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(BLe;Ljava/awt/Canvas;I)Loa;")
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "()Lcd;")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lwaa;IB)V")
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lco;)V")
