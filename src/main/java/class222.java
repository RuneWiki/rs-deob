...
public abstract class class222 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)V", line = 32)
    public static void method1481(int arg0) {
        field3468 = null;
        int var1 = -40 / ((-arg0 - 41) / 52);
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lke;Lak;)V", line = 41)
