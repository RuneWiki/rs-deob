...
public abstract class class222 implements class238 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(B)I", line = 44)
    public final int method1481(byte arg0) {
        field3330++;
        return arg0 == 98 ? this.field3328 : 101;
    }

    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 118)
    ...
    @OriginalMember(owner = "client!aba", name = "finalize", descriptor = "()V", line = 144)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Ljj;IIIZ)V", line = 239)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lnu;", line = 157)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(BZ)V", line = 221)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(I)V", line = 256)
