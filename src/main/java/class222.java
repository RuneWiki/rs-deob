...
public class class222 extends class411 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIZLwl;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lug;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILug;)Lug;")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIIII[[ZLwl;[I[I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILwl;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(Lug;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lvn;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(Lug;IIIIZ)V")
    public final void method1516(class325 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(IIIIIII[[ZLwl;[I[I)V")
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field3064[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field881; ++var23) {
                            ...
                            } else if (var21.field875 != null && var21.field875[var23] != -1) {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lj;[I)V")
