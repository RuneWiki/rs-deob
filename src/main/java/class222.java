...
public class class222 extends class214 {
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "()V", line = 29)
    public class222() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILofa;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ki", name = "f", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IB)[I", line = 134)
