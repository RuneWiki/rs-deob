...
public abstract class class222 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Llt;I)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lhf;ILha;I)V")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lbl;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lbl;ILjaggl/memory/NativeBuffer;IZ)V")
