...
public class class222 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(CI)V", line = 10)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Llf;I)V", line = 22)
    public class222(class250 arg0, int arg1) {
        this.field2873 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZI)I", line = 36)
    public static final int method1414(boolean arg0, int arg1) {
        field2876++;
        return arg0 ? arg1 & 0xFF : -85;
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(II)Laka;", line = 74)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ILha;ZZ)Lma;", line = 113)
