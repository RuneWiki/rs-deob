...
public class class570 extends class657 {
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZI)V", line = 47)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IIZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lffa;Lbb;)V", line = 151)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IBLhs;)V", line = 164)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IBLmw;)V", line = 206)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(B)V", line = 216)
