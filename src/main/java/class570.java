...
public class class570 extends class66 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "([IIILid;)Lwv;", line = 10)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Leq;I)V", line = 187)
    public class570(class357 arg0, int arg1) {
        this.field7949 = arg0;
        this.field7943 = new class45(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ip", name = "d", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(I)Lgv;", line = 207)
    ...
    @OriginalMember(owner = "client!ip", name = "e", descriptor = "(I)I", line = 218)
    public final int method3206(int arg0) {
        field7947++;
        return arg0 <= 65 ? 77 : this.field7943.field670;
    }

    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BLgaa;ILha;I)V", line = 229)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(FLgv;BLgv;)Z", line = 542)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Ljava/awt/Color;ILjava/lang/String;Ljava/awt/Color;Ljava/awt/Color;B)V", line = 744)
