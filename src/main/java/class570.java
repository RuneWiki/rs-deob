...
public class class570 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lr;ZII)Lvl;", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lie;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lie;Z)V", line = 114)
