...
public class class570 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(II)Lwv;")
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "(I)Lefa;")
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BLoa;IZ)Llu;")
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Luea;ILpq;)V")
