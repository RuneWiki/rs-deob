...
public class class570 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZILjp;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "([Ljava/lang/Object;II[JI)V", line = 32)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 104)
    public static void method3194(int arg0) {
        int var1 = 127 % ((48 - arg0) / 52);
        field7586 = null;
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BI)V", line = 114)
