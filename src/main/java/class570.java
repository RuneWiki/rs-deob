...
public class class570 extends class607 {
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!mj", name = "e", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(B)Z", line = 210)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)V", line = 224)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZB)V", line = 244)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IBLiu;)V", line = 275)
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(B)V", line = 288)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(III)V", line = 314)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Ltu;)V", line = 338)
    public class570(class294 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILkea;II)Ldj;", line = 341)
