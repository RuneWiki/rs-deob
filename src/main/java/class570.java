...
public class class570 implements class547 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(I)V", line = 18)
    public class570(int arg0) {
        this.field7975 = arg0;
    }

    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(I)Lwea;", line = 38)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III)Z", line = 50)
