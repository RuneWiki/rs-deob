...
public class class570 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIIIIIIIILsn;)Z", line = 41)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BZ)V", line = 397)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)V", line = 481)
