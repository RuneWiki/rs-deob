...
public class class570 extends class474 {
    ...
    @OriginalMember(owner = "client!cv", name = "b", descriptor = "(B)Lnc;", line = 4)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(Lwh;IIIIII)V", line = 87)
