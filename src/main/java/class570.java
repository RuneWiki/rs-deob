...
public class class570 extends class606 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BLag;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IZIIZ)V")
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lma;II)V")
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Lsr;)V")
