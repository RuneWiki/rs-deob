...
public abstract class class570 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLmc;)Laea;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lpu;I)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BII[III)Lpu;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IZILd;IILwm;Ljava/awt/Canvas;)Lha;")
