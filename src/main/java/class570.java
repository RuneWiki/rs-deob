...
public class class570 extends Callback {
    ...
    @OriginalMember(owner = "client!oca", name = "callback", descriptor = "(IIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(ZILjava/awt/Component;)V", line = 59)
