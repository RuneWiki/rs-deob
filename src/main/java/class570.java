...
public class class570 extends class513 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Ljava/lang/String;ZB)V", line = 35)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I)I", line = 108)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IIB)Z", line = 124)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IIIZILwu;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(II)V", line = 158)
