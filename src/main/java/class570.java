...
public class class570 extends class483 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ZIILjava/awt/Graphics;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 28)
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 49)
