...
public class class570 extends class159 {
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(B)Lwg;", line = 3)
    ...
    @OriginalMember(owner = "client!paa", name = "e", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Len;IIIIII)V", line = 94)
