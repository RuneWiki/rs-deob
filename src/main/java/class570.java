...
public class class570 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)[Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 57)
    ...
    @OriginalMember(owner = "client!md", name = "toString", descriptor = "()Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(II)I", line = 99)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(II)V", line = 127)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILjava/lang/String;)V", line = 139)
    public final void method3299(int arg0, String arg1) {
        this.method3296(arg1, this.field7825 + arg0, (byte) -119);
        field7820++;
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(IZ)V", line = 278)
