...
public class class570 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIZLpe;ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lkr;I)Ln;", line = 33)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)Lbs;", line = 86)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lpe;Lpe;)V", line = 102)
