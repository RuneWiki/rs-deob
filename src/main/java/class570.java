...
public class class570 {
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(B)Loca;", line = 6)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Loca;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(I)V", line = 67)
    public class570(int arg0) {
        this.field8326 = arg0;
    }

    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "(IIIIII)V", line = 74)
