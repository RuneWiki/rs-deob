...
public class class570 extends class349 {
    ...
    @OriginalMember(owner = "client!kia", name = "d", descriptor = "()V", line = 3)
    public final void method2236() {
        field8217.method1331(this.field8218, super.field5159);
    }

    @OriginalMember(owner = "client!kia", name = "a", descriptor = "()V", line = 7)
    public final void method2223() {
        field8217.method1332(2, this.field8218);
    }

    @OriginalMember(owner = "client!kia", name = "b", descriptor = "()I", line = 10)
    public final int method2233() {
        return field8217.method1329(256, this.field8218);
    }

    @OriginalMember(owner = "client!kia", name = "e", descriptor = "()V", line = 13)
    public static void method3392() {
        field8217 = null;
    }

    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 16)
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lhga;I)V", line = 19)
    public class570(class300 arg0, int arg1) {
        field8217 = (class371) arg0.method1865(true);
        this.field8218 = arg1;
    }

    @OriginalMember(owner = "client!kia", name = "c", descriptor = "()V", line = 24)
    public final void method2234() {
        field8217.method1334(-21944, this.field8218);
    }

    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(I)V", line = 27)
