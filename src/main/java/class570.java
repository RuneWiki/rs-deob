...
public class class570 {
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(IIJIILgga;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Z)I", line = 39)
    ...
    @OriginalMember(owner = "client!sv", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field7916++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(II)V", line = 59)
