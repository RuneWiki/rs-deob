...
public class class570 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lgda;BI)Lkaa;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lat;B)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(B)Lac;")
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(B)Lac;")
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lat;)V")
