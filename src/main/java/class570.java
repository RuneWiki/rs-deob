...
public class class570 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)Lsg;", line = 5)
    ...
    @OriginalMember(owner = "client!lj", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field7569++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(IIII)V", line = 49)
