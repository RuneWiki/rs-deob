...
public class class570 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)I", line = 12)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(FB)F", line = 30)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)V", line = 56)
