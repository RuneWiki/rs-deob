...
public class class161 extends class398 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(III)Le;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lri;III[Z)Z")
