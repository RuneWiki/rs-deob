...
public class class161 {
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(I)Lra;")
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "(I)Lra;")
    ...
    @OriginalMember(owner = "client!p", name = "e", descriptor = "(I)Lra;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BLra;)V")
