...
public class class161 extends class277 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!un", name = "d", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILbfa;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IZ)V", line = 878)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(IZ)V", line = 889)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(B)Z", line = 908)
    ...
    @OriginalMember(owner = "client!un", name = "e", descriptor = "(B)V", line = 920)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)V", line = 934)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILrg;)V", line = 960)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lqj;)V", line = 992)
