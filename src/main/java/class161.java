...
public class class161 extends class417 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(BS)V", line = 207)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I[[ZBII)V", line = 226)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(Lte;Lsb;Lnm;[I)V", line = 283)
    ...
    @OriginalMember(owner = "client!ov", name = "c", descriptor = "(II)V", line = 505)
