...
public class class161 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lfa;II)V", line = 163)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "()V", line = 172)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;)V", line = 183)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)Lqba;", line = 193)
    public static final class369 method1209(int arg0) {
        return (class369) field2610.method2818(-22803, (long) arg0);
    }

    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIIIIIII)V", line = 196)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;Lek;IIII[I[I)V", line = 208)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "()V", line = 342)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "([B[B[SII)V", line = 372)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)V", line = 515)
    public static final void method1214(int arg0) {
        field2607 = (class369) field2610.method2818(-22803, (long) arg0);
    }

    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;IIIIIII[S[BZ)V", line = 519)
    ...
    @OriginalMember(owner = "client!waa", name = "d", descriptor = "()V", line = 681)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lfa;III)I", line = 703)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;Lfu;IIII)V", line = 760)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;II)V", line = 765)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;IIII)Lau;", line = 945)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(II)Lqba;", line = 959)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(Lr;IIII)V", line = 972)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(II)Lgd;", line = 1316)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lr;IIII[S[B)V", line = 1333)
    ...
    @OriginalMember(owner = "client!waa", name = "e", descriptor = "()V", line = 1391)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(Lr;)Lau;", line = 1405)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(Lvo;Lud;Lus;Lrw;Lgda;Lok;Lof;)V", line = 1416)
