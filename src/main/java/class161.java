...
public class class161 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IBILmv;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lgk;Lm;)V")
    public class161(class463 arg0, class79 arg1) {
        this.field2096 = arg1;
        this.field2098 = arg0;
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BI)Lsr;")
