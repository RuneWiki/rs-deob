...
public class class161 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZLfg;Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)V", line = 337)
