...
public class class161 extends class601 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(ILgn;)V", line = 17)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(II)I", line = 32)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(B)I", line = 43)
    public final int method39(byte arg0) {
        ++field1795;
        return arg0 != -17 ? -19 : 1;
    }

    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lgn;)V", line = 170)
    public class161(class699 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IZ)V", line = 174)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ljava/lang/String;[BIB)I", line = 198)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(II)Z", line = 246)
