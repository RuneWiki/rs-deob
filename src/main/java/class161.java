...
public class class161 extends class263 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III)I", line = 83)
