...
public class class161 extends class496 implements class47 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lvo;Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II[I[I)Lea;", line = 37)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIII)V", line = 39)
    public final void method1039(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!h", name = "u", descriptor = "()Z", line = 42)
    public final boolean method1040() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "ZA", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lvo;)V", line = 50)
    ...
    @OriginalMember(owner = "client!h", name = "f", descriptor = "()Z", line = 54)
    public final boolean method1043() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I)V", line = 60)
    public final void method1045(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lc;Lvo;Lia;Lmn;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 86)
    ...
    @OriginalMember(owner = "client!h", name = "j", descriptor = "()Z", line = 99)
    public final boolean method1052() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "s", descriptor = "()Z", line = 108)
    public final boolean method1056() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIILea;II)V", line = 111)
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "()V", line = 115)
    public final void method1058() {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II[[I[[IIII)Lna;", line = 118)
    ...
    @OriginalMember(owner = "client!h", name = "D", descriptor = "()Lma;", line = 123)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lia;[Lmn;I)V", line = 139)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "()Z", line = 161)
    public final boolean method1065() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "z", descriptor = "()V", line = 163)
    public final void method1066() {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Z)V", line = 165)
    public final void method1067(boolean arg0) {
    }

    @OriginalMember(owner = "client!h", name = "i", descriptor = "()Z", line = 170)
    public final boolean method1070() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIF)Ldd;", line = 173)
    ...
    @OriginalMember(owner = "client!h", name = "f", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(IIIIII)V", line = 192)
    ...
    @OriginalMember(owner = "client!h", name = "C", descriptor = "()V", line = 197)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lro;IIII)Lc;", line = 213)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;Lhu;)V", line = 217)
    ...
    @OriginalMember(owner = "client!h", name = "l", descriptor = "()Z", line = 259)
    public final boolean method1077() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Lc;Lvo;Lia;[Lmn;I)V", line = 262)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lmc;Lmc;FLmc;)Lmc;", line = 306)
    public final class242 method1081(class242 arg0, class242 arg1, float arg2, class242 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 309)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 327)
    ...
    @OriginalMember(owner = "client!h", name = "k", descriptor = "()I", line = 337)
    public final int method1084() {
        return 4;
    }

    @OriginalMember(owner = "client!h", name = "c", descriptor = "()V", line = 339)
    public final void method1085() {
    }

    @OriginalMember(owner = "client!h", name = "p", descriptor = "()Lia;", line = 344)
    public final class23 method1088() {
        return this.field2338;
    }

    @OriginalMember(owner = "client!h", name = "r", descriptor = "()Z", line = 347)
    public final boolean method1089() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 351)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 375)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "()Lia;", line = 418)
    public final class23 method1092() {
        return new class521();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lmc;)V", line = 420)
    public final void method1093(class242 arg0) {
    }

    @OriginalMember(owner = "client!h", name = "h", descriptor = "()Z", line = 423)
    public final boolean method1094() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lse;[Lrl;Z)Loa;", line = 426)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "([IIIII)Lf;", line = 436)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIIIIIII)V", line = 472)
    public final void method1098(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!h", name = "B", descriptor = "()V", line = 477)
    ...
    @OriginalMember(owner = "client!h", name = "e", descriptor = "(I)V", line = 501)
    public final void method1105(int arg0) {
        this.field2341[arg0].method2700();
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I[Ldd;)V", line = 505)
    ...
    @OriginalMember(owner = "client!h", name = "o", descriptor = "()Z", line = 526)
    public final boolean method1109() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "A", descriptor = "()Ljava/lang/Object;", line = 533)
    private final Object method1113() {
        return new class155();
    }

    @OriginalMember(owner = "client!h", name = "c", descriptor = "(Z)V", line = 535)
    public final void method1114(boolean arg0) {
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lrl;Z)Lf;", line = 541)
    ...
    @OriginalMember(owner = "client!h", name = "i", descriptor = "(I)V", line = 618)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(FFF)V", line = 633)
    public final void method1120(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!h", name = "x", descriptor = "()V", line = 635)
    public final void method1121() {
    }

    @OriginalMember(owner = "client!h", name = "finalize", descriptor = "()V", line = 641)
    protected final void finalize() {
        this.method218();
    }

    @OriginalMember(owner = "client!h", name = "y", descriptor = "()Z", line = 644)
    public final boolean method1124() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIII)V", line = 648)
    ...
    @OriginalMember(owner = "client!h", name = "MA", descriptor = "(S)Z", line = 656)
    ...
    @OriginalMember(owner = "client!h", name = "c", descriptor = "(I)Ll;", line = 681)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)I", line = 686)
    public final int method1130(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!h", name = "g", descriptor = "(I)V", line = 689)
    public final void method1131(int arg0) {
        this.field2341[arg0].method2684();
    }

    @OriginalMember(owner = "client!h", name = "t", descriptor = "()Z", line = 693)
    public final boolean method1132() {
        return false;
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ll;)V", line = 696)
    public final void method1133(class195 arg0) {
        this.field2321 = (class79) arg0;
        this.method1036(arg0);
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(IIIIZ)Lf;", line = 700)
    ...
    @OriginalMember(owner = "client!h", name = "v", descriptor = "()Z", line = 712)
    public final boolean method1138() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "b", descriptor = "(IIIIII)Lmc;", line = 716)
    public final class242 method1140(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!h", name = "b", descriptor = "(II)I", line = 725)
    ...
    @OriginalMember(owner = "client!h", name = "EA", descriptor = "(S)Z", line = 731)
    ...
    @OriginalMember(owner = "client!h", name = "m", descriptor = "()V", line = 743)
    public final void method1143() {
    }

    @OriginalMember(owner = "client!h", name = "b", descriptor = "(Z)V", line = 745)
    public final void method1144(boolean arg0) {
    }

    @OriginalMember(owner = "client!h", name = "q", descriptor = "()Z", line = 750)
    public final boolean method1145() {
        return true;
    }

    @OriginalMember(owner = "client!h", name = "n", descriptor = "()Z", line = 761)
