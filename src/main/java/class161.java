...
public class class161 extends class644 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lnp;)Lql;", line = 7)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
