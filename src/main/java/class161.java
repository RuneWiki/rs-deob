...
public class class161 extends class60 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(ILhd;)V", line = 19)
    public class161(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;)V", line = 22)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIBI)V", line = 63)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(II)I", line = 88)
    public final int method406(int arg0, int arg1) {
        ++field1984;
        return arg0 != 0 ? 27 : 3;
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lhd;)V", line = 100)
    public class161(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Z)I", line = 114)
    ...
    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(B)V", line = 134)
