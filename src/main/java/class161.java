...
public abstract class class161 extends class180 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IIII[[[BIIIBIIILkm;)V", line = 29)
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BC)B", line = 85)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZI)I", line = 218)
    public static final int method979(boolean arg0, int arg1) {
        field2312++;
        return arg0 ? arg1 >> 11 & 0x7F : 11;
    }

    @OriginalMember(owner = "client!wc", name = "f", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZC)C", line = 265)
