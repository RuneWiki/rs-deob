...
public class class161 extends class171 {
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(FIIZLsa;)V", line = 137)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIIIZIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lsk;B)V", line = 208)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(BLsk;)V", line = 224)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLsk;)V", line = 243)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)V", line = 260)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(ILqa;)V", line = 270)
    ...
    @OriginalMember(owner = "client!ro", name = "c", descriptor = "(B)V", line = 378)
