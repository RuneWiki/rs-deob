...
public class class161 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IBIIIILya;II)V", line = 8)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IB)I", line = 148)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BLgf;)Z", line = 171)
