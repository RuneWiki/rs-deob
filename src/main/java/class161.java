...
public class class161 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lqfa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILqfa;Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZILqfa;Lkd;)V", line = 398)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBI)Z", line = 567)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBLqfa;)V", line = 579)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lqfa;Z)V", line = 600)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BLqfa;)V", line = 635)
