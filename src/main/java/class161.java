...
public class class161 extends class147 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IZILbg;)Ldf;")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IILja;)V")
