...
public class class161 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(III)I", line = 30)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II)V", line = 68)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ZB)V", line = 126)
