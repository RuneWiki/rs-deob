...
public class class161 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B[BLco;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(B)J", line = 36)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lbi;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BII)Z", line = 81)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "(III)V", line = 111)
