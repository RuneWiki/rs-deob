...
public class class161 extends class69 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ILjava/lang/String;)Z")
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Llba;Laga;Lsca;[I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
