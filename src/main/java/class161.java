...
public class class161 extends class179 {
    ...
    @OriginalMember(owner = "client!tf", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IBIIIIZFI)[[I", line = 32)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ZC)I", line = 64)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BILec;)V", line = 88)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lqa;I)Z", line = 155)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lec;Z)V", line = 186)
    ...
    @OriginalMember(owner = "client!tf", name = "e", descriptor = "(B)V", line = 207)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 221)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IC)I", line = 248)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ldp;BLdp;)V", line = 274)
