...
public class class161 extends class397 {
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBLae;)V", line = 50)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "()V", line = 99)
    public class161() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pd", name = "e", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(II)[I", line = 121)
