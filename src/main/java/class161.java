...
public abstract class class161 extends class476 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Li;III[Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "([[[Lwr;I)V", line = 49)
