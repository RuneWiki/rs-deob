...
public class class161 implements class7 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILsn;)V", line = 11)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILnb;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILtr;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "()V", line = 112)
    public final void method50() {
        this.field1931.field3342.glBindFramebufferEXT(36160, 0);
    }

    @OriginalMember(owner = "client!js", name = "b", descriptor = "()I", line = 115)
    public final int method49() {
        return this.field1935;
    }

    @OriginalMember(owner = "client!js", name = "finalize", descriptor = "()V", line = 122)
    protected final void finalize() throws Throwable {
        this.field1931.method1414(this.field1930);
        super.finalize();
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILnb;I)V", line = 128)
    public final void method781(int arg0, class359 arg1, int arg2) {
        this.method776(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Lic;)V", line = 134)
