...
public class class161 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I[B)[B", line = 5)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)Lwn;", line = 73)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ZI)I", line = 115)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "([SI)[S", line = 133)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)I", line = 203)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(II)V", line = 217)
