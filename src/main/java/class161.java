...
public class class161 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lft;[[BZ)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILhd;II)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lrd;IIILtf;)V")
