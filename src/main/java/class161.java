...
public class class161 extends class317 {
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "()Lbk;")
    public final class317 method925() {
        return (class317) this.field1973.method716(14);
    }

    @OriginalMember(owner = "client!ov", name = "c", descriptor = "()Lbk;")
    public final class317 method926() {
        return (class317) this.field1973.method719(false);
    }

    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Luj;Lww;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lww;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Lbk;)V")
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(Lbk;)V")
