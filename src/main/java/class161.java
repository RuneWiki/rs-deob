...
public class class161 extends class142 implements class444 {
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 4)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(Lmba;Lpw;III[B)V", line = 28)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lgv;I)V", line = 101)
