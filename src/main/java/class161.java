...
public class class161 extends class337 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(II[IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "()V", line = 203)
