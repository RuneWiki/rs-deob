...
public class class161 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Lir;Lir;Lqj;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([IZI)V", line = 63)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 95)
