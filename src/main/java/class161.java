...
public class class161 extends class544 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIB[[Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IS)V", line = 77)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIII)Z", line = 93)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lbda;Lml;Lcba;[I)V", line = 362)
