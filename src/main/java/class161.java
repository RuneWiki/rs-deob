...
public class class161 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lkm;II)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lcv;")
