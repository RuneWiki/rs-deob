...
public class class161 {
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lcu;I)Lq;", line = 35)
    ...
    @OriginalMember(owner = "client!nj", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IBI)V", line = 81)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(II)Lth;", line = 96)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Loq;ILbu;Lbu;)V", line = 149)
