...
public class class161 extends class342 {
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 6)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lgo;Ljava/lang/Object;I)V", line = 17)
    public class161(class451 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field2383 = arg1;
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Lsq;IIIII)V", line = 67)
