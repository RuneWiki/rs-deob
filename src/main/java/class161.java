...
public class class161 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B[[[Lak;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(II)I", line = 75)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)V", line = 91)
