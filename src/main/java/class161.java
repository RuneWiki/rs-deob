...
public class class161 extends class530 {
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)I", line = 37)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(ILah;)V", line = 53)
    public class161(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lah;)V", line = 67)
    public class161(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZI)V", line = 104)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 121)
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "(I)V", line = 152)
