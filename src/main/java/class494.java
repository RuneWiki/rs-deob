...
public class class494 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILtl;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lqa;Lqv;IIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZII)I", line = 189)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZZ)Z", line = 211)
    public static boolean method2940(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Ltl;BI)V", line = 228)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)I", line = 469)
