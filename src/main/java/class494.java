...
public class class494 extends class99 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 14)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field7221 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 22)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)I", line = 35)
