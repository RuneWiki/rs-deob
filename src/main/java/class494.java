...
public class class494 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BI)Lfn;")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lci;ILhe;)V")
