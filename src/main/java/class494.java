...
public class class494 extends class4 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "([BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ldc;I)V", line = 71)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)I", line = 92)
    public static final int method2990(int arg0, int arg1) {
        return class680.field9452 == null ? 0 : class680.field9452[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IBLdc;)V", line = 95)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(CLjava/lang/String;I)[Ljava/lang/String;", line = 141)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BILjava/lang/String;)Ljava/lang/String;", line = 173)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(III)I", line = 192)
