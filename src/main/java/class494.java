...
public class class494 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(II)Lhi;", line = 12)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(II)Lgea;", line = 115)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZI)V", line = 174)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IIFIIIFF)[F", line = 191)
    ...
    @OriginalMember(owner = "client!qi", name = "<init>", descriptor = "(Lcda;ILkea;Lkea;Lkea;)V", line = 276)
