...
public class class494 extends class583 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Lkba;III)V", line = 15)
    ...
    @OriginalMember(owner = "client!iaa", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(II)Z", line = 198)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(ZI)Z", line = 211)
    ...
    @OriginalMember(owner = "client!iaa", name = "b", descriptor = "(III)V", line = 223)
    ...
    @OriginalMember(owner = "client!iaa", name = "d", descriptor = "(I)Lnu;", line = 241)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(I)V", line = 282)
