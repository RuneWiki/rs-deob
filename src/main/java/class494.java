...
public class class494 extends class41 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Loga;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZLes;)Lro;", line = 92)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILes;)V", line = 104)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(III)Z", line = 119)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lbn;Z)V", line = 140)
