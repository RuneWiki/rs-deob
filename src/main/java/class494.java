...
public class class494 extends class372 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(III)Lpl;", line = 4)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!bw", name = "e", descriptor = "(II)V", line = 125)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lmm;Z)V", line = 143)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BI)Z", line = 171)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILmm;)V", line = 181)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 201)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)V", line = 228)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILnw;)V", line = 239)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IB)V", line = 410)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II)V", line = 435)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lci;III)Lch;", line = 488)
    ...
    @OriginalMember(owner = "client!bw", name = "f", descriptor = "(II)Z", line = 506)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)V", line = 517)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(BLmm;)V", line = 543)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lo;ZFII)V", line = 569)
