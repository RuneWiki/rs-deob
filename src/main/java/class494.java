...
public class class494 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Lvj;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IILvj;)V", line = 28)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZBI)V", line = 125)
    ...
    @OriginalMember(owner = "client!iga", name = "b", descriptor = "(I)V", line = 152)
