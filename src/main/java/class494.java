...
public class class494 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lnn;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILnn;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 106)
