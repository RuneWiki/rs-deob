...
public class class494 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IZLqa;I)Lf;", line = 5)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIIII)Lmd;", line = 49)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIC)I", line = 71)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lti;I)V", line = 91)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(I)Z", line = 142)
    public final boolean method2949(int arg0) {
        field7195++;
        return arg0 == 0 ? this.field7207.field4002.method682(0, this.field7198) : false;
    }

    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILti;I)V", line = 154)
