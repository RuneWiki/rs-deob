...
public class class494 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IZII)I", line = 3)
    ...
    @OriginalMember(owner = "client!ku", name = "finalize", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Los;II)V", line = 65)
    public class494(class468 arg0, int arg1, int arg2) {
        this.field7452 = arg2;
        this.field7455 = arg0;
    }

    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILwca;I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "([Ljava/lang/String;B[S)V", line = 111)
