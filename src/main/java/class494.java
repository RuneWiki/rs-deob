...
public class class494 extends class263 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "([I)Lft;")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lpfa;II)Lhl;")
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lpfa;)Z")
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lpfa;I)Lhl;")
