...
public abstract class class494 extends class404 {
    ...
    @OriginalMember(owner = "client!jb", name = "h", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(B)Z", line = 44)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!jb", name = "e", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BII)Z", line = 89)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 160)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lbf;I)I", line = 179)
    ...
    @OriginalMember(owner = "client!jb", name = "d", descriptor = "(Z)V", line = 202)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "([Lab;I)I", line = 217)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILua;)I", line = 389)
