...
public class class494 extends class325 {
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ljp;IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(III)Z", line = 43)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "()V", line = 171)
    public class494() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(BI)[I", line = 79)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(BLjava/lang/String;)V", line = 160)
