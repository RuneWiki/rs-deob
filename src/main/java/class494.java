...
public class class494 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Lat;BLat;IZ)Lbd;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BILat;Lat;)Lbd;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lql;Lmv;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
