...
public class class494 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fj", name = "c", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 264)
    private class494() {
    }

    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "([I)V", line = 266)
