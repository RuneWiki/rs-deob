...
public class class494 extends class551 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(FI[FIIBFFIIF)V", line = 17)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(I)V", line = 129)
