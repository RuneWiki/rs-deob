...
public class class494 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;B)V")
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
