...
public class class494 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lwea;Lwea;II)Lgu;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILwea;Lwea;ZI)Lgu;")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Ldm;Lhe;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
