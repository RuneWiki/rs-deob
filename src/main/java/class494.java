...
public class class494 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILgo;IB)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILgk;I)V")
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lgk;I)V")
