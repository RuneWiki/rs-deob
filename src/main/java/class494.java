...
public class class494 extends class546 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "h", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Lrr;)V", line = 25)
    public class494(class332 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(III)V", line = 40)
    ...
    @OriginalMember(owner = "client!tp", name = "f", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZII)Z", line = 62)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZI)V", line = 76)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZLpca;)V", line = 86)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZLwq;)V", line = 122)
