...
public class class494 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(JB)Ljava/lang/Object;", line = 18)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BLvfa;)V", line = 104)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(I)V", line = 123)
    public class494(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!aq", name = "c", descriptor = "(I)Leq;", line = 128)
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 170)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)V", line = 200)
    ...
    @OriginalMember(owner = "client!aq", name = "e", descriptor = "(I)I", line = 249)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IJLjava/lang/Object;)V", line = 262)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILjava/lang/Object;IJ)V", line = 274)
    ...
    @OriginalMember(owner = "client!aq", name = "f", descriptor = "(I)I", line = 316)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(B)V", line = 330)
    ...
    @OriginalMember(owner = "client!aq", name = "g", descriptor = "(I)V", line = 357)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 460)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(JZ)V", line = 491)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(II)V", line = 510)
