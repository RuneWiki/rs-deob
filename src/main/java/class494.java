...
public class class494 extends class35 implements class21 {
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(Lza;B)Lkf;", line = 4)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IZLjava/lang/String;I)I", line = 45)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(I)Z", line = 123)
    public final boolean method113(int arg0) {
        ++field6972;
        return arg0 != 31692 ? false : this.field6993.method654((byte) 105);
    }

    @OriginalMember(owner = "client!bw", name = "e", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!bw", name = "d", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 158)
    ...
    @OriginalMember(owner = "client!bw", name = "c", descriptor = "(I)I", line = 169)
    public final int method114(int arg0) {
        ++field6975;
        return arg0 != -9772 ? -47 : this.field6993.field1154;
    }

    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILza;)V", line = 183)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ILza;I)Le;", line = 194)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)I", line = 207)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lza;B)V", line = 218)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Lza;I)V", line = 237)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IILza;I)Z", line = 266)
    ...
    @OriginalMember(owner = "client!bw", name = "b", descriptor = "(B)Z", line = 290)
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lza;Lfu;IIIIIZII)V", line = 301)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(I)I", line = 311)
    ...
    @OriginalMember(owner = "client!bw", name = "g", descriptor = "(I)V", line = 321)
