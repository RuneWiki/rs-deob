...
public class class494 extends class350 implements class142 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "([ILq;)V", line = 9)
    private final void method2844(int[] arg0, class389 arg1) {
        this.field7156.method364().method3420(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lmr;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(BIZ)Lba;", line = 32)
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()[Ldg;", line = 37)
    public final class375[] method886() {
        return this.field7157;
    }

    @OriginalMember(owner = "client!j", name = "finalize", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(IILq;Z)Z", line = 53)
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()[Lhaa;", line = 56)
    public final class73[] method882() {
        return this.field7155;
    }

    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lmr;II)V", line = 67)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lba;IIIZ)V", line = 83)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;)V", line = 88)
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()Z", line = 148)
    public final boolean method898() {
        return true;
    }

    @OriginalMember(owner = "client!j", name = "b", descriptor = "()V", line = 150)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lqda;IIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;)V", line = 230)
