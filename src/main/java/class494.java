...
public class class494 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IB)I", line = 11)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(I)V", line = 205)
    public class494(int arg0) {
        this.field7228 = arg0;
    }

    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(IIIIII)V", line = 212)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)Lno;", line = 25)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 36)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 53)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(Ljava/lang/String;B)I", line = 169)
    public static final int method2962(String arg0, byte arg1) {
        field7229++;
        return arg1 >= -73 ? 80 : arg0.length() + 1;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILno;)V", line = 188)
