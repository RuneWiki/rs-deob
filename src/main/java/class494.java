...
public class class494 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IB)Lhf;")
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IIIIIII)Lpa;")
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Lgn;ILvo;)V")
