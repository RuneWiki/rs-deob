...
public class class494 extends class42 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(II)I", line = 3)
    public static int method2839(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIB)Z", line = 29)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "()V", line = 43)
    public class494() {
    }

    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 46)
