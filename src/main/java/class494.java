...
public class class494 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BLud;I)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lud;B)V")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ZLak;[II)V")
