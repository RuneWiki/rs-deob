...
public class class494 extends class92 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILqv;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZB)V", line = 17)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lnd;)V", line = 60)
    ...
    @OriginalMember(owner = "client!ku", name = "e", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)Z", line = 191)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZI)V", line = 205)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILqa;II)V", line = 266)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIZ)Z", line = 745)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ZII)V", line = 758)
