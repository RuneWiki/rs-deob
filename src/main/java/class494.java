...
public class class494 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!via", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Ljc;II)V", line = 82)
