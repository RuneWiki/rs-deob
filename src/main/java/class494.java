...
public class class494 extends class48 implements class373 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(II[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "([[[Lgn;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Lji;ILjaclib/memory/Buffer;IZ)V", line = 117)
    public class494(class622 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field6530 = arg1;
    }

    @OriginalMember(owner = "client!rfa", name = "b", descriptor = "(I)J", line = 126)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "(Lji;I[BIZ)V", line = 138)
    public class494(class622 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field6530 = arg1;
    }

    @OriginalMember(owner = "client!rfa", name = "d", descriptor = "(I)V", line = 146)
