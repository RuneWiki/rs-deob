...
public class class494 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lrv;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(IBLrv;)V", line = 32)
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(I)V", line = 48)
