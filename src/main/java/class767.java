...
public class class767 extends class540 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 190)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BB)V", line = 289)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "([[ZIIII)V", line = 331)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IS)V", line = 387)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lkv;Lwr;Ljw;[I)V", line = 409)
