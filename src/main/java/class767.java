...
public class class767 implements Runnable {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(B[BII)I", line = 33)
    ...
    @OriginalMember(owner = "client!sia", name = "run", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 225)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(B)V", line = 151)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Lfca;I)Lne;", line = 194)
    ...
    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(I)V", line = 214)
