...
public class class767 extends class232 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "()V", line = 352)
    public class767() {
        super(0, true);
    }

    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "([III)V", line = 59)
    ...
    @OriginalMember(owner = "client!eja", name = "d", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ILwq;I)V", line = 228)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(ILjava/awt/Component;)Lwi;", line = 331)
    ...
    @OriginalMember(owner = "client!eja", name = "b", descriptor = "(B)V", line = 355)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IIIIIZI)I", line = 397)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(IIII)I", line = 477)
