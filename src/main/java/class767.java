...
public class class767 extends class231 implements class784 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loo;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loo;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILoo;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILoo;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lfba;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILoo;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loo;Lea;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Loo;Lea;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lao;IIII)V")
