...
public class class767 extends class233 implements class784 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILdm;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldm;Let;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldm;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "()[Lpi;")
    public final class335[] method590() {
        return this.field10599;
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILdm;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldm;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILdm;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "()[Lgfa;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldm;Let;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lida;IIII)V")
