...
public class class767 implements class421 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(I)Lpj;")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lsd;Lpj;Z)V")
