...
public class class767 extends class234 implements class69 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lko;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lus;IZ[[I)V")
