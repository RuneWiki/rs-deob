...
public abstract class class649 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Ld;ILjava/awt/Canvas;II)Lha;", line = 3)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(Lhs;)V", line = 40)
    public class649(class358 arg0) {
        this.field9224 = arg0;
        this.field9223 = this.method135(50);
    }

    @OriginalMember(owner = "client!sga", name = "<init>", descriptor = "(ILhs;)V", line = 48)
