...
public class class649 extends class54 {
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(ILhia;)V", line = 5)
    public class649(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!paa", name = "d", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Ljava/lang/String;ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(IB)I", line = 163)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(Z)I", line = 181)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(Z)I", line = 209)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lhia;)V", line = 220)
