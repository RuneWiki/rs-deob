...
public class class649 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(DB)V", line = 25)
    ...
    @OriginalMember(owner = "client!pl", name = "finalize", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lfha;JI)V", line = 51)
