...
public class class649 extends class557 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IILha;)Leb;", line = 32)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BLdt;)V", line = 69)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Ltn;I)V", line = 82)
