...
public class class649 extends class224 {
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lvf;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lvf;IIIII)V")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lvf;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lvf;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(Lvf;IIII)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IZILjava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!kia", name = "e", descriptor = "(I)V")
