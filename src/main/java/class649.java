...
public class class649 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IIII)Z", line = 46)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!dda", name = "b", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(IZ)V", line = 213)
