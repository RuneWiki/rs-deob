...
public class class649 {
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(Lsu;Lsu;I)V", line = 70)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(IBI)V", line = 92)
    ...
    @OriginalMember(owner = "client!lha", name = "a", descriptor = "(BI)Lor;", line = 105)
    ...
    @OriginalMember(owner = "client!lha", name = "b", descriptor = "(BI)V", line = 138)
    ...
    @OriginalMember(owner = "client!lha", name = "<init>", descriptor = "(Liv;ILcb;Lcb;)V", line = 172)
