...
public class class649 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lad;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lad;Ljaclib/memory/Buffer;)V", line = 21)
