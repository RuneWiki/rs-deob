...
public class class649 extends class502 {
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(ILeka;)V", line = 3)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Leka;)V", line = 17)
    public class649(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!of", name = "c", descriptor = "(II)V", line = 25)
    ...
    @OriginalMember(owner = "client!of", name = "c", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)I", line = 48)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(I)V", line = 78)
