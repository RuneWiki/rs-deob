...
public class class649 extends class546 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(JILr;)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILr;IZJ)V")
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIB)Z")
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lr;Lns;Loa;J)V")
