...
public class class649 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 33)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;IILjava/lang/String;Ljava/lang/String;)V", line = 53)
