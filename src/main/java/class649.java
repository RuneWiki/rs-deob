...
public class class649 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)Lpea;")
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(I)Lpea;")
    ...
    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(I)Lpea;")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ILpea;)V")
