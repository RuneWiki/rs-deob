...
public class class649 extends class260 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lwia;BILwia;)V", line = 4)
    ...
    @OriginalMember(owner = "client!paa", name = "d", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IB)V", line = 30)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lgn;)V", line = 41)
    public class649(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(ILgn;)V", line = 46)
    public class649(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!paa", name = "e", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(II)I", line = 72)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!paa", name = "f", descriptor = "(I)V", line = 100)
