...
public class class649 implements Runnable {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(IB)Lph;", line = 5)
    ...
    @OriginalMember(owner = "client!pia", name = "run", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)Z", line = 77)
