...
public class class649 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BI[I)Lbp;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I[II)Lbp;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I[III)Lbp;")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I[III)Lbp;")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lpe;Lpe;)V")
