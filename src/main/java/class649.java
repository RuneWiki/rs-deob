...
public class class649 extends class183 {
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(B)V", line = 6)
    public static void method3677(byte arg0) {
        int var1 = -37 % ((arg0 - -4) / 52);
        field9170 = null;
    }

    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Leq;Leq;Lk;)V", line = 16)
    public class649(class209 arg0, class209 arg1, class562 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IBZI)V", line = 24)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIZI)V", line = 39)
