...
public class class649 extends class22 implements class540 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILrha;)V")
    ...
    @OriginalMember(owner = "client!ve", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Llj;IZ[[I)V")
