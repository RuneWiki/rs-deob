...
public class class654 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IILfca;B)V", line = 50)
