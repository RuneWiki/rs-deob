...
public class class654 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(III)B", line = 17)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ILug;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Luv;Lbba;Lsi;IIIII)V", line = 262)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(JI)V", line = 430)
