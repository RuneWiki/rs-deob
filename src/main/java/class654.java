...
public abstract class class654 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILwq;)Luea;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)Lfi;")
    ...
    @OriginalMember(owner = "client!eb", name = "d", descriptor = "(B)Ldja;")
