...
public class class654 extends class631 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZZ)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IILta;)V")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILka;IIB)Lkj;")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Leea;)V")
