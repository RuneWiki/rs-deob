...
public class class654 extends class518 {
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "()V", line = 7)
    public class654() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kp", name = "f", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(BI)I", line = 23)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(II)[I", line = 40)
