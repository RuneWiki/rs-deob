...
public class class654 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IILha;IILlfa;I)Lka;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILcea;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILat;Z)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILha;IIILlfa;B)Lka;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILcea;I)V")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIIIZLha;IIILlfa;Ls;ILs;)Lka;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lha;IILs;ILlfa;IBLs;IZIBI)Lka;")
