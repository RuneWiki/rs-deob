...
public class class654 implements class354 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tq", name = "toString", descriptor = "()Ljava/lang/String;", line = 34)
    public final String toString() {
        field8817++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/String;IIIIBLha;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 190)
