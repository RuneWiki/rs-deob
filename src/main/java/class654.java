...
public class class654 extends class766 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "()V", line = 64)
    public class654() {
    }

    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(S)V", line = 66)
