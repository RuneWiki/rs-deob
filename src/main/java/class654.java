...
public class class654 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZLha;Lgj;)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)Lcj;")
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lim;ILgj;)V")
