...
public class class654 extends class18 implements class532 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)Z", line = 25)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Loa;BI)Lba;", line = 36)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILoa;)Ldd;", line = 60)
    ...
    @OriginalMember(owner = "client!dq", name = "g", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Loa;B)V", line = 90)
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Z)I", line = 129)
    public final int method146(boolean arg0) {
        ++field8857;
        return arg0 ? -15 : this.field8868 & 65535;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Loa;I)V", line = 142)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(Z)I", line = 173)
    public final int method152(boolean arg0) {
        ++field8854;
        return !arg0 ? -20 : this.field8850;
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IBLoa;)Lba;", line = 185)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Loa;Lbd;IIIIZIIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)V", line = 238)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLoa;)Lpe;", line = 250)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BILoa;I)Z", line = 279)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ILoa;IZ)Lun;", line = 299)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Loa;Z)V", line = 332)
