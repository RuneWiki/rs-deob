...
public class class654 extends class331 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(BLtn;)Lgn;")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Lts;)V")
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Llea;BZ)V")
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(ILts;)V")
