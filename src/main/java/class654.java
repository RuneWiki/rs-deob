...
public class class654 extends class263 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIII)I", line = 35)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 51)
