...
public class class654 extends class324 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lkea;)Z")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lkea;I)Lrw;")
    ...
    @OriginalMember(owner = "client!rw", name = "e", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "([I)Lte;")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lkea;II)Lrw;")
