...
public abstract class class654 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BI)I", line = 10)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)V", line = 54)
