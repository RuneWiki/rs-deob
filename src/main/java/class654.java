...
public class class654 extends class17 {
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(III)V", line = 32)
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(III)V", line = 81)
