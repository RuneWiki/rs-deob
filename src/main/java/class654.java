...
public class class654 extends class72 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(III)Lwr;", line = 59)
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(I)Z", line = 72)
    public final boolean method3689(int arg0) {
        ++field9206;
        return arg0 != -10034 ? false : class736.method4111(super.field1282, (byte) 89);
    }

    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(ILcq;)V", line = 83)
    public class654(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lcq;)V", line = 86)
    public class654(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qp", name = "e", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!qp", name = "d", descriptor = "(II)I", line = 102)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(II)I", line = 117)
    ...
    @OriginalMember(owner = "client!qp", name = "f", descriptor = "(I)I", line = 147)
