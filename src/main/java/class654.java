...
public class class654 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;IIILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lpda;Lha;Ldh;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 248)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IBLjava/net/Socket;)Lgn;", line = 268)
