...
public class class653 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BZIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IC)Z", line = 142)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(I)V", line = 153)
