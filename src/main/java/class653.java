...
public class class653 extends class659 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 15)
    public class653(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ljava/awt/Frame;ILft;)V", line = 33)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V", line = 60)
