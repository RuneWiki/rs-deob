...
public class class653 extends class286 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IB)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "g", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(CI)C", line = 66)
