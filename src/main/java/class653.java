...
public class class653 extends class314 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(IIBI)I", line = 66)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "()V", line = 91)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(III)Z", line = 166)
    ...
    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(II)[I", line = 245)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "()V", line = 268)
    public class653() {
        super(0, true);
    }

    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B[B)Lf;", line = 271)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "([[II)V", line = 310)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(BLie;I)V", line = 366)
