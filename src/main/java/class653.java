...
public class class653 extends class499 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z)Z", line = 27)
    ...
    @OriginalMember(owner = "client!vh", name = "e", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILsfa;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Lgd;)V", line = 111)
    public class653(class696 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ILuc;I)V", line = 114)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(ZZ)V", line = 158)
