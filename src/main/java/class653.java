...
public class class653 extends class675 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIZ)Lhq;", line = 97)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZI)V", line = 142)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IBI)Ljava/lang/String;", line = 188)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(B)V", line = 228)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)Z", line = 260)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 274)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIILts;Lkia;IILdja;)V", line = 296)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIILha;Ldja;)V", line = 400)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 452)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lkv;Lb;)V", line = 463)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lfia;IZ)V", line = 514)
