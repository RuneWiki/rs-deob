...
public class class653 {
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ZBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(IIII[BII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(Ldc;IB)V", line = 79)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILdc;)V", line = 104)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(B)V", line = 135)
