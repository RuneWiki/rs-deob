...
public class class653 extends class381 {
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(I)V", line = 76)
    public class653(int arg0) {
        this.field9305 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!kca", name = "b", descriptor = "(B)V", line = 95)
