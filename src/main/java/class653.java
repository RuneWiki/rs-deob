...
public class class653 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)[[[I", line = 18)
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(III)V", line = 269)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IB)[[I", line = 45)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IBII)V", line = 117)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(ILsea;Llaa;)V", line = 148)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(BLac;)Lrk;", line = 205)
    ...
    @OriginalMember(owner = "client!no", name = "b", descriptor = "(I)V", line = 243)
