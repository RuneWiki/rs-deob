...
public class class653 extends class176 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(JI)V", line = 13)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lha;J)V", line = 410)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "()V", line = 585)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Lcg;IIIIIIIIIIIZZ)V", line = 595)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Lcg;IIIIIIIIIIIZZ)V", line = 616)
