...
public class class653 extends class454 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!rs", name = "f", descriptor = "(I)Ldga;", line = 31)
    ...
    @OriginalMember(owner = "client!rs", name = "g", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(II)V", line = 69)
