...
public class class653 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(Ldt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(Ldt;)V", line = 40)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "()V", line = 56)
    public class653() {
        this.field8798[0] = 0;
