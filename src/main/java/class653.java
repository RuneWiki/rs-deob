...
public class class653 extends class69 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "([[BLtf;B)V", line = 16)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "()V", line = 89)
    public class653() {
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(III[IIIII)Z", line = 92)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 186)
    public class653(String arg0, int arg1) {
        this.field9115 = arg0;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 196)
