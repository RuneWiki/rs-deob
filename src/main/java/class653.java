...
public class class653 extends class175 {
    ...
    @OriginalMember(owner = "client!mj", name = "c", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 14)
    public class653(Object arg0, int arg1) {
        super(arg1);
        this.field8960 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 24)
