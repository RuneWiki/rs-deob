...
public class class653 implements class169 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I)Ljq;", line = 22)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)I", line = 37)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Laj;Ljava/lang/String;)V", line = 49)
