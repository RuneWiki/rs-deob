...
public class class653 extends class377 {
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Llea;IIZ[[BI)V", line = 149)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILm;IIIIIIIILha;I)V", line = 169)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Llea;IIZ[[I)V", line = 243)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Llea;II)V", line = 274)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIIII)V", line = 295)
