...
public class class653 extends class477 implements class532 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Loa;Lbd;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Loa;B)V")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!sea", name = "d", descriptor = "(Z)V")
