...
public class class653 implements class160 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZI)Lij;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(BI)Lmf;")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ILd;Lha;)V")
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "([[[Liia;IZIII)Z")
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(Lla;Lla;Lla;)V")
