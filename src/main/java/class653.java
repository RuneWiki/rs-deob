...
public class class653 extends class72 {
    ...
    @OriginalMember(owner = "client!fj", name = "d", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lcq;)V", line = 94)
    public class653(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(ILcq;)V", line = 97)
    public class653(int arg0, class464 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(I)I", line = 100)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(II)I", line = 112)
