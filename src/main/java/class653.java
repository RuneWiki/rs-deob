...
public class class653 extends class740 implements class545 {
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(BII)V", line = 42)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Z)V", line = 80)
    public final void method262(boolean arg0) {
        super.method262(arg0);
        ++field9316;
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 88)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)Z", line = 100)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lai;Z)V", line = 112)
    public class653(class597 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ljaclib/memory/Source;BII)Z", line = 123)
