...
public class class684 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BLjava/lang/Object;Lpe;)V", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILpe;)V", line = 16)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZLnv;)V", line = 45)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(ILpe;)Ljava/lang/Object;", line = 125)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)V", line = 197)
    ...
    @OriginalMember(owner = "client!si", name = "d", descriptor = "(I)V", line = 246)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILjava/lang/Object;Lpe;B)V", line = 261)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(B)I", line = 298)
    public final int method3839(byte arg0) {
        field9650++;
        return arg0 == -59 ? this.field9658 : 98;
    }

    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(I)V", line = 321)
