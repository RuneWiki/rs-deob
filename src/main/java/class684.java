...
public class class684 implements class121 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZII)I", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)Lqv;", line = 31)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(I)V", line = 41)
    public class684(int arg0) {
        this.field9694 = arg0;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZJ)V", line = 50)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 119)
