...
public class class684 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ILbda;III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)Ljga;", line = 131)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Ljga;IJ)V", line = 166)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(JI)Ljga;", line = 201)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(I)V", line = 368)
