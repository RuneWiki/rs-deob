...
public class class684 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IZ)Llv;", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)V", line = 45)
    public static void method3670(int arg0) {
        int var1 = 32 / ((arg0 - 25) / 37);
        field8824 = null;
    }

    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lega;ILwm;)V", line = 57)
