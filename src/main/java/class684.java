...
public class class684 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(BI)[B", line = 183)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III[B)Z", line = 262)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIB)V", line = 295)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)V", line = 326)
    ...
    @OriginalMember(owner = "client!kv", name = "toString", descriptor = "()Ljava/lang/String;", line = 344)
    public final String toString() {
        field9508++;
        return "Cache:" + this.field9503;
    }

    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(ILsg;Lsg;I)V", line = 496)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZZ[BI)Z", line = 358)
