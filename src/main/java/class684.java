...
public class class684 extends class706 {
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lbfa;B)I", line = 76)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lpj;II)V", line = 538)
    public class684(class38 arg0, int arg1, int arg2) {
        this.field9678 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(III)Z", line = 551)
