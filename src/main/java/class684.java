...
public class class684 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IILr;)Z")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IB)Lng;")
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lrf;ILpl;)V")
