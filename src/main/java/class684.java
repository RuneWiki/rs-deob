...
public class class684 extends class299 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZLjava/lang/Object;I)[B", line = 3)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BII)V", line = 70)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BII[FFIIIIIF)V", line = 96)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIII)I", line = 171)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 199)
