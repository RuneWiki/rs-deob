...
public class class684 extends class111 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(III)V", line = 73)
