...
public class class684 extends class426 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "()Lso;")
    ...
    @OriginalMember(owner = "client!au", name = "c", descriptor = "()Lso;")
    public final class436 method3869() {
        return this.field9780;
    }

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lr;[Lnba;Z)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "([Lfk;Z)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lr;J[Lnba;[Lfk;Z)V")
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(IZ)Lau;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lr;J)Z")
