...
public class class684 extends class645 {
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Laj;Lmja;)V", line = 3)
    public class684(class333 arg0, class443 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fj", name = "e", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)Z", line = 25)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IZ)V", line = 37)
