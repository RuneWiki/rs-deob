...
public class class684 implements class437 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(BLcea;)Liia;", line = 3)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)Lad;", line = 19)
    public final class426 method119(byte arg0) {
        field9253++;
        return arg0 < 116 ? null : class293.field4105;
    }

    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(I)V", line = 89)
    public class684(int arg0) {
        this.field9258 = arg0;
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Z)V", line = 99)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(II)I", line = 195)
