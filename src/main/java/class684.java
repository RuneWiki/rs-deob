...
public class class684 extends class206 {
    ...
    @OriginalMember(owner = "client!kja", name = "b", descriptor = "(IB)V", line = 12)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(IIBI)V", line = 61)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(IB)V", line = 75)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(IIIFB)V", line = 85)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(B)Ltia;", line = 210)
    ...
    @OriginalMember(owner = "client!kja", name = "<init>", descriptor = "(Lim;IIIII)V", line = 386)
    ...
    @OriginalMember(owner = "client!kja", name = "a", descriptor = "(IB[I)V", line = 230)
