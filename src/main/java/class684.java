...
public abstract class class684 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILjava/lang/Throwable;Ljava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I[BBI)Ljava/lang/String;", line = 85)
