...
public class class684 implements class486 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(ILjava/lang/String;C)[Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!dv", name = "c", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIB)Z", line = 109)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)Leo;", line = 128)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Ljava/lang/String;Log;Lgi;IIIIIIIIII)V", line = 141)
