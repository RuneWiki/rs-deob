...
public class class428 extends class17 {
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 4)
    public class428() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "(III)V", line = 115)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)[I", line = 191)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(B)V", line = 225)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IB)[[I", line = 239)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lwm;II)V", line = 283)
