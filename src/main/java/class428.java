...
public class class428 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)Lrs;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lid;IIILir;ILvc;Lwe;)V")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(B)Lrs;")
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lwk;)V")
