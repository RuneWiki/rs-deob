...
public class class428 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "([II)V", line = 29)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 188)
    public void method2415(Component arg0) throws Exception {
        field5846++;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 209)
    public void method2409(int arg0) throws Exception {
        field5850++;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "()V", line = 216)
    public void method2414() throws Exception {
        field5856++;
    }

    @OriginalMember(owner = "client!ou", name = "b", descriptor = "()V", line = 223)
    public void method2413() throws Exception {
        field5848++;
    }

    @OriginalMember(owner = "client!ou", name = "c", descriptor = "()V", line = 231)
    public void method2411() {
        field5841++;
    }

    @OriginalMember(owner = "client!ou", name = "d", descriptor = "()I", line = 239)
    public int method2410() throws Exception {
        field5851++;
        return this.field5870;
    }

    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZLgm;)V", line = 247)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BI)V", line = 258)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIIII)V", line = 321)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(I)V", line = 405)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IBLgm;)V", line = 528)
    ...
    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(I)V", line = 552)
