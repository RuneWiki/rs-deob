...
public class class428 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(III)I", line = 16)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lwn;)V", line = 49)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)[I", line = 141)
