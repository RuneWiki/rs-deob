...
public class class428 {
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(II)Lpg;")
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Ljava/lang/String;ILjaa;I)Lhr;")
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lbs;IZLpfa;Lpfa;)V")
