...
public class class428 extends class766 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lgga;II)Lkp;", line = 4)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "()V", line = 11)
    public final void method2506() {
        this.field5932 = null;
    }

    @OriginalMember(owner = "client!kp", name = "b", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lol;)V", line = 126)
