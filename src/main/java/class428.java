...
public class class428 extends class425 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lo;III[Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(II)V", line = 36)
    public class428(int arg0, int arg1) {
        this.field6094 = arg0;
        this.field6092 = arg1;
    }

    @OriginalMember(owner = "client!dr", name = "d", descriptor = "(B)V", line = 46)
