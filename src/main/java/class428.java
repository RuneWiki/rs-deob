...
public class class428 extends class322 implements class228 {
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lnfa;Lvj;II[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IF)F", line = 23)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lnfa;II[III)V", line = 34)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lnfa;Lvj;Lnb;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(FI)F", line = 59)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIIIIIB[I)V", line = 70)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I)Z", line = 91)
    public final boolean method1327(int arg0) {
        ++field5674;
        return arg0 != 12832 ? false : false;
    }

    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IZZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!vaa", name = "c", descriptor = "(I)I", line = 112)
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(Lnfa;Lvj;II[FII)V", line = 125)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIII[BLvj;III)V", line = 140)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(I)I", line = 165)
    ...
    @OriginalMember(owner = "client!vaa", name = "d", descriptor = "(B)V", line = 183)
