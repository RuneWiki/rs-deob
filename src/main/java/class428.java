...
public class class428 extends class183 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lc;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BI[BI)I", line = 138)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(B)V", line = 220)
