...
public class class428 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "([Ljava/lang/Object;B[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ifa", name = "finalize", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Lbga;JI)V", line = 47)
