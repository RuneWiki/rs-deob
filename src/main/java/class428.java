...
public class class428 extends class91 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(III)[B", line = 7)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "([BZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)[B", line = 35)
