...
public class class428 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lek;Lek;II)Lrr;")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lek;Lek;ZII)Lrr;")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lt;Lqc;)V")
