...
public class class428 extends class263 {
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(II)V", line = 10)
    ...
    @OriginalMember(owner = "client!eo", name = "c", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IZLgk;)V", line = 37)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "()V", line = 88)
    public class428() {
        this(0);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BIILok;ZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(I)V", line = 111)
    private class428(int arg0) {
        super(0, false);
        this.method2534(255, arg0);
    }

    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 119)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(IB)[[I", line = 169)
