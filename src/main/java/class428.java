...
public class class428 extends class18 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(II)Ljava/lang/String;", line = 46)
