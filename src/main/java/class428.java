...
public class class428 extends class456 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Ltq;ILan;)I", line = 4)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(II)[I", line = 29)
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILje;)Lje;", line = 65)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "()V", line = 88)
    public class428() {
        super(0, true);
    }
}
