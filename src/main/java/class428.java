...
public class class428 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILmo;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)Lfg;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lhp;[Lne;I)Law;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lmo;II)V")
