...
public class class428 extends class507 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIBII)V", line = 15)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(III)I", line = 37)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lmo;)V", line = 59)
