...
public class class428 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lno;Lno;I)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILqu;)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lqu;B)Z")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lsba;I)I")
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Ldw;)V")
