...
public class class428 extends class311 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIB)Z", line = 82)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IZ)Loh;", line = 99)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "([IIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(IIB)Z", line = 141)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(Lea;ZIIBII[Lbm;I[BII)[I", line = 160)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BIII)Z", line = 633)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(I)V", line = 648)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II[II)V", line = 659)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(ZI)V", line = 674)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(IIIIIIIII)V", line = 699)
