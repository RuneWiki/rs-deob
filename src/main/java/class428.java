...
public class class428 extends class145 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lap;IILbd;)V")
    ...
    @OriginalMember(owner = "client!h", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Lap;BI)V")
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(II)Lks;")
