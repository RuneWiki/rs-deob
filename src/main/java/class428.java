...
public class class428 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILie;)V", line = 22)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BILda;III)Lda;", line = 238)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIZIILda;BI)Lda;", line = 379)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IB)V", line = 444)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BIZI)I", line = 460)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILie;)V", line = 588)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 609)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 644)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILjava/lang/String;)I", line = 673)
