...
public class class428 extends class259 {
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lvda;Lrl;[Lfba;[I[I)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(CIIIZLpa;II)V")
    ...
    @OriginalMember(owner = "client!ai", name = "HA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "([B[IIIIIIIIIIILpa;II)V")
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "([B[IIIIIIII)V")
