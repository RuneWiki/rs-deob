...
public class class428 extends class194 {
    ...
    @OriginalMember(owner = "client!uba", name = "b", descriptor = "(IB)Z")
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Loea;)V")
    ...
    @OriginalMember(owner = "client!uba", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(BILme;Lme;)V")
