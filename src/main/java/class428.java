...
public class class428 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)Luh;")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)Luh;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILuh;)V")
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)Luh;")
