...
public class class428 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lps;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lps;)V", line = 41)
    public final void method2694(class52 arg0) {
        this.method2692(arg0, true);
    }

    @OriginalMember(owner = "client!rl", name = "b", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lhj;)V", line = 361)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(Lps;)Z", line = 103)
    ...
    @OriginalMember(owner = "client!rl", name = "c", descriptor = "()Z", line = 131)
    private final boolean method2697() {
        return this.field6143.method2171() == this.field6142;
    }

    @OriginalMember(owner = "client!rl", name = "d", descriptor = "()V", line = 140)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IIII)Z", line = 227)
