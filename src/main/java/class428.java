...
public class class428 extends Callback {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILjava/awt/Component;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "callback", descriptor = "(IIII)I", line = 48)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIB)V", line = 89)
