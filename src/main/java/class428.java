...
public class class428 extends class262 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIIIIIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lag;IIII[BI)V", line = 91)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Lag;IIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!pd", name = "g", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!pd", name = "h", descriptor = "(I)V", line = 72)
