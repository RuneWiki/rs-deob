...
public class class428 extends class696 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "()Lcd;")
    public final class603 method2540() {
        return this.field6082;
    }

    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lha;J[Lal;[Lmi;Z)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IZ)Laj;")
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "()Lcd;")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lha;[Lal;Z)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "([Lmi;Z)V")
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lha;J)Z")
