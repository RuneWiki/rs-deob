...
public class class428 extends class152 {
    ...
    @OriginalMember(owner = "client!jw", name = "BA", descriptor = "(III[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jw", name = "oa", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lhw;II[I)V", line = 37)
    ...
    @OriginalMember(owner = "client!jw", name = "AA", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!jw", name = "M", descriptor = "(Lq;)V", line = 154)
    ...
    @OriginalMember(owner = "client!jw", name = "w", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!jw", name = "J", descriptor = "(I)V", line = 203)
    ...
    @OriginalMember(owner = "client!jw", name = "o", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!jw", name = "ZA", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIIILnf;)V", line = 269)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(III[I)V", line = 323)
    ...
    @OriginalMember(owner = "client!jw", name = "YA", descriptor = "([I)V", line = 334)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "()Lq;", line = 351)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 373)
    ...
    @OriginalMember(owner = "client!jw", name = "U", descriptor = "(III)V", line = 388)
    ...
    @OriginalMember(owner = "client!jw", name = "na", descriptor = "(IIIIII)V", line = 398)
    ...
    @OriginalMember(owner = "client!jw", name = "wa", descriptor = "(III[I)V", line = 441)
    ...
    @OriginalMember(owner = "client!jw", name = "Y", descriptor = "()V", line = 451)
    ...
    @OriginalMember(owner = "client!jw", name = "NA", descriptor = "(III)V", line = 460)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "()V", line = 482)
    public class428() {
        this.method167();
    }
}
