...
public class class428 {
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(II)Lfga;")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Ltp;I)V")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lnb;ILoh;)V")
