...
public class class428 implements class92 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "finalize", descriptor = "()V", line = 20)
    protected final void finalize() throws Throwable {
        this.method2736();
        super.finalize();
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lih;III)V", line = 39)
