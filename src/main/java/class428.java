...
public class class428 extends class387 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(BILiga;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(ZB)V", line = 16)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(III)V", line = 62)
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(Lrda;Llba;)V", line = 162)
    ...
    @OriginalMember(owner = "client!hea", name = "c", descriptor = "(Z)V", line = 212)
    ...
    @OriginalMember(owner = "client!hea", name = "d", descriptor = "(Z)V", line = 224)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(B)[Llu;", line = 253)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(I)Z", line = 264)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(BZ)V", line = 279)
    ...
    @OriginalMember(owner = "client!hea", name = "b", descriptor = "(B)V", line = 291)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Z)V", line = 320)
