...
public class class428 extends class279 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ILha;)Ldfa;", line = 3)
    ...
    @OriginalMember(owner = "client!qba", name = "l", descriptor = "(I)I", line = 171)
    ...
    @OriginalMember(owner = "client!qba", name = "h", descriptor = "(I)Z", line = 185)
    public final boolean method19(int arg0) {
        ++field6085;
        return arg0 >= -87;
    }

    @OriginalMember(owner = "client!qba", name = "k", descriptor = "(I)Z", line = 196)
    public final boolean method21(int arg0) {
        ++field6087;
        return arg0 != 0 ? true : this.field6092;
    }

    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(IIIII)V", line = 207)
    public class428(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIILha;)Z", line = 210)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(BLha;)V", line = 258)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "(B)V", line = 272)
    ...
    @OriginalMember(owner = "client!qba", name = "m", descriptor = "(I)I", line = 287)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lha;B)Lel;", line = 299)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(Z)I", line = 316)
