...
public class class428 extends class454 {
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lkd;II)V")
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lkd;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lkd;IIZ[[I)V")
