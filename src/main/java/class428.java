...
public class class428 extends class250 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "()Lit;", line = 37)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III)V", line = 63)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ldr;)V", line = 69)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(III[I)V", line = 84)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "([I)V", line = 92)
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "()V", line = 143)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "()V", line = 177)
    public class428() {
        this.method1388();
    }
}
