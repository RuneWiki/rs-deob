...
public class class428 extends class398 {
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(II)[I", line = 22)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "()V", line = 74)
    public class428() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lnj;II)V", line = 79)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BIILps;)V", line = 98)
