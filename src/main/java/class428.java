...
public class class428 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IBII)I", line = 12)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IIII)Z", line = 62)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)V", line = 280)
