...
public class class428 extends class116 implements class503 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lya;B)Lmf;", line = 3)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lya;II)Lt;", line = 30)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(ILya;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)I", line = 63)
    ...
    @OriginalMember(owner = "client!ou", name = "j", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZILya;I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ou", name = "h", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILya;BZ)Lso;", line = 143)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(ILya;)V", line = 174)
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lya;Ljo;IIIIIZIIIIIIZ)V", line = 203)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILya;)V", line = 236)
    ...
    @OriginalMember(owner = "client!ou", name = "c", descriptor = "(Z)V", line = 267)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lya;IZLij;III)V", line = 279)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!ou", name = "f", descriptor = "(I)Z", line = 328)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(Z)I", line = 339)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BLya;I)Lt;", line = 351)
    ...
    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(I)I", line = 362)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIII)V", line = 376)
    ...
    @OriginalMember(owner = "client!ou", name = "d", descriptor = "(I)I", line = 390)
