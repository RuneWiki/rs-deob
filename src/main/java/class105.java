...
public class class105 extends class775 {
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Luq;ILuq;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(III)V", line = 100)
