...
public class class105 extends class187 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IJLza;)V", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!si", name = "i", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Luu;Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!si", name = "g", descriptor = "(I)[B", line = 273)
    ...
    @OriginalMember(owner = "client!si", name = "h", descriptor = "(I)I", line = 295)
