...
public class class105 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)V", line = 240)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[B)V", line = 265)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "([BI)V", line = 446)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)V", line = 463)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(BI)V", line = 477)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIII)V", line = 529)
