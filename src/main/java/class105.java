...
public class class105 extends class225 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lwo;)V", line = 42)
    public class105(class52 arg0) {
        this.field1522 = arg0;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(CZ)Z", line = 61)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(I)V", line = 106)
