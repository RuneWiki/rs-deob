...
public class class105 extends class456 {
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "()V", line = 8)
    public class105() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ci", name = "h", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(II)[I", line = 26)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IBLre;)V", line = 55)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II[I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIIIII)I", line = 305)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Z)V", line = 382)
    ...
    @OriginalMember(owner = "client!ci", name = "i", descriptor = "(I)V", line = 428)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lps;", line = 470)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BIC)I", line = 499)
