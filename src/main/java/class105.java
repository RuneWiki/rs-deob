...
public class class105 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)J", line = 10)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIB)V", line = 29)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!lr", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(I)Ljava/io/File;", line = 150)
    ...
    @OriginalMember(owner = "client!lr", name = "e", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lih;II)V", line = 605)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "([BIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IJ)V", line = 408)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I[B)V", line = 428)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II[BI)V", line = 439)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IZII)V", line = 571)
