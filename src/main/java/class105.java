...
public class class105 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIIIIILqa;II)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILqa;I)Z")
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(I[Llp;IIII)V")
