...
public class class105 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([II[III)V")
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([BI[BII)V")
    public static final void method792(byte[] arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        if (arg0 == arg2) {
            if (arg1 == arg3) {
                return;
            }
    ...
    public static final void method794(int[] arg0, int arg1, int arg2, int arg3) {
