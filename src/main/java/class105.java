...
public class class105 extends class190 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(IIIIIF)V", line = 47)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(III)V", line = 64)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIZ)I", line = 75)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIB)V", line = 140)
