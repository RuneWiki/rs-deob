...
public class class105 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/String;B)Lpk;", line = 6)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 684)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BILjava/lang/Runnable;)Lkl;", line = 33)
    public final class70 method757(byte arg0, int arg1, Runnable arg2) {
        return arg0 <= 40 ? null : this.method765(12, 0, arg1, arg2, 2);
    }

    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)Z", line = 45)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIIII)Lkl;", line = 65)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Lpk;", line = 75)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZLjava/lang/String;II)Lkl;", line = 117)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Lkl;", line = 133)
    ...
    @OriginalMember(owner = "client!laa", name = "run", descriptor = "()V", line = 145)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ZBLjava/lang/String;)Lkl;", line = 440)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(II)Lkl;", line = 455)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIILjava/lang/Object;I)Lkl;", line = 474)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/io/File;B[B)Z", line = 504)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(I)V", line = 524)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/awt/Frame;I)Lkl;", line = 591)
    public final class70 method768(Frame arg0, int arg1) {
        return arg1 == 0 ? this.method765(arg1 ^ 0xC, 0, 0, arg0, 7) : null;
    }

    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 601)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/String;I)Lkl;", line = 612)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(I)V", line = 626)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;)Lkl;", line = 646)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/awt/Component;IILjava/awt/Point;[I)Lkl;", line = 664)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(B)Lkl;", line = 836)
    public final class70 method774(byte arg0) {
        int var2 = -103 / ((arg0 - 39) / 51);
        return this.method765(12, 0, 0, null, 5);
    }

    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/net/URL;I)Lkl;", line = 845)
