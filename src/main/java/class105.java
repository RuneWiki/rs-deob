...
public class class105 extends class55 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(I)V", line = 21)
    public class105(int arg0) {
        this.field1472 = arg0;
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ZII)Z", line = 29)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(III)Z", line = 56)
