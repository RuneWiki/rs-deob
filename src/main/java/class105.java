...
public class class105 extends class493 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lie;B)Lng;", line = 7)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BLr;)V", line = 46)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lkfa;IBII)V", line = 137)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(I)V", line = 189)
