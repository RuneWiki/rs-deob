...
public class class105 extends class772 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IILha;Luaa;I)V")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lgd;IIZ)V")
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Lgd;II[III)V")
