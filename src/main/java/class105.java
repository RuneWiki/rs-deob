...
public class class105 extends class504 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "()V", line = 32)
    public class105() {
    }

    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(J)V", line = 36)
