...
public class class105 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(II)[B", line = 61)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lml;ILja;)I", line = 109)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIB)I", line = 136)
