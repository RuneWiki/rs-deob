...
public class class105 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(JIZLjava/lang/String;ZIZIJIBLjava/lang/String;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IB)Lcm;", line = 120)
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Ldt;ILwia;)V", line = 152)
