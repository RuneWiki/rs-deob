...
public class class105 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 39)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IILae;IBLjh;)V", line = 64)
