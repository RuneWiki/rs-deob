...
public class class105 extends class440 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "()V", line = 51)
    public class105() {
        super(0, true);
    }

    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILjava/io/File;I)[B", line = 28)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILmo;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!laa", name = "g", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BI)[I", line = 154)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Lqaa;II)V", line = 288)
