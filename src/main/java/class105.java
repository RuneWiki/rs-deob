...
public abstract class class105 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BLua;)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IB)I", line = 37)
    public static final int method610(int arg0, byte arg1) {
        field1319++;
        return arg1 <= 80 ? 91 : arg0 & 0x7F;
    }

    @OriginalMember(owner = "client!m", name = "a", descriptor = "(IIIIIZII)V", line = 52)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Z)V", line = 172)
