...
public class class105 extends OutputStream {
    ...
    @OriginalMember(owner = "client!pq", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field1436++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!pq", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!pq", name = "b", descriptor = "(I)V", line = 38)
