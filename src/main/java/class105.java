...
public class class105 extends class82 {
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IILos;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ICLjava/lang/String;)I", line = 32)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(II)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "()V", line = 172)
    public class105() {
        super(0, false);
    }

    @OriginalMember(owner = "client!ut", name = "h", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)I", line = 139)
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "(III)V", line = 150)
