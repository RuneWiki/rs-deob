...
public class class105 extends class208 {
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(ZII)V", line = 116)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IB)V", line = 140)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(BI)V", line = 173)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(III)V", line = 200)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(IIIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)V", line = 233)
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(III)V", line = 244)
