...
public abstract class class105 extends class670 {
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(I[Lwi;BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!kba", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!kba", name = "f", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!kba", name = "h", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(II)V", line = 143)
