...
public class class105 {
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(IBIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(BLjka;)Ljava/lang/String;", line = 61)
