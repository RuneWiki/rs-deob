...
public class class105 extends class263 {
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "()V", line = 5)
    public class105() {
        super(0, true);
    }

    @OriginalMember(owner = "client!si", name = "d", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IB)[I", line = 46)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IZLgk;)V", line = 182)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lgk;II)Ljava/lang/String;", line = 249)
