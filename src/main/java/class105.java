...
public abstract class class105 {
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(III)V", line = 82)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)I", line = 96)
