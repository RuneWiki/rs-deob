...
public class class105 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II)Loda;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILek;)Lem;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZLwv;ILjava/lang/String;Z)V")
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(BIIIIIILvj;)V")
