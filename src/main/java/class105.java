...
public class class105 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILsq;)Z", line = 29)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lrl;J[Lmt;)V", line = 53)
