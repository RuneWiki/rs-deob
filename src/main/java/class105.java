...
public abstract class class105 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(B)V", line = 33)
    public static void method886(byte arg0) {
        int var1 = 115 % ((arg0 + 55) / 60);
        field1758 = null;
    }

    @OriginalMember(owner = "client!m", name = "a", descriptor = "(III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BLjava/lang/String;)V", line = 61)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 77)
