...
public class class105 extends class32 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lwu;)Lps;", line = 3)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
