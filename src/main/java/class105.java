...
public class class105 extends class497 {
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BII)V", line = 18)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(III)V", line = 29)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(IIIIIFFF)V", line = 61)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(B)V", line = 113)
