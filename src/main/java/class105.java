...
public class class105 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BLsq;J)V", line = 31)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILti;)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 96)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IJ)Lsq;", line = 140)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(I)V", line = 208)
