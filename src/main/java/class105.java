...
public class class105 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BLwm;)V", line = 41)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lwm;BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Z)V", line = 162)
