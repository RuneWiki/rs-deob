...
public class class105 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IBIIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IILvt;)V", line = 103)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lvt;I)V", line = 358)
