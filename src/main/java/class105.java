...
public class class105 extends class3 implements class453 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B[BII)V", line = 44)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)J", line = 74)
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(I)I", line = 98)
    public final int method734(int arg0) {
        ++field1545;
        return arg0 < 69 ? 0 : 0;
    }

    @OriginalMember(owner = "client!ib", name = "d", descriptor = "(I)Lms;", line = 109)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)I", line = 125)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lbo;I[BI)V", line = 137)
    public class105(class511 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1535 = arg1;
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIIBIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IB)I", line = 318)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIILqa;III)Lc;", line = 341)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lbo;ILjaggl/memory/NativeBuffer;)V", line = 402)
