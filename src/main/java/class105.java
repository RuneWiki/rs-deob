...
public class class105 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lft;B)V", line = 15)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)V", line = 708)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLufa;)[Lan;", line = 737)
