...
public class class105 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Les;I)Loc;", line = 7)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BII)I", line = 18)
    ...
    @OriginalMember(owner = "client!ps", name = "toString", descriptor = "()Ljava/lang/String;", line = 43)
    public final String toString() {
        field1343++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIZ)Lwl;", line = 52)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(B)V", line = 66)
