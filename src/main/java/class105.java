...
public class class105 extends class694 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BIIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "()V", line = 163)
    public class105() {
        super(0, true);
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILjr;B)V", line = 137)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BII)Z", line = 187)
