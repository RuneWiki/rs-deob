...
public class class105 {
    ...
    @OriginalMember(owner = "client!kba", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kba", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(IZI)Les;", line = 42)
    ...
    @OriginalMember(owner = "client!kba", name = "d", descriptor = "(I)V", line = 56)
