...
public class class105 extends class3 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lq;FILq;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(B)Lq;", line = 206)
    public final class429 method9(byte arg0) {
        field1850++;
        return arg0 == -121 ? this.field1851 : null;
    }

    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(I)I", line = 218)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lha;II)Lmi;", line = 229)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Z)V", line = 257)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(I)V", line = 273)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Lqo;I)V", line = 286)
