...
public class class414 implements class75 {
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lqq;I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(FIIFBFIFIFLhm;)[B", line = 107)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B)V", line = 121)
