...
public class class414 {
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(ILol;)V", line = 4)
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(Lol;BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!aka", name = "a", descriptor = "(ZI)Z", line = 73)
