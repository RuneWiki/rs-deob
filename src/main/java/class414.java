...
public class class414 extends class195 {
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lge;IIZ[[I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "()V", line = 43)
    public final void method658() {
        this.field2858.field1604.glFramebufferTexture2DEXT(36160, this.field6004, 3553, 0, 0);
        this.field6004 = -1;
    }

    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lge;II)V", line = 50)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Lge;IIZ[[BI)V", line = 65)
