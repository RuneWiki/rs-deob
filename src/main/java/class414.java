...
public class class414 {
    ...
    @OriginalMember(owner = "client!wj", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Lffa;JI)V", line = 56)
