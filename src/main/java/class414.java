...
public class class414 extends class602 implements class196 {
    ...
    @OriginalMember(owner = "client!vja", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!vja", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!vja", name = "h", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IIBI[IIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "(Ldga;Lhh;IIZ[FII)V", line = 76)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IIIII[IB)V", line = 101)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(ZF)F", line = 124)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "(Ldga;IIZ[III)V", line = 135)
    ...
    @OriginalMember(owner = "client!vja", name = "b", descriptor = "(I)I", line = 157)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "(Ldga;Lhh;IIZ[BII)V", line = 167)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IF)F", line = 188)
    ...
    @OriginalMember(owner = "client!vja", name = "g", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(Lhh;I[BIIIIII)V", line = 227)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IZZ)V", line = 245)
    ...
    @OriginalMember(owner = "client!vja", name = "<init>", descriptor = "(Ldga;Lhh;Lon;II)V", line = 258)
    ...
    @OriginalMember(owner = "client!vja", name = "a", descriptor = "(IIII[FLhh;III)V", line = 273)
