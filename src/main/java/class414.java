...
public class class414 {
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(II)[I", line = 42)
    ...
    @OriginalMember(owner = "client!bba", name = "b", descriptor = "(B)[[I", line = 112)
