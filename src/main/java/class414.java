...
public class class414 extends OutputStream {
    ...
    @OriginalMember(owner = "client!dg", name = "write", descriptor = "(I)V", line = 3)
    public final void write(int arg0) throws IOException {
        field5850++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Ld;IILjava/awt/Canvas;I)Lha;", line = 11)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IILee;IIZIIIIILhaa;)V", line = 33)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(III)V", line = 61)
    public static final void method2391(int arg0, int arg1, int arg2) {
        class425.method2432(arg2, arg0, arg1 ^ arg1);
        field5849++;
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(B)V", line = 76)
