...
public class class414 extends class30 {
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "()V", line = 6)
    public class414() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BI)[[I", line = 9)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZBIIZIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(Z)V", line = 297)
    ...
    @OriginalMember(owner = "client!dq", name = "f", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljg;II)V", line = 363)
