...
public class class414 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)[I", line = 14)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(CII)C", line = 25)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 118)
    public class414(String arg0, int arg1) {
        this.field5857 = arg1;
        this.field5862 = arg0;
    }

    @OriginalMember(owner = "client!ci", name = "toString", descriptor = "()Ljava/lang/String;", line = 130)
