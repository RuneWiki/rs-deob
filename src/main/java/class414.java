...
public abstract class class414 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!mha", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 3)
    ...
    @OriginalMember(owner = "client!mha", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 20)
    public final void windowClosed(WindowEvent arg0) {
        field5662++;
    }

    @OriginalMember(owner = "client!mha", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 27)
    public final void windowOpened(WindowEvent arg0) {
        field5661++;
    }

    @OriginalMember(owner = "client!mha", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 34)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(Z)Z", line = 50)
    public final boolean method2529(boolean arg0) {
        field5652++;
        return arg0 ? class79.method555(33, "jagtheora") : false;
    }

    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ILjava/lang/String;)V", line = 147)
    ...
    @OriginalMember(owner = "client!mha", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 174)
    public final void windowActivated(WindowEvent arg0) {
        field5664++;
    }

    @OriginalMember(owner = "client!mha", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 181)
    public final void windowIconified(WindowEvent arg0) {
        field5643++;
    }

    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!mha", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 222)
    ...
    @OriginalMember(owner = "client!mha", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 237)
    ...
    @OriginalMember(owner = "client!mha", name = "stop", descriptor = "()V", line = 253)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!mha", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 318)
    public final void windowClosing(WindowEvent arg0) {
        field5656++;
        this.destroy();
    }

    @OriginalMember(owner = "client!mha", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 326)
    ...
    @OriginalMember(owner = "client!mha", name = "destroy", descriptor = "()V", line = 336)
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(I)Z", line = 351)
    ...
    @OriginalMember(owner = "client!mha", name = "start", descriptor = "()V", line = 393)
    ...
    @OriginalMember(owner = "client!mha", name = "run", descriptor = "()V", line = 406)
    ...
    @OriginalMember(owner = "client!mha", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 528)
    ...
    @OriginalMember(owner = "client!mha", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 555)
    public final void windowDeactivated(WindowEvent arg0) {
        field5655++;
    }

    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(Z)Z", line = 564)
    ...
    @OriginalMember(owner = "client!mha", name = "d", descriptor = "(B)Ljava/lang/String;", line = 578)
    ...
    @OriginalMember(owner = "client!mha", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 594)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field5636++;
    }

    @OriginalMember(owner = "client!mha", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 605)
    public final void windowDeiconified(WindowEvent arg0) {
        field5638++;
    }

    @OriginalMember(owner = "client!mha", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 626)
    public final void focusLost(FocusEvent arg0) {
        class591.field8340 = false;
        field5635++;
    }

    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(ZI)V", line = 638)
    ...
    @OriginalMember(owner = "client!mha", name = "c", descriptor = "(Z)V", line = 713)
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IZIIIILjava/lang/String;I)V", line = 756)
    ...
    @OriginalMember(owner = "client!mha", name = "d", descriptor = "(I)Z", line = 799)
    public final boolean method2539(int arg0) {
        field5647++;
        return arg0 == -32067 ? class79.method555(33, "jagmisc") : true;
    }

    @OriginalMember(owner = "client!mha", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 813)
