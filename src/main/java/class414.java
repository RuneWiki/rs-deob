...
public class class414 extends Canvas {
    ...
    @OriginalMember(owner = "client!ca", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 5)
    public final void update(Graphics arg0) {
        this.field6085.update(arg0);
        field6088++;
    }

    @OriginalMember(owner = "client!ca", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 15)
    public final void paint(Graphics arg0) {
        this.field6085.paint(arg0);
        field6087++;
    }

    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 31)
