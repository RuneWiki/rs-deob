...
public class class414 extends class177 implements class232 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IZII)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Z)I", line = 54)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(Lqa;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIILqa;)Z", line = 79)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)Z", line = 119)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lqa;IB)Lc;", line = 135)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IILqa;)Lc;", line = 158)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lqa;Lbo;IIIIZIIIII)V", line = 169)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)I", line = 194)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(Z)I", line = 205)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lqa;I)V", line = 321)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILqa;)Lbw;", line = 348)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZILqa;I)Lrl;", line = 374)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(Lqa;I)V", line = 407)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(Z)V", line = 435)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILtn;ZI)V", line = 449)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(I)V", line = 462)
