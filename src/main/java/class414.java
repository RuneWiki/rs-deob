...
public class class414 extends class201 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IILqi;[BIZII)Lr;")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lqi;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lqi;IIII[I)V")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lqi;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lqi;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "([ILqi;IZZI)Lr;")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIILqi;II)Lr;")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lqi;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(Lqi;IIIII[BI)V")
