...
public class class414 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IBLgh;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BII[B)V", line = 25)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lwh;Lwha;Lmh;IIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)V", line = 78)
