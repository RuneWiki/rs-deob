...
public class class414 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lvj;)V", line = 4)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Lvj;)V", line = 38)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "()V", line = 50)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "()V", line = 56)
    public class414() {
        this.field5763[0] = 0;
