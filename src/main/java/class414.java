...
public class class414 extends class321 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lmv;IZBLfa;I)[F", line = 6)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IBZIZDLmv;Lfa;)[I", line = 125)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IZLfa;Lmv;IDI)[I", line = 260)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 396)
    public static void method2526(byte arg0) {
        int var1 = 28 % ((-arg0 - 18) / 54);
        field6131 = null;
    }

    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "()V", line = 411)
    public class414() {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lmv;Lfa;B)Z", line = 427)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lgk;)V", line = 476)
