...
public class class414 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(BLos;)V")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IILos;)V")
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(II[[[Ldg;BIZ)Z")
