...
public class class414 extends class314 {
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "()V", line = 23)
    public class414() {
        super(3, false);
    }

    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!qd", name = "d", descriptor = "(III)I", line = 81)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IB)[[I", line = 103)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(BLie;I)V", line = 184)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(B)V", line = 199)
