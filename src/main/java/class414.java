...
public class class414 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIII)Lco;", line = 34)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(I)V", line = 93)
