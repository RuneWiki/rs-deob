...
public class class414 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Lnf;I)Z")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ILwn;)V")
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lwn;)V")
