...
public class class414 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "toString", descriptor = "()Ljava/lang/String;", line = 20)
    public final String toString() {
        field5179++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(III)I", line = 35)
