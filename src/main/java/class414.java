...
public class class414 extends class324 {
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lgl;Ljava/lang/Object;)V", line = 15)
    public class414(class357 arg0, Object arg1) {
        super(arg0);
        this.field5968 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!dq", name = "e", descriptor = "(I)Z", line = 24)
