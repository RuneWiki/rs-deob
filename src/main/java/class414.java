...
public class class414 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(II)V", line = 49)
