...
public class class414 extends class694 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILva;)V", line = 61)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILjr;B)V", line = 485)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IB)V", line = 520)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "()V", line = 637)
    public class414() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jea", name = "i", descriptor = "(I)V", line = 540)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(II)[[I", line = 564)
