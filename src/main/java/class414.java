...
public class class414 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lrda;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!uf", name = "toString", descriptor = "()Ljava/lang/String;", line = 120)
