...
public class class414 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)Lwg;", line = 5)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIIIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(IIIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 152)
