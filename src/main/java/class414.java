...
public class class414 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)Lrg;")
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)Lrg;")
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lqk;)V")
