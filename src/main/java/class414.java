...
public class class414 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;)V", line = 28)
