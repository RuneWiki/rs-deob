...
public class class414 extends class739 {
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZI)[I", line = 13)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(II)[[I", line = 65)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lsl;IB)V", line = 148)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "()V", line = 166)
    public class414() {
        super(3, false);
    }
}
