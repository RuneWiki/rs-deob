...
public class class414 implements class58 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZD)V", line = 56)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lsd;)V", line = 84)
    public class414(class56 arg0) {
        this.field6093 = arg0;
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)Z", line = 92)
