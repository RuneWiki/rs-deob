...
public class class414 extends class518 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IBI)V", line = 28)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(IIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)V", line = 50)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IIZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(B)V", line = 91)
