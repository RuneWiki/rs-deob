...
public class class414 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II[Ljava/lang/Object;B[J)V", line = 120)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ltg;", line = 175)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Leb;I)V", line = 193)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IIIIIIIII)Z", line = 220)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLeb;I)V", line = 239)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)V", line = 274)
