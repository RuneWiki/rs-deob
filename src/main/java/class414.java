...
public class class414 extends class189 {
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IS)V")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(II[[ZII)V")
    ...
    @OriginalMember(owner = "client!mha", name = "b", descriptor = "(III)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(Lsr;Laca;Lwi;[I)V")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(III[B)[B")
