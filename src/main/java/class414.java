...
public class class414 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 70)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IBLap;)V", line = 98)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ZILap;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lbi;B)V", line = 183)
    ...
    @OriginalMember(owner = "client!nd", name = "c", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(B)V", line = 280)
