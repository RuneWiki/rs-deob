...
public class class414 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!jea", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Lok;II)V", line = 36)
