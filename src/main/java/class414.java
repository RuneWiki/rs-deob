...
public class class414 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZILtq;)Z", line = 76)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 490)
