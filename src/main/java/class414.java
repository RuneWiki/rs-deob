...
public class class414 extends class312 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Ljd;Z)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lnc;I)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BLjd;)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(FILij;ZI)V")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([BB)Lks;")
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILjd;)V")
