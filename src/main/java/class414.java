...
public class class414 {
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lur;)V", line = 529)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)Z", line = 119)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIII)Z", line = 264)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLhf;)V", line = 311)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(B)V", line = 328)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lhf;I)Z", line = 357)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)Z", line = 403)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(I)V", line = 440)
