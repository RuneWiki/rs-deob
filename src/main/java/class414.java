...
public class class414 extends class349 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IILdga;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(BI)[I", line = 52)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 161)
    public class414() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lcga;III)V", line = 169)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(B)V", line = 204)
