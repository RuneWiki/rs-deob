...
public class class414 extends class75 {
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 21)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "()I", line = 80)
    public final int method526() {
        return this.field6297 - (this.field6294.available() >> (class175.field2777 ? 2 : 1));
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 93)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 130)
