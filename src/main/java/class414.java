...
public class class414 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ltj;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ltj;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ltj;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Ltj;IZLjava/awt/Component;)V")
