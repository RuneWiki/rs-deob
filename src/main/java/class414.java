...
public class class414 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ldr;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ldr;ZILjava/lang/Object;)V", line = 109)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Z)V", line = 176)
    ...
    @OriginalMember(owner = "client!wj", name = "b", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ZLkca;)V", line = 199)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Ljava/lang/Object;Ldr;I)V", line = 217)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(B)I", line = 230)
    ...
    @OriginalMember(owner = "client!wj", name = "c", descriptor = "(I)Leo;", line = 242)
    ...
    @OriginalMember(owner = "client!wj", name = "d", descriptor = "(I)I", line = 254)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILdr;)Ljava/lang/Object;", line = 266)
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(I)V", line = 328)
