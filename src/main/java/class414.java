...
public class class414 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "()I", line = 11)
    public int method2293() throws Exception {
        field5947++;
        return this.field5979;
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "([II)V", line = 27)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILuq;ZIII)V", line = 187)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "()V", line = 199)
    public void method2294() throws Exception {
        field5952++;
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)V", line = 206)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 322)
    public void method2297(Component arg0) throws Exception {
        field5962++;
    }

    @OriginalMember(owner = "client!br", name = "b", descriptor = "(B)V", line = 329)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IZ)V", line = 351)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lpp;ZI)V", line = 368)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "()V", line = 393)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(III)Z", line = 403)
    ...
    @OriginalMember(owner = "client!br", name = "d", descriptor = "()V", line = 415)
    public void method2296() throws Exception {
        field5950++;
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IIB)Z", line = 428)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(B)V", line = 439)
    public static void method2499(byte arg0) {
        field5958 = null;
        int var1 = -47 % ((-arg0 - 20) / 45);
    }

    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILpp;)V", line = 448)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!br", name = "e", descriptor = "()V", line = 504)
