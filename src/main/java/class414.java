...
public class class414 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IB)V", line = 54)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IZ)Lph;", line = 95)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lkr;ILok;)V", line = 156)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(I)V", line = 145)
