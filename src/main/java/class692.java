...
public class class692 extends class487 {
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lrs;IIIII)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lrs;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lrs;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lrs;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lrs;IIII)V")
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIIIIIBIILha;II[[[B)V")
