...
public class class692 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIII[B[B)I", line = 5)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 155)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IBI[BI[B)I", line = 189)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "([B)V", line = 271)
