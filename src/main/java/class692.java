...
public class class692 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILha;)Liea;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lha;I)Liea;")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(ILha;)Liea;")
    ...
    @OriginalMember(owner = "client!kb", name = "c", descriptor = "(ILha;)Liea;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILsl;)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IILsl;)V")
