...
public class class692 extends class117 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILpq;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lgn;Z)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZBLd;I)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lgn;I)V")
