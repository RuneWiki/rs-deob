...
public class class692 extends class430 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IZ)I", line = 13)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILrq;BI)V", line = 37)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BI)V", line = 77)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(IIIIIZ)V", line = 99)
