...
public class class692 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lee;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Lee;IB)V", line = 302)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(ILjava/lang/String;)I", line = 537)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(Z)V", line = 568)
