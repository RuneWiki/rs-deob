...
public class class692 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Lqba;IIZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(IIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BI)Lpn;", line = 81)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(B)V", line = 91)
