...
public class class692 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IB)Lvf;", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)Z", line = 42)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 54)
