...
public class class692 {
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(Lob;B)Z", line = 72)
    ...
    @OriginalMember(owner = "client!jja", name = "a", descriptor = "(ILlga;I)Lcd;", line = 3695)
