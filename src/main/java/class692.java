...
public class class692 implements Runnable {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Los;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!rda", name = "run", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BLtc;[BI)Los;", line = 104)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IBLtc;)Los;", line = 123)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ltc;II)Los;", line = 141)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(Llc;)V", line = 187)
