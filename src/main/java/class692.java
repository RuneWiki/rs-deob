...
public class class692 extends class540 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IZZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 64)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(I)[I", line = 174)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Ljv;B)V", line = 205)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 221)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(Lrv;)V", line = 348)
    public class692(class120 arg0) {
        this.method3897(arg0, 124);
    }

    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Lrv;I)V", line = 295)
