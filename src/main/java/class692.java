...
public class class692 extends class204 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BLtja;)Z")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lfs;)V")
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(ILfs;)V")
