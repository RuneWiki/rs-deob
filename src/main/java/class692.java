...
public class class692 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!jha", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field9740++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)V", line = 111)
