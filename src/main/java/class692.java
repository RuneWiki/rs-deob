...
public class class692 extends Exception {
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 131)
