...
public class class692 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IZ)Lvq;", line = 55)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)Z", line = 86)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lnq;ILga;Lga;)V", line = 131)
