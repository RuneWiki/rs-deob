...
public class class692 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIILji;)V", line = 7)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIILpfa;)Lub;", line = 84)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILji;I)V", line = 105)
