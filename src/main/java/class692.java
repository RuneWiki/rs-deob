...
public class class692 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!au", name = "c", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!au", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 70)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ljava/lang/Object;BJ)V", line = 105)
    ...
    @OriginalMember(owner = "client!au", name = "e", descriptor = "(I)I", line = 118)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IJ)V", line = 132)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ljava/lang/Object;JII)V", line = 146)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Z)J", line = 173)
    public static final long method3898(boolean arg0) {
        field9771++;
        return arg0 ? 27L : class639.field9177.method1351(0);
    }

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(B)I", line = 185)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)V", line = 196)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 248)
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 291)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(IIIII)V", line = 321)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(I)V", line = 342)
    public class692(int arg0) {
        this(arg0, arg0);
    }

    @OriginalMember(owner = "client!au", name = "a", descriptor = "(BLgaa;)V", line = 346)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(II)V", line = 368)
