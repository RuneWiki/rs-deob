...
public class class692 extends class547 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Ljava/net/Proxy;I)Ljava/net/Socket;", line = 13)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 36)
    ...
    @OriginalMember(owner = "client!bca", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 89)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(I)Ljava/net/Socket;", line = 168)
