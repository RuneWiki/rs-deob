...
public class class692 extends class469 implements class60 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ZIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 29)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIZ[B)V", line = 68)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(Lno;I[BI)V", line = 80)
    public class692(class658 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field9738 = arg1;
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)I", line = 88)
    public final int method493(boolean arg0) {
        ++field9734;
        return arg0 ? 36 : this.field9738;
    }

    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(I)J", line = 125)
    public final long method492(int arg0) {
        ++field9741;
        return arg0 >= -80 ? -109L : super.field6284.getAddress();
    }

    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIIIB[B[BII)V", line = 139)
