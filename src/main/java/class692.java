...
public class class692 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IIILha;IIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(III)Z", line = 40)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Z)I", line = 53)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 64)
