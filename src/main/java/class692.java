...
public class class692 extends class530 {
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(IIIIIILha;IILka;IIILec;)Lka;")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(ILah;)V")
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(Lah;)V")
