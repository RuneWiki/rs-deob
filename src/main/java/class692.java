...
public class class692 extends class58 implements class531 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(FFF)V", line = 3)
    public final void method401(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "()La;", line = 15)
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "()Z", line = 27)
    public final boolean method376() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "w", descriptor = "()Z", line = 34)
    public final boolean method421() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[I[I)Laa;", line = 37)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljj;)V", line = 50)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([IIIIIZ)Lhu;", line = 55)
    ...
    @OriginalMember(owner = "client!oa", name = "OA", descriptor = "()Ljava/lang/Object;", line = 58)
    private final Object method3901() {
        return new class386(this);
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Z)V", line = 61)
    public final void method407(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "y", descriptor = "()V", line = 64)
    public final void method426() {
        this.method417(this.field9756.field2528);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 68)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIII)Lkm;", line = 81)
    public final class353 method343(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 97)
    ...
    @OriginalMember(owner = "client!oa", name = "p", descriptor = "()V", line = 113)
    public final void method384() {
    }

    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V", line = 118)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(II)I", line = 147)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "()I", line = 158)
    public final int method350() {
        return 4;
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "()V", line = 162)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)Liaa;", line = 168)
    public final class493 method337(int arg0, int arg1) {
        return new class500(arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lur;[Lg;Z)Lda;", line = 172)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Luk;IIII)Lka;", line = 209)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;II)V", line = 212)
    ...
    @OriginalMember(owner = "client!oa", name = "m", descriptor = "()Z", line = 215)
    public final boolean method359() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "h", descriptor = "()V", line = 217)
    public final void method351() {
    }

    @OriginalMember(owner = "client!oa", name = "v", descriptor = "()Z", line = 221)
    public final boolean method420() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "t", descriptor = "()Z", line = 224)
    public final boolean method413() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "()V", line = 227)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkm;)V", line = 260)
    public final void method348(class353 arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpca;)V", line = 266)
    ...
    @OriginalMember(owner = "client!oa", name = "n", descriptor = "()V", line = 272)
    public final void method362() {
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkm;Lkm;FLkm;)Lkm;", line = 275)
    public final class353 method341(class353 arg0, class353 arg1, float arg2, class353 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lza;)V", line = 279)
    public final void method385(class413 arg0) {
        this.field9742 = (class51) arg0;
        this.method3915(arg0);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "()V", line = 283)
    public final void method331() {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 286)
    public final void method365(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I[Lada;)V", line = 291)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Z)V", line = 308)
    public final void method347(boolean arg0) {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(IIIIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lg;Z)Lhu;", line = 315)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(II)V", line = 320)
    ...
    @OriginalMember(owner = "client!oa", name = "f", descriptor = "(I)V", line = 330)
    public final void method392(int arg0) {
        this.field9761[arg0].method3517();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lkv;Liaa;)Ljj;", line = 334)
    public final class118 method423(class268 arg0, class493 arg1) {
        return new class609(this, (class539) arg0, (class500) arg1);
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([I)V", line = 339)
    ...
    @OriginalMember(owner = "client!oa", name = "j", descriptor = "()Ldfa;", line = 344)
    public final class165 method352() {
        return new class276();
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIILaa;IIIII)V", line = 346)
    ...
    @OriginalMember(owner = "client!oa", name = "l", descriptor = "()Z", line = 349)
    public final boolean method358() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "()Z", line = 352)
    public final boolean method326() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIII)V", line = 355)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "()V", line = 357)
    public final void method334() {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "()Z", line = 360)
    public final boolean method328() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "()Z", line = 368)
    public final boolean method431() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "A", descriptor = "()Z", line = 372)
    public final boolean method440() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 374)
    public final void method439(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(II)I", line = 379)
    public final int method404(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!oa", name = "s", descriptor = "()Z", line = 382)
    public final boolean method411() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "j", descriptor = "(I)V", line = 390)
    public final void method433(int arg0) {
        this.field9761[arg0].method3515();
    }

    @OriginalMember(owner = "client!oa", name = "g", descriptor = "(I)Lza;", line = 394)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpca;Z)V", line = 400)
    ...
    @OriginalMember(owner = "client!oa", name = "x", descriptor = "()Ldfa;", line = 430)
    public final class165 method422() {
        return this.field9748;
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(I)V", line = 437)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lpca;I)V", line = 445)
    public final void method402(class713 arg0, int arg1) {
        this.method3910(arg0, false);
        this.method3900().method3508(this, field9746, field9749, field9744, field9757, arg0.field10032.method1075(1));
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II[[I[[IIII)Ls;", line = 450)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 453)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIZ)Lhu;", line = 466)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIIIIIII)V", line = 469)
    ...
    @OriginalMember(owner = "client!oa", name = "k", descriptor = "()Z", line = 472)
    public final boolean method353() {
        return false;
    }

    @OriginalMember(owner = "client!oa", name = "u", descriptor = "()Ldfa;", line = 475)
    public final class165 method414() {
        return this.field9759;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIF)Lada;", line = 478)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 484)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Ldfa;)V", line = 507)
    public final void method339(class165 arg0) {
        this.field9759 = arg0;
        this.method3912(((class276) arg0).nativeid);
    }

    @OriginalMember(owner = "client!oa", name = "r", descriptor = "()Loba;", line = 511)
    public final class261 method395() {
        return new class261(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!oa", name = "WA", descriptor = "(S)Z", line = 517)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(II)Lkv;", line = 541)
    public final class268 method425(int arg0, int arg1) {
        return this.method332(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(IIIIII)V", line = 544)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZ)Lhu;", line = 552)
    public final class131 method332(int arg0, int arg1, boolean arg2) {
        return new class539(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!oa", name = "finalize", descriptor = "()V", line = 555)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 566)
    ...
    @OriginalMember(owner = "client!oa", name = "q", descriptor = "()Z", line = 582)
    public final boolean method394() {
        return true;
    }

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)V", line = 590)
    public final void method405(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8) {
    }

    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(S)Z", line = 603)
