...
public class class692 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILau;)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lau;BLtv;)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Z)Ltv;")
    ...
    @OriginalMember(owner = "client!au", name = "e", descriptor = "(I)Ltv;")
    ...
    @OriginalMember(owner = "client!au", name = "f", descriptor = "(I)Ltv;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Ltv;I)V")
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(Ltv;I)V")
    ...
    @OriginalMember(owner = "client!au", name = "h", descriptor = "(I)Ltv;")
    ...
    @OriginalMember(owner = "client!au", name = "i", descriptor = "(I)Ltv;")
