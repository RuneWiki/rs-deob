...
public class class211 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIILr;)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IILr;I)V")
    ...
    @OriginalMember(owner = "client!pk", name = "<init>", descriptor = "(Lhk;Lvca;)V")
    ...
    @OriginalMember(owner = "client!pk", name = "b", descriptor = "(IIILr;)Z")
