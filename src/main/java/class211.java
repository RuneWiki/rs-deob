...
public class class211 extends class296 {
    ...
    @OriginalMember(owner = "client!ff", name = "B", descriptor = "(CIIIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(CIIIZLta;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(Lih;Lqm;[Lwh;Z)V", line = 67)
