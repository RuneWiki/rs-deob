...
public abstract class class211 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lhb;Ljava/lang/String;IIIILth;IILsj;Lon;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 55)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lfs;ZLfs;)V", line = 119)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILae;)V", line = 136)
