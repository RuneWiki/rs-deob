...
public class class211 extends class227 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ILvda;)I", line = 3)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(ILaa;Liea;IBILria;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(IBB)V", line = 72)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(IIII)[B", line = 88)
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "()V", line = 102)
    public class211() {
