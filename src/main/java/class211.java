...
public class class211 extends class504 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "([B)V", line = 7)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I)I", line = 159)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "()V", line = 186)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "([I)Lfc;", line = 215)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "([BI)V", line = 275)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lbi;)Z", line = 284)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lbi;I)Ljda;", line = 304)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "([B)V", line = 322)
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lbi;II)Ljda;", line = 365)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "()I", line = 380)
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(I)F", line = 390)
    ...
    @OriginalMember(owner = "client!jda", name = "c", descriptor = "(I)[F", line = 401)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "([B)V", line = 816)
