...
public class class211 extends class446 {
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLjava/lang/String;I)Ljava/lang/String;", line = 74)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Z)I", line = 96)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLkh;)V", line = 107)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(ILkh;B)V", line = 128)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;BI)V", line = 172)
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(III)I", line = 234)
