...
public abstract class class211 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "([Ljava/lang/Object;B[J)V", line = 46)
    ...
    @OriginalMember(owner = "client!kn", name = "c", descriptor = "(B)Z", line = 66)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(I)Z", line = 79)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(B)V", line = 123)
