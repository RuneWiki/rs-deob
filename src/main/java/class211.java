...
public class class211 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!iba", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field2852++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(III)Z", line = 38)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(II)V", line = 92)
    public class211(int arg0, int arg1) {
        this.field2849 = arg0;
        this.field2848 = arg1;
    }

    @OriginalMember(owner = "client!iba", name = "c", descriptor = "(I)V", line = 105)
