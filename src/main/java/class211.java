...
public class class211 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)Lnaa;", line = 18)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BI)Ldu;", line = 45)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(BI)V", line = 131)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Z)V", line = 145)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lcr;ILla;Lla;)V", line = 186)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(II)Lnaa;", line = 170)
