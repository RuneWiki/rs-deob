...
public class class211 extends class392 {
    ...
    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(ILw;)V", line = 3)
    public class211(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Z)I", line = 23)
    public final int method292(boolean arg0) {
        ++field3083;
        return !arg0 ? 44 : 0;
    }

    @OriginalMember(owner = "client!ega", name = "<init>", descriptor = "(Lw;)V", line = 34)
    public class211(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!ega", name = "a", descriptor = "(Lfc;I[Lfo;)Lnw;", line = 51)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(II)I", line = 118)
    ...
    @OriginalMember(owner = "client!ega", name = "b", descriptor = "(Z)V", line = 130)
