...
public class class211 extends class346 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lir;Lir;I)V")
    ...
    @OriginalMember(owner = "client!dp", name = "e", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lwh;Ljava/awt/Canvas;II)Ltj;")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lfb;ZI)V")
