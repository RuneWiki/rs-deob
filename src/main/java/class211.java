...
public class class211 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IZI)Lev;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B[Lwv;I)V")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lio;I)V")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Ljava/awt/Component;I)Lsc;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IILio;)V")
