...
public class class211 {
    ...
    @OriginalMember(owner = "client!in", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BII[B)V", line = 35)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(JZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I[BBI)I", line = 67)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(B)Ljava/io/File;", line = 81)
    public final File method1371(byte arg0) {
        int var2 = -63 % ((arg0 - 38) / 63);
        return this.field3116;
    }

    @OriginalMember(owner = "client!in", name = "b", descriptor = "(B)J", line = 91)
