...
public class class211 extends class569 {
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(III)Ldn;", line = 22)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(III)Z", line = 36)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BC)Z", line = 66)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(II[I[I)V", line = 78)
