...
public class class211 extends class322 {
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lch;)V", line = 3)
    public class211(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(Z)I", line = 6)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(ILch;)V", line = 50)
    public class211(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(CZ)Z", line = 53)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)I", line = 115)
