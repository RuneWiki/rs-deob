...
public class class211 extends class125 {
    ...
    @OriginalMember(owner = "client!fp", name = "c", descriptor = "(Z)Lnm;")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "([I[I[ILps;B)V")
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lqg;I)V")
    public class211(class321 arg0, int arg1) {
        this.field3059 = arg0;
        this.field3056 = new class329(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILqf;)I")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lnm;FILnm;)Z")
