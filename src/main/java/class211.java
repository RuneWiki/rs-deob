...
public class class211 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IBI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZI)I", line = 21)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIIIIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Z", line = 202)
