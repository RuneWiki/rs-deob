...
public class class211 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(B)V", line = 788)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Z)V", line = 866)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(Z)V", line = 876)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)I", line = 919)
