...
public class class211 extends class522 implements class351 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIZLqa;)Llp;")
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(ILqa;)Lnf;")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ILqa;I)Lc;")
    public final class121 method9(int arg0, class162 arg1, int arg2) {
        ++field3066;
        return arg2 > -22 ? null : this.method1479(arg0, 18, arg1);
    }

    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(Lqa;Lkn;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIILic;IIZ)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lme;IIIIIILme;II)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IILqa;B)Z")
