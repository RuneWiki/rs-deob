...
public class class211 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(ZLvaa;[[B)V", line = 23)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IIILun;Lun;)V", line = 165)
