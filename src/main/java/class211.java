...
public class class211 extends class424 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IB)V", line = 33)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIBIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!iba", name = "b", descriptor = "(BII)B", line = 237)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(SI)V", line = 268)
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(III[[ZI)V", line = 286)
    ...
    @OriginalMember(owner = "client!iba", name = "<init>", descriptor = "(Lji;Lwo;Lpn;[I)V", line = 352)
