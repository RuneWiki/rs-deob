...
public class class211 implements Runnable {
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "(Liba;)V", line = 6)
    ...
    @OriginalMember(owner = "client!wfa", name = "a", descriptor = "()J", line = 15)
    public final long method1399() {
        return this.field2788;
    }

    @OriginalMember(owner = "client!wfa", name = "run", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!wfa", name = "b", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!wfa", name = "c", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!wfa", name = "d", descriptor = "()Z", line = 44)
    public final boolean method1402() {
        return this.field2790 == null || !this.field2784 && this.field2790.method3137(-1);
    }

    @OriginalMember(owner = "client!wfa", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class211(int arg0, class65 arg1) {
        this.field2783 = arg0;
        this.field2787 = arg1;
    }

    @OriginalMember(owner = "client!wfa", name = "e", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!wfa", name = "f", descriptor = "()V", line = 69)
