...
public class class211 extends class478 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ILnp;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "()V", line = 19)
    public class211() {
        super(1, false);
    }

    @OriginalMember(owner = "client!se", name = "c", descriptor = "(III)V", line = 22)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZI)[[I", line = 97)
    ...
    @OriginalMember(owner = "client!se", name = "c", descriptor = "(I)V", line = 175)
