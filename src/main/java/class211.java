...
public class class211 implements class702 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)Lve;")
    public final class527 method606(int arg0) {
        field3062++;
        return arg0 == 0 ? class468.field6683 : null;
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(ZZB)V")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(ILfda;Laba;IIIIIIIZ)V")
