...
public class class211 extends class601 {
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "()V", line = 11)
    public final void method1333() {
        this.field2809 = true;
    }

    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(IZ)V", line = 390)
    private class211(int arg0, boolean arg1) {
        this.method1346(arg0, arg1);
    }

    @OriginalMember(owner = "client!kw", name = "b", descriptor = "()Lbe;", line = 18)
    public final class33 method1334() {
        return this.field2807;
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Loa;)V", line = 23)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Loa;J)Z", line = 35)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(IZ)Lkw;", line = 84)
    ...
    @OriginalMember(owner = "client!kw", name = "c", descriptor = "()V", line = 97)
    private final void method1338() {
        this.field2796 = false;
    }

    @OriginalMember(owner = "client!kw", name = "d", descriptor = "()V", line = 100)
    public static void method1339() {
        field2803 = null;
        field2802 = null;
    }

    @OriginalMember(owner = "client!kw", name = "e", descriptor = "()Lbe;", line = 105)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Loa;[Lfca;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!kw", name = "f", descriptor = "()V", line = 201)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Loa;J[Lfca;[Lgl;Z)V", line = 237)
    ...
    @OriginalMember(owner = "client!kw", name = "g", descriptor = "()V", line = 252)
    public final void method1344() {
        this.field2796 = true;
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(J)V", line = 255)
    public final void method1345(long arg0) {
        this.field2799 = arg0;
    }

    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(IZ)V", line = 259)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "([Lgl;Z)V", line = 271)
