...
public class class211 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lpl;II)Luea;")
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Les;)V")
    ...
    @OriginalMember(owner = "client!uea", name = "c", descriptor = "()Loaa;")
