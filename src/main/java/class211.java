...
public class class211 extends class435 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILug;)Lqq;", line = 11)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILza;I)Le;", line = 61)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIIIIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(I)V", line = 173)
