...
public class class211 extends class133 implements class171 {
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(I)I", line = 6)
    public final int method409(int arg0) {
        ++field2571;
        return arg0 != -50 ? 78 : this.field2562.field6132;
    }

    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(Luo;B)V", line = 22)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Luo;B)V", line = 50)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(B)I", line = 62)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(B)I", line = 73)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Luo;II)Lge;", line = 95)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Luo;IIZ)Z", line = 107)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(Luo;B)Lkj;", line = 126)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(B)V", line = 178)
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "(Luo;Lnd;IIIIIIIZIIIII)V", line = 190)
    ...
    @OriginalMember(owner = "client!pr", name = "g", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BLuo;)V", line = 240)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Luo;IIIZBLpc;)V", line = 256)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)I", line = 267)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Luo;Lpc;III)V", line = 278)
    ...
    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(I)V", line = 324)
