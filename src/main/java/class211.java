...
public class class211 implements Runnable {
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 199)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!ik", name = "run", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(I[BIB)I", line = 125)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IB)Z", line = 168)
