...
public class class211 extends class350 implements class395 {
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lja;Lfb;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BILja;)Lrc;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZLja;)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lja;I)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILja;IIIILc;B)V")
