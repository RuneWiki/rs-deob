...
public class class211 extends class45 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)Lnd;", line = 22)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILdr;)V", line = 57)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)V", line = 1123)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(Z)V", line = 1149)
