...
public class class211 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!hd", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lgk;II)V", line = 32)
