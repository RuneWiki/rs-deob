...
public class class211 extends class313 {
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(IIIII)V", line = 5)
    public class211(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!jd", name = "g", descriptor = "(B)I", line = 8)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B[FI)[F", line = 23)
    ...
    @OriginalMember(owner = "client!jd", name = "h", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILol;IIIIIILol;)V", line = 53)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLr;)Lll;", line = 119)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(ILr;)Lod;", line = 138)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lr;Z)V", line = 311)
    ...
    @OriginalMember(owner = "client!jd", name = "g", descriptor = "(I)I", line = 321)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ZILr;I)Z", line = 332)
    ...
    @OriginalMember(owner = "client!jd", name = "i", descriptor = "(I)Z", line = 368)
    public final boolean method402(int arg0) {
        ++field3519;
        return arg0 != 623404585 ? false : this.field3511;
    }

    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(I)V", line = 379)
    public static void method1602(int arg0) {
        int var1 = 66 / ((arg0 - 21) / 39);
        field3517 = null;
    }

    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)V", line = 400)
