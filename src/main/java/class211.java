...
public class class211 extends class452 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(Z)I", line = 17)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZIBII)V", line = 28)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(Z)V", line = 71)
    ...
    @OriginalMember(owner = "client!en", name = "j", descriptor = "(I)I", line = 112)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(B)J", line = 123)
    ...
    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(II)V", line = 138)
