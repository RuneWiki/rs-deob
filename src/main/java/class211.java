...
public class class211 extends class96 {
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!on", name = "e", descriptor = "(B)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ILae;)Ljava/lang/String;", line = 84)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!on", name = "e", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(II)Lak;", line = 150)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lae;I)V", line = 165)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lae;II)V", line = 184)
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "(Z)V", line = 255)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lae;I[I)V", line = 269)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIZ)I", line = 299)
