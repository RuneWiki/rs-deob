...
public class class211 extends class349 {
    ...
    @OriginalMember(owner = "client!st", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IILdga;)V", line = 28)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(BI)[I", line = 54)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(ZI)V", line = 80)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "()V", line = 91)
    public class211() {
        this(4096);
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(JIIB)V", line = 96)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II)V", line = 140)
