...
public class class211 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILgk;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ZLgo;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lgk;B)V", line = 88)
