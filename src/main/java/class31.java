...
public class class31 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(II)Lvq;", line = 23)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IB)V", line = 108)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BI)V", line = 125)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Ljc;IZLgp;Lgp;)V", line = 179)
