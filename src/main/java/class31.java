...
public class class31 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IB)V", line = 38)
    ...
    @OriginalMember(owner = "client!kha", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IIII)Z", line = 61)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;I)V", line = 201)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(BB)Z", line = 250)
