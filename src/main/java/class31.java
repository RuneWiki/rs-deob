...
public class class31 {
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Llm;BJ)V", line = 92)
    ...
    @OriginalMember(owner = "client!ov", name = "<init>", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ov", name = "b", descriptor = "(I)Llm;", line = 144)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(Z)V", line = 179)
    ...
    @OriginalMember(owner = "client!ov", name = "a", descriptor = "(JI)Llm;", line = 194)
