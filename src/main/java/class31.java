...
public class class31 extends class85 {
    ...
    @OriginalMember(owner = "client!d", name = "fb", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!d", name = "X", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!d", name = "T", descriptor = "Llf;")
    public static class109 field729 = field733;

    @OriginalMember(owner = "client!d", name = "hb", descriptor = "Llf;")
    private static class109 field743 = class35.method275("World", 2);

    @OriginalMember(owner = "client!d", name = "bb", descriptor = "Llf;")
    public static class109 field737 = field743;

    @OriginalMember(owner = "client!d", name = "cb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILuc;)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BI)Lng;")
