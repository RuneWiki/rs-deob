...
public abstract class class31 extends class361 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 4)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILhm;Lul;Lta;IIILjava/lang/String;IIILla;)V", line = 66)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(B)Lfp;", line = 116)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lza;ILfp;Ljd;II)Z", line = 145)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILoi;Loi;)I", line = 366)
