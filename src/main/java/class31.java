...
public class class31 extends class354 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BIIII)I", line = 57)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "()V", line = 83)
    public class31() {
        super(1, true);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "(I)Lda;", line = 100)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILti;I)V", line = 144)
