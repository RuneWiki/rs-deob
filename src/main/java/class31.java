...
public class class31 extends class145 {
    ...
    @OriginalMember(owner = "client!mq", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZI)[[I", line = 13)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "()V", line = 339)
    public class31() {
        super(2, false);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lap;BI)V", line = 343)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)[I", line = 382)
    ...
    @OriginalMember(owner = "client!mq", name = "f", descriptor = "(I)V", line = 624)
