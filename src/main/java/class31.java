...
public class class31 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILdh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Z)Z", line = 35)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)Lgu;", line = 62)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldh;B)Lul;", line = 84)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIB)V", line = 95)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Ldh;I)V", line = 119)
