...
public class class31 extends class48 {
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "(Lql;Lbo;)V", line = 102)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "()V", line = 163)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Z)V", line = 187)
    public final void method70(boolean arg0) {
    }

    @OriginalMember(owner = "client!mq", name = "b", descriptor = "()Z", line = 189)
    public final boolean method74() {
        return true;
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lna;)V", line = 193)
    public final void method71(class50 arg0) {
        this.field480.method2032(arg0);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "()V", line = 196)
