...
public class class31 extends class398 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([[B[[I[[B[[BLii;Lck;Z[[BIIIILck;)V", line = 256)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Lnj;II)V", line = 1052)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(I)V", line = 1092)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "()V", line = 1115)
    public class31() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IIZ)I", line = 1119)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(II)[[I", line = 1155)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(Z)V", line = 1214)
    ...
    @OriginalMember(owner = "client!mq", name = "c", descriptor = "(B)V", line = 1228)
