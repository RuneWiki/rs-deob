...
public class class31 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lkh;ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lya;Lok;ILok;)V", line = 75)
    ...
    @OriginalMember(owner = "client!oo", name = "toString", descriptor = "()Ljava/lang/String;", line = 101)
    public final String toString() {
        field443++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)I", line = 120)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)V", line = 132)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 151)
    public class31(String arg0, int arg1) {
        this.field447 = arg1;
    }

    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(Z)V", line = 161)
