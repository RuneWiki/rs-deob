...
public class class31 {
    ...
    @OriginalMember(owner = "client!ICYGYVTE", name = "d", descriptor = "LOAUECDUZ;")
    ...
    @OriginalMember(owner = "client!ICYGYVTE", name = "b", descriptor = "[LICYGYVTE;")
    ...
    @OriginalMember(owner = "client!ICYGYVTE", name = "b", descriptor = "(I)LICYGYVTE;")
