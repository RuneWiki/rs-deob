...
public class class31 extends class212 {
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(ILdh;)V", line = 24)
    public class31(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(Ldh;)V", line = 33)
    public class31(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(II)V", line = 57)
    ...
    @OriginalMember(owner = "client!mca", name = "d", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!mca", name = "e", descriptor = "(I)I", line = 85)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(I)I", line = 99)
