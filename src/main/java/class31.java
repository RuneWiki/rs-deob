...
public class class31 extends class278 {
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(II)[I", line = 47)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "()V", line = 474)
    public class31() {
        super(0, true);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Llh;II)V", line = 280)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIIIIIIIIIIIII)V", line = 367)
