...
public class class31 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lhd;")
    ...
    @OriginalMember(owner = "client!vo", name = "b", descriptor = "(II)Lvp;")
    ...
    @OriginalMember(owner = "client!vo", name = "<init>", descriptor = "(Lci;ILhe;)V")
