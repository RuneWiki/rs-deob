...
public class class31 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Len;Ljava/lang/String;[IIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "()I", line = 24)
    public final int method176() {
        return this.field283 - 1;
    }

    @OriginalMember(owner = "client!gp", name = "b", descriptor = "()V", line = 30)
    public static void method177() {
        field286 = null;
    }

    @OriginalMember(owner = "client!gp", name = "c", descriptor = "()I", line = 33)
    public final int method178() {
        return this.field287;
    }

    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Len;IZLjava/awt/Component;)V", line = 192)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Len;Ljava/lang/String;IIIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Ljava/lang/String;)I", line = 58)
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(Len;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 75)
