...
public class class31 {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(BLvc;)V", line = 15)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(I)V", line = 32)
