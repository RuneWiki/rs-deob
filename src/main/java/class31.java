...
public class class31 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IZB)Ljava/lang/String;", line = 67)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)V", line = 82)
