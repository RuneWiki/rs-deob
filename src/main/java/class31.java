...
@OriginalClass("client!LYZBHNJP")
public class class31 {

    @OriginalMember(owner = "client!LYZBHNJP", name = "a", descriptor = "I")
    private int field1031 = 9;

    @OriginalMember(owner = "client!LYZBHNJP", name = "b", descriptor = "I")
    private int field1032 = -963;

    @OriginalMember(owner = "client!LYZBHNJP", name = "c", descriptor = "I")
    private int field1033 = -302;

    @OriginalMember(owner = "client!LYZBHNJP", name = "d", descriptor = "Z")
    private boolean field1034 = false;

    @OriginalMember(owner = "client!LYZBHNJP", name = "f", descriptor = "I")
    public int field1036;

    @OriginalMember(owner = "client!LYZBHNJP", name = "k", descriptor = "Z")
    private boolean field1041;

    @OriginalMember(owner = "client!LYZBHNJP", name = "e", descriptor = "[B")
    public byte[] field1035;

    @OriginalMember(owner = "client!LYZBHNJP", name = "g", descriptor = "[I")
    public int[] field1037;

    @OriginalMember(owner = "client!LYZBHNJP", name = "h", descriptor = "[I")
    public int[] field1038;

    @OriginalMember(owner = "client!LYZBHNJP", name = "i", descriptor = "[I")
    public int[] field1039;

    @OriginalMember(owner = "client!LYZBHNJP", name = "j", descriptor = "[I")
    public int[] field1040;

    @OriginalMember(owner = "client!LYZBHNJP", name = "<init>", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!LYZBHNJP", name = "a", descriptor = "([BI)V")
    ...
    @OriginalMember(owner = "client!LYZBHNJP", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
