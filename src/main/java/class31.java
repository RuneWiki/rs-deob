...
public class class31 extends class11 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Leh;I)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)Llj;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(B[ILeh;)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IILeh;)V")
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(II)Lae;")
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(BLeh;)Ljava/lang/String;")
