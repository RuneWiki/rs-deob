...
@OriginalClass("client!KMJDCQND")
public class class31 {

    @OriginalMember(owner = "client!KMJDCQND", name = "a", descriptor = "I")
    private int field1078 = 45903;

    @OriginalMember(owner = "client!KMJDCQND", name = "b", descriptor = "I")
    private int field1079 = -43;

    @OriginalMember(owner = "client!KMJDCQND", name = "k", descriptor = "[I")
    private int[] field1088 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "l", descriptor = "[I")
    private int[] field1089 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "m", descriptor = "[I")
    private int[] field1090 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "o", descriptor = "I")
    private int field1092 = 100;

    @OriginalMember(owner = "client!KMJDCQND", name = "r", descriptor = "I")
    public int field1095 = 500;

    @OriginalMember(owner = "client!KMJDCQND", name = "w", descriptor = "[I")
    private static int[] field1100 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "x", descriptor = "[I")
    private static int[] field1101 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "y", descriptor = "[I")
    private static int[] field1102 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "z", descriptor = "[I")
    private static int[] field1103 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "A", descriptor = "[I")
    private static int[] field1104 = new int[5];

    @OriginalMember(owner = "client!KMJDCQND", name = "n", descriptor = "I")
    private int field1091;

    @OriginalMember(owner = "client!KMJDCQND", name = "s", descriptor = "I")
    public int field1096;

    @OriginalMember(owner = "client!KMJDCQND", name = "c", descriptor = "LKMZLAUEV;")
    private class32 field1080;

    @OriginalMember(owner = "client!KMJDCQND", name = "d", descriptor = "LKMZLAUEV;")
    private class32 field1081;

    @OriginalMember(owner = "client!KMJDCQND", name = "e", descriptor = "LKMZLAUEV;")
    private class32 field1082;

    @OriginalMember(owner = "client!KMJDCQND", name = "f", descriptor = "LKMZLAUEV;")
    private class32 field1083;

    @OriginalMember(owner = "client!KMJDCQND", name = "g", descriptor = "LKMZLAUEV;")
    private class32 field1084;

    @OriginalMember(owner = "client!KMJDCQND", name = "h", descriptor = "LKMZLAUEV;")
    private class32 field1085;

    @OriginalMember(owner = "client!KMJDCQND", name = "i", descriptor = "LKMZLAUEV;")
    private class32 field1086;

    @OriginalMember(owner = "client!KMJDCQND", name = "j", descriptor = "LKMZLAUEV;")
    private class32 field1087;

    @OriginalMember(owner = "client!KMJDCQND", name = "q", descriptor = "LKMZLAUEV;")
    private class32 field1094;

    @OriginalMember(owner = "client!KMJDCQND", name = "p", descriptor = "LQEWPNZTS;")
    private class47 field1093;

    @OriginalMember(owner = "client!KMJDCQND", name = "t", descriptor = "[I")
    private static int[] field1097;

    @OriginalMember(owner = "client!KMJDCQND", name = "u", descriptor = "[I")
    private static int[] field1098;

    @OriginalMember(owner = "client!KMJDCQND", name = "v", descriptor = "[I")
    private static int[] field1099;

    @OriginalMember(owner = "client!KMJDCQND", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!KMJDCQND", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!KMJDCQND", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!KMJDCQND", name = "a", descriptor = "(LKHOMSBHW;I)V")
