...
public class class31 extends class122 implements class103 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(III[I)V", line = 4)
    public final void method178(int arg0, int arg1, int arg2, int[] arg3) {
        this.method186(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!i", name = "finalize", descriptor = "()V", line = 18)
    protected final void finalize() {
        class1.method1(this, (byte) -31);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "()Lc;", line = 26)
