...
public abstract class class31 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILjava/lang/String;[Lc;[IIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BILjava/lang/String;IIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIILjava/lang/String;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILjava/lang/String;)V", line = 127)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "([II[Lc;BLjava/lang/String;[II[I)V", line = 199)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 367)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IB)I", line = 399)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IZI)V", line = 410)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)V", line = 430)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II[IIIII[Lc;IILjava/lang/String;IIIILem;)I", line = 442)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III[Lc;[ILjava/util/Random;Ljava/lang/String;III)I", line = 530)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "([IIII[Lc;Lem;ILjava/lang/String;I)V", line = 570)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIII)V", line = 723)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIZLjava/lang/String;)V", line = 762)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIILjava/util/Random;IIII[III[Lc;[IILjava/lang/String;)I", line = 779)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(IIIIZLjava/lang/String;)V", line = 856)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)Lgm;", line = 872)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Luo;Lfa;)V", line = 906)
    public class31(class118 arg0, class347 arg1) {
        this.field335 = arg0;
        this.field346 = arg1;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBILjava/lang/String;II)V", line = 918)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 942)
