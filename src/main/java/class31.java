...
public class class31 {
    ...
    @OriginalMember(owner = "client!KWOZHDOE", name = "p", descriptor = "LBMQRLUHC;")
    private class5 field1060;

    @OriginalMember(owner = "client!KWOZHDOE", name = "c", descriptor = "LYJSRODCC;")
    private class64 field1047;

    @OriginalMember(owner = "client!KWOZHDOE", name = "d", descriptor = "LYJSRODCC;")
    private class64 field1048;

    @OriginalMember(owner = "client!KWOZHDOE", name = "e", descriptor = "LYJSRODCC;")
    private class64 field1049;

    @OriginalMember(owner = "client!KWOZHDOE", name = "f", descriptor = "LYJSRODCC;")
    private class64 field1050;

    @OriginalMember(owner = "client!KWOZHDOE", name = "g", descriptor = "LYJSRODCC;")
    private class64 field1051;

    @OriginalMember(owner = "client!KWOZHDOE", name = "h", descriptor = "LYJSRODCC;")
    private class64 field1052;

    @OriginalMember(owner = "client!KWOZHDOE", name = "i", descriptor = "LYJSRODCC;")
    private class64 field1053;

    @OriginalMember(owner = "client!KWOZHDOE", name = "j", descriptor = "LYJSRODCC;")
    private class64 field1054;

    @OriginalMember(owner = "client!KWOZHDOE", name = "q", descriptor = "LYJSRODCC;")
    ...
    @OriginalMember(owner = "client!KWOZHDOE", name = "a", descriptor = "(LPGNBHFUF;I)V")
