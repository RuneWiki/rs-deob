...
public class class31 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lps;IB)V", line = 6)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BLps;)V", line = 53)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Throwable;)V", line = 88)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIIIBI)V", line = 152)
