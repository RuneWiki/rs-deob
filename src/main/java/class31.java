...
public class class31 {
    ...
    @OriginalMember(owner = "client!LVQCDTJA", name = "c", descriptor = "[LLVQCDTJA;")
    public static class31[] field1035;

    @OriginalMember(owner = "client!LVQCDTJA", name = "a", descriptor = "(LFNOQZAYQ;I)V")
    ...
    @OriginalMember(owner = "client!LVQCDTJA", name = "a", descriptor = "(LDNRIFKTO;IB)V")
