...
public class class31 extends class125 {
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(ILgp;)V")
    public class31(int arg0, class549 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jha", name = "a", descriptor = "([[BLdu;B)V")
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ILhga;)[Luv;")
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lgp;)V")
    public class31(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(BI)V")
    ...
    @OriginalMember(owner = "client!jha", name = "c", descriptor = "(Z)I")
