...
public class class31 implements class212 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(JJ)J", line = 3)
    public static long method391(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ZIIIIF)[I", line = 10)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IZIFII)[F", line = 29)
    ...
    @OriginalMember(owner = "client!tfa", name = "b", descriptor = "(II)Lve;", line = 40)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(II)Z", line = 69)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Lrm;I)I", line = 84)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IB)Lah;", line = 157)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IBI)I", line = 169)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(ILgba;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(IZIBIF)[I", line = 228)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Z)I", line = 239)
    ...
    @OriginalMember(owner = "client!tfa", name = "<init>", descriptor = "(Ljn;Ljn;Ljn;)V", line = 253)
