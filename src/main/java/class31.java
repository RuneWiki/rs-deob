...
public class class31 extends class123 {
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lha;J)V", line = 8)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Lmd;IIIIIIIIIIIZZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "()V", line = 203)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "()V", line = 213)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lmd;IIIIIIIIIIIZZ)V", line = 222)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(JI)V", line = 242)
