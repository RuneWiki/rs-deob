...
public class class31 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILes;I)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)Lcr;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lbn;I)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Les;I)V")
