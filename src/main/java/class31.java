...
public class class31 extends class283 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!mca", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lcu;ZI)V", line = 44)
    ...
    @OriginalMember(owner = "client!mca", name = "<init>", descriptor = "(Lac;)V", line = 57)
    public class31(class541 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ZZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(ZI)V", line = 73)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(IB)Z", line = 84)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(B)V", line = 99)
