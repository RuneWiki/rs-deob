...
public class class31 {
    ...
    @OriginalMember(owner = "client!LIHJZCBF", name = "c", descriptor = "[LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!LIHJZCBF", name = "a", descriptor = "(J)LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!LIHJZCBF", name = "a", descriptor = "(LJBHJGXME;JI)V")
