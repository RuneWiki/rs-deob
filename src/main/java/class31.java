...
public class class31 extends class449 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILnl;)I", line = 7)
    ...
    @OriginalMember(owner = "client!mm", name = "d", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!mm", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILwg;)V", line = 190)
