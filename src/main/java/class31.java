...
public abstract class class31 extends class189 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(FFI[BIILpj;IFFFIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 24)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(III)Z", line = 81)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 101)
