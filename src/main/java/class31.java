...
public class class31 extends class20 {
    ...
    @OriginalMember(owner = "client!NUXITFPR", name = "<init>", descriptor = "(LDTIATKJO;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!NUXITFPR", name = "a", descriptor = "(ILKZTQXFDC;ZI)V")
