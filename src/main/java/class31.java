...
public class class31 extends class638 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ZLre;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(II)Lvfa;", line = 40)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Lr;III[Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ILofa;)Lhj;", line = 111)
