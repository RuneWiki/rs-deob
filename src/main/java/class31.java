...
public class class31 extends class319 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lha;B)Lel;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lka;BLha;Luu;)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lha;Lwea;ZIIII)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZLha;)Lka;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILha;)Ldfa;")
