...
public class class31 extends class530 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IIBIIILha;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lah;)V", line = 61)
    public class31(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(ILah;)V", line = 64)
    public class31(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)I", line = 110)
    public final int method74(int arg0) {
        ++field479;
        return arg0 != 0 ? 116 : 1;
    }

    @OriginalMember(owner = "client!jha", name = "c", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(II)I", line = 139)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(II[IIIII[FI[I[FII)V", line = 153)
