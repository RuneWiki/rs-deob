...
@OriginalClass("client!MNHXSMWL")
public class class31 {

    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "Z")
    private boolean field907 = true;

    @OriginalMember(owner = "client!MNHXSMWL", name = "b", descriptor = "I")
    private int field908 = -46309;

    @OriginalMember(owner = "client!MNHXSMWL", name = "c", descriptor = "I")
    private int field909 = 726;

    @OriginalMember(owner = "client!MNHXSMWL", name = "d", descriptor = "I")
    private int field910 = 49110;

    @OriginalMember(owner = "client!MNHXSMWL", name = "e", descriptor = "I")
    private int field911 = 49110;

    @OriginalMember(owner = "client!MNHXSMWL", name = "f", descriptor = "Z")
    private boolean field912 = true;

    @OriginalMember(owner = "client!MNHXSMWL", name = "g", descriptor = "Z")
    private boolean field913 = false;

    @OriginalMember(owner = "client!MNHXSMWL", name = "h", descriptor = "I")
    private int field914 = -868;

    @OriginalMember(owner = "client!MNHXSMWL", name = "i", descriptor = "I")
    public int field915 = 0;

    @OriginalMember(owner = "client!MNHXSMWL", name = "j", descriptor = "I")
    public int field916 = 0;

    @OriginalMember(owner = "client!MNHXSMWL", name = "k", descriptor = "I")
    public int field917;

    @OriginalMember(owner = "client!MNHXSMWL", name = "l", descriptor = "I")
    public int field918;

    @OriginalMember(owner = "client!MNHXSMWL", name = "m", descriptor = "[[I")
    public int[][] field919;

    @OriginalMember(owner = "client!MNHXSMWL", name = "<init>", descriptor = "(IZI)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(IIIZIII)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "b", descriptor = "(III)V")
    private void method272(int arg0, int arg1, int arg2) {
        this.field919[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(ZIIIIZ)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(ZIIIIBI)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(IZII)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "c", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(BIIIIII)Z")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(IIIIIZI)Z")
    ...
    @OriginalMember(owner = "client!MNHXSMWL", name = "a", descriptor = "(IIIIIIII)Z")
