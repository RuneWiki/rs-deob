...
public class class31 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZ)Z", line = 73)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)V", line = 91)
