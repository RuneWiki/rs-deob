...
@OriginalClass("client!ILVDIPQT")
public class class31 {

    @OriginalMember(owner = "client!ILVDIPQT", name = "a", descriptor = "I")
    private int field956 = 431;

    @OriginalMember(owner = "client!ILVDIPQT", name = "b", descriptor = "Z")
    private boolean field957 = false;

    @OriginalMember(owner = "client!ILVDIPQT", name = "c", descriptor = "Z")
    private boolean field958 = true;

    @OriginalMember(owner = "client!ILVDIPQT", name = "d", descriptor = "LTLIWLEHU;")
    public class54 field959 = new class54();

    @OriginalMember(owner = "client!ILVDIPQT", name = "e", descriptor = "LTLIWLEHU;")
    private class54 field960;

    @OriginalMember(owner = "client!ILVDIPQT", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "a", descriptor = "(LTLIWLEHU;)V")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "a", descriptor = "(LTLIWLEHU;I)V")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "a", descriptor = "()LTLIWLEHU;")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "b", descriptor = "()LTLIWLEHU;")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "a", descriptor = "(Z)LTLIWLEHU;")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "a", descriptor = "(I)LTLIWLEHU;")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "b", descriptor = "(I)LTLIWLEHU;")
    ...
    @OriginalMember(owner = "client!ILVDIPQT", name = "c", descriptor = "()V")
