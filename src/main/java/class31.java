...
public abstract class class31 {
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mca", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!mca", name = "a", descriptor = "(Lnd;BI)Lbr;", line = 34)
