...
public class class31 extends class249 {
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lui;I)Z", line = 56)
    ...
    @OriginalMember(owner = "client!lm", name = "i", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IBI)V", line = 99)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)I", line = 193)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Lah;ZLah;I)V", line = 206)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)Z", line = 362)
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lih;)V", line = 391)
