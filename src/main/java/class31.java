...
public abstract class class31 extends class507 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ZLla;Ljava/lang/String;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!i", name = "d", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!i", name = "e", descriptor = "(I)V", line = 48)
