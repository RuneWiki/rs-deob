...
public class class31 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)Z", line = 10)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)I", line = 36)
    public final int method194(int arg0) {
        field552++;
        return arg0 == 0 ? this.field548 : -69;
    }

    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(ZIIZ)V", line = 60)
