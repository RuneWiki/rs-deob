...
public class class31 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILtl;)V")
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(I)Lro;")
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)Lro;")
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IILtl;)V")
