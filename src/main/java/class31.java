...
public class class31 extends class585 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZLha;Z)Lda;")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BIILvn;I)V")
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Lso;II)V")
