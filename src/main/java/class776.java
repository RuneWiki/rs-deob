...
public class class776 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljc;I)Ltc;", line = 17)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 47)
    ...
    @OriginalMember(owner = "client!kka", name = "<init>", descriptor = "(IZ)V", line = 177)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 70)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(BLjava/lang/String;)V", line = 88)
    ...
    @OriginalMember(owner = "client!kka", name = "toString", descriptor = "()Ljava/lang/String;", line = 99)
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(II)I", line = 123)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljc;B)Lsm;", line = 158)
