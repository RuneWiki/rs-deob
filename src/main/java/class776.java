...
public class class776 extends class154 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)Z", line = 13)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(IIIIIZ)V", line = 36)
