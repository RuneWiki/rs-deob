...
public class class776 extends class325 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(Ljp;IB)V", line = 38)
    ...
    @OriginalMember(owner = "client!pn", name = "d", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IB)[[I", line = 129)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "()V", line = 171)
    public class776() {
        super(1, false);
    }
}
