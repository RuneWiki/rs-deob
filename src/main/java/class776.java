...
public class class776 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IB)Lnba;", line = 3)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 40)
    public static void method4268(byte arg0) {
        field10669 = null;
        int var1 = 32 / ((6 - arg0) / 57);
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIIIII)Z", line = 54)
