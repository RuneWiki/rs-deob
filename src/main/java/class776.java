...
public abstract class class776 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)Lui;")
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(B)Lnj;")
    ...
    @OriginalMember(owner = "client!kr", name = "f", descriptor = "(I)Lus;")
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(B)Lpp;")
