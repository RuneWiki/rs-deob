...
public class class112 implements Runnable {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Class;Ljava/lang/Class;B)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILjava/lang/Runnable;B)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLjava/net/URL;)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/awt/Frame;I)Lrp;")
    public final class280 method615(Frame arg0, int arg1) {
        return arg1 == 26420 ? this.method616(arg0, 0, arg1 ^ 0x988C, 7, 0) : null;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IZILjava/lang/String;)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)Lhh;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)Lrp;")
    public final class280 method621(int arg0, int arg1) {
        return arg0 == 65535 ? this.method616(null, arg1, 65464, 3, 0) : null;
    }

    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILjava/lang/String;)Lhh;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IBIII)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLjava/lang/String;)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ZILjava/lang/String;)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILjava/awt/Point;Ljava/awt/Component;[III)Lrp;")
    ...
    @OriginalMember(owner = "client!cr", name = "d", descriptor = "(I)Lrp;")
