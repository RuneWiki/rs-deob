...
public class class112 extends class85 {
    ...
    @OriginalMember(owner = "client!m", name = "ab", descriptor = "Llf;")
    private static class109 field2223 = class35.method275(" seconds)3", 2);

    @OriginalMember(owner = "client!m", name = "S", descriptor = "Llf;")
    public static class109 field2215 = field2223;

    @OriginalMember(owner = "client!m", name = "Y", descriptor = "Llf;")
    public static class109 field2221 = class35.method275("RuneScape wurde aktualisiert(Q", 2);

    @OriginalMember(owner = "client!m", name = "Z", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(BILja;)V")
