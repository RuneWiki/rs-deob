...
public abstract class class112 implements class742 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFFFIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIII)V", line = 36)
    public final void method783(int arg0, int arg1, int arg2, int arg3) {
        this.method778(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFFFFFIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(II)V", line = 42)
    public final void method785(int arg0, int arg1) {
        this.method795(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(IIII)V", line = 52)
    public final void method791(int arg0, int arg1, int arg2, int arg3) {
        this.method788(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFIILaa;II)V", line = 65)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFII)V", line = 71)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(FFFFIILaa;II)V", line = 75)
