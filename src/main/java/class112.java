...
public class class112 extends class98 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(II)[[I", line = 18)
    ...
    @OriginalMember(owner = "client!sa", name = "d", descriptor = "(I)I", line = 84)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 101)
    public class112() {
        super(0, false);
    }

    @OriginalMember(owner = "client!sa", name = "e", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILdg;I)V", line = 120)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III)V", line = 141)
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(I)V", line = 161)
