...
public class class112 extends class161 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Le;ZII[BI[Lfn;)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Ljg;ILap;I)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lmo;Lmo;Z)V")
