...
public class class112 extends class149 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IBLtl;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(III)I", line = 18)
    ...
    @OriginalMember(owner = "client!wu", name = "d", descriptor = "(III)I", line = 42)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BI)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIBIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "()V", line = 168)
    public class112() {
        super(3, false);
    }

    @OriginalMember(owner = "client!wu", name = "e", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II)[I", line = 189)
