...
public class class112 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(III[B)Ljava/lang/String;", line = 32)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(I)V", line = 127)
