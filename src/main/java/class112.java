...
public class class112 extends class121 implements class340 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "()I", line = 4)
    public final int method49() {
        return super.method49();
    }

    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(Lpa;)V", line = 8)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lks;ILjava/nio/ByteBuffer;Z)V", line = 11)
    public class112(class173 arg0, int arg1, ByteBuffer arg2, boolean arg3) {
        super(arg0, 34962, arg2, arg3);
        this.field1543 = arg1;
    }

    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lks;I[BIZ)V", line = 15)
    public class112(class173 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1543 = arg1;
    }

    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(Lpa;)V", line = 19)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I[BI)V", line = 22)
    public final void method373(int arg0, byte[] arg1, int arg2) {
        this.method820(arg1, arg2);
        this.field1543 = arg0;
    }

    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(Lpa;)V", line = 26)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "()V", line = 29)
    public final void method52() {
        this.field1614.method1172(this);
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lpa;)V", line = 33)
