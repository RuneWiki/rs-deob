...
public class class112 extends class134 {
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(ILkda;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILnq;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lkda;)V")
