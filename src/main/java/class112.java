...
public class class112 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIZ)Z", line = 19)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)V", line = 68)
