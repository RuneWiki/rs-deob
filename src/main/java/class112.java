...
public class class112 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lmh;I)Z")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLgk;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lgk;)V")
