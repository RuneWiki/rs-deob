...
public class class112 extends class469 {
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lml;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!gfa", name = "a", descriptor = "(IIIZI)V")
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lml;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!gfa", name = "<init>", descriptor = "(Lml;II)V")
    ...
    @OriginalMember(owner = "client!gfa", name = "c", descriptor = "(B)V")
