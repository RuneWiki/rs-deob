...
public class class112 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lbt;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IILbt;)V", line = 133)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLbt;)Lrm;", line = 196)
