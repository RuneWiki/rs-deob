...
public class class112 implements class104 {
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)Lfl;", line = 192)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IB)V", line = 207)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Ljava/lang/String;Lffa;Loca;IIIIIIIIII)V", line = 225)
