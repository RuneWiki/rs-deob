...
public class class112 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(CLjava/lang/String;I)[Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIII)I", line = 94)
