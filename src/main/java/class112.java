...
public class class112 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IIIILza;IIIII)V")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZLza;)Z")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Ltn;Z)Z")
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lza;Llb;IIIII)V")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(I[Lbm;IIII)V")
