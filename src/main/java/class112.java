...
public class class112 extends class739 {
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "()V", line = 16)
    public class112() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wd", name = "c", descriptor = "(II)Ljia;", line = 20)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(II)[[I", line = 86)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lsl;IB)V", line = 218)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZI)[I", line = 267)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 361)
