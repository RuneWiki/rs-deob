...
public class class112 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(BJLme;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(I)Lme;", line = 28)
    ...
    @OriginalMember(owner = "client!qha", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qha", name = "d", descriptor = "(I)Lme;", line = 91)
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(BI)V", line = 112)
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(Z)Lme;", line = 125)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(I[Lme;)I", line = 159)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!qha", name = "e", descriptor = "(I)I", line = 199)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(JI)Lme;", line = 219)
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(I)I", line = 248)
    ...
    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "(I)V", line = 395)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(Z)I", line = 417)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(BI)I", line = 451)
