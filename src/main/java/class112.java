...
public class class112 extends class354 {
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BJLqa;)V", line = 18)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "()V", line = 52)
    public class112() {
        super(0, true);
    }

    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(B)V", line = 59)
