...
public class class112 extends class85 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IILbt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZLbt;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIIIBIIIIIILbm;)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 490)
    ...
    @OriginalMember(owner = "client!ci", name = "f", descriptor = "(I)[Ldg;", line = 500)
