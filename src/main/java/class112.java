...
public class class112 extends class362 implements class21 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILza;I)Le;", line = 20)
    ...
    @OriginalMember(owner = "client!jh", name = "g", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!jh", name = "h", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lza;ZIZ)Lqr;", line = 55)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(I)Z", line = 88)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILza;I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lza;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!jh", name = "f", descriptor = "(I)I", line = 133)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)I", line = 147)
    public final int method114(int arg0) {
        ++field1509;
        return arg0 != -9772 ? -116 : this.field1515;
    }

    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(Lza;B)Lkf;", line = 159)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILza;)Le;", line = 187)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lza;B)V", line = 210)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(ILza;)V", line = 237)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)I", line = 266)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lza;Lfu;IIIIZIIIII)V", line = 292)
