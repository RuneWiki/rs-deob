...
public class class112 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILqa;IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILqa;I)Z")
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(I[Lsb;IIII)V")
