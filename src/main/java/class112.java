...
public class class112 extends class378 {
    ...
    @OriginalMember(owner = "client!bm", name = "b", descriptor = "(B)Lvq;", line = 5)
    ...
    @OriginalMember(owner = "client!bm", name = "c", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lln;IIIIII)V", line = 117)
