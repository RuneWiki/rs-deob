...
public class class112 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILnn;)V", line = 32)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIZ)Z", line = 52)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BLnn;)V", line = 66)
