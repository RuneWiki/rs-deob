...
public class class112 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ILbfa;)V", line = 19)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZLr;ZLsa;Lla;Ljava/lang/String;)V", line = 34)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!rf", name = "toString", descriptor = "()Ljava/lang/String;", line = 144)
    public final String toString() {
        field1465++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 159)
