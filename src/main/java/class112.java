...
public class class112 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BLvt;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILha;ILsu;IB)V")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lwh;I)V")
