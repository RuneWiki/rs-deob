...
public class class112 {
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lnd;)V", line = 742)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILnd;)V", line = 25)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Lnd;BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(B)V", line = 413)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILsh;Lnd;)V", line = 426)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BLnd;)V", line = 694)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(ILnd;)V", line = 709)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 723)
