...
public class class112 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(III)I", line = 30)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lvt;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ZLvt;)V", line = 154)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIIIBII)V", line = 187)
