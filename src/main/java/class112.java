...
public class class112 extends class147 implements class425 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLii;)V", line = 17)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILii;I)Ldc;", line = 45)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILii;)V", line = 91)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lii;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)I", line = 129)
    public final int method120(int arg0) {
        ++field1591;
        return arg0 != 25940 ? 89 : this.field1585;
    }

    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(I)I", line = 142)
    public final int method105(int arg0) {
        ++field1572;
        return arg0 >= -4 ? 108 : 22;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIZLii;)Z", line = 177)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(II)V", line = 218)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lii;IIIILnc;Z)V", line = 233)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lii;Lge;IIIIZIZ)V", line = 253)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Lii;I)Leb;", line = 285)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(ILii;I)Ldc;", line = 320)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILii;ZZ)Lcb;", line = 343)
