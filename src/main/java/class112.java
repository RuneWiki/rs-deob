...
public class class112 extends class42 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(SZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IILtf;B)V", line = 20)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIII[[Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIIIII)V", line = 182)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BI)I", line = 357)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)I", line = 371)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lbt;Lgu;Lni;[I)V", line = 506)
