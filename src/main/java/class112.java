...
public class class112 extends class397 {
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 59)
    public class112() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!ei", name = "e", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ei", name = "f", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IBLae;)V", line = 157)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BI)[[I", line = 193)
