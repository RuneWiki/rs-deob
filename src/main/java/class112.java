...
public class class112 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III[I)Lbv;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([IIII)Lbv;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([IZI)Lbv;")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BLrq;)Z")
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II[I)Lbv;")
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lhh;Lhh;)V")
