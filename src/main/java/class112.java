...
public class class112 {
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)J")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(I[BII)V")
    ...
    @OriginalMember(owner = "client!is", name = "d", descriptor = "(I)Ljava/io/File;")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IBI[B)I")
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IJ)V")
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V")
