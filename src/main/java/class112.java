...
public class class112 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "([BJI)V", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(II)I", line = 89)
    public static int method903(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(B)V", line = 287)
