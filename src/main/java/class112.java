...
public class class112 extends class306 implements class394 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lr;I)Lej;")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lr;Lnf;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(ILr;)Leh;")
    public final class203 method631(int arg0, class98 arg1) {
        ++field1799;
        return arg0 != 1 ? null : this.field1785;
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILr;B)Z")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lr;B)V")
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILr;)V")
