...
public class class112 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B[J[Ljava/lang/Object;)V", line = 20)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lvj;I)V", line = 34)
