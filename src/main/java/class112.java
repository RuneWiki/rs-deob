...
public class class112 {
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lpq;Lha;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IBZLeg;Leg;)Loq;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IBLeg;Leg;)Loq;")
