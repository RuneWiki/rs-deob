...
public abstract class class112 extends class454 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(JJ)J", line = 6)
    public static long method927(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIILuf;)V", line = 72)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lqj;I)V", line = 95)
    public class112(class572 arg0, int arg1) {
        this.field1622 = arg0;
        this.field1618 = arg1;
    }

    @OriginalMember(owner = "client!tk", name = "i", descriptor = "(I)V", line = 105)
