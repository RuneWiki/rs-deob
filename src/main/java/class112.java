...
public class class112 extends class320 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "()[I", line = 4)
    public final int[] method836() {
        return this.field1891;
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(II[IZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "()V", line = 202)
