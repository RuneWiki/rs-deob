...
public abstract class class134 extends class179 {
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 18)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IB)V", line = 51)
    ...
    @OriginalMember(owner = "client!fm", name = "d", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ZLjava/lang/String;)Ljava/lang/String;", line = 83)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BLjava/lang/String;)V", line = 104)
