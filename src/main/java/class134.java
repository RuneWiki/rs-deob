...
public abstract class class134 {
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(IIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(IIIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IIIBI)V", line = 60)
    ...
    @OriginalMember(owner = "client!ae", name = "d", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILul;Lrd;ILjava/awt/Canvas;I)Lae;", line = 93)
    ...
    @OriginalMember(owner = "client!ae", name = "finalize", descriptor = "()V", line = 151)
    protected final void finalize() {
        field1618++;
        this.method824(83);
    }

    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BIIII)V", line = 171)
    ...
    @OriginalMember(owner = "client!ae", name = "f", descriptor = "(IIIIII)V", line = 182)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(B)V", line = 238)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(B)V", line = 256)
    ...
    @OriginalMember(owner = "client!ae", name = "h", descriptor = "(IIIIII)V", line = 288)
