...
public class class134 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(BLwq;)V", line = 43)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(Luq;ZI)I", line = 102)
