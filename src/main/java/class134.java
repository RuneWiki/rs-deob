...
public class class134 extends class36 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lut;[III)V")
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lut;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lut;II)V")
