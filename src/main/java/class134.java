...
public class class134 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BI)Lrh;", line = 36)
    ...
    @OriginalMember(owner = "client!ut", name = "finalize", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Log;JI)V", line = 77)
