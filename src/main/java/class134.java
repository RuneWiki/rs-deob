...
public class class134 extends class692 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(III)Lq;")
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Llea;Lan;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILfga;I)V")
