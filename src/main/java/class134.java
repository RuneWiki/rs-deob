...
public class class134 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;IB)V", line = 16)
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 36)
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(ZBLraa;)V", line = 53)
