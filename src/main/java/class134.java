...
public class class134 extends class290 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILza;Le;)V", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILza;IILvl;Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lza;ZII)Le;", line = 69)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)V", line = 87)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZI)Z", line = 141)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)I", line = 152)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(ILza;)Lsr;", line = 179)
    ...
    @OriginalMember(owner = "client!li", name = "finalize", descriptor = "()V", line = 215)
    ...
    @OriginalMember(owner = "client!li", name = "e", descriptor = "(I)I", line = 236)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IB)V", line = 252)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lza;III)Z", line = 284)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(BLza;)V", line = 296)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(III)Lhc;", line = 323)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Z)Z", line = 342)
