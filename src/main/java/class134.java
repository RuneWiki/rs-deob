...
public class class134 extends class298 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IILvt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IZ)[I", line = 98)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILjava/lang/String;IZ)I", line = 147)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(I)V", line = 224)
    ...
    @OriginalMember(owner = "client!nq", name = "e", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 245)
    public class134() {
        super(3, false);
    }

    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IILoj;IBIILqh;III)Lqh;", line = 259)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!nq", name = "d", descriptor = "(I)V", line = 361)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(II)Lmg;", line = 375)
