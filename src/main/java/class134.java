...
public class class134 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BLei;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILhu;)Z")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILqg;)Lsq;")
