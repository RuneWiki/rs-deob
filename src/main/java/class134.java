...
public class class134 extends class348 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILjava/awt/Graphics;III)V", line = 7)
    ...
    @OriginalMember(owner = "client!qm", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 26)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field1631;
    }

    @OriginalMember(owner = "client!qm", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 35)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILjava/awt/Graphics;BI)V", line = 69)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 82)
    ...
    @OriginalMember(owner = "client!qm", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 104)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!qm", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 129)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1633;
    }

    @OriginalMember(owner = "client!qm", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 136)
