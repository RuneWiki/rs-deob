...
public class class134 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILw;II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lql;IB)Z", line = 76)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 276)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IZIIIII)I", line = 301)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lw;IBI)V", line = 335)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)V", line = 412)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIJI)V", line = 424)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I[[ZIIIZ)V", line = 468)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lw;III)V", line = 651)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Len;Lot;)V", line = 732)
