...
public class class134 extends class212 {
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(III)V", line = 37)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(ZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!eea", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(ILdh;)V", line = 201)
    public class134(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "(Ldh;)V", line = 207)
    public class134(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eea", name = "e", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Z)V", line = 231)
    ...
    @OriginalMember(owner = "client!eea", name = "f", descriptor = "(I)I", line = 248)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(B)Z", line = 260)
    ...
    @OriginalMember(owner = "client!eea", name = "g", descriptor = "(I)Z", line = 272)
    ...
    @OriginalMember(owner = "client!eea", name = "h", descriptor = "(I)V", line = 290)
