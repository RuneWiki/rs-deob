...
public class class134 extends class374 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILuo;I)Z")
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!qa", name = "g", descriptor = "(B)Lun;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ZLuo;)Laj;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IBLuo;)Z")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILic;ILuo;ILmj;II)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lkh;B)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IBIILrr;Luo;Z)V")
