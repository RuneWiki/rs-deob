...
public class class134 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I)Lsu;")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIIIILue;IIIII)Z")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
