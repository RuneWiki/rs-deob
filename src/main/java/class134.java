...
public class class134 extends class339 implements class111 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BILjava/lang/String;IIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BLpe;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lpe;Lkk;IIIIIIIZI)V", line = 44)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lpe;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IILpe;I)Z", line = 71)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lpe;B)Lca;", line = 87)
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lpe;II)Lsj;", line = 150)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILpe;)V", line = 161)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)I", line = 173)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)I", line = 190)
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(I)Z", line = 201)
    ...
    @OriginalMember(owner = "client!ub", name = "i", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)Z", line = 235)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)I", line = 247)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZILhh;Lpe;III)V", line = 258)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZBZ)V", line = 273)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIII)I", line = 298)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 311)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)V", line = 321)
