...
public class class134 extends class178 implements class492 {
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lhj;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)I", line = 39)
    public static int method848(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(II)I", line = 62)
    public static final int method850(int arg0, int arg1) {
        ++field1910;
        return arg1 != 200 ? 47 : arg0 & 255;
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(III)Luda;", line = 75)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZI)I", line = 98)
