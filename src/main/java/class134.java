...
public class class134 implements class215 {
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(IB)Lcr;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZLmp;ILe;III)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IB)Lnq;")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lmo;Lmo;Lmo;)V")
