...
public class class134 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "([IIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Lfg;)V")
