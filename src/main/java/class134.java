...
public class class134 extends class85 {
    ...
    @OriginalMember(owner = "client!od", name = "Y", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!od", name = "U", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!od", name = "bb", descriptor = "Lvg;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lnf;IIIIIII)V")
