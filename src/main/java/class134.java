...
public class class134 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IILha;I)V")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lha;IIILtba;I)V")
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(IIIIIIIIIZZI)V")
