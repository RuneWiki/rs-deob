...
public class class134 extends class179 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZII)I", line = 19)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BLtf;)Z", line = 64)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)Z", line = 104)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IS)V", line = 116)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B[[ZIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILjava/lang/String;)V", line = 370)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IB)V", line = 425)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lbl;Ltn;Lki;[I)V", line = 439)
