...
public abstract class class134 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(JI)V", line = 20)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IB)Lul;", line = 43)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)B", line = 136)
