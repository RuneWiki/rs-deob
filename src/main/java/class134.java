...
public class class134 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IB)Lkj;", line = 99)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IBLre;)V", line = 129)
    ...
    @OriginalMember(owner = "client!we", name = "d", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(Lgp;ILui;Lui;)V", line = 196)
