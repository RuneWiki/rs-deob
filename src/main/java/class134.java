...
public class class134 extends class703 implements class761 {
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I[ILbs;[I[I)V", line = 29)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIIIII[F[FFI)V", line = 135)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILjava/lang/String;)I", line = 197)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II[BI)V", line = 220)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lwh;ILjaclib/memory/Buffer;IZ)V", line = 234)
    public class134(class148 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field1796 = arg1;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)Lmi;", line = 242)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(I)V", line = 256)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIZ)V", line = 266)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)I", line = 278)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lwh;I[BIZ)V", line = 289)
