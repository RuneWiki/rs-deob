...
public class class134 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIIZZ)Lqj;", line = 101)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(B)V", line = 133)
