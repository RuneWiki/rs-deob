...
public class class134 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ZI)Lhe;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIZILfu;I)Lop;")
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIILjv;)Lwm;")
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lpca;ILbi;)V")
