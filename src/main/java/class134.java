...
public class class134 extends class31 {
    ...
    @OriginalMember(owner = "client!tj", name = "e", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IBIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIZ)Z", line = 481)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(II)V", line = 493)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(I)V", line = 539)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "(Lda;II)V", line = 568)
