...
public class class134 extends class66 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IBILha;Lqia;)V", line = 4)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ILgaa;Lgaa;)V", line = 39)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!aba", name = "c", descriptor = "(I)Lgv;", line = 77)
    ...
    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(Leq;IIIIII)V", line = 145)
