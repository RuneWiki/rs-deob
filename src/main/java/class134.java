...
public class class134 extends class45 {
    ...
    @OriginalMember(owner = "client!rn", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(BI)V", line = 28)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 75)
    public class134() {
    }

    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 80)
