...
public class class134 extends class437 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ZIIIILjava/awt/Graphics;)V", line = 12)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 29)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IILjava/awt/Graphics;Z)V", line = 51)
