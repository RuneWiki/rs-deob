...
public class class134 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)J", line = 9)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILjava/lang/String;)V", line = 33)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 53)
