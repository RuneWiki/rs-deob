...
public class class134 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(ILvca;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BLol;)V", line = 54)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Ljava/awt/Canvas;BLfa;I)Lr;", line = 81)
    ...
    @OriginalMember(owner = "client!mg", name = "toString", descriptor = "()Ljava/lang/String;", line = 100)
    public final String toString() {
        field2193++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)Ljn;", line = 113)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(I)V", line = 138)
