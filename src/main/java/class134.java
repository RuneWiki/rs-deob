...
public class class134 {
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(BI)Leea;", line = 4)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(ZZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(Ldn;IZ)Ltc;", line = 123)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Lbda;Ln;)V", line = 152)
