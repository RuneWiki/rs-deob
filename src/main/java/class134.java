...
public class class134 extends class18 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "()V", line = 15)
    private final void method863() {
        this.field1935 = false;
    }

    @OriginalMember(owner = "client!li", name = "b", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "()V", line = 33)
    public final void method865() {
        this.field1942 = true;
    }

    @OriginalMember(owner = "client!li", name = "d", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lqa;J)Z", line = 57)
    ...
    @OriginalMember(owner = "client!li", name = "e", descriptor = "()V", line = 105)
    public static void method868() {
        field1930 = null;
        field1936 = null;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lqa;J[Le;[Lil;Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!li", name = "f", descriptor = "()Lvo;", line = 118)
    public final class258 method870() {
        return this.field1948;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Lqa;[Le;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!li", name = "g", descriptor = "()V", line = 195)
    public final void method872() {
        this.field1935 = true;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "([Lil;Z)V", line = 202)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(J)V", line = 297)
