...
public class class134 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IBILve;)V")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lve;IIB)Z")
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILve;IZ)V")
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Lql;Lge;)V")
