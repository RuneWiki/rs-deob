...
public class class134 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIIIZIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(JZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)V", line = 127)
