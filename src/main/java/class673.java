...
public class class673 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lsca;B)V", line = 6)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Z)V", line = 41)
