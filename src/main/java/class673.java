...
public abstract class class673 extends class477 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IIIIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lrl;I)V", line = 142)
