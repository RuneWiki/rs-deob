...
public class class673 extends class363 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lji;II)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lji;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ILji;)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lpfa;Z)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lji;Z[I)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Le;Loa;I)V")
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(II)Lvf;")
