...
public class class673 extends class435 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ILvo;Lvo;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(III)Z", line = 107)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZLr;IB)Lql;", line = 122)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/awt/Canvas;BLfa;)Lr;", line = 193)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 203)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(I)V", line = 220)
