...
public class class673 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(B)[Lsaa;", line = 20)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BI)V", line = 31)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)Z", line = 52)
