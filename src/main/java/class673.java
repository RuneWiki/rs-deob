...
public class class673 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BILgk;)V", line = 22)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZIILr;)Lf;", line = 52)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BLgk;)V", line = 101)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(III)Z", line = 123)
