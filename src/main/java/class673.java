...
public class class673 extends class694 {
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)[I", line = 64)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 100)
    public class673() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZIZ)I", line = 103)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILjr;B)V", line = 144)
    ...
    @OriginalMember(owner = "client!fm", name = "g", descriptor = "(I)V", line = 189)
