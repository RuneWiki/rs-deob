...
public class class673 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(JLjava/lang/String;IBJZLjava/lang/String;IZIZII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ee", name = "toString", descriptor = "()Ljava/lang/String;", line = 21)
    public final String toString() {
        field9444++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIII)I", line = 49)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(III)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 85)
