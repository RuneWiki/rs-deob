...
public class class673 extends class609 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "([[ZIIIII[III[ILlr;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Llr;I[IIIZ[I[I)V", line = 141)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Lql;IIII[[I[[II)V", line = 825)
    public class673(class173 arg0, int arg1, int arg2, int arg3, int arg4, int[][] arg5, int[][] arg6, int arg7) {
        super(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "([IZ[ILlr;I[II)V", line = 828)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)I", line = 1201)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1215)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(III[I[IIILlr;III[[Z)V", line = 1242)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)V", line = 1382)
