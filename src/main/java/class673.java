...
public class class673 extends class657 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IZ)Lap;")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lok;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lok;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lok;IIIII)V")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lok;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ZLqs;)I")
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Lok;IIII)V")
