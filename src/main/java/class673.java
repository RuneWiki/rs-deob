...
public abstract class class673 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Z)Lbr;")
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(B)Lop;")
    ...
    @OriginalMember(owner = "client!mea", name = "d", descriptor = "(I)Lbda;")
    ...
    @OriginalMember(owner = "client!mea", name = "g", descriptor = "(I)Lwda;")
