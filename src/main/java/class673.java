...
public abstract class class673 implements class262 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Z)I", line = 28)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IIII)Lfi;", line = 60)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)I", line = 138)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lwm;Lwm;Laf;)V", line = 187)
