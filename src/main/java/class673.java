...
public class class673 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lsba;IIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 825)
