...
public class class673 extends class134 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lsca;I)V")
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(ILwq;)Lvha;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILwq;)V")
