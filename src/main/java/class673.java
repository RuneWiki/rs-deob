...
public class class673 extends class631 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IILta;)V", line = 40)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Leea;Lrc;)V", line = 92)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lfp;I)I", line = 120)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IZ)V", line = 187)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)Z", line = 223)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BZ)V", line = 244)
    ...
    @OriginalMember(owner = "client!fb", name = "d", descriptor = "(I)V", line = 292)
