...
public class class673 extends class753 implements class627 {
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Loia;Lul;II[BII)V")
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Loia;Lul;Lso;II)V")
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "([BIIILul;IIII)V")
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Loia;II[III)V")
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Loia;Lul;II[FII)V")
