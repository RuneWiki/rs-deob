...
public abstract class class673 {
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IZI)Lfn;", line = 41)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(B)I", line = 171)
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(III)V", line = 186)
