...
public class class673 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lks;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lbaa;JI[I)Ljava/lang/String;", line = 37)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IB)Luj;", line = 68)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(ILpl;Lpl;Llv;)V", line = 140)
