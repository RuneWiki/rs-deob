...
public class class673 extends class739 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lsl;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!vfa", name = "d", descriptor = "(III)I", line = 31)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "()V", line = 128)
    public class673() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(II)[I", line = 48)
