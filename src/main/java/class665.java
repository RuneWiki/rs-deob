...
public class class665 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(Lha;IIIIIBI)V")
    ...
    @OriginalMember(owner = "client!qt", name = "b", descriptor = "(II)Lkca;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(II)Lgr;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(JZLpe;[I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(ILgda;Lgda;Lhia;)V")
