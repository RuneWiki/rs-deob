...
public class class665 extends class181 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(B)Lnm;")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lor;B)V")
