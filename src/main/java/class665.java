...
public class class665 implements class549 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(I)V", line = 44)
    public class665(int arg0) {
        this.field9135 = arg0;
    }

    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IBI)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(I)Llf;", line = 92)
