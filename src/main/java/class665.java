...
public class class665 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IC)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ZI)Lwe;", line = 48)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(II)V", line = 135)
    ...
    @OriginalMember(owner = "client!nfa", name = "b", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(Lvd;ILpe;Lpe;)V", line = 179)
