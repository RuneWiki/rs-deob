...
public class class665 implements class688 {
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)Lds;")
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!caa", name = "<init>", descriptor = "(Lcka;Lds;Z)V")
