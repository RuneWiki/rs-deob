...
public class class665 extends class331 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ljava/lang/String;Ltn;I)I")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lts;)V")
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(ILts;)V")
