...
public class class665 extends class330 {
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(III[BI[BIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(BIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!gka", name = "<init>", descriptor = "()V", line = 227)
    public class665() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Loq;III)V", line = 230)
    ...
    @OriginalMember(owner = "client!gka", name = "b", descriptor = "(Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(IIII)V", line = 297)
    ...
    @OriginalMember(owner = "client!gka", name = "c", descriptor = "(Z)V", line = 370)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Lgga;IB)V", line = 398)
