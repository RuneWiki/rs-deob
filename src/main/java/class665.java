...
public class class665 {
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(BLit;Low;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(B)Lit;", line = 40)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Lit;B)V", line = 64)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I)Lit;", line = 89)
    ...
    @OriginalMember(owner = "client!ow", name = "c", descriptor = "(B)V", line = 109)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(BLit;)V", line = 119)
    ...
    @OriginalMember(owner = "client!ow", name = "d", descriptor = "(B)Lit;", line = 137)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IIIBZI)V", line = 157)
    ...
    @OriginalMember(owner = "client!ow", name = "e", descriptor = "(B)Lit;", line = 380)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(I)I", line = 405)
    ...
    @OriginalMember(owner = "client!ow", name = "c", descriptor = "(I)Lit;", line = 439)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Low;Z)V", line = 459)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "()V", line = 498)
    public class665() {
        this.field9375.field10584 = this.field9375;
        this.field9375.field10591 = this.field9375;
    }

    @OriginalMember(owner = "client!ow", name = "d", descriptor = "(I)V", line = 476)
