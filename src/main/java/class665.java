...
public class class665 extends class164 {
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIIIZ[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIIII[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIIZ[III)V", line = 65)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIIIIZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(III)Z", line = 123)
    public static final boolean method3760(int arg0, int arg1, int arg2) {
        ++field9323;
        return arg2 != 3553;
    }

    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIII[I)V", line = 134)
    public class665(class565 arg0, int arg1, int arg2, int arg3, int arg4, int[] arg5) {
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Llj;IIIIIIZ)V", line = 149)
