...
public class class665 {
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(BIIILjava/lang/String;III)V", line = 19)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)I", line = 58)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IIII)Z", line = 69)
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(I)V", line = 211)
