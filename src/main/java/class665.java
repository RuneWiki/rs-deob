...
public class class665 extends class518 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ILjc;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(II)[I", line = 53)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "()V", line = 143)
    public class665() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)Liga;", line = 154)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lim;", line = 184)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)[[I", line = 201)
