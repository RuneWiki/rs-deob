...
public class class665 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!ge", name = "toString", descriptor = "()Ljava/lang/String;", line = 40)
    public final String toString() {
        field9434++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BII)V", line = 54)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(II)V", line = 99)
    public class665(int arg0, int arg1) {
        this.field9432 = arg0;
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IIIIFIFF)[F", line = 109)
