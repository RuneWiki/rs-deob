...
public class class665 extends class539 {
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(BII)V", line = 88)
    ...
    @OriginalMember(owner = "client!pea", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!pea", name = "b", descriptor = "(I)Z", line = 122)
