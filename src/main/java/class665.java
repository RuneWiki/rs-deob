...
public abstract class class665 extends class593 {
    ...
    @OriginalMember(owner = "client!ica", name = "l", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I[Lraa;)I")
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(Lha;I)Z")
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(ILvs;ZILha;II)V")
