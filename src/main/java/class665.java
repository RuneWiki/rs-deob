...
public class class665 extends class330 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lqha;I)V")
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Lha;I)Lrn;")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILha;Z)Z")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZLje;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lha;I)Lmaa;")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Lmi;BIIII)V")
