...
public class class665 extends class54 {
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Z)I", line = 16)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(IB)I", line = 27)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(ILhia;)V", line = 68)
    public class665(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lhia;)V", line = 72)
