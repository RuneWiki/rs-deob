...
public class class665 implements class620 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILbca;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!eba", name = "c", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!eba", name = "e", descriptor = "(I)Z", line = 86)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IZ)V", line = 123)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(IZ)V", line = 152)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(BILifa;I)V", line = 167)
    ...
    @OriginalMember(owner = "client!eba", name = "d", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(II)I", line = 194)
    public static int method3759(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IIIJ)V", line = 203)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(II)V", line = 246)
    ...
    @OriginalMember(owner = "client!eba", name = "f", descriptor = "(I)V", line = 261)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Lfba;BII)V", line = 271)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILifa;III)V", line = 305)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Ldw;)V", line = 391)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IBLfba;)V", line = 345)
    ...
    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!eba", name = "finalize", descriptor = "()V", line = 373)
