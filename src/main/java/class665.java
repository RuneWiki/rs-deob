...
public class class665 extends class354 {
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(ILwo;)V", line = 21)
    public class665(int arg0, class746 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lwo;)V", line = 24)
    public class665(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(B)I", line = 41)
    ...
    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)I", line = 62)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)V", line = 72)
