...
public class class665 extends class372 implements class508 {
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Ldda;Z)V")
    ...
    @OriginalMember(owner = "client!jga", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
