...
public class class665 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IB)Lpca;", line = 20)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(IB)V", line = 49)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IIIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lqh;ILtf;)V", line = 116)
