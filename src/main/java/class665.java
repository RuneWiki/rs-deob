...
public class class665 extends class732 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IILpaa;B)V")
    ...
    @OriginalMember(owner = "client!pv", name = "<init>", descriptor = "([Lot;)V")
    public class665(class378[] arg0) {
        this.field9378 = arg0;
    }

    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Loq;ILjava/lang/String;Lda;ZLha;)V")
