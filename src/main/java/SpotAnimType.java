...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!pc", name = "n", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!pc", name = "f", descriptor = "Lnc;")
    public SeqType field1170;

    @OriginalMember(owner = "client!pc", name = "b", descriptor = "[Lpc;")
    public static SpotAnimType[] field1166;

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lxb;Z)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Llb;Z)V")
