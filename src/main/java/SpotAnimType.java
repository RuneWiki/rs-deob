...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!kc", name = "r", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!kc", name = "i", descriptor = "Ljc;")
    public SeqType field1064;

    @OriginalMember(owner = "client!kc", name = "c", descriptor = "Z")
    private static boolean field1058;

    @OriginalMember(owner = "client!kc", name = "f", descriptor = "[Lkc;")
    public static SpotAnimType[] field1061;

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILub;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLkb;)V")
