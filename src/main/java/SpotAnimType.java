...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!gc", name = "l", descriptor = "Lr;")
    ...
    @OriginalMember(owner = "client!gc", name = "h", descriptor = "Lfc;")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(Ltb;I)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "(BLjb;)V")
    ...
    @OriginalMember(owner = "client!gc", name = "a", descriptor = "()Ldb;")
