...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!oc", name = "o", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!oc", name = "b", descriptor = "[Loc;")
    public static SpotAnimType[] field1142;

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ILyb;)V")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "()Lfb;")
