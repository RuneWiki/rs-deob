...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!qc", name = "p", descriptor = "Ls;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "()Leb;")
