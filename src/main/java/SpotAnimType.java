...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!pc", name = "n", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lyb;I)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "()Lfb;")
