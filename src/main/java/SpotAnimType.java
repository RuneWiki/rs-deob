...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!nc", name = "q", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILmb;)V")
