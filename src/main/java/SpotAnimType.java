...
public class SpotAnimType {
    ...
    @OriginalMember(owner = "client!nc", name = "p", descriptor = "Lt;")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ZLmb;)V")
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "()Lfb;")
