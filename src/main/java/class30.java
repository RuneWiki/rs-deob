...
public class class30 extends class114 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIILvea;)V", line = 19)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljc;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILha;)V", line = 91)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILwfa;)V", line = 117)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ZC)C", line = 133)
