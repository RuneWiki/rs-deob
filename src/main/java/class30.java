...
public class class30 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Lav;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IB)V", line = 54)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(IB)Lcm;", line = 69)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!iha", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(II)V", line = 138)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ILee;)V", line = 154)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 204)
