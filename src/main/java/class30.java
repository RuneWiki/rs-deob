...
public class class30 implements class16 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Lnc;IBII)V")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IILaw;I)V")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(BIILnc;)V")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZLjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!iha", name = "d", descriptor = "(B)Ljm;")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ILaw;I)V")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(CI)C")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Laea;II)V")
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lwh;)V")
