...
public class class30 extends class27 {
    ...
    @OriginalMember(owner = "client!JEESRQGR", name = "k", descriptor = "Z")
    public static boolean field936;

    @OriginalMember(owner = "client!JEESRQGR", name = "i", descriptor = "[LLWVZOAPR;")
    ...
    @OriginalMember(owner = "client!JEESRQGR", name = "a", descriptor = "(I)LVYUQHOMO;")
