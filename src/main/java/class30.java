...
@OriginalClass("client!IJWJZMOM")
public class class30 {

    @OriginalMember(owner = "client!IJWJZMOM", name = "a", descriptor = "I")
    public int field953;

    @OriginalMember(owner = "client!IJWJZMOM", name = "b", descriptor = "[I")
    public int[] field954;

    @OriginalMember(owner = "client!IJWJZMOM", name = "c", descriptor = "[[I")
    public int[][] field955;

    @OriginalMember(owner = "client!IJWJZMOM", name = "<init>", descriptor = "(ZLXOUQUKZW;)V")
