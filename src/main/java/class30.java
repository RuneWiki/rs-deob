...
public class class30 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IIIII[B)V", line = 19)
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(ZIILha;)V", line = 54)
