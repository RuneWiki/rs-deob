...
public class class30 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "([III[JB)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(BI)I", line = 157)
