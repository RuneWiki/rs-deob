...
public class class30 {
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(I)Lmn;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Z)Lmn;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)Lmn;")
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(B)Lmn;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIILet;Let;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(BLmn;)V")
