...
public abstract class class30 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(BLra;Lra;)I", line = 5)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([BB)[B", line = 39)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ZZLjava/lang/String;I)I", line = 87)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(III)V", line = 163)
