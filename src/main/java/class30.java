...
public class class30 extends class11 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILoa;I)Lkga;", line = 6)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILeh;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILeh;)V", line = 41)
