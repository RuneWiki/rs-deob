...
public class class30 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)Ldaa;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLdaa;)V")
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)Ldaa;")
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(B)Ldaa;")
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILfja;)V")
