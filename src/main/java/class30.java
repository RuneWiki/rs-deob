...
public class class30 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lbl;B)I", line = 128)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 167)
