...
public abstract class class30 extends class401 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(B)I", line = 17)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!rk", name = "c", descriptor = "(I)V", line = 70)
    public static void method291(int arg0) {
        int var1 = 61 / ((-arg0 - 17) / 52);
        field383 = null;
    }

    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IB)[[I", line = 91)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(III)[[I", line = 112)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ZII)V", line = 144)
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(BILac;)V", line = 169)
    ...
    @OriginalMember(owner = "client!rk", name = "<init>", descriptor = "(IZ)V", line = 179)
    public class30(int arg0, boolean arg1) {
        this.field371 = new class30[arg0];
        this.field378 = arg1;
    }

    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIB)[I", line = 196)
