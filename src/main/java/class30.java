...
public class class30 extends class478 implements class278 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "([SI[Ljava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(Z)I", line = 17)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lkm;II)Lab;", line = 28)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(I)Z", line = 112)
    public final boolean method214(int arg0) {
        ++field491;
        return arg0 < 24 ? true : this.field492.method638(0);
    }

    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(Lkm;I)V", line = 123)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ILkm;IZILkj;B)V", line = 154)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Z[[[Lui;)V", line = 165)
    ...
    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(B)V", line = 244)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(Lkm;I)V", line = 271)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lkm;I)V", line = 283)
    ...
    @OriginalMember(owner = "client!rt", name = "g", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!rt", name = "e", descriptor = "(I)Z", line = 310)
    ...
    @OriginalMember(owner = "client!rt", name = "c", descriptor = "(B)I", line = 322)
    public final int method205(byte arg0) {
        ++field487;
        return arg0 != 114 ? 124 : this.field492.method640(0);
    }

    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lkm;Lcj;IIIIIZIIIIIII)V", line = 340)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(Lkm;BII)Z", line = 349)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)I", line = 368)
    ...
    @OriginalMember(owner = "client!rt", name = "d", descriptor = "(Lkm;I)Lto;", line = 381)
    ...
    @OriginalMember(owner = "client!rt", name = "e", descriptor = "(B)V", line = 418)
