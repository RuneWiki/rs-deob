...
public class class30 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BILya;)Z")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lvd;II)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
