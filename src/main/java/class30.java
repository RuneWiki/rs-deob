...
@OriginalClass("client!LNSFKVMU")
public class class30 {

    @OriginalMember(owner = "client!LNSFKVMU", name = "a", descriptor = "I")
    private int field874 = -261;

    @OriginalMember(owner = "client!LNSFKVMU", name = "b", descriptor = "Z")
    private boolean field875 = false;

    @OriginalMember(owner = "client!LNSFKVMU", name = "c", descriptor = "I")
    private int field876 = -548;

    @OriginalMember(owner = "client!LNSFKVMU", name = "d", descriptor = "I")
    private int field877 = 9;

    @OriginalMember(owner = "client!LNSFKVMU", name = "e", descriptor = "I")
    private int field878 = 1;

    @OriginalMember(owner = "client!LNSFKVMU", name = "i", descriptor = "I")
    public int field882 = -1;

    @OriginalMember(owner = "client!LNSFKVMU", name = "k", descriptor = "[I")
    public int[] field884 = new int[6];

    @OriginalMember(owner = "client!LNSFKVMU", name = "l", descriptor = "[I")
    public int[] field885 = new int[6];

    @OriginalMember(owner = "client!LNSFKVMU", name = "m", descriptor = "[I")
    public int[] field886 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!LNSFKVMU", name = "n", descriptor = "Z")
    public boolean field887 = false;

    @OriginalMember(owner = "client!LNSFKVMU", name = "f", descriptor = "I")
    private static int field879;

    @OriginalMember(owner = "client!LNSFKVMU", name = "g", descriptor = "I")
    public static int field880;

    @OriginalMember(owner = "client!LNSFKVMU", name = "j", descriptor = "[I")
    public int[] field883;

    @OriginalMember(owner = "client!LNSFKVMU", name = "h", descriptor = "[LLNSFKVMU;")
    public static class30[] field881;

    @OriginalMember(owner = "client!LNSFKVMU", name = "a", descriptor = "(LCXFTMSCH;B)V")
    ...
    @OriginalMember(owner = "client!LNSFKVMU", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!LNSFKVMU", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!LNSFKVMU", name = "a", descriptor = "(I)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!LNSFKVMU", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!LNSFKVMU", name = "c", descriptor = "(I)LYYHPBDED;")
