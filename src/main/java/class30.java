...
public class class30 extends class6 {
    ...
    @OriginalMember(owner = "client!IYPTVTAD", name = "h", descriptor = "I")
    public static int field990;

    @OriginalMember(owner = "client!IYPTVTAD", name = "f", descriptor = "LIYPTVTAD;")
    public class30 field988;

    @OriginalMember(owner = "client!IYPTVTAD", name = "g", descriptor = "LIYPTVTAD;")
