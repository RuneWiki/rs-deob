...
public class class30 extends class309 {
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lic;)V", line = 41)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lvd;)V", line = 152)
    public final void method51(class5 arg0) {
        this.field4530.method1379(arg0);
    }

    @OriginalMember(owner = "client!sq", name = "c", descriptor = "()V", line = 159)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(Z)V", line = 222)
    public final void method57(boolean arg0) {
        this.field4530.method1360(8448, 7681);
    }

    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "()Z", line = 238)
