...
public class class30 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIIIIZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(I)V", line = 81)
