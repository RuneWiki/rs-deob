...
public class class30 extends class630 {
    ...
    @OriginalMember(owner = "client!ks", name = "n", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(BLhr;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ks", name = "f", descriptor = "(Z)I", line = 31)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(ZI)I", line = 52)
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(ZI)I", line = 82)
    ...
    @OriginalMember(owner = "client!ks", name = "l", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!ks", name = "y", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!ks", name = "m", descriptor = "(B)Z", line = 143)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(II[BI)V", line = 159)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(I)V", line = 179)
    public class30(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ks", name = "n", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!ks", name = "z", descriptor = "(I)V", line = 197)
    public final void method207(int arg0) {
        this.field425 = super.field8812 * arg0;
        ++field419;
    }

    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(B[I)V", line = 219)
