...
@OriginalClass("client!JHLQAAYP")
public class class30 {

    @OriginalMember(owner = "client!JHLQAAYP", name = "b", descriptor = "Z")
    private boolean field951 = true;

    @OriginalMember(owner = "client!JHLQAAYP", name = "i", descriptor = "Z")
    public boolean field958 = false;

    @OriginalMember(owner = "client!JHLQAAYP", name = "j", descriptor = "I")
    public int field959 = -1;

    @OriginalMember(owner = "client!JHLQAAYP", name = "a", descriptor = "Z")
    private static boolean field950 = true;

    @OriginalMember(owner = "client!JHLQAAYP", name = "c", descriptor = "I")
    public static int field952;

    @OriginalMember(owner = "client!JHLQAAYP", name = "f", descriptor = "I")
    public int field955;

    @OriginalMember(owner = "client!JHLQAAYP", name = "g", descriptor = "I")
    public int field956;

    @OriginalMember(owner = "client!JHLQAAYP", name = "h", descriptor = "I")
    public int field957;

    @OriginalMember(owner = "client!JHLQAAYP", name = "k", descriptor = "I")
    public int field960;

    @OriginalMember(owner = "client!JHLQAAYP", name = "e", descriptor = "Ljava/lang/String;")
    public String field954;

    @OriginalMember(owner = "client!JHLQAAYP", name = "d", descriptor = "[LJHLQAAYP;")
    public static class30[] field953;

    @OriginalMember(owner = "client!JHLQAAYP", name = "a", descriptor = "(ZLXMRRKSSB;)V")
    ...
    @OriginalMember(owner = "client!JHLQAAYP", name = "a", descriptor = "(ZLXQPFGONL;I)V")
