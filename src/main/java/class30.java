...
public class class30 extends class338 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BIILgo;Lfd;IIILvm;)V", line = 7)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIILqs;IIIIIB)Z", line = 109)
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(IIIIIZ)V", line = 385)
