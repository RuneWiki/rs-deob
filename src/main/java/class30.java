...
public class class30 extends class45 {
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Z)V", line = 203)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lnj;B)Lmo;", line = 215)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(II)V", line = 233)
