...
public class class30 extends class34 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lsv;II)V", line = 258)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Lsv;Lor;II)V", line = 352)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BIIIII)V", line = 464)
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "()V", line = 764)
    public class30() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(III)V", line = 494)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I[[ILjava/util/Random;ZIII)V", line = 512)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(B)V", line = 709)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(Z)V", line = 749)
