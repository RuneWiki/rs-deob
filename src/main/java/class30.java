...
public class class30 {
    ...
    @OriginalMember(owner = "client!LSYVWAVF", name = "d", descriptor = "LNHEPCMLW;")
    ...
    @OriginalMember(owner = "client!LSYVWAVF", name = "a", descriptor = "(IZLNHEPCMLW;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!LSYVWAVF", name = "a", descriptor = "(ILNHEPCMLW;Ljava/lang/String;)V")
