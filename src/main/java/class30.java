...
public class class30 extends class148 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(IIIIII)Z", line = 25)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILdh;I)V", line = 104)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(ZI)V", line = 201)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIII[[ILjava/util/Random;I)V", line = 242)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZLdh;Ljava/lang/String;)I", line = 456)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(II)[I", line = 472)
