...
public class class30 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ZI)V", line = 12)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Z)V", line = 77)
