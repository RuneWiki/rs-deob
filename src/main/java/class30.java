...
public class class30 extends class155 {
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(IIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(ZIZI)Leq;", line = 45)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IIB)V", line = 63)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(CB)C", line = 83)
