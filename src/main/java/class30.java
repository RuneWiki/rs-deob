...
public abstract class class30 extends class161 {
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(BII)V", line = 15)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(BI)[[I", line = 38)
    ...
    @OriginalMember(owner = "client!na", name = "d", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(III)[[I", line = 92)
    ...
    @OriginalMember(owner = "client!na", name = "c", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!na", name = "d", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Ljg;II)V", line = 176)
    ...
    @OriginalMember(owner = "client!na", name = "e", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Lno;B)Ljava/lang/String;", line = 206)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(IZ)V", line = 222)
    public class30(int arg0, boolean arg1) {
        this.field376 = arg1;
        this.field370 = new class30[arg0];
    }

    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IB)[I", line = 238)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(BII)[I", line = 254)
