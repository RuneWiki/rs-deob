...
public class class30 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILha;IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "([Ljava/lang/Object;I[JII)V", line = 72)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(IJI)Ljava/lang/String;", line = 131)
