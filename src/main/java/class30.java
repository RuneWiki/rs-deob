...
public class class30 extends class95 {
    ...
    @OriginalMember(owner = "client!ci", name = "lb", descriptor = "Lbi;")
    ...
    @OriginalMember(owner = "client!ci", name = "jb", descriptor = "Llf;")
    public static class109 field645 = class35.method275("leuchten2:", 2);

    @OriginalMember(owner = "client!ci", name = "hb", descriptor = "Llf;")
    public static class109 field643 = class35.method275("event_opbase", 2);

    @OriginalMember(owner = "client!ci", name = "qb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ci", name = "nb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(I)Lue;")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Ljava/awt/Component;Lke;BII)Lah;")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IBLwa;)V")
