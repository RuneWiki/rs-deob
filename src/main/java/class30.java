...
public class class30 extends class400 {
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(I)Llm;")
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "()Ljba;")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(BLcea;)Lfn;")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Llm;I)V")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "()Ljba;")
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IDI)Llm;")
