...
public class class30 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)Lna;", line = 22)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(II)V", line = 68)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIFIFLue;FIFF)[B", line = 102)
    ...
    @OriginalMember(owner = "client!wl", name = "c", descriptor = "(II)Z", line = 116)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Luea;ILpq;Lpq;)V", line = 134)
