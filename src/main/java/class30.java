...
public class class30 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "([I[IBLmq;[I)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IIII)Lrca;")
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(I)Lth;")
