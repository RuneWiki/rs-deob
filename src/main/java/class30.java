...
public class class30 extends class376 {
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ILqj;)V", line = 11)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "([Llf;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(Z)Z", line = 65)
    ...
    @OriginalMember(owner = "client!na", name = "c", descriptor = "(B)V", line = 178)
