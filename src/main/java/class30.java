...
public class class30 {
    ...
    @OriginalMember(owner = "client!JFSYEOAW", name = "d", descriptor = "LJHKSAGUC;")
    ...
    @OriginalMember(owner = "client!JFSYEOAW", name = "a", descriptor = "(IZLJHKSAGUC;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!JFSYEOAW", name = "a", descriptor = "(LJHKSAGUC;ILjava/lang/String;)V")
