...
public class class30 extends class47 {
    ...
    @OriginalMember(owner = "client!LMGYBGQR", name = "h", descriptor = "I")
    public static int field1019;

    @OriginalMember(owner = "client!LMGYBGQR", name = "f", descriptor = "LLMGYBGQR;")
    public class30 field1017;

    @OriginalMember(owner = "client!LMGYBGQR", name = "g", descriptor = "LLMGYBGQR;")
