...
public class class30 extends class117 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(CB)I", line = 3)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILti;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!vd", name = "c", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!vd", name = "d", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lti;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(CB)I", line = 164)
