...
public class class30 extends class317 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "([B[IIIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(CIIIZLta;II)V", line = 136)
    ...
    @OriginalMember(owner = "client!vd", name = "B", descriptor = "(CIIIZ)V", line = 202)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lsr;Lfj;[Lef;[I[I)V", line = 258)
