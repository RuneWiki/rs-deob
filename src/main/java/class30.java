...
public class class30 extends class297 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Z)Z", line = 5)
    public final boolean method240(boolean arg0) {
        ++field505;
        return !arg0;
    }

    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZI)V", line = 22)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(Lbo;Lri;)V", line = 124)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZII)V", line = 136)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(III)Z", line = 206)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(Lnk;II)V", line = 220)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(BII)Z", line = 230)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ILjava/lang/Throwable;)Ljava/lang/String;", line = 243)
