...
public class class30 extends class28 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILfd;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IB)Lmv;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILfd;[I)V")
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(ILfd;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lfd;II)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(IBLtc;I)V")
