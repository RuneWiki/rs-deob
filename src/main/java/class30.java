...
public class class30 {
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IIIIIILda;B)Lda;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IILmo;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(IILda;IIZ)Lda;")
    ...
    @OriginalMember(owner = "client!rk", name = "a", descriptor = "(ILmo;)V")
    ...
    @OriginalMember(owner = "client!rk", name = "b", descriptor = "(ILmo;)Lhc;")
