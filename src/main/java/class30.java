...
public class class30 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([JII[Ljava/lang/Object;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILha;Ljava/lang/String;)I", line = 75)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luj;ZB)V", line = 108)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 276)
