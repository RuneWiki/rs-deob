...
public class class30 extends class390 {
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ILnq;Lnq;)V", line = 21)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "([B)V", line = 40)
    public class30(byte[] arg0) {
        this.field496 = arg0;
    }

    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IILjava/lang/String;)V", line = 52)
