...
public class class513 {
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)Lme;", line = 3)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(B)Lme;", line = 25)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lef;Lme;Z)V", line = 47)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILef;)V", line = 86)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IC)B", line = 97)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILme;)V", line = 222)
    ...
    @OriginalMember(owner = "client!ef", name = "h", descriptor = "(I)Lme;", line = 243)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Z)Lme;", line = 281)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(IB)V", line = 302)
    ...
    @OriginalMember(owner = "client!ef", name = "c", descriptor = "(I)Z", line = 333)
    ...
    @OriginalMember(owner = "client!ef", name = "e", descriptor = "(I)I", line = 345)
    ...
    @OriginalMember(owner = "client!ef", name = "d", descriptor = "(I)Lme;", line = 369)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZLme;)V", line = 388)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;)V", line = 406)
    ...
    @OriginalMember(owner = "client!ef", name = "f", descriptor = "(I)Ljava/lang/String;", line = 430)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "()V", line = 477)
    public class513() {
        try {
    ...
    @OriginalMember(owner = "client!ef", name = "g", descriptor = "(I)V", line = 453)
