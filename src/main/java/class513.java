...
public class class513 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILud;)V", line = 17)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lud;II)V", line = 64)
