...
public class class513 extends class223 {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(III)V", line = 42)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(IIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(III)V", line = 68)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(III)V", line = 102)
