...
public class class513 extends class354 {
    ...
    @OriginalMember(owner = "client!dw", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lnj;II)V", line = 18)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "()V", line = 80)
    public class513() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dw", name = "i", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIIBIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Ldq;IILjava/awt/Component;I)Lkl;", line = 258)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IB)[[I", line = 352)
