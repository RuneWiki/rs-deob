...
public class class513 extends class354 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ILti;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "()V", line = 47)
    public class513() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(B[Ljava/lang/Object;[J)V", line = 52)
    ...
    @OriginalMember(owner = "client!fm", name = "e", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BI)[[I", line = 76)
    ...
    @OriginalMember(owner = "client!fm", name = "f", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!fm", name = "g", descriptor = "(I)Lnn;", line = 249)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIBII)V", line = 273)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZII)Ljava/lang/String;", line = 291)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IB)[I", line = 304)
