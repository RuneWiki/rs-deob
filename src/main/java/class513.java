...
public class class513 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(Ljava/lang/String;B)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIIIBIII)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(BI[Ljava/lang/String;I[S)V")
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IIIIIB)V")
