...
public class class513 extends class76 implements Runnable {
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIB)Z", line = 17)
    ...
    @OriginalMember(owner = "client!pg", name = "c", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!pg", name = "run", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 107)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lfc;)V", line = 218)
    public class513(class170 arg0) {
        this.field7568 = arg0;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(III)V", line = 199)
