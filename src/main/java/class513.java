...
public class class513 extends class263 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIIB)V")
    ...
    @OriginalMember(owner = "client!sp", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IZLgk;)V")
