...
public class class513 extends class38 {
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lkd;[III)V")
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IILrg;)V")
