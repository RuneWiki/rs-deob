...
public class class513 extends class28 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lpq;I)Lva;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "([I)Lmda;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lpq;II)Lva;")
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Lpq;)Z")
