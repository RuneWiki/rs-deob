...
public abstract class class513 extends class361 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(CIZ)C", line = 6)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(I)V", line = 112)
    public class513(int arg0) {
        this.field7574 = arg0;
    }

    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)I", line = 123)
    public static final int method3058(int arg0, int arg1) {
        return class211.field3059 == null ? 0 : class211.field3059[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!dw", name = "g", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lsq;IIII)V", line = 169)
