...
public class class513 {
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(II)[I", line = 14)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(III)V", line = 169)
    ...
    @OriginalMember(owner = "client!ft", name = "b", descriptor = "(I)[[I", line = 119)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(III)Z", line = 153)
