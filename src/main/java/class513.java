...
public class class513 extends class535 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(ILwn;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)[[I", line = 60)
    ...
    @OriginalMember(owner = "client!nk", name = "c", descriptor = "(I)Z", line = 198)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "()V", line = 337)
    public class513() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Z)V", line = 220)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(II)[I", line = 235)
