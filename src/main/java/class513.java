...
public class class513 extends class148 {
    ...
    @OriginalMember(owner = "client!pg", name = "e", descriptor = "(I)Lsc;", line = 7)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILdh;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILic;)V", line = 67)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IBLjava/lang/String;Ljava/lang/String;)I", line = 78)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "()V", line = 352)
    public class513() {
        super(3, false);
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II)[I", line = 203)
    ...
    @OriginalMember(owner = "client!pg", name = "f", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZI)[[I", line = 295)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)V", line = 355)
