...
public abstract class class513 {
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIIIIIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(IIIII)V", line = 439)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIIII[B[BI)V", line = 54)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 99)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Z)V", line = 178)
    ...
    @OriginalMember(owner = "client!ug", name = "d", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(III)Z", line = 419)
