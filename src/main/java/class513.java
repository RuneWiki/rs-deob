...
public class class513 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ZILha;I)Lhu;", line = 14)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lee;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)Z", line = 86)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lee;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)V", line = 148)
