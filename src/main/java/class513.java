...
public abstract class class513 extends class693 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "([Lih;Z)I")
    ...
    @OriginalMember(owner = "client!lda", name = "b", descriptor = "(ILha;)Z")
    ...
    @OriginalMember(owner = "client!lda", name = "i", descriptor = "(I)V")
