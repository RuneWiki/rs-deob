...
public class class513 extends class238 implements class231 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lqa;IZIILco;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BILqa;)Lr;", line = 46)
    public final class159 method190(byte arg0, int arg1, class208 arg2) {
        ++field7314;
        return arg0 <= 40 ? null : this.method3048(arg2, (byte) -8, arg1);
    }

    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILqa;)V", line = 72)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(ILqa;)Lin;", line = 94)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IZLqa;B)Lis;", line = 119)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IZI)I", line = 149)
    ...
    @OriginalMember(owner = "client!th", name = "e", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILjava/lang/String;ZLjava/awt/Color;Ljava/awt/Color;ILjava/awt/Color;)V", line = 184)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lqa;BI)Lr;", line = 262)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)I", line = 289)
    ...
    @OriginalMember(owner = "client!th", name = "h", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILqa;IB)Z", line = 312)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)Z", line = 335)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lqa;Luh;IIIIZIZ)V", line = 346)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)I", line = 385)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(BLqa;)V", line = 398)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)V", line = 427)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lqa;I)Lpl;", line = 469)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BLqa;)V", line = 483)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(B)Z", line = 512)
