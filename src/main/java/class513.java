...
public class class513 extends class539 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(Z)Z", line = 14)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIB)Z", line = 39)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)Z", line = 50)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)I", line = 64)
    public final int method2848(int arg0) {
        field7009++;
        return arg0 == -1 ? class110.method824(this.field7010, 114) : 115;
    }

    @OriginalMember(owner = "client!po", name = "c", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 97)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IZ[S)[S", line = 132)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(II)V", line = 147)
