...
public class class513 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;[IIII[I[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;[II[I[I)V", line = 86)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "()V", line = 166)
    public static void method3108() {
        field7463 = null;
    }

    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(II)V", line = 172)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "()V", line = 256)
    private static final void method3111() {
        field7468 = 0;
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "([III)V", line = 262)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lr;[II)V", line = 314)
