...
public class class513 implements class69 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ZLbp;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BII)I", line = 37)
    ...
    @OriginalMember(owner = "client!hb", name = "finalize", descriptor = "()V", line = 52)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!hb", name = "d", descriptor = "(B)I", line = 73)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lgfa;III)V", line = 93)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILgfa;BI)V", line = 107)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BI)V", line = 182)
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lml;)V", line = 360)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Ljt;II)V", line = 203)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Z)Z", line = 239)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 278)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(II)V", line = 294)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(Z)I", line = 308)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IB)V", line = 331)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)V", line = 347)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lbp;II)V", line = 373)
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(B)V", line = 381)
