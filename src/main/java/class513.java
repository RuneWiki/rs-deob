...
public class class513 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(IIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIIIIIIIIIIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "([IIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "([I[IIIIIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "([I[IIIIIIIIFFFFFF)V")
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lra;)V")
