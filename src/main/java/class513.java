...
public class class513 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B[BI)I", line = 40)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)Z", line = 54)
