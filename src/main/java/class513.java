...
public class class513 extends class574 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(B)Z", line = 3)
    public final boolean method3116(byte arg0) {
        field7429++;
        return arg0 == -5 ? false : false;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lut;Ljava/lang/Object;I)V", line = 117)
    public class513(class688 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field7426 = arg1;
    }

    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 125)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IBILha;III)V", line = 135)
    ...
    @OriginalMember(owner = "client!ic", name = "d", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!ic", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 204)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILjc;I)V", line = 231)
