...
public class class513 extends class618 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "()V", line = 6)
    public final void method2832() {
        this.field6547 = true;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(IIIII)V", line = 10)
    public final void method2833(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field6546 = arg0;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lha;J)Z", line = 21)
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class513(int arg0, boolean arg1) {
        this.method2842(arg0, arg1);
    }

    @OriginalMember(owner = "client!nia", name = "b", descriptor = "()V", line = 72)
    public static void method2835() {
        field6539 = null;
        field6538 = null;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(J)V", line = 76)
    public final void method2836(long arg0) {
        this.field6537 = arg0;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "([Lld;Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!nia", name = "c", descriptor = "()Lwq;", line = 169)
    ...
    @OriginalMember(owner = "client!nia", name = "d", descriptor = "()V", line = 184)
    private final void method2839() {
        this.field6540 = false;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lha;J[Lsba;[Lld;Z)V", line = 188)
    ...
    @OriginalMember(owner = "client!nia", name = "e", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(IZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(IZ)Lnia;", line = 240)
    ...
    @OriginalMember(owner = "client!nia", name = "f", descriptor = "()Lwq;", line = 253)
    public final class705 method2844() {
        return this.field6549;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lha;)V", line = 261)
    ...
    @OriginalMember(owner = "client!nia", name = "g", descriptor = "()V", line = 280)
    public final void method2846() {
        this.field6540 = true;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lha;[Lsba;Z)V", line = 285)
