...
public class class513 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIII)Z", line = 58)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Z)V", line = 104)
