...
public class class513 extends class371 {
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "()V", line = 6)
    public class513() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(BI)[[I", line = 13)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!uu", name = "b", descriptor = "(IIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Luf;BLjava/lang/Object;)V", line = 251)
    ...
    @OriginalMember(owner = "client!uu", name = "g", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IBLps;)V", line = 298)
