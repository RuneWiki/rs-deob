...
public class class513 extends class751 {
    ...
    @OriginalMember(owner = "client!hca", name = "<init>", descriptor = "()V", line = 4)
    public class513() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hca", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(ILrv;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lwga;Z)Z", line = 66)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IIILge;)V", line = 202)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(II)[I", line = 237)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IB)[[I", line = 328)
