...
public class class513 extends class315 {
    ...
    @OriginalMember(owner = "client!pg", name = "OA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lcv;Ldq;[Lft;[I[I)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([B[IIIIIIIIIIILma;II)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(CIIIZLma;II)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "([B[IIIIIIII)V")
