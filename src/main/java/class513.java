...
public class class513 extends class55 {
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(I)V", line = 66)
    public class513(int arg0) {
        this.field6940 = arg0;
    }

    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)V", line = 40)
