...
public class class513 extends class313 {
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(ILkha;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([BB)I", line = 36)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Z)V", line = 137)
