...
public class class513 extends class89 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILya;)V", line = 3)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(II)Z", line = 58)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(II)Z", line = 75)
    public final boolean method3064(int arg0, int arg1) {
        field7433++;
        return arg0 > -56 ? false : this.field7440[arg1].field7324;
    }

    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIB)V", line = 91)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IB)Z", line = 122)
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(I)V", line = 241)
