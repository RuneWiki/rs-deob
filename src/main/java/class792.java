...
public class class792 implements Runnable {
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 256)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(II[BI)I", line = 54)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "([Lhh;ILpq;)Lon;", line = 99)
    ...
    @OriginalMember(owner = "client!wv", name = "run", descriptor = "()V", line = 168)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 232)
