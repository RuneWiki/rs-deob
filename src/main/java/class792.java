...
public class class792 extends class502 {
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!ms", name = "c", descriptor = "(B)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(Leka;)V", line = 87)
    public class792(class492 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!ms", name = "<init>", descriptor = "(ILeka;)V", line = 104)
    public class792(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(B)I", line = 108)
    public final int method4322(byte arg0) {
        ++field10850;
        return arg0 <= 49 ? 78 : super.field6865;
    }

    @OriginalMember(owner = "client!ms", name = "b", descriptor = "(I)Z", line = 120)
