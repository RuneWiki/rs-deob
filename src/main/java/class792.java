...
public class class792 implements class730 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(IIIIIIZZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)V", line = 33)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZILgga;Ljava/lang/String;)Ldl;", line = 45)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIIIIZZ)V", line = 95)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lrp;Lmq;Ltia;)V", line = 116)
