...
public class class792 extends class232 {
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZB)V", line = 46)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILdr;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lwk;)V", line = 100)
    ...
    @OriginalMember(owner = "client!mp", name = "e", descriptor = "(I)Z", line = 210)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BJ)V", line = 225)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(B)V", line = 288)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)V", line = 301)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZI)V", line = 318)
