...
public class class792 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIIIIIBLeq;I)Z", line = 8)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIB)Z", line = 367)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lha;ZII)Lda;", line = 383)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 401)
