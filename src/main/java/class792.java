...
public class class792 implements class414 {
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)Ldn;", line = 26)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 37)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Ler;Ldn;Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IZ)V", line = 90)
