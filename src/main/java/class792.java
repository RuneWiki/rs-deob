...
public class class792 extends class84 {
    ...
    @OriginalMember(owner = "client!ms", name = "e", descriptor = "(B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!ms", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ms", name = "f", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!ms", name = "g", descriptor = "(B)V", line = 65)
