...
public class class792 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IIB)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILka;BI)Loba;", line = 30)
