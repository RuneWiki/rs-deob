...
public class class792 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILft;)Lvn;")
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)Ljc;")
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(BLht;)Z")
