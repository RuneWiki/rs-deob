...
public class class337 extends class535 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILwn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "()V", line = 280)
    public class337() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIZI)V", line = 125)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 231)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(II)[[I", line = 286)
    ...
    @OriginalMember(owner = "client!nm", name = "e", descriptor = "(I)V", line = 358)
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(II)I", line = 380)
