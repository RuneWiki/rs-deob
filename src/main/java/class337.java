...
public class class337 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ZLza;)V", line = 38)
    ...
    @OriginalMember(owner = "client!dp", name = "b", descriptor = "(I)Lko;", line = 149)
    ...
    @OriginalMember(owner = "client!dp", name = "c", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IILia;)V", line = 231)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ljava/lang/String;CI)I", line = 312)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(B)Z", line = 338)
    ...
    @OriginalMember(owner = "client!dp", name = "d", descriptor = "(I)V", line = 367)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)Lko;", line = 383)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(CBI)C", line = 459)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(BC)Z", line = 544)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Lia;B)V", line = 572)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "()V", line = 597)
