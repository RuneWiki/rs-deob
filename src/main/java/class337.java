...
public class class337 extends class403 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 17)
    public class337(Object arg0, int arg1) {
        super(arg1);
        this.field5076 = arg0;
    }

    @OriginalMember(owner = "client!np", name = "e", descriptor = "(I)Z", line = 29)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lqf;Liq;)V", line = 40)
    ...
    @OriginalMember(owner = "client!np", name = "d", descriptor = "(B)V", line = 1166)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 1177)
