...
public class class337 extends class345 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!dk", name = "f", descriptor = "(I)Lrm;")
    ...
    @OriginalMember(owner = "client!dk", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(II)Lou;")
