...
public class class337 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!qi", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!qi", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(IZ)V", line = 90)
