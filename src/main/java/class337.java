...
public class class337 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lvo;", line = 6)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(JI)V", line = 23)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIBLab;)V", line = 117)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lve;I)I", line = 140)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILvt;)V", line = 172)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)V", line = 258)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lvt;II)V", line = 268)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 295)
