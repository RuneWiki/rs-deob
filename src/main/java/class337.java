...
public class class337 implements class219 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILm;II)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILsr;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILhj;II)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILhj;I)V")
    public final void method2139(int arg0, class106 arg1, int arg2) {
        this.method2136(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILoe;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILm;I)V")
    public final void method2141(int arg0, class181 arg1, int arg2) {
        this.method2133(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILoe;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lhd;)V")
