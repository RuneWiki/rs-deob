...
public class class337 extends class577 implements class281 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!vu", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BLha;)Llba;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ILha;IZ)Lbt;")
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IZI)Z")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(ILha;)Llca;")
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IILha;)Lka;")
