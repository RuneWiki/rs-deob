...
public class class337 extends class346 {
    ...
    @OriginalMember(owner = "client!vl", name = "d", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(B[[[Ldh;)V", line = 21)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lps;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(II)[I", line = 124)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "()V", line = 147)
    public class337() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 170)
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 187)
