...
public abstract class class337 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)I", line = 31)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIILnr;Lfl;I)V", line = 207)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIILbr;Lbr;)V", line = 294)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)V", line = 301)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(II)V", line = 321)
