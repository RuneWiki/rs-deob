...
public class class337 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZLeq;IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IILeq;I)Lww;", line = 69)
