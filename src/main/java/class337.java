...
public class class337 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIILuw;)Ljk;")
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(IB)Lii;")
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lsj;ILin;Lin;)V")
