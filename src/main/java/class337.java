...
public abstract class class337 implements class220 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)Z", line = 27)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Z)I", line = 54)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lkfa;IIIZ)V", line = 213)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "(I)Z", line = 142)
    ...
    @OriginalMember(owner = "client!jo", name = "finalize", descriptor = "()V", line = 165)
    ...
    @OriginalMember(owner = "client!jo", name = "e", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(IZ)V", line = 189)
