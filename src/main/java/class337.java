...
public class class337 extends class228 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 9)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IBILjava/awt/Graphics;)V", line = 30)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIILjava/awt/Graphics;I)V", line = 43)
