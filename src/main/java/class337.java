...
public class class337 extends class56 {
    ...
    @OriginalMember(owner = "client!vc", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BILes;)V", line = 48)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "()V", line = 274)
    public class337() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IIIBIII)I", line = 176)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 256)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB[I)V", line = 281)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)[I", line = 441)
