...
public class class337 extends class214 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IB)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 80)
    public class337() {
        super(0, false);
    }

    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Llk;II)V", line = 929)
    ...
    @OriginalMember(owner = "client!tb", name = "d", descriptor = "(I)I", line = 943)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Z)V", line = 956)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(III)V", line = 968)
