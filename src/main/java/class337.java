...
public abstract class class337 {
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(III)I", line = 14)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!qi", name = "a", descriptor = "(ZLsd;)V", line = 56)
