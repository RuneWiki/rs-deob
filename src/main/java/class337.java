...
public class class337 extends class7 {
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZJ)I", line = 20)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!en", name = "c", descriptor = "(I)J", line = 70)
    ...
    @OriginalMember(owner = "client!en", name = "d", descriptor = "(I)J", line = 98)
