...
public class class337 extends class299 {
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(IIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!tr", name = "c", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BII)V", line = 65)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(III)V", line = 76)
