...
public class class337 extends class264 implements class440 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIZLjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lhj;Z)V")
    public class337(class47 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(ZI)Ljaclib/memory/Buffer;")
