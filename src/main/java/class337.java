...
public class class337 implements class502 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III[FIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IZ)V", line = 117)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)I", line = 142)
    public final int method1936(int arg0) {
        field4277++;
        return arg0 < 28 ? -28 : this.field4270.field9563;
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IJ)Z", line = 155)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!b", name = "d", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I[Lria;Z)V", line = 227)
    ...
    @OriginalMember(owner = "client!b", name = "b", descriptor = "(I)V", line = 299)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(I[[BLsa;)V", line = 312)
    ...
    @OriginalMember(owner = "client!b", name = "e", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Ljca;Ler;)V", line = 1223)
