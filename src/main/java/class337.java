...
public class class337 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "([BII)[B", line = 8)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IIZLaa;IILha;ILqk;)V", line = 22)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)V", line = 237)
