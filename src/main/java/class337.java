...
public class class337 extends class172 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lrt;I)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lkm;I)I")
    ...
    @OriginalMember(owner = "client!mt", name = "g", descriptor = "(I)V")
