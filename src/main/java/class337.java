...
public class class337 extends class234 {
    ...
    @OriginalMember(owner = "client!cc", name = "f", descriptor = "(B)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!cc", name = "e", descriptor = "(B)Z", line = 15)
    public final boolean method1722(byte arg0) {
        return arg0 > -35 ? true : true;
    }

    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Lmc;Ljava/lang/Object;)V", line = 25)
