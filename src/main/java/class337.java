...
public class class337 extends class669 {
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(I)Z", line = 4)
    public final boolean method1(int arg0) {
        return arg0 == 9567 ? this.field4670 : true;
    }

    @OriginalMember(owner = "client!uv", name = "f", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IILnq;)V", line = 34)
    ...
    @OriginalMember(owner = "client!uv", name = "d", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZI)V", line = 125)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Lss;Lbi;)V", line = 133)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ZZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 165)
    ...
    @OriginalMember(owner = "client!uv", name = "e", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!uv", name = "g", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BII)V", line = 232)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)V", line = 241)
