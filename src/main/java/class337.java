...
public class class337 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IZ)Ltr;", line = 24)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)Lff;", line = 54)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(Z)V", line = 74)
    ...
    @OriginalMember(owner = "client!vu", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(BI)V", line = 102)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(IIILha;IIILbe;IIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!vu", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 196)
