...
public class class337 extends class371 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IBLps;)V", line = 21)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BI)[[I", line = 63)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "()V", line = 134)
    public class337() {
        super(1, false);
    }
}
