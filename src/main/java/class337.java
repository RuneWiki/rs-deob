...
public class class337 implements Runnable {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZLlg;)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lpg;I)V")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Ldh;II)Lpg;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I[BZLdh;)Lpg;")
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(IILdh;)Lpg;")
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lkj;)V")
