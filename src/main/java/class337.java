...
public abstract class class337 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lmh;)V", line = 23)
    public class337(class537 arg0) {
        this.field4382 = arg0;
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BII)Z", line = 37)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)Lbo;", line = 47)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)V", line = 70)
