...
public abstract class class337 extends class431 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BILhp;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II)[[I", line = 24)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(B)I", line = 36)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!eu", name = "g", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(III)[[I", line = 125)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IB)[I", line = 157)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(III)[I", line = 173)
    ...
    @OriginalMember(owner = "client!eu", name = "h", descriptor = "(I)V", line = 196)
    ...
    @OriginalMember(owner = "client!eu", name = "d", descriptor = "(III)Z", line = 209)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(IZ)V", line = 221)
