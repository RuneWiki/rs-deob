...
public class class337 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ILwd;)Lnga;", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ldc;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lvk;I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(III)Z", line = 136)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Z)V", line = 147)
