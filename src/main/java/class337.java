...
public class class337 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lr;Lhe;)Z")
    public final boolean method2117(class166 arg0, class337 arg1) {
        return this.field4977 != null || this.method2125(arg0, arg1);
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lr;IIIIII)V")
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(Lr;Lhe;)V")
    ...
    @OriginalMember(owner = "client!he", name = "c", descriptor = "(Lr;Lhe;)V")
    ...
    @OriginalMember(owner = "client!he", name = "d", descriptor = "(Lr;Lhe;)Z")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lr;)V")
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(Lr;)V")
