...
public class class337 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BLrd;)V", line = 41)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IZLjava/lang/String;Z)I", line = 125)
