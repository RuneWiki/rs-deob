...
public abstract class class337 extends class22 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!os", name = "d", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Luo;IIIZBLpc;)V", line = 48)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[IB[JI)V", line = 65)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([IB)Ljava/lang/String;", line = 120)
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(I)V", line = 172)
