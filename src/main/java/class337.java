...
public class class337 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(I)[Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(IZ)V", line = 196)
    public class337(int arg0, boolean arg1) {
        this.field4882 = arg1;
        this.field4893 = arg0;
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 65)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!vc", name = "toString", descriptor = "()Ljava/lang/String;", line = 115)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)I", line = 149)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IB)V", line = 178)
