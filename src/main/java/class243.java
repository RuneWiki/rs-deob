...
public abstract class class243 extends class168 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!rga", name = "b", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IIIIIILje;IIII)Z", line = 43)
    ...
    @OriginalMember(owner = "client!rga", name = "e", descriptor = "(B)I", line = 304)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(Ljava/lang/String;IZI)I", line = 320)
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(Lbi;)V", line = 396)
