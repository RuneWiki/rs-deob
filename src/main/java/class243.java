...
public class class243 extends class379 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "([IILpl;[B)Z", line = 24)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IBLjava/lang/String;)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 182)
    public class243() {
    }

    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "([B)V", line = 186)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 822)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 835)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)V", line = 849)
