...
public class class243 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Lne;I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Log;", line = 31)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(B)V", line = 48)
