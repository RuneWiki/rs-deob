...
public class class243 extends class627 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Ljava/lang/String;ZB)V", line = 177)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIIIF)V", line = 192)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IB)V", line = 315)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)V", line = 334)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(II)V", line = 347)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lup;IIIII)V", line = 367)
