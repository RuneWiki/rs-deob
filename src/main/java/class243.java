...
public class class243 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILos;I)V")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(I)Ldp;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Los;I)V")
