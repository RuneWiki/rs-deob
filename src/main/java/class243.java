...
public class class243 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!dia", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!dia", name = "d", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(ZIIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Z)Z", line = 56)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(II)I", line = 67)
    public static final int method2098(int arg0, int arg1) {
        return class54.field691 == null ? 0 : class54.field691[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!dia", name = "c", descriptor = "(I)I", line = 72)
