...
public class class243 extends class424 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lrg;BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIB)V", line = 98)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IZ)[[I", line = 126)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIIII)V", line = 169)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIIIB)V", line = 187)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(IB)[I", line = 203)
    ...
    @OriginalMember(owner = "client!v", name = "g", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "()V", line = 249)
    public class243() {
        super(1, false);
    }

    @OriginalMember(owner = "client!v", name = "b", descriptor = "(Z)V", line = 252)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "(III)Ljk;", line = 268)
