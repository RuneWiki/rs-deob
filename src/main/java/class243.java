...
public class class243 extends class21 {
    ...
    @OriginalMember(owner = "client!eia", name = "d", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 16)
    public final Object method165(int arg0) {
        return arg0 <= 75 ? (Object) null : this.field3533.get();
    }

    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 25)
