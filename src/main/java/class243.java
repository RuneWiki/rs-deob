...
public class class243 extends class98 {
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)[I", line = 81)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "()V", line = 128)
    public class243() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ILdg;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ad", name = "e", descriptor = "(I)V", line = 182)
