...
public class class243 extends class237 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILqa;Lr;)V", line = 18)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!daa", name = "e", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILqa;)Llb;", line = 90)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 173)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IILqa;I)Lr;", line = 128)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILqa;IB)Z", line = 145)
    public final boolean method164(int arg0, class167 arg1, int arg2, byte arg3) {
        ++field3573;
        return arg3 != 77;
    }

    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)V", line = 156)
    ...
    @OriginalMember(owner = "client!daa", name = "finalize", descriptor = "()V", line = 203)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(Z)Z", line = 214)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BLqa;)Led;", line = 225)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ZBI)V", line = 250)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(IC)Z", line = 342)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lqa;Z)V", line = 358)
