...
public class class243 extends class285 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 18)
    public final void method1490(byte arg0, Component arg1) {
        int var3 = 79 / ((55 - arg0) / 59);
        arg1.addMouseWheelListener(this);
    }

    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 26)
    public final void method1491(Component arg0, int arg1) {
        arg0.removeMouseWheelListener(this);
        int var3 = 47 / ((arg1 + 57) / 47);
    }

    @OriginalMember(owner = "client!uv", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 35)
