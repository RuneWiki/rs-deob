...
public class class243 extends class354 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lnj;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "()V", line = 49)
    public class243() {
        super(1, false);
    }

    @OriginalMember(owner = "client!du", name = "b", descriptor = "(BI)[I", line = 52)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IB)[[I", line = 144)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(BIIIII[B)Z", line = 283)
    ...
    @OriginalMember(owner = "client!du", name = "b", descriptor = "(III)V", line = 338)
