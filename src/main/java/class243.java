...
public class class243 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIB)I", line = 23)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IB)V", line = 52)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BLeo;)V", line = 80)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZI)Lpq;", line = 113)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lgt;ILdn;)V", line = 163)
