...
public class class243 extends class227 {
    ...
    @OriginalMember(owner = "client!vh", name = "j", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "()V", line = 17)
    public class243() {
        this(0);
    }

    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lug;II)V", line = 34)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIIII)I", line = 60)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(I)V", line = 116)
    private class243(int arg0) {
        super(0, false);
        this.method1516(arg0, 4080);
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IZ)[[I", line = 128)
