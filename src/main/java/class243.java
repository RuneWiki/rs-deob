...
public class class243 extends class499 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "([III)V", line = 53)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIIII)V", line = 175)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(FIIBI)V", line = 192)
    ...
    @OriginalMember(owner = "client!uv", name = "b", descriptor = "(II)V", line = 305)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(BIII)V", line = 318)
    ...
    @OriginalMember(owner = "client!uv", name = "c", descriptor = "(II)V", line = 332)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IIIIBI)V", line = 348)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IBI)V", line = 450)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "(Ljt;IIIII)V", line = 473)
