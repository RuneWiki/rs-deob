...
public class class243 implements Runnable {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZBLir;Lir;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lfb;B)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[BLeg;)Loo;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILeg;)Loo;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILoo;)V")
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IILeg;)Loo;")
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lde;)V")
