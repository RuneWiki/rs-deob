...
public class class243 extends class32 {
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 5)
    public class243(Object arg0, int arg1) {
        super(arg1);
        this.field3397 = arg0;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(III)V", line = 14)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 41)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)Z", line = 52)
