...
public class class243 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(III)V", line = 10)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Luc;)V", line = 85)
    public class243(class58 arg0) {
        this.field3309 = arg0;
    }

    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)Lgl;", line = 50)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(B)Lgl;", line = 96)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(Lam;IIZ)Ljp;", line = 130)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IJ)V", line = 146)
