...
public class class243 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IBIIIII)I", line = 15)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 131)
