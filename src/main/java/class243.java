...
public class class243 extends class756 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lic;[IB[I[I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Lkp;I)V")
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLib;)V")
