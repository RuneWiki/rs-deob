...
public class class243 extends Canvas {
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    public final void paint(Graphics arg0) {
        this.field3539.paint(arg0);
        field3545++;
    }

    @OriginalMember(owner = "client!mh", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
