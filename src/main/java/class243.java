...
public class class243 extends class214 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IB)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lms;Z)Ljava/lang/String;", line = 43)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IBII)V", line = 65)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(I)V", line = 95)
    private class243(int arg0) {
        super(0, false);
        this.method1521(92, arg0);
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(CB)Z", line = 107)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Llk;II)V", line = 151)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II)V", line = 180)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "()V", line = 192)
    public class243() {
        this(0);
    }

    @OriginalMember(owner = "client!ge", name = "f", descriptor = "(I)V", line = 195)
