...
public class class243 extends class436 {
    ...
    @OriginalMember(owner = "client!un", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!un", name = "f", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILeb;)V", line = 275)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "()V", line = 309)
    public class243() {
        super(2, false);
    }

    @OriginalMember(owner = "client!un", name = "b", descriptor = "(II)[[I", line = 314)
