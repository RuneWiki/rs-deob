...
public class class243 extends class449 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IBII)Z", line = 17)
    ...
    @OriginalMember(owner = "client!om", name = "d", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(II)V", line = 139)
    public class243(int arg0, int arg1) {
        this.field3528 = arg0;
        this.field3530 = arg1;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZ)V", line = 149)
