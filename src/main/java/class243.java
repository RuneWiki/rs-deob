...
public class class243 extends class119 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "([[BILft;)V", line = 7)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lug;IIII[BI)V", line = 125)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lug;IIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIZIIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(III)Ljava/lang/String;", line = 183)
