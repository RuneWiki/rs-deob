...
public class class243 extends class461 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BLeh;)Loba;", line = 4)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(IIIIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IIB)V", line = 70)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BII)V", line = 103)
