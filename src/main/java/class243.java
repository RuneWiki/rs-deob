...
public class class243 implements class344 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 23)
    public class243(String arg0) {
        this.field3337 = arg0;
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(JJ)J", line = 31)
    public static long method1596(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)Z", line = 84)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Z)I", line = 95)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(B)Ldca;", line = 114)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BIIIIILid;)Z", line = 129)
