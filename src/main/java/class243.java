...
public abstract class class243 {
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(JJ)J", line = 5)
    public static long method1403(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ZIBIZ)I", line = 12)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lmu;Lmu;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 101)
