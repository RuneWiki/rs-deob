...
public class class243 implements Runnable {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lwk;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljava/lang/String;B)Lwu;", line = 31)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 126)
    public class243() {
        this.field3470.setDaemon(true);
        this.field3470.start();
    }

    @OriginalMember(owner = "client!ui", name = "run", descriptor = "()V", line = 88)
