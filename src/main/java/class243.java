...
public class class243 {
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(B)Lgda;", line = 6)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(ILgda;)V", line = 29)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(Z)Lgda;", line = 50)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!eia", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(ZII)Z", line = 112)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(FIIIIZII)[I", line = 123)
    ...
    @OriginalMember(owner = "client!eia", name = "b", descriptor = "(I)I", line = 146)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(B[B)[B", line = 165)
    ...
    @OriginalMember(owner = "client!eia", name = "c", descriptor = "(I)Lgda;", line = 227)
    ...
    @OriginalMember(owner = "client!eia", name = "d", descriptor = "(I)Lgda;", line = 245)
    ...
    @OriginalMember(owner = "client!eia", name = "a", descriptor = "(BLcha;ILcha;IZZ)I", line = 270)
    ...
    @OriginalMember(owner = "client!eia", name = "e", descriptor = "(I)Z", line = 308)
    ...
    @OriginalMember(owner = "client!eia", name = "<init>", descriptor = "()V", line = 323)
    public class243() {
