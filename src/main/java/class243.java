...
public abstract class class243 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 82)
    public final void windowOpened(WindowEvent arg0) {
        field3660++;
    }

    @OriginalMember(owner = "client!pr", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 91)
    ...
    @OriginalMember(owner = "client!pr", name = "start", descriptor = "()V", line = 113)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lam;B)V", line = 125)
    ...
    @OriginalMember(owner = "client!pr", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 168)
    public final void windowDeiconified(WindowEvent arg0) {
        field3648++;
    }

    @OriginalMember(owner = "client!pr", name = "stop", descriptor = "()V", line = 175)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!pr", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 204)
    public final void windowActivated(WindowEvent arg0) {
        field3673++;
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!pr", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 249)
    ...
    @OriginalMember(owner = "client!pr", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 265)
    public final void windowClosed(WindowEvent arg0) {
        field3663++;
    }

    @OriginalMember(owner = "client!pr", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 272)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ILjava/lang/String;)V", line = 286)
    ...
    @OriginalMember(owner = "client!pr", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 313)
    public final void focusLost(FocusEvent arg0) {
        class232.field3491 = false;
        field3672++;
    }

    @OriginalMember(owner = "client!pr", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 322)
    public final void windowIconified(WindowEvent arg0) {
        field3662++;
    }

    @OriginalMember(owner = "client!pr", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 340)
    ...
    @OriginalMember(owner = "client!pr", name = "destroy", descriptor = "()V", line = 355)
    ...
    @OriginalMember(owner = "client!pr", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 370)
    ...
    @OriginalMember(owner = "client!pr", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 385)
    ...
    @OriginalMember(owner = "client!pr", name = "run", descriptor = "()V", line = 401)
    ...
    @OriginalMember(owner = "client!pr", name = "c", descriptor = "(I)V", line = 519)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IZIII)V", line = 530)
    ...
    @OriginalMember(owner = "client!pr", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 577)
    public final void windowDeactivated(WindowEvent arg0) {
        field3645++;
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIILjava/lang/String;ZII)V", line = 587)
    ...
    @OriginalMember(owner = "client!pr", name = "d", descriptor = "(I)V", line = 628)
    ...
    @OriginalMember(owner = "client!pr", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 678)
    public final void update(Graphics arg0) {
        this.paint(arg0);
        field3652++;
    }

    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(B)V", line = 686)
    ...
    @OriginalMember(owner = "client!pr", name = "e", descriptor = "(I)V", line = 720)
    ...
    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(I)V", line = 753)
    ...
    @OriginalMember(owner = "client!pr", name = "providesignlink", descriptor = "(Lgt;)V", line = 798)
    ...
    @OriginalMember(owner = "client!pr", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 811)
    public final void windowClosing(WindowEvent arg0) {
        field3654++;
        this.destroy();
    }

    @OriginalMember(owner = "client!pr", name = "f", descriptor = "(B)Ljava/lang/String;", line = 822)
