...
public class class243 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lfd;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lfd;Ljaggl/memory/NativeBuffer;)V", line = 21)
