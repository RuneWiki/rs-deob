...
public class class243 extends class17 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lwm;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIB)V", line = 47)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(B)Lrm;", line = 97)
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "()V", line = 113)
    public class243() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)[I", line = 116)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Loi;Z)V", line = 164)
    ...
    @OriginalMember(owner = "client!ws", name = "h", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!ws", name = "d", descriptor = "(III)Z", line = 197)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IB)[[I", line = 207)
    ...
    @OriginalMember(owner = "client!ws", name = "e", descriptor = "(III)I", line = 285)
