...
public class class243 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILnf;)Z", line = 183)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)V", line = 205)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lsha;J[Lmca;)V", line = 216)
    public class243(class757 arg0, long arg1, class33[] arg2) {
        this.field3190 = arg0;
        this.field3191 = arg1;
    }

    @OriginalMember(owner = "client!jd", name = "finalize", descriptor = "()V", line = 228)
