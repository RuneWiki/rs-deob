...
public class class243 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Lqp;IIFIF[BBFIIIFF)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BLao;)V")
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)Lao;")
