...
public class class243 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lkd;I)I")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILha;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z)[Las;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IILjb;Z)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIILjava/lang/Class;)Lum;")
