...
public class class243 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lov;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IB)Lfw;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)Lfu;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lfaa;B)V")
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(Lov;I)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lls;B)V")
