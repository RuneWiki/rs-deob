...
public class class257 extends class569 implements class65 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(FI)F", line = 3)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IBIII[III)V", line = 16)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Z)Z", line = 39)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(I)[Lgi;", line = 51)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Llca;IIZIIII[B)V", line = 61)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(Z)I", line = 84)
    public final int method665(boolean arg0) {
        ++field3927;
        return arg0 ? -97 : this.field3926;
    }

    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lhp;Llca;Lig;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lhp;Llca;II[FII)V", line = 121)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ZF)F", line = 136)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lhp;Llca;II[BII)V", line = 149)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(BZZ)V", line = 164)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Lhp;II[III)V", line = 174)
