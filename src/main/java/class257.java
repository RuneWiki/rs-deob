...
public class class257 extends class108 implements class534 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILqa;ZLee;Z)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lqa;Lku;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILqa;I)Lka;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B[I[I[ILsg;)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILqa;)Lnj;")
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(Lqa;B)Lem;")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lrg;IILqa;Lau;I)Z")
