...
public class class257 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lr;ZZ)Lf;")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lie;BI)V")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(ILr;)Lf;")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(BLhfa;)Z")
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(Lie;I)V")
