...
public class class257 extends class281 {
    ...
    @OriginalMember(owner = "client!ok", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lac;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ok", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIILen;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lcba;[I)V")
    ...
    @OriginalMember(owner = "client!ok", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lni;ZIIII)V")
