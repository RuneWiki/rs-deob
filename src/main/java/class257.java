...
public class class257 extends class206 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Ldd;[I)V")
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lbv;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIILfi;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "U", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!lh", name = "O", descriptor = "(IILj;)Lj;")
    ...
    @OriginalMember(owner = "client!lh", name = "SA", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lj;IIIIZ)Z")
