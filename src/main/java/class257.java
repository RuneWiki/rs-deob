...
public class class257 implements class40 {

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "[I")
    private int[] field4127 = null;
    ...
    public final void method72(int arg0) {
        ...
        if (class322.field4994 && this.field4127 != null) {
            var2.glActiveTexture(33985);
            var2.glBindTexture(34067, this.field4127[arg0 - 1]);
            var2.glActiveTexture(33984);
        }
    }

    @OriginalMember(owner = "client!vi", name = "d", descriptor = "()V", line = 25)
    private final void method1846() {
        GL var1 = class232.field3716;
        if (this.field4127 == null) {
            this.field4127 = new int[3];
            var1.glGenTextures(3, this.field4127, 0);
        }
        short var2 = 4096;
        ...
        for (int var6 = 0; var6 < 6; var6++) {
            ...
            var1.glBindTexture(34067, this.field4127[0]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var4));
            var1.glBindTexture(34067, this.field4127[1]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var5));
            var1.glBindTexture(34067, this.field4127[2]);
            var1.glTexImage2D(var6 + 34069, 0, 6406, 64, 64, 0, 6406, 5121, ByteBuffer.wrap(var3));
            class230.field3663 += var2 * 3;
        }
    }

    @OriginalMember(owner = "client!vi", name = "e", descriptor = "()V", line = 141)
    private final void method1847() {
        GL var1 = class232.field3716;
        this.field4128 = var1.glGenLists(2);
        var1.glNewList(this.field4128, 4864);
        if (this.field4127 == null) {
            ...
            if (this.field4129) {
                ...
                var1.glTexEnvi(8960, 34162, 7681);
                var1.glTexEnvi(8960, 34184, 34167);
                var1.glBindTexture(3553, class232.field3685);
                var1.glEnable(3553);
            }
            var1.glActiveTexture(33984);
        }
        var1.glEndList();
        var1.glNewList(this.field4128 + 1, 4864);
        if (this.field4127 == null) {
    ...
    @OriginalMember(owner = "client!vi", name = "c", descriptor = "()I", line = 233)
    public final int method66() {
        return 4;
    }

    @OriginalMember(owner = "client!vi", name = "a", descriptor = "()V", line = 240)
    public final void method69() {
        GL var1 = class232.field3716;
        class232.method1664(1);
        if (class322.field4994) {
            var1.glCallList(this.field4128);
        } else {
            var1.glTexEnvi(8960, 34184, 34167);
        }
    }

    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "()V", line = 270)
    public class257() {
        if (class232.field3722 && class232.field3721 >= 2) {
            this.method1846();
            GL var1 = class232.field3716;
            var1.glBindTexture(34067, this.field4127[0]);
            ...
            var1.glTexParameteri(34067, 10242, 33071);
            var1.glTexParameteri(34067, 10243, 33071);
            this.field4129 = class232.field3721 < 3;
        }
        this.method1847();
    }

    @OriginalMember(owner = "client!vi", name = "b", descriptor = "()V", line = 260)
    public final void method71() {
        GL var1 = class232.field3716;
        if (class322.field4994) {
            var1.glCallList(this.field4128 + 1);
        } else {
            var1.glTexEnvi(8960, 34184, 5890);
        }
    }
