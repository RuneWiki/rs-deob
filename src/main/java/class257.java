...
public class class257 extends class333 implements class157 {
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lih;ILjaggl/memory/NativeBuffer;)V")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lih;I[BI)V")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lza;B)V")
