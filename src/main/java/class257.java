...
public class class257 extends class124 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(BLc;)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILjk;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!ku", name = "ha", descriptor = "(Lc;)V")
