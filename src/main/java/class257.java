...
public class class257 extends class194 {
    ...
    @OriginalMember(owner = "client!vw", name = "j", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vw", name = "k", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(FB)V", line = 214)
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(I)V", line = 233)
    public class257(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(FI)V", line = 237)
