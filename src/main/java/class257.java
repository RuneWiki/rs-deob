...
public class class257 implements class126 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(II)Ljs;")
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(II)Lom;")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lhh;Lhh;Lhh;)V")
