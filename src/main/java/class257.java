...
public class class257 extends class210 {
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IILat;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ro", name = "g", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(ILct;)V", line = 51)
    ...
    @OriginalMember(owner = "client!ro", name = "b", descriptor = "(IB)I", line = 63)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IB)[I", line = 74)
    ...
    @OriginalMember(owner = "client!ro", name = "e", descriptor = "(I)V", line = 136)
    public final void method363(int arg0) {
        class51.method392(arg0);
        ++field3805;
    }

    @OriginalMember(owner = "client!ro", name = "<init>", descriptor = "()V", line = 144)
    public class257() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(Lva;I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(II)[[I", line = 178)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(BLbn;)V", line = 241)
    ...
    @OriginalMember(owner = "client!ro", name = "a", descriptor = "(IIZLgt;II)Ljava/awt/Frame;", line = 253)
