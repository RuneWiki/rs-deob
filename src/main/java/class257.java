...
public class class257 extends class782 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILjava/awt/Graphics;IBIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(ILjava/awt/Canvas;II)V", line = 29)
