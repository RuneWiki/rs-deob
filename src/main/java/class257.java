...
public class class257 extends class445 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIIIZLnb;IILjo;Lwm;)Lgn;", line = 3)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Lr;I)V", line = 270)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lhk;", line = 328)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IIIZI)Lcu;", line = 345)
    ...
    @OriginalMember(owner = "client!we", name = "b", descriptor = "(B)V", line = 386)
