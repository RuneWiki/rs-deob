...
public class class257 extends class248 {
    ...
    @OriginalMember(owner = "client!bv", name = "b", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 16)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!bv", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 69)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "()V", line = 106)
    ...
    @OriginalMember(owner = "client!bv", name = "c", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!bv", name = "d", descriptor = "()I", line = 142)
