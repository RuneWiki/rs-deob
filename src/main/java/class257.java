...
public class class257 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(I)V", line = 57)
    public void method1451(int arg0) throws Exception {
        field3772++;
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 64)
    public void method1454(Component arg0) throws Exception {
        field3767++;
    }

    @OriginalMember(owner = "client!ln", name = "a", descriptor = "()I", line = 72)
    public int method1453() throws Exception {
        field3762++;
        return this.field3786;
    }

    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lti;B)V", line = 247)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "()V", line = 260)
    public void method1456() {
        field3779++;
    }

    @OriginalMember(owner = "client!ln", name = "c", descriptor = "()V", line = 267)
    public void method1455() throws Exception {
        field3782++;
    }

    @OriginalMember(owner = "client!ln", name = "d", descriptor = "()V", line = 276)
    public void method1452() throws Exception {
        field3769++;
    }

    @OriginalMember(owner = "client!ln", name = "d", descriptor = "(I)V", line = 296)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IILti;)V", line = 342)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "([II)V", line = 363)
    ...
    @OriginalMember(owner = "client!ln", name = "c", descriptor = "(B)V", line = 523)
