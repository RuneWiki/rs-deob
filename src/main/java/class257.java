...
public class class257 extends class551 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kj", name = "g", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!kj", name = "h", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lkv;Lqv;)V", line = 71)
