...
public class class257 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(II)[I", line = 26)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(III)V", line = 153)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(B)[[I", line = 116)
