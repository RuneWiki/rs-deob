...
public class class257 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(ILcu;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(Lcu;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(B)V", line = 81)
