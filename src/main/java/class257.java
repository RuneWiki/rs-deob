...
public class class257 extends class87 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(ILda;ILjava/lang/String;)Lrs;", line = 18)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ku", name = "d", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 113)
