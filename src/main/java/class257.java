...
public class class257 extends class150 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)[B", line = 6)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIBII)V", line = 25)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(III[BIII[BI)V", line = 50)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(III)Ljo;", line = 95)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)I", line = 151)
