...
public class class257 extends class436 {
    ...
    @OriginalMember(owner = "client!nf", name = "e", descriptor = "(I)Z", line = 6)
    public final boolean method1621(int arg0) {
        return arg0 > 118;
    }

    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lbp;Ljava/lang/Object;)V", line = 15)
    public class257(class46 arg0, Object arg1) {
        super(arg0);
        this.field3760 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!nf", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 24)
