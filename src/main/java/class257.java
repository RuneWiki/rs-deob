...
public class class257 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILce;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Lnp;B)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILnp;)V")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BBIILda;III)Lda;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILda;IIB)Lda;")
