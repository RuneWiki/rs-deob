...
public class class257 extends class666 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IB)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!uu", name = "<init>", descriptor = "()V", line = 146)
    public class257() {
        super(1, false);
    }

    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IZII)V", line = 162)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILiaa;Z)V", line = 270)
