...
public abstract class class257 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFIILua;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIII)V", line = 34)
    public final void method1632(int arg0, int arg1, int arg2, int arg3) {
        this.method15(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFFFLua;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIIIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)V", line = 64)
    public final void method1638(int arg0, int arg1) {
        this.method3(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(FFFFIILua;II)V", line = 69)
