...
public class class257 extends class389 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!pd", name = "c", descriptor = "()V", line = 18)
    public static void method1532() {
        field3138 = null;
        field3142 = null;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lha;J[Lnda;[Loia;Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "([Loia;Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!pd", name = "d", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(J)V", line = 156)
    public final void method1536(long arg0) {
        this.field3135 = arg0;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lha;J)Z", line = 159)
    ...
    @OriginalMember(owner = "client!pd", name = "e", descriptor = "()Lpca;", line = 207)
    public final class713 method1538() {
        return this.field3145;
    }

    @OriginalMember(owner = "client!pd", name = "f", descriptor = "()Lpca;", line = 214)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class257(int arg0, boolean arg1) {
        this.method1531(arg0, arg1);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lha;[Lnda;Z)V", line = 235)
    ...
    @OriginalMember(owner = "client!pd", name = "g", descriptor = "()V", line = 314)
    public final void method1541() {
        this.field3148 = true;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IIIII)V", line = 317)
    public final void method1542(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field3149 = arg0;
    }

    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(IZ)Lpd;", line = 339)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lha;)V", line = 352)
