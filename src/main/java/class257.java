...
public class class257 {
    ...
    @OriginalMember(owner = "client!aia", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field4033++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(B)[Lvj;", line = 50)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ZLcb;Lnp;)Lsr;", line = 60)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(II)Ltda;", line = 93)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V", line = 132)
