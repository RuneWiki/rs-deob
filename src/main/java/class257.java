...
public class class257 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIIBILaa;Ljava/lang/String;Lda;Loq;Lpaa;II)V", line = 189)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Lgs;Z)Z", line = 237)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIIZI)V", line = 355)
