...
public abstract class class257 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BI)I", line = 12)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "([BI)[B", line = 31)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)V", line = 53)
