...
public class class257 extends class432 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ZII)V", line = 29)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLld;)I", line = 58)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BII)V", line = 97)
