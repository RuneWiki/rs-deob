...
public class class257 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lh;ILjava/lang/String;)Ldr;", line = 8)
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lh;II)V", line = 42)
    private class257(class327 arg0, int arg1, int arg2) {
        this.field3316 = arg0;
        this.field3317 = arg1;
    }

    @OriginalMember(owner = "client!dr", name = "finalize", descriptor = "()V", line = 51)
