...
public class class257 extends class447 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZZIZI)Lqj;", line = 4)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(CI)I", line = 32)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IBIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILeb;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BC)I", line = 172)
    ...
    @OriginalMember(owner = "client!bn", name = "f", descriptor = "(B)V", line = 206)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILeb;)V", line = 237)
