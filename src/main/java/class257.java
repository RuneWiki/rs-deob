...
public class class257 extends class383 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(II)V", line = 23)
    public class257(int arg0, int arg1) {
        this.field3270 = arg0;
        this.field3271 = arg1;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lvn;)V", line = 34)
