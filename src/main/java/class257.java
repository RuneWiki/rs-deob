...
public class class257 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lsq;IIILha;III)Ljd;")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lha;Lsq;IIIILda;Lha;ZIBZ)Ljd;")
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(II)Lbca;")
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ldt;IZLega;Lwia;Lwia;)V")
