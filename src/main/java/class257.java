...
public class class257 {
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BI)Lbb;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILqn;IBILqa;IZLra;IZLqa;)Lha;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(BIILqa;IILqn;I)Lha;")
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Ljc;IZLvb;Lgp;Lgp;)V")
