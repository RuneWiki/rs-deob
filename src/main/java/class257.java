...
public class class257 extends class739 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IIBIIILha;IIIILip;)V", line = 4)
    ...
    @OriginalMember(owner = "client!aia", name = "c", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IB)Lhl;", line = 91)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ZI)[I", line = 128)
    ...
    @OriginalMember(owner = "client!aia", name = "c", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "()V", line = 175)
    public class257() {
        super(0, true);
    }
}
