...
public class class257 implements Runnable {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "Lhf;")
    private class413 field3605 = new class413();
    ...
    @OriginalMember(owner = "client!cca", name = "run", descriptor = "()V", line = 4)
    public final void run() {
        while (!this.field3615) {
            class413 var1 = this.field3605;
            class663 var2;
            synchronized (this.field3605) {
                var2 = (class663) this.field3605.method2481((byte) 92);
                if (var2 == null) {
                    try {
                        this.field3605.wait();
            ...
            try {
                if (var2.field9302 == 2) {
                    var2.field9309.method171(519, (int) var2.field3123, var2.field9304.length, var2.field9304);
                } else if (var2.field9302 == 3) {
                    var2.field9304 = var2.field9309.method172((int) var2.field3123, 255);
                }
            } catch (Exception var6) {
                class329.method2129(null, false, var6);
            }
            var2.field4984 = false;
        }
        field3616++;
    }

    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)V", line = 71)
    public final void method1689(int arg0) {
        field3618++;
        this.field3615 = true;
        class413 var2 = this.field3605;
        synchronized (this.field3605) {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ZILqia;)Lwda;", line = 90)
    public final class663 method1690(boolean arg0, int arg1, class23 arg2) {
        field3613++;
        class663 var4 = new class663();
        var4.field9302 = 3;
        var4.field4985 = false;
        var4.field3123 = arg1;
        var4.field9309 = arg2;
        this.method1693((byte) 42, var4);
        if (!arg0) {
            this.method1690(false, 55, null);
        }
        return var4;
    }

    @OriginalMember(owner = "client!cca", name = "a", descriptor = "([BILqia;I)Lwda;", line = 116)
    public final class663 method1691(byte[] arg0, int arg1, class23 arg2, int arg3) {
        if (arg3 <= 76) {
            this.method1690(true, 63, null);
        }
        field3612++;
        class663 var5 = new class663();
        var5.field4985 = false;
        var5.field9304 = arg0;
        var5.field9302 = 2;
        var5.field9309 = arg2;
        var5.field3123 = arg1;
        this.method1693((byte) 42, var5);
        return var5;
    }

    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Lsf;)V", line = 136)
    public static final void method1692(class547 arg0) {
        if (arg0 == null) {
            return;
        }
        for (int var1 = 0; var1 < 2; var1++) {
            class547 var2 = null;
            for (class547 var3 = class472.field6734[var1]; var3 != null; var3 = var3.field7714) {
                if (arg0 == var3) {
                    if (var2 == null) {
                        class472.field6734[var1] = var3.field7714;
                    } else {
                        var2.field7714 = var3.field7714;
                    }
            ...
            class547 var4 = null;
            for (class547 var5 = class110.field1365[var1]; var5 != null; var5 = var5.field7714) {
                if (arg0 == var5) {
                    if (var4 == null) {
                        class110.field1365[var1] = var5.field7714;
                    } else {
                        var4.field7714 = var5.field7714;
                    }
                    class432.field6151 = true;
                    return;
                }
            ...
            class547 var6 = null;
            for (class547 var7 = class511.field7305[var1]; var7 != null; var7 = var7.field7714) {
                if (arg0 == var7) {
                    if (var6 == null) {
                        class511.field7305[var1] = var7.field7714;
                    } else {
                        var6.field7714 = var7.field7714;
                    }
                    class432.field6151 = true;
                    return;
                }
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Lkj;)V", line = 285)
    public class257(class590 arg0) {
        class370 var2 = arg0.method3426(97, this, 5);
        ...
        this.field3619 = (Thread) var2.field5317;
    }

    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(BLwda;)V", line = 221)
    private final void method1693(byte arg0, class663 arg1) {
        field3610++;
        class413 var3 = this.field3605;
        synchronized (this.field3605) {
            this.field3605.method2475(arg1, -19680);
            if (arg0 != 42) {
                method1688((byte) 43);
            }
            this.field3620++;
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ILqia;I)Lwda;", line = 243)
    public final class663 method1694(int arg0, class23 arg1, int arg2) {
        field3614++;
        class663 var4 = new class663();
        var4.field9302 = 1;
        class413 var5 = this.field3605;
        synchronized (this.field3605) {
            if (arg2 != -8915) {
                field3608 = null;
            }
            class663 var6 = (class663) this.field3605.method2480(381);
            while (true) {
                if (var6 == null) {
                    break;
                }
                if ((long) arg0 == var6.field3123 && var6.field9309 == arg1 && var6.field9302 == 2) {
                    var4.field4984 = false;
                    var4.field9304 = var6.field9304;
                    return var4;
                }
                var6 = (class663) this.field3605.method2476((byte) 18);
            }
        }
        var4.field9304 = arg1.method172(arg0, arg2 + 9170);
        var4.field4984 = false;
        var4.field4985 = true;
        return var4;
    }
