...
public class class257 extends class348 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "([B[IIIIIIIIIIILfs;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "([B[IIIIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(CIIIZLfs;II)V", line = 135)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Llg;Lmo;[Lpi;[I[I)V", line = 198)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(CIIIZ)V", line = 221)
