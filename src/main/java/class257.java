...
public class class257 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)Lqk;", line = 5)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Lqk;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)Lqk;", line = 43)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)Lqk;", line = 60)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(I)Z", line = 141)
    ...
    @OriginalMember(owner = "client!bn", name = "f", descriptor = "(I)Lqk;", line = 156)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "()V", line = 216)
    public class257() {
        this.field3496.field134 = this.field3496;
        this.field3496.field128 = this.field3496;
    }

    @OriginalMember(owner = "client!bn", name = "g", descriptor = "(I)Z", line = 185)
