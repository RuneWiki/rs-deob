...
public class class257 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lmo;III)Lo;", line = 10)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lmo;I)V", line = 63)
