...
public class class257 extends class321 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIII[BIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lmm;IIIIZ[BIZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIII[IIIZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lmm;IIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)V", line = 175)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lmm;IIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "()V", line = 189)
    public final void method377() {
        this.field4370.field4794.glFramebufferTexture2DEXT(36160, this.field3569, this.field4369, 0, 0);
        this.field3569 = -1;
    }

    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lmm;IIIIZ[IZ)V", line = 193)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IIIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lmm;IIIIZ[FI)V", line = 249)
