...
public class class257 extends class443 {
    ...
    @OriginalMember(owner = "client!ok", name = "fa", descriptor = "(CIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Llea;Lrt;[Lde;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(CIIIZLaa;II)V", line = 262)
