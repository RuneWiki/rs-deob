...
public class class257 extends class72 {
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lec;)V", line = 545)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lgk;B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILgk;)V", line = 69)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BLok;)V", line = 336)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I)Lgk;", line = 368)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIZ)V", line = 416)
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(II)Z", line = 437)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lec;I)V", line = 452)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(II)Z", line = 489)
    public final boolean method1533(int arg0, int arg1) {
        ++field3485;
        return ~arg1 == arg0 && !this.field3481 ? super.field988 : true;
    }

    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IB)I", line = 503)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZI)V", line = 521)
