...
public abstract class class257 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lvc;Lnl;BLnl;)V", line = 5)
    ...
    @OriginalMember(owner = "client!de", name = "d", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([JII[II)V", line = 204)
