...
public class class257 extends class154 {
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "()Los;", line = 15)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!os", name = "d", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!os", name = "g", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(B)[F", line = 90)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(III[I)V", line = 154)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([I)V", line = 167)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "()V", line = 180)
    ...
    @OriginalMember(owner = "client!os", name = "i", descriptor = "(I)[F", line = 188)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIII)V", line = 209)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(III)V", line = 244)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILs;)V", line = 257)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ls;)V", line = 280)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "()V", line = 299)
    public class257() {
        this.method1137();
    }
}
