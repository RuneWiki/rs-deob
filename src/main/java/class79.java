...
public class class79 extends class263 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Luc;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!fca", name = "<init>", descriptor = "(I)V", line = 816)
    public class79(int arg0) {
        this.field1034 = arg0;
    }

    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(IB)V", line = 719)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 735)
