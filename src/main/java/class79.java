...
public class class79 extends class655 {
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(ILni;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(I[B)I", line = 17)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ILni;B)Lufa;", line = 118)
    ...
    @OriginalMember(owner = "client!dha", name = "e", descriptor = "(B)V", line = 148)
