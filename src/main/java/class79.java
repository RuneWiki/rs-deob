...
public class class79 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(II)Laca;", line = 26)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 183)
