...
public class class79 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lsba;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!pb", name = "toString", descriptor = "()Ljava/lang/String;", line = 91)
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(I)V", line = 112)
