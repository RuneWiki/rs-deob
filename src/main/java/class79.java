...
public class class79 extends class751 {
    ...
    @OriginalMember(owner = "client!naa", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "()V", line = 44)
    public class79() {
        super(1, true);
    }

    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(ILrv;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!naa", name = "g", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!naa", name = "h", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)[I", line = 134)
