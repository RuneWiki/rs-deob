...
public class class79 extends class743 implements class649 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IBZILha;ILig;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tv", name = "f", descriptor = "(I)I", line = 35)
    ...
    @OriginalMember(owner = "client!tv", name = "g", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(Lha;I)Ljl;", line = 76)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(ILha;)V", line = 105)
    public final void method271(int arg0, class545 arg1) {
        int var3 = -117 / ((arg0 - -15) / 57);
        ++field1079;
    }

    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(B)Z", line = 115)
    ...
    @OriginalMember(owner = "client!tv", name = "l", descriptor = "(I)I", line = 127)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILha;)V", line = 140)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)I", line = 169)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(ILha;)Lgp;", line = 180)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZLha;II)Lws;", line = 197)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZIIIIIIZ)V", line = 229)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lha;I)V", line = 277)
    ...
    @OriginalMember(owner = "client!tv", name = "j", descriptor = "(I)Z", line = 304)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)I", line = 322)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)Z", line = 335)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lha;III)Z", line = 351)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IILha;)Lka;", line = 373)
    ...
    @OriginalMember(owner = "client!tv", name = "e", descriptor = "(B)V", line = 396)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 416)
