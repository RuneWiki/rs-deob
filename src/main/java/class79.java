...
public class class79 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILvg;IILkf;II)V")
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)Lla;")
