...
public class class79 extends class207 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lpi;FZLpi;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(B)Lpi;", line = 88)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lse;I)V", line = 97)
    public class79(class282 arg0, int arg1) {
        this.field1099 = arg0;
        this.field1100 = new class141(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)I", line = 107)
