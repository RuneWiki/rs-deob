...
public class class79 implements class632 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(ILbm;I)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(BLjk;II)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(Lgaa;II)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(ILgaa;II)V")
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(IILjk;IZ)V")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lno;)V")
