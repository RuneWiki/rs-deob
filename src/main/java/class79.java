...
public class class79 extends class235 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZII)I", line = 8)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZIZIIZLil;IIIII)V", line = 47)
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 194)
    ...
    @OriginalMember(owner = "client!tk", name = "e", descriptor = "(B)I", line = 205)
