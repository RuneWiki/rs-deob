...
public class class79 extends class657 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ILff;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lwga;Lur;)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ILdu;I)V")
