...
public class class79 extends class598 implements class269 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILdn;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZLoe;ILqa;III)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(ILqa;)Loj;")
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(ILqa;)Lso;")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(IIIIIIIIIILgn;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZLqa;)V")
