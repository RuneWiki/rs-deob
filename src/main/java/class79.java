...
public class class79 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILac;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)Lnba;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lac;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)Lnba;")
