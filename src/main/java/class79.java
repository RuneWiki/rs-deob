...
public class class79 extends class306 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Lnm;)Lfv;", line = 10)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
