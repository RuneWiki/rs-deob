...
public class class79 implements Runnable {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/Object;IIBI)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/awt/Frame;I)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/String;BIZ)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "c", descriptor = "(I)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(BIIII)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZILjava/lang/String;Ljava/lang/String;)Lfn;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;BLjava/lang/Class;)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I[IBLjava/awt/Component;ILjava/awt/Point;)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/String;Z)Lfn;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILjava/lang/Runnable;B)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILjava/lang/String;Z)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ILjava/net/URL;)Loaa;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/String;I)Loaa;")
