...
public class class79 extends class276 {
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(IIII)Lou;")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IFFI[BIFFFIIILal;)V")
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Lih;Lgk;Lja;[I)V")
