...
public class class79 extends class344 {
    ...
    @OriginalMember(owner = "client!sj", name = "e", descriptor = "(B)[B", line = 5)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)I", line = 26)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([I[[BIBI[[B[B[I)I", line = 43)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Leg;ILg;)V", line = 103)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([BB)[B", line = 121)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BII)B", line = 176)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(I)V", line = 194)
