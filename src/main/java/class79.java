...
public class class79 extends class189 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZI)V", line = 137)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(I[B)V", line = 157)
