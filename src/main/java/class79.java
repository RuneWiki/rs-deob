...
public class class79 extends class35 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ljava/lang/String;Lec;B)I")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lbc;IZI)V")
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(I)[Lt;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZILja;IZILpi;)V")
