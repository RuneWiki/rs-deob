...
public class class79 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BI)Lhu;", line = 49)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Ld;ILfo;)V", line = 92)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)V", line = 116)
