...
public abstract class class79 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIIIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)Z", line = 134)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!fv", name = "c", descriptor = "(I)Z", line = 159)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIII)Z", line = 174)
    ...
    @OriginalMember(owner = "client!fv", name = "d", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!fv", name = "e", descriptor = "(I)Z", line = 225)
