...
public class class79 extends class330 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IZ)[I", line = 5)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lgga;IB)V", line = 44)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)[[I", line = 311)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 381)
    public class79() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(Z)V", line = 387)
