...
public class class79 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILqj;Z)Ldi;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILmo;J)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BJ)Lmo;")
