...
public class class79 extends class550 {
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lla;Lji;)V", line = 4)
    public class79(class422 arg0, class80 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILla;)V", line = 28)
