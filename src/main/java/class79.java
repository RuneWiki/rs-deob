...
public class class79 extends class298 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(CIIIZLgo;II)V")
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lhm;Ljp;[Lv;[I[I)V")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "([B[IIIIIIIIIIILgo;II)V")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "([B[IIIIIIIIIIILgo;II)V")
