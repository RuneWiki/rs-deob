...
public class class79 extends class423 {
    ...
    @OriginalMember(owner = "client!kj", name = "fa", descriptor = "(CIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(CIIIZLaa;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 130)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V", line = 216)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([B[I[IIIIIII)V", line = 309)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lcg;Ltba;[Lbe;[I[I)V", line = 366)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([B[IIIIIIII)V", line = 392)
