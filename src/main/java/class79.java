...
public class class79 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(II)Lsca;")
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Lrt;Z)Lnd;")
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Lcda;ILkea;)V")
