...
public class class79 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BIII)I", line = 96)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lps;IIILr;)V", line = 107)
