...
public class class79 extends class55 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lha;IJ)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZZILha;J)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(BLfo;)Z")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lha;Lwr;Lpaa;J)V")
