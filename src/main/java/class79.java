...
public class class79 extends class354 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILti;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "([[[Lkf;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILqa;IIII)V")
