...
public class class79 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(BLjava/lang/String;)V", line = 34)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ILjava/lang/String;)I", line = 151)
