...
public class class79 extends class17 implements class620 {
    ...
    @OriginalMember(owner = "client!kt", name = "e", descriptor = "(B)[Lan;", line = 4)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Loa;Lsa;IIIIIZIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)I", line = 114)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(III)V", line = 129)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(Loa;I)V", line = 269)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Loa;B)Lpl;", line = 280)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(Loa;I)Lcd;", line = 325)
    ...
    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(B)I", line = 337)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 348)
    public final void method64(byte arg0) {
        int var2 = -50 / ((-71 - arg0) / 39);
        ++field1092;
    }

    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(Loa;I)V", line = 359)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILoa;ILcq;ZI)V", line = 383)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Loa;I)V", line = 394)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)Z", line = 410)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(B)I", line = 421)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILoa;I)Z", line = 432)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(B)V", line = 452)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I[Ljava/lang/Object;II[I)V", line = 463)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Loa;II)Lba;", line = 521)
