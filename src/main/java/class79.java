...
public class class79 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BI)I", line = 64)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(II)V", line = 86)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B[B)[B", line = 148)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(BI)I", line = 216)
