...
public class class79 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Liv;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "()V", line = 41)
    public class79() {
        this.field1053[0] = 0;
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(Liv;)V", line = 56)
