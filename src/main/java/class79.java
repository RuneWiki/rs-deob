...
public class class79 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IZ)I", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II)Ljava/lang/String;", line = 50)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 77)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Ldga;IB)V", line = 106)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BLdga;)V", line = 193)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IB)Z", line = 264)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(ILjava/lang/String;)V", line = 306)
