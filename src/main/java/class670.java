...
public abstract class class670 extends class333 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(B)F", line = 18)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IIIIZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(B)I", line = 130)
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(B)Z", line = 143)
    ...
    @OriginalMember(owner = "client!eq", name = "f", descriptor = "(B)I", line = 155)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)I", line = 188)
    public final int method3710(boolean arg0) {
        field9337++;
        return arg0 ? 26 : this.field9335;
    }

    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(IIIIIF)V", line = 205)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)I", line = 218)
