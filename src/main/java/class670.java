...
public class class670 implements class496 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(I)Ljea;")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IILsha;Lda;Lhw;IIILjava/lang/String;Laa;BI)V")
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Lae;Ljava/lang/String;)V")
