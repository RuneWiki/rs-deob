...
public class class670 extends class282 implements class535 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 125)
    public final boolean method1675(class185 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 132)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 178)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Llaa;[I)V", line = 187)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 195)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 201)
