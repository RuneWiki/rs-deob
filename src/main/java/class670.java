...
public class class670 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 24)
    public static void method3835(byte arg0) {
        int var1 = -41 % ((arg0 - 30) / 56);
        field9425 = null;
    }

    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIZJI)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ZILec;)V", line = 114)
