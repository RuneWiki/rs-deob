...
public class class670 extends class200 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(Z)Z", line = 16)
    ...
    @OriginalMember(owner = "client!nia", name = "g", descriptor = "(I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(IIB)V", line = 43)
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Llf;)V", line = 124)
    public class670(class250 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(II)V", line = 127)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lrba;Lrba;II)V", line = 140)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(ZI)Z", line = 296)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(I)Z", line = 311)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(I)V", line = 349)
    ...
    @OriginalMember(owner = "client!nia", name = "h", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(II)I", line = 387)
