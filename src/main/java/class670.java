...
public class class670 extends class493 implements class187 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BB)C", line = 31)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Llm;Lec;III[B)V", line = 79)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILjava/lang/String;I[B)I", line = 94)
