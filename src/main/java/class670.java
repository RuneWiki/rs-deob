...
public class class670 extends class405 {
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IBI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(IIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(III)V", line = 74)
    public final void method1405(int arg0, int arg1, int arg2) {
        int var4 = 123 / ((-71 - arg0) / 53);
        ++field9138;
    }

    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)V", line = 105)
