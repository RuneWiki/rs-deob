...
public class class670 extends class497 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILil;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(III)V", line = 15)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ldfa;B)V", line = 25)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(ZZ)V", line = 65)
    public final void method163(boolean arg0, boolean arg1) {
        super.field6867.method1632(true, arg1);
        ++field9426;
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)Z", line = 85)
    ...
    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;ILor;II)V", line = 109)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Ldia;)V", line = 424)
