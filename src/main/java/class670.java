...
public class class670 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZILbp;)V", line = 44)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lwea;B)Lof;", line = 112)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z)V", line = 127)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLpc;)Z", line = 169)
