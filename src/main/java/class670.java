...
public class class670 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ZZLjava/io/File;)V", line = 31)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILhc;Lhc;)V", line = 57)
