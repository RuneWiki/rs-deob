...
public class class670 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "Lmq;")
    public static class78 field9159 = new class78(40, -1);
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)V", line = 15)
    public static void method3620(int arg0) {
        field9159 = null;
        if (arg0 != 2) {
            method3622((byte) -13, 2);
        }
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IILgaa;)I", line = 26)
    public static final int method3621(int arg0, int arg1, class460 arg2) {
        if (arg0 != 1) {
            method3623(14, 66, 18, -61, -81, -25, 86, 112);
        }
        field9161++;
        if (!client.method715(arg2).method288(arg1, arg0 - 112) && arg2.field6580 == null) {
            return -1;
        } else if (arg2.field6520 == null || arg2.field6520.length <= arg1) {
            return -1;
        } else {
            return arg2.field6520[arg1];
        }
    }

    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BI)[[[B", line = 41)
    public static final byte[][][] method3622(byte arg0, int arg1) {
        field9162++;
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIIIIIII)V", line = 818)
    public static final void method3623(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        field9160++;
        int var8 = 0;
        int var9 = arg5;
        int var10 = 0;
        ...
        int var37 = var30;
        int var38 = (arg4 + var12) * var29;
        int[] var39 = class15.field220[arg7];
        class284.method1709(var39, arg1 - var11, -8251, arg1 - arg0, arg2);
        class284.method1709(var39, arg1 + var11, -8251, arg1 - var11, arg6);
        class284.method1709(var39, arg0 + arg1, -8251, arg1 - -var11, arg2);
        while (var9 > 0) {
            ...
            if (var40) {
                ...
                class284.method1709(class15.field220[var41], var46, -8251, var44, arg2);
                class284.method1709(class15.field220[var41], var45, -8251, var46, arg6);
                class284.method1709(class15.field220[var41], var43, -8251, var45, arg2);
                class284.method1709(class15.field220[var42], var46, -8251, var44, arg2);
                class284.method1709(class15.field220[var42], var45, -8251, var46, arg6);
                class284.method1709(class15.field220[var42], var43, -8251, var45, arg2);
            } else {
                class284.method1709(class15.field220[var41], var43, -8251, var44, arg2);
                class284.method1709(class15.field220[var42], var43, arg4 ^ 0x203A, var44, arg2);
            }
        }
    }
}
