...
public class class670 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(IIBII)V", line = 36)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILac;I)V", line = 54)
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILac;)V", line = 97)
