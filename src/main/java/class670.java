...
public class class670 extends class71 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(JJ)J", line = 35)
    public static long method3777(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIII[[Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)Lve;", line = 103)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIIZII)V", line = 119)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(SI)V", line = 302)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(III)Z", line = 319)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lrl;Leha;Ltj;[I)V", line = 342)
