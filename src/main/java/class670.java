...
public class class670 extends class568 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILmj;)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lwq;I)Lgia;", line = 30)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(ILns;[II)V", line = 55)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(ILov;IZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(IIIII)I", line = 160)
