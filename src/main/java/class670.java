...
public class class670 extends class280 implements class534 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lraa;[I)V", line = 116)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 122)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 174)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 228)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 231)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 246)
