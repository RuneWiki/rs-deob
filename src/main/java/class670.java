...
public class class670 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "([Lfs;B)V")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(ILla;I)Lfs;")
