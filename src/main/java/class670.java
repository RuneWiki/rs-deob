...
public class class670 extends class350 {
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(IIII)[B", line = 4)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "()V", line = 57)
    public class670() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IBI)V", line = 60)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Leea;", line = 74)
    ...
    @OriginalMember(owner = "client!lca", name = "e", descriptor = "(B)[Lti;", line = 92)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(I)V", line = 105)
