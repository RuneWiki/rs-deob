...
public class context {
    ...
    private HashSet field5238 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "a", descriptor = "Ljaggl/opengl;")
    private opengl field5236 = new opengl(this);

    @OriginalMember(owner = "client!jaggl/context", name = "b", descriptor = "Ljaggl/context;")
    private static context field5237 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "nativeid", descriptor = "J")
    public long nativeid;

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;II)Z", line = 6)
    public boolean choosePixelFormat(Component arg0, int arg1, int arg2) {
        return this.choosePixelFormat1(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Ljaggl/opengl;", line = 15)
    public opengl getGL() {
        return this.field5236;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getCurrentContext", descriptor = "()Ljaggl/context;", line = 22)
    public static context getCurrentContext() {
        return field5237;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;)Z", line = 31)
    public boolean choosePixelFormat(Component arg0) {
        return this.choosePixelFormat0(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 50)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field5238 == null) {
            String var2 = this.field5236.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field5238 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field5238.add(var3[var4]);
            }
        }
        return this.field5238.contains(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "makeCurrent", descriptor = "()Z", line = 76)
