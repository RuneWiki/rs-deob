...
public class context {
    ...
    public boolean isExtensionAvailable(String arg0) {
        if (this.field5571 == null) {
            String var2 = this.field5569.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field5571 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field5571.add(var3[var4]);
            }
        }
        return this.field5571.contains(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "makeCurrent", descriptor = "()Z", line = 45)
    ...
    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;II)Z", line = 62)
    ...
    public context() {
        this.init(this.field5569);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Ljaggl/opengl;", line = 86)
    public opengl getGL() {
        return this.field5569;
    }
