...
public class context {
    ...
    public boolean isExtensionAvailable(String arg0) {
        if (this.field3321 == null) {
            String var2 = this.field3322.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field3321 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field3321.add(var3[var4]);
            }
        }
        return this.field3321.contains(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Ljaggl/opengl;", line = 38)
    public opengl getGL() {
        return this.field3322;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "makeCurrent", descriptor = "()Z", line = 50)
    ...
    @OriginalMember(owner = "client!jaggl/context", name = "getCurrentContext", descriptor = "()Ljaggl/context;", line = 63)
    public static context getCurrentContext() {
        return field3320;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;)Z", line = 73)
    public boolean choosePixelFormat(Component arg0) {
        return this.choosePixelFormat0(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;II)Z", line = 80)
