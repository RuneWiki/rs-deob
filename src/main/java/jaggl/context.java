...
public class context {
    ...
    private HashSet field3140 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "a", descriptor = "Ljaggl/opengl;")
    private opengl field3138 = new opengl(this);

    @OriginalMember(owner = "client!jaggl/context", name = "b", descriptor = "Ljaggl/context;")
    private static context field3139 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "nativeid", descriptor = "J")
    public long nativeid;

    @OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Ljaggl/opengl;", line = 11)
    public opengl getGL() {
        return this.field3138;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 19)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field3140 == null) {
            String var2 = this.field3138.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field3140 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field3140.add(var3[var4]);
            }
        }
        return this.field3140.contains(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getCurrentContext", descriptor = "()Ljaggl/context;", line = 44)
    ...
    @OriginalMember(owner = "client!jaggl/context", name = "makeCurrent", descriptor = "()Z", line = 67)
    ...
    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;II)Z", line = 82)
