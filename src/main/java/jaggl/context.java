...
public class context {
    ...
    private HashSet field2950 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "c", descriptor = "Ljaggl/opengl;")
    private opengl field2951 = new opengl(this);

    @OriginalMember(owner = "client!jaggl/context", name = "a", descriptor = "Ljaggl/context;")
    private static context field2949 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "nativeid", descriptor = "J")
    public long nativeid;

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;)Z", line = 6)
    public boolean choosePixelFormat(Component arg0) {
        return this.choosePixelFormat0(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 20)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field2950 == null) {
            String var2 = this.field2951.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field2950 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field2950.add(var3[var4]);
            }
        }
        return this.field2950.contains(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "makeCurrent", descriptor = "()Z", line = 44)
    ...
    @OriginalMember(owner = "client!jaggl/context", name = "getCurrentContext", descriptor = "()Ljaggl/context;", line = 61)
    public static context getCurrentContext() {
        return field2949;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Ljaggl/opengl;", line = 75)
    public opengl getGL() {
        return this.field2951;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;II)Z", line = 83)
