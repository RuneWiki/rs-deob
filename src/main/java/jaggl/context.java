...
public class context {
    ...
    private HashSet field3132 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "c", descriptor = "Ljaggl/opengl;")
    private opengl field3133 = new opengl(this);

    @OriginalMember(owner = "client!jaggl/context", name = "a", descriptor = "Ljaggl/context;")
    private static context field3131 = null;

    @OriginalMember(owner = "client!jaggl/context", name = "nativeid", descriptor = "J")
    public long nativeid;

    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;II)Z", line = 11)
    public boolean choosePixelFormat(Component arg0, int arg1, int arg2) {
        return this.choosePixelFormat1(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getGL", descriptor = "()Ljaggl/opengl;", line = 18)
    public opengl getGL() {
        return this.field3133;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "makeCurrent", descriptor = "()Z", line = 27)
    ...
    @OriginalMember(owner = "client!jaggl/context", name = "choosePixelFormat", descriptor = "(Ljava/awt/Component;)Z", line = 41)
    public boolean choosePixelFormat(Component arg0) {
        return this.choosePixelFormat0(arg0);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "getCurrentContext", descriptor = "()Ljaggl/context;", line = 51)
    public static context getCurrentContext() {
        return field3131;
    }

    @OriginalMember(owner = "client!jaggl/context", name = "<init>", descriptor = "()V", line = 67)
    public context() {
        this.init(this.field3133);
    }

    @OriginalMember(owner = "client!jaggl/context", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 78)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field3132 == null) {
            String var2 = this.field3133.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field3132 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field3132.add(var3[var4]);
            }
        }
        return this.field3132.contains(arg0);
    }
