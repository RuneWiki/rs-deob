...
public class context {
    ...
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6203 == null) {
            String var2 = this.field6202.glGetString(7939) + " " + this.getExtensionsString();
            String[] var3 = var2.split(" ");
            this.field6203 = new HashSet(var3.length);
            for (int var4 = 0; var4 < var3.length; var4++) {
                this.field6203.add(var3[var4]);
            }
        }
        return this.field6203.contains(arg0);
    }
