...
public class opengl {
    ...
    private context field5572;

    @OriginalMember(owner = "client!jaggl/opengl", name = "nativeid", descriptor = "J")
    public long nativeid;

    @OriginalMember(owner = "client!jaggl/opengl", name = "glBufferSubDataARB", descriptor = "(III[BI)V", line = 39)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "getDirectBufferByteOffset", descriptor = "(Ljava/nio/Buffer;)I", line = 51)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "getIndirectBufferByteOffset", descriptor = "(Ljava/nio/Buffer;)I", line = 108)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glShaderSourceARB", descriptor = "(II[Ljava/lang/String;[II)V", line = 171)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glMultMatrixf", descriptor = "(Ljava/nio/FloatBuffer;)V", line = 210)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetIntegerv", descriptor = "(I[II)V", line = 230)
    public void glGetIntegerv(int arg0, int[] arg1, int arg2) {
        this.glGetIntegerv1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glGenFramebuffersEXT", descriptor = "(I[II)V", line = 267)
    public void glGenFramebuffersEXT(int arg0, int[] arg1, int arg2) {
        this.glGenFramebuffersEXT1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexImage3D", descriptor = "(IIIIIIIII[BI)V", line = 288)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glReadPixels", descriptor = "(IIIIII[BI)V", line = 301)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexGenfv", descriptor = "(II[FI)V", line = 335)
    public void glTexGenfv(int arg0, int arg1, float[] arg2, int arg3) {
        this.glTexGenfv1(arg0, arg1, arg2, arg3 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexCoordPointer", descriptor = "(III[BI)V", line = 382)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGenProgramsARB", descriptor = "(I[II)V", line = 391)
    public void glGenProgramsARB(int arg0, int[] arg1, int arg2) {
        this.glGenProgramsARB1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexImage1D", descriptor = "(IIIIIIILjava/nio/Buffer;)V", line = 467)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glDeleteRenderbuffersEXT", descriptor = "(I[II)V", line = 556)
    public void glDeleteRenderbuffersEXT(int arg0, int[] arg1, int arg2) {
        this.glDeleteRenderbuffersEXT1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 646)
    public boolean isExtensionAvailable(String arg0) {
        return this.field5572.isExtensionAvailable(arg0);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glMultMatrixf", descriptor = "([FI)V", line = 678)
    public void glMultMatrixf(float[] arg0, int arg1) {
        this.glMultMatrixf1(arg0, arg1 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexCoordPointer", descriptor = "(IIILjava/nio/Buffer;)V", line = 972)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "isDirect", descriptor = "(Ljava/nio/Buffer;)Z", line = 1031)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glDeleteProgramsARB", descriptor = "(I[II)V", line = 1096)
    public void glDeleteProgramsARB(int arg0, int[] arg1, int arg2) {
        this.glDeleteProgramsARB1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetObjectParameterivARB", descriptor = "(II[II)V", line = 1162)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetInfoLogARB", descriptor = "(II[II[BI)V", line = 1207)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glDrawPixels", descriptor = "(IIIILjava/nio/Buffer;)V", line = 1224)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glLightModelfv", descriptor = "(I[FI)V", line = 1324)
    public void glLightModelfv(int arg0, float[] arg1, int arg2) {
        this.glLightModelfv1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexImage2D", descriptor = "(IIIIIIIILjava/nio/Buffer;)V", line = 1345)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glPointParameterfvARB", descriptor = "(I[FI)V", line = 1379)
    public void glPointParameterfvARB(int arg0, float[] arg1, int arg2) {
        this.glPointParameterfvARB1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetProgramivARB", descriptor = "(II[II)V", line = 1438)
    public void glGetProgramivARB(int arg0, int arg1, int[] arg2, int arg3) {
        this.glGetProgramivARB1(arg0, arg1, arg2, arg3 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glDrawPixels", descriptor = "(IIII[BI)V", line = 1449)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glVertexPointer", descriptor = "(IIILjava/nio/Buffer;)V", line = 1584)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glColor4fv", descriptor = "([FI)V", line = 1627)
    public void glColor4fv(float[] arg0, int arg1) {
        this.glColor4fv1(arg0, arg1 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexSubImage2D", descriptor = "(IIIIIIII[BI)V", line = 1635)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glBufferDataARB", descriptor = "(II[BII)V", line = 1804)
    public void glBufferDataARB(int arg0, int arg1, byte[] arg2, int arg3, int arg4) {
        this.glBufferDataARB1(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glNormal3fv", descriptor = "(Ljava/nio/FloatBuffer;)V", line = 1872)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGenTextures", descriptor = "(I[II)V", line = 1932)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexSubImage2D", descriptor = "(IIIIIIIILjava/nio/Buffer;)V", line = 2090)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetTexLevelParameteriv", descriptor = "(III[II)V", line = 2161)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexImage2D", descriptor = "(IIIIIIII[BI)V", line = 2176)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetFloatv", descriptor = "(I[FI)V", line = 2239)
    public void glGetFloatv(int arg0, float[] arg1, int arg2) {
        this.glGetFloatv1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glLightfv", descriptor = "(II[FI)V", line = 2246)
    public void glLightfv(int arg0, int arg1, float[] arg2, int arg3) {
        this.glLightfv1(arg0, arg1, arg2, arg3 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glDrawElements", descriptor = "(III[BI)V", line = 2257)
    public void glDrawElements(int arg0, int arg1, int arg2, byte[] arg3, int arg4) {
        this.glDrawElements1(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glNormalPointer", descriptor = "(II[BI)V", line = 2307)
    public void glNormalPointer(int arg0, int arg1, byte[] arg2, int arg3) {
        this.glNormalPointer1(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glMaterialfv", descriptor = "(II[FI)V", line = 2340)
    public void glMaterialfv(int arg0, int arg1, float[] arg2, int arg3) {
        this.glMaterialfv1(arg0, arg1, arg2, arg3 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glNormal3fv", descriptor = "([FI)V", line = 2380)
    public void glNormal3fv(float[] arg0, int arg1) {
        this.glNormal3fv1(arg0, arg1 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glGetFloatv", descriptor = "(ILjava/nio/FloatBuffer;)V", line = 2445)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glFogfv", descriptor = "(I[FI)V", line = 2464)
    public void glFogfv(int arg0, float[] arg1, int arg2) {
        this.glFogfv1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glLoadMatrixf", descriptor = "([FI)V", line = 2520)
    public void glLoadMatrixf(float[] arg0, int arg1) {
        this.glLoadMatrixf1(arg0, arg1 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glDeleteTextures", descriptor = "(I[II)V", line = 2529)
    public void glDeleteTextures(int arg0, int[] arg1, int arg2) {
        this.glDeleteTextures1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glVertexPointer", descriptor = "(III[BI)V", line = 2558)
    public void glVertexPointer(int arg0, int arg1, int arg2, byte[] arg3, int arg4) {
        this.glVertexPointer1(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glColorPointer", descriptor = "(IIILjava/nio/Buffer;)V", line = 2577)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glProgramLocalParameter4fvARB", descriptor = "(II[FI)V", line = 2624)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glInterleavedArrays", descriptor = "(IILjava/nio/Buffer;)V", line = 2643)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexEnvfv", descriptor = "(II[FI)V", line = 2667)
    public void glTexEnvfv(int arg0, int arg1, float[] arg2, int arg3) {
        this.glTexEnvfv1(arg0, arg1, arg2, arg3 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glBufferSubDataARB", descriptor = "(IIILjava/nio/Buffer;)V", line = 2795)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glNormalPointer", descriptor = "(IILjava/nio/Buffer;)V", line = 2840)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glDrawElements", descriptor = "(IIILjava/nio/Buffer;)V", line = 2875)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glDrawBuffersARB", descriptor = "(I[II)V", line = 2897)
    public void glDrawBuffersARB(int arg0, int[] arg1, int arg2) {
        this.glDrawBuffersARB1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glDeleteFramebuffersEXT", descriptor = "(I[II)V", line = 2946)
    public void glDeleteFramebuffersEXT(int arg0, int[] arg1, int arg2) {
        this.glDeleteFramebuffersEXT1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "setSwapInterval", descriptor = "(I)V", line = 2978)
    public void setSwapInterval(int arg0) {
        this.field5572.setSwapInterval(arg0);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "getArray", descriptor = "(Ljava/nio/Buffer;)Ljava/lang/Object;", line = 3001)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glInterleavedArrays", descriptor = "(II[BI)V", line = 3139)
    public void glInterleavedArrays(int arg0, int arg1, byte[] arg2, int arg3) {
        this.glInterleavedArrays1(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glBufferDataARB", descriptor = "(IILjava/nio/Buffer;I)V", line = 3146)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glGenRenderbuffersEXT", descriptor = "(I[II)V", line = 3176)
    public void glGenRenderbuffersEXT(int arg0, int[] arg1, int arg2) {
        this.glGenRenderbuffersEXT1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glColorPointer", descriptor = "(III[BI)V", line = 3190)
    public void glColorPointer(int arg0, int arg1, int arg2, byte[] arg3, int arg4) {
        this.glColorPointer1(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glGenBuffersARB", descriptor = "(I[II)V", line = 3259)
    public void glGenBuffersARB(int arg0, int[] arg1, int arg2) {
        this.glGenBuffersARB1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glTexImage1D", descriptor = "(IIIIIII[BI)V", line = 3321)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glDeleteBuffersARB", descriptor = "(I[II)V", line = 3373)
    public void glDeleteBuffersARB(int arg0, int[] arg1, int arg2) {
        this.glDeleteBuffersARB1(arg0, arg1, arg2 * 4);
    }

    @OriginalMember(owner = "client!jaggl/opengl", name = "glReadPixels", descriptor = "(IIIIIILjava/nio/Buffer;)V", line = 3463)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "glProgramLocalParameter4fvARB", descriptor = "(IILjava/nio/FloatBuffer;)V", line = 3560)
    ...
    @OriginalMember(owner = "client!jaggl/opengl", name = "<init>", descriptor = "(Ljaggl/context;)V", line = 3614)
