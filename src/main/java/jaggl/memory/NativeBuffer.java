...
public class NativeBuffer {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "a", descriptor = "([BII)V", line = 7)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "b", descriptor = "()J", line = 32)
    public final long method2610() {
        return this.field6248.getBufferAddress(this.field6246);
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "c", descriptor = "()Z", line = 39)
    private final synchronized boolean method2611() {
        return this.field6248.method2621() && this.field6247;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "finalize", descriptor = "()V", line = 47)
