...
public class NativeBuffer {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "finalize", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "<init>", descriptor = "(Ljaggl/memory/NativeHeap;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "a", descriptor = "()Z", line = 33)
    private final synchronized boolean method2671() {
        return this.field6511.method2682() && this.field6509;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "b", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "c", descriptor = "()J", line = 59)
