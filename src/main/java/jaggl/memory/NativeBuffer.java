...
public class NativeBuffer {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "finalize", descriptor = "()V", line = 5)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method2644();
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "a", descriptor = "()J", line = 14)
    public final long method2641() {
        return this.field6587.getBufferAddress(this.field6586);
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "b", descriptor = "()Z", line = 21)
    private final synchronized boolean method2642() {
        return this.field6587.method2654() && this.field6588;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "a", descriptor = "([BII)V", line = 28)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "c", descriptor = "()V", line = 40)
