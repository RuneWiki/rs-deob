...
public class NativeBuffer {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "a", descriptor = "([BII)V", line = 11)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "finalize", descriptor = "()V", line = 23)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method2627();
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "a", descriptor = "()Z", line = 31)
    private final synchronized boolean method2626() {
        return this.field6563.method2637() && this.field6561;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "b", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeBuffer", name = "c", descriptor = "()J", line = 49)
