...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "finalize", descriptor = "()V", line = 7)
    ...
    public final synchronized boolean method2600() {
        return this.field6466;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "b", descriptor = "()V", line = 28)
    public final synchronized void method2601() {
        if (this.field6466) {
            this.deallocateHeap();
        }
