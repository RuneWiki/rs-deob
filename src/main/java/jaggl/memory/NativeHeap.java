...
public class NativeHeap {
    ...
    public final synchronized boolean method2603() {
        return this.field6330;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "b", descriptor = "()V", line = 23)
    public final synchronized void method2604() {
        if (this.field6330) {
            this.deallocateHeap();
        }
    ...
    public NativeHeap(int arg0) {
        this.field6331 = arg0;
        this.allocateHeap(this.field6331);
        this.field6330 = true;
    }
