...
public class NativeHeap {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "a", descriptor = "()V", line = 5)
    public final synchronized void method2732() {
        if (this.field6737) {
            this.deallocateHeap();
        }
        this.field6737 = false;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "b", descriptor = "()Z", line = 18)
    public final synchronized boolean method2733() {
        return this.field6737;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "finalize", descriptor = "()V", line = 29)
