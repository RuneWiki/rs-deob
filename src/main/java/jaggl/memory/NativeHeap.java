...
public class NativeHeap {
    ...
    public final NativeBuffer method121(int arg0) {
        if (!this.field226) {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "a", descriptor = "()V")
    public final synchronized void method122() {
        if (this.field226) {
            this.deallocateHeap();
        }
        this.field226 = false;
    ...
    public NativeHeap(int arg0) {
        this.field227 = arg0;
        this.allocateHeap(this.field227);
        this.field226 = true;
    }
    ...
    public final synchronized boolean method123() {
