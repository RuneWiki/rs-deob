...
public class NativeHeap {
    ...
    public final synchronized boolean method103() {
        return this.field217;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "b", descriptor = "()V", line = 15)
    public final synchronized void method104() {
        if (this.field217) {
            this.deallocateHeap();
        }
        this.field217 = false;
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "a", descriptor = "(I)Ljaggl/memory/NativeBuffer;", line = 28)
    public final NativeBuffer method105(int arg0) {
        if (!this.field217) {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "finalize", descriptor = "()V", line = 40)
    ...
    public NativeHeap(int arg0) {
        this.field216 = arg0;
        this.allocateHeap(this.field216);
        this.field217 = true;
    }
