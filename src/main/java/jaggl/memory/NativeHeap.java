...
public class NativeHeap {
    ...
    public final NativeBuffer method2636(int arg0) {
        if (!this.field6569) {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "a", descriptor = "()Z", line = 15)
    public final synchronized boolean method2637() {
        return this.field6569;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "finalize", descriptor = "()V", line = 28)
    protected final synchronized void finalize() throws Throwable {
        super.finalize();
        this.method2638();
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "<init>", descriptor = "(I)V", line = 36)
    public NativeHeap(int arg0) {
        this.field6570 = arg0;
        this.allocateHeap(this.field6570);
        this.field6569 = true;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeHeap", name = "b", descriptor = "()V", line = 47)
