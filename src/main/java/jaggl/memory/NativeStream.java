...
public class NativeStream {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "(F)V", line = 6)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "<init>", descriptor = "(Ljaggl/memory/NativeBuffer;)V", line = 21)
    public NativeStream(NativeBuffer arg0) {
        this(arg0, arg0.field293 < 4096 ? arg0.field293 : 4096);
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "(I)V", line = 26)
    public final void method153(int arg0) {
        this.method157();
        this.field298 = arg0;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "<init>", descriptor = "(Ljaggl/memory/NativeBuffer;I)V", line = 63)
    private NativeStream(NativeBuffer arg0, int arg1) {
        this.field297 = arg0;
        this.field300 = new byte[arg1];
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "()Z", line = 73)
    public static final boolean method156() {
        return getLSB(-65536) == -1;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "c", descriptor = "()I", line = 93)
