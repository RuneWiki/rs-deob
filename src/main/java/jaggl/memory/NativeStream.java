...
public class NativeStream {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "(I)V", line = 7)
    public final void method2645(int arg0) {
        this.method2650();
        this.field6452 = arg0;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "(F)V", line = 15)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "(F)V", line = 30)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "<init>", descriptor = "(Ljaggl/memory/NativeBuffer;)V", line = 59)
    public NativeStream(NativeBuffer arg0) {
        this(arg0, arg0.field6447 >= 4096 ? 4096 : arg0.field6447);
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "()Z", line = 65)
    public static final boolean method2649() {
        return getLSB(-65536) == -1;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "()V", line = 72)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "c", descriptor = "()I", line = 87)
