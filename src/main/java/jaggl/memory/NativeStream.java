...
public class NativeStream {
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "(F)V", line = 4)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "<init>", descriptor = "(Ljaggl/memory/NativeBuffer;)V", line = 38)
    public NativeStream(NativeBuffer arg0) {
        this(arg0, arg0.field6249 >= 4096 ? 4096 : arg0.field6249);
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "a", descriptor = "(I)V", line = 41)
    public final void method2614(int arg0) {
        this.method2613();
        this.field6252 = arg0;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "()I", line = 49)
    public final int method2615() {
        return this.field6252 + this.field6251;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "c", descriptor = "()Z", line = 56)
    public static final boolean method2616() {
        return getLSB(-65536) == -1;
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "<init>", descriptor = "(Ljaggl/memory/NativeBuffer;I)V", line = 79)
    private NativeStream(NativeBuffer arg0, int arg1) {
        this.field6253 = arg0;
        this.field6250 = new byte[arg1];
    }

    @OriginalMember(owner = "client!jaggl/memory/NativeStream", name = "b", descriptor = "(F)V", line = 88)
