...
public class MapBuffer extends NativeBuffer {
    ...
    public final boolean method3307() {
        boolean var1 = true;
        if (this.field8249 != 0) {
            var1 = OpenGL.glUnmapBufferARB(this.field8249);
            this.method3232(0L, 0);
            this.field8249 = 0;
        }
        return var1;
    }
    ...
    public final boolean method3308() {
        return this.field8249 != 0;
    }

    @OriginalMember(owner = "client!jaggl/MapBuffer", name = "a", descriptor = "(III)Z", line = 32)
    public final boolean method3309(int arg0, int arg1, int arg2) {
        if (this.field8249 != 0) {
            return false;
        }
        ...
        if (var4 == 0L) {
            ...
            this.method3232(var4, arg1);
            this.field8249 = arg0;
            return true;
        }
    }

    @OriginalMember(owner = "client!jaggl/MapBuffer", name = "a", descriptor = "([BIII)V", line = 50)
    public final void method2410(byte[] arg0, int arg1, int arg2, int arg3) {
        if (this.field8249 == 0) {
            throw new RuntimeException();
        }
        super.method2410(arg0, arg1, arg2, arg3);
    }
}
