...
public class MapBuffer extends NativeBuffer {
    ...
    public final void method2972(byte[] arg0, int arg1, int arg2, int arg3) {
        ...
        super.method2972(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jaggl/MapBuffer", name = "a", descriptor = "()Z", line = 15)
    public final boolean method3716() {
        boolean var1 = true;
        if (this.field9148 != 0) {
            var1 = OpenGL.glUnmapBufferARB(this.field9148);
            this.method3963(0L, 0);
            this.field9148 = 0;
        }
        return var1;
    }

    @OriginalMember(owner = "client!jaggl/MapBuffer", name = "b", descriptor = "()Z", line = 35)
    public final boolean method3717() {
        return this.field9148 != 0;
    }
