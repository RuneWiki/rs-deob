...
public class MapBuffer extends NativeBuffer {
    ...
    public final boolean method3570(int arg0, int arg1, int arg2) {
        ...
        if (var4 == 0L) {
            ...
            this.method3824(var4, arg1);
            this.field8933 = arg0;
            return true;
        }
    }

    @OriginalMember(owner = "client!jaggl/MapBuffer", name = "a", descriptor = "()Z", line = 24)
    public final boolean method3571() {
        return this.field8933 != 0;
    }

    @OriginalMember(owner = "client!jaggl/MapBuffer", name = "b", descriptor = "()Z", line = 31)
    public final boolean method3572() {
        boolean var1 = true;
        if (this.field8933 != 0) {
            var1 = OpenGL.glUnmapBufferARB(this.field8933);
            this.method3824(0L, 0);
            this.field8933 = 0;
        }
        return var1;
    }
    ...
    public final void method2917(byte[] arg0, int arg1, int arg2, int arg3) {
        ...
        super.method2917(arg0, arg1, arg2, arg3);
    }
}
