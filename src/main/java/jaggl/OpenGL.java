...
public class OpenGL {
    ...
    private static Hashtable field8765 = new Hashtable();
    ...
    private Thread field8764;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8766;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1722)
    public final synchronized boolean method3609() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8765.put(var1, this);
        if (var2 != null) {
            var2.field8764 = null;
        }
        this.field8764 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1881)
    public final boolean method3610(String arg0) {
        if (this.field8766 == null) {
            this.field8766 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8766.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8766.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8766.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2800)
    public final synchronized boolean method3611() {
        if (this.field8764 == Thread.currentThread()) {
            this.detachPeer();
            field8765.remove(this.field8764);
            this.field8764 = null;
            return true;
        } else {
            return false;
