...
public class OpenGL {
    ...
    private static Hashtable field6583 = new Hashtable();

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "peer", descriptor = "J")
    public long peer;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/lang/Thread;")
    private Thread field6584;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6582;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 291)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6583.put(var1, this);
        if (var2 != null) {
            var2.field6584 = null;
        }
        this.field6584 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1667)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6582 == null) {
            this.field6582 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6582.put(var5, var5);
                }
            }
        }
        return this.field6582.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2803)
    public synchronized boolean detach() {
        if (this.field6584 == Thread.currentThread()) {
            this.detachPeer();
            field6583.remove(this.field6584);
            this.field6584 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2836)
    public static OpenGL getCurrent() {
        return (OpenGL) field6583.get(Thread.currentThread());
    }
