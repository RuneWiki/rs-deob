...
public class OpenGL {
    ...
    private static Hashtable field8892 = new Hashtable();
    ...
    private Thread field8894;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8893;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 41)
    public final synchronized boolean method3547() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8892.put(var1, this);
        if (var2 != null) {
            var2.field8894 = null;
        }
        this.field8894 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2144)
    public final boolean method3548(String arg0) {
        if (this.field8893 == null) {
            this.field8893 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8893.put(var5, var5);
                }
            }
        }
        return this.field8893.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2710)
    public final synchronized boolean method3549() {
        if (this.field8894 == Thread.currentThread()) {
            this.detachPeer();
            field8892.remove(this.field8894);
            this.field8894 = null;
            return true;
        } else {
            return false;
