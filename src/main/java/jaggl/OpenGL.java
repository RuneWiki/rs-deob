...
public class OpenGL {
    ...
    private static Hashtable field7090 = new Hashtable();
    ...
    private Thread field7091;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7089;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 235)
    public static OpenGL getCurrent() {
        return (OpenGL) field7090.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 540)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field7089 == null) {
            this.field7089 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field7089.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field7089.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field7089.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1172)
    public synchronized boolean detach() {
        if (this.field7091 == Thread.currentThread()) {
            this.detachPeer();
            field7090.remove(this.field7091);
            this.field7091 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 1416)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7090.put(var1, this);
        if (var2 != null) {
            var2.field7091 = null;
        }
        this.field7091 = var1;
