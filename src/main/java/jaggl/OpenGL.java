...
public class OpenGL {
   ...
   private static Hashtable field10698 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field10697;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "b",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field10696;
   ...
   public final boolean method5260(String arg0) {
      if (this.field10696 == null) {
         this.field10696 = new Hashtable();
      ...
      return this.field10696.containsKey(arg0);
   }
   ...
   public final synchronized boolean method5261() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field10698.put(var1, this);
         if (var2 != null) {
            var2.field10697 = null;
         }

         this.field10697 = var1;
         return true;
      } else {
         return false;
      }
   ...
   public final synchronized boolean method5262() {
      if (this.field10697 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field10698.remove(this.field10697);
         this.field10697 = null;
         return true;
      }
   }
