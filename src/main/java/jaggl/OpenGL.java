...
public class OpenGL {
    ...
    private static Hashtable field7478 = new Hashtable();
    ...
    public final synchronized boolean method3071() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7478.put(var1, this);
        if (var2 != null) {
            var2.field7479 = null;
        }
        this.field7479 = var1;
    ...
    public final synchronized boolean method3072() {
        if (this.field7479 == Thread.currentThread()) {
            this.detachPeer();
            field7478.remove(this.field7479);
            this.field7479 = null;
            return true;
        } else {
            return false;
    ...
    public final boolean method3073(String arg0) {
        if (this.field7477 == null) {
            this.field7477 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field7477.put(var5, var5);
                }
            }
        }
        return this.field7477.containsKey(arg0);
    }
