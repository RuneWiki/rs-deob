...
public class OpenGL {
    ...
    private static Hashtable field6401 = new Hashtable();
    ...
    private Thread field6402;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6400;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 866)
    public synchronized boolean detach() {
        if (this.field6402 == Thread.currentThread()) {
            this.detachPeer();
            field6401.remove(this.field6402);
            this.field6402 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1130)
    public static OpenGL getCurrent() {
        return (OpenGL) field6401.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 1443)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6401.put(var1, this);
        if (var2 != null) {
            var2.field6402 = null;
        }
        this.field6402 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 2646)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6400 == null) {
            this.field6400 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6400.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6400.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6400.containsKey(arg0);
    }
