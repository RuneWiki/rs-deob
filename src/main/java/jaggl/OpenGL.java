...
public class OpenGL {
    ...
    private static Hashtable field9145 = new Hashtable();
    ...
    private Thread field9146;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9147;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 502)
    public final synchronized boolean method3713() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9145.put(var1, this);
        if (var2 != null) {
            var2.field9146 = null;
        }
        this.field9146 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 779)
    public final synchronized boolean method3714() {
        if (this.field9146 == Thread.currentThread()) {
            this.detachPeer();
            field9145.remove(this.field9146);
            this.field9146 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 873)
    public final boolean method3715(String arg0) {
        if (this.field9147 == null) {
            this.field9147 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field9147.put(var5, var5);
                }
            }
        }
        return this.field9147.containsKey(arg0);
    }
