...
public class OpenGL {
    ...
    private static Hashtable field8070 = new Hashtable();
    ...
    public final synchronized boolean method3262() {
        if (this.field8071 == Thread.currentThread()) {
            this.detachPeer();
            field8070.remove(this.field8071);
            this.field8071 = null;
            return true;
        } else {
            return false;
    ...
    public final boolean method3263(String arg0) {
        if (this.field8069 == null) {
            this.field8069 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8069.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8069.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8069.containsKey(arg0);
    }
    ...
    public final synchronized boolean method3264() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8070.put(var1, this);
        if (var2 != null) {
            var2.field8071 = null;
        }
        this.field8071 = var1;
