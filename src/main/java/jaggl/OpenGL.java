...
public class OpenGL {
    ...
    private static Hashtable field8427 = new Hashtable();
    ...
    private Thread field8426;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8425;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 240)
    public final boolean method3369(String arg0) {
        if (this.field8425 == null) {
            this.field8425 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8425.put(var5, var5);
                }
            }
        }
        return this.field8425.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1235)
    public final synchronized boolean method3370() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8427.put(var1, this);
        if (var2 != null) {
            var2.field8426 = null;
        }
        this.field8426 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2875)
    public final synchronized boolean method3371() {
        if (this.field8426 == Thread.currentThread()) {
            this.detachPeer();
            field8427.remove(this.field8426);
            this.field8426 = null;
            return true;
        } else {
            return false;
