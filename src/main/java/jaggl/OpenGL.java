...
public class OpenGL {
    ...
    private static Hashtable field7943 = new Hashtable();
    ...
    private Thread field7945;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7944;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1648)
    public final synchronized boolean method3215() {
        if (this.field7945 == Thread.currentThread()) {
            this.detachPeer();
            field7943.remove(this.field7945);
            this.field7945 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1825)
    public final synchronized boolean method3216() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7943.put(var1, this);
        if (var2 != null) {
            var2.field7945 = null;
        }
        this.field7945 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1998)
    public final boolean method3217(String arg0) {
        if (this.field7944 == null) {
            this.field7944 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field7944.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field7944.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field7944.containsKey(arg0);
    }
