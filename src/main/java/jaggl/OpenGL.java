...
public class OpenGL {
    ...
    private static Hashtable field8741 = new Hashtable();
    ...
    private Thread field8742;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8740;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 760)
    public final synchronized boolean method3529() {
        if (this.field8742 == Thread.currentThread()) {
            this.detachPeer();
            field8741.remove(this.field8742);
            this.field8742 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1883)
    public final boolean method3530(String arg0) {
        if (this.field8740 == null) {
            this.field8740 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8740.put(var5, var5);
                }
            }
        }
        return this.field8740.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2376)
    public final synchronized boolean method3531() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8741.put(var1, this);
        if (var2 != null) {
            var2.field8742 = null;
        }
        this.field8742 = var1;
