...
public class OpenGL {
    ...
    private static Hashtable field6243 = new Hashtable();
    ...
    private Thread field6244;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6245;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 675)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6243.put(var1, this);
        if (var2 != null) {
            var2.field6244 = null;
        }
        this.field6244 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2153)
    public synchronized boolean detach() {
        if (this.field6244 == Thread.currentThread()) {
            this.detachPeer();
            field6243.remove(this.field6244);
            this.field6244 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 2299)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6245 == null) {
            this.field6245 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6245.put(var5, var5);
                }
            }
        }
        return this.field6245.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2490)
    public static OpenGL getCurrent() {
        return (OpenGL) field6243.get(Thread.currentThread());
    }
