...
public class OpenGL {
   ...
   private static Hashtable field9195 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field9196;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "c",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field9197;
   ...
   public final synchronized boolean method4749() {
      if (this.field9196 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field9195.remove(this.field9196);
         this.field9196 = null;
         return true;
      }
   }
   ...
   public final boolean method4750(String arg0) {
      if (this.field9197 == null) {
         this.field9197 = new Hashtable();
         ...
         while(true) {
            ...
            var3 = var4 + 1;
            if (var5.length() != 0) {
               this.field9197.put(var5, var5);
            }
         }
      }

      return this.field9197.containsKey(arg0);
   }
   ...
   public final synchronized boolean method4751() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field9195.put(var1, this);
         if (var2 != null) {
            var2.field9196 = null;
         }
