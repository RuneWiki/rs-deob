...
public class OpenGL {
    ...
    private static Hashtable field8305 = new Hashtable();
    ...
    private Thread field8304;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8303;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 281)
    public final synchronized boolean method3437() {
        if (this.field8304 == Thread.currentThread()) {
            this.detachPeer();
            field8305.remove(this.field8304);
            this.field8304 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 300)
    public final boolean method3438(String arg0) {
        if (this.field8303 == null) {
            this.field8303 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8303.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8303.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8303.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1507)
    public final synchronized boolean method3439() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8305.put(var1, this);
        if (var2 != null) {
            var2.field8304 = null;
        }
        this.field8304 = var1;
