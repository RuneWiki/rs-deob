...
public class OpenGL {
    ...
    private static Hashtable field9059 = new Hashtable();
    ...
    private Thread field9057;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9058;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 474)
    public final synchronized boolean method3635() {
        if (this.field9057 == Thread.currentThread()) {
            this.detachPeer();
            field9059.remove(this.field9057);
            this.field9057 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1479)
    public final boolean method3636(String arg0) {
        if (this.field9058 == null) {
            this.field9058 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field9058.put(var5, var5);
                }
            }
        }
        return this.field9058.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2002)
    public final synchronized boolean method3637() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9059.put(var1, this);
        if (var2 != null) {
            var2.field9057 = null;
        }
        this.field9057 = var1;
