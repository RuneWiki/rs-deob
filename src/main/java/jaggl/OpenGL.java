...
public class OpenGL {
    ...
    private static Hashtable field8962 = new Hashtable();
    ...
    private Thread field8960;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8961;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 217)
    public final boolean method3599(String arg0) {
        if (this.field8961 == null) {
            this.field8961 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8961.put(var5, var5);
                }
            }
        }
        return this.field8961.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1334)
    public final synchronized boolean method3600() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8962.put(var1, this);
        if (var2 != null) {
            var2.field8960 = null;
        }
        this.field8960 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2660)
    public final synchronized boolean method3601() {
        if (this.field8960 == Thread.currentThread()) {
            this.detachPeer();
            field8962.remove(this.field8960);
            this.field8960 = null;
            return true;
        } else {
            return false;
