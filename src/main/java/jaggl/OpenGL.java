...
public class OpenGL {
    ...
    private static Hashtable field6508 = new Hashtable();
    ...
    private Thread field6507;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6506;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 375)
    public static OpenGL getCurrent() {
        return (OpenGL) field6508.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 897)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6506 == null) {
            this.field6506 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6506.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6506.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6506.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1803)
    public synchronized boolean detach() {
        if (this.field6507 == Thread.currentThread()) {
            this.detachPeer();
            field6508.remove(this.field6507);
            this.field6507 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2659)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6508.put(var1, this);
        if (var2 != null) {
            var2.field6507 = null;
        }
        this.field6507 = var1;
