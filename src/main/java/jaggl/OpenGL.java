...
public class OpenGL {
    ...
    private static Hashtable field6551 = new Hashtable();
    ...
    private Thread field6550;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6549;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 489)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6549 == null) {
            this.field6549 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6549.put(var5, var5);
                }
            }
        }
        return this.field6549.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 841)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6551.put(var1, this);
        if (var2 != null) {
            var2.field6550 = null;
        }
        this.field6550 = var1;
    ...
    public synchronized boolean detach() {
        if (this.field6550 == Thread.currentThread()) {
            this.detachPeer();
            field6551.remove(this.field6550);
            this.field6550 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1908)
    public static OpenGL getCurrent() {
        return (OpenGL) field6551.get(Thread.currentThread());
    }
