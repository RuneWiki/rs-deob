...
public class OpenGL {
    ...
    private static Hashtable field8777 = new Hashtable();
    ...
    private Thread field8779;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8778;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1172)
    public final synchronized boolean method3622() {
        if (this.field8779 == Thread.currentThread()) {
            this.detachPeer();
            field8777.remove(this.field8779);
            this.field8779 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1532)
    public final boolean method3623(String arg0) {
        if (this.field8778 == null) {
            this.field8778 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8778.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8778.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8778.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1776)
    public final synchronized boolean method3624() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8777.put(var1, this);
        if (var2 != null) {
            var2.field8779 = null;
        }
        this.field8779 = var1;
