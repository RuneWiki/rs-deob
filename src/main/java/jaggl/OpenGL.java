...
public class OpenGL {
    ...
    private static Hashtable field6012 = new Hashtable();
    ...
    private Thread field6011;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6013;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 266)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6012.put(var1, this);
        if (var2 != null) {
            var2.field6011 = null;
        }
        this.field6011 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1213)
    public synchronized boolean detach() {
        if (this.field6011 == Thread.currentThread()) {
            this.detachPeer();
            field6012.remove(this.field6011);
            this.field6011 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1751)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6013 == null) {
            this.field6013 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6013.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6013.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6013.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2611)
    public static OpenGL getCurrent() {
        return (OpenGL) field6012.get(Thread.currentThread());
    }
