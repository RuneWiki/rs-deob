...
public class OpenGL {
    ...
    private static Hashtable field8681 = new Hashtable();
    ...
    private Thread field8680;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8679;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 926)
    public final boolean method3500(String arg0) {
        if (this.field8679 == null) {
            this.field8679 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8679.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8679.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8679.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2370)
    public final synchronized boolean method3501() {
        if (this.field8680 == Thread.currentThread()) {
            this.detachPeer();
            field8681.remove(this.field8680);
            this.field8680 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2482)
    public final synchronized boolean method3502() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8681.put(var1, this);
        if (var2 != null) {
            var2.field8680 = null;
        }
        this.field8680 = var1;
