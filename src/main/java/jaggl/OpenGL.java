...
public class OpenGL {
    ...
    private static Hashtable field9045 = new Hashtable();
    ...
    private Thread field9044;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9046;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 22)
    public final synchronized boolean method3665() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9045.put(var1, this);
        if (var2 != null) {
            var2.field9044 = null;
        }
        this.field9044 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 314)
    public final synchronized boolean method3666() {
        if (this.field9044 == Thread.currentThread()) {
            this.detachPeer();
            field9045.remove(this.field9044);
            this.field9044 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2817)
    public final boolean method3667(String arg0) {
        if (this.field9046 == null) {
            this.field9046 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field9046.put(var5, var5);
                }
            }
        }
        return this.field9046.containsKey(arg0);
    }
