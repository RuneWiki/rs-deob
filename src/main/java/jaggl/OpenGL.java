...
public class OpenGL {
    ...
    private static Hashtable field8606 = new Hashtable();
    ...
    private Thread field8605;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8607;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 946)
    public final synchronized boolean method3567() {
        if (this.field8605 == Thread.currentThread()) {
            this.detachPeer();
            field8606.remove(this.field8605);
            this.field8605 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1240)
    public final synchronized boolean method3568() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8606.put(var1, this);
        if (var2 != null) {
            var2.field8605 = null;
        }
        this.field8605 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2555)
    public final boolean method3569(String arg0) {
        if (this.field8607 == null) {
            this.field8607 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8607.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8607.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8607.containsKey(arg0);
    }
