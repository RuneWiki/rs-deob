...
public class OpenGL {
    ...
    private static Hashtable field8247 = new Hashtable();
    ...
    private Thread field8246;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8245;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1712)
    public final synchronized boolean method3388() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8247.put(var1, this);
        if (var2 != null) {
            var2.field8246 = null;
        }
        this.field8246 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2083)
    public final synchronized boolean method3389() {
        if (this.field8246 == Thread.currentThread()) {
            this.detachPeer();
            field8247.remove(this.field8246);
            this.field8246 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2698)
    public final boolean method3390(String arg0) {
        if (this.field8245 == null) {
            this.field8245 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8245.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8245.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8245.containsKey(arg0);
    }
