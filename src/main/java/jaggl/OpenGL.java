...
public class OpenGL {
    ...
    private static Hashtable field6726 = new Hashtable();
    ...
    private Thread field6727;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6725;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 574)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6726.put(var1, this);
        if (var2 != null) {
            var2.field6727 = null;
        }
        this.field6727 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 697)
    public static OpenGL getCurrent() {
        return (OpenGL) field6726.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 873)
    public synchronized boolean detach() {
        if (this.field6727 == Thread.currentThread()) {
            this.detachPeer();
            field6726.remove(this.field6727);
            this.field6727 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1678)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6725 == null) {
            this.field6725 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6725.put(var5, var5);
                }
            }
        }
        return this.field6725.containsKey(arg0);
    }
