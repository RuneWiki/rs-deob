...
public class OpenGL {
    ...
    private static Hashtable field10298 = new Hashtable();
    ...
    private Thread field10299;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field10297;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 340)
    public final synchronized boolean method5237() {
        if (this.field10299 == Thread.currentThread()) {
            this.detachPeer();
            field10298.remove(this.field10299);
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 476)
    public final boolean method5238(String arg0) {
        if (this.field10297 == null) {
            this.field10297 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field10297.put(var5, var5);
                }
            }
        }
        return this.field10297.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 997)
    public final synchronized boolean method5239() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field10298.put(var1, this);
        if (var2 != null) {
            var2.field10299 = null;
        }
        this.field10299 = var1;
        return true;
    }
