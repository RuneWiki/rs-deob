...
public class OpenGL {
    ...
    private static Hashtable field291 = new Hashtable();
    ...
    private Thread field292;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field290;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 14)
    public static OpenGL getCurrent() {
        return (OpenGL) field291.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 120)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field290 == null) {
            this.field290 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field290.put(var5, var5);
                }
            }
        }
        return this.field290.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 244)
    public synchronized boolean detach() {
        if (this.field292 == Thread.currentThread()) {
            this.detachPeer();
            field291.remove(this.field292);
            this.field292 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2502)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field291.put(var1, this);
        if (var2 != null) {
            var2.field292 = null;
        }
        this.field292 = var1;
