...
public class OpenGL {
    ...
    private static Hashtable field8412 = new Hashtable();
    ...
    public final synchronized boolean method3324() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8412.put(var1, this);
        if (var2 != null) {
            var2.field8413 = null;
        }
        this.field8413 = var1;
    ...
    public final boolean method3325(String arg0) {
        if (this.field8414 == null) {
            this.field8414 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8414.put(var5, var5);
                }
            }
        }
        return this.field8414.containsKey(arg0);
    }
    ...
    public final synchronized boolean method3326() {
        if (this.field8413 == Thread.currentThread()) {
            this.detachPeer();
            field8412.remove(this.field8413);
            this.field8413 = null;
            return true;
        } else {
            return false;
