...
public class OpenGL {
    ...
    private static Hashtable field257 = new Hashtable();
    ...
    private Thread field256;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field255;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 109)
    public final synchronized boolean method122() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field257.put(var1, this);
        if (var2 != null) {
            var2.field256 = null;
        }
        this.field256 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 342)
    public final boolean method123(String arg0) {
        if (this.field255 == null) {
            this.field255 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field255.put(var5, var5);
                }
            }
        }
        return this.field255.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1550)
    public final synchronized boolean method124() {
        if (this.field256 == Thread.currentThread()) {
            this.detachPeer();
            field257.remove(this.field256);
            this.field256 = null;
            return true;
        } else {
            return false;
