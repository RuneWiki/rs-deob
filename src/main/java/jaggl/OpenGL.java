...
public class OpenGL {
    ...
    private static Hashtable field443 = new Hashtable();
    ...
    private Thread field442;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field444;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 408)
    public final synchronized boolean method159() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field443.put(var1, this);
        if (var2 != null) {
            var2.field442 = null;
        }
        this.field442 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 642)
    public final boolean method160(String arg0) {
        if (this.field444 == null) {
            this.field444 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field444.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field444.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field444.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 792)
    public final synchronized boolean method161() {
        if (this.field442 == Thread.currentThread()) {
            this.detachPeer();
            field443.remove(this.field442);
            this.field442 = null;
            return true;
        } else {
            return false;
