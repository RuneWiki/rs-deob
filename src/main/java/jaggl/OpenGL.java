...
public class OpenGL {
    ...
    private static Hashtable field235 = new Hashtable();
    ...
    private Thread field234;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field236;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1118)
    public final synchronized boolean method117() {
        if (this.field234 == Thread.currentThread()) {
            this.detachPeer();
            field235.remove(this.field234);
            this.field234 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2382)
    public final boolean method118(String arg0) {
        if (this.field236 == null) {
            this.field236 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field236.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field236.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field236.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2709)
    public final synchronized boolean method119() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field235.put(var1, this);
        if (var2 != null) {
            var2.field234 = null;
        }
        this.field234 = var1;
