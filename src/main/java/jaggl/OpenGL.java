...
public class OpenGL {
    ...
    private static Hashtable field7488 = new Hashtable();
    ...
    private Thread field7487;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7489;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 742)
    public final synchronized boolean method3175() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7488.put(var1, this);
        if (var2 != null) {
            var2.field7487 = null;
        }
        this.field7487 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1195)
    public final boolean method3176(String arg0) {
        if (this.field7489 == null) {
            this.field7489 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field7489.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field7489.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field7489.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2345)
    public final synchronized boolean method3177() {
        if (this.field7487 == Thread.currentThread()) {
            this.detachPeer();
            field7488.remove(this.field7487);
            this.field7487 = null;
            return true;
        } else {
            return false;
