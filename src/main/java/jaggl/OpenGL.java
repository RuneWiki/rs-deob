...
public class OpenGL {
   ...
   private static Hashtable field420 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field419;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "c",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field421;
   ...
   public final synchronized boolean method227() {
      if (this.field419 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field420.remove(this.field419);
         this.field419 = null;
         return true;
      }
   }
   ...
   public final synchronized boolean method228() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field420.put(var1, this);
         if (var2 != null) {
            var2.field419 = null;
         }
   ...
   public final boolean method229(String arg0) {
      if (this.field421 == null) {
         this.field421 = new Hashtable();
         ...
         while(true) {
            ...
            var3 = var4 + 1;
            if (~var5.length() != -1) {
               this.field421.put(var5, var5);
            }
         }
      }

      return this.field421.containsKey(arg0);
   }
