...
public class OpenGL {
    ...
    private static Hashtable field8269 = new Hashtable();
    ...
    private Thread field8270;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8271;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1482)
    public final synchronized boolean method3347() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8269.put(var1, this);
        if (var2 != null) {
            var2.field8270 = null;
        }
        this.field8270 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1850)
    public final boolean method3348(String arg0) {
        if (this.field8271 == null) {
            this.field8271 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8271.put(var5, var5);
                }
            }
        }
        return this.field8271.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2195)
    public final synchronized boolean method3349() {
        if (this.field8270 == Thread.currentThread()) {
            this.detachPeer();
            field8269.remove(this.field8270);
            this.field8270 = null;
            return true;
        } else {
            return false;
