...
public class OpenGL {
    ...
    private static Hashtable field6069 = new Hashtable();
    ...
    private Thread field6068;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6067;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1135)
    public static OpenGL getCurrent() {
        return (OpenGL) field6069.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1254)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6067 == null) {
            this.field6067 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6067.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6067.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6067.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2616)
    public synchronized boolean detach() {
        if (this.field6068 == Thread.currentThread()) {
            this.detachPeer();
            field6069.remove(this.field6068);
            this.field6068 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2869)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6069.put(var1, this);
        if (var2 != null) {
            var2.field6068 = null;
        }
        this.field6068 = var1;
