...
public class OpenGL {
    ...
    private static Hashtable field9360 = new Hashtable();
    ...
    private Thread field9359;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9361;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 612)
    public final boolean method4761(String arg0) {
        if (this.field9361 == null) {
            this.field9361 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field9361.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field9361.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field9361.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2214)
    public final synchronized boolean method4762() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9360.put(var1, this);
        if (var2 != null) {
            var2.field9359 = null;
        }
        this.field9359 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2639)
    public final synchronized boolean method4763() {
        if (this.field9359 == Thread.currentThread()) {
            this.detachPeer();
            field9360.remove(this.field9359);
            this.field9359 = null;
            return true;
        } else {
            return false;
