...
public class OpenGL {
    ...
    private static Hashtable field215 = new Hashtable();
    ...
    public synchronized boolean attach() {
        ...
        OpenGL var2 = (OpenGL) field215.put(var1, this);
        if (var2 != null) {
            var2.field216 = null;
        }
        this.field216 = var1;
    ...
    public static OpenGL getCurrent() {
        return (OpenGL) field215.get(Thread.currentThread());
    }
    ...
    public synchronized boolean detach() {
        if (this.field216 == Thread.currentThread()) {
            this.detachPeer();
            field215.remove(this.field216);
            this.field216 = null;
            return true;
        } else {
            return false;
    ...
    public boolean isExtensionAvailable(String arg0) {
        if (this.field217 == null) {
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field217.put(var5, var5);
                }
            }
        }
        return this.field217.containsKey(arg0);
    }
