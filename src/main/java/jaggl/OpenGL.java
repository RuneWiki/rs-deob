...
public class OpenGL {
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "b",
      descriptor = "Ljava/util/Hashtable;"
   )
   private static Hashtable field10347 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field10346;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "c",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field10348;
   ...
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "init",
      descriptor = "(Ljava/awt/Canvas;IIIIII)J"
   )
   ...
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "releaseSurface",
      descriptor = "(Ljava/awt/Canvas;J)V"
   )
   ...
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "glTexSubImage2Di",
      descriptor = "(IIIIIIII[II)V"
   )
   ...
   public final synchronized boolean method5237() {
      if (this.field10346 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field10347.remove(this.field10346);
         this.field10346 = null;
         return true;
      }
   }
   ...
   public final synchronized boolean method5238() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field10347.put(var1, this);
         if (var2 != null) {
            var2.field10346 = null;
         }

         this.field10346 = var1;
         return true;
      } else {
         return false;
      }
   ...
   public final boolean method5239(String arg0) {
      if (this.field10348 == null) {
         this.field10348 = new Hashtable();
         ...
         while(true) {
            ...
            var3 = var4 + 1;
            if (~var5.length() != -1) {
               this.field10348.put(var5, var5);
            }
         }
      }

      return this.field10348.containsKey(arg0);
   }
