...
public class OpenGL {
    ...
    private static Hashtable field7055 = new Hashtable();
    ...
    private Thread field7057;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7056;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 805)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7055.put(var1, this);
        if (var2 != null) {
            var2.field7057 = null;
        }
        this.field7057 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1089)
    public synchronized boolean detach() {
        if (this.field7057 == Thread.currentThread()) {
            this.detachPeer();
            field7055.remove(this.field7057);
            this.field7057 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1336)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field7056 == null) {
            this.field7056 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field7056.put(var5, var5);
                }
            }
        }
        return this.field7056.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1787)
    public static OpenGL getCurrent() {
        return (OpenGL) field7055.get(Thread.currentThread());
    }
