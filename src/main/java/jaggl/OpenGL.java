...
public class OpenGL {
    ...
    private static Hashtable field9412 = new Hashtable();
    ...
    private Thread field9413;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9414;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1182)
    public final synchronized boolean method4776() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9412.put(var1, this);
        if (var2 != null) {
            var2.field9413 = null;
        }
        this.field9413 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2189)
    public final boolean method4777(String arg0) {
        if (this.field9414 == null) {
            this.field9414 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field9414.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field9414.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field9414.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2364)
    public final synchronized boolean method4778() {
        if (this.field9413 == Thread.currentThread()) {
            this.detachPeer();
            field9412.remove(this.field9413);
            this.field9413 = null;
            return true;
        } else {
            return false;
