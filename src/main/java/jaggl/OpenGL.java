...
public class OpenGL {
    ...
    private static Hashtable field7744 = new Hashtable();
    ...
    private Thread field7743;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7745;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 189)
    public final synchronized boolean method3206() {
        if (this.field7743 == Thread.currentThread()) {
            this.detachPeer();
            field7744.remove(this.field7743);
            this.field7743 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 278)
    public final boolean method3207(String arg0) {
        if (this.field7745 == null) {
            this.field7745 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field7745.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field7745.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field7745.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 944)
    public final synchronized boolean method3208() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7744.put(var1, this);
        if (var2 != null) {
            var2.field7743 = null;
        }
        this.field7743 = var1;
