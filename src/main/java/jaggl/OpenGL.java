...
public class OpenGL {
    ...
    private static Hashtable field6455 = new Hashtable();
    ...
    private Thread field6457;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6456;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1642)
    public static OpenGL getCurrent() {
        return (OpenGL) field6455.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1817)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6456 == null) {
            this.field6456 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6456.put(var5, var5);
                }
            }
        }
        return this.field6456.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2361)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6455.put(var1, this);
        if (var2 != null) {
            var2.field6457 = null;
        }
        this.field6457 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2549)
    public synchronized boolean detach() {
        if (this.field6457 == Thread.currentThread()) {
            this.detachPeer();
            field6455.remove(this.field6457);
            this.field6457 = null;
            return true;
        } else {
            return false;
