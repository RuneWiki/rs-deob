...
public class OpenGL {
    ...
    private static Hashtable field7860 = new Hashtable();
    ...
    private Thread field7859;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7861;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 264)
    public final boolean method3327(String arg0) {
        if (this.field7861 == null) {
            this.field7861 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field7861.put(var5, var5);
                }
            }
        }
        return this.field7861.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2474)
    public final synchronized boolean method3328() {
        if (this.field7859 == Thread.currentThread()) {
            this.detachPeer();
            field7860.remove(this.field7859);
            this.field7859 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2637)
    public final synchronized boolean method3329() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7860.put(var1, this);
        if (var2 != null) {
            var2.field7859 = null;
        }
        this.field7859 = var1;
