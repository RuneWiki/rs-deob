...
public class OpenGL {
    ...
    private static Hashtable field6369 = new Hashtable();
    ...
    private Thread field6368;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6367;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1155)
    public static OpenGL getCurrent() {
        return (OpenGL) field6369.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1282)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6367 == null) {
            this.field6367 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6367.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6367.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6367.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 1342)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6369.put(var1, this);
        if (var2 != null) {
            var2.field6368 = null;
        }
        this.field6368 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2027)
    public synchronized boolean detach() {
        if (this.field6368 == Thread.currentThread()) {
            this.detachPeer();
            field6369.remove(this.field6368);
            this.field6368 = null;
            return true;
        } else {
            return false;
