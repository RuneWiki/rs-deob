...
public class OpenGL {
    ...
    private static Hashtable field7845 = new Hashtable();
    ...
    private Thread field7846;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7844;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 7)
    public final synchronized boolean method3236() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7845.put(var1, this);
        if (var2 != null) {
            var2.field7846 = null;
        }
        this.field7846 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 714)
    public final synchronized boolean method3237() {
        if (this.field7846 == Thread.currentThread()) {
            this.detachPeer();
            field7845.remove(this.field7846);
            this.field7846 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2547)
    public final boolean method3238(String arg0) {
        if (this.field7844 == null) {
            this.field7844 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field7844.put(var5, var5);
                }
            }
        }
        return this.field7844.containsKey(arg0);
    }
