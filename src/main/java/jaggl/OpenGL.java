...
public class OpenGL {
    ...
    private static Hashtable field6943 = new Hashtable();
    ...
    private Thread field6941;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6942;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 737)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6943.put(var1, this);
        if (var2 != null) {
            var2.field6941 = null;
        }
        this.field6941 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1395)
    public synchronized boolean detach() {
        if (this.field6941 == Thread.currentThread()) {
            this.detachPeer();
            field6943.remove(this.field6941);
            this.field6941 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 2093)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6942 == null) {
            this.field6942 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6942.put(var5, var5);
                }
            }
        }
        return this.field6942.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2893)
    public static OpenGL getCurrent() {
        return (OpenGL) field6943.get(Thread.currentThread());
    }
