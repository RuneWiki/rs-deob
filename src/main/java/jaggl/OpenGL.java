...
public class OpenGL {
    ...
    private static Hashtable field8251 = new Hashtable();
    ...
    private Thread field8250;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8252;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 716)
    public final synchronized boolean method3310() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8251.put(var1, this);
        if (var2 != null) {
            var2.field8250 = null;
        }
        this.field8250 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2123)
    public final boolean method3311(String arg0) {
        if (this.field8252 == null) {
            this.field8252 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8252.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8252.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8252.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2776)
    public final synchronized boolean method3312() {
        if (this.field8250 == Thread.currentThread()) {
            this.detachPeer();
            field8251.remove(this.field8250);
            this.field8250 = null;
            return true;
        } else {
            return false;
