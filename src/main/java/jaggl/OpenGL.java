...
public class OpenGL {
   ...
   private static Hashtable field9489 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field9488;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "b",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field9490;
   ...
   public final boolean method4691(String arg0) {
      if (this.field9490 == null) {
         this.field9490 = new Hashtable();
         ...
         while(true) {
            ...
            var3 = var4 + 1;
            if (var5.length() != 0) {
               this.field9490.put(var5, var5);
            }
         }
      }

      return this.field9490.containsKey(arg0);
   }
   ...
   public final synchronized boolean method4692() {
      if (this.field9488 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field9489.remove(this.field9488);
         this.field9488 = null;
         return true;
      }
   }
   ...
   public final synchronized boolean method4693() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field9489.put(var1, this);
         if (var2 != null) {
            var2.field9488 = null;
         }
