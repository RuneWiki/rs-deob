...
public class OpenGL {
    ...
    private static Hashtable field8932 = new Hashtable();
    ...
    private Thread field8931;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8930;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 352)
    public final synchronized boolean method3567() {
        if (this.field8931 == Thread.currentThread()) {
            this.detachPeer();
            field8932.remove(this.field8931);
            this.field8931 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 954)
    public final boolean method3568(String arg0) {
        if (this.field8930 == null) {
            this.field8930 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8930.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8930.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8930.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2740)
    public final synchronized boolean method3569() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8932.put(var1, this);
        if (var2 != null) {
            var2.field8931 = null;
        }
        this.field8931 = var1;
