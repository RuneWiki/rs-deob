...
public class OpenGL {
    ...
    private static Hashtable field8063 = new Hashtable();
    ...
    private Thread field8061;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8062;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 653)
    public final boolean method3210(String arg0) {
        if (this.field8062 == null) {
            this.field8062 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8062.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8062.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8062.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 843)
    public final synchronized boolean method3211() {
        if (this.field8061 == Thread.currentThread()) {
            this.detachPeer();
            field8063.remove(this.field8061);
            this.field8061 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1769)
    public final synchronized boolean method3212() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8063.put(var1, this);
        if (var2 != null) {
            var2.field8061 = null;
        }
        this.field8061 = var1;
