...
public class OpenGL {
   ...
   private static Hashtable field9420 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field9419;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "a",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field9421;
   ...
   public final synchronized boolean method4762() {
      if (this.field9419 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field9420.remove(this.field9419);
         this.field9419 = null;
         return true;
      }
   }
   ...
   public final synchronized boolean method4763() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field9420.put(var1, this);
         if (var2 != null) {
            var2.field9419 = null;
         }
   ...
   public final boolean method4764(String arg0) {
      if (this.field9421 == null) {
         this.field9421 = new Hashtable();
         ...
         while(true) {
            ...
            var3 = var4 - -1;
            if (var5.length() != 0) {
               this.field9421.put(var5, var5);
            }
         }
      }

      return this.field9421.containsKey(arg0);
   }
