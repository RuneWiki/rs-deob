...
public class OpenGL {
    ...
    private static Hashtable field8730 = new Hashtable();
    ...
    private Thread field8729;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8728;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1743)
    public final boolean method3496(String arg0) {
        if (this.field8728 == null) {
            this.field8728 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8728.put(var5, var5);
                }
            }
        }
        return this.field8728.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2407)
    public final synchronized boolean method3497() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8730.put(var1, this);
        if (var2 != null) {
            var2.field8729 = null;
        }
        this.field8729 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2504)
    public final synchronized boolean method3498() {
        if (this.field8729 == Thread.currentThread()) {
            this.detachPeer();
            field8730.remove(this.field8729);
            this.field8729 = null;
            return true;
        } else {
            return false;
