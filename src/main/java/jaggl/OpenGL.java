...
public class OpenGL {
    ...
    public Hashtable field1;

    @ObfuscatedName("jaggl/OpenGL.n")
    public Thread field2;

    @ObfuscatedName("jaggl/OpenGL.m")
    public static Hashtable field3 = new Hashtable();

    @ObfuscatedName("jaggl/OpenGL.e(Ljava/lang/String;)Z")
    public boolean method1(String arg0) {
        if (this.field1 == null) {
            this.field1 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var5.length() != 0) {
                        this.field1.put(var5, var5);
                    }
                    break;
                }
                String var6 = var2.substring(var3, var4).trim();
                if (var6.length() != 0) {
                    this.field1.put(var6, var6);
                }
                var3 = var4 + 1;
            }
        }
        return this.field1.containsKey(arg0);
    }
    ...
    public synchronized boolean method2() {
        ...
        OpenGL var2 = (OpenGL) field3.put(var1, this);
        if (var2 != null) {
            var2.field2 = null;
        }
        this.field2 = var1;
    ...
    public synchronized boolean method3() {
        if (this.field2 == Thread.currentThread()) {
            this.detachPeer();
            field3.remove(this.field2);
            this.field2 = null;
            return true;
        } else {
            return false;
