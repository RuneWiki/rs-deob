...
public class OpenGL {
    ...
    private static Hashtable field454 = new Hashtable();
    ...
    private Thread field452;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field453;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 45)
    public final synchronized boolean method278() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field454.put(var1, this);
        if (var2 != null) {
            var2.field452 = null;
        }
        this.field452 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 456)
    public final boolean method279(String arg0) {
        if (this.field453 == null) {
            this.field453 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field453.put(var5, var5);
                }
            }
        }
        return this.field453.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2658)
    public final synchronized boolean method280() {
        if (this.field452 == Thread.currentThread()) {
            this.detachPeer();
            field454.remove(this.field452);
            this.field452 = null;
            return true;
        } else {
            return false;
