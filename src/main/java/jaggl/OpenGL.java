...
public class OpenGL {
    ...
    private static Hashtable field7454 = new Hashtable();
    ...
    private Thread field7453;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7452;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 358)
    public final synchronized boolean method3022() {
        if (this.field7453 == Thread.currentThread()) {
            this.detachPeer();
            field7454.remove(this.field7453);
            this.field7453 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1612)
    public final boolean method3023(String arg0) {
        if (this.field7452 == null) {
            this.field7452 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field7452.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field7452.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field7452.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2247)
    public final synchronized boolean method3024() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7454.put(var1, this);
        if (var2 != null) {
            var2.field7453 = null;
        }
        this.field7453 = var1;
