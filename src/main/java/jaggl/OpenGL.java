...
public class OpenGL {
    ...
    private static Hashtable field6944 = new Hashtable();
    ...
    private Thread field6945;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6946;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1419)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6946 == null) {
            this.field6946 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6946.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6946.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6946.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2372)
    public synchronized boolean detach() {
        if (this.field6945 == Thread.currentThread()) {
            this.detachPeer();
            field6944.remove(this.field6945);
            this.field6945 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2616)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6944.put(var1, this);
        if (var2 != null) {
            var2.field6945 = null;
        }
        this.field6945 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2834)
    public static OpenGL getCurrent() {
        return (OpenGL) field6944.get(Thread.currentThread());
    }
