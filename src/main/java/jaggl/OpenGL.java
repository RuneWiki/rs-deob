...
public class OpenGL {
    ...
    private static Hashtable field8002 = new Hashtable();
    ...
    private Thread field8000;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8001;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1604)
    public final boolean method3275(String arg0) {
        if (this.field8001 == null) {
            this.field8001 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8001.put(var5, var5);
                }
            }
        }
        return this.field8001.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2301)
    public final synchronized boolean method3276() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8002.put(var1, this);
        if (var2 != null) {
            var2.field8000 = null;
        }
        this.field8000 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2861)
    public final synchronized boolean method3277() {
        if (this.field8000 == Thread.currentThread()) {
            this.detachPeer();
            field8002.remove(this.field8000);
            this.field8000 = null;
            return true;
        } else {
            return false;
