...
public class OpenGL {
    ...
    private static Hashtable field6498 = new Hashtable();
    ...
    private Thread field6497;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6496;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 779)
    public synchronized boolean detach() {
        if (this.field6497 == Thread.currentThread()) {
            this.detachPeer();
            field6498.remove(this.field6497);
            this.field6497 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 1009)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6498.put(var1, this);
        if (var2 != null) {
            var2.field6497 = null;
        }
        this.field6497 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1853)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6496 == null) {
            this.field6496 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6496.put(var5, var5);
                }
            }
        }
        return this.field6496.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2347)
    public static OpenGL getCurrent() {
        return (OpenGL) field6498.get(Thread.currentThread());
    }
