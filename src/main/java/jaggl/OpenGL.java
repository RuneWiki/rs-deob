...
public class OpenGL {
    ...
    private static Hashtable field9087 = new Hashtable();
    ...
    private Thread field9085;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9086;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 103)
    public final synchronized boolean method3723() {
        if (this.field9085 == Thread.currentThread()) {
            this.detachPeer();
            field9087.remove(this.field9085);
            this.field9085 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 583)
    public final boolean method3724(String arg0) {
        if (this.field9086 == null) {
            this.field9086 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field9086.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field9086.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field9086.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 730)
    public final synchronized boolean method3725() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9087.put(var1, this);
        if (var2 != null) {
            var2.field9085 = null;
        }
        this.field9085 = var1;
