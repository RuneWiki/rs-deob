...
public class OpenGL {
    ...
    private static Hashtable field318 = new Hashtable();
    ...
    private Thread field319;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field320;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1397)
    public final boolean method223(String arg0) {
        if (this.field320 == null) {
            this.field320 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field320.put(var5, var5);
                }
            }
        }
        return this.field320.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2420)
    public final synchronized boolean method224() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field318.put(var1, this);
        if (var2 != null) {
            var2.field319 = null;
        }
        this.field319 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2569)
    public final synchronized boolean method225() {
        if (this.field319 == Thread.currentThread()) {
            this.detachPeer();
            field318.remove(this.field319);
            this.field319 = null;
            return true;
        } else {
            return false;
