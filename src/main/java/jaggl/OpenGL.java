...
public class OpenGL {
    ...
    private static Hashtable field8138 = new Hashtable();
    ...
    private Thread field8136;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8137;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1856)
    public final synchronized boolean method3277() {
        if (this.field8136 == Thread.currentThread()) {
            this.detachPeer();
            field8138.remove(this.field8136);
            this.field8136 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2019)
    public final synchronized boolean method3278() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8138.put(var1, this);
        if (var2 != null) {
            var2.field8136 = null;
        }
        this.field8136 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2182)
    public final boolean method3279(String arg0) {
        if (this.field8137 == null) {
            this.field8137 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8137.put(var5, var5);
                }
            }
        }
        return this.field8137.containsKey(arg0);
    }
