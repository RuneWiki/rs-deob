...
public class OpenGL {
    ...
    private static Hashtable field8612 = new Hashtable();
    ...
    private Thread field8611;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8613;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 549)
    public final boolean method3509(String arg0) {
        if (this.field8613 == null) {
            this.field8613 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8613.put(var5, var5);
                }
            }
        }
        return this.field8613.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1638)
    public final synchronized boolean method3510() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8612.put(var1, this);
        if (var2 != null) {
            var2.field8611 = null;
        }
        this.field8611 = var1;
    ...
    public final synchronized boolean method3511() {
        if (this.field8611 == Thread.currentThread()) {
            this.detachPeer();
            field8612.remove(this.field8611);
            this.field8611 = null;
            return true;
        } else {
            return false;
