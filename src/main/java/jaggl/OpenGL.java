...
public class OpenGL {
    ...
    private static Hashtable field301 = new Hashtable();
    ...
    private Thread field302;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field303;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 2238)
    public final synchronized boolean method233() {
        if (this.field302 == Thread.currentThread()) {
            this.detachPeer();
            field301.remove(this.field302);
            this.field302 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2451)
    public final synchronized boolean method234() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field301.put(var1, this);
        if (var2 != null) {
            var2.field302 = null;
        }
        this.field302 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2758)
    public final boolean method235(String arg0) {
        if (this.field303 == null) {
            this.field303 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field303.put(var5, var5);
                }
            }
        }
        return this.field303.containsKey(arg0);
    }
