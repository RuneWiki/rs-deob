...
public class OpenGL {
    ...
    private static Hashtable field8170 = new Hashtable();
    ...
    private Thread field8168;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8169;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 567)
    public final boolean method3303(String arg0) {
        if (this.field8169 == null) {
            this.field8169 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8169.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8169.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8169.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1500)
    public final synchronized boolean method3304() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8170.put(var1, this);
        if (var2 != null) {
            var2.field8168 = null;
        }
        this.field8168 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2509)
    public final synchronized boolean method3305() {
        if (this.field8168 == Thread.currentThread()) {
            this.detachPeer();
            field8170.remove(this.field8168);
            this.field8168 = null;
            return true;
        } else {
            return false;
