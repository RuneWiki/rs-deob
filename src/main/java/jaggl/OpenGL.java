...
public class OpenGL {
    ...
    private static Hashtable field6558 = new Hashtable();
    ...
    private Thread field6560;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6559;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 652)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6558.put(var1, this);
        if (var2 != null) {
            var2.field6560 = null;
        }
        this.field6560 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1777)
    public static OpenGL getCurrent() {
        return (OpenGL) field6558.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 2333)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6559 == null) {
            this.field6559 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6559.put(var5, var5);
                }
            }
        }
        return this.field6559.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2819)
    public synchronized boolean detach() {
        if (this.field6560 == Thread.currentThread()) {
            this.detachPeer();
            field6558.remove(this.field6560);
            this.field6560 = null;
            return true;
        } else {
            return false;
