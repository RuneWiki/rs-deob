...
public class OpenGL {
    ...
    private static Hashtable field7763 = new Hashtable();
    ...
    private Thread field7765;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7764;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 485)
    public final synchronized boolean method3147() {
        if (this.field7765 == Thread.currentThread()) {
            this.detachPeer();
            field7763.remove(this.field7765);
            this.field7765 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1143)
    public final synchronized boolean method3148() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7763.put(var1, this);
        if (var2 != null) {
            var2.field7765 = null;
        }
        this.field7765 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2644)
    public final boolean method3149(String arg0) {
        if (this.field7764 == null) {
            this.field7764 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field7764.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field7764.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field7764.containsKey(arg0);
    }
