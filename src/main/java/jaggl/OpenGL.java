...
public class OpenGL {
    ...
    private static Hashtable field207 = new Hashtable();
    ...
    private Thread field205;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field206;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 461)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field206 == null) {
            this.field206 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field206.put(var5, var5);
                }
            }
        }
        return this.field206.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1185)
    public synchronized boolean detach() {
        if (this.field205 == Thread.currentThread()) {
            this.detachPeer();
            field207.remove(this.field205);
            this.field205 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2035)
    public static OpenGL getCurrent() {
        return (OpenGL) field207.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2205)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field207.put(var1, this);
        if (var2 != null) {
            var2.field205 = null;
        }
        this.field205 = var1;
