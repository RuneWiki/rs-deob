...
public class OpenGL {
    ...
    private static Hashtable field6320 = new Hashtable();
    ...
    private Thread field6319;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6321;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 669)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6320.put(var1, this);
        if (var2 != null) {
            var2.field6319 = null;
        }
        this.field6319 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1816)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6321 == null) {
            this.field6321 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field6321.put(var5, var5);
                }
            }
        }
        return this.field6321.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 2437)
    public synchronized boolean detach() {
        if (this.field6319 == Thread.currentThread()) {
            this.detachPeer();
            field6320.remove(this.field6319);
            this.field6319 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 2627)
    public static OpenGL getCurrent() {
        return (OpenGL) field6320.get(Thread.currentThread());
    }
