...
public class OpenGL {
    ...
    private static Hashtable field8883 = new Hashtable();
    ...
    private Thread field8885;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8884;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 933)
    public final synchronized boolean method3544() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8883.put(var1, this);
        if (var2 != null) {
            var2.field8885 = null;
        }
        this.field8885 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 1145)
    public final synchronized boolean method3545() {
        if (this.field8885 == Thread.currentThread()) {
            this.detachPeer();
            field8883.remove(this.field8885);
            this.field8885 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1543)
    public final boolean method3546(String arg0) {
        if (this.field8884 == null) {
            this.field8884 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8884.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8884.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8884.containsKey(arg0);
    }
