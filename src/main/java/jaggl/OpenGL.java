...
public class OpenGL {
    ...
    private static Hashtable field8160 = new Hashtable();
    ...
    private Thread field8158;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8159;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1204)
    public final synchronized boolean method3368() {
        if (this.field8158 == Thread.currentThread()) {
            this.detachPeer();
            field8160.remove(this.field8158);
            this.field8158 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2341)
    public final synchronized boolean method3369() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8160.put(var1, this);
        if (var2 != null) {
            var2.field8158 = null;
        }
        this.field8158 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 2752)
    public final boolean method3370(String arg0) {
        if (this.field8159 == null) {
            this.field8159 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field8159.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field8159.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field8159.containsKey(arg0);
    }
