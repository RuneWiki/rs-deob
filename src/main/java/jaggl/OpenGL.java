...
public class OpenGL {
   ...
   private static Hashtable field9573 = new Hashtable();
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "peer",
      descriptor = "J"
   ...
   private Thread field9574;
   @OriginalMember(
      owner = "client!jaggl/OpenGL",
      name = "b",
      descriptor = "Ljava/util/Hashtable;"
   )
   private Hashtable field9572;
   ...
   public final boolean method4790(String arg0) {
      if (this.field9572 == null) {
         this.field9572 = new Hashtable();
      ...
      return this.field9572.containsKey(arg0);
   }
   ...
   public final synchronized boolean method4791() {
      Thread var1 = Thread.currentThread();
      if (this.attachPeer()) {
         OpenGL var2 = (OpenGL)field9573.put(var1, this);
         if (var2 != null) {
            var2.field9574 = null;
         }
   ...
   public final synchronized boolean method4792() {
      if (this.field9574 != Thread.currentThread()) {
         return false;
      } else {
         this.detachPeer();
         field9573.remove(this.field9574);
         this.field9574 = null;
         return true;
      }
   }
