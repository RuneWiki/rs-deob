...
public class OpenGL {
    ...
    private static Hashtable field8536 = new Hashtable();
    ...
    private Thread field8534;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field8535;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 42)
    public final synchronized boolean method3387() {
        if (this.field8534 == Thread.currentThread()) {
            this.detachPeer();
            field8536.remove(this.field8534);
            this.field8534 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 719)
    public final boolean method3388(String arg0) {
        if (this.field8535 == null) {
            this.field8535 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field8535.put(var5, var5);
                }
            }
        }
        return this.field8535.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 896)
    public final synchronized boolean method3389() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field8536.put(var1, this);
        if (var2 != null) {
            var2.field8534 = null;
        }
        this.field8534 = var1;
