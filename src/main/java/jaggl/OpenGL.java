...
public class OpenGL {
    ...
    private static Hashtable field7667 = new Hashtable();
    ...
    private Thread field7666;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "c", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field7668;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 1268)
    public final synchronized boolean method3138() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field7667.put(var1, this);
        if (var2 != null) {
            var2.field7666 = null;
        }
        this.field7666 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 1934)
    public final boolean method3139(String arg0) {
        if (this.field7668 == null) {
            this.field7668 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field7668.put(var5, var5);
                }
            }
        }
        return this.field7668.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 2201)
    public final synchronized boolean method3140() {
        if (this.field7666 == Thread.currentThread()) {
            this.detachPeer();
            field7667.remove(this.field7666);
            this.field7666 = null;
            return true;
        } else {
            return false;
