...
public class OpenGL {
    ...
    private static Hashtable field6446 = new Hashtable();
    ...
    private Thread field6444;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field6445;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "detach", descriptor = "()Z", line = 1198)
    public synchronized boolean detach() {
        if (this.field6444 == Thread.currentThread()) {
            this.detachPeer();
            field6446.remove(this.field6444);
            this.field6444 = null;
            return true;
        } else {
            return false;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "getCurrent", descriptor = "()Ljaggl/OpenGL;", line = 1781)
    public static OpenGL getCurrent() {
        return (OpenGL) field6446.get(Thread.currentThread());
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "isExtensionAvailable", descriptor = "(Ljava/lang/String;)Z", line = 1840)
    public boolean isExtensionAvailable(String arg0) {
        if (this.field6445 == null) {
            this.field6445 = new Hashtable();
            ...
            while (true) {
                ...
                if (var4 == -1) {
                    ...
                    if (var6.length() != 0) {
                        this.field6445.put(var6, var6);
                    }
                    break;
                }
                String var5 = var2.substring(var3, var4).trim();
                if (var5.length() != 0) {
                    this.field6445.put(var5, var5);
                }
                var3 = var4 + 1;
            }
        }
        return this.field6445.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "attach", descriptor = "()Z", line = 2446)
    public synchronized boolean attach() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field6446.put(var1, this);
        if (var2 != null) {
            var2.field6444 = null;
        }
        this.field6444 = var1;
