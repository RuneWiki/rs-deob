...
public class OpenGL {
    ...
    private static Hashtable field9010 = new Hashtable();
    ...
    private Thread field9008;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "Ljava/util/Hashtable;")
    private Hashtable field9009;

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "(Ljava/lang/String;)Z", line = 357)
    public final boolean method3689(String arg0) {
        if (this.field9009 == null) {
            this.field9009 = new Hashtable();
            ...
            while (true) {
                ...
                var3 = var4 + 1;
                if (var5.length() != 0) {
                    this.field9009.put(var5, var5);
                }
            }
        }
        return this.field9009.containsKey(arg0);
    }

    @OriginalMember(owner = "client!jaggl/OpenGL", name = "a", descriptor = "()Z", line = 538)
    public final synchronized boolean method3690() {
        Thread var1 = Thread.currentThread();
        if (!this.attachPeer()) {
            return false;
        }
        OpenGL var2 = (OpenGL) field9010.put(var1, this);
        if (var2 != null) {
            var2.field9008 = null;
        }
        this.field9008 = var1;
    ...
    @OriginalMember(owner = "client!jaggl/OpenGL", name = "b", descriptor = "()Z", line = 646)
    public final synchronized boolean method3691() {
        if (this.field9008 == Thread.currentThread()) {
            this.detachPeer();
            field9010.remove(this.field9008);
            this.field9008 = null;
            return true;
        } else {
            return false;
