...
public abstract class class98 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(BLf;)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lis;I)V")
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(BILvo;Ljava/awt/Canvas;ILfa;)Lr;")
