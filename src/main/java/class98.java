...
public class class98 extends class11 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BI)Llj;")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ILeh;I)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lno;II)V")
