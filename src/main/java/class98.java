...
public class class98 extends class354 {
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 136)
    public class98() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IFFFI)F", line = 25)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILti;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IB)[I", line = 139)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "([[ILjava/util/Random;IIIII)V", line = 391)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 595)
