...
public class class98 {
    ...
    @OriginalMember(owner = "client!ln", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ln", name = "movemouse", descriptor = "(II)V", line = 22)
    public final void movemouse(int arg0, int arg1) {
        this.field1057.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!ln", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V", line = 31)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "()V", line = 59)
