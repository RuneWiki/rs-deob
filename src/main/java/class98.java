...
public class class98 extends class297 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "([Lat;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(II)[I", line = 73)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "()V", line = 85)
    public class98() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 94)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IZI)Z", line = 121)
