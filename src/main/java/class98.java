...
public class class98 implements class622 {
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIILio;)V", line = 17)
    public final void method798(int arg0, int arg1, int arg2, class708 arg3) {
        field1441++;
        this.method810(arg0, arg2, arg1, arg3, (byte) -103);
    }

    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ju", name = "e", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!ju", name = "f", descriptor = "(I)I", line = 113)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILqca;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IILwo;I)V", line = 176)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)V", line = 209)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(II)V", line = 231)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lrs;)V", line = 357)
    ...
    @OriginalMember(owner = "client!ju", name = "finalize", descriptor = "()V", line = 251)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIILio;B)V", line = 267)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)Z", line = 313)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(BI)V", line = 337)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lwo;ZI)V", line = 371)
