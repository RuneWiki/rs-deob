...
public class class98 extends class142 implements class722 {
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BLha;)Loia;")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ILha;BI)Z")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lmg;B)V")
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Lgg;BZILha;II)V")
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(Lha;I)Lbd;")
