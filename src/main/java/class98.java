...
public class class98 {
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(Ljava/lang/String;IIZ)Z", line = 8)
    ...
    @OriginalMember(owner = "client!eha", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!eha", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 103)
