...
public class class98 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BLq;Lq;I)Lss;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILq;IZLq;)Lss;")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lii;Lls;)V")
