...
public class class98 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(CI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lfd;I)V", line = 68)
