...
public abstract class class98 extends class27 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILir;ZILr;IB)V")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([Lqea;B)I")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(ILr;I)Z")
