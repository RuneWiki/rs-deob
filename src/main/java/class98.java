...
public class class98 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLea;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILka;IZII)Lka;", line = 159)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 297)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILol;)V", line = 311)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLol;I)V", line = 336)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(III)B", line = 539)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IIIBLka;III)Lka;", line = 554)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)V", line = 622)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)V", line = 638)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZB)V", line = 673)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZIZI)I", line = 736)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 918)
