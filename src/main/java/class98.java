...
public class class98 extends class45 {
    ...
    @OriginalMember(owner = "client!pj", name = "f", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lcu;II)V", line = 20)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)[I", line = 89)
