...
public class class98 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(B)V", line = 50)
