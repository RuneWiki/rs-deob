...
public class class98 extends class11 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILjn;IB)J", line = 3)
    ...
    @OriginalMember(owner = "client!ct", name = "f", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)[[I", line = 56)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lsi;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "()V", line = 165)
    public class98() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(BII)Z", line = 169)
    ...
    @OriginalMember(owner = "client!ct", name = "c", descriptor = "(Z)V", line = 186)
    ...
    @OriginalMember(owner = "client!ct", name = "d", descriptor = "(II)[I", line = 210)
