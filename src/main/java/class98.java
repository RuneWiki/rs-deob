...
public class class98 extends class168 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)[B", line = 20)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)[B", line = 34)
