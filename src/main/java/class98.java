...
public class class98 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)Lww;")
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)Lrt;")
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(B)Lww;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILww;)V")
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(Z)Lww;")
