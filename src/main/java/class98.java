...
public class class98 extends class132 {
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 5)
    public class98(Object arg0, int arg1) {
        super(arg1);
        this.field1443 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(B)Z", line = 15)
    public final boolean method651(byte arg0) {
        int var2 = -18 / ((61 - arg0) / 38);
        return true;
    }

    @OriginalMember(owner = "client!qm", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 23)
