...
public class class98 extends class89 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(III)I", line = 18)
    ...
    @OriginalMember(owner = "client!ct", name = "f", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILfh;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lfh;II)V", line = 79)
