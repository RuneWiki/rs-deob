...
public class class98 extends class13 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZB[B)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILuo;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "()V", line = 471)
    public class98() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wp", name = "a", descriptor = "([[[BIIIIIILuo;IIBII)V", line = 474)
    ...
    @OriginalMember(owner = "client!wp", name = "d", descriptor = "(I)V", line = 510)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIIIIIII)V", line = 525)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZI)[I", line = 553)
