...
public class class98 extends class148 {
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 8)
    public class98() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILdh;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(II)I", line = 190)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)[I", line = 242)
