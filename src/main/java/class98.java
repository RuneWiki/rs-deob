...
public class class98 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lnp;JI)V", line = 6)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "([Leo;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIII)I", line = 126)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(JB)Lnp;", line = 168)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)V", line = 216)
