...
public class class98 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIF)F", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IF)I", line = 9)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(F)F", line = 74)
    private static final float method572(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lps;Lraa;)V", line = 79)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "()V", line = 152)
    public static void method574() {
        field1222 = null;
        field1223 = null;
    }

    @OriginalMember(owner = "client!og", name = "b", descriptor = "(IIF)F", line = 165)
