...
public class class98 extends class85 {
    ...
    @OriginalMember(owner = "client!kd", name = "U", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!kd", name = "hb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!kd", name = "mb", descriptor = "Lkf;")
    public static class100 field1986;

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Llf;ZLlf;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lbg;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BILja;)V")
