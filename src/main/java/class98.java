...
public class class98 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BLql;BII)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ILcd;[[B)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BLqa;)V")
