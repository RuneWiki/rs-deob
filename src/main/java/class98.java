...
public class class98 implements class508 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lkaa;Z)V")
