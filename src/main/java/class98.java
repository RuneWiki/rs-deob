...
public class class98 extends class355 {
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljj;IIIII[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljj;IIIZ[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!og", name = "f", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljj;IIIIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljj;IIIIIIZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljj;IIII[I)V", line = 91)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Ljj;IIIIZ[BI)V", line = 110)
