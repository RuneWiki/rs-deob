...
public class class98 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)Z", line = 19)
    ...
    @OriginalMember(owner = "client!qfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 45)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(II[B)[B", line = 66)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(II)Z", line = 79)
