...
public class class98 extends class415 {
    ...
    @OriginalMember(owner = "client!pj", name = "YA", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!pj", name = "ma", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!pj", name = "Q", descriptor = "(IIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!pj", name = "na", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III[I)V", line = 94)
    ...
    @OriginalMember(owner = "client!pj", name = "X", descriptor = "([I)V", line = 100)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "()Lia;", line = 114)
    ...
    @OriginalMember(owner = "client!pj", name = "E", descriptor = "(III[I)V", line = 130)
    ...
    @OriginalMember(owner = "client!pj", name = "HA", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!pj", name = "R", descriptor = "(III)V", line = 139)
    ...
    @OriginalMember(owner = "client!pj", name = "ZA", descriptor = "(III)V", line = 147)
    ...
    @OriginalMember(owner = "client!pj", name = "ba", descriptor = "(Lia;)V", line = 160)
    ...
    @OriginalMember(owner = "client!pj", name = "O", descriptor = "(I)V", line = 179)
