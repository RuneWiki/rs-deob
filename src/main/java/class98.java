...
public class class98 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Ljava/lang/String;CB)I", line = 12)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ILfh;)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 70)
