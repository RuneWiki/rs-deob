...
public class class98 extends class329 implements class521 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Z)C", line = 12)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZIILr;Lbda;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(I)I", line = 81)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(I)J", line = 94)
    ...
    @OriginalMember(owner = "client!me", name = "i", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(B)I", line = 123)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(I)I", line = 137)
