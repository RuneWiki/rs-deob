...
public class class98 extends class455 implements class185 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IILqq;Z)Ldi;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lqq;Lin;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I[Ltq;I)V")
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(III)Ljk;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lqq;ZI)Lcd;")
    public final class198 method167(class318 arg0, boolean arg1, int arg2) {
        ++field1771;
        return arg1 ? null : this.method744(-117, arg2, arg0);
    }

    @OriginalMember(owner = "client!d", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IILqq;)Lcd;")
