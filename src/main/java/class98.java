...
public class class98 extends class445 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(ZLjava/lang/Object;I)[B", line = 17)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(BZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!ps", name = "c", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ps", name = "<init>", descriptor = "(Lnd;Lnd;Lufa;)V", line = 145)
    public class98(class547 arg0, class547 arg1, class682 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(IIIBI)V", line = 149)
    ...
    @OriginalMember(owner = "client!ps", name = "b", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!ps", name = "a", descriptor = "(I[BZ[BIIIII)V", line = 192)
