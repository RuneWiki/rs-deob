...
public class class98 extends class518 {
    ...
    @OriginalMember(owner = "client!wja", name = "f", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 89)
    ...
    @OriginalMember(owner = "client!wja", name = "g", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!wja", name = "<init>", descriptor = "()V", line = 156)
    public class98() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wja", name = "b", descriptor = "(II)[I", line = 160)
