...
public class class98 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Las;III[Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILjd;)V", line = 66)
