...
public class class98 extends class390 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IBZIILnf;Lja;)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIIZZ)Ldp;")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lbh;I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lja;II)Z")
