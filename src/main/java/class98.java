...
public abstract class class98 extends class406 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IBI)[I", line = 35)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "(I)I", line = 103)
    ...
    @OriginalMember(owner = "client!r", name = "c", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!r", name = "d", descriptor = "(B)I", line = 127)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILdg;I)V", line = 144)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(II)[I", line = 159)
    ...
    @OriginalMember(owner = "client!r", name = "b", descriptor = "(II)[[I", line = 170)
    ...
    @OriginalMember(owner = "client!r", name = "e", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IB)Z", line = 193)
    ...
    @OriginalMember(owner = "client!r", name = "<init>", descriptor = "(IZ)V", line = 258)
    public class98(int arg0, boolean arg1) {
        this.field1182 = new class98[arg0];
        this.field1176 = arg1;
    }

    @OriginalMember(owner = "client!r", name = "b", descriptor = "(IBI)[[I", line = 283)
