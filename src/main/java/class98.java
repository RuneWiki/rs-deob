...
public class class98 {
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IBLph;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "([BIIIIII[BI)V", line = 105)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(I[[ZZIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIILph;)Z", line = 337)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "([BIII[BIIBI)V", line = 406)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIII[BI)Z", line = 453)
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IIIII)V", line = 500)
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lic;Lto;)V", line = 537)
    ...
    @OriginalMember(owner = "client!vb", name = "b", descriptor = "(IIILph;)V", line = 554)
