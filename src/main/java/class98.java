...
public class class98 extends class316 {
    ...
    @OriginalMember(owner = "client!aja", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(BLmda;)V", line = 20)
    ...
    @OriginalMember(owner = "client!aja", name = "a", descriptor = "(ILso;)V", line = 38)
