...
public class class98 {
    ...
    @OriginalMember(owner = "client!wea", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field1214++;
        return "Cache:" + this.field1213;
    }

    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(ZILha;I)Lda;", line = 27)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(I[BZII)Z", line = 52)
    ...
    @OriginalMember(owner = "client!wea", name = "<init>", descriptor = "(ILee;Lee;I)V", line = 311)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "([BIII)Z", line = 178)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(IIC)I", line = 209)
    ...
    @OriginalMember(owner = "client!wea", name = "a", descriptor = "(II)[B", line = 229)
