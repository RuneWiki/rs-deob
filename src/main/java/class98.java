...
public class class98 extends class9 {
    ...
    @OriginalMember(owner = "client!oda", name = "c", descriptor = "(III)I", line = 11)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 226)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "([IIII)Z", line = 43)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lbk;I)I", line = 87)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I[III)Z", line = 120)
    ...
    @OriginalMember(owner = "client!oda", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Z[IIII)Z", line = 164)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ZII)Z", line = 247)
