...
public class class98 extends class355 {
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 4)
    public class98(Object arg0) {
        this.field1242 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!wp", name = "d", descriptor = "(B)Z", line = 14)
    public final boolean method494(byte arg0) {
        int var2 = 9 % ((10 - arg0) / 47);
        return true;
    }

    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 23)
