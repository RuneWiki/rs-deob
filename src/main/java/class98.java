...
public abstract class class98 extends class225 {
    ...
    @OriginalMember(owner = "client!ri", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BLii;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIIIZII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IZ)Ltl;", line = 147)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lii;Lnc;III)V", line = 174)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 220)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(Z)V", line = 295)
