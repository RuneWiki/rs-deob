...
public class class98 extends class86 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lts;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!d", name = "d", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILjava/lang/String;)V", line = 111)
