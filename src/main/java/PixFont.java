...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(ILjava/lang/String;ZLxb;)V")
    ...
    public void method208(int arg0, int arg1, int arg2, boolean arg3, int arg4, String arg5) {
        ...
        if (arg1 >= this.field687 && arg1 <= this.field687 && this.field697) {
            Draw2D.method159(arg4 - var7, var7, 8388608, true, (int) ((double) this.field695 * 0.7D) + var8);
        }
    }
    ...
    private void method211(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg3 > 0 && arg4 > 0) {
            this.method212(Draw2D.field620, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method213(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7) {
        ...
        int var9 = Draw2D.field621 * arg3 + arg1;
        int var10 = Draw2D.field621 - arg6;
        int var11 = 0;
        int var12 = 0;
        if (arg3 < Draw2D.field623) {
            int var13 = Draw2D.field623 - arg3;
            arg4 -= var13;
            arg3 = Draw2D.field623;
            var12 += arg6 * var13;
            var9 += Draw2D.field621 * var13;
        }
        if (arg3 + arg4 >= Draw2D.field624) {
            arg4 -= arg3 + arg4 + 1 - Draw2D.field624;
        }
        if (arg1 < Draw2D.field625) {
            int var14 = Draw2D.field625 - arg1;
            arg6 -= var14;
            arg1 = Draw2D.field625;
            var12 += var14;
            var9 += var14;
        ...
        if (arg1 + arg6 >= Draw2D.field626) {
            int var15 = arg1 + arg6 + 1 - Draw2D.field626;
            arg6 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg6 > 0 && arg4 > 0) {
            this.method214(var11, arg6, arg2, arg0, false, Draw2D.field620, var9, var12, var10, arg5, arg4);
        }
    }
