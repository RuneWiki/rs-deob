...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(BLyb;Ljava/lang/String;)V")
    ...
    private void method214(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field609 * arg2 + arg1;
        int var8 = Draw2D.field609 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field611) {
            int var11 = Draw2D.field611 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field611;
            var10 += arg3 * var11;
            var7 += Draw2D.field609 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field612) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field612;
        }
        if (arg1 < Draw2D.field613) {
            int var12 = Draw2D.field613 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field613;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field614) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field614;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method215(Draw2D.field608, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method216(int arg0, byte[] arg1, int arg2, byte arg3, int arg4, int arg5, int arg6, int arg7) {
        int var9 = Draw2D.field609 * arg2 + arg4;
        int var10 = Draw2D.field609 - arg5;
        int var11 = 0;
        int var12 = 0;
        if (arg2 < Draw2D.field611) {
            int var13 = Draw2D.field611 - arg2;
            arg6 -= var13;
            arg2 = Draw2D.field611;
            var12 += arg5 * var13;
            var9 += Draw2D.field609 * var13;
        }
        if (arg2 + arg6 >= Draw2D.field612) {
            arg6 -= arg2 + arg6 + 1 - Draw2D.field612;
        }
        if (arg4 < Draw2D.field613) {
            int var14 = Draw2D.field613 - arg4;
            arg5 -= var14;
            arg4 = Draw2D.field613;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg4 + arg5 >= Draw2D.field614) {
            int var15 = arg4 + arg5 + 1 - Draw2D.field614;
            arg5 -= var15;
            var11 += var15;
            var10 += var15;
        }
        ...
        this.method217(arg6, arg5, arg0, var12, var9, arg7, var10, var11, Draw2D.field608, true, arg1);
        if (arg3 != -73) {
