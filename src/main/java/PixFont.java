...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(ZLxb;ILjava/lang/String;)V")
    ...
    public void method210(int arg0, boolean arg1, int arg2, int arg3, int arg4, String arg5) {
        ...
        if (this.field692) {
            Draw2D.method160((int) ((double) this.field690 * 0.7D) + var8, var7, arg2 - var7, (byte) 6, 8388608);
        }
    }
    ...
    private void method213(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg3 > 0 && arg4 > 0) {
            this.method214(Draw2D.field620, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method215(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, byte[] arg7) {
        ...
        int var10 = Draw2D.field621 * arg5 + arg1;
        int var11 = Draw2D.field621 - arg2;
        int var12 = 0;
        int var13 = 0;
        if (arg5 < Draw2D.field623) {
            int var14 = Draw2D.field623 - arg5;
            arg6 -= var14;
            arg5 = Draw2D.field623;
            var13 += arg2 * var14;
            var10 += Draw2D.field621 * var14;
        }
        if (arg5 + arg6 >= Draw2D.field624) {
            arg6 -= arg5 + arg6 + 1 - Draw2D.field624;
        }
        if (arg1 < Draw2D.field625) {
            int var15 = Draw2D.field625 - arg1;
            arg2 -= var15;
            arg1 = Draw2D.field625;
            var13 += var15;
            var10 += var15;
        ...
        if (arg1 + arg2 >= Draw2D.field626) {
            int var16 = arg1 + arg2 + 1 - Draw2D.field626;
            arg2 -= var16;
            var12 += var16;
            var11 += var16;
        }
        if (arg2 > 0 && arg6 > 0) {
            this.method216(this.field682, var10, arg6, arg3, Draw2D.field620, var13, arg7, arg4, var12, var11, arg2);
        }
    }
