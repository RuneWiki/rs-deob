...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(IZLjava/lang/String;Lxb;)V")
    ...
    public void method210(String arg0, boolean arg1, int arg2, int arg3, boolean arg4, int arg5) {
        ...
        if (this.field704) {
            Draw2D.method160((int) ((double) this.field702 * 0.7D) + var9, 5, var8, 8388608, arg3 - var8);
        }
    }
    ...
    private void method215(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, byte[] arg6, byte arg7) {
        int var9 = Draw2D.field622 * arg4 + arg1;
        int var10 = Draw2D.field622 - arg0;
        int var11 = 0;
        int var12 = 0;
        if (arg4 < Draw2D.field624) {
            int var13 = Draw2D.field624 - arg4;
            arg5 -= var13;
            arg4 = Draw2D.field624;
            var12 += arg0 * var13;
            var9 += Draw2D.field622 * var13;
        }
        if (arg4 + arg5 >= Draw2D.field625) {
            arg5 -= arg4 + arg5 + 1 - Draw2D.field625;
        }
        if (arg1 < Draw2D.field626) {
            int var14 = Draw2D.field626 - arg1;
            arg0 -= var14;
            arg1 = Draw2D.field626;
            var12 += var14;
            var9 += var14;
        ...
        if (arg0 + arg1 >= Draw2D.field627) {
            int var15 = arg0 + arg1 + 1 - Draw2D.field627;
            arg0 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg0 > 0 && arg5 > 0) {
            this.method216(var11, Draw2D.field621, -487, arg2, arg5, arg0, var9, arg3, var10, arg6, var12);
            if (arg7 == 6) {
                boolean var16 = false;
            }
        }
