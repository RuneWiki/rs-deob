...
public class PixFont extends Draw2D {
    ...
    public void method210(int arg0, int arg1, boolean arg2, int arg3, String arg4, int arg5) {
        ...
        if (this.field700) {
            Draw2D.method160(var7, 8388608, (int) ((double) this.field698 * 0.7D) + var8, arg1 - var7, 1);
        }
    }
    ...
    private void method213(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg3 > 0 && arg4 > 0) {
            this.method214(Draw2D.field627, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method215(int arg0, int arg1, int arg2, int arg3, int arg4, byte[] arg5, int arg6, int arg7) {
        int var9 = Draw2D.field628 * arg1 + arg0;
        int var10 = Draw2D.field628 - arg2;
        int var11 = 0;
        int var12 = 0;
        if (arg1 < Draw2D.field630) {
            int var13 = Draw2D.field630 - arg1;
            arg4 -= var13;
            arg1 = Draw2D.field630;
            var12 += arg2 * var13;
            var9 += Draw2D.field628 * var13;
        }
        if (arg1 + arg4 >= Draw2D.field631) {
            arg4 -= arg1 + arg4 + 1 - Draw2D.field631;
        }
        ...
        if (arg0 + arg2 >= Draw2D.field633) {
            int var15 = arg0 + arg2 + 1 - Draw2D.field633;
            arg2 -= var15;
            var11 += var15;
            var10 += var15;
        }
        ...
        this.method216(arg5, arg6, 0, var12, arg2, var11, var9, Draw2D.field627, var10, arg7, arg4);
        if (arg3 <= 0) {
