...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Ljava/lang/String;BLyb;)V")
    ...
    public void method219(String arg0, int arg1, int arg2, boolean arg3, int arg4, int arg5) {
        ...
        if (this.field699) {
            Draw2D.method173((int) ((double) this.field697 * 0.7D) + var8, var7, arg2 - var7, 8388608, (byte) 59);
        }
    }
    ...
    private void method222(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field630 * arg2 + arg1;
        int var8 = Draw2D.field630 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field632) {
            int var11 = Draw2D.field632 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field632;
            var10 += arg3 * var11;
            var7 += Draw2D.field630 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field633) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field633;
        }
        if (arg1 < Draw2D.field634) {
            int var12 = Draw2D.field634 - arg1;
            arg3 -= var12;
        ...
        if (arg1 + arg3 >= Draw2D.field635) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field635;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method223(Draw2D.field629, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method224(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, byte[] arg6, int arg7) {
        ...
        int var9 = Draw2D.field630 * arg2 + arg1;
        int var10 = Draw2D.field630 - arg3;
        int var11 = 0;
        int var12 = 0;
        if (arg2 < Draw2D.field632) {
            int var13 = Draw2D.field632 - arg2;
            arg5 -= var13;
            arg2 = Draw2D.field632;
            var12 += arg3 * var13;
            var9 += Draw2D.field630 * var13;
        }
        if (arg2 + arg5 >= Draw2D.field633) {
            arg5 -= arg2 + arg5 + 1 - Draw2D.field633;
        }
        if (arg1 < Draw2D.field634) {
            int var14 = Draw2D.field634 - arg1;
            arg3 -= var14;
            arg1 = Draw2D.field634;
            var12 += var14;
            var9 += var14;
        ...
        if (arg1 + arg3 >= Draw2D.field635) {
            int var15 = arg1 + arg3 + 1 - Draw2D.field635;
            arg3 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg3 > 0 && arg5 > 0) {
            this.method225(var10, Draw2D.field629, arg3, var11, arg4, var12, arg7, var9, true, arg5, arg6);
        }
    }
