...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(ZLjava/lang/String;Lxb;I)V")
    ...
    public void method210(int arg0, int arg1, String arg2, int arg3, boolean arg4, byte arg5) {
        ...
        if (this.field701) {
            Draw2D.method160(8388608, 0, (int) ((double) this.field699 * 0.7D) + var8, arg1 - var7, var7);
        }
    }
    ...
    private void method213(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg3 > 0 && arg4 > 0) {
            this.method214(Draw2D.field621, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method215(int arg0, int arg1, byte[] arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        int var9 = Draw2D.field622 * arg3 + arg4;
        int var10 = Draw2D.field622 - arg0;
        int var11 = 0;
        int var12 = 0;
        if (arg3 < Draw2D.field624) {
            int var13 = Draw2D.field624 - arg3;
            arg7 -= var13;
            arg3 = Draw2D.field624;
            var12 += arg0 * var13;
            var9 += Draw2D.field622 * var13;
        }
        if (arg3 + arg7 >= Draw2D.field625) {
            arg7 -= arg3 + arg7 + 1 - Draw2D.field625;
        }
        if (arg4 < Draw2D.field626) {
            int var14 = Draw2D.field626 - arg4;
            arg0 -= var14;
            arg4 = Draw2D.field626;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg0 + arg4 >= Draw2D.field627) {
            int var15 = arg0 + arg4 + 1 - Draw2D.field627;
            arg0 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg0 > 0 && arg7 > 0) {
            this.method216(var9, var11, var12, arg1, (byte) 8, var10, arg7, Draw2D.field621, arg6, arg2, arg0);
        }
    }
