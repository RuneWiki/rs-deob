...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lxb;ZLjava/lang/String;B)V")
    ...
    public void method205(String arg0, int arg1, boolean arg2, int arg3, int arg4, int arg5) {
        ...
        if (arg1 > 0 && this.field696) {
            Draw2D.method159(arg4 - var7, 8388608, var7, (byte) 125, (int) ((double) this.field694 * 0.7D) + var8);
        }
    }
    ...
    private void method208(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field616 * arg2 + arg1;
        int var8 = Draw2D.field616 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field618) {
            int var11 = Draw2D.field618 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field618;
            var10 += arg3 * var11;
            var7 += Draw2D.field616 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field619) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field619;
        }
        if (arg1 < Draw2D.field620) {
            int var12 = Draw2D.field620 - arg1;
            arg3 -= var12;
        ...
        if (arg1 + arg3 >= Draw2D.field621) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field621;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method209(Draw2D.field615, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method210(int arg0, byte[] arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6, int arg7) {
        int var9 = Draw2D.field616 * arg0 + arg2;
        int var10 = Draw2D.field616 - arg7;
        int var11 = 0;
        int var12 = 0;
        if (arg0 < Draw2D.field618) {
            int var13 = Draw2D.field618 - arg0;
            arg4 -= var13;
            arg0 = Draw2D.field618;
            var12 += arg7 * var13;
            var9 += Draw2D.field616 * var13;
        }
        if (arg0 + arg4 >= Draw2D.field619) {
            arg4 -= arg0 + arg4 + 1 - Draw2D.field619;
        }
        if (arg2 < Draw2D.field620) {
            int var14 = Draw2D.field620 - arg2;
            arg7 -= var14;
        ...
        if (arg2 + arg7 >= Draw2D.field621) {
            int var15 = arg2 + arg7 + 1 - Draw2D.field621;
            arg7 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg7 > 0 && arg4 > 0) {
            this.method211(arg4, arg1, arg3, arg7, var11, arg6, var9, Draw2D.field615, -701, var12, var10);
            if (!arg5) {
                ;
            }
        }
