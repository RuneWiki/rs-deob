...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lxb;ILjava/lang/String;Z)V")
    ...
    public void method205(String arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        ...
        if (this.field687) {
            Draw2D.method159(3, var7, 8388608, (int) ((double) this.field685 * 0.7D) + var8, arg4 - var7);
        }
    }
    ...
    private void method208(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field615 * arg2 + arg1;
        int var8 = Draw2D.field615 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field617) {
            int var11 = Draw2D.field617 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field617;
            var10 += arg3 * var11;
            var7 += Draw2D.field615 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field618) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field618;
        }
        if (arg1 < Draw2D.field619) {
            int var12 = Draw2D.field619 - arg1;
            arg3 -= var12;
        ...
        if (arg1 + arg3 >= Draw2D.field620) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field620;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method209(Draw2D.field614, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method210(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        int var9 = Draw2D.field615 * arg2 + arg3;
        int var10 = Draw2D.field615 - arg5;
        int var11 = 0;
        int var12 = 0;
        if (arg2 < Draw2D.field617) {
            int var13 = Draw2D.field617 - arg2;
            arg6 -= var13;
            arg2 = Draw2D.field617;
            var12 += arg5 * var13;
            var9 += Draw2D.field615 * var13;
        }
        if (arg2 + arg6 >= Draw2D.field618) {
            arg6 -= arg2 + arg6 + 1 - Draw2D.field618;
        }
        if (arg3 < Draw2D.field619) {
            int var14 = Draw2D.field619 - arg3;
            arg5 -= var14;
            arg3 = Draw2D.field619;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg3 + arg5 >= Draw2D.field620) {
            int var15 = arg3 + arg5 + 1 - Draw2D.field620;
            arg5 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg5 > 0 && arg6 > 0) {
            this.method211(var10, var12, arg5, this.field678, Draw2D.field614, var11, arg6, arg4, arg7, arg0, var9);
        }
    }
