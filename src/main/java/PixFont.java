...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lyb;Ljava/lang/String;B)V")
    ...
    public void method219(int arg0, int arg1, boolean arg2, String arg3, int arg4, int arg5) {
        ...
        if (this.field703) {
            Draw2D.method173(8388608, (int) ((double) this.field701 * 0.7D) + var8, -25370, arg5 - var7, var7);
        }
    }
    ...
    private void method222(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field628 * arg2 + arg1;
        int var8 = Draw2D.field628 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field630) {
            int var11 = Draw2D.field630 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field630;
            var10 += arg3 * var11;
            var7 += Draw2D.field628 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field631) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field631;
        }
        if (arg1 < Draw2D.field632) {
            int var12 = Draw2D.field632 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field632;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field633) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field633;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method223(Draw2D.field627, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method224(int arg0, int arg1, int arg2, int arg3, byte[] arg4, byte arg5, int arg6, int arg7) {
        int var9 = Draw2D.field628 * arg3 + arg0;
        int var10 = Draw2D.field628 - arg1;
        int var11 = 0;
        int var12 = 0;
        if (arg5 != 62) {
            this.field693 = -234;
        }
        if (arg3 < Draw2D.field630) {
            int var13 = Draw2D.field630 - arg3;
            arg6 -= var13;
            arg3 = Draw2D.field630;
            var12 += arg1 * var13;
            var9 += Draw2D.field628 * var13;
        }
        if (arg3 + arg6 >= Draw2D.field631) {
            arg6 -= arg3 + arg6 + 1 - Draw2D.field631;
        }
        if (arg0 < Draw2D.field632) {
            int var14 = Draw2D.field632 - arg0;
            arg1 -= var14;
            arg0 = Draw2D.field632;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg0 + arg1 >= Draw2D.field633) {
            int var15 = arg0 + arg1 + 1 - Draw2D.field633;
            arg1 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg1 > 0 && arg6 > 0) {
            this.method225(arg2, arg4, Draw2D.field627, var12, arg1, true, arg7, arg6, var11, var10, var9);
        }
    }
