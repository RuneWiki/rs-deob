...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lxb;ZLjava/lang/String;I)V")
    ...
    public void method210(int arg0, int arg1, String arg2, boolean arg3, byte arg4, int arg5) {
        ...
        if (this.field700) {
            Draw2D.method160(8388608, arg0 - var7, false, var7, (int) ((double) this.field698 * 0.7D) + var8);
        }
    }
    ...
    private void method213(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field620 * arg2 + arg1;
        int var8 = Draw2D.field620 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field622) {
            int var11 = Draw2D.field622 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field622;
            var10 += arg3 * var11;
            var7 += Draw2D.field620 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field623) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field623;
        }
        if (arg1 < Draw2D.field624) {
            int var12 = Draw2D.field624 - arg1;
            arg3 -= var12;
        ...
        if (arg1 + arg3 >= Draw2D.field625) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field625;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method214(Draw2D.field619, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method215(int arg0, int arg1, int arg2, int arg3, byte arg4, byte[] arg5, int arg6, int arg7) {
        int var9 = Draw2D.field620 * arg3 + arg6;
        int var10 = Draw2D.field620 - arg7;
        int var11 = 0;
        int var12 = 0;
        if (arg4 == 0) {
            boolean var13 = false;
        ...
        if (arg3 < Draw2D.field622) {
            int var14 = Draw2D.field622 - arg3;
            arg1 -= var14;
            arg3 = Draw2D.field622;
            var12 += arg7 * var14;
            var9 += Draw2D.field620 * var14;
        }
        if (arg1 + arg3 >= Draw2D.field623) {
            arg1 -= arg1 + arg3 + 1 - Draw2D.field623;
        }
        if (arg6 < Draw2D.field624) {
            int var15 = Draw2D.field624 - arg6;
            arg7 -= var15;
            arg6 = Draw2D.field624;
            var12 += var15;
            var9 += var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg6 + arg7 >= Draw2D.field625) {
            int var16 = arg6 + arg7 + 1 - Draw2D.field625;
            arg7 -= var16;
            var11 += var16;
            var10 += var16;
        }
        if (arg7 > 0 && arg1 > 0) {
            this.method216(arg7, arg5, arg1, var11, Draw2D.field619, arg2, var12, arg0, true, var9, var10);
        }
    }
