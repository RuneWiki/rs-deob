...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lub;Ljava/lang/String;I)V")
    ...
    private void method199(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field534 * arg2 + arg1;
        int var8 = Draw2D.field534 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field536) {
            int var11 = Draw2D.field536 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field536;
            var10 += arg3 * var11;
            var7 += Draw2D.field534 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field537) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field537;
        }
        if (arg1 < Draw2D.field538) {
            int var12 = Draw2D.field538 - arg1;
            arg3 -= var12;
        ...
        if (arg1 + arg3 >= Draw2D.field539) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field539;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method200(Draw2D.field533, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method201(byte[] arg0, byte arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        int var9 = Draw2D.field534 * arg5 + arg2;
        int var10 = Draw2D.field534 - arg7;
        int var11 = 0;
        int var12 = 0;
        if (arg5 < Draw2D.field536) {
            int var13 = Draw2D.field536 - arg5;
            arg3 -= var13;
            arg5 = Draw2D.field536;
            var12 += arg7 * var13;
            var9 += Draw2D.field534 * var13;
        }
        if (arg3 + arg5 >= Draw2D.field537) {
            arg3 -= arg3 + arg5 + 1 - Draw2D.field537;
        }
        if (arg2 < Draw2D.field538) {
            int var14 = Draw2D.field538 - arg2;
            arg7 -= var14;
        ...
        if (arg2 + arg7 >= Draw2D.field539) {
            int var15 = arg2 + arg7 + 1 - Draw2D.field539;
            arg7 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg7 > 0 && arg3 > 0) {
            this.method202(arg3, var9, arg7, Draw2D.field533, arg0, arg6, var12, var10, var11, (byte) 2, arg4);
        }
    }
