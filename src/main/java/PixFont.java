...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lub;ILjava/lang/String;)V")
    ...
    private void method199(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field545 * arg2 + arg1;
        int var8 = Draw2D.field545 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field547) {
            int var11 = Draw2D.field547 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field547;
            var10 += arg3 * var11;
            var7 += Draw2D.field545 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field548) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field548;
        }
        if (arg1 < Draw2D.field549) {
            int var12 = Draw2D.field549 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field549;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field550) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field550;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method200(Draw2D.field544, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method201(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, byte[] arg7) {
        int var9 = Draw2D.field545 * arg1 + arg4;
        int var10 = Draw2D.field545 - arg2;
        int var11 = 0;
        int var12 = 0;
        if (arg3 != 3181) {
            return;
        }
        if (arg1 < Draw2D.field547) {
            int var13 = Draw2D.field547 - arg1;
            arg6 -= var13;
            arg1 = Draw2D.field547;
            var12 += arg2 * var13;
            var9 += Draw2D.field545 * var13;
        }
        if (arg1 + arg6 >= Draw2D.field548) {
            arg6 -= arg1 + arg6 + 1 - Draw2D.field548;
        }
        if (arg4 < Draw2D.field549) {
            int var14 = Draw2D.field549 - arg4;
            arg2 -= var14;
            arg4 = Draw2D.field549;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg2 + arg4 >= Draw2D.field550) {
            int var15 = arg2 + arg4 + 1 - Draw2D.field550;
            arg2 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg2 > 0 && arg6 > 0) {
            this.method202(arg2, var11, arg5, var10, arg6, var12, Draw2D.field544, var9, true, arg7, arg0);
        }
    }
