...
public class PixFont extends Draw2D {
    ...
    public void method206(int arg0, int arg1, int arg2, boolean arg3, int arg4, String arg5) {
        ...
        if (this.field693) {
            Draw2D.method159((int) ((double) this.field691 * 0.7D) + var8, 8388608, arg2 - var7, 0, var7);
        }
    }
    ...
    private void method209(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field621 * arg2 + arg1;
        int var8 = Draw2D.field621 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field623) {
            int var11 = Draw2D.field623 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field623;
            var10 += arg3 * var11;
            var7 += Draw2D.field621 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field624) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field624;
        }
        if (arg1 < Draw2D.field625) {
            int var12 = Draw2D.field625 - arg1;
            arg3 -= var12;
        ...
        if (arg1 + arg3 >= Draw2D.field626) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field626;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method210(Draw2D.field620, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method211(int arg0, int arg1, boolean arg2, int arg3, int arg4, int arg5, byte[] arg6, int arg7) {
        ...
        int var9 = Draw2D.field621 * arg4 + arg5;
        int var10 = Draw2D.field621 - arg3;
        int var11 = 0;
        int var12 = 0;
        if (arg4 < Draw2D.field623) {
            int var13 = Draw2D.field623 - arg4;
            arg1 -= var13;
            arg4 = Draw2D.field623;
            var12 += arg3 * var13;
            var9 += Draw2D.field621 * var13;
        }
        if (arg1 + arg4 >= Draw2D.field624) {
            arg1 -= arg1 + arg4 + 1 - Draw2D.field624;
        }
        if (arg5 < Draw2D.field625) {
            int var14 = Draw2D.field625 - arg5;
            arg3 -= var14;
            arg5 = Draw2D.field625;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg3 + arg5 >= Draw2D.field626) {
            int var15 = arg3 + arg5 + 1 - Draw2D.field626;
            arg3 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg3 > 0 && arg1 > 0) {
            this.method212(arg1, arg7, arg3, var11, var9, arg6, (byte) 9, Draw2D.field620, arg0, var12, var10);
        }
    }
