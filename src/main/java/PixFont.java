...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(ZLub;Ljava/lang/String;)V")
    ...
    private void method188(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field523 * arg2 + arg1;
        int var8 = Draw2D.field523 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field525) {
            int var11 = Draw2D.field525 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field525;
            var10 += arg3 * var11;
            var7 += Draw2D.field523 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field526) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field526;
        }
        if (arg1 < Draw2D.field527) {
            int var12 = Draw2D.field527 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field527;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field528) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field528;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method189(Draw2D.field522, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
