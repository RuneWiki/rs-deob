...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Ljava/lang/String;Lyb;Z)V")
    ...
    public void method219(boolean arg0, String arg1, int arg2, byte arg3, int arg4, int arg5) {
        ...
        if (this.field696) {
            Draw2D.method173(var7, (int) ((double) this.field694 * 0.7D) + var8, 4, 8388608, arg5 - var7);
        }
    }
    ...
    private void method222(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field624 * arg2 + arg1;
        int var8 = Draw2D.field624 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field626) {
            int var11 = Draw2D.field626 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field626;
            var10 += arg3 * var11;
            var7 += Draw2D.field624 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field627) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field627;
        }
        if (arg1 < Draw2D.field628) {
            int var12 = Draw2D.field628 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field628;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field629) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field629;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method223(Draw2D.field623, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method224(int arg0, int arg1, int arg2, int arg3, int arg4, byte[] arg5, int arg6, int arg7) {
        ...
        int var9 = Draw2D.field624 * arg1 + arg7;
        int var10 = Draw2D.field624 - arg4;
        int var11 = 0;
        int var12 = 0;
        if (arg1 < Draw2D.field626) {
            int var13 = Draw2D.field626 - arg1;
            arg0 -= var13;
            arg1 = Draw2D.field626;
            var12 += arg4 * var13;
            var9 += Draw2D.field624 * var13;
        }
        if (arg0 + arg1 >= Draw2D.field627) {
            arg0 -= arg0 + arg1 + 1 - Draw2D.field627;
        }
        if (arg7 < Draw2D.field628) {
            int var14 = Draw2D.field628 - arg7;
            arg4 -= var14;
            arg7 = Draw2D.field628;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg4 + arg7 >= Draw2D.field629) {
            int var15 = arg4 + arg7 + 1 - Draw2D.field629;
            arg4 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg4 > 0 && arg0 > 0) {
            this.method225(arg2, Draw2D.field623, arg4, arg3, 32727, var11, arg5, var12, var10, arg0, var9);
        }
    }
