...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Ljava/lang/String;Lyb;B)V")
    ...
    public void method218(int arg0, int arg1, int arg2, boolean arg3, boolean arg4, String arg5) {
        ...
        if (this.field702) {
            Draw2D.method172((int) ((double) this.field700 * 0.7D) + var8, arg1 - var7, var7, 0, 8388608);
        }
    }
    ...
    private void method221(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field631 * arg2 + arg1;
        int var8 = Draw2D.field631 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field633) {
            int var11 = Draw2D.field633 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field633;
            var10 += arg3 * var11;
            var7 += Draw2D.field631 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field634) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field634;
        }
        if (arg1 < Draw2D.field635) {
            int var12 = Draw2D.field635 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field635;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field636) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field636;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method222(Draw2D.field630, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method223(int arg0, int arg1, int arg2, int arg3, byte[] arg4, int arg5, int arg6, int arg7) {
        int var9 = Draw2D.field631 * arg1 + arg0;
        int var10 = Draw2D.field631 - arg6;
        int var11 = 0;
        int var12 = 0;
        if (arg1 < Draw2D.field633) {
            int var13 = Draw2D.field633 - arg1;
            arg7 -= var13;
            arg1 = Draw2D.field633;
            var12 += arg6 * var13;
            var9 += Draw2D.field631 * var13;
        }
        if (arg1 + arg7 >= Draw2D.field634) {
            arg7 -= arg1 + arg7 + 1 - Draw2D.field634;
        }
        if (arg0 < Draw2D.field635) {
            int var14 = Draw2D.field635 - arg0;
            arg6 -= var14;
            arg0 = Draw2D.field635;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg0 + arg6 >= Draw2D.field636) {
            int var15 = arg0 + arg6 + 1 - Draw2D.field636;
            arg6 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg6 > 0 && arg7 > 0) {
            this.method224(arg6, var12, Draw2D.field630, arg4, var9, var11, var10, false, arg5, arg7, arg3);
            if (arg2 < 0) {
                ;
            }
        }
