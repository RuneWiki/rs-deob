...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lyb;Ljava/lang/String;)V")
    ...
    public void method205(int arg0, int arg1, String arg2, int arg3, boolean arg4, int arg5) {
        ...
        if (this.field694) {
            Draw2D.method159(8388608, arg3 - var7, var7, (int) ((double) this.field692 * 0.7D) + var8, (byte) 2);
        }
    }
    ...
    private void method208(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field622 * arg2 + arg1;
        int var8 = Draw2D.field622 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field624) {
            int var11 = Draw2D.field624 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field624;
            var10 += arg3 * var11;
            var7 += Draw2D.field622 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field625) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field625;
        }
        if (arg1 < Draw2D.field626) {
            int var12 = Draw2D.field626 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field626;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field627) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field627;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method209(Draw2D.field621, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method210(int arg0, byte[] arg1, int arg2, int arg3, int arg4, int arg5, int arg6, boolean arg7) {
        ...
        int var10 = Draw2D.field622 * arg6 + arg2;
        int var11 = Draw2D.field622 - arg5;
        int var12 = 0;
        int var13 = 0;
        if (arg6 < Draw2D.field624) {
            int var14 = Draw2D.field624 - arg6;
            arg4 -= var14;
            arg6 = Draw2D.field624;
            var13 += arg5 * var14;
            var10 += Draw2D.field622 * var14;
        }
        if (arg4 + arg6 >= Draw2D.field625) {
            arg4 -= arg4 + arg6 + 1 - Draw2D.field625;
        }
        if (arg2 < Draw2D.field626) {
            int var15 = Draw2D.field626 - arg2;
            arg5 -= var15;
            arg2 = Draw2D.field626;
            var13 += var15;
            var10 += var15;
            var12 += var15;
            var11 += var15;
        }
        if (arg2 + arg5 >= Draw2D.field627) {
            int var16 = arg2 + arg5 + 1 - Draw2D.field627;
            arg5 -= var16;
            var12 += var16;
            var11 += var16;
        }
        if (arg5 > 0 && arg4 > 0) {
            this.method211(var12, arg3, 0, Draw2D.field621, arg5, var13, arg1, arg4, var11, arg0, var10);
        }
    }
