...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lyb;ILjava/lang/String;)V")
    ...
    public void method219(String arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        ...
        if (this.field721) {
            Draw2D.method173(this.field709, 8388608, var7, arg2 - var7, (int) ((double) this.field719 * 0.7D) + var8);
        }
    }
    ...
    private void method222(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field645 * arg2 + arg1;
        int var8 = Draw2D.field645 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field647) {
            int var11 = Draw2D.field647 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field647;
            var10 += arg3 * var11;
            var7 += Draw2D.field645 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field648) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field648;
        }
        if (arg1 < Draw2D.field649) {
            int var12 = Draw2D.field649 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field649;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field650) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field650;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method223(Draw2D.field644, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method224(byte[] arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5, int arg6, int arg7) {
        int var9 = Draw2D.field645 * arg3 + arg7;
        int var10 = Draw2D.field645 - arg2;
        int var11 = 0;
        int var12 = 0;
        if (arg3 < Draw2D.field647) {
            int var13 = Draw2D.field647 - arg3;
            arg4 -= var13;
            arg3 = Draw2D.field647;
            var12 += arg2 * var13;
            var9 += Draw2D.field645 * var13;
        }
        if (arg3 + arg4 >= Draw2D.field648) {
            arg4 -= arg3 + arg4 + 1 - Draw2D.field648;
        }
        if (arg7 < Draw2D.field649) {
            int var14 = Draw2D.field649 - arg7;
            arg2 -= var14;
            arg7 = Draw2D.field649;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg2 + arg7 >= Draw2D.field650) {
            int var15 = arg2 + arg7 + 1 - Draw2D.field650;
            arg2 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg2 > 0 && arg4 > 0) {
            this.method225(Draw2D.field644, arg4, var9, arg0, arg6, this.field710, var10, arg2, arg1, var12, var11);
            if (!arg5) {
                this.field710 = 270;
            }
        }
