...
public class PixFont extends Draw2D {
    ...
    private void method214(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field617 * arg2 + arg1;
        int var8 = Draw2D.field617 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field619) {
            int var11 = Draw2D.field619 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field619;
            var10 += arg3 * var11;
            var7 += Draw2D.field617 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field620) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field620;
        }
        if (arg1 < Draw2D.field621) {
            int var12 = Draw2D.field621 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field621;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field622) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field622;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method215(Draw2D.field616, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method216(int arg0, int arg1, int arg2, byte[] arg3, int arg4, int arg5, int arg6, int arg7) {
        int var9 = Draw2D.field617 * arg6 + arg5;
        int var10 = Draw2D.field617 - arg2;
        int var11 = 0;
        int var12 = 0;
        if (arg6 < Draw2D.field619) {
            int var13 = Draw2D.field619 - arg6;
            arg0 -= var13;
            arg6 = Draw2D.field619;
            var12 += arg2 * var13;
            var9 += Draw2D.field617 * var13;
        }
        if (arg0 + arg6 >= Draw2D.field620) {
            arg0 -= arg0 + arg6 + 1 - Draw2D.field620;
        }
        if (arg5 < Draw2D.field621) {
            int var14 = Draw2D.field621 - arg5;
            arg2 -= var14;
        ...
        if (arg2 + arg5 >= Draw2D.field622) {
            int var15 = arg2 + arg5 + 1 - Draw2D.field622;
            arg2 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg2 > 0 && arg0 > 0) {
            this.method217(Draw2D.field616, var10, arg3, var9, arg7, arg2, arg0, arg4, var12, 385, var11);
            while (arg1 >= 0) {
