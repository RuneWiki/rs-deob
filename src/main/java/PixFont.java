...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Ljava/lang/String;Lub;I)V")
    ...
    private void method193(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field535 * arg2 + arg1;
        int var8 = Draw2D.field535 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field537) {
            int var11 = Draw2D.field537 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field537;
            var10 += arg3 * var11;
            var7 += Draw2D.field535 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field538) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field538;
        }
        if (arg1 < Draw2D.field539) {
            int var12 = Draw2D.field539 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field539;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field540) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field540;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method194(Draw2D.field534, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
