...
public class PixFont extends Draw2D {
    ...
    public void drawStringTag(boolean arg0, boolean arg1, int arg2, int arg3, String arg4, int arg5) {
        ...
        if (!arg0 && this.strikethrough) {
            Draw2D.drawHorizontalLine((int) ((double) this.height * 0.7D) + var8, 8388608, arg2 - var7, var7, (byte) 4);
        }
    }
    ...
    private void drawChar(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.width2d * arg2 + arg1;
        int var8 = Draw2D.width2d - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.top) {
            int var11 = Draw2D.top - arg2;
            arg4 -= var11;
            arg2 = Draw2D.top;
            var10 += arg3 * var11;
            var7 += Draw2D.width2d * var11;
        }
        if (arg2 + arg4 >= Draw2D.bottom) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.bottom;
        }
        if (arg1 < Draw2D.left) {
            int var12 = Draw2D.left - arg1;
            arg3 -= var12;
            arg1 = Draw2D.left;
            var10 += var12;
            var7 += var12;
        ...
        if (arg1 + arg3 >= Draw2D.right) {
            int var13 = arg1 + arg3 + 1 - Draw2D.right;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
    ...
    private void drawCharAlpha(int arg0, int arg1, byte[] arg2, int arg3, int arg4, int arg5, boolean arg6, int arg7) {
        int var9 = Draw2D.width2d * arg4 + arg1;
        int var10 = Draw2D.width2d - arg3;
        int var11 = 0;
        int var12 = 0;
        if (arg4 < Draw2D.top) {
            int var13 = Draw2D.top - arg4;
            arg5 -= var13;
            arg4 = Draw2D.top;
            var12 += arg3 * var13;
            var9 += Draw2D.width2d * var13;
        }
        if (arg4 + arg5 >= Draw2D.bottom) {
            arg5 -= arg4 + arg5 + 1 - Draw2D.bottom;
        }
        if (arg1 < Draw2D.left) {
            int var14 = Draw2D.left - arg1;
            arg3 -= var14;
            arg1 = Draw2D.left;
            var12 += var14;
            var9 += var14;
        ...
        if (arg1 + arg3 >= Draw2D.right) {
            int var15 = arg1 + arg3 + 1 - Draw2D.right;
            arg3 -= var15;
            var11 += var15;
            var10 += var15;
        }
