...
public class PixFont extends Draw2D {
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(ZZLjava/lang/String;Lxb;)V")
    ...
    public void method210(String arg0, byte arg1, int arg2, int arg3, boolean arg4, int arg5) {
        ...
        if (this.field713) {
            Draw2D.method160(arg5 - var7, 8388608, -380, (int) ((double) this.field711 * 0.7D) + var8, var7);
        }
    }
    ...
    private void method213(byte[] arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        int var7 = Draw2D.field640 * arg2 + arg1;
        int var8 = Draw2D.field640 - arg3;
        int var9 = 0;
        int var10 = 0;
        if (arg2 < Draw2D.field642) {
            int var11 = Draw2D.field642 - arg2;
            arg4 -= var11;
            arg2 = Draw2D.field642;
            var10 += arg3 * var11;
            var7 += Draw2D.field640 * var11;
        }
        if (arg2 + arg4 >= Draw2D.field643) {
            arg4 -= arg2 + arg4 + 1 - Draw2D.field643;
        }
        if (arg1 < Draw2D.field644) {
            int var12 = Draw2D.field644 - arg1;
            arg3 -= var12;
            arg1 = Draw2D.field644;
            var10 += var12;
            var7 += var12;
            var9 += var12;
            var8 += var12;
        }
        if (arg1 + arg3 >= Draw2D.field645) {
            int var13 = arg1 + arg3 + 1 - Draw2D.field645;
            arg3 -= var13;
            var9 += var13;
            var8 += var13;
        }
        if (arg3 > 0 && arg4 > 0) {
            this.method214(Draw2D.field639, arg0, arg5, var10, var7, arg3, arg4, var8, var9);
        }
    }
    ...
    private void method215(int arg0, int arg1, int arg2, int arg3, byte[] arg4, int arg5, int arg6, int arg7) {
        int var9 = Draw2D.field640 * arg2 + arg5;
        int var10 = Draw2D.field640 - arg3;
        int var11 = 0;
        int var12 = 0;
        if (arg2 < Draw2D.field642) {
            int var13 = Draw2D.field642 - arg2;
            arg0 -= var13;
            arg2 = Draw2D.field642;
            var12 += arg3 * var13;
            var9 += Draw2D.field640 * var13;
        }
        if (arg0 + arg2 >= Draw2D.field643) {
            arg0 -= arg0 + arg2 + 1 - Draw2D.field643;
        }
        if (arg5 < Draw2D.field644) {
            int var14 = Draw2D.field644 - arg5;
            arg3 -= var14;
            arg5 = Draw2D.field644;
            var12 += var14;
            var9 += var14;
            var11 += var14;
            var10 += var14;
        }
        if (arg3 + arg5 >= Draw2D.field645) {
            int var15 = arg3 + arg5 + 1 - Draw2D.field645;
            arg3 -= var15;
            var11 += var15;
            var10 += var15;
        }
        if (arg3 > 0 && arg0 > 0) {
            this.method216(Draw2D.field639, var11, var9, var12, arg1, arg0, -45169, arg3, arg4, arg7, var10);
