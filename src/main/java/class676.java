...
public class class676 extends class140 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZIIIII[Lofa;IIII)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lee;IIZ)V")
    ...
    @OriginalMember(owner = "client!fh", name = "<init>", descriptor = "(Lee;II[III)V")
