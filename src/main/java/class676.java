...
public class class676 extends class618 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIIIIIB)I", line = 34)
