...
public class class676 extends class249 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(IIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(BII)V", line = 36)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BII)V", line = 59)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 79)
