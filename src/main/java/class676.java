...
public class class676 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIILka;ILfs;Lha;IIIIIII)Lka;", line = 14)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIIII)V", line = 193)
