...
public class class676 extends class39 {
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dw", name = "f", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIIBZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(BLoa;)Lvg;", line = 105)
    public final class162 method134(byte arg0, class689 arg1) {
        ++field9574;
        return arg0 < 121 ? null : null;
    }

    @OriginalMember(owner = "client!dw", name = "e", descriptor = "(I)Z", line = 118)
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "(B)Z", line = 129)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(Z)Z", line = 143)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Z)I", line = 154)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Loa;B)Llt;", line = 180)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(BLoa;)V", line = 256)
    ...
    @OriginalMember(owner = "client!dw", name = "m", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(I)I", line = 303)
    ...
    @OriginalMember(owner = "client!dw", name = "l", descriptor = "(I)I", line = 325)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V", line = 346)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IZIIIII)V", line = 357)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Loa;BI)Z", line = 939)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(IIB)V", line = 1138)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "(II)V", line = 1236)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lqba;I)V", line = 1381)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIILoa;)Z", line = 1398)
