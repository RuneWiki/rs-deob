...
public class class676 implements Runnable {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IBJLjava/lang/String;Lbl;)V", line = 32)
    ...
    @OriginalMember(owner = "client!lc", name = "run", descriptor = "()V", line = 47)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)Z", line = 173)
    ...
    @OriginalMember(owner = "client!lc", name = "d", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)Ljava/lang/String;", line = 213)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(BLjga;)V", line = 225)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(B)I", line = 238)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)Lbl;", line = 265)
    ...
    @OriginalMember(owner = "client!lc", name = "f", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!lc", name = "e", descriptor = "(I)J", line = 290)
