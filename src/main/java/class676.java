...
public class class676 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILha;)Z", line = 52)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIILha;IBIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(I[Lgd;IIII)V", line = 227)
