...
public class class676 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(II)[I", line = 346)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(III)V", line = 462)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)[[I", line = 416)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)Z", line = 473)
