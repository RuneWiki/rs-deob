...
public class class676 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILgk;)V", line = 4)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Z)I", line = 27)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILgk;B)V", line = 47)
