...
public class class676 extends class648 {
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Ldg;II[IIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!iha", name = "d", descriptor = "()Lrn;", line = 67)
    ...
    @OriginalMember(owner = "client!iha", name = "c", descriptor = "()Lrn;", line = 90)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(Z)V", line = 107)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IIIBILnga;)Ljava/awt/Frame;", line = 198)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(II)V", line = 291)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "()I", line = 355)
    public final int method671() {
        field9184++;
        return 0;
    }

    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IILdg;)V", line = 364)
    ...
    @OriginalMember(owner = "client!iha", name = "a", descriptor = "(IZ)V", line = 404)
    ...
    @OriginalMember(owner = "client!iha", name = "b", descriptor = "([III)V", line = 450)
    ...
    @OriginalMember(owner = "client!iha", name = "<init>", descriptor = "(Lnl;)V", line = 502)
