...
public class class676 extends class262 implements class438 {
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IBIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 58)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(I)V", line = 69)
    public final void method1543(int arg0) {
        ++field9425;
        super.method1543(arg0);
    }

    @OriginalMember(owner = "client!og", name = "b", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(BII)Z", line = 106)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Loia;Z)V", line = 238)
    public class676(class97 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)Z", line = 241)
    ...
    @OriginalMember(owner = "client!og", name = "c", descriptor = "(I)I", line = 253)
    ...
    @OriginalMember(owner = "client!og", name = "d", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 282)
    ...
    @OriginalMember(owner = "client!og", name = "g", descriptor = "(I)I", line = 298)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)I", line = 340)
