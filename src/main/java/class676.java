...
public class class676 extends class165 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(IIBILjava/lang/String;Lha;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILmia;)V", line = 49)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I[BII)[B", line = 60)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lrv;I)V", line = 93)
