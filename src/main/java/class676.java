...
public class class676 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "([BIIIIBII[B)V", line = 22)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BI)[B", line = 67)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IBZI[B)Z", line = 150)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(ILcv;Lcv;I)V", line = 360)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I[BII)Z", line = 277)
    ...
    @OriginalMember(owner = "client!lf", name = "toString", descriptor = "()Ljava/lang/String;", line = 317)
    public final String toString() {
        field9489++;
        return "Cache:" + this.field9495;
    }

    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZI)Log;", line = 327)
