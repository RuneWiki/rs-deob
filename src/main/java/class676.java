...
public class class676 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 25)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)Z", line = 39)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Leh;II)V", line = 74)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZI)Z", line = 139)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILeh;)V", line = 151)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 172)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 201)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(IB)I", line = 220)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(B)V", line = 244)
