...
public class class676 extends class173 {
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(Ljka;ILjka;F)Z")
    ...
    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(ILsda;)Z")
    ...
    @OriginalMember(owner = "client!pia", name = "<init>", descriptor = "(Lpq;I)V")
    public class676(class194 arg0, int arg1) {
        this.field9476 = arg0;
        this.field9472 = new class734(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!pia", name = "a", descriptor = "(I)Ljka;")
