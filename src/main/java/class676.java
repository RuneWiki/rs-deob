...
public class class676 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "(Lha;Lhba;IIIILkba;ZI)V", line = 551)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)I", line = 46)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILkba;)V", line = 77)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILha;)V", line = 180)
    ...
    @OriginalMember(owner = "client!wca", name = "finalize", descriptor = "()V", line = 193)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(ILha;)V", line = 210)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ZIZLha;I)Lka;", line = 227)
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)I", line = 364)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(BI)V", line = 375)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lka;IZLha;BLnga;III)V", line = 496)
