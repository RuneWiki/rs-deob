...
public class class676 extends class644 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILsl;)V", line = 78)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BC)I", line = 98)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IC)I", line = 122)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILsl;I)V", line = 191)
    ...
    @OriginalMember(owner = "client!fb", name = "c", descriptor = "(I)V", line = 257)
