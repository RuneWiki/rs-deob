...
public class class676 extends class665 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 23)
    public static void method3758(byte arg0) {
        int var1 = 56 % ((7 - arg0) / 59);
        field9563 = null;
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILmo;)V", line = 72)
