...
public class class676 extends class646 {
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lsea;Ljava/lang/Object;I)V", line = 15)
    public class676(class652 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field9224 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 24)
