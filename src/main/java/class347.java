...
public class class347 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lraa;IZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lfc;ILjava/lang/Object;)V", line = 22)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIILmj;)V", line = 64)
