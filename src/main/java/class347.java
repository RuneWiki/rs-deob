...
public class class347 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z[[[Lrr;)V", line = 17)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Z)V", line = 123)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 144)
    public final String method2103(int arg0, byte arg1) {
        field5338++;
        return arg1 == 34 ? this.field5337[arg0] : null;
    }

    @OriginalMember(owner = "client!dp", name = "toString", descriptor = "()Ljava/lang/String;", line = 181)
    public final String toString() {
        field5339++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 202)
