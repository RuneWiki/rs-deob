...
public class class347 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lac;II)Z")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ZBLig;)V")
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lda;)V")
