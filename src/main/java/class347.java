...
public class class347 extends class93 implements Runnable {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILah;Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lch;)V", line = 88)
    public class347(class326 arg0) {
        this.field5131 = arg0;
    }

    @OriginalMember(owner = "client!pi", name = "run", descriptor = "()V", line = 71)
