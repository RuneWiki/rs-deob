...
public class class347 extends class249 {
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(ZZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Lme;ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(III)V", line = 163)
    ...
    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Lwh;Ljga;)V", line = 224)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Lrg;B)Lkba;", line = 271)
    ...
    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(I)Z", line = 323)
