...
public class class347 extends class599 {
    ...
    @OriginalMember(owner = "client!ofa", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(ZLgda;BIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!ofa", name = "c", descriptor = "(I)Loda;", line = 35)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IBILgda;)Lpja;", line = 96)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IIB)I", line = 130)
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "(Lgca;IIIIII)V", line = 153)
