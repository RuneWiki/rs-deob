...
public class class347 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZLce;ILce;I)Lnh;")
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lgm;Lwo;)V")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lce;BILce;)Lnh;")
