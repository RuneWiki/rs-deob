...
public class class347 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IIB)Z", line = 17)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lnj;ZI)V", line = 87)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BLnj;)V", line = 333)
