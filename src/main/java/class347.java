...
public class class347 extends class83 {
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IBLtq;)V", line = 107)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "()V", line = 183)
    public class347() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(II)S", line = 154)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZI)[[I", line = 197)
