...
public class class347 extends class234 implements class467 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(FIIIIIII[FFI)V", line = 4)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)Z", line = 56)
    public final boolean method1021(boolean arg0) {
        field5078++;
        return arg0 ? super.method1021(arg0) : true;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)V", line = 68)
    public final void method1022(byte arg0) {
        field5085++;
        super.method1022(arg0);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 78)
    ...
    @OriginalMember(owner = "client!vr", name = "d", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 935)
    ...
    @OriginalMember(owner = "client!vr", name = "e", descriptor = "(I)V", line = 954)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(III)Z", line = 996)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lmc;Z)V", line = 1016)
    public class347(class381 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(B)I", line = 1020)
