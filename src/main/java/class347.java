...
public class class347 implements Runnable {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!qfa", name = "run", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!qfa", name = "finalize", descriptor = "()V", line = 175)
    protected final void finalize() {
        field5122++;
        this.method2156(-52);
    }

    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "([BIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!qfa", name = "c", descriptor = "(Z)I", line = 276)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lr;I)V", line = 291)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 307)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(BC)C", line = 329)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ILr;)V", line = 731)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B[BII)V", line = 784)
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Ljava/net/Socket;Lew;I)V", line = 832)
