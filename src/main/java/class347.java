...
public class class347 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II[S)[S", line = 20)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILpca;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(II)Lir;", line = 83)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BI)Z", line = 118)
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Lei;ILri;)V", line = 143)
