...
public class class347 implements Runnable {
    ...
    @OriginalMember(owner = "client!gha", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!gha", name = "run", descriptor = "()V", line = 51)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(III[B)I", line = 118)
    ...
    @OriginalMember(owner = "client!gha", name = "c", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!gha", name = "<init>", descriptor = "(Ljava/io/InputStream;I)V", line = 214)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(IZ)Z", line = 173)
    ...
    @OriginalMember(owner = "client!gha", name = "a", descriptor = "(Ljb;I)Loga;", line = 230)
