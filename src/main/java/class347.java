...
public class class347 extends class447 implements class193 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZILuo;I)Lvg;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILuo;)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILuo;I)Z")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZLuo;)Laj;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILuo;I)Lmj;")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IBIILrr;Luo;Z)V")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Luo;Lgm;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Luo;II)Lmj;")
    ...
    @OriginalMember(owner = "client!v", name = "i", descriptor = "(I)I")
