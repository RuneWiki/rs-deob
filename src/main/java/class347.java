...
public class class347 extends class361 implements class351 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lnr;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ql", name = "i", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(Lnr;Z)Lg;", line = 63)
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "(B)V", line = 89)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILnr;ZI)Lbc;", line = 137)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(B)I", line = 169)
    ...
    @OriginalMember(owner = "client!ql", name = "e", descriptor = "(B)Z", line = 181)
    public final boolean method151(byte arg0) {
        ++field5145;
        return arg0 != -115 ? true : this.field5138;
    }

    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(II)I", line = 194)
    public static int method2311(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!ql", name = "j", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(I)I", line = 228)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lnr;I)V", line = 240)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lnr;Lta;IIIIIZIIIIIIZ)V", line = 251)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lnr;BI)Lqc;", line = 293)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILnr;II)Z", line = 315)
    ...
    @OriginalMember(owner = "client!ql", name = "g", descriptor = "(I)I", line = 340)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILnr;)V", line = 354)
    ...
    @OriginalMember(owner = "client!ql", name = "g", descriptor = "(B)I", line = 382)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(B)Z", line = 393)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(BILnr;)Lqc;", line = 405)
