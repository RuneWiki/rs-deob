...
public class class347 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "([IIII[I)V", line = 28)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lig;I)Luca;", line = 87)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIBZJ)Ljava/lang/String;", line = 113)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(I)Llha;", line = 192)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(I)Llha;", line = 221)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILlha;)V", line = 243)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(Z)I", line = 263)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 306)
    public class347() {
        this.field4488.field8923 = this.field4488;
        this.field4488.field8927 = this.field4488;
    }

    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)Llha;", line = 289)
