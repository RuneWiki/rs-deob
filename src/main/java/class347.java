...
public class class347 extends class16 implements class143 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZIZI)I", line = 5)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILec;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lvq;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lvq;IIB)Z", line = 103)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lta;B)V", line = 125)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(B)I", line = 148)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lvq;Lbi;IIIIIIZI)V", line = 163)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Z)Z", line = 180)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "(I)V", line = 191)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BLvq;)Lbf;", line = 208)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(I)I", line = 244)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IILvq;)Lni;", line = 255)
    ...
    @OriginalMember(owner = "client!v", name = "g", descriptor = "(I)V", line = 266)
    ...
    @OriginalMember(owner = "client!v", name = "h", descriptor = "(I)Lvl;", line = 277)
    ...
    @OriginalMember(owner = "client!v", name = "d", descriptor = "(I)Z", line = 292)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 303)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILvq;)V", line = 314)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(B)I", line = 327)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lvq;B)V", line = 338)
