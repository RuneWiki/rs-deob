...
public class class347 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILwm;)V", line = 12)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(BII)I", line = 77)
