...
public class class347 extends class6 {
    ...
    @OriginalMember(owner = "client!ve", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ldw;B)V", line = 44)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lpd;Lbq;)V", line = 99)
