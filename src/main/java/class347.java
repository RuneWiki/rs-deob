...
public class class347 extends class424 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BI)Lgda;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Let;BLwha;)Z")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lhca;Llda;)Lnl;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Let;Lwha;Z)Z")
    ...
    @OriginalMember(owner = "client!tk", name = "fb", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZB)Liaa;")
    public final class497 method1995(boolean arg0, byte arg1) {
        ++field4370;
        return arg1 >= -77 ? null : new class343(this, class285.field3590, arg0);
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lmda;Lmda;FLmda;)Lmda;")
    public final class267 method485(class267 arg0, class267 arg1, float arg2, class267 arg3) {
        ++field4424;
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLd;Lnd;I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lnl;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILbp;Z)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I[BIILet;I)Laga;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I[Lfk;)Lri;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ljv;III)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)Llda;")
    ...
    @OriginalMember(owner = "client!tk", name = "r", descriptor = "()Lnia;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Z[IIBIII)Lwk;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lwha;IIBLet;)Lwk;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIIIZLet;[B)Lwk;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lmg;I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(II)Lhca;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILjv;Liaa;ZII)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILri;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IZI[[I)Lnn;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BZZLbp;I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILet;ZI[FIZ)Lwk;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILia;B)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZZ)Lia;")
