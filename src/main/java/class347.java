...
public class class347 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)Lrm;", line = 14)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lqa;Ldn;B)V", line = 26)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(II)I", line = 155)
    public static int method1937(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(IIII)V", line = 172)
