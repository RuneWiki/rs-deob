...
public class class347 extends class54 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(IIB)V", line = 17)
    ...
    @OriginalMember(owner = "client!ee", name = "e", descriptor = "(B)Lfb;", line = 33)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "()V", line = 55)
    public class347() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(IIII)[B", line = 61)
    ...
    @OriginalMember(owner = "client!ee", name = "d", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lza;I)V", line = 88)
