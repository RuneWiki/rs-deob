...
public class class347 extends class526 implements class706 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BIII)Z")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!sc", name = "k", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ZBLwm;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(BLha;)V")
    public final void method753(byte arg0, class58 arg1) {
        ++field4890;
        int var3 = -30 % ((arg0 - 18) / 40);
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ZLha;IILkba;II)V")
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILha;IZ)Lqha;")
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!sc", name = "l", descriptor = "(I)V")
