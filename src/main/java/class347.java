...
public class class347 extends class107 {
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(II)Lfh;", line = 3)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lrg;B)Lrg;", line = 65)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIBII)V", line = 308)
    ...
    @OriginalMember(owner = "client!pm", name = "c", descriptor = "(II)I", line = 326)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BIZ)V", line = 342)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "()V", line = 418)
    protected class347() {
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Leb;)V", line = 429)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lqj;I)V", line = 486)
