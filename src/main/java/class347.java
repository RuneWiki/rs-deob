...
public class class347 extends class331 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIZILul;Ltq;)[F")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ltq;ZILul;DZIB)[I")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ILul;Ltq;)Z")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ltq;Ltq;Ltq;Leo;B)Z")
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ltq;ILul;ZIDI)[I")
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(B)Lbj;")
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ldg;)V")
