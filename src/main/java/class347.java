...
public class class347 extends class725 {
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(ILafa;I)V")
    ...
    @OriginalMember(owner = "client!hda", name = "b", descriptor = "()Lco;")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "()Lco;")
    ...
    @OriginalMember(owner = "client!hda", name = "a", descriptor = "(Lafa;B[IIII)V")
    ...
    @OriginalMember(owner = "client!hda", name = "<init>", descriptor = "(Laea;)V")
