...
public class class347 extends class65 {
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(IIIIIF)V")
    public class347(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(FB)V")
    ...
    @OriginalMember(owner = "client!mv", name = "g", descriptor = "(I)Lae;")
