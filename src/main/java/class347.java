...
public class class347 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!hb", name = "toString", descriptor = "()Ljava/lang/String;", line = 31)
    public final String toString() {
        field4652++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(I)V", line = 38)
    public class347(int arg0) {
        this.field4651 = arg0;
    }

    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILnp;B)Ljava/lang/String;", line = 53)
