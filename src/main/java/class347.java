...
public class class347 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "([BB)Lfp;", line = 49)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(II)Lbg;", line = 152)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(II)V", line = 200)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIIIIII)Len;", line = 227)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IB)V", line = 248)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Lim;ILgj;Lgj;)V", line = 276)
