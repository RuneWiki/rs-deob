...
public class class347 extends class551 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Ln;DIIIZLdda;)[I")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILn;Ldda;)Z")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Ldda;IZLn;IB)[F")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Ln;Ldda;DIBZZI)[I")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lps;)V")
