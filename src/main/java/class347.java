...
public class class347 extends class203 {
    ...
    @OriginalMember(owner = "client!lfa", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(ZB)V", line = 18)
    ...
    @OriginalMember(owner = "client!lfa", name = "b", descriptor = "(I)Z", line = 28)
    ...
    @OriginalMember(owner = "client!lfa", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(Lpq;)V", line = 60)
    ...
    @OriginalMember(owner = "client!lfa", name = "e", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!lfa", name = "f", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!lfa", name = "g", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(BZ)V", line = 660)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IIZ)V", line = 683)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IZLwha;)V", line = 693)
