...
public class class347 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)Lcg;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BLcg;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZLum;)V")
    public final void method2091(boolean arg0, class347 arg1) {
        this.method2097(arg0, this.field5018.field1179, arg1);
        field5007++;
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILcg;)V")
    ...
    @OriginalMember(owner = "client!um", name = "f", descriptor = "(I)Lcg;")
    ...
    @OriginalMember(owner = "client!um", name = "g", descriptor = "(I)Lcg;")
    ...
    @OriginalMember(owner = "client!um", name = "h", descriptor = "(I)Lcg;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ZLcg;Lum;)V")
    ...
    @OriginalMember(owner = "client!um", name = "i", descriptor = "(I)Lcg;")
