...
public class class347 extends class449 {
    ...
    @OriginalMember(owner = "client!ho", name = "b", descriptor = "(B)Lsq;")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(III)Lp;")
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(ILcn;Lcn;Lgf;Lru;IIZ)V")
