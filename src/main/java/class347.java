...
public class class347 extends class135 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IILph;II)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Laj;II)V")
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(Lnh;)V")
