...
public class class347 extends class86 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IILha;Lbha;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(ILsf;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lsf;)V")
