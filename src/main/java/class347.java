...
public class class347 extends class417 {
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "()V", line = 7)
    public class347() {
    }

    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "(J)V", line = 9)
    public class347(long arg0) {
        this.field4757 = arg0;
    }

    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(B)V", line = 20)
