...
public class class347 extends Callback {
    ...
    @OriginalMember(owner = "client!ofa", name = "callback", descriptor = "(IIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(BZLjava/awt/Component;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IIZ)V", line = 92)
