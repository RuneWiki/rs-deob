...
public class class347 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIILqa;ILeca;)Lr;", line = 11)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(FB)F", line = 23)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lco;B)V", line = 51)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILsa;Leca;IBIIILqa;IIILsa;Z)Lr;", line = 79)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZILsa;IBLsa;Lqa;ILeca;IIII)Lr;", line = 194)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lco;II)V", line = 207)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lqa;ILeca;IIIB)Lr;", line = 329)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "([II)Ljava/lang/String;", line = 353)
