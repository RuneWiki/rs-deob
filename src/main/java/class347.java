...
public class class347 extends class338 implements class323 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILqa;)Lc;", line = 16)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLrn;ZIILqa;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BIZ)Ljava/lang/String;", line = 73)
    ...
    @OriginalMember(owner = "client!ag", name = "d", descriptor = "(I)I", line = 87)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLqa;)V", line = 110)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZILqa;)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILhs;IZI)Ljava/awt/Frame;", line = 153)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Lqa;B)Lvs;", line = 227)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Lqa;Ljt;IIIIIZII)V", line = 268)
    ...
    @OriginalMember(owner = "client!ag", name = "e", descriptor = "(I)Z", line = 279)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)Z", line = 304)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 315)
