...
public class class347 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I[S)[S", line = 4)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(III)Z", line = 29)
