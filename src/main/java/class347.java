...
public class class347 implements class528 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(JB[ILho;)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)I", line = 35)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIIIZIILjava/lang/String;)V", line = 47)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IB)Lsb;", line = 79)
