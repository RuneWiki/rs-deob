...
public class class347 extends class633 {
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)Lng;", line = 6)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 65)
    ...
    @OriginalMember(owner = "client!uj", name = "d", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(BFLng;Lng;)Z", line = 111)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lap;I)V", line = 316)
