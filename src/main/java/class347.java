...
public class class347 extends class330 {
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(IIILsba;III)Z")
    ...
    @OriginalMember(owner = "client!cia", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cia", name = "a", descriptor = "(II)Lgia;")
