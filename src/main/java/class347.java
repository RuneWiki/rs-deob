...
public class class347 extends class210 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(B)I", line = 80)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IB)[I", line = 94)
    ...
    @OriginalMember(owner = "client!gm", name = "d", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "()V", line = 204)
    public class347() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IILat;)V", line = 153)
