...
public class class347 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)Lve;", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIII)I", line = 18)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(I)V", line = 187)
    public class347(int arg0) {
        this.field4749 = arg0;
    }

    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(IIIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IZII)Z", line = 139)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lve;B)V", line = 168)
