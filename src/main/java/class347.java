...
public class class347 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Z[B)[B", line = 7)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Lnfa;)V", line = 64)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)V", line = 143)
