...
public class class358 extends class220 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IIIZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IILhaa;ILha;ILek;Lafa;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)Lg;", line = 78)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ldp;Lfv;IIIIIIIIIIIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "([[B[B[III[[BI[I)I", line = 126)
