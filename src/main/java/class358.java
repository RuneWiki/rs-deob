...
public class class358 extends class397 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ur", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IIIIZ)V", line = 243)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(IBLae;)V", line = 260)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BI)[[I", line = 296)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "()V", line = 366)
    public class358() {
        super(3, false);
    }

    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(BI)Z", line = 369)
