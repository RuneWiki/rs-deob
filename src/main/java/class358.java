...
public class class358 extends class366 {
    ...
    @OriginalMember(owner = "client!qj", name = "g", descriptor = "(I)Z", line = 5)
    public final boolean method657(int arg0) {
        return arg0 == 16 ? true : true;
    }

    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lsv;Ljava/lang/Object;I)V", line = 15)
    public class358(class477 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5507 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!qj", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 25)
