...
public abstract class class358 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 49)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 78)
