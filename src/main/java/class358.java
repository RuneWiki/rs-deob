...
public class class358 extends class52 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(FFFFFFLpa;II)V")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILpa;II)V")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lbda;IIZ)V")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lbda;II[III)V")
