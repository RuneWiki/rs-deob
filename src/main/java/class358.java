...
public class class358 extends class179 {
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lih;II)V")
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(Lqs;B)V")
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lih;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lih;IIZ[[I)V")
