...
public class class358 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lor;II)I", line = 11)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IZIZII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Lfg;IB)Z", line = 82)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Ldc;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IB)Z", line = 188)
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Lpg;)V", line = 249)
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(IBI)I", line = 207)
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(B)V", line = 226)
