...
public class class358 extends class518 {
    ...
    @OriginalMember(owner = "client!oga", name = "<init>", descriptor = "()V", line = 9)
    public class358() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ZIIIIIIIII)Z", line = 12)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(ILjc;I)V", line = 653)
    ...
    @OriginalMember(owner = "client!oga", name = "d", descriptor = "(B)V", line = 702)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(I)V", line = 734)
    ...
    @OriginalMember(owner = "client!oga", name = "f", descriptor = "(I)V", line = 750)
    ...
    @OriginalMember(owner = "client!oga", name = "b", descriptor = "(II)[I", line = 770)
    ...
    @OriginalMember(owner = "client!oga", name = "e", descriptor = "(B)V", line = 846)
