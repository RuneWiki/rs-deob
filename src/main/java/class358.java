...
public class class358 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZLei;)I", line = 3)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BLsl;)V", line = 32)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lsl;IB)V", line = 58)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BLjk;)V", line = 74)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "([[[Lds;ZIIII)Z", line = 121)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 449)
