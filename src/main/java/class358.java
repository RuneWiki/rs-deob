...
public class class358 extends class263 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BII)I", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "()V", line = 21)
    public class358() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IB)[I", line = 25)
