...
public class class358 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ILol;B)V", line = 18)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(ILgga;)V", line = 52)
