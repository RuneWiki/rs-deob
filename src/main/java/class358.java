...
public class class358 extends class484 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(IIIIIIIIILle;I)Z")
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(Lql;B)Z")
    ...
    @OriginalMember(owner = "client!wj", name = "<init>", descriptor = "(Ljo;Lfca;)V")
