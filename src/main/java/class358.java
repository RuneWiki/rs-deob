...
public class class358 extends class339 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIILvv;)V", line = 146)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIII)V", line = 153)
