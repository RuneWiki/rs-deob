...
public class class358 extends class648 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lbca;II)V", line = 18)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(I[BILjava/lang/String;)I", line = 30)
    ...
    @OriginalMember(owner = "client!bga", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!bga", name = "c", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Lwu;)V", line = 103)
    public class358(class373 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ZZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(ZI)V", line = 119)
    ...
    @OriginalMember(owner = "client!bga", name = "c", descriptor = "(B)V", line = 129)
