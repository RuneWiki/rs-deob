...
public class class358 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IBLnp;)V", line = 9)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lnp;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(B)V", line = 61)
