...
public class class358 extends class433 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIZFZII)[I", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!re", name = "j", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)I", line = 54)
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "(Z)I", line = 92)
    ...
    @OriginalMember(owner = "client!re", name = "k", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILen;)Lir;", line = 124)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Len;I)V", line = 202)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lwm;B)V", line = 230)
    ...
    @OriginalMember(owner = "client!re", name = "g", descriptor = "(I)I", line = 244)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIZLen;)Z", line = 261)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZLen;)Z", line = 293)
    ...
    @OriginalMember(owner = "client!re", name = "l", descriptor = "(I)Z", line = 406)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)I", line = 417)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(ILen;IBLfs;IZ)V", line = 438)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(ZI)Lir;", line = 451)
