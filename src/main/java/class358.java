...
public class class358 extends class418 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IFIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(II)V", line = 131)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "([III)V", line = 143)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(II)V", line = 292)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lsb;IIII)V", line = 306)
