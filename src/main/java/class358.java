...
public class class358 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(BLjava/lang/String;Ljava/applet/Applet;)V", line = 3)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B[Ljava/lang/Object;)Ljava/lang/Object;", line = 12)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)Ljava/lang/Object;", line = 24)
