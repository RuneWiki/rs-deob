...
public class class358 extends class6 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!fo", name = "f", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!fo", name = "c", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(BILsi;)V", line = 58)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lsi;I)V", line = 124)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IC)I", line = 144)
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(IC)I", line = 170)
