...
public class class358 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIILsl;)V", line = 37)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 44)
