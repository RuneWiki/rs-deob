...
public class class358 extends class431 implements class338 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!hv", name = "d", descriptor = "(I)Z", line = 3)
    public final boolean method338(int arg0) {
        field4838++;
        return arg0 >= -8;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 18)
    public final void method342(int arg0) {
        int var2 = 4 / ((56 - arg0) / 52);
        field4837++;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILqa;)V", line = 48)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(ILqa;)Lfm;", line = 59)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lqa;Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(IIILpe;)V", line = 80)
    public class358(int arg0, int arg1, int arg2, class431 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field4835 = arg3;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)I", line = 88)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lqa;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IILqa;Leq;IIZ)V", line = 126)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLqa;I)Lc;", line = 136)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)Z", line = 148)
    public final boolean method126(byte arg0) {
        field4831++;
        return arg0 == 54 ? false : false;
    }

    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)I", line = 162)
    public final int method345(int arg0) {
        field4826++;
        return arg0 == -1736 ? 0 : -28;
    }

    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IILqa;I)Z", line = 186)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)I", line = 198)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(Z)V", line = 212)
