...
public class class358 extends class371 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IBLps;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BI)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 122)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 190)
    public class358() {
        super(1, false);
    }

    @OriginalMember(owner = "client!hp", name = "g", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!hp", name = "h", descriptor = "(I)Z", line = 205)
