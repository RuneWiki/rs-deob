...
public class class358 extends class659 {
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tq", name = "d", descriptor = "()Lac;", line = 14)
    public final class659 method534() {
        return (class659) this.field5282.method1901(108);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lac;)V", line = 17)
    public final synchronized void method2205(class659 arg0) {
        arg0.method2360((byte) 66);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "([III)V", line = 27)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(Lac;)V", line = 78)
    public final synchronized void method2206(class659 arg0) {
        this.field5282.method1908(0, arg0);
    }

    @OriginalMember(owner = "client!tq", name = "c", descriptor = "()Lac;", line = 82)
    public final class659 method531() {
        return (class659) this.field5282.method1904(false);
    }

    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Ldu;Lpu;)V", line = 85)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lpu;)V", line = 92)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "([III)V", line = 156)
    ...
    @OriginalMember(owner = "client!tq", name = "e", descriptor = "()V", line = 166)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "()I", line = 184)
    public final int method545() {
        return 0;
    }

    @OriginalMember(owner = "client!tq", name = "f", descriptor = "()I", line = 188)
