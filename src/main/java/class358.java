...
public class class358 extends InputStream {
    ...
    @OriginalMember(owner = "client!md", name = "read", descriptor = "()I", line = 7)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)Las;", line = 18)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILnr;IBILlo;Los;Lkb;)V", line = 30)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Loq;Lpm;)V", line = 72)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BB)V", line = 1201)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 1239)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(CZI)C", line = 1251)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)Lhq;", line = 1359)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lnr;Lcb;III)V", line = 1376)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(B)V", line = 1422)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIB)Lro;", line = 1436)
