...
public class class358 extends class631 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lfga;[III)V")
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lfga;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ke", name = "<init>", descriptor = "(Lfga;II)V")
