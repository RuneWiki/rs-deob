...
public class class358 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B)Ljq;", line = 3)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(B)Ljq;", line = 24)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "()V", line = 146)
    public class358() {
        this.field5128.field5159 = this.field5128;
        this.field5128.field5158 = this.field5128;
    }

    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(Ljq;Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(I)Ljq;", line = 100)
