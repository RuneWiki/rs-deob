...
public class class358 extends class317 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(III)[B", line = 6)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I[B)V", line = 23)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)[B", line = 36)
