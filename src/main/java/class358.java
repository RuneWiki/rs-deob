...
public class class358 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)Z", line = 56)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(III)I", line = 80)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BLiv;)V", line = 124)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Liv;B)Loc;", line = 150)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Liv;II)V", line = 190)
