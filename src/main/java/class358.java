...
public abstract class class358 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!gd", name = "g", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!gd", name = "e", descriptor = "(I)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!gd", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 31)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILjava/lang/String;)V", line = 40)
    ...
    @OriginalMember(owner = "client!gd", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 69)
    ...
    @OriginalMember(owner = "client!gd", name = "run", descriptor = "()V", line = 86)
    ...
    @OriginalMember(owner = "client!gd", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 205)
    ...
    @OriginalMember(owner = "client!gd", name = "g", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!gd", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 262)
    ...
    @OriginalMember(owner = "client!gd", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 271)
    ...
    @OriginalMember(owner = "client!gd", name = "provideLoaderApplet", descriptor = "(Ljava/applet/Applet;)V", line = 278)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(I)Z", line = 297)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)Z", line = 308)
    ...
    @OriginalMember(owner = "client!gd", name = "stop", descriptor = "()V", line = 319)
    ...
    @OriginalMember(owner = "client!gd", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 330)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 348)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)V", line = 395)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)Z", line = 434)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZ)V", line = 447)
    ...
    @OriginalMember(owner = "client!gd", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 518)
    ...
    @OriginalMember(owner = "client!gd", name = "destroy", descriptor = "()V", line = 527)
    ...
    @OriginalMember(owner = "client!gd", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 543)
    ...
    @OriginalMember(owner = "client!gd", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 565)
    ...
    @OriginalMember(owner = "client!gd", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 573)
    ...
    @OriginalMember(owner = "client!gd", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 582)
    ...
    @OriginalMember(owner = "client!gd", name = "start", descriptor = "()V", line = 591)
    ...
    @OriginalMember(owner = "client!gd", name = "f", descriptor = "(I)V", line = 602)
    ...
    @OriginalMember(owner = "client!gd", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 654)
    ...
    @OriginalMember(owner = "client!gd", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 662)
    ...
    @OriginalMember(owner = "client!gd", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 676)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZIBIIILjava/lang/String;)V", line = 687)
    ...
    @OriginalMember(owner = "client!gd", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 730)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(B)Z", line = 752)
    ...
    @OriginalMember(owner = "client!gd", name = "f", descriptor = "(B)V", line = 794)
