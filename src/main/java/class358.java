...
public class class358 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IB)Lnf;", line = 90)
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)Lmd;", line = 144)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Ldn;ILr;Lr;)V", line = 194)
