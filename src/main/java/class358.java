...
public class class358 extends class32 implements Runnable {
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "c", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Ldk;)V", line = 137)
    public class358(class390 arg0) {
        this.field5436 = arg0;
    }

    @OriginalMember(owner = "client!li", name = "run", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!li", name = "d", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I[Ljava/lang/Object;II[J)V", line = 65)
