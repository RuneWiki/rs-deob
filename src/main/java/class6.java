...
public abstract class class6 extends class167 {
    ...
    @OriginalMember(owner = "client!ie", name = "o", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 13)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(ILha;)Z", line = 50)
    ...
    @OriginalMember(owner = "client!ie", name = "p", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B[Luca;)I", line = 89)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!ie", name = "g", descriptor = "(I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(IIIIII)V", line = 134)
