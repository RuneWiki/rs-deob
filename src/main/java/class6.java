...
public class class6 extends class314 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIIBIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "([Ldm;)V", line = 81)
    public class6(class680[] arg0) {
        this.field209 = arg0;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)V", line = 89)
