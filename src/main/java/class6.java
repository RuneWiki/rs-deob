...
public class class6 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)Ljq;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Lfa;I)I")
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)Ljq;")
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILjq;)V")
