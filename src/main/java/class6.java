...
public class class6 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Z)Lob;")
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(I)Lob;")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(Lbo;)V")
