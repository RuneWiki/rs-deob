...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIILqa;III)Lc;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IZ)Llk;")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Llf;ILvh;)V")
