...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lha;IZI)Lnf;", line = 28)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lfca;B)V", line = 72)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)V", line = 92)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIIII)V", line = 107)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILfca;I)V", line = 126)
