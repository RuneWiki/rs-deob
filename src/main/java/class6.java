...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)Lie;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([ILqh;II)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIIIIIILnn;IIII)Z")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lie;B)V")
