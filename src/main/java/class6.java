...
public class class6 extends class85 {
    ...
    @OriginalMember(owner = "client!ae", name = "Y", descriptor = "Llf;")
    public static class109 field92 = class35.method275("Sichtbare Karte vorbereitet)3", 2);

    @OriginalMember(owner = "client!ae", name = "Z", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BILja;)V")
