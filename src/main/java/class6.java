...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(III)Ltr;")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lcda;ILkea;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(II)Lei;")
