...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([I[Ljava/lang/String;[Ljd;Ljava/lang/String;B)I")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ZLwia;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([Ljd;Ljava/lang/String;IB)I")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/String;[Ljd;B)I")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/String;B[Ljd;I)I")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/String;[Ljd;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I[Ljd;Ljava/lang/String;II)I")
