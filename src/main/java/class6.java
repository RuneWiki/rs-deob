...
public class class6 extends class429 {
    ...
    @OriginalMember(owner = "client!se", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(ZZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Lmj;)V", line = 67)
    public class6(class114 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(Len;ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!se", name = "b", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)Z", line = 129)
