...
public class class6 extends class125 implements class518 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLza;)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lza;III)Z", line = 14)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lza;Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(I)V", line = 167)
    public final void method31(int arg0) {
        ++field56;
        int var2 = -127 % ((arg0 - 57) / 48);
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILza;I)Le;", line = 179)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(B)Z", line = 190)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILza;)V", line = 200)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(Z)V", line = 228)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILco;ILmo;Lza;Lit;BI)V", line = 239)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lza;Lp;IIIIIZII)V", line = 284)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(I)I", line = 299)
    public final int method38(int arg0) {
        ++field77;
        return arg0 != 5638 ? -68 : this.field73.field6842;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILza;IILvl;Z)V", line = 310)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(ILza;)Lsr;", line = 322)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILjava/lang/String;)V", line = 364)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Z)Z", line = 401)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(BLza;)V", line = 416)
