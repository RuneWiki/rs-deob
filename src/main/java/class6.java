...
public class class6 extends class115 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II[Ljf;)V", line = 5)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)V", line = 119)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "()V", line = 131)
    public class6() {
        super(0, true);
    }

    @OriginalMember(owner = "client!to", name = "b", descriptor = "(II)[I", line = 136)
    ...
    @OriginalMember(owner = "client!to", name = "h", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!to", name = "c", descriptor = "(II)I", line = 169)
    ...
    @OriginalMember(owner = "client!to", name = "e", descriptor = "(B)V", line = 275)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(BLen;)V", line = 348)
    ...
    @OriginalMember(owner = "client!to", name = "f", descriptor = "(B)V", line = 389)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 438)
