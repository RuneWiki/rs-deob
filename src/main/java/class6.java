...
public abstract class class6 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!kr", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 7)
    public final void windowOpened(WindowEvent arg0) {
        field53++;
    }

    @OriginalMember(owner = "client!kr", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 16)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field66++;
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!kr", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 132)
    public final void windowClosed(WindowEvent arg0) {
        field54++;
    }

    @OriginalMember(owner = "client!kr", name = "d", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!kr", name = "destroy", descriptor = "()V", line = 154)
    ...
    @OriginalMember(owner = "client!kr", name = "e", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!kr", name = "stop", descriptor = "()V", line = 217)
    ...
    @OriginalMember(owner = "client!kr", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 230)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZLjava/lang/Object;I)[B", line = 250)
    ...
    @OriginalMember(owner = "client!kr", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 284)
    public final void windowDeiconified(WindowEvent arg0) {
        field62++;
    }

    @OriginalMember(owner = "client!kr", name = "start", descriptor = "()V", line = 291)
    ...
    @OriginalMember(owner = "client!kr", name = "providesignlink", descriptor = "(Lvj;)V", line = 304)
    ...
    @OriginalMember(owner = "client!kr", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 314)
    public final void windowIconified(WindowEvent arg0) {
        field47++;
    }

    @OriginalMember(owner = "client!kr", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 325)
    public final void focusLost(FocusEvent arg0) {
        class276.field4157 = false;
        field75++;
    }

    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(B)V", line = 333)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIIZ)V", line = 366)
    ...
    @OriginalMember(owner = "client!kr", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 413)
    ...
    @OriginalMember(owner = "client!kr", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 429)
    ...
    @OriginalMember(owner = "client!kr", name = "run", descriptor = "()V", line = 446)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZI)V", line = 561)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILjava/lang/String;IIIZZI)V", line = 643)
    ...
    @OriginalMember(owner = "client!kr", name = "g", descriptor = "(I)Z", line = 681)
    ...
    @OriginalMember(owner = "client!kr", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 719)
    ...
    @OriginalMember(owner = "client!kr", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 733)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(JB)V", line = 757)
    ...
    @OriginalMember(owner = "client!kr", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 862)
    ...
    @OriginalMember(owner = "client!kr", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 877)
    public final void windowActivated(WindowEvent arg0) {
        field55++;
    }

    @OriginalMember(owner = "client!kr", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 885)
    public final void windowDeactivated(WindowEvent arg0) {
        field76++;
    }

    @OriginalMember(owner = "client!kr", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 893)
