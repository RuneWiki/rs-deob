...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BI[BI)V", line = 80)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II[BI)V", line = 269)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)Ljava/io/File;", line = 388)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lst;II)V", line = 546)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)V", line = 411)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)V", line = 460)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([BI)V", line = 474)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(JI)V", line = 484)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(B)J", line = 534)
