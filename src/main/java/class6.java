...
public abstract class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II)I", line = 8)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ZI)Z", line = 34)
