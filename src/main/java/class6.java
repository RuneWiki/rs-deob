...
public class class6 {
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "m", descriptor = "LVNWSQIXW;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "g", descriptor = "LGHHPHSRU;")
    private static class14 field564;

    @OriginalMember(owner = "client!DDJHHGTJ", name = "L", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "f", descriptor = "[LDDJHHGTJ;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "a", descriptor = "([IIII)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "a", descriptor = "(LGHHPHSRU;I)V")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "c", descriptor = "(I)LDDJHHGTJ;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "d", descriptor = "(I)LOQIGXOFQ;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "e", descriptor = "(I)LDDJHHGTJ;")
    ...
    @OriginalMember(owner = "client!DDJHHGTJ", name = "a", descriptor = "(LDTIATKJO;)V")
