...
@OriginalClass("client!AZLXGPCM")
public class class6 {

    @OriginalMember(owner = "client!AZLXGPCM", name = "a", descriptor = "I")
    public int field125;

    @OriginalMember(owner = "client!AZLXGPCM", name = "b", descriptor = "[I")
    public int[] field126;

    @OriginalMember(owner = "client!AZLXGPCM", name = "c", descriptor = "[[I")
    public int[][] field127;

    @OriginalMember(owner = "client!AZLXGPCM", name = "<init>", descriptor = "(ILYOXDZEVD;)V")
