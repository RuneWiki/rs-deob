...
public class class6 extends class66 {
    ...
    @OriginalMember(owner = "client!DYEBQOMK", name = "C", descriptor = "LPNPNYEVW;")
    ...
    @OriginalMember(owner = "client!DYEBQOMK", name = "v", descriptor = "Lclient;")
    public static client field670;

    @OriginalMember(owner = "client!DYEBQOMK", name = "a", descriptor = "(B)LNRKXAGEB;")
    ...
    @OriginalMember(owner = "client!DYEBQOMK", name = "a", descriptor = "(Z)LCSGBDGDY;")
