...
public class class6 extends class435 {
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Ld;)V", line = 6)
    public class6(class88 arg0) {
        this.field49 = arg0;
    }

    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/String;BC)[Ljava/lang/String;", line = 43)
