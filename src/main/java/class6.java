...
public abstract class class6 extends class417 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIIBFIFF)[F", line = 3)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 126)
