...
@OriginalClass("client!CWWAFTAL")
public class class6 {

    @OriginalMember(owner = "client!CWWAFTAL", name = "b", descriptor = "I")
    private int field554 = 224;

    @OriginalMember(owner = "client!CWWAFTAL", name = "d", descriptor = "Z")
    private boolean field556 = true;

    @OriginalMember(owner = "client!CWWAFTAL", name = "e", descriptor = "Z")
    private boolean field557 = false;

    @OriginalMember(owner = "client!CWWAFTAL", name = "h", descriptor = "I")
    public int field560 = -1;

    @OriginalMember(owner = "client!CWWAFTAL", name = "j", descriptor = "[I")
    public int[] field562 = new int[6];

    @OriginalMember(owner = "client!CWWAFTAL", name = "k", descriptor = "[I")
    public int[] field563 = new int[6];

    @OriginalMember(owner = "client!CWWAFTAL", name = "l", descriptor = "[I")
    public int[] field564 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!CWWAFTAL", name = "m", descriptor = "Z")
    public boolean field565 = false;

    @OriginalMember(owner = "client!CWWAFTAL", name = "a", descriptor = "I")
    private static int field553 = 8;

    @OriginalMember(owner = "client!CWWAFTAL", name = "f", descriptor = "I")
    public static int field558;

    @OriginalMember(owner = "client!CWWAFTAL", name = "c", descriptor = "Z")
    private static boolean field555;

    @OriginalMember(owner = "client!CWWAFTAL", name = "i", descriptor = "[I")
    public int[] field561;

    @OriginalMember(owner = "client!CWWAFTAL", name = "g", descriptor = "[LCWWAFTAL;")
    public static class6[] field559;

    @OriginalMember(owner = "client!CWWAFTAL", name = "a", descriptor = "(LFIGUVTWB;Z)V")
    ...
    @OriginalMember(owner = "client!CWWAFTAL", name = "a", descriptor = "(LMUKVLYLC;Z)V")
    ...
    @OriginalMember(owner = "client!CWWAFTAL", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!CWWAFTAL", name = "b", descriptor = "(Z)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!CWWAFTAL", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!CWWAFTAL", name = "a", descriptor = "(B)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!CWWAFTAL", name = "<init>", descriptor = "()V")
    public class6() {
