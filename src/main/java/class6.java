...
public class class6 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(CI)I", line = 17)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)Lpf;", line = 37)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(FFFB)I", line = 56)
