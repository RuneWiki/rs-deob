...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lda;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lda;Ljaggl/memory/NativeBuffer;)V", line = 21)
