...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Z)I", line = 17)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lya;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BLjava/lang/String;)V", line = 46)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II)V", line = 91)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 109)
    public class6(String arg0, int arg1) {
        this.field67 = arg1;
    }

    @OriginalMember(owner = "client!ie", name = "toString", descriptor = "()Ljava/lang/String;", line = 119)
    public final String toString() {
        field68++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(II)V", line = 134)
