...
public class class6 extends class5 {
    ...
    private void method22(Font arg0, FontMetrics arg1, char arg2, int arg3, boolean arg4, class1 arg5) {
    ...
    public class6(int arg0, boolean arg1, class1 arg2) {
        this.field49 = 855;
        this.field48 = false;
    ...
    public void method24(String arg0, int arg1, int arg2, int arg3, boolean arg4) {
        ...
        if (arg1 - var6 <= class5.field43 && (arg1 + var6 >= class5.field42 && (arg2 - var7 <= class5.field41 && arg2 >= 0))) {
    ...
    private void method28(int arg0, int arg1, int arg2, int arg3, byte[] arg4, boolean arg5) {
        ...
        int var12 = class5.field38 * var8 + var7;
        int var13 = class5.field38 - var9;
        int var14 = 0;
        if (var8 < class5.field40) {
            int var15 = class5.field40 - var8;
            var10 -= var15;
            var8 = class5.field40;
            var11 += var9 * var15;
            var12 += class5.field38 * var15;
        }
        if (var8 + var10 >= class5.field41) {
            var10 -= var8 + var10 + 1 - class5.field41;
        }
        if (var7 < class5.field42) {
            int var16 = class5.field42 - var7;
            var9 -= var16;
            var7 = class5.field42;
            var11 += var16;
            var12 += var16;
        ...
        if (var7 + var9 >= class5.field43) {
            int var17 = var7 + var9 + 1 - class5.field43;
            var9 -= var17;
            var14 += var17;
            var13 += var17;
        }
        ...
        if (arg5) {
            this.method25(class5.field37, arg4, arg3, var11, var12, var9, var10, var13, var14);
        } else {
            this.method29(class5.field37, arg4, arg3, var11, var12, var9, var10, var13, var14);
        }
    }
