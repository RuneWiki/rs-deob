...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!ie", name = "finalize", descriptor = "()V", line = 21)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Llf;II)V", line = 33)
