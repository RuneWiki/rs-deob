...
public abstract class class6 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZLrg;)Lpg;")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ZLvg;Z)V")
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lgg;IIII)V")
