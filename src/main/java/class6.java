...
public class class6 extends class513 implements class3 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(Lha;B)Lrga;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ZILha;ILrda;II)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IZLha;I)Lvh;")
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lha;Ltk;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lha;B)Lkv;")
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILha;I)Lka;")
