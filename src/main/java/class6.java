...
public class class6 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 9)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 64)
