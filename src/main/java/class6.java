...
public class class6 extends class362 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIIIILkda;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([IIZ[IB)J", line = 14)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lhg;Loo;IIIIILha;ZI)Lka;", line = 67)
