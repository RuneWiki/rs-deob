...
public abstract class class6 extends class202 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IBILrfa;ZILha;)V")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(B[Lta;)I")
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(Lha;B)Z")
