...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IZII)Z", line = 27)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(II)V", line = 218)
