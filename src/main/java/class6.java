...
public class class6 extends class294 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IILtr;ZILtq;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)J", line = 82)
