...
public class class6 {
    ...
    @OriginalMember(owner = "client!BOZWYCIO", name = "c", descriptor = "LAGCGSOQI;")
    public class1 field79 = new class1();

    @OriginalMember(owner = "client!BOZWYCIO", name = "d", descriptor = "LAGCGSOQI;")
    ...
    @OriginalMember(owner = "client!BOZWYCIO", name = "a", descriptor = "(LAGCGSOQI;)V")
    ...
    @OriginalMember(owner = "client!BOZWYCIO", name = "a", descriptor = "()LAGCGSOQI;")
    ...
    @OriginalMember(owner = "client!BOZWYCIO", name = "b", descriptor = "()LAGCGSOQI;")
    ...
    @OriginalMember(owner = "client!BOZWYCIO", name = "a", descriptor = "(Z)LAGCGSOQI;")
