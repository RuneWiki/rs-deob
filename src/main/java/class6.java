...
public class class6 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(BI)Lkf;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lkm;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ldk;ILfc;)V")
