...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILug;)V", line = 183)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILie;)Z", line = 196)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "()V", line = 281)
    public class6() {
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lug;)V", line = 297)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)V", line = 233)
