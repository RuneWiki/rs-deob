...
public class class6 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IBII)V", line = 51)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lfq;)V", line = 90)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(III)I", line = 185)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lvc;Luq;IIIII)V", line = 200)
