...
public class class6 {
    ...
    @OriginalMember(owner = "client!BUIWQSXJ", name = "q", descriptor = "LZYLCKQCD;")
    ...
    @OriginalMember(owner = "client!BUIWQSXJ", name = "i", descriptor = "LKIZBPSHZ;")
    public class29 field53;

    @OriginalMember(owner = "client!BUIWQSXJ", name = "e", descriptor = "[LBUIWQSXJ;")
    public static class6[] field49;

    @OriginalMember(owner = "client!BUIWQSXJ", name = "a", descriptor = "(ILQDHHNYHL;)V")
    ...
    @OriginalMember(owner = "client!BUIWQSXJ", name = "a", descriptor = "(LPGNBHFUF;I)V")
    ...
    @OriginalMember(owner = "client!BUIWQSXJ", name = "a", descriptor = "()LPOJFANDE;")
