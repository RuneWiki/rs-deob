...
public class class6 {
    ...
    @OriginalMember(owner = "client!BKJQHSVH", name = "p", descriptor = "LDMOAMUBS;")
    ...
    @OriginalMember(owner = "client!BKJQHSVH", name = "h", descriptor = "LMJVHTYCA;")
    public class45 field65;

    @OriginalMember(owner = "client!BKJQHSVH", name = "d", descriptor = "[LBKJQHSVH;")
    public static class6[] field61;

    @OriginalMember(owner = "client!BKJQHSVH", name = "a", descriptor = "(ZLMJLXHQTQ;)V")
    ...
    @OriginalMember(owner = "client!BKJQHSVH", name = "a", descriptor = "(ZLXGRGMPUQ;)V")
    ...
    @OriginalMember(owner = "client!BKJQHSVH", name = "a", descriptor = "()LVYUQHOMO;")
