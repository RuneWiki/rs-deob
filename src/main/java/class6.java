...
public class class6 {
    ...
    @OriginalMember(owner = "client!CHVNTVHC", name = "d", descriptor = "LUAWAYCTK;")
    ...
    @OriginalMember(owner = "client!CHVNTVHC", name = "a", descriptor = "(LUAWAYCTK;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!CHVNTVHC", name = "a", descriptor = "(Ljava/lang/String;ILUAWAYCTK;)V")
