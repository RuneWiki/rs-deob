...
public class class6 {
    ...
    @OriginalMember(owner = "client!BDUNOHSG", name = "f", descriptor = "[LBDUNOHSG;")
    public static class6[] field101;

    @OriginalMember(owner = "client!BDUNOHSG", name = "a", descriptor = "(LBYZSQZUF;Z)V")
    ...
    @OriginalMember(owner = "client!BDUNOHSG", name = "a", descriptor = "(ILIMUIZRAF;)V")
    ...
    @OriginalMember(owner = "client!BDUNOHSG", name = "a", descriptor = "(Z)LYABPKWWG;")
    ...
    @OriginalMember(owner = "client!BDUNOHSG", name = "c", descriptor = "(I)LYABPKWWG;")
