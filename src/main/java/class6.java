...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Lbt;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "([Ljd;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(ILbt;)V", line = 153)
