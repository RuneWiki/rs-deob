...
public class class6 extends class70 implements class196 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lqa;I)Lpj;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILqa;B)Lc;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Lqv;BLqa;IZII)V")
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lqa;Leu;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZILqa;I)Lfo;")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILqa;)V")
