...
public class class6 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(I)V", line = 77)
