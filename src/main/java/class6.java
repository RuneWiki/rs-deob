...
public class class6 {
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILgg;Lgg;IZ)Lef;", line = 55)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILgg;Lgg;)Lef;", line = 96)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)Z", line = 119)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lcq;Lpt;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 195)
