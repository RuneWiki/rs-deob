...
public class class6 extends class102 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "()V", line = 3)
    public static void method34() {
        field75 = null;
        field77 = null;
    }

    @OriginalMember(owner = "client!kr", name = "b", descriptor = "()Lop;", line = 7)
    public final class352 method35() {
        return this.field84;
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lii;J[Lho;[Lkg;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "()V", line = 20)
    public final void method37() {
        this.field81 = true;
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lii;[Lho;Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "([Lkg;Z)V", line = 101)
    ...
    @OriginalMember(owner = "client!kr", name = "d", descriptor = "()V", line = 186)
    public final void method40() {
        this.field78 = true;
    }

    @OriginalMember(owner = "client!kr", name = "e", descriptor = "()V", line = 189)
    ...
    @OriginalMember(owner = "client!kr", name = "f", descriptor = "()V", line = 201)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lii;J)Z", line = 222)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIII)V", line = 283)
    ...
    @OriginalMember(owner = "client!kr", name = "g", descriptor = "()V", line = 291)
    private final void method45() {
        this.field78 = false;
    }

    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(J)V", line = 294)
