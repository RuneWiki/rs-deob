...
public class class6 {
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Lfo;)V", line = 108)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Z)Z", line = 91)
