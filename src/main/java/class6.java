...
@OriginalClass("client!CMUBOYNL")
public class class6 {

    @OriginalMember(owner = "client!CMUBOYNL", name = "f", descriptor = "I")
    public int field624 = -1;

    @OriginalMember(owner = "client!CMUBOYNL", name = "g", descriptor = "Z")
    public boolean field625 = false;

    @OriginalMember(owner = "client!CMUBOYNL", name = "h", descriptor = "Z")
    public boolean field626 = true;

    @OriginalMember(owner = "client!CMUBOYNL", name = "b", descriptor = "I")
    public static int field620;

    @OriginalMember(owner = "client!CMUBOYNL", name = "e", descriptor = "I")
    public int field623;

    @OriginalMember(owner = "client!CMUBOYNL", name = "i", descriptor = "I")
    public int field627;

    @OriginalMember(owner = "client!CMUBOYNL", name = "j", descriptor = "I")
    public int field628;

    @OriginalMember(owner = "client!CMUBOYNL", name = "k", descriptor = "I")
    public int field629;

    @OriginalMember(owner = "client!CMUBOYNL", name = "l", descriptor = "I")
    public int field630;

    @OriginalMember(owner = "client!CMUBOYNL", name = "m", descriptor = "I")
    public int field631;

    @OriginalMember(owner = "client!CMUBOYNL", name = "n", descriptor = "I")
    public int field632;

    @OriginalMember(owner = "client!CMUBOYNL", name = "d", descriptor = "Ljava/lang/String;")
    public String field622;

    @OriginalMember(owner = "client!CMUBOYNL", name = "a", descriptor = "Z")
    private static boolean field619;

    @OriginalMember(owner = "client!CMUBOYNL", name = "c", descriptor = "[LCMUBOYNL;")
    public static class6[] field621;

    @OriginalMember(owner = "client!CMUBOYNL", name = "a", descriptor = "(ZLEAXVDNXA;)V")
    ...
    @OriginalMember(owner = "client!CMUBOYNL", name = "a", descriptor = "(BLCKBTFRZM;)V")
    ...
    @OriginalMember(owner = "client!CMUBOYNL", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!CMUBOYNL", name = "a", descriptor = "(III)I")
