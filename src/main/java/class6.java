...
public abstract class class6 {
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(IIIII)V", line = 327)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BI)Lce;", line = 277)
