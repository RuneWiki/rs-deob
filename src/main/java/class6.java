...
public class class6 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ldk;Ldk;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I[S)[S", line = 37)
