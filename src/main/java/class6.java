...
public class class6 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IBI)I", line = 5)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)Lot;", line = 67)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Los;Ln;)V", line = 130)
