...
public class class6 extends class787 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!ie", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BLjava/awt/event/MouseEvent;)I", line = 32)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 79)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field85++;
        this.method118((byte) -99, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(I)Lgn;", line = 98)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(B)Z", line = 113)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 125)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method118((byte) -53, arg0.getY(), arg0.getX());
        field74++;
    }

    @OriginalMember(owner = "client!ie", name = "e", descriptor = "(B)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(IIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!ie", name = "d", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!ie", name = "e", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!ie", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 206)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 230)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method118((byte) 50, arg0.getY(), arg0.getX());
        field65++;
    }

    @OriginalMember(owner = "client!ie", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 238)
    ...
    @OriginalMember(owner = "client!ie", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 248)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        field69++;
        this.method118((byte) 102, arg0.getY(), arg0.getX());
    }

    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Z)I", line = 261)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(BII)V", line = 272)
    ...
    @OriginalMember(owner = "client!ie", name = "f", descriptor = "(B)V", line = 291)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 302)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(B)V", line = 319)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 354)
