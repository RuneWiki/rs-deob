...
public class class6 extends class71 {
    ...
    @OriginalMember(owner = "client!CHUIKYUV", name = "ub", descriptor = "LAUWOQLEO;")
    ...
    @OriginalMember(owner = "client!CHUIKYUV", name = "a", descriptor = "(B)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!CHUIKYUV", name = "a", descriptor = "(I)LIGXVZOHI;")
