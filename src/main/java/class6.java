...
public class class6 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(B)Leb;", line = 68)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(ILeb;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(IIILeb;)V", line = 146)
