...
@OriginalClass("client!BBMKAXRK")
public class class6 {

    @OriginalMember(owner = "client!BBMKAXRK", name = "a", descriptor = "I")
    private int field135;

    @OriginalMember(owner = "client!BBMKAXRK", name = "c", descriptor = "I")
    public int field137;

    @OriginalMember(owner = "client!BBMKAXRK", name = "h", descriptor = "Z")
    private boolean field142;

    @OriginalMember(owner = "client!BBMKAXRK", name = "b", descriptor = "[B")
    public byte[] field136;

    @OriginalMember(owner = "client!BBMKAXRK", name = "d", descriptor = "[I")
    public int[] field138;

    @OriginalMember(owner = "client!BBMKAXRK", name = "e", descriptor = "[I")
    public int[] field139;

    @OriginalMember(owner = "client!BBMKAXRK", name = "f", descriptor = "[I")
    public int[] field140;

    @OriginalMember(owner = "client!BBMKAXRK", name = "g", descriptor = "[I")
    public int[] field141;

    @OriginalMember(owner = "client!BBMKAXRK", name = "<init>", descriptor = "(B[B)V")
    ...
    @OriginalMember(owner = "client!BBMKAXRK", name = "a", descriptor = "(B[B)V")
    ...
    @OriginalMember(owner = "client!BBMKAXRK", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
