...
@OriginalClass("client!COIHKGSL")
public class class6 {

    @OriginalMember(owner = "client!COIHKGSL", name = "a", descriptor = "I")
    public int field566 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "d", descriptor = "I")
    public int field569 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "h", descriptor = "I")
    public int field573 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "i", descriptor = "I")
    private int field574 = -261;

    @OriginalMember(owner = "client!COIHKGSL", name = "l", descriptor = "I")
    public int field577 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "n", descriptor = "I")
    public int field579 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "o", descriptor = "Z")
    public boolean field580 = true;

    @OriginalMember(owner = "client!COIHKGSL", name = "p", descriptor = "I")
    public int field581 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "q", descriptor = "I")
    public int field582 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "t", descriptor = "I")
    private int field585 = -548;

    @OriginalMember(owner = "client!COIHKGSL", name = "w", descriptor = "I")
    public int field588 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "B", descriptor = "B")
    public byte field593 = 1;

    @OriginalMember(owner = "client!COIHKGSL", name = "C", descriptor = "I")
    private int field594 = 128;

    @OriginalMember(owner = "client!COIHKGSL", name = "D", descriptor = "Z")
    public boolean field595 = false;

    @OriginalMember(owner = "client!COIHKGSL", name = "F", descriptor = "I")
    public int field597 = -1;

    @OriginalMember(owner = "client!COIHKGSL", name = "G", descriptor = "I")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "J", descriptor = "I")
    public int field601 = 32;

    @OriginalMember(owner = "client!COIHKGSL", name = "L", descriptor = "Z")
    public boolean field603 = true;

    @OriginalMember(owner = "client!COIHKGSL", name = "M", descriptor = "J")
    public long field604 = -1L;

    @OriginalMember(owner = "client!COIHKGSL", name = "N", descriptor = "I")
    private int field605 = 128;

    @OriginalMember(owner = "client!COIHKGSL", name = "k", descriptor = "LECXUVDNP;")
    public static class12 field576 = new class12(0, 30);

    @OriginalMember(owner = "client!COIHKGSL", name = "e", descriptor = "I")
    private int field570;

    @OriginalMember(owner = "client!COIHKGSL", name = "j", descriptor = "I")
    public static int field575;

    @OriginalMember(owner = "client!COIHKGSL", name = "y", descriptor = "I")
    private int field590;

    @OriginalMember(owner = "client!COIHKGSL", name = "A", descriptor = "I")
    private static int field592;

    @OriginalMember(owner = "client!COIHKGSL", name = "K", descriptor = "I")
    private int field602;

    @OriginalMember(owner = "client!COIHKGSL", name = "E", descriptor = "LMQZHAILV;")
    private static class33 field596;

    @OriginalMember(owner = "client!COIHKGSL", name = "m", descriptor = "Lclient;")
    public static client field578;

    @OriginalMember(owner = "client!COIHKGSL", name = "x", descriptor = "Ljava/lang/String;")
    public String field589;

    @OriginalMember(owner = "client!COIHKGSL", name = "c", descriptor = "[B")
    public byte[] field568;

    @OriginalMember(owner = "client!COIHKGSL", name = "b", descriptor = "[I")
    private static int[] field567;

    @OriginalMember(owner = "client!COIHKGSL", name = "g", descriptor = "[I")
    private int[] field572;

    @OriginalMember(owner = "client!COIHKGSL", name = "r", descriptor = "[I")
    public int[] field583;

    @OriginalMember(owner = "client!COIHKGSL", name = "s", descriptor = "[I")
    private int[] field584;

    @OriginalMember(owner = "client!COIHKGSL", name = "v", descriptor = "[I")
    private int[] field587;

    @OriginalMember(owner = "client!COIHKGSL", name = "z", descriptor = "[I")
    private int[] field591;

    @OriginalMember(owner = "client!COIHKGSL", name = "f", descriptor = "[LCOIHKGSL;")
    private static class6[] field571;

    @OriginalMember(owner = "client!COIHKGSL", name = "u", descriptor = "[Ljava/lang/String;")
    public String[] field586;

    @OriginalMember(owner = "client!COIHKGSL", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "a", descriptor = "(IZ[II)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "a", descriptor = "(I)LCOIHKGSL;")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "a", descriptor = "(LCXFTMSCH;)V")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "b", descriptor = "(I)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!COIHKGSL", name = "c", descriptor = "(I)LCOIHKGSL;")
