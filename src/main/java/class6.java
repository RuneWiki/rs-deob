...
public abstract class class6 extends class525 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!ie", name = "e", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(I)V", line = 86)
    public class6(int arg0) {
        this.field32 = arg0;
    }

    @OriginalMember(owner = "client!ie", name = "f", descriptor = "(I)V", line = 96)
