...
public class class6 extends class96 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILbt;)V", line = 5)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!lq", name = "g", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIIZIII)V", line = 183)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)[[I", line = 203)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "()V", line = 282)
    public class6() {
        super(3, false);
    }

    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(II)[I", line = 285)
