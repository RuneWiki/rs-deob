...
public class class6 implements class194 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "()V", line = 7)
    public final void method44() {
        this.field94.field1927.glFramebufferRenderbufferEXT(36160, this.field93, 36161, 0);
        this.field93 = -1;
    }

    @OriginalMember(owner = "client!to", name = "finalize", descriptor = "()V", line = 11)
    protected final void finalize() throws Throwable {
        this.method45();
        super.finalize();
    }

    @OriginalMember(owner = "client!to", name = "b", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Lao;III)V", line = 39)
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(I)V", line = 30)
