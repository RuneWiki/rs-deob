...
public class class679 extends class603 {
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IBILkfa;IILfga;Lrda;)V", line = 17)
    ...
    @OriginalMember(owner = "client!cc", name = "<init>", descriptor = "(Ljn;Ljn;Lvaa;)V", line = 117)
    public class679(class668 arg0, class668 arg1, class435 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "([BIIIBII)Z", line = 121)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(B)V", line = 170)
    public static void method3854(byte arg0) {
        field9728 = null;
        int var1 = 104 / ((arg0 - -21) / 32);
    }

    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZII)V", line = 179)
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lun;Z)Lrp;", line = 193)
