...
public class class679 extends class601 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BI)[I", line = 11)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lee;BI)V", line = 118)
    ...
    @OriginalMember(owner = "client!gi", name = "e", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILvfa;I)V", line = 271)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)V", line = 315)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "()V", line = 380)
    public class679() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIII)V", line = 352)
