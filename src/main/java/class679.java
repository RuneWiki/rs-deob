...
public class class679 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILr;II)Z", line = 41)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IIIBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lr;III)V", line = 157)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IIILr;)V", line = 232)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(B)V", line = 304)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Leq;Lqh;)V", line = 315)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(I[[ZIZZI)V", line = 340)
