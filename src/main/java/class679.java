...
public class class679 {
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLsr;I)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(ILsr;B)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lsr;Ldm;IB)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lsr;B)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lsr;I)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(BLsr;)V")
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(Lsr;)V")
