...
public abstract class class679 {
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IB)[[[B", line = 19)
    ...
    @OriginalMember(owner = "client!vca", name = "<init>", descriptor = "(IIIII)V", line = 1053)
    ...
    @OriginalMember(owner = "client!vca", name = "b", descriptor = "(B)V", line = 813)
    ...
    @OriginalMember(owner = "client!vca", name = "a", descriptor = "(IIII)V", line = 833)
    ...
    @OriginalMember(owner = "client!vca", name = "c", descriptor = "(B)V", line = 1001)
