...
public class class679 implements class630 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(I)Lag;", line = 5)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(BLww;Lww;)V", line = 56)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(II)I", line = 78)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IIB)Ljava/lang/String;", line = 89)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lvfa;Lrq;IIIIIII)V", line = 131)
