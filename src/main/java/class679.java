...
public class class679 extends class665 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIIZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!hd", name = "f", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!hd", name = "g", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(B)J", line = 93)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(II)V", line = 108)
    public class679(int arg0, int arg1) {
        super.field7311 = (long) arg1 | (long) arg0 << 32;
    }

    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(B)I", line = 118)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IZIBI)V", line = 132)
