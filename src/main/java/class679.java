...
public class class679 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 31)
    public class679(String arg0, int arg1) {
        this.field9548 = arg1;
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lpl;Lfa;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!wl", name = "toString", descriptor = "()Ljava/lang/String;", line = 53)
