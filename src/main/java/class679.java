...
public class class679 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILmg;)I", line = 12)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(II)I", line = 43)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(B)[Lfia;", line = 57)
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(B)V", line = 70)
