...
public class class679 implements class437 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(B)Lad;", line = 3)
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(IIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(I)V", line = 42)
