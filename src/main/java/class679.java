...
public class class679 extends class333 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIIIIII)V", line = 445)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(I)V", line = 519)
    public class679(int arg0) {
        this.field9562 = arg0;
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ZIIB)V", line = 482)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)V", line = 506)
