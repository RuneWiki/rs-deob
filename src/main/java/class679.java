...
public class class679 extends class24 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ILjp;)V", line = 5)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lke;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZZZ)V", line = 53)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Z)V", line = 76)
