...
public class class679 extends class127 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mj", name = "g", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(IIIIIF)V", line = 41)
    public class679(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IF)V", line = 45)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(B)V", line = 58)
