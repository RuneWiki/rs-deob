...
public class class679 extends class213 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "()Lfq;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lam;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "()Lfq;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lme;Lam;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Lfq;)V")
    public final synchronized void method4980(class213 arg0) {
        arg0.method1824(1);
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lfq;)V")
