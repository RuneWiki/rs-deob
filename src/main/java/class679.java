...
public class class679 extends class517 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 20)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Luca;IIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IBIIIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Luca;IIII[BI)V", line = 100)
