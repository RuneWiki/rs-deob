...
public class class679 extends class134 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I[ILvi;[B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)V", line = 81)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "()V", line = 101)
    public class679() {
    }

    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "([B)V", line = 103)
