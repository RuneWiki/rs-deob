...
public class class679 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(ILkd;)Lwg;", line = 9)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(I)Lsr;", line = 61)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIII)I", line = 79)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(BILha;)Z", line = 91)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(B)V", line = 540)
    ...
    @OriginalMember(owner = "client!aea", name = "a", descriptor = "(IIIIIII)Lsn;", line = 560)
    ...
    @OriginalMember(owner = "client!aea", name = "<init>", descriptor = "(Llga;Llga;)V", line = 580)
