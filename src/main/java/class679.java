...
public class class679 extends class224 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(BLee;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(CIB)I", line = 34)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lgda;)V", line = 52)
