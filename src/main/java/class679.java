...
public class class679 extends Canvas {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lvq;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!fo", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 46)
    public final void paint(Graphics arg0) {
        this.field9495.paint(arg0);
        field9496++;
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(II)Z", line = 54)
    ...
    @OriginalMember(owner = "client!fo", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 83)
    public final void update(Graphics arg0) {
        this.field9495.update(arg0);
        field9492++;
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 92)
    public class679(Component arg0) {
        this.field9495 = arg0;
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 100)
