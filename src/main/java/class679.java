...
public class class679 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;I)V")
