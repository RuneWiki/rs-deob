...
public class class679 extends class214 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(ILofa;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!wia", name = "c", descriptor = "(II)[[I", line = 26)
    ...
    @OriginalMember(owner = "client!wia", name = "e", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IB)[I", line = 120)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "()V", line = 174)
    public class679() {
        super(3, false);
    }
}
