...
public class class679 extends class515 {
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(Lha;B)Liha;", line = 7)
    ...
    @OriginalMember(owner = "client!wq", name = "j", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(CI)C", line = 42)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lha;II)Z", line = 71)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(I)Z", line = 133)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lha;I)Lua;", line = 150)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZLha;)V", line = 281)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILha;IB)Z", line = 309)
    ...
    @OriginalMember(owner = "client!wq", name = "f", descriptor = "(B)I", line = 364)
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(I)Z", line = 385)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BII)Z", line = 402)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)I", line = 420)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(III)V", line = 442)
    ...
    @OriginalMember(owner = "client!wq", name = "m", descriptor = "(I)V", line = 539)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z)I", line = 550)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(B)Z", line = 577)
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(Z)V", line = 595)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BLha;ZILuq;II)V", line = 608)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIIZII)V", line = 624)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lsk;I)V", line = 718)
