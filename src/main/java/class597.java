...
public class class597 extends class328 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BILco;)V", line = 5)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(III)I", line = 24)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II)[I", line = 37)
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "()V", line = 105)
    public class597() {
        super(1, true);
    }
}
