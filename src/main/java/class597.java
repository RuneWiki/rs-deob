...
public class class597 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZ)Lac;")
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/String;I)Lnh;")
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lal;IZLnd;Lnd;)V")
