...
public abstract class class597 extends class209 {
    ...
    @OriginalMember(owner = "client!wda", name = "d", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!wda", name = "f", descriptor = "(I)V", line = 29)
    public void method226(int arg0) {
        int var2 = -115 / ((arg0 + 60) / 57);
        field8006++;
    }

    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 50)
