...
public class class597 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILqa;Lra;ZZII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ih", name = "toString", descriptor = "()Ljava/lang/String;", line = 173)
    public final String toString() {
        field8647++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!ih", name = "b", descriptor = "(B)Z", line = 206)
