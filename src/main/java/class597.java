...
public class class597 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "([Lmi;ILjava/lang/String;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "([Lmi;IIILjava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Ljava/lang/String;[Lmi;Z)I")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Ljava/lang/String;ZI[Lmi;)I")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Ljava/lang/String;[I[Ljava/lang/String;B[Lmi;)I")
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "([Lmi;ILjava/lang/String;I)I")
