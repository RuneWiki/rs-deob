...
public class class597 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lol;Z)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ZZLuf;)V")
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BILol;)V")
