...
public class class597 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)Lrj;", line = 5)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILrj;)V", line = 16)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(I)V", line = 199)
    public class597(int arg0) {
        this.field8450 = arg0;
    }

    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(IIIIII)V", line = 210)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Z[BB)Ljava/lang/Object;", line = 166)
