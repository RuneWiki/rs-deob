...
public class class597 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Ls;[[ILs;Lha;ILs;B)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IILmc;II[Leo;IIII)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "([Leo;Lha;I[[[I)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIILmc;I[Leo;I)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Z[[BIII[[B[Z[[BLha;Ltg;IIILdaa;)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Ls;[[IILs;Ls;ILha;)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ZLha;Ls;Ls;)V")
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIZILmc;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!kia", name = "<init>", descriptor = "(IIIZLvg;Lsc;)V")
