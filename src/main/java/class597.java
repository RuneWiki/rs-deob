...
public class class597 extends class333 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(III[[ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lgu;Lgu;IBZ)I", line = 265)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(SI)V", line = 366)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ZI)V", line = 381)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BI)Z", line = 394)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lmj;Lbh;Leq;[I)V", line = 438)
