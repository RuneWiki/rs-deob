...
public abstract class class597 extends class321 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/Class;", line = 6)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)Leda;", line = 48)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)V", line = 63)
