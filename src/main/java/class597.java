...
public class class597 extends class649 {
    ...
    @OriginalMember(owner = "client!jq", name = "c", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(II)I", line = 16)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;ZZII)V", line = 28)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(ZLofa;)Lgs;", line = 150)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!jq", name = "b", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(ILhs;)V", line = 189)
    public class597(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jq", name = "<init>", descriptor = "(Lhs;)V", line = 192)
    public class597(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IB)V", line = 198)
