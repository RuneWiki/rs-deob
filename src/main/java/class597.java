...
public abstract class class597 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I[Ltc;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/lang/String;IIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 98)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;IIILjava/util/Random;II[IIZI[I[Lxa;II)I", line = 128)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)I", line = 203)
    public static int method3238(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Lxa;IIII[ILjava/lang/String;I)V", line = 216)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 230)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;IIIIB)V", line = 264)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;IIILjava/util/Random;[Lxa;III[I)I", line = 291)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Ljava/lang/String;IIIII)V", line = 330)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 347)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lfa;IIILjava/lang/String;[Lxa;II[I)V", line = 424)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 577)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILpe;ZII)V", line = 605)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;)I", line = 626)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BIILjava/lang/String;II)V", line = 648)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([Lxa;[IILfa;IIIIIIIILjava/lang/String;IIII)I", line = 663)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 770)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILjava/lang/String;)V", line = 784)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Loa;Lsga;)V", line = 821)
    public class597(class43 arg0, class547 arg1) {
        this.field8072 = arg0;
        this.field8069 = arg1;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 830)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "([I[Lxa;ILjava/lang/String;[III[I)V", line = 861)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III)V", line = 1023)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIIIIILjava/lang/String;Lfa;I[II[Lxa;IIII)I", line = 1046)
