...
public class class597 extends class27 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IILvf;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Llj;Lud;)V", line = 55)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)Z", line = 76)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BZII)V", line = 89)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZI)V", line = 105)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILrc;)V", line = 121)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BZ)V", line = 196)
