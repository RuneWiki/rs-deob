...
public class class597 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIIIIIILga;BI)Z")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)Ldj;")
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Ler;ILjn;)V")
