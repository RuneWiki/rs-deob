...
public class class597 implements class102 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III)Z", line = 26)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)Lci;", line = 36)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(II)V", line = 53)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(JJ)J", line = 63)
