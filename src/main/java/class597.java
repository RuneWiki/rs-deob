...
public class class597 extends class127 implements class246 {
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)Lew;", line = 3)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lck;Lew;Z)V", line = 14)
    public class597(class221 arg0, class240 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field8280 = arg1;
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(B)Z", line = 36)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 58)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)I", line = 75)
    public final int method819(byte arg0) {
        ++field8282;
        return arg0 >= -108 ? -114 : super.method819((byte) -127);
    }

    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(III)Z", line = 87)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 110)
