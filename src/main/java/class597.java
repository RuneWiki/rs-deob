...
public class class597 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(FIIFF)F", line = 6)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZZB)V", line = 21)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IILri;)Lufa;", line = 910)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Z)V", line = 927)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IIIIII)V", line = 955)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 1059)
