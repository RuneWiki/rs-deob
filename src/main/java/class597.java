...
public class class597 extends class679 {
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)Lag;", line = 22)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Lvfa;Lrq;IIIIIIIII)V", line = 33)
