...
public class class597 extends class349 {
    ...
    @OriginalMember(owner = "client!wca", name = "b", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!wca", name = "d", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ILjava/lang/String;)V", line = 32)
    ...
    @OriginalMember(owner = "client!wca", name = "<init>", descriptor = "()V", line = 93)
    public class597() {
        super(0, true);
    }
}
