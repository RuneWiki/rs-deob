...
public class class597 {
    ...
    @OriginalMember(owner = "client!lca", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field8432++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(I)V", line = 25)
