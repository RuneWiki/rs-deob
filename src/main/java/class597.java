...
public class class597 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)Ljava/io/File;", line = 8)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/io/File;", line = 98)
    public static File method3304(String arg0, int arg1) {
        int var2 = 33 % ((-arg1 - 71) / 52);
        return method3303(field8318, 0, arg0, field8319);
    }

    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 112)
