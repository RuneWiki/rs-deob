...
public class class597 extends class294 {
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Luf;[I)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!im", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!im", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(ILvu;II)V")
    ...
    @OriginalMember(owner = "client!im", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lkd;IIII[[I[[II)V")
