...
public class class597 extends class583 {
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ILd;DIBLfp;Z)[I", line = 7)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ZLfp;IIZIDLd;)[I", line = 144)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Lfp;Ld;B)Z", line = 283)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ZILd;Lfp;II)[F", line = 350)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IIBI)I", line = 467)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(BI)V", line = 498)
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "()V", line = 520)
    public class597() {
    ...
    @OriginalMember(owner = "client!oea", name = "<init>", descriptor = "(Lee;)V", line = 536)
