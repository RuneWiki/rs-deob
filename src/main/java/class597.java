...
public abstract class class597 extends class488 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "([Lgga;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ev", name = "f", descriptor = "(I)Z", line = 87)
    ...
    @OriginalMember(owner = "client!ev", name = "f", descriptor = "(B)Z", line = 101)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 113)
    ...
    @OriginalMember(owner = "client!ev", name = "h", descriptor = "(I)[Lbaa;", line = 132)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(IIIIII)V", line = 144)
