...
public class class597 implements class34 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I)Lil;", line = 4)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)Z", line = 68)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 90)
