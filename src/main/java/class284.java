...
public class class284 implements Runnable {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZLfq;I)Lrf;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BILfq;[B)Lrf;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZLrf;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BLfq;I)Lrf;")
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Llt;)V")
