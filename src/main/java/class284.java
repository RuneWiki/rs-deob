...
public class class284 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(II)Ltp;", line = 4)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IB)V", line = 34)
    ...
    @OriginalMember(owner = "client!uea", name = "b", descriptor = "(IB)Lts;", line = 51)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(ILgga;B)Ljava/lang/String;", line = 99)
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Ljk;ILae;Lae;)V", line = 151)
