...
public class class284 extends class210 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IZII)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!aj", name = "e", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I[B[[B[I[II[[BI)I", line = 70)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IILr;I)Lda;", line = 129)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIILr;)Z", line = 177)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lvv;IIZLr;II)V", line = 200)
    ...
    @OriginalMember(owner = "client!aj", name = "finalize", descriptor = "()V", line = 219)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Lr;I)Lbca;", line = 231)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lq;Lda;BLr;)V", line = 303)
    ...
    @OriginalMember(owner = "client!aj", name = "i", descriptor = "(I)V", line = 339)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(I)I", line = 350)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ILr;)Lcr;", line = 362)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Lr;Z)V", line = 398)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(Z)Z", line = 419)
    ...
    @OriginalMember(owner = "client!aj", name = "g", descriptor = "(I)Z", line = 435)
    ...
    @OriginalMember(owner = "client!aj", name = "f", descriptor = "(I)I", line = 446)
