...
public class class284 extends class466 {
    ...
    @OriginalMember(owner = "client!ft", name = "<init>", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "([ILum;I[IIB)Lgi;", line = 8)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lps;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ft", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(IZFFIIIF[FFI)V", line = 125)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lr;ILjo;)I", line = 215)
    ...
    @OriginalMember(owner = "client!ft", name = "a", descriptor = "(Lmv;IIIIIZJ)V", line = 244)
