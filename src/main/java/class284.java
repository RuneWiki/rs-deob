...
public class class284 extends class675 implements class624 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lkf;Lha;IIIZI)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lbk;I)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BLha;)Lck;")
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lha;IIB)Z")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Laha;[[BZ)V")
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(ILha;)Lww;")
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lee;B)Ljava/lang/String;")
