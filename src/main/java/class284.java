...
public class class284 extends class472 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lfh;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZLfh;)V", line = 30)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIII)I", line = 58)
