...
public class class284 implements class233 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(I)V", line = 29)
    public class284(int arg0) {
        this.field3578 = arg0;
    }

    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(I)Lhm;", line = 40)
