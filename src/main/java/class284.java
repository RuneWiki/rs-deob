...
public class class284 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;)V", line = 5)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;B)Ljava/lang/Object;", line = 14)
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "([Ljava/lang/Object;Ljava/lang/String;Ljava/applet/Applet;I)Ljava/lang/Object;", line = 24)
