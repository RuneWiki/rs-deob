...
public class class284 extends class779 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZZII)V", line = 40)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(B)Z", line = 52)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lgj;Lgj;Lwv;)V", line = 65)
    public class284(class662 arg0, class662 arg1, class37 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIZ)V", line = 69)
