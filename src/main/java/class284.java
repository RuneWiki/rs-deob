...
public class class284 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IZILqp;III)V", line = 20)
    ...
    @OriginalMember(owner = "client!lg", name = "toString", descriptor = "()Ljava/lang/String;", line = 77)
    public final String toString() {
        field3818++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(II)V", line = 84)
