...
public class class284 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILwn;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILwn;)V")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IB)Lqe;")
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILtf;)V")
