...
public class class284 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILic;Lqa;)V", line = 62)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IIIII)V", line = 196)
