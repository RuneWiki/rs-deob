...
public class class284 implements Runnable {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IJZIILga;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!th", name = "finalize", descriptor = "()V", line = 82)
    protected final void finalize() {
        field3743++;
        this.method1679(1);
    }

    @OriginalMember(owner = "client!th", name = "d", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!th", name = "e", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!th", name = "f", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!th", name = "g", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!th", name = "run", descriptor = "()V", line = 172)
    ...
    @OriginalMember(owner = "client!th", name = "h", descriptor = "(I)I", line = 249)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II[BI)V", line = 270)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Ljava/net/Socket;Lgba;)V", line = 369)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(II[BI)V", line = 338)
