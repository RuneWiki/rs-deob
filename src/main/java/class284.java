...
public class class284 extends class167 implements class303 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IBILza;)Z")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILza;B)Le;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BLza;)Lql;")
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(Lza;I)V")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Llb;IZIBILza;)V")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(IIILin;)V")
