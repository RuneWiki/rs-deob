...
public abstract class class284 {
    ...
    @OriginalMember(owner = "client!kba", name = "b", descriptor = "(IJ)I", line = 19)
    ...
    @OriginalMember(owner = "client!kba", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!kba", name = "a", descriptor = "(BILfca;ILfa;IJII)V", line = 144)
