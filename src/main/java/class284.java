...
public class class284 extends class111 implements class103 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZZI)V", line = 14)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lkaa;Lfca;IIZ[BII)V", line = 24)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIII[IIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)I", line = 133)
    public final int method764(boolean arg0) {
        return arg0 ? 33 : this.field3851;
    }

    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lkaa;Lfca;Lbv;II)V", line = 144)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZIIIIIILfca;[B)V", line = 165)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IF)F", line = 207)
    public final float method758(int arg0, float arg1) {
        return arg0 == 12943 ? arg1 / (float) this.field3850 : 0.92662424F;
    }

    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lkaa;IIZ[III)V", line = 216)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(FI)F", line = 274)
    public final float method761(float arg0, int arg1) {
        return arg1 == -22297 ? arg0 / (float) this.field3851 : -0.04100604F;
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ILfw;)V", line = 284)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 294)
    public final IDirect3DBaseTexture method799(int arg0) {
        return arg0 == -25567 ? this.field3853 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)I", line = 304)
