...
public class class284 extends class147 implements class503 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIBI)V", line = 38)
    ...
    @OriginalMember(owner = "client!dg", name = "d", descriptor = "(I)I", line = 72)
    public final int method490(int arg0) {
        ++field3916;
        return arg0 != -29679 ? -102 : this.field3903 & 65535;
    }

    @OriginalMember(owner = "client!dg", name = "e", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZIILya;)Lso;", line = 99)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)Z", line = 130)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lya;B)Lmf;", line = 143)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(ILya;)V", line = 173)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lya;Ljo;IIIIZIIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lya;II)Lt;", line = 227)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILya;)V", line = 250)
    ...
    @OriginalMember(owner = "client!dg", name = "i", descriptor = "(I)I", line = 279)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BLya;I)Lt;", line = 290)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(ILya;)V", line = 303)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZILya;I)Z", line = 313)
