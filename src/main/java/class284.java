...
public class class284 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ZB)V", line = 7)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lua;I)I", line = 36)
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)V", line = 71)
