...
public class class284 extends class303 implements class149 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Le;IB)Lid;")
    ...
    @OriginalMember(owner = "client!np", name = "b", descriptor = "(Le;B)V")
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Le;Lfa;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IIILe;)Z")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Le;I)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Ltf;BLtf;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ZI[Lne;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Le;Z)Lum;")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Le;B)V")
