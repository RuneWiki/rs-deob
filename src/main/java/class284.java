...
public class class284 extends class96 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIIIILhi;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!e", name = "g", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!e", name = "b", descriptor = "(II)[I", line = 67)
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(II)Z", line = 106)
    ...
    @OriginalMember(owner = "client!e", name = "<init>", descriptor = "()V", line = 127)
    public class284() {
        super(1, true);
    }
}
