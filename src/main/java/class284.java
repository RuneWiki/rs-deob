...
public class class284 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(Lej;)V")
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(ILeq;ILeq;)V")
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(IIZLdm;I)V")
