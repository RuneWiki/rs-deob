...
public class class284 extends class306 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "([ILpg;IBII)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IBLpg;)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lkd;B)I")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "()Lca;")
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "()Lca;")
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Ljo;)V")
