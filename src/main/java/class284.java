...
public class class284 extends class170 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILrg;B)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Ljb;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lea;)V")
