...
public class class284 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lha;IIIIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "([IIIII)V", line = 41)
