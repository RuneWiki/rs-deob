...
public class class284 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Llk;Z)Lpj;", line = 6)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZB)V", line = 25)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IZ)Lfa;", line = 93)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Ldk;ILfc;)V", line = 125)
