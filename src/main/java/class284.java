...
public abstract class class284 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILro;I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lro;ILro;IIIZII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Ldc;I)Lao;")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ILro;Lro;IZIIII[II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BIIIZILega;Z[Z[ILmp;Lmp;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lro;IIIIIIIILro;Lro;ZI[ZLro;)V")
