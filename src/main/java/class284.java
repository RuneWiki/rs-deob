...
public class class284 extends class312 {
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(II)V", line = 23)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIII[III)V", line = 123)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(IIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III)V", line = 157)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "([I)V", line = 182)
    ...
    @OriginalMember(owner = "client!kv", name = "c", descriptor = "()I", line = 193)
    public final int method1634() {
        field3286++;
        return this.field3308 + this.field3303 + this.field3310.field9120;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIIII)V", line = 309)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IILaa;II)V", line = 445)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "()I", line = 504)
    public final int method1636() {
        field3285++;
        return this.field3306 + this.field3300 + this.field3310.field9126;
    }

    @OriginalMember(owner = "client!kv", name = "b", descriptor = "()I", line = 512)
    public final int method1637() {
        field3301++;
        return this.field3310.field9126;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(FFFFFFIIII)V", line = 520)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lpc;IIZ)V", line = 769)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lpc;IIII)V", line = 779)
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Lpc;II[III)V", line = 789)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZ)V", line = 592)
    ...
    @OriginalMember(owner = "client!kv", name = "d", descriptor = "()I", line = 627)
    public final int method1640() {
        field3289++;
        return this.field3310.field9120;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIIII)V", line = 636)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 679)
