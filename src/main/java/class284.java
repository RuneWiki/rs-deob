...
public class class284 extends class264 {
    ...
    @OriginalMember(owner = "client!ag", name = "f", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "()V", line = 30)
    public class284() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(BI)[[I", line = 38)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLkk;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(II)[I", line = 138)
