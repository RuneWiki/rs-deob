...
public class class284 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(ZLvw;)Z")
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lji;I)V")
    ...
    @OriginalMember(owner = "client!vw", name = "<init>", descriptor = "(Lji;)V")
