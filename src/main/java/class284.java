...
public class class284 extends class382 {
    ...
    @OriginalMember(owner = "client!ria", name = "b", descriptor = "(B)I", line = 5)
    public final int method779(byte arg0) {
        int var2 = -67 % ((arg0 + 14) / 60);
        return this.field4030;
    }

    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!ria", name = "c", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!ria", name = "b", descriptor = "(I)I", line = 40)
    public final int method778(int arg0) {
        return arg0 == 0 ? this.field4032 : -86;
    }

    @OriginalMember(owner = "client!ria", name = "d", descriptor = "(I)J", line = 50)
