...
public class class284 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lg;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "(I)V", line = 86)
