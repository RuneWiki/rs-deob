...
public abstract class class284 {
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(I)[Lse;", line = 3)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(Z)Z", line = 20)
    ...
    @OriginalMember(owner = "client!tfa", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!tfa", name = "d", descriptor = "(B)V", line = 51)
