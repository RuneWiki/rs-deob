...
public class class284 {
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(BLig;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(BLjava/lang/String;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ria", name = "a", descriptor = "(IZLig;)V", line = 119)
