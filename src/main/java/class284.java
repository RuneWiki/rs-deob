...
public class class284 extends class457 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lvo;)V", line = 9)
    public final void method63(class205 arg0) {
        this.field6752.method1160(arg0);
    }

    @OriginalMember(owner = "client!aa", name = "b", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "()Z", line = 30)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lks;)V", line = 53)
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "()V", line = 162)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Z)V", line = 224)
    public final void method62(boolean arg0) {
        this.field6752.method1161(8448, 7681);
    }

    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(I)V", line = 233)
