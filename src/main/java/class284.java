...
public class class284 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILiv;I)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZLac;Lac;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Liv;B)V")
