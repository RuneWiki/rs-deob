...
public class class284 implements Runnable {
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILhc;)V", line = 7)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ef", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(Lwe;II)Lhc;", line = 112)
    ...
    @OriginalMember(owner = "client!ef", name = "<init>", descriptor = "(Lml;)V", line = 320)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILwe;I[B)Lhc;", line = 152)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(II)Lmj;", line = 171)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ZII)V", line = 203)
    ...
    @OriginalMember(owner = "client!ef", name = "b", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!ef", name = "a", descriptor = "(ILwe;B)Lhc;", line = 297)
