...
public class class467 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BIILqa;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(Z)V", line = 483)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)Z", line = 499)
