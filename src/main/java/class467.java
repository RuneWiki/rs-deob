...
public class class467 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(B)Lko;", line = 3)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IFFF)F", line = 15)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "([Lko;I)I", line = 27)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(B)I", line = 76)
    ...
    @OriginalMember(owner = "client!rda", name = "b", descriptor = "(I)Lko;", line = 87)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(JB)Lko;", line = 117)
    ...
    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!rda", name = "d", descriptor = "(I)I", line = 215)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Lko;JI)V", line = 251)
    ...
    @OriginalMember(owner = "client!rda", name = "e", descriptor = "(I)Lko;", line = 269)
