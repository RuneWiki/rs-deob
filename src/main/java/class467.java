...
public class class467 extends class311 {
    ...
    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(I)V", line = 10)
    public static void method2815(int arg0) {
        field6572 = null;
        int var1 = -89 / ((arg0 - 8) / 39);
    }

    @OriginalMember(owner = "client!nd", name = "b", descriptor = "(IIB)B", line = 21)
    ...
    @OriginalMember(owner = "client!nd", name = "c", descriptor = "(I)[Luq;", line = 52)
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(IC)Z", line = 133)
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(II[I[I)V", line = 175)
