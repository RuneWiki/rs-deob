...
public class class467 extends class403 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(III)V", line = 211)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Lpg;IIIIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)Lgi;", line = 237)
