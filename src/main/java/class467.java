...
public class class467 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(II)V", line = 124)
