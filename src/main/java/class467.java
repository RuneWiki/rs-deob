...
public class class467 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)Ljda;", line = 4)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "()V", line = 30)
    public class467() {
    }

    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)Ljda;", line = 35)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(III)V", line = 61)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Ljh;)V", line = 81)
    public class467(class158 arg0) {
        this.field6735 = arg0;
    }

    @OriginalMember(owner = "client!so", name = "b", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Laf;II)Z", line = 110)
