...
public class class467 extends class683 implements class511 {
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lag;ILjaclib/memory/Buffer;)V", line = 4)
    public class467(class469 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field6132 = arg1;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BI[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lag;I[BI)V", line = 27)
    public class467(class469 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field6132 = arg1;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)I", line = 62)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(Z)V", line = 73)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)J", line = 84)
