...
public class class467 extends class489 {
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(IIII)[B", line = 7)
    ...
    @OriginalMember(owner = "client!gh", name = "e", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!gh", name = "c", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BI)I", line = 67)
