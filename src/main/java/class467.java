...
public class class467 extends class96 {
    ...
    @OriginalMember(owner = "client!od", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 35)
    public class467() {
        super(0, true);
    }

    @OriginalMember(owner = "client!od", name = "e", descriptor = "(III)I", line = 40)
