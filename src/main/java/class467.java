...
public class class467 extends class5 {
    ...
    @OriginalMember(owner = "client!u", name = "b", descriptor = "(IIII)I", line = 4)
    ...
    @OriginalMember(owner = "client!u", name = "i", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(II)[I", line = 46)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(ILes;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!u", name = "<init>", descriptor = "()V", line = 254)
    public class467() {
        super(1, false);
    }

    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IZ)[[I", line = 188)
