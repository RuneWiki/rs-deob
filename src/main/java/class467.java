...
public class class467 extends class393 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(CIIIZLua;II)V")
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Luca;Lfo;[Lut;Z)V")
    ...
    @OriginalMember(owner = "client!wt", name = "OA", descriptor = "(CIIIZ)V")
