...
public class class467 extends class36 {
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!rc", name = "g", descriptor = "(I)Lmh;", line = 48)
    ...
    @OriginalMember(owner = "client!rc", name = "h", descriptor = "(I)I", line = 72)
    public final int method2855(int arg0) {
        ++field6931;
        return arg0 != -18737 ? -69 : (int) super.field4676;
    }

    @OriginalMember(owner = "client!rc", name = "i", descriptor = "(I)J", line = 86)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(B)I", line = 100)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(II)V", line = 115)
