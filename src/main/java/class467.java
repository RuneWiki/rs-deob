...
public abstract class class467 extends class184 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lr;III[Z)Z")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(III)Lffa;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lvd;ILvd;Lvd;Lvd;)V")
