...
public class class467 extends class337 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BILhp;)V", line = 16)
    ...
    @OriginalMember(owner = "client!mj", name = "i", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(BB)C", line = 40)
    ...
    @OriginalMember(owner = "client!mj", name = "j", descriptor = "(I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "()V", line = 213)
    public class467() {
        super(0, false);
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZZ)V", line = 98)
    ...
    @OriginalMember(owner = "client!mj", name = "k", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)[[I", line = 223)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Lya;ZLul;Lul;)V", line = 292)
    ...
    @OriginalMember(owner = "client!mj", name = "l", descriptor = "(I)V", line = 314)
    ...
    @OriginalMember(owner = "client!mj", name = "g", descriptor = "(I)I", line = 469)
