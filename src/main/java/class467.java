...
public class class467 {
    ...
    @OriginalMember(owner = "client!vj", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!vj", name = "<init>", descriptor = "(Luv;)V", line = 70)
    public class467(class385 arg0) {
    }

    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)I", line = 51)
