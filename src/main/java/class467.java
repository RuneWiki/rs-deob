...
public class class467 extends class1 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLkc;)V", line = 246)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 278)
