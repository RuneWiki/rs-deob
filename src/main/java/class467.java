...
public class class467 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(ILrk;)V")
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(II)Lkp;")
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(Ljk;ILae;)V")
