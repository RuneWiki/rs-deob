...
public class class467 extends class140 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)I", line = 107)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BIILqa;)Z", line = 121)
    public final boolean method138(byte arg0, int arg1, int arg2, class165 arg3) {
        ++field6968;
        return arg0 <= 121;
    }

    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 133)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(Z)Z", line = 190)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(ZLqa;)V", line = 202)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 285)
    ...
    @OriginalMember(owner = "client!bl", name = "f", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILqa;B)Lka;", line = 243)
    ...
    @OriginalMember(owner = "client!bl", name = "finalize", descriptor = "()V", line = 264)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILqa;)Lou;", line = 310)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILa;IIILqa;Z)V", line = 344)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lqa;BLka;)V", line = 356)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(B)V", line = 380)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(I[S)[S", line = 392)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIIII)V", line = 414)
