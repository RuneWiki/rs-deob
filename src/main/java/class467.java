...
public class class467 extends class264 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(ILmfa;)V", line = 42)
    public class467(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!qv", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IB)V", line = 59)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "(B)I", line = 94)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BIIIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lmfa;)V", line = 136)
    public class467(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BI)I", line = 147)
