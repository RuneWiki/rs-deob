...
public class class467 extends class260 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IBI)V", line = 84)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(Z)[Liu;", line = 94)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)V", line = 138)
