...
public class class467 extends class121 implements Runnable {
    ...
    @OriginalMember(owner = "client!og", name = "run", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(ILjj;)V", line = 33)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIIIZZ)V", line = 63)
    ...
    @OriginalMember(owner = "client!og", name = "b", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Los;)V", line = 173)
    public class467(class311 arg0) {
        this.field6519 = arg0;
    }

    @OriginalMember(owner = "client!og", name = "c", descriptor = "(I)V", line = 145)
