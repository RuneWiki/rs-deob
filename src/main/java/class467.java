...
public class class467 {
    ...
    @OriginalMember(owner = "client!sv", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    public final String toString() {
        field6864++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(Lat;IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ZLtn;)Ltn;", line = 95)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "(IIII)V", line = 115)
