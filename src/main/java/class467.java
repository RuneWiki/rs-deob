...
public class class467 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILps;)V", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)V", line = 45)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILps;I)V", line = 147)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(II)V", line = 186)
