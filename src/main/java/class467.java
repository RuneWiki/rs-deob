...
public class class467 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(JI)Lbp;")
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)Lbp;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BLbp;J)V")
