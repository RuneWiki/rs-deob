...
public class class467 extends class164 {
    ...
    @OriginalMember(owner = "client!ve", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BLfa;Ljn;)Z", line = 110)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IB)I", line = 166)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 188)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lfa;ILjn;IIZ)[F", line = 202)
    ...
    @OriginalMember(owner = "client!ve", name = "f", descriptor = "(I)[Lpc;", line = 318)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(DLfa;ZILjn;ZI)[I", line = 404)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "()V", line = 542)
    public class467() {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(ILjn;ZDZLfa;II)[I", line = 559)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IBI)Z", line = 699)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(Lun;)V", line = 711)
