...
public abstract class class467 extends class487 {
    ...
    @OriginalMember(owner = "client!og", name = "d", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIILog;)V", line = 15)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIILqa;ZLee;Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Z)V", line = 99)
