...
public class class467 extends class666 {
    ...
    @OriginalMember(owner = "client!dk", name = "d", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!dk", name = "d", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILiaa;Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "()V", line = 53)
    public class467() {
        super(0, false);
    }

    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IB)[[I", line = 60)
    ...
    @OriginalMember(owner = "client!dk", name = "c", descriptor = "(I)V", line = 131)
