...
public abstract class class467 extends class280 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Z[BB)Ljava/lang/Object;", line = 9)
    ...
    @OriginalMember(owner = "client!pi", name = "f", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIII)Z", line = 52)
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(IIII)V", line = 78)
