...
public class class467 extends class646 {
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IBIIIIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "()V", line = 125)
    public class467() {
        super(1, true);
    }

    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(IB)[I", line = 133)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lek;IB)V", line = 205)
    ...
    @OriginalMember(owner = "client!uf", name = "f", descriptor = "(I)V", line = 257)
