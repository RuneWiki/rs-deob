...
public class class467 {
    ...
    @OriginalMember(owner = "client!vaa", name = "d", descriptor = "Ljm;")
    private class687 field6676;
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(IILjm;)V", line = 12)
    private class467(int arg0, int arg1, class687 arg2) {
        this.field6674 = arg1;
        this.field6676 = arg2;
        this.field6677 = arg0;
        this.field6678 = this.field6676.field9690 * this.field6674;
        if (this.field6677 >= 16) {
            throw new RuntimeException();
        }
    }

    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BI)Lvaa;", line = 30)
    public static final class467 method2829(byte arg0, int arg1) {
        field6675++;
        if (arg1 == 0) {
            return field6679;
        } else if (arg1 == 1) {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!vaa", name = "b", descriptor = "(I)V", line = 121)
    public static final void method2831(int arg0) {
        ...
        int var1 = 0;
        for (int var2 = 0; var2 < class489.field6976; var2++) {
            for (int var3 = 0; var3 < class153.field1677; var3++) {
                if (class607.method3443(class638.field9170, var1, true, var3, (byte) -118, var2)) {
                    var1++;
                }
                if (var1 >= 512) {
                    return;
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(III)Z", line = 157)
    public static final boolean method2832(int arg0, int arg1, int arg2) {
        if (arg0 == -1) {
            field6680++;
    ...
    @OriginalMember(owner = "client!vaa", name = "toString", descriptor = "()Ljava/lang/String;", line = 169)
