...
public class class467 extends class443 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lhq;[I)V", line = 2)
    public final void method1866(class190 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(Lph;IIIIZ)Z", line = 6)
    public final boolean method1871(class125 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "()V", line = 9)
    public final void method1868() {
        this.field6556 = null;
        this.field6570 = null;
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIZLit;[I[I[I)V", line = 17)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILph;)Lph;", line = 583)
    public final class125 method1869(int arg0, int arg1, class125 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lph;IIIIZ)V", line = 589)
    public final void method1864(class125 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIIIII[[Z)V", line = 593)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(II)I", line = 607)
    public final int method1861(int arg0, int arg1) {
        return this.field6555[arg0][arg1];
    }

    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Ld;IIII[[I[[II)V", line = 613)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(II)I", line = 678)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIIIII[[ZLit;[I[I)V", line = 698)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(IIIIIII[[ZLit;[I[I)V", line = 830)
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field6558[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field3806; ++var23) {
                            ...
                            } else if (var21.field3809 != null && var21.field3809[var23] != -1) {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III[[ZZ)V", line = 962)
    ...
    @OriginalMember(owner = "client!vh", name = "d", descriptor = "(II)I", line = 980)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 1009)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(II)V", line = 1503)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(III)V", line = 1515)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 1520)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)Z", line = 1749)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(Lph;IIIIZ)V", line = 1761)
    public final void method1858(class125 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IILit;[I[I[I)V", line = 1766)
