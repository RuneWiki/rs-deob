...
public class class467 extends class281 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Laj;Laj;Laj;ILaj;)V")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(Lwp;I)I")
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(II)Lsca;")
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(Lkw;Lsp;)V")
