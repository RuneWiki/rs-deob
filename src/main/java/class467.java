...
public class class467 extends class451 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(ZIB)V", line = 111)
    ...
    @OriginalMember(owner = "client!od", name = "d", descriptor = "(I)Lvb;", line = 126)
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IBII)[B", line = 143)
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "()V", line = 166)
    public class467() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!od", name = "c", descriptor = "(B)V", line = 170)
