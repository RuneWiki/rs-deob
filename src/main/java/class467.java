...
public class class467 {
    ...
    @OriginalMember(owner = "client!vaa", name = "<init>", descriptor = "(IILjm;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BI)Lvaa;")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(III)Z")
