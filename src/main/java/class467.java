...
public class class467 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lcea;IB)V", line = 45)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ILcea;)V", line = 303)
