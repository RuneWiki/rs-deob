...
public class class467 extends class330 implements class165 {
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Luda;IZ[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 67)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BLag;)V", line = 78)
