...
public class class474 extends class601 {
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(Lee;BI)V")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(B)Lpda;")
    ...
    @OriginalMember(owner = "client!maa", name = "a", descriptor = "(ZLfs;)V")
