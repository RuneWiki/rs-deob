...
public class class474 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II)Ljava/lang/String;", line = 6)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 34)
    public class474(String arg0, String arg1, String arg2, String arg3) {
        this.field7006 = new String[] { arg0, arg1, arg2, arg3 };
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILqd;IIIILtt;Leca;)V", line = 53)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!ea", name = "toString", descriptor = "()Ljava/lang/String;", line = 219)
