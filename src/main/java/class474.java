...
public class class474 extends class497 {
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(ILpp;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "<init>", descriptor = "(Lpp;)V")
    ...
    @OriginalMember(owner = "client!vb", name = "a", descriptor = "(IZLng;)V")
