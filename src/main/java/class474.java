...
public class class474 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZIZIZ)Lic;", line = 49)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "([I)V", line = 81)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZII)V", line = 120)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I[I)Ljava/lang/String;", line = 146)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZIII)I", line = 210)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(II)I", line = 246)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(Z)V", line = 273)
