...
public class class474 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(Z)I", line = 129)
    public static final int method2732(boolean arg0) {
        field6600++;
        return arg0 ? -74 : 19;
    }

    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(IIIIIIIIIZZI)V", line = 145)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)V", line = 166)
