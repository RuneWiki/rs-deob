...
public class class474 extends class59 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "(Llr;Lur;[Lg;[I[I)V")
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!qq", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "([B[IIIIIIII)V")
