...
public class class474 implements class525 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(Z)I", line = 74)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IJ)Z", line = 117)
    ...
    @OriginalMember(owner = "client!vq", name = "c", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "(Lok;Lul;)V", line = 149)
