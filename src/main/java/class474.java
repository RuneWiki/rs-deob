...
public class class474 extends class424 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nga", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 15)
    ...
    @OriginalMember(owner = "client!nga", name = "e", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(IIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!nga", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 69)
    ...
    @OriginalMember(owner = "client!nga", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 91)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method2784((byte) 122, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!nga", name = "c", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Ljava/awt/Component;Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(ZLjava/awt/event/MouseEvent;)I", line = 135)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(Z)Z", line = 161)
    ...
    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(B)Z", line = 172)
    public final boolean method2084(byte arg0) {
        int var2 = 26 / ((54 - arg0) / 50);
        return (this.field6765 & 0x4) != 0;
    }

    @OriginalMember(owner = "client!nga", name = "a", descriptor = "(BII)V", line = 180)
    ...
    @OriginalMember(owner = "client!nga", name = "g", descriptor = "(I)I", line = 199)
    public final int method2093(int arg0) {
        return arg0 == 22302 ? this.field6764 : 16;
    }

    @OriginalMember(owner = "client!nga", name = "d", descriptor = "(I)Llp;", line = 209)
    ...
    @OriginalMember(owner = "client!nga", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 219)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method2784((byte) 122, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!nga", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 226)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2784((byte) 122, arg0.getX(), arg0.getY());
    }

    @OriginalMember(owner = "client!nga", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 233)
    ...
    @OriginalMember(owner = "client!nga", name = "b", descriptor = "(Z)V", line = 242)
    ...
    @OriginalMember(owner = "client!nga", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 255)
    ...
    @OriginalMember(owner = "client!nga", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 310)
    public class474(Component arg0, boolean arg1) {
        this.method2782(arg0, false);
        this.field6771 = arg1;
    }

    @OriginalMember(owner = "client!nga", name = "h", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!nga", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 298)
