...
public class class474 extends class233 implements class502 {
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!pc", name = "f", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "([BIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!pc", name = "d", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lht;I[BIZ)V", line = 71)
    public class474(class410 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field6921 = arg1;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)J", line = 84)
