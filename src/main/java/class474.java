...
public class class474 extends class415 {
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!lq", name = "g", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Lnba;Ljava/lang/Object;I)V", line = 32)
    public class474(class249 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6693 = arg1;
    }

    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 46)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II[F)[F", line = 65)
