...
public class class474 extends class29 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lcu;I)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIILmq;)V")
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)Lcu;")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lli;I)V")
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lli;)V")
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lqa;Lbu;I)V")
