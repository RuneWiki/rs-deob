...
public class class474 extends class403 {
    ...
    @OriginalMember(owner = "client!ua", name = "b", descriptor = "(BI)I", line = 6)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(FFIFIIII[FFI)V", line = 80)
    ...
    @OriginalMember(owner = "client!ua", name = "<init>", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ILma;IIILuq;IILya;)V", line = 182)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ZIIII)V", line = 317)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(IB)Z", line = 337)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(ZI[[[Lfq;III)Z", line = 347)
    ...
    @OriginalMember(owner = "client!ua", name = "a", descriptor = "(B)V", line = 661)
