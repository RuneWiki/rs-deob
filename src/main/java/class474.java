...
public class class474 {
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!oga", name = "a", descriptor = "(B)V", line = 44)
