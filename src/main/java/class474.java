...
public class class474 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Leq;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Leq;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Leq;IZLjava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Leq;Ljava/lang/String;IIIZ)V")
