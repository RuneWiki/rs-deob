...
public class class474 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)Lpp;", line = 6)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)V", line = 26)
    public static void method2764(byte arg0) {
        field6909 = null;
        int var1 = 66 / ((arg0 - 59) / 59);
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILpp;)V", line = 35)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)Lpp;", line = 60)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "()V", line = 162)
    public class474() {
        this.field6911.field4675 = this.field6911;
        this.field6911.field4673 = this.field6911;
    }

    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(B)I", line = 119)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)Lpp;", line = 141)
