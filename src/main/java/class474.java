...
public class class474 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIZLr;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z[[ZIBII)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ILee;)Lra;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(ILr;IB)Z")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IIILr;)V")
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(Leea;Lio;)V")
