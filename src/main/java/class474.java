...
public abstract class class474 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(I[ZIZILeg;ILeg;Lvia;ZI[I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZLic;IILic;IIII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IZIILtd;I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lic;Lic;ILic;IIZI[ZILic;IIII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZIII[IIIZLic;ILic;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lic;II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIFIBLsb;FFIFFII[B)V")
