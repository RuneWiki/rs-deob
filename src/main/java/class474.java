...
public class class474 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(JI)Ltm;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lma;Lya;Lgo;IIIIII)V")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)Ltm;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ILtm;J)V")
