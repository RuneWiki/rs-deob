...
public class class474 {
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(Ltn;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(III)I", line = 94)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(II)[I", line = 134)
