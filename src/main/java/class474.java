...
public abstract class class474 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIIILta;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lcm;II)V", line = 132)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZLcm;IILcm;IIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Z)V", line = 205)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)I", line = 228)
    public static final int method2857(int arg0, int arg1) {
        field6861++;
        return arg0 >= -67 ? 113 : arg1 >>> 8;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "([IIZILcm;IIILcm;II)V", line = 239)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(II)Z", line = 297)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I[ZIILrl;Lmd;ZILrl;IZ[I)V", line = 325)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B[ZIIZIIIILcm;ILcm;ILcm;Lcm;)V", line = 539)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I[IIIIZI[III)V", line = 601)
