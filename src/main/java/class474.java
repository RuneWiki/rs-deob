...
public abstract class class474 extends class401 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IB)V", line = 7)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(B)Z", line = 30)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IBIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 78)
    ...
    @OriginalMember(owner = "client!uca", name = "c", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BLin;)Lin;", line = 115)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IIILks;IIIIILda;Lr;III)Lda;", line = 150)
    ...
    @OriginalMember(owner = "client!uca", name = "d", descriptor = "(B)I", line = 328)
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(III)V", line = 344)
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Llj;)V", line = 365)
    public class474(class565 arg0) {
        this.field6531 = arg0;
    }

    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(IBLjava/io/File;[B)V", line = 373)
