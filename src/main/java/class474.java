...
public class class474 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(B[B)Lnf;", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lrh;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ILfca;)V", line = 81)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Lfca;)V", line = 172)
