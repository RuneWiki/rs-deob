...
public class AnimFrame {
    ...
    @OriginalMember(owner = "client!h", name = "d", descriptor = "Lg;")
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "[Lh;")
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)Lh;")
