...
public class AnimFrame {
    ...
    @OriginalMember(owner = "client!g", name = "e", descriptor = "Lf;")
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "[Lg;")
    public static AnimFrame[] field89;

    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLub;)V")
