...
@OriginalClass("SQHJOGRT")
public class AnimFrame {

    @OriginalMember(owner = "SQHJOGRT", name = "a", descriptor = "I")
    private static int _flowObfuscator1 = -715;

    @OriginalMember(owner = "SQHJOGRT", name = "c", descriptor = "I")
    public int id;

    @OriginalMember(owner = "SQHJOGRT", name = "e", descriptor = "I")
    public int length;

    @OriginalMember(owner = "SQHJOGRT", name = "d", descriptor = "LKVCQPLIW;")
    public AnimBase base;

    @OriginalMember(owner = "SQHJOGRT", name = "f", descriptor = "[I")
    public int[] groups;

    @OriginalMember(owner = "SQHJOGRT", name = "g", descriptor = "[I")
    public int[] x;

    @OriginalMember(owner = "SQHJOGRT", name = "h", descriptor = "[I")
    public int[] y;

    @OriginalMember(owner = "SQHJOGRT", name = "i", descriptor = "[I")
    public int[] z;

    @OriginalMember(owner = "SQHJOGRT", name = "b", descriptor = "[LSQHJOGRT;")
    private static AnimFrame[] instances;

    @OriginalMember(owner = "SQHJOGRT", name = "j", descriptor = "[Z")
    private static boolean[] hasAlpha;

    @OriginalMember(owner = "SQHJOGRT", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "SQHJOGRT", name = "a", descriptor = "([BZ)V")
    ...
    @OriginalMember(owner = "SQHJOGRT", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "SQHJOGRT", name = "a", descriptor = "(II)LSQHJOGRT;")
    ...
    @OriginalMember(owner = "SQHJOGRT", name = "a", descriptor = "(IZ)Z")
