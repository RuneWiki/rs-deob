...
public class class788 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(I)V", line = 22)
    public static void method4357(int arg0) {
        int var1 = -1 % ((59 - arg0) / 42);
        field10862 = null;
    }

    @OriginalMember(owner = "client!f", name = "a", descriptor = "(III)Z", line = 31)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IBI)I", line = 41)
