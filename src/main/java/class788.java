...
public class class788 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(IIIBIIIIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)V", line = 635)
    public static void method4324(byte arg0) {
        field10816 = null;
        int var1 = 116 / ((-arg0 - 19) / 61);
    }

    @OriginalMember(owner = "client!jk", name = "toString", descriptor = "()Ljava/lang/String;", line = 652)
    public final String toString() {
        field10813++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(II)Ljava/lang/String;", line = 663)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 699)
