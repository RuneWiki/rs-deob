...
public class class788 extends class264 {
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(ILmfa;)V", line = 10)
    public class788(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(B)I", line = 43)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Z)Z", line = 55)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(BI)V", line = 75)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(Lmfa;)V", line = 86)
    public class788(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BI)I", line = 89)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(B)I", line = 104)
