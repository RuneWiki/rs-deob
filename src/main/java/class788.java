...
public class class788 extends class756 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)Lrfa;", line = 5)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lkp;I)V", line = 342)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(BLib;)V", line = 354)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(ILib;ILmca;)V", line = 373)
