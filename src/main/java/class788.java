...
public class class788 implements Runnable {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lmc;I)Lei;", line = 3)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!nh", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lko;Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILjava/lang/String;)Lie;", line = 101)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IIZJB)Ljava/lang/String;", line = 137)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 218)
    public class788() {
