...
public class class788 extends class90 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "([Lqr;Z)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;[Loea;Z)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IZ)Lf;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "()Lmf;")
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "()Lmf;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lha;J[Loea;[Lqr;Z)V")
