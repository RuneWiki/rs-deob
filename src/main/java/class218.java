...
public abstract class class218 {
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "(IILuu;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ll", name = "finalize", descriptor = "()V", line = 200)
    ...
    @OriginalMember(owner = "client!ll", name = "a", descriptor = "([BII)V", line = 210)
    ...
    @OriginalMember(owner = "client!ll", name = "c", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Ltt;I[BIZ)V", line = 260)
    ...
    @OriginalMember(owner = "client!ll", name = "<init>", descriptor = "(Ltt;ILjaggl/memory/NativeBuffer;IZ)V", line = 280)
