...
public class class218 extends class134 implements class531 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 23)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 30)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 37)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 59)
