...
public class class218 extends class35 implements class276 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III[[ZZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)V", line = 34)
    public final void method365(int arg0, int arg1) {
        this.field3132.method2778().method56(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lfk;[I)V", line = 151)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lj;IIIIZ)Z", line = 155)
    public final boolean method369(class377 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIIII[[Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 165)
