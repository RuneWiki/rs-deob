...
public class class218 extends class287 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(BII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(CI)I", line = 27)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(BII)Z", line = 58)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZIIZ)V", line = 72)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILvj;)V", line = 351)
    ...
    @OriginalMember(owner = "client!mu", name = "b", descriptor = "(CI)I", line = 380)
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lvj;BI)V", line = 415)
    ...
    @OriginalMember(owner = "client!mu", name = "d", descriptor = "(B)V", line = 478)
