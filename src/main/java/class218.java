...
public class class218 extends class155 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILfl;)V", line = 5)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lbr;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lfca;I)Leja;", line = 56)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIB)V", line = 96)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZZ)V", line = 115)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IZ)V", line = 127)
    ...
    @OriginalMember(owner = "client!sa", name = "g", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILha;IILd;II)V", line = 186)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lsf;)V", line = 272)
    ...
    @OriginalMember(owner = "client!sa", name = "e", descriptor = "(I)V", line = 385)
