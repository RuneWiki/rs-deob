...
public class class218 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Lr;IIIIIIZZ)V")
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ILie;)V")
    ...
    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(ILie;)Lmp;")
