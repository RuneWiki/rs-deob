...
public class class218 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ILha;)Lmq;")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(ILha;)Lmq;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lol;B)V")
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(Lha;I)Lmq;")
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(IILol;)V")
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(Lha;I)Lmq;")
