...
public class class218 extends class300 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIII)[B", line = 10)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIB)V", line = 23)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILbn;)V", line = 60)
