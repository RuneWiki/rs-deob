...
public class class218 extends class264 {
    ...
    @OriginalMember(owner = "client!vl", name = "h", descriptor = "(I)Lfl;")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(BLkk;I)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(Lrs;ZLrs;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(IIIIILtq;Lvc;)V")
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(ILfo;)I")
