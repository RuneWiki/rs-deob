...
public class class218 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lfs;II)Lbb;")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lfs;I)[Lbb;")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Lfs;II)[Lbb;")
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Lfs;I)Lbb;")
