...
public class class218 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lgg;IIIII)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)Lsk;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(JB)Lsk;")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(JLsk;I)V")
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)Lib;")
