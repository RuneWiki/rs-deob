...
public class class218 extends class65 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[Lvp;IIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(B)V", line = 684)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(III)Z", line = 694)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(I)V", line = 708)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(I)V", line = 728)
