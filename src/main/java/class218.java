...
public class class218 extends class35 implements class276 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIIII[[Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)V", line = 20)
    public final void method279(int arg0, int arg1) {
        this.field3154.method2797().method72(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 27)
    protected final void finalize() {
        class284.method1787(-24204, this);
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III[[ZZ)V", line = 31)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Ltj;[I)V", line = 156)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lj;IIIIZ)Z", line = 161)
