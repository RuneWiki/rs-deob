...
public class class218 extends class63 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lha;Z)Ltb;", line = 3)
    ...
    @OriginalMember(owner = "client!hm", name = "h", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!hm", name = "c", descriptor = "(BLha;)V", line = 27)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III)Z", line = 38)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lbj;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!hm", name = "f", descriptor = "(B)Z", line = 85)
    ...
    @OriginalMember(owner = "client!hm", name = "g", descriptor = "(B)Z", line = 96)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lha;IZI)Z", line = 107)
    ...
    @OriginalMember(owner = "client!hm", name = "d", descriptor = "(B)I", line = 156)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(BLha;)Lvw;", line = 184)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(IIIII)V", line = 407)
    public class218(int arg0, int arg1, int arg2, int arg3, int arg4) {
        super(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!hm", name = "e", descriptor = "(B)I", line = 363)
