...
public class class218 extends class125 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Lha;IIZ)Ler;", line = 3)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BI)V", line = 68)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIIIII)I", line = 97)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)I", line = 127)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(II)V", line = 141)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lgp;)V", line = 157)
    public class218(class549 arg0) {
        super(arg0);
        class517.method3141(-92, super.field1732);
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BIIIII)I", line = 165)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZI)I", line = 221)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)Z", line = 236)
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(Z)I", line = 252)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(ILgp;)V", line = 264)
    public class218(int arg0, class549 arg1) {
        super(arg0, arg1);
        class517.method3141(58, super.field1732);
    }

    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(Z)V", line = 272)
