...
public class class218 extends class267 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!jo", name = "d", descriptor = "(I)Lvb;", line = 194)
    public final class91 method1648(int arg0) {
        ++field3231;
        return arg0 != 8 ? null : class22.field327[super.field4008];
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lja;Lnf;IIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIILjs;Ljs;)V", line = 296)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZLja;)V", line = 306)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILdp;)V", line = 374)
