...
public class class218 extends class35 implements class276 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)V", line = 6)
    public final void method204(int arg0, int arg1) {
        this.field3199.method2802().method53(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lkt;[I)V", line = 10)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(III[[ZZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIIIIII[[Z)V", line = 149)
    ...
    @OriginalMember(owner = "client!b", name = "finalize", descriptor = "()V", line = 153)
    protected final void finalize() {
        class236.method1601(103, this);
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(Lj;IIIIZ)Z", line = 156)
    public final boolean method196(class377 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "(Lh;Lba;II[[I[[IIII)V", line = 159)
