...
public class class218 extends class596 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILte;IIII)V", line = 22)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lgd;II[B)V", line = 294)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lgd;II[I)V", line = 306)
