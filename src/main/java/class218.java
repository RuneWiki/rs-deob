...
public class class218 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)Ljca;", line = 20)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Lwo;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(B)Ljca;", line = 65)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "()V", line = 100)
    public class218() {
    }

    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Lwo;)V", line = 103)
