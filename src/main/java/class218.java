...
public class class218 extends class326 {
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "()V", line = 3)
    public class218() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(III)[B", line = 15)
