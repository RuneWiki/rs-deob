...
public class class218 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([JBI[Ljava/lang/Object;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IB)V", line = 116)
