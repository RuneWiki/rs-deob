...
public class class218 extends class115 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IILen;BLnl;I)V")
    ...
    @OriginalMember(owner = "client!ba", name = "h", descriptor = "(I)Ldh;")
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(BLbk;I)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
