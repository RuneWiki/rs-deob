...
public class class218 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lsi;IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IZII)V", line = 28)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IJ)V", line = 41)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Ljava/awt/Frame;Ldr;B)V", line = 130)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(B)V", line = 167)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(FI)F", line = 199)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IILsi;I)V", line = 213)
