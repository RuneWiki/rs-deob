...
public class class218 extends class367 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIZI)I", line = 7)
    ...
    @OriginalMember(owner = "client!ml", name = "f", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(BIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIZJ)Ljava/lang/String;", line = 61)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 140)
    public class218(Object arg0) {
        this.field3070 = arg0;
    }

    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(III)V", line = 148)
    ...
    @OriginalMember(owner = "client!ml", name = "f", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(B)Z", line = 202)
    public final boolean method934(byte arg0) {
        field3075++;
        return arg0 == -40 ? false : false;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 217)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(Z)Ljava/lang/Object;", line = 241)
