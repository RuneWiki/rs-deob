...
public class class218 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lqj;Lbe;ZLqj;Lqj;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZILcp;)Lba;", line = 21)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "()V", line = 106)
    private class218() {
    }
}
