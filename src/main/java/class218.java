...
public class class218 extends class50 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lql;IIIIZ[FI)V", line = 12)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lql;IIIIZ[IZ)V", line = 32)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lql;IIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZZ)V", line = 91)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIII[BIIIZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIII[IIIZ)V", line = 149)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "()V", line = 188)
    public final void method119() {
        this.field482.field4697.glFramebufferTexture2DEXT(36160, this.field2925, this.field484, 0, 0);
        this.field2925 = -1;
    }

    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lql;IIIIZ[BIZ)V", line = 193)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lql;IIIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIIIII)V", line = 256)
