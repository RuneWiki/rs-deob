...
public class class218 extends class270 implements class323 {
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(Lqa;B)Lvs;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ILeo;Leo;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lqa;I)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IZILqa;)Z")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(BLrn;ZIILqa;I)V")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lqa;ZBI)Ldf;")
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Lqa;Ljt;IIIIZIIZ)V")
