...
public class class218 extends class250 {
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "([I)V", line = 44)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ldr;)V", line = 59)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ldr;B)V", line = 81)
    ...
    @OriginalMember(owner = "client!rh", name = "e", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!rh", name = "d", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(III)V", line = 148)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(B)[F", line = 157)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(III)V", line = 179)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(IIIIII)V", line = 191)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(III[I)V", line = 236)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "()Lrh;", line = 246)
    ...
    @OriginalMember(owner = "client!rh", name = "c", descriptor = "(B)[F", line = 270)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "()V", line = 294)
    public class218() {
        this.method1388();
    }

    @OriginalMember(owner = "client!rh", name = "a", descriptor = "()V", line = 303)
