...
public class class218 extends class271 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Lhn;)Ldga;", line = 4)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
