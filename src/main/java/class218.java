...
public class class218 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(Lhe;Z)V")
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "(B)Lhe;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V")
