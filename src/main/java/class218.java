...
public class class218 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IB)I", line = 6)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I[FI)[F", line = 18)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(Lct;ZI)V", line = 85)
