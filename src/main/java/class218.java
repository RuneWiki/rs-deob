...
public abstract class class218 extends class243 {
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!hc", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(IIII)V", line = 38)
