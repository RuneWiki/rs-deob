...
public class class218 extends class40 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ZIZLij;)V", line = 4)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 63)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILkd;)V", line = 75)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lcp;Ljava/lang/Object;I)V", line = 115)
    public class218(class512 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field3584 = arg1;
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)Z", line = 123)
