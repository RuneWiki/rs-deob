...
public class class218 extends class291 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 692)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 705)
