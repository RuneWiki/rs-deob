...
public class class218 extends class460 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILjo;I)V")
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "(Lkfa;Lul;)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lba;I[BIIFIFFIFFI)V")
