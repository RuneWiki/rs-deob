...
public class class218 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(BLtj;)V", line = 18)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "()V", line = 43)
    public class218() {
    }

    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(B)I", line = 48)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(Llf;)V", line = 59)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(CBLjava/lang/String;)I", line = 76)
