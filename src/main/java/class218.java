...
public class class218 extends class44 implements class111 {
    ...
    @OriginalMember(owner = "client!ir", name = "e", descriptor = "(I)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ir", name = "h", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IILpe;I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)I", line = 63)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILpe;)V", line = 95)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpe;B)Lca;", line = 105)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)I", line = 131)
    public final int method580(int arg0) {
        ++field3007;
        return arg0 != 24493 ? 126 : this.field3023;
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpe;I)V", line = 143)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ZILhh;Lpe;III)V", line = 170)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpe;II)Lsj;", line = 204)
    public final class73 method576(class391 arg0, int arg1, int arg2) {
        ++field3027;
        return arg2 != -2705 ? null : this.method1495(arg0, arg1, false);
    }

    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!ir", name = "g", descriptor = "(B)[Luo;", line = 237)
    ...
    @OriginalMember(owner = "client!ir", name = "i", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)I", line = 331)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BZLpe;I)Lil;", line = 347)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lpe;IZ)Lsj;", line = 377)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lpe;Lkk;IIIIZIZ)V", line = 403)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIILf;Lf;)V", line = 448)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(B)V", line = 460)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BLpe;)V", line = 474)
