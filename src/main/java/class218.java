...
public class class218 extends class212 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BJ)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!sba", name = "d", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Ldh;)V", line = 104)
    public class218(class322 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(II)V", line = 112)
    ...
    @OriginalMember(owner = "client!sba", name = "e", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(ILdh;)V", line = 133)
    public class218(int arg0, class322 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I[IILke;)V", line = 137)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)I", line = 224)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IIIIBI)V", line = 235)
