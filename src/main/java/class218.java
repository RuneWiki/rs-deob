...
public class class218 extends class69 {
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "()Lpn;")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Ld;Lwba;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lwba;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lpn;)V")
    public final synchronized void method1295(class69 arg0) {
        arg0.method1871(-92);
    }

    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(Lpn;)V")
    public final synchronized void method1296(class69 arg0) {
        this.field2676.method236(arg0, (byte) 23);
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "()Lpn;")
