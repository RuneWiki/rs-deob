...
public abstract class class218 extends class15 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BI[B)I", line = 15)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lvl;I)V", line = 48)
