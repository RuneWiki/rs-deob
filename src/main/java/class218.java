...
public class class218 extends class39 implements class147 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLoa;)V", line = 6)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Loa;B)Lac;", line = 17)
    ...
    @OriginalMember(owner = "client!dt", name = "i", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Loa;Llt;IIIIIZIIIIIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!dt", name = "g", descriptor = "(I)Z", line = 52)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!dt", name = "d", descriptor = "(I)I", line = 88)
    ...
    @OriginalMember(owner = "client!dt", name = "e", descriptor = "(I)I", line = 99)
    public final int method549(int arg0) {
        ++field3148;
        return arg0 != 12352 ? 50 : this.field3152.field3548;
    }

    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(BLoa;)V", line = 111)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZLoa;)V", line = 129)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IILoa;)Lba;", line = 147)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IIZI[Lfaa;I)V", line = 158)
    ...
    @OriginalMember(owner = "client!dt", name = "k", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 230)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IILoa;I)Z", line = 240)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ILoa;)Lwc;", line = 260)
    ...
    @OriginalMember(owner = "client!dt", name = "c", descriptor = "(I)Z", line = 299)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)Z", line = 310)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)I", line = 324)
    public final int method554(int arg0) {
        ++field3164;
        return arg0 != -18971 ? 122 : this.field3152.field3569;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IZ)Z", line = 337)
