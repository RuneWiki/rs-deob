...
public class class218 extends class274 implements class251 {
    ...
    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(Ll;Lm;II[[I[[IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(II)V", line = 13)
    public final void method383(int arg0, int arg1) {
        this.field2621.method935().method1075(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!s", name = "a", descriptor = "(Leq;[I)V", line = 16)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III[[ZZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!s", name = "finalize", descriptor = "()V", line = 68)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIIIIII[[Z)V", line = 191)
