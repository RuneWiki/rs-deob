...
public class Tile extends Linkable {
    ...
    @OriginalMember(owner = "client!v", name = "o", descriptor = "Lj;")
    public GroundDecoration field374;

    @OriginalMember(owner = "client!v", name = "p", descriptor = "Lk;")
    public ObjStack field375;

    @OriginalMember(owner = "client!v", name = "C", descriptor = "Lv;")
    public Tile field388;

    @OriginalMember(owner = "client!v", name = "l", descriptor = "Li;")
    public TileOverlay field371;

    @OriginalMember(owner = "client!v", name = "k", descriptor = "Lo;")
    public TileUnderlay field370;

    @OriginalMember(owner = "client!v", name = "m", descriptor = "Lq;")
    public Wall field372;

    @OriginalMember(owner = "client!v", name = "n", descriptor = "Lh;")
