...
public class class18 extends class180 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIBII)V", line = 14)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(BII)Z", line = 460)
    ...
    @OriginalMember(owner = "client!l", name = "e", descriptor = "(B)V", line = 476)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIII)V", line = 505)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(III)Z", line = 523)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)Z", line = 534)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "(I)V", line = 545)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lkba;IIIII)V", line = 561)
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lsr;II)V", line = 655)
