...
public abstract class class18 implements class233 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)Z", line = 13)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZB)V", line = 38)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)I", line = 57)
    public final int method121(int arg0) {
        field425++;
        return arg0 >= -118 ? 9 : this.field433;
    }

    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lhk;IIIZ)V", line = 183)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)I", line = 75)
    ...
    @OriginalMember(owner = "client!qk", name = "finalize", descriptor = "()V", line = 88)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)V", line = 98)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II)I", line = 141)
    public static int method125(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZI)V", line = 151)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(B)V", line = 200)
