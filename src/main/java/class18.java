...
public class class18 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lme;I)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Ldd;I)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lme;)V")
