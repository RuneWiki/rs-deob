...
public abstract class class18 extends class487 {
    ...
    @OriginalMember(owner = "client!l", name = "e", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)Z", line = 63)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)Z", line = 93)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "(B)V", line = 166)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILoa;ILni;ZZI)V", line = 180)
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(IIIIIII)V", line = 199)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I[FB)[F", line = 213)
