...
public class class18 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lqa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "()V", line = 65)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lqa;Lsaa;)V", line = 71)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(Lqa;IIIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(Lqa;Lsaa;)Z", line = 203)
    public final boolean method209(class167 arg0, class18 arg1) {
        return this.field269 != null || this.method213(arg0, arg1);
    }

    @OriginalMember(owner = "client!saa", name = "c", descriptor = "(Lqa;Lsaa;)V", line = 207)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "()V", line = 290)
    public static final void method211() {
        field276 = null;
        field283 = null;
    }

    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIII)Z", line = 299)
    ...
    @OriginalMember(owner = "client!saa", name = "d", descriptor = "(Lqa;Lsaa;)Z", line = 356)
    ...
    @OriginalMember(owner = "client!saa", name = "c", descriptor = "()V", line = 396)
    public final void method214() {
        this.field269 = null;
    }

    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(Lqa;)V", line = 399)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
