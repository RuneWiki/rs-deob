...
public class class18 {
    ...
    @OriginalMember(owner = "client!EMBMBPSC", name = "f", descriptor = "LNSCXCZCZ;")
    ...
    @OriginalMember(owner = "client!EMBMBPSC", name = "d", descriptor = "[LEMBMBPSC;")
    ...
    @OriginalMember(owner = "client!EMBMBPSC", name = "a", descriptor = "(ZI)LEMBMBPSC;")
