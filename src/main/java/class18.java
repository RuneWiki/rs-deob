...
public abstract class class18 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ld;Llga;IIBILjava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ltb;I)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[IIBI)Ltb;")
