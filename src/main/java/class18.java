...
public class class18 extends class535 implements class440 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Ltt;I[BI)V", line = 14)
    public class18(class249 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field202 = arg1;
    }

    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)J", line = 25)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "([BIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)[Lkw;", line = 58)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)Z", line = 139)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)I", line = 176)
