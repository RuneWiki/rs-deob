...
public class class18 extends class210 {
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I[Ljava/lang/String;II)Ljava/lang/String;", line = 42)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 107)
    public class18() {
        super(0, false);
    }

    @OriginalMember(owner = "client!kn", name = "g", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(III)V", line = 123)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIIILhl;)V", line = 146)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IILat;)V", line = 184)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(II)[[I", line = 204)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(ILwc;)V", line = 277)
