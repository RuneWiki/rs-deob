...
public class class18 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IB)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)[[[I", line = 103)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(III)V", line = 170)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BI)V", line = 157)
