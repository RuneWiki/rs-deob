...
public class class18 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILe;)V", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IZ)V", line = 83)
