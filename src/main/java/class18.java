...
public class class18 extends class493 implements class660 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IIII)I", line = 21)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Llm;IZ[[I)V", line = 44)
    ...
    @OriginalMember(owner = "client!saa", name = "b", descriptor = "(II)Ltda;", line = 81)
