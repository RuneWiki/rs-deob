...
public class class18 implements class70 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILnc;II)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILoa;I)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILpi;II)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILpi;I)V")
    public final void method137(int arg0, class141 arg1, int arg2) {
        this.method134(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILij;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILnc;I)V")
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lse;)V")
