...
public class class18 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(JLda;B)V")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I[Lda;)I")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)Lda;")
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)Lda;")
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)Lda;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(JB)Lda;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IZLjava/awt/Component;)Lwt;")
