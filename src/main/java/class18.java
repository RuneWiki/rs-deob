...
public class class18 {
    ...
    @OriginalMember(owner = "client!GDBQCAOA", name = "b", descriptor = "[LGDBQCAOA;")
    public static class18[] field798;

    @OriginalMember(owner = "client!GDBQCAOA", name = "a", descriptor = "(ILQDHHNYHL;)V")
    ...
    @OriginalMember(owner = "client!GDBQCAOA", name = "a", descriptor = "(BLPGNBHFUF;I)V")
