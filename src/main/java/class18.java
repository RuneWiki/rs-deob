...
public class class18 extends class375 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IB[IILar;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IB)I", line = 72)
    ...
    @OriginalMember(owner = "client!jf", name = "e", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "()Luh;", line = 94)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lar;ZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!jf", name = "c", descriptor = "()Luh;", line = 150)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "([III)V", line = 170)
    ...
    @OriginalMember(owner = "client!jf", name = "d", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Ldi;)V", line = 263)
    public class18(class166 arg0) {
        this.field233 = arg0;
    }

    @OriginalMember(owner = "client!jf", name = "d", descriptor = "()I", line = 271)
