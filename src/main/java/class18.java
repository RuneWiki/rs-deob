...
public class class18 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)V", line = 19)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIBIIIIII)Z", line = 30)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIZIZI)V", line = 124)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILtq;ILjava/awt/Canvas;)Lvc;", line = 435)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIIZZBI)V", line = 454)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)V", line = 506)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIII)V", line = 542)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIILem;)V", line = 560)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIIBIII)Z", line = 574)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIZ)V", line = 944)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(IIII)V", line = 958)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(III)V", line = 969)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BII)V", line = 985)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLvh;)V", line = 998)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIIIBIII)Z", line = 1027)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZIIIIIZ)V", line = 1071)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIIIIII)Z", line = 1379)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZZIIIZI)V", line = 1587)
