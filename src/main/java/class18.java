...
public class class18 extends class397 {
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "()V", line = 39)
    public class18() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IBLae;)V", line = 42)
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(II)[I", line = 124)
    ...
    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(B)V", line = 196)
