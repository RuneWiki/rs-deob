...
public abstract class class18 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(B)V", line = 25)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IZ)I", line = 897)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)V", line = 908)
    ...
    @OriginalMember(owner = "client!as", name = "d", descriptor = "(B)V", line = 935)
