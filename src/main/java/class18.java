...
public abstract class class18 {
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "([BII)V", line = 21)
    ...
    @OriginalMember(owner = "client!ea", name = "finalize", descriptor = "()V", line = 48)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Luca;I[BIZ)V", line = 58)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Luca;ILjaclib/memory/Buffer;IZ)V", line = 77)
