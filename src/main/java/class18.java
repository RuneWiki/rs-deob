...
public class class18 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILdp;Ldp;)V", line = 4)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 19)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 58)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IB)V", line = 102)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(CB)Z", line = 452)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(I)V", line = 503)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(JI)V", line = 519)
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 543)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(I)V", line = 603)
    ...
    @OriginalMember(owner = "client!fg", name = "e", descriptor = "(I)V", line = 579)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Ljava/lang/Object;IJ)V", line = 622)
    ...
    @OriginalMember(owner = "client!fg", name = "f", descriptor = "(I)I", line = 650)
    ...
    @OriginalMember(owner = "client!fg", name = "g", descriptor = "(I)I", line = 674)
    ...
    @OriginalMember(owner = "client!fg", name = "h", descriptor = "(I)V", line = 685)
