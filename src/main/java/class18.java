...
public class class18 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lya;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIFI[FIIIFI)V", line = 110)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 190)
