...
@OriginalClass("client!FTZZSWCP")
public class class18 {

    @OriginalMember(owner = "client!FTZZSWCP", name = "i", descriptor = "Z")
    public boolean field746 = false;

    @OriginalMember(owner = "client!FTZZSWCP", name = "j", descriptor = "I")
    public int field747 = -1;

    @OriginalMember(owner = "client!FTZZSWCP", name = "a", descriptor = "I")
    private static int field738 = 8;

    @OriginalMember(owner = "client!FTZZSWCP", name = "b", descriptor = "Z")
    private static boolean field739 = true;

    @OriginalMember(owner = "client!FTZZSWCP", name = "c", descriptor = "I")
    public static int field740;

    @OriginalMember(owner = "client!FTZZSWCP", name = "f", descriptor = "I")
    public int field743;

    @OriginalMember(owner = "client!FTZZSWCP", name = "g", descriptor = "I")
    public int field744;

    @OriginalMember(owner = "client!FTZZSWCP", name = "h", descriptor = "I")
    public int field745;

    @OriginalMember(owner = "client!FTZZSWCP", name = "k", descriptor = "I")
    public int field748;

    @OriginalMember(owner = "client!FTZZSWCP", name = "e", descriptor = "Ljava/lang/String;")
    public String field742;

    @OriginalMember(owner = "client!FTZZSWCP", name = "d", descriptor = "[LFTZZSWCP;")
    public static class18[] field741;

    @OriginalMember(owner = "client!FTZZSWCP", name = "a", descriptor = "(LFIGUVTWB;Z)V")
    ...
    @OriginalMember(owner = "client!FTZZSWCP", name = "a", descriptor = "(ILMUKVLYLC;I)V")
