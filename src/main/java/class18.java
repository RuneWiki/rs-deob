...
public class class18 extends class249 implements Runnable {
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nc", name = "run", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lcj;)V", line = 195)
    public class18(class414 arg0) {
        this.field327 = arg0;
    }

    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lms;I)Z", line = 168)
