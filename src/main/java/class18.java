...
public class class18 extends class71 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!nc", name = "d", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(B)[F", line = 38)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lvr;)V", line = 61)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "([I)V", line = 84)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(B)[F", line = 97)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(III)V", line = 119)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(III)V", line = 130)
    ...
    @OriginalMember(owner = "client!nc", name = "e", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "()Lnc;", line = 167)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIIII)V", line = 193)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lvr;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!nc", name = "c", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(III[I)V", line = 261)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "()V", line = 301)
    public class18() {
        this.method116();
    }
}
