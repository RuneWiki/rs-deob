...
public class class18 extends class167 implements class201 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ldd;)V")
    public final void method264(class654 arg0) {
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lwt;Z)Lf;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ltt;Z)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Luo;IIII)Lda;")
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)Le;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ltt;I)V")
    ...
    @OriginalMember(owner = "client!l", name = "m", descriptor = "()Lfe;")
    public final class530 method160() {
        return new class530(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIF)Lcp;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I[Lcp;)V")
    ...
    @OriginalMember(owner = "client!l", name = "o", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lufa;[Lwt;Z)Lla;")
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(IIIIII)Ldd;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ldd;Ldd;FLdd;)Ldd;")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ltt;)V")
