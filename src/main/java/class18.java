...
public class class18 extends class70 {
    ...
    @OriginalMember(owner = "client!FSNLAIJY", name = "sb", descriptor = "LNHTDEVDA;")
    public class37 field722;

    @OriginalMember(owner = "client!FSNLAIJY", name = "d", descriptor = "(I)LFUTAQMCE;")
    ...
    @OriginalMember(owner = "client!FSNLAIJY", name = "a", descriptor = "(I)LFUTAQMCE;")
