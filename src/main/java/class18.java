...
public class class18 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZLnd;ZILoj;Loj;IILcr;III)Lrg;", line = 53)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIILnd;ILoj;I)Lrg;", line = 117)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ZI)V", line = 135)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILhg;IBILrg;ILab;)V", line = 202)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)Lmm;", line = 243)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(II)V", line = 317)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I[S[Ljava/lang/String;)V", line = 348)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lci;IZLfn;Lg;Lg;)V", line = 393)
