...
@OriginalClass("client!GINAMIRO")
public class class18 {

    @OriginalMember(owner = "client!GINAMIRO", name = "a", descriptor = "I")
    private int field879 = 791;

    @OriginalMember(owner = "client!GINAMIRO", name = "f", descriptor = "I")
    public int field884 = 65000;

    @OriginalMember(owner = "client!GINAMIRO", name = "e", descriptor = "I")
    public int field883;

    @OriginalMember(owner = "client!GINAMIRO", name = "c", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field881;

    @OriginalMember(owner = "client!GINAMIRO", name = "d", descriptor = "Ljava/io/RandomAccessFile;")
    public RandomAccessFile field882;

    @OriginalMember(owner = "client!GINAMIRO", name = "b", descriptor = "[B")
    public static byte[] field880 = new byte[520];

    @OriginalMember(owner = "client!GINAMIRO", name = "<init>", descriptor = "(Ljava/io/RandomAccessFile;IIILjava/io/RandomAccessFile;)V")
    ...
    @OriginalMember(owner = "client!GINAMIRO", name = "a", descriptor = "(II)[B")
    ...
    @OriginalMember(owner = "client!GINAMIRO", name = "a", descriptor = "(BII[B)Z")
    ...
    @OriginalMember(owner = "client!GINAMIRO", name = "a", descriptor = "([BIIIZ)Z")
    ...
    @OriginalMember(owner = "client!GINAMIRO", name = "a", descriptor = "(IBLjava/io/RandomAccessFile;)V")
