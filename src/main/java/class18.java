...
public class class18 extends class415 {
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cv", name = "d", descriptor = "(B)[B", line = 17)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(ILap;)V", line = 36)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)I", line = 112)
