...
public class class18 {
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)J", line = 47)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BI)I", line = 83)
