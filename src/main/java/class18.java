...
public class class18 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lkea;IB)Lko;")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lrt;BI)V")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(BLrt;)V")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ZI)Leba;")
