...
public class class18 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ZI)Lbh;")
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(ILkp;I)Z")
    ...
    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(Leq;)V")
