...
public abstract class class18 {
    ...
    @OriginalMember(owner = "client!bg", name = "d", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!bg", name = "y", descriptor = "[Lob;")
    public static class132[] field384 = new class132[6];

    @OriginalMember(owner = "client!bg", name = "a", descriptor = "Llf;")
    public static class109 field360 = field363;

    @OriginalMember(owner = "client!bg", name = "w", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!bg", name = "f", descriptor = "Lig;")
    ...
    @OriginalMember(owner = "client!bg", name = "m", descriptor = "[Lig;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLbg;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLlf;)I")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(BLlf;I)I")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILlf;Llf;)[B")
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(ILlf;Llf;)Z")
    ...
    @OriginalMember(owner = "client!bg", name = "c", descriptor = "(II)Lfc;")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLlf;)V")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lbg;Llf;Lbg;ZLlf;)Ldb;")
