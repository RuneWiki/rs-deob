...
public class class18 {
    ...
    @OriginalMember(owner = "client!GCYXYCPV", name = "a", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!GCYXYCPV", name = "c", descriptor = "[LGCYXYCPV;")
    public static class18[] field779;

    @OriginalMember(owner = "client!GCYXYCPV", name = "a", descriptor = "(ZLXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!GCYXYCPV", name = "a", descriptor = "(BLGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!GCYXYCPV", name = "b", descriptor = "(B)LVHYCWIPJ;")
    ...
    @OriginalMember(owner = "client!GCYXYCPV", name = "b", descriptor = "(I)LVHYCWIPJ;")
