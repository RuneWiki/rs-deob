...
public class class18 extends class101 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II[B[IIIIIIILqk;II)I", line = 7)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II[B[IIIIIIIILqk;II)I", line = 34)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "()I", line = 68)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I[B[IIIIIIIIIILqk;)I", line = 80)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(III)V", line = 133)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I[B[IIIIIIIIIILqk;)I", line = 179)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "([IIIII)I", line = 232)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "()I", line = 287)
    public final synchronized int method172() {
        return this.field332 < 0 ? -1 : this.field332;
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II[B[IIIIIIIIIILqk;II)I", line = 290)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 377)
    public final synchronized void method175(int arg0) {
        this.method206(arg0 << 6, this.method172());
    }

    @OriginalMember(owner = "client!qk", name = "d", descriptor = "()Lsd;", line = 381)
    public final class101 method176() {
        return null;
    }

    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II[B[IIIIIIIILqk;II)I", line = 385)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II)V", line = 419)
    public final synchronized void method178(int arg0, int arg1) {
        this.method169(arg0, arg1, this.method172());
    }

    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)V", line = 422)
    public final synchronized void method179(int arg0) {
        this.field334 = arg0;
    }

    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II[B[IIIIIIIIIILqk;II)I", line = 425)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "([B[IIIIIIIILqk;)I", line = 466)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 501)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(II)I", line = 721)
    private static final int method183(int arg0, int arg1) {
        return arg1 < 0 ? arg0 : (int) ((double) arg0 * Math.sqrt((double) (16384 - arg1) * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 725)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "([B[IIIIIIILqk;)I", line = 731)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "(I)V", line = 757)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I[B[IIIIIIIILqk;)I", line = 768)
    ...
    @OriginalMember(owner = "client!qk", name = "g", descriptor = "(I)V", line = 807)
    private final synchronized void method188(int arg0) {
        this.method206(arg0, this.method172());
    }

    @OriginalMember(owner = "client!qk", name = "b", descriptor = "([B[IIIIIIIILqk;)I", line = 813)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I[B[IIIIIIIILqk;)I", line = 848)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "()Lsd;", line = 887)
    public final class101 method191() {
        return null;
    }

    @OriginalMember(owner = "client!qk", name = "h", descriptor = "(I)V", line = 890)
    public final synchronized void method192(int arg0) {
        this.method206(this.method208(), arg0);
    }

    @OriginalMember(owner = "client!qk", name = "f", descriptor = "()Z", line = 893)
    public final boolean method193() {
        return this.field321 < 0 || this.field321 >= ((class218) super.field1179).field3377.length << 8;
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Ldga;III)Lqk;", line = 899)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "([B[IIIIIIILqk;)I", line = 905)
    ...
    @OriginalMember(owner = "client!qk", name = "g", descriptor = "()Z", line = 930)
    public final boolean method196() {
        return this.field331 != 0;
    }

    @OriginalMember(owner = "client!qk", name = "h", descriptor = "()I", line = 933)
    public final synchronized int method197() {
        return this.field324 < 0 ? -this.field324 : this.field324;
    }

    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(II)I", line = 936)
    private static final int method198(int arg0, int arg1) {
        return arg1 < 0 ? -arg0 : (int) ((double) arg0 * Math.sqrt((double) arg1 * 1.220703125E-4D) + 0.5D);
    }

    @OriginalMember(owner = "client!qk", name = "i", descriptor = "(I)V", line = 939)
    ...
    @OriginalMember(owner = "client!qk", name = "i", descriptor = "()Z", line = 948)
    ...
    @OriginalMember(owner = "client!qk", name = "j", descriptor = "()V", line = 1033)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(II[B[IIIIIIIILqk;II)I", line = 1048)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "([III)V", line = 1081)
    ...
    @OriginalMember(owner = "client!qk", name = "k", descriptor = "()V", line = 1317)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II[B[IIIIIIILqk;II)I", line = 1322)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "(II)V", line = 1348)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(II[B[IIIIIIIILqk;II)I", line = 1354)
    ...
    @OriginalMember(owner = "client!qk", name = "l", descriptor = "()I", line = 1386)
    public final synchronized int method208() {
        return this.field320 == Integer.MIN_VALUE ? 0 : this.field320;
    }

    @OriginalMember(owner = "client!qk", name = "b", descriptor = "([IIIII)I", line = 1392)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "()I", line = 1449)
    public final int method210() {
        return this.field320 == 0 && this.field331 == 0 ? 0 : 1;
    }

    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Ldga;III)V", line = 1456)
