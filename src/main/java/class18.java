...
public class class18 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II[BIIII[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III)I", line = 55)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ub", name = "finalize", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BLui;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lqg;II)V", line = 154)
    public class18(class321 arg0, int arg1, int arg2) {
        this.field275 = arg0;
        this.field279 = arg2;
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZILjava/awt/Component;)Lbr;", line = 169)
