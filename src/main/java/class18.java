...
public class class18 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(BI)[B", line = 7)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "([BZIIZ)Z", line = 99)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(III[B)Z", line = 224)
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;)V", line = 250)
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(ILlt;Llt;I)V", line = 311)
    ...
    @OriginalMember(owner = "client!saa", name = "toString", descriptor = "()Ljava/lang/String;", line = 301)
