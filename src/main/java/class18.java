...
public class class18 implements Runnable {
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 177)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!l", name = "run", descriptor = "()V", line = 55)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([BIIB)V", line = 130)
