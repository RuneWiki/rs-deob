...
public class class18 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IB)V", line = 15)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZIZ)Ljava/lang/String;", line = 70)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)V", line = 132)
