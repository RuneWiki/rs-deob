...
public class class18 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILpj;ZLpj;)V", line = 144)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)V", line = 174)
