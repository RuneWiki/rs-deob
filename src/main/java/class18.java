...
public class class18 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)Lqe;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZLai;IIIIILqa;)Lf;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILqv;IIII)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILai;IIIZLqa;Lqa;Loa;IZB)Lf;")
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lgt;IZLep;Ldn;Ldn;)V")
