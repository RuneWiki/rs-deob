...
public class class18 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 20)
    public class18(String arg0, int arg1) {
        this.field190 = arg1;
    }

    @OriginalMember(owner = "client!ub", name = "toString", descriptor = "()Ljava/lang/String;", line = 31)
    public final String toString() {
        field189++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 49)
