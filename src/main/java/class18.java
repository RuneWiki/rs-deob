...
public class class18 implements class268 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BI)Z", line = 7)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZIFIZI)[I", line = 21)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(I)I", line = 33)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(FZZIII)[I", line = 48)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(II)Lfca;", line = 63)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)Ljp;", line = 95)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IZIFIB)[F", line = 106)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lwu;Lwu;Lwu;)V", line = 142)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)V", line = 124)
