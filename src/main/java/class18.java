...
public class class18 extends class404 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(III)Loh;", line = 25)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)[I", line = 39)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "()V", line = 130)
    public class18() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILha;I)V", line = 135)
    ...
    @OriginalMember(owner = "client!ub", name = "h", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lol;ILol;)V", line = 195)
