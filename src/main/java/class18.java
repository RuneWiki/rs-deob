...
@OriginalClass("client!ESLZGWKZ")
public class class18 extends class41 {

    @OriginalMember(owner = "client!ESLZGWKZ", name = "h", descriptor = "I")
    private int field787 = 581;

    @OriginalMember(owner = "client!ESLZGWKZ", name = "j", descriptor = "I")
    public int field789 = 1000;

    @OriginalMember(owner = "client!ESLZGWKZ", name = "k", descriptor = "Z")
    public static boolean field790;

    @OriginalMember(owner = "client!ESLZGWKZ", name = "i", descriptor = "[LPLSKXSKV;")
    public class49[] field788;

    @OriginalMember(owner = "client!ESLZGWKZ", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ESLZGWKZ", name = "a", descriptor = "(B)LDHUPIIUL;")
