...
public class class18 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)Lfda;")
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)Lfda;")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Ldh;IIILha;Lpda;)Z")
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILfda;)V")
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(I)Lrs;")
