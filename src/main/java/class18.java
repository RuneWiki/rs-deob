...
public class class18 extends class424 {
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(IB)[I", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "()V", line = 40)
    public class18() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fg", name = "d", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!fg", name = "c", descriptor = "(III)I", line = 55)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lrg;BI)V", line = 81)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IIB)V", line = 116)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Z)V", line = 132)
