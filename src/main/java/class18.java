...
public class class18 extends class40 {
    ...
    @OriginalMember(owner = "client!HGVATLQF", name = "vb", descriptor = "LRRZTMHXJ;")
    public class52 field841;

    @OriginalMember(owner = "client!HGVATLQF", name = "a", descriptor = "(I)LJLNSJQDR;")
    ...
    @OriginalMember(owner = "client!HGVATLQF", name = "a", descriptor = "(B)LJLNSJQDR;")
