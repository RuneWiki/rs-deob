...
@OriginalClass("client!FRPXDCME")
public class class18 extends class17 {

    @OriginalMember(owner = "client!FRPXDCME", name = "k", descriptor = "I")
    public int field848 = 1000;

    @OriginalMember(owner = "client!FRPXDCME", name = "l", descriptor = "Z")
    public static boolean field849;

    @OriginalMember(owner = "client!FRPXDCME", name = "j", descriptor = "[LVSCWMKBW;")
    public class68[] field847;

    @OriginalMember(owner = "client!FRPXDCME", name = "a", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!FRPXDCME", name = "a", descriptor = "(I)LGFYXEFQY;")
