...
public class class18 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)Lds;", line = 37)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BLhp;)Leu;", line = 87)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZII)I", line = 123)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lee;ILul;)V", line = 243)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II[Ljava/lang/Object;[IB)V", line = 184)
