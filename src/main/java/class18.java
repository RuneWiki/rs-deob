...
public class class18 extends class272 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Loa;)V", line = 5)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IZ)Ll;", line = 20)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "()V", line = 33)
    private final void method102() {
        this.field183 = false;
    }

    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(IZ)V", line = 390)
    private class18(int arg0, boolean arg1) {
        this.method115(arg0, arg1);
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "()V", line = 46)
    public static void method104() {
        field186 = null;
        field184 = null;
    }

    @OriginalMember(owner = "client!l", name = "c", descriptor = "()Lig;", line = 53)
    public final class228 method105() {
        return this.field198;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Loa;J)Z", line = 57)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(J)V", line = 106)
    public final void method107(long arg0) {
        this.field189 = arg0;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Loa;[Let;Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([Lfd;Z)V", line = 191)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "()V", line = 279)
    public final void method110() {
        this.field183 = true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Loa;J[Let;[Lfd;Z)V", line = 282)
    ...
    @OriginalMember(owner = "client!l", name = "e", descriptor = "()V", line = 293)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "()V", line = 329)
    public final void method113() {
        this.field195 = true;
    }

    @OriginalMember(owner = "client!l", name = "g", descriptor = "()Lig;", line = 333)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(IZ)V", line = 352)
