...
public class class18 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(F)F", line = 4)
    private static final float method100(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()V", line = 8)
    public static void method101() {
        field201 = null;
        field204 = null;
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIF)F", line = 14)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(IIF)F", line = 33)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lfd;Lck;)V", line = 39)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IF)I", line = 116)
