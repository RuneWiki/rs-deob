...
public class class18 extends class166 implements class200 {
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(Ljava/awt/Canvas;)V", line = 3)
    ...
    @OriginalMember(owner = "client!l", name = "p", descriptor = "()Z", line = 18)
    public final boolean method87() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "B", descriptor = "()Z", line = 22)
    public final boolean method88() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lwn;Lwn;FLwn;)Lwn;", line = 28)
    public final class674 method91(class674 arg0, class674 arg1, float arg2, class674 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lq;)V", line = 42)
    public final void method93(class392 arg0) {
        this.field182 = arg0;
        this.method171(arg0);
    }

    @OriginalMember(owner = "client!l", name = "e", descriptor = "()Z", line = 46)
    public final boolean method94() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "z", descriptor = "()V", line = 51)
    public final void method96() {
        this.method86(this.field193.field2747);
    }

    @OriginalMember(owner = "client!l", name = "s", descriptor = "()V", line = 55)
    public final void method98() {
    }

    @OriginalMember(owner = "client!l", name = "finalize", descriptor = "()V", line = 58)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Z)V", line = 63)
    public final void method99(boolean arg0) {
    }

    @OriginalMember(owner = "client!l", name = "o", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIII)V", line = 78)
    public final void method103(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!l", name = "x", descriptor = "()V", line = 80)
    public final void method104() {
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lnba;IIII)Lda;", line = 84)
    ...
    @OriginalMember(owner = "client!l", name = "i", descriptor = "()Z", line = 87)
    public final boolean method107() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIF)Ltw;", line = 90)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "()Z", line = 93)
    public final boolean method109() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Le;)V", line = 97)
    public final void method111(class493 arg0) {
        this.field181 = (class175) arg0;
        this.method177(arg0);
    }

    @OriginalMember(owner = "client!l", name = "d", descriptor = "(IIIIII)V", line = 103)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)I", line = 107)
    public final int method114(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!l", name = "c", descriptor = "()Z", line = 112)
    public final boolean method116() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIIIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!l", name = "h", descriptor = "()Z", line = 122)
    public final boolean method120() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "A", descriptor = "(S)Z", line = 125)
    ...
    @OriginalMember(owner = "client!l", name = "k", descriptor = "()V", line = 138)
    public final void method125() {
    }

    @OriginalMember(owner = "client!l", name = "q", descriptor = "()Z", line = 145)
    public final boolean method127() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lwn;)V", line = 149)
    public final void method128(class674 arg0) {
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lvn;[Lqga;Z)Lla;", line = 153)
    ...
    @OriginalMember(owner = "client!l", name = "j", descriptor = "()Z", line = 190)
    public final boolean method130() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "g", descriptor = "()Z", line = 194)
    public final boolean method132() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "b", descriptor = "(II)I", line = 199)
    ...
    @OriginalMember(owner = "client!l", name = "n", descriptor = "()V", line = 204)
    public final void method135() {
    }

    @OriginalMember(owner = "client!l", name = "d", descriptor = "()V", line = 207)
    ...
    @OriginalMember(owner = "client!l", name = "fa", descriptor = "()Ljava/lang/Object;", line = 238)
    private final Object method138() {
        return new class617(this);
    }

    @OriginalMember(owner = "client!l", name = "D", descriptor = "()Lqa;", line = 244)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lfa;)V", line = 264)
    ...
    @OriginalMember(owner = "client!l", name = "w", descriptor = "()Lq;", line = 291)
    public final class392 method144() {
        return this.field182;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lqga;Z)Lf;", line = 296)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(FFF)V", line = 369)
    public final void method147(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!l", name = "W", descriptor = "(S)Z", line = 373)
    ...
    @OriginalMember(owner = "client!l", name = "u", descriptor = "()Lho;", line = 398)
    public final class134 method151() {
        return new class134(0, "SSE", 1, "CPU", 0L);
    }

    @OriginalMember(owner = "client!l", name = "c", descriptor = "(Ljava/awt/Canvas;)V", line = 401)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIZ)Lf;", line = 418)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(Z)V", line = 424)
    public final void method157(boolean arg0) {
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "([I)V", line = 428)
    ...
    @OriginalMember(owner = "client!l", name = "b", descriptor = "(I)V", line = 438)
    public final void method159(int arg0) {
        this.field197[arg0].method1426();
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ldk;Z)V", line = 443)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ldk;)V", line = 476)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Lf;Z)V", line = 480)
    ...
    @OriginalMember(owner = "client!l", name = "e", descriptor = "(IIIIII)Lwn;", line = 491)
    public final class674 method165(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!l", name = "A", descriptor = "()Lq;", line = 494)
    public final class392 method166() {
        return this.field184;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ldk;I)V", line = 497)
    public final void method167(class472 arg0, int arg1) {
        this.method160(arg0, false);
        this.method140().method1429(this, field188, field198, field196, field191, arg0.field6493.method3411(true));
    }

    @OriginalMember(owner = "client!l", name = "r", descriptor = "()Lq;", line = 501)
    public final class392 method168() {
        return new class94();
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIZ)Lf;", line = 505)
    ...
    @OriginalMember(owner = "client!l", name = "WA", descriptor = "()V", line = 512)
    ...
    @OriginalMember(owner = "client!l", name = "h", descriptor = "(I)V", line = 517)
    public final void method173(int arg0) {
        this.field197[arg0].method1420();
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "([IIIII)Lf;", line = 525)
    ...
    @OriginalMember(owner = "client!l", name = "y", descriptor = "()Z", line = 564)
    public final boolean method178() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II[I[I)Lua;", line = 569)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(I[Ltw;)V", line = 576)
    ...
    @OriginalMember(owner = "client!l", name = "f", descriptor = "(I)Le;", line = 597)
    ...
    @OriginalMember(owner = "client!l", name = "g", descriptor = "(I)V", line = 603)
    public final void method187(int arg0) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!l", name = "t", descriptor = "()Z", line = 607)
    public final boolean method189() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIII)V", line = 611)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "(I)V", line = 617)
    ...
    @OriginalMember(owner = "client!l", name = "C", descriptor = "()Z", line = 630)
    public final boolean method192() {
        return false;
    }

    @OriginalMember(owner = "client!l", name = "e", descriptor = "(I)V", line = 635)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II[[I[[IIII)Li;", line = 648)
    ...
    @OriginalMember(owner = "client!l", name = "m", descriptor = "()V", line = 650)
    public final void method196() {
    }

    @OriginalMember(owner = "client!l", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 654)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIIIIILua;II)V", line = 670)
    ...
    @OriginalMember(owner = "client!l", name = "l", descriptor = "()Z", line = 703)
    public final boolean method201() {
        return true;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "()I", line = 708)
    public final int method203() {
        return 4;
    }

    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 720)
