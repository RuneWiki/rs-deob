...
public abstract class class18 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(III)B", line = 14)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILrv;)Lrg;", line = 29)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)Ljava/net/Socket;", line = 45)
