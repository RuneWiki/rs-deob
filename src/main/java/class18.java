...
public class class18 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!EUDZGBGU", name = "p", descriptor = "[LPDMJJHOP;")
    ...
    @OriginalMember(owner = "client!EUDZGBGU", name = "o", descriptor = "LBVMYRJQC;")
    public class10 field762;

    @OriginalMember(owner = "client!EUDZGBGU", name = "q", descriptor = "LIUROYOHP;")
