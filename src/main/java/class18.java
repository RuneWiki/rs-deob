...
public class class18 {
    ...
    @OriginalMember(owner = "client!EDPSKMQR", name = "c", descriptor = "LCFARFRSG;")
    ...
    @OriginalMember(owner = "client!EDPSKMQR", name = "a", descriptor = "(IILCFARFRSG;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!EDPSKMQR", name = "a", descriptor = "(Ljava/lang/String;BLCFARFRSG;)V")
