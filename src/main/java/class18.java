...
public class class18 extends class452 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILqi;Z)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IB)Lbd;")
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "()Ltf;")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIILqi;I[I)V")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "()Ltf;")
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Laq;B)V")
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "(La;)V")
