...
public class class419 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ILoo;)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lofa;I)Z")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)Lhg;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)[Lac;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Loo;BI)V")
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lei;ILri;)V")
