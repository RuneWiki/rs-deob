...
public class class419 extends class100 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IFLil;Lil;)Z")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)Lil;")
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lht;I)V")
