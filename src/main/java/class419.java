...
public abstract class class419 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;IIILjava/util/Random;II[Lf;III[I[I)I", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIIII)V", line = 78)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 97)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[IIILjava/lang/String;ILua;I[Lf;)V", line = 115)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([III[IILjava/lang/String;[Lf;[I)V", line = 271)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III[Lf;Ljava/lang/String;IIBILua;I[IIIII)I", line = 437)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[I[Lf;ILjava/lang/String;Ljava/util/Random;III)I", line = 449)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;BI)V", line = 495)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 529)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 544)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 621)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IBLjava/lang/String;)V", line = 631)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 669)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lua;II[IILjava/lang/String;IIBII[Lf;IIIII)I", line = 683)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIIIII)V", line = 787)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 818)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIZIII)V", line = 835)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljn;III)Lgda;", line = 972)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lr;Lgda;)V", line = 987)
    public class419(class165 arg0, class50 arg1) {
        this.field5934 = arg1;
        this.field5943 = arg0;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IIIIBI)V", line = 999)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([IILjava/lang/String;II[Lf;ZI)V", line = 1025)
