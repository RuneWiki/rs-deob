...
public class class419 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ltj;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ltj;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ltj;[II)V")
