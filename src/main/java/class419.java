...
public class class419 {
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)V", line = 128)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(B)V", line = 157)
