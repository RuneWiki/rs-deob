...
public class class419 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lha;IBILqw;)V", line = 28)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(II)V", line = 62)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Ljava/lang/Object;BLst;)V", line = 132)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lst;Ljava/lang/Object;II)V", line = 144)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Z)V", line = 171)
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(I)I", line = 188)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILst;)Ljava/lang/Object;", line = 199)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ZIZI)Luq;", line = 250)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lqo;I)V", line = 270)
    ...
    @OriginalMember(owner = "client!jba", name = "d", descriptor = "(I)I", line = 297)
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(I)V", line = 314)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(ILst;)V", line = 330)
