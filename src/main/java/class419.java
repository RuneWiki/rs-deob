...
public class class419 implements Runnable {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIZI)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLjava/awt/Frame;)Lqt;")
    public final class449 method2550(byte arg0, Frame arg1) {
        return arg0 == -64 ? this.method2560(0, 0, arg1, arg0 ^ 0xFFFFFFC0, 7) : null;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjava/lang/String;I)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;I)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(B)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)Lqn;")
    public final class46 method2557(int arg0) {
        return arg0 == 18 ? this.field6172 : null;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjava/awt/Component;Z)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLjava/lang/Class;)Lqt;")
    public final class449 method2559(byte arg0, Class arg1) {
        int var3 = 17 % ((-arg0 - 62) / 58);
        return this.method2560(0, 0, arg1, 0, 20);
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILjava/lang/Object;II)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BLjava/lang/String;)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BI)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILjava/lang/Runnable;)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;B)Lqt;")
    public final class449 method2565(Transferable arg0, byte arg1) {
        return arg1 == 87 ? this.method2560(0, 0, arg0, 0, 19) : null;
    }

    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/awt/Point;Ljava/awt/Component;I[III)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Ljava/lang/String;I)Lqt;")
    public final class449 method2567(String arg0, int arg1) {
        return arg1 == 14 ? this.method2560(0, 0, arg0, 0, 16) : null;
    }

    @OriginalMember(owner = "client!et", name = "c", descriptor = "(B)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/Class;Z)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/awt/Component;ZII)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjava/lang/Object;III)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Lqt;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/net/URL;I)Lqt;")
    public final class449 method2574(URL arg0, int arg1) {
        return arg1 >= -97 ? null : this.method2560(0, 0, arg0, 0, 4);
    }

    @OriginalMember(owner = "client!et", name = "c", descriptor = "(Ljava/lang/String;I)Lqt;")
