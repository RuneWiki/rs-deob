...
public class class419 extends class204 {
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(I)Ltia;")
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(Lfs;)V")
    public class419(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(ILfs;)V")
