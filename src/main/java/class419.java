...
public class class419 extends class433 implements class137 {
    ...
    @OriginalMember(owner = "client!aa", name = "finalize", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;[IIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILfa;II)V", line = 31)
    public final void method1572(int arg0, int arg1, class199 arg2, int arg3, int arg4) {
        this.method2645(arg0, arg1, arg2, arg3, arg4);
    }

    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lda;La;IIII)V", line = 37)
