...
public class class419 extends class424 {
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 26)
    public class419() {
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(S)V", line = 46)
