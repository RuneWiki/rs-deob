...
public class class419 extends class402 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(B)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ZLza;II)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IBILvs;Lza;ZI)V", line = 67)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)Z", line = 108)
    ...
    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(B)V", line = 119)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IB)V", line = 134)
    ...
    @OriginalMember(owner = "client!ia", name = "h", descriptor = "(I)I", line = 168)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(Lza;I)Lnd;", line = 180)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BLza;)V", line = 216)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(IZILza;)Le;", line = 236)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(Lza;ZLe;)V", line = 254)
    ...
    @OriginalMember(owner = "client!ia", name = "f", descriptor = "(I)V", line = 285)
