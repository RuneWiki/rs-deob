...
public class class419 implements class703 {
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIILni;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)I", line = 31)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZIILme;)V", line = 56)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)V", line = 110)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Lme;ZI)V", line = 127)
    public final void method2556(class192 arg0, boolean arg1, int arg2) {
        field5874++;
        this.method2553(arg1, 0, arg2, arg0);
    }

    @OriginalMember(owner = "client!ij", name = "e", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!ij", name = "<init>", descriptor = "(Loea;)V", line = 479)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(B)V", line = 192)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(BI)I", line = 204)
    ...
    @OriginalMember(owner = "client!ij", name = "d", descriptor = "(B)V", line = 218)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(ZIZ)V", line = 311)
    ...
    @OriginalMember(owner = "client!ij", name = "finalize", descriptor = "()V", line = 347)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IIIILni;)V", line = 361)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)V", line = 394)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IILnh;)V", line = 407)
    ...
    @OriginalMember(owner = "client!ij", name = "c", descriptor = "(I)V", line = 436)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(IB)V", line = 449)
    ...
    @OriginalMember(owner = "client!ij", name = "b", descriptor = "(B)V", line = 465)
