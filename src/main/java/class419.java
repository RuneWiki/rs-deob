...
public class class419 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lha;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(ILjava/util/Random;B)I", line = 49)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I)V", line = 84)
