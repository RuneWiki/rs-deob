...
public class class419 extends class182 {
    ...
    @OriginalMember(owner = "client!gia", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gia", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "(IIIIIF)V", line = 35)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(II)I", line = 70)
    public static final int method2538(int arg0, int arg1) {
        return class111.field1590 != null ? class111.field1590[arg0][arg1] & 255 : 0;
    }

    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(III)V", line = 75)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(IIB)V", line = 89)
    public void method2539(int arg0, int arg1, byte arg2) {
        ++field5808;
        this.field5810[this.field5814++] = (byte) (127 + (class136.method878(arg2, arg0) >> 1));
    }

    @OriginalMember(owner = "client!gia", name = "f", descriptor = "(I)V", line = 98)
