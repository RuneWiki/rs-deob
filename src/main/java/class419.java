...
public class class419 {
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(ILia;)V")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I)Lwh;")
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(BILia;)V")
