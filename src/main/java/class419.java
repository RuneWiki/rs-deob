...
public class class419 extends class115 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IZ)Ljb;")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BLbk;I)V")
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Len;IILvr;III[[[B[I[I[I[I[IIBIIZ)V")
