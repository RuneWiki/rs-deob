...
public class class419 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lnp;IBLnp;)Lnca;")
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Lnp;ILnp;BZ)Lnca;")
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lro;Lhfa;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
