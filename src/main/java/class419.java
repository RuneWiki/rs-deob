...
public class class419 extends class650 {
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Loa;B)Llt;", line = 77)
    ...
    @OriginalMember(owner = "client!nu", name = "g", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!nu", name = "b", descriptor = "(BLoa;)V", line = 138)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(BLoa;)Lvg;", line = 149)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IZ)V", line = 167)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(IIILoa;)Z", line = 207)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(Ltk;Z)I", line = 261)
    ...
    @OriginalMember(owner = "client!nu", name = "a", descriptor = "(III)Z", line = 327)
