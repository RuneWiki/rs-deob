...
public abstract class class419 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lok;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)I", line = 183)
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(I)V", line = 194)
