...
public class class419 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lka;Lel;IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIII[B)V", line = 164)
    ...
    @OriginalMember(owner = "client!mt", name = "toString", descriptor = "()Ljava/lang/String;", line = 193)
    public final String toString() {
        field6018++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(IIIIIIIIII)Z", line = 210)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "(IIII)V", line = 867)
