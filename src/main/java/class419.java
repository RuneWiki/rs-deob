...
public class class419 extends class535 implements class583 {
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(B)Z", line = 21)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(B)I", line = 42)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IILha;)Lka;", line = 57)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lha;Lc;IIIIIZIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!tb", name = "m", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lha;ZII)Llg;", line = 114)
    ...
    @OriginalMember(owner = "client!tb", name = "h", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!tb", name = "c", descriptor = "(ILha;)V", line = 152)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(Z)Z", line = 162)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(ILha;)V", line = 178)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)Z", line = 209)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IILha;B)Z", line = 220)
    ...
    @OriginalMember(owner = "client!tb", name = "j", descriptor = "(I)I", line = 242)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Z)I", line = 255)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lha;I)Lcca;", line = 273)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lha;B)V", line = 287)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(I)I", line = 339)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILha;)V", line = 350)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BLha;)Ltf;", line = 379)
