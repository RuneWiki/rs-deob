...
public class class419 extends class86 implements class147 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILoa;)Lwc;", line = 3)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(II)I", line = 29)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IJ)V", line = 57)
    ...
    @OriginalMember(owner = "client!gt", name = "g", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!gt", name = "c", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Loa;Llt;IIIIZIIZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILoa;I)Lba;", line = 137)
    ...
    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(I)I", line = 162)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILoa;I)Z", line = 180)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Loa;B)Lac;", line = 207)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 223)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ZLoa;)V", line = 235)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Z)V", line = 245)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 256)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILoa;)Lba;", line = 288)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IILoa;Z)Lcda;", line = 302)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BLoa;)V", line = 332)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(BLoa;)V", line = 362)
    ...
    @OriginalMember(owner = "client!gt", name = "e", descriptor = "(I)I", line = 389)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)V", line = 400)
