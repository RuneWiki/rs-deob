...
public class class419 extends class147 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BII)Z", line = 21)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B[III)V", line = 38)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(II)Z", line = 55)
    ...
    @OriginalMember(owner = "client!fl", name = "c", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BIIIIII)V", line = 86)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIII)Z", line = 140)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "([IIZI)V", line = 155)
    ...
    @OriginalMember(owner = "client!fl", name = "<init>", descriptor = "(IIIIIIIII)V", line = 168)
