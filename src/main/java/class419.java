...
public class class419 extends class416 {
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lok;Luq;[Lfg;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(CIIIZLua;II)V", line = 244)
    ...
    @OriginalMember(owner = "client!gt", name = "OA", descriptor = "(CIIIZ)V", line = 290)
