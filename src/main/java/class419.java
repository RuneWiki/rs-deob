...
public class class419 extends class467 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lul;Lul;Lmf;Lul;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!ot", name = "m", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)[[I", line = 56)
