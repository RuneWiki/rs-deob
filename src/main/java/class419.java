...
public class class419 extends class45 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIBI)Lhe;", line = 4)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "()V", line = 83)
    public class419() {
    }

    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 89)
