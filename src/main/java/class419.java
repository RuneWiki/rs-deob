...
public class class419 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(ZI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(JZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "([[II)V", line = 33)
