...
public class class419 {
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BILlf;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(BILcb;)V", line = 45)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Llf;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIIII)V", line = 255)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IIIIIBI)V", line = 309)
