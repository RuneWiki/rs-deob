...
public class class419 extends class712 implements class238 {
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(ILha;)Lrk;", line = 6)
    ...
    @OriginalMember(owner = "client!jba", name = "d", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ZLha;)Loba;", line = 48)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lha;II)Lka;", line = 63)
    ...
    @OriginalMember(owner = "client!jba", name = "i", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(B)I", line = 99)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(I)I", line = 111)
    public final int method927(int arg0) {
        ++field5466;
        return arg0 != -24482 ? 11 : 65535 & this.field5478;
    }

    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(I)Z", line = 124)
    public final boolean method935(int arg0) {
        ++field5477;
        return arg0 != 25271 ? true : this.field5485;
    }

    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(Lha;I)V", line = 152)
    ...
    @OriginalMember(owner = "client!jba", name = "j", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIIIIIIZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!jba", name = "e", descriptor = "(Z)Z", line = 269)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(ILha;)V", line = 283)
    ...
    @OriginalMember(owner = "client!jba", name = "f", descriptor = "(Z)V", line = 311)
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(II)Lcf;", line = 325)
    ...
    @OriginalMember(owner = "client!jba", name = "e", descriptor = "(I)I", line = 344)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(I)I", line = 355)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IIZLha;)Lwv;", line = 366)
    ...
    @OriginalMember(owner = "client!jba", name = "f", descriptor = "(I)I", line = 396)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lha;I)V", line = 406)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lgda;Lha;IIZII)V", line = 432)
    ...
    @OriginalMember(owner = "client!jba", name = "d", descriptor = "(Z)V", line = 464)
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(Z)Z", line = 482)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IBILha;)Z", line = 504)
