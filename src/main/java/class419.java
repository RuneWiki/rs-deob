...
public class class419 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Lta;BLat;ILo;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZILsv;)V", line = 51)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(BZZII)I", line = 83)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IB)Lgt;", line = 132)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)I", line = 162)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 220)
