...
public class class419 {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILaba;B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(II)Z", line = 37)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "(Ljj;)V", line = 311)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ZIZIII)V", line = 233)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(I)V", line = 293)
