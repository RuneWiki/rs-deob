...
public class class419 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILza;IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIB)B", line = 88)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lza;II)Z", line = 109)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 198)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(I[Lpm;IIII)V", line = 297)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lta;IBIIILhm;IJ)V", line = 238)
