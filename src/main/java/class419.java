...
public class class419 {
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "(Lfca;)V", line = 23)
    ...
    @OriginalMember(owner = "client!mt", name = "b", descriptor = "(Lfca;)V", line = 38)
    ...
    @OriginalMember(owner = "client!mt", name = "<init>", descriptor = "()V", line = 48)
    public class419() {
        this.field5711[0] = 0;
    ...
    @OriginalMember(owner = "client!mt", name = "a", descriptor = "()V", line = 62)
