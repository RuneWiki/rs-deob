...
public abstract class class419 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIIII)V", line = 173)
    ...
    @OriginalMember(owner = "client!ot", name = "d", descriptor = "(I)V", line = 298)
    ...
    @OriginalMember(owner = "client!ot", name = "e", descriptor = "(B)V", line = 312)
