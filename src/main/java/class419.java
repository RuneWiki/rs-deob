...
public class class419 extends class204 {
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(JI)I", line = 20)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(I)J", line = 54)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "()V", line = 118)
    public class419() {
    ...
    @OriginalMember(owner = "client!gia", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!gia", name = "d", descriptor = "(I)J", line = 81)
