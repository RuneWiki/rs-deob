...
public class class419 extends class198 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIZ)[B", line = 7)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Z)[B", line = 24)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(B[B)V", line = 37)
