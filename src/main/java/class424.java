...
public abstract class class424 extends class404 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(II)I", line = 4)
    public static final int method2597(int arg0, int arg1) {
        return class315.field4362 != null ? class315.field4362[arg0][arg1] & 65535 : 0;
    }

    @OriginalMember(owner = "client!un", name = "h", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!un", name = "m", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!un", name = "n", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Lha;IZLga;IBI)V", line = 78)
    ...
    @OriginalMember(owner = "client!un", name = "j", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIIII)V", line = 116)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "([Lab;I)I", line = 136)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(IIIIIII)V", line = 146)
    ...
    @OriginalMember(owner = "client!un", name = "o", descriptor = "(I)Lmf;", line = 164)
