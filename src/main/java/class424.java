...
public class class424 extends class30 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Ljg;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "()V", line = 101)
    public class424() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nk", name = "e", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "([J[II)V", line = 62)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIIIIII)I", line = 73)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IB)[I", line = 104)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIIIII)Z", line = 149)
    ...
    @OriginalMember(owner = "client!nk", name = "f", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(III)B", line = 283)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BI)[[I", line = 305)
