...
public class class424 extends class261 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lwo;B[I[B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Z[BI)Ljava/lang/Object;", line = 91)
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "()V", line = 152)
    public class424() {
    }

    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "([B)V", line = 159)
