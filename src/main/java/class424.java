...
public class class424 extends class719 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lha;I)Lcw;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
