...
public class class424 extends class400 implements class56 {
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ur", name = "e", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILtj;II)Z", line = 42)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ltj;I)Lri;", line = 62)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(B)Z", line = 101)
    public final boolean method107(byte arg0) {
        ++field6171;
        return arg0 < 119;
    }

    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILtj;BIZLkm;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ltj;IB)Lqb;", line = 125)
    ...
    @OriginalMember(owner = "client!ur", name = "c", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!ur", name = "g", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Ltj;Lqr;IIIIIIIZI)V", line = 204)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(B)I", line = 215)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(ILtj;)V", line = 227)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(I)I", line = 241)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILtj;)V", line = 253)
    ...
    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(I)Z", line = 268)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(BLtj;)V", line = 283)
