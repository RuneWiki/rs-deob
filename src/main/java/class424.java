...
public class class424 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIF)F", line = 10)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IF)I", line = 22)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(IIF)F", line = 91)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lec;Lki;)V", line = 100)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(F)F", line = 180)
