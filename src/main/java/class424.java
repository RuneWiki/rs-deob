...
public class class424 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILrb;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IB)V", line = 56)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILrb;ILjava/lang/Object;)V", line = 109)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BLrb;)V", line = 139)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)V", line = 165)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 175)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Ljava/lang/Object;Lrb;B)V", line = 186)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)I", line = 198)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(III)V", line = 209)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILcm;)V", line = 224)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)I", line = 307)
