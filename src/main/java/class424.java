...
public abstract class class424 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IB)I", line = 18)
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIII)V", line = 91)
