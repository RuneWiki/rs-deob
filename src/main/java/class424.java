...
public class class424 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(ZI)Z", line = 61)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IZ)I", line = 105)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(II)Z", line = 204)
