...
public class class424 extends class187 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(ZI)V", line = 110)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lkj;)V", line = 121)
    public class424(class235 arg0) {
        this.field6219 = arg0;
    }

    @OriginalMember(owner = "client!vn", name = "f", descriptor = "(I)V", line = 131)
