...
public class class424 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)Z", line = 164)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Luv;I)Z", line = 186)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)Z", line = 227)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BLuv;)V", line = 355)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lug;)V", line = 863)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "([[[Lev;ZIIII)Z", line = 391)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IBIII)Z", line = 711)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZZBII)Lqn;", line = 759)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(I)V", line = 787)
