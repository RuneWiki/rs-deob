...
public class class424 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lqr;Lqp;I[Laq;ILvc;Lgd;IIIILvk;ZLpt;ILqp;Lkp;Ldj;B)Ln;", line = 3)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lnl;IBI)Lqi;", line = 494)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(I)V", line = 514)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ZZ)V", line = 556)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Ljava/util/Random;IB)I", line = 569)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(III)V", line = 600)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILqr;Lvk;BIILpt;Lqp;Ldj;Lgd;Lvc;I)Ln;", line = 613)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(B)V", line = 800)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IILpt;I)V", line = 811)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(ILvc;Lpt;IILqp;ILvk;IIII)Ln;", line = 834)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([III[IZI)V", line = 989)
