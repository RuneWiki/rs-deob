...
public class class424 extends class184 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(Liia;ZI)V")
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Loea;Lqr;)V")
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(IB)Lva;")
