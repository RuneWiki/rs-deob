...
public class class424 extends class200 {
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Lqe;Lkga;[Lpga;[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(CIIIZLfa;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!rca", name = "q", descriptor = "(CIIIZ)V", line = 204)
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "([B[IIIIIIII)V", line = 263)
