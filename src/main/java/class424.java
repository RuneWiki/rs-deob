...
public class class424 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "()[F", line = 13)
    public final float[] method2671() {
        return this.field6063[this.method2672()];
    }

    @OriginalMember(owner = "client!ki", name = "b", descriptor = "()I", line = 18)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "()V", line = 26)
