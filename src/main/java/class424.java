...
public class class424 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IBI)I", line = 16)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lda;IIILcu;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(III)Z", line = 71)
