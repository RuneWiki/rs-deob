...
public class class424 extends class332 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(ILps;Lft;III)V", line = 34)
    public class424(int arg0, class105 arg1, class4 arg2, int arg3, int arg4, int arg5) {
        super(arg0, arg1, arg2, arg3, arg4);
        this.field5628 = arg5;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BII)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)Llf;", line = 83)
