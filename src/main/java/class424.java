...
public class class424 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(I)Lfl;")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Lis;IIIII)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BILae;)V")
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)Lfl;")
