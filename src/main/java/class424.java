...
public class class424 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IILgw;)V", line = 85)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)Ljava/lang/String;", line = 139)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(B)V", line = 159)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(II)I", line = 175)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(II)Z", line = 196)
    ...
    @OriginalMember(owner = "client!mi", name = "c", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lgw;B)V", line = 236)
