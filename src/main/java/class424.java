...
public class class424 extends class376 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIIIIIILie;III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "()V", line = 274)
    public class424() {
    }

    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 276)
