...
public class class424 extends class86 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Z)I", line = 6)
    public final int method2445(boolean arg0) {
        ++field5579;
        return arg0 ? -88 : super.field1200;
    }

    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(ILsf;)V", line = 19)
    public class424(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(II)I", line = 39)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B[B)[B", line = 51)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lsf;)V", line = 70)
    public class424(class551 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 96)
