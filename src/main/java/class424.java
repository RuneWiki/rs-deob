...
public abstract class class424 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lni;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILqa;ILmk;ILfb;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIII[B)V", line = 257)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZI)Lun;", line = 354)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 385)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(B)V", line = 480)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BII)Z", line = 514)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)I", line = 530)
