...
public class class424 {
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(II)Lmfa;", line = 33)
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ad", name = "a", descriptor = "(ZIII)I", line = 95)
    ...
    @OriginalMember(owner = "client!ad", name = "<init>", descriptor = "(Leea;Ld;)V", line = 130)
