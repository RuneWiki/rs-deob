...
public class class424 extends class665 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I[BII)[B", line = 4)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(CI)I", line = 51)
    ...
    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(CI)I", line = 71)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BLjr;)V", line = 127)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(BILjr;)V", line = 166)
    ...
    @OriginalMember(owner = "client!vq", name = "f", descriptor = "(I)V", line = 229)
