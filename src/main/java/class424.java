...
public class class424 extends class366 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZI)V", line = 10)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Ler;Lfj;)V", line = 81)
    ...
    @OriginalMember(owner = "client!sl", name = "c", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III)V", line = 168)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)Z", line = 237)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZZ)V", line = 282)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ILep;I)V", line = 292)
