...
public class class424 extends class38 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IILrg;)V", line = 83)
    ...
    @OriginalMember(owner = "client!un", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "()V", line = 115)
    public class424() {
        super(3, false);
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(CI)Z", line = 118)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(BI)[I", line = 136)
