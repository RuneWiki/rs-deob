...
public class class424 extends class227 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILjava/lang/String;)I", line = 4)
    ...
    @OriginalMember(owner = "client!rj", name = "e", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "()V", line = 44)
    public class424() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)[I", line = 51)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lug;II)V", line = 215)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(II)I", line = 265)
