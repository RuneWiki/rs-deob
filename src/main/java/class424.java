...
public class class424 extends class136 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([IBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIIIIII)I", line = 162)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 237)
    public class424() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IBLjava/lang/Object;I)[B", line = 240)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IILiv;)V", line = 272)
    ...
    @OriginalMember(owner = "client!gl", name = "f", descriptor = "(I)V", line = 368)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 407)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(B)V", line = 436)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(B)V", line = 453)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)[I", line = 470)
