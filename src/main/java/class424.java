...
public class class424 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(ZI)I", line = 59)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 188)
