...
public class class424 extends class194 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IILbg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IC)C", line = 67)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 99)
    public class424() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)[I", line = 102)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIIIII)V", line = 176)
