...
public class class424 extends class285 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(FFFFFFLtm;II)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IILtm;II)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lks;IIII)V")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lks;II[III)V")
