...
public class class424 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIILir;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IZ)V", line = 91)
