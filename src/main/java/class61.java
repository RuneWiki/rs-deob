...
public class class61 extends class5 {
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IIB)Lqba;", line = 3)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(ILes;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(BLjava/io/File;)[B", line = 66)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(IZ)[[I", line = 77)
    ...
    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!ofa", name = "<init>", descriptor = "()V", line = 224)
    public class61() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ofa", name = "a", descriptor = "(II)[I", line = 243)
