...
public class class61 extends class601 {
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!mia", name = "b", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(Lgn;)V")
