...
public class class61 extends class124 {
    ...
    @OriginalMember(owner = "client!qh", name = "i", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qh", name = "c", descriptor = "(II)I", line = 15)
    ...
    @OriginalMember(owner = "client!qh", name = "l", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lwa;I)V", line = 39)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILr;)Lcr;", line = 56)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIBIZI)V", line = 168)
    ...
    @OriginalMember(owner = "client!qh", name = "m", descriptor = "(I)V", line = 254)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lr;Lfa;IIIII)V", line = 270)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILr;I)Z", line = 353)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIILr;)Z", line = 527)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(Lr;I)Lbca;", line = 579)
    ...
    @OriginalMember(owner = "client!qh", name = "d", descriptor = "(Z)I", line = 703)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lr;Z)V", line = 729)
    ...
    @OriginalMember(owner = "client!qh", name = "i", descriptor = "(B)V", line = 757)
    ...
    @OriginalMember(owner = "client!qh", name = "e", descriptor = "(Z)Z", line = 800)
    ...
    @OriginalMember(owner = "client!qh", name = "n", descriptor = "(I)Z", line = 822)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)I", line = 837)
    ...
    @OriginalMember(owner = "client!qh", name = "j", descriptor = "(I)I", line = 861)
    ...
    @OriginalMember(owner = "client!qh", name = "g", descriptor = "(I)Z", line = 883)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lvv;IIZLr;II)V", line = 900)
