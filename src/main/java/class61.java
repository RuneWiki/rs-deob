...
public class class61 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IZ)Lrr;", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BI)V", line = 35)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Loj;La;III)V", line = 87)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lci;ILg;)V", line = 149)
