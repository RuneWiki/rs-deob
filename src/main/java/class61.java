...
public class class61 extends class101 {
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Laj;I)Lmk;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Laj;II)Lmk;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "([I)Lks;")
    ...
    @OriginalMember(owner = "client!mk", name = "a", descriptor = "(Laj;)Z")
