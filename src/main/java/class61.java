...
public class class61 {
    ...
    @OriginalMember(owner = "client!in", name = "b", descriptor = "()Lcv;")
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lci;II)Lin;")
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lwn;)V")
