...
public class class61 extends class246 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIILha;IBI)Lka;", line = 11)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(III)Z", line = 72)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(II)[B", line = 91)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIIIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lsf;IIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Z)Lpj;", line = 205)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(BI)V", line = 269)
