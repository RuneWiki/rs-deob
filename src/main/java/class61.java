...
public abstract class class61 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILaa;ILjava/lang/String;[Lufa;[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 150)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BII)V", line = 212)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 235)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IZ)V", line = 309)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 348)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 389)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II)V", line = 416)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILaa;IIIIIIB[Lufa;IILjava/lang/String;I[I)I", line = 434)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIIIILjava/lang/String;)V", line = 536)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILjava/lang/String;Ljava/util/Random;[III[Lufa;I)I", line = 578)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[Lufa;ILjava/lang/String;IILaa;IBI[IIIIII)I", line = 627)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIZ[I[Lufa;Ljava/lang/String;[II)V", line = 642)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BILjava/lang/String;III)V", line = 806)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(IIIIILjava/lang/String;I)V", line = 821)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(I[IILjava/lang/String;IIB[Lufa;)V", line = 852)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(I)V", line = 867)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(ILjava/lang/String;IIBI)V", line = 878)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Lmv;)V", line = 892)
    public class61(class60 arg0, class377 arg1) {
        this.field664 = arg1;
        this.field671 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIIIILjava/util/Random;I[IILjava/lang/String;I[II[Lufa;I)I", line = 905)
