...
public class class61 implements class462 {
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IFIIIZ)[I", line = 18)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IZIIIF)[I", line = 29)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)I", line = 42)
    public final int method434(byte arg0) {
        field693++;
        return arg0 == 67 ? this.field686 : 62;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BI)Ljf;", line = 59)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)Z", line = 86)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLjava/lang/String;)[B", line = 99)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lkea;Lkea;Lkea;)V", line = 156)
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(II)Lpw;", line = 134)
    public final class614 method438(int arg0, int arg1) {
        field699++;
        return arg0 < 31 ? null : this.field698[arg1];
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "([FII)[F", line = 145)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BIZIFI)[F", line = 369)
