...
public class class61 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lol;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(II)Z", line = 274)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I[SI)[S", line = 298)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)V", line = 319)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lol;Z)V", line = 362)
