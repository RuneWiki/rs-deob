...
public class class61 {
    ...
    private int field1641 = 457;

    @OriginalMember(owner = "client!XAGUDWSZ", name = "d", descriptor = "[I")
    private int[] field1644 = new int[256];
    ...
    public class61(byte arg0, int[] arg1) {
        if (arg0 != -9) {
            this.field1641 = -170;
        }
        this.field1643 = new int[256];
        for (int var3 = 0; var3 < arg1.length; var3++) {
            this.field1643[var3] = arg1[var3];
        }
        this.method560();
    }
    ...
    private final void method559() {
        this.field1646 += ++this.field1647;
        for (int var1 = 0; var1 < 256; var1++) {
            int var2 = this.field1644[var1];
            if ((var1 & 0x3) == 0) {
                this.field1645 ^= this.field1645 << 13;
            } else if ((var1 & 0x3) == 1) {
                this.field1645 ^= this.field1645 >>> 6;
            } else if ((var1 & 0x3) == 2) {
                this.field1645 ^= this.field1645 << 2;
            } else if ((var1 & 0x3) == 3) {
                this.field1645 ^= this.field1645 >>> 16;
            }
            this.field1645 += this.field1644[var1 + 128 & 0xFF];
            int var3;
            this.field1644[var1] = var3 = this.field1644[var2 >> 2 & 0xFF] + this.field1645 + this.field1646;
            this.field1643[var1] = this.field1646 = this.field1644[var3 >> 8 >> 2 & 0xFF] + var2;
        }
    }
    ...
    private final void method560() {
        ...
        for (int var10 = 0; var10 < 256; var10 += 8) {
            int var36 = this.field1643[var10] + var8;
            int var37 = this.field1643[var10 + 1] + var7;
            int var38 = this.field1643[var10 + 2] + var6;
            int var39 = this.field1643[var10 + 3] + var5;
            int var40 = this.field1643[var10 + 4] + var4;
            int var41 = this.field1643[var10 + 5] + var3;
            int var42 = this.field1643[var10 + 6] + var2;
            int var43 = this.field1643[var10 + 7] + var1;
            ...
            var6 = var1 + var50;
            var8 = var7 + var57;
            this.field1644[var10] = var8;
            this.field1644[var10 + 1] = var7;
            this.field1644[var10 + 2] = var6;
            this.field1644[var10 + 3] = var5;
            this.field1644[var10 + 4] = var4;
            this.field1644[var10 + 5] = var3;
            this.field1644[var10 + 6] = var2;
            this.field1644[var10 + 7] = var1;
        }
        for (int var11 = 0; var11 < 256; var11 += 8) {
            int var12 = this.field1644[var11] + var8;
            int var13 = this.field1644[var11 + 1] + var7;
            int var14 = this.field1644[var11 + 2] + var6;
            int var15 = this.field1644[var11 + 3] + var5;
            int var16 = this.field1644[var11 + 4] + var4;
            int var17 = this.field1644[var11 + 5] + var3;
            int var18 = this.field1644[var11 + 6] + var2;
            int var19 = this.field1644[var11 + 7] + var1;
            ...
            var6 = var1 + var26;
            var8 = var7 + var33;
            this.field1644[var11] = var8;
            this.field1644[var11 + 1] = var7;
            this.field1644[var11 + 2] = var6;
            this.field1644[var11 + 3] = var5;
            this.field1644[var11 + 4] = var4;
            this.field1644[var11 + 5] = var3;
            this.field1644[var11 + 6] = var2;
            this.field1644[var11 + 7] = var1;
        }
        this.method559();
        this.field1642 = 256;
    }
