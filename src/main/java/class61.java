...
public abstract class class61 {
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lbf;I[BIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lbf;ILjava/nio/ByteBuffer;Z)V", line = 57)
