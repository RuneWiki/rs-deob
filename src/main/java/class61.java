...
public class class61 extends class364 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lsk;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lsk;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILqe;)V", line = 140)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(II)V", line = 309)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(FBIZLnc;)V", line = 348)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IB)V", line = 374)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ZI)V", line = 438)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILsk;)V", line = 466)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IIII)I", line = 492)
