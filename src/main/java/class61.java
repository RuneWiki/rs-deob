...
public class class61 extends class102 implements class500 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I[BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lgk;I[BIZ)V", line = 19)
    public class61(class463 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field790 = arg1;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!ns", name = "c", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 65)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lgk;ILjaggl/memory/NativeBuffer;IZ)V", line = 120)
    public class61(class463 arg0, int arg1, NativeBuffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field790 = arg1;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILeo;B)V", line = 128)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)J", line = 152)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)I", line = 163)
