...
public abstract class class61 extends class112 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!gda", name = "c", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(Z)I", line = 34)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IIB[Lkp;)I", line = 47)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(CB)B", line = 86)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(III)Z", line = 215)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(II)I", line = 244)
