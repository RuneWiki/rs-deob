...
public class class61 extends class235 implements class529 {
    ...
    @OriginalMember(owner = "client!tt", name = "c", descriptor = "(Lya;I)Lfk;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Liv;B)Lbr;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILfi;BZLya;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZLya;)V")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lya;II)Lt;")
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lya;Lrd;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!tt", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(Lya;I)V")
