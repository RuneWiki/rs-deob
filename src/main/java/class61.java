...
public class class61 {
    ...
    @OriginalMember(owner = "client!UPKVWWFD", name = "p", descriptor = "I")
    ...
    @OriginalMember(owner = "client!UPKVWWFD", name = "a", descriptor = "(LEGCCHUZS;Z)V")
    ...
    @OriginalMember(owner = "client!UPKVWWFD", name = "a", descriptor = "(ILEGCCHUZS;)V")
