...
public class class61 extends class64 {
    ...
    @OriginalMember(owner = "client!WLTWEDNK", name = "h", descriptor = "I")
    public static int field1568;

    @OriginalMember(owner = "client!WLTWEDNK", name = "f", descriptor = "LWLTWEDNK;")
    public class61 field1566;

    @OriginalMember(owner = "client!WLTWEDNK", name = "g", descriptor = "LWLTWEDNK;")
