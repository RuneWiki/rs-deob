...
public class class61 extends class205 {
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lks;IIZ[[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lks;IIZ[[I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)V", line = 54)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()V", line = 58)
    public final void method419() {
        this.field2875.field2253.glFramebufferTexture2DEXT(36160, this.field811, 3553, 0, 0);
        this.field811 = -1;
    }

    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lks;II)V", line = 65)
