...
public class class61 extends class388 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lsl;I)V")
    ...
    @OriginalMember(owner = "client!k", name = "d", descriptor = "(Z)Lg;")
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ZILsl;)V")
