...
public class class61 extends class19 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "([IIIILrr;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "()Lnr;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lvo;II)Lll;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZLrr;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(III)Lkj;")
    ...
    @OriginalMember(owner = "client!gf", name = "d", descriptor = "()Lnr;")
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lpn;)V")
