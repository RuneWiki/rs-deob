...
public class class61 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Le;BIIII)Le;", line = 6)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(B)V", line = 283)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZILfh;)V", line = 333)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 500)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIZI)I", line = 549)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z[BB)V", line = 677)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)V", line = 728)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIIBIILe;I)Le;", line = 742)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lfh;I)V", line = 814)
