...
public class class61 {
    ...
    @OriginalMember(owner = "client!WOJPETNO", name = "b", descriptor = "[LWOJPETNO;")
    public static class61[] field1641;

    @OriginalMember(owner = "client!WOJPETNO", name = "a", descriptor = "(LGWOEELWB;B)V")
    ...
    @OriginalMember(owner = "client!WOJPETNO", name = "a", descriptor = "(IILMLYYHULT;)V")
