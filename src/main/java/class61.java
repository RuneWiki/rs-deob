...
public class class61 implements Runnable {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ZLjava/lang/String;)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILjava/lang/String;Z)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ljava/lang/String;I)Llm;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ljava/lang/String;B[Ljava/lang/Class;Ljava/lang/Class;)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(BLjava/awt/Frame;)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)Llm;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(II[ILjava/awt/Component;ILjava/awt/Point;)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILjava/net/URL;)Luga;")
    public final class218 method638(int arg0, URL arg1) {
        return arg0 == 30975 ? this.method640(0, arg1, 0, 0, 4) : null;
    }

    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ljava/lang/String;ZII)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ILjava/lang/Object;III)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "d", descriptor = "(I)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ljava/lang/Runnable;II)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(II)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Luga;")
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIIII)Luga;")
