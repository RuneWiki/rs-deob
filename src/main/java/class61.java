...
public class class61 extends class719 {
    ...
    @OriginalMember(owner = "client!gda", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gda", name = "<init>", descriptor = "(Lee;)V", line = 15)
    public class61(class703 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(IZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!gda", name = "b", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!gda", name = "g", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ZLb;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ZZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Ljca;IIIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(III)V", line = 124)
