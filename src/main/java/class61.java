...
public class class61 extends class157 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 6)
    ...
    @OriginalMember(owner = "client!bd", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 24)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method650(arg0.getY(), (byte) -76, arg0.getX());
        field1197++;
    }

    @OriginalMember(owner = "client!bd", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 33)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method650(arg0.getY(), (byte) -76, arg0.getX());
        field1196++;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILjava/awt/event/MouseEvent;)I", line = 42)
    ...
    @OriginalMember(owner = "client!bd", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 77)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method650(arg0.getY(), (byte) -76, arg0.getX());
        field1222++;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)Z", line = 87)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!bd", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 122)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field1205++;
        this.method650(arg0.getY(), (byte) -76, arg0.getX());
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IBI)V", line = 131)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)I", line = 151)
    public final int method571(byte arg0) {
        field1200++;
        return arg0 <= 69 ? -123 : this.field1218;
    }

    @OriginalMember(owner = "client!bd", name = "f", descriptor = "(I)Lbu;", line = 162)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IIIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!bd", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 194)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)Z", line = 219)
    ...
    @OriginalMember(owner = "client!bd", name = "e", descriptor = "(I)Z", line = 229)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILcea;I)Ljava/lang/String;", line = 241)
    ...
    @OriginalMember(owner = "client!bd", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 274)
    ...
    @OriginalMember(owner = "client!bd", name = "g", descriptor = "(I)V", line = 302)
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 387)
    public class61(Component arg0, boolean arg1) {
        this.method648((byte) -108, arg0);
        this.field1228 = arg1;
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Z)I", line = 330)
    ...
    @OriginalMember(owner = "client!bd", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 345)
    ...
    @OriginalMember(owner = "client!bd", name = "c", descriptor = "(B)V", line = 372)
