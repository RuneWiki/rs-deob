...
public class class61 extends class204 {
    ...
    @OriginalMember(owner = "client!fka", name = "c", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(II)I", line = 41)
    ...
    @OriginalMember(owner = "client!fka", name = "d", descriptor = "(II)V", line = 58)
    ...
    @OriginalMember(owner = "client!fka", name = "b", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!fka", name = "<init>", descriptor = "(Lfs;)V", line = 83)
    public class61(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fka", name = "a", descriptor = "(B)I", line = 91)
    ...
    @OriginalMember(owner = "client!fka", name = "b", descriptor = "(B)I", line = 102)
    ...
    @OriginalMember(owner = "client!fka", name = "<init>", descriptor = "(ILfs;)V", line = 116)
