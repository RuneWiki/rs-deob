...
public class class61 {
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "c", descriptor = "LJBHJGXME;")
    public class27 field1517 = new class27();

    @OriginalMember(owner = "client!UEUHLQTT", name = "d", descriptor = "LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "a", descriptor = "(LJBHJGXME;)V")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "a", descriptor = "(LJBHJGXME;I)V")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "a", descriptor = "()LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "b", descriptor = "()LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "a", descriptor = "(I)LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "a", descriptor = "(Z)LJBHJGXME;")
    ...
    @OriginalMember(owner = "client!UEUHLQTT", name = "b", descriptor = "(I)LJBHJGXME;")
