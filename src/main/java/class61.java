...
@OriginalClass("client!XTGOQLGZ")
public class class61 extends class54 {

    @OriginalMember(owner = "client!XTGOQLGZ", name = "s", descriptor = "Z")
    public boolean field1573 = false;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "t", descriptor = "LZSSCYSIO;")
    private class71 field1574;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "l", descriptor = "I")
    public int field1566;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "m", descriptor = "I")
    public int field1567;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "n", descriptor = "I")
    public int field1568;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "o", descriptor = "I")
    public int field1569;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "p", descriptor = "I")
    public int field1570;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "q", descriptor = "I")
    private int field1571;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "r", descriptor = "I")
    private int field1572;

    @OriginalMember(owner = "client!XTGOQLGZ", name = "a", descriptor = "(B)LCCYECDYX;")
    ...
    @OriginalMember(owner = "client!XTGOQLGZ", name = "<init>", descriptor = "(IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!XTGOQLGZ", name = "a", descriptor = "(II)V")
