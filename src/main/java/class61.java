...
public class class61 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "([III)Lgu;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I[II)Lgu;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIZ[I)Lgu;")
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(II[II)Lgu;")
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Llt;Llt;)V")
