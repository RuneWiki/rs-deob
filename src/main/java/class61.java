...
public class class61 extends class28 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(III)Z", line = 15)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "()V", line = 31)
    public class61() {
    }

    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 33)
