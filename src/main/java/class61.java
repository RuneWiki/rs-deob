...
public class class61 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!UNXTKTRJ", name = "p", descriptor = "[LYGMSKJOQ;")
    ...
    @OriginalMember(owner = "client!UNXTKTRJ", name = "q", descriptor = "LLQFUVOUC;")
    public class31 field1522;

    @OriginalMember(owner = "client!UNXTKTRJ", name = "o", descriptor = "LYQSLUNUN;")
