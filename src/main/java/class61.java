...
public class class61 extends class243 {
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(III)Lvr;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lef;I)V")
    ...
    @OriginalMember(owner = "client!tt", name = "c", descriptor = "(I)Ltk;")
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lsk;I)V")
