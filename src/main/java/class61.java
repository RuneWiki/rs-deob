...
public class class61 extends class467 implements class191 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILkha;)V", line = 4)
    public final void method340(int arg0, class584 arg1) {
        super.method340(arg0, arg1);
    }

    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lmh;Lqda;III[B)V", line = 16)
    ...
    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 97)
