...
public class class61 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IILnn;)V", line = 6)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Lnn;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)Lse;", line = 89)
