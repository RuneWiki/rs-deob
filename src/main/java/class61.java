...
public class class61 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)Z", line = 12)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(Z)V", line = 56)
