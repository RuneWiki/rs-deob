...
public class class61 extends class30 {
    ...
    @OriginalMember(owner = "client!co", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "g", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(BILmo;)Lpo;", line = 32)
    ...
    @OriginalMember(owner = "client!co", name = "c", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IB)[I", line = 63)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "()V", line = 206)
    public class61() {
        super(0, true);
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(Z)V", line = 209)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZ)V", line = 274)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Ljg;II)V", line = 299)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZLjg;)Lfj;", line = 416)
