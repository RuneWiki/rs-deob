...
public class class61 extends class83 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lhc;)Lok;", line = 4)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
