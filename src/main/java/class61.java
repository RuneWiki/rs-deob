...
public class class61 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II)Lqi;", line = 54)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z)V", line = 89)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 104)
