...
public class class61 extends class509 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBI)V", line = 41)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!nv", name = "e", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!nv", name = "<init>", descriptor = "(Lnca;Ldda;)V", line = 90)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZILmn;)V", line = 120)
    ...
    @OriginalMember(owner = "client!nv", name = "d", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IZ)V", line = 150)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ZB)V", line = 159)
    public final void method35(boolean arg0, byte arg1) {
        this.field717 = arg0;
        int var3 = -40 % ((40 - arg1) / 36);
    }

    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Z)V", line = 175)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(B)V", line = 238)
