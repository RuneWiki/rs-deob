...
public class class61 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BI)Z", line = 82)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(II)Ljf;", line = 117)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Liaa;[[BZ)V", line = 159)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lvd;IZLpe;Lpe;)V", line = 279)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZB)V", line = 238)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(BI)V", line = 257)
