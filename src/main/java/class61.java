...
public class class61 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZC)C", line = 3)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZII)I", line = 401)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 426)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(III)Lno;", line = 443)
