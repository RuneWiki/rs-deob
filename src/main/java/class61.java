...
public class class61 extends class71 {
    ...
    @OriginalMember(owner = "client!WYAAPLJP", name = "z", descriptor = "LVYCKCNXO;")
    ...
    @OriginalMember(owner = "client!WYAAPLJP", name = "n", descriptor = "Lclient;")
    public static client field1595;

    @OriginalMember(owner = "client!WYAAPLJP", name = "b", descriptor = "(Z)LMKWUPJYP;")
    ...
    @OriginalMember(owner = "client!WYAAPLJP", name = "a", descriptor = "(Z)LOQIGXOFQ;")
