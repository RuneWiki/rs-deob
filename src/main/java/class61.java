...
public class class61 implements class152 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B[[[Ljd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BI)Lpp;", line = 81)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IFIIIZ)[I", line = 105)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IB)Lmp;", line = 120)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ILuo;Lcf;)I", line = 133)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)Lpg;", line = 159)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IBFZII)[I", line = 174)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)Z", line = 185)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lnq;Lnq;Lnq;)V", line = 222)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZIIIIF)[F", line = 205)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 414)
