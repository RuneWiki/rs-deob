...
public class class61 extends class606 {
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IBLkd;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(III)V", line = 44)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IZ)V", line = 70)
    ...
    @OriginalMember(owner = "client!mia", name = "b", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(ILjava/lang/String;)V", line = 103)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(B)V", line = 142)
    public final void method521(byte arg0) {
        ++field758;
        int var2 = -52 / ((-26 - arg0) / 56);
    }

    @OriginalMember(owner = "client!mia", name = "d", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(Lma;II)V", line = 165)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IIZI)Lfp;", line = 177)
    ...
    @OriginalMember(owner = "client!mia", name = "c", descriptor = "(I)Z", line = 196)
    public final boolean method525(int arg0) {
        ++field744;
        return arg0 <= 19;
    }

    @OriginalMember(owner = "client!mia", name = "<init>", descriptor = "(Lsr;)V", line = 207)
    public class61(class251 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IIIIIIIIBI)Z", line = 212)
    ...
    @OriginalMember(owner = "client!mia", name = "a", descriptor = "(IIB)I", line = 853)
