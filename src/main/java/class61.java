...
public class class61 extends class449 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIII)V", line = 184)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 208)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZBLjava/awt/Component;)Lpo;", line = 223)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(II[III)V", line = 239)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIIIB)V", line = 268)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(I[B)V", line = 284)
