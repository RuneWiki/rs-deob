...
public class class61 extends class426 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!in", name = "e", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZIBIZ)Loi;", line = 58)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/awt/Graphics;IIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!in", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 112)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field749;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ljava/awt/Graphics;ZII)V", line = 121)
    ...
    @OriginalMember(owner = "client!in", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 135)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field764;
        return this.field756 == arg0;
    }

    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Ltn;I)V", line = 143)
    ...
    @OriginalMember(owner = "client!in", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 157)
    public final void startProduction(ImageConsumer arg0) {
        ++field768;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!in", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 171)
    ...
    @OriginalMember(owner = "client!in", name = "f", descriptor = "(I)V", line = 184)
    ...
    @OriginalMember(owner = "client!in", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 198)
    ...
    @OriginalMember(owner = "client!in", name = "g", descriptor = "(I)V", line = 228)
