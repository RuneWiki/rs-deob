...
public class class61 {
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IZ)Let;", line = 4)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(Z)V", line = 56)
    ...
    @OriginalMember(owner = "client!pv", name = "a", descriptor = "(IIIII[B[BII)V", line = 69)
