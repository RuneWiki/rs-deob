...
@OriginalClass("client!UVAKRMXV")
public class class61 {

    @OriginalMember(owner = "client!UVAKRMXV", name = "a", descriptor = "Z")
    private boolean field1418 = true;

    @OriginalMember(owner = "client!UVAKRMXV", name = "b", descriptor = "[I")
    public int[] field1419 = new int[2];

    @OriginalMember(owner = "client!UVAKRMXV", name = "c", descriptor = "[[[I")
    public int[][][] field1420 = new int[2][2][4];

    @OriginalMember(owner = "client!UVAKRMXV", name = "d", descriptor = "[[[I")
    public int[][][] field1421 = new int[2][2][4];

    @OriginalMember(owner = "client!UVAKRMXV", name = "e", descriptor = "[I")
    public int[] field1422 = new int[2];

    @OriginalMember(owner = "client!UVAKRMXV", name = "f", descriptor = "[[F")
    public static float[][] field1423 = new float[2][8];

    @OriginalMember(owner = "client!UVAKRMXV", name = "g", descriptor = "[[I")
    public static int[][] field1424 = new int[2][8];

    @OriginalMember(owner = "client!UVAKRMXV", name = "h", descriptor = "F")
    public static float field1425;

    @OriginalMember(owner = "client!UVAKRMXV", name = "i", descriptor = "I")
    public static int field1426;

    @OriginalMember(owner = "client!UVAKRMXV", name = "a", descriptor = "(FIII)F")
    ...
    @OriginalMember(owner = "client!UVAKRMXV", name = "a", descriptor = "(FI)F")
    ...
    @OriginalMember(owner = "client!UVAKRMXV", name = "a", descriptor = "(IFII)F")
    ...
    @OriginalMember(owner = "client!UVAKRMXV", name = "a", descriptor = "(ZFI)I")
    ...
    @OriginalMember(owner = "client!UVAKRMXV", name = "a", descriptor = "(LRRWCTNMK;LEILHLJCE;I)V")
    ...
    @OriginalMember(owner = "client!UVAKRMXV", name = "<init>", descriptor = "()V")
    public class61() {
        if (class30.field987) {
        }
    }
