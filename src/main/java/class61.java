...
public abstract class class61 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILjava/lang/String;IIIIILjava/util/Random;[Lwn;I[II[IIB)I")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "([ILjava/lang/String;BI[Lwn;III)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "([Lwn;IIII[IILjava/lang/String;ILjava/util/Random;)I")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IILjava/lang/String;IIII[IIBLde;[Lwn;IIII)I")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILjava/lang/String;I[I[I[II[Lwn;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II[Lwn;ILjava/lang/String;II[ILde;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)Lms;")
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lea;Lci;)V")
