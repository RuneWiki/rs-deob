...
public class class61 extends class440 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "()V", line = 227)
    public class61() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I[II)V", line = 67)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIIBIII)I", line = 248)
    ...
    @OriginalMember(owner = "client!qh", name = "h", descriptor = "(I)V", line = 328)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILmo;I)V", line = 370)
