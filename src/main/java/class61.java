...
public class class61 extends class65 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "()I", line = 5)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "([I)Lso;", line = 13)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)F", line = 72)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "([B)V", line = 84)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "([B)V", line = 239)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "([BI)V", line = 283)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lla;)Z", line = 293)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)[F", line = 306)
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "()V", line = 723)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lla;II)Lkda;", line = 741)
    ...
    @OriginalMember(owner = "client!kda", name = "c", descriptor = "(I)I", line = 771)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Lla;I)Lkda;", line = 800)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "([B)V", line = 814)
