...
public class passwordapp extends Applet implements ActionListener, KeyListener, TextListener, Runnable {
   ...
   private String[] example_questions = new String[]{"Where were you born?", "What was your first teachers name?", "What is your fathers middle name?", "What is your mothers middle name?", "Who was your first best friend?", "What is your favourite vacation spot?", "What was your first pets name?", "What was the name of your first school?", "What is your mothers maiden name?", "Who was your first boyfriend/girlfriend?", "Who is your favourite actor/actress?", "Who is your favourite author?", "Who is your favourite musician?", "Who is your favourite cartoon character?", "What is your favourite book?", "What is your favourite food?", "What is your favourite movie?"};
   @OriginalMember(
      owner = "passapplet!passwordapp",
      name = "initialised",
      descriptor = "Z"
   ...
   private void init_messages() {
      ...
      Label var1 = this.getLabel("Processing Request", 180, this.getSize().height / 2 - 10);
      ...
      Label var4 = this.getLabel("Error Processing Request", 165, var2);
      var4.setFont(new Font("Arial", 1, 13));
      this.system_error_page.add(var4);
      this.system_error_page.add(this.getLabel("Sorry, there was an error processing your request.", 100, var2 + 30));
      this.system_error_page.add(this.getLabel("Please try again later.", 180, var2 + 50));
      Button var3 = new Button("Go back and try again");
      var3.setBounds(150, var2 + 80, 200, 22);
      ...
      this.blocked_query_page.add(this.getLabel("Due to continued problems with this account, we are no longer", 80, this.getSize().height / 2 - 20));
      this.blocked_query_page.add(this.getLabel("accepting password support requests for it.", 80, this.getSize().height / 2));
      ...
      this.blocked_attack_page.add(this.getLabel("Due to repeated attempts at password recovery from your ip", 80, this.getSize().height / 2 - 20));
      this.blocked_attack_page.add(this.getLabel("your request has been denied. Please try again later.", 80, this.getSize().height / 2));
      ...
      this.wrongpassword_page.add(this.getLabel("You entered your existing password incorrectly.", 110, var5));
      this.wrongpassword_page.setVisible(false);
      Button var6 = new Button("Go Back");
      ...
      this.change_questions_success_page_active.add(this.getLabel("Your Recovery Questions and Answers have been successfully updated", 30, this.getSize().height / 2 - 10));
      this.change_questions_success_page_active.add(this.getLabel("and are now active.", 30, this.getSize().height / 2 + 10));
      ...
      this.change_questions_success_page_pending.add(this.getLabel("Your Recovery Questions and Answers have been successfully set", 30, this.getSize().height / 2 - 10));
      this.change_questions_success_page_pending.add(this.getLabel("and are pending. They will become active in 14 days.", 30, this.getSize().height / 2 + 10));
      ...
      this.change_questions_tooshort_page.add(this.getLabel("One or more of the questions or answers", 130, 200));
      this.change_questions_tooshort_page.add(this.getLabel("that you gave was too short or empty.", 140, 220));
      this.change_questions_tooshort_page.setVisible(false);
      Button var7 = new Button("Go Back");
      ...
      this.change_questions_samequestions_page.add(this.getLabel("Two or more of the questions you entered were", 120, 200));
      this.change_questions_samequestions_page.add(this.getLabel("the same. All questions must be different.", 130, 220));
      this.change_questions_samequestions_page.setVisible(false);
      Button var8 = new Button("Go Back");
      ...
      this.change_questions_sameanswers_page.add(this.getLabel("Two or more of the answers you entered were", 120, 200));
      this.change_questions_sameanswers_page.add(this.getLabel("the same. All answers must be different.", 130, 220));
      this.change_questions_sameanswers_page.setVisible(false);
      Button var9 = new Button("Go Back");
      ...
      this.change_questions_qandamatch_page.add(this.getLabel("One or more of your questions matches one", 120, 200));
      this.change_questions_qandamatch_page.add(this.getLabel("of the answers you entered. Please make sure", 110, 220));
      this.change_questions_qandamatch_page.add(this.getLabel("that none of your answers match any of your questions.", 90, 240));
      this.change_questions_qandamatch_page.setVisible(false);
      Button var10 = new Button("Go Back");
      var10.setBounds(150, 270, 200, 22);
   ...
   private void init_change_questions() {
      ...
      this.change_questions_page.add(this.getLabel("Answer:", 0, 400, 100, 20));
      this.change_questions_page.add(this.recov[3]);
      Label var9 = this.getLabel("Recovery Question 5", 0, 440);
      var9.setFont(new Font("Arial", 1, 13));
      this.change_questions_page.add(var9);
      this.change_questions_page.add(this.getLabel("Question:", 0, 470, 100, 20));
      this.change_questions_page.add(this.question[4]);
      Button var12 = new Button("New Question");
      ...
      this.change_questions_page.add(this.getLabel("Answer:", 0, 500, 100, 20));
      this.change_questions_page.add(this.recov[4]);
      Button var4 = new Button("Submit Questions & Answers");
      ...
      if (this.onreversepath) {
         ...
         if (this.type == 2) {
            ...
            if (var2 != null && var2.startsWith("NEWRQ")) {
               String var10 = this.example_questions[(int)(Math.random() * (double)(this.example_questions.length - 1))];
   ...
   public void keyPressed(KeyEvent arg0) {
      ...
      if (var2 != 8 && var2 != 127 && !arg0.isActionKey() && (arg0.getModifiers() & 2) == 0 && (arg0.getModifiers() & 8) == 0) {
         ...
         } else if (var3 instanceof TextArea) {
            TextArea var5 = (TextArea)var3;
            if (var5.getText().length() >= 400 && var5.getSelectedText().equals("")) {
               arg0.consume();
            }
         }
