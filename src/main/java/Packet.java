...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!mb", name = "C", descriptor = "Lpb;")
    private static LinkList field702;

    @OriginalMember(owner = "client!mb", name = "D", descriptor = "Lpb;")
    private static LinkList field703;

    @OriginalMember(owner = "client!mb", name = "E", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!mb", name = "y", descriptor = "Lxb;")
    public Isaac field698;

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZI)Lmb;")
