...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!kb", name = "D", descriptor = "Lob;")
    private static LinkList field632;

    @OriginalMember(owner = "client!kb", name = "E", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!kb", name = "y", descriptor = "Ltb;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZI)Lkb;")
