...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!mb", name = "y", descriptor = "Lpb;")
    private static LinkList field721;

    @OriginalMember(owner = "client!mb", name = "z", descriptor = "Lpb;")
    private static LinkList field722;

    @OriginalMember(owner = "client!mb", name = "A", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!mb", name = "u", descriptor = "Lxb;")
