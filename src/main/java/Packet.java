...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!jb", name = "x", descriptor = "Lnb;")
    private static LinkList field594;

    @OriginalMember(owner = "client!jb", name = "y", descriptor = "Lnb;")
    private static LinkList field595;

    @OriginalMember(owner = "client!jb", name = "z", descriptor = "Lnb;")
    ...
    @OriginalMember(owner = "client!jb", name = "t", descriptor = "Lsb;")
    public Isaac field590;

    @OriginalMember(owner = "client!jb", name = "A", descriptor = "Z")
    public static boolean field597;

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)Ljb;")
