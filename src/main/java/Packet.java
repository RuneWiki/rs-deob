...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!kb", name = "w", descriptor = "Lob;")
    private static LinkList field632;

    @OriginalMember(owner = "client!kb", name = "x", descriptor = "Lob;")
    private static LinkList field633;

    @OriginalMember(owner = "client!kb", name = "y", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!kb", name = "s", descriptor = "Ltb;")
