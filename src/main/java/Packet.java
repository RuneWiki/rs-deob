...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!kb", name = "C", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!kb", name = "w", descriptor = "Ltb;")
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(BI)Lkb;")
