...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!mb", name = "u", descriptor = "Lpb;")
    private static LinkList field706;

    @OriginalMember(owner = "client!mb", name = "v", descriptor = "Lpb;")
    private static LinkList field707;

    @OriginalMember(owner = "client!mb", name = "w", descriptor = "Lpb;")
    ...
    @OriginalMember(owner = "client!mb", name = "q", descriptor = "Lxb;")
