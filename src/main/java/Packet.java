...
public class Packet extends DoublyLinkable {
    ...
    @OriginalMember(owner = "client!kb", name = "z", descriptor = "Lob;")
    private static LinkList field630;

    @OriginalMember(owner = "client!kb", name = "A", descriptor = "Lob;")
    private static LinkList field631;

    @OriginalMember(owner = "client!kb", name = "B", descriptor = "Lob;")
    ...
    @OriginalMember(owner = "client!kb", name = "v", descriptor = "Ltb;")
    ...
    public void method205(byte arg0, int arg1) {
        this.field621[this.field622++] = (byte) (arg1 + this.field626.method253());
