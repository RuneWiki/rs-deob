...
public class class799 extends class391 implements class719 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Ldga;Z)V")
    public class799(class713 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
