...
public abstract class class509 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lrq;B)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(ILdw;)V")
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lcr;ZLjava/lang/String;ZI)V")
