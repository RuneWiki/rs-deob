...
public class class509 extends class681 {
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "([Lhv;Z)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;J[Lqi;[Lhv;Z)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "()Lfl;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;[Lqi;Z)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(IZ)Lod;")
    ...
    @OriginalMember(owner = "client!od", name = "g", descriptor = "()Lfl;")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(Lha;)V")
