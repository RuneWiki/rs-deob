...
public class class509 extends class117 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZ)Lsv;")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lti;[IB)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BLti;)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lti;ZI)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lti;Z)Ljava/lang/String;")
