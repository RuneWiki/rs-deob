...
public abstract class class509 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ILfh;)V", line = 5)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)I", line = 39)
    public static final int method3029(int arg0, int arg1) {
        return class341.field5093 == null ? 0 : class341.field5093[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(II)V", line = 54)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Ltt;)V", line = 95)
    public class509(class249 arg0) {
        this.field7409 = arg0;
    }

    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Lwl;BZ)V", line = 103)
