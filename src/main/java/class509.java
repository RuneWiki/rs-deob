...
public abstract class class509 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IIIIIIIIIZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!eba", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 80)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(Lkw;)V", line = 108)
    public class509(class174 arg0) {
        this.field7558 = arg0;
    }

    @OriginalMember(owner = "client!eba", name = "b", descriptor = "(IBI)V", line = 125)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IB)Z", line = 145)
    ...
    @OriginalMember(owner = "client!eba", name = "c", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(III)I", line = 171)
    ...
    @OriginalMember(owner = "client!eba", name = "d", descriptor = "(I)V", line = 186)
