...
public class class509 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 105)
    public class509(Throwable arg0, String arg1) {
        this.field7248 = arg0;
        this.field7247 = arg1;
    }

    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)Lhb;", line = 116)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIB)V", line = 170)
    ...
    @OriginalMember(owner = "client!ek", name = "c", descriptor = "(I)I", line = 185)
    ...
    @OriginalMember(owner = "client!ek", name = "d", descriptor = "(I)V", line = 197)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)V", line = 214)
