...
public class class509 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([Ljava/lang/String;IZ[SI)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lem;B)Lem;")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(III)V")
