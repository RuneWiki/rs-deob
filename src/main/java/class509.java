...
public class class509 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I[S)[S", line = 6)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(ILhe;II)J", line = 25)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(III)Z", line = 56)
