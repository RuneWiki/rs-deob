...
public class class509 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BLpt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IJ)Ljava/lang/Object;", line = 33)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(IJ)V", line = 76)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(JILjava/lang/Object;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!hn", name = "<init>", descriptor = "(I)V", line = 335)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IB)V", line = 163)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Llr;[II[I[I)V", line = 216)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)I", line = 313)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)I", line = 350)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(B)I", line = 361)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lza;II)Z", line = 373)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZLjk;II)V", line = 784)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 808)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(B)V", line = 840)
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(I)V", line = 857)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(JLjava/lang/Object;I)V", line = 871)
    public final void method3046(long arg0, Object arg1, int arg2) {
        field7390++;
        this.method3035(arg0, arg2 + 29542, arg1, arg2);
    }

    @OriginalMember(owner = "client!hn", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 879)
