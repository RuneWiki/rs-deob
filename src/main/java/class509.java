...
public class class509 extends class105 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 3)
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Lmb;Ljava/lang/Object;I)V", line = 56)
    public class509(class288 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field7392 = arg1;
    }

    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(Z)Z", line = 69)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BILza;ILpu;)V", line = 80)
    ...
    @OriginalMember(owner = "client!bf", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 114)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lec;ZZII)V", line = 125)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lza;Lvl;III)V", line = 206)
