...
public class class509 extends class748 {
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IZII[BII[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(II)[I", line = 55)
    ...
    @OriginalMember(owner = "client!vq", name = "a", descriptor = "(IZLvj;)V", line = 113)
    ...
    @OriginalMember(owner = "client!vq", name = "<init>", descriptor = "()V", line = 167)
    public class509() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vq", name = "b", descriptor = "(Z)V", line = 175)
