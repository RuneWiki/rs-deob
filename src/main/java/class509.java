...
public class class509 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(B)V", line = 4)
    public static final synchronized void method2921(byte arg0) {
        field7178++;
        int var1 = 37 % ((-arg0 - 10) / 47);
    }

    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ZB)V", line = 28)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(BLp;)V", line = 43)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)V", line = 68)
