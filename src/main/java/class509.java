...
public class class509 extends class707 {
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lkha;Lfm;)V", line = 77)
    public class509(class687 arg0, class267 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IFBFIF[BILhm;FIFII)V", line = 27)
