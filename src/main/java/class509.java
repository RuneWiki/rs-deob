...
public class class509 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLwm;)V", line = 37)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)I", line = 57)
    public static int method3039(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZBLhm;)V", line = 65)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILwm;)V", line = 93)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(JLjava/lang/String;ILjava/lang/String;IIZIIZI)V", line = 153)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(II)I", line = 222)
