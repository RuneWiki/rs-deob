...
public class class509 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BILeh;)V", line = 35)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILeh;)V", line = 115)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)Z", line = 137)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(B)Lpf;", line = 170)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(B)Z", line = 242)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)Lpf;", line = 269)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Loa;Lni;III)V", line = 342)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)V", line = 401)
