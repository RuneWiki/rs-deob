...
public class class509 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)[Lud;")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "([Lf;I)V")
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lgf;III)V")
