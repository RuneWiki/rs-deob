...
public class class509 extends class11 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lya;IIIIII)Lt;")
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(III)Lei;")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lsi;II)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IJLya;)V")
