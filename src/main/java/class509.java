...
public class class509 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(II)Ljv;", line = 44)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lgn;ILvo;Lvo;)V", line = 101)
