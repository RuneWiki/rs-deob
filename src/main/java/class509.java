...
public class class509 {
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!oaa", name = "a", descriptor = "(Ljava/awt/Canvas;Z)Lnt;", line = 24)
    ...
    @OriginalMember(owner = "client!oaa", name = "<init>", descriptor = "(BIIIII)V", line = 58)
