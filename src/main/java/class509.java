...
public class class509 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(ZI)S", line = 13)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Llt;IILpi;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IF)F", line = 309)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IZI[Lep;II)V", line = 320)
