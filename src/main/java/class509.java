...
public class class509 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IILi;B)Z")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Li;III)V")
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(ILi;II)V")
    ...
    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lda;Lwv;)V")
