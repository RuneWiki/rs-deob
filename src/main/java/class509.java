...
public class class509 extends class186 {
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Leq;Ljava/lang/Object;I)V", line = 5)
    public class509(class137 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field7393 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 14)
    public final Object method1420(byte arg0) {
        return arg0 == 122 ? this.field7393.get() : (Object) null;
    }

    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)Z", line = 24)
