...
public class class509 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lbia;III)V", line = 22)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIBI)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Luu;I)V", line = 89)
