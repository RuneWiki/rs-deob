...
public class class509 extends class692 {
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!tha", name = "<init>", descriptor = "(Llea;)V", line = 56)
    ...
    @OriginalMember(owner = "client!tha", name = "c", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(BIII)I", line = 180)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(FFIIIFIIFFLlt;)[B", line = 196)
    ...
    @OriginalMember(owner = "client!tha", name = "b", descriptor = "(I)Z", line = 208)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IBI)B", line = 220)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ILfga;I)V", line = 267)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(IIIIIBI)V", line = 279)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(Lufa;IZ)V", line = 296)
    ...
    @OriginalMember(owner = "client!tha", name = "a", descriptor = "(ZB)V", line = 346)
    ...
    @OriginalMember(owner = "client!tha", name = "d", descriptor = "(I)V", line = 366)
