...
public class class509 extends class17 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILse;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIII)I", line = 86)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILme;IZ)V", line = 109)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IIIIIIFI[FI)V", line = 269)
