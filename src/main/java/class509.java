...
public class class509 extends class155 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 14)
    public class509(Object arg0, int arg1) {
        super(arg1);
        this.field7423 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!gh", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 24)
