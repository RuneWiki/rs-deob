...
public class class509 extends class409 {
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ljava/lang/String;CI)[Ljava/lang/String;", line = 67)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lmv;B)V", line = 106)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(III)V", line = 132)
