...
public class class509 extends class567 implements class310 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Loa;B)V", line = 17)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ZLoa;Lnt;IIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Lsn;B)V", line = 39)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(IIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(B)I", line = 99)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(Loa;B)V", line = 111)
    ...
    @OriginalMember(owner = "client!md", name = "<init>", descriptor = "(Loa;Lpg;IIIIIZIII)V", line = 137)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Loa;I)V", line = 146)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(I)Z", line = 158)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Loa;BI)Lba;", line = 172)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(BILoa;I)Z", line = 183)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)I", line = 202)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(ILoa;)Lww;", line = 214)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(I)I", line = 264)
    ...
    @OriginalMember(owner = "client!md", name = "e", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!md", name = "b", descriptor = "(Loa;I)Lqt;", line = 286)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Z)Z", line = 298)
    ...
    @OriginalMember(owner = "client!md", name = "c", descriptor = "(B)V", line = 313)
