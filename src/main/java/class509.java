...
public class class509 extends class31 implements class358 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lhl;Lwd;Ljm;II)V", line = 14)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIB[BIIILwd;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIII[IIZI)V", line = 74)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(FI)F", line = 125)
    public final float method599(float arg0, int arg1) {
        int var3 = -95 / ((arg1 + 41) / 47);
        return arg0 / (float) this.field7243;
    }

    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I[IIIIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lhl;Lwd;IIZ[BII)V", line = 173)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IF)F", line = 242)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(B)Z", line = 252)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lqo;I)V", line = 262)
    public final void method155(class22 arg0, int arg1) {
        super.method155(arg0, arg1);
    }

    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ZZB)V", line = 269)
    ...
    @OriginalMember(owner = "client!dk", name = "<init>", descriptor = "(Lhl;IIZ[III)V", line = 279)
    ...
    @OriginalMember(owner = "client!dk", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 338)
