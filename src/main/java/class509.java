...
public class class509 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(II)Lsq;", line = 5)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "()V", line = 198)
    public void method960() {
        field7425++;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 207)
    public void method957(Component arg0) throws Exception {
        field7422++;
    }

    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILoo;I)V", line = 264)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "([II)V", line = 288)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Loo;B)V", line = 447)
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(I)V", line = 468)
    public void method959(int arg0) throws Exception {
        field7429++;
    }

    @OriginalMember(owner = "client!eq", name = "b", descriptor = "()I", line = 481)
    public int method956() throws Exception {
        field7432++;
        return this.field7447;
    }

    @OriginalMember(owner = "client!eq", name = "f", descriptor = "(I)V", line = 501)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "()V", line = 525)
    public void method961() throws Exception {
        field7436++;
    }

    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IB)V", line = 534)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "()V", line = 551)
