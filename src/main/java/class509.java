...
public class class509 extends class172 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZLr;)Log;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(BILr;)Lda;")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ILr;Lq;Lda;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(ZLr;)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IILr;I)Z")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(ZIBLr;Llo;II)V")
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lr;I)Lsd;")
