...
public class class509 implements class277 {
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(II)Lvf;")
    ...
    @OriginalMember(owner = "client!hb", name = "c", descriptor = "(II)Lkv;")
    ...
    @OriginalMember(owner = "client!hb", name = "<init>", descriptor = "(Lfs;Lfs;Lfs;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLjava/awt/Component;)Lup;")
