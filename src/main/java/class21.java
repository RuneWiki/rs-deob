...
public class class21 extends class85 {
    ...
    @OriginalMember(owner = "client!c", name = "R", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ldf;B)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BILja;)V")
