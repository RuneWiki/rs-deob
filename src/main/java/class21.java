...
public class class21 extends class192 {
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(ILfd;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uv", name = "<init>", descriptor = "()V", line = 80)
    public class21() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uv", name = "e", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!uv", name = "a", descriptor = "(IB)[I", line = 99)
