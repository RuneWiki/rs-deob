...
public class class21 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lpg;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lpg;Ljaggl/memory/NativeBuffer;)V", line = 21)
