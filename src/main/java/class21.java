...
@OriginalClass("client!FIQZIGZB")
public class class21 {

    @OriginalMember(owner = "client!FIQZIGZB", name = "b", descriptor = "Z")
    private boolean field839 = false;

    @OriginalMember(owner = "client!FIQZIGZB", name = "c", descriptor = "I")
    private int field840 = 411;

    @OriginalMember(owner = "client!FIQZIGZB", name = "d", descriptor = "I")
    private int field841 = -427;

    @OriginalMember(owner = "client!FIQZIGZB", name = "g", descriptor = "I")
    public int field844 = -1;

    @OriginalMember(owner = "client!FIQZIGZB", name = "i", descriptor = "[I")
    public int[] field846 = new int[6];

    @OriginalMember(owner = "client!FIQZIGZB", name = "j", descriptor = "[I")
    public int[] field847 = new int[6];

    @OriginalMember(owner = "client!FIQZIGZB", name = "k", descriptor = "[I")
    public int[] field848 = new int[] { -1, -1, -1, -1, -1 };

    @OriginalMember(owner = "client!FIQZIGZB", name = "l", descriptor = "Z")
    public boolean field849 = false;

    @OriginalMember(owner = "client!FIQZIGZB", name = "a", descriptor = "Z")
    private static boolean field838 = true;

    @OriginalMember(owner = "client!FIQZIGZB", name = "e", descriptor = "I")
    public static int field842;

    @OriginalMember(owner = "client!FIQZIGZB", name = "h", descriptor = "[I")
    public int[] field845;

    @OriginalMember(owner = "client!FIQZIGZB", name = "f", descriptor = "[LFIQZIGZB;")
    public static class21[] field843;

    @OriginalMember(owner = "client!FIQZIGZB", name = "a", descriptor = "(LDYBMLHQM;Z)V")
    ...
    @OriginalMember(owner = "client!FIQZIGZB", name = "a", descriptor = "(ILINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!FIQZIGZB", name = "a", descriptor = "(B)Z")
    ...
    @OriginalMember(owner = "client!FIQZIGZB", name = "a", descriptor = "(I)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!FIQZIGZB", name = "a", descriptor = "(Z)Z")
    ...
    @OriginalMember(owner = "client!FIQZIGZB", name = "b", descriptor = "(B)LDHUPIIUL;")
