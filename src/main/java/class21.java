...
public class class21 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILbu;)Z", line = 22)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Lmca;B)Lvd;", line = 87)
