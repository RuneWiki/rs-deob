...
@OriginalClass("client!FULHVSIU")
public class class21 {

    @OriginalMember(owner = "client!FULHVSIU", name = "f", descriptor = "I")
    public int field706 = -1;

    @OriginalMember(owner = "client!FULHVSIU", name = "h", descriptor = "[I")
    public int[] field708 = new int[6];

    @OriginalMember(owner = "client!FULHVSIU", name = "i", descriptor = "[I")
    public int[] field709 = new int[6];

    @OriginalMember(owner = "client!FULHVSIU", name = "j", descriptor = "I")
    public int field710 = 128;

    @OriginalMember(owner = "client!FULHVSIU", name = "k", descriptor = "I")
    public int field711 = 128;

    @OriginalMember(owner = "client!FULHVSIU", name = "o", descriptor = "LHPFNYARJ;")
    public static class25 field715 = new class25((byte) 41, 30);

    @OriginalMember(owner = "client!FULHVSIU", name = "b", descriptor = "I")
    public static int field702;

    @OriginalMember(owner = "client!FULHVSIU", name = "d", descriptor = "I")
    public int field704;

    @OriginalMember(owner = "client!FULHVSIU", name = "e", descriptor = "I")
    public int field705;

    @OriginalMember(owner = "client!FULHVSIU", name = "l", descriptor = "I")
    public int field712;

    @OriginalMember(owner = "client!FULHVSIU", name = "m", descriptor = "I")
    public int field713;

    @OriginalMember(owner = "client!FULHVSIU", name = "n", descriptor = "I")
    public int field714;

    @OriginalMember(owner = "client!FULHVSIU", name = "g", descriptor = "LNMXKUYSC;")
    public class42 field707;

    @OriginalMember(owner = "client!FULHVSIU", name = "a", descriptor = "Z")
    private static boolean field701;

    @OriginalMember(owner = "client!FULHVSIU", name = "c", descriptor = "[LFULHVSIU;")
    public static class21[] field703;

    @OriginalMember(owner = "client!FULHVSIU", name = "a", descriptor = "(ILCVNWKEAW;)V")
    ...
    @OriginalMember(owner = "client!FULHVSIU", name = "a", descriptor = "(BLXOUQUKZW;)V")
    ...
    @OriginalMember(owner = "client!FULHVSIU", name = "a", descriptor = "()LKPUOCBCE;")
