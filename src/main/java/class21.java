...
public class class21 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III)Lida;")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lks;II)V")
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(BI)Ldn;")
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Lrf;ILpl;Lpl;)V")
