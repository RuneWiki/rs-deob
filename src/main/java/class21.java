...
public class class21 extends class331 {
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(ILts;)V", line = 15)
    public class21(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(II)I", line = 22)
    public final int method222(int arg0, int arg1) {
        ++field266;
        return arg1 != 1 ? -126 : 1;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(III[Lgaa;ZZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Lts;)V", line = 87)
    public class21(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(B)I", line = 108)
    public final int method225(byte arg0) {
        ++field265;
        return arg0 >= -119 ? 85 : super.field4202;
    }

    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(B)I", line = 119)
    public final int method226(byte arg0) {
        ++field267;
        return arg0 != 13 ? 60 : 1;
    }

    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(II)V", line = 130)
