...
public class class21 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIIIIBII)V", line = 8)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IZLrg;)V", line = 40)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)Z", line = 85)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BLjava/lang/String;)V", line = 116)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IB)V", line = 135)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "([IZLke;[I[I)V", line = 149)
