...
public class class21 extends class264 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "()[I", line = 7)
    public final int[] method237() {
        return this.field301;
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "()V", line = 10)
    public static void method238() {
        field300 = null;
    }

    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(II)V", line = 15)
    public final void method239(int arg0, int arg1) {
        if (arg0 == 0 && arg1 == 0) {
            return;
        }
        if (field300 == null || field300.length < this.field301.length) {
            field300 = new int[this.field301.length];
        }
        int var3 = this.field301.length;
        int var4 = arg0;
        int var5 = this.field303 - 1;
        int var6 = this.field303 * arg1;
        int var7 = var3 - 1;
        for (int var8 = 0; var8 < var3; var8 += this.field303) {
            int var10 = var6 + var8 & var7;
            for (int var11 = 0; var11 < this.field303; var11++) {
                int var12 = var8 + var11;
                int var13 = (var4 + var11 & var5) + var10;
                field300[var12] = this.field301[var13];
            }
        }
        int[] var9 = this.field301;
        this.field301 = field300;
        field300 = var9;
    }

    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(II[IZ)V", line = 59)
    public class21(int arg0, int arg1, int[] arg2, boolean arg3) {
        this.field299 = arg0;
        this.field303 = arg1;
        this.field301 = arg2;
        if (arg3) {
            int[] var5 = new int[this.field303];
            int[] var6 = new int[this.field303];
            int[] var7 = new int[this.field303];
            if (field300 == null || field300.length < this.field301.length) {
                field300 = new int[this.field301.length];
            }
            int var8 = this.field303;
            int var9 = this.field303;
            int var10 = var8 - 1;
            int var11 = var9 - 1;
            int var12 = var8 * var9;
            int var13 = var8;
            ...
            for (int var17 = var11; var17 >= 0; var17--) {
                ...
                for (int var25 = var10; var25 >= 0; var25--) {
                    ...
                    int var31 = var22 / 9;
                    var16--;
                    field300[var16] = var29 << 16 | var30 << 8 | var31;
                ...
                for (int var26 = var10; var26 >= 0; var26--) {
                    var13--;
                    int var27 = this.field301[var13];
                    var14--;
                    int var28 = this.field301[var14];
