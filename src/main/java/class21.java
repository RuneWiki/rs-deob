...
public abstract class class21 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!rc", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 3)
    public final void focusLost(FocusEvent arg0) {
        class481.field7012 = false;
        field382++;
    }

    @OriginalMember(owner = "client!rc", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 12)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(IIZII)V", line = 28)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!rc", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 150)
    public final void windowActivated(WindowEvent arg0) {
        field379++;
    }

    @OriginalMember(owner = "client!rc", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 157)
    public final void windowDeiconified(WindowEvent arg0) {
        field388++;
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(BZI)V", line = 165)
    ...
    @OriginalMember(owner = "client!rc", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 184)
    ...
    @OriginalMember(owner = "client!rc", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 204)
    public final void windowClosing(WindowEvent arg0) {
        field372++;
        this.destroy();
    }

    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(I)Z", line = 212)
    ...
    @OriginalMember(owner = "client!rc", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 257)
    public final void windowIconified(WindowEvent arg0) {
        field368++;
    }

    @OriginalMember(owner = "client!rc", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 264)
    public final void windowDeactivated(WindowEvent arg0) {
        field402++;
    }

    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 322)
    ...
    @OriginalMember(owner = "client!rc", name = "c", descriptor = "(B)V", line = 359)
    ...
    @OriginalMember(owner = "client!rc", name = "destroy", descriptor = "()V", line = 374)
    ...
    @OriginalMember(owner = "client!rc", name = "d", descriptor = "(B)V", line = 388)
    ...
    @OriginalMember(owner = "client!rc", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 400)
    public final void update(Graphics arg0) {
        field399++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ZI)V", line = 417)
    ...
    @OriginalMember(owner = "client!rc", name = "start", descriptor = "()V", line = 496)
    ...
    @OriginalMember(owner = "client!rc", name = "run", descriptor = "()V", line = 508)
    ...
    @OriginalMember(owner = "client!rc", name = "stop", descriptor = "()V", line = 627)
    ...
    @OriginalMember(owner = "client!rc", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 642)
    ...
    @OriginalMember(owner = "client!rc", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 656)
    ...
    @OriginalMember(owner = "client!rc", name = "f", descriptor = "(I)V", line = 678)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lsc;IIIII)V", line = 710)
    ...
    @OriginalMember(owner = "client!rc", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 779)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Z)V", line = 788)
    ...
    @OriginalMember(owner = "client!rc", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 871)
    public final void windowOpened(WindowEvent arg0) {
        field370++;
    }

    @OriginalMember(owner = "client!rc", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 878)
    public final void windowClosed(WindowEvent arg0) {
        field395++;
    }

    @OriginalMember(owner = "client!rc", name = "providesignlink", descriptor = "(Lhs;)V", line = 886)
    ...
    @OriginalMember(owner = "client!rc", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 894)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(ILjava/lang/String;ZIIIIB)V", line = 911)
