...
public class class21 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lnr;[II[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)V", line = 7)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lnr;[IIII[I[I)V", line = 58)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "()V", line = 96)
    private static final void method179() {
        field349 = 0;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)Z", line = 147)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "()V", line = 222)
    public static void method182() {
        field347 = null;
    }

    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)V", line = 225)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([III)V", line = 265)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lnr;[II)V", line = 317)
