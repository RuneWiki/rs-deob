...
public class class21 extends InputStream {
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZLja;)V", line = 113)
    ...
    @OriginalMember(owner = "client!mp", name = "read", descriptor = "()I", line = 132)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(B)V", line = 141)
