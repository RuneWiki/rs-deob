...
public class class21 extends class42 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lcr;B)Lcr;", line = 3)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I[B[BIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIIIII)Lto;", line = 66)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lpc;Lqa;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(B)V", line = 106)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "([Lf;B)V", line = 137)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 173)
