...
public class class21 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BI)Lul;", line = 13)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lfb;III)V", line = 43)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIBI)V", line = 133)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(BI)V", line = 144)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Z)V", line = 166)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IZLfb;)V", line = 223)
