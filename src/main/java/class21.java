...
public class class21 extends class7 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I[IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!o", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZI)V", line = 239)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIIB[I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IBII)I", line = 125)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(ILmo;IB)Lg;", line = 139)
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(I[III)Z", line = 177)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(III)Z", line = 212)
