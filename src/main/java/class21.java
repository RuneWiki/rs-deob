...
public class class21 extends class269 {
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IBZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZI)V", line = 295)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIII)V", line = 306)
    ...
    @OriginalMember(owner = "client!mp", name = "f", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIIIIIBI)V", line = 341)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILsb;B)V", line = 422)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "()V", line = 479)
    protected class21() {
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lap;)V", line = 490)
