...
public class class21 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I[Ljava/lang/String;II[S)V", line = 3)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lwn;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IILwn;)V", line = 82)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILwn;)V", line = 117)
