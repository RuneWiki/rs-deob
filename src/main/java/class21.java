...
public class class21 implements Runnable {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ILgda;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qia", name = "run", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ILjava/lang/String;)Lbfa;", line = 62)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(II)Z", line = 103)
    ...
    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "()V", line = 135)
    public class21() {
        this.field145.setDaemon(true);
        this.field145.start();
    }

    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(B)V", line = 153)
