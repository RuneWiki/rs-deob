...
public class class21 extends class5 {
    ...
    @OriginalMember(owner = "client!HHCKFJEO", name = "Eb", descriptor = "LRPWOWYDL;")
    ...
    @OriginalMember(owner = "client!HHCKFJEO", name = "Rb", descriptor = "LHEKJNUPL;")
    public class20 field803;

    @OriginalMember(owner = "client!HHCKFJEO", name = "Ab", descriptor = "LSNMMQNPZ;")
    public class55 field786;

    @OriginalMember(owner = "client!HHCKFJEO", name = "Tb", descriptor = "Ljava/lang/String;")
    public String field805;

    @OriginalMember(owner = "client!HHCKFJEO", name = "a", descriptor = "(I)LSNMMQNPZ;")
    ...
    @OriginalMember(owner = "client!HHCKFJEO", name = "a", descriptor = "(B)LSNMMQNPZ;")
    ...
    @OriginalMember(owner = "client!HHCKFJEO", name = "c", descriptor = "(B)LSNMMQNPZ;")
    ...
    @OriginalMember(owner = "client!HHCKFJEO", name = "a", descriptor = "(LDNRIFKTO;I)V")
