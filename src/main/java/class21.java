...
public class class21 {
    ...
    @OriginalMember(owner = "client!nc", name = "toString", descriptor = "()Ljava/lang/String;", line = 26)
    public final String toString() {
        field300++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IBLci;ILjava/awt/Component;)Lig;", line = 48)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIZZ)I", line = 129)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IBI)I", line = 170)
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(I)V", line = 191)
