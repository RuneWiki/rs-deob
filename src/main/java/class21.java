...
public class class21 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(Lua;)V", line = 23)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(BLvl;)V", line = 117)
    ...
    @OriginalMember(owner = "client!qia", name = "toString", descriptor = "()Ljava/lang/String;", line = 149)
