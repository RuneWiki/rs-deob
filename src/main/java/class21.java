...
public abstract class class21 extends class366 {
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IIILsg;Lbr;Lvj;ZI)V", line = 40)
