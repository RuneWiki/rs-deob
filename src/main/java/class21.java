...
public class class21 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "([IIII[J)V", line = 19)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!bu", name = "toString", descriptor = "()Ljava/lang/String;", line = 92)
    public final String toString() {
        field351++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IIIIIB)V", line = 100)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(II)V", line = 123)
