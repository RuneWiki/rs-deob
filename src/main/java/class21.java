...
@OriginalClass("client!HZUGKGVT")
public class class21 {

    @OriginalMember(owner = "client!HZUGKGVT", name = "a", descriptor = "I")
    private int field754;

    @OriginalMember(owner = "client!HZUGKGVT", name = "b", descriptor = "[LTSSAWEFF;")
    private class53[] field755;

    @OriginalMember(owner = "client!HZUGKGVT", name = "<init>", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!HZUGKGVT", name = "a", descriptor = "(J)LTSSAWEFF;")
    ...
    @OriginalMember(owner = "client!HZUGKGVT", name = "a", descriptor = "(JZLTSSAWEFF;)V")
