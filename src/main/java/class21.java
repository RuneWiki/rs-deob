...
public class class21 extends class115 {
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IILjava/lang/String;[BII)I", line = 22)
    ...
    @OriginalMember(owner = "client!o", name = "h", descriptor = "(I)V", line = 155)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(IB)V", line = 168)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(II)[[I", line = 424)
    ...
    @OriginalMember(owner = "client!o", name = "i", descriptor = "(I)V", line = 475)
    ...
    @OriginalMember(owner = "client!o", name = "e", descriptor = "(B)V", line = 490)
    ...
    @OriginalMember(owner = "client!o", name = "j", descriptor = "(I)Llk;", line = 593)
    ...
    @OriginalMember(owner = "client!o", name = "f", descriptor = "(B)V", line = 614)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(BLbk;I)V", line = 647)
