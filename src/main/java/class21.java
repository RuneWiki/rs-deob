...
public class class21 extends class149 {
    ...
    @OriginalMember(owner = "client!pf", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IBLtl;)V", line = 20)
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "()V", line = 73)
    public class21() {
        super(1, true);
    }
    ...
    @OriginalMember(owner = "client!pf", name = "d", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IB)[I", line = 333)
