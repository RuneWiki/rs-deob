...
public abstract class class21 implements class358 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IIII)V", line = 3)
    public final void method100(int arg0, int arg1, int arg2, int arg3) {
        this.method107(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II)V", line = 7)
    public final void method101(int arg0, int arg1) {
        this.method104(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFFFIILaa;II)V", line = 11)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(IIII)V", line = 43)
    public final void method109(int arg0, int arg1, int arg2, int arg3) {
        this.method105(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(IIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFFFIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFII)V", line = 73)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFIILaa;II)V", line = 79)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFFFFFIII)V", line = 91)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(FFIIIII)V", line = 94)
