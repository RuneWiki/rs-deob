...
public class class21 extends class443 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(ILjj;IIII)Log;", line = 20)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!cn", name = "d", descriptor = "(Z)I", line = 68)
    public final int method228(boolean arg0) {
        ++field301;
        return arg0 ? 26 : (int) super.field1798;
    }

    @OriginalMember(owner = "client!cn", name = "f", descriptor = "(I)J", line = 80)
    ...
    @OriginalMember(owner = "client!cn", name = "g", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(II)V", line = 110)
