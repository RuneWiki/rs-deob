...
public class class21 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)Lfn;")
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(II)Lcq;")
    ...
    @OriginalMember(owner = "client!nc", name = "<init>", descriptor = "(Lcm;ILlt;Llt;Llt;)V")
