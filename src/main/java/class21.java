...
public class class21 extends class76 {
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(B)Lmaa;")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IFLmaa;Lmaa;)Z")
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Lck;I)V")
