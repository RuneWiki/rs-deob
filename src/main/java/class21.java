...
public class class21 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)Lmb;", line = 4)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BLiaa;)Lhs;", line = 29)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BII[I[ILap;)Leca;", line = 69)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILmb;)V", line = 99)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)Lmb;", line = 130)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Z)I", line = 149)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(I)Z", line = 170)
    ...
    @OriginalMember(owner = "client!qo", name = "e", descriptor = "(I)Lmb;", line = 182)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 231)
    public class21() {
        this.field194.field3008 = this.field194;
        this.field194.field3007 = this.field194;
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)Lmb;", line = 209)
