...
public class class21 {
    ...
    @OriginalMember(owner = "client!HVIFHYEW", name = "f", descriptor = "LXEMMPKIX;")
    ...
    @OriginalMember(owner = "client!HVIFHYEW", name = "d", descriptor = "[LHVIFHYEW;")
    ...
    @OriginalMember(owner = "client!HVIFHYEW", name = "c", descriptor = "(I)LHVIFHYEW;")
