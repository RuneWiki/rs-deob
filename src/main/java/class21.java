...
public abstract class class21 extends class13 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(IIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!qia", name = "c", descriptor = "(II)Z", line = 22)
    ...
    @OriginalMember(owner = "client!qia", name = "<init>", descriptor = "(I)V", line = 32)
    public class21(int arg0) {
        this.field325 = arg0;
    }

    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(IB)Z", line = 42)
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ZB)V", line = 57)
    ...
    @OriginalMember(owner = "client!qia", name = "e", descriptor = "(I)V", line = 121)
