...
public class class21 extends class507 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Ljava/awt/Color;ZLjava/awt/Color;ZLjava/lang/String;ILjava/awt/Color;)V", line = 27)
    ...
    @OriginalMember(owner = "client!nc", name = "b", descriptor = "(Z)V", line = 109)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIIIIIIILas;II)Z", line = 122)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 477)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IBI)V", line = 544)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(IIII)V", line = 567)
