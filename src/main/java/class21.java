...
@OriginalClass("client!HPYXKOFA")
public class class21 extends class23 {

    @OriginalMember(owner = "client!HPYXKOFA", name = "sb", descriptor = "[I")
    public int[] field759 = new int[5];

    @OriginalMember(owner = "client!HPYXKOFA", name = "tb", descriptor = "J")
    public long field760 = -1L;

    @OriginalMember(owner = "client!HPYXKOFA", name = "ub", descriptor = "Z")
    private boolean field761 = true;

    @OriginalMember(owner = "client!HPYXKOFA", name = "vb", descriptor = "Z")
    private boolean field762 = true;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Fb", descriptor = "Z")
    public boolean field772 = false;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Gb", descriptor = "Z")
    public boolean field773 = false;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Tb", descriptor = "[I")
    public int[] field786 = new int[12];

    @OriginalMember(owner = "client!HPYXKOFA", name = "xb", descriptor = "LRUNMBJUO;")
    public static class51 field764 = new class51(260, false);

    @OriginalMember(owner = "client!HPYXKOFA", name = "rb", descriptor = "I")
    public int field758;

    @OriginalMember(owner = "client!HPYXKOFA", name = "yb", descriptor = "I")
    public int field765;

    @OriginalMember(owner = "client!HPYXKOFA", name = "zb", descriptor = "I")
    private int field766;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Ab", descriptor = "I")
    public int field767;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Bb", descriptor = "I")
    public int field768;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Cb", descriptor = "I")
    public int field769;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Eb", descriptor = "I")
    public int field771;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Ib", descriptor = "I")
    public int field775;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Jb", descriptor = "I")
    public int field776;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Kb", descriptor = "I")
    public int field777;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Lb", descriptor = "I")
    public int field778;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Mb", descriptor = "I")
    public int field779;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Nb", descriptor = "I")
    private int field780;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Pb", descriptor = "I")
    public int field782;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Qb", descriptor = "I")
    public int field783;
    ...
    @OriginalMember(owner = "client!HPYXKOFA", name = "Ob", descriptor = "J")
    public long field781;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Db", descriptor = "LNJPATAFL;")
    public class35 field770;

    @OriginalMember(owner = "client!HPYXKOFA", name = "wb", descriptor = "LBYABUZFP;")
    public class5 field763;

    @OriginalMember(owner = "client!HPYXKOFA", name = "Hb", descriptor = "Ljava/lang/String;")
    public String field774;

    @OriginalMember(owner = "client!HPYXKOFA", name = "a", descriptor = "(I)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!HPYXKOFA", name = "c", descriptor = "(I)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!HPYXKOFA", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!HPYXKOFA", name = "d", descriptor = "(I)LNJPATAFL;")
    ...
    @OriginalMember(owner = "client!HPYXKOFA", name = "a", descriptor = "(ILMUKVLYLC;)V")
