...
public class class21 extends class349 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Lpq;IIIZI)V")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(B[ILpea;I[II)Lkfa;")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IILdga;)V")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Lcga;IIIII)V")
