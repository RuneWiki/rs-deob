...
public class class21 extends class83 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IZIIZBI)V", line = 68)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "()V", line = 187)
    public class21() {
        super(0, false);
    }

    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)I", line = 174)
    ...
    @OriginalMember(owner = "client!mp", name = "e", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IBLtq;)V", line = 204)
