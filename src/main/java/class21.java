...
public class class21 extends class513 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Z)I", line = 67)
