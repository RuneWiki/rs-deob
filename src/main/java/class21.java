...
public class class21 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)[Ltca;", line = 6)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(Lcn;B)V", line = 39)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)Lcn;", line = 55)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(I)V", line = 80)
    public class21(int arg0) {
        this.field267 = arg0;
    }

    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(IIIIII)V", line = 87)
