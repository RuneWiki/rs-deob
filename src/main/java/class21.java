...
public class class21 extends class775 {
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)V", line = 92)
