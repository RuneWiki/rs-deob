...
public class class21 extends class30 {
    ...
    @OriginalMember(owner = "client!FGVBONDH", name = "l", descriptor = "Z")
    public static boolean field742;

    @OriginalMember(owner = "client!FGVBONDH", name = "j", descriptor = "[LGPZVLKRL;")
    ...
    @OriginalMember(owner = "client!FGVBONDH", name = "a", descriptor = "(I)LHEQROJXW;")
