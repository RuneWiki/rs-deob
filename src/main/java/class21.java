...
public class class21 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BLlh;)V", line = 62)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II[II[I)V", line = 97)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(ILlh;I)V", line = 177)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(II)Z", line = 434)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(B)V", line = 509)
