...
public class class21 {
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(ILuf;I)V")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(ILuf;Luf;II)V")
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(I)[Lbu;")
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(ILuf;Luf;IIZZ)V")
