...
public class class21 extends class567 implements class310 {

    @OriginalMember(owner = "client!qo", name = "i", descriptor = "Lou;")
    public class567 field226;
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Loa;B)V", line = 9)
    public final void method130(class650 arg0, byte arg1) {
        field242++;
        if (arg1 >= -27) {
            this.method136(null, -72);
        }
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)I", line = 20)
    public final int method131(byte arg0) {
        if (arg0 != -97) {
            this.method8((byte) -66, -36, null, 49);
        }
        field236++;
        return 0;
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(Loa;B)V", line = 31)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 42)
    public final void method132(int arg0) {
        field229++;
        if (arg0 != -13968) {
            this.method6(null, -119);
        }
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Z)Z", line = 53)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BILoa;I)Z", line = 67)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Loa;BI)Lba;", line = 77)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(IIIIILou;)V", line = 88)
    public class21(int arg0, int arg1, int arg2, int arg3, int arg4, class567 arg5) {
        super(arg2, arg3, arg4, class367.method2139(3, arg1, arg0));
        this.field226 = arg5;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZLoa;Lnt;IIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Loa;I)V", line = 106)
    public final void method136(class650 arg0, int arg1) {
        field240++;
        int var3 = -34 / ((arg1 + 78) / 37);
    }

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)I", line = 131)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILoa;)Lww;", line = 143)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(Loa;I)Lqt;", line = 155)
    public final class595 method6(class650 arg0, int arg1) {
        if (arg1 != -7459) {
            field232 = -99;
        }
        field241++;
        return this.field226.method6(arg0, arg1);
    }

    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)I", line = 167)
    public final int method139(byte arg0) {
        field228++;
        return arg0 < 13 ? 37 : 0;
    }

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(B)V", line = 178)
    public final void method140(byte arg0) {
        field239++;
        int var2 = -78 % ((arg0 + 16) / 40);
    }
}
