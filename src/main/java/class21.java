...
public class class21 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIZLjava/lang/Object;)[B", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)Lga;", line = 35)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IB)V", line = 61)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "(II)Z", line = 126)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IZ)Lsj;", line = 136)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BI)V", line = 167)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 206)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)V", line = 194)
