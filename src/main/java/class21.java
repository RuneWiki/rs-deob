...
public class class21 implements class370 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "([ILrr;IJ)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BI)Lsr;", line = 45)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 103)
