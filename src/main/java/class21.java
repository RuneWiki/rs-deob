...
public class class21 {
    ...
    @OriginalMember(owner = "client!GMRGYXFL", name = "t", descriptor = "I")
    ...
    @OriginalMember(owner = "client!GMRGYXFL", name = "d", descriptor = "[LGMRGYXFL;")
    public static class21[] field817;

    @OriginalMember(owner = "client!GMRGYXFL", name = "a", descriptor = "(ILQKFGLETG;)V")
    ...
    @OriginalMember(owner = "client!GMRGYXFL", name = "a", descriptor = "(BLXJCNBMKS;)V")
