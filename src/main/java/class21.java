...
public class class21 extends class755 {
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(ZBI)V")
    ...
    @OriginalMember(owner = "client!qia", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!qia", name = "a", descriptor = "(IBII)[B")
