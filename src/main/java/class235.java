...
public class class235 extends class481 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!tc", name = "f", descriptor = "(I)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lhf;Ljava/lang/Object;I)V", line = 25)
