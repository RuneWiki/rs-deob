...
public class class235 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(ZI)Lki;", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)V", line = 36)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIBI)V", line = 95)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Ld;ILfo;Lfo;)V", line = 148)
