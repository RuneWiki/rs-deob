...
public class class235 extends class221 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIBZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!bc", name = "c", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIIIIIIII)V", line = 77)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lrl;IIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!bc", name = "b", descriptor = "(III)Z", line = 125)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IIIIIBII)V", line = 136)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IBI)Z", line = 149)
    ...
    @OriginalMember(owner = "client!bc", name = "<init>", descriptor = "(Lrl;IIII[BI)V", line = 177)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(ZII)Z", line = 166)
