...
public class class235 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIIIIIBII)V", line = 44)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(IIILf;Lf;)V", line = 56)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ILce;IIII)Lop;", line = 78)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(Ljava/util/Random;IZ)I", line = 111)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)Ltp;", line = 145)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(Lwv;ILqs;)V", line = 189)
    public class235(class535 arg0, int arg1, class496 arg2) {
        this.field4071 = arg2;
        this.field4071.method2940(29, -10511);
    }

    @OriginalMember(owner = "client!dc", name = "b", descriptor = "(I)V", line = 204)
