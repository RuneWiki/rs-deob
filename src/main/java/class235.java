...
public class class235 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Z[Ljava/lang/Object;[J)V", line = 4)
    ...
    @OriginalMember(owner = "client!fc", name = "toString", descriptor = "()Ljava/lang/String;", line = 17)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILjava/lang/String;)V", line = 43)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(II)V", line = 60)
    public class235(int arg0, int arg1) {
        this.field3390 = arg1;
        this.field3395 = arg0;
    }

    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(Z)V", line = 75)
