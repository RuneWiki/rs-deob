...
public abstract class class235 extends class388 {
    ...
    @OriginalMember(owner = "client!rb", name = "e", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!rb", name = "b", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(IIII)V", line = 55)
