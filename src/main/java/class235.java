...
public class class235 {
    ...
    @OriginalMember(owner = "client!fc", name = "toString", descriptor = "()Ljava/lang/String;", line = 12)
    public final String toString() {
        field3244++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 66)
    public class235(String arg0, int arg1) {
        this.field3245 = arg1;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIB[IIIII)Z", line = 78)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILjava/lang/String;)I", line = 184)
