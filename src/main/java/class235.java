...
public class class235 extends class354 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lia;III[Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(BI)[I", line = 41)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IB)[[I", line = 95)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 172)
    public class235() {
        super(3, false);
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lnj;II)V", line = 179)
