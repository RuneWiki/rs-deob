...
public class class235 implements Runnable {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IIB[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(B)V", line = 56)
    public static void method1475(byte arg0) {
        field3034 = null;
        int var1 = -77 % ((57 - arg0) / 46);
    }

    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ZIIIILkha;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!pfa", name = "run", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 195)
