...
public class class235 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(F)F", line = 4)
    private static final float method1533(float arg0) {
        float var1 = (float) Math.pow(2.0D, (double) arg0) * 32.703197F;
        return var1 * 3.1415927F / 11025.0F;
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "()V", line = 9)
    public static void method1534() {
        field3342 = null;
        field3348 = null;
    }

    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lrg;Lrq;)V", line = 15)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIF)F", line = 85)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IF)I", line = 90)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(IIF)F", line = 150)
