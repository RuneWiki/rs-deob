...
public class class235 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ZI)V", line = 27)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IILm;IIBLqa;)V", line = 45)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "()V", line = 131)
    public void method930() throws Exception {
        field3347++;
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 140)
    public void method928(Component arg0) throws Exception {
        field3343++;
    }

    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)V", line = 157)
    public void method927(int arg0) throws Exception {
        field3340++;
    }

    @OriginalMember(owner = "client!fe", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "([II)V", line = 289)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ID)V", line = 448)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)V", line = 474)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IILho;)V", line = 518)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(B)V", line = 539)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ILho;)V", line = 563)
    ...
    @OriginalMember(owner = "client!fe", name = "c", descriptor = "()I", line = 574)
    public int method925() throws Exception {
        field3342++;
        return this.field3351;
    }

    @OriginalMember(owner = "client!fe", name = "d", descriptor = "(I)V", line = 584)
    public static void method1598(int arg0) {
        field3338 = null;
        int var1 = -2 / ((arg0 - 45) / 44);
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I[[B[I[B[III[[B)I", line = 598)
    ...
    @OriginalMember(owner = "client!fe", name = "d", descriptor = "()V", line = 679)
