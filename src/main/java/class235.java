...
public class class235 extends class393 {
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(ILil;)Lak;", line = 45)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "(I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!w", name = "c", descriptor = "(I)V", line = 97)
