...
public class class235 extends class119 {
    ...
    @OriginalMember(owner = "client!ue", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(B)[B", line = 35)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(ILria;)V", line = 78)
