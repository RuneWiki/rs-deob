...
public class class235 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Llf;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(IB)Llf;", line = 29)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(B)I", line = 40)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!dia", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(Llf;)V", line = 82)
    public class235(class239 arg0) {
        this.field3087 = 1;
        this.field3088 = arg0.field3126;
    }

    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "([Llf;)V", line = 91)
    public class235(class239[] arg0) {
