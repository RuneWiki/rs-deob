...
public class class235 extends class401 {
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lwu;Lfaa;)V", line = 15)
    public class235(class557 arg0, class32 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!wv", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(CB)Z", line = 42)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lpaa;BIILha;)V", line = 59)
