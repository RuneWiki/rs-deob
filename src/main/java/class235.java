...
public class class235 extends class183 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IB)I", line = 8)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(I)J", line = 44)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)J", line = 99)
