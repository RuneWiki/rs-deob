...
public class class235 extends class163 implements class416 {
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lic;ILjava/nio/ByteBuffer;Z)V")
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(Lfh;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lfh;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(Lfh;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "d", descriptor = "(Lfh;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lic;I[BIZ)V")
