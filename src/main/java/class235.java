...
public class class235 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Z)V", line = 54)
