...
public class class235 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIILr;)V", line = 93)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIIIIBII)V", line = 165)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(BZII[[ZI)V", line = 180)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILr;ZI)V", line = 378)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ltja;I)V", line = 455)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IILr;I)Z", line = 1174)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Lai;Lew;)V", line = 1250)
