...
public class class235 {
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(Lmu;ILmu;F)Z")
    ...
    @OriginalMember(owner = "client!wda", name = "a", descriptor = "(ILhca;)V")
    ...
    @OriginalMember(owner = "client!wda", name = "<init>", descriptor = "(Los;)V")
