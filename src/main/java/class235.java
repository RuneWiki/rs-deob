...
public class class235 extends class631 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILta;)V", line = 27)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Leea;)V", line = 81)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IB)Z", line = 119)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(III)V", line = 142)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!lf", name = "d", descriptor = "(I)V", line = 185)
