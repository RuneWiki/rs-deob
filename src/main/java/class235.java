...
public class class235 extends class131 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!ji", name = "f", descriptor = "(I)J", line = 42)
    public final long method910(int arg0) {
        field3427++;
        return arg0 == 11195 ? this.field3426 : -53L;
    }

    @OriginalMember(owner = "client!ji", name = "g", descriptor = "(I)I", line = 70)
