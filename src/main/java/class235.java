...
public class class235 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(ILdga;)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IBIILud;)V")
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(Ldga;II)V")
