...
public class class235 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILdt;I)V")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIBLofa;Lha;I)V")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILdt;IB)V")
