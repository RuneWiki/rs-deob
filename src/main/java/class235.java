...
public class class235 extends class559 implements class523 {
    ...
    @OriginalMember(owner = "client!pm", name = "m", descriptor = "(I)[Lhga;", line = 3)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)I", line = 92)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lha;II)Lka;", line = 104)
    ...
    @OriginalMember(owner = "client!pm", name = "f", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(B)I", line = 138)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ZILha;Lov;IIZ)V", line = 148)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(Lha;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!pm", name = "i", descriptor = "(I)Z", line = 191)
    ...
    @OriginalMember(owner = "client!pm", name = "g", descriptor = "(B)I", line = 206)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIZLha;)Leo;", line = 218)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lha;Z)V", line = 248)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLha;)V", line = 276)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)I", line = 305)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lha;I)Lkn;", line = 322)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(B)Z", line = 337)
    public final boolean method88(byte arg0) {
        ++field3778;
        return arg0 < 44 ? false : this.field3784;
    }

    @OriginalMember(owner = "client!pm", name = "k", descriptor = "(I)Z", line = 349)
    ...
    @OriginalMember(owner = "client!pm", name = "g", descriptor = "(I)Z", line = 364)
    public final boolean method92(int arg0) {
        ++field3774;
        return arg0 != 2 ? false : this.field3777;
    }

    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILha;I)Z", line = 376)
    ...
    @OriginalMember(owner = "client!pm", name = "j", descriptor = "(I)I", line = 397)
    ...
    @OriginalMember(owner = "client!pm", name = "h", descriptor = "(I)V", line = 411)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lha;Ljl;IIIIIZIIIIIIZ)V", line = 428)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(B)I", line = 461)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIIZJ)Ljava/lang/String;", line = 476)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(ILha;)Lgh;", line = 559)
