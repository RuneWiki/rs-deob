...
public class class235 {
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(IZLfe;IIIIIIIII[I[II)I", line = 3)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Z)V", line = 182)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(ILas;II)J", line = 193)
    ...
    @OriginalMember(owner = "client!uu", name = "a", descriptor = "(Ljava/lang/String;ZII)V", line = 222)
