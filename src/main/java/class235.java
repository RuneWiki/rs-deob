...
public class class235 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IB)V", line = 42)
