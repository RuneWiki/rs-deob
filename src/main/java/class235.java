...
public class class235 extends class264 {
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lmfa;)V")
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(ILmfa;)V")
    public class235(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ILnba;)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(I[Lwq;ZIIIIIIII)V")
