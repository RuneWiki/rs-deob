...
public class class235 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)[[[I", line = 3)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BI)[[I", line = 61)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(BI)Ljava/lang/String;", line = 128)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IILwia;ZJII)V", line = 156)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(III)V", line = 220)
