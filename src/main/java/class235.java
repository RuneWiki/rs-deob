...
public class class235 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IZLpf;IIIIIBI[II[III)I", line = 6)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(II)V", line = 186)
    public class235(int arg0, int arg1) {
        this.field3412 = arg1;
        this.field3414 = arg0;
    }

    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Llh;I)V", line = 194)
