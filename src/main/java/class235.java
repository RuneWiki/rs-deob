...
public class class235 extends class747 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILjava/awt/Component;)Leh;")
    public static final class259 method1564(int arg0, Component arg1) {
        field3484++;
        return arg0 == 9 ? new class22(arg1) : null;
    }

    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZILwq;)V")
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ljava/awt/Frame;BLrp;)V")
