...
public class class235 extends class131 {
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(IIIIIF)V", line = 5)
    public class235(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IF)V", line = 11)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/Class;", line = 38)
