...
public class class235 extends class634 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ILig;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lig;Z)Lvv;", line = 60)
    ...
    @OriginalMember(owner = "client!ida", name = "f", descriptor = "(I)V", line = 82)
    public static void method1392(int arg0) {
        int var1 = -37 % ((-13 - arg0) / 52);
        field2799 = null;
    }

    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(BI)[I", line = 98)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BLtp;)Ltp;", line = 185)
