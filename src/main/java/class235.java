...
public class class235 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BI)Lpk;")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "([BZIIILgk;II)Lcw;")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Leo;III)V")
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lgt;ILdn;Ldn;)V")
