...
public class class235 {
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIIBI)V", line = 5)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ZLco;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(ILco;)V", line = 305)
    ...
    @OriginalMember(owner = "client!lba", name = "b", descriptor = "(I)V", line = 344)
