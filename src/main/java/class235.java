...
public class class235 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIILtj;II)Lqb;")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ZLfb;I)V")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(III)Llq;")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILfb;)V")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILrr;Lrr;BZ)I")
