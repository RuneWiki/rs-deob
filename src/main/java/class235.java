...
public class class235 extends class666 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lnq;[[BB)V", line = 9)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IZ)I", line = 81)
    public static final int method1363(int arg0, boolean arg1) {
        ++field2988;
        return !arg1 ? -102 : arg0 >>> 8;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[BBI)[B", line = 97)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILiaa;Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(II)[I", line = 189)
    ...
    @OriginalMember(owner = "client!fc", name = "b", descriptor = "(IIII)I", line = 259)
