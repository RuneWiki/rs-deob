...
public class class235 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(B)V", line = 79)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IIII)V", line = 90)
