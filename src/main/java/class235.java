...
public class class235 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IILtj;)Lf;", line = 52)
