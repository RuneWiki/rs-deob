...
public class class235 extends class17 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lvm;BLjn;)V", line = 36)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIILvm;)Z", line = 59)
    ...
    @OriginalMember(owner = "client!kj", name = "e", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lvm;I)V", line = 82)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ltm;Ltm;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!kj", name = "d", descriptor = "(B)Z", line = 116)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!kj", name = "finalize", descriptor = "()V", line = 166)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(II)V", line = 176)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lvm;Z)Ldn;", line = 194)
    ...
    @OriginalMember(owner = "client!kj", name = "c", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(BIIII)V", line = 244)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 357)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 369)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZIIILai;ILvm;)V", line = 386)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lvm;II)Ljn;", line = 400)
