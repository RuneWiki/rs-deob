...
public class class235 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZZZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/Class;", line = 51)
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lra;I)V", line = 156)
