...
public class class235 extends class216 implements Runnable {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!qf", name = "run", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Ldn;)V", line = 101)
