...
public class class235 extends class702 {
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(IB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sda", name = "<init>", descriptor = "(Lkga;)V", line = 16)
    ...
    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(Z)Z", line = 45)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(III)V", line = 56)
    public final void method1001(int arg0, int arg1, int arg2) {
        ++field3141;
        int var4 = -61 % ((arg1 - 55) / 36);
    }

    @OriginalMember(owner = "client!sda", name = "b", descriptor = "(B)V", line = 70)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ZZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!sda", name = "c", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(ZI)V", line = 167)
    ...
    @OriginalMember(owner = "client!sda", name = "a", descriptor = "(Ljf;II)V", line = 188)
