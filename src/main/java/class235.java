...
public class class235 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIB)V", line = 27)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/awt/Canvas;BILl;)Lza;", line = 51)
