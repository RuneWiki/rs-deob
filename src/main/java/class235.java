...
public class class235 extends class424 {
    ...
    @OriginalMember(owner = "client!bfa", name = "b", descriptor = "(BII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(III[I)V", line = 23)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(IZI)Z", line = 38)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(B[III)V", line = 53)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(JI)V", line = 79)
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(BIII)Z", line = 175)
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(IIIIIIIII)V", line = 190)
