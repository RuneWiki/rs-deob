...
public class class525 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIIIBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)V", line = 98)
