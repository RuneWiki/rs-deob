...
public class class525 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lda;ILnu;III)V", line = 11)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lvg;IJLua;IIIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIIIIIIII)V", line = 84)
