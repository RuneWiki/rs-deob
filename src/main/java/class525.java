...
public class class525 extends class34 {
    ...
    @OriginalMember(owner = "client!rl", name = "d", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "()V", line = 46)
    public class525() {
        super(1, true);
    }

    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lsv;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(IB)[I", line = 50)
