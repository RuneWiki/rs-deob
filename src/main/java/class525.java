...
public class class525 extends class568 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BILrv;)V", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IJ)V", line = 23)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(IIB)I", line = 83)
    ...
    @OriginalMember(owner = "client!pi", name = "b", descriptor = "(II)V", line = 122)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "()V", line = 143)
    public class525() {
    }

    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 148)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIB)Z", line = 156)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 168)
