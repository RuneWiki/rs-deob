...
public class class525 implements class473 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZLjava/awt/Canvas;)Lwe;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ZIIILfo;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(I[ILsd;J)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IILir;I)V")
