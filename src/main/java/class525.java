...
public class class525 {
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!si", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!si", name = "d", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(II)V", line = 77)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(IZ)Lrv;", line = 90)
    ...
    @OriginalMember(owner = "client!si", name = "<init>", descriptor = "(Lbs;ILpfa;)V", line = 132)
