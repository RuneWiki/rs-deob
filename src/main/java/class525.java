...
public class class525 extends class518 {
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IIIIFIFFLue;IFFI[B)V", line = 8)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IZI)V", line = 67)
    ...
    @OriginalMember(owner = "client!in", name = "<init>", descriptor = "(Lpea;)V", line = 187)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(IILdda;I)J", line = 143)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZI)V", line = 175)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(Z)Z", line = 225)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(BLwq;I)V", line = 236)
    ...
    @OriginalMember(owner = "client!in", name = "a", descriptor = "(ZB)V", line = 248)
