...
public class class525 extends class435 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!sf", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method3080(arg0.getY(), 34, arg0.getX());
    }

    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sf", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 36)
    ...
    @OriginalMember(owner = "client!sf", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 48)
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!sf", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 86)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIBII)V", line = 112)
    ...
    @OriginalMember(owner = "client!sf", name = "b", descriptor = "(B)Z", line = 127)
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 148)
    ...
    @OriginalMember(owner = "client!sf", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 174)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method3080(arg0.getY(), 85, arg0.getX());
    }

    @OriginalMember(owner = "client!sf", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 181)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method3080(arg0.getY(), 100, arg0.getX());
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 188)
    ...
    @OriginalMember(owner = "client!sf", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 203)
    ...
    @OriginalMember(owner = "client!sf", name = "e", descriptor = "(I)I", line = 226)
    ...
    @OriginalMember(owner = "client!sf", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 236)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method3080(arg0.getY(), 41, arg0.getX());
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Z)Lwi;", line = 243)
    public final class467 method2699(boolean arg0) {
        return arg0 ? (class467) null : (class467) this.field7491.method1198((byte) 124);
    }

    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(III)V", line = 254)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(I)Z", line = 270)
    ...
    @OriginalMember(owner = "client!sf", name = "f", descriptor = "(I)I", line = 280)
    ...
    @OriginalMember(owner = "client!sf", name = "d", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!sf", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 312)
