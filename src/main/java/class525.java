...
public class class525 implements Runnable {
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 702)
    ...
    @OriginalMember(owner = "client!k", name = "run", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIIZI)Lsw;", line = 307)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(B)Z", line = 328)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z[BLjava/io/File;)Z", line = 348)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljava/net/URL;B)Lsw;", line = 371)
    public final class701 method3168(URL arg0, byte arg1) {
        return arg1 == -30 ? this.method3172(75, arg0, 0, 0, 4) : null;
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILjava/lang/String;Z)Lsw;", line = 382)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;B)Lsw;", line = 397)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(B)V", line = 409)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILjava/lang/Object;III)Lsw;", line = 419)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ZILjava/lang/String;I)Lsw;", line = 458)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z)Lsw;", line = 472)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljava/lang/String;B)Lsw;", line = 482)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Lsw;", line = 499)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(ILjava/awt/Point;[IIILjava/awt/Component;)Lsw;", line = 509)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljava/awt/Frame;B)Lsw;", line = 521)
    public final class701 method3178(Frame arg0, byte arg1) {
        return arg1 <= 92 ? null : this.method3172(104, arg0, 0, 0, 7);
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 532)
    public final Object method3179(int arg0) {
        return arg0 == -16 ? this.field7662 : null;
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Ljava/lang/Runnable;ZI)Lsw;", line = 542)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BLjava/lang/String;)Lqq;", line = 558)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;)Lqq;", line = 568)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(BI)Lsw;", line = 614)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V", line = 625)
