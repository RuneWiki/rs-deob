...
public class class525 extends class90 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!pi", name = "d", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIILha;)V", line = 45)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IB)I", line = 149)
