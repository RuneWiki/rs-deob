...
public class class525 extends class519 {
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)Ljw;", line = 22)
    public final class551 method930(int arg0) {
        field7466++;
        return arg0 == 17503 ? class459.field6630 : null;
    }

    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Ljg;Ljha;IIIIIIIIIIIIII)V", line = 38)
