...
public class class525 extends class141 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!lm", name = "b", descriptor = "(B)I", line = 14)
    ...
    @OriginalMember(owner = "client!lm", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 43)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!lm", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 270)
    public final void focusGained(FocusEvent arg0) {
        field7291++;
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILjava/awt/event/KeyEvent;I)V", line = 285)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BICI)V", line = 320)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILjava/lang/String;)I", line = 341)
    ...
    @OriginalMember(owner = "client!lm", name = "d", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!lm", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 422)
    public final synchronized void focusLost(FocusEvent arg0) {
        field7281++;
        this.method3044((byte) -47, 0, '\u0000', -1);
    }

    @OriginalMember(owner = "client!lm", name = "e", descriptor = "(I)V", line = 431)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(BZ)V", line = 441)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(II)Z", line = 489)
    ...
    @OriginalMember(owner = "client!lm", name = "c", descriptor = "(B)V", line = 503)
    ...
    @OriginalMember(owner = "client!lm", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 531)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field7279++;
        this.method3043(1, arg0, -125);
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)Loea;", line = 539)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 602)
    public class525(Component arg0) {
        class551.method3165(190);
        this.method3050(arg0, (byte) 108);
    }

    @OriginalMember(owner = "client!lm", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 556)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method3043(0, arg0, 47);
        field7286++;
    }

    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 574)
