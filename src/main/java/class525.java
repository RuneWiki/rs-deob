...
public class class525 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIBII)V", line = 33)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IB)Ljp;", line = 61)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lgn;ILvo;)V", line = 120)
