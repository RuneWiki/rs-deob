...
public class class525 extends class297 {
    ...
    @OriginalMember(owner = "client!hr", name = "<init>", descriptor = "()V", line = 7)
    public class525() {
        super(3, false);
    }

    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lcea;II)V", line = 77)
    ...
    @OriginalMember(owner = "client!hr", name = "e", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!hr", name = "d", descriptor = "(II)[[I", line = 123)
    ...
    @OriginalMember(owner = "client!hr", name = "c", descriptor = "(Z)I", line = 179)
