...
public class class525 extends Canvas {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ljn;")
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
