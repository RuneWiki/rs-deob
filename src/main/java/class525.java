...
public class class525 extends class136 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILiv;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 36)
    public class525() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nh", name = "f", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BII)I", line = 67)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BI)[[I", line = 84)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(ILta;)V", line = 131)
    public static final void method3115(int arg0, class142 arg1) {
        class131.field1899[arg0] = arg1;
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(II)[I", line = 134)
    ...
    @OriginalMember(owner = "client!nh", name = "b", descriptor = "(BI)V", line = 170)
