...
public class class525 extends class230 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)Ljava/net/Socket;")
    ...
    @OriginalMember(owner = "client!hr", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLjava/net/Proxy;)Ljava/net/Socket;")
