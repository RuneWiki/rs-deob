...
public class class525 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)[[[B", line = 92)
    ...
    @OriginalMember(owner = "client!cp", name = "b", descriptor = "(I)V", line = 871)
