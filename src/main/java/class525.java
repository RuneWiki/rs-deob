...
public class class525 extends class618 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(JJ)J", line = 8)
    public static long method2990(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Z[B)[B", line = 41)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lnv;II[B)V", line = 98)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(Lqh;[IZ[I[I)V", line = 126)
    ...
    @OriginalMember(owner = "client!k", name = "<init>", descriptor = "(Lnv;II[I)V", line = 225)
