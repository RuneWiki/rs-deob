...
public class class525 extends class293 {
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIII[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(II)Z", line = 19)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(JJ)J", line = 77)
    public static long method3040(long arg0, long arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIIIIIZ)V", line = 84)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIIII)V", line = 97)
    public class525(class483 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
    ...
    @OriginalMember(owner = "client!baa", name = "i", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIIIZ[BI)V", line = 145)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIIZ[III)V", line = 171)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIIII[BI)V", line = 192)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lbi;IIIIIZ)V", line = 206)
