...
public class class525 {
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BI)Z", line = 29)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(III)I", line = 112)
