...
public abstract class class525 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lha;Ld;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)V", line = 241)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(IIIIBIIIII)V", line = 253)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 328)
