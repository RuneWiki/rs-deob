...
public class class525 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILoi;)Z")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Loi;I)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)Lrq;")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Len;)V")
