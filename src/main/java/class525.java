...
public class class525 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(BLgk;)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIZIILr;Li;Lar;IBILi;II)Lda;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IIILar;Lr;II)Lda;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(IBLar;IILr;I)Lda;")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(ILgk;I)V")
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lr;IIIIIZIILi;ILi;Lar;)Lda;")
