...
public class class525 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Ltca;IIIII)Ldd;")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(II)Lki;")
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lre;ILdn;)V")
