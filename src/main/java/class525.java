...
public abstract class class525 implements class489 {
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 29)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljaclib/memory/Source;BI)Z", line = 80)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)Z", line = 122)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)I", line = 154)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(B)J", line = 177)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIBII)V", line = 207)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)V", line = 234)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(B)V", line = 263)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lag;IZ)V", line = 315)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(III)Llca;", line = 290)
    ...
    @OriginalMember(owner = "client!ji", name = "finalize", descriptor = "()V", line = 303)
