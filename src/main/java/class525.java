...
public class class525 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)Lem;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Lya;IIIIBI)V")
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Lya;Lsi;I)V")
