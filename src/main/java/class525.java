...
public class class525 {
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(Z)Ljl;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(IIII)Le;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(B)Luf;")
