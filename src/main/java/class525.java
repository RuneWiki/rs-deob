...
public class class525 extends class42 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIII[Ltf;IIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I)Z", line = 696)
    ...
    @OriginalMember(owner = "client!pg", name = "b", descriptor = "(I)V", line = 712)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIBIIZ)V", line = 729)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(B)V", line = 787)
