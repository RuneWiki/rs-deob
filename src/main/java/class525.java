...
public abstract class class525 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "([BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!qc", name = "finalize", descriptor = "()V", line = 61)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lkd;I[BIZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lkd;ILjaggl/memory/NativeBuffer;IZ)V", line = 121)
