...
public class class525 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(BI)Z", line = 6)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IZ)I", line = 57)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIIIII)I", line = 88)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Lia;I)V", line = 124)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 144)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(BI)Ljava/lang/String;", line = 200)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILia;B)V", line = 221)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIIII)V", line = 302)
