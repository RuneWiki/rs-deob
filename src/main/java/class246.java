...
public class class246 extends class328 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(ZLae;Lgp;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lum;Lum;B)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lgp;I)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(BILco;)V")
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(Lk;III[Z)V")
