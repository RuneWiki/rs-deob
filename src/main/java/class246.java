...
public class class246 extends class433 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Lkea;BLtq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "()I", line = 49)
    public final int method1576() {
        field3478++;
        return this.field3492;
    }

    @OriginalMember(owner = "client!sb", name = "EA", descriptor = "(IIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!sb", name = "sa", descriptor = "(FFFFFFIII)V", line = 73)
    ...
    @OriginalMember(owner = "client!sb", name = "AA", descriptor = "()I", line = 140)
    public final int method1577() {
        field3472++;
        return this.field3487 + this.field3491 + this.field3494;
    }

    @OriginalMember(owner = "client!sb", name = "I", descriptor = "(IIIII)V", line = 149)
    ...
    @OriginalMember(owner = "client!sb", name = "GA", descriptor = "(IIIIII)V", line = 183)
    ...
    @OriginalMember(owner = "client!sb", name = "QA", descriptor = "()I", line = 206)
    public final int method1570() {
        field3471++;
        return this.field3487;
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "()I", line = 218)
    public final int method1568() {
        field3488++;
        return this.field3492 - (-this.field3490 - this.field3469);
    }

    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Ltu;IIZ)V", line = 822)
    ...
    @OriginalMember(owner = "client!sb", name = "<init>", descriptor = "(Ltu;II[III)V", line = 836)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IILfa;II)V", line = 235)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)V", line = 281)
    ...
    @OriginalMember(owner = "client!sb", name = "KA", descriptor = "(IIIIIII)V", line = 440)
    ...
    @OriginalMember(owner = "client!sb", name = "t", descriptor = "(III)V", line = 477)
    public final void method1569(int arg0, int arg1, int arg2) {
        field3496++;
    }

    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIII[III)V", line = 485)
    ...
    @OriginalMember(owner = "client!sb", name = "b", descriptor = "(I)V", line = 494)
    ...
    @OriginalMember(owner = "client!sb", name = "ba", descriptor = "(IIIIIII)V", line = 510)
    ...
    @OriginalMember(owner = "client!sb", name = "c", descriptor = "(I)V", line = 719)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 757)
