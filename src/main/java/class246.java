...
public class class246 extends class472 implements class562 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[BI)V", line = 27)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IC)Z", line = 254)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)I", line = 267)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(IIII)V", line = 280)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ljava/lang/String;BILjava/lang/String;)V", line = 294)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(B)J", line = 307)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lqa;B)V", line = 317)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IB)I", line = 332)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lte;I[BIZ)V", line = 343)
