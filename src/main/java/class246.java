...
public class class246 extends class40 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IILlf;)V", line = 58)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "()V", line = 103)
    public class246() {
        super(0, true);
    }

    @OriginalMember(owner = "client!q", name = "b", descriptor = "(BI)V", line = 108)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIIIIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!q", name = "h", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BI)[I", line = 152)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(ILjava/lang/String;)V", line = 244)
