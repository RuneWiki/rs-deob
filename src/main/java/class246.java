...
public class class246 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lbi;B)I", line = 45)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILd;)V", line = 117)
    public static final void method1509(int arg0, class139 arg1) {
        class218.field3099[arg0] = arg1;
    }

    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILcc;ILcc;)Ln;", line = 126)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lcc;ILcc;ZB)Ln;", line = 141)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Z)V", line = 183)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(Z)Z", line = 195)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Llfa;Lde;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 301)
