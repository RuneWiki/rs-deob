...
public class class246 extends class414 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lia;B)V")
    ...
    @OriginalMember(owner = "client!mn", name = "ba", descriptor = "(Lia;)V")
