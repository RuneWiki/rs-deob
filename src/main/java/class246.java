...
public class class246 extends class449 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lnl;II)Lng;")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lnl;)Z")
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "([I)Lqq;")
