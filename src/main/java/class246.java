...
public class class246 extends class402 {
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(B)Loga;")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IBI)Lsr;")
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(Lpq;IIII)Liq;")
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(ILpn;Lpn;Ldu;Leda;I[BIZ)V")
