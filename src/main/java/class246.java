...
public class class246 {
    ...
    @OriginalMember(owner = "client!ec", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lko;JI)V", line = 69)
