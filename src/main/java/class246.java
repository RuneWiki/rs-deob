...
public class class246 extends class344 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ILvf;III)Lub;")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lgb;II)V")
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Lvf;)V")
