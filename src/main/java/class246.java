...
public class class246 extends class186 {
    ...
    @OriginalMember(owner = "client!ol", name = "<init>", descriptor = "(Leq;Ljava/lang/Object;I)V", line = 3)
    public class246(class137 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field3951 = arg1;
    }

    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)Z", line = 12)
    public final boolean method1422(int arg0) {
        field3950++;
        return arg0 != 0;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 38)
