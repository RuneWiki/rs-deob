...
public class class246 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BILm;Ljava/awt/Canvas;)Lqa;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BLna;IILna;Lcl;ZIILqa;III)Lc;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lqa;Lcl;IIZII)Lc;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BLti;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lna;Lqa;ILna;Lcl;IIIIIBIIZ)Lc;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lcl;Lqa;IIIII)Lc;")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(IZLti;)V")
