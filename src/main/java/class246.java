...
public class class246 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BIC)C")
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BI)Lnk;")
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lci;ILhe;)V")
