...
public class class246 extends class326 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lwm;Lhp;III)V", line = 11)
    ...
    @OriginalMember(owner = "client!br", name = "f", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILbt;I)V", line = 98)
