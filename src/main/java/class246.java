...
public class class246 extends class604 {
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!ig", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IIII)[B", line = 34)
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(BII)V", line = 55)
