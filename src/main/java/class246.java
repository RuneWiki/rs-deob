...
public class class246 extends class61 {
    ...
    @OriginalMember(owner = "client!bj", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Laha;Ljl;[Lhb;[I[I)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "([B[IIIIIIII)V")
