...
public class class246 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!eh", name = "toString", descriptor = "()Ljava/lang/String;", line = 35)
    public final String toString() {
        field3593++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(II)V", line = 44)
    public class246(int arg0, int arg1) {
        this.field3592 = arg1;
        this.field3590 = arg0;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIZ)I", line = 54)
