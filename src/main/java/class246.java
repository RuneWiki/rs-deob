...
public class class246 extends class617 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILtf;Lfa;ZBD)[I")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZDIIZLfa;ILtf;)[I")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLtf;Lfa;)Z")
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lnp;)V")
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lfa;IBLtf;ZI)[F")
