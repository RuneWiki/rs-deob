...
public class class246 extends class283 implements class2 {
    ...
    @OriginalMember(owner = "client!i", name = "f", descriptor = "()[Lhr;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "()[Loo;")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luha;IZ)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luha;Lau;I)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILuha;ZII)Z")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "([ILuha;)V")
    private final void method1566(int[] arg0, class723 arg1) {
        this.field3425.method2466().method1051(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luha;Lau;II)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Luha;)V")
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IILuha;ZI)Z")
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(Loa;Lya;Lkda;IIII)V")
