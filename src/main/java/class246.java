...
public class class246 extends class202 {
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)[F", line = 6)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!nb", name = "g", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!nb", name = "EA", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!nb", name = "v", descriptor = "()V", line = 89)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(III)V", line = 99)
    ...
    @OriginalMember(owner = "client!nb", name = "K", descriptor = "(III[I)V", line = 119)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(ILc;)V", line = 131)
    ...
    @OriginalMember(owner = "client!nb", name = "wa", descriptor = "([I)V", line = 154)
    ...
    @OriginalMember(owner = "client!nb", name = "ea", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!nb", name = "W", descriptor = "(III)V", line = 197)
    ...
    @OriginalMember(owner = "client!nb", name = "ca", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!nb", name = "ha", descriptor = "(Lc;)V", line = 222)
    ...
    @OriginalMember(owner = "client!nb", name = "A", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(FIFIIFI)V", line = 260)
    ...
    @OriginalMember(owner = "client!nb", name = "YA", descriptor = "(IIIIII)V", line = 303)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(I)[F", line = 338)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "()Lc;", line = 362)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(III[I)V", line = 385)
    ...
    @OriginalMember(owner = "client!nb", name = "U", descriptor = "(III)V", line = 395)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "()V", line = 409)
    public class246() {
        this.method1244();
    }
}
