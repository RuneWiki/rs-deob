...
public class class246 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;BLjagdx/IDirect3DSurface;)V", line = 35)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IZ)I", line = 48)
    public final int method1476(int arg0, boolean arg1) {
        return arg1 ? this.field3175.Present(arg0) : 111;
    }

    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 56)
    public class246(IDirect3DSwapChain arg0, IDirect3DSurface arg1) {
        this.method1475(arg0, (byte) 81, arg1);
    }

    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)Z", line = 65)
