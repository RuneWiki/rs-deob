...
public class class246 implements Runnable {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(II[B[BIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(Ljava/lang/String;Z)Lrda;", line = 62)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(BLmg;)V", line = 85)
    ...
    @OriginalMember(owner = "client!dia", name = "run", descriptor = "()V", line = 108)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(B)V", line = 148)
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "()V", line = 179)
    public class246() {
