...
public abstract class class246 extends class339 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;B)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Lgj;Lgj;Lgj;Lgj;B)V", line = 34)
