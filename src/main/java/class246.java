...
public class class246 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lbl;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ILbl;)V", line = 357)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(Lbl;B)V", line = 377)
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(Lbl;B)V", line = 395)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(B)V", line = 409)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZI)V", line = 420)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(BLii;Lbl;)V", line = 433)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(ZB)V", line = 718)
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "([BB)Lwt;", line = 759)
