...
public class class246 extends class56 {
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(ILee;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(II)[[I", line = 38)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "()V", line = 138)
    public class246() {
        super(1, false);
    }
}
