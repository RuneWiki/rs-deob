...
public class class507 extends class775 {
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(I)V", line = 4)
    public static void method2933(int arg0) {
        field7007 = null;
        int var1 = -12 / ((arg0 - 19) / 36);
    }

    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILjp;)V", line = 13)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(BLhka;)V", line = 42)
