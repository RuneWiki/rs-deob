...
public class class507 extends class513 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(BB)C", line = 29)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Z)V", line = 59)
