...
public class class507 implements class351 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([[BLct;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIIIIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(I)Lgb;", line = 80)
    public final class228 method1499(int arg0) {
        field6970++;
        return arg0 == 27291 ? class228.field3323 : null;
    }

    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lgj;Ljava/lang/String;)V", line = 97)
