...
public abstract class class507 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lkda;BZLjava/lang/String;)Llk;")
    ...
    @OriginalMember(owner = "client!ot", name = "providesignlink", descriptor = "(Llp;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lgw;I)V")
    ...
    @OriginalMember(owner = "client!ot", name = "g", descriptor = "(B)V")
