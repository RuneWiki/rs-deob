...
public class class507 {
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(Lgo;Lgo;B)V", line = 24)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!bc", name = "a", descriptor = "(IB)V", line = 83)
