...
public class class507 extends class189 {
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ek", name = "<init>", descriptor = "(I)V", line = 168)
    public class507(int arg0) {
        this.field7257 = arg0;
    }

    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(BLeea;)V", line = 114)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)V", line = 159)
