...
public class class507 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lie;BI)V")
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ILie;)V")
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)Lba;")
