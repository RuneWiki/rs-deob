...
public class class507 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(I)Lrh;", line = 139)
    ...
    @OriginalMember(owner = "client!pw", name = "c", descriptor = "(I)Z", line = 156)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Z)Lrh;", line = 167)
    ...
    @OriginalMember(owner = "client!pw", name = "d", descriptor = "(I)Lrh;", line = 188)
    ...
    @OriginalMember(owner = "client!pw", name = "e", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B)Lrh;", line = 224)
    ...
    @OriginalMember(owner = "client!pw", name = "f", descriptor = "(I)Luo;", line = 246)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(Lrh;I)V", line = 258)
    ...
    @OriginalMember(owner = "client!pw", name = "g", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(II)V", line = 299)
    ...
    @OriginalMember(owner = "client!pw", name = "h", descriptor = "(I)I", line = 312)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "()V", line = 343)
    public class507() {
