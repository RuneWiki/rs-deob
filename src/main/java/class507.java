...
public class class507 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(Lhp;I)Lwh;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(II)Lau;")
    ...
    @OriginalMember(owner = "client!jn", name = "<init>", descriptor = "(Lee;ILul;)V")
