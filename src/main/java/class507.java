...
public class class507 extends class14 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IBLmd;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(BII)Lcl;", line = 15)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IB)[I", line = 35)
    ...
    @OriginalMember(owner = "client!wn", name = "d", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(II)V", line = 85)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "()V", line = 184)
    public class507() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IB[BI)[B", line = 219)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(II)[[I", line = 239)
