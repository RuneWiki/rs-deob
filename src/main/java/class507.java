...
public class class507 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "([IBI)Lpv;", line = 11)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I[IB)Lpv;", line = 31)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "([IIZI)Lpv;", line = 68)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I[III)Lpv;", line = 221)
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Luq;Luq;)V", line = 267)
