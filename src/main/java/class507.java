...
public class class507 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(B[[[Lch;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BLjava/awt/Component;)Lrl;")
    public static final class232 method3025(byte arg0, Component arg1) {
        field7084++;
        return arg0 < 61 ? null : new class47(arg1);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lpaa;ZLpaa;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lvj;I)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IBLvj;)V")
