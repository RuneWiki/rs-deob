...
public abstract class class507 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IBIIII[I[IIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IBLiu;)V", line = 152)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[ZIIILiu;ZILiu;Liu;IIILiu;)V", line = 198)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIIBILna;)V", line = 254)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Liu;I[IZIIIZIILiu;)V", line = 375)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ldc;IIZ[ZZZ[ILsp;ILdc;I)V", line = 410)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILiu;IIIILiu;ZB)V", line = 622)
