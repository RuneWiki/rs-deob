...
public class class507 extends class358 implements class144 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lot;II)V")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "()[Lefa;")
    ...
    @OriginalMember(owner = "client!j", name = "d", descriptor = "()[Ljt;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lot;I)V")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lpf;IIII)V")
