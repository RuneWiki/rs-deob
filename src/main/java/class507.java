...
public class class507 extends class12 implements class721 {
    ...
    @OriginalMember(owner = "client!bda", name = "e", descriptor = "(B)Z", line = 3)
    public final boolean method738(byte arg0) {
        ++field7215;
        return arg0 != 88;
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILha;)V", line = 19)
    ...
    @OriginalMember(owner = "client!bda", name = "j", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(ILvs;ZILha;II)V", line = 41)
    ...
    @OriginalMember(owner = "client!bda", name = "e", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!bda", name = "c", descriptor = "(B)I", line = 66)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lfe;Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(Lha;B)Lc;", line = 103)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!bda", name = "k", descriptor = "(B)Z", line = 164)
    ...
    @OriginalMember(owner = "client!bda", name = "i", descriptor = "(B)Z", line = 178)
    public final boolean method320(byte arg0) {
        ++field7221;
        return arg0 != 84;
    }

    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Lha;Lsu;IIIIIZIII)V", line = 263)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lha;I)Lria;", line = 194)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)Z", line = 205)
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!bda", name = "h", descriptor = "(B)I", line = 228)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lha;Z)V", line = 239)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IBLha;I)Z", line = 272)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lha;B)V", line = 292)
