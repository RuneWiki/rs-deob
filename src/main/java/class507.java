...
public class class507 extends class71 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lal;IIIIILrg;IIIBI)V", line = 12)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIILka;ILiha;)V", line = 54)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(IIIIIZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IIBIIII)V", line = 139)
