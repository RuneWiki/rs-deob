...
public class class507 extends class530 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIILqd;)V")
    ...
    @OriginalMember(owner = "client!cp", name = "d", descriptor = "(I)Lbj;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(III)Lnh;")
