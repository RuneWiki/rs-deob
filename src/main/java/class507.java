...
public class class507 extends class339 implements class2 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lr;IIIIZ)Z", line = 4)
    public final boolean method624(class706 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return true;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 122)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Loa;Lya;II[[I[[IIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZII)V", line = 138)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvt;[I)V", line = 186)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(II)V", line = 190)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III[[ZZI)V", line = 201)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIIIII[[Z)V", line = 248)
