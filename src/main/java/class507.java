...
public class class507 extends class359 implements class145 {
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lpo;II)V")
    ...
    @OriginalMember(owner = "client!j", name = "c", descriptor = "()[Let;")
    ...
    @OriginalMember(owner = "client!j", name = "b", descriptor = "()[Lfd;")
    ...
    @OriginalMember(owner = "client!j", name = "a", descriptor = "(Lq;Lpo;I)V")
    ...
    @OriginalMember(owner = "client!j", name = "<init>", descriptor = "(Lda;La;Lnj;IIII)V")
