...
public class class507 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIBLqq;IILeu;I)Lig;", line = 85)
    ...
    @OriginalMember(owner = "client!mo", name = "d", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(BI)Lbq;", line = 122)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(II)V", line = 199)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ZB)V", line = 214)
    ...
    @OriginalMember(owner = "client!mo", name = "e", descriptor = "(I)V", line = 229)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Leu;IIILwn;IZBIZLqq;Lqq;)Lig;", line = 285)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)V", line = 352)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lcm;IZLwb;Llt;Llt;)V", line = 451)
    ...
    @OriginalMember(owner = "client!mo", name = "f", descriptor = "(I)V", line = 423)
