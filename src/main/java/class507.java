...
public class class507 implements class515 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(II)I", line = 21)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;ZLjava/lang/Object;)Z", line = 86)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Ljava/lang/Object;", line = 112)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ZJ)Z", line = 130)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(IB)I", line = 143)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(II)I", line = 159)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(B)I", line = 193)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BZ)V", line = 206)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Class;I)I", line = 399)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Ljka;B)V", line = 412)
    ...
    @OriginalMember(owner = "client!ae", name = "b", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(I)V", line = 487)
    ...
    @OriginalMember(owner = "client!ae", name = "c", descriptor = "(B)V", line = 512)
