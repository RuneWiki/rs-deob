...
public class class507 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(IIII[BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ILha;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lda;)V", line = 100)
    public class507(class60 arg0) {
        this.field6774 = arg0;
    }

    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(Lda;Lrc;)V", line = 107)
