...
public class class507 extends class212 {
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(ILdh;)V")
    ...
    @OriginalMember(owner = "client!od", name = "a", descriptor = "(BILin;)Loea;")
    ...
    @OriginalMember(owner = "client!od", name = "<init>", descriptor = "(Ldh;)V")
