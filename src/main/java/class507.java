...
public class class507 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILdh;Ldh;I)Lau;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILdh;ZILdh;)Lau;")
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(Lgl;Lkp;)V")
