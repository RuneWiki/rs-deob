...
public class class507 extends class476 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "([Ljava/lang/String;[SZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IZLnf;)V", line = 21)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "([B)V", line = 333)
