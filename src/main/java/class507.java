...
public class class507 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(ZLrv;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(I)Lrv;", line = 69)
    ...
    @OriginalMember(owner = "client!ko", name = "c", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "()V", line = 143)
    public class507() {
        this.field7154.field1623 = this.field7154;
        this.field7154.field1622 = this.field7154;
    }

    @OriginalMember(owner = "client!ko", name = "b", descriptor = "(B)Lrv;", line = 125)
