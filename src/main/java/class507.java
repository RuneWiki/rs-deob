...
public class class507 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BLsl;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIIILeda;IIIIIILcga;)V")
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BILsl;)V")
