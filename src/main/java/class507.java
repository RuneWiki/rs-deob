...
public class class507 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lrg;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(JI)V", line = 83)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lfn;IZ)V", line = 177)
