...
public class class507 extends class14 {
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(IBLbha;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(ILjava/lang/String;ZLjava/lang/String;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!wga", name = "c", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!wga", name = "a", descriptor = "(B)Lgp;", line = 67)
    ...
    @OriginalMember(owner = "client!wga", name = "<init>", descriptor = "(Lpf;Ldg;IIIIIIIII)V", line = 87)
