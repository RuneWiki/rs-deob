...
public class InputTracking {
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!f", name = "b", descriptor = "(I)Lmb;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(B)Lmb;")
