...
public class InputTracking {
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "Lmb;")
    public static Packet field152 = null;

    @OriginalMember(owner = "client!f", name = "g", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)Lmb;")
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Z)Lmb;")
