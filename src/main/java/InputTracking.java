...
public class InputTracking {
    ...
    @OriginalMember(owner = "client!e", name = "g", descriptor = "Lkb;")
    public static Packet field78 = null;

    @OriginalMember(owner = "client!e", name = "h", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!e", name = "c", descriptor = "(I)Lkb;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(B)Lkb;")
