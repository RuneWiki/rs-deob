...
public abstract class class37 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(Lu;ZLu;)V", line = 4)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(III)I", line = 23)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!i", name = "c", descriptor = "(III)I", line = 62)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIIIIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(III[[I)V", line = 135)
