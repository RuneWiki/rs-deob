...
public class class37 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(JI)V", line = 74)
