...
public abstract class class37 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ZLac;)Lefa;", line = 22)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IBI)I", line = 43)
    ...
    @OriginalMember(owner = "client!i", name = "<init>", descriptor = "(III[[I)V", line = 70)
    ...
    @OriginalMember(owner = "client!i", name = "b", descriptor = "(III)I", line = 90)
