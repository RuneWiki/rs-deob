...
public class class37 extends class45 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "()V", line = 37)
    public class37() {
    }

    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(I)V", line = 40)
