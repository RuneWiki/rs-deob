...
public class class37 {
    ...
    @OriginalMember(owner = "client!PNEYGONI", name = "c", descriptor = "LOGGHOMII;")
    public class33 field1312 = new class33();

    @OriginalMember(owner = "client!PNEYGONI", name = "d", descriptor = "LOGGHOMII;")
    ...
    @OriginalMember(owner = "client!PNEYGONI", name = "a", descriptor = "(LOGGHOMII;)V")
    ...
    @OriginalMember(owner = "client!PNEYGONI", name = "a", descriptor = "()LOGGHOMII;")
    ...
    @OriginalMember(owner = "client!PNEYGONI", name = "b", descriptor = "()LOGGHOMII;")
    ...
    @OriginalMember(owner = "client!PNEYGONI", name = "a", descriptor = "(I)LOGGHOMII;")
