...
public class class37 {
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(III[B)[B", line = 33)
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ZI)Lbca;", line = 70)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Lib;B)Lrfa;", line = 118)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(BII)V", line = 160)
    ...
    @OriginalMember(owner = "client!wv", name = "<init>", descriptor = "(Lffa;Ld;)V", line = 300)
