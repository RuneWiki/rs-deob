...
public class class37 extends class147 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lya;FZII)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BLno;)V")
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(BLno;)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lno;B)V")
