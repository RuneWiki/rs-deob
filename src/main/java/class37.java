...
public class class37 extends class544 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)Loj;")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ZLjava/lang/String;ILgp;)Lmj;")
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Ljj;IIIIII)V")
