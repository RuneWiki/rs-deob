...
public class class37 extends class559 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!nf", name = "b", descriptor = "(B)I", line = 39)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(III)Z", line = 66)
    ...
    @OriginalMember(owner = "client!nf", name = "d", descriptor = "(B)[B", line = 78)
