...
public class class37 {
    ...
    @OriginalMember(owner = "client!LPMARHLZ", name = "d", descriptor = "[LLPMARHLZ;")
    public static class37[] field1110;

    @OriginalMember(owner = "client!LPMARHLZ", name = "a", descriptor = "(ILSPZBTZXL;)V")
    ...
    @OriginalMember(owner = "client!LPMARHLZ", name = "a", descriptor = "(ZLLDILQFVA;I)V")
