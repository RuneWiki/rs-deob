...
public abstract class class37 extends class504 {
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIILjava/lang/String;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(IIIII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILbi;)V", line = 54)
    ...
    @OriginalMember(owner = "client!i", name = "a", descriptor = "(ILvj;I)V", line = 68)
