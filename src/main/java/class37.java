...
public class class37 extends class16 {
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lh;)V", line = 86)
    public class37(class327 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wg", name = "c", descriptor = "()Z", line = 91)
    public final boolean method92() {
        return this.field407 != null;
    }

    @OriginalMember(owner = "client!wg", name = "e", descriptor = "()Z", line = 98)
    public final boolean method239() {
        return this.field181.field4405 && this.field181.field4457 && this.field181.field4440;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "()I", line = 103)
    public final int method89() {
        return 1;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILbj;Lbj;)V", line = 114)
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "()Z", line = 265)
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(I)V", line = 296)
