...
public class class37 {
    ...
    @OriginalMember(owner = "client!OAXQGLDV", name = "f", descriptor = "[LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!OAXQGLDV", name = "a", descriptor = "(J)LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!OAXQGLDV", name = "a", descriptor = "(JLOKDOXVFL;I)V")
