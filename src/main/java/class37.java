...
@OriginalClass("client!NPWLDXJE")
public class class37 {

    @OriginalMember(owner = "client!NPWLDXJE", name = "e", descriptor = "J")
    public long field1122 = -1L;

    @OriginalMember(owner = "client!NPWLDXJE", name = "f", descriptor = "I")
    public int field1123 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "g", descriptor = "I")
    private int field1124 = 128;

    @OriginalMember(owner = "client!NPWLDXJE", name = "j", descriptor = "B")
    public byte field1127 = 1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "k", descriptor = "Z")
    public boolean field1128 = true;

    @OriginalMember(owner = "client!NPWLDXJE", name = "m", descriptor = "I")
    public int field1130 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "n", descriptor = "I")
    public int field1131 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "o", descriptor = "Z")
    public boolean field1132 = true;

    @OriginalMember(owner = "client!NPWLDXJE", name = "q", descriptor = "I")
    private int field1134 = 128;

    @OriginalMember(owner = "client!NPWLDXJE", name = "r", descriptor = "B")
    private byte field1135 = 29;

    @OriginalMember(owner = "client!NPWLDXJE", name = "s", descriptor = "I")
    public int field1136 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "t", descriptor = "I")
    public int field1137 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "u", descriptor = "I")
    public int field1138 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "v", descriptor = "I")
    public int field1139 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "w", descriptor = "I")
    public int field1140 = 32;

    @OriginalMember(owner = "client!NPWLDXJE", name = "x", descriptor = "I")
    public int field1141 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "A", descriptor = "I")
    public int field1144 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "B", descriptor = "Z")
    public boolean field1145 = false;

    @OriginalMember(owner = "client!NPWLDXJE", name = "F", descriptor = "I")
    public int field1149 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "H", descriptor = "I")
    public int field1151 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "I", descriptor = "I")
    public int field1152 = -1;

    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "LDSMCVRKW;")
    public static class15 field1118 = new class15((byte) 7, 30);

    @OriginalMember(owner = "client!NPWLDXJE", name = "h", descriptor = "I")
    private int field1125;

    @OriginalMember(owner = "client!NPWLDXJE", name = "z", descriptor = "I")
    public static int field1143;

    @OriginalMember(owner = "client!NPWLDXJE", name = "E", descriptor = "I")
    private static int field1148;

    @OriginalMember(owner = "client!NPWLDXJE", name = "J", descriptor = "I")
    private int field1153;

    @OriginalMember(owner = "client!NPWLDXJE", name = "C", descriptor = "LEILHLJCE;")
    private static class17 field1146;

    @OriginalMember(owner = "client!NPWLDXJE", name = "d", descriptor = "Lclient;")
    public static client field1121;

    @OriginalMember(owner = "client!NPWLDXJE", name = "y", descriptor = "Ljava/lang/String;")
    public String field1142;

    @OriginalMember(owner = "client!NPWLDXJE", name = "D", descriptor = "[B")
    public byte[] field1147;

    @OriginalMember(owner = "client!NPWLDXJE", name = "b", descriptor = "[I")
    public int[] field1119;

    @OriginalMember(owner = "client!NPWLDXJE", name = "c", descriptor = "[I")
    private int[] field1120;

    @OriginalMember(owner = "client!NPWLDXJE", name = "i", descriptor = "[I")
    private static int[] field1126;

    @OriginalMember(owner = "client!NPWLDXJE", name = "l", descriptor = "[I")
    private int[] field1129;

    @OriginalMember(owner = "client!NPWLDXJE", name = "K", descriptor = "[I")
    private int[] field1154;

    @OriginalMember(owner = "client!NPWLDXJE", name = "L", descriptor = "[I")
    private int[] field1155;

    @OriginalMember(owner = "client!NPWLDXJE", name = "G", descriptor = "[LNPWLDXJE;")
    private static class37[] field1150;

    @OriginalMember(owner = "client!NPWLDXJE", name = "p", descriptor = "[Ljava/lang/String;")
    public String[] field1133;

    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "(II[IZ)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "(B)LNPWLDXJE;")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "(Z)LKBEXSZSN;")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "(LBBMKAXRK;)V")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "b", descriptor = "(I)LNPWLDXJE;")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!NPWLDXJE", name = "a", descriptor = "(LEILHLJCE;B)V")
