...
public abstract class class37 extends class140 {
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!dm", name = "f", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I[Ljava/lang/String;BI)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BI)V", line = 99)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BIIIIIIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 194)
