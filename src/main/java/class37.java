...
public class class37 extends class100 implements class218 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!kg", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!kg", name = "<init>", descriptor = "(Ltq;Lvc;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(ILtq;)V")
