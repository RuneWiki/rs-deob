...
public class class37 extends class370 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIILqa;)Z")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILqa;)Lbw;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IILqa;IZLha;I)V")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lqa;Lc;I)V")
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(Lqa;I)V")
