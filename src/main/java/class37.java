...
public class class37 extends class15 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lvt;I)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BLws;)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILvt;B)V")
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IILmt;)Loe;")
