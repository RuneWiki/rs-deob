...
public class class37 extends class583 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILha;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 576)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZJZ)V", line = 609)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BII)Z", line = 628)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(I)V", line = 639)
