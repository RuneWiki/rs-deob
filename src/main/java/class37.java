...
public class class37 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BILuaa;I)V")
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IB)Lo;")
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lega;ILwm;)V")
