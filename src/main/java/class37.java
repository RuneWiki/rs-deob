...
public class class37 extends class430 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "([IZBI[I)J", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IZ)I", line = 50)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(BIII)Z", line = 153)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIILaca;)V", line = 192)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IILvo;ILha;IZIILjr;)Lka;", line = 234)
