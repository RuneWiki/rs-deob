...
public class class37 extends class192 implements class518 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BLza;)V", line = 7)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(IIIIILf;)V", line = 159)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILza;I)Le;", line = 167)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)I", line = 179)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(I)V", line = 190)
    public final void method31(int arg0) {
        field562++;
        int var2 = 95 / ((57 - arg0) / 48);
    }

    @OriginalMember(owner = "client!mm", name = "e", descriptor = "(I)I", line = 199)
    public final int method274(int arg0) {
        field559++;
        return arg0 == -2 ? 0 : -63;
    }

    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)I", line = 210)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lza;III)Z", line = 221)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(BLza;)V", line = 238)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(ILza;)Lsr;", line = 248)
    ...
    @OriginalMember(owner = "client!mm", name = "f", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!mm", name = "d", descriptor = "(B)V", line = 270)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILza;)V", line = 297)
