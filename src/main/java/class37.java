...
public class class37 extends class45 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILuu;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lfd;Lm;)V", line = 18)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZB)V", line = 84)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)Z", line = 99)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(III)Z", line = 164)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 174)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILkj;Z)V", line = 194)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(III)V", line = 205)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 252)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIIII)V", line = 280)
