...
@OriginalClass("client!LLYASRTI")
public class class37 implements Runnable {

    @OriginalMember(owner = "client!LLYASRTI", name = "a", descriptor = "I")
    private int field1099 = 49942;

    @OriginalMember(owner = "client!LLYASRTI", name = "b", descriptor = "I")
    private int field1100 = -630;

    @OriginalMember(owner = "client!LLYASRTI", name = "f", descriptor = "Z")
    private boolean field1104 = false;

    @OriginalMember(owner = "client!LLYASRTI", name = "k", descriptor = "Z")
    private boolean field1109 = false;

    @OriginalMember(owner = "client!LLYASRTI", name = "l", descriptor = "Z")
    private boolean field1110 = false;

    @OriginalMember(owner = "client!LLYASRTI", name = "g", descriptor = "LQNTDRCTM;")
    public class45 field1105;

    @OriginalMember(owner = "client!LLYASRTI", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field1103;

    @OriginalMember(owner = "client!LLYASRTI", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field1101;

    @OriginalMember(owner = "client!LLYASRTI", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1102;

    @OriginalMember(owner = "client!LLYASRTI", name = "i", descriptor = "I")
    private int field1107;

    @OriginalMember(owner = "client!LLYASRTI", name = "j", descriptor = "I")
    private int field1108;

    @OriginalMember(owner = "client!LLYASRTI", name = "h", descriptor = "[B")
    private byte[] field1106;

    @OriginalMember(owner = "client!LLYASRTI", name = "<init>", descriptor = "(Ljava/net/Socket;ZLQNTDRCTM;)V")
    ...
    @OriginalMember(owner = "client!LLYASRTI", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!LLYASRTI", name = "c", descriptor = "()I")
    public int method353() throws IOException {
        return this.field1104 ? 0 : this.field1101.available();
    }

    @OriginalMember(owner = "client!LLYASRTI", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!LLYASRTI", name = "a", descriptor = "(III[B)V")
    ...
    @OriginalMember(owner = "client!LLYASRTI", name = "run", descriptor = "()V")
    public void run() {
    ...
    @OriginalMember(owner = "client!LLYASRTI", name = "a", descriptor = "(I)V")
