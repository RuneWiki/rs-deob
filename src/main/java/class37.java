...
@OriginalClass("client!KMFVYEKJ")
public class class37 {

    @OriginalMember(owner = "client!KMFVYEKJ", name = "a", descriptor = "Z")
    private boolean field1205 = false;

    @OriginalMember(owner = "client!KMFVYEKJ", name = "b", descriptor = "I")
    private int field1206 = -5196;

    @OriginalMember(owner = "client!KMFVYEKJ", name = "c", descriptor = "LMOVYLKVL;")
    public class41 field1207 = new class41();

    @OriginalMember(owner = "client!KMFVYEKJ", name = "d", descriptor = "LMOVYLKVL;")
    private class41 field1208;

    @OriginalMember(owner = "client!KMFVYEKJ", name = "<init>", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!KMFVYEKJ", name = "a", descriptor = "(LMOVYLKVL;)V")
    ...
    @OriginalMember(owner = "client!KMFVYEKJ", name = "a", descriptor = "()LMOVYLKVL;")
    ...
    @OriginalMember(owner = "client!KMFVYEKJ", name = "b", descriptor = "()LMOVYLKVL;")
    ...
    @OriginalMember(owner = "client!KMFVYEKJ", name = "a", descriptor = "(I)LMOVYLKVL;")
    ...
    @OriginalMember(owner = "client!KMFVYEKJ", name = "c", descriptor = "()I")
