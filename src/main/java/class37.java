...
public class class37 extends class424 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(IIB)I", line = 3)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(B[I)Ljava/lang/String;", line = 38)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(B[Ltc;I)V", line = 93)
