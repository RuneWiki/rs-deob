...
public class class37 extends class539 {
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Ltt;)V", line = 8)
    public class37(class249 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ts", name = "i", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BLcd;Lcd;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!ts", name = "f", descriptor = "(I)Z", line = 207)
    ...
    @OriginalMember(owner = "client!ts", name = "g", descriptor = "(I)Z", line = 226)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(III)V", line = 267)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZI)V", line = 346)
    ...
    @OriginalMember(owner = "client!ts", name = "j", descriptor = "(I)Z", line = 361)
