...
public class class37 implements class209 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!bh", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(Lni;Lni;Ltga;)V", line = 87)
