...
public class class37 {
    ...
    @OriginalMember(owner = "client!NGIGHQOG", name = "p", descriptor = "LRPWOWYDL;")
    ...
    @OriginalMember(owner = "client!NGIGHQOG", name = "h", descriptor = "LZGXCNUJM;")
    public class71 field1141;

    @OriginalMember(owner = "client!NGIGHQOG", name = "d", descriptor = "[LNGIGHQOG;")
    public static class37[] field1137;

    @OriginalMember(owner = "client!NGIGHQOG", name = "a", descriptor = "(LFNOQZAYQ;I)V")
    ...
    @OriginalMember(owner = "client!NGIGHQOG", name = "a", descriptor = "(LDNRIFKTO;I)V")
    ...
    @OriginalMember(owner = "client!NGIGHQOG", name = "a", descriptor = "()LSNMMQNPZ;")
