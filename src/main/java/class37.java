...
public class class37 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(II)Li;", line = 49)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lwp;IZI)V", line = 79)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lai;ILic;Lic;)V", line = 855)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 816)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(II)V", line = 832)
