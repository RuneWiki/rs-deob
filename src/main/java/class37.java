...
public class class37 extends class164 implements class351 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BILnr;)Lqc;", line = 5)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ec", name = "g", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(Lnr;Z)Lg;", line = 42)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(B)I", line = 83)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lnr;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)V", line = 113)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)I", line = 136)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(B)I", line = 151)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lnr;Lta;IIIIIIIZIIII)V", line = 168)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lnr;Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILnr;II)Z", line = 193)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILnr;)V", line = 212)
