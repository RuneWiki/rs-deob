...
public class class37 extends class5 {
    ...
    @OriginalMember(owner = "client!OTOMPFCI", name = "ub", descriptor = "LWHKCNEXD;")
    public class60 field1044;

    @OriginalMember(owner = "client!OTOMPFCI", name = "a", descriptor = "(Z)LYABPKWWG;")
    ...
    @OriginalMember(owner = "client!OTOMPFCI", name = "c", descriptor = "(I)LYABPKWWG;")
