...
public class class37 extends class644 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!bh", name = "e", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!bh", name = "f", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Ljava/lang/String;BLqg;I)Lsq;", line = 62)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(Z)J", line = 140)
    ...
    @OriginalMember(owner = "client!bh", name = "<init>", descriptor = "(II)V", line = 151)
