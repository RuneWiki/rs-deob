...
public class class37 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIIIIIFF[F[FIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)Ljt;", line = 57)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILjt;)V", line = 68)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(I)V", line = 98)
    public class37(int arg0) {
        this.field519 = arg0;
    }

    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(IIIIII)V", line = 105)
