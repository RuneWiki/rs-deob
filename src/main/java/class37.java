...
public class class37 {
    ...
    @OriginalMember(owner = "client!OYARMXQN", name = "c", descriptor = "[LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!OYARMXQN", name = "a", descriptor = "(J)LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!OYARMXQN", name = "a", descriptor = "(LOYTUMBCI;JI)V")
