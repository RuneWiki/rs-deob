...
public class class37 extends class770 {
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(JLgda;ZIIIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!bh", name = "c", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!bh", name = "a", descriptor = "(IIII)V", line = 38)
