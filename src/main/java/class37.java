...
public class class37 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(B)V", line = 23)
    public static void method267(byte arg0) {
        int var1 = 4 / ((arg0 - 43) / 51);
        field589 = null;
    }

    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IB)Lqr;", line = 32)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lgo;ILns;)V", line = 102)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZI)V", line = 90)
