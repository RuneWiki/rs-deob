...
@OriginalClass("client!OQOGSGFM")
public class class37 {

    @OriginalMember(owner = "client!OQOGSGFM", name = "a", descriptor = "I")
    private int field967 = -261;

    @OriginalMember(owner = "client!OQOGSGFM", name = "b", descriptor = "I")
    private int field968 = -548;

    @OriginalMember(owner = "client!OQOGSGFM", name = "g", descriptor = "I")
    public int field973 = -1;

    @OriginalMember(owner = "client!OQOGSGFM", name = "i", descriptor = "[I")
    public int[] field975 = new int[6];

    @OriginalMember(owner = "client!OQOGSGFM", name = "j", descriptor = "[I")
    public int[] field976 = new int[6];

    @OriginalMember(owner = "client!OQOGSGFM", name = "k", descriptor = "I")
    public int field977 = 128;

    @OriginalMember(owner = "client!OQOGSGFM", name = "l", descriptor = "I")
    public int field978 = 128;

    @OriginalMember(owner = "client!OQOGSGFM", name = "p", descriptor = "LECXUVDNP;")
    public static class12 field982 = new class12(0, 30);

    @OriginalMember(owner = "client!OQOGSGFM", name = "c", descriptor = "I")
    public static int field969;

    @OriginalMember(owner = "client!OQOGSGFM", name = "e", descriptor = "I")
    public int field971;

    @OriginalMember(owner = "client!OQOGSGFM", name = "f", descriptor = "I")
    public int field972;

    @OriginalMember(owner = "client!OQOGSGFM", name = "m", descriptor = "I")
    public int field979;

    @OriginalMember(owner = "client!OQOGSGFM", name = "n", descriptor = "I")
    public int field980;

    @OriginalMember(owner = "client!OQOGSGFM", name = "o", descriptor = "I")
    public int field981;

    @OriginalMember(owner = "client!OQOGSGFM", name = "h", descriptor = "LJFYFSKVR;")
    public class22 field974;

    @OriginalMember(owner = "client!OQOGSGFM", name = "d", descriptor = "[LOQOGSGFM;")
    public static class37[] field970;

    @OriginalMember(owner = "client!OQOGSGFM", name = "a", descriptor = "(LCXFTMSCH;B)V")
    ...
    @OriginalMember(owner = "client!OQOGSGFM", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!OQOGSGFM", name = "a", descriptor = "()LYYHPBDED;")
