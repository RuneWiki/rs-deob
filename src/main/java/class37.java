...
public class class37 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(ILjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V", line = 15)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(I)Z", line = 24)
    ...
    @OriginalMember(owner = "client!nf", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 61)
