...
public class class37 extends class424 {
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IBI)Z", line = 96)
    ...
    @OriginalMember(owner = "client!dm", name = "e", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I[Ljava/lang/String;II)Ljava/lang/String;", line = 140)
    ...
    @OriginalMember(owner = "client!dm", name = "e", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIBI)V", line = 220)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BIIIIII)V", line = 238)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lbt;II)V", line = 680)
    public class37(class33 arg0, int arg1, int arg2) {
        this.field786 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIIIBI)V", line = 692)
