...
public class class37 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZ)S", line = 20)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZIILmq;)V", line = 48)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BLbu;)V", line = 83)
