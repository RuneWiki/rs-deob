...
public class class37 {
    ...
    @OriginalMember(owner = "client!LYKGAWTC", name = "m", descriptor = "I")
    ...
    @OriginalMember(owner = "client!LYKGAWTC", name = "a", descriptor = "(BLGLMIQHJI;)V")
    ...
    @OriginalMember(owner = "client!LYKGAWTC", name = "a", descriptor = "(LGLMIQHJI;I)V")
