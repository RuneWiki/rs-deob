...
public abstract class class37 extends class170 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIILp;)V", line = 5)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II[J[II)V", line = 45)
    ...
    @OriginalMember(owner = "client!ec", name = "e", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z[J[Ljava/lang/Object;II)V", line = 120)
