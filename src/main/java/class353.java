...
public class class353 implements class450 {
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(ZI)I", line = 7)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(I)Z", line = 109)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!tc", name = "a", descriptor = "(IZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!tc", name = "b", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!tc", name = "<init>", descriptor = "(Lvd;Lvd;Llca;)V", line = 180)
