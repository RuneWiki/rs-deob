...
public class class353 extends class563 implements class302 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lr;Llr;IIIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZBZLuaa;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILr;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "i", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZILr;I)Z")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILr;)Lda;")
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(ILr;)Lod;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIILr;ZILpn;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BLr;)Lll;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILr;Z)Lraa;")
