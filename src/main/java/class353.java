...
public class class353 extends class391 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lsd;B)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILsd;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ZLsd;)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ZLna;FII)V")
