...
public class class353 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZBILoa;)Lta;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLjr;)V")
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Len;I)V")
