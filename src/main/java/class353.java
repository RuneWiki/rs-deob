...
public class class353 extends class56 {
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!b", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BII)Z", line = 93)
    ...
    @OriginalMember(owner = "client!b", name = "<init>", descriptor = "()V", line = 210)
    public class353() {
        super(0, true);
    }

    @OriginalMember(owner = "client!b", name = "a", descriptor = "(BILes;)V", line = 133)
    ...
    @OriginalMember(owner = "client!b", name = "a", descriptor = "(IIZ)Z", line = 217)
