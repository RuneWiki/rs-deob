...
public class class353 extends class735 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lrh;Z)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZI)Lng;")
