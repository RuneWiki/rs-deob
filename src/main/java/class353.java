...
public abstract class class353 extends class179 {
    ...
    @OriginalMember(owner = "client!pt", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(I[BII)I", line = 15)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(B)V", line = 37)
