...
public abstract class class353 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!km", name = "b", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Loh;III)Lur;", line = 64)
