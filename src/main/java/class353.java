...
public class class353 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IJLlq;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(JI)Llq;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)Llq;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lws;Lfba;B)Leo;")
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(I)Llq;")
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(Z)Llq;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I[Llq;)I")
