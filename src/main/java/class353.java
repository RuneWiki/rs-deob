...
public class class353 extends class262 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II)Lht;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILoa;B)V")
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lifa;)V")
