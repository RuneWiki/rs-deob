...
public class class353 extends class269 {
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(Lbt;Lgg;[Lho;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(CIIIZLi;II)V", line = 209)
    ...
    @OriginalMember(owner = "client!lm", name = "g", descriptor = "(CIIIZ)V", line = 254)
