...
public class class353 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([BIIB)I")
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(I)Ljava/io/File;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(JB)V")
