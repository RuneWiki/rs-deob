...
public class class353 extends class436 {
    ...
    @OriginalMember(owner = "client!th", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "()V", line = 158)
    public class353() {
        super(0, true);
    }

    @OriginalMember(owner = "client!th", name = "e", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)[I", line = 247)
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(I)V", line = 357)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILeb;)V", line = 368)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILjj;)V", line = 455)
    ...
    @OriginalMember(owner = "client!th", name = "g", descriptor = "(I)V", line = 499)
