...
public class class353 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILmc;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ls;Lcl;IIIZIIIILs;Lha;B)Lka;", line = 125)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILcl;ILs;ZIBIILha;ZILs;I)Lka;", line = 136)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIIIII)V", line = 252)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIBLcl;BILha;I)Lka;", line = 285)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lmc;I)V", line = 330)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lcl;IILha;III)Lka;", line = 356)
