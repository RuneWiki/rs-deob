...
public class class353 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILlf;)Ljava/lang/String;", line = 11)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(III)Lqo;", line = 23)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(III)I", line = 68)
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(I)V", line = 82)
