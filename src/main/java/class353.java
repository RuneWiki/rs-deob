...
public class class353 extends class331 {
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(ILts;)V")
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "(Lts;)V")
    public class353(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(IIILkha;ZLnl;B)V")
