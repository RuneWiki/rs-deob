...
public class class353 extends class220 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(CIIIZLrn;II)V")
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "([B[IIIIIIIIIIILrn;II)V")
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Ljn;Lbs;[Lhb;[I[I)V")
