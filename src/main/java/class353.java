...
public class class353 extends class335 {
    ...
    @OriginalMember(owner = "client!a", name = "d", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(ZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!a", name = "e", descriptor = "(III)Z", line = 75)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZI)[I", line = 193)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ILio;I)V", line = 244)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "()V", line = 328)
    public class353() {
        super(0, true);
    }

    @OriginalMember(owner = "client!a", name = "b", descriptor = "(Z)V", line = 338)
    ...
    @OriginalMember(owner = "client!a", name = "f", descriptor = "(III)V", line = 354)
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "(B)V", line = 368)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(B)V", line = 408)
