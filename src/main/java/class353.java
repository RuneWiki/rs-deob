...
public class class353 extends class383 implements class196 {
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lqa;Leu;IIIIIZII)V", line = 12)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!jc", name = "g", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(BLqa;)V", line = 50)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILqa;)V", line = 72)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)I", line = 82)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(B)Z", line = 93)
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(I)Z", line = 104)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILqa;B)Lc;", line = 116)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IIILqa;)Z", line = 127)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)I", line = 148)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lqa;I)Lpj;", line = 161)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BZI)V", line = 205)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(BLqa;)V", line = 273)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(IB)I", line = 285)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lqv;BLqa;IZII)V", line = 302)
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(I)V", line = 314)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(II[B)I", line = 325)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(B)V", line = 341)
