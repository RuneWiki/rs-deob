...
public class class353 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lhr;I)V", line = 32)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Ldt;)V", line = 84)
    public class353(class254 arg0) {
        this.method2247(-2, arg0);
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILdt;)V", line = 92)
