...
public class class353 extends class168 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lcc;II[I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "([B)V", line = 130)
