...
public class class353 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 17)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(I)V", line = 653)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lnn;", line = 668)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "([Lae;II)V", line = 688)
