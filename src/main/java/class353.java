...
public abstract class class353 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Laa;ILho;Lsha;IBII)V", line = 7)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(III[B)[B", line = 50)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(II)V", line = 90)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(B)V", line = 110)
