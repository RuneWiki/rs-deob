...
public class class353 extends class578 {
    ...
    @OriginalMember(owner = "client!iga", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(I)V", line = 61)
