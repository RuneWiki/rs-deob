...
public class class353 extends class77 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!mj", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 4)
    public final synchronized void focusLost(FocusEvent arg0) {
        field4904++;
        this.method2128(-1, -98, 0, '\u0000');
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!mj", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 42)
    public final void focusGained(FocusEvent arg0) {
        field4924++;
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!mj", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 61)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field4911++;
        this.method2126(arg0, -1, 1);
    }

    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(I)Lau;", line = 69)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(II)Z", line = 90)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V", line = 107)
    ...
    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IIIC)V", line = 170)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(III)V", line = 193)
    ...
    @OriginalMember(owner = "client!mj", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 204)
    ...
    @OriginalMember(owner = "client!mj", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 223)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field4919++;
        this.method2126(arg0, -1, 0);
    }

    @OriginalMember(owner = "client!mj", name = "b", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!mj", name = "d", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 324)
