...
public class class353 extends class62 {
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lwf;Ljava/lang/Object;I)V", line = 5)
    public class353(class107 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field4550 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!raa", name = "g", descriptor = "(I)Z", line = 14)
    public final boolean method398(int arg0) {
        return arg0 == 233 ? true : true;
    }

    @OriginalMember(owner = "client!raa", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 24)
