...
public class class353 extends class508 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILqa;B)Lc;")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ILeo;I)I")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
