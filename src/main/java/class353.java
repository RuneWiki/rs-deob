...
public class class353 extends class584 {
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lfo;Lie;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "g", descriptor = "(I)Lav;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILld;B)V")
