...
public class class353 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "([I)V", line = 27)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IB)I", line = 62)
