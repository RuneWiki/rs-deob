...
public class class353 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lw;ZJ)V", line = 6)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IJ)Lw;", line = 33)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZD)V", line = 137)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B)V", line = 164)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIZII)V", line = 175)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(I)V", line = 325)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;JIIZIIZZ)V", line = 238)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)V", line = 300)
