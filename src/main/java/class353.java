...
public class class353 extends class404 {
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLtca;ILtca;)V", line = 4)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IB)V", line = 168)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Ldia;)V", line = 182)
    public class353(class246 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)Z", line = 186)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)I", line = 223)
    ...
    @OriginalMember(owner = "client!bb", name = "j", descriptor = "(I)Z", line = 242)
    ...
    @OriginalMember(owner = "client!bb", name = "h", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Z)V", line = 273)
    ...
    @OriginalMember(owner = "client!bb", name = "i", descriptor = "(I)Z", line = 290)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(III)V", line = 307)
