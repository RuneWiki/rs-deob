...
public class class353 extends Canvas {
    ...
    @OriginalMember(owner = "client!fm", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 5)
    public final void paint(Graphics arg0) {
        field5231++;
        this.field5237.paint(arg0);
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!fm", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 32)
    public final void update(Graphics arg0) {
        field5235++;
        this.field5237.update(arg0);
    }

    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 75)
