...
public class class353 extends class694 implements class624 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILjava/lang/String;)J", line = 6)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lha;B)V", line = 50)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(ILha;)Lww;", line = 75)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lha;IIB)Z", line = 127)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLha;)Lck;", line = 147)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Z)V", line = 159)
    ...
    @OriginalMember(owner = "client!tu", name = "j", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "([FI[III[FIIIIII[I)V", line = 184)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ILha;)V", line = 272)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(III)I", line = 285)
    ...
    @OriginalMember(owner = "client!tu", name = "h", descriptor = "(I)I", line = 299)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(I)Z", line = 310)
    ...
    @OriginalMember(owner = "client!tu", name = "g", descriptor = "(B)Z", line = 323)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(B)I", line = 333)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(Z)Z", line = 344)
    ...
    @OriginalMember(owner = "client!tu", name = "<init>", descriptor = "(Lha;Lqfa;IIIIIZIIIII)V", line = 355)
    ...
    @OriginalMember(owner = "client!tu", name = "c", descriptor = "(B)I", line = 366)
    ...
    @OriginalMember(owner = "client!tu", name = "e", descriptor = "(B)I", line = 377)
    ...
    @OriginalMember(owner = "client!tu", name = "b", descriptor = "(B)I", line = 391)
    public final int method1752(byte arg0) {
        ++field4971;
        return arg0 != -111 ? 54 : this.field4975.field2437;
    }

    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(ZLha;)V", line = 403)
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLbk;)V", line = 419)
