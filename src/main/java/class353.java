...
public class class353 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(III)Z", line = 80)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(Z)V", line = 966)
    ...
    @OriginalMember(owner = "client!raa", name = "b", descriptor = "(B)V", line = 976)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(II)Lor;", line = 1093)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lip;I)Ljava/lang/String;", line = 1121)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Lmp;ILla;Lla;)V", line = 1151)
