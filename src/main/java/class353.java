...
public class class353 implements Runnable {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/String;I)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILjava/awt/Frame;)Lbca;")
    public final class286 method2155(int arg0, Frame arg1) {
        int var3 = -106 / (-arg0 / 63);
        return this.method2180(-1, arg1, 0, 0, 7);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IBLjava/lang/Runnable;)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(B)Lbca;")
    public final class286 method2160(byte arg0) {
        int var2 = -80 % ((arg0 + 65) / 55);
        return this.method2180(-1, null, 0, 0, 5);
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIIZLjava/lang/Object;)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIBII)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/awt/Component;IZ)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/String;BI)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/Class;Ljava/lang/String;I)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/net/URL;I)Lbca;")
    public final class286 method2167(URL arg0, int arg1) {
        int var3 = -63 % (-arg1 / 36);
        return this.method2180(-1, arg0, 0, 0, 4);
    }

    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)Lap;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "([ILjava/awt/Point;IILjava/awt/Component;B)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(I)Lbca;")
    public final class286 method2173(int arg0) {
        return arg0 == -30551 ? this.method2180(arg0 ^ 0x7756, null, 0, 0, 18) : null;
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IBILjava/awt/Component;)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/String;IZ)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILjava/lang/Object;III)Lbca;")
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(Ljava/lang/String;I)Lbca;")
