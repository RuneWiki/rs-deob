...
public abstract class class353 {
    ...
    @OriginalMember(owner = "client!kq", name = "finalize", descriptor = "()V", line = 4)
    protected final void finalize() throws Throwable {
        this.field4981.method965(this.field4979, this.field4983);
        super.finalize();
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "([BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "()I", line = 32)
    public int method461() {
        return this.field4979;
    }

    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lao;I[BIZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lao;ILjava/nio/ByteBuffer;Z)V", line = 54)
