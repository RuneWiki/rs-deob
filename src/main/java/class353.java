...
public class class353 implements class436 {
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIILhp;)V", line = 44)
    ...
    @OriginalMember(owner = "client!fs", name = "finalize", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZ)V", line = 91)
    ...
    @OriginalMember(owner = "client!fs", name = "e", descriptor = "(I)Z", line = 112)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(III)V", line = 144)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLhp;I)V", line = 156)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IBLcm;)V", line = 167)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IILoj;I)V", line = 216)
    public final void method2147(int arg0, int arg1, class498 arg2, int arg3) {
        field5031++;
        this.method2152(arg0, arg2, (byte) 58, arg3, arg1);
    }

    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(II)V", line = 225)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!fs", name = "f", descriptor = "(I)Z", line = 258)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ILoj;BII)V", line = 330)
    ...
    @OriginalMember(owner = "client!fs", name = "d", descriptor = "(B)V", line = 363)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Ljj;)V", line = 413)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Z)I", line = 381)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(B)V", line = 401)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(I)V", line = 426)
