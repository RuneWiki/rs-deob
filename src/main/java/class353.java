...
public class class353 extends class398 implements class240 {
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "()[Lng;")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lqb;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lc;Lqb;II)V")
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "()[Ldh;")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lqa;Lna;Lio;IIII)V")
