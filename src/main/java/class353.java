...
public class class353 extends class163 {
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(I)V", line = 8)
    public class353(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(FB)V", line = 14)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIZII)V", line = 29)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IF)V", line = 303)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILib;)Lfha;", line = 320)
    ...
    @OriginalMember(owner = "client!jo", name = "w", descriptor = "(I)V", line = 330)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(ILib;)Luq;", line = 349)
