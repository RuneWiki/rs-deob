...
public class class353 extends class383 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(II)Lbe;", line = 4)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "([I[BBLjj;)Z", line = 41)
    ...
    @OriginalMember(owner = "client!mq", name = "b", descriptor = "(Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "()V", line = 133)
    public class353() {
    }

    @OriginalMember(owner = "client!mq", name = "<init>", descriptor = "([B)V", line = 135)
