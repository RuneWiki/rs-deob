...
public class class479 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)Lnb;")
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(ZLnb;)V")
    ...
    @OriginalMember(owner = "client!du", name = "c", descriptor = "(I)Lnb;")
    ...
    @OriginalMember(owner = "client!du", name = "d", descriptor = "(I)Lnb;")
    ...
    @OriginalMember(owner = "client!du", name = "f", descriptor = "(I)Lnb;")
