...
public class class479 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIB)V", line = 6)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IB)Lff;", line = 24)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IZ)V", line = 69)
