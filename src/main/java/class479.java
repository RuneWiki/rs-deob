...
public class class479 extends class535 {
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(II)Lob;")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILwn;I)V")
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILqa;IBIII)Lka;")
