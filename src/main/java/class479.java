...
public class class479 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lkj;IIIII)Ljava/awt/Frame;", line = 100)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)V", line = 170)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IB)V", line = 195)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(II)Lef;", line = 226)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Llf;IZLvh;Lvh;)V", line = 277)
