...
public class class479 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(JZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(ILsv;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BI)V", line = 143)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(BLsv;)V", line = 234)
