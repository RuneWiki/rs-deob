...
public class class479 extends class152 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!lt", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 17)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method2880(0, false, arg0);
        field6906++;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 27)
    ...
    @OriginalMember(owner = "client!lt", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 51)
    public final synchronized void focusLost(FocusEvent arg0) {
        field6899++;
        this.method2882(0, 0, -1, '\u0000');
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(I)Lup;", line = 60)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IZLjava/awt/event/KeyEvent;)V", line = 84)
    ...
    @OriginalMember(owner = "client!lt", name = "d", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!lt", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 225)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIIC)V", line = 239)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BIZ)V", line = 261)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 296)
    public class479(Component arg0) {
        class17.method143(42);
        this.method2879(0, arg0);
    }

    @OriginalMember(owner = "client!lt", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 281)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field6910++;
        this.method2880(1, false, arg0);
    }

    @OriginalMember(owner = "client!lt", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 289)
