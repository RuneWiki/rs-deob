...
public class class479 extends class702 {
    ...
    @OriginalMember(owner = "client!fo", name = "qa", descriptor = "(FFFFFFIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!fo", name = "E", descriptor = "()I", line = 74)
    public final int method1658() {
        field6611++;
        return this.field6588;
    }

    @OriginalMember(owner = "client!fo", name = "xa", descriptor = "(III)V", line = 84)
    public final void method939(int arg0, int arg1, int arg2) {
        field6595++;
    }

    @OriginalMember(owner = "client!fo", name = "u", descriptor = "()I", line = 92)
    public final int method1653() {
        field6607++;
        return this.field6615;
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!fo", name = "V", descriptor = "(IIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIII[III)V", line = 149)
    ...
    @OriginalMember(owner = "client!fo", name = "A", descriptor = "()I", line = 158)
    public final int method1660() {
        field6591++;
        return this.field6592 + this.field6588 + this.field6602;
    }

    @OriginalMember(owner = "client!fo", name = "DA", descriptor = "(IIIIIII)V", line = 171)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lnv;IIZ)V", line = 592)
    ...
    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lnv;II[III)V", line = 607)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IILua;II)V", line = 384)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(FFFFFFILua;II)V", line = 428)
    ...
    @OriginalMember(owner = "client!fo", name = "da", descriptor = "(IIIIII)V", line = 483)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(III)Z", line = 514)
    ...
    @OriginalMember(owner = "client!fo", name = "Q", descriptor = "(IIII)V", line = 525)
    ...
    @OriginalMember(owner = "client!fo", name = "ca", descriptor = "()I", line = 538)
    public final int method1661() {
        field6603++;
        return this.field6615 + this.field6598 + this.field6596;
    }

    @OriginalMember(owner = "client!fo", name = "YA", descriptor = "(IIIIIIII)V", line = 555)
