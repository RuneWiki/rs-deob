...
public class class479 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!ct", name = "toString", descriptor = "()Ljava/lang/String;", line = 24)
    public final String toString() {
        field6865++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ct", name = "a", descriptor = "([[[Lko;I)V", line = 32)
