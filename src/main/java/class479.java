...
public class class479 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lbh;B)Z")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lbh;I)Ltd;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IBLjava/lang/String;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Les;B)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IB)Lkq;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Les;II)V")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Laaa;IIIIBILha;Lgfa;[ILjf;ILbh;ILfs;I[Lhb;Lfs;)Lka;")
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lbh;Lgfa;ILaaa;ILha;Lfs;III)Lka;")
