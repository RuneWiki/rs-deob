...
public class class479 {
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(BI)Lsh;")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILcea;I)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lcea;B)V")
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(Lga;[Lab;)V")
