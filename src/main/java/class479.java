...
public class class479 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)J", line = 20)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IBI[B)V", line = 37)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(B)Ljava/io/File;", line = 55)
    public final File method2606(byte arg0) {
        field6363++;
        return arg0 >= -112 ? null : this.field6362;
    }

    @OriginalMember(owner = "client!cu", name = "finalize", descriptor = "()V", line = 66)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I[BII)I", line = 82)
    ...
    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(JI)V", line = 128)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIB)I", line = 144)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 158)
