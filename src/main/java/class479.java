...
public class class479 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(I)V", line = 27)
    public final void method2884(int arg0) {
        field6812++;
        this.field6814.method834(5, arg0);
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "([SI)[S", line = 35)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)Ljb;", line = 81)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lcb;Ln;)V", line = 131)
    public class479(class444 arg0, class17 arg1) {
        this.field6810 = arg1;
        this.field6805 = arg0;
    }

    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)V", line = 140)
