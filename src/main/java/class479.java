...
public class class479 extends class493 {
    ...
    @OriginalMember(owner = "client!iea", name = "h", descriptor = "(I)V", line = 8)
    public static void method2688(int arg0) {
        int var1 = 45 % ((arg0 - 41) / 34);
        field6613 = null;
    }

    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!iea", name = "<init>", descriptor = "(Luv;)V", line = 30)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 140)
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(IZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IZ)V", line = 203)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(IILbl;)V", line = 214)
    ...
    @OriginalMember(owner = "client!iea", name = "c", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(III)V", line = 267)
    ...
    @OriginalMember(owner = "client!iea", name = "b", descriptor = "(B)Z", line = 286)
    ...
    @OriginalMember(owner = "client!iea", name = "a", descriptor = "(ILjava/lang/String;)V", line = 299)
