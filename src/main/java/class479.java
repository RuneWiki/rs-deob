...
public class class479 extends class241 implements class269 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BZLjava/awt/Component;)Lpp;")
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(ILqa;)Lso;")
    public final class398 method328(int arg0, class206 arg1) {
        ++field6724;
        return arg0 != 12 ? null : this.field6735;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZLoe;ILqa;III)V")
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(ILqa;)Loj;")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III)Lig;")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lqa;Lcn;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILqa;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
