...
public class class479 extends class641 implements class532 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Loa;I)V")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BLoa;)Lpe;")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILoa;ILni;ZZI)V")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(ILoa;)Ldd;")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Loa;Z)V")
    ...
    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Loa;Lbd;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Loa;BI)Lba;")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(BILoa;I)Z")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Loa;B)V")
