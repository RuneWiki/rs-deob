...
public class class479 extends InputStream {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!gaa", name = "read", descriptor = "()I", line = 23)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Z)V", line = 32)
