...
public class class479 {
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Lji;B)Lqi;", line = 15)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "([FIIBIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(I)V", line = 129)
