...
public class class479 extends class334 {
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(ILgk;)Llea;", line = 14)
    ...
    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(IIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!vda", name = "<init>", descriptor = "(IIIIIF)V", line = 59)
    public class479(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!vda", name = "a", descriptor = "(FB)V", line = 65)
