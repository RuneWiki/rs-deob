...
public class class479 extends class96 implements class395 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!ip", name = "e", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ip", name = "finalize", descriptor = "()V", line = 52)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILeq;Lhe;Lhe;)V", line = 79)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lrl;III)V", line = 104)
    ...
    @OriginalMember(owner = "client!ip", name = "<init>", descriptor = "(Lrl;IIII)V", line = 119)
