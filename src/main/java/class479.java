...
public class class479 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ZILeea;[IIIII)Lll;", line = 40)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!eu", name = "b", descriptor = "(B)J", line = 78)
