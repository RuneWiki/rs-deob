...
public class class479 implements class695 {
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(III)I", line = 15)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Loa;Lpj;I)V", line = 30)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)Lhs;", line = 194)
    public class295 method52(int arg0) {
        field6688++;
        return arg0 == -14151 ? class238.field3435 : null;
    }

    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "(ILfw;Ldg;II)V", line = 210)
