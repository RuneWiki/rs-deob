...
public class class479 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IIIIIIZI)V", line = 60)
