...
public class class479 extends class551 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!ff", name = "g", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(IIIIZIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(BI)I", line = 86)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "([B)V", line = 108)
