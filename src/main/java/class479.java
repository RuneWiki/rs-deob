...
public class class479 extends class429 {
    ...
    @OriginalMember(owner = "client!rca", name = "b", descriptor = "(I)Liv;")
    ...
    @OriginalMember(owner = "client!rca", name = "c", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Llf;IIIIII)V")
