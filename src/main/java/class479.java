...
public class class479 {
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(IIILwh;[BIZI)Liba;")
    ...
    @OriginalMember(owner = "client!lia", name = "a", descriptor = "(Loi;III)Lru;")
    ...
    @OriginalMember(owner = "client!lia", name = "<init>", descriptor = "(IIIIIIIIIZZI)V")
