...
public class class479 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ZIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)Lbs;", line = 30)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lnq;ILga;)V", line = 110)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BI)V", line = 134)
    ...
    @OriginalMember(owner = "client!bj", name = "c", descriptor = "(I)V", line = 148)
