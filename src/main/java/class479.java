...
public class class479 {
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "([BB)V", line = 9)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZZ)Z", line = 182)
    public static boolean method2833(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IZZIIII)V", line = 197)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "([BI)V", line = 251)
