...
public class class479 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(II)S", line = 17)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZI)Lsj;", line = 88)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)I", line = 121)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)I", line = 141)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "()V", line = 313)
    private class479() {
    }

    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "([I)V", line = 315)
