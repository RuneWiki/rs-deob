...
public class class479 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(II)Lgt;", line = 10)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IB)V", line = 92)
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!lw", name = "<init>", descriptor = "(Lle;ILoi;)V", line = 127)
    public class479(class205 arg0, int arg1, class53 arg2) {
        this.field6680 = arg2;
        this.field6680.method435(26, 0);
    }

    @OriginalMember(owner = "client!lw", name = "d", descriptor = "(B)V", line = 146)
