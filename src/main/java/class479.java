...
public class class479 extends class33 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(I)[B", line = 6)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "([BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(III)[B", line = 36)
