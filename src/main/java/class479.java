...
public class class479 {
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(Lee;)V", line = 7)
    ...
    @OriginalMember(owner = "client!qq", name = "b", descriptor = "(Lee;)V", line = 25)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "()V", line = 32)
    ...
    @OriginalMember(owner = "client!qq", name = "a", descriptor = "(I)I", line = 40)
    ...
    @OriginalMember(owner = "client!qq", name = "<init>", descriptor = "()V", line = 56)
    public class479() {
        this.field6568[0] = 0;
