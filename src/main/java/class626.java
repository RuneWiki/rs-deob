...
public class class626 extends class297 {
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIIZIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)[[I", line = 69)
