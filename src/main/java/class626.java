...
public abstract class class626 implements class367 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(Lnfa;IZ)V")
