...
public class class626 {
    ...
    @OriginalMember(owner = "client!fba", name = "b", descriptor = "(I)Lgda;", line = 18)
    ...
    @OriginalMember(owner = "client!fba", name = "a", descriptor = "(IZII)Lfba;", line = 33)
    ...
    @OriginalMember(owner = "client!fba", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!fba", name = "<init>", descriptor = "(IIIIB)V", line = 78)
