...
public class class626 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lcd;I)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)Lcq;")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Loda;ILdda;)V")
