...
public class class626 extends class573 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II)I", line = 15)
    public static final int method3531(int arg0, int arg1) {
        return class352.field4941 == null ? 0 : class352.field4941[arg0][arg1] & 0xFF;
    }

    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "([Lls;)V", line = 18)
    public class626(class148[] arg0) {
        this.field8920 = arg0;
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIIIIB)V", line = 27)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(B)V", line = 56)
