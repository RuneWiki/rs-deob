...
public class class626 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(IIIIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)Liu;", line = 36)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILsda;)Luq;", line = 51)
    ...
    @OriginalMember(owner = "client!oo", name = "b", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Lfp;Lfp;)V", line = 113)
