...
public class class626 {
    ...
    @OriginalMember(owner = "client!eb", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)Z", line = 53)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lnw;ILnw;I)Lbja;", line = 79)
    ...
    @OriginalMember(owner = "client!eb", name = "c", descriptor = "(I)Z", line = 90)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BZILnw;Lnw;)Lbja;", line = 165)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Ltha;Laca;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 211)
