...
public class class626 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ZILe;Ljava/awt/Canvas;)Loa;", line = 94)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 109)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(II)Lsi;", line = 263)
