...
public class class626 extends class98 {
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lfo;[Lut;Z)Lla;")
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(IIIIII)Lrs;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Luo;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIIIIF)Ltg;")
    public final class334 method687(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lan;IIII)V")
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(IIIIZ)Lf;")
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Ljava/awt/Canvas;Lfa;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lq;)V")
    public final void method616(class151 arg0) {
        this.field9078 = (class121) arg0;
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lak;IIII)Lda;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II[I[I)Lua;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(II[[I[[IIII)Li;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Luo;I)V")
    ...
    @OriginalMember(owner = "client!st", name = "C", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!st", name = "FA", descriptor = "(ILua;II)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lut;Z)Lf;")
    ...
    @OriginalMember(owner = "client!st", name = "w", descriptor = "()Lpg;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I)Le;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Le;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lrs;)V")
    public final void method611(class649 arg0) {
    }

    @OriginalMember(owner = "client!st", name = "m", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lf;Z)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Lrs;Lrs;FLrs;)Lrs;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(I[Ltg;)V")
    ...
    @OriginalMember(owner = "client!st", name = "u", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lfa;)V")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "([IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(IIZ)Lf;")
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Ljava/lang/Runnable;)Lqb;")
