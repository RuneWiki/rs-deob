...
public class class626 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lda;IIIZLr;IBLq;)V", line = 138)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lr;ZZII)Lda;", line = 180)
    ...
    @OriginalMember(owner = "client!fb", name = "finalize", descriptor = "()V", line = 317)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BLr;)V", line = 328)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ILpn;)V", line = 341)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 440)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)I", line = 541)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(BLr;)V", line = 555)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)V", line = 574)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(I)I", line = 591)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(IIII)I", line = 602)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(III)Lpca;", line = 629)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(B)Z", line = 651)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Lr;Llr;IIIILpn;ZI)V", line = 703)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(II)V", line = 665)
