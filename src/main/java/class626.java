...
public class class626 extends class529 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IBLtn;)V")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IILd;BLha;II)V")
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(BLtn;)Lmfa;")
