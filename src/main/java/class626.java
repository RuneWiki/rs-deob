...
public class class626 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(I)V", line = 68)
    public final void method3524(int arg0) {
        field8726++;
        this.field8728.method265(arg0, -36);
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(II)Lgl;", line = 88)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 147)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Lsf;Ld;)V", line = 178)
