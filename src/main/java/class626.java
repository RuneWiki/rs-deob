...
public class class626 implements class519 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ZZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Ltga;Z)V")
