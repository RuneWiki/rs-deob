...
public class class626 {
    ...
    @OriginalMember(owner = "client!uj", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "(Lmr;J[Lsi;)V", line = 37)
    public class626(class221 arg0, long arg1, class141[] arg2) {
        this.field8844 = arg0;
        this.field8842 = arg1;
    }

    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ZII)V", line = 48)
