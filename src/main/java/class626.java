...
public class class626 {
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(JILha;)V", line = 7)
    ...
    @OriginalMember(owner = "client!md", name = "a", descriptor = "(B)V", line = 44)
    public static void method3526(byte arg0) {
        field8420 = null;
        int var1 = -36 % ((arg0 + 40) / 36);
    }

    @OriginalMember(owner = "client!md", name = "a", descriptor = "(Luu;I)V", line = 54)
