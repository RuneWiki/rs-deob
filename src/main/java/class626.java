...
public class class626 extends class324 implements class423 {
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lhg;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(ILie;)V")
