...
public class class626 implements Runnable {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I[BII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lda;)V", line = 28)
    public static final void method3580(class443 arg0) {
        class203.field3004 = arg0;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ed", name = "finalize", descriptor = "()V", line = 69)
    protected final void finalize() {
        this.method3581(-109);
        field8882++;
    }

    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Ljava/net/Socket;Lcea;I)V", line = 352)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZII[B)V", line = 102)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 172)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZLfm;)V", line = 196)
    ...
    @OriginalMember(owner = "client!ed", name = "run", descriptor = "()V", line = 224)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Z)I", line = 296)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(I)V", line = 311)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(Z)V", line = 330)
