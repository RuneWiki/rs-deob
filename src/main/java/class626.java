...
public class class626 extends class55 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "()V", line = 3)
    public final void method3602() {
        this.field8766 = true;
    }

    @OriginalMember(owner = "client!paa", name = "b", descriptor = "()Lof;", line = 6)
    public final class624 method3603() {
        return this.field8765;
    }

    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IZ)Lpaa;", line = 9)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "()V", line = 22)
    public final void method3605() {
        this.field8755 = true;
    }

    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;J[Lwr;[Lol;Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;[Lwr;Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIIII)V", line = 110)
    public final void method3608(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field8768 = arg0;
    }

    @OriginalMember(owner = "client!paa", name = "d", descriptor = "()V", line = 121)
    public static void method3609() {
        field8756 = null;
        field8762 = null;
    }

    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;)V", line = 126)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "([Lol;Z)V", line = 141)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class626(int arg0, boolean arg1) {
        this.method3612(arg0, arg1);
    }

    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(IZ)V", line = 234)
    ...
    @OriginalMember(owner = "client!paa", name = "e", descriptor = "()V", line = 247)
    ...
    @OriginalMember(owner = "client!paa", name = "f", descriptor = "()Lof;", line = 283)
    ...
    @OriginalMember(owner = "client!paa", name = "g", descriptor = "()V", line = 302)
    private final void method3615() {
        this.field8755 = false;
    }

    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;J)Z", line = 305)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(J)V", line = 357)
