...
public class class626 implements class144 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()V", line = 9)
    public final void method3436() {
        this.field8453 = Thread.currentThread();
        this.method3449();
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 13)
    public final void method3437() {
        this.field8453 = null;
        this.method3438();
    }

    @OriginalMember(owner = "client!t", name = "finalize", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lda;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lj;BIZ)Lba;", line = 55)
