...
public class class626 implements class107 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IB)I", line = 32)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "([Lud;ILjj;)Lvv;", line = 43)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZI)I", line = 138)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(III)V", line = 179)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(III)V", line = 203)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 235)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IBI)V", line = 246)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)I", line = 297)
