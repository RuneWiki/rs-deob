...
public class class626 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(B)[[[I", line = 29)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IZ)[[I", line = 54)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(III)V", line = 173)
