...
public class class626 extends class243 {
    ...
    @OriginalMember(owner = "client!oo", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!oo", name = "e", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!oo", name = "d", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(II)[I", line = 56)
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "()V", line = 370)
    public class626() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ILji;B)V", line = 275)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(ZLji;I)Ljava/lang/String;", line = 383)
