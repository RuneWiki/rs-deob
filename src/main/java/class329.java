...
public class class329 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IB)Lst;", line = 62)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(IB)V", line = 134)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lee;ILul;)V", line = 159)
