...
public abstract class class329 extends class28 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIB)B", line = 6)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B)F", line = 169)
    ...
    @OriginalMember(owner = "client!hj", name = "c", descriptor = "(B)I", line = 186)
    ...
    @OriginalMember(owner = "client!hj", name = "d", descriptor = "(B)I", line = 197)
    public final int method2115(byte arg0) {
        field4826++;
        return arg0 == -63 ? this.field4830 : 35;
    }

    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(IIIIIF)V", line = 214)
