...
public class class329 extends class540 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Z)[Lfda;", line = 3)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(IIII[F[IZII[FII[I)V", line = 30)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(Ljava/lang/String;ZLjava/lang/Throwable;)V", line = 120)
