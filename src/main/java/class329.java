...
public class class329 extends class481 implements class519 {
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Lvg;Lkf;III[B)V")
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    public final IDirect3DBaseTexture method130(int arg0) {
        return arg0 < 9 ? (IDirect3DBaseTexture) null : this.field4863;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLqaa;)V")
