...
public class class329 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILmc;I)V", line = 15)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIIII)I", line = 31)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(BI)V", line = 98)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lmc;B)V", line = 119)
