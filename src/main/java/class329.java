...
public class class329 extends class404 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Lsd;)V", line = 6)
    public final void method353(class233 arg0) {
    }

    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Lh;Lsh;)V", line = 8)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "()V", line = 16)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 79)
    public final void method349(boolean arg0) {
        this.field5606.method2056(260, 8448);
    }

    @OriginalMember(owner = "client!td", name = "b", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "()Z", line = 100)
    public final boolean method350() {
        return true;
    }

    @OriginalMember(owner = "client!td", name = "a", descriptor = "(I)V", line = 108)
