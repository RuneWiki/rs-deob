...
public class class329 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IB)Lsb;")
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lkp;ILph;)V")
