...
public class class329 extends class393 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZIII)Z", line = 6)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(III)V", line = 22)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BII)Z", line = 50)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([IIBI)V", line = 64)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BII[I)V", line = 96)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(BLqj;)V", line = 128)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(IIIIIIIII)V", line = 152)
