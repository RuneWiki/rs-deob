...
public class class329 implements class126 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(B)I", line = 44)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!hfa", name = "c", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(B)V", line = 95)
    public final void method902(byte arg0) {
        int var2 = 94 % ((arg0 - 37) / 38);
        field4752++;
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ILgk;)Lsm;", line = 104)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(II)I", line = 142)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;", line = 156)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Z)V", line = 172)
    ...
    @OriginalMember(owner = "client!hfa", name = "b", descriptor = "(II)I", line = 194)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(Ljava/lang/Object;Ljava/lang/String;ILjava/lang/Class;)I", line = 211)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "()V", line = 226)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZZ)V", line = 399)
    ...
    @OriginalMember(owner = "client!hfa", name = "d", descriptor = "(B)V", line = 588)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(IIZ)I", line = 600)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZJ)Z", line = 627)
    public final boolean method904(boolean arg0, long arg1) {
        field4787++;
        return arg0 ? true : true;
    }

    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(ZII)Z", line = 638)
    ...
    @OriginalMember(owner = "client!hfa", name = "a", descriptor = "(BLjava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)Z", line = 653)
