...
public class class329 extends class93 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Lpp;B)V", line = 10)
    ...
    @OriginalMember(owner = "client!kka", name = "<init>", descriptor = "(I)V", line = 21)
    public class329(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kka", name = "p", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!kka", name = "s", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!kka", name = "f", descriptor = "(IB)I", line = 67)
    ...
    @OriginalMember(owner = "client!kka", name = "t", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!kka", name = "e", descriptor = "(Z)Z", line = 89)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(I[BBI)V", line = 107)
    ...
    @OriginalMember(owner = "client!kka", name = "q", descriptor = "(II)I", line = 126)
    ...
    @OriginalMember(owner = "client!kka", name = "p", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Z[I)V", line = 169)
    ...
    @OriginalMember(owner = "client!kka", name = "f", descriptor = "(Z)V", line = 188)
