...
public class class329 extends class440 {
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lqg;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lqg;II)V")
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Lqg;IIZ[[I)V")
