...
public class class329 extends class167 implements class439 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Llh;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Lm;[Lgr;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Loaa;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIII)Llh;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lbt;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(IIIIIF)Lat;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(I[Lat;)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Loaa;Z)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "([Lr;Loaa;Lm;[Lgr;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Llh;Llh;FLlh;)Llh;")
    public final class125 method332(class125 arg0, class125 arg1, float arg2, class125 arg3) {
        return null;
    }

    @OriginalMember(owner = "client!a", name = "e", descriptor = "(I)Lu;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "()Lrr;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Ldd;[Lqr;Z)Lra;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lqr;Z)Lha;")
