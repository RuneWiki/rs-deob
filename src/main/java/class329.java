...
public class class329 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Lae;B)V")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(B)Lt;")
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(IB)Lvr;")
