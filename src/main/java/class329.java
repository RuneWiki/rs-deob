...
public class class329 extends class34 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lat;Lat;I)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ILws;)V")
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lsv;II)V")
