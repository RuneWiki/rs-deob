...
public class class329 extends class330 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III)V", line = 47)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lar;I)V", line = 64)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(II)V", line = 87)
