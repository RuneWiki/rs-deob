...
public class class329 extends class281 {
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(III)I", line = 5)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Z)V", line = 32)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(II[Lor;)V", line = 43)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljp;I)V", line = 113)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(ILjp;I)V", line = 137)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(BLaj;)V", line = 181)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(ILjava/lang/String;I)Ljava/lang/String;", line = 200)
