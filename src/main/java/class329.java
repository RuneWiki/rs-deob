...
public class class329 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZZ)Z", line = 3)
    public static boolean method2016(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!en", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 16)
    public class329(Throwable arg0, String arg1) {
        this.field4927 = arg1;
        this.field4928 = arg0;
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 25)
