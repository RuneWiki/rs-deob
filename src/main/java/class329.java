...
public class class329 extends class152 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!kka", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!kka", name = "d", descriptor = "(I)J", line = 81)
    ...
    @OriginalMember(owner = "client!kka", name = "<init>", descriptor = "([[SD)V", line = 94)
    public class329(short[][] arg0, double arg1) {
        this.field4064 = arg0;
        this.field4070 = arg1;
    }

    @OriginalMember(owner = "client!kka", name = "g", descriptor = "(I)Luea;", line = 103)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(III)V", line = 114)
