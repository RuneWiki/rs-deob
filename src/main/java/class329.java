...
public class class329 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 10)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "()V", line = 39)
    public class329() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lsl;[BI)V", line = 56)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "([BI)[B", line = 81)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLbi;)V", line = 103)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(III)V", line = 145)
