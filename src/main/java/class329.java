...
public class class329 extends class262 {
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lc;Ljava/lang/Object;)V", line = 5)
    public class329(class100 arg0, Object arg1) {
        super(arg0);
        this.field4478 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!fs", name = "f", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!fs", name = "e", descriptor = "(B)Ljava/lang/Object;", line = 24)
