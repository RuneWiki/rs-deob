...
public class class329 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(III)Z", line = 116)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 128)
