...
public class class329 extends class649 {
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lhs;)V")
    public class329(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(ILhs;)V")
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Llw;I)I")
