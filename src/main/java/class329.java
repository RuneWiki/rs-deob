...
public class class329 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(II)Liu;")
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(IZ)Lhi;")
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Lgt;ILdn;Ldn;Ldn;)V")
