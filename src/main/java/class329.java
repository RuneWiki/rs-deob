...
public class class329 extends class375 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lfa;Lpu;IZIDIZ)[I")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lfa;DLpu;ZIBI)[I")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lrga;IIIII)V")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lpu;Lfa;B)Z")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILfa;Lpu;ZI)[F")
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "(Lmo;)V")
