...
public class class329 extends class166 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IB)Z", line = 146)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 157)
