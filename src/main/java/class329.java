...
public class class329 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(IB)Z", line = 6)
    public final boolean method1884(int arg0, byte arg1) {
        int var3 = -32 % ((-arg1 - 16) / 49);
        return this.field4390[arg0].method74();
    }

    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lna;B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZIZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!ih", name = "<init>", descriptor = "(Lql;)V", line = 101)
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ZIZ)V", line = 84)
