...
public class class329 extends class381 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ILbi;)Z", line = 11)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!el", name = "d", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(ZLpe;IBIILwe;Lqi;II)Lsj;", line = 92)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IZIILsb;)V", line = 325)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II)V", line = 488)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Z)V", line = 518)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIBII)V", line = 531)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIIII)V", line = 560)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "([I[IZII)J", line = 587)
