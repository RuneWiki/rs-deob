...
public class class329 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IB)Luo;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lha;IIIIIILah;)Lpga;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILah;IILda;IZLha;Lha;IIZ)Lpga;")
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lqg;IZLkw;Lvd;Lvd;)V")
