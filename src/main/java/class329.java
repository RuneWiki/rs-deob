...
public class class329 extends class398 {
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(ILwm;)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(Lnj;II)V")
    ...
    @OriginalMember(owner = "client!ih", name = "a", descriptor = "(BI)Lge;")
