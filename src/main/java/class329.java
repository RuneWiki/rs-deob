...
public class class329 extends class365 {
    ...
    @OriginalMember(owner = "client!lq", name = "d", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lq", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!lq", name = "c", descriptor = "(B)V", line = 29)
