...
public class class329 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(JBLdg;)V", line = 19)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(JI)Ldg;", line = 49)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(JZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(I)V", line = 124)
