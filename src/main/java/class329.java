...
public class class329 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)Llba;")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lll;I)Z")
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ILol;)Lbb;")
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(Lmj;Ld;)V")
