...
public class class329 extends class262 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Ljava/io/File;II)[B", line = 4)
    ...
    @OriginalMember(owner = "client!oq", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!oq", name = "c", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(I)Z", line = 67)
    public final boolean method375(int arg0) {
        ++field4380;
        return arg0 != -18095 ? true : this.field4381.method1670(false);
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ILoa;B)V", line = 78)
    ...
    @OriginalMember(owner = "client!oq", name = "h", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IZ)V", line = 147)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Lifa;Lvt;)V", line = 166)
    public class329(class393 arg0, class276 arg1) {
        super(arg0);
        this.field4381 = arg1;
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZI)V", line = 174)
