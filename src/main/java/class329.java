...
public class class329 extends class362 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "([I)Lob;")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lin;)Z")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lin;I)Lhp;")
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lin;II)Lhp;")
