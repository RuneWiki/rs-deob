...
public abstract class class329 extends class69 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IJI)Ljava/lang/String;", line = 29)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(CI)Z", line = 51)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 122)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 133)
