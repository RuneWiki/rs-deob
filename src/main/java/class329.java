...
public class class329 extends class365 {
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Lbc;Ljava/lang/Object;)V", line = 3)
    public class329(class103 arg0, Object arg1) {
        super(arg0);
        this.field4854 = arg1;
    }

    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIII)Z", line = 15)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IB)V", line = 36)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 62)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(B)Z", line = 80)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZLob;Lob;)V", line = 91)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)I", line = 125)
