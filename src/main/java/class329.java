...
public class class329 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BZLoa;I)Lxa;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Lrr;Z)Lrr;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(Lji;B)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILji;B)V")
