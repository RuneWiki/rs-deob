...
public class class329 extends class106 implements class194 {
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Z)I", line = 23)
    public final int method591(boolean arg0) {
        ++field4454;
        return !arg0 ? -64 : 0;
    }

    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)I", line = 34)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I[BII)V", line = 46)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Llj;ILjaclib/memory/Buffer;)V", line = 59)
    public class329(class565 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field4451 = arg1;
    }

    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IIIBI)V", line = 68)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)J", line = 144)
    ...
    @OriginalMember(owner = "client!vh", name = "d", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!vh", name = "<init>", descriptor = "(Llj;I[BI)V", line = 181)
