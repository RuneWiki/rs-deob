...
public class class329 {
    ...
    @OriginalMember(owner = "client!d", name = "d", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!d", name = "e", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!d", name = "f", descriptor = "(I)[I", line = 40)
    ...
    @OriginalMember(owner = "client!d", name = "g", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!d", name = "h", descriptor = "(I)V", line = 68)
