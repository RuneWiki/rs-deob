...
public class class329 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)Lsr;")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lsr;I)V")
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(I)Lsr;")
