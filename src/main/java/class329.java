...
public class class329 extends class666 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(I[BB)[B", line = 3)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(BCLjava/lang/String;)I", line = 18)
    ...
    @OriginalMember(owner = "client!rr", name = "<init>", descriptor = "()V", line = 46)
    public class329() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(II)[I", line = 67)
