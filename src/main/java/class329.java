...
public class class329 extends class227 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "()V", line = 52)
    public class329() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)[I", line = 55)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IZ)[[I", line = 103)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lug;II)V", line = 186)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ILvb;)V", line = 234)
