...
public class class265 extends class667 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lud;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIIIII)I", line = 31)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "()V", line = 99)
    public class265() {
        this(4096);
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BI)[I", line = 102)
