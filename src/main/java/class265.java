...
public class class265 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IB)V", line = 41)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lmca;ILgga;)V", line = 128)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)Lwg;", line = 99)
