...
public class class265 extends class752 implements class722 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(Lha;I)Lbd;")
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLha;)Loia;")
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lha;Lvha;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ILha;BI)Z")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IBLha;Z)Lsfa;")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lgg;BZILha;II)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lha;I)V")
