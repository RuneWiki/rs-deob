...
public class class265 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)Lpp;")
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(I)Lpp;")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BI)Lbaa;")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILpp;)V")
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BLpp;)V")
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)Lpp;")
    ...
    @OriginalMember(owner = "client!je", name = "d", descriptor = "(B)Lpp;")
