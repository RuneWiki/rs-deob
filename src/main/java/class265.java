...
public class class265 implements class485 {
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(II)I", line = 56)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(B)V", line = 107)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ZB)I", line = 123)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 161)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BI)I", line = 199)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(BII)V", line = 212)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(I)V", line = 240)
