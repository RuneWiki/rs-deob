...
public class class265 {
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Ltb;[BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Ltb;Ljava/nio/ByteBuffer;)V", line = 18)
    public class265(class227 arg0, ByteBuffer arg1) {
        this.field3689 = arg0;
        this.field3690 = arg1;
    }

    @OriginalMember(owner = "client!wr", name = "a", descriptor = "([BI)V", line = 27)
