...
public class class265 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lie;II)V")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IIZLr;)Lf;")
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(ZLie;)V")
