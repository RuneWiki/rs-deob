...
public class class265 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Li;III[Z)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IC)C", line = 60)
