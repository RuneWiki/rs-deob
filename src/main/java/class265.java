...
public abstract class class265 implements class136 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljaggl/MapBuffer;I)Z")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljaggl/MapBuffer;ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljaclib/memory/Source;IZ)Z")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILmq;)I")
    ...
    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lkd;IZ)V")
