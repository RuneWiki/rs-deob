...
public class class265 extends class297 {
    ...
    @OriginalMember(owner = "client!oca", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!oca", name = "<init>", descriptor = "()V", line = 19)
    public class265() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oca", name = "c", descriptor = "(II)[I", line = 23)
    ...
    @OriginalMember(owner = "client!oca", name = "a", descriptor = "(Lcea;II)V", line = 110)
