...
public class class265 extends class71 {
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Law;[Lvc;)V")
    private class265(class67 arg0, class265[] arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Law;)V")
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Law;Lfd;IIII)V")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(BIZ)Lr;")
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Llf;[Lvc;)Lvc;")
