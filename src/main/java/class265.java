...
public class class265 {
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)Ldd;", line = 6)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILms;)V", line = 58)
    ...
    @OriginalMember(owner = "client!kr", name = "c", descriptor = "(I)Ldd;", line = 79)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(IIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILfi;)V", line = 113)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(ILnv;)V", line = 147)
    ...
    @OriginalMember(owner = "client!kr", name = "b", descriptor = "(IIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "()V", line = 274)
    public class265() {
    }

    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lnv;)V", line = 276)
