...
public class class265 extends class363 implements class231 {
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(Lqa;Ltk;IIIIZIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fn", name = "c", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lqa;B)V", line = 54)
    ...
    @OriginalMember(owner = "client!fn", name = "e", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BZILqa;IILcea;)V", line = 80)
    ...
    @OriginalMember(owner = "client!fn", name = "d", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!fn", name = "g", descriptor = "(I)Ljava/lang/String;", line = 166)
    ...
    @OriginalMember(owner = "client!fn", name = "d", descriptor = "(I)Z", line = 184)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BLqa;II)Z", line = 196)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(ILqa;)Lkm;", line = 220)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ZLqa;)V", line = 235)
    ...
    @OriginalMember(owner = "client!fn", name = "c", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(B)I", line = 279)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILqa;Z)Lr;", line = 290)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ZIILqa;)Lep;", line = 304)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILqa;)V", line = 335)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IBLqa;)Lr;", line = 365)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)I", line = 392)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Lqa;I)Lbi;", line = 403)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(IIZ)Z", line = 435)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z)Z", line = 447)
    ...
    @OriginalMember(owner = "client!fn", name = "b", descriptor = "(I)I", line = 460)
