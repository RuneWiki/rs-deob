...
public abstract class class265 extends class274 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BLjava/awt/Canvas;ILet;Lga;)Lya;", line = 35)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILiv;)Lob;", line = 48)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IIBIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(Z)V", line = 114)
