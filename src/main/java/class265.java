...
public class class265 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Lnha;BLnha;I)Ljba;")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ZILnha;Lnha;B)Ljba;")
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Ljh;Ljg;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
