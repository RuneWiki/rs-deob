...
public class class265 extends class264 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)Lkp;", line = 10)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(IZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILuq;)V", line = 94)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(Lia;Z)Ljava/lang/String;", line = 129)
    ...
    @OriginalMember(owner = "client!hn", name = "d", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(II)V", line = 165)
    ...
    @OriginalMember(owner = "client!hn", name = "e", descriptor = "(I)V", line = 181)
