...
public class class265 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIZ)I", line = 16)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIZ)Z", line = 56)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)Z", line = 70)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)Lkb;", line = 95)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIILjq;II)Lmh;", line = 126)
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(II)Lnp;", line = 158)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILdk;Ldk;Ldk;Ldk;)V", line = 185)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Lad;ILdk;)V", line = 230)
