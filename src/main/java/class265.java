...
public class class265 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Ll;IB[I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Ljava/lang/String;B)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(III)V", line = 172)
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(Llia;)V", line = 190)
