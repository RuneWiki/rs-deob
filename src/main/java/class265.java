...
public class class265 extends class28 {
    ...
    @OriginalMember(owner = "client!cd", name = "e", descriptor = "()V", line = 6)
    public static void method1748() {
        field3751 = null;
    }

    @OriginalMember(owner = "client!cd", name = "c", descriptor = "()V", line = 9)
    public final void method44() {
        field3751.method2421(this.field3750, super.field304);
    }

    @OriginalMember(owner = "client!cd", name = "d", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!cd", name = "d", descriptor = "()V", line = 18)
    public final void method40() {
        field3751.method2416(this.field3750, -128);
    }

    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 21)
    ...
    @OriginalMember(owner = "client!cd", name = "b", descriptor = "()V", line = 25)
    public final void method45() {
        field3751.method2417((byte) -97, this.field3750);
    }

    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(Ltq;I)V", line = 28)
