...
public class class265 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BLjp;)Lcea;")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lvw;)V")
