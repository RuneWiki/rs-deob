...
public class class265 extends class227 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lug;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(II)[I", line = 49)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "()V", line = 184)
    public class265() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IZ)[[I", line = 95)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(FFFII)F", line = 159)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "([[II)V", line = 171)
