...
public class class265 extends class117 {
    ...
    @OriginalMember(owner = "client!ba", name = "f", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(ZILwj;Lwj;ZII)I", line = 27)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Z)I", line = 60)
    ...
    @OriginalMember(owner = "client!ba", name = "g", descriptor = "(I)J", line = 71)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(Lms;BZ)V", line = 83)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!ba", name = "h", descriptor = "(I)I", line = 128)
    ...
    @OriginalMember(owner = "client!ba", name = "i", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!ba", name = "<init>", descriptor = "(II)V", line = 153)
