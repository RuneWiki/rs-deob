...
public class class265 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IILjava/lang/String;Ljava/awt/Color;Ljava/awt/Color;ZLjava/awt/Color;)V", line = 12)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIIIIIIIILba;I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(BLjava/awt/Frame;Lwd;)V", line = 362)
