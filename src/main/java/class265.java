...
public class class265 extends class154 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ZLfca;)V", line = 21)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 91)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IILgj;)Lnf;", line = 115)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(I[IIIIIII)V", line = 139)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IB)V", line = 247)
    ...
    @OriginalMember(owner = "client!gca", name = "<init>", descriptor = "(Lfca;)V", line = 340)
    public class265(class93 arg0) {
        this.method1728(false, arg0);
    }

    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILica;)V", line = 289)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(ILjava/lang/String;)[B", line = 308)
