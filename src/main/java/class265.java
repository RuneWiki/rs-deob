...
public class class265 extends class529 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILjo;)I", line = 6)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IBLtn;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)[[I", line = 64)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 128)
