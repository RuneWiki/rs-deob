...
public class class265 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(IBIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Luk;I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZLufa;)Ldn;", line = 115)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(II)I", line = 126)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!uk", name = "b", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ZZI)Ljs;", line = 237)
