...
public class class265 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(IIIBIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(BII)Z", line = 74)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(BI)Lpg;", line = 91)
