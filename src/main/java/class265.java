...
public class class265 extends class39 {
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(III)I", line = 8)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!kf", name = "f", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(IIII)[B", line = 53)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IIIIB)V", line = 66)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "()V", line = 94)
    public class265() {
