...
public class class265 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IC)Z", line = 23)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(Lfu;B)V", line = 36)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)Lfu;", line = 59)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)V", line = 70)
    public static final void method1764(int arg0, int arg1) {
        field3872++;
        class65.field974 = arg0 / arg1;
    }

    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(I)V", line = 95)
    public class265(int arg0) {
        this.field3878 = arg0;
    }

    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(IIIIII)V", line = 102)
