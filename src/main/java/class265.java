...
public class class265 extends class49 implements class720 {
    ...
    @OriginalMember(owner = "client!kk", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!kk", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!kk", name = "h", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IBI)V", line = 44)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lpq;III)V", line = 87)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lpq;IIII)V", line = 102)
