...
public class class265 extends class540 {
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(BIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!fga", name = "b", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "([IBII)V", line = 204)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(III[I)V", line = 216)
    ...
    @OriginalMember(owner = "client!fga", name = "a", descriptor = "(B)V", line = 248)
    ...
    @OriginalMember(owner = "client!fga", name = "<init>", descriptor = "(IIIIIIIII)V", line = 260)
