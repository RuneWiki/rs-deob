...
public class class265 extends class159 {
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(ILjava/lang/Object;Lec;)V")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(BLqba;)I")
    ...
    @OriginalMember(owner = "client!ae", name = "a", descriptor = "(Laf;II)Z")
    ...
    @OriginalMember(owner = "client!ae", name = "<init>", descriptor = "(Lsu;)V")
