...
public class class265 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IBILvi;Ldr;)V")
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BI)Lti;")
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(ILok;Lok;)V")
