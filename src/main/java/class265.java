...
public class class265 extends class14 {
    ...
    @OriginalMember(owner = "client!fu", name = "d", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IBLmd;)V", line = 21)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IB)[I", line = 47)
    ...
    @OriginalMember(owner = "client!fu", name = "e", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(B)V", line = 269)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "()V", line = 314)
    public class265() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fu", name = "e", descriptor = "(B)Lii;", line = 300)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(IB)[I", line = 317)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B[B)[B", line = 336)
    ...
    @OriginalMember(owner = "client!fu", name = "f", descriptor = "(I)V", line = 404)
