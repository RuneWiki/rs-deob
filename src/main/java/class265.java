...
public class class265 extends class197 {
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILak;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ZLbl;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lza;III)Z")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(Lza;II)Z")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(ILnk;)V")
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IILza;IILvl;Z)V")
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(ILza;)Lsr;")
