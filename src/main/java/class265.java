...
public class class265 extends class573 {
    ...
    @OriginalMember(owner = "client!mb", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lr;III[Z)Z", line = 61)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B[[F[[S)[[S", line = 100)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(III)V", line = 128)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lrv;)V", line = 203)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(B)V", line = 313)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(Z)V", line = 324)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZI)V", line = 388)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(Z)V", line = 399)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lwc;IB)V", line = 473)
