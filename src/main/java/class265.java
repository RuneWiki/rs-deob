...
public class class265 extends class47 {
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lwa;)V")
    public class265(class222 arg0) {
        this.field3817 = arg0;
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lup;III)V")
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lis;B)V")
    ...
    @OriginalMember(owner = "client!gs", name = "d", descriptor = "(B)V")
