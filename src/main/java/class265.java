...
public class class265 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILdp;IB)Leb;", line = 64)
