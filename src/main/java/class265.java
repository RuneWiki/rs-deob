...
public class class265 extends class384 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)Lvaa;", line = 4)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(Llk;Lvea;IIIIIIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 33)
