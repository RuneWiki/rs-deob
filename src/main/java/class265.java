...
public class class265 extends class8 {
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)J", line = 5)
    ...
    @OriginalMember(owner = "client!cw", name = "d", descriptor = "(B)I", line = 16)
    public final int method55(byte arg0) {
        field3632++;
        return arg0 == 71 ? 0 : -54;
    }

    @OriginalMember(owner = "client!cw", name = "f", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ZLdga;)Lvm;", line = 42)
    ...
    @OriginalMember(owner = "client!cw", name = "e", descriptor = "(B)I", line = 90)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(B)I", line = 122)
