...
public class class265 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ZI)Lg;", line = 15)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IIIBIIZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Lrk;I)V", line = 70)
