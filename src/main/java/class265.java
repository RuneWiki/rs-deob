...
public abstract class class265 extends class452 {
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ba", name = "a", descriptor = "(IBI)Z", line = 15)
    ...
    @OriginalMember(owner = "client!ba", name = "b", descriptor = "(B)Lbn;", line = 26)
