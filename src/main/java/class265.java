...
public class class265 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)Lgq;", line = 38)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BI)V", line = 84)
    ...
    @OriginalMember(owner = "client!kf", name = "c", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!kf", name = "b", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Ldt;ILwia;Ljia;)V", line = 132)
