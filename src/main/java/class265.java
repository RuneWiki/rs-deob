...
public class class265 extends class260 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "([BI)Leh;", line = 43)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(IIIIIZ)V", line = 123)
