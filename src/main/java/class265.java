...
public class class265 extends class40 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "()V", line = 70)
    public class265() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wr", name = "h", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IILlf;)V", line = 97)
