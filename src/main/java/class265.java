...
public class class265 extends class119 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIBIIIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "([IB[J)V", line = 23)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I[BIIIZIIBI)V", line = 34)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZIZ)V", line = 125)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lug;IIIIZ[BIZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!ml", name = "d", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lug;IIIIZ[FI)V", line = 212)
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lug;IIIIZ[IZ)V", line = 261)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lug;IIII)V", line = 380)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lug;IIIII)V", line = 392)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IZ)Z", line = 250)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II[IIIIZII)V", line = 311)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 370)
