...
public class class265 extends class65 {
    ...
    @OriginalMember(owner = "client!uga", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!uga", name = "b", descriptor = "(I)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!uga", name = "<init>", descriptor = "(II)V", line = 41)
