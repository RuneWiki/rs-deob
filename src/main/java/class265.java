...
public class class265 extends class629 {
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "()I", line = 3)
    public final synchronized int method1727() {
        return this.field3800.method2764(64);
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lpda;)V", line = 8)
    public final synchronized void method1728(class629 arg0) {
        this.field3800.method2769(arg0, -80);
    }

    @OriginalMember(owner = "client!cl", name = "d", descriptor = "()Lpda;", line = 12)
    public final class629 method1361() {
        return (class629) this.field3800.method2765(-12261);
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lm;Lqk;)V", line = 15)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lqk;)V", line = 22)
    ...
    @OriginalMember(owner = "client!cl", name = "f", descriptor = "()V", line = 35)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "()Lpda;", line = 55)
    public final class629 method1400() {
        return (class629) this.field3800.method2759(-15361);
    }

    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Lpda;)V", line = 125)
    public final synchronized void method1733(class629 arg0) {
        arg0.method1185(-92);
    }

    @OriginalMember(owner = "client!cl", name = "c", descriptor = "([III)V", line = 132)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "([III)V", line = 150)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "()I", line = 199)
