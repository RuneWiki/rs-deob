...
public class class265 extends class530 {
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(II)V", line = 44)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)I", line = 88)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lah;)V", line = 99)
    public class265(class374 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!wba", name = "b", descriptor = "(Z)Z", line = 114)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(ILah;)V", line = 125)
    public class265(int arg0, class374 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wba", name = "c", descriptor = "(I)I", line = 129)
