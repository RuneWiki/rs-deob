...
public class class129 extends class436 {
    ...
    @OriginalMember(owner = "client!dq", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IB)[[I", line = 109)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I[BZ)[B", line = 162)
    ...
    @OriginalMember(owner = "client!dq", name = "h", descriptor = "(I)V", line = 183)
