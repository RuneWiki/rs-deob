...
public class class129 {
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLpf;)V", line = 58)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIIIIIZ)V", line = 90)
