...
public class class129 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sk", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IILjava/lang/String;)I", line = 34)
