...
public class class129 extends class204 {
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)Lgfa;")
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lfd;I)Ldq;")
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Lji;I)V")
    public class129(class622 arg0, int arg1) {
        this.field1640 = arg0;
        this.field1644 = new class660(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(Lgfa;BFLgfa;)Z")
