...
public class class129 extends class405 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "([J[Ljava/lang/Object;Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "([B)V", line = 32)
