...
public class class129 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "([BI)[B", line = 44)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Z[BLjp;)V", line = 64)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IILjava/lang/String;IZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "()V", line = 100)
    public class129() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(III)V", line = 110)
