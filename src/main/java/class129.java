...
public class class129 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Z)Lir;", line = 36)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)V", line = 93)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "(Lkw;ILuq;Luq;)V", line = 138)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(II)Lel;", line = 156)
