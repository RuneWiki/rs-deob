...
public class class129 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILco;I)V")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)Lfba;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lco;I)V")
