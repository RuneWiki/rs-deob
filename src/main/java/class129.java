...
public class class129 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lvq;ILja;IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ljj;)V", line = 135)
    public class129(class156 arg0) {
        this.field2106 = arg0;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IIIIIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)Lon;", line = 101)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Z)Lon;", line = 147)
