...
public class class129 extends class441 implements class722 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!jga", name = "b", descriptor = "(Lha;B)Liha;")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(BLkea;)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lha;I)Lua;")
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Lha;Lts;IIIIIZII)V")
