...
public class class129 extends class381 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lio;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZIIII)Lji;", line = 196)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(III)Z", line = 235)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ltj;)V", line = 305)
    public class129(class430 arg0) {
        this.field1841 = arg0;
    }

    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(I)V", line = 283)
