...
public class class129 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BI)Lrha;", line = 25)
    ...
    @OriginalMember(owner = "client!baa", name = "b", descriptor = "(BI)V", line = 60)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!baa", name = "<init>", descriptor = "(Lwj;ILwu;Lwu;)V", line = 90)
