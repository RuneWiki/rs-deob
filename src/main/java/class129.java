...
public abstract class class129 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(II)Llk;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lhs;Ljava/awt/Canvas;Lm;IIB)Lqa;")
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIBI)V")
