...
public class class129 extends class18 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILgj;)V", line = 35)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(BLnr;IIZLcb;I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lnr;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(Z)Z", line = 85)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)I", line = 102)
    ...
    @OriginalMember(owner = "client!ai", name = "j", descriptor = "(I)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(II)V", line = 136)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IILnr;)Z", line = 154)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ILnr;II)Z", line = 269)
    ...
    @OriginalMember(owner = "client!ai", name = "g", descriptor = "(I)I", line = 302)
    ...
    @OriginalMember(owner = "client!ai", name = "k", descriptor = "(I)V", line = 313)
    ...
    @OriginalMember(owner = "client!ai", name = "g", descriptor = "(B)I", line = 328)
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(B)I", line = 349)
    ...
    @OriginalMember(owner = "client!ai", name = "e", descriptor = "(B)Z", line = 371)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(Lnr;Z)Lg;", line = 383)
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(I)V", line = 454)
    ...
    @OriginalMember(owner = "client!ai", name = "c", descriptor = "(IIII)V", line = 470)
