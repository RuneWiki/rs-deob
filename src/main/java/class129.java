...
public class class129 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "([B)[Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lvd;I)Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Lvd;I)[Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lvd;II)Lfg;")
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Lvd;II)[Lfg;")
