...
public class class129 extends class57 {
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(B)J", line = 3)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(BJ)I", line = 49)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(I)J", line = 84)
    ...
    @OriginalMember(owner = "client!hh", name = "c", descriptor = "(B)J", line = 94)
