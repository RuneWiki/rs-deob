...
public class class129 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II)V", line = 46)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(II)Lkg;", line = 74)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lci;ILg;Lg;)V", line = 155)
