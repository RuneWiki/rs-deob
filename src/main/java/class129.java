...
public abstract class class129 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[IIII[Ll;ILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[III[Ll;IBILjava/lang/String;Ljava/util/Random;)I")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BIIILjava/util/Random;II[II[Ll;IILjava/lang/String;[II)I")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lro;BI)Lpl;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)Ldb;")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIILjava/lang/String;Lsf;III[II[Ll;III)I")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Ljava/lang/String;II[Ll;I[IBI)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([II[Ll;IILsf;IZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(Ltj;Lvn;)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([I[Ll;IIBIILjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I[Ll;I[I[ILjava/lang/String;[II)V")
