...
public class class129 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IZI)V", line = 14)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lwh;I)Z", line = 59)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILtq;)Loc;", line = 105)
