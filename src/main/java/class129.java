...
public class class129 extends class62 {
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "()V", line = 87)
    public class129() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(IBI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Lgw;II)V", line = 90)
    ...
    @OriginalMember(owner = "client!wh", name = "g", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(III)Z", line = 178)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIILhu;Lhu;)V", line = 197)
    ...
    @OriginalMember(owner = "client!wh", name = "h", descriptor = "(I)V", line = 206)
