...
public class class129 extends class305 implements class218 {
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(ILtq;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ltq;III)Z")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "b", descriptor = "(Ltq;I)Lcj;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BILtq;)Lns;")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(Lui;Ltq;I)V")
    ...
    @OriginalMember(owner = "client!ne", name = "a", descriptor = "(BZLtq;Lhm;III)V")
    ...
    @OriginalMember(owner = "client!ne", name = "<init>", descriptor = "(Ltq;Lvc;IIIIIZIIIIIII)V")
