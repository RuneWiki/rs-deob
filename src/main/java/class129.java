...
public class class129 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(III)I", line = 11)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z[BB)V", line = 33)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(ILmk;)V", line = 89)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(IIIIII)V", line = 138)
