...
public class class129 {
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(II)Lfv;", line = 39)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(IB)V", line = 68)
    ...
    @OriginalMember(owner = "client!wm", name = "b", descriptor = "(IB)Lfq;", line = 86)
    ...
    @OriginalMember(owner = "client!wm", name = "<init>", descriptor = "(Luea;ILpq;Lpq;Lpq;)V", line = 132)
    ...
    @OriginalMember(owner = "client!wm", name = "a", descriptor = "(Z)V", line = 157)
