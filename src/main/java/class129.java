...
public class class129 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILec;)Z")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Llf;B)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/Object;Lml;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lo;III[Z)Z")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lak;BIILmq;Lvq;Lt;I)V")
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Llf;)V")
