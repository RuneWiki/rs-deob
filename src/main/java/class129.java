...
public class class129 extends class85 {
    ...
    @OriginalMember(owner = "client!nh", name = "bb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!nh", name = "ob", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!nh", name = "c", descriptor = "(III)Lvg;")
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(BILja;)V")
