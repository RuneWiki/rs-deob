...
public class class129 extends class499 {
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIIIII)I", line = 89)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IB)I", line = 153)
    ...
    @OriginalMember(owner = "client!me", name = "d", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Z)V", line = 206)
