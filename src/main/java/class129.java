...
public class class129 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Ldi;B)Z", line = 55)
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(I)V", line = 71)
