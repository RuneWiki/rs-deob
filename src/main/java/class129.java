...
public class class129 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(BLvl;)Z")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZLvl;)V")
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IILqa;I)V")
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Lqg;)V")
