...
public class class129 extends class532 {
    ...
    @OriginalMember(owner = "client!gm", name = "Q", descriptor = "(IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!gm", name = "qa", descriptor = "(FFFFFFIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!gm", name = "u", descriptor = "()I", line = 83)
    public final int method529() {
        field1795++;
        return this.field1798;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(FFFFFFILua;II)V", line = 91)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!gm", name = "DA", descriptor = "(IIIIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IILua;II)V", line = 375)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lqq;IIZ)V", line = 552)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lqq;II[III)V", line = 568)
    ...
    @OriginalMember(owner = "client!gm", name = "A", descriptor = "()I", line = 425)
    public final int method523() {
        field1788++;
        return this.field1777 + this.field1773 + this.field1784;
    }

    @OriginalMember(owner = "client!gm", name = "V", descriptor = "(IIIII)V", line = 438)
    ...
    @OriginalMember(owner = "client!gm", name = "ca", descriptor = "()I", line = 470)
    public final int method532() {
        field1782++;
        return this.field1774 + this.field1772 + this.field1798;
    }

    @OriginalMember(owner = "client!gm", name = "da", descriptor = "(IIIIII)V", line = 481)
    ...
    @OriginalMember(owner = "client!gm", name = "E", descriptor = "()I", line = 506)
    public final int method530() {
        field1793++;
        return this.field1777;
    }

    @OriginalMember(owner = "client!gm", name = "xa", descriptor = "(III)V", line = 519)
    public final void method218(int arg0, int arg1, int arg2) {
        field1787++;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIII[III)V", line = 529)
    ...
    @OriginalMember(owner = "client!gm", name = "YA", descriptor = "(IIIIIIII)V", line = 587)
