...
public class class129 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lat;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(B)V", line = 194)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILat;)V", line = 208)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILat;Lgt;)V", line = 439)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIII)V", line = 577)
