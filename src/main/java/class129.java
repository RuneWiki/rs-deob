...
public class class129 extends class26 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(BIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrl;IIIII[BI)V", line = 184)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrl;IIIIIZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrl;IIII[I)V", line = 224)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrl;IIIZ[I)V", line = 240)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrl;IIIIZ[BI)V", line = 261)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Leq;ILhe;)V", line = 290)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "(Lrl;IIIIIIZ)V", line = 421)
