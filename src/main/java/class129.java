...
public class class129 extends class5 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILes;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "()V", line = 83)
    public class129() {
        super(3, false);
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZ)[[I", line = 86)
