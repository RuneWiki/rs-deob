...
public class class129 extends class189 {
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(Ljava/lang/String;IIIIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!m", name = "e", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(ILlt;IZII)Ljava/awt/Frame;", line = 54)
    ...
    @OriginalMember(owner = "client!m", name = "a", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!m", name = "<init>", descriptor = "(Lkh;Loi;)V", line = 158)
