...
public class class129 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILka;IIII)Lka;", line = 5)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 139)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIZ)I", line = 173)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILrv;)V", line = 310)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 339)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIBILka;II)Lka;", line = 383)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lrv;IZ)V", line = 450)
