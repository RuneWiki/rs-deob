...
public class class129 {
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II[Lvg;)V", line = 226)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)I", line = 323)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 339)
    private class129() {
    }

    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "([I)V", line = 341)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(B)I", line = 360)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IBIII)V", line = 377)
