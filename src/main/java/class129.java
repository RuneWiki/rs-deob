...
public class class129 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([Lpl;B)I", line = 19)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)Lpl;", line = 50)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Z)Lpl;", line = 82)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BJLpl;)V", line = 112)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)I", line = 134)
    public final int method884(int arg0) {
        field1818++;
        return arg0 == 14552 ? this.field1809 : -115;
    }

    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)Lpl;", line = 151)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(JI)Lpl;", line = 169)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(B)I", line = 199)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(I)V", line = 270)
