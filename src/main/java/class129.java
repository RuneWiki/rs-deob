...
public class class129 extends class458 implements class706 {
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(ILha;)V", line = 7)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(B)I", line = 18)
    ...
    @OriginalMember(owner = "client!hw", name = "i", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lha;III)Z", line = 50)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(III)Z", line = 73)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Z)Z", line = 93)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(ILha;)Lkj;", line = 104)
    ...
    @OriginalMember(owner = "client!hw", name = "i", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!hw", name = "e", descriptor = "(I)Z", line = 149)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(Lha;B)V", line = 160)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(BLha;)Lml;", line = 175)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(Lha;Lhba;IIIIIZIIIII)V", line = 312)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!hw", name = "d", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)Z", line = 255)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(B)I", line = 267)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "([IB[J)V", line = 278)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(Z)V", line = 289)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(II)V", line = 299)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(BLha;)V", line = 321)
    ...
    @OriginalMember(owner = "client!hw", name = "g", descriptor = "(B)I", line = 344)
