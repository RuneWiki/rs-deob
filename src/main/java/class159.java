...
public class class159 extends class139 implements class200 {
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lbfa;IIZ[III)V", line = 4)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lbfa;Lwq;Lbaa;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lria;I)V", line = 80)
    public final void method376(class287 arg0, int arg1) {
        super.method376(arg0, arg1);
    }

    @OriginalMember(owner = "client!kt", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 87)
    public final IDirect3DBaseTexture method375(int arg0) {
        return arg0 == 17723 ? this.field2557 : (IDirect3DBaseTexture) null;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Z)I", line = 97)
    public final int method1009(boolean arg0) {
        return arg0 ? -95 : this.field2558;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I)I", line = 109)
    public final int method1010(int arg0) {
        int var2 = -47 % ((55 - arg0) / 63);
        return this.field2556;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(I[IIIIBI)V", line = 117)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lbfa;Lwq;IIZ[BII)V", line = 156)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BF)F", line = 214)
    public final float method1002(byte arg0, float arg1) {
        return arg0 > -24 ? -0.2576451F : arg1 / (float) this.field2556;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(II[IIIIII)V", line = 227)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(FI)F", line = 267)
    public final float method1004(float arg0, int arg1) {
        return arg1 < 69 ? 0.44069603F : arg0 / (float) this.field2558;
    }

    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(B)V", line = 277)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIBIIII[BLwq;)V", line = 287)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)Z", line = 329)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ZZI)V", line = 339)
