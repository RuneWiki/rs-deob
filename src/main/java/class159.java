...
public class class159 extends class115 {
    ...
    @OriginalMember(owner = "client!nm", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(Z)Z", line = 16)
    public final boolean method985(boolean arg0) {
        return arg0;
    }

    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 24)
