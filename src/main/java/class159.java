...
public class class159 extends class474 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!cda", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 5)
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "(B)Z", line = 34)
    public final boolean method1103(byte arg0) {
        int var2 = -7 % ((arg0 + 47) / 48);
        return (this.field2506 & 0x4) != 0;
    }

    @OriginalMember(owner = "client!cda", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 43)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1115(arg0.getY(), 0, arg0.getX());
    }

    @OriginalMember(owner = "client!cda", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 50)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1115(arg0.getY(), 0, arg0.getX());
    }

    @OriginalMember(owner = "client!cda", name = "d", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(Z)Z", line = 78)
    ...
    @OriginalMember(owner = "client!cda", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 89)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(B)Lhca;", line = 123)
    public final class458 method1107(byte arg0) {
        return arg0 >= -67 ? (class458) null : (class458) this.field2504.method3262(-123);
    }

    @OriginalMember(owner = "client!cda", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 133)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.method1115(arg0.getY(), 0, arg0.getX());
    }

    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!cda", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 155)
    ...
    @OriginalMember(owner = "client!cda", name = "c", descriptor = "(I)Z", line = 168)
    ...
    @OriginalMember(owner = "client!cda", name = "b", descriptor = "(B)I", line = 180)
    public final int method1110(byte arg0) {
        return arg0 == 91 ? this.field2503 : 36;
    }

    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IIIII)V", line = 191)
    ...
    @OriginalMember(owner = "client!cda", name = "e", descriptor = "(I)V", line = 207)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(I)I", line = 229)
    public final int method1113(int arg0) {
        return arg0 == -6387 ? this.field2505 : -41;
    }

    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)I", line = 241)
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(III)V", line = 269)
    ...
    @OriginalMember(owner = "client!cda", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 283)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1115(arg0.getY(), 0, arg0.getX());
    }

    @OriginalMember(owner = "client!cda", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 312)
    public class159(Component arg0, boolean arg1) {
        this.method1108(arg0, (byte) 117);
        this.field2511 = arg1;
    }

    @OriginalMember(owner = "client!cda", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 297)
