...
public abstract class class159 extends class434 {
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!aba", name = "d", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)Ljd;", line = 32)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(IIII[FIFIIFI)V", line = 62)
