...
public class class159 extends class185 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lik;)Lve;", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!ve", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
