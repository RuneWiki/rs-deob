...
public class class159 extends class438 {
    ...
    @OriginalMember(owner = "client!bq", name = "b", descriptor = "(III)[B", line = 3)
    ...
    @OriginalMember(owner = "client!bq", name = "<init>", descriptor = "()V", line = 9)
    public class159() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(IB)V", line = 13)
