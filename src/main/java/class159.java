...
public class class159 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lms;I)V")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IB)Lei;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILqr;)V")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Ldk;ILfc;)V")
