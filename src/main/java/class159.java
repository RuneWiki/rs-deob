...
public class class159 extends OutputStream {
    ...
    @OriginalMember(owner = "client!kv", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field2392++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(III)Z", line = 33)
