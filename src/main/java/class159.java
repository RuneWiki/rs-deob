...
public class class159 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(ZII)I", line = 137)
    ...
    @OriginalMember(owner = "client!aba", name = "toString", descriptor = "()Ljava/lang/String;", line = 154)
    public final String toString() {
        field2314++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 162)
