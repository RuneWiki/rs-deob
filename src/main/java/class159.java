...
public class class159 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIIIBZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BLhc;Lhc;)V", line = 268)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Z)V", line = 288)
