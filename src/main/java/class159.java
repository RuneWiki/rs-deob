...
public class class159 extends class38 implements class130 {
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(III[[ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lls;[I)V", line = 20)
    ...
    @OriginalMember(owner = "client!fa", name = "finalize", descriptor = "()V", line = 25)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(IIIIIII[[Z)V", line = 36)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lw;Lg;II[[I[[IIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Li;IIIIZ)Z", line = 45)
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(II)V", line = 171)
