...
public class class159 extends class485 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lln;II[B)V", line = 26)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(Lln;II[I)V", line = 38)
