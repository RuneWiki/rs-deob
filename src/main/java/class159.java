...
public abstract class class159 {
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lgm;Lgm;ILgm;ZIIII[ZIILgm;II)V", line = 12)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "([IBII[IIZIII)V", line = 68)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Z)V", line = 171)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lgm;Lgm;IIIIIIZ)V", line = 185)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILgm;I[IIILgm;IZZI)V", line = 224)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILgm;I)V", line = 266)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(Lhf;I[[B)V", line = 325)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(ILkw;IZILuca;[IIZ[ZILuca;)V", line = 403)
    ...
    @OriginalMember(owner = "client!r", name = "a", descriptor = "(IIBIIIILsa;I)V", line = 632)
