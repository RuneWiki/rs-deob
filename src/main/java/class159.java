...
public class class159 extends class518 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 76)
    public class159(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)I", line = 110)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)D", line = 124)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IILvd;I)Ljj;", line = 150)
    ...
    @OriginalMember(owner = "client!hq", name = "e", descriptor = "(B)Lhm;", line = 178)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIII)I", line = 190)
