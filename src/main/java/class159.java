...
public class class159 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(IBLia;)V", line = 6)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)Lfd;", line = 364)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ILha;)V", line = 384)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(III)I", line = 414)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZIZIZ)V", line = 430)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lha;BI)V", line = 445)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(BIII)V", line = 471)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Z)V", line = 488)
