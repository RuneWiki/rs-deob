...
public class class159 extends class315 implements class309 {
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lia;II[III)V", line = 16)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ILpw;I[BIIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(B)I", line = 52)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lia;Lpw;II[BII)V", line = 64)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "([IIBIIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lia;Lpw;Llj;II)V", line = 112)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(Lia;Lpw;II[FII)V", line = 124)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(ZZI)V", line = 143)
    ...
    @OriginalMember(owner = "client!wd", name = "e", descriptor = "(B)V", line = 156)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IF)F", line = 175)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(FB)F", line = 187)
