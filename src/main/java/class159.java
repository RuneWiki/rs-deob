...
public class class159 extends class491 {
    ...
    @OriginalMember(owner = "client!db", name = "YA", descriptor = "([I)V", line = 3)
    ...
    @OriginalMember(owner = "client!db", name = "J", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!db", name = "U", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(BFFF[FF)V", line = 48)
    ...
    @OriginalMember(owner = "client!db", name = "wa", descriptor = "(III[I)V", line = 94)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(III[I)V", line = 108)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "()Lq;", line = 118)
    ...
    @OriginalMember(owner = "client!db", name = "o", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Z)[F", line = 161)
    ...
    @OriginalMember(owner = "client!db", name = "ZA", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!db", name = "oa", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIZ)Z", line = 232)
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(Z)V", line = 243)
    ...
    @OriginalMember(owner = "client!db", name = "NA", descriptor = "(III)V", line = 262)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(I)V", line = 275)
    ...
    @OriginalMember(owner = "client!db", name = "d", descriptor = "(I)[F", line = 287)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IBFIFFI)V", line = 313)
    ...
    @OriginalMember(owner = "client!db", name = "Y", descriptor = "()V", line = 348)
    ...
    @OriginalMember(owner = "client!db", name = "M", descriptor = "(Lq;)V", line = 357)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "()V", line = 377)
    public class159() {
        this.method918();
    }

    @OriginalMember(owner = "client!db", name = "na", descriptor = "(IIIIII)V", line = 385)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Lq;B)V", line = 423)
    ...
    @OriginalMember(owner = "client!db", name = "w", descriptor = "(I)V", line = 449)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(B)Ljava/lang/String;", line = 477)
    ...
    @OriginalMember(owner = "client!db", name = "AA", descriptor = "(I)V", line = 494)
