...
public class class159 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!rh", name = "<init>", descriptor = "(Ldn;IZLr;Lr;)V", line = 239)
    ...
    @OriginalMember(owner = "client!rh", name = "b", descriptor = "(IB)Lct;", line = 169)
