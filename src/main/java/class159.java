...
public class class159 extends class140 implements class68 {
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILa;IIILqa;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILqa;I)Lka;", line = 48)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IIIIIIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BIILqa;)Z", line = 100)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)I", line = 121)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILqa;)Lka;", line = 132)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILi;IILga;IBLqa;I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(Z)V", line = 252)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILqa;)Lou;", line = 265)
    ...
    @OriginalMember(owner = "client!ec", name = "e", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lqa;I)V", line = 303)
    ...
    @OriginalMember(owner = "client!ec", name = "i", descriptor = "(I)I", line = 330)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZLqa;)V", line = 342)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 372)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lqa;Lcd;IIIIIZIIIIIIZ)V", line = 394)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(ZLqa;)V", line = 427)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lqa;IIZ)Lkj;", line = 440)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)I", line = 472)
    ...
    @OriginalMember(owner = "client!ec", name = "f", descriptor = "(I)V", line = 486)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BLnj;)V", line = 501)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(Z)Z", line = 554)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Z", line = 579)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(I)I", line = 591)
