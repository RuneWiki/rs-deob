...
public class class159 extends class114 {
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(Lns;)V")
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(ILwfa;)V")
