...
public class class159 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(Z)V", line = 69)
