...
public class class159 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Loa;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(ILoa;)V", line = 102)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(B)V", line = 130)
