...
public class class159 extends class34 {
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lsv;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)[I", line = 53)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(ZII)Z", line = 77)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 95)
    public class159() {
        this(4096);
    }
}
