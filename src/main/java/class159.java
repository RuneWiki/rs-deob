...
public class class159 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIILjava/lang/Class;)Lwl;", line = 4)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(Ltq;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(IIIJ)V", line = 109)
