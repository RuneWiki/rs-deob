...
public class class159 {
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BLee;)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILee;)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IIILcj;Lcj;)V")
