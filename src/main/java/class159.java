...
public class class159 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "Ldg;")
    public static class376 field2282 = new class376(30, 5);

    @OriginalMember(owner = "client!aba", name = "v", descriptor = "I")
    public static int field2303 = 0;

    @OriginalMember(owner = "client!aba", name = "e", descriptor = "Lnea;")
    public static class664 field2286 = new class664(19, 0);

    @OriginalMember(owner = "client!aba", name = "j", descriptor = "B")
    public byte field2291;

    @OriginalMember(owner = "client!aba", name = "k", descriptor = "B")
    public byte field2292;

    @OriginalMember(owner = "client!aba", name = "l", descriptor = "B")
    public byte field2293;

    @OriginalMember(owner = "client!aba", name = "o", descriptor = "B")
    public byte field2296;

    @OriginalMember(owner = "client!aba", name = "p", descriptor = "B")
    public byte field2297;

    @OriginalMember(owner = "client!aba", name = "q", descriptor = "B")
    public byte field2298;

    @OriginalMember(owner = "client!aba", name = "s", descriptor = "B")
    ...
    @OriginalMember(owner = "client!aba", name = "x", descriptor = "Z")
    public boolean field2305;

    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(B)V", line = 20)
    public static void method1105(byte arg0) {
        field2282 = null;
        field2286 = null;
        field2302 = null;
        int var1 = 9 % ((arg0 - 75) / 33);
    }
}
