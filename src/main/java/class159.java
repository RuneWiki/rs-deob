...
public class class159 extends class73 implements class438 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lqa;Lih;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILqa;I)Lr;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BLqa;)Led;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lqa;IZZ)Lrp;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(ILqa;)Llb;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Lqa;Z)V")
    ...
    @OriginalMember(owner = "client!ee", name = "b", descriptor = "(Lqa;B)V")
