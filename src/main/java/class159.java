...
public class class159 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(II)Lfi;")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IFLfd;Lfd;)Z")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Ltt;)V")
