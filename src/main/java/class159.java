...
public class class159 extends class502 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)I", line = 61)
    public final int method1226(byte arg0) {
        ++field2567;
        return arg0 <= 49 ? -126 : super.field6865;
    }

    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(ILeka;)V", line = 73)
    public class159(int arg0, class492 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)I", line = 80)
    public final int method55(int arg0) {
        ++field2565;
        return arg0 != -2 ? 81 : 0;
    }

    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)Z", line = 91)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Leka;)V", line = 114)
