...
public class class159 extends class247 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!c", name = "e", descriptor = "(I)Lja;", line = 100)
