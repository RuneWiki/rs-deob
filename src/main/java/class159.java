...
public class class159 {
    ...
    @OriginalMember(owner = "client!rb", name = "f", descriptor = "Llf;")
    public static class109 field2982 = class35.method275("_", 2);

    @OriginalMember(owner = "client!rb", name = "j", descriptor = "Llf;")
    public static class109 field2986 = class35.method275("nicht hergestellt werden)3", 2);

    @OriginalMember(owner = "client!rb", name = "d", descriptor = "Lvg;")
    ...
    @OriginalMember(owner = "client!rb", name = "n", descriptor = "Llf;")
    private static class109 field2990 = class35.method275("Hidden", 2);

    @OriginalMember(owner = "client!rb", name = "o", descriptor = "Llf;")
