...
public class class159 extends class98 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lie;Z)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)Lui;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lie;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lie;IB)V")
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lie;Z[I)V")
