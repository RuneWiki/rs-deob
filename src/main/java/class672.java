...
public abstract class class672 extends class421 {
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(ILha;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!it", name = "h", descriptor = "(B)V", line = 18)
    public static void method3823(byte arg0) {
        field9369 = null;
        int var1 = 64 / ((arg0 - -8) / 39);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I[Lqm;)I", line = 27)
    ...
    @OriginalMember(owner = "client!it", name = "g", descriptor = "(B)Z", line = 200)
    ...
    @OriginalMember(owner = "client!it", name = "j", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(IIIIIIIIIZB)V", line = 260)
