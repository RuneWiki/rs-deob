...
public class class672 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I[BIB[BI)I", line = 21)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILha;Lco;IIIIIIIIILka;)Lka;", line = 92)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIZ[Lwq;II)V", line = 261)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I[BII[BI)I", line = 312)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "([B)V", line = 478)
