...
public class class672 extends class207 {
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(ILrd;)V", line = 3)
    public class672(int arg0, class355 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIBIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!lc", name = "<init>", descriptor = "(Lrd;)V", line = 29)
    public class672(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IIIIBIIZF)[[I", line = 33)
    ...
    @OriginalMember(owner = "client!lc", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IB)V", line = 81)
    ...
    @OriginalMember(owner = "client!lc", name = "b", descriptor = "(IB)I", line = 92)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IZ)V", line = 108)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(B)Z", line = 139)
    ...
    @OriginalMember(owner = "client!lc", name = "d", descriptor = "(I)I", line = 153)
