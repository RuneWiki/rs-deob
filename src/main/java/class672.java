...
public class class672 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BII)V", line = 14)
    ...
    @OriginalMember(owner = "client!rl", name = "toString", descriptor = "()Ljava/lang/String;", line = 35)
    public final String toString() {
        field9472++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!rl", name = "<init>", descriptor = "(II)V", line = 69)
