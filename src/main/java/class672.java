...
public class class672 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(II)Lww;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IB)Lsc;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "([BI)Lf;")
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lrf;ILpl;Lpl;)V")
