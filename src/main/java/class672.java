...
public class class672 extends class453 {
    ...
    @OriginalMember(owner = "client!lt", name = "T", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!lt", name = "C", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILtr;)V", line = 56)
    ...
    @OriginalMember(owner = "client!lt", name = "n", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljagdx/IDirect3DPixelShader;I)V", line = 119)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lsfa;Lsfa;FLsfa;)Lsfa;", line = 131)
    public final class693 method571(class693 arg0, class693 arg1, float arg2, class693 arg3) {
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(II)Lvi;", line = 140)
    public final class536 method551(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!lt", name = "e", descriptor = "(I)V", line = 147)
    public final synchronized void method566(int arg0) {
        this.field9439.method3777((byte) 98);
        super.method566(arg0);
    }

    @OriginalMember(owner = "client!lt", name = "g", descriptor = "(II)V", line = 155)
    ...
    @OriginalMember(owner = "client!lt", name = "g", descriptor = "(Z)F", line = 165)
    ...
    @OriginalMember(owner = "client!lt", name = "q", descriptor = "()Lsia;", line = 176)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljagdx/IDirect3DVertexShader;B)V", line = 184)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BI)Ldw;", line = 197)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLcv;)V", line = 242)
    ...
    @OriginalMember(owner = "client!lt", name = "O", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!lt", name = "v", descriptor = "()Z", line = 283)
    public final boolean method618() {
        return false;
    }

    @OriginalMember(owner = "client!lt", name = "e", descriptor = "(II)Lc;", line = 290)
    public final class185 method644(int arg0, int arg1) {
        return null;
    }

    @OriginalMember(owner = "client!lt", name = "h", descriptor = "()Z", line = 297)
    public final boolean method562() {
        return false;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIILkca;I[BZI)Lwda;", line = 305)
    ...
    @OriginalMember(owner = "client!lt", name = "I", descriptor = "()I", line = 315)
    public final int method594() {
        return 0;
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lkca;IBI[BI)Lii;", line = 323)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IIII)V", line = 330)
    public final void method625(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(IIIID)V", line = 332)
    public final void method532(int arg0, int arg1, int arg2, int arg3, double arg4) {
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(I[Lofa;)Lhi;", line = 335)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLti;Lkca;)Z", line = 345)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lqt;Z)I", line = 357)
    ...
    @OriginalMember(owner = "client!lt", name = "c", descriptor = "()V", line = 374)
    public final void method536() {
    }

    @OriginalMember(owner = "client!lt", name = "h", descriptor = "(B)V", line = 377)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZZ)V", line = 389)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(B)V", line = 399)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(IZ)Lida;", line = 412)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZZBILtaa;)V", line = 422)
    ...
    @OriginalMember(owner = "client!lt", name = "j", descriptor = "(B)V", line = 472)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Canvas;BLjava/lang/Object;)V", line = 509)
    ...
    @OriginalMember(owner = "client!lt", name = "l", descriptor = "()V", line = 518)
    public final void method567() {
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ltaa;I)I", line = 521)
    ...
    @OriginalMember(owner = "client!lt", name = "A", descriptor = "()V", line = 546)
    public final void method638() {
        this.field9439.method3781((byte) 112);
        super.method638();
    }

    @OriginalMember(owner = "client!lt", name = "ya", descriptor = "()V", line = 556)
    public final void method619() {
        this.method2715(true, -106);
        this.field9423.Clear(2, 0, 1.0F, 0);
    }

    @OriginalMember(owner = "client!lt", name = "q", descriptor = "(I)V", line = 564)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "()V", line = 573)
    public final void method533() {
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(BLti;Lkca;)I", line = 579)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "([FIIZIILkca;I)Lwda;", line = 617)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lut;Z)V", line = 627)
    ...
    @OriginalMember(owner = "client!lt", name = "Y", descriptor = "(I)V", line = 651)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 661)
    public final void method628(Rectangle[] arg0, int arg1, int arg2, int arg3) throws class701 {
        this.method554(arg2, arg3);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLuf;)I", line = 668)
    ...
    @OriginalMember(owner = "client!lt", name = "createToolkit", descriptor = "(Ljava/awt/Canvas;Ld;Leq;Ljava/lang/Integer;)Lha;", line = 703)
    ...
    @OriginalMember(owner = "client!lt", name = "p", descriptor = "()V", line = 801)
    public final void method595() {
    }

    @OriginalMember(owner = "client!lt", name = "J", descriptor = "(I)V", line = 804)
    ...
    @OriginalMember(owner = "client!lt", name = "y", descriptor = "(I)V", line = 825)
    ...
    @OriginalMember(owner = "client!lt", name = "bb", descriptor = "(I)V", line = 842)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljagdx/IDirect3D;IIBLjagdx/D3DPRESENT_PARAMETERS;I)Z", line = 879)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZIZ[[I)Lsaa;", line = 984)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILjava/awt/Canvas;Ljava/lang/Object;)V", line = 994)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/lang/Object;ILjava/awt/Canvas;)V", line = 1005)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILkca;Lti;II)Lwda;", line = 1036)
    ...
    @OriginalMember(owner = "client!lt", name = "F", descriptor = "(II)V", line = 1046)
    public final void method580(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lcaa;II)V", line = 1050)
    ...
    @OriginalMember(owner = "client!lt", name = "cb", descriptor = "(I)V", line = 1061)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lai;I)V", line = 1071)
    ...
    @OriginalMember(owner = "client!lt", name = "I", descriptor = "(I)V", line = 1113)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "(IILjava/awt/Canvas;Ljaclib/peer/wf;Ljagdx/IDirect3D;Ljagdx/IDirect3DDevice;Lgk;Ljagdx/D3DPRESENT_PARAMETERS;Ljagdx/D3DCAPS;Ld;Leq;I)V", line = 1656)
    ...
    @OriginalMember(owner = "client!lt", name = "na", descriptor = "(IIII)[I", line = 1129)
    ...
    @OriginalMember(owner = "client!lt", name = "G", descriptor = "(I)V", line = 1170)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILtaa;ZI)V", line = 1189)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(IILida;BILuf;I)V", line = 1235)
    ...
    @OriginalMember(owner = "client!lt", name = "e", descriptor = "(B)V", line = 1250)
    ...
    @OriginalMember(owner = "client!lt", name = "d", descriptor = "(B)V", line = 1282)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(Lfga;I)I", line = 1312)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Luf;III)V", line = 1348)
    ...
    @OriginalMember(owner = "client!lt", name = "u", descriptor = "(B)V", line = 1357)
    ...
    @OriginalMember(owner = "client!lt", name = "o", descriptor = "()V", line = 1369)
    ...
    @OriginalMember(owner = "client!lt", name = "p", descriptor = "(B)V", line = 1392)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(Z)V", line = 1401)
    public final void method564(boolean arg0) {
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ILti;Lkca;)Z", line = 1405)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(III[IZIZ)Lwda;", line = 1416)
    ...
    @OriginalMember(owner = "client!lt", name = "C", descriptor = "(I)V", line = 1426)
    ...
    @OriginalMember(owner = "client!lt", name = "Z", descriptor = "(I)V", line = 1438)
    ...
    @OriginalMember(owner = "client!lt", name = "F", descriptor = "(I)V", line = 1448)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BZ)Lcaa;", line = 1457)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(FFF)V", line = 1466)
    public final void method606(float arg0, float arg1, float arg2) {
    }

    @OriginalMember(owner = "client!lt", name = "m", descriptor = "(I)V", line = 1469)
    public final void method1027(int arg0) {
        this.field9423.method2894(137, this.field6520 && !this.field6501);
        int var2 = 111 / ((-arg0 - 60) / 51);
    }

    @OriginalMember(owner = "client!lt", name = "q", descriptor = "(B)V", line = 1478)
    ...
    @OriginalMember(owner = "client!lt", name = "GA", descriptor = "(I)V", line = 1488)
    public final void method617(int arg0) {
        this.field9423.Clear(1, arg0, 0.0F, 0);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Ljava/awt/Canvas;B)Ljava/lang/Object;", line = 1495)
    ...
    @OriginalMember(owner = "client!lt", name = "s", descriptor = "(B)V", line = 1505)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(BLrr;)I", line = 1515)
    ...
    @OriginalMember(owner = "client!lt", name = "i", descriptor = "(B)V", line = 1545)
    ...
    @OriginalMember(owner = "client!lt", name = "u", descriptor = "(I)V", line = 1565)
    ...
    @OriginalMember(owner = "client!lt", name = "g", descriptor = "(B)V", line = 1606)
    public final void method1043(byte arg0) {
        int var2 = 85 % ((arg0 + 62) / 43);
        this.field9423.SetTransform(3, this.field6478);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Luaa;)V", line = 1618)
    public final void method610(class116 arg0) {
    }

    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(II)V", line = 1621)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lhi;Z)V", line = 1646)
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lc;Lvi;)Luaa;", line = 1698)
