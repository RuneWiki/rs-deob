...
public class class672 extends class440 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BI)[I", line = 11)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lmo;B)V", line = 63)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILmo;I)V", line = 94)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(II)I", line = 129)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(B)V", line = 144)
    ...
    @OriginalMember(owner = "client!rl", name = "b", descriptor = "(IIZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(II)[[I", line = 172)
