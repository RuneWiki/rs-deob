...
public class class672 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(ILfca;)Lfca;", line = 24)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(I)V", line = 61)
