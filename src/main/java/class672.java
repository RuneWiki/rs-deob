...
public class class672 extends class305 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(ILhb;)V", line = 24)
    public class672(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZI[BI)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lhb;)V", line = 314)
    public class672(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(I)Z", line = 318)
    ...
    @OriginalMember(owner = "client!pc", name = "d", descriptor = "(I)I", line = 329)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)I", line = 340)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(II)V", line = 355)
    ...
    @OriginalMember(owner = "client!pc", name = "c", descriptor = "(II)I", line = 374)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(B)V", line = 394)
