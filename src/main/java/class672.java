...
public class class672 extends class433 implements class537 {
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Ldc;IZ[[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(ILeh;)Ltq;", line = 49)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!jga", name = "e", descriptor = "(I)Z", line = 77)
