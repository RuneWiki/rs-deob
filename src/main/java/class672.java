...
public class class672 extends class644 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lsl;Lqg;BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lsl;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 172)
