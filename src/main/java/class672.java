...
public class class672 extends class161 {
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "()V", line = 3)
    public final void method572() {
        field8705.method99(this.field8704, super.field2133);
    }

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "()V", line = 13)
    public final void method574() {
        field8705.method98(123, this.field8704);
    }

    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Loq;I)V", line = 15)
    public class672(class775 arg0, int arg1) {
        field8705 = (class22) arg0.method4243(true);
        this.field8704 = arg1;
    }

    @OriginalMember(owner = "client!qo", name = "e", descriptor = "()V", line = 21)
    public static void method3626() {
        field8705 = null;
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "()V", line = 24)
    public final void method570() {
        field8705.method101(this.field8704, (byte) 121);
    }

    @OriginalMember(owner = "client!qo", name = "c", descriptor = "()I", line = 27)
    public final int method569() {
        return field8705.method97(-123, this.field8704);
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 30)
