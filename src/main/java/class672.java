...
public class class672 extends class362 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lfca;II)V", line = 7)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "()V", line = 61)
    public class672() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lca", name = "d", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IB)[[I", line = 173)
    ...
    @OriginalMember(owner = "client!lca", name = "c", descriptor = "(I)V", line = 225)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!lca", name = "b", descriptor = "(IB)V", line = 301)
