...
public class class672 extends class304 {
    ...
    @OriginalMember(owner = "client!bba", name = "<init>", descriptor = "(Lufa;I)V", line = 3)
    public class672(class140 arg0, int arg1) {
        field9321 = (class212) arg0.method1061(true);
        this.field9320 = arg1;
    }

    @OriginalMember(owner = "client!bba", name = "e", descriptor = "()V", line = 8)
    public static void method3688() {
        field9321 = null;
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 12)
    ...
    @OriginalMember(owner = "client!bba", name = "c", descriptor = "()V", line = 15)
    public final void method1790() {
        field9321.method1366(this.field9320, super.field3978);
    }

    @OriginalMember(owner = "client!bba", name = "d", descriptor = "()V", line = 18)
    public final void method1798() {
        field9321.method1361(this.field9320, (byte) -26);
    }

    @OriginalMember(owner = "client!bba", name = "b", descriptor = "()I", line = 21)
    public final int method1787() {
        return field9321.method1364(this.field9320, true);
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "()V", line = 24)
    public final void method1786() {
        field9321.method1363(-6142, this.field9320);
    }

    @OriginalMember(owner = "client!bba", name = "a", descriptor = "(I)V", line = 27)
