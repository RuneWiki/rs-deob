...
public class class672 {
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;)V", line = 29)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;IIIIIII[S[BZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!lw", name = "c", descriptor = "()V", line = 221)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;II)V", line = 250)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lfa;II)V", line = 430)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;Llv;IIII)V", line = 439)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(II)Lgfa;", line = 444)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;IIII)V", line = 460)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Lr;)Lwo;", line = 804)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lfa;III)I", line = 815)
    ...
    @OriginalMember(owner = "client!lw", name = "d", descriptor = "()V", line = 874)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;Lio;IIII[I[I)V", line = 1033)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(Lr;IIII)Lwo;", line = 1169)
    ...
    @OriginalMember(owner = "client!lw", name = "e", descriptor = "()V", line = 1179)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lga;Llp;Lcq;Lmg;Lcf;Lkaa;Lml;)V", line = 1192)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(Lr;IIII[S[B)V", line = 1222)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "([B[B[SII)V", line = 1283)
    ...
    @OriginalMember(owner = "client!lw", name = "b", descriptor = "(II)Lsfa;", line = 1436)
    ...
    @OriginalMember(owner = "client!lw", name = "a", descriptor = "(IIIIIIII)V", line = 1454)
