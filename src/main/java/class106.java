...
public class class106 extends class71 {
    ...
    @OriginalMember(owner = "client!lc", name = "o", descriptor = "Llf;")
    public static class109 field2097 = class35.method275(" zuerst von Ihrer Freunde)2Liste(Q", 2);

    @OriginalMember(owner = "client!lc", name = "E", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!lc", name = "y", descriptor = "Lvg;")
