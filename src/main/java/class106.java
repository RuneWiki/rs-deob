...
public class class106 extends class372 {
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lmm;Z)V", line = 131)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II[B[BBIIII)V", line = 159)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BLmm;)V", line = 205)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ILmm;)V", line = 223)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)V", line = 251)
    public final void method777(byte arg0) {
        int var2 = 38 % ((48 - arg0) / 62);
        ++field1608;
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lo;ZFII)V", line = 260)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIII)Z", line = 279)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II)V", line = 496)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZLjava/lang/String;I)V", line = 507)
