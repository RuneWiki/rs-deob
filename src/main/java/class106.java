...
public class class106 extends class82 {
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "()V", line = 50)
    public class106() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(II)[I", line = 54)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IILos;)V", line = 105)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 168)
