...
public class class106 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IJ)Lsp;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIIIBI[[[BIIILya;I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(B)Lsp;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lsp;JI)V")
