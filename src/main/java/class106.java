...
public class class106 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILha;ZIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(III)V", line = 48)
    ...
    @OriginalMember(owner = "client!iv", name = "toString", descriptor = "()Ljava/lang/String;", line = 71)
    public final String toString() {
        field1310++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 79)
