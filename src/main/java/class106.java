...
public class class106 extends class786 {
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(I)[B", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Z)I", line = 23)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Lfda;I)I", line = 40)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!kd", name = "e", descriptor = "(I)V", line = 194)
