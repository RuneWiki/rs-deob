...
public class class106 extends class181 {
    ...
    @OriginalMember(owner = "client!iv", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 5)
    public class106(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Laj;IIJBZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B)F", line = 46)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(Z)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 73)
    ...
    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(I)Ljava/lang/String;", line = 147)
    public final String method811(int arg0) {
        ++field1466;
        return arg0 >= -25 ? null : this.field1457;
    }

    @OriginalMember(owner = "client!iv", name = "d", descriptor = "(B)F", line = 161)
