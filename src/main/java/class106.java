...
public class class106 extends class211 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIBLla;)Llq;")
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BILib;)V")
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BLtia;)V")
