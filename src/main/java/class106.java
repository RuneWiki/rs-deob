...
public class class106 extends class501 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IZ)Z", line = 6)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(II)Z", line = 33)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(B)Z", line = 82)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(ZI)Z", line = 179)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(III)Z", line = 194)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(I)V", line = 206)
    public class106(int arg0) {
        this.field1532 = arg0;
    }

    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Llp;I)[Luq;", line = 214)
