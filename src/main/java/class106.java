...
public class class106 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I)Lvu;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JI)Lvu;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lcw;IB)V")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(JILvu;)V")
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(B)Lvu;")
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(B)Lvu;")
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(I[Lvu;)I")
