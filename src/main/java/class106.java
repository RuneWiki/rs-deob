...
public class class106 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IB)V", line = 8)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 68)
    public class106(Throwable arg0, String arg1) {
        this.field1550 = arg1;
        this.field1547 = arg0;
    }

    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(IZ)V", line = 81)
