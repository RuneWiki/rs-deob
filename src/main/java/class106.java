...
public class class106 extends class83 implements class162 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IIIIIIB)V", line = 119)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B[ILao;I)Lcda;", line = 150)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Loaa;Lpb;III[B)V", line = 338)
