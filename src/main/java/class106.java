...
public class class106 extends class278 {
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "()V", line = 5)
    public class106() {
        super(1, false);
    }

    @OriginalMember(owner = "client!g", name = "d", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Llh;II)V", line = 155)
    ...
    @OriginalMember(owner = "client!g", name = "e", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II)[[I", line = 207)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lir;B)I", line = 294)
