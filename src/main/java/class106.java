...
public class class106 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lpi;Lnp;BI)V")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ltf;ZLtf;Lrda;Ltf;)Z")
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lkq;I)V")
