...
public class class106 extends class523 {
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(III)Lje;", line = 3)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Z)Lwo;", line = 22)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!qda", name = "d", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)Lkk;", line = 99)
    ...
    @OriginalMember(owner = "client!qda", name = "e", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lkk;BLkk;F)Z", line = 123)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Lbi;I)V", line = 327)
