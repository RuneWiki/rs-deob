...
public class class106 extends class349 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)Lok;", line = 5)
    ...
    @OriginalMember(owner = "client!td", name = "e", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IIIII)V", line = 123)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(ZII)V", line = 138)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "()V", line = 435)
    protected class106() {
    ...
    @OriginalMember(owner = "client!td", name = "<init>", descriptor = "(Ltq;)V", line = 454)
