...
public abstract class class106 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Lvj;)V", line = 179)
