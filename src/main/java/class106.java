...
public class class106 extends class366 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ICB)I", line = 17)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ZLlf;)V", line = 43)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IBLlf;)V", line = 66)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(Ljava/awt/Canvas;B)Leg;", line = 86)
    ...
    @OriginalMember(owner = "client!me", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(III)I", line = 129)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIIIIIII)V", line = 147)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(II)V", line = 158)
