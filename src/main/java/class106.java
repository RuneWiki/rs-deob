...
public class class106 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Lmd;II)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLmd;)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)Lfq;")
