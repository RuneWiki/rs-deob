...
public class class106 {
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(I)Lii;")
    ...
    @OriginalMember(owner = "client!ej", name = "a", descriptor = "(Loe;I)V")
    ...
    @OriginalMember(owner = "client!ej", name = "b", descriptor = "(I)Lii;")
    ...
    @OriginalMember(owner = "client!ej", name = "<init>", descriptor = "(Loe;)V")
