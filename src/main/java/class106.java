...
public class class106 extends class361 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IFLsm;IIIFIF[BFIFI)V", line = 20)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I[BII)I", line = 81)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZIIIIIII)V", line = 104)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(Z)V", line = 121)
