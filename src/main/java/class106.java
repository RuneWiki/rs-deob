...
public class class106 extends class264 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!af", name = "e", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 78)
    public class106() {
    }

    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 80)
