...
public class class106 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(II[II)Lok;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I[III)Lok;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(II[I)Lok;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(B[II)Lok;")
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lqj;Lqj;)V")
