...
public class class106 extends class377 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IIIII[[ILjava/util/Random;)V", line = 4)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(II)I", line = 202)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "()V", line = 214)
    public class106() {
        super(0, true);
    }

    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IILji;)V", line = 230)
    ...
    @OriginalMember(owner = "client!uaa", name = "f", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!uaa", name = "e", descriptor = "(B)V", line = 341)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(II)[I", line = 377)
