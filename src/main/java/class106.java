...
public class class106 extends class55 {
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "()V", line = 94)
    public class106() {
    }

    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 97)
