...
public class class106 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Lqe;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IIILjava/lang/Class;)Lwt;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lkk;B)V")
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Llo;ILnl;Lnl;)V")
