...
public class class106 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IBIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(IB)V", line = 24)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)V", line = 78)
