...
public class class106 implements class473 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lds;II)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIILwn;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Ltc;III)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZLwn;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIILtc;I)V")
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lnv;)V")
