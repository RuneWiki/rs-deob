...
public class class106 extends class194 {
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ZI)Ldj;", line = 27)
    ...
    @OriginalMember(owner = "client!af", name = "h", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "([BII)I", line = 75)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IILbg;)V", line = 85)
    ...
    @OriginalMember(owner = "client!af", name = "i", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!af", name = "j", descriptor = "(I)V", line = 287)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 331)
    public class106() {
        super(1, true);
    }

    @OriginalMember(owner = "client!af", name = "f", descriptor = "(I)V", line = 305)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BI)I", line = 342)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Laq;III)V", line = 363)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(II)[I", line = 435)
