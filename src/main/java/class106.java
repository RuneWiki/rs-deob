...
public class class106 {
    ...
    @OriginalMember(owner = "client!bk", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field1571++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(III)V", line = 13)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(IZ)V", line = 56)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Llr;BI)Z", line = 121)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(I)V", line = 288)
