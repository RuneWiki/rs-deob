...
public class class106 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)I", line = 11)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lcd;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lps;B)V", line = 90)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BIIILjava/lang/String;)V", line = 118)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IILps;)V", line = 233)
