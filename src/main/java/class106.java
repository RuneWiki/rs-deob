...
public class class106 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(I)Lrha;")
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Ljc;I)V")
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Ljc;II)V")
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(B)Lrha;")
