...
public class class106 extends class190 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IJIZLuo;)V", line = 4)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "([SI)[S", line = 167)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(II)V", line = 186)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(Luo;Lrf;Le;J)V", line = 283)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(JB)V", line = 216)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(B)V", line = 263)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(I)V", line = 301)
