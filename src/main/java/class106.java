...
public class class106 implements class396 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lrca;Lvt;Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 52)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "(I)I", line = 69)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(II)V", line = 79)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "(I)Lvt;", line = 115)
