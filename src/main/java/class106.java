...
public class class106 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Throwable;)V", line = 3)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "([[BLgl;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(III)Z", line = 144)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZLjava/lang/String;IILjava/lang/String;)V", line = 156)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ldr;BI)V", line = 167)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(III)V", line = 205)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 219)
