...
public class class106 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Lsba;)V", line = 8)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "([I[I[I[BIII)V", line = 514)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILsba;)I", line = 582)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(Lsba;)V", line = 608)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(Lsba;)B", line = 625)
    private static final byte method867(class230 arg0) {
        return (byte) method865(1, arg0);
    }

    @OriginalMember(owner = "client!qu", name = "d", descriptor = "(Lsba;)V", line = 630)
    ...
    @OriginalMember(owner = "client!qu", name = "e", descriptor = "(Lsba;)B", line = 783)
    private static final byte method869(class230 arg0) {
        return (byte) method865(8, arg0);
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "()V", line = 798)
    public static void method870() {
        field1349 = null;
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "([BI[BII)I", line = 803)
