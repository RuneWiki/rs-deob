...
public class class106 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IC)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lii;IIB)V", line = 206)
