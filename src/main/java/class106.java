...
public class class106 extends OutputStream {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ZI)Z", line = 16)
    ...
    @OriginalMember(owner = "client!qu", name = "write", descriptor = "(I)V", line = 28)
    public final void write(int arg0) throws IOException {
        field1691++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "([BI)[B", line = 37)
