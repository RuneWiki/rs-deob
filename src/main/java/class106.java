...
public abstract class class106 extends class515 {
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "()I", line = 60)
    public final int method777() {
        return this.field1517;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(FFFFFFIIII)V", line = 79)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "()I", line = 178)
    public final int method780() {
        return this.field1524 + this.field1508 + this.field1528;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 185)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(IIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "()I", line = 207)
    public final int method784() {
        return this.field1523 + this.field1517 + this.field1519;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(FFFFFF)Z", line = 212)
    ...
    @OriginalMember(owner = "client!ql", name = "d", descriptor = "()I", line = 347)
    public final int method787() {
        return this.field1524;
    }

    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lsa;II)V", line = 367)
