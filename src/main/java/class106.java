...
public class class106 extends class98 implements class697 {
    ...
    @OriginalMember(owner = "client!laa", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(IIII)I", line = 21)
    ...
    @OriginalMember(owner = "client!laa", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Ler;III)V", line = 133)
    ...
    @OriginalMember(owner = "client!laa", name = "<init>", descriptor = "(Ler;IIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 64)
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!laa", name = "finalize", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!laa", name = "b", descriptor = "(III)V", line = 105)
