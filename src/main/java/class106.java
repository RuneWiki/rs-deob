...
public class class106 extends class217 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "([[BII[I[II[[B[B)I", line = 3)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Ljava/lang/String;BI)Lvu;", line = 55)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(II[I[I)V", line = 87)
    public class106(int arg0, int arg1, int[] arg2, int[] arg3) {
        this.field1575 = arg2;
        this.field1574 = arg3;
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(III)Z", line = 100)
