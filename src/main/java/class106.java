...
public class class106 extends class371 implements class223 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lea;I)V")
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Lea;Lp;IIIIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Lea;BI)Lts;")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZILea;I)Z")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILea;)V")
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BLea;)V")
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(ILea;)Lms;")
