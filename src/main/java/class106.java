...
public class class106 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IBIIIIII)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IZ)Ldh;")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "([BIIIIIII[B)V")
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lsr;Ld;)V")
