...
public class class106 extends class513 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIIIIIIIZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B[Ljava/lang/String;)[Ljava/lang/String;", line = 91)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 126)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BIZII)V", line = 157)
