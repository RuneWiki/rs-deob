...
public class class231 extends class715 {
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dia", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(ILdu;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!dia", name = "<init>", descriptor = "(Lgt;)V", line = 73)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(ZI)V", line = 187)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "([SII)[S", line = 231)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(BZ)V", line = 245)
    ...
    @OriginalMember(owner = "client!dia", name = "a", descriptor = "(III)V", line = 256)
    ...
    @OriginalMember(owner = "client!dia", name = "f", descriptor = "(I)V", line = 274)
