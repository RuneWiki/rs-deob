...
public class class231 extends class35 {
    ...
    @OriginalMember(owner = "client!tt", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIBII)V", line = 17)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "()V", line = 123)
    public class231() {
    }

    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(S)V", line = 129)
    public class231(short arg0) {
        this.field3393 = arg0;
    }

    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(III)V", line = 138)
