...
public class class231 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILrg;)Lrg;", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Ljj;B)V", line = 59)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILjava/lang/String;)V", line = 112)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBIIIIII)V", line = 136)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIII)I", line = 147)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IBI)V", line = 162)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(IIII)I", line = 179)
