...
public class class231 extends class389 {
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "()Lqu;", line = 3)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "()V", line = 20)
    private final void method1455() {
        this.field3082 = false;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "()V", line = 31)
    public static void method1457() {
        field3089 = null;
        field3081 = null;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Loa;J)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ru", name = "d", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(J)V", line = 120)
    public final void method1460(long arg0) {
        this.field3086 = arg0;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "([Lrea;Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Loa;J[Lgi;[Lrea;Z)V", line = 217)
    ...
    @OriginalMember(owner = "client!ru", name = "e", descriptor = "()V", line = 225)
    public final void method1463() {
        this.field3082 = true;
    }

    @OriginalMember(owner = "client!ru", name = "f", descriptor = "()V", line = 228)
    public final void method1464() {
        this.field3099 = true;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(IIIII)V", line = 231)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(IZ)V", line = 390)
    private class231(int arg0, boolean arg1) {
        this.method1456(arg0, arg1);
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Loa;)V", line = 243)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(IZ)Lru;", line = 255)
    ...
    @OriginalMember(owner = "client!ru", name = "g", descriptor = "()Lqu;", line = 269)
    public final class282 method1468() {
        return this.field3092;
    }

    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Loa;[Lgi;Z)V", line = 277)
