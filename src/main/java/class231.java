...
public class class231 extends class7 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Ljava/lang/String;Lmb;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BLja;)Lkh;")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILja;II)Z")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILec;)Lti;")
