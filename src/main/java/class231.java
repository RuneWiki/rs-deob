...
public class class231 extends class214 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Llk;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(III)I", line = 47)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(ILfc;II)Lss;", line = 67)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IIIIIZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(IB)[[I", line = 168)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "()V", line = 246)
    public class231() {
        super(1, false);
    }
}
