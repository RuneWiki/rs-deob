...
public class class231 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IZ)I", line = 15)
    public static final int method1591(int arg0, boolean arg1) {
        field3340++;
        return arg1 ? 62 : arg0 >> 11 & 0x7F;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(II)I", line = 30)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(IZ)V", line = 61)
