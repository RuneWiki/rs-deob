...
public class class231 extends class695 {
    ...
    @OriginalMember(owner = "client!pd", name = "j", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!pd", name = "m", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(ZF)V", line = 69)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(I)V", line = 85)
    public class231(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(BF)V", line = 92)
