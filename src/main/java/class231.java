...
public class class231 extends class393 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IILjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)Loo;", line = 19)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "()V", line = 46)
    public class231() {
    }

    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(B)V", line = 50)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lnr;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(I)V", line = 88)
