...
public class class231 {
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BI)Lvaa;", line = 26)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(Z)I", line = 38)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(II)I", line = 85)
    ...
    @OriginalMember(owner = "client!tg", name = "a", descriptor = "(BLvaa;)V", line = 96)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!tg", name = "b", descriptor = "(II)Z", line = 126)
    ...
    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "(Lvaa;)V", line = 139)
    public class231(class467 arg0) {
        this.field2707 = 1;
        this.field2700 = arg0.field6677;
    }

    @OriginalMember(owner = "client!tg", name = "<init>", descriptor = "([Lvaa;)V", line = 147)
    public class231(class467[] arg0) {
