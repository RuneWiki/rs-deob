...
public class class231 extends class336 {
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfp;Lbi;I)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfp;Lje;ZIIII)V")
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Lfp;II)Lbi;")
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILfp;)Luq;")
