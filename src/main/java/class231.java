...
public class class231 extends class428 {
    ...
    @OriginalMember(owner = "client!rha", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!rha", name = "<init>", descriptor = "(Lgca;)V")
    public class231(class261 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Lln;BI)V")
