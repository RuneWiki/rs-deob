...
public class class231 {
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(Lfea;[[BI)V")
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "([Lwaa;Lrs;B)Lun;")
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(II)Lmw;")
    ...
    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "(Lcr;ILla;)V")
