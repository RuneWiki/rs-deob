...
public class class231 extends class38 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IILrg;)V", line = 22)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(II)[[I", line = 58)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BI)[I", line = 377)
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "()V", line = 624)
    public class231() {
        super(2, false);
    }
}
