...
public class class231 extends class22 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIBILjava/awt/Graphics;II)V", line = 12)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IILjava/awt/Canvas;I)V", line = 33)
