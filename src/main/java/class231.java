...
public class class231 extends class248 {
    ...
    @OriginalMember(owner = "client!oh", name = "d", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!oh", name = "f", descriptor = "(I)Lwb;", line = 209)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIILcb;Lcb;)V", line = 227)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIIIII)V", line = 236)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIIIZIIIIII)Z", line = 343)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(IIILfn;IIIIIII)Z", line = 361)
