...
public class class231 extends class4 {
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lhd;IIIII)V")
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lhd;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lhd;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lhd;IIII)V")
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Lhd;IIIIZ[FI)V")
