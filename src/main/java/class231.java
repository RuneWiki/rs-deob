...
public class class231 extends class709 {
    ...
    @OriginalMember(owner = "client!pfa", name = "b", descriptor = "(B)Lkaa;")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILni;)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Lha;Ljo;Lto;B)V")
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(Ldw;II)V")
