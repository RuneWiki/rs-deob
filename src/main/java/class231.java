...
public class class231 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "([IIII)Lug;")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I[II)Lug;")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I[IBI)Lug;")
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IZ[I)Lug;")
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "(Ltf;Ltf;)V")
