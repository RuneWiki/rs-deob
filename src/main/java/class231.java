...
public class class231 extends class371 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILjava/lang/Object;II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!vba", name = "g", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "()V", line = 50)
    public class231() {
        super(2, false);
    }

    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BI)[[I", line = 55)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(III[BII)V", line = 376)
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(BI)[I", line = 404)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IBLps;)V", line = 652)
