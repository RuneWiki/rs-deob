...
public class class231 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IIIZZI)V", line = 8)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILwj;I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILkh;Lkh;)V", line = 96)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 114)
    public static void method1483(int arg0) {
        int var1 = -56 / ((arg0 + 57) / 40);
        field3108 = null;
    }

    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(II)Luk;", line = 125)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(Lck;)V", line = 229)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BJ)V", line = 159)
