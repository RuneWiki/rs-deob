...
public class class231 extends class439 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lat;IIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(II)V", line = 56)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "()V", line = 70)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBIIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(B)V", line = 243)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 264)
