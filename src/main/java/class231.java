...
public class class231 extends class739 {
    ...
    @OriginalMember(owner = "client!aia", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lwaa;B)Z")
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(Lsl;II)V")
