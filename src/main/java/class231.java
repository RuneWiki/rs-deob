...
public class class231 extends class122 {
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(BLku;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "(Lc;Z)V")
    ...
    @OriginalMember(owner = "client!tu", name = "za", descriptor = "(Lc;)V")
    ...
    @OriginalMember(owner = "client!tu", name = "a", descriptor = "()Lc;")
