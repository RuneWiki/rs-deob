...
public class class231 {
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(B)Lii;")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(Lii;Z)V")
    ...
    @OriginalMember(owner = "client!kg", name = "a", descriptor = "(I)Lii;")
