...
public class class231 extends class238 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BIZIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZIFIZII)[I", line = 139)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BFFF)F", line = 163)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lrt;B)I", line = 174)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)Lav;", line = 250)
    public static final class583 method1346(int arg0, int arg1) {
        field2941++;
        return arg0 < 7 ? null : new class583(arg1, false);
    }

    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Loa;BII)Z", line = 267)
