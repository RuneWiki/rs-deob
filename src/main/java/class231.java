...
public class class231 extends class258 {
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(IIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IIILbb;ILbr;Lsg;ILjava/lang/String;IILug;)V", line = 74)
    ...
    @OriginalMember(owner = "client!ns", name = "d", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IB)V", line = 150)
    public void method1166(int arg0, byte arg1) {
        this.field3413[this.field3410++] = (byte) (127 + (class209.method1483(arg1, 255) >> 1));
        ++field3409;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(III)V", line = 170)
