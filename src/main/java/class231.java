...
public class class231 extends class165 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BI)V", line = 14)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lij;BLij;)V", line = 34)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIZ)V", line = 49)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 81)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(II[I[I)V", line = 92)
