...
public class class231 implements class258 {
    ...
    @OriginalMember(owner = "client!oq", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    public final String toString() {
        field3511++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 69)
