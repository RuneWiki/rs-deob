...
public class class231 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IBIZI)Lew;")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IB)Lkd;")
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(ILfaa;Z)V")
