...
public class class231 extends class311 {
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lmn;Ljava/lang/Object;)V", line = 4)
    public class231(class205 arg0, Object arg1) {
        super(arg0);
        this.field3259 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!oh", name = "h", descriptor = "(I)Ljava/lang/Object;", line = 13)
    public final Object method423(int arg0) {
        return arg0 == -27364 ? this.field3259.get() : (Object) null;
    }

    @OriginalMember(owner = "client!oh", name = "e", descriptor = "(I)Z", line = 23)
