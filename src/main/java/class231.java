...
public class class231 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(I)[Lu;", line = 39)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIILha;II)V", line = 52)
    ...
    @OriginalMember(owner = "client!ku", name = "b", descriptor = "(B)V", line = 146)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IIIIIIIIILuda;II)Z", line = 167)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B)V", line = 600)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(III[BILjava/lang/String;)I", line = 617)
