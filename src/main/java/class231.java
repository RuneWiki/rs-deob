...
public class class231 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(JI)V", line = 5)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BJ)Ljava/lang/Object;", line = 20)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 62)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Ljava/lang/Object;JB)V", line = 93)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(I)I", line = 107)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIII)I", line = 122)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(B)I", line = 173)
    ...
    @OriginalMember(owner = "client!fr", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 200)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BLjava/lang/Object;JI)V", line = 228)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ZLns;)V", line = 256)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BI)V", line = 274)
    ...
    @OriginalMember(owner = "client!fr", name = "e", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(B)I", line = 336)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(I)V", line = 351)
