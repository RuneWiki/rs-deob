...
public class class231 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)Lcu;")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIZI[[[Lrr;I)Z")
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Liv;ILcb;)V")
