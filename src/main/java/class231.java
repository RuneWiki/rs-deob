...
public class class231 extends class159 implements class558 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 38)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(II)V", line = 59)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 89)
