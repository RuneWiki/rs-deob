...
public class class231 implements class655 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(I)Lmh;", line = 4)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(BLjava/io/File;Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!ru", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!ru", name = "c", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ru", name = "a", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!ru", name = "<init>", descriptor = "(ILtca;Lvea;II)V", line = 173)
