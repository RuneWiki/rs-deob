...
public class class231 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIIFIILhj;[BFFIFFZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(B)V", line = 102)
