...
public class class231 extends class683 {
    ...
    @OriginalMember(owner = "client!cca", name = "<init>", descriptor = "(Lmq;)V", line = 10)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(IIIIB)V", line = 28)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(III)I", line = 63)
    ...
    @OriginalMember(owner = "client!cca", name = "a", descriptor = "(I)V", line = 92)
