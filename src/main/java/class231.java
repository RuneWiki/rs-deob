...
public class class231 extends class83 {
    ...
    @OriginalMember(owner = "client!jr", name = "d", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "()V", line = 14)
    public class231() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)[I", line = 28)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IBLtq;)V", line = 112)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IBI)I", line = 156)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZZ)V", line = 176)
