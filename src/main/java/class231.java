...
public class class231 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "()V", line = 4)
    public static final void method1584() {
        class169.method1171(1, class208.field2979);
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lic;ILic;)V", line = 13)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIIIIB)V", line = 32)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)V", line = 95)
