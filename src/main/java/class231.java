...
public class class231 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILsv;)Lsi;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(II)Lgl;")
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lad;ILdk;)V")
