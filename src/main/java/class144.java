...
public class class144 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IBIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 652)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lct;B)Z", line = 684)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILee;)V", line = 697)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "()V", line = 732)
    public class144() {
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lee;)V", line = 748)
