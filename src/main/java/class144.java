...
public class class144 extends class451 {
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lqj;Lqj;IZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIIFIZIII)[[I", line = 124)
