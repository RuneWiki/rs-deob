...
public class class144 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lkga;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lkga;Ljaclib/memory/Buffer;)V", line = 21)
