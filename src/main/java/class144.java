...
public class class144 {
    ...
    @OriginalMember(owner = "client!un", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILvga;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILjava/lang/String;I)I", line = 65)
    public static final int method1112(int arg0, String arg1, int arg2) {
        field2234++;
        return arg2 > -21 ? -73 : class440.method2705(82, arg1, arg0, true);
    }

    @OriginalMember(owner = "client!un", name = "<init>", descriptor = "(Lrs;J[Lwaa;)V", line = 75)
    public class144(class166 arg0, long arg1, class621[] arg2) {
        this.field2237 = arg1;
        this.field2233 = arg0;
    }

    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILofa;)V", line = 86)
