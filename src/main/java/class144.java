...
public class class144 extends class121 implements class276 {
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "()Z", line = 4)
    public final boolean method748() {
        return true;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILia;)V", line = 11)
    ...
    @OriginalMember(owner = "client!p", name = "e", descriptor = "()V", line = 63)
    public final void method721() {
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lvk;I)V", line = 69)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lvk;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lc;IIIZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IILia;Z)Z", line = 108)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()[Lu;", line = 112)
    public final class52[] method747() {
        return this.field2148;
    }

    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 115)
    protected final void finalize() {
        class236.method1601(-60, this);
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIII)V", line = 124)
    public final void method742(int arg0, int arg1, int arg2, int arg3) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BIZ)Lc;", line = 139)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "()[Lat;", line = 147)
    public final class255[] method703() {
        return this.field2149;
    }

    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Lqc;IIII)V", line = 158)
