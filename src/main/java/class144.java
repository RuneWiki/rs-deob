...
public class class144 extends class121 implements class276 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Llc;II)V")
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "()[Lnk;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()[Lwv;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Llc;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Lnd;IIII)V")
