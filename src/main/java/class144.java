...
public class class144 extends class311 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILij;)V", line = 4)
    ...
    @OriginalMember(owner = "client!sf", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZLjava/lang/String;IB)I", line = 45)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IBI)I", line = 126)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIILvg;)V", line = 145)
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IIIII)V", line = 169)
