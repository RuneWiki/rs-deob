...
public class class144 extends class493 {
    ...
    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILjava/awt/Canvas;ILd;ILni;)Lha;", line = 15)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(IZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Luv;)V", line = 63)
    public class144(class367 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wk", name = "c", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(III)V", line = 87)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(B)Z", line = 97)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IILbl;)V", line = 109)
