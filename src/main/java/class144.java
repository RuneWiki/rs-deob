...
public class class144 extends class450 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lwr;)V", line = 6)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III[I)V", line = 25)
    ...
    @OriginalMember(owner = "client!ng", name = "g", descriptor = "(I)[F", line = 35)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "([I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLwr;)V", line = 73)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III)V", line = 130)
    ...
    @OriginalMember(owner = "client!ng", name = "d", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "()V", line = 153)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(III)V", line = 176)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!ng", name = "h", descriptor = "(I)[F", line = 212)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "()Lng;", line = 241)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!ng", name = "f", descriptor = "(I)V", line = 278)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 301)
    public class144() {
        this.method931();
    }
}
