...
public class class144 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/lang/Throwable;ZLjava/lang/String;)V", line = 11)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(III)V", line = 86)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IBILg;)Lbg;", line = 138)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)Lbh;", line = 169)
