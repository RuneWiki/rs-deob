...
public class class144 extends class447 {
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Leb;I)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Leb;IB)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(BLeb;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(ILqj;Lqj;)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Leb;[II)V")
    ...
    @OriginalMember(owner = "client!rh", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!rh", name = "a", descriptor = "(Ljk;IIII)V")
