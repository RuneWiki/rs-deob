...
public class class144 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lgk;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ILgk;I)V", line = 67)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(I)Lut;", line = 114)
