...
public class class144 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(Laa;II)Ljf;", line = 47)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(II)Lwe;", line = 91)
    ...
    @OriginalMember(owner = "client!we", name = "<init>", descriptor = "(IIII)V", line = 101)
