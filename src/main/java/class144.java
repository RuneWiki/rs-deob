...
public class class144 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "([B)[Ltr;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lct;II)Ltr;")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Lct;II)[Ltr;")
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lct;I)Ltr;")
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Lct;I)[Ltr;")
