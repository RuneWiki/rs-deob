...
public class class144 extends class418 {
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IILsj;IIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!dd", name = "c", descriptor = "(I)V", line = 182)
    ...
    @OriginalMember(owner = "client!dd", name = "d", descriptor = "(I)V", line = 237)
