...
public class class144 extends class121 implements class276 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lnh;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()[Lvj;", line = 24)
    public final class304[] method770() {
        return this.field2062;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lc;IIIZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(BIZ)Lc;", line = 40)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lnh;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "()V", line = 63)
    public final void method796() {
    }

    @OriginalMember(owner = "client!p", name = "e", descriptor = "()Z", line = 72)
    public final boolean method801() {
        return true;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IIII)V", line = 76)
    public final void method763(int arg0, int arg1, int arg2, int arg3) {
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!p", name = "c", descriptor = "()[Lit;", line = 81)
    public final class456[] method789() {
        return this.field2063;
    }

    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IILia;Z)Z", line = 86)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(ILia;)V", line = 91)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 151)
    protected final void finalize() {
        class390.method2237(true, this);
    }

    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Lwk;IIII)V", line = 157)
