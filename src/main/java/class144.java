...
public class class144 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)[[[B", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(II)Lme;", line = 786)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z)V", line = 809)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILqp;)I", line = 822)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(II)I", line = 878)
    public static final int method1138(int arg0, int arg1) {
        field2253++;
        return arg1 == 1 ? arg0 & 0x7F : 109;
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BI)V", line = 889)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)V", line = 901)
