...
public class class144 extends class228 {
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lsj;ILpe;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(ZILhh;Lpe;III)V")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(Lpe;B)Lca;")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IILpe;I)Z")
    ...
    @OriginalMember(owner = "client!sf", name = "a", descriptor = "(IILpe;)Lsj;")
