...
public class class144 implements Runnable {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(IB[BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!br", name = "run", descriptor = "()V", line = 95)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(Ljava/net/Socket;Lhs;)V", line = 329)
    ...
    @OriginalMember(owner = "client!br", name = "finalize", descriptor = "()V", line = 212)
    protected final void finalize() {
        field1903++;
        this.method1003(1);
    }

    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)I", line = 221)
    ...
    @OriginalMember(owner = "client!br", name = "d", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "([BIII)V", line = 255)
    ...
    @OriginalMember(owner = "client!br", name = "b", descriptor = "(B)V", line = 284)
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(B)I", line = 301)
