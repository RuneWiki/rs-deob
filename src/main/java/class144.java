...
public class class144 extends class156 {
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "()I", line = 10)
    public final int method198() {
        return this.field2199 - (this.field2197.available() >> (class368.field5405 ? 2 : 1));
    }

    @OriginalMember(owner = "client!eq", name = "b", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 55)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 81)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!eq", name = "c", descriptor = "()V", line = 139)
