...
public class class144 implements Runnable {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)Z", line = 14)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILcc;[[B)V", line = 30)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILiw;)V", line = 75)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(CI)Z", line = 114)
    ...
    @OriginalMember(owner = "client!kc", name = "run", descriptor = "()V", line = 125)
    ...
    @OriginalMember(owner = "client!kc", name = "d", descriptor = "(I)Lida;", line = 259)
    ...
    @OriginalMember(owner = "client!kc", name = "e", descriptor = "(I)V", line = 271)
    ...
    @OriginalMember(owner = "client!kc", name = "f", descriptor = "(I)Ljava/lang/String;", line = 282)
    ...
    @OriginalMember(owner = "client!kc", name = "g", descriptor = "(I)I", line = 294)
    public final int method1009(int arg0) {
        field1938++;
        return arg0 == 19684 ? this.field1944 : -7;
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BILjava/lang/String;JLida;)V", line = 309)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Z)V", line = 322)
    public final void method1011(boolean arg0) {
        this.field1928 = arg0;
        field1926++;
    }

    @OriginalMember(owner = "client!kc", name = "h", descriptor = "(I)J", line = 331)
