...
public class class144 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Z)V", line = 86)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIIIII)I", line = 105)
    ...
    @OriginalMember(owner = "client!ev", name = "toString", descriptor = "()Ljava/lang/String;", line = 143)
