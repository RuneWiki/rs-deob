...
public abstract class class144 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IILgh;Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(II)Z", line = 77)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(B)V", line = 101)
