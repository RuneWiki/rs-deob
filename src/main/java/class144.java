...
public class class144 extends class381 implements class159 {
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "()V", line = 3)
    public final void method468() {
        this.field5239.method451(this);
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "()I", line = 9)
    public final int method464() {
        return super.method464();
    }

    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(I[BI)V", line = 13)
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lfu;I[BIZ)V", line = 18)
