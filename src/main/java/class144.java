...
public class class144 {
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(ZLme;)V", line = 3)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(I)Lme;", line = 37)
    ...
    @OriginalMember(owner = "client!eea", name = "<init>", descriptor = "()V", line = 356)
    public class144() {
        this.field1810.field2467 = this.field1810;
        this.field1810.field2468 = this.field1810;
    }

    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!eea", name = "b", descriptor = "(I)I", line = 295)
    ...
    @OriginalMember(owner = "client!eea", name = "c", descriptor = "(I)V", line = 323)
    ...
    @OriginalMember(owner = "client!eea", name = "c", descriptor = "(B)Z", line = 345)
    ...
    @OriginalMember(owner = "client!eea", name = "a", descriptor = "(Z)Lme;", line = 366)
