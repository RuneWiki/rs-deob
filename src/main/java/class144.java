...
public class class144 extends class45 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)Lvc;", line = 6)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lni;)V", line = 371)
    public class144(class246 arg0) {
        this.field1973 = arg0;
    }

    @OriginalMember(owner = "client!la", name = "b", descriptor = "(III)Z", line = 33)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(JZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)V", line = 87)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLjava/lang/String;IZ)Z", line = 109)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(B)V", line = 201)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIZ)V", line = 216)
