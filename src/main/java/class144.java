...
public class class144 extends class98 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILdg;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(II)[[I", line = 43)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(IB)Loa;", line = 81)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZII)Ljm;", line = 114)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IILae;IIBLhb;Lon;I)V", line = 127)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(I)V", line = 227)
    private class144(int arg0) {
        super(0, false);
        this.method880(arg0, (byte) 114);
    }

    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(IB)V", line = 237)
    ...
    @OriginalMember(owner = "client!cl", name = "f", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIIIIB)V", line = 264)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "()V", line = 397)
    public class144() {
        this(0);
    }
}
