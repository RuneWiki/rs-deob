...
public class class144 extends class121 implements class276 {
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "()[Lau;")
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "()[Lqm;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lfo;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lfo;II)V")
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Lwp;IIII)V")
