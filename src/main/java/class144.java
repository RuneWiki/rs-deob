...
public class class144 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IB)Lob;", line = 91)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Z)V", line = 121)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIII)I", line = 133)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(FFFFLgl;II[BIIIFI)V", line = 151)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lal;ILmg;)V", line = 175)
