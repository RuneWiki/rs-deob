...
public class class144 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 6)
    public static void method1045(byte arg0) {
        int var1 = -21 / ((25 - arg0) / 46);
        field2271 = null;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLmo;Lmo;)V", line = 25)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lid;ILe;IIIILgn;IZIIIIB)Lid;", line = 43)
