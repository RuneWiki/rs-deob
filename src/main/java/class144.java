...
public class class144 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "([SII)[S", line = 3)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)Lrr;", line = 29)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILua;IJIILwv;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)V", line = 115)
