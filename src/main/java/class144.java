...
public class class144 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lsl;B)Lqa;", line = 3)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)Ldk;", line = 36)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(III)I", line = 56)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZI)Ldd;", line = 87)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(IIII)V", line = 102)
