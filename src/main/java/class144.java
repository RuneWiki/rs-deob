...
public class class144 extends class715 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IB)Z", line = 44)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "([Lqe;)V", line = 54)
    public class144(class491[] arg0) {
        this.field1837 = arg0;
    }

    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(II)I", line = 75)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(III)Z", line = 128)
