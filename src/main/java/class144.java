...
public class class144 extends class333 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(II)V", line = 118)
