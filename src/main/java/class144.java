...
public class class144 extends class719 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V")
    ...
    @OriginalMember(owner = "client!bw", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
