...
public class class144 implements class419 {
    ...
    @OriginalMember(owner = "client!faa", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!faa", name = "c", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(B)Ldda;", line = 32)
    ...
    @OriginalMember(owner = "client!faa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 45)
    public class144(String arg0) {
        this.field1738 = arg0;
    }

    @OriginalMember(owner = "client!faa", name = "a", descriptor = "(I)I", line = 58)
