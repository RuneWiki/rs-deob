...
public class class144 extends class121 implements class276 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lsf;II)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Lsf;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()[Lwq;")
    ...
    @OriginalMember(owner = "client!p", name = "e", descriptor = "()[Lqr;")
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Llo;IIII)V")
