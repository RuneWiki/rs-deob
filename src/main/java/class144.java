...
public class class144 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(ZII)V", line = 5)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IZILje;I)V", line = 95)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIIII)Z", line = 175)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(BI)V", line = 234)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(IIIII)V", line = 331)
