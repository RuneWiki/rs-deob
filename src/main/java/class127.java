...
public class class127 extends class428 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!co", name = "h", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lln;BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lns;ZB)V", line = 55)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Z)V", line = 219)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZI)V", line = 246)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lgca;)V", line = 279)
    public class127(class261 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!co", name = "f", descriptor = "(I)Z", line = 282)
