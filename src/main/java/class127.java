...
public class class127 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IIZIZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(II)Z", line = 59)
    public final boolean method896(int arg0, int arg1) {
        field1760++;
        return arg0 == 1 ? this.field1753[arg1].method77(108) : false;
    }

    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 71)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lou;II)Z", line = 174)
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Lkw;)V", line = 319)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "([Ljava/lang/Object;I[JIB)V", line = 221)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(FFFB)I", line = 277)
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "([SIZ)[S", line = 345)
