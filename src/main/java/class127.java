...
public class class127 extends class390 {
    ...
    @OriginalMember(owner = "client!qo", name = "g", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!qo", name = "h", descriptor = "(I)Z", line = 21)
    ...
    @OriginalMember(owner = "client!qo", name = "e", descriptor = "(B)I", line = 37)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)Z", line = 53)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIZII)V", line = 69)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lec;I)V", line = 83)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZIII)V", line = 278)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IBZIILnf;Lja;)V", line = 304)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZB)Ljava/lang/String;", line = 315)
    ...
    @OriginalMember(owner = "client!qo", name = "i", descriptor = "(B)V", line = 357)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)I", line = 379)
    ...
    @OriginalMember(owner = "client!qo", name = "e", descriptor = "(I)I", line = 390)
    ...
    @OriginalMember(owner = "client!qo", name = "d", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lja;BI)Z", line = 426)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BLja;)Lkh;", line = 570)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(ZI)Ljava/lang/String;", line = 714)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lrc;IILja;BLpo;II)V", line = 745)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)I", line = 771)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lmb;Z)Lmb;", line = 783)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILja;)V", line = 816)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILja;II)Z", line = 851)
