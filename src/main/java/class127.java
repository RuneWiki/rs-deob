...
public class class127 extends class187 {
    ...
    @OriginalMember(owner = "client!om", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(II)Z", line = 40)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IZ)Z", line = 51)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)Z", line = 62)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIIII)I", line = 153)
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZB)V", line = 170)
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(I)V", line = 203)
