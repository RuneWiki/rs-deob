...
public class class127 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(B)Ltda;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Z)Ltda;")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ltda;B)V")
