...
public class class127 extends class111 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)Lvm;", line = 9)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lnf;I)V", line = 18)
    public class127(class256 arg0, int arg1) {
        this.field1773 = arg0;
        this.field1774 = new class322(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lvm;FLvm;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)I", line = 111)
