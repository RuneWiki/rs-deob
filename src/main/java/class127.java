...
public class class127 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BLuo;)V", line = 21)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(ILol;II)J", line = 129)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(BLuo;)V", line = 167)
