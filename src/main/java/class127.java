...
public abstract class class127 implements class299 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IILjaclib/memory/Source;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IB)V", line = 57)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)I", line = 87)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Lck;IZ)V", line = 275)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z", line = 108)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(I)J", line = 140)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ZLjaggl/MapBuffer;B)Ljaclib/memory/Buffer;", line = 176)
    ...
    @OriginalMember(owner = "client!eda", name = "finalize", descriptor = "()V", line = 219)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(I)V", line = 234)
    ...
    @OriginalMember(owner = "client!eda", name = "d", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIIII)V", line = 288)
