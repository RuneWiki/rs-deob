...
public class class127 extends class100 implements class258 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lha;Liv;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(ILha;)Ljda;")
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(Lha;I)Lhw;")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;IZLga;IBI)V")
