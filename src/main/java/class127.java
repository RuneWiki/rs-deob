...
public class class127 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)Lop;")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILkh;)V")
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)Lkv;")
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lop;I)V")
