...
public class class127 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IC)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljava/lang/String;ZBI)I", line = 20)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIZ)V", line = 143)
