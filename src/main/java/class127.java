...
public class class127 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZBLfp;)Lae;")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILat;I)V")
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IILat;I)V")
