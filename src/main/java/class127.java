...
public class class127 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BII[B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(ZIIIZ)Lss;", line = 43)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(II)V", line = 99)
