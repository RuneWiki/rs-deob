...
public abstract class class127 extends class159 {
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Z)I", line = 62)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(DZ)V", line = 75)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(B)I", line = 89)
    public final int method901(byte arg0) {
        field1737++;
        return arg0 == -115 ? this.field1748 : -82;
    }

    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(I)F", line = 100)
    ...
    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(B)I", line = 111)
    ...
    @OriginalMember(owner = "client!uaa", name = "f", descriptor = "(I)I", line = 122)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(IIIIIF)V", line = 142)
