...
public class class127 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ZI)Ljava/lang/String;", line = 45)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B[B)V", line = 90)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "([BI[B)V", line = 292)
