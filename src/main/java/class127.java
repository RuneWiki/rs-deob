...
public class class127 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Ljava/lang/Object;Lws;I)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILws;)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lvn;Z)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lws;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILjava/lang/Object;Lws;Z)V")
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IILpa;Lwca;IIIBJ)V")
