...
public class class127 {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ut", name = "b", descriptor = "(I)V", line = 48)
    public static void method954(int arg0) {
        field1809 = null;
        int var1 = 21 % ((-arg0 - 30) / 60);
    }

    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(II)Lkb;", line = 58)
    ...
    @OriginalMember(owner = "client!ut", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IB)V", line = 107)
    ...
    @OriginalMember(owner = "client!ut", name = "<init>", descriptor = "(Lal;ILnd;Lnd;)V", line = 133)
