...
public class class127 {
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(IB)V", line = 39)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BILcj;Lha;)V", line = 55)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(II)Lbs;", line = 386)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(B)V", line = 413)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(ZI)V", line = 431)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BI)V", line = 444)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(II)Lvq;", line = 463)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lgia;ILaj;Laj;Laj;)V", line = 504)
