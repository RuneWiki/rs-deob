...
public class class127 extends class60 implements class116 {
    ...
    @OriginalMember(owner = "client!ao", name = "c", descriptor = "(ILoj;)Lmg;", line = 3)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILoj;)V", line = 62)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(I)Z", line = 104)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Loj;ZII)Lpr;", line = 115)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(I)Z", line = 148)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILoj;B)Lqh;", line = 161)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ILoj;II)Z", line = 195)
    ...
    @OriginalMember(owner = "client!ao", name = "h", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Loj;II)Lqh;", line = 228)
    ...
    @OriginalMember(owner = "client!ao", name = "e", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!ao", name = "d", descriptor = "(ILoj;)V", line = 266)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(Z)I", line = 276)
    public final int method16(boolean arg0) {
        ++field1553;
        return arg0 ? -44 : 65535 & this.field1557;
    }

    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIZLa;IBLoj;)V", line = 291)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(ILoj;)V", line = 310)
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Loj;Lcu;IIIIZIZ)V", line = 338)
    ...
    @OriginalMember(owner = "client!ao", name = "b", descriptor = "(B)I", line = 375)
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(IIIIIII)V", line = 385)
