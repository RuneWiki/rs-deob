...
public class class127 extends class58 {
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(FLgda;Lgda;Z)Z", line = 17)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I[BBIILjava/lang/String;)I", line = 219)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(I)Lgda;", line = 357)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(Ljaa;I)V", line = 368)
