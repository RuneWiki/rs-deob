...
public class class127 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IF[BFFIFIIIILdd;F)V", line = 126)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lru;III)V", line = 151)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 181)
