...
public class class127 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(FFIIF)F", line = 3)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 34)
