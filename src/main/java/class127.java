...
public class class127 extends class134 {
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Lkda;)V", line = 3)
    public class127(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(ILkda;)V", line = 99)
