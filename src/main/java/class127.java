...
public class class127 extends InputStream {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(ILhn;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(BII)Ljava/lang/String;", line = 64)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(III)Z", line = 106)
    ...
    @OriginalMember(owner = "client!qea", name = "read", descriptor = "()I", line = 117)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(I)V", line = 128)
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(ILvk;Ljava/awt/Component;II)Lvo;", line = 168)
