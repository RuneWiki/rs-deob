...
public class class127 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IZLta;)Z", line = 25)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 45)
