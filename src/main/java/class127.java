...
public class class127 extends class56 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BI)Ljb;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILee;I)V")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BZII)I")
