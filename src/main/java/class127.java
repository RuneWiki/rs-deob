...
public class class127 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BLjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
