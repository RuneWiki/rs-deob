...
public class class127 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IB)Lfp;", line = 4)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(I)Llda;", line = 33)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BJ)V", line = 54)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)Llda;", line = 76)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(ILjava/lang/String;ILhk;)Lwea;", line = 98)
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "()V", line = 140)
    public class127() {
    }

    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Loaa;)V", line = 144)
