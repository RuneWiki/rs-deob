...
public class class127 extends class108 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(IIIIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ZIIIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(ILui;II)V", line = 195)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(B)V", line = 939)
