...
public abstract class class127 extends class43 {
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!ue", name = "f", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(II)V", line = 82)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IB)V", line = 104)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(IIIIII)I", line = 128)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(IIIZZ)V", line = 202)
