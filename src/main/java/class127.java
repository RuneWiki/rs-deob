...
public class class127 extends class354 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IB)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(III)Z", line = 68)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lnj;II)V", line = 189)
    ...
    @OriginalMember(owner = "client!op", name = "h", descriptor = "(I)V", line = 236)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "()V", line = 246)
    public class127() {
        super(1, false);
    }

    @OriginalMember(owner = "client!op", name = "b", descriptor = "(B)V", line = 265)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(IIIIIII)V", line = 287)
