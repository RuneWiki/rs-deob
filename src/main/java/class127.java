...
public class class127 extends class619 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(ILha;)Lfd;")
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
