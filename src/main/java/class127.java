...
public class class127 extends class620 {
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(Z)Z", line = 32)
    ...
    @OriginalMember(owner = "client!rea", name = "d", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Loha;Lka;ILha;)V", line = 57)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lha;JI)V", line = 83)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(III)Lsi;", line = 120)
    ...
    @OriginalMember(owner = "client!rea", name = "finalize", descriptor = "()V", line = 133)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ZIBLlq;Lha;II)V", line = 148)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(ILha;)Lid;", line = 174)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(II)V", line = 184)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(ILha;)Lpi;", line = 216)
    ...
    @OriginalMember(owner = "client!rea", name = "d", descriptor = "(B)Z", line = 262)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IILha;I)Z", line = 276)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 289)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(Lha;I)V", line = 303)
    ...
    @OriginalMember(owner = "client!rea", name = "e", descriptor = "(B)I", line = 338)
    public final int method745(byte arg0) {
        ++field1675;
        return arg0 >= -85 ? -117 : this.field1695;
    }

    @OriginalMember(owner = "client!rea", name = "g", descriptor = "(I)V", line = 361)
    ...
    @OriginalMember(owner = "client!rea", name = "e", descriptor = "(I)I", line = 371)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILha;II)Lka;", line = 382)
