...
public class class127 extends class467 {
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IIC)I", line = 18)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Lqa;Lqv;III)V", line = 43)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "()V", line = 98)
    public class127() {
    }

    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 103)
