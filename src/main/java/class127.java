...
public class class127 extends class362 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILpe;I)Z", line = 27)
    ...
    @OriginalMember(owner = "client!qo", name = "l", descriptor = "(I)Z", line = 60)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZILhh;Lpe;III)V", line = 74)
    ...
    @OriginalMember(owner = "client!qo", name = "f", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILpe;Z)Z", line = 142)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lqr;I)V", line = 260)
    ...
    @OriginalMember(owner = "client!qo", name = "g", descriptor = "(I)I", line = 278)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILpe;)V", line = 289)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(IIII)Z", line = 309)
    ...
    @OriginalMember(owner = "client!qo", name = "e", descriptor = "(I)Z", line = 322)
    ...
    @OriginalMember(owner = "client!qo", name = "g", descriptor = "(B)Z", line = 335)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lpe;B)Lca;", line = 346)
    ...
    @OriginalMember(owner = "client!qo", name = "m", descriptor = "(I)V", line = 424)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(Z)V", line = 439)
    ...
    @OriginalMember(owner = "client!qo", name = "n", descriptor = "(I)V", line = 459)
    ...
    @OriginalMember(owner = "client!qo", name = "i", descriptor = "(I)I", line = 469)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(B)V", line = 492)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)I", line = 506)
