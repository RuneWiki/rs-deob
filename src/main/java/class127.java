...
public abstract class class127 implements class398 {
    ...
    @OriginalMember(owner = "client!ue", name = "finalize", descriptor = "()V", line = 7)
    protected final void finalize() throws Throwable {
        this.method871();
        super.finalize();
    }

    @OriginalMember(owner = "client!ue", name = "b", descriptor = "()I", line = 12)
    public final int method862() {
        return this.field1788;
    }

    @OriginalMember(owner = "client!ue", name = "c", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!ue", name = "d", descriptor = "()Z", line = 39)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(I)I", line = 70)
    ...
    @OriginalMember(owner = "client!ue", name = "e", descriptor = "()I", line = 97)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(Z)V", line = 102)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V", line = 112)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V", line = 200)
    ...
    @OriginalMember(owner = "client!ue", name = "f", descriptor = "()V", line = 298)
    ...
    @OriginalMember(owner = "client!ue", name = "b", descriptor = "(I)V", line = 308)
    private final void method872(int arg0) {
        this.field1787.field3198 -= arg0;
        this.field1787.field3198 += this.method867();
    }

    @OriginalMember(owner = "client!ue", name = "c", descriptor = "(I)I", line = 312)
    ...
    @OriginalMember(owner = "client!ue", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V", line = 333)
    ...
    @OriginalMember(owner = "client!ue", name = "<init>", descriptor = "(Ltb;IIIZ)V", line = 428)
