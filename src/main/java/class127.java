...
public class class127 extends class5 {
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(ILea;)Lms;")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BILea;)Lts;")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILea;Lts;)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IILea;Lac;ZII)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Lea;I)V")
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZILea;I)Z")
