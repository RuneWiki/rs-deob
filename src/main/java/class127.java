...
public class class127 {
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(J[IILbja;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(II)Lph;")
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(ILbt;Lbt;Lcda;)V")
