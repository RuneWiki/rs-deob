...
public class class127 {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(Z)Ldf;")
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIILka;Lka;IIJ)V")
