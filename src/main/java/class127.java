...
public class class127 extends class497 {
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!vt", name = "c", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BI)I", line = 167)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(Lpp;)V", line = 180)
    public class127(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(ILpp;)V", line = 184)
    public class127(int arg0, class640 arg1) {
        super(arg1);
    }

    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(BIIIII)V", line = 189)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 216)
