...
public class class127 {
    ...
    @OriginalMember(owner = "client!ld", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field1648++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ld", name = "<init>", descriptor = "(I)V", line = 15)
    public class127(int arg0) {
        this.field1646 = arg0;
    }

    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(IIIBII)I", line = 23)
    ...
    @OriginalMember(owner = "client!ld", name = "a", descriptor = "(ZIIBII)V", line = 82)
