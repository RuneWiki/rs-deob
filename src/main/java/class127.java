...
public class class127 extends class413 {
    ...
    @OriginalMember(owner = "client!qea", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qea", name = "<init>", descriptor = "(I)V", line = 16)
    public class127(int arg0) {
        this.field1331 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!qea", name = "a", descriptor = "([Lrr;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!qea", name = "b", descriptor = "(B)V", line = 68)
