...
public class class127 extends class533 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lgl;FLgl;Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lkd;I)V", line = 206)
    public class127(class188 arg0, int arg1) {
        this.field1861 = arg0;
        this.field1859 = new class428(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIII)V", line = 221)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "([Ljava/lang/Object;[JI)V", line = 244)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IB)V", line = 255)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(I)Lgl;", line = 289)
    ...
    @OriginalMember(owner = "client!vp", name = "b", descriptor = "(B)I", line = 302)
