...
public class class127 extends class416 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([SIB)[S", line = 3)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 51)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(I)V", line = 352)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IB)Z", line = 416)
    ...
    @OriginalMember(owner = "client!ju", name = "d", descriptor = "(Z)J", line = 427)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)I", line = 438)
    ...
    @OriginalMember(owner = "client!ju", name = "e", descriptor = "(I)V", line = 449)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(II)V", line = 466)
