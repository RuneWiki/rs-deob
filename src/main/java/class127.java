...
public class class127 extends class222 {
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)Lvea;", line = 3)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)[Lnd;", line = 191)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "([BIILjava/lang/String;BI)I", line = 207)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)V", line = 360)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lsv;IIIIII)V", line = 370)
