...
public class class127 extends class574 implements class219 {
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lmr;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II[S)[S")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(I)[Lqg;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
