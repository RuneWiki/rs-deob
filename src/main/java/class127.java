...
public class class127 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZLjava/lang/String;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(IBIIIIIII)Z", line = 39)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZLbt;)V", line = 57)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(III)Z", line = 113)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(II)I", line = 124)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(II)Z", line = 149)
    ...
    @OriginalMember(owner = "client!dq", name = "b", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!dq", name = "c", descriptor = "(II)I", line = 198)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BILbt;)V", line = 211)
    ...
    @OriginalMember(owner = "client!dq", name = "d", descriptor = "(II)Ljava/lang/String;", line = 267)
