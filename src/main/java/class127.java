...
public class class127 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILgh;Lgh;)V", line = 4)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IB)S", line = 29)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIII)Lop;", line = 68)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 113)
