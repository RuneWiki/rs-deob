...
public class class636 extends class496 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(II[FIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "([Lha;I)V", line = 100)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BI[I[ILos;I)Loba;", line = 157)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(II)V", line = 192)
