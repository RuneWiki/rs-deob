...
public class class636 {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(ILko;)V", line = 17)
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(II)Lko;", line = 28)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "(Lko;)V", line = 44)
    public class636(class255 arg0) {
        this.field8790 = arg0.field3342;
        this.field8794 = 1;
    }

    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(I)I", line = 57)
    ...
    @OriginalMember(owner = "client!qp", name = "b", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qp", name = "<init>", descriptor = "([Lko;)V", line = 77)
    public class636(class255[] arg0) {
    ...
    @OriginalMember(owner = "client!qp", name = "a", descriptor = "(IZ)I", line = 92)
