...
public class class636 extends class401 {
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Z)[Lrg;", line = 13)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(I)I", line = 73)
