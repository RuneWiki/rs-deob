...
public class class636 extends class67 {
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Lkd;Llq;[Liga;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(CIIIZLaa;II)V", line = 307)
    public final void method129(char arg0, int arg1, int arg2, int arg3, boolean arg4, class512 arg5, int arg6, int arg7) {
    }

    @OriginalMember(owner = "client!ji", name = "fa", descriptor = "(CIIIZ)V", line = 313)
