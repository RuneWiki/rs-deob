...
public abstract class class636 extends class649 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IIII)Z", line = 120)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(B)V", line = 170)
