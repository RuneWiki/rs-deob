...
public class class636 {
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(II)Lkv;")
    ...
    @OriginalMember(owner = "client!nfa", name = "a", descriptor = "(Loa;Lvi;B)I")
    ...
    @OriginalMember(owner = "client!nfa", name = "<init>", descriptor = "(ILpfa;Lpfa;)V")
