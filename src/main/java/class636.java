...
public class class636 extends class170 {
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "()Los;", line = 4)
    public final class170 method1086() {
        return (class170) this.field8972.method3561((byte) 116);
    }

    @OriginalMember(owner = "client!caa", name = "e", descriptor = "()I", line = 10)
    public final int method1054() {
        return 0;
    }

    @OriginalMember(owner = "client!caa", name = "c", descriptor = "()Los;", line = 13)
    public final class170 method1065() {
        return (class170) this.field8972.method3565(-73);
    }

    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Los;)V", line = 16)
    public final synchronized void method3652(class170 arg0) {
        arg0.method2656((byte) 121);
    }

    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!caa", name = "c", descriptor = "([III)V", line = 76)
    ...
    @OriginalMember(owner = "client!caa", name = "f", descriptor = "()I", line = 85)
    public final synchronized int method3654() {
        return this.field8972.method3557(-93);
    }

    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Lqm;Lkp;)V", line = 88)
    ...
    @OriginalMember(owner = "client!caa", name = "g", descriptor = "()V", line = 96)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "([III)V", line = 118)
    ...
    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(Los;)V", line = 164)
    public final synchronized void method3657(class170 arg0) {
        this.field8972.method3558(0, arg0);
    }

    @OriginalMember(owner = "client!caa", name = "b", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!caa", name = "a", descriptor = "(Lkp;)V", line = 184)
