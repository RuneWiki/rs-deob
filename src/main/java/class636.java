...
public class class636 extends class356 {
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!sfa", name = "e", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!sfa", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!sfa", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!sfa", name = "c", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!sfa", name = "<init>", descriptor = "(Lhaa;Lhm;)V", line = 108)
