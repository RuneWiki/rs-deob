...
public class class636 extends class244 {
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!eu", name = "c", descriptor = "(IIII)[B", line = 27)
    ...
    @OriginalMember(owner = "client!eu", name = "d", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "()V", line = 52)
    public class636() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(BIZ)V", line = 64)
