...
public class class636 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IBI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!pe", name = "toString", descriptor = "()Ljava/lang/String;", line = 28)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(IIII)V", line = 40)
