...
public class class636 extends class774 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIII)[B", line = 5)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILwm;IIZI)V", line = 37)
    ...
    @OriginalMember(owner = "client!eb", name = "f", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "()V", line = 59)
    public class636() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BIB)V", line = 65)
