...
public class class636 {
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "([BI)Lufa;", line = 21)
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(IILha;Lkia;)V", line = 68)
