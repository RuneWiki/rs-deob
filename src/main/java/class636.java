...
public class class636 implements class126 {
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(I)Lgj;", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!jk", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(Lvd;)V", line = 74)
    public class636(class39 arg0) {
        this.field8938 = arg0;
    }

    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(B)I", line = 82)
