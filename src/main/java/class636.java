...
public class class636 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lfm;I)Z")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lqf;III)V")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lrt;Z)V")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Lrt;)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
