...
public class class636 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!fe", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 15)
    public class636(String arg0, int arg1) {
        this.field8937 = arg1;
    }

    @OriginalMember(owner = "client!fe", name = "toString", descriptor = "()Ljava/lang/String;", line = 29)
    public final String toString() {
        field8938++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(II)I", line = 56)
