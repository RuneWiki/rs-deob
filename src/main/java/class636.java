...
public class class636 extends class142 implements class289 {
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Loa;Luca;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(BLoa;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IILoa;)Lba;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILoa;B)Lba;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IZLoa;Z)Ltaa;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIILoa;)Z")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Loa;B)Llt;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BLoa;)Lvg;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILoa;)V")
