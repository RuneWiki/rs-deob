...
public class class636 {
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(ZI[B)V", line = 53)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IZII)V", line = 107)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(Z)V", line = 161)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(IIII[I)V", line = 270)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(J[BI)V", line = 303)
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(III)Lbh;", line = 399)
