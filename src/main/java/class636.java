...
public class class636 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lks;II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 168)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BI)Lqb;", line = 181)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IB)V", line = 224)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)V", line = 238)
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lrf;ILpl;)V", line = 277)
