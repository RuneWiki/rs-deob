...
public class class636 extends class682 {
    ...
    @OriginalMember(owner = "client!fw", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(Lkfa;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(III)Z")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IILhk;I)V")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!fw", name = "v", descriptor = "(IILha;)Lha;")
    ...
    @OriginalMember(owner = "client!fw", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lam;[I)V")
