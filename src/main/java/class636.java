...
public class class636 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILfd;I)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lfd;B)V")
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IBLrba;I)Ljk;")
