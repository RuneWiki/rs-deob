...
public class class671 {
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(Lkga;[IBI[II)Lpg;")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(BLun;)V")
    ...
    @OriginalMember(owner = "client!rl", name = "a", descriptor = "(ILun;I)V")
