...
public abstract class class671 implements class553 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljaggl/MapBuffer;Z)Z")
    ...
    @OriginalMember(owner = "client!q", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljaclib/memory/Source;II)Z")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljaggl/MapBuffer;IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lsb;IZ)V")
