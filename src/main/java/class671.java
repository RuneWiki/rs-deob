...
public class class671 extends class349 {
    ...
    @OriginalMember(owner = "client!vd", name = "b", descriptor = "(BI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IB)[[I", line = 38)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IILdga;)V", line = 83)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "()V", line = 98)
    public class671() {
        super(1, false);
    }

    @OriginalMember(owner = "client!vd", name = "f", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IILoa;Le;III)V", line = 114)
