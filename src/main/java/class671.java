...
public class class671 {
    ...
    @OriginalMember(owner = "client!pca", name = "toString", descriptor = "()Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IILst;IB)V", line = 494)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)V", line = 528)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 568)
