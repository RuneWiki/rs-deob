...
public class class671 {
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(B)Lkba;", line = 3)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BLtia;)V", line = 26)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(BLgs;)V", line = 47)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(Lno;B)V", line = 68)
    ...
    @OriginalMember(owner = "client!fb", name = "b", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!fb", name = "a", descriptor = "(ZLgs;)V", line = 108)
    ...
    @OriginalMember(owner = "client!fb", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 151)
