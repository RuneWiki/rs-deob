...
public class class671 extends class443 {
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lrp;Lrt;[Lde;[I[I)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(CIIIZLaa;II)V")
    ...
    @OriginalMember(owner = "client!cm", name = "fa", descriptor = "(CIIIZ)V")
