...
public class class671 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(IIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(BC)C", line = 71)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!dr", name = "b", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(III)Z", line = 222)
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "()V", line = 235)
