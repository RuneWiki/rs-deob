...
public class class671 extends class211 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(II)[[I", line = 7)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(IIILqa;Lqa;)V", line = 73)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "()V", line = 145)
    public class671() {
        super(1, false);
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(BILib;)V", line = 148)
