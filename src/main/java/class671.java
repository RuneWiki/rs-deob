...
public class class671 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)Llh;", line = 3)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IJ)Llh;", line = 39)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BJLlh;)V", line = 79)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIIIIZI)V", line = 100)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIB)I", line = 163)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(I)V", line = 189)
