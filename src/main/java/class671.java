...
public class class671 extends class620 {
    ...
    @OriginalMember(owner = "client!naa", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!naa", name = "d", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "([BI)Lit;", line = 37)
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lpl;Lpl;Laea;)V", line = 117)
    public class671(class612 arg0, class612 arg1, class39 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!naa", name = "e", descriptor = "(B)Leaa;", line = 124)
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IBIII)V", line = 135)
