...
public class class671 extends class299 implements class556 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)I", line = 17)
    public final int method1755(int arg0) {
        ++field9547;
        return arg0 != 16383 ? -48 : super.method1755(arg0);
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(B)Lvea;", line = 28)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(III)Z", line = 44)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;", line = 57)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(II)V", line = 73)
    public final void method1765(int arg0, int arg1) {
        super.method1765(this.field9543.field5334 * arg0, arg1);
        ++field9539;
    }

    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!sh", name = "d", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Lqi;Lvea;Z)V", line = 110)
    public class671(class510 arg0, class404 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field9543 = arg1;
    }

    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(IIIIIII)Z", line = 118)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lir;III)V", line = 181)
