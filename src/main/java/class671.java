...
public class class671 extends class152 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILjava/lang/String;Lbq;Lha;ZLda;)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZLes;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)Lbja;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Lkq;B)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(Les;II)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "([ILes;I)V")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZ)Lbja;")
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BLes;)V")
