...
public class class671 extends class55 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IILcn;BFFIFIIF[BF)V", line = 19)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(II)V", line = 48)
