...
public class class671 extends class371 implements class471 {
    ...
    @OriginalMember(owner = "client!mja", name = "b", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Lcka;Ltn;Lds;II)V")
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Lcka;Ltn;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Lcka;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(ILtn;IIBI[BII)V")
    ...
    @OriginalMember(owner = "client!mja", name = "a", descriptor = "(BLqt;)V")
