...
public class class671 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lgia;IZLaj;Laj;)V", line = 237)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(BI)Lpu;", line = 82)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 146)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(II)V", line = 157)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!ph", name = "b", descriptor = "(IZ)V", line = 195)
