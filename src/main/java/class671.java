...
public class class671 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lha;[II)V")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lha;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lha;[II[I[I)V")
