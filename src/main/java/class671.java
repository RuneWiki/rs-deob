...
public class class671 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lha;B)V", line = 11)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!nia", name = "finalize", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(ILs;)V", line = 53)
    public static final void method3812(int arg0, class294 arg1) {
        class208.field3219[arg0] = arg1;
    }

    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lje;I)V", line = 56)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(IILha;ZZ)Lka;", line = 172)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(II)V", line = 310)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lha;Z)V", line = 434)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(ILka;IIIIZLqja;Lha;)V", line = 448)
    ...
    @OriginalMember(owner = "client!nia", name = "<init>", descriptor = "(Lha;Lkv;IIIILje;ZI)V", line = 576)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Lmi;I)V", line = 500)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(B)Z", line = 519)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(I)I", line = 535)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(I)V", line = 566)
