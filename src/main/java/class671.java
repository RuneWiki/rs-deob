...
public class class671 extends class283 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ZII)V", line = 29)
    ...
    @OriginalMember(owner = "client!mea", name = "c", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lkw;)V", line = 65)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)Z", line = 102)
    ...
    @OriginalMember(owner = "client!mea", name = "d", descriptor = "(I)V", line = 115)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Ljava/net/Socket;II)Loi;", line = 129)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(B)V", line = 141)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Lou;II)V", line = 175)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(IZ)V", line = 216)
    ...
    @OriginalMember(owner = "client!mea", name = "e", descriptor = "(I)V", line = 236)
