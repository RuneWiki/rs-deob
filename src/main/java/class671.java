...
public class class671 extends class694 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!ww", name = "<init>", descriptor = "()V", line = 164)
    public class671() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IB)V", line = 70)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ILjr;B)V", line = 113)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B)V", line = 167)
