...
public class class671 extends class195 {
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lwh;II[BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(I)V", line = 51)
