...
public class class671 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lee;BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILee;)V", line = 39)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IZJ)Ljava/lang/String;", line = 60)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ILwd;I)V", line = 89)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(BII)Z", line = 114)
