...
public class class16 extends class615 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BILeh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 422)
    public class16() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IB)[I", line = 92)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(II)V", line = 321)
    ...
    @OriginalMember(owner = "client!qk", name = "f", descriptor = "(I)V", line = 365)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(B)V", line = 396)
