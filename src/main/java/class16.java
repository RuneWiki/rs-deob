...
public class class16 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IB)I", line = 15)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;ILjagdx/IDirect3DSwapChain;)V", line = 55)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 65)
