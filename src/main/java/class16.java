...
public class class16 extends class422 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(III)[B", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IB)V", line = 10)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 17)
    public class16() {
