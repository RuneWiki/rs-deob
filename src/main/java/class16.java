...
public class class16 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(B)I", line = 60)
    ...
    @OriginalMember(owner = "client!qo", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "()V", line = 104)
    public class16() {
    }

    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Leb;)V", line = 112)
