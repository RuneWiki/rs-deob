...
public abstract class class16 extends class439 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(I)Z", line = 43)
    ...
    @OriginalMember(owner = "client!l", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(III)V", line = 75)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(IIZII)V", line = 95)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(ILti;)Ljq;", line = 115)
