...
public class class16 extends class260 {
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(ILgn;)V", line = 8)
    public class16(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ds", name = "e", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(I)I", line = 48)
    public final int method123(int arg0) {
        ++field304;
        return arg0 != 4377 ? 23 : 0;
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IB)V", line = 61)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(II)I", line = 77)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lgn;)V", line = 101)
