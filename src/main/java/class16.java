...
public class class16 {
    ...
    @OriginalMember(owner = "client!be", name = "u", descriptor = "Llf;")
    public static class109 field311 = class35.method275("Lade)3)3)3", 2);

    @OriginalMember(owner = "client!be", name = "s", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!be", name = "l", descriptor = "Lbg;")
    public static class18 field302;

    @OriginalMember(owner = "client!be", name = "q", descriptor = "Lwb;")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IILbi;Lbi;B)Lue;")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILja;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIIZLbg;)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILbi;I)Lue;")
