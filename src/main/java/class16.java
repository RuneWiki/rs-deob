...
public abstract class class16 extends class499 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Z)Lvq;", line = 4)
    ...
    @OriginalMember(owner = "client!l", name = "c", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(Llh;Lkj;II)V", line = 32)
