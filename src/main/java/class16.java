...
public class class16 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lao;[BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(Lao;Ljava/nio/ByteBuffer;)V", line = 29)
