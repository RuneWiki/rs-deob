...
public class class16 extends class145 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lap;BI)V", line = 122)
    ...
    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "()V", line = 208)
    public class16() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kn", name = "e", descriptor = "(I)V", line = 178)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(B)V", line = 190)
    ...
    @OriginalMember(owner = "client!kn", name = "f", descriptor = "(I)V", line = 211)
