...
@OriginalClass("client!GAQBLBTP")
public class class16 {

    @OriginalMember(owner = "client!GAQBLBTP", name = "b", descriptor = "I")
    private int field790 = 30502;

    @OriginalMember(owner = "client!GAQBLBTP", name = "i", descriptor = "Z")
    public boolean field797 = false;

    @OriginalMember(owner = "client!GAQBLBTP", name = "j", descriptor = "I")
    public int field798 = -1;

    @OriginalMember(owner = "client!GAQBLBTP", name = "a", descriptor = "Z")
    private static boolean field789 = true;

    @OriginalMember(owner = "client!GAQBLBTP", name = "c", descriptor = "I")
    public static int field791;

    @OriginalMember(owner = "client!GAQBLBTP", name = "f", descriptor = "I")
    public int field794;

    @OriginalMember(owner = "client!GAQBLBTP", name = "g", descriptor = "I")
    public int field795;

    @OriginalMember(owner = "client!GAQBLBTP", name = "h", descriptor = "I")
    public int field796;

    @OriginalMember(owner = "client!GAQBLBTP", name = "k", descriptor = "I")
    public int field799;

    @OriginalMember(owner = "client!GAQBLBTP", name = "e", descriptor = "Ljava/lang/String;")
    public String field793;

    @OriginalMember(owner = "client!GAQBLBTP", name = "d", descriptor = "[LGAQBLBTP;")
    public static class16[] field792;

    @OriginalMember(owner = "client!GAQBLBTP", name = "a", descriptor = "(ILSYUGXMZF;)V")
    ...
    @OriginalMember(owner = "client!GAQBLBTP", name = "a", descriptor = "(ILKHOMSBHW;B)V")
