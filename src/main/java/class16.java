...
public class class16 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZI)Loba;")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Leaa;I)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lr;IIIIBIZLjaa;Lr;ZLla;)Lf;")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Ljaa;ILr;IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Ler;IZLtd;Ljn;Ljn;)V")
