...
public class class16 extends class130 {
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLwl;)I", line = 110)
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!dc", name = "<init>", descriptor = "(II)V", line = 217)
