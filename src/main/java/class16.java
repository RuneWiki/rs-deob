...
public class class16 extends class425 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lqa;B)V", line = 15)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIIIIIIILqa;)V", line = 127)
    ...
    @OriginalMember(owner = "client!tda", name = "b", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(ILwca;ZII)V", line = 279)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(I)V", line = 356)
