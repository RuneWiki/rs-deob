...
public class class16 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IIBII)V", line = 15)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(I)V", line = 37)
