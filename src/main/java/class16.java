...
public class class16 extends class384 {
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(IB)Lbg;", line = 4)
    ...
    @OriginalMember(owner = "client!kn", name = "d", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(II)[[I", line = 53)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(IC)Z", line = 99)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(CI)C", line = 127)
