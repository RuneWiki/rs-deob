...
public class class16 extends class24 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I[SI[Ljava/lang/String;B)V", line = 19)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ILra;)V", line = 90)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(II)I", line = 111)
