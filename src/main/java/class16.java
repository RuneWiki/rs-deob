...
public class class16 extends class54 {
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(IB)I", line = 5)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lhia;)V", line = 41)
    public class16(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(Z)I", line = 44)
    ...
    @OriginalMember(owner = "client!ds", name = "c", descriptor = "(Z)I", line = 58)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(ILhia;)V", line = 70)
    public class16(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 102)
