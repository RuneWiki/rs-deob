...
public class class16 extends class88 {
    ...
    @OriginalMember(owner = "client!wt", name = "l", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!wt", name = "s", descriptor = "(I)V", line = 22)
    public final void method99(int arg0) {
        ++field270;
        this.field260 = super.field1176 * arg0;
    }

    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(BI)I", line = 31)
    ...
    @OriginalMember(owner = "client!wt", name = "c", descriptor = "(ZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!wt", name = "t", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(IZ)I", line = 90)
    public final int method103(int arg0, boolean arg1) {
        ++field261;
        return !arg1 ? -103 : arg0 * 8 - this.field260;
    }

    @OriginalMember(owner = "client!wt", name = "m", descriptor = "(B)I", line = 101)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Z[I)V", line = 131)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IB[BI)V", line = 142)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(I)V", line = 160)
    public class16(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wt", name = "u", descriptor = "(I)Z", line = 163)
