...
public class class16 {
    ...
    @OriginalMember(owner = "client!FXRMRSFD", name = "c", descriptor = "[LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!FXRMRSFD", name = "a", descriptor = "(J)LWWONSPNF;")
    ...
    @OriginalMember(owner = "client!FXRMRSFD", name = "a", descriptor = "(JLWWONSPNF;I)V")
