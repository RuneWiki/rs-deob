...
public class class16 extends class268 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(CIIIZLi;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "([B[IIIIIIII)V", line = 69)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "([B[IIIIIIIIIIILi;II)V", line = 105)
    ...
    @OriginalMember(owner = "client!bu", name = "g", descriptor = "(CIIIZ)V", line = 200)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(Lvq;Lju;[Lmn;[I[I)V", line = 256)
