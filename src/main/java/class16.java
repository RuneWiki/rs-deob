...
public class class16 extends class253 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IBZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IBII)[B", line = 29)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "()V", line = 41)
    public class16() {
