...
@OriginalClass("client!ECVTLYGP")
public class class16 {

    @OriginalMember(owner = "client!ECVTLYGP", name = "a", descriptor = "I")
    private int field711 = 637;

    @OriginalMember(owner = "client!ECVTLYGP", name = "b", descriptor = "I")
    private int field712 = -446;

    @OriginalMember(owner = "client!ECVTLYGP", name = "c", descriptor = "[I")
    public int[] field713 = new int[2];

    @OriginalMember(owner = "client!ECVTLYGP", name = "d", descriptor = "[[[I")
    public int[][][] field714 = new int[2][2][4];

    @OriginalMember(owner = "client!ECVTLYGP", name = "e", descriptor = "[[[I")
    public int[][][] field715 = new int[2][2][4];

    @OriginalMember(owner = "client!ECVTLYGP", name = "f", descriptor = "[I")
    public int[] field716 = new int[2];

    @OriginalMember(owner = "client!ECVTLYGP", name = "g", descriptor = "[[F")
    public static float[][] field717 = new float[2][8];

    @OriginalMember(owner = "client!ECVTLYGP", name = "h", descriptor = "[[I")
    public static int[][] field718 = new int[2][8];

    @OriginalMember(owner = "client!ECVTLYGP", name = "i", descriptor = "F")
    public static float field719;

    @OriginalMember(owner = "client!ECVTLYGP", name = "j", descriptor = "I")
    public static int field720;

    @OriginalMember(owner = "client!ECVTLYGP", name = "a", descriptor = "(IFII)F")
    ...
    @OriginalMember(owner = "client!ECVTLYGP", name = "a", descriptor = "(IF)F")
    ...
    @OriginalMember(owner = "client!ECVTLYGP", name = "a", descriptor = "(FIII)F")
    ...
    @OriginalMember(owner = "client!ECVTLYGP", name = "a", descriptor = "(IIF)I")
    ...
    @OriginalMember(owner = "client!ECVTLYGP", name = "a", descriptor = "(BLYOXDZEVD;LNSRSHTPL;)V")
