...
public class class16 extends class612 {
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(I[BII)V", line = 9)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(I[BIIZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lcc;)Lqk;", line = 23)
