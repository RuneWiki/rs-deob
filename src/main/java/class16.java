...
public abstract class class16 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lap;)V", line = 67)
