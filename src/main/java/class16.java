...
public class class16 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BI)Lvb;", line = 48)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Liv;ILcb;Lcb;)V", line = 103)
