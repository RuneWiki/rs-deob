...
public class class16 extends class715 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)J", line = 18)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(IJ)I", line = 34)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)J", line = 66)
    public final long method70(byte arg0) {
        return arg0 <= 12 ? 126L : this.field118;
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)J", line = 78)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 115)
    public class16() {
