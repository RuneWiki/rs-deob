...
public class class16 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)I", line = 9)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BI)V", line = 24)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IBI)I", line = 50)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IB)Luca;", line = 63)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IZ)V", line = 112)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZIIIII)V", line = 153)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(Lim;ILgj;Ll;)V", line = 238)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(I)V", line = 176)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IB[BIII)V", line = 196)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(B)V", line = 226)
