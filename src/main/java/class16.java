...
public class class16 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILin;IILr;IILua;B)V")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)Lwi;")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lsea;I)V")
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Lci;ILsea;)V")
