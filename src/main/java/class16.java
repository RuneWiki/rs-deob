...
public class class16 {
    ...
    @OriginalMember(owner = "client!EMWMNDZQ", name = "c", descriptor = "[LEMWMNDZQ;")
    public static class16[] field724;

    @OriginalMember(owner = "client!EMWMNDZQ", name = "a", descriptor = "(ILTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!EMWMNDZQ", name = "a", descriptor = "(LEGCCHUZS;II)V")
