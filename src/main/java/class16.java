...
@OriginalClass("client!FLUCRVAS")
public class class16 implements Runnable {

    @OriginalMember(owner = "client!FLUCRVAS", name = "a", descriptor = "I")
    private int field681 = 3;

    @OriginalMember(owner = "client!FLUCRVAS", name = "b", descriptor = "Z")
    private boolean field682 = false;

    @OriginalMember(owner = "client!FLUCRVAS", name = "f", descriptor = "Z")
    private boolean field686 = false;

    @OriginalMember(owner = "client!FLUCRVAS", name = "k", descriptor = "Z")
    private boolean field691 = false;

    @OriginalMember(owner = "client!FLUCRVAS", name = "l", descriptor = "Z")
    private boolean field692 = false;

    @OriginalMember(owner = "client!FLUCRVAS", name = "g", descriptor = "LDKKOWNCZ;")
    public class7 field687;

    @OriginalMember(owner = "client!FLUCRVAS", name = "e", descriptor = "Ljava/net/Socket;")
    private Socket field685;

    @OriginalMember(owner = "client!FLUCRVAS", name = "c", descriptor = "Ljava/io/InputStream;")
    private InputStream field683;

    @OriginalMember(owner = "client!FLUCRVAS", name = "d", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field684;

    @OriginalMember(owner = "client!FLUCRVAS", name = "i", descriptor = "I")
    private int field689;

    @OriginalMember(owner = "client!FLUCRVAS", name = "j", descriptor = "I")
    private int field690;

    @OriginalMember(owner = "client!FLUCRVAS", name = "h", descriptor = "[B")
    private byte[] field688;

    @OriginalMember(owner = "client!FLUCRVAS", name = "<init>", descriptor = "(LDKKOWNCZ;Ljava/net/Socket;B)V")
    ...
    @OriginalMember(owner = "client!FLUCRVAS", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!FLUCRVAS", name = "b", descriptor = "()I")
    public int method211() throws IOException {
        return this.field686 ? 0 : this.field683.read();
    }

    @OriginalMember(owner = "client!FLUCRVAS", name = "c", descriptor = "()I")
    public int method212() throws IOException {
        return this.field686 ? 0 : this.field683.available();
    }

    @OriginalMember(owner = "client!FLUCRVAS", name = "a", descriptor = "([BII)V")
    ...
    @OriginalMember(owner = "client!FLUCRVAS", name = "a", descriptor = "(II[BZ)V")
    ...
    @OriginalMember(owner = "client!FLUCRVAS", name = "run", descriptor = "()V")
    public void run() {
        while (this.field691) {
            int var2;
            int var3;
    ...
    @OriginalMember(owner = "client!FLUCRVAS", name = "a", descriptor = "(I)V")
