...
public class class16 extends class50 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "([Lil;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "()V", line = 93)
    public final void method108() {
        this.field342 = true;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIIII)V", line = 98)
    public final void method109(int arg0, int arg1, int arg2, int arg3, int arg4) {
        this.field345 = arg0;
    }

    @OriginalMember(owner = "client!kv", name = "<init>", descriptor = "(IZ)V", line = 394)
    private class16(int arg0, boolean arg1) {
        this.method121(arg0, arg1);
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lr;J[Lrca;[Lil;Z)V", line = 116)
    ...
    @OriginalMember(owner = "client!kv", name = "c", descriptor = "()Luo;", line = 162)
    public final class620 method112() {
        return this.field346;
    }

    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(J)V", line = 166)
    public final void method113(long arg0) {
        this.field334 = arg0;
    }

    @OriginalMember(owner = "client!kv", name = "d", descriptor = "()V", line = 169)
    public final void method114() {
        this.field349 = true;
    }

    @OriginalMember(owner = "client!kv", name = "e", descriptor = "()V", line = 175)
    public static void method115() {
        field335 = null;
        field338 = null;
    }

    @OriginalMember(owner = "client!kv", name = "f", descriptor = "()V", line = 179)
    private final void method116() {
        this.field342 = false;
    }

    @OriginalMember(owner = "client!kv", name = "g", descriptor = "()Luo;", line = 182)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lr;[Lrca;Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lr;J)Z", line = 274)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IZ)Lkv;", line = 326)
    ...
    @OriginalMember(owner = "client!kv", name = "b", descriptor = "(IZ)V", line = 340)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Lr;)V", line = 347)
