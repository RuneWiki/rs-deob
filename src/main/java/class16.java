...
public class class16 extends class352 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(IIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(I)Z", line = 60)
    public static final boolean method135(int arg0) {
        ++field262;
        return arg0 != -8337 ? false : class181.field2582;
    }

    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(III)V", line = 77)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(III)V", line = 97)
