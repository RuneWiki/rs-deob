...
@OriginalClass("client!EOXICPMP")
public class class16 {

    @OriginalMember(owner = "client!EOXICPMP", name = "a", descriptor = "I")
    private int field661 = 497;

    @OriginalMember(owner = "client!EOXICPMP", name = "b", descriptor = "I")
    private int field662 = -838;

    @OriginalMember(owner = "client!EOXICPMP", name = "c", descriptor = "LEEYSIGWL;")
    public class14 field663 = new class14();

    @OriginalMember(owner = "client!EOXICPMP", name = "d", descriptor = "LEEYSIGWL;")
    private class14 field664;

    @OriginalMember(owner = "client!EOXICPMP", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!EOXICPMP", name = "a", descriptor = "(LEEYSIGWL;)V")
    ...
    @OriginalMember(owner = "client!EOXICPMP", name = "a", descriptor = "()LEEYSIGWL;")
    ...
    @OriginalMember(owner = "client!EOXICPMP", name = "b", descriptor = "()LEEYSIGWL;")
    ...
    @OriginalMember(owner = "client!EOXICPMP", name = "a", descriptor = "(I)LEEYSIGWL;")
    ...
    @OriginalMember(owner = "client!EOXICPMP", name = "c", descriptor = "()I")
