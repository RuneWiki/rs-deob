...
public class class16 extends class281 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I)J", line = 11)
    ...
    @OriginalMember(owner = "client!ds", name = "e", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ds", name = "f", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ds", name = "g", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ds", name = "h", descriptor = "(I)J", line = 61)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(IJ)V", line = 72)
    public class16(int arg0, long arg1) {
        super.field1409 = (long) arg0 << 56 | arg1;
    }

    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)Z", line = 82)
    ...
    @OriginalMember(owner = "client!ds", name = "d", descriptor = "(B)V", line = 92)
