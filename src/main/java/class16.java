...
public class class16 extends class194 implements class523 {
    ...
    @OriginalMember(owner = "client!nq", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!nq", name = "i", descriptor = "(I)Z", line = 25)
    public final boolean method86(int arg0) {
        ++field177;
        return arg0 != 0 ? true : this.field161;
    }

    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(I)I", line = 42)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)Z", line = 54)
    ...
    @OriginalMember(owner = "client!nq", name = "j", descriptor = "(I)I", line = 65)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZIIII)Z", line = 77)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lha;Z)V", line = 110)
    ...
    @OriginalMember(owner = "client!nq", name = "g", descriptor = "(I)Z", line = 121)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Lha;I)Lkn;", line = 132)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IILha;I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lha;Ljl;IIIIIZIII)V", line = 225)
    ...
    @OriginalMember(owner = "client!nq", name = "k", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(BLha;)V", line = 176)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(Lha;I)V", line = 190)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)I", line = 213)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!nq", name = "d", descriptor = "(B)I", line = 248)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ILjava/lang/String;)I", line = 258)
    ...
    @OriginalMember(owner = "client!nq", name = "h", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(ILha;)Lgh;", line = 287)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZILha;Lov;IIZ)V", line = 338)
