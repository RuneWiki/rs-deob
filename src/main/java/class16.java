...
public class class16 extends class368 {
    ...
    @OriginalMember(owner = "client!uda", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!uda", name = "a", descriptor = "(II[BI[BIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!uda", name = "g", descriptor = "(I)[B", line = 80)
