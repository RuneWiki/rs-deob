...
public class class16 {
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!kv", name = "a", descriptor = "(IIBILkfa;IZ[B)Lbb;", line = 59)
