...
@OriginalClass("client!DYTTVJNT")
public class class16 {

    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "Z")
    private boolean field748 = false;

    @OriginalMember(owner = "client!DYTTVJNT", name = "b", descriptor = "I")
    private int field749 = 334;

    @OriginalMember(owner = "client!DYTTVJNT", name = "c", descriptor = "Z")
    private boolean field750 = true;

    @OriginalMember(owner = "client!DYTTVJNT", name = "d", descriptor = "I")
    private int field751 = 27473;

    @OriginalMember(owner = "client!DYTTVJNT", name = "e", descriptor = "Z")
    private boolean field752 = false;

    @OriginalMember(owner = "client!DYTTVJNT", name = "f", descriptor = "B")
    private byte field753 = 2;

    @OriginalMember(owner = "client!DYTTVJNT", name = "g", descriptor = "I")
    private int field754 = 4;

    @OriginalMember(owner = "client!DYTTVJNT", name = "h", descriptor = "Z")
    private boolean field755 = true;

    @OriginalMember(owner = "client!DYTTVJNT", name = "i", descriptor = "I")
    private int field756 = 1;

    @OriginalMember(owner = "client!DYTTVJNT", name = "j", descriptor = "I")
    public int field757 = 0;

    @OriginalMember(owner = "client!DYTTVJNT", name = "k", descriptor = "I")
    public int field758 = 0;

    @OriginalMember(owner = "client!DYTTVJNT", name = "l", descriptor = "I")
    public int field759;

    @OriginalMember(owner = "client!DYTTVJNT", name = "m", descriptor = "I")
    public int field760;

    @OriginalMember(owner = "client!DYTTVJNT", name = "n", descriptor = "[[I")
    public int[][] field761;

    @OriginalMember(owner = "client!DYTTVJNT", name = "<init>", descriptor = "(BII)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(ZIIZII)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IIZZIII)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "b", descriptor = "(III)V")
    private void method204(int arg0, int arg1, int arg2) {
        this.field761[arg0][arg1] |= arg2;
    }

    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IIZIII)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IZII)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IZI)V")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IIIZIII)Z")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!DYTTVJNT", name = "a", descriptor = "(ZIIIIIII)Z")
