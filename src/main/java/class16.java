...
@OriginalClass("client!DYBMLHQM")
public class class16 {

    @OriginalMember(owner = "client!DYBMLHQM", name = "a", descriptor = "Z")
    private boolean field773 = true;

    @OriginalMember(owner = "client!DYBMLHQM", name = "b", descriptor = "Z")
    private boolean field774 = true;

    @OriginalMember(owner = "client!DYBMLHQM", name = "c", descriptor = "I")
    private int field775 = -1221;

    @OriginalMember(owner = "client!DYBMLHQM", name = "e", descriptor = "I")
    public int field777;

    @OriginalMember(owner = "client!DYBMLHQM", name = "j", descriptor = "Z")
    private boolean field782;

    @OriginalMember(owner = "client!DYBMLHQM", name = "d", descriptor = "[B")
    public byte[] field776;

    @OriginalMember(owner = "client!DYBMLHQM", name = "f", descriptor = "[I")
    public int[] field778;

    @OriginalMember(owner = "client!DYBMLHQM", name = "g", descriptor = "[I")
    public int[] field779;

    @OriginalMember(owner = "client!DYBMLHQM", name = "h", descriptor = "[I")
    public int[] field780;

    @OriginalMember(owner = "client!DYBMLHQM", name = "i", descriptor = "[I")
    public int[] field781;

    @OriginalMember(owner = "client!DYBMLHQM", name = "<init>", descriptor = "([BI)V")
    ...
    @OriginalMember(owner = "client!DYBMLHQM", name = "a", descriptor = "(Z[B)V")
    ...
    @OriginalMember(owner = "client!DYBMLHQM", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
