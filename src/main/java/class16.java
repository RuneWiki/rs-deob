...
public class class16 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ca", name = "<init>", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Z)Z", line = 48)
    ...
    @OriginalMember(owner = "client!ca", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(III)B", line = 73)
