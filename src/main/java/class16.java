...
public class class16 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(I[Ljava/lang/Object;B[II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!ds", name = "b", descriptor = "(I)[[I", line = 168)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIZI)V", line = 194)
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(III)V", line = 239)
