...
public class class16 extends class495 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tda", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(Ltf;Ltf;Ldt;)V", line = 50)
    public class16(class701 arg0, class701 arg1, class225 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!tda", name = "d", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(IIIII)V", line = 77)
