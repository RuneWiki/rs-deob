...
@OriginalClass("client!FOKYUBQV")
public class class16 {

    @OriginalMember(owner = "client!FOKYUBQV", name = "a", descriptor = "Z")
    private boolean field718 = false;

    @OriginalMember(owner = "client!FOKYUBQV", name = "b", descriptor = "I")
    private int field719 = 2;

    @OriginalMember(owner = "client!FOKYUBQV", name = "c", descriptor = "Z")
    private boolean field720 = false;

    @OriginalMember(owner = "client!FOKYUBQV", name = "d", descriptor = "LFLQEGCUY;")
    public class15 field721 = new class15();

    @OriginalMember(owner = "client!FOKYUBQV", name = "e", descriptor = "LFLQEGCUY;")
    private class15 field722;

    @OriginalMember(owner = "client!FOKYUBQV", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "a", descriptor = "(LFLQEGCUY;)V")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "a", descriptor = "(ILFLQEGCUY;)V")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "a", descriptor = "()LFLQEGCUY;")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "b", descriptor = "()LFLQEGCUY;")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "a", descriptor = "(I)LFLQEGCUY;")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "b", descriptor = "(I)LFLQEGCUY;")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "c", descriptor = "(I)LFLQEGCUY;")
    ...
    @OriginalMember(owner = "client!FOKYUBQV", name = "c", descriptor = "()V")
