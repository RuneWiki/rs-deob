...
public class class16 extends class48 {
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Z)V", line = 6)
    public final void method70(boolean arg0) {
        this.field480.method2053(8448, 7681);
    }

    @OriginalMember(owner = "client!kn", name = "a", descriptor = "(Lna;)V", line = 10)
    public final void method71(class50 arg0) {
        this.field480.method2032(arg0);
    }

    @OriginalMember(owner = "client!kn", name = "<init>", descriptor = "(Lql;)V", line = 18)
    ...
    @OriginalMember(owner = "client!kn", name = "a", descriptor = "()V", line = 54)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!kn", name = "b", descriptor = "()Z", line = 89)
