...
public class class16 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)Lrg;", line = 10)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ICI)I", line = 32)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)Lrg;", line = 75)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Lrg;I)V", line = 118)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)Lrg;", line = 150)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZI)V", line = 170)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "()V", line = 229)
    public class16() {
