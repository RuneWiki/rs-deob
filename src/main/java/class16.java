...
public class class16 {
    ...
    @OriginalMember(owner = "client!HNYSLMKN", name = "g", descriptor = "[LVUJNNHKQ;")
    private class62[] field729 = new class62[10];

    @OriginalMember(owner = "client!HNYSLMKN", name = "c", descriptor = "[LHNYSLMKN;")
    ...
    @OriginalMember(owner = "client!HNYSLMKN", name = "f", descriptor = "LUAWAYCTK;")
    ...
    @OriginalMember(owner = "client!HNYSLMKN", name = "a", descriptor = "(ILUAWAYCTK;)V")
    ...
    @OriginalMember(owner = "client!HNYSLMKN", name = "a", descriptor = "(IZI)LUAWAYCTK;")
    ...
    @OriginalMember(owner = "client!HNYSLMKN", name = "b", descriptor = "(ILUAWAYCTK;)V")
    ...
    @OriginalMember(owner = "client!HNYSLMKN", name = "a", descriptor = "(II)LUAWAYCTK;")
