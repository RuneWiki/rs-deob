...
public class class16 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ILtt;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIILbw;Lbw;)V", line = 86)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(II)I", line = 97)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Z)V", line = 115)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BI)Lbl;", line = 127)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(III)V", line = 177)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lcda;ILkea;Lkea;)V", line = 225)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIB)Z", line = 191)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IB)V", line = 202)
