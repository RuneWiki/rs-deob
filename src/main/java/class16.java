...
public class class16 extends class87 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Lae;Z)V")
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIJLsha;ILaa;BI)V")
    ...
    @OriginalMember(owner = "client!ds", name = "<init>", descriptor = "(II[I[I)V")
