...
public class class16 extends class89 {
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lks;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIIIILks;)Lmf;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lks;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IIILks;IIZ[B)Lmf;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lks;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lks;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lks;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Z[IIILks;I)Lmf;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lks;IIII[I)V")
