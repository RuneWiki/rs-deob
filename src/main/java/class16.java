...
public class class16 extends class45 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "([IIZB[I)J", line = 4)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(Lhca;ILr;IIIIIZLbl;)Lda;", line = 71)
