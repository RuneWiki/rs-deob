...
public class class16 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IILen;[IZ[I)Lap;")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)Lpg;")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Llaa;[IJB)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ZLjr;)Lhh;")
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(ILpj;Lpj;Lqe;)V")
