...
public class class716 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILro;)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)[Lht;")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(Z)Lpb;")
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(B)Lpb;")
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Lro;)V")
