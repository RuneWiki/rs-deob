...
public class class716 extends class242 {
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 5)
    public class716(Object arg0, int arg1) {
        super(arg1);
        this.field9410 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 14)
    public final Object method1380(boolean arg0) {
        return arg0 ? (Object) null : this.field9410.get();
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(B)Z", line = 24)
