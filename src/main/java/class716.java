...
public class class716 extends class77 {
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!nk", name = "g", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(ILha;)Lkj;")
    ...
    @OriginalMember(owner = "client!nk", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(BLha;)Lml;")
    ...
    @OriginalMember(owner = "client!nk", name = "f", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!nk", name = "i", descriptor = "(I)I")
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLha;)V")
    public final void method753(byte arg0, class58 arg1) {
        int var3 = -113 % ((18 - arg0) / 40);
        ++field9959;
    }

    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(Lha;III)Z")
