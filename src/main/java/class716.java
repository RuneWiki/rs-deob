...
public class class716 extends Canvas {
    ...
    @OriginalMember(owner = "client!vm", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void update(Graphics arg0) {
        field9997++;
        this.field10001.update(arg0);
    }

    @OriginalMember(owner = "client!vm", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 14)
    public final void paint(Graphics arg0) {
        this.field10001.paint(arg0);
        field9996++;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IBIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 88)
    public class716(Component arg0) {
        this.field10001 = arg0;
    }

    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILor;)Lor;", line = 111)
