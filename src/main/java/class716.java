...
public class class716 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "([[[Ldn;IZIIZ)Z", line = 7)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)V", line = 324)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)V", line = 337)
    ...
    @OriginalMember(owner = "client!tn", name = "finalize", descriptor = "()V", line = 349)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lkw;JI)V", line = 369)
