...
public class class716 {
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(ZBLjava/lang/String;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!bw", name = "a", descriptor = "(CII)I", line = 149)
