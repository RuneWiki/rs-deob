...
public class class716 {
    ...
    @OriginalMember(owner = "client!ks", name = "listmodes", descriptor = "()[I", line = 11)
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(Ljava/awt/Frame;I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ks", name = "enter", descriptor = "(Ljava/awt/Frame;IIII)V", line = 76)
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!ks", name = "exit", descriptor = "()V", line = 174)
