...
public class class716 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILtn;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Ltn;B)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILab;Lab;)V")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IILha;IIILnaa;Ls;ILs;IZI)Lka;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILha;IILs;ZIILs;ILnaa;IIB)Lka;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lnaa;ILha;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lha;Lnaa;IIIIB)Lka;")
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLet;)V")
