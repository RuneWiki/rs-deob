...
public class class716 extends class206 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(IIIFI)V", line = 23)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B[II)V", line = 133)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BI)V", line = 260)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(II)V", line = 276)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Laq;IIIII)V", line = 294)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II)V", line = 313)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Z)V", line = 326)
