...
public abstract class class703 {
    ...
    @OriginalMember(owner = "client!gn", name = "finalize", descriptor = "()V", line = 10)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(I[BIIIII)Z", line = 19)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(CB)C", line = 66)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(IZ[B)V", line = 102)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lwh;I[BIZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(Lwh;ILjaclib/memory/Buffer;IZ)V", line = 150)
