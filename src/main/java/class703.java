...
public class class703 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I[BIIBI[BII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(BC)V", line = 90)
    ...
    @OriginalMember(owner = "client!ee", name = "<init>", descriptor = "(Lkv;I)V", line = 104)
    public class703(class280 arg0, int arg1) {
        this.field9904 = OpenGL.glGenLists(arg1);
    }

    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)Z", line = 120)
