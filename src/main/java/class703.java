...
public class class703 {
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(JI[ILui;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(IILpca;I)V")
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(II)Lgg;")
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "(ILri;Lri;Lmn;)V")
