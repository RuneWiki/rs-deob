...
public class class703 extends class468 {
    ...
    @OriginalMember(owner = "client!lr", name = "EA", descriptor = "(IIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!lr", name = "AA", descriptor = "()I", line = 35)
    public final int method1552() {
        field9842++;
        return this.field9841.field1767 + this.field9851 + this.field9836;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "()I", line = 45)
    public final int method1549() {
        field9828++;
        return this.field9841.field1769 + this.field9830 + this.field9840;
    }

    @OriginalMember(owner = "client!lr", name = "sa", descriptor = "(FFFFFFIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IILfa;II)V", line = 127)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ljaa;IIZ)V", line = 705)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ljaa;IIII)V", line = 715)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Ljaa;II[III)V", line = 725)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "()I", line = 196)
    public final int method1544() {
        field9837++;
        return this.field9841.field1769;
    }

    @OriginalMember(owner = "client!lr", name = "ba", descriptor = "(IIIIIII)V", line = 205)
    ...
    @OriginalMember(owner = "client!lr", name = "t", descriptor = "(III)V", line = 345)
    ...
    @OriginalMember(owner = "client!lr", name = "KA", descriptor = "(IIIIIII)V", line = 375)
    ...
    @OriginalMember(owner = "client!lr", name = "QA", descriptor = "()I", line = 479)
    public final int method1556() {
        field9848++;
        return this.field9841.field1767;
    }

    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(FFFFFFLfa;II)V", line = 487)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 576)
    ...
    @OriginalMember(owner = "client!lr", name = "I", descriptor = "(IIIII)V", line = 598)
    ...
    @OriginalMember(owner = "client!lr", name = "GA", descriptor = "(IIIIII)V", line = 649)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(II)V", line = 669)
