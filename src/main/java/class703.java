...
public class class703 implements class236 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)Ltca;", line = 29)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BII)Z", line = 45)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(ILtl;Lfn;II)V", line = 67)
    ...
    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(I)V", line = 79)
