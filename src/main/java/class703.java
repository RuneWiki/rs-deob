...
public class class703 extends class585 {
    ...
    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(ZI)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!lt", name = "<init>", descriptor = "()V", line = 98)
    public class703() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lt", name = "a", descriptor = "(Lso;II)V", line = 106)
    ...
    @OriginalMember(owner = "client!lt", name = "b", descriptor = "(Z)V", line = 191)
