...
public class class703 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILeea;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILeea;)V", line = 25)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Lee;B)V", line = 41)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(ILeea;)V", line = 100)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)V", line = 114)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Ldm;BILeea;)V", line = 126)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(Leea;I)V", line = 300)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ILeea;Z)V", line = 321)
