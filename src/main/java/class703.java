...
public class class703 extends class701 {
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IILua;II)V", line = 17)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(FFFFFFILua;II)V", line = 62)
    ...
    @OriginalMember(owner = "client!eca", name = "YA", descriptor = "(IIIIIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(CI)Z", line = 158)
    ...
    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IZIILkga;I[BI)Leb;", line = 184)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lifa;IIZ)V", line = 620)
    ...
    @OriginalMember(owner = "client!eca", name = "<init>", descriptor = "(Lifa;II[III)V", line = 635)
    ...
    @OriginalMember(owner = "client!eca", name = "qa", descriptor = "(FFFFFFIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!eca", name = "u", descriptor = "()I", line = 273)
    public final int method900() {
        field9920++;
        return this.field9938;
    }

    @OriginalMember(owner = "client!eca", name = "xa", descriptor = "(III)V", line = 285)
    public final void method4(int arg0, int arg1, int arg2) {
        field9923++;
    }

    @OriginalMember(owner = "client!eca", name = "Q", descriptor = "(IIII)V", line = 297)
    ...
    @OriginalMember(owner = "client!eca", name = "DA", descriptor = "(IIIIIII)V", line = 309)
    ...
    @OriginalMember(owner = "client!eca", name = "ca", descriptor = "()I", line = 518)
    public final int method901() {
        field9925++;
        return this.field9942 + this.field9938 + this.field9939;
    }

    @OriginalMember(owner = "client!eca", name = "A", descriptor = "()I", line = 529)
    public final int method896() {
        field9941++;
        return this.field9926 + this.field9921 + this.field9922;
    }

    @OriginalMember(owner = "client!eca", name = "da", descriptor = "(IIIIII)V", line = 541)
    ...
    @OriginalMember(owner = "client!eca", name = "V", descriptor = "(IIIII)V", line = 562)
    ...
    @OriginalMember(owner = "client!eca", name = "E", descriptor = "()I", line = 602)
    public final int method902() {
        field9929++;
        return this.field9922;
    }

    @OriginalMember(owner = "client!eca", name = "a", descriptor = "(IIII[III)V", line = 610)
