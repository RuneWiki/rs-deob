...
public class class703 extends class55 {
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(III)I", line = 7)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(I)I", line = 34)
    public final int method3962(int arg0) {
        field9869++;
        return arg0 == 1 ? (this.field9868 & 0x1DF9B4) >> 18 : 24;
    }

    @OriginalMember(owner = "client!waa", name = "b", descriptor = "(I)Z", line = 46)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!waa", name = "a", descriptor = "(BI)Z", line = 69)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(B)Z", line = 81)
    ...
    @OriginalMember(owner = "client!waa", name = "c", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!waa", name = "e", descriptor = "(I)Z", line = 103)
    ...
    @OriginalMember(owner = "client!waa", name = "<init>", descriptor = "(II)V", line = 114)
