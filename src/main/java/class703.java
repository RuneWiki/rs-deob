...
public class class703 implements class21 {
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(B)Los;", line = 18)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIB)V", line = 31)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(I)V", line = 44)
