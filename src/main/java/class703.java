...
public class class703 extends class566 implements class492 {
    ...
    @OriginalMember(owner = "client!uca", name = "b", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!uca", name = "a", descriptor = "(Ltha;B)V")
    public final void method1121(class372 arg0, byte arg1) {
        super.method1121(arg0, arg1);
    }

    @OriginalMember(owner = "client!uca", name = "<init>", descriptor = "(Lkfa;IZ[[I)V")
