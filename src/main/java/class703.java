...
public class class703 extends class392 {
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(ILw;)V", line = 29)
    public class703(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!st", name = "b", descriptor = "(I)I", line = 32)
    public final int method3934(int arg0) {
        ++field9852;
        return arg0 != 17539 ? 35 : super.field5452;
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!st", name = "<init>", descriptor = "(Lw;)V", line = 57)
    public class703(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!st", name = "a", descriptor = "(BI)V", line = 62)
    ...
    @OriginalMember(owner = "client!st", name = "a", descriptor = "(Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!st", name = "b", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!st", name = "c", descriptor = "(I)Z", line = 114)
