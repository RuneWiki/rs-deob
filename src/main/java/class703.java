...
public class class703 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;B)V", line = 33)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Z)Z", line = 55)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 66)
