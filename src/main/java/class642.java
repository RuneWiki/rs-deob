...
public class class642 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(II)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(BI)S", line = 47)
