...
public class class642 extends class738 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BII)V", line = 5)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!qo", name = "<init>", descriptor = "(IIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(III)V", line = 56)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIBII)V", line = 119)
