...
public class class642 extends class435 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(SI)V", line = 10)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(BI)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IBII[[Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILjava/lang/String;)I", line = 108)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIIIZII)V", line = 127)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(IB)V", line = 303)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(B)V", line = 316)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Lnh;Lsq;Lam;[I)V", line = 335)
