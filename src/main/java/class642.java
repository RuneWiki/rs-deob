...
public class class642 extends class360 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lqa;Lr;I)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Lqa;I)Lbi;")
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(ILqa;)Lkm;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BLqa;II)Z")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IBLqa;)Lr;")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(IBILgca;II)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BZILqa;IILcea;)V")
