...
public class class642 extends class619 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILkha;)I")
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Z)Lqi;")
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lgq;Lkfa;IIIIIIIII)V")
