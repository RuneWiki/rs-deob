...
public class class642 {
    ...
    @OriginalMember(owner = "client!ck", name = "a", descriptor = "()Lob;", line = 11)
    ...
    @OriginalMember(owner = "client!ck", name = "b", descriptor = "()I", line = 17)
    ...
    @OriginalMember(owner = "client!ck", name = "c", descriptor = "()[B", line = 60)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "(Lcea;)V", line = 120)
    ...
    @OriginalMember(owner = "client!ck", name = "<init>", descriptor = "()V", line = 140)
    private class642() {
    }

    @OriginalMember(owner = "client!ck", name = "a", descriptor = "(Lin;II)Lck;", line = 145)
