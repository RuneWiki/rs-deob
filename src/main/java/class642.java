...
public class class642 extends class56 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ZILjava/lang/String;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(ILee;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "()V", line = 255)
    public class642() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(II)[[I", line = 148)
    ...
    @OriginalMember(owner = "client!ph", name = "c", descriptor = "(B)V", line = 242)
    ...
    @OriginalMember(owner = "client!ph", name = "e", descriptor = "(I)V", line = 263)
