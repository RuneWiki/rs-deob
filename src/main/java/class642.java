...
public class class642 implements class105 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(II)Lot;")
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Z)Lwh;")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Ljava/lang/String;Ljk;Ltda;IIIIIIIIII)V")
