...
public class class642 extends class114 {
    ...
    @OriginalMember(owner = "client!fc", name = "e", descriptor = "(II)Ljk;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIZ[BIILnea;I)Llba;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILnea;I[BI)Loq;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZI)Lwba;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lvr;Lvr;FLvr;)Lvr;")
    ...
    @OriginalMember(owner = "client!fc", name = "f", descriptor = "()Lev;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIIILmg;II)Z")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BLnea;Ldr;)Z")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IZLgca;B)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lrs;)V")
    public final void method120(class730 arg0) {
        ++field9034;
    }

    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILrl;II)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(BILwba;)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I[Lpfa;)Lija;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lup;B)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILnea;[FIZIB)Llba;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IZZLgca;I)V")
    ...
    @OriginalMember(owner = "client!fc", name = "g", descriptor = "(II)Lsba;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IBLnea;Ldr;I)Llba;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lija;I)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "([IIIIIIZ)Llba;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILvv;Lrl;III)V")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Lnea;Ldr;I)Z")
    ...
    @OriginalMember(owner = "client!fc", name = "c", descriptor = "(II)Llf;")
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(Llf;Ljk;)Lrs;")
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLd;Lgga;I)V")
