...
public class class642 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "()V", line = 12)
    public static final void method3571() {
        field9096 = null;
        field9092 = null;
    }

    @OriginalMember(owner = "client!el", name = "c", descriptor = "()V", line = 19)
    public final void method3572() {
        this.field9101 = null;
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Loa;Lel;)Z", line = 23)
    public final boolean method3573(class689 arg0, class642 arg1) {
        return this.field9101 != null || this.method3577(arg0, arg1);
    }

    @OriginalMember(owner = "client!el", name = "a", descriptor = "(IIII)Z", line = 32)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(Loa;Lel;)V", line = 93)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Loa;IIIIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!el", name = "c", descriptor = "(Loa;Lel;)Z", line = 206)
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Loa;)V", line = 243)
    ...
    @OriginalMember(owner = "client!el", name = "d", descriptor = "(Loa;Lel;)V", line = 325)
    ...
    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 419)
    ...
    @OriginalMember(owner = "client!el", name = "b", descriptor = "(Loa;)V", line = 430)
