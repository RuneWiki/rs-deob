...
public class class642 {
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IC)V", line = 7)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(IBZ)Lib;", line = 36)
    ...
    @OriginalMember(owner = "client!hg", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(II)I", line = 60)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(BI)V", line = 66)
    ...
    @OriginalMember(owner = "client!hg", name = "a", descriptor = "(III)V", line = 78)
    ...
    @OriginalMember(owner = "client!hg", name = "<init>", descriptor = "(Lok;I)V", line = 92)
