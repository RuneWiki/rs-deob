...
public class class642 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(II)Lnba;")
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Lbda;I)I")
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Lto;ILla;)V")
