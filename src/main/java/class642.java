...
public class class642 {
    ...
    @OriginalMember(owner = "client!jaa", name = "a", descriptor = "(Lnba;B)Lww;")
    ...
    @OriginalMember(owner = "client!jaa", name = "b", descriptor = "(I)Lup;")
    ...
    @OriginalMember(owner = "client!jaa", name = "<init>", descriptor = "(Laj;Laj;)V")
