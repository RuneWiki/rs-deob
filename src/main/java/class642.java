...
public class class642 extends class324 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(BLoo;)V")
    ...
    @OriginalMember(owner = "client!av", name = "d", descriptor = "(I)Ltl;")
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ILha;IIIBIII)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
