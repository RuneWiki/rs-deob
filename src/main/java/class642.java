...
public class class642 extends class278 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BI)I", line = 20)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "([Luaa;)V", line = 45)
