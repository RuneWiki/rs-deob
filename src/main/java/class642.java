...
public class class642 {
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(II)Lgv;", line = 4)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lfs;ILlga;)V", line = 95)
