...
public class class642 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lr;[II[I[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "()V", line = 6)
    public static void method3569() {
        field8863 = null;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)Z", line = 10)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "([III)V", line = 135)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "()V", line = 185)
    private static final void method3573() {
        field8866 = 0;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(II)V", line = 192)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lr;[II)V", line = 236)
    public static final void method3575(class166 arg0, int[] arg1, int arg2) {
        method3576(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lr;[IIII[I[I)V", line = 244)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(II)V", line = 283)
