...
public class class642 extends class322 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IB)I", line = 4)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(IB)Z", line = 53)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(BLjava/lang/String;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILio;)V", line = 79)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Lgba;I)V", line = 427)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lgba;)V", line = 1058)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(IB)V", line = 464)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZI)V", line = 477)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)V", line = 491)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(ZI)I", line = 531)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(I)V", line = 554)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)I", line = 592)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(I)I", line = 655)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(B)V", line = 838)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IZ)Z", line = 855)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(IB)I", line = 873)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 890)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(BII)I", line = 913)
    ...
    @OriginalMember(owner = "client!gl", name = "d", descriptor = "(B)V", line = 965)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(ZI)V", line = 1019)
