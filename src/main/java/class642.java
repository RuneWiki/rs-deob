...
public class class642 extends class402 {
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!l", name = "<init>", descriptor = "(Lfga;Lej;[Loia;[I[I)V")
    ...
    @OriginalMember(owner = "client!l", name = "a", descriptor = "(CIIIZLaa;II)V")
