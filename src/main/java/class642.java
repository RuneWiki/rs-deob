...
public abstract class class642 {
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IJ)I", line = 7)
    ...
    @OriginalMember(owner = "client!f", name = "c", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ILso;ILr;BI)V", line = 62)
