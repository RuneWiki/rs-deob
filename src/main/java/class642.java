...
public class class642 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IZZLjava/lang/String;Ljava/lang/String;)V", line = 22)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZI)V", line = 66)
