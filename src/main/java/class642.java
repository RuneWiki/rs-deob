...
public class class642 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)Lns;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lni;Lcfa;Lkf;Lsia;Lup;Lui;Lcj;)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;Lji;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(II)Lgga;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)Lgga;")
    public static final class294 method3620(int arg0) {
        return (class294) field8933.method2552((long) arg0, -1);
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;Luca;IIII)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(Lha;IIII)Lkba;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;Luca;Lbq;)V")
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(Lha;)Lkba;")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
