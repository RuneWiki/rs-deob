...
public class class642 extends class646 {
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Ljava/net/Proxy;B)Ljava/net/Socket;", line = 13)
    ...
    @OriginalMember(owner = "client!nia", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 34)
    ...
    @OriginalMember(owner = "client!nia", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 98)
    ...
    @OriginalMember(owner = "client!nia", name = "b", descriptor = "(B)Ljava/net/Socket;", line = 175)
