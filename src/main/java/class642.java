...
public class class642 extends class38 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "([FIZILlw;III)Lrm;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lfb;II)V")
    ...
    @OriginalMember(owner = "client!om", name = "q", descriptor = "()Lqm;")
    ...
    @OriginalMember(owner = "client!om", name = "u", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!om", name = "g", descriptor = "(II)Lwm;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILlw;Lal;)Z")
    ...
    @OriginalMember(owner = "client!om", name = "c", descriptor = "(ZI)Lfb;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "([[IBIZ)Lqn;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IIILoq;ILri;I)V")
    ...
    @OriginalMember(owner = "client!om", name = "d", descriptor = "(IZ)Loq;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ZLqg;)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lpea;)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lmq;ZII)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Llw;IILal;I)Lrm;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lvm;Lvm;FLvm;)Lvm;")
    public final class72 method1242(class72 arg0, class72 arg1, float arg2, class72 arg3) {
        ++field9128;
        return arg2 < 0.5F ? arg0 : arg1;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "([BBLlw;III)Luc;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILfk;)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILmq;ZZI)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IILlw;I[BIIZ)Lrm;")
    ...
    @OriginalMember(owner = "client!om", name = "b", descriptor = "(II)Lhu;")
    ...
    @OriginalMember(owner = "client!om", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLd;Lla;I)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(IB)Loca;")
    ...
    @OriginalMember(owner = "client!om", name = "o", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILri;ZI)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(ILal;Llw;)Z")
    public final boolean method399(int arg0, class121 arg1, class233 arg2) {
        ++field9094;
        return arg0 != 18154 ? true : true;
    }

    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lhu;Lwm;)Lpea;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(III[IIIZ)Lrm;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(I[Lbl;)Lfk;")
