...
public class class642 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(II)I", line = 17)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BI)I", line = 54)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Z[B)[B", line = 141)
