...
public class class445 extends class618 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/ca;)V", line = 4)
    public class445(class617 arg0) {
        super(arg0);
        this.Init();
    }
