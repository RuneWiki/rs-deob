...
public class class724 extends class361 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/ku;)V", line = 13)
    public class724(class360 arg0) {
        super(arg0);
        this.Init();
    }
