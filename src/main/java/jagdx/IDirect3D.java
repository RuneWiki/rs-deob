...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/fk;")
    private class578 field5788;

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(I)Ljagdx/D3DDISPLAYMODE;")
    public final D3DDISPLAYMODE method2422(int arg0) {
        D3DDISPLAYMODE var2 = new D3DDISPLAYMODE();
        int var3 = this._GetAdapterDisplayMode(arg0, var2);
        if (class410.method2427(114, var3)) {
    ...
    public final IDirect3DDevice method2424(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field5788);
        int var7 = this._CreateDevice(arg0, arg1, arg2, arg3, arg4, var6);
        if (class410.method2427(103, var7)) {
            throw new class409(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/fk;)Ljagdx/IDirect3D;")
    public static final IDirect3D method2425(int arg0, class578 arg1) {
        IDirect3D var2 = new IDirect3D(arg1);
        int var3 = _Direct3DCreate(arg0, var2);
        if (class410.method2427(109, var3)) {
            throw new class409(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final D3DCAPS method2426(int arg0, int arg1) {
        D3DCAPS var3 = new D3DCAPS();
        int var4 = this._GetDeviceCaps(arg0, arg1, var3);
        if (class410.method2427(101, var4)) {
            throw new class409(String.valueOf(var4));
        }
        return var3;
    }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/fk;)V")
    private IDirect3D(class578 arg0) {
        super(arg0);
        this.field5788 = arg0;
    }
