...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/pb;")
    private class570 field5750;

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(I)Ljagdx/D3DDISPLAYMODE;", line = 11)
    public final D3DDISPLAYMODE method2387(int arg0) {
        D3DDISPLAYMODE var2 = new D3DDISPLAYMODE();
        int var3 = this._GetAdapterDisplayMode(arg0, var2);
        if (class398.method2383((byte) -122, var3)) {
            throw new class399(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(II)Ljagdx/D3DCAPS;", line = 24)
    public final D3DCAPS method2388(int arg0, int arg1) {
        D3DCAPS var3 = new D3DCAPS();
        int var4 = this._GetDeviceCaps(arg0, arg1, var3);
        if (class398.method2383((byte) -87, var4)) {
            throw new class399(String.valueOf(var4));
        }
        return var3;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DADAPTER_IDENTIFIER;", line = 42)
    public final D3DADAPTER_IDENTIFIER method2389(int arg0, int arg1) {
        D3DADAPTER_IDENTIFIER var3 = new D3DADAPTER_IDENTIFIER();
        int var4 = this._GetAdapterIdentifier(arg0, arg1, var3);
        if (class398.method2383((byte) 109, var4)) {
            throw new class399(String.valueOf(var4));
        }
        return var3;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(IILjava/awt/Canvas;ILjagdx/D3DPRESENT_PARAMETERS;)Ljagdx/IDirect3DDevice;", line = 55)
    public final IDirect3DDevice method2390(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field5750);
        int var7 = this._CreateDevice(arg0, arg1, arg2, arg3, arg4, var6);
        if (class398.method2383((byte) 110, var7)) {
            throw new class399(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/pb;)Ljagdx/IDirect3D;", line = 69)
    public static final IDirect3D method2391(int arg0, class570 arg1) {
        IDirect3D var2 = new IDirect3D(arg1);
        int var3 = _Direct3DCreate(arg0, var2);
        if (class398.method2383((byte) -59, var3)) {
            throw new class399(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/pb;)V", line = 87)
    private IDirect3D(class570 arg0) {
        super(arg0);
        this.field5750 = arg0;
    }
