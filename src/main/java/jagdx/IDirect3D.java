...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/naa;")
    private class623 field6336;
    ...
    public final IDirect3DDevice method2642(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field6336);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/naa;)V", line = 21)
    private IDirect3D(class623 arg0) {
        super(arg0);
        this.field6336 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(II)Ljagdx/D3DADAPTER_IDENTIFIER;", line = 32)
    public final D3DADAPTER_IDENTIFIER method2643(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/naa;)Ljagdx/IDirect3D;", line = 47)
    public static final IDirect3D method2644(int arg0, class623 arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjagdx/D3DDISPLAYMODE;)I", line = 62)
    public final int method2645(int arg0, D3DDISPLAYMODE arg1) {
    ...
    public final D3DCAPS method2646(int arg0, int arg1) {
