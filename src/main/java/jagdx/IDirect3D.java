...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/pe;")
    private class576 field5334;

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(II)Ljagdx/D3DCAPS;", line = 12)
    public final D3DCAPS method2315(int arg0, int arg1) {
        D3DCAPS var3 = new D3DCAPS();
        int var4 = this._GetDeviceCaps(arg0, arg1, var3);
        if (class407.method2321((byte) 95, var4)) {
            throw new class408("");
        }
        return var3;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/pe;)V", line = 24)
    private IDirect3D(class576 arg0) {
        super(arg0);
        this.field5334 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(IILjava/awt/Canvas;ILjagdx/D3DPRESENT_PARAMETERS;)Ljagdx/IDirect3DDevice;", line = 35)
    public final IDirect3DDevice method2316(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field5334);
        int var7 = this._CreateDevice(arg0, arg1, arg2, arg3, arg4, var6);
        if (class407.method2321((byte) 101, var7)) {
            throw new class408("");
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "c", descriptor = "(I)Ljagdx/D3DDISPLAYMODE;", line = 50)
    public final D3DDISPLAYMODE method2317(int arg0) {
        D3DDISPLAYMODE var2 = new D3DDISPLAYMODE();
        int var3 = this._GetAdapterDisplayMode(arg0, var2);
        if (class407.method2321((byte) 53, var3)) {
            throw new class408("");
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/pe;)Ljagdx/IDirect3D;", line = 66)
    public static final IDirect3D method2318(int arg0, class576 arg1) {
        IDirect3D var2 = new IDirect3D(arg1);
        int var3 = _Direct3DCreate(arg0, var2);
        if (class407.method2321((byte) 11, var3)) {
            throw new class408("");
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DADAPTER_IDENTIFIER;", line = 84)
    public final D3DADAPTER_IDENTIFIER method2319(int arg0, int arg1) {
        D3DADAPTER_IDENTIFIER var3 = new D3DADAPTER_IDENTIFIER();
        int var4 = this._GetAdapterIdentifier(arg0, arg1, var3);
        if (class407.method2321((byte) 114, var4)) {
            throw new class408("");
        }
        return var3;
    }
