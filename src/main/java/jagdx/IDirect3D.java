...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/pe;)V")
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "c", descriptor = "(I)Ljagdx/D3DDISPLAYMODE;")
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/pe;)Ljagdx/IDirect3D;")
