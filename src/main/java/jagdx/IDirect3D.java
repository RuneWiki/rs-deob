...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/am;")
    private class625 field5474;

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(II)Ljagdx/D3DADAPTER_IDENTIFIER;", line = 6)
    public final D3DADAPTER_IDENTIFIER method2309(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjagdx/D3DDISPLAYMODE;)I", line = 30)
    public final int method2310(int arg0, D3DDISPLAYMODE arg1) {
        return this._GetAdapterDisplayMode(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/am;)V", line = 37)
    private IDirect3D(class625 arg0) {
        super(arg0);
        this.field5474 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DCAPS;", line = 47)
    public final D3DCAPS method2311(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(IILjava/awt/Canvas;ILjagdx/D3DPRESENT_PARAMETERS;)Ljagdx/IDirect3DDevice;", line = 61)
    public final IDirect3DDevice method2312(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field5474);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/am;)Ljagdx/IDirect3D;", line = 77)
    public static final IDirect3D method2313(int arg0, class625 arg1) {
