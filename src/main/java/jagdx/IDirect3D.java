...
public class IDirect3D extends IUnknown {
   ...
   private class709 field936;

   @OriginalMember(
      owner = "client!jagdx/IDirect3D",
      name = "a",
      descriptor = "(ILjaclib/peer/jv;)Ljagdx/IDirect3D;"
   )
   public static final IDirect3D method553(int arg0, class709 arg1) {
      IDirect3D var2 = new IDirect3D(arg1);
      int var3 = _Direct3DCreate(arg0, var2);
      if (class71.method549(var3, 46)) {
   ...
   public final D3DCAPS method554(int arg0, int arg1) {
      D3DCAPS var3 = new D3DCAPS();
      int var4 = this._GetDeviceCaps(arg0, arg1, var3);
      if (!class71.method549(var4, 37)) {
         return var3;
      } else {
   ...
   private IDirect3D(class709 arg0) {
      super(arg0);
      this.field936 = arg0;
   }
   ...
   public final IDirect3DDevice method556(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
      IDirect3DDevice var6 = new IDirect3DDevice(this.field936);
      int var7 = this._CreateDevice(arg0, arg1, arg2, arg3, arg4, var6);
      if (!class71.method549(var7, 34)) {
         return var6;
      } else {
   ...
   public final int method557(int arg0, D3DDISPLAYMODE arg1) {
