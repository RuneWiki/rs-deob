...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/ik;")
    private class571 field5475;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/ik;)V")
    private IDirect3D(class571 arg0) {
        super(arg0);
        this.field5475 = arg0;
    }
    ...
    public final IDirect3DDevice method2382(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field5475);
    ...
    public final D3DCAPS method2383(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/ik;)Ljagdx/IDirect3D;")
    public static final IDirect3D method2384(int arg0, class571 arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(I)Ljagdx/D3DDISPLAYMODE;")
    public final D3DDISPLAYMODE method2385(int arg0) {
    ...
    public final D3DADAPTER_IDENTIFIER method2386(int arg0, int arg1) {
