...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/hea;)V")
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/hea;)Ljagdx/IDirect3D;")
