...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/dba;)V")
    private IDirect3D(class375 arg0) {
        super(arg0);
        this.field10420 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/dba;)Ljagdx/IDirect3D;")
