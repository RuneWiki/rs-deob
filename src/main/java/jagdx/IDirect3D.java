...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/jd;")
    private class339 field9536;
    ...
    public final IDirect3DDevice method3783(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field9536);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjagdx/D3DDISPLAYMODE;)I", line = 22)
    public final int method3784(int arg0, D3DDISPLAYMODE arg1) {
    ...
    public final D3DADAPTER_IDENTIFIER method3785(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DCAPS;", line = 54)
    public final D3DCAPS method3786(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/jd;)V", line = 66)
    private IDirect3D(class339 arg0) {
        super(arg0);
        this.field9536 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/jd;)Ljagdx/IDirect3D;", line = 77)
    public static final IDirect3D method3787(int arg0, class339 arg1) {
