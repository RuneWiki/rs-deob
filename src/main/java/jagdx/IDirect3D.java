...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/wn;")
    private class569 field5935;

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(II)Ljagdx/D3DADAPTER_IDENTIFIER;", line = 12)
    public final D3DADAPTER_IDENTIFIER method2417(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/wn;)Ljagdx/IDirect3D;", line = 27)
    public static final IDirect3D method2418(int arg0, class569 arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DCAPS;", line = 43)
    public final D3DCAPS method2419(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(IILjava/awt/Canvas;ILjagdx/D3DPRESENT_PARAMETERS;)Ljagdx/IDirect3DDevice;", line = 60)
    public final IDirect3DDevice method2420(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field5935);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/wn;)V", line = 73)
    private IDirect3D(class569 arg0) {
        super(arg0);
        this.field5935 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(I)Ljagdx/D3DDISPLAYMODE;", line = 84)
    public final D3DDISPLAYMODE method2421(int arg0) {
