...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/gca;")
    private class674 field6946;
    ...
    public final IDirect3DDevice method2859(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field6946);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/gca;)V", line = 21)
    private IDirect3D(class674 arg0) {
        super(arg0);
        this.field6946 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/gca;)Ljagdx/IDirect3D;", line = 36)
    public static final IDirect3D method2860(int arg0, class674 arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(II)Ljagdx/D3DADAPTER_IDENTIFIER;", line = 52)
    public final D3DADAPTER_IDENTIFIER method2861(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DCAPS;", line = 70)
    public final D3DCAPS method2862(int arg0, int arg1) {
    ...
    public final int method2863(int arg0, D3DDISPLAYMODE arg1) {
