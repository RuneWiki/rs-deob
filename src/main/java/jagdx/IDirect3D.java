...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/pba;")
    private class703 field7228;
    ...
    public final IDirect3DDevice method3043(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field7228);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/pba;)V", line = 18)
    ...
    public final D3DCAPS method3044(int arg0, int arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/pba;)Ljagdx/IDirect3D;", line = 51)
    public static final IDirect3D method3045(int arg0, class703 arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjagdx/D3DDISPLAYMODE;)I", line = 65)
    public final int method3046(int arg0, D3DDISPLAYMODE arg1) {
    ...
    public final D3DADAPTER_IDENTIFIER method3047(int arg0, int arg1) {
