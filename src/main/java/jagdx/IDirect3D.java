...
public class IDirect3D extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "Ljaclib/peer/hk;")
    private class699 field7114;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "b", descriptor = "(II)Ljagdx/D3DCAPS;", line = 25)
    public final D3DCAPS method2953(int arg0, int arg1) {
    ...
    public final IDirect3DDevice method2954(int arg0, int arg1, Canvas arg2, int arg3, D3DPRESENT_PARAMETERS arg4) {
        IDirect3DDevice var6 = new IDirect3DDevice(this.field7114);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "<init>", descriptor = "(Ljaclib/peer/hk;)V", line = 51)
    private IDirect3D(class699 arg0) {
        super(arg0);
        this.field7114 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjaclib/peer/hk;)Ljagdx/IDirect3D;", line = 66)
    public static final IDirect3D method2955(int arg0, class699 arg1) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3D", name = "a", descriptor = "(ILjagdx/D3DDISPLAYMODE;)I", line = 80)
    public final int method2956(int arg0, D3DDISPLAYMODE arg1) {
