...
public class class511 extends class702 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/pba;)V", line = 8)
    public class511(class703 arg0) {
        super(arg0);
        this.Init();
    }
