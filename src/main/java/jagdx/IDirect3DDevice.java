...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/ca;")
    private class617 field6242;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field6243 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 5)
    public final int method2545(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6243[1] = arg2;
        field6243[0] = arg1;
        field6243[2] = arg3;
        field6243[3] = arg4;
        return this.method2549(arg0, field6243);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 20)
    public final IDirect3DSwapChain method2546(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6242);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class443.method2539(var3, (byte) -117)) {
            throw new class444(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 33)
    public final IDirect3DSurface method2547() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6242);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class443.method2539(var2, (byte) -122)) {
            throw new class444(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 52)
    public final IDirect3DVertexShader method2548(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6242);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class443.method2539(var3, (byte) -108)) {
            throw new class444(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 77)
    public final int method2549(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 91)
    public final IDirect3DEventQuery method2550() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6242);
        if (class443.method2538(-1, this._CreateEventQuery(var1))) {
            return var1.method3431(-89) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 109)
    public final IDirect3DSurface method2551(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6242);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class443.method2539(var3, (byte) -96)) {
            throw new class444(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/ca;)V", line = 121)
    public IDirect3DDevice(class617 arg0) {
        super(arg0);
        this.field6242 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 131)
    public final IDirect3DCubeTexture method2552(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6242);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class443.method2539(var7, (byte) -93)) {
            throw new class444(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 152)
    public final IDirect3DTexture method2553(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6242);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class443.method2539(var8, (byte) -127)) {
            throw new class444(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 165)
    public final IDirect3DIndexBuffer method2554(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6242);
        } else {
            arg4.method3440(21066);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class443.method2539(var6, (byte) -94)) {
            throw new class444(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 187)
    public final IDirect3DVertexBuffer method2555(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6242);
        } else {
            arg4.method3440(21066);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class443.method2539(var6, (byte) -73)) {
            throw new class444(String.valueOf(var6));
        }
        arg4.field6245 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 214)
    public final int method2556(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 222)
    public final IDirect3DVolumeTexture method2557(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6242);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class443.method2539(var9, (byte) -115)) {
            throw new class444(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 236)
    public final IDirect3DVertexDeclaration method2558(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6242);
        } else {
            arg1.method3440(21066);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class443.method2539(var3, (byte) -90)) {
            throw new class444(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 256)
    public final int method2559(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 270)
    public final IDirect3DSurface method2560(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6242);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class443.method2539(var8, (byte) -100)) {
            throw new class444(String.valueOf(var8));
        }
        return var7;
    }
    ...
    public final native int SetLight(int arg0, class445 arg1);
