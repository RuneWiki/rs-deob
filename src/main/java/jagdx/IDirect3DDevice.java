...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/bd;")
    private class700 field7204;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field7205 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 11)
    public final IDirect3DVolumeTexture method3059(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field7204);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class507.method3052(var9, 55)) {
            throw new class508(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 24)
    public final IDirect3DEventQuery method3060() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field7204);
        if (class507.method3053(this._CreateEventQuery(var1), -1)) {
            return var1.method3963((byte) -125) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 39)
    public final IDirect3DSwapChain method3061(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field7204);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class507.method3052(var3, 72)) {
            throw new class508(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 56)
    public final int method3062(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field7205[1] = arg2;
        field7205[2] = arg3;
        field7205[0] = arg1;
        field7205[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field7205, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 68)
    public final int method3063(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field7205[1] = arg2;
        field7205[2] = arg3;
        field7205[3] = arg4;
        field7205[0] = arg1;
        return this.SetVertexShaderConstantF(arg0, field7205, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 81)
    public final IDirect3DSurface method3064(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field7204);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class507.method3052(var8, -114)) {
            throw new class508(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 97)
    public final IDirect3DSurface method3065(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field7204);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class507.method3052(var3, -102)) {
            throw new class508(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 120)
    public final IDirect3DIndexBuffer method3066(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field7204);
        } else {
            arg4.method3967(29036);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class507.method3052(var6, -96)) {
            throw new class508(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 146)
    public final IDirect3DPixelShader method3067(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field7204);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class507.method3052(var3, 122)) {
            throw new class508(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 166)
    public final IDirect3DVertexShader method3068(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field7204);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class507.method3052(var3, -97)) {
            throw new class508(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 184)
    public final IDirect3DCubeTexture method3069(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field7204);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class507.method3052(var7, 91)) {
            throw new class508(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 201)
    public final IDirect3DTexture method3070(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field7204);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class507.method3052(var8, 78)) {
            throw new class508(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 216)
    public final IDirect3DVertexDeclaration method3071(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field7204);
        } else {
            arg1.method3967(29036);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class507.method3052(var3, -118)) {
            throw new class508(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 235)
    public final IDirect3DSurface method3072() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field7204);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class507.method3052(var2, 44)) {
            throw new class508(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 265)
    public final int method3073(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/bd;)V", line = 275)
    public IDirect3DDevice(class700 arg0) {
        super(arg0);
        this.field7204 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 284)
    public final IDirect3DVertexBuffer method3074(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field7204);
        } else {
            arg4.method3967(29036);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class507.method3052(var6, 126)) {
            throw new class508(String.valueOf(var6));
        }
        arg4.field7207 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 306)
    public final int method3075(int arg0, float[] arg1) {
    ...
    public final int method3076(int arg0, boolean arg1) {
    ...
    public final native int SetLight(int arg0, class509 arg1);
