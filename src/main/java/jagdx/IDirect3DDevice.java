...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/ep;")
    private class421 field10302;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field10301 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 14)
    public final IDirect3DVolumeTexture method4095(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field10302);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class735.method4118(var9, -2420)) {
            throw new class736(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 29)
    public final IDirect3DVertexDeclaration method4096(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field10302);
        } else {
            arg1.method2583((byte) -108);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class735.method4118(var3, -2420)) {
            throw new class736(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 47)
    public final int method4097(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10301[2] = arg3;
        field10301[0] = arg1;
        field10301[1] = arg2;
        field10301[3] = arg4;
        return this.SetVertexShaderConstantF(arg0, field10301, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 58)
    public final IDirect3DPixelShader method4098(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field10302);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 84)
    public final int method4099(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10301[1] = arg2;
        field10301[3] = arg4;
        field10301[2] = arg3;
        field10301[0] = arg1;
        return this.SetPixelShaderConstantF(arg0, field10301, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 97)
    public final int method4100(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 112)
    public final IDirect3DSurface method4101(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field10302);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class735.method4118(var8, -2420)) {
            throw new class736(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 130)
    public final IDirect3DTexture method4102(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field10302);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 143)
    public final IDirect3DSurface method4103(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field10302);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 158)
    public final IDirect3DIndexBuffer method4104(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field10302);
        } else {
            arg4.method2583((byte) -103);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class735.method4118(var6, -2420)) {
            throw new class736(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 182)
    public final int method4105(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/ep;)V", line = 192)
    public IDirect3DDevice(class421 arg0) {
        super(arg0);
        this.field10302 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 205)
    public final IDirect3DEventQuery method4106() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field10302);
        if (class735.method4119(-2005530516, this._CreateEventQuery(var1))) {
            return var1.method2576(-27169) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 221)
    public final IDirect3DSurface method4107() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field10302);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class735.method4118(var2, -2420)) {
            throw new class736(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 239)
    public final int method4108(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 250)
    public final IDirect3DCubeTexture method4109(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field10302);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class735.method4118(var7, -2420)) {
            throw new class736(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 264)
    public final IDirect3DVertexShader method4110(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field10302);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 283)
    public final IDirect3DSwapChain method4111(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field10302);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 298)
    public final IDirect3DVertexBuffer method4112(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field10302);
        } else {
            arg4.method2583((byte) -127);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class735.method4118(var6, -2420)) {
            throw new class736(String.valueOf(var6));
        }
        arg4.field10300 = arg0;
        return arg4;
    }
    ...
    public final native int SetLight(int arg0, class737 arg1);
