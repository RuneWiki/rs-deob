...
public class IDirect3DDevice extends IUnknown {
   ...
   private class700 field7357;
   @OriginalMember(
      owner = "client!jagdx/IDirect3DDevice",
      name = "b",
      descriptor = "[F"
   )
   private static float[] field7358 = new float[4];
   ...
   public final IDirect3DSurface method3802(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
      IDirect3DSurface var7 = new IDirect3DSurface(this.field7357);
      int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
      if (!class507.method3796(0, var8)) {
         return var7;
      } else {
   ...
   public final IDirect3DIndexBuffer method3803(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
      if (arg4 == null) {
         arg4 = new IDirect3DIndexBuffer(this.field7357);
      } else {
         arg4.method5108((byte)7);
      }

      int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
      if (class507.method3796(0, var6)) {
   ...
   public final int method3804(int arg0, boolean arg1) {
   ...
   public final IDirect3DVertexShader method3805(byte[] arg0) {
      if (arg0 != null) {
         IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field7357);
   ...
   public final IDirect3DPixelShader method3806(byte[] arg0) {
      if (arg0 == null) {
         return null;
      } else {
         IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field7357);
   ...
   public final IDirect3DVolumeTexture method3807(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
      IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field7357);
      int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
      if (class507.method3796(0, var9)) {
   ...
   public final IDirect3DSurface method3808(int arg0) {
      IDirect3DSurface var2 = new IDirect3DSurface(this.field7357);
   ...
   public final IDirect3DVertexBuffer method3809(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
      if (arg4 == null) {
         arg4 = new IDirect3DVertexBuffer(this.field7357);
      } else {
         arg4.method5108((byte)7);
      }
   ...
   public final IDirect3DEventQuery method3810() {
      IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field7357);
      if (class507.method3795(this._CreateEventQuery(var1), -10)) {
         return var1.method5097(false) ? var1 : null;
      } else {
         return null;
      }
   }
   ...
   public final IDirect3DSwapChain method3811(int arg0) {
      IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field7357);
   ...
   public final IDirect3DSurface method3812() {
      IDirect3DSurface var1 = new IDirect3DSurface(this.field7357);
      int var2 = this._GetDepthStencilSurface(var1);
      if (!class507.method3796(0, var2)) {
         return var1;
      } else {
   ...
   public final IDirect3DTexture method3813(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
      IDirect3DTexture var7 = new IDirect3DTexture(this.field7357);
   ...
   public final int method3814(int arg0, float arg1) {
   ...
   public final IDirect3DVertexDeclaration method3815(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
      if (arg1 == null) {
         arg1 = new IDirect3DVertexDeclaration(this.field7357);
      } else {
         arg1.method5108((byte)7);
      }
   ...
   public final int method3816(int arg0, float[] arg1) {
   ...
   public final int method3817(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field7358[1] = arg2;
      field7358[0] = arg1;
      field7358[2] = arg3;
      field7358[3] = arg4;
      return this.SetVertexShaderConstantF(arg0, field7358, 1);
   }
   ...
   public final IDirect3DCubeTexture method3818(int arg0, int arg1, int arg2, int arg3, int arg4) {
      IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field7357);
   ...
   public final int method3819(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field7358[3] = arg4;
      field7358[1] = arg2;
      field7358[0] = arg1;
      field7358[2] = arg3;
      return this.SetPixelShaderConstantF(arg0, field7358, 1);
   }
