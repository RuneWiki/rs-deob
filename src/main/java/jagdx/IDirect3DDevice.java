...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/iw;")
    private class441 field10440;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field10439 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 11)
    public final IDirect3DSurface method4171(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field10440);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class771.method4196((byte) -82, var8)) {
            throw new class769(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 29)
    public final IDirect3DCubeTexture method4172(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field10440);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class771.method4196((byte) -109, var7)) {
            throw new class769(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 49)
    public final int method4173(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 57)
    public final IDirect3DIndexBuffer method4174(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field10440);
        } else {
            arg4.method2546(true);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class771.method4196((byte) -99, var6)) {
            throw new class769(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 83)
    public final int method4175(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 91)
    public final int method4176(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10439[1] = arg2;
        field10439[3] = arg4;
        field10439[2] = arg3;
        field10439[0] = arg1;
        return this.SetVertexShaderConstantF(arg0, field10439, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 107)
    public final IDirect3DSwapChain method4177(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field10440);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class771.method4196((byte) -122, var3)) {
            throw new class769(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 119)
    public final int method4178(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 132)
    public final IDirect3DTexture method4179(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field10440);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class771.method4196((byte) -106, var8)) {
            throw new class769(String.valueOf(var8));
        }
        return var7;
    }
    ...
    public final IDirect3DEventQuery method4180() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field10440);
        if (class771.method4195(false, this._CreateEventQuery(var1))) {
            return var1.method2539(-958) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 164)
    public final IDirect3DSurface method4181() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field10440);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class771.method4196((byte) -60, var2)) {
            throw new class769(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 183)
    public final IDirect3DVertexBuffer method4182(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field10440);
        } else {
            arg4.method2546(true);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class771.method4196((byte) -50, var6)) {
            throw new class769(String.valueOf(var6));
        }
        arg4.field10438 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 204)
    public final IDirect3DVertexDeclaration method4183(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field10440);
        } else {
            arg1.method2546(true);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class771.method4196((byte) -80, var3)) {
            throw new class769(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 223)
    public final IDirect3DVolumeTexture method4184(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field10440);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class771.method4196((byte) -49, var9)) {
            throw new class769(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 239)
    public final IDirect3DVertexShader method4185(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field10440);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class771.method4196((byte) -70, var3)) {
            throw new class769(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 261)
    public final IDirect3DSurface method4186(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field10440);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class771.method4196((byte) -117, var3)) {
            throw new class769(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 278)
    public final int method4187(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10439[3] = arg4;
        field10439[0] = arg1;
        field10439[2] = arg3;
        field10439[1] = arg2;
        return this.SetPixelShaderConstantF(arg0, field10439, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/iw;)V", line = 288)
    public IDirect3DDevice(class441 arg0) {
        super(arg0);
        this.field10440 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 299)
    public final IDirect3DPixelShader method4188(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field10440);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class771.method4196((byte) -75, var3)) {
            throw new class769(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final native int SetLight(int arg0, class770 arg1);
