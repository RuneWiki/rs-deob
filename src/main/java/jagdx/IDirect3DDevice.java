...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/pb;")
    private class570 field5752;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field5751 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 8)
    public final IDirect3DEventQuery method2392() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field5752);
        if (class398.method2384(7155, this._CreateEventQuery(var1))) {
            return var1.method3338(-31968) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 26)
    public final int method2393(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field5751[2] = arg3;
        field5751[0] = arg1;
        field5751[3] = arg4;
        field5751[1] = arg2;
        return this.method2395(arg0, field5751);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 40)
    public final IDirect3DVolumeTexture method2394(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field5752);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class398.method2383((byte) -2, var9)) {
            throw new class399(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 52)
    public final int method2395(int arg0, float[] arg1) {
    ...
    public final IDirect3DVertexShader method2396(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field5752);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class398.method2383((byte) 126, var3)) {
            throw new class399(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/pb;)V", line = 85)
    public IDirect3DDevice(class570 arg0) {
        super(arg0);
        this.field5752 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 99)
    public final IDirect3DSurface method2397(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field5752);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class398.method2383((byte) 115, var8)) {
            throw new class399(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 116)
    public final IDirect3DSwapChain method2398(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field5752);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class398.method2383((byte) -110, var3)) {
            throw new class399(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 134)
    public final IDirect3DIndexBuffer method2399(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field5752);
        } else {
            arg4.method3340((byte) -27);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class398.method2383((byte) 107, var6)) {
            throw new class399(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 157)
    public final IDirect3DVertexDeclaration method2400(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field5752);
        } else {
            arg1.method3340((byte) -27);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class398.method2383((byte) 120, var3)) {
            throw new class399(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 176)
    public final IDirect3DVertexBuffer method2401(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field5752);
        } else {
            arg4.method3340((byte) -27);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class398.method2383((byte) -34, var6)) {
            throw new class399(String.valueOf(var6));
        }
        arg4.field5749 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 196)
    public final int method2402(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 207)
    public final IDirect3DSurface method2403(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field5752);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 223)
    public final IDirect3DCubeTexture method2404(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field5752);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class398.method2383((byte) 123, var7)) {
            throw new class399(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 236)
    public final int method2405(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 249)
    public final IDirect3DSurface method2406() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field5752);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class398.method2383((byte) -79, var2)) {
            throw new class399(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 262)
    public final IDirect3DTexture method2407(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field5752);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class398.method2383((byte) 118, var8)) {
            throw new class399(String.valueOf(var8));
        }
        return var7;
    }
    ...
    public final native int SetLight(int arg0, class397 arg1);
