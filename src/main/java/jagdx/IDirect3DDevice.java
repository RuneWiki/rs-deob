...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/pba;")
    private class703 field7229;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field7230 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/pba;)V", line = 4)
    public IDirect3DDevice(class703 arg0) {
        super(arg0);
        this.field7229 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 13)
    public final IDirect3DVertexDeclaration method3050(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field7229);
        } else {
            arg1.method4003(true);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class509.method3049(-1, var3)) {
            throw new class510(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 35)
    public final IDirect3DTexture method3051(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field7229);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class509.method3049(-1, var8)) {
            throw new class510(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 53)
    public final int method3052(int arg0, boolean arg1) {
    ...
    public final IDirect3DCubeTexture method3053(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field7229);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class509.method3049(-1, var7)) {
            throw new class510(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 86)
    public final IDirect3DSurface method3054(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field7229);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 100)
    public final IDirect3DSurface method3055() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field7229);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class509.method3049(-1, var2)) {
            throw new class510(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 117)
    public final IDirect3DSurface method3056(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field7229);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 134)
    public final IDirect3DEventQuery method3057() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field7229);
        if (class509.method3048(-1, this._CreateEventQuery(var1))) {
            return var1.method3994(-16912) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 150)
    public final IDirect3DIndexBuffer method3058(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field7229);
        } else {
            arg4.method4003(true);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class509.method3049(-1, var6)) {
            throw new class510(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 175)
    public final IDirect3DVolumeTexture method3059(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field7229);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class509.method3049(-1, var9)) {
            throw new class510(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 193)
    public final IDirect3DVertexBuffer method3060(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field7229);
        } else {
            arg4.method4003(true);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 216)
    public final int method3061(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 226)
    public final int method3062(int arg0, float arg1) {
    ...
    public final IDirect3DVertexShader method3063(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field7229);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 260)
    public final int method3064(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field7230[1] = arg2;
        field7230[2] = arg3;
        field7230[3] = arg4;
        field7230[0] = arg1;
        return this.SetPixelShaderConstantF(arg0, field7230, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 274)
    public final IDirect3DSwapChain method3065(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field7229);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 287)
    public final IDirect3DPixelShader method3066(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field7229);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 304)
    public final int method3067(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field7230[0] = arg1;
        field7230[3] = arg4;
        field7230[1] = arg2;
        field7230[2] = arg3;
        return this.SetVertexShaderConstantF(arg0, field7230, 1);
    }
    ...
    public final native int SetLight(int arg0, class511 arg1);
