...
public class IDirect3DDevice extends IUnknown {
   ...
   private class406 field5931;
   @OriginalMember(
      owner = "client!jagdx/IDirect3DDevice",
      name = "c",
      descriptor = "[F"
   )
   private static float[] field5930 = new float[4];
   ...
   public final IDirect3DVertexShader method3115(byte[] arg0) {
      if (arg0 != null) {
         IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field5931);
         int var3 = this._CreateVertexShader(arg0, var2);
         if (class402.method3145(var3, (byte)123)) {
            throw new class401(String.valueOf(var3));
         } else {
            return var2;
         }
      } else {
   ...
   public final IDirect3DSurface method3116() {
      IDirect3DSurface var1 = new IDirect3DSurface(this.field5931);
      int var2 = this._GetDepthStencilSurface(var1);
      if (!class402.method3145(var2, (byte)123)) {
         return var1;
      } else {
         throw new class401(String.valueOf(var2));
      }
   }
   ...
   public final IDirect3DVertexDeclaration method3117(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
      if (arg1 == null) {
         arg1 = new IDirect3DVertexDeclaration(this.field5931);
      } else {
         arg1.method3157(103);
      }
   ...
   public final native int SetLight(int arg0, class400 arg1);
   ...
   public final IDirect3DTexture method3118(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
      IDirect3DTexture var7 = new IDirect3DTexture(this.field5931);
      int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
      if (class402.method3145(var8, (byte)123)) {
         throw new class401(String.valueOf(var8));
      } else {
         return var7;
      }
   }
   ...
   public final int method3119(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field5930[2] = arg3;
      field5930[1] = arg2;
      field5930[0] = arg1;
      field5930[3] = arg4;
      return this.SetPixelShaderConstantF(arg0, field5930, 1);
   }
   ...
   public final IDirect3DSurface method3120(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
      IDirect3DSurface var7 = new IDirect3DSurface(this.field5931);
   ...
   public final IDirect3DPixelShader method3121(byte[] arg0) {
      if (arg0 == null) {
         return null;
      } else {
         IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field5931);
   ...
   public final IDirect3DSurface method3122(int arg0) {
      IDirect3DSurface var2 = new IDirect3DSurface(this.field5931);
   ...
   public final int method3123(int arg0, float[] arg1) {
   ...
   public final IDirect3DSwapChain method3124(int arg0) {
      IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field5931);
   ...
   public final IDirect3DIndexBuffer method3125(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
      if (arg4 == null) {
         arg4 = new IDirect3DIndexBuffer(this.field5931);
      } else {
         arg4.method3157(113);
      }

      int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
      if (class402.method3145(var6, (byte)123)) {
         throw new class401(String.valueOf(var6));
      } else {
         return arg4;
      }
   }
   ...
   public final IDirect3DVolumeTexture method3126(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
      IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field5931);
      int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
      if (class402.method3145(var9, (byte)123)) {
         throw new class401(String.valueOf(var9));
      } else {
         return var8;
      }
   }
   ...
   public final int method3127(int arg0, boolean arg1) {
   ...
   public final IDirect3DEventQuery method3128() {
      IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field5931);
      if (class402.method3144(-2005530595, this._CreateEventQuery(var1))) {
         return !var1.method3160(true) ? null : var1;
      } else {
         return null;
      }
   }
   ...
   public final IDirect3DVertexBuffer method3129(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
      if (arg4 != null) {
         arg4.method3157(2);
      } else {
         arg4 = new IDirect3DVertexBuffer(this.field5931);
      }
   ...
   public final IDirect3DCubeTexture method3130(int arg0, int arg1, int arg2, int arg3, int arg4) {
      IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field5931);
      int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
      if (class402.method3145(var7, (byte)123)) {
         throw new class401(String.valueOf(var7));
      } else {
         return var6;
      }
   }
   ...
   public final int method3131(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field5930[0] = arg1;
      field5930[1] = arg2;
      field5930[3] = arg4;
      field5930[2] = arg3;
      return this.SetVertexShaderConstantF(arg0, field5930, 1);
   }
   ...
   public final int method3132(int arg0, float arg1) {
