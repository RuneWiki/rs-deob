...
public class IDirect3DDevice extends IUnknown {
   ...
   private class378 field11099;
   @OriginalMember(
      owner = "client!jagdx/IDirect3DDevice",
      name = "c",
      descriptor = "[F"
   )
   private static float[] field11100 = new float[4];
   ...
   public final IDirect3DSurface method5495() {
      IDirect3DSurface var1 = new IDirect3DSurface(this.field11099);
      int var2 = this._GetDepthStencilSurface(var1);
      if (class760.method5513(false, var2)) {
         throw new class759(String.valueOf(var2));
      } else {
         return var1;
      }
   }
   ...
   public IDirect3DDevice(class378 arg0) {
      super(arg0);
      this.field11099 = arg0;
   }
   ...
   public final IDirect3DIndexBuffer method5496(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
      if (arg4 == null) {
         arg4 = new IDirect3DIndexBuffer(this.field11099);
      } else {
         arg4.method2971((byte)118);
      }

      int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
      if (!class760.method5513(false, var6)) {
         return arg4;
      } else {
         throw new class759(String.valueOf(var6));
      }
   }
   ...
   public final IDirect3DSwapChain method5497(int arg0) {
      IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field11099);
      int var3 = this._GetSwapChain(arg0, var2);
      if (!class760.method5513(false, var3)) {
         return var2;
      } else {
         throw new class759(String.valueOf(var3));
      }
   }
   ...
   public final int method5498(int arg0, float arg1) {
   ...
   public final IDirect3DVertexShader method5499(byte[] arg0) {
      if (arg0 != null) {
         IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field11099);
   ...
   public final IDirect3DEventQuery method5500() {
      IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field11099);
      if (!class760.method5514(25060, this._CreateEventQuery(var1))) {
         return null;
      } else {
         return !var1.method2972(-21735) ? null : var1;
      }
   }
   ...
   public final IDirect3DVertexDeclaration method5501(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
      if (arg1 == null) {
         arg1 = new IDirect3DVertexDeclaration(this.field11099);
      } else {
         arg1.method2971((byte)93);
      }
   ...
   public final IDirect3DPixelShader method5502(byte[] arg0) {
      if (arg0 == null) {
         return null;
      } else {
         IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field11099);
   ...
   public final IDirect3DVolumeTexture method5503(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
      IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field11099);
      int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
      if (!class760.method5513(false, var9)) {
         return var8;
      } else {
         throw new class759(String.valueOf(var9));
      }
   }
   ...
   public final IDirect3DSurface method5504(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
      IDirect3DSurface var7 = new IDirect3DSurface(this.field11099);
      int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
      if (!class760.method5513(false, var8)) {
         return var7;
      } else {
         throw new class759(String.valueOf(var8));
      }
   }
   ...
   public final int method5505(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field11100[3] = arg4;
      field11100[0] = arg1;
      field11100[2] = arg3;
      field11100[1] = arg2;
      return this.SetVertexShaderConstantF(arg0, field11100, 1);
   }
   ...
   public final IDirect3DVertexBuffer method5506(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
      if (arg4 != null) {
         arg4.method2971((byte)-119);
      } else {
         arg4 = new IDirect3DVertexBuffer(this.field11099);
      }

      int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
      if (!class760.method5513(false, var6)) {
         arg4.field11097 = arg0;
         return arg4;
      } else {
         throw new class759(String.valueOf(var6));
      }
   ...
   public final IDirect3DCubeTexture method5507(int arg0, int arg1, int arg2, int arg3, int arg4) {
      IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field11099);
      int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
      if (!class760.method5513(false, var7)) {
         return var6;
      } else {
         throw new class759(String.valueOf(var7));
      }
   }
   ...
   public final IDirect3DSurface method5508(int arg0) {
      IDirect3DSurface var2 = new IDirect3DSurface(this.field11099);
   ...
   public final native int SetLight(int arg0, class758 arg1);
   ...
   public final IDirect3DTexture method5509(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
      IDirect3DTexture var7 = new IDirect3DTexture(this.field11099);
   ...
   public final int method5510(int arg0, float[] arg1) {
   ...
   public final int method5511(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field11100[1] = arg2;
      field11100[0] = arg1;
      field11100[2] = arg3;
      field11100[3] = arg4;
      return this.SetPixelShaderConstantF(arg0, field11100, 1);
   }
   ...
   public final int method5512(int arg0, boolean arg1) {
