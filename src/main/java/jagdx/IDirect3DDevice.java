...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/rh;")
    private class670 field6876;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field6875 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 10)
    public final int method2898(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 17)
    public final int method2899(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 24)
    public final int method2900(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6875[2] = arg3;
        field6875[3] = arg4;
        field6875[1] = arg2;
        field6875[0] = arg1;
        return this.SetVertexShaderConstantF(arg0, field6875, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 35)
    public final IDirect3DVertexDeclaration method2901(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6876);
        } else {
            arg1.method3834(-31315);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class481.method2897(var3, -15560)) {
            throw new class482(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 54)
    public final IDirect3DSurface method2902(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6876);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class481.method2897(var8, -15560)) {
            throw new class482(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 69)
    public final IDirect3DVertexBuffer method2903(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6876);
        } else {
            arg4.method3834(-31315);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class481.method2897(var6, -15560)) {
            throw new class482(String.valueOf(var6));
        }
        arg4.field6878 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 91)
    public final IDirect3DEventQuery method2904() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6876);
        if (class481.method2896(this._CreateEventQuery(var1), 2005530520)) {
            return var1.method3830((byte) -124) ? var1 : null;
        } else {
            return null;
        }
    }
    ...
    public final IDirect3DVolumeTexture method2905(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6876);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class481.method2897(var9, -15560)) {
            throw new class482(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 130)
    public final int method2906(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6875[2] = arg3;
        field6875[1] = arg2;
        field6875[0] = arg1;
        field6875[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field6875, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 144)
    public final IDirect3DSurface method2907(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6876);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 162)
    public final IDirect3DSurface method2908() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6876);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class481.method2897(var2, -15560)) {
            throw new class482(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 180)
    public final IDirect3DVertexShader method2909(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6876);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 207)
    public final IDirect3DTexture method2910(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6876);
    ...
    public final IDirect3DIndexBuffer method2912(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6876);
        } else {
            arg4.method3834(-31315);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 251)
    public final IDirect3DPixelShader method2913(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field6876);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 270)
    public final IDirect3DCubeTexture method2914(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6876);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class481.method2897(var7, -15560)) {
            throw new class482(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/rh;)V", line = 290)
    public IDirect3DDevice(class670 arg0) {
        super(arg0);
        this.field6876 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 302)
    public final IDirect3DSwapChain method2915(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6876);
    ...
    public final native int SetLight(int arg0, class483 arg1);
