...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/hr;")
    private class615 field6103;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field6104 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 10)
    public final IDirect3DEventQuery method2429() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6103);
        if (class441.method2451(this._CreateEventQuery(var1), (byte) -119)) {
            return var1.method3448(-21717) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 33)
    public final IDirect3DIndexBuffer method2430(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6103);
        } else {
            arg4.method3457((byte) -34);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class441.method2452(var6, (byte) 111)) {
            throw new class440(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 54)
    public final IDirect3DVertexDeclaration method2431(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6103);
        } else {
            arg1.method3457((byte) -34);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class441.method2452(var3, (byte) 109)) {
            throw new class440(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 74)
    public final IDirect3DTexture method2432(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6103);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class441.method2452(var8, (byte) 88)) {
            throw new class440(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 89)
    public final IDirect3DCubeTexture method2433(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6103);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class441.method2452(var7, (byte) 110)) {
            throw new class440(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 105)
    public final IDirect3DVertexBuffer method2434(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6103);
        } else {
            arg4.method3457((byte) -34);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class441.method2452(var6, (byte) 123)) {
            throw new class440(String.valueOf(var6));
        }
        arg4.field6106 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 128)
    public final IDirect3DSwapChain method2435(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6103);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class441.method2452(var3, (byte) 110)) {
            throw new class440(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 143)
    public final int method2436(int arg0, float[] arg1) {
    ...
    public final int method2437(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/hr;)V", line = 161)
    public IDirect3DDevice(class615 arg0) {
        super(arg0);
        this.field6103 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 175)
    public final IDirect3DSurface method2438(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6103);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class441.method2452(var8, (byte) 87)) {
            throw new class440(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 189)
    public final int method2439(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6104[2] = arg3;
        field6104[0] = arg1;
        field6104[3] = arg4;
        field6104[1] = arg2;
        return this.method2436(arg0, field6104);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 200)
    public final int method2440(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 210)
    public final IDirect3DSurface method2441() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6103);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class441.method2452(var2, (byte) 105)) {
            throw new class440(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 226)
    public final IDirect3DSurface method2442(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6103);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class441.method2452(var3, (byte) 127)) {
            throw new class440(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 249)
    public final IDirect3DVolumeTexture method2443(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6103);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class441.method2452(var9, (byte) 118)) {
            throw new class440(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 262)
    public final IDirect3DVertexShader method2444(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6103);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class441.method2452(var3, (byte) 118)) {
            throw new class440(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final native int SetLight(int arg0, class442 arg1);
