...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/ik;")
    private class571 field5477;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field5476 = new float[4];
    ...
    public final IDirect3DSurface method2387(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field5477);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class399.method2378(var8, -1)) {
    ...
    public final IDirect3DEventQuery method2388() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field5477);
        if (class399.method2379(this._CreateEventQuery(var1), 28658)) {
            return var1.method3210((byte) 107) ? var1 : null;
        } else {
            return null;
        }
    }
    ...
    public final IDirect3DVertexDeclaration method2389(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field5477);
        } else {
            arg1.method3212((byte) 87);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class399.method2378(var3, -1)) {
    ...
    public final IDirect3DTexture method2390(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field5477);
    ...
    public final IDirect3DVertexShader method2391(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field5477);
    ...
    public final IDirect3DSurface method2392() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field5477);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class399.method2378(var2, -1)) {
    ...
    public final int method2393(int arg0, float arg1, float arg2, float arg3, float arg4) {
        ...
        field5476[0] = arg1;
        field5476[1] = arg2;
        return this.method2396(arg0, field5476);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I")
    public final int method2394(int arg0, float arg1) {
    ...
    public final IDirect3DSwapChain method2395(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field5477);
    ...
    public final int method2396(int arg0, float[] arg1) {
    ...
    public final IDirect3DVertexBuffer method2397(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field5477);
        } else {
            arg4.method3212((byte) 87);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class399.method2378(var6, -1)) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/ik;)V")
    public IDirect3DDevice(class571 arg0) {
        super(arg0);
        this.field5477 = arg0;
    }
    ...
    public final IDirect3DSurface method2398(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field5477);
    ...
    public final int method2399(int arg0, boolean arg1) {
    ...
    public final IDirect3DIndexBuffer method2400(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field5477);
        } else {
            arg4.method3212((byte) 87);
        }
    ...
    public final IDirect3DCubeTexture method2401(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field5477);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class399.method2378(var7, -1)) {
    ...
    public final IDirect3DVolumeTexture method2402(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field5477);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class399.method2378(var9, -1)) {
