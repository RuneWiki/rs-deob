...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/fk;")
    private class578 field5790;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field5789 = new float[4];
    ...
    public final IDirect3DIndexBuffer method2429(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field5790);
        } else {
            arg4.method3306((byte) -86);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class410.method2427(111, var6)) {
            throw new class409(String.valueOf(var6));
        }
        return arg4;
    }
    ...
    public final IDirect3DVertexDeclaration method2430(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field5790);
        } else {
            arg1.method3306((byte) 126);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class410.method2427(107, var3)) {
            throw new class409(String.valueOf(var3));
        }
        return arg1;
    }
    ...
    public final IDirect3DVertexBuffer method2431(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field5790);
        } else {
            arg4.method3306((byte) 123);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class410.method2427(112, var6)) {
            throw new class409(String.valueOf(var6));
        }
        arg4.field5792 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/fk;)V")
    public IDirect3DDevice(class578 arg0) {
        super(arg0);
        this.field5790 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;")
    public final IDirect3DSwapChain method2432(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field5790);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class410.method2427(99, var3)) {
            throw new class409(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final IDirect3DSurface method2433(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field5790);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class410.method2427(105, var3)) {
            throw new class409(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final IDirect3DTexture method2434(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field5790);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class410.method2427(104, var8)) {
            throw new class409(String.valueOf(var8));
        }
        return var7;
    }
    ...
    public final IDirect3DCubeTexture method2435(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field5790);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class410.method2427(106, var7)) {
            throw new class409(String.valueOf(var7));
        }
        return var6;
    }
    ...
    public final IDirect3DVolumeTexture method2437(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field5790);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class410.method2427(110, var9)) {
            throw new class409(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I")
    public final int method2438(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field5789[3] = arg4;
        field5789[2] = arg3;
        field5789[1] = arg2;
        field5789[0] = arg1;
        return this.method2439(arg0, field5789);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I")
    public final int method2439(int arg0, float[] arg1) {
    ...
    public final IDirect3DEventQuery method2440() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field5790);
        if (class410.method2428(this._CreateEventQuery(var1), (byte) 71)) {
            return var1.method3302(-12372) ? var1 : null;
        } else {
            return null;
        }
    }
    ...
    public final IDirect3DSurface method2441(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field5790);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class410.method2427(122, var8)) {
            throw new class409(String.valueOf(var8));
        }
        return var7;
    }
    ...
    public final IDirect3DSurface method2442() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field5790);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class410.method2427(111, var2)) {
            throw new class409(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;")
    public final IDirect3DVertexShader method2443(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field5790);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class410.method2427(104, var3)) {
            throw new class409(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final int method2444(int arg0, boolean arg1) {
    ...
    public final native int SetLight(int arg0, class411 arg1);
