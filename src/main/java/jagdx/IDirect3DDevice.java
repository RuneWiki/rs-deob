...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/wf;")
    private class669 field6833;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field6832 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 8)
    public final IDirect3DVertexBuffer method2886(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6833);
        } else {
            arg4.method3786(30216);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class480.method2880((byte) -114, var6)) {
            throw new class481(String.valueOf(var6));
        }
        arg4.field6835 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 31)
    public final IDirect3DVolumeTexture method2887(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6833);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class480.method2880((byte) -120, var9)) {
            throw new class481(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 51)
    public final int method2888(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 59)
    public final int method2889(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 69)
    public final int method2890(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6832[0] = arg1;
        field6832[1] = arg2;
        field6832[3] = arg4;
        field6832[2] = arg3;
        return this.SetVertexShaderConstantF(arg0, field6832, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 80)
    public final IDirect3DVertexDeclaration method2891(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6833);
        } else {
            arg1.method3786(30216);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class480.method2880((byte) -90, var3)) {
            throw new class481(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 106)
    public final int method2892(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6832[1] = arg2;
        field6832[0] = arg1;
        field6832[3] = arg4;
        field6832[2] = arg3;
        return this.SetPixelShaderConstantF(arg0, field6832, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 120)
    public final IDirect3DCubeTexture method2893(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6833);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class480.method2880((byte) -111, var7)) {
            throw new class481(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 134)
    public final int method2894(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 142)
    public final IDirect3DIndexBuffer method2895(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6833);
        } else {
            arg4.method3786(30216);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class480.method2880((byte) -127, var6)) {
            throw new class481(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 169)
    public final IDirect3DSurface method2896(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6833);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class480.method2880((byte) -99, var3)) {
            throw new class481(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 188)
    public final IDirect3DSurface method2897() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6833);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class480.method2880((byte) -59, var2)) {
            throw new class481(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 209)
    public final IDirect3DSurface method2898(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6833);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class480.method2880((byte) -63, var8)) {
            throw new class481(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 223)
    public final IDirect3DEventQuery method2899() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6833);
        if (class480.method2879(this._CreateEventQuery(var1), (byte) -101)) {
            return var1.method3782(32422) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 242)
    public final IDirect3DSwapChain method2900(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6833);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class480.method2880((byte) -119, var3)) {
            throw new class481(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 259)
    public final IDirect3DTexture method2901(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6833);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class480.method2880((byte) -42, var8)) {
            throw new class481(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 274)
    public final IDirect3DPixelShader method2902(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field6833);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class480.method2880((byte) -34, var3)) {
            throw new class481(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/wf;)V", line = 292)
    public IDirect3DDevice(class669 arg0) {
        super(arg0);
        this.field6833 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 304)
    public final IDirect3DVertexShader method2903(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6833);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class480.method2880((byte) -43, var3)) {
            throw new class481(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final native int SetLight(int arg0, class482 arg1);
