...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/io;")
    private class406 field5825;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field5826 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 7)
    public final IDirect3DSurface method3127(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field5825);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class402.method3157(var8, -2005530585)) {
            throw new class400(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 21)
    public final IDirect3DEventQuery method3128() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field5825);
        if (class402.method3156(this._CreateEventQuery(var1), -1)) {
            return var1.method3179((byte) 125) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 43)
    public final IDirect3DVolumeTexture method3129(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field5825);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class402.method3157(var9, -2005530585)) {
            throw new class400(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/io;)V", line = 56)
    public IDirect3DDevice(class406 arg0) {
        super(arg0);
        this.field5825 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 66)
    public final IDirect3DVertexBuffer method3130(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field5825);
        } else {
            arg4.method3176(true);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class402.method3157(var6, -2005530585)) {
            throw new class400(String.valueOf(var6));
        }
        arg4.field5828 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 86)
    public final IDirect3DSwapChain method3131(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field5825);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class402.method3157(var3, -2005530585)) {
            throw new class400(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 104)
    public final IDirect3DCubeTexture method3132(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field5825);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class402.method3157(var7, -2005530585)) {
            throw new class400(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 124)
    public final IDirect3DSurface method3133(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field5825);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 138)
    public final IDirect3DPixelShader method3134(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field5825);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 161)
    public final IDirect3DVertexDeclaration method3135(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field5825);
        } else {
            arg1.method3176(true);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 181)
    public final int method3136(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 193)
    public final IDirect3DSurface method3137() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field5825);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class402.method3157(var2, -2005530585)) {
            throw new class400(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 209)
    public final IDirect3DIndexBuffer method3138(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field5825);
        } else {
            arg4.method3176(true);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 235)
    public final int method3139(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field5826[2] = arg3;
        field5826[0] = arg1;
        field5826[3] = arg4;
        field5826[1] = arg2;
        return this.SetVertexShaderConstantF(arg0, field5826, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 246)
    public final IDirect3DVertexShader method3140(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field5825);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 264)
    public final int method3141(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 274)
    public final IDirect3DTexture method3142(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field5825);
    ...
    public final int method3143(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 308)
    public final int method3144(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field5826[2] = arg3;
        field5826[0] = arg1;
        field5826[1] = arg2;
        field5826[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field5826, 1);
    }
    ...
    public final native int SetLight(int arg0, class401 arg1);
