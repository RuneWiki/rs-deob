...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/ku;")
    private class360 field10167;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field10168 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 11)
    public final IDirect3DTexture method4008(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field10167);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class723.method3997(var8, -113)) {
            throw new class725(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 26)
    public final IDirect3DPixelShader method4009(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field10167);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class723.method3997(var3, -126)) {
            throw new class725(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 46)
    public final IDirect3DSurface method4010(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field10167);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class723.method3997(var3, -98)) {
            throw new class725(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/ku;)V", line = 59)
    public IDirect3DDevice(class360 arg0) {
        super(arg0);
        this.field10167 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 69)
    public final IDirect3DCubeTexture method4011(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field10167);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class723.method3997(var7, -91)) {
            throw new class725(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 84)
    public final int method4012(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10168[0] = arg1;
        field10168[2] = arg3;
        field10168[1] = arg2;
        field10168[3] = arg4;
        return this.SetVertexShaderConstantF(arg0, field10168, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 102)
    public final IDirect3DVertexShader method4013(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field10167);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class723.method3997(var3, -116)) {
            throw new class725(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final int method4014(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 129)
    public final IDirect3DVertexDeclaration method4015(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field10167);
        } else {
            arg1.method2211(125);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class723.method3997(var3, -119)) {
            throw new class725(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 148)
    public final IDirect3DVertexBuffer method4016(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field10167);
        } else {
            arg4.method2211(125);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class723.method3997(var6, -82)) {
            throw new class725(String.valueOf(var6));
        }
        arg4.field10165 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 184)
    public final IDirect3DEventQuery method4017() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field10167);
        if (class723.method3998(false, this._CreateEventQuery(var1))) {
            return var1.method2213(306) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 206)
    public final IDirect3DIndexBuffer method4018(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field10167);
        } else {
            arg4.method2211(123);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class723.method3997(var6, -84)) {
            throw new class725(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 228)
    public final int method4019(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10168[2] = arg3;
        field10168[0] = arg1;
        field10168[1] = arg2;
        field10168[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field10168, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 242)
    public final IDirect3DVolumeTexture method4020(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field10167);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class723.method3997(var9, -114)) {
            throw new class725(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 254)
    public final int method4021(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 268)
    public final int method4022(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 277)
    public final IDirect3DSwapChain method4023(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field10167);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class723.method3997(var3, -117)) {
            throw new class725(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 292)
    public final IDirect3DSurface method4024(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field10167);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class723.method3997(var8, -97)) {
            throw new class725(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 306)
    public final IDirect3DSurface method4025() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field10167);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class723.method3997(var2, -87)) {
            throw new class725(String.valueOf(var2));
        }
        return var1;
    }
    ...
    public final native int SetLight(int arg0, class724 arg1);
