...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/dba;")
    private class375 field10422;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field10421 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 7)
    public final int method4173(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 20)
    public final IDirect3DVertexBuffer method4174(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field10422);
        } else {
            arg4.method2320(-5017);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class757.method4191(var6, (byte) 84)) {
            throw new class756(String.valueOf(var6));
        }
        arg4.field10419 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 42)
    public final IDirect3DSwapChain method4175(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field10422);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class757.method4191(var3, (byte) 84)) {
            throw new class756(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 66)
    public final IDirect3DSurface method4176(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field10422);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class757.method4191(var8, (byte) 84)) {
            throw new class756(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 82)
    public final IDirect3DSurface method4177(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field10422);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 97)
    public final IDirect3DTexture method4178(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field10422);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 111)
    public final int method4179(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10421[2] = arg3;
        field10421[3] = arg4;
        field10421[1] = arg2;
        field10421[0] = arg1;
        return this.SetVertexShaderConstantF(arg0, field10421, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 126)
    public final IDirect3DVertexShader method4180(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field10422);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 145)
    public final IDirect3DCubeTexture method4181(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field10422);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class757.method4191(var7, (byte) 84)) {
            throw new class756(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 159)
    public final int method4182(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 167)
    public final int method4183(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/dba;)V", line = 173)
    public IDirect3DDevice(class375 arg0) {
        super(arg0);
        this.field10422 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 183)
    public final IDirect3DVolumeTexture method4184(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field10422);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class757.method4191(var9, (byte) 84)) {
            throw new class756(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 201)
    public final IDirect3DVertexDeclaration method4185(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field10422);
        } else {
            arg1.method2320(-5017);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 221)
    public final IDirect3DSurface method4186() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field10422);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class757.method4191(var2, (byte) 84)) {
    ...
    public final IDirect3DIndexBuffer method4187(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field10422);
        } else {
            arg4.method2320(-5017);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 261)
    public final IDirect3DPixelShader method4188(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field10422);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 281)
    public final IDirect3DEventQuery method4189() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field10422);
        if (class757.method4192(this._CreateEventQuery(var1), (byte) 116)) {
            return var1.method2321(false) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 303)
    public final int method4190(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10421[1] = arg2;
        field10421[0] = arg1;
        field10421[3] = arg4;
        field10421[2] = arg3;
        return this.SetPixelShaderConstantF(arg0, field10421, 1);
    }
