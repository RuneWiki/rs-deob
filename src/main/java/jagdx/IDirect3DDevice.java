...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/in;")
    private class699 field7243;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field7244 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 5)
    public final IDirect3DIndexBuffer method2953(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field7243);
        } else {
            arg4.method3973(false);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class507.method2946(-124, var6)) {
            throw new class506(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 33)
    public final IDirect3DPixelShader method2954(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field7243);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class507.method2946(87, var3)) {
            throw new class506(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 53)
    public final IDirect3DSurface method2955(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field7243);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class507.method2946(89, var3)) {
            throw new class506(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 69)
    public final IDirect3DTexture method2956(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field7243);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class507.method2946(-108, var8)) {
            throw new class506(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 82)
    public final int method2957(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 93)
    public final IDirect3DCubeTexture method2958(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field7243);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class507.method2946(-128, var7)) {
            throw new class506(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 107)
    public final int method2959(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 114)
    public final IDirect3DVertexBuffer method2960(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field7243);
        } else {
            arg4.method3973(false);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class507.method2946(-43, var6)) {
            throw new class506(String.valueOf(var6));
        }
        arg4.field7246 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 136)
    public final IDirect3DVolumeTexture method2961(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field7243);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class507.method2946(125, var9)) {
            throw new class506(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/in;)V", line = 150)
    public IDirect3DDevice(class699 arg0) {
        super(arg0);
        this.field7243 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 170)
    public final int method2962(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field7244[2] = arg3;
        field7244[0] = arg1;
        field7244[1] = arg2;
        field7244[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field7244, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 188)
    public final IDirect3DSurface method2963(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field7243);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 203)
    public final IDirect3DVertexDeclaration method2964(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field7243);
        } else {
            arg1.method3973(false);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class507.method2946(-47, var3)) {
            throw new class506(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 222)
    public final IDirect3DEventQuery method2965() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field7243);
        if (class507.method2947(this._CreateEventQuery(var1), -13)) {
            return var1.method3969(280) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 235)
    public final IDirect3DVertexShader method2966(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field7243);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class507.method2946(-86, var3)) {
            throw new class506(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 254)
    public final int method2967(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 261)
    public final int method2968(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field7244[2] = arg3;
        field7244[3] = arg4;
        field7244[0] = arg1;
        field7244[1] = arg2;
        return this.SetVertexShaderConstantF(arg0, field7244, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 289)
    public final IDirect3DSurface method2969() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field7243);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class507.method2946(-41, var2)) {
            throw new class506(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 306)
    public final IDirect3DSwapChain method2970(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field7243);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class507.method2946(-122, var3)) {
            throw new class506(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final native int SetLight(int arg0, class508 arg1);
