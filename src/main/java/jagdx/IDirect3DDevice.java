...
public class IDirect3DDevice extends IUnknown {
   ...
   private class704 field7082;
   @OriginalMember(
      owner = "client!jagdx/IDirect3DDevice",
      name = "c",
      descriptor = "[F"
   )
   private static float[] field7081 = new float[4];
   ...
   public final IDirect3DSurface method3720() {
      IDirect3DSurface var1 = new IDirect3DSurface(this.field7082);
      int var2 = this._GetDepthStencilSurface(var1);
      if (!class512.method3719(var2, -2005530586)) {
         return var1;
      } else {
         throw new class513(String.valueOf(var2));
      }
   }
   ...
   public final IDirect3DVertexDeclaration method3721(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
      if (arg1 == null) {
         arg1 = new IDirect3DVertexDeclaration(this.field7082);
      } else {
         arg1.method5123(-1928);
      }

      int var3 = this._CreateVertexDeclaration(arg0, arg1);
      if (class512.method3719(var3, -2005530586)) {
         throw new class513(String.valueOf(var3));
      } else {
         return arg1;
      }
   }
   ...
   public final IDirect3DEventQuery method3722() {
      IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field7082);
      if (!class512.method3718(this._CreateEventQuery(var1), 2005530519)) {
         return null;
      } else {
         return var1.method5117(27043) ? var1 : null;
      }
   }
   ...
   public final native int SetLight(int arg0, class514 arg1);
   ...
   public final IDirect3DVertexShader method3723(byte[] arg0) {
      if (arg0 == null) {
         return null;
      } else {
         IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field7082);
   ...
   public final IDirect3DCubeTexture method3724(int arg0, int arg1, int arg2, int arg3, int arg4) {
      IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field7082);
      int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
      if (!class512.method3719(var7, -2005530586)) {
         return var6;
      } else {
         throw new class513(String.valueOf(var7));
      }
   }
   ...
   public final IDirect3DVertexBuffer method3725(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
      if (arg4 == null) {
         arg4 = new IDirect3DVertexBuffer(this.field7082);
      } else {
         arg4.method5123(-1928);
      }

      int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
      if (class512.method3719(var6, -2005530586)) {
         throw new class513(String.valueOf(var6));
      } else {
         arg4.field7084 = arg0;
         return arg4;
      }
   ...
   public final IDirect3DIndexBuffer method3726(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
      if (arg4 != null) {
         arg4.method5123(-1928);
      } else {
         arg4 = new IDirect3DIndexBuffer(this.field7082);
      }
   ...
   public final int method3727(int arg0, float arg1) {
   ...
   public final IDirect3DTexture method3728(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
      IDirect3DTexture var7 = new IDirect3DTexture(this.field7082);
      int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
      if (!class512.method3719(var8, -2005530586)) {
         return var7;
      } else {
         throw new class513(String.valueOf(var8));
      }
   }
   ...
   public final IDirect3DSwapChain method3729(int arg0) {
      IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field7082);
   ...
   public final int method3730(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field7081[2] = arg3;
      field7081[1] = arg2;
      field7081[3] = arg4;
      field7081[0] = arg1;
      return this.SetPixelShaderConstantF(arg0, field7081, 1);
   }
   ...
   public final IDirect3DPixelShader method3731(byte[] arg0) {
      if (arg0 != null) {
         IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field7082);
   ...
   public final int method3732(int arg0, float[] arg1) {
   ...
   public final IDirect3DVolumeTexture method3734(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
      IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field7082);
      int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
      if (!class512.method3719(var9, -2005530586)) {
         return var8;
      } else {
         throw new class513(String.valueOf(var9));
      }
   }
   ...
   public final IDirect3DSurface method3735(int arg0) {
      IDirect3DSurface var2 = new IDirect3DSurface(this.field7082);
   ...
   public final int method3736(int arg0, float arg1, float arg2, float arg3, float arg4) {
      field7081[3] = arg4;
      field7081[1] = arg2;
      field7081[2] = arg3;
      field7081[0] = arg1;
      return this.SetVertexShaderConstantF(arg0, field7081, 1);
   }
   ...
   public final IDirect3DSurface method3737(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
      IDirect3DSurface var7 = new IDirect3DSurface(this.field7082);
