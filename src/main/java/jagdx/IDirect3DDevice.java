...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/tc;")
    private class622 field6163;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field6164 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 11)
    public final IDirect3DVertexBuffer method2518(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6163);
        } else {
            arg4.method3483(-128);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class439.method2512(var6, 0)) {
            throw new class438(String.valueOf(var6));
        }
        arg4.field6161 = arg0;
        return arg4;
    }
    ...
    public final IDirect3DVertexShader method2519(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6163);
    ...
    public final int method2520(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6164[0] = arg1;
        field6164[1] = arg2;
        field6164[3] = arg4;
        field6164[2] = arg3;
        return this.SetVertexShaderConstantF(arg0, field6164, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 69)
    public final int method2521(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 88)
    public final IDirect3DSurface method2522() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6163);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class439.method2512(var2, 0)) {
            throw new class438(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 102)
    public final IDirect3DSwapChain method2523(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6163);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 114)
    public final IDirect3DIndexBuffer method2524(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6163);
        } else {
            arg4.method3483(-128);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 140)
    public final int method2525(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6164[3] = arg4;
        field6164[1] = arg2;
        field6164[0] = arg1;
        field6164[2] = arg3;
        return this.SetPixelShaderConstantF(arg0, field6164, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 152)
    public final IDirect3DTexture method2526(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6163);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class439.method2512(var8, 0)) {
            throw new class438(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 166)
    public final IDirect3DPixelShader method2527(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field6163);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 185)
    public final int method2528(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 194)
    public final IDirect3DSurface method2529(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6163);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 208)
    public final IDirect3DVertexDeclaration method2530(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6163);
        } else {
            arg1.method3483(-127);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/tc;)V", line = 229)
    public IDirect3DDevice(class622 arg0) {
        super(arg0);
        this.field6163 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 244)
    public final IDirect3DVolumeTexture method2531(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6163);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class439.method2512(var9, 0)) {
            throw new class438(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 258)
    public final int method2532(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 266)
    public final IDirect3DEventQuery method2533() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6163);
        if (class439.method2511((byte) 35, this._CreateEventQuery(var1))) {
            return var1.method3481(28436) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 281)
    public final IDirect3DCubeTexture method2534(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6163);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 306)
    public final IDirect3DSurface method2535(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6163);
    ...
    public final native int SetLight(int arg0, class437 arg1);
