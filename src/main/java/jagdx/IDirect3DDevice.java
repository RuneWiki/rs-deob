...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/gca;")
    private class674 field6948;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field6947 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 13)
    public final IDirect3DTexture method2866(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6948);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class485.method2864(-2005530522, var8)) {
            throw new class487(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 25)
    public final int method2867(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 35)
    public final IDirect3DVertexShader method2868(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6948);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class485.method2864(-2005530522, var3)) {
            throw new class487(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 54)
    public final int method2869(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6947[1] = arg2;
        field6947[2] = arg3;
        field6947[0] = arg1;
        field6947[3] = arg4;
        return this.SetVertexShaderConstantF(arg0, field6947, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 71)
    public final int method2870(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 79)
    public final int method2871(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6947[0] = arg1;
        field6947[2] = arg3;
        field6947[3] = arg4;
        field6947[1] = arg2;
        return this.SetPixelShaderConstantF(arg0, field6947, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 92)
    public final IDirect3DVolumeTexture method2872(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6948);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class485.method2864(-2005530522, var9)) {
            throw new class487(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 106)
    public final IDirect3DVertexBuffer method2873(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6948);
        } else {
            arg4.method3809((byte) -36);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class485.method2864(-2005530522, var6)) {
            throw new class487(String.valueOf(var6));
        }
        arg4.field6950 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 132)
    public final IDirect3DSurface method2874() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6948);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class485.method2864(-2005530522, var2)) {
            throw new class487(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 148)
    public final IDirect3DSurface method2875(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6948);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 163)
    public final IDirect3DEventQuery method2876() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6948);
        if (class485.method2865(this._CreateEventQuery(var1), 25499)) {
            return var1.method3805((byte) -90) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/gca;)V", line = 176)
    public IDirect3DDevice(class674 arg0) {
        super(arg0);
        this.field6948 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 189)
    public final IDirect3DPixelShader method2877(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field6948);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 207)
    public final IDirect3DIndexBuffer method2878(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6948);
        } else {
            arg4.method3809((byte) -36);
        }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 229)
    public final IDirect3DCubeTexture method2879(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6948);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class485.method2864(-2005530522, var7)) {
            throw new class487(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 249)
    public final IDirect3DSurface method2880(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6948);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 261)
    public final int method2881(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 282)
    public final IDirect3DSwapChain method2882(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6948);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 300)
    public final IDirect3DVertexDeclaration method2883(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6948);
        } else {
            arg1.method3809((byte) -36);
        }
    ...
    public final native int SetLight(int arg0, class486 arg1);
