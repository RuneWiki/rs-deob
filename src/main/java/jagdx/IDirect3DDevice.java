...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/er;")
    private class420 field10311;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field10310 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 5)
    public final IDirect3DPixelShader method4100(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field10311);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class737.method4095(var3, (byte) 81)) {
            throw new class738(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 25)
    public final IDirect3DEventQuery method4101() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field10311);
        if (class737.method4096(74, this._CreateEventQuery(var1))) {
            return var1.method2565(-14296) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DSurface;", line = 43)
    public final IDirect3DSurface method4102() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field10311);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class737.method4095(var2, (byte) -66)) {
            throw new class738(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 63)
    public final int method4103(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10310[0] = arg1;
        field10310[2] = arg3;
        field10310[1] = arg2;
        field10310[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field10310, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 74)
    public final int method4104(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10310[3] = arg4;
        field10310[1] = arg2;
        field10310[0] = arg1;
        field10310[2] = arg3;
        return this.SetVertexShaderConstantF(arg0, field10310, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 86)
    public final IDirect3DIndexBuffer method4105(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field10311);
        } else {
            arg4.method2573((byte) -106);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class737.method4095(var6, (byte) 91)) {
            throw new class738(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 109)
    public final int method4106(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 122)
    public final IDirect3DVolumeTexture method4107(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field10311);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class737.method4095(var9, (byte) -100)) {
            throw new class738(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 141)
    public final IDirect3DSurface method4108(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field10311);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class737.method4095(var8, (byte) 103)) {
            throw new class738(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 157)
    public final IDirect3DVertexBuffer method4109(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field10311);
        } else {
            arg4.method2573((byte) -109);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class737.method4095(var6, (byte) 79)) {
            throw new class738(String.valueOf(var6));
        }
        arg4.field10309 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 176)
    public final IDirect3DVertexShader method4110(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field10311);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class737.method4095(var3, (byte) -25)) {
            throw new class738(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 197)
    public final IDirect3DSurface method4111(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field10311);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class737.method4095(var3, (byte) 115)) {
            throw new class738(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/er;)V", line = 208)
    public IDirect3DDevice(class420 arg0) {
        super(arg0);
        this.field10311 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 220)
    public final IDirect3DSwapChain method4112(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field10311);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class737.method4095(var3, (byte) 100)) {
            throw new class738(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 234)
    public final IDirect3DCubeTexture method4113(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field10311);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class737.method4095(var7, (byte) -14)) {
            throw new class738(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 267)
    public final IDirect3DTexture method4114(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field10311);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class737.method4095(var8, (byte) 112)) {
            throw new class738(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 281)
    public final IDirect3DVertexDeclaration method4115(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field10311);
        } else {
            arg1.method2573((byte) -126);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class737.method4095(var3, (byte) 119)) {
            throw new class738(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 301)
    public final int method4116(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 314)
    public final int method4117(int arg0, float arg1) {
    ...
    public final native int SetLight(int arg0, class739 arg1);
