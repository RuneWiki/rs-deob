...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "Ljaclib/peer/uca;")
    private class674 field6631;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "[F")
    private static float[] field6630 = new float[4];

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 12)
    public final int method2747(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 22)
    public final IDirect3DSurface method2748() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6631);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class487.method2768(var2, -43)) {
            throw new class486(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 46)
    public final IDirect3DTexture method2749(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6631);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class487.method2768(var8, -73)) {
            throw new class486(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 60)
    public final IDirect3DIndexBuffer method2750(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6631);
        } else {
            arg4.method3757((byte) -41);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class487.method2768(var6, -118)) {
            throw new class486(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/uca;)V", line = 82)
    public IDirect3DDevice(class674 arg0) {
        super(arg0);
        this.field6631 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 93)
    public final IDirect3DVertexDeclaration method2751(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6631);
        } else {
            arg1.method3757((byte) -86);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class487.method2768(var3, -90)) {
            throw new class486(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 110)
    public final IDirect3DPixelShader method2752(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field6631);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class487.method2768(var3, -121)) {
            throw new class486(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 131)
    public final IDirect3DCubeTexture method2753(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6631);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class487.method2768(var7, -33)) {
            throw new class486(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 144)
    public final IDirect3DEventQuery method2754() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6631);
        if (class487.method2767(this._CreateEventQuery(var1), (byte) 109)) {
            return var1.method3748(-118) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 161)
    public final IDirect3DVolumeTexture method2755(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6631);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class487.method2768(var9, -107)) {
            throw new class486(String.valueOf(var9));
        }
        return var8;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 176)
    public final int method2756(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6630[1] = arg2;
        field6630[3] = arg4;
        field6630[2] = arg3;
        field6630[0] = arg1;
        return this.SetPixelShaderConstantF(arg0, field6630, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DVertexBuffer;)Ljagdx/IDirect3DVertexBuffer;", line = 195)
    public final IDirect3DVertexBuffer method2757(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6631);
        } else {
            arg4.method3757((byte) -101);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class487.method2768(var6, -124)) {
            throw new class486(String.valueOf(var6));
        }
        arg4.field6633 = arg0;
        return arg4;
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 217)
    public final int method2758(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 226)
    public final IDirect3DSurface method2759(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6631);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class487.method2768(var8, -59)) {
            throw new class486(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 241)
    public final IDirect3DVertexShader method2760(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6631);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class487.method2768(var3, -72)) {
            throw new class486(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 262)
    public final IDirect3DSwapChain method2761(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6631);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 279)
    public final IDirect3DSurface method2762(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6631);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class487.method2768(var3, -54)) {
            throw new class486(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 298)
    public final int method2763(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6630[3] = arg4;
        field6630[1] = arg2;
        field6630[2] = arg3;
        field6630[0] = arg1;
        return this.SetVertexShaderConstantF(arg0, field6630, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 313)
    public final int method2764(int arg0, boolean arg1) {
    ...
    public final native int SetLight(int arg0, class488 arg1);
