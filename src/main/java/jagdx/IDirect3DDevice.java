...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/hea;")
    private class422 field10215;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field10216 = new float[4];
    ...
    public final IDirect3DVertexBuffer method4112(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field10215);
        } else {
            arg4.method2637(-10573);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class742.method4136(var6, (byte) -63)) {
            throw new class740(String.valueOf(var6));
        }
        arg4.field10214 = arg0;
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "([B)Ljagdx/IDirect3DVertexShader;", line = 29)
    public final IDirect3DVertexShader method4113(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field10215);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class742.method4136(var3, (byte) -16)) {
            throw new class740(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "(I)Ljagdx/IDirect3DSurface;", line = 49)
    public final IDirect3DSurface method4114(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field10215);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class742.method4136(var3, (byte) 115)) {
            throw new class740(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IF)I", line = 68)
    public final int method4115(int arg0, float arg1) {
        return this.SetRenderStatef(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(Ljagdx/VertexElementCollection;Ljagdx/IDirect3DVertexDeclaration;)Ljagdx/IDirect3DVertexDeclaration;", line = 76)
    public final IDirect3DVertexDeclaration method4116(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field10215);
        } else {
            arg1.method2637(-10573);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class742.method4136(var3, (byte) -37)) {
            throw new class740(String.valueOf(var3));
        }
        return arg1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "()Ljagdx/IDirect3DSurface;", line = 95)
    public final IDirect3DSurface method4117() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field10215);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class742.method4136(var2, (byte) 124)) {
            throw new class740(String.valueOf(var2));
        }
        return var1;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "d", descriptor = "(I)Ljagdx/IDirect3DSwapChain;", line = 111)
    public final IDirect3DSwapChain method4118(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field10215);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class742.method4136(var3, (byte) 113)) {
            throw new class740(String.valueOf(var3));
        }
        return var2;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIII)Ljagdx/IDirect3DCubeTexture;", line = 129)
    public final IDirect3DCubeTexture method4119(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field10215);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class742.method4136(var7, (byte) -64)) {
            throw new class740(String.valueOf(var7));
        }
        return var6;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IFFFF)I", line = 142)
    public final int method4120(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10216[0] = arg1;
        field10216[2] = arg3;
        field10216[1] = arg2;
        field10216[3] = arg4;
        return this.SetVertexShaderConstantF(arg0, field10216, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "([B)Ljagdx/IDirect3DPixelShader;", line = 157)
    public final IDirect3DPixelShader method4121(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field10215);
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "(IFFFF)I", line = 175)
    public final int method4122(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field10216[1] = arg2;
        field10216[3] = arg4;
        field10216[0] = arg1;
        field10216[2] = arg3;
        return this.SetPixelShaderConstantF(arg0, field10216, 1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIZ)Ljagdx/IDirect3DSurface;", line = 189)
    public final IDirect3DSurface method4123(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field10215);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class742.method4136(var8, (byte) 124)) {
            throw new class740(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "()Ljagdx/IDirect3DEventQuery;", line = 212)
    public final IDirect3DEventQuery method4124() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field10215);
        if (class742.method4137(this._CreateEventQuery(var1), -1)) {
            return var1.method2634(119) ? var1 : null;
        } else {
            return null;
        }
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(I[F)I", line = 227)
    public final int method4125(int arg0, float[] arg1) {
        return this.SetVertexShaderConstantF(arg0, arg1, arg1.length / 4);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIILjagdx/IDirect3DIndexBuffer;)Ljagdx/IDirect3DIndexBuffer;", line = 236)
    public final IDirect3DIndexBuffer method4126(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field10215);
        } else {
            arg4.method2637(-10573);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class742.method4136(var6, (byte) 117)) {
            throw new class740(String.valueOf(var6));
        }
        return arg4;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IZ)I", line = 260)
    public final int method4127(int arg0, boolean arg1) {
        return this.SetRenderStateb(arg0, arg1);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/hea;)V", line = 271)
    public IDirect3DDevice(class422 arg0) {
        super(arg0);
        this.field10215 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIII)Ljagdx/IDirect3DTexture;", line = 283)
    public final IDirect3DTexture method4128(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field10215);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class742.method4136(var8, (byte) 125)) {
            throw new class740(String.valueOf(var8));
        }
        return var7;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "a", descriptor = "(IIIIIII)Ljagdx/IDirect3DVolumeTexture;", line = 304)
    public final IDirect3DVolumeTexture method4129(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field10215);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class742.method4136(var9, (byte) 114)) {
            throw new class740(String.valueOf(var9));
        }
        return var8;
    }
    ...
    public final native int SetLight(int arg0, class741 arg1);
