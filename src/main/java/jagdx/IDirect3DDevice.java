...
public class IDirect3DDevice extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "b", descriptor = "Ljaclib/peer/bda;")
    private class626 field6456;

    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "c", descriptor = "[F")
    private static float[] field6457 = new float[4];
    ...
    public final IDirect3DSurface method2702(int arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        IDirect3DSurface var7 = new IDirect3DSurface(this.field6456);
        int var8 = this._CreateRenderTarget(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class451.method2726(var8, (byte) -31)) {
    ...
    public final int method2703(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6457[1] = arg2;
        field6457[3] = arg4;
        field6457[0] = arg1;
        field6457[2] = arg3;
        return this.SetVertexShaderConstantF(arg0, field6457, 1);
    }
    ...
    public final IDirect3DVertexDeclaration method2704(VertexElementCollection arg0, IDirect3DVertexDeclaration arg1) {
        if (arg1 == null) {
            arg1 = new IDirect3DVertexDeclaration(this.field6456);
        } else {
            arg1.method3595((byte) -67);
        }
        int var3 = this._CreateVertexDeclaration(arg0, arg1);
        if (class451.method2726(var3, (byte) -97)) {
    ...
    public final IDirect3DVertexBuffer method2705(int arg0, int arg1, int arg2, int arg3, IDirect3DVertexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DVertexBuffer(this.field6456);
        } else {
            arg4.method3595((byte) -67);
        }
        int var6 = this._CreateVertexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class451.method2726(var6, (byte) -54)) {
    ...
    public final int method2706(int arg0, float arg1, float arg2, float arg3, float arg4) {
        field6457[0] = arg1;
        field6457[1] = arg2;
        field6457[2] = arg3;
        field6457[3] = arg4;
        return this.SetPixelShaderConstantF(arg0, field6457, 1);
    }
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DDevice", name = "<init>", descriptor = "(Ljaclib/peer/bda;)V")
    ...
    public final IDirect3DTexture method2707(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        IDirect3DTexture var7 = new IDirect3DTexture(this.field6456);
        int var8 = this._CreateTexture(arg0, arg1, arg2, arg3, arg4, arg5, var7);
        if (class451.method2726(var8, (byte) -80)) {
            throw new class450(String.valueOf(var8));
        }
        return var7;
    }
    ...
    public final IDirect3DPixelShader method2708(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DPixelShader var2 = new IDirect3DPixelShader(this.field6456);
        int var3 = this._CreatePixelShader(arg0, var2);
        if (class451.method2726(var3, (byte) -88)) {
            throw new class450(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final IDirect3DSurface method2709(int arg0) {
        IDirect3DSurface var2 = new IDirect3DSurface(this.field6456);
        int var3 = this._GetRenderTarget(arg0, var2);
        if (class451.method2726(var3, (byte) -109)) {
            throw new class450(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final IDirect3DIndexBuffer method2710(int arg0, int arg1, int arg2, int arg3, IDirect3DIndexBuffer arg4) {
        if (arg4 == null) {
            arg4 = new IDirect3DIndexBuffer(this.field6456);
        } else {
            arg4.method3595((byte) -67);
        }
        int var6 = this._CreateIndexBuffer(arg0, arg1, arg2, arg3, arg4);
        if (class451.method2726(var6, (byte) 90)) {
            throw new class450(String.valueOf(var6));
        }
        return arg4;
    }
    ...
    public final IDirect3DSurface method2711() {
        IDirect3DSurface var1 = new IDirect3DSurface(this.field6456);
        int var2 = this._GetDepthStencilSurface(var1);
        if (class451.method2726(var2, (byte) 106)) {
    ...
    public final IDirect3DVolumeTexture method2712(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6) {
        IDirect3DVolumeTexture var8 = new IDirect3DVolumeTexture(this.field6456);
        int var9 = this._CreateVolumeTexture(arg0, arg1, arg2, arg3, arg4, arg5, arg6, var8);
        if (class451.method2726(var9, (byte) -91)) {
    ...
    public final IDirect3DEventQuery method2713() {
        IDirect3DEventQuery var1 = new IDirect3DEventQuery(this.field6456);
        if (class451.method2727(this._CreateEventQuery(var1), 3102)) {
            return var1.method3586(26624) ? var1 : null;
        } else {
            return null;
        }
    }
    ...
    public final IDirect3DSwapChain method2714(int arg0) {
        IDirect3DSwapChain var2 = new IDirect3DSwapChain(this.field6456);
        int var3 = this._GetSwapChain(arg0, var2);
        if (class451.method2726(var3, (byte) -68)) {
            throw new class450(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final IDirect3DVertexShader method2715(byte[] arg0) {
        if (arg0 == null) {
            return null;
        }
        IDirect3DVertexShader var2 = new IDirect3DVertexShader(this.field6456);
        int var3 = this._CreateVertexShader(arg0, var2);
        if (class451.method2726(var3, (byte) 80)) {
            throw new class450(String.valueOf(var3));
        }
        return var2;
    }
    ...
    public final int method2716(int arg0, float arg1) {
    ...
    public final int method2718(int arg0, boolean arg1) {
    ...
    public final IDirect3DCubeTexture method2719(int arg0, int arg1, int arg2, int arg3, int arg4) {
        IDirect3DCubeTexture var6 = new IDirect3DCubeTexture(this.field6456);
        int var7 = this._CreateCubeTexture(arg0, arg1, arg2, arg3, arg4, var6);
        if (class451.method2726(var7, (byte) 109)) {
