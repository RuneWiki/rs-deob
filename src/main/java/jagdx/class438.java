...
public class class438 extends class624 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/am;)V", line = 4)
    public class438(class625 arg0) {
        super(arg0);
        this.Init();
    }
