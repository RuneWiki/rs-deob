...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method2450(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg3 > (arg1 + arg0.getSize())) {
            throw new class440("");
        } else if (arg2 >= 0 && arg3 <= this.field6106 + arg2) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/hr;)V", line = 32)
    public IDirect3DVertexBuffer(class615 arg0) {
        super(arg0);
    }
