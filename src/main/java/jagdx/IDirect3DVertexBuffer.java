...
public class IDirect3DVertexBuffer extends IUnknown {
   ...
   public final boolean method3825(Source arg0, int arg1, int arg2, int arg3, int arg4) {
      if (arg0 != null && 0 <= arg1 && arg3 <= arg0.getSize() + arg1) {
         if (-1 >= ~arg2 && ~arg3 >= ~(this.field7360 + arg2)) {
