...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method4111(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg0.getSize() + arg1) < arg3) {
            throw new class740("");
        } else if (arg2 >= 0 && (this.field10214 + arg2) >= arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/hea;)V", line = 32)
    public IDirect3DVertexBuffer(class422 arg0) {
        super(arg0);
    }
