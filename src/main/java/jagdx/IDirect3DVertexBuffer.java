...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/of;)V", line = 7)
    public IDirect3DVertexBuffer(class579 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "()J", line = 11)
    protected final long method2439() {
        this.field5620 = 0;
        return super.method2439();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 19)
