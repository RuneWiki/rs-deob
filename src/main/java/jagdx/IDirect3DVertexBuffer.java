...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "()J", line = 7)
    protected final long method2934() {
        this.field7000 = 0;
        return super.method2934();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 15)
    public final boolean method2937(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg1 + arg0.getSize()) < arg3) {
            throw new class511("");
        } else if (arg2 >= 0 && arg3 <= this.field7000 + arg2) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/mba;)V", line = 28)
    public IDirect3DVertexBuffer(class701 arg0) {
        super(arg0);
    }
