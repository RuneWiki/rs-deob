...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/jd;)V", line = 4)
    public IDirect3DVertexBuffer(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "()J", line = 9)
    protected final long method2013() {
        this.field9535 = 0;
        return super.method2013();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 21)
    public final boolean method3782(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg3 > (arg1 + arg0.getSize())) {
            throw new class671("");
        } else if (arg2 >= 0 && arg2 + this.field9535 >= arg3) {
