...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    protected final long method2380() {
        this.field5474 = 0;
        return super.method2380();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/ik;)V")
    public IDirect3DVertexBuffer(class571 arg0) {
        super(arg0);
    }
    ...
    public final boolean method2381(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg0.getSize() + arg1) < arg3) {
            throw new class398("");
        } else if (arg2 >= 0 && (this.field5474 + arg2) >= arg3) {
