...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method3154(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg1 + arg0.getSize()) < arg3) {
            throw new class400("");
        } else if (arg2 >= 0 && (arg2 + this.field5828) >= arg3) {
    ...
    protected final long method3145() {
        this.field5828 = 0;
        return super.method3145();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/io;)V", line = 30)
    public IDirect3DVertexBuffer(class406 arg0) {
        super(arg0);
    }
