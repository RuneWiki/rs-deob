...
public class IDirect3DVertexBuffer extends IUnknown {
   ...
   protected final long method3793() {
      this.field7498 = 0;
      return super.method3793();
   }
   ...
   public final boolean method3796(Source arg0, int arg1, int arg2, int arg3, int arg4) {
      if (arg0 != null && -1 >= ~arg1 && ~arg3 >= ~(arg1 - -arg0.getSize())) {
         if (~arg2 <= -1 && arg3 <= this.field7498 + arg2) {
