...
public class IDirect3DVertexBuffer extends IUnknown {
   ...
   protected final long method3740() {
      this.field7084 = 0;
   ...
   public final boolean method3743(Source arg0, int arg1, int arg2, int arg3, int arg4) {
      if (arg0 != null && ~arg1 <= -1 && arg1 + arg0.getSize() >= arg3) {
         if (-1 >= ~arg2 && arg3 <= this.field7084 + arg2) {
