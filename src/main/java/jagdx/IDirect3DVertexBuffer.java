...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/pe;)V", line = 7)
    public IDirect3DVertexBuffer(class576 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "()J", line = 12)
    protected final long method2340() {
        this.field5338 = 0;
        return super.method2340();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 20)
    public final boolean method2343(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg1 + arg0.getSize() < arg3) {
            throw new class408("");
        } else if (arg2 >= 0 && arg3 <= this.field5338 + arg2) {
