...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/jv;)V", line = 6)
    ...
    public final boolean method2665(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg3 > arg1 + arg0.getSize()) {
            throw new class445("");
        } else if (arg2 >= 0 && arg3 <= (arg2 + this.field6475)) {
