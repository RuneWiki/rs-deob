...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method2307(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg0.getSize() + arg1) < arg3) {
            throw new class437("");
        } else if (arg2 >= 0 && arg3 <= (arg2 + this.field5473)) {
    ...
    protected final long method2308() {
        this.field5473 = 0;
        return super.method2308();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/am;)V", line = 27)
    public IDirect3DVertexBuffer(class625 arg0) {
        super(arg0);
    }
