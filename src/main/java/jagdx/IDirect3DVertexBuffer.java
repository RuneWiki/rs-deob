...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "()J", line = 23)
    protected final long method2575() {
        this.field10300 = 0;
        return super.method2575();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/ep;)V", line = 30)
    public IDirect3DVertexBuffer(class421 arg0) {
        super(arg0);
    }
