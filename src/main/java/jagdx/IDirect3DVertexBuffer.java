...
public class IDirect3DVertexBuffer extends IUnknown {
   ...
   public final boolean method3142(Source arg0, int arg1, int arg2, int arg3, int arg4) {
      if (arg0 != null && -1 >= ~arg1 && arg3 <= arg0.getSize() + arg1) {
         if (~arg2 <= -1 && ~(this.field5933 + arg2) <= ~arg3) {
