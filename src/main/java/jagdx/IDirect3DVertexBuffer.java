...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method2889(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg3 > arg0.getSize() + arg1) {
            throw new class487("");
        } else if (arg2 >= 0 && (arg2 + this.field6950) >= arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/gca;)V", line = 21)
    ...
    protected final long method2886() {
        this.field6950 = 0;
        return super.method2886();
    }
