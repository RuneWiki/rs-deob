...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method2982(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg1 + arg0.getSize()) < arg3) {
            throw new class508("");
        } else if (arg2 >= 0 && arg3 <= this.field7118 + arg2) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/hk;)V", line = 27)
