...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    public final boolean method2860(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg3 > (arg0.getSize() + arg1)) {
            throw new class484("");
        } else if (arg2 >= 0 && arg3 <= (this.field6733 + arg2)) {
    ...
    protected final long method2857() {
        this.field6733 = 0;
        return super.method2857();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/hb;)V", line = 28)
    public IDirect3DVertexBuffer(class673 arg0) {
        super(arg0);
    }
