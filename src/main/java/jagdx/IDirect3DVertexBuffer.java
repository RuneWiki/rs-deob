...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/wn;)V", line = 4)
    public IDirect3DVertexBuffer(class569 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 10)
    public final boolean method2415(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg0.getSize() + arg1) < arg3) {
            throw new class398("");
        } else if (arg2 >= 0 && (this.field5934 + arg2) >= arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "()J", line = 24)
    protected final long method2416() {
        this.field5934 = 0;
        return super.method2416();
    }
