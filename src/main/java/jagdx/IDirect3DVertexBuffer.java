...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 6)
    public final boolean method2921(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || arg3 > (arg1 + arg0.getSize())) {
            throw new class482("");
        } else if (arg2 >= 0 && arg3 <= arg2 + this.field6878) {
    ...
    protected final long method2918() {
        this.field6878 = 0;
        return super.method2918();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/rh;)V", line = 32)
    public IDirect3DVertexBuffer(class670 arg0) {
        super(arg0);
    }
