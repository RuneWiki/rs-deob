...
public class IDirect3DVertexBuffer extends IUnknown {
    ...
    protected final long method2509() {
        this.field6161 = 0;
        return super.method2509();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/tc;)V", line = 16)
    public IDirect3DVertexBuffer(class622 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DVertexBuffer", name = "a", descriptor = "(Ljaclib/memory/Source;IIII)Z", line = 21)
    public final boolean method2510(Source arg0, int arg1, int arg2, int arg3, int arg4) {
        if (arg0 == null || arg1 < 0 || (arg1 + arg0.getSize()) < arg3) {
            throw new class438("");
        } else if (arg2 >= 0 && (arg2 + this.field6161) >= arg3) {
