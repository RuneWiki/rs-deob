...
public class class482 extends class670 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/wf;)V", line = 6)
    public class482(class669 arg0) {
        super(arg0);
        this.Init();
    }
