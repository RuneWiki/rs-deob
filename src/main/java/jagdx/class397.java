...
public class class397 extends class571 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/pb;)V", line = 13)
    public class397(class570 arg0) {
        super(arg0);
        this.Init();
    }
