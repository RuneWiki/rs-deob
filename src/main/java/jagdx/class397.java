...
public class class397 extends class570 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/wn;)V", line = 10)
    public class397(class569 arg0) {
        super(arg0);
        this.Init();
    }
