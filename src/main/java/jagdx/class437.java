...
public class class437 extends class621 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/tc;)V", line = 5)
    public class437(class622 arg0) {
        super(arg0);
        this.Init();
    }
