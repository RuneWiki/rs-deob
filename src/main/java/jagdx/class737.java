...
public class class737 extends class420 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/ep;)V", line = 5)
    public class737(class421 arg0) {
        super(arg0);
        this.Init();
    }
