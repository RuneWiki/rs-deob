...
public class class509 extends class701 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/bd;)V", line = 6)
    public class509(class700 arg0) {
        super(arg0);
        this.Init();
    }
