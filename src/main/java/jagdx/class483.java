...
public class class483 extends class671 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/rh;)V", line = 10)
    public class483(class670 arg0) {
        super(arg0);
        this.Init();
    }
