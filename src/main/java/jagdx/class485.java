...
public class class485 extends class673 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/jaa;)V", line = 9)
    public class485(class672 arg0) {
        super(arg0);
        this.Init();
    }
