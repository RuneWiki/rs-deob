...
public class class685 extends class247 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/vo;)V", line = 10)
    public class685(class246 arg0) {
        super(arg0);
        this.Init();
    }
