...
public class class674 extends class339 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/aaa;)V", line = 4)
    public class674(class338 arg0) {
        super(arg0);
        this.Init();
    }
