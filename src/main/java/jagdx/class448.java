...
public class class448 extends class625 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/fl;)V", line = 9)
    public class448(class626 arg0) {
        super(arg0);
        this.Init();
    }
