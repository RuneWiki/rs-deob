...
public class class434 extends class620 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/ow;)V", line = 8)
    public class434(class621 arg0) {
        super(arg0);
        this.Init();
    }
