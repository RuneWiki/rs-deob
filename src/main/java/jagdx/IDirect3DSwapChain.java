...
public class IDirect3DSwapChain extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Ljaclib/peer/iw;")
    private class441 field10442;

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "a", descriptor = "(II)Ljagdx/IDirect3DSurface;", line = 8)
    public final IDirect3DSurface method4194(int arg0, int arg1) {
        IDirect3DSurface var3 = new IDirect3DSurface(this.field10442);
        int var4 = this._GetBackBuffer(arg0, arg1, var3);
        if (class771.method4196((byte) -120, var4)) {
            throw new class769(String.valueOf(var4));
        }
        return var3;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Ljaclib/peer/iw;)V", line = 21)
    public IDirect3DSwapChain(class441 arg0) {
        super(arg0);
