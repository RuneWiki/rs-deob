...
public class IDirect3DSwapChain extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Ljaclib/peer/bda;")
    private class626 field6458;
    ...
    public final IDirect3DSurface method2720(int arg0, int arg1) {
        IDirect3DSurface var3 = new IDirect3DSurface(this.field6458);
        int var4 = this._GetBackBuffer(arg0, arg1, var3);
        if (class451.method2726(var4, (byte) 92)) {
            throw new class450(String.valueOf(var4));
        }
        return var3;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Ljaclib/peer/bda;)V")
