...
public class IDirect3DSwapChain extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Ljaclib/peer/ge;")
    private class703 field7028;

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Ljaclib/peer/ge;)V", line = 4)
    ...
    public final IDirect3DSurface method2979(int arg0, int arg1) {
        IDirect3DSurface var3 = new IDirect3DSurface(this.field7028);
