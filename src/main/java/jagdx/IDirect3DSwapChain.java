...
public class IDirect3DSwapChain extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Ljaclib/peer/hea;")
    private class422 field10218;

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Ljaclib/peer/hea;)V", line = 4)
    public IDirect3DSwapChain(class422 arg0) {
        super(arg0);
    ...
    public final IDirect3DSurface method4135(int arg0, int arg1) {
        IDirect3DSurface var3 = new IDirect3DSurface(this.field10218);
        int var4 = this._GetBackBuffer(arg0, arg1, var3);
        if (class742.method4136(var4, (byte) -99)) {
