...
public class IDirect3DSwapChain extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "b", descriptor = "Ljaclib/peer/cv;")
    private class587 field6292;

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "<init>", descriptor = "(Ljaclib/peer/cv;)V", line = 4)
    public IDirect3DSwapChain(class587 arg0) {
        super(arg0);
        this.field6292 = arg0;
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DSwapChain", name = "a", descriptor = "(II)Ljagdx/IDirect3DSurface;", line = 14)
    public final IDirect3DSurface method2634(int arg0, int arg1) {
        IDirect3DSurface var3 = new IDirect3DSurface(this.field6292);
