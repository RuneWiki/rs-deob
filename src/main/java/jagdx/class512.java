...
public class class512 extends class702 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/mba;)V", line = 13)
    public class512(class701 arg0) {
        super(arg0);
        this.Init();
    }
