...
public class class512 extends class703 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/qd;)V", line = 11)
    public class512(class704 arg0) {
        super(arg0);
        this.Init();
    }
