...
public class class670 extends class337 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/wl;)V", line = 14)
    public class670(class336 arg0) {
        super(arg0);
        this.Init();
    }
