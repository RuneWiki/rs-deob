...
public class class449 extends class625 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/pi;)V", line = 14)
    public class449(class624 arg0) {
        super(arg0);
        this.Init();
    }
