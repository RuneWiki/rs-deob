...
public class class409 extends class575 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/pe;)V", line = 7)
    public class409(class576 arg0) {
        super(arg0);
        this.Init();
    }
