...
public class class442 extends class616 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/hr;)V", line = 6)
    public class442(class615 arg0) {
        super(arg0);
        this.Init();
    }
