...
public class class447 extends class625 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/jv;)V", line = 10)
    public class447(class624 arg0) {
        super(arg0);
        this.Init();
    }
