...
public class VertexElementCollection extends class672 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/faa;)V", line = 4)
    public VertexElementCollection(class671 arg0) {
        super(arg0);
        this.init();
    }
