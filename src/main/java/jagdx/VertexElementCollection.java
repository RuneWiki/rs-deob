...
public class VertexElementCollection extends class700 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/in;)V", line = 7)
    public VertexElementCollection(class699 arg0) {
        super(arg0);
        this.init();
    }
