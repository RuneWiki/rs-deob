...
public class VertexElementCollection extends class618 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/ca;)V", line = 5)
    public VertexElementCollection(class617 arg0) {
        super(arg0);
        this.init();
    }
