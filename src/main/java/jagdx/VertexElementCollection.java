...
public class VertexElementCollection extends class374 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/dba;)V", line = 5)
    public VertexElementCollection(class375 arg0) {
        super(arg0);
        this.init();
    }
