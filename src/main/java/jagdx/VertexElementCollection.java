...
public class VertexElementCollection extends class616 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/hr;)V", line = 4)
    public VertexElementCollection(class615 arg0) {
        super(arg0);
        this.init();
    }
