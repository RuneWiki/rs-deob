...
public class VertexElementCollection extends class627 {
    ...
    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/bda;)V")
    public VertexElementCollection(class626 arg0) {
        super(arg0);
        this.init();
    }
