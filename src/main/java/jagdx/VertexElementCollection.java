...
public class VertexElementCollection extends class440 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/iw;)V", line = 8)
    public VertexElementCollection(class441 arg0) {
        super(arg0);
        this.init();
    }
