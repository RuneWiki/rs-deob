...
public class VertexElementCollection extends class421 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/er;)V", line = 7)
    public VertexElementCollection(class420 arg0) {
        super(arg0);
        this.init();
    }
