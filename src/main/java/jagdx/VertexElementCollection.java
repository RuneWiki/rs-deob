...
public class VertexElementCollection extends class703 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/qd;)V", line = 6)
    public VertexElementCollection(class704 arg0) {
        super(arg0);
        this.init();
    }
