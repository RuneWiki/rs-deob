...
public class VertexElementCollection extends class702 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/mba;)V", line = 6)
    public VertexElementCollection(class701 arg0) {
        super(arg0);
        this.init();
    }
