...
public class VertexElementCollection extends class575 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/pe;)V", line = 4)
    public VertexElementCollection(class576 arg0) {
        super(arg0);
        this.init();
    }
