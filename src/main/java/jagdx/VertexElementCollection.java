...
public class VertexElementCollection extends class631 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/bea;)V", line = 6)
    public VertexElementCollection(class630 arg0) {
        super(arg0);
        this.init();
    }
