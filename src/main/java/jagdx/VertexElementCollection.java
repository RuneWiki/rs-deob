...
public class VertexElementCollection extends class361 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/ku;)V", line = 8)
    public VertexElementCollection(class360 arg0) {
        super(arg0);
        this.init();
    }
