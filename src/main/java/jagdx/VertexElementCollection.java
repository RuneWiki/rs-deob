...
public class VertexElementCollection extends class673 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/uca;)V", line = 8)
    public VertexElementCollection(class674 arg0) {
        super(arg0);
        this.init();
    }
