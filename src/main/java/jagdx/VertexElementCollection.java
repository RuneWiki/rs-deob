...
public class VertexElementCollection extends class625 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/pi;)V", line = 8)
    public VertexElementCollection(class624 arg0) {
        super(arg0);
        this.init();
    }
