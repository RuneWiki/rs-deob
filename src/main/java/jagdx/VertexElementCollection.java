...
public class VertexElementCollection extends class337 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/wl;)V", line = 4)
    public VertexElementCollection(class336 arg0) {
        super(arg0);
        this.init();
    }
