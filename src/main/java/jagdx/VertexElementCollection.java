...
public class VertexElementCollection extends class420 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/ep;)V", line = 8)
    public VertexElementCollection(class421 arg0) {
        super(arg0);
        this.init();
    }
