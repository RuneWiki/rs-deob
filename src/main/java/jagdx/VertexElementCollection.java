...
public class VertexElementCollection extends class620 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/ow;)V", line = 5)
    public VertexElementCollection(class621 arg0) {
        super(arg0);
        this.init();
    }
