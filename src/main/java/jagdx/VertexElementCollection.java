...
public class VertexElementCollection extends class339 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/aaa;)V", line = 7)
    public VertexElementCollection(class338 arg0) {
        super(arg0);
        this.init();
    }
