...
public class VertexElementCollection extends class624 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/naa;)V", line = 4)
    public VertexElementCollection(class623 arg0) {
        super(arg0);
        this.init();
    }
