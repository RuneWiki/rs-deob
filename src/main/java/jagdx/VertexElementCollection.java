...
public class VertexElementCollection extends class670 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/wf;)V", line = 7)
    public VertexElementCollection(class669 arg0) {
        super(arg0);
        this.init();
    }
