...
public class VertexElementCollection extends class570 {

    @OriginalMember(owner = "client!jagdx/VertexElementCollection", name = "<init>", descriptor = "(Ljaclib/peer/wn;)V", line = 8)
    public VertexElementCollection(class569 arg0) {
        super(arg0);
        this.init();
    }
