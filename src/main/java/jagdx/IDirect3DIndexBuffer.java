...
public class IDirect3DIndexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "a", descriptor = "()J", line = 7)
    protected final long method2601() {
        return super.method2601();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/k;)V", line = 20)
    public IDirect3DIndexBuffer(class419 arg0) {
        super(arg0);
    }
