...
public class IDirect3DIndexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/jv;)V", line = 7)
    public IDirect3DIndexBuffer(class624 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "a", descriptor = "()J", line = 17)
    protected final long method2662() {
        return super.method2662();
    }
