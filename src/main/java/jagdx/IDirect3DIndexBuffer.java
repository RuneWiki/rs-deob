...
public class IDirect3DIndexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "a", descriptor = "()J", line = 10)
    protected final long method2740() {
        return super.method2740();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/jaa;)V", line = 18)
    public IDirect3DIndexBuffer(class672 arg0) {
        super(arg0);
    }
