...
public class IDirect3DIndexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "a", descriptor = "()J", line = 9)
    protected final long method2308() {
        return super.method2308();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/am;)V", line = 19)
    public IDirect3DIndexBuffer(class625 arg0) {
        super(arg0);
    }
