...
public class IDirect3DIndexBuffer extends IUnknown {
    ...
    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "a", descriptor = "()J", line = 8)
    protected final long method2769() {
        return super.method2769();
    }

    @OriginalMember(owner = "client!jagdx/IDirect3DIndexBuffer", name = "<init>", descriptor = "(Ljaclib/peer/uca;)V", line = 20)
    public IDirect3DIndexBuffer(class674 arg0) {
        super(arg0);
    }
