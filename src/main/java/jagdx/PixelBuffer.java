...
public class PixelBuffer extends class702 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/pba;)V", line = 16)
    public PixelBuffer(class703 arg0) {
        super(arg0);
        this.init();
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 26)
    ...
    public final void method3072(int[] arg0, int arg1, int arg2, int arg3) {
