...
public class PixelBuffer extends class701 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/bd;)V", line = 15)
    public PixelBuffer(class700 arg0) {
        super(arg0);
        this.init();
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 25)
    public final void method3080(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    public final void method3081(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg1 < 0 | arg0 == null | arg0.length < (arg1 + arg3) | arg2 < 0) || arg3 * 4 + arg2 > this.getSize()) {
            throw new class508();
        }
        this.puti(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([BIII)V", line = 51)
