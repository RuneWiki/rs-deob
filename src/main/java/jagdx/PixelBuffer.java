...
public class PixelBuffer extends class625 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 8)
    public final void method2663(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/jv;)V", line = 18)
