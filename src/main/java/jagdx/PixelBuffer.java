...
public class PixelBuffer extends class570 implements Buffer {
    ...
    public final void method2413(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    public final void method2414(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | arg1 < 0 | arg0 == null | (arg1 + arg3) > arg0.length) || this.getSize() < (arg2 + (arg3 * 4))) {
            throw new class398();
        }
        this.geti(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/wn;)V", line = 42)
    public PixelBuffer(class569 arg0) {
        super(arg0);
        this.init();
    }
