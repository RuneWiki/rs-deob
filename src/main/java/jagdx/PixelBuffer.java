...
import jaclib.peer.class440;
import jaclib.peer.class441;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;

@OriginalClass("client!jagdx/PixelBuffer")
public class PixelBuffer extends class440 implements Buffer {

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/iw;)V", line = 4)
    public PixelBuffer(class441 arg0) {
        super(arg0);
        this.init();
    }
    ...
    public final void method4168(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "b", descriptor = "([IIII)V", line = 46)
    public final void method4169(int[] arg0, int arg1, int arg2, int arg3) {
