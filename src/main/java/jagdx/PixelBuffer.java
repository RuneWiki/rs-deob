...
public class PixelBuffer extends class420 implements Buffer {
    ...
    public final void method4111(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg0 == null | arg1 < 0 | arg1 + arg3 > arg0.length | arg2 < 0) || this.getSize() < arg3 * 4 + arg2) {
            throw new class739();
        }
        this.geti(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([BIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/k;)V", line = 28)
    public PixelBuffer(class419 arg0) {
        super(arg0);
        this.init();
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "getAddress", descriptor = "()J", line = 37)
    public final long getAddress() {
        return 0L;
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "b", descriptor = "([IIII)V", line = 47)
    public final void method4112(int[] arg0, int arg1, int arg2, int arg3) {
