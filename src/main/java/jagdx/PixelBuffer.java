...
import jaclib.peer.class627;
import org.openrs2.deob.annotation.OriginalClass;
import org.openrs2.deob.annotation.OriginalMember;

@OriginalClass("client!jagdx/PixelBuffer")
public class PixelBuffer extends class627 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/bda;)V")
    ...
    public final void method2723(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    public final void method2724(int[] arg0, int arg1, int arg2, int arg3) {
