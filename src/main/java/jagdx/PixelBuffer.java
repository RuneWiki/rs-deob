...
public class PixelBuffer extends class625 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "getAddress", descriptor = "()J", line = 12)
    public final long getAddress() {
        return 0L;
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 19)
    public final void method2550(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | arg1 + arg3 > arg0.length | arg0 == null | arg1 < 0) || this.getSize() < (arg3 * 4 + arg2)) {
            throw new class447();
        }
    ...
    public final void method2551(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/fl;)V", line = 49)
    public PixelBuffer(class626 arg0) {
        super(arg0);
        this.init();
    }
