...
public class PixelBuffer extends class703 implements Buffer {
   ...
   public final void method3741(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg1 < 0 | arg0 == null | arg1 + arg3 > arg0.length | 0 > arg2) && arg3 * 4 + arg2 <= this.getSize()) {
   ...
   public final void method3739(byte[] arg0, int arg1, int arg2, int arg3) {
      if (!(~arg2 > -1 | arg1 + arg3 > arg0.length | 0 > arg1 | arg0 == null) && this.getSize() >= arg2 + arg3) {
   ...
   public final void method3742(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg0.length < arg1 - -arg3 | ~arg1 > -1 | arg0 == null | arg2 < 0) && ~this.getSize() <= ~(arg3 * 4 + arg2)) {
