...
public class PixelBuffer extends class702 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([BIII)V", line = 16)
    ...
    public final void method2935(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/mba;)V", line = 36)
    ...
    public final void method2936(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | arg1 < 0 | arg0 == null | arg0.length < (arg1 + arg3)) || arg2 + (arg3 * 4) > this.getSize()) {
            throw new class511();
        }
