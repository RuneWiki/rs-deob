...
public class PixelBuffer extends class699 implements Buffer {
   @OriginalMember(
   ...
   public final void method3821(byte[] arg0, int arg1, int arg2, int arg3) {
      if (!(-1 < ~arg2 | -1 < ~arg1 | arg0 == null | arg1 + arg3 > arg0.length) && arg2 + arg3 <= this.getSize()) {
   ...
   public final void method3823(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg1 + arg3 > arg0.length | arg0 == null | arg1 < 0 | 0 > arg2) && arg3 * 4 + arg2 <= this.getSize()) {
   ...
   public final void method3824(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg0 == null | arg1 < 0 | arg0.length < arg1 - -arg3 | ~arg2 > -1) && ~(arg2 - -(arg3 * 4)) >= ~this.getSize()) {
