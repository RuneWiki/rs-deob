...
public class PixelBuffer extends class629 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 18)
    public final void method2484(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/dj;)V", line = 31)
    ...
    public final void method2485(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "getAddress", descriptor = "()J", line = 51)
