...
public class PixelBuffer extends class571 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([BIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/pb;)V", line = 27)
    public PixelBuffer(class570 arg0) {
        super(arg0);
        this.init();
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 39)
    public final void method2381(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    public final void method2382(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg0 == null | arg1 < 0 | arg0.length < arg1 + arg3 | arg2 < 0) || this.getSize() < arg2 + (arg3 * 4)) {
            throw new class399();
        }
