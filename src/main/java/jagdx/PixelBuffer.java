...
public class PixelBuffer extends class377 implements Buffer {
   @OriginalMember(
   ...
   public final void method231(byte[] arg0, int arg1, int arg2, int arg3) {
      if (!(~(arg1 + arg3) < ~arg0.length | 0 > arg1 | arg0 == null | ~arg2 > -1) && ~(arg2 + arg3) >= ~this.getSize()) {
   ...
   public final void method5486(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg1 - -arg3 > arg0.length | -1 < ~arg1 | arg0 == null | -1 < ~arg2) && this.getSize() >= arg2 - -(arg3 * 4)) {
   ...
   public final void method5487(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg1 - -arg3 > arg0.length | -1 < ~arg1 | arg0 == null | arg2 < 0) && arg3 * 4 + arg2 <= this.getSize()) {
   ...
   public PixelBuffer(class378 arg0) {
      super(arg0);
      this.init();
   }
