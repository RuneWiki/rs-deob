...
public class PixelBuffer extends class710 implements Buffer {
   @OriginalMember(
   ...
   public final void method559(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg2 < 0 | arg1 + arg3 > arg0.length | ~arg1 > -1 | arg0 == null) && arg3 * 4 + arg2 <= this.getSize()) {
   ...
   public PixelBuffer(class709 arg0) {
      super(arg0);
      this.init();
   }
   ...
   public final void method548(byte[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg0 == null | 0 > arg1 | ~(arg1 + arg3) < ~arg0.length | ~arg2 > -1) && ~(arg2 - -arg3) >= ~this.getSize()) {
   ...
   public final void method560(int[] arg0, int arg1, int arg2, int arg3) {
      if (!(0 > arg2 | arg0 == null | ~arg1 > -1 | ~(arg1 + arg3) < ~arg0.length) && arg3 * 4 + arg2 <= this.getSize()) {
