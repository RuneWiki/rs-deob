...
public class PixelBuffer extends class673 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/jaa;)V", line = 12)
    public PixelBuffer(class672 arg0) {
        super(arg0);
        this.init();
    }

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([IIII)V", line = 22)
    public final void method2741(int[] arg0, int arg1, int arg2, int arg3) {
    ...
    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "a", descriptor = "([BIII)V", line = 33)
    ...
    public final void method2742(int[] arg0, int arg1, int arg2, int arg3) {
