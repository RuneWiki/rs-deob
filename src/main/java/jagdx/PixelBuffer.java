...
public class PixelBuffer extends class616 implements Buffer {

    @OriginalMember(owner = "client!jagdx/PixelBuffer", name = "<init>", descriptor = "(Ljaclib/peer/hr;)V", line = 6)
    public PixelBuffer(class615 arg0) {
        super(arg0);
        this.init();
    }
    ...
    public final void method2446(byte[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | arg0.length < arg1 + arg3 | arg1 < 0 | arg0 == null) || this.getSize() < (arg2 + arg3)) {
            throw new class440();
        }
    ...
    public final void method2448(int[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | arg1 + arg3 > arg0.length | arg0 == null | arg1 < 0) || (arg3 * 4 + arg2) > this.getSize()) {
            throw new class440();
        }
