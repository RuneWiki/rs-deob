...
public class class770 extends class440 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/iw;)V", line = 9)
    public class770(class441 arg0) {
        super(arg0);
        this.Init();
    }
