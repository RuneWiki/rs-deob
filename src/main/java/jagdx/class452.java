...
public class class452 extends class629 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/dj;)V", line = 6)
    public class452(class630 arg0) {
        super(arg0);
        this.Init();
    }
