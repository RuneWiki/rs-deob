...
public class class738 extends class420 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/k;)V", line = 7)
    public class738(class419 arg0) {
        super(arg0);
        this.Init();
    }
