...
public class class484 extends class672 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/faa;)V", line = 13)
    public class484(class671 arg0) {
        super(arg0);
        this.Init();
    }
