...
public class GeometryBuffer extends class627 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/bda;)V")
    public GeometryBuffer(class626 arg0) {
        super(arg0);
        this.init();
    }
}
