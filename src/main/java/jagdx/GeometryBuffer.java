...
public class GeometryBuffer extends class575 implements Buffer {

    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/pe;)V", line = 5)
    public GeometryBuffer(class576 arg0) {
        super(arg0);
        this.init();
    }
    ...
    public final void method2339(byte[] arg0, int arg1, int arg2, int arg3) {
        if ((arg1 < 0 | arg0 == null | arg1 + arg3 > arg0.length | arg2 < 0) || (arg2 + arg3) > this.getSize()) {
            throw new class408();
        }
