...
public class GeometryBuffer extends class702 implements Buffer {
    ...
    public final void method3069(byte[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | arg0.length < arg1 + arg3 | arg1 < 0 | arg0 == null) || (arg2 + arg3) > this.getSize()) {
            throw new class510();
        }
        this.putub(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/pba;)V", line = 18)
