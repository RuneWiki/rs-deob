...
public class GeometryBuffer extends class624 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/am;)V", line = 5)
    public GeometryBuffer(class625 arg0) {
        super(arg0);
        this.init();
    }
    ...
    public final void method2304(byte[] arg0, int arg1, int arg2, int arg3) {
        if ((arg2 < 0 | (arg1 + arg3) > arg0.length | arg0 == null | arg1 < 0) || this.getSize() < arg2 + arg3) {
            throw new class437();
        }
