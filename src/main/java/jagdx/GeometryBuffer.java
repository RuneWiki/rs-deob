...
public class GeometryBuffer extends class377 implements Buffer {
   @OriginalMember(
   ...
   public final void method231(byte[] arg0, int arg1, int arg2, int arg3) {
      if (!(arg0 == null | ~arg1 > -1 | arg0.length < arg1 - -arg3 | ~arg2 > -1) && ~this.getSize() <= ~(arg2 + arg3)) {
   ...
   public GeometryBuffer(class378 arg0) {
      super(arg0);
      this.init();
   }
