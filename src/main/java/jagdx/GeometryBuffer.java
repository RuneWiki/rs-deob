...
public class GeometryBuffer extends class620 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/ow;)V", line = 20)
    public GeometryBuffer(class621 arg0) {
        super(arg0);
        this.init();
    }
