...
public class GeometryBuffer extends class421 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/er;)V", line = 17)
    public GeometryBuffer(class420 arg0) {
        super(arg0);
        this.init();
    }
