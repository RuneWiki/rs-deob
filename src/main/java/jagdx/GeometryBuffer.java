...
public class GeometryBuffer extends class339 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/aaa;)V", line = 16)
    public GeometryBuffer(class338 arg0) {
        super(arg0);
        this.init();
    }
