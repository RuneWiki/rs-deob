...
public class GeometryBuffer extends class701 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/bd;)V", line = 16)
    public GeometryBuffer(class700 arg0) {
        super(arg0);
        this.init();
    }
