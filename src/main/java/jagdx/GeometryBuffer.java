...
public class GeometryBuffer extends class624 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "a", descriptor = "([BIII)V", line = 10)
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/naa;)V", line = 20)
