...
public class GeometryBuffer extends class586 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/cv;)V", line = 16)
    public GeometryBuffer(class587 arg0) {
        super(arg0);
        this.init();
    }
