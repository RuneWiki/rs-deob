...
public class GeometryBuffer extends class618 implements Buffer {

    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/ca;)V", line = 5)
    public GeometryBuffer(class617 arg0) {
        super(arg0);
        this.init();
    }
