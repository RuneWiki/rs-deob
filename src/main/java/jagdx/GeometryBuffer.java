...
public class GeometryBuffer extends class670 implements Buffer {
    ...
    @OriginalMember(owner = "client!jagdx/GeometryBuffer", name = "<init>", descriptor = "(Ljaclib/peer/wf;)V", line = 20)
    public GeometryBuffer(class669 arg0) {
        super(arg0);
        this.init();
    }
