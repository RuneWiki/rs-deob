...
public class class741 extends class423 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/hea;)V", line = 5)
    public class741(class422 arg0) {
        super(arg0);
        this.Init();
    }
