...
public class class739 extends class421 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/er;)V", line = 4)
    public class739(class420 arg0) {
        super(arg0);
        this.Init();
    }
