...
public class class510 extends class700 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/bw;)V", line = 14)
    public class510(class701 arg0) {
        super(arg0);
        this.Init();
    }
