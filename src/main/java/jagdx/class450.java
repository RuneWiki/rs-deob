...
public class class450 extends class624 {

    @OriginalMember(owner = "client!jagdx/D3DLIGHT", name = "<init>", descriptor = "(Ljaclib/peer/naa;)V", line = 4)
    public class450(class623 arg0) {
        super(arg0);
        this.Init();
    }
