...
public class class41 extends class264 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(III)I", line = 3)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!is", name = "d", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(II)V", line = 159)
