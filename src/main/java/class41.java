...
public class class41 extends class260 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIILha;IIII)V")
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I[[I)V")
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(Lgn;)V")
    public class41(class729 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(ILgn;)V")
