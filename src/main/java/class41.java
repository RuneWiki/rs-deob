...
@OriginalClass("client!ODMBIHRM")
public class class41 {

    @OriginalMember(owner = "client!ODMBIHRM", name = "h", descriptor = "I")
    public int field1189 = -1;

    @OriginalMember(owner = "client!ODMBIHRM", name = "j", descriptor = "Z")
    public boolean field1191 = false;

    @OriginalMember(owner = "client!ODMBIHRM", name = "k", descriptor = "I")
    public int field1192 = 5;

    @OriginalMember(owner = "client!ODMBIHRM", name = "l", descriptor = "I")
    public int field1193 = -1;

    @OriginalMember(owner = "client!ODMBIHRM", name = "m", descriptor = "I")
    public int field1194 = -1;

    @OriginalMember(owner = "client!ODMBIHRM", name = "n", descriptor = "I")
    public int field1195 = 99;

    @OriginalMember(owner = "client!ODMBIHRM", name = "o", descriptor = "I")
    public int field1196 = -1;

    @OriginalMember(owner = "client!ODMBIHRM", name = "p", descriptor = "I")
    public int field1197 = -1;

    @OriginalMember(owner = "client!ODMBIHRM", name = "q", descriptor = "I")
    public int field1198 = 2;

    @OriginalMember(owner = "client!ODMBIHRM", name = "b", descriptor = "I")
    public static int field1183;

    @OriginalMember(owner = "client!ODMBIHRM", name = "d", descriptor = "I")
    public int field1185;

    @OriginalMember(owner = "client!ODMBIHRM", name = "r", descriptor = "I")
    public int field1199;

    @OriginalMember(owner = "client!ODMBIHRM", name = "s", descriptor = "I")
    public static int field1200;

    @OriginalMember(owner = "client!ODMBIHRM", name = "a", descriptor = "Z")
    private static boolean field1182;

    @OriginalMember(owner = "client!ODMBIHRM", name = "e", descriptor = "[I")
    public int[] field1186;

    @OriginalMember(owner = "client!ODMBIHRM", name = "f", descriptor = "[I")
    public int[] field1187;

    @OriginalMember(owner = "client!ODMBIHRM", name = "g", descriptor = "[I")
    private int[] field1188;

    @OriginalMember(owner = "client!ODMBIHRM", name = "i", descriptor = "[I")
    public int[] field1190;

    @OriginalMember(owner = "client!ODMBIHRM", name = "c", descriptor = "[LODMBIHRM;")
    public static class41[] field1184;

    @OriginalMember(owner = "client!ODMBIHRM", name = "a", descriptor = "(ILBBMKAXRK;)V")
    ...
    @OriginalMember(owner = "client!ODMBIHRM", name = "a", descriptor = "(IZ)I")
    ...
    @OriginalMember(owner = "client!ODMBIHRM", name = "a", descriptor = "(LEILHLJCE;B)V")
