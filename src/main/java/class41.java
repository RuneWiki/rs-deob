...
public class class41 extends class30 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BLmo;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(BI)[[I", line = 15)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "()V", line = 73)
    public class41() {
        super(3, false);
    }

    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(Ljg;II)V", line = 87)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IB)[I", line = 124)
    ...
    @OriginalMember(owner = "client!wc", name = "e", descriptor = "(B)V", line = 176)
    ...
    @OriginalMember(owner = "client!wc", name = "f", descriptor = "(I)V", line = 198)
    public static void method273(int arg0) {
        int var1 = -90 % ((59 - arg0) / 40);
        field512 = null;
    }

    @OriginalMember(owner = "client!wc", name = "f", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(BI)V", line = 229)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILno;)I", line = 244)
