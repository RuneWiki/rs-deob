...
public class class41 {
    ...
    @OriginalMember(owner = "client!e", name = "o", descriptor = "Ls;")
    public static class166 field871;

    @OriginalMember(owner = "client!e", name = "p", descriptor = "Lah;")
    ...
    @OriginalMember(owner = "client!e", name = "a", descriptor = "(ILja;[B)V")
