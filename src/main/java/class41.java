...
@OriginalClass("client!OTSGNSQM")
public class class41 {

    @OriginalMember(owner = "client!OTSGNSQM", name = "b", descriptor = "Z")
    private boolean field1181 = false;

    @OriginalMember(owner = "client!OTSGNSQM", name = "a", descriptor = "I")
    private int field1180;

    @OriginalMember(owner = "client!OTSGNSQM", name = "d", descriptor = "I")
    public int field1183;

    @OriginalMember(owner = "client!OTSGNSQM", name = "i", descriptor = "Z")
    private boolean field1188;

    @OriginalMember(owner = "client!OTSGNSQM", name = "c", descriptor = "[B")
    public byte[] field1182;

    @OriginalMember(owner = "client!OTSGNSQM", name = "e", descriptor = "[I")
    public int[] field1184;

    @OriginalMember(owner = "client!OTSGNSQM", name = "f", descriptor = "[I")
    public int[] field1185;

    @OriginalMember(owner = "client!OTSGNSQM", name = "g", descriptor = "[I")
    public int[] field1186;

    @OriginalMember(owner = "client!OTSGNSQM", name = "h", descriptor = "[I")
    public int[] field1187;

    @OriginalMember(owner = "client!OTSGNSQM", name = "<init>", descriptor = "([BZ)V")
    ...
    @OriginalMember(owner = "client!OTSGNSQM", name = "a", descriptor = "(I[B)V")
    ...
    @OriginalMember(owner = "client!OTSGNSQM", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
