...
public class class41 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BCI)I", line = 3)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)V", line = 29)
    public static void method240(int arg0) {
        field450 = null;
        int var1 = 34 % ((arg0 + 8) / 54);
    }

    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(BI)I", line = 102)
