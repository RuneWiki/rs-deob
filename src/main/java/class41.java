...
public class class41 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIIIIII)Z", line = 11)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIIIIIIII)Z", line = 381)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IBIIIIIII)Z", line = 476)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIII)V", line = 518)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BIIIIZZI)V", line = 529)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(IIII)V", line = 585)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IBI)V", line = 597)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIZIZII)V", line = 614)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)V", line = 666)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IZIIBIZ)V", line = 698)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIZ)V", line = 1010)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Ljava/lang/String;BZ)V", line = 1025)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IZ)Lac;", line = 1097)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BZIIIIZ)V", line = 1120)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IZIIIIII)Z", line = 1431)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BII)V", line = 1618)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(IBI)V", line = 1634)
