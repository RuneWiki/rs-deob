...
public class class41 {
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(Lofa;BI)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(CI)C", line = 37)
    ...
    @OriginalMember(owner = "client!bq", name = "a", descriptor = "(I)V", line = 427)
