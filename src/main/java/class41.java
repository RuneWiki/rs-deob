...
public class class41 implements class104 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)Lfl;", line = 15)
    public class103 method318(int arg0) {
        field580++;
        return arg0 == -26207 ? null : null;
    }

    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lffa;Loca;IIIIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)V", line = 58)
