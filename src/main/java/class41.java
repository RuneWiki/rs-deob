...
public class class41 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Lvs;B)V")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(B)Lgda;")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BLqda;)V")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Ltw;I)V")
    ...
    @OriginalMember(owner = "client!vba", name = "b", descriptor = "(Lvs;B)V")
