...
public class class41 {
    ...
    @OriginalMember(owner = "client!NYAYDXBO", name = "b", descriptor = "[LNYAYDXBO;")
    public static class41[] field1125;

    @OriginalMember(owner = "client!NYAYDXBO", name = "a", descriptor = "(ILQKFGLETG;)V")
    ...
    @OriginalMember(owner = "client!NYAYDXBO", name = "a", descriptor = "(LXJCNBMKS;II)V")
