...
public class class41 extends class12 {
    ...
    @OriginalMember(owner = "client!LPVEAYFU", name = "n", descriptor = "LIUTBNGPH;")
    ...
    @OriginalMember(owner = "client!LPVEAYFU", name = "y", descriptor = "Lclient;")
    public static client field1069;

    @OriginalMember(owner = "client!LPVEAYFU", name = "a", descriptor = "(B)LQMZPELNG;")
    ...
    @OriginalMember(owner = "client!LPVEAYFU", name = "a", descriptor = "(I)LLFTMDGKK;")
