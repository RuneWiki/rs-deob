...
public class class41 {
    ...
    @OriginalMember(owner = "client!OCQVXKDE", name = "d", descriptor = "LPKHWFJLM;")
    ...
    @OriginalMember(owner = "client!OCQVXKDE", name = "a", descriptor = "(IBLPKHWFJLM;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!OCQVXKDE", name = "a", descriptor = "(Ljava/lang/String;LPKHWFJLM;I)V")
