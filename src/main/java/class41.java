...
public class class41 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(BLio;)Lqm;", line = 14)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(III)Lia;", line = 27)
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(B)V", line = 35)
