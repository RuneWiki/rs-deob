...
public class class41 extends class405 {
    ...
    @OriginalMember(owner = "client!wg", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)Z", line = 20)
    public final boolean method324(int arg0, int arg1) {
        field543++;
        return arg1 == -1500 ? this.field538[arg0].field780 : true;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BI)I", line = 31)
    ...
    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(II)Z", line = 46)
    public final boolean method326(int arg0, int arg1) {
        field540++;
        return arg0 == 0 ? this.field538[arg1].field784 : false;
    }

    @OriginalMember(owner = "client!wg", name = "b", descriptor = "(BI)Z", line = 61)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIII)Z", line = 71)
    ...
    @OriginalMember(owner = "client!wg", name = "d", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(I)V", line = 269)
    public class41(int arg0) {
        this.field544 = arg0;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)Z", line = 277)
