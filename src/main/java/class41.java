...
public class class41 {
    ...
    @OriginalMember(owner = "client!NXAZLFDC", name = "n", descriptor = "I")
    ...
    @OriginalMember(owner = "client!NXAZLFDC", name = "a", descriptor = "(LLDILQFVA;I)V")
    ...
    @OriginalMember(owner = "client!NXAZLFDC", name = "a", descriptor = "(LLDILQFVA;Z)V")
