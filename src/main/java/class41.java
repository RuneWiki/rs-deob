...
public class class41 {
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lsq;IIIII)V")
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(IB)Ldt;")
    ...
    @OriginalMember(owner = "client!fw", name = "<init>", descriptor = "(ILoi;Loi;)V")
