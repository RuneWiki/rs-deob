...
public class class41 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(II)I", line = 41)
    public static int method323(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!rv", name = "a", descriptor = "([[[Ldr;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 122)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIIZ)V", line = 139)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BII)V", line = 183)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(II)Let;", line = 204)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lgo;ILns;Lns;)V", line = 249)
