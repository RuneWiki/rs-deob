...
public class class41 extends class141 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!ha", name = "f", descriptor = "(I)V", line = 159)
