...
public class class41 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(Lqq;II)Z")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(I[Lhe;IIII)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILqq;IIIIII)V")
