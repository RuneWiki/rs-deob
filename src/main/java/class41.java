...
public class class41 implements class399 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([IIIJ)Ljava/lang/String;", line = 51)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZII)V", line = 90)
