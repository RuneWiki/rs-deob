...
public class class41 extends class260 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(II[IB)V", line = 22)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLjava/lang/String;)V", line = 40)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBI[I)V", line = 104)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IBII)Z", line = 117)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lgg;)V", line = 135)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(BII)Z", line = 192)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(IIIIIIIII)V", line = 208)
