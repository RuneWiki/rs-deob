...
public class class41 {
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ILep;B)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(ZLep;)V")
    ...
    @OriginalMember(owner = "client!vo", name = "a", descriptor = "(II[BIILoea;ZI)Lm;")
