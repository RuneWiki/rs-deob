...
public class class41 {
    ...
    @OriginalMember(owner = "client!gs", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field432++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIIIZIZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Lcd;I)V", line = 75)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 108)
