...
public class class41 extends class518 {
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!na", name = "b", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!na", name = "<init>", descriptor = "(IIIIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(I[Lxa;)V", line = 59)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(ZI)I", line = 84)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IBI)V", line = 113)
    ...
    @OriginalMember(owner = "client!na", name = "a", descriptor = "(IIZ)V", line = 134)
