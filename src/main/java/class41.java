...
public class class41 extends class46 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lib;I)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!be", name = "c", descriptor = "(I)Ljava/lang/String;", line = 46)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lib;BI)V", line = 71)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BII)I", line = 150)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "([ILib;B)V", line = 170)
    ...
    @OriginalMember(owner = "client!be", name = "d", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "()V", line = 227)
    public static final void method283() {
        class519.method3949(1, class501.field7246);
    }

    @OriginalMember(owner = "client!be", name = "c", descriptor = "(B)I", line = 231)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lib;Z)V", line = 247)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ZI)Ldv;", line = 272)
