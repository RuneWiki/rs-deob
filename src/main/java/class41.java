...
public class class41 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILdt;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILdt;)V", line = 299)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IIIZ)Lqba;", line = 322)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Z)V", line = 382)
