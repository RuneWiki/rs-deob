...
public class class41 {
    ...
    @OriginalMember(owner = "client!QFWDHRAY", name = "c", descriptor = "LGHHPHSRU;")
    ...
    @OriginalMember(owner = "client!QFWDHRAY", name = "a", descriptor = "(ILGHHPHSRU;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!QFWDHRAY", name = "a", descriptor = "(Ljava/lang/String;LGHHPHSRU;B)V")
