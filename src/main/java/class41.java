...
public class class41 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ZLgga;)Ldda;", line = 6)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILgga;)V", line = 35)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(Z)V", line = 64)
    ...
    @OriginalMember(owner = "client!ts", name = "toString", descriptor = "()Ljava/lang/String;", line = 100)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(II)V", line = 124)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(B)[Ljava/lang/String;", line = 135)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(ILjava/lang/String;)V", line = 162)
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IILjava/lang/String;)V", line = 172)
    ...
    @OriginalMember(owner = "client!ts", name = "<init>", descriptor = "(IZ)V", line = 251)
    public class41(int arg0, boolean arg1) {
        this.field427 = arg1;
        this.field415 = arg0;
    }

    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(I)V", line = 204)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(II)I", line = 217)
    ...
    @OriginalMember(owner = "client!ts", name = "b", descriptor = "(ILjava/lang/String;)V", line = 260)
