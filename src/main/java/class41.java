...
public class class41 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ZIIBZ)Llm;", line = 30)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "([BIII[I[[B[I[[B)I", line = 68)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLnj;Ljava/lang/String;)I", line = 130)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILjava/lang/String;JLjava/lang/String;IZI)V", line = 150)
