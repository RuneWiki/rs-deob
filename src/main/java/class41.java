...
@OriginalClass("client!RKTGZGSS")
public class class41 {

    @OriginalMember(owner = "client!RKTGZGSS", name = "a", descriptor = "I")
    private static int field1295 = -302;

    @OriginalMember(owner = "client!RKTGZGSS", name = "d", descriptor = "I")
    public int field1298;

    @OriginalMember(owner = "client!RKTGZGSS", name = "f", descriptor = "I")
    public int field1300;

    @OriginalMember(owner = "client!RKTGZGSS", name = "e", descriptor = "LDIQFKGVT;")
    public class10 field1299;

    @OriginalMember(owner = "client!RKTGZGSS", name = "b", descriptor = "Z")
    private static boolean field1296;

    @OriginalMember(owner = "client!RKTGZGSS", name = "g", descriptor = "[I")
    public int[] field1301;

    @OriginalMember(owner = "client!RKTGZGSS", name = "h", descriptor = "[I")
    public int[] field1302;

    @OriginalMember(owner = "client!RKTGZGSS", name = "i", descriptor = "[I")
    public int[] field1303;

    @OriginalMember(owner = "client!RKTGZGSS", name = "j", descriptor = "[I")
    public int[] field1304;

    @OriginalMember(owner = "client!RKTGZGSS", name = "c", descriptor = "[LRKTGZGSS;")
    private static class41[] field1297;

    @OriginalMember(owner = "client!RKTGZGSS", name = "k", descriptor = "[Z")
    private static boolean[] field1305;

    @OriginalMember(owner = "client!RKTGZGSS", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!RKTGZGSS", name = "a", descriptor = "([BZ)V")
    ...
    @OriginalMember(owner = "client!RKTGZGSS", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!RKTGZGSS", name = "a", descriptor = "(II)LRKTGZGSS;")
    ...
    @OriginalMember(owner = "client!RKTGZGSS", name = "a", descriptor = "(IB)Z")
