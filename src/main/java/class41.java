...
public class class41 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lop;I)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lop;)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lae;I)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lpn;II)V")
