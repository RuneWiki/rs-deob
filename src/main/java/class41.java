...
public class class41 {
    ...
    @OriginalMember(owner = "client!oo", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;B)V")
    ...
    @OriginalMember(owner = "client!oo", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
