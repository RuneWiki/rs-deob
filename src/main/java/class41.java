...
public class class41 extends class634 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)I", line = 5)
    public final int method332(byte arg0) {
        field546++;
        return arg0 <= 2 ? 14 : this.field545;
    }

    @OriginalMember(owner = "client!qga", name = "d", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(Z)I", line = 32)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)J", line = 49)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IIIII)V", line = 60)
    ...
    @OriginalMember(owner = "client!qga", name = "f", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)I", line = 91)
