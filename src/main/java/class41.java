...
public class class41 extends class331 {
    ...
    @OriginalMember(owner = "client!wc", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(II)V", line = 22)
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(Z)Z", line = 35)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILdg;Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILdg;)V", line = 80)
