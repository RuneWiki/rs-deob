...
public class class41 extends class73 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "()Lkca;")
    public final class73 method256() {
        return (class73) this.field482.method124((byte) 42);
    }

    @OriginalMember(owner = "client!sca", name = "b", descriptor = "()Lkca;")
    public final class73 method257() {
        return (class73) this.field482.method120(-125);
    }

    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lkca;)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lkp;Lhb;)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Lhb;)V")
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(Lkca;)V")
