...
public class class41 extends class26 {
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lnm;IIII)V", line = 11)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lnm;IIIIZ[FI)V", line = 22)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lnm;IIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lnm;IIIIZ[IZ)V", line = 62)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "()V", line = 110)
    public final void method309() {
        this.field329.field3648.glFramebufferTexture2DEXT(36160, this.field568, this.field330, 0, 0);
        this.field568 = -1;
    }

    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Lnm;IIIIZ[BIZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIII[BIIIZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(IIII[IIIZ)V", line = 169)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(ZZ)V", line = 262)
