...
public class class41 extends class346 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(BLie;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lw;Lbd;Ltj;B)V")
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Lfb;ZI)V")
