...
public class class41 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IJ)V", line = 68)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZLlh;)V", line = 93)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Llh;II)V", line = 114)
