...
public class class41 extends class56 {
    ...
    @OriginalMember(owner = "client!PNDCOEKM", name = "O", descriptor = "[LNUXLZYAZ;")
    ...
    @OriginalMember(owner = "client!PNDCOEKM", name = "y", descriptor = "Z")
    ...
    @OriginalMember(owner = "client!PNDCOEKM", name = "a", descriptor = "(LGWOEELWB;I)V")
