...
public class class41 extends class448 {
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(Lm;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IILok;Lea;ZII)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILvg;)V")
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLjq;)I")
