...
public class class41 extends class214 {
    ...
    @OriginalMember(owner = "client!fw", name = "e", descriptor = "()I", line = 4)
    public final synchronized int method383() {
        return this.field542.method1000((byte) 121);
    }

    @OriginalMember(owner = "client!fw", name = "c", descriptor = "([III)V", line = 9)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lfp;)V", line = 19)
    public final synchronized void method385(class214 arg0) {
        arg0.method2677(-22491);
    }

    @OriginalMember(owner = "client!fw", name = "c", descriptor = "()Lfp;", line = 22)
    public final class214 method386() {
        return (class214) this.field542.method1004((byte) -85);
    }

    @OriginalMember(owner = "client!fw", name = "a", descriptor = "([III)V", line = 30)
    ...
    @OriginalMember(owner = "client!fw", name = "f", descriptor = "()V", line = 76)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lfd;)V", line = 151)
    ...
    @OriginalMember(owner = "client!fw", name = "b", descriptor = "()I", line = 164)
    public final int method391() {
        return 0;
    }

    @OriginalMember(owner = "client!fw", name = "b", descriptor = "(Lfp;)V", line = 171)
    public final synchronized void method392(class214 arg0) {
        this.field542.method998(arg0, 100);
    }

    @OriginalMember(owner = "client!fw", name = "g", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!fw", name = "d", descriptor = "()Lfp;", line = 187)
    public final class214 method394() {
        return (class214) this.field542.method996(1);
    }

    @OriginalMember(owner = "client!fw", name = "a", descriptor = "(Lcf;Lfd;)V", line = 190)
