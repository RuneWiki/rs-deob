...
public abstract class class41 {
    ...
    @OriginalMember(owner = "client!gs", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(III[B)[B", line = 13)
    ...
    @OriginalMember(owner = "client!gs", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IB[B)V", line = 44)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lok;I[BIZ)V", line = 74)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(IIII)I", line = 95)
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(Lok;ILjaclib/memory/Buffer;IZ)V", line = 126)
