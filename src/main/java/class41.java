...
public class class41 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IZ)V", line = 54)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IBIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 210)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IB)V", line = 223)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(IB)V", line = 237)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(I)V", line = 257)
    ...
    @OriginalMember(owner = "client!wr", name = "c", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(II)Lis;", line = 294)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILfc;Lfc;)I", line = 376)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IBIILkm;Lwh;II)Laq;", line = 410)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZZILkm;Lkm;Loj;IILwh;III)Laq;", line = 430)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Ldk;IZLqb;Lfc;Lfc;)V", line = 525)
