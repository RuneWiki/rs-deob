...
public class class41 extends class642 {
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILgk;B)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IILr;)V")
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ILpca;)I")
