...
public class class41 implements class591 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!vba", name = "<init>", descriptor = "(Lul;Z)V")
