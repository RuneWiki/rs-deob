...
public class class184 extends class56 {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IB)I", line = 7)
    public static final int method1162(int arg0, byte arg1) {
        ++field2499;
        return arg1 != -128 ? 69 : arg0 >>> 8;
    }

    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZ)[I", line = 18)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Z)Lhha;", line = 41)
    ...
    @OriginalMember(owner = "client!c", name = "c", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II)[[I", line = 68)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILee;I)V", line = 130)
    ...
    @OriginalMember(owner = "client!c", name = "<init>", descriptor = "()V", line = 214)
    public class184() {
        super(0, true);
    }

    @OriginalMember(owner = "client!c", name = "e", descriptor = "(I)V", line = 219)
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[[I)V", line = 287)
    ...
    @OriginalMember(owner = "client!c", name = "d", descriptor = "(B)V", line = 340)
