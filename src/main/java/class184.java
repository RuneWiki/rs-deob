...
public class class184 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lkda;Lkda;I)I", line = 6)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Lica;[IB[I[I)V", line = 62)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(II)Z", line = 157)
