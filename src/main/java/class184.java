...
public class class184 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIIBI)V", line = 18)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(ILmj;IZII)Liw;", line = 96)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(BI)Llda;", line = 132)
    ...
    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lwj;ILwu;)V", line = 194)
    public class184(class121 arg0, int arg1, class557 arg2) {
        this.field2663 = arg2;
        this.field2663.method3333(29, 3443);
    }

    @OriginalMember(owner = "client!ir", name = "b", descriptor = "(I)V", line = 209)
