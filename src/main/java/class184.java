...
public class class184 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ldg;I)I")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Lgp;Lgp;ILgp;Ltda;)Z")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Z)Lbea;")
    ...
    @OriginalMember(owner = "client!br", name = "c", descriptor = "(I)[Lml;")
