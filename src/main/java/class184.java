...
public class class184 {
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(II)Lgw;")
    ...
    @OriginalMember(owner = "client!el", name = "a", descriptor = "(Lla;)V")
    public static final void method1120(class413 arg0) {
        class653.field9162 = arg0;
    }

    @OriginalMember(owner = "client!el", name = "<init>", descriptor = "(Lqh;ILtf;Ltf;)V")
