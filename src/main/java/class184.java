...
public class class184 extends class54 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(B[[[Liia;)V")
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IBILev;I)V")
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(ILhia;)V")
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Lhia;)V")
    public class184(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hga", name = "e", descriptor = "(I)V")
