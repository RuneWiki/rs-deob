...
public class class184 extends class189 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(BLnn;)V", line = 8)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lnn;II)V", line = 33)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IB)I", line = 55)
