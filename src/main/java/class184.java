...
public abstract class class184 {
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IILha;III)V", line = 11)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(BLae;)Lae;", line = 107)
    ...
    @OriginalMember(owner = "client!ffa", name = "<init>", descriptor = "(Loea;)V", line = 125)
    public class184(class594 arg0) {
        this.field2626 = arg0;
    }

    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(IILoea;Ljava/lang/String;)Lpp;", line = 134)
    ...
    @OriginalMember(owner = "client!ffa", name = "a", descriptor = "(B)V", line = 160)
