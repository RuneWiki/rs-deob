...
public class class184 extends class107 {
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(IIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hga", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!hga", name = "<init>", descriptor = "(Ljr;)V", line = 91)
