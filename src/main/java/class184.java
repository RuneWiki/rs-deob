...
public class class184 extends class428 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILoj;IZJ)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lab;Lab;I)V")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILcu;IIB)V")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Loj;Ltn;Lbt;J)V")
