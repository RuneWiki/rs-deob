...
public class class184 extends class423 {
    ...
    @OriginalMember(owner = "client!gf", name = "f", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIIB)V", line = 19)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!gf", name = "c", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!gf", name = "g", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIBIII)V", line = 130)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lnq;II)V", line = 569)
    public class184(class325 arg0, int arg1, int arg2) {
        this.field2491 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lwj;B)V", line = 579)
