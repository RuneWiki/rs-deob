...
public class class184 {
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(BILil;)V", line = 75)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(Lil;I)V", line = 307)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(IIIBIIIII)V", line = 329)
    ...
    @OriginalMember(owner = "client!jq", name = "a", descriptor = "(I)V", line = 360)
