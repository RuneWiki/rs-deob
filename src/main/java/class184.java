...
public class class184 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(B)V", line = 233)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 250)
