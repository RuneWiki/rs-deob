...
public class class184 extends class398 {
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "()V", line = 117)
    public class184() {
        super(0, true);
    }

    @OriginalMember(owner = "client!um", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!um", name = "c", descriptor = "(B)V", line = 137)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)[I", line = 155)
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(Z)I", line = 227)
    public static final int method1121(boolean arg0) {
        ++field2495;
        return !arg0 ? -27 : 6;
    }

    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lnj;II)V", line = 240)
