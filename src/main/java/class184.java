...
public class class184 {
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "([Lmq;IIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BII)I", line = 652)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIB)I", line = 669)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(ILck;)V", line = 685)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(Lnh;III)V", line = 893)
