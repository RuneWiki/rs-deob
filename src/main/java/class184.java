...
public class class184 extends class7 {
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Ldia;IIIIZ[BIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(ZZI)V", line = 55)
    ...
    @OriginalMember(owner = "client!tca", name = "f", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!tca", name = "g", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IIZII[BIIII)V", line = 306)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Ldia;IIII)V", line = 364)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Ldia;IIIII)V", line = 379)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Ldia;IIIIZ[FI)V", line = 397)
    ...
    @OriginalMember(owner = "client!tca", name = "h", descriptor = "(B)V", line = 419)
    ...
    @OriginalMember(owner = "client!tca", name = "<init>", descriptor = "(Ldia;IIIIZ[IIIZ)V", line = 434)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IBII)V", line = 495)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IZIIIII)V", line = 514)
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "([IZIIIIIII)V", line = 543)
