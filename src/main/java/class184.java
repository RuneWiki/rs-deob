...
public class class184 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)Ljq;")
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(B)Ljq;")
    ...
    @OriginalMember(owner = "client!um", name = "d", descriptor = "(B)Ljq;")
    ...
    @OriginalMember(owner = "client!um", name = "f", descriptor = "(B)Ljq;")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Ljq;I)V")
