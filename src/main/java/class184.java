...
public class class184 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lkk;II)V", line = 12)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 102)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lkk;I)V", line = 136)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lae;I)V", line = 163)
