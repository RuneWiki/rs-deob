...
public class class184 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(III)Lpi;", line = 29)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lkm;Lcj;IIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IJLjs;)V", line = 110)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 136)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZJ)Ljs;", line = 192)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(I)V", line = 238)
