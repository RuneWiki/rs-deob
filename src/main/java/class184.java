...
public class class184 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(III[I)Lve;")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(II[I)Lve;")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lil;III)V")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "([III)Lve;")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "([IZII)Lve;")
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "(Lwo;Lwo;)V")
