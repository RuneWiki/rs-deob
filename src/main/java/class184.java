...
public class class184 implements class509 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)Z", line = 15)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)[Liga;", line = 28)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IIILda;ILjava/lang/String;)I", line = 84)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Leb;Lom;)V", line = 95)
