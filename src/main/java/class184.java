...
public class class184 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(IIILwb;Leq;III)Lqg;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(ILeq;IZLwb;IZILhr;IILeq;)Lqg;")
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)Lac;")
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lci;IZLoj;Lhe;Lhe;)V")
