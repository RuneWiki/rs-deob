...
public class class184 implements Runnable {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ILmu;)V", line = 5)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 19)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/lang/String;B)Luba;", line = 40)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!oe", name = "run", descriptor = "()V", line = 139)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "()V", line = 180)
    public class184() {
        this.field2238.setDaemon(true);
        this.field2238.start();
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ICI)C", line = 193)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I)V", line = 280)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(BIZIZ)Ljo;", line = 304)
