...
public class class184 extends class114 {
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(BLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(IBI)V", line = 14)
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(Ljc;I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(IB)V", line = 81)
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(ILwfa;)V", line = 98)
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!qka", name = "a", descriptor = "(ILjc;)Lno;", line = 139)
