...
public class class184 extends class36 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIIZLe;Lkea;)[F")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(DLe;Lkea;ZIIIZ)[I")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(ILe;ZDZILkea;)[I")
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Le;BLkea;)Z")
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lrt;)V")
