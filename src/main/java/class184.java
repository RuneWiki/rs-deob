...
public class class184 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(B)Lwd;", line = 4)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(IIIILbt;I)Lhf;", line = 15)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(Lwd;I)V", line = 55)
    ...
    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(I)V", line = 85)
    public class184(int arg0) {
        this.field2718 = arg0;
    }

    @OriginalMember(owner = "client!wd", name = "<init>", descriptor = "(IIIIII)V", line = 92)
