...
public class class184 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(BILgk;)V", line = 64)
    ...
    @OriginalMember(owner = "client!ve", name = "b", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(Lgk;I)V", line = 116)
