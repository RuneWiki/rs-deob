...
public class class184 {
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILfca;I)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!cda", name = "a", descriptor = "(IZZ)V")
