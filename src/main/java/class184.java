...
public class class184 extends class278 {
    ...
    @OriginalMember(owner = "client!kd", name = "g", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Llh;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(II)[[I", line = 71)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(II)[I", line = 143)
