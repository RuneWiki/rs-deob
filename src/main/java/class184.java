...
public class class184 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)V", line = 9)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Throwable;)V", line = 46)
