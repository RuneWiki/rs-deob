...
public class class184 extends class409 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZLkg;)V")
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lde;IIIII)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!rr", name = "d", descriptor = "(I)Lum;")
