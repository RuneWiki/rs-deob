...
public abstract class class184 implements class218 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ldca;B)V", line = 11)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!oe", name = "d", descriptor = "(I)I", line = 68)
    ...
    @OriginalMember(owner = "client!oe", name = "finalize", descriptor = "()V", line = 163)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(I[BIII)V", line = 172)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Ltba;ILpn;Ljg;IZ)V", line = 774)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIIZ[I)V", line = 275)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(Z)V", line = 381)
    ...
    @OriginalMember(owner = "client!oe", name = "e", descriptor = "(I)V", line = 400)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(II)V", line = 416)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B[FIII)V", line = 434)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(B)V", line = 531)
    ...
    @OriginalMember(owner = "client!oe", name = "f", descriptor = "(I)I", line = 730)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Z)V", line = 746)
