...
public class class184 extends class323 implements class438 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lfp;Z)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lfp;Lje;ZIIII)V")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(IIILcl;)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lge;ILwc;II)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILfp;)Luq;")
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(ILfp;)V")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lfp;II)Lbi;")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lfp;III)Z")
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lfp;I)V")
