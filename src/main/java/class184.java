...
public class class184 extends class192 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IZ)I", line = 40)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIIII)V", line = 67)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(BII)Z", line = 86)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIIIIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lwk;II)V", line = 539)
