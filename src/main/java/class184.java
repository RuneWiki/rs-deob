...
public class class184 {
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Leh;Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BILeh;)V", line = 87)
