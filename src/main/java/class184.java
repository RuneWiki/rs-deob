...
public class class184 {
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "([Lmg;I)I")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(I)Lmg;")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(Z)Lmg;")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IJLmg;)V")
    ...
    @OriginalMember(owner = "client!tca", name = "a", descriptor = "(IJ)Lmg;")
    ...
    @OriginalMember(owner = "client!tca", name = "b", descriptor = "(B)Lmg;")
