...
public class class184 extends class507 implements class241 {
    ...
    @OriginalMember(owner = "client!p", name = "d", descriptor = "()[Lsm;")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Laq;II)V")
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Lia;Laq;I)V")
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "()[Lot;")
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Lh;Lba;Luu;IIII)V")
