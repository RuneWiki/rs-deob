...
public class class184 extends class509 {
    ...
    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Ltt;)V")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(Lfi;B)Lfi;")
    ...
    @OriginalMember(owner = "client!bf", name = "e", descriptor = "(I)[Lsc;")
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(BILin;)V")
