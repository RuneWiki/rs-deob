...
public class class184 {
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lqa;Lte;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "()V", line = 42)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "()V", line = 61)
    public final void method1305() {
        this.field2600 = null;
    }

    @OriginalMember(owner = "client!te", name = "b", descriptor = "(Lqa;Lte;)V", line = 73)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(Lqa;Lte;)V", line = 158)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lqa;)V", line = 248)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "()V", line = 327)
    public static final void method1309() {
        field2607 = null;
        field2605 = null;
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lqa;IIIIII)V", line = 331)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIII)Z", line = 358)
    ...
    @OriginalMember(owner = "client!te", name = "d", descriptor = "(Lqa;Lte;)Z", line = 416)
    public final boolean method1312(class496 arg0, class184 arg1) {
        return this.field2600 != null || this.method1303(arg0, arg1);
    }

    @OriginalMember(owner = "client!te", name = "b", descriptor = "(Lqa;)V", line = 419)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(IIIIIIIZ)V", line = 479)
