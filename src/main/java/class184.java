...
public class class184 extends class17 {
    ...
    @OriginalMember(owner = "client!up", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!up", name = "<init>", descriptor = "()V", line = 46)
    public class184() {
        super(0, true);
    }

    @OriginalMember(owner = "client!up", name = "a", descriptor = "(IBIIIII)I", line = 53)
    ...
    @OriginalMember(owner = "client!up", name = "h", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!up", name = "d", descriptor = "(III)V", line = 144)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(Lwm;II)V", line = 171)
    ...
    @OriginalMember(owner = "client!up", name = "g", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(ZI[I)V", line = 296)
    ...
    @OriginalMember(owner = "client!up", name = "a", descriptor = "(II)[I", line = 459)
