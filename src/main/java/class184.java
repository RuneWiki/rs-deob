...
public class class184 {
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(II)Lgk;")
    ...
    @OriginalMember(owner = "client!an", name = "a", descriptor = "(IB)Lui;")
    ...
    @OriginalMember(owner = "client!an", name = "<init>", descriptor = "(Lad;ILdk;)V")
