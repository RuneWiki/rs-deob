...
public class class184 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(IBIIIII)Lmv;", line = 3)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Los;I)Lvu;", line = 66)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(B)V", line = 81)
