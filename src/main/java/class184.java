...
public class class184 extends class267 implements class305 {
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Llea;ILjaclib/memory/Buffer;IZ)V")
    public class184(class573 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field2791 = arg1;
    }

    @OriginalMember(owner = "client!mja", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!mja", name = "<init>", descriptor = "(Llea;I[BIZ)V")
