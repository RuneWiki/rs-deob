...
public class class146 extends OutputStream {
    ...
    @OriginalMember(owner = "client!cf", name = "write", descriptor = "(I)V", line = 4)
    public final void write(int arg0) throws IOException {
        field1974++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILmj;IZLmj;BZ)I", line = 35)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lqh;III[Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIZZIIZ)V", line = 100)
