...
public class class146 extends class469 implements class534 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(Lqa;B)Lem;", line = 16)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIILqa;)Z", line = 29)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(B)I", line = 52)
    public final int method559(byte arg0) {
        ++field2253;
        return arg0 < 3 ? -125 : this.field2254.field3066;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BLqa;)V", line = 63)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILqa;)Lnj;", line = 74)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILqa;I)Lka;", line = 120)
    ...
    @OriginalMember(owner = "client!ta", name = "f", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(B)I", line = 145)
    public final int method561(byte arg0) {
        ++field2257;
        return arg0 != -85 ? -93 : this.field2254.field3089;
    }

    @OriginalMember(owner = "client!ta", name = "g", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(I)V", line = 203)
    public final void method548(int arg0) {
        int var2 = 79 % ((arg0 - -37) / 34);
        ++field2258;
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lqa;I)V", line = 214)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(I)Z", line = 226)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lqa;Lku;IIIIIZIIIIII)V", line = 236)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Lqa;B)V", line = 249)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(I)I", line = 271)
