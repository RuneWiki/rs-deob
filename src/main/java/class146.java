...
public class class146 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lne;IIIII)Ljava/awt/Frame;", line = 16)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILm;)Ljava/lang/Object;", line = 91)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIZIIIII)Z", line = 144)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLjava/lang/Object;Lm;)V", line = 163)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B)I", line = 192)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lij;I)V", line = 209)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)V", line = 226)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(BLm;)V", line = 276)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(I)V", line = 304)
    ...
    @OriginalMember(owner = "client!la", name = "b", descriptor = "(B)V", line = 322)
    ...
    @OriginalMember(owner = "client!la", name = "c", descriptor = "(I)I", line = 348)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(I)V", line = 370)
