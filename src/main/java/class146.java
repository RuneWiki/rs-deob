...
public class class146 extends class42 {
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Lig;)V", line = 7)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lee;)V", line = 114)
    public final void method286(class404 arg0) {
        this.field582.method888(arg0);
    }

    @OriginalMember(owner = "client!rn", name = "c", descriptor = "()V", line = 118)
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "()V", line = 181)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Z)V", line = 203)
    public final void method288(boolean arg0) {
        this.field582.method926(8448, 7681);
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "()Z", line = 222)
    public final boolean method287() {
        return true;
    }

    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(Z)V", line = 225)
