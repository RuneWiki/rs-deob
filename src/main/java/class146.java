...
public class class146 extends class695 implements class761 {
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lwh;ILjaclib/memory/Buffer;)V")
    public class146(class148 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field1942 = arg1;
    }

    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Lwh;I[BI)V")
    ...
    @OriginalMember(owner = "client!ct", name = "b", descriptor = "(B)Ltl;")
