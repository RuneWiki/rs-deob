...
public class class146 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(III)Lel;", line = 71)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIILda;)V", line = 88)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 126)
