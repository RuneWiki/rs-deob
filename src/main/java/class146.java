...
public class class146 extends class648 {
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)Lke;")
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "()Lrn;")
    public final class648 method662() {
        field1758++;
        return null;
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZILgaa;)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IBD)Lke;")
    ...
    @OriginalMember(owner = "client!cf", name = "d", descriptor = "()Lrn;")
    public final class648 method673() {
        field1763++;
        return null;
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lke;I)V")
