...
public class class146 extends class354 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(III)Lqca;")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lwo;)V")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(ILwo;)V")
