...
public class class146 extends class121 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIZILse;[I)Lfj;", line = 4)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lse;IIIIIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lse;IIIZ[I)V", line = 34)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I[BZIILse;II)Lfj;", line = 56)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lse;IIIIIZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lse;IIIIZ[BI)V", line = 94)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lse;IIIII[BI)V", line = 120)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Lse;IIII[I)V", line = 134)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IILse;IBI)Lfj;", line = 148)
