...
public class class146 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Ljava/lang/String;B)J", line = 45)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(II)Lrm;", line = 91)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(Lim;ILgj;)V", line = 108)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IB)[I", line = 248)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Ljava/awt/Canvas;I)V", line = 306)
