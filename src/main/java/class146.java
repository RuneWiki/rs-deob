...
public class class146 extends class22 implements class225 {
    ...
    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Llj;Lnea;IIZ[BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ZZI)V", line = 62)
    ...
    @OriginalMember(owner = "client!cw", name = "c", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 113)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(IZLnea;I[BIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(ILrha;)V", line = 166)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(B)I", line = 177)
    public final int method334(byte arg0) {
        int var2 = -31 % ((arg0 - 30) / 37);
        return this.field2356;
    }

    @OriginalMember(owner = "client!cw", name = "<init>", descriptor = "(Llj;IIZ[III)V", line = 184)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(B)Z", line = 240)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(III[IIII)V", line = 260)
    ...
    @OriginalMember(owner = "client!cw", name = "a", descriptor = "(II[IIIIII)V", line = 300)
    ...
    @OriginalMember(owner = "client!cw", name = "b", descriptor = "(I)I", line = 341)
