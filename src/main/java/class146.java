...
public class class146 extends class497 {
    ...
    @OriginalMember(owner = "client!tw", name = "d", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!tw", name = "c", descriptor = "(I)I", line = 32)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(ILpp;)V", line = 44)
    public class146(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lpp;)V", line = 58)
    public class146(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(JII)Ldka;", line = 62)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BI)I", line = 91)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)Z", line = 112)
