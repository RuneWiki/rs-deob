...
public class class146 extends class66 {
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lpm;Lie;[Lus;[I[I)V", line = 9)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([B[I[IIIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V", line = 92)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(CIIIZLaa;II)V", line = 178)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V", line = 245)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "([B[IIIIIIII)V", line = 333)
    ...
    @OriginalMember(owner = "client!vr", name = "fa", descriptor = "(CIIIZ)V", line = 388)
