...
public class class146 extends class390 {
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 34)
    public class146(String arg0) {
        this.field2079 = arg0;
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "()V", line = 9)
    public static final void method995() {
        class125.method856(1, class392.field5617);
    }

    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IBII)V", line = 13)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IC)C", line = 44)
