...
public class class146 {
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lofa;Lvj;I)Ljo;", line = 6)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLofa;)V", line = 60)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(Lofa;Z)Lor;", line = 86)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IIIIBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)V", line = 134)
