...
public class class146 extends class179 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILgd;Lwo;)Z", line = 7)
    ...
    @OriginalMember(owner = "client!oa", name = "c", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZIILwo;ILgd;)[F", line = 222)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lwo;Lwo;Z)V", line = 330)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IILnd;ZILuo;)V", line = 349)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(DIIZILwo;Lgd;Z)[I", line = 417)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(DILgd;Lwo;IIZ)[I", line = 557)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(II)V", line = 696)
    ...
    @OriginalMember(owner = "client!oa", name = "d", descriptor = "(Z)V", line = 728)
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "()V", line = 743)
    public class146() {
    ...
    @OriginalMember(owner = "client!oa", name = "<init>", descriptor = "(Lbg;)V", line = 758)
