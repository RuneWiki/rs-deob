...
public class class146 implements class18 {
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Law;III)V", line = 21)
    public final void method901(class55 arg0, int arg1, int arg2, int arg3) {
        field1927++;
        this.method908(arg1 + 103, arg1, arg2, arg0, arg3);
    }

    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IJ)V", line = 29)
    ...
    @OriginalMember(owner = "client!gb", name = "d", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lhm;I)Lhm;", line = 135)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI)I", line = 178)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(BI)V", line = 188)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 204)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lgu;IB)V", line = 217)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIILaw;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(II)V", line = 269)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILgu;I)V", line = 284)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(B)V", line = 332)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 345)
    ...
    @OriginalMember(owner = "client!gb", name = "e", descriptor = "(I)I", line = 360)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lih;)V", line = 479)
    ...
    @OriginalMember(owner = "client!gb", name = "d", descriptor = "(B)I", line = 389)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IILlc;)V", line = 414)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 452)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(II)V", line = 493)
    ...
    @OriginalMember(owner = "client!gb", name = "finalize", descriptor = "()V", line = 509)
    ...
    @OriginalMember(owner = "client!gb", name = "e", descriptor = "(B)Z", line = 526)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 547)
