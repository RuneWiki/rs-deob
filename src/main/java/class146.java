...
public class class146 implements class37 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILda;IILjava/lang/String;I)I")
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IZLhw;)Z")
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(I)[Lal;")
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lcp;Luw;)V")
