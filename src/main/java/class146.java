...
public class class146 extends class398 {
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "()V", line = 3)
    public class146() {
        super(1, false);
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II)[I", line = 9)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(CB)Z", line = 42)
    ...
    @OriginalMember(owner = "client!qe", name = "c", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lnj;II)V", line = 76)
    ...
    @OriginalMember(owner = "client!qe", name = "f", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(II)[[I", line = 141)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIIIII)V", line = 188)
