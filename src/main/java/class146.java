...
public class class146 extends class555 {
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Lqq;)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Lot;BI)V")
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(Ljava/awt/Canvas;IILfa;)Lr;")
