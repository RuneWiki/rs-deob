...
public class class146 extends class452 implements class526 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!gb", name = "j", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!gb", name = "finalize", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(III)V", line = 71)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lkd;III)V", line = 114)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lkd;IIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!gb", name = "k", descriptor = "(I)V", line = 87)
