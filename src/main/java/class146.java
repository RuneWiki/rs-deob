...
public class class146 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIILda;Lha;IZLuba;Lha;IZ)Lhu;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIILha;ILuba;II)Lhu;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BI)Lrba;")
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lnb;IZLqia;Loh;Loh;)V")
