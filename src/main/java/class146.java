...
public abstract class class146 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Z[BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!vm", name = "finalize", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lbv;I[BIZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lbv;ILjaggl/memory/NativeBuffer;IZ)V", line = 76)
    ...
    @OriginalMember(owner = "client!vm", name = "d", descriptor = "(I)V", line = 99)
