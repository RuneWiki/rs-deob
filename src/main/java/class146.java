...
public class class146 extends class270 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lnc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "([III)V", line = 20)
    ...
    @OriginalMember(owner = "client!gw", name = "d", descriptor = "()I", line = 65)
    public final int method800() {
        return 0;
    }

    @OriginalMember(owner = "client!gw", name = "b", descriptor = "()Lvv;", line = 68)
    public final class270 method801() {
        return (class270) this.field1753.method1047(-7962);
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lwda;Lnc;)V", line = 73)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lvv;)V", line = 81)
    public final synchronized void method803(class270 arg0) {
        arg0.method3187(true);
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "()Lvv;", line = 145)
    public final class270 method806() {
        return (class270) this.field1753.method1050((byte) 73);
    }

    @OriginalMember(owner = "client!gw", name = "e", descriptor = "()I", line = 149)
    public final synchronized int method807() {
        return this.field1753.method1055(0);
    }

    @OriginalMember(owner = "client!gw", name = "c", descriptor = "([III)V", line = 157)
    ...
    @OriginalMember(owner = "client!gw", name = "f", descriptor = "()V", line = 166)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(Lvv;)V", line = 185)
