...
public class class146 extends class465 {
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "(Lno;Lhm;)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(ILnea;)I")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(Lfa;IIILgba;ZLxa;I)V")
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IILhf;)V")
