...
public class class146 extends class424 implements class128 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "([Ljava/awt/Rectangle;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "()V", line = 52)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "()V", line = 62)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Lda;Ljava/awt/Canvas;)V", line = 71)
    ...
    @OriginalMember(owner = "client!v", name = "finalize", descriptor = "()V", line = 79)
