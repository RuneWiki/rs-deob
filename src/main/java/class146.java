...
public class class146 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Les;IIBIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(III)Z", line = 50)
