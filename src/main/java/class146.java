...
public class class146 {
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(II)La;")
    ...
    @OriginalMember(owner = "client!bfa", name = "a", descriptor = "(BLpi;Ljava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!bfa", name = "<init>", descriptor = "(Lqh;ILtf;)V")
