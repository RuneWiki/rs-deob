...
public class class146 extends class35 {
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(IIIIIIIIZ)Z", line = 10)
    ...
    @OriginalMember(owner = "client!se", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 49)
