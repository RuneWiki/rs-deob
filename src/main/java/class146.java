...
public class class146 extends class281 {
    ...
    @OriginalMember(owner = "client!qm", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lfc;III)V")
    ...
    @OriginalMember(owner = "client!qm", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qm", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lr;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lwga;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lab;[I)V")
