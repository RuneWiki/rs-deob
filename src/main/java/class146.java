...
public class class146 {
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "()Ltk;")
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lvo;II)Lub;")
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lek;)V")
