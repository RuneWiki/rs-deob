...
public class class146 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)V", line = 41)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!hm", name = "b", descriptor = "(II)Lct;", line = 76)
    ...
    @OriginalMember(owner = "client!hm", name = "<init>", descriptor = "(Llf;ILvh;Lvh;)V", line = 111)
