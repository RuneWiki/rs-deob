...
public class class146 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(Ljava/lang/String;Lnj;I)I", line = 3)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)I", line = 34)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(BI)I", line = 90)
