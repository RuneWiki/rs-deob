...
public class class146 extends class147 {
    ...
    @OriginalMember(owner = "client!sr", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(Lgn;ZI)V", line = 17)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIZIFIII)[I", line = 327)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIB)Ldf;", line = 350)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "([IILpq;[B)Z", line = 383)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "()V", line = 441)
    public class146() {
    }

    @OriginalMember(owner = "client!sr", name = "c", descriptor = "(I)V", line = 444)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "([B)V", line = 461)
