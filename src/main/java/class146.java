...
public class class146 extends class115 {
    ...
    @OriginalMember(owner = "client!rn", name = "b", descriptor = "(II)[I", line = 6)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(IIII)Lq;", line = 45)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(III)I", line = 114)
    ...
    @OriginalMember(owner = "client!rn", name = "a", descriptor = "(Lbk;Z)Lop;", line = 128)
    ...
    @OriginalMember(owner = "client!rn", name = "<init>", descriptor = "()V", line = 140)
    public class146() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rn", name = "h", descriptor = "(I)V", line = 143)
