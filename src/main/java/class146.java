...
public class class146 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILsa;)V", line = 6)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)Lsa;", line = 28)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)Lcm;", line = 50)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(Z)V", line = 69)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(I)Lsa;", line = 91)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!vr", name = "c", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIBIILha;II)V", line = 148)
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "()V", line = 188)
    public class146() {
