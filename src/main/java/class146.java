...
public abstract class class146 {
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "Llf;")
    public static class109 field2817 = class35.method275("l", 2);

    @OriginalMember(owner = "client!pg", name = "e", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "[Lkf;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IZIBILbi;)V")
