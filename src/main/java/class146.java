...
public class class146 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lya;ZZ)Ll;")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLsi;)V")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lsi;II)V")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Lya;B)Ll;")
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLvk;)Z")
