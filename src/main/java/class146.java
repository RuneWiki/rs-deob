...
public class class146 extends class452 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(Lfp;BIII)V")
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I[[BLnq;)V")
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(Z)V")
