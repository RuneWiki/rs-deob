...
public class class146 extends class381 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lrk;)Z")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Lrk;II)Lla;")
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([I)Lkf;")
