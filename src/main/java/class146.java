...
public class class146 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "([III)Lmg;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I[II)Lmg;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "([IIII)Lmg;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(III[I)Lmg;")
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lqs;Lqs;)V")
