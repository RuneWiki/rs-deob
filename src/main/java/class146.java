...
public abstract class class146 implements class697 {
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Llaa;IZ)V", line = 308)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)I", line = 17)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILjaggl/MapBuffer;)Z", line = 31)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(B)J", line = 64)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Ljaggl/MapBuffer;BZ)Ljaclib/memory/Buffer;", line = 76)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(IZ)I", line = 122)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!qm", name = "finalize", descriptor = "()V", line = 189)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(B)V", line = 198)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IB)V", line = 212)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 243)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILjaclib/memory/Source;B)Z", line = 263)
