...
public class class146 extends class145 {
    ...
    @OriginalMember(owner = "client!wq", name = "c", descriptor = "(IIB)I", line = 5)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "()V", line = 19)
    public class146() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wq", name = "i", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZI)[I", line = 37)
