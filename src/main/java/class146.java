...
public class class146 {
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IIILlv;)V", line = 12)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IB)Loa;", line = 20)
    ...
    @OriginalMember(owner = "client!jf", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 136)
    public class146(class341 arg0, int arg1, class459 arg2) {
        this.field2447 = arg2;
        this.field2447.method2763(31, -3);
    }

    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(III)V", line = 58)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!jf", name = "b", descriptor = "(I)V", line = 125)
    ...
    @OriginalMember(owner = "client!jf", name = "a", descriptor = "(IZ)V", line = 159)
