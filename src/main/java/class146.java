...
public class class146 extends OutputStream {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!hm", name = "write", descriptor = "(I)V", line = 38)
