...
public class class146 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(ILcu;)V", line = 6)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(III)I", line = 28)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(BLcu;I)V", line = 97)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 166)
