...
public class class146 {
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(I)Laa;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(Laa;B)V")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(B)Laa;")
    ...
    @OriginalMember(owner = "client!ep", name = "b", descriptor = "(B)Laa;")
    ...
    @OriginalMember(owner = "client!ep", name = "f", descriptor = "(I)Laa;")
