...
public class class146 extends class299 {
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(IIIIII)Lbn;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lrr;Z)Lo;")
    ...
    @OriginalMember(owner = "client!qf", name = "SA", descriptor = "(Lc;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I)Ln;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Ljava/lang/Runnable;)Lmh;")
    ...
    @OriginalMember(owner = "client!qf", name = "u", descriptor = "()Lc;")
    public final class517 method538() {
        class112 var1 = this.method1038(Thread.currentThread());
        return var1.field1673;
    }

    @OriginalMember(owner = "client!qf", name = "w", descriptor = "()Lc;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "([IIIII)Lo;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lij;III)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Le;Lvm;Lc;Lwg;I)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "([Le;Lc;[Lwg;I)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(ILjava/awt/Canvas;Ll;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(ILl;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIIF)Lrd;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lfe;IIII)Le;")
    ...
    @OriginalMember(owner = "client!qf", name = "ra", descriptor = "(ILta;II)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(I[Lrd;)V")
    public final void method519(int arg0, class344[] arg1) {
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lbn;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II[[I[[IIII)Lya;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lap;[Lrr;Z)Lla;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II[I[I)Lta;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIIILta;II)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lvm;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIIZ)Lo;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Lbn;Lbn;FLbn;)Lbn;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Ln;)V")
