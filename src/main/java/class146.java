...
public class class146 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(Z)V", line = 49)
