...
public class class101 extends class350 implements class659 {
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lmc;Lps;Z)V")
    public class101(class120 arg0, class82 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field1373 = arg1;
    }

    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)Lps;")
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
