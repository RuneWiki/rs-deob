...
public class class101 extends class189 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(ILjava/lang/String;ZIZZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IIIIIIIILdp;ILfv;I)V")
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(Ljava/lang/String;B)Z")
    ...
    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(ILjw;IZ)V")
