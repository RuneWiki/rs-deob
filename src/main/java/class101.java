...
public class class101 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIIIIZ)V", line = 134)
