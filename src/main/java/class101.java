...
public class class101 extends class657 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BIIIFIZI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZIIZI[Lat;)V", line = 38)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 96)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IZ)V", line = 105)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILdu;I)V", line = 121)
    ...
    @OriginalMember(owner = "client!al", name = "e", descriptor = "(I)Z", line = 134)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ZB)V", line = 145)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Lwga;)V", line = 155)
