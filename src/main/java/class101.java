...
public class class101 extends class11 implements class130 {
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(Leh;Z)Lqg;")
    ...
    @OriginalMember(owner = "client!bm", name = "a", descriptor = "(ILoa;)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lno;III)V")
    ...
    @OriginalMember(owner = "client!bm", name = "<init>", descriptor = "(Lno;IIII)V")
