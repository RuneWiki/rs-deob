...
public class class101 extends class298 {
    ...
    @OriginalMember(owner = "client!tt", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 60)
