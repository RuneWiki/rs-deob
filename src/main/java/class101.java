...
public class class101 implements class121 {
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(I)Lqv;", line = 19)
    public final class406 method484(int arg0) {
        field1102++;
        return arg0 == 16236 ? class469.field6548 : null;
    }

    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(IIII)I", line = 30)
    ...
    @OriginalMember(owner = "client!lfa", name = "a", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!lfa", name = "<init>", descriptor = "(ILida;Lce;IIIIIIIZ)V", line = 59)
