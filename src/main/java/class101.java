...
public class class101 extends class496 {
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(IB)I", line = 5)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!uaa", name = "d", descriptor = "(I)I", line = 67)
    ...
    @OriginalMember(owner = "client!uaa", name = "c", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!uaa", name = "e", descriptor = "(I)I", line = 272)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(Z)V", line = 283)
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(ILwo;Lwo;Laga;Ln;I[BIZ)V", line = 811)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BII)Ldga;", line = 307)
    ...
    @OriginalMember(owner = "client!uaa", name = "f", descriptor = "(I)V", line = 581)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(BI)V", line = 598)
    ...
    @OriginalMember(owner = "client!uaa", name = "b", descriptor = "(B)Lar;", line = 632)
    ...
    @OriginalMember(owner = "client!uaa", name = "g", descriptor = "(I)V", line = 732)
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "(II)[B", line = 779)
