...
public abstract class class101 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(B)Z", line = 20)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 36)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(BIIIIIIIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(B)V", line = 65)
