...
public class class101 extends class84 implements class145 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(ILet;III[BIII)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Ltk;Let;II[FII)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Ltk;Let;II[BII)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Ltk;Let;Lwha;II)V")
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I[BILtk;)Lap;")
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(Ltk;II[III)V")
