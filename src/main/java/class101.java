...
public class class101 extends class52 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ILrq;Lrq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "()I", line = 151)
    public final int method354() {
        return 1;
    }

    @OriginalMember(owner = "client!vp", name = "e", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!vp", name = "e", descriptor = "()Z", line = 171)
    public final boolean method707() {
        return this.field777.field4705 && this.field777.field4664 && this.field777.field4708;
    }

    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)V", line = 174)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "()V", line = 247)
    ...
    @OriginalMember(owner = "client!vp", name = "c", descriptor = "()Z", line = 258)
    public final boolean method353() {
        return this.field1519 != null;
    }

    @OriginalMember(owner = "client!vp", name = "<init>", descriptor = "(Lhj;)V", line = 267)
    public class101(class338 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vp", name = "b", descriptor = "()Z", line = 270)
