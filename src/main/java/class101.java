...
public class class101 extends class55 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(II)V", line = 11)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!qfa", name = "c", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Ljava/lang/String;I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 212)
