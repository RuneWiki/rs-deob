...
public class class101 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljk;ILza;)V", line = 20)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIZI)Z", line = 45)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(III)I", line = 191)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ZI)V", line = 205)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(I)V", line = 218)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)Z", line = 229)
