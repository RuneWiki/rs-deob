...
public class class101 extends class555 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Lot;BI)V", line = 13)
    ...
    @OriginalMember(owner = "client!aaa", name = "<init>", descriptor = "(Lqq;)V", line = 31)
    public class101(class651 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZZ)V", line = 35)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!aaa", name = "b", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "()V", line = 84)
    ...
    @OriginalMember(owner = "client!aaa", name = "c", descriptor = "(B)V", line = 160)
