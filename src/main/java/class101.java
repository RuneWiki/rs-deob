...
public class class101 extends class425 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Z)Llf;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(II)Ldc;")
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(IIIIILb;Lvq;ILcn;Z)Lni;")
