...
public class class101 extends class467 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IZZII)V", line = 83)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(ILpaa;)Lpaa;", line = 97)
    ...
    @OriginalMember(owner = "client!ct", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 134)
