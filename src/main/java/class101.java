...
public class class101 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BIILvl;)J")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lmn;B)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lmn;BLjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BLdg;Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lmn;I)Ljava/lang/Object;")
