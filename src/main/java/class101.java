...
public class class101 extends class428 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILg;I)Lsr;", line = 36)
