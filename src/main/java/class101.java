...
public class class101 implements class775 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Lgv;BLgv;)V", line = 4)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIBII)V", line = 22)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Z)I", line = 127)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(JB)Z", line = 154)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!tt", name = "c", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I)I", line = 240)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(B)V", line = 263)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(III)V", line = 276)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lrm;Lhea;)V", line = 289)
    ...
    @OriginalMember(owner = "client!tt", name = "d", descriptor = "(I)V", line = 307)
