...
public class class101 extends class311 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!fr", name = "d", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIILrd;)V", line = 105)
