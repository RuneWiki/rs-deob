...
public class class101 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ILha;IILtc;Lka;ZII)V")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ZZILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BLov;)V")
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Lha;Ljl;IIIILov;ZI)V")
