...
public class class101 extends class603 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lun;I)Lvaa;")
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Lr;II)V")
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Ljn;Ljn;Lpv;)V")
