...
public class class101 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBLsm;I)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(II)Lup;")
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lkr;IZLok;Lok;)V")
