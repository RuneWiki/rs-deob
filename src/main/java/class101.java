...
public class class101 extends class141 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(I)Z", line = 150)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZI)V", line = 180)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(III)V", line = 191)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)V", line = 208)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lei;II)V", line = 236)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(Lbt;)V", line = 328)
    ...
    @OriginalMember(owner = "client!pj", name = "d", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IZ)V", line = 440)
