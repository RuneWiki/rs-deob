...
public class class101 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(Ltn;Lqi;B)Lada;", line = 21)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ZCLjava/lang/String;)I", line = 75)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(III)V", line = 104)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ILtn;)V", line = 149)
