...
public abstract class class101 extends class396 {
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(BLjf;)V", line = 20)
    ...
    @OriginalMember(owner = "client!vp", name = "d", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(Lbo;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!vp", name = "f", descriptor = "(B)V", line = 379)
    ...
    @OriginalMember(owner = "client!vp", name = "a", descriptor = "(ZLra;Lra;I)V", line = 399)
