...
public class class101 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IZZILkm;IB)Lab;")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ZLkm;)V")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIILkm;IILab;Z)V")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lkm;Z)V")
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lkm;Lcj;IIIIIIZI)V")
