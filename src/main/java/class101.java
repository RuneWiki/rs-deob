...
public class class101 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)V", line = 32)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(IIIIII)V", line = 43)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(III)B", line = 151)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILnr;ZI[[I)V", line = 170)
