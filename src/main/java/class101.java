...
public class class101 extends class229 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Lea;IIILss;Lf;ZI)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIZILid;IIIIII)Z")
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(Lht;Lgo;)V")
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IILao;)V")
