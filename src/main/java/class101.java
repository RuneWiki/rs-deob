...
public class class101 extends class532 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZB)V", line = 5)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IBI)V", line = 37)
    ...
    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lnv;Lbt;Lrfa;)V", line = 72)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(III)Z", line = 115)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIIIIII)V", line = 128)
    ...
    @OriginalMember(owner = "client!tt", name = "d", descriptor = "(B)Z", line = 301)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZILgaa;)V", line = 313)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZI)V", line = 330)
