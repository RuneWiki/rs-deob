...
public class class101 extends class383 {
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "()V", line = 20)
    public class101() {
    }

    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "(I)V", line = 22)
    public class101(int arg0) {
        this.field1222 = arg0;
    }

    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(I)J", line = 30)
    public static final long method759(int arg0) {
        if (arg0 == 0) {
            field1221++;
            return class479.field7013.method542(108);
        } else {
            return -66L;
        }
    }
