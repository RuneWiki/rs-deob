...
public class class101 {
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lnp;Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLib;Lnp;)Lvb;", line = 69)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(II)V", line = 114)
