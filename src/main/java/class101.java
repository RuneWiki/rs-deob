...
public class class101 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)J", line = 3)
    public final long method679(byte arg0) throws IOException {
        return arg0 < 52 ? -113L : this.field1299.length();
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)Ljava/io/File;", line = 13)
    ...
    @OriginalMember(owner = "client!ri", name = "finalize", descriptor = "()V", line = 24)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IJ)V", line = 56)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II[BI)I", line = 66)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(III[B)V", line = 80)
