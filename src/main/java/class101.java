...
public class class101 extends class76 {
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(IIIIIIIIIIIZ)V", line = 249)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Le;BLza;)V", line = 14)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(ILza;)Lhp;", line = 38)
    ...
    @OriginalMember(owner = "client!gu", name = "f", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!gu", name = "finalize", descriptor = "()V", line = 91)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IZ)V", line = 107)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)V", line = 167)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IIIII)V", line = 185)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lza;III)Z", line = 225)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)I", line = 236)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lza;IIILps;IZ)V", line = 283)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILza;)V", line = 295)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(I)V", line = 318)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILza;I)Le;", line = 332)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(B)Z", line = 350)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)V", line = 370)
