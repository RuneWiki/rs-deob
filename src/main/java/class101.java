...
public class class101 extends class43 {
    ...
    @OriginalMember(owner = "client!db", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(IIII)I", line = 18)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(II)V", line = 51)
    ...
    @OriginalMember(owner = "client!db", name = "c", descriptor = "(B)V", line = 82)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(IIIIIZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lhh;", line = 107)
