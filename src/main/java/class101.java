...
public class class101 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "([Ljava/lang/Object;ILjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/applet/Applet;Ljava/lang/String;I)V", line = 13)
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;", line = 23)
