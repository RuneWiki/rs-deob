...
public class Wave {
    ...
    @OriginalMember(owner = "client!cc", name = "h", descriptor = "[Ldc;")
    ...
    @OriginalMember(owner = "client!cc", name = "g", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Llb;Z)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BII)Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Llb;Z)V")
