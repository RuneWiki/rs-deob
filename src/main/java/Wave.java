...
public class Wave {
    ...
    private SoundTone[] field922 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "f", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZI)Llb;")
    ...
    private final void method320(int arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            ...
            if (var5 != 0) {
                arg1.field713--;
                this.field922[var3] = new SoundTone();
