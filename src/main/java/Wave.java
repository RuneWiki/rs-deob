...
public class Wave {
    ...
    @OriginalMember(owner = "client!yb", name = "g", descriptor = "[Lzb;")
    private SoundTone[] field770 = new SoundTone[10];

    @OriginalMember(owner = "client!yb", name = "b", descriptor = "I")
    private static int field765 = 473;

    @OriginalMember(owner = "client!yb", name = "c", descriptor = "[Lyb;")
    ...
    @OriginalMember(owner = "client!yb", name = "f", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(BII)Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(ZLkb;)V")
    private final void method272(boolean arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var4 = arg1.method216();
            if (var4 != 0) {
                arg1.field622--;
                this.field770[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(ZI)Lkb;")
