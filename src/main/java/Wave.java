...
public class Wave {
    ...
    private SoundTone[] field905 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IBI)Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILlb;)V")
    private final void method320(int arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var4 = arg1.method229();
            if (var4 != 0) {
                arg1.field703--;
                this.field905[var3] = new SoundTone();
