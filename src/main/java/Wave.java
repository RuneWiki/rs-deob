...
public class Wave {
    ...
    @OriginalMember(owner = "client!yb", name = "i", descriptor = "[Lzb;")
    ...
    @OriginalMember(owner = "client!yb", name = "e", descriptor = "[Lyb;")
    ...
    @OriginalMember(owner = "client!yb", name = "h", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(BLkb;)V")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(IB)Lkb;")
