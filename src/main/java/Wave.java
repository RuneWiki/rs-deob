...
public class Wave {
    ...
    private SoundTone[] field768 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(ILkb;)V")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(ZII)Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(Lkb;Z)V")
    private final void method272(Packet arg0, boolean arg1) {
        ...
        for (int var3 = 0; var3 < 10; var3++) {
            ...
            if (var4 != 0) {
                arg0.field624--;
                this.field768[var3] = new SoundTone();
