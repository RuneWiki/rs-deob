...
public class Wave {
    ...
    @OriginalMember(owner = "client!yb", name = "h", descriptor = "[Lzb;")
    private SoundTone[] field771 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!yb", name = "d", descriptor = "[Lyb;")
    ...
    @OriginalMember(owner = "client!yb", name = "g", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(Lkb;I)V")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(III)Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "b", descriptor = "(Lkb;I)V")
    private final void method265(Packet arg0, int arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var5 = arg0.method209();
            if (var5 != 0) {
                arg0.field621--;
                this.field771[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(II)Lkb;")
