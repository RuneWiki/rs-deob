...
public class Wave {
    ...
    private SoundTone[] field911 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIB)Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "b", descriptor = "(Llb;I)V")
    private final void method320(Packet arg0, int arg1) {
        ...
        for (int var4 = 0; var4 < 10; var4++) {
            ...
            if (var5 != 0) {
                arg0.field711--;
                this.field911[var4] = new SoundTone();
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IB)Llb;")
