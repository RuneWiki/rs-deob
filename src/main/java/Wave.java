...
public class Wave {
    ...
    @OriginalMember(owner = "client!cc", name = "i", descriptor = "[Ldc;")
    private SoundTone[] field909 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "h", descriptor = "Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Llb;I)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)Llb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Llb;B)V")
    private final void method316(Packet arg0, byte arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var4 = arg0.method225();
            if (var4 != 0) {
                arg0.field708--;
                this.field909[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Llb;")
