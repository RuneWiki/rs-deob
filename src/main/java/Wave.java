...
public class Wave {
    ...
    private SoundTone[] field918 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZLlb;)V")
    private final void method320(boolean arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var4 = arg1.method229();
            if (var4 != 0) {
                arg1.field712--;
                this.field918[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IZ)Llb;")
