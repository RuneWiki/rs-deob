...
public class Wave {
    ...
    private SoundTone[] field877 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(III)Lmb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZLmb;)V")
    private final void method310(boolean arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var4 = arg1.method231();
            if (var4 != 0) {
                arg1.field694--;
                this.field877[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ZI)Lmb;")
