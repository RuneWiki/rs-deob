...
public class Wave {
    ...
    @OriginalMember(owner = "client!cc", name = "f", descriptor = "[Ldc;")
    private SoundTone[] field897 = new SoundTone[10];

    @OriginalMember(owner = "client!cc", name = "b", descriptor = "[Lcc;")
    ...
    @OriginalMember(owner = "client!cc", name = "e", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(IIB)Lmb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(ILmb;)V")
    private final void method324(int arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            int var5 = arg1.method239();
            if (var5 != 0) {
                arg1.field711--;
                this.field897[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(II)Lmb;")
