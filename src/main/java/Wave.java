...
public class Wave {
    ...
    @OriginalMember(owner = "client!yb", name = "l", descriptor = "[Lzb;")
    private SoundTone[] field778 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!yb", name = "h", descriptor = "[Lyb;")
    ...
    @OriginalMember(owner = "client!yb", name = "k", descriptor = "Lkb;")
    ...
    @OriginalMember(owner = "client!yb", name = "a", descriptor = "(IBI)Lkb;")
    ...
    private final void method265(byte arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            ...
            if (var5 != 0) {
                arg1.field623--;
                this.field778[var3] = new SoundTone();
