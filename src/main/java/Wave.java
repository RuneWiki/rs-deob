...
public class Wave {
    ...
    private SoundTone[] field931 = new SoundTone[10];
    ...
    @OriginalMember(owner = "client!cc", name = "h", descriptor = "Lmb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lmb;I)V")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BII)Lmb;")
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(Lmb;B)V")
    private final void method324(Packet arg0, byte arg1) {
        ...
        for (int var3 = 0; var3 < 10; var3++) {
            ...
            if (var4 != 0) {
                arg0.field736--;
                this.field931[var3] = new SoundTone();
    ...
    @OriginalMember(owner = "client!cc", name = "a", descriptor = "(BI)Lmb;")
