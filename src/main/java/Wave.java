...
public class Wave {
    ...
    private SoundTone[] field883 = new SoundTone[10];

    @OriginalMember(owner = "client!cc", name = "c", descriptor = "[Lcc;")
    ...
    @OriginalMember(owner = "client!cc", name = "f", descriptor = "Lmb;")
    ...
    private final void method314(int arg0, Packet arg1) {
        for (int var3 = 0; var3 < 10; var3++) {
            ...
            if (var4 != 0) {
                arg1.field698--;
                this.field883[var3] = new SoundTone();
