...
public class Wave {
    ...
    @OriginalMember(owner = "client!dc", name = "g", descriptor = "[Lec;")
    private SoundTone[] field918 = new SoundTone[10];

    @OriginalMember(owner = "client!dc", name = "a", descriptor = "I")
    private static int field912 = 6771;

    @OriginalMember(owner = "client!dc", name = "c", descriptor = "[Ldc;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(III)Lmb;")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(BLmb;)V")
    ...
    @OriginalMember(owner = "client!dc", name = "a", descriptor = "(II)Lmb;")
