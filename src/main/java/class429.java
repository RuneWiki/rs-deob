...
public class class429 extends class375 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIII[BIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(II)V", line = 65)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lfu;IIIIZ[IZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lfu;IIIII)V", line = 117)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ZZ)V", line = 131)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lfu;IIIIZ[BIZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "()V", line = 191)
    public final void method88() {
        this.field5186.field557.glFramebufferTexture2DEXT(36160, this.field5976, this.field5180, 0, 0);
        this.field5976 = -1;
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIII[IIIZ)V", line = 196)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lfu;IIII)V", line = 242)
    ...
    @OriginalMember(owner = "client!uo", name = "<init>", descriptor = "(Lfu;IIIIZ[FI)V", line = 252)
