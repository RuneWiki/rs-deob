...
public class class429 extends class31 {
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(JB)V", line = 512)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(III)Z", line = 528)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIZII)V", line = 540)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lur;II)V", line = 605)
