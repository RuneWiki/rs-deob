...
public class class429 extends class36 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lqo;II)V", line = 25)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lqo;IIZ[[BI)V", line = 57)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lqo;IIZ[[I)V", line = 82)
    ...
    @OriginalMember(owner = "client!q", name = "f", descriptor = "(I)V", line = 121)
