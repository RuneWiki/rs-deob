...
public class class429 extends class325 {
    ...
    @OriginalMember(owner = "client!hja", name = "d", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!hja", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!hja", name = "a", descriptor = "(Ljp;IB)V")
