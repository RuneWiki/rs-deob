...
public class class429 extends class117 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIB)I", line = 9)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Llk;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IILlk;)V", line = 50)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BI)V", line = 104)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IBLjava/lang/String;)Ljava/lang/String;", line = 116)
