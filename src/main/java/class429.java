...
public class class429 extends class125 {
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(ZI)I", line = 5)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BI)V", line = 45)
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(Z)I", line = 56)
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(BB)V", line = 72)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(Lgp;)V", line = 113)
    public class429(class549 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(B)I", line = 117)
    ...
    @OriginalMember(owner = "client!aw", name = "<init>", descriptor = "(ILgp;)V", line = 128)
