...
public class class429 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Liv;Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Liv;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(II)I", line = 64)
    public static int method2613(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 72)
