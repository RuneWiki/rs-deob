...
public class class429 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lof;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lol;II)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lof;I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Leh;I)V")
