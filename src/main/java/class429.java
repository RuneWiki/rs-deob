...
public class class429 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(III)Lqv;", line = 4)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILga;[ILga;)V", line = 17)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIZ)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(I)V", line = 49)
