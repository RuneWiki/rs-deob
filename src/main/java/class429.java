...
public abstract class class429 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(ZILkja;)V")
    ...
    @OriginalMember(owner = "client!sba", name = "g", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Lmj;)V")
