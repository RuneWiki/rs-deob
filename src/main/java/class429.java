...
public class class429 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IC)Z", line = 41)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLeq;)V", line = 86)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLpm;)V", line = 96)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Z)Lpm;", line = 118)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "()V", line = 171)
    public class429() {
        this.field6371.field6211 = this.field6371;
        this.field6371.field6208 = this.field6371;
    }

    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)Lpm;", line = 148)
    ...
    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)V", line = 180)
