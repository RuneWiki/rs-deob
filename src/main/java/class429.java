...
public class class429 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "([[BBLrfa;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!ch", name = "b", descriptor = "(II)Lod;", line = 119)
