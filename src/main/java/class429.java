...
public class class429 extends class525 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BIZLl;ILci;)[F")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(BILl;Lci;DZI)[I")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IBZIDZLci;Ll;)[I")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ll;Lci;Z)Z")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lwn;)V")
