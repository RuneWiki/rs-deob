...
public class class429 extends class127 implements class161 {
    ...
    @OriginalMember(owner = "client!wn", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILjava/lang/String;)I", line = 16)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Laa;Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!wn", name = "d", descriptor = "(II)Ljava/lang/String;", line = 52)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Laa;I)Lcn;", line = 63)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IZIILaa;ILqh;)V", line = 100)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I)I", line = 114)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(Laa;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!wn", name = "d", descriptor = "(I)Z", line = 138)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(I)I", line = 149)
    public final int method124(int arg0) {
        ++field6172;
        return arg0 != -11197 ? -73 : this.field6175.field6324;
    }

    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(B)Z", line = 160)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Laa;IB)Lhc;", line = 170)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIIIIII)V", line = 185)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(Laa;Lsk;IIIIIIZI)V", line = 243)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIILaa;)Z", line = 252)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Laa;B)V", line = 272)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIBIIIII)V", line = 301)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B)I", line = 329)
    ...
    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(B)V", line = 342)
