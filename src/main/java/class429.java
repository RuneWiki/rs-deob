...
public class class429 extends class56 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ID)V", line = 6)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "()V", line = 19)
    public class429() {
        super(1, false);
    }

    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(BILes;)V", line = 24)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ZI)V", line = 67)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(II)[I", line = 114)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIIIIIIII)V", line = 152)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(BI)[[I", line = 192)
