...
public class class429 extends class438 {
    ...
    @OriginalMember(owner = "client!iu", name = "e", descriptor = "(I)Z", line = 5)
    public final boolean method2368(int arg0) {
        return arg0 <= 120 ? true : true;
    }

    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "(Lrb;Ljava/lang/Object;I)V", line = 15)
    public class429(class284 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field6380 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 24)
