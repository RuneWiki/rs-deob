...
public class class429 extends class179 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BILtq;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 33)
    public class429(String arg0) {
        this.field6295 = arg0;
    }

    @OriginalMember(owner = "client!mh", name = "d", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!mh", name = "e", descriptor = "(I)V", line = 59)
