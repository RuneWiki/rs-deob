...
public class class429 extends class5 {
    ...
    @OriginalMember(owner = "client!sv", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(ILes;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(BI)Lce;", line = 83)
    ...
    @OriginalMember(owner = "client!sv", name = "a", descriptor = "(II)[I", line = 109)
    ...
    @OriginalMember(owner = "client!sv", name = "<init>", descriptor = "()V", line = 254)
    public class429() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sv", name = "i", descriptor = "(I)V", line = 258)
