...
public class class429 implements Runnable {
    ...
    @OriginalMember(owner = "client!qg", name = "finalize", descriptor = "()V", line = 13)
    protected final void finalize() {
        this.method2579(31088);
        field6157++;
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BLjava/lang/String;)I", line = 47)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "([BBII)V", line = 83)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)I", line = 134)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 150)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!qg", name = "c", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ljava/net/Socket;Lwd;)V", line = 369)
    ...
    @OriginalMember(owner = "client!qg", name = "run", descriptor = "()V", line = 243)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BI[BI)V", line = 318)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(Z)I", line = 346)
