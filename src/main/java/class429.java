...
public class class429 implements class184 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IILjaclib/memory/Source;I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(I)Z", line = 36)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Z)I", line = 57)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 84)
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lik;Z)V", line = 107)
    public class429(class107 arg0, boolean arg1) {
        this.field6252 = arg0;
        this.field6251 = arg1;
    }

    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(III)Z", line = 117)
