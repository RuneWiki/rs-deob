...
public class class429 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([BII[BII)I", line = 25)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", line = 97)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 105)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIIIIBI)V", line = 243)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)V", line = 287)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(BLmo;Lmo;)V", line = 331)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(I[B[BIII)I", line = 344)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "([B)V", line = 502)
