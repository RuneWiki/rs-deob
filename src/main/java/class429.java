...
public class class429 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILfh;)V", line = 5)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILfh;)V", line = 26)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(I)[Lcu;", line = 79)
    ...
    @OriginalMember(owner = "client!qs", name = "b", descriptor = "(B)Lqv;", line = 91)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lfh;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(BII)Z", line = 150)
