...
public class class429 {
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Leg;III)I")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;IIII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(I)Lob;")
    public static final class227 method2561(int arg0) {
        return (class227) field6182.method233(57, (long) arg0);
    }

    @OriginalMember(owner = "client!au", name = "b", descriptor = "(Loj;)Lvf;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;II)V")
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(Loj;IIII)Lvf;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Leg;II)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Lob;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;Lfg;IIII)V")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Loj;Lvt;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(II)Lpf;")
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(Lg;Lkh;Luo;Lhi;Lqp;Lbu;Leh;)V")
