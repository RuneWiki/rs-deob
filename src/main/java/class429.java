...
public class class429 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIILha;IIIII)V")
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Lha;II)Z")
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(I[Lrc;IIII)V")
