...
public abstract class class429 {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(BII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(III)Z", line = 33)
