...
public class class429 {
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "(I)V", line = 68)
    public class429(int arg0) {
        this.field5993 = arg0;
    }

    @OriginalMember(owner = "client!eka", name = "<init>", descriptor = "(IIIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(Leka;B)V", line = 28)
    ...
    @OriginalMember(owner = "client!eka", name = "a", descriptor = "(B)Leka;", line = 50)
