...
public class class429 extends class371 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIILvg;)V", line = 3)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIIBIII)Z", line = 16)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BII)Z", line = 43)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lj;III[Z)V", line = 58)
