...
public class class429 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lpq;)Z", line = 81)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "()Z", line = 109)
    private final boolean method2670() {
        return this.field6102.method225() == this.field6103;
    }

    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Lhd;)V", line = 361)
    ...
    @OriginalMember(owner = "client!wk", name = "d", descriptor = "()V", line = 172)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lpq;Z)V", line = 199)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(Lpq;)V", line = 207)
    public final void method2674(class343 arg0) {
        this.method2673(arg0, true);
    }

    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IIII)Z", line = 238)
