...
public class class429 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Len;I)I", line = 17)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IC)B", line = 106)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(III)V", line = 231)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "(I)V", line = 259)
