...
public class class429 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ZLjava/lang/String;BLjava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(ILjga;)V", line = 17)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)[Lmm;", line = 74)
