...
public class class429 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIIIIZII)V", line = 6)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 75)
