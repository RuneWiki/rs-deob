...
public class class429 extends class181 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "h", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Z)V", line = 48)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIIIBII)V", line = 110)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Loea;II)V", line = 557)
