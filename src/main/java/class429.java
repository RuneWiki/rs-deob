...
public class class429 extends class331 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ILdg;)V", line = 11)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)I", line = 31)
    public static int method2704(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(BLdg;I)V", line = 38)
