...
public class class429 extends class228 {
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILza;I)Z", line = 26)
    ...
    @OriginalMember(owner = "client!et", name = "g", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(Z)I", line = 231)
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(B)I", line = 251)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IILza;I)Z", line = 262)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIZIII)V", line = 298)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(Lza;B)Lkf;", line = 378)
    ...
    @OriginalMember(owner = "client!et", name = "c", descriptor = "(I)Z", line = 462)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(I)V", line = 477)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIIII)V", line = 505)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lwr;Z)V", line = 527)
    ...
    @OriginalMember(owner = "client!et", name = "g", descriptor = "(I)Z", line = 543)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Lza;I)V", line = 558)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(I[BIIII)Z", line = 580)
    ...
    @OriginalMember(owner = "client!et", name = "d", descriptor = "(B)I", line = 668)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 688)
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(IIB)V", line = 701)
    ...
    @OriginalMember(owner = "client!et", name = "e", descriptor = "(I)V", line = 795)
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "(B)Z", line = 809)
