...
public class class429 {
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(II)[B", line = 3)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!hn", name = "b", descriptor = "(I)V", line = 671)
    ...
    @OriginalMember(owner = "client!hn", name = "c", descriptor = "(I)V", line = 687)
    ...
    @OriginalMember(owner = "client!hn", name = "a", descriptor = "(ZII)V", line = 698)
