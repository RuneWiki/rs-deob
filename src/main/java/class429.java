...
public class class429 extends class498 {
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IIZII)V", line = 32)
