...
public class class429 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILp;)V", line = 34)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!bg", name = "b", descriptor = "(I)V", line = 82)
