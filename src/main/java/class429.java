...
public class class429 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILkf;)I", line = 7)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lkf;)V", line = 36)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(Lkf;)V", line = 541)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([BI[BII)I", line = 557)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "()V", line = 584)
    public static void method2670() {
        field6224 = null;
    }

    @OriginalMember(owner = "client!wn", name = "c", descriptor = "(Lkf;)V", line = 599)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([I[I[I[BIII)V", line = 760)
    ...
    @OriginalMember(owner = "client!wn", name = "d", descriptor = "(Lkf;)B", line = 829)
    private static final byte method2673(class137 arg0) {
        return (byte) method2666(1, arg0);
    }

    @OriginalMember(owner = "client!wn", name = "e", descriptor = "(Lkf;)B", line = 832)
