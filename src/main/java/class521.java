...
public abstract class class521 extends class4 {
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!pc", name = "b", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(ZII)Z", line = 60)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I[I[ILcea;[I)V", line = 72)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIIBI)V", line = 175)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IB)V", line = 193)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(I)V", line = 207)
    public class521(int arg0) {
        this.field7263 = arg0;
    }

    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(Lida;I)Ljava/lang/String;", line = 215)
