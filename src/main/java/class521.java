...
public class class521 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lci;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ldw;II)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lci;I)V")
