...
public class class521 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lio;B)V", line = 12)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ZLio;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIIZILtfa;ILi;Li;IIBLr;)Lda;", line = 177)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I[BIIIII)V", line = 299)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIILr;ILtfa;I)Lda;", line = 400)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Ltfa;Li;ILr;IIZIIILi;II)Lda;", line = 414)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BIILtfa;IILr;)Lda;", line = 445)
