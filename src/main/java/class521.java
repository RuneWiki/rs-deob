...
public class class521 {
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!k", name = "a", descriptor = "(II)Z", line = 31)
    ...
    @OriginalMember(owner = "client!k", name = "b", descriptor = "(II)V", line = 52)
