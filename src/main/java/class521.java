...
public class class521 extends class79 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lnj;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lda;Lnj;)V")
    ...
    @OriginalMember(owner = "client!qc", name = "b", descriptor = "()Lgm;")
