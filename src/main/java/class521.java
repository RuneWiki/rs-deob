...
public class class521 extends class180 implements class55 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IILco;ILqa;ZZ)V")
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(IIILgf;)V")
    public class521(int arg0, int arg1, int arg2, class180 arg3) {
        super(arg0, arg1, arg2, false, false);
        this.field7679 = arg3;
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IILqa;)Lc;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lqa;III)Z")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lqa;I)Lip;")
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(ILqa;)V")
