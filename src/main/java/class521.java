...
public class class521 {
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lsg;III)V", line = 124)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 982)
