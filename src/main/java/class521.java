...
public class class521 extends class770 implements class466 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILaka;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lha;Z)V")
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Lha;Lro;IIIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(Lha;I)Ltja;")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILha;II)Z")
