...
public class class521 extends class545 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ltba;Z)Lcw;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lza;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(I[Lkb;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "([IIIIIZ)Lcw;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIIIF)Lkb;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Ljava/lang/Runnable;)Lae;")
    ...
    @OriginalMember(owner = "client!ii", name = "p", descriptor = "()Luha;")
    public final class723 method2135() {
        return this.field7308;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lkda;IIII)Lka;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lsm;IIII)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lcd;Lcd;FLcd;)Lcd;")
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(II)Lhs;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(IIIIII)Lcd;")
    public final class22 method2134(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lev;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II[I[I)Laa;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lev;I)V")
    ...
    @OriginalMember(owner = "client!ii", name = "z", descriptor = "()Lgba;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Luha;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "A", descriptor = "(ILaa;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "j", descriptor = "(I)Lza;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lcha;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "n", descriptor = "()Luha;")
    public final class723 method2087() {
        class351 var1 = this.method3097(Thread.currentThread());
        return var1.field4469;
    }

    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II[[I[[IIII)Ls;")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Lcd;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(Loq;[Ltba;Z)Lda;")
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ld;II)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIIIILaa;IIIII)V")
    ...
    @OriginalMember(owner = "client!ii", name = "x", descriptor = "()Luha;")
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "(Ld;)V")
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIZ)Lcw;")
