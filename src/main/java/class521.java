...
public abstract class class521 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BI)I", line = 3)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)I", line = 78)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIB)V", line = 92)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BIZ)V", line = 139)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IB)Z", line = 185)
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(B)V", line = 222)
