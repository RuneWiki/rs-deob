...
public class class521 extends class438 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILji;I[BZIII)Lch;", line = 4)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!kga", name = "i", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(IB)[[I", line = 54)
