...
public class class521 extends class327 {
    ...
    @OriginalMember(owner = "client!tl", name = "c", descriptor = "(B)V", line = 9)
    public static void method2942(byte arg0) {
        int var1 = 7 % ((arg0 - 51) / 39);
        field7241 = null;
    }

    @OriginalMember(owner = "client!tl", name = "d", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIIIIII)V", line = 54)
