...
public class class521 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)Lvj;")
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B[BLsha;I)Lkfa;")
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Lkw;ILuq;)V")
