...
public class class521 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(ILnp;B)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Ltf;IIIZII)V")
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lnp;I)V")
