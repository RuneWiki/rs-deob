...
public class class521 extends class260 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IB)I", line = 5)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IC)B", line = 15)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(IB)V", line = 140)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(B)I", line = 154)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(ILfca;)V", line = 168)
    public class521(int arg0, class92 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Z)V", line = 171)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lfca;)V", line = 188)
    public class521(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(I)I", line = 191)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(IZIILkp;)Z", line = 203)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I[FI)[F", line = 330)
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "(Z)V", line = 349)
