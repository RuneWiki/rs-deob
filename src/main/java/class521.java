...
public class class521 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(II)V", line = 24)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(IIIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Z)V", line = 248)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(IIII)Z", line = 259)
