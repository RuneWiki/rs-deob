...
public class class521 extends class23 implements class47 {
    ...
    @OriginalMember(owner = "client!sa", name = "finalize", descriptor = "()V", line = 11)
    protected final void finalize() {
        class342.method2198(this, (byte) -50);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III[I)V", line = 21)
    public final void method174(int arg0, int arg1, int arg2, int[] arg3) {
        this.method3097(arg0, arg1, arg2, arg3);
    }

    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 27)
    public class521() {
        this.method3098();
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "()Lia;", line = 32)
