...
public class class521 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(II)Lhg;", line = 43)
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "([ILfca;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILha;)V", line = 187)
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 269)
