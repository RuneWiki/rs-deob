...
public class class521 extends class427 implements Runnable {
    ...
    @OriginalMember(owner = "client!au", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!au", name = "a", descriptor = "(II)Z", line = 17)
    ...
    @OriginalMember(owner = "client!au", name = "run", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!au", name = "<init>", descriptor = "(Lah;)V", line = 73)
    public class521(class263 arg0) {
        this.field7566 = arg0;
    }

    @OriginalMember(owner = "client!au", name = "b", descriptor = "(I)V", line = 53)
