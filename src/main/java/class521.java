...
public class class521 {
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IZI)I", line = 4)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILhd;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(BLfh;)V", line = 152)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(ILfh;I)V", line = 173)
    ...
    @OriginalMember(owner = "client!fl", name = "b", descriptor = "(B)V", line = 409)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 423)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(Z)V", line = 435)
    ...
    @OriginalMember(owner = "client!fl", name = "a", descriptor = "(IIZI)V", line = 462)
