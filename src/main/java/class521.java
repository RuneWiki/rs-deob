...
public class class521 extends class618 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Luea;", line = 5)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZZI)V", line = 23)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lsea;ILfa;)V", line = 42)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(II[I[I)V", line = 88)
