...
public class class521 extends class623 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(BC)I", line = 4)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(II)V", line = 29)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(ILig;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(Lig;I)V", line = 133)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(CI)I", line = 155)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(I)V", line = 181)
