...
public class class521 implements Runnable {
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Llaa;Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I[BIIIIB)Z", line = 30)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)Z", line = 81)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 94)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!va", name = "run", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I[I[ILpj;II)Lcca;", line = 249)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(Z)V", line = 306)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I[II[Ljava/lang/String;I)V", line = 317)
    ...
    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)I", line = 369)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Ljava/lang/String;JIILgp;)V", line = 398)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(I)Lgp;", line = 416)
    ...
    @OriginalMember(owner = "client!va", name = "d", descriptor = "(I)I", line = 427)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(Z)Ljava/lang/String;", line = 446)
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(B)J", line = 458)
