...
public class class521 extends class513 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IIZLjn;II)V")
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZLec;I)V")
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "(Lifa;Ljda;Lul;[I)V")
