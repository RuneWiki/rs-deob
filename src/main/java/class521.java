...
public class class521 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BIII)I", line = 19)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lwn;Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IILwn;)V", line = 126)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BILtf;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IZ)V", line = 261)
