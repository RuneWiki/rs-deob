...
public class class521 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Z)V", line = 13)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(Le;B)V", line = 66)
