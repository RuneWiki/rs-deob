...
public class class521 extends class504 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Loa;Lwi;IIIBIZILdv;)Lba;", line = 3)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I[I[IZI)J", line = 262)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)V", line = 306)
