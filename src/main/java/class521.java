...
public class class521 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(B)I", line = 8)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(I)Lpi;", line = 29)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 50)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(B)V", line = 66)
    ...
    @OriginalMember(owner = "client!ni", name = "b", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Ldr;I)V", line = 101)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(B)Lpi;", line = 309)
    ...
    @OriginalMember(owner = "client!ni", name = "c", descriptor = "(I)Lpi;", line = 330)
    ...
    @OriginalMember(owner = "client!ni", name = "d", descriptor = "(I)Lpi;", line = 350)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(CB)Z", line = 367)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Z)V", line = 413)
    ...
    @OriginalMember(owner = "client!ni", name = "e", descriptor = "(I)V", line = 533)
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(ILpi;)V", line = 550)
    ...
    @OriginalMember(owner = "client!ni", name = "<init>", descriptor = "()V", line = 585)
    public class521() {
