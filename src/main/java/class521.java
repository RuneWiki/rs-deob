...
public class class521 extends class37 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III[[ZZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Ler;IIII[[I[[II)V", line = 20)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(II)V", line = 80)
    public final void method489(int arg0, int arg1) {
        ++field7537;
    }

    @OriginalMember(owner = "client!tv", name = "DA", descriptor = "(Lha;IIIIZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 114)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILcda;II)V", line = 135)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 200)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IIIIIII[[Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III)V", line = 382)
    ...
    @OriginalMember(owner = "client!tv", name = "E", descriptor = "(Lha;IIIIZ)V", line = 393)
    ...
    @OriginalMember(owner = "client!tv", name = "O", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 411)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(III[[ZZ)V", line = 480)
    ...
    @OriginalMember(owner = "client!tv", name = "v", descriptor = "(IILha;)Lha;", line = 488)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lcp;[I)V", line = 517)
    ...
    @OriginalMember(owner = "client!tv", name = "BA", descriptor = "()V", line = 542)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZBI[[ZIII)V", line = 1123)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 1268)
