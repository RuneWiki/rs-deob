...
public class class521 extends class535 implements class68 {
    ...
    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(BIILqa;)Z", line = 25)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILqa;)Lou;", line = 46)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(I)I", line = 88)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lqa;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)Z", line = 113)
    ...
    @OriginalMember(owner = "client!cm", name = "g", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILqa;I)Lka;", line = 142)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILa;IIILqa;Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)I", line = 164)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIIIIIIII)V", line = 176)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ZLqa;)V", line = 211)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(IZ)Lko;", line = 222)
    ...
    @OriginalMember(owner = "client!cm", name = "e", descriptor = "(I)V", line = 545)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Z)Z", line = 556)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(Lqa;Lcd;IIIIIZIII)V", line = 567)
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(I)V", line = 576)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(ZLqa;)V", line = 587)
