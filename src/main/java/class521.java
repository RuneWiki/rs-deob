...
public class class521 extends class232 implements class21 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lza;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!cm", name = "<init>", descriptor = "(IIIIILdj;)V", line = 15)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(Lza;B)Lkf;", line = 25)
    public final class170 method126(class290 arg0, byte arg1) {
        field7666++;
        return arg1 > -86 ? null : null;
    }

    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(I)Z", line = 37)
    ...
    @OriginalMember(owner = "client!cm", name = "e", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILza;)V", line = 71)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ZBLjava/lang/String;Z)V", line = 82)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(I)I", line = 881)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILza;I)Le;", line = 893)
    public final class377 method116(int arg0, class290 arg1, int arg2) {
        field7671++;
        return arg0 == 13439 ? null : null;
    }

    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(I)V", line = 907)
    ...
    @OriginalMember(owner = "client!cm", name = "b", descriptor = "(B)Z", line = 922)
    ...
    @OriginalMember(owner = "client!cm", name = "f", descriptor = "(I)V", line = 934)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(ILza;ILge;IZI)V", line = 945)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(B)I", line = 956)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(Lza;B)V", line = 967)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IILza;I)Z", line = 977)
    ...
    @OriginalMember(owner = "client!cm", name = "d", descriptor = "(Z)V", line = 992)
