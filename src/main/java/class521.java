...
public class class521 extends class478 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(ZIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hha", name = "<init>", descriptor = "(Log;Lega;IIIIIIIIIIIIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(B)Lio;", line = 39)
    ...
    @OriginalMember(owner = "client!hha", name = "d", descriptor = "(B)V", line = 56)
