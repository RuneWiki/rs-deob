...
public class class521 extends class477 {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IIII)[B", line = 4)
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "()V", line = 18)
    public class521() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(IIB)V", line = 60)
