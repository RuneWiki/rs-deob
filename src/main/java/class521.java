...
public abstract class class521 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Ljk;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(III)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IJ)V", line = 42)
