...
public class class521 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(JJ)J", line = 24)
    public static long method3026(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IB)Lhv;", line = 37)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(IB)V", line = 47)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)Lkt;", line = 60)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(II)V", line = 78)
