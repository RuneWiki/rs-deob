...
public class class521 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lfl;BBII)V", line = 24)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Z[[F[[S)[[S", line = 65)
