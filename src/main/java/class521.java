...
public class class521 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(IIIIB)V", line = 284)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "([Ljava/lang/Object;[JB)V", line = 299)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(ILcw;I)V", line = 332)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lya;IIIIII)V", line = 540)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "()V", line = 553)
    protected class521() {
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lya;Liv;I)V", line = 564)
