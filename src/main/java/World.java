...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;Lob;[B[Lec;BII)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIBILob;Lr;ILec;)V")
                    ...
                    for (int var67 = -5; var67 < this.field40 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field40 - 1 && (!field36 || (this.field42[var5][var58][var67] & 0x10) == 0 && this.method19(0, var67, var5, var58) == field37)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var82 = 0;
                                if (var80 != -1) {
                                    var82 = Draw3D.field573[method25(var80, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var88;
                                    if (var86 >= 0) {
                                        var87 = Draw3D.method159(var86, true);
                                        var88 = -1;
                                        ...
                                        var87 = Draw3D.field573[this.method26(var88, 96)];
                                    }
    ...
    private static final int method22(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field562[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lec;Lob;IILr;[[[IIIIZII)V")
