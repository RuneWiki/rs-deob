...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([BBLr;[Lbc;IILob;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIILbc;IILob;Lr;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;Z[Lbc;)V")
                    ...
                    for (int var69 = -5; var69 < this.field39 + 5; var69++) {
                        ...
                        if (var69 >= 1 && var69 < this.field39 - 1) {
                            ...
                            if (var73 > 0 || var74 > 0) {
                                ...
                                int var85 = 0;
                                if (var83 != -1) {
                                    var85 = Draw3D.field556[method24(var83, 96)];
                                }
                                if (var74 == 0) {
                                    ...
                                    int var91;
                                    if (var89 >= 0) {
                                        var90 = Draw3D.method155((byte) -29, var89);
                                        var91 = -1;
                                        ...
                                        var90 = Draw3D.field556[this.method25(var91, 96)];
                                    }
    ...
    private static final int method21(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field545[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILr;IIIILbc;Lob;[[[IIBI)V")
