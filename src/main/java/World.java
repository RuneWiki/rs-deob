...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lub;Llb;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[BLr;B[Ljc;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IILr;IIIILjc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B[Ljc;Lr;)V")
                    ...
                    for (int var67 = -5; var67 < this.field44 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field44 - 1 && (!field41 || (this.field46[var5][var58][var67] & 0x10) == 0 && this.method21(var67, var58, 0, var5) == field42)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field656[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method169(0, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field656[this.method28(var91.field1122, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field645[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIII[[[IIILjc;Lr;II)V")
