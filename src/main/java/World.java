...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Llb;Lub;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZLr;I[B[Ljc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIILr;Ljc;III)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Z[Ljc;Lr;)V")
                    ...
                    for (int var67 = -5; var67 < this.field46 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field46 - 1 && (!field43 || (this.field48[var5][var58][var67] & 0x10) == 0 && this.method21((byte) 115, var58, var5, var67) == field44)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field675[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method170(var92, -592);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field675[this.method28(var91.field1122, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field664[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIILjc;II[[[ILr;II)V")
