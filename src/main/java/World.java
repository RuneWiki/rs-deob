...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Llb;Lub;B)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[Ljc;Lr;I[BZ)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIILr;Ljc;II)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Ljc;Lr;Z)V")
                        ...
                        if (var67 >= 1 && var67 < this.field46 - 1 && (!field43 || (this.field48[var5][var58][var67] & 0x10) == 0 && this.method21(var5, var58, 318, var67) == field44)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method170((byte) 5, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field655[this.method28(var91.field1125, 96)];
                                    }
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(III[[[ILjc;IILr;III)V")
