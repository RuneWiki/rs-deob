...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lub;ILlb;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Ljc;[BBILr;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIIILjc;Lr;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;[Ljc;I)V")
                        ...
                        if (var67 >= 1 && var67 < this.field44 - 1 && (!field41 || (this.field46[var5][var58][var67] & 0x10) == 0 && this.method21(856, var67, var58, var5) == field42)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method170(574, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field655[this.method28(var91.field1117, 96)];
                                    }
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IZILr;ILjc;I[[[IIII)V")
