...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lub;ZLlb;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(B[BI[Ljc;Lr;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IILr;IIIZLjc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;I[Ljc;)V")
                    ...
                    for (int var68 = -5; var68 < this.field47 + 5; var68++) {
                        ...
                        if (var68 >= 1 && var68 < this.field47 - 1 && (!field44 || (this.field49[var6][var59][var68] & 0x10) == 0 && this.method21((byte) 8, var59, var6, var68) == field45)) {
                            ...
                            if (var71 > 0 || var72 > 0) {
                                ...
                                int var89 = 0;
                                if (var81 != -1) {
                                    var89 = Draw3D.field655[method27(var82, 96)];
                                }
                                if (var72 == 0) {
                                    ...
                                    int var95;
                                    if (var93 >= 0) {
                                        var94 = Draw3D.method170(-84, var93);
                                        var95 = -1;
                                        ...
                                        var94 = Draw3D.field655[this.method28(var92.field1111, 96)];
                                    }
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ljc;IIII[[[IBIIILr;)V")
