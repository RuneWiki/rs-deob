...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvb;Lmb;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ls;III[B[Ljc;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIILs;IILjc;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ls;[Ljc;B)V")
                    ...
                    for (int var67 = -5; var67 < this.field46 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field46 - 1 && (!field43 || (this.field48[var5][var58][var67] & 0x10) == 0 && this.method21(var5, var67, var58, false) == field44)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field662[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method183(929, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field662[this.method28(var91.field1095, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field651[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIILjc;IIILs;II[[[I)V")
