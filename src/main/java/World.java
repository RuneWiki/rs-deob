...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lvb;ILmb;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Ljc;Ls;[BIII)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ljc;IIIIIIILs;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BLs;[Ljc;)V")
                    ...
                    for (int var67 = -5; var67 < this.field55 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field55 - 1 && (!field52 || (this.field57[var5][var58][var67] & 0x10) == 0 && this.method21(var5, 0, var58, var67) == field53)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field678[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method183(12151, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field678[this.method28(var91.field1124, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field667[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ljc;Ls;IZIII[[[IIII)V")
