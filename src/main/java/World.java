...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[BLob;[Lec;IILr;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILr;ILob;IIILec;IB)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;B[Lec;)V")
                    ...
                    for (int var68 = -5; var68 < this.field45 + 5; var68++) {
                        ...
                        if (var68 >= 1 && var68 < this.field45 - 1 && (!field41 || (this.field47[var6][var59][var68] & 0x10) == 0 && this.method19(-80, var6, var68, var59) == field42)) {
                            ...
                            if (var71 > 0 || var72 > 0) {
                                ...
                                int var83 = 0;
                                if (var81 != -1) {
                                    var83 = Draw3D.field571[method25(var81, 96)];
                                }
                                if (var72 == 0) {
                                    ...
                                    int var89;
                                    if (var87 >= 0) {
                                        var88 = Draw3D.method159((byte) -127, var87);
                                        var89 = -1;
                                        ...
                                        var88 = Draw3D.field571[this.method26(var89, 96)];
                                    }
    ...
    private static final int method22(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field560[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lec;II[[[IBILob;IILr;II)V")
