...
public class World {
                    ...
                    for (int var67 = -5; var67 < this.maxTileZ + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.maxTileZ - 1 && (!lowMemory || (this.levelTileFlags[0][var58][var67] & 0x2) != 0 || (this.levelTileFlags[var5][var58][var67] & 0x10) == 0 && this.getDrawLevel(var67, var5, var58, 0) == levelBuilt)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.palette[mulHSL(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.getAverageTextureRGB(var92, 12660);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.palette[this.adjustLightness(var91.hsl, 96)];
                                    }
    ...
    private static final int perlin(int arg0, int arg1) {
        int var2 = perlin(arg0 + 45365, arg1 + 91923, 4) + (perlin(arg0 + 10294, arg1 + 37821, 2) - 128 >> 1) + (perlin(arg0, arg1, 1) - 128 >> 2) - 128;
    ...
    private final void readLandInner(int arg0, int arg1, Packet arg2, int arg3, int arg4, int arg5, int arg6, int arg7) {
        ...
        while (true) {
            ...
            if (var10 == 0) {
                if (arg4 == 0) {
                    this.levelHeightmap[0][arg3][arg0] = -perlin(arg3 + arg7 + 932731, arg0 + 556238 + arg1) * 8;
                    return;
                } else {
