...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lub;BLlb;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BLr;[BI[Ljc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ljc;IIIILr;III)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Ljc;BLr;)V")
                    ...
                    for (int var67 = -5; var67 < this.field47 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field47 - 1 && (!field44 || (this.field49[var5][var58][var67] & 0x10) == 0 && this.method21((byte) 111, var5, var58, var67) == field45)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field667[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method170(-333, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field667[this.method28(var91.field1129, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field656[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[[[ILjc;IILr;IIII)V")
