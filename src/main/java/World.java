...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([BLnb;[Lac;Lq;III)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lq;Lnb;IIIIIILac;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lac;Lq;I)V")
                    ...
                    for (int var70 = -5; var70 < this.field38 + 5; var70++) {
                        ...
                        if (var70 >= 1 && var70 < this.field38 - 1) {
                            ...
                            if (var74 > 0 || var75 > 0) {
                                ...
                                int var86 = 0;
                                if (var84 != -1) {
                                    var86 = Draw3D.field541[method24(var84, 96)];
                                }
                                if (var75 == 0) {
                                    ...
                                    int var92;
                                    if (var90 >= 0) {
                                        var91 = Draw3D.method141(var90, 47117);
                                        var92 = -1;
                                        ...
                                        var91 = Draw3D.field541[this.method25(var92, 96)];
                                    }
    ...
    private static final int method21(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field530[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILnb;IIILac;[[[IILq;III)V")
