...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILub;Llb;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;[BIII[Ljc;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILjc;Lr;ZIIIII)V")
                    ...
                    for (int var67 = -5; var67 < this.field48 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field48 - 1 && (!field45 || (this.field50[var5][var58][var67] & 0x10) == 0 && this.method21(var67, var58, 0, var5) == field46)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field660[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method170((byte) 7, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field660[this.method28(var91.field1120, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field649[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[[[IIZLjc;IILr;II)V")
