...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZLob;[B[Lec;Lr;II)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;IILec;IILob;III)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lec;ILr;)V")
                    ...
                    for (int var67 = -5; var67 < this.field40 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field40 - 1 && (!field36 || (this.field42[var5][var58][var67] & 0x10) == 0 && this.method19(var5, false, var58, var67) == field37)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field581[method25(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method160(var92, (byte) 5);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field581[this.method26(var91.field939, 96)];
                                    }
    ...
    private static final int method22(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field570[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIIILec;Lr;ILob;[[[I)V")
