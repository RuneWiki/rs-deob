...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lmb;Lvb;B)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILs;I[B[Ljc;B)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIIILjc;ILs;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ls;[Ljc;I)V")
                    ...
                    for (int var67 = -5; var67 < this.field47 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field47 - 1 && (!field44 || (this.field49[var5][var58][var67] & 0x10) == 0 && this.method21(11519, var58, var67, var5) == field45)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field657[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method183(0, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field657[this.method28(var91.field1088, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field646[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IILjc;IIILs;[[[IIII)V")
