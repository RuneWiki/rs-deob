...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(BLlb;Lub;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[BZLr;I[Ljc;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IILjc;IIILr;II)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Ljc;ZLr;)V")
                    ...
                    for (int var67 = -5; var67 < this.field45 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field45 - 1 && (!field42 || (this.field47[var5][var58][var67] & 0x10) == 0 && this.method21(var5, var67, 11451, var58) == field43)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field649[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method169(false, var92);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field649[this.method28(var91.field1109, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field638[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;IIZIIILjc;[[[III)V")
