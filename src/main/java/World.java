...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([BLr;[Lec;Lob;ZII)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lec;ZIIIILr;Lob;II)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;I[Lec;)V")
                    ...
                    for (int var68 = -5; var68 < this.field40 + 5; var68++) {
                        ...
                        if (var68 >= 1 && var68 < this.field40 - 1 && (!field36 || (this.field42[var5][var59][var68] & 0x10) == 0 && this.method19(var5, (byte) 10, var59, var68) == field37)) {
                            ...
                            if (var71 > 0 || var72 > 0) {
                                ...
                                int var89 = 0;
                                if (var81 != -1) {
                                    var89 = Draw3D.field570[method25(var82, 96)];
                                }
                                if (var72 == 0) {
                                    ...
                                    int var95;
                                    if (var93 >= 0) {
                                        var94 = Draw3D.method160(787, var93);
                                        var95 = -1;
                                        ...
                                        var94 = Draw3D.field570[this.method26(var92.field945, 96)];
                                    }
    ...
    private static final int method22(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field559[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ILob;Lec;II[[[IIIIILr;I)V")
