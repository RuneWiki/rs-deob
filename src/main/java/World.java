...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lmb;Lvb;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "([Lic;Ls;III[B)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIILic;IILs;II)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ls;I[Lic;)V")
                    ...
                    for (int var67 = -5; var67 < this.field40 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field40 - 1 && (!field36 || (this.field42[var5][var58][var67] & 0x10) == 0 && this.method21(var67, var5, var58, 0) == field37)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field644[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method175(var92, true);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field644[this.method28(var91.field1047, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field633[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lic;II[[[IIILs;BIII)V")
