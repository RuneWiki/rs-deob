...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(II[BLr;[Lkc;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lkc;IILr;BIIII)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(ZLr;[Lkc;)V")
                    ...
                    for (int var67 = -5; var67 < this.field47 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field47 - 1 && (!field44 || (this.field49[var5][var58][var67] & 0x10) == 0 && this.method21(var67, var5, var58, -40434) == field45)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var88 = 0;
                                if (var80 != -1) {
                                    var88 = Draw3D.field658[method27(var81, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var94;
                                    if (var92 >= 0) {
                                        var93 = Draw3D.method169(var92, 0);
                                        var94 = -1;
                                        ...
                                        var93 = Draw3D.field658[this.method28(var91.field1109, 96)];
                                    }
    ...
    private static final int method24(int arg0, int arg1, int arg2, int arg3) {
        int var4 = 65536 - Draw3D.field647[arg2 * 1024 / arg3] >> 1;
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIIB[[[ILr;IIILkc;)V")
