...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lmb;Lvb;Z)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(I[Lic;I[BILs;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIILs;IILic;II)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Ls;[Lic;Z)V")
                    ...
                    for (int var68 = -5; var68 < this.field44 + 5; var68++) {
                        ...
                        if (var68 >= 1 && var68 < this.field44 - 1 && (!field40 || (this.field46[var5][var59][var68] & 0x10) == 0 && this.method21(22171, var68, var59, var5) == field41)) {
                            ...
                            if (var71 > 0 || var72 > 0) {
                                ...
                                int var89 = 0;
                                if (var81 != -1) {
                                    var89 = Draw3D.field650[method27(var82, 96)];
                                }
                                if (var72 == 0) {
                                    ...
                                    int var95;
                                    if (var93 >= 0) {
                                        var94 = Draw3D.method175(41904, var93);
                                        var95 = -1;
                                        ...
                                        var94 = Draw3D.field650[this.method28(var92.field1058, 96)];
                                    }
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IIIII[[[IILic;ILs;I)V")
