...
public class World {
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IB[Lec;[BLob;Lr;I)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(IILob;IILr;IIILec;)V")
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;[Lec;Z)V")
                    ...
                    for (int var67 = -5; var67 < this.field39 + 5; var67++) {
                        ...
                        if (var67 >= 1 && var67 < this.field39 - 1 && (!field35 || (this.field41[var5][var58][var67] & 0x10) == 0 && this.method19(928, var5, var58, var67) == field36)) {
                            ...
                            if (var70 > 0 || var71 > 0) {
                                ...
                                int var82 = 0;
                                if (var80 != -1) {
                                    var82 = Draw3D.field570[method25(var80, 96)];
                                }
                                if (var71 == 0) {
                                    ...
                                    int var88;
                                    if (var86 >= 0) {
                                        var87 = Draw3D.method158(true, var86);
                                        var88 = -1;
                                        ...
                                        var87 = Draw3D.field570[this.method26(var88, 96)];
                                    }
    ...
    @OriginalMember(owner = "client!c", name = "a", descriptor = "(Lr;ILec;I[[[IIILob;BIII)V")
