...
public class class744 {
    ...
    @OriginalMember(owner = "client!lja", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field10363++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!lja", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!lja", name = "<init>", descriptor = "(II)V", line = 37)
