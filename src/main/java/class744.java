...
public class class744 implements class716 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZB)V", line = 18)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "(Lnd;Lgq;)V", line = 66)
