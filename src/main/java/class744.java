...
public class class744 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;IIII[S[B)V", line = 18)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(II)Lav;", line = 106)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "()V", line = 120)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;Lee;IIII[I[I)V", line = 277)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lwu;Ljb;Llh;Lwb;Lpm;Lcl;Lbj;)V", line = 411)
    ...
    @OriginalMember(owner = "client!hd", name = "d", descriptor = "()V", line = 443)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(II)Ldr;", line = 454)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;IIII)Lro;", line = 471)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;Lpda;Ldh;)V", line = 481)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Lha;IIII)V", line = 590)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ld;III)I", line = 934)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;)V", line = 993)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;Lpda;IIII)V", line = 1005)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(IIIIIIII)V", line = 1009)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)Lav;", line = 1019)
    public static final class640 method4168(int arg0) {
        return (class640) field10332.method2135((long) arg0, (byte) 31);
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "([B[B[SII)V", line = 1023)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(Lha;)Lro;", line = 1170)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Ld;II)V", line = 1182)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;II)V", line = 1192)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 1370)
    public static final void method4173(int arg0) {
        field10336 = (class640) field10332.method2135((long) arg0, (byte) 31);
    }

    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V", line = 1374)
    ...
    @OriginalMember(owner = "client!hd", name = "e", descriptor = "()V", line = 1581)
