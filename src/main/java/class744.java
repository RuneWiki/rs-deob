...
public class class744 {
    ...
    @OriginalMember(owner = "client!si", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(B)I", line = 27)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!si", name = "a", descriptor = "(Lrfa;III)V", line = 106)
