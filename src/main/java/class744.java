...
public class class744 {
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(Z)I", line = 21)
    ...
    @OriginalMember(owner = "client!hd", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!hd", name = "a", descriptor = "(ZBII)Ljava/lang/String;", line = 242)
    ...
    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "()V", line = 290)
    private class744() {
    }

    @OriginalMember(owner = "client!hd", name = "<init>", descriptor = "([I)V", line = 292)
