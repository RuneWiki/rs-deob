...
public class class744 extends class281 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BI[B)I", line = 7)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(IIBII)V", line = 33)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Lpda;)V", line = 109)
