...
public class class744 extends class182 {
    ...
    @OriginalMember(owner = "client!lr", name = "d", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIB)V", line = 21)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(IIIIIFFF)V", line = 34)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIILfw;Lfw;)V", line = 45)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(III)V", line = 91)
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(III)Lcea;", line = 128)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(I)V", line = 143)
