...
public class class744 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)Lbr;", line = 136)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 214)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIILjr;IILha;I)Ltd;", line = 242)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 262)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lda;IIIILjr;Lha;Lha;ZBIZ)Ltd;", line = 292)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 357)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(II)V", line = 370)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Z)V", line = 386)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIBIII)I", line = 403)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lsl;B)Lbba;", line = 434)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZ)V", line = 457)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIII)I", line = 477)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(B)V", line = 500)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lmp;IZLcn;Lla;Lla;)V", line = 542)
