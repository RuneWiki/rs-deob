...
public class class744 extends class224 implements class356 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!nh", name = "h", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Z)V", line = 42)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(Loea;IIIII)Lm;", line = 55)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Loea;III)V", line = 100)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Loea;IIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!nh", name = "finalize", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 87)
