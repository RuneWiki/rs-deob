...
public abstract class class744 extends class176 {
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(B)Z", line = 18)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lgg;BZILha;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!wo", name = "i", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lha;B)Z", line = 51)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(I[Lcba;)I", line = 62)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "(IIIIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(Z)Z", line = 88)
