...
public class class744 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(II)Lso;", line = 12)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(IC)Z", line = 43)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(B)Ldd;", line = 54)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BI)V", line = 94)
    ...
    @OriginalMember(owner = "client!pca", name = "b", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Liv;ILcb;)V", line = 135)
