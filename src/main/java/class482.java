...
public class class482 extends class258 {
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 13)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 43)
    ...
    @OriginalMember(owner = "client!o", name = "c", descriptor = "()V", line = 80)
    ...
    @OriginalMember(owner = "client!o", name = "d", descriptor = "()V", line = 101)
    ...
    @OriginalMember(owner = "client!o", name = "a", descriptor = "()V", line = 135)
    ...
    @OriginalMember(owner = "client!o", name = "b", descriptor = "()I", line = 149)
