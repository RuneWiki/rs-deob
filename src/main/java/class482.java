...
public class class482 extends class656 implements class393 {
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(IIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Ljaa;ILjaclib/memory/Buffer;IZ)V", line = 46)
    public class482(class576 arg0, int arg1, Buffer arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field5991 = arg1;
    }

    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(B)J", line = 59)
    ...
    @OriginalMember(owner = "client!cn", name = "<init>", descriptor = "(Ljaa;I[BIZ)V", line = 70)
    public class482(class576 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field5991 = arg1;
    }

    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(Z)V", line = 80)
    ...
    @OriginalMember(owner = "client!cn", name = "c", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!cn", name = "b", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(I)I", line = 129)
    ...
    @OriginalMember(owner = "client!cn", name = "a", descriptor = "(III[B)V", line = 141)
