...
public class class482 extends class340 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(B)Lwb;")
    ...
    @OriginalMember(owner = "client!cga", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    public class482(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
