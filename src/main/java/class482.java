...
public class class482 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZZ)Z", line = 20)
    public static boolean method2809(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(ILjava/lang/String;ILjava/lang/String;J)V", line = 31)
