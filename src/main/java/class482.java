...
public class class482 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(B)Leh;", line = 6)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Luh;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(I)Leh;", line = 39)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Z)V", line = 120)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IBI)Z", line = 131)
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "()V", line = 144)
    public class482() {
    }

    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Luh;)V", line = 161)
