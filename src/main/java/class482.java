...
public class class482 extends class631 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lkda;Ln;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lgba;B)I", line = 36)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIB)[B", line = 79)
    ...
    @OriginalMember(owner = "client!ug", name = "c", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "()V", line = 106)
    public class482() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!ug", name = "e", descriptor = "(I)Ljava/lang/String;", line = 110)
