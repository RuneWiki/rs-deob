...
public class class482 extends class210 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IIILbp;IZLeq;)V")
    ...
    @OriginalMember(owner = "client!lu", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(Lva;Leq;B)V")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(IILeq;)Lva;")
