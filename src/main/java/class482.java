...
public class class482 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIZ)I", line = 24)
    ...
    @OriginalMember(owner = "client!rq", name = "toString", descriptor = "()Ljava/lang/String;", line = 49)
    public final String toString() {
        field6531++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIII)V", line = 61)
