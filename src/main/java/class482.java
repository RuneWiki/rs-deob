...
public class class482 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZB[BLfd;IIII)Lps;")
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)Lfk;")
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Liv;)V")
