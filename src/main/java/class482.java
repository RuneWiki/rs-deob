...
public class class482 extends class337 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Ljava/lang/String;Lod;BI)Lam;", line = 3)
    ...
    @OriginalMember(owner = "client!qf", name = "b", descriptor = "(II)Z", line = 85)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BILhp;)V", line = 103)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(II)V", line = 146)
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "()V", line = 159)
    public class482() {
        this(0);
    }

    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(I)V", line = 163)
    private class482(int arg0) {
        super(0, false);
        this.method2892(109, arg0);
    }

    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(II)[[I", line = 171)
