...
public class class482 extends class101 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lrs;I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "()V", line = 37)
    public class482() {
    }

    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 40)
    public class482(String arg0) {
        this.field6664 = arg0;
    }

    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(B)V", line = 49)
