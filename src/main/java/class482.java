...
public class class482 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(CI)Z", line = 5)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!iga", name = "<init>", descriptor = "(II)V", line = 68)
    public class482(int arg0, int arg1) {
        this.field6730 = arg0;
    }

    @OriginalMember(owner = "client!iga", name = "toString", descriptor = "()Ljava/lang/String;", line = 80)
    public final String toString() {
        field6734++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(IBI[BIII[BI)V", line = 88)
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ILwj;IZZIIII[IIIII[I)I", line = 133)
