...
public class class482 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)Lau;", line = 29)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lau;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(Lau;)V", line = 65)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "([Lau;)V", line = 73)
    public class482(class771[] arg0) {
        try {
