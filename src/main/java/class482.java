...
public class class482 extends class115 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Llk;II[III)V")
    ...
    @OriginalMember(owner = "client!ab", name = "b", descriptor = "()Lwq;")
    ...
    @OriginalMember(owner = "client!ab", name = "d", descriptor = "()Lwq;")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Llk;IB)V")
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Lwt;)V")
