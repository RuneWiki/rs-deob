...
public class class482 extends class578 {
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(BI)I", line = 4)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)I", line = 35)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BI)V", line = 70)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "()V", line = 110)
    public class482() {
    }

    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 112)
