...
public class class482 extends class132 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IBI)Z", line = 21)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;IILjava/lang/String;)V", line = 49)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILdn;)V", line = 125)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IZI)V", line = 140)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(IIIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(I)V", line = 169)
