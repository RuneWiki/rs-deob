...
public class class482 extends class382 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(III)V", line = 57)
    ...
    @OriginalMember(owner = "client!vm", name = "c", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!vm", name = "<init>", descriptor = "(Lht;II[B)V", line = 104)
