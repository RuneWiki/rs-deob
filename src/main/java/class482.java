...
public class class482 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)Loo;")
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(II)Lvm;")
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lkr;ILok;)V")
