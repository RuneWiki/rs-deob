...
public class class482 {
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B)Ltv;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(I)Ltv;")
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(I)Ltv;")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Ltv;JZ)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(B[Ltv;)I")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IJ)Ltv;")
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(BI)Ldc;")
