...
public class class482 extends class189 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ZI)V", line = 36)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BII)V", line = 52)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(IIIB)I", line = 109)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lsv;IB)V", line = 157)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(B)Z", line = 170)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)V", line = 180)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lih;Lpq;)V", line = 266)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILjava/lang/String;)J", line = 303)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lhm;B)V", line = 326)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)V", line = 354)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(ZI)V", line = 366)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(BLwm;)Llq;", line = 389)
