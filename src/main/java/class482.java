...
public class class482 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)Lgt;", line = 20)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(IIII)V", line = 42)
