...
public class class482 extends class264 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IBII)I", line = 4)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(BI)V", line = 48)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(BI)I", line = 60)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Lmfa;)V", line = 71)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B)I", line = 90)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(ILmfa;)V", line = 102)
