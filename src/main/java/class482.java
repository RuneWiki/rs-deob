...
public class class482 extends class616 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljn;Ljn;Ljn;Ljn;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lifa;II[B)V", line = 24)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)I", line = 37)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lifa;II[I)V", line = 48)
