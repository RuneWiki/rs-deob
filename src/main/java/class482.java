...
public class class482 extends class148 {
    ...
    @OriginalMember(owner = "client!bs", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)Z", line = 35)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "()V", line = 46)
    public class482() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ZI)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(DI)V", line = 114)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IIBLod;II)Lwe;", line = 140)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(ILdh;I)V", line = 160)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)[I", line = 232)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "([[II)V", line = 266)
