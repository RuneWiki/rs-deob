...
public class class482 extends class264 {
    ...
    @OriginalMember(owner = "client!sa", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(III)I", line = 37)
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "()V", line = 194)
    public class482() {
        super(1, true);
    }

    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lpg;[[BB)V", line = 116)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLkk;I)V", line = 202)
    ...
    @OriginalMember(owner = "client!sa", name = "i", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(II)[I", line = 254)
