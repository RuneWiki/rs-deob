...
public class class482 extends class314 implements class41 {
    ...
    @OriginalMember(owner = "client!ar", name = "c", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILya;II)Z", line = 22)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lgg;IZIIILya;)V", line = 44)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Z)I", line = 76)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IILya;)Lt;", line = 90)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ZLya;)Llo;", line = 101)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lya;IZI)Ldp;", line = 127)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lya;BI)Lt;", line = 171)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(B)Z", line = 193)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(ILya;)V", line = 206)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lya;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)Z", line = 244)
    public final boolean method182(int arg0) {
        ++field7051;
        return arg0 != -2286 ? false : this.field7044;
    }

    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IZI)I", line = 260)
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!ar", name = "d", descriptor = "(I)V", line = 303)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lya;Lho;IIIIZIIZ)V", line = 316)
    ...
    @OriginalMember(owner = "client!ar", name = "f", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILya;)V", line = 363)
