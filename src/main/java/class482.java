...
public class class482 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lis;I)Lrd;")
    ...
    @OriginalMember(owner = "client!bd", name = "<init>", descriptor = "(Lae;Lae;)V")
    public class482(class283 arg0, class283 arg1) {
        this.field6662 = arg1;
        this.field6668 = arg0;
    }

    @OriginalMember(owner = "client!bd", name = "b", descriptor = "(B)Leb;")
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lee;Lhv;IIILsda;Lha;BI)V")
