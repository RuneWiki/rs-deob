...
public class class482 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILmf;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)Les;")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lmf;)V")
    public class482(class291 arg0) {
        this.field7108 = arg0;
    }

    @OriginalMember(owner = "client!gi", name = "c", descriptor = "(I)Les;")
