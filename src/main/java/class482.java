...
public class class482 extends class298 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IZ)[I", line = 3)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BII)I", line = 36)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "()V", line = 94)
    public class482() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BLoj;)V", line = 97)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIIIIZ)V", line = 205)
    ...
    @OriginalMember(owner = "client!jh", name = "d", descriptor = "(I)I", line = 351)
