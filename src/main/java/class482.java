...
public abstract class class482 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIII)V", line = 48)
