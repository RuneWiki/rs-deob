...
public abstract class class482 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IZ[B)V", line = 15)
    ...
    @OriginalMember(owner = "client!am", name = "finalize", descriptor = "()V", line = 41)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IIIIIIIIBIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!am", name = "c", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lpea;I[BIZ)V", line = 170)
    ...
    @OriginalMember(owner = "client!am", name = "<init>", descriptor = "(Lpea;ILjaclib/memory/Buffer;IZ)V", line = 192)
