...
public class class482 extends class619 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!sq", name = "d", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(B)Z", line = 37)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lag;)V", line = 74)
    public class482(class469 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!sq", name = "e", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!sq", name = "e", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!sq", name = "f", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)V", line = 169)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(BLag;[Lvk;)Lte;", line = 250)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Z", line = 324)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Ldga;IILdga;)V", line = 335)
