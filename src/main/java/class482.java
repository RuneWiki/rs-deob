...
public class class482 extends class192 {
    ...
    @OriginalMember(owner = "client!mo", name = "e", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "()V", line = 321)
    public class482() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(IIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(IIII)V", line = 134)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(IB)[[I", line = 193)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(ILfd;I)V", line = 272)
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lol;B)I", line = 326)
