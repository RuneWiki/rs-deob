...
public class class482 extends class681 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lha;IJZI)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Lha;JB)V")
    ...
    @OriginalMember(owner = "client!eu", name = "<init>", descriptor = "(Lha;Lqi;Lod;J)V")
