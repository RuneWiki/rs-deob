...
public class class482 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(IB)V", line = 64)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Z)V", line = 77)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(IB)V", line = 88)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(BZ)V", line = 110)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(BZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(II)Lgm;", line = 152)
    ...
    @OriginalMember(owner = "client!bs", name = "b", descriptor = "(B)V", line = 195)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(Loq;IZLbu;Lbu;)V", line = 243)
