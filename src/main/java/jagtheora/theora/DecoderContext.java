...
public class DecoderContext extends SimplePeer {
    ...
    @OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "<init>", descriptor = "(Ljagtheora/theora/TheoraInfo;Ljagtheora/theora/SetupInfo;)V", line = 12)
    ...
    @OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "granuleTime", descriptor = "(Ljagtheora/theora/GranulePos;)D")
    ...
    @OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "init", descriptor = "(Ljagtheora/theora/TheoraInfo;Ljagtheora/theora/SetupInfo;)V")
    ...
    @OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "decodePacketIn", descriptor = "(Ljagtheora/ogg/OggPacket;Ljagtheora/theora/GranulePos;)I")
    public final native int decodePacketIn(OggPacket arg0, GranulePos arg1);

    @OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "granuleFrame", descriptor = "(Ljagtheora/theora/GranulePos;)J")
    public final native long granuleFrame(GranulePos arg0);

    @OriginalMember(owner = "client!jagtheora/theora/DecoderContext", name = "decodeFrame", descriptor = "(Ljagtheora/theora/Frame;)I")
