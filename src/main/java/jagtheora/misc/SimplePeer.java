...
public abstract class SimplePeer {
    ...
    @OriginalMember(owner = "client!jagtheora/misc/SimplePeer", name = "a", descriptor = "()Z", line = 5)
    public final boolean method4093() {
        return this.peer == 0L;
    }

    @OriginalMember(owner = "client!jagtheora/misc/SimplePeer", name = "b", descriptor = "()V", line = 12)
    public final void method4094() {
        if (!this.method4093()) {
            this.clear();
        }
    }
    ...
    @OriginalMember(owner = "client!jagtheora/misc/SimplePeer", name = "finalize", descriptor = "()V", line = 40)
