...
public abstract class SimplePeer {
    ...
    @OriginalMember(owner = "client!jagtheora/misc/SimplePeer", name = "a", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!jagtheora/misc/SimplePeer", name = "finalize", descriptor = "()V", line = 22)
    ...
    @OriginalMember(owner = "client!jagtheora/misc/SimplePeer", name = "b", descriptor = "()Z", line = 37)
    public final boolean method3951() {
        return this.peer == 0L;
    }
