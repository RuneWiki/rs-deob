...
public class class400 implements class466 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I[I)V", line = 30)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "()V", line = 195)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(BI)V", line = 67)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(II)I", line = 103)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)V", line = 138)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(ILjava/awt/Component;BZ)V", line = 162)
