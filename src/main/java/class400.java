...
public class class400 {
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(FI[BIFIILoia;FFIIFI)V", line = 7)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(I)Lvh;", line = 55)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lvh;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(I)I", line = 100)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(B)V", line = 121)
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(JLha;I)V", line = 134)
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "()V", line = 235)
    public class400() {
        this.field5965.field5227 = this.field5965;
        this.field5965.field5222 = this.field5965;
    }

    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!jba", name = "d", descriptor = "(I)V", line = 190)
    ...
    @OriginalMember(owner = "client!jba", name = "e", descriptor = "(I)Lvh;", line = 213)
