...
public class class400 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IJLfs;)V", line = 32)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(JI)Lfs;", line = 78)
    ...
    @OriginalMember(owner = "client!gf", name = "b", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(I)V", line = 128)
