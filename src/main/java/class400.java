...
public class class400 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILjr;B)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Lpj;B[ILpj;)V")
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ILjr;)V")
