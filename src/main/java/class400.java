...
public class class400 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILvj;IIII)Lbr;")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BILnp;)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILnp;)V")
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(BLr;)V")
