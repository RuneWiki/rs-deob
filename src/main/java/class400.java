...
public class class400 extends class251 {
    ...
    @OriginalMember(owner = "client!uh", name = "f", descriptor = "()V", line = 4)
    public final void method1183() {
        this.field5318 = null;
        this.field5331 = null;
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lve;[I)V", line = 7)
    public final void method1186(class182 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIIIII[[ZLip;[I[I)V", line = 15)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Lfe;IIII[[I[[II)V", line = 145)
    ...
    @OriginalMember(owner = "client!uh", name = "U", descriptor = "(Lj;IIIIZ)V", line = 196)
    public final void method1170(class254 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!uh", name = "O", descriptor = "(IILj;)Lj;", line = 204)
    public final class254 method1180(int arg0, int arg1, class254 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 208)
    ...
    @OriginalMember(owner = "client!uh", name = "I", descriptor = "(II)I", line = 437)
    public final int method1187(int arg0, int arg1) {
        return this.field5322[arg0][arg1];
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Lj;IIIIZ)Z", line = 443)
    public final boolean method1172(class254 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!uh", name = "va", descriptor = "(II)I", line = 447)
    ...
    @OriginalMember(owner = "client!uh", name = "JA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 464)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(II)I", line = 958)
    ...
    @OriginalMember(owner = "client!uh", name = "SA", descriptor = "(Lj;IIIIZ)V", line = 986)
    public final void method1181(class254 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)Z", line = 989)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(II)V", line = 1005)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(IIIIIII[[ZLip;[I[I)V", line = 1018)
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field5317[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field1822; ++var23) {
                            ...
                            } else if (var21.field1824 != null && var21.field1824[var23] != -1) {
    ...
    @OriginalMember(owner = "client!uh", name = "QA", descriptor = "(III)V", line = 1154)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III[[ZZ)V", line = 1161)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIIIII[[Z)V", line = 1178)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIZLip;[I[I[I)V", line = 1197)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IILip;[I[I[I)V", line = 1838)
