...
public class class400 extends class626 implements class180 {
    ...
    @OriginalMember(owner = "client!ks", name = "<init>", descriptor = "(Lnfa;Lnb;Z)V")
    ...
    @OriginalMember(owner = "client!ks", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ks", name = "b", descriptor = "(I)Lnb;")
