...
public class class400 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIIIIIILea;)Z")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BLbg;)V")
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lbl;Leo;III)V")
