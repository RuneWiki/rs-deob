...
public class class400 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ILjava/lang/String;Ljava/applet/Applet;)V", line = 3)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;[Ljava/lang/Object;Z)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)Ljava/lang/Object;", line = 23)
