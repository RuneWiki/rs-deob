...
public class class400 extends class200 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)[B", line = 19)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(III)[B", line = 35)
