...
public class class400 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IZIILft;Lwu;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(II)Lpha;")
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lms;IZLwu;Lwu;)V")
