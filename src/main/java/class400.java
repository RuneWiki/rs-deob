...
public class class400 extends class11 {
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lkm;)V", line = 14)
    ...
    @OriginalMember(owner = "client!ab", name = "e", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Loe;)V", line = 45)
    public final synchronized void method2406(class11 arg0) {
        arg0.method2714(51);
    }

    @OriginalMember(owner = "client!ab", name = "d", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "()I", line = 107)
    public final int method54() {
        return 0;
    }

    @OriginalMember(owner = "client!ab", name = "d", descriptor = "()Loe;", line = 110)
    public final class11 method55() {
        return (class11) this.field5484.method763(0);
    }

    @OriginalMember(owner = "client!ab", name = "b", descriptor = "()Loe;", line = 115)
    public final class11 method53() {
        return (class11) this.field5484.method775(1);
    }

    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(Loe;)V", line = 120)
    public final synchronized void method2407(class11 arg0) {
        this.field5484.method774(arg0, (byte) 127);
    }

    @OriginalMember(owner = "client!ab", name = "c", descriptor = "([III)V", line = 125)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Lrs;Lkm;)V", line = 134)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "([III)V", line = 147)
