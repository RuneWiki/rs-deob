...
public class class400 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lie;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Lpca;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILie;)V", line = 71)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIILiq;I)Z", line = 91)
