...
public class class400 extends class176 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Ldq;Ll;IIILjava/awt/Canvas;)Lqa;", line = 4)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IIIZIZB)V", line = 20)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILga;Lqa;II)V", line = 65)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(Lqw;I)Ljava/lang/String;", line = 376)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)V", line = 407)
