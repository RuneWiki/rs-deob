...
public class class400 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "([IBI)Lql;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II[II)Lql;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(I[III)Lql;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(IB[I)Lql;")
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(ILsk;)I")
    ...
    @OriginalMember(owner = "client!pb", name = "<init>", descriptor = "(Lga;Lga;)V")
