...
public class class400 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(I[Lwl;IIII)V", line = 223)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lza;IIIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IBLza;)Z", line = 145)
