...
public class class400 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lfp;Lje;IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(B)V", line = 188)
