...
public class class400 implements class407 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ILvl;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z)J", line = 47)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIBLjava/awt/Component;Lkd;)Lgq;", line = 79)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)I", line = 171)
