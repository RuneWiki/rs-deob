...
public class class400 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIILcu;Lcu;)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ljba;I)Ljba;")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lac;)V")
