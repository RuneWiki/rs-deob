...
public class class400 implements Runnable {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(I)Loq;")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(Ljava/lang/String;Loq;IJB)V")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(BLlfa;)V")
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ZLkha;)V")
