...
public class class400 extends class337 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lmc;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(Lfv;I)V")
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Lmc;)V")
