...
public class class400 extends class80 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(Llh;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZILlh;)V", line = 38)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(CI)I", line = 102)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ZC)I", line = 127)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(ILqa;)V", line = 151)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IZ)Z", line = 254)
    ...
    @OriginalMember(owner = "client!hj", name = "g", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIIIIZI)V", line = 299)
