...
public class class400 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BIIIIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BI)Z", line = 270)
