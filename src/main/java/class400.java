...
public class class400 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILes;)Z", line = 28)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)V", line = 54)
