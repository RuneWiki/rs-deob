...
public class class400 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvq;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()I", line = 92)
    public final int method2506() {
        return this.field5623 - 1;
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 96)
    public static void method2507() {
        field5624 = null;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Ljava/lang/String;)I", line = 101)
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "()I", line = 117)
    public final int method2509() {
        return this.field5619;
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvq;Ljava/lang/String;IIIZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lvq;Ljava/lang/String;[IIIIZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lvq;IZLjava/awt/Component;)V", line = 192)
