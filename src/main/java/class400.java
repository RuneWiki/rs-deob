...
public class class400 extends class137 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IILjava/awt/Graphics;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!uba", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 17)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!uba", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 55)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field5314;
    }

    @OriginalMember(owner = "client!uba", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 67)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field5317;
        return this.field5303 == arg0;
    }

    @OriginalMember(owner = "client!uba", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 76)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field5301;
    }

    @OriginalMember(owner = "client!uba", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 90)
    ...
    @OriginalMember(owner = "client!uba", name = "c", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 132)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 148)
