...
public class class400 extends class594 {
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(BLjava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(B)V", line = 28)
    public static void method2463(byte arg0) {
        int var1 = -56 % ((-arg0 - 12) / 58);
        field5488 = null;
    }

    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(III)I", line = 44)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(I)Lks;", line = 132)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Lpj;IIIIII)V", line = 193)
