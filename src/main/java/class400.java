...
public class class400 extends class175 implements class547 {
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lnca;IZ[[I)V")
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lqq;I)V")
    public final void method379(class599 arg0, int arg1) {
        super.method379(arg0, arg1);
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;")
