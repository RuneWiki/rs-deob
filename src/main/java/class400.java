...
public class class400 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "()[B", line = 4)
    ...
    @OriginalMember(owner = "client!dw", name = "b", descriptor = "()Luq;", line = 67)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(Lns;II)Ldw;", line = 75)
    ...
    @OriginalMember(owner = "client!dw", name = "c", descriptor = "()I", line = 84)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(Ltl;)V", line = 129)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "()V", line = 149)
    private class400() {
    }
}
