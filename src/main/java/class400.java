...
public class class400 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(IIBZZ)V")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([BILfha;I)Lpl;")
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Luu;IIIIIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(Lee;)V")
