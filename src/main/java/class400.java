...
public abstract class class400 {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([Lcw;IBIIIII[IILjava/lang/String;IILaa;II)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([I[IILjava/lang/String;ZI[I[Lcw;)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[ILjava/lang/String;[Lcw;IILaa;I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "([IIIILjava/lang/String;IIILjava/util/Random;II[I[Lcw;II)I")
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Lha;Loq;)V")
    public class400(class545 arg0, class742 arg1) {
        this.field5537 = arg1;
        this.field5532 = arg0;
    }

    @OriginalMember(owner = "client!da", name = "a", descriptor = "(II[Lcw;[IILjava/lang/String;IILjava/util/Random;I)I")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IILjava/lang/String;[Lcw;III[I)V")
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IIILaa;I[IIIIIIILjava/lang/String;[Lcw;III)I")
