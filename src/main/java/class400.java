...
public class class400 extends class508 implements class54 {
    ...
    @OriginalMember(owner = "client!pca", name = "a", descriptor = "(ILpl;)V")
    ...
    @OriginalMember(owner = "client!pca", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Lqj;III)V")
    ...
    @OriginalMember(owner = "client!pca", name = "<init>", descriptor = "(Lqj;IIII)V")
