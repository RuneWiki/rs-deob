...
public class class400 extends class156 implements Runnable {
    ...
    @OriginalMember(owner = "client!t", name = "run", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!t", name = "b", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(ILtq;Ltq;)V", line = 43)
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "(III)I", line = 67)
    ...
    @OriginalMember(owner = "client!t", name = "c", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lkr;)V", line = 101)
