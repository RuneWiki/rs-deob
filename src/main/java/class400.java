...
public class class400 extends class263 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIZI)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Loa;Lnt;IIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(B[B)V", line = 152)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "([B)V", line = 185)
