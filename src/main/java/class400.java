...
public class class400 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lbt;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)Lvj;", line = 37)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lbt;B)V", line = 75)
