...
public class class400 {
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(I)[Lcv;")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(BILhf;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(ILhf;)V")
