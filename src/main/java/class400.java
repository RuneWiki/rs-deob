...
public class class400 extends class91 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ILs;)V", line = 186)
    public static final void method2374(int arg0, class419 arg1) {
        class678.field9594[arg0] = arg1;
    }

    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(ZII)V", line = 191)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(Z)Ljo;", line = 349)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(B)V", line = 369)
