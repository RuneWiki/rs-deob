...
public class class400 extends class134 {
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(ILwq;)V", line = 9)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(Lsca;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!fha", name = "a", descriptor = "(B)V", line = 55)
