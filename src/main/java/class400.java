...
public class class400 implements Runnable {
    ...
    @OriginalMember(owner = "client!ad", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ad", name = "run", descriptor = "()V", line = 70)
    ...
    @OriginalMember(owner = "client!ad", name = "c", descriptor = "(B)V", line = 113)
