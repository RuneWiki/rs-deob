...
public class class38 extends class5 {
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lic;II[BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "()V", line = 20)
    public final void method47() {
    }

    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ZI)V", line = 26)
