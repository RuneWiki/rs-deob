...
@OriginalClass("client!JQZFCGYF")
public class class38 extends class35 {

    @OriginalMember(owner = "client!JQZFCGYF", name = "z", descriptor = "B")
    private byte field1180 = 5;

    @OriginalMember(owner = "client!JQZFCGYF", name = "A", descriptor = "I")
    private int field1181 = 4;

    @OriginalMember(owner = "client!JQZFCGYF", name = "B", descriptor = "I")
    private int field1182 = 817;

    @OriginalMember(owner = "client!JQZFCGYF", name = "C", descriptor = "Z")
    private boolean field1183 = true;

    @OriginalMember(owner = "client!JQZFCGYF", name = "J", descriptor = "I")
    public int field1190;

    @OriginalMember(owner = "client!JQZFCGYF", name = "K", descriptor = "I")
    public int field1191;

    @OriginalMember(owner = "client!JQZFCGYF", name = "E", descriptor = "[I")
    public int[] field1185;

    @OriginalMember(owner = "client!JQZFCGYF", name = "H", descriptor = "I")
    public int field1188;

    @OriginalMember(owner = "client!JQZFCGYF", name = "I", descriptor = "I")
    public int field1189;

    @OriginalMember(owner = "client!JQZFCGYF", name = "F", descriptor = "I")
    public int field1186;

    @OriginalMember(owner = "client!JQZFCGYF", name = "G", descriptor = "I")
    public int field1187;

    @OriginalMember(owner = "client!JQZFCGYF", name = "D", descriptor = "[B")
    public byte[] field1184;

    @OriginalMember(owner = "client!JQZFCGYF", name = "<init>", descriptor = "(LEAXVDNXA;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "a", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "a", descriptor = "(IIZ)V")
    ...
    @OriginalMember(owner = "client!JQZFCGYF", name = "a", descriptor = "(I[BI[IIIZ[III)V")
