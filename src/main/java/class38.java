...
public class class38 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lrk;Lrk;B)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Lap;III)V")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZBILpe;)Lkb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILap;B)V")
