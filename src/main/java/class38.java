...
public class class38 extends class739 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(ILvda;)Ljava/lang/String;", line = 50)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "()V", line = 130)
    public class38() {
        super(1, false);
    }

    @OriginalMember(owner = "client!be", name = "a", descriptor = "(BI)[[I", line = 64)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(Lsl;II)V", line = 133)
