...
public class class38 {
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "e", descriptor = "LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "f", descriptor = "LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "a", descriptor = "(LMRGQMKFG;)V")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "a", descriptor = "(LMRGQMKFG;B)V")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "a", descriptor = "()LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "b", descriptor = "()LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "a", descriptor = "(I)LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "b", descriptor = "(I)LMRGQMKFG;")
    ...
    @OriginalMember(owner = "client!OCPYCLUF", name = "a", descriptor = "(Z)LMRGQMKFG;")
