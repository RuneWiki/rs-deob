...
public class class38 {
    ...
    @OriginalMember(owner = "client!LJCRDSKE", name = "e", descriptor = "[LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!LJCRDSKE", name = "a", descriptor = "(J)LXNCSKJMM;")
    ...
    @OriginalMember(owner = "client!LJCRDSKE", name = "a", descriptor = "(BLXNCSKJMM;J)V")
