...
public class class38 extends class416 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IBZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(IIIB)[B", line = 19)
    ...
    @OriginalMember(owner = "client!sc", name = "c", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "()V", line = 42)
    public class38() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ZZLoa;I)Lbd;", line = 45)
