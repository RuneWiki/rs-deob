...
public class class38 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(BI)Lgl;")
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(BI)Llc;")
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "([[BLfp;Lui;I[[BI[[IIZ[[B[[BILui;)V")
