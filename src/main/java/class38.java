...
public class class38 extends class41 {
    ...
    @OriginalMember(owner = "client!uja", name = "c", descriptor = "(B)V", line = 4)
    public static void method328(byte arg0) {
        int var1 = -2 / ((22 - arg0) / 46);
        field557 = null;
    }

    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(ILes;)V", line = 17)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(III)Let;", line = 38)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Loga;I)V", line = 47)
