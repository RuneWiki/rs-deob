...
public class class38 extends class287 {
    ...
    @OriginalMember(owner = "client!vg", name = "f", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!vg", name = "d", descriptor = "(B)[B", line = 31)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(I)I", line = 53)
    ...
    @OriginalMember(owner = "client!vg", name = "g", descriptor = "(I)V", line = 73)
