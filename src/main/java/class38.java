...
public class class38 extends class503 implements class17 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ZI)Ljaclib/memory/Buffer;", line = 4)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IB)V", line = 15)
    public final void method73(int arg0, byte arg1) {
        ++field384;
        super.method73(this.field386.field2003 * arg0, arg1);
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(B)Lrt;", line = 49)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lmr;Lrt;Z)V", line = 104)
    public class38(class221 arg0, class179 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field386 = arg1;
    }

    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ICLjava/lang/String;)I", line = 123)
