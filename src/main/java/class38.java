...
@OriginalClass("client!PCSJGLYB")
public class class38 {

    @OriginalMember(owner = "client!PCSJGLYB", name = "a", descriptor = "I")
    private int field983 = 30484;

    @OriginalMember(owner = "client!PCSJGLYB", name = "b", descriptor = "I")
    public int field984;

    @OriginalMember(owner = "client!PCSJGLYB", name = "c", descriptor = "[I")
    public int[] field985;

    @OriginalMember(owner = "client!PCSJGLYB", name = "d", descriptor = "[[I")
    public int[][] field986;

    @OriginalMember(owner = "client!PCSJGLYB", name = "<init>", descriptor = "(LMQZHAILV;I)V")
