...
public class class38 extends class30 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ILmo;Lmo;Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IB)[I", line = 21)
    ...
    @OriginalMember(owner = "client!dl", name = "f", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZLjava/lang/Object;)[B", line = 102)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "()V", line = 266)
    public class38() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(BI)[[I", line = 142)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Ljg;II)V", line = 216)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(III)Lop;", line = 254)
