...
@OriginalClass("client!LVGEETWD")
public class class38 {

    @OriginalMember(owner = "client!LVGEETWD", name = "a", descriptor = "Z")
    private boolean field1111 = false;

    @OriginalMember(owner = "client!LVGEETWD", name = "b", descriptor = "I")
    private int field1112 = 939;

    @OriginalMember(owner = "client!LVGEETWD", name = "c", descriptor = "I")
    private int field1113 = 123;

    @OriginalMember(owner = "client!LVGEETWD", name = "d", descriptor = "LZAQWNGNJ;")
    public class70 field1114 = new class70();

    @OriginalMember(owner = "client!LVGEETWD", name = "e", descriptor = "LZAQWNGNJ;")
    private class70 field1115;

    @OriginalMember(owner = "client!LVGEETWD", name = "<init>", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!LVGEETWD", name = "a", descriptor = "(LZAQWNGNJ;)V")
    ...
    @OriginalMember(owner = "client!LVGEETWD", name = "a", descriptor = "()LZAQWNGNJ;")
    ...
    @OriginalMember(owner = "client!LVGEETWD", name = "b", descriptor = "()LZAQWNGNJ;")
    ...
    @OriginalMember(owner = "client!LVGEETWD", name = "a", descriptor = "(I)LZAQWNGNJ;")
