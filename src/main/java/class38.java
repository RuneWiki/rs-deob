...
public class class38 {
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Llk;I)V")
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(Lws;B)Z")
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(Llk;)V")
