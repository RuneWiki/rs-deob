...
public class class38 extends class354 {
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(B)V", line = 251)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(BI)[[I", line = 267)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILti;I)V", line = 595)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(ILak;)V", line = 630)
