...
public class class38 {
    ...
    @OriginalMember(owner = "client!PQRCEBTR", name = "b", descriptor = "[LPQRCEBTR;")
    public static class38[] field1315;

    @OriginalMember(owner = "client!PQRCEBTR", name = "a", descriptor = "(LDTIATKJO;I)V")
    ...
    @OriginalMember(owner = "client!PQRCEBTR", name = "a", descriptor = "(LGHHPHSRU;I)V")
