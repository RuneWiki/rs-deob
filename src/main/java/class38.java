...
public class class38 {
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(ZLjava/lang/String;BLvc;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(IIIZII)V", line = 68)
    ...
    @OriginalMember(owner = "client!vd", name = "a", descriptor = "(B)V", line = 87)
    ...
    @OriginalMember(owner = "client!vd", name = "<init>", descriptor = "(I)V", line = 106)
