...
public class class38 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)I", line = 9)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/awt/Canvas;)Lgw;", line = 26)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Z)V", line = 133)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 282)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(III)Z", line = 297)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "()V", line = 307)
    private class38() {
    }

    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)I", line = 310)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "([I)V", line = 326)
