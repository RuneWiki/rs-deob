...
public abstract class class38 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILra;IZ)Loq;", line = 5)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Len;)V", line = 27)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(BC)B", line = 104)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 232)
    public static void method230(int arg0) {
        field390 = null;
        int var1 = 58 / ((-arg0 - 21) / 55);
    }

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(IBLra;)Lnm;", line = 243)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(B)I", line = 263)
