...
public class class38 extends class331 {
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lts;)V", line = 3)
    public class38(class41 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(II)I", line = 6)
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(B)I", line = 19)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(B)I", line = 30)
    ...
    @OriginalMember(owner = "client!rea", name = "d", descriptor = "(II)Lga;", line = 41)
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(II)V", line = 69)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(ILts;)V", line = 85)
    public class38(int arg0, class41 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(Z)V", line = 108)
