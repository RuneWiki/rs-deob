...
public class class38 extends class44 {
    ...
    @OriginalMember(owner = "client!dl", name = "c", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "()V", line = 93)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "(Z)V", line = 115)
    public final void method230(boolean arg0) {
        this.field540.method981(8448, 7681);
    }

    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(Llp;)V", line = 119)
    public final void method231(class220 arg0) {
        this.field540.method1003(arg0);
    }

    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(Lao;)V", line = 122)
    ...
    @OriginalMember(owner = "client!dl", name = "b", descriptor = "()Z", line = 237)
