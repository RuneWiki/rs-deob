...
public abstract class class38 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lga;ILjava/awt/Canvas;IBLet;)Lya;", line = 22)
    ...
    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(IIIII)V", line = 93)
    ...
    @OriginalMember(owner = "client!ya", name = "finalize", descriptor = "()V", line = 108)
    protected void finalize() {
        field431++;
        this.method333(true);
    }

    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!ya", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!ya", name = "A", descriptor = "()V", line = 231)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIBII)V", line = 482)
    ...
    @OriginalMember(owner = "client!ya", name = "b", descriptor = "(IIIIII)V", line = 496)
    ...
    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(IIIIII)V", line = 509)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(ILga;)V", line = 524)
    public class38(int arg0, class277 arg1) {
        this.field425 = arg1;
        this.field430 = arg0;
    }

    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(BIIII)V", line = 547)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIIIIIIB)Z", line = 558)
