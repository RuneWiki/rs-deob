...
public class class38 {
    ...
    @OriginalMember(owner = "client!MXUYAYVV", name = "b", descriptor = "LMXUYAYVV;")
    public class38 field1226;

    @OriginalMember(owner = "client!MXUYAYVV", name = "c", descriptor = "LMXUYAYVV;")
    public class38 field1227;

    @OriginalMember(owner = "client!MXUYAYVV", name = "d", descriptor = "Z")
