...
public class class38 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IILpaa;B)V", line = 55)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(I)V", line = 68)
