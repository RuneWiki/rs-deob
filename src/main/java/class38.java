...
public class class38 {
    ...
    @OriginalMember(owner = "client!OYTUMBCI", name = "c", descriptor = "LOYTUMBCI;")
    public class38 field1219;

    @OriginalMember(owner = "client!OYTUMBCI", name = "d", descriptor = "LOYTUMBCI;")
    public class38 field1220;

    @OriginalMember(owner = "client!OYTUMBCI", name = "e", descriptor = "Z")
