...
public class class38 {
    ...
    @OriginalMember(owner = "client!LQCMEXCE", name = "b", descriptor = "LJDDBCSRY;")
    private class29 field1104;

    @OriginalMember(owner = "client!LQCMEXCE", name = "c", descriptor = "LJDDBCSRY;")
    private class29 field1105;

    @OriginalMember(owner = "client!LQCMEXCE", name = "d", descriptor = "LJDDBCSRY;")
    private class29 field1106;

    @OriginalMember(owner = "client!LQCMEXCE", name = "e", descriptor = "LJDDBCSRY;")
    private class29 field1107;

    @OriginalMember(owner = "client!LQCMEXCE", name = "f", descriptor = "LJDDBCSRY;")
    private class29 field1108;

    @OriginalMember(owner = "client!LQCMEXCE", name = "g", descriptor = "LJDDBCSRY;")
    private class29 field1109;

    @OriginalMember(owner = "client!LQCMEXCE", name = "h", descriptor = "LJDDBCSRY;")
    private class29 field1110;

    @OriginalMember(owner = "client!LQCMEXCE", name = "i", descriptor = "LJDDBCSRY;")
    private class29 field1111;

    @OriginalMember(owner = "client!LQCMEXCE", name = "p", descriptor = "LJDDBCSRY;")
    private class29 field1118;

    @OriginalMember(owner = "client!LQCMEXCE", name = "o", descriptor = "LQPCNAGNU;")
    ...
    @OriginalMember(owner = "client!LQCMEXCE", name = "a", descriptor = "(ZLXGRGMPUQ;)V")
