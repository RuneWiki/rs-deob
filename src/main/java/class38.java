...
@OriginalClass("client!NSRSHTPL")
public class class38 {

    @OriginalMember(owner = "client!NSRSHTPL", name = "a", descriptor = "B")
    private byte field1080 = 44;

    @OriginalMember(owner = "client!NSRSHTPL", name = "b", descriptor = "I")
    private int field1081;

    @OriginalMember(owner = "client!NSRSHTPL", name = "c", descriptor = "I")
    private int field1082;

    @OriginalMember(owner = "client!NSRSHTPL", name = "f", descriptor = "I")
    public int field1085;

    @OriginalMember(owner = "client!NSRSHTPL", name = "g", descriptor = "I")
    public int field1086;

    @OriginalMember(owner = "client!NSRSHTPL", name = "h", descriptor = "I")
    public int field1087;

    @OriginalMember(owner = "client!NSRSHTPL", name = "i", descriptor = "I")
    private int field1088;

    @OriginalMember(owner = "client!NSRSHTPL", name = "j", descriptor = "I")
    private int field1089;

    @OriginalMember(owner = "client!NSRSHTPL", name = "k", descriptor = "I")
    private int field1090;

    @OriginalMember(owner = "client!NSRSHTPL", name = "l", descriptor = "I")
    private int field1091;

    @OriginalMember(owner = "client!NSRSHTPL", name = "m", descriptor = "I")
    private int field1092;

    @OriginalMember(owner = "client!NSRSHTPL", name = "n", descriptor = "I")
    public static int field1093;

    @OriginalMember(owner = "client!NSRSHTPL", name = "d", descriptor = "[I")
    private int[] field1083;

    @OriginalMember(owner = "client!NSRSHTPL", name = "e", descriptor = "[I")
    private int[] field1084;

    @OriginalMember(owner = "client!NSRSHTPL", name = "a", descriptor = "(BLYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!NSRSHTPL", name = "a", descriptor = "(ILYOXDZEVD;)V")
    ...
    @OriginalMember(owner = "client!NSRSHTPL", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!NSRSHTPL", name = "a", descriptor = "(II)I")
