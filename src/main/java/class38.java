...
public class class38 {
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 13)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(IIFIII[FIBI)V", line = 61)
    ...
    @OriginalMember(owner = "client!vba", name = "a", descriptor = "(B)V", line = 112)
