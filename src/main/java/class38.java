...
public class class38 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(JBLut;)V", line = 10)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(I)Lut;", line = 35)
    ...
    @OriginalMember(owner = "client!vg", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(JI)Lut;", line = 99)
    ...
    @OriginalMember(owner = "client!vg", name = "c", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(I)V", line = 151)
