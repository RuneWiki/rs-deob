...
public class class38 extends Applet implements Runnable, MouseListener, MouseMotionListener, KeyListener, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!KWRIFYWM", name = "n", descriptor = "[LHOSNGCXH;")
    ...
    @OriginalMember(owner = "client!KWRIFYWM", name = "o", descriptor = "LHAQQOONQ;")
    public class26 field1052;

    @OriginalMember(owner = "client!KWRIFYWM", name = "m", descriptor = "LYJGBGRIO;")
