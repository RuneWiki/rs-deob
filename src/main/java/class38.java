...
public class class38 {
    ...
    @OriginalMember(owner = "client!dg", name = "j", descriptor = "Lrc;")
    public static class160 field818 = new class160(5);

    @OriginalMember(owner = "client!dg", name = "o", descriptor = "Llf;")
    public static class109 field823 = class35.method275("<col=ff7000>", 2);

    @OriginalMember(owner = "client!dg", name = "q", descriptor = "Llf;")
    public static class109 field825 = class35.method275("Lade Eingabe)2Steuerungsprogramm)3)3)3", 2);

    @OriginalMember(owner = "client!dg", name = "m", descriptor = "Llf;")
    private static class109 field821 = class35.method275("Bad session id)3", 2);

    @OriginalMember(owner = "client!dg", name = "n", descriptor = "Llf;")
    public static class109 field822 = field821;

    @OriginalMember(owner = "client!dg", name = "l", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "Lka;")
    public class95 field810;

    @OriginalMember(owner = "client!dg", name = "g", descriptor = "Lka;")
    public class95 field815;

    @OriginalMember(owner = "client!dg", name = "i", descriptor = "Lka;")
    public class95 field817;

    @OriginalMember(owner = "client!dg", name = "k", descriptor = "[I")
    public static int[] field819;

    @OriginalMember(owner = "client!dg", name = "s", descriptor = "[Ldf;")
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lbg;III)[Ldf;")
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(I)Lkb;")
