...
public class class38 extends class133 {
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!lj", name = "finalize", descriptor = "()V", line = 23)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Luo;IIIZBLpc;)V", line = 53)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Luo;IIZ)Z", line = 78)
    ...
    @OriginalMember(owner = "client!lj", name = "b", descriptor = "(ZI)V", line = 101)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IBIII)V", line = 180)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(ILge;Luo;)V", line = 228)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Luo;BI)Lge;", line = 252)
    ...
    @OriginalMember(owner = "client!lj", name = "f", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!lj", name = "d", descriptor = "(B)I", line = 297)
    ...
    @OriginalMember(owner = "client!lj", name = "c", descriptor = "(Luo;B)Lkj;", line = 313)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(BLuo;)V", line = 346)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IJ[II)Ljava/lang/String;", line = 369)
