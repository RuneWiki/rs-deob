...
public abstract class class38 {
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lrl;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!mk", name = "<init>", descriptor = "(Lrl;ILjaggl/memory/NativeBuffer;IZ)V")
