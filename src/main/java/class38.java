...
public abstract class class38 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IZII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(II)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(III)Ldj;", line = 50)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(III)V", line = 93)
