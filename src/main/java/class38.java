...
@OriginalClass("client!LAKHMHBY")
public class class38 extends class50 {

    @OriginalMember(owner = "client!LAKHMHBY", name = "sb", descriptor = "Z")
    public boolean field1092 = false;

    @OriginalMember(owner = "client!LAKHMHBY", name = "vb", descriptor = "[I")
    public int[] field1095 = new int[12];

    @OriginalMember(owner = "client!LAKHMHBY", name = "yb", descriptor = "J")
    public long field1098 = -1L;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Jb", descriptor = "I")
    private int field1109 = 50;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Nb", descriptor = "[I")
    public int[] field1113 = new int[5];

    @OriginalMember(owner = "client!LAKHMHBY", name = "Pb", descriptor = "Z")
    public boolean field1115 = false;

    @OriginalMember(owner = "client!LAKHMHBY", name = "wb", descriptor = "LHPFNYARJ;")
    public static class25 field1096 = new class25((byte) 41, 260);

    @OriginalMember(owner = "client!LAKHMHBY", name = "qb", descriptor = "I")
    public int field1090;

    @OriginalMember(owner = "client!LAKHMHBY", name = "rb", descriptor = "I")
    public int field1091;

    @OriginalMember(owner = "client!LAKHMHBY", name = "tb", descriptor = "I")
    public int field1093;

    @OriginalMember(owner = "client!LAKHMHBY", name = "ub", descriptor = "I")
    public int field1094;

    @OriginalMember(owner = "client!LAKHMHBY", name = "zb", descriptor = "I")
    public int field1099;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Ab", descriptor = "I")
    public int field1100;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Bb", descriptor = "I")
    public int field1101;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Cb", descriptor = "I")
    public int field1102;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Db", descriptor = "I")
    public int field1103;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Eb", descriptor = "I")
    public int field1104;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Fb", descriptor = "I")
    public int field1105;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Gb", descriptor = "I")
    public int field1106;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Ib", descriptor = "I")
    public int field1108;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Kb", descriptor = "I")
    public int field1110;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Lb", descriptor = "I")
    public int field1111;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Mb", descriptor = "J")
    public long field1112;

    @OriginalMember(owner = "client!LAKHMHBY", name = "xb", descriptor = "LHQFMWUSH;")
    public class26 field1097;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Hb", descriptor = "LKPUOCBCE;")
    public class35 field1107;

    @OriginalMember(owner = "client!LAKHMHBY", name = "Ob", descriptor = "Ljava/lang/String;")
    public String field1114;

    @OriginalMember(owner = "client!LAKHMHBY", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!LAKHMHBY", name = "b", descriptor = "(B)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!LAKHMHBY", name = "a", descriptor = "(I)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!LAKHMHBY", name = "c", descriptor = "(I)LKPUOCBCE;")
    ...
    @OriginalMember(owner = "client!LAKHMHBY", name = "a", descriptor = "(BLXOUQUKZW;)V")
