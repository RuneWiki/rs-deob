...
public class class38 extends class212 {
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Lmca;Ljava/awt/Frame;I)V", line = 8)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(B[B)Lnf;", line = 34)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Z)V", line = 134)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Ljava/lang/String;Lmca;IILjava/lang/String;)Lvd;", line = 146)
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "(IIIIIFFF)V", line = 228)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(IBB)V", line = 239)
    ...
    @OriginalMember(owner = "client!uja", name = "d", descriptor = "(B)V", line = 251)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(III)V", line = 265)
    ...
    @OriginalMember(owner = "client!uja", name = "b", descriptor = "(B)V", line = 306)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(BI)I", line = 327)
