...
public class class38 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILaea;)Laea;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lcea;ILwq;IIILts;I)V")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIZLha;)Loh;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z[B)Lfi;")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lida;IIIIIIILha;III)V")
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(ILjm;Z)V")
