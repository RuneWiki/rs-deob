...
public class class38 {
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "c", descriptor = "LWYQNTERC;")
    public class64 field1047 = new class64();

    @OriginalMember(owner = "client!PILILDKN", name = "d", descriptor = "LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "a", descriptor = "(LWYQNTERC;)V")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "a", descriptor = "(LWYQNTERC;Z)V")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "a", descriptor = "()LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "b", descriptor = "()LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "a", descriptor = "(I)LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "a", descriptor = "(B)LWYQNTERC;")
    ...
    @OriginalMember(owner = "client!PILILDKN", name = "b", descriptor = "(I)LWYQNTERC;")
