...
public class class38 extends class346 {
    ...
    @OriginalMember(owner = "client!oc", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lfb;ZI)V", line = 68)
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(II)[[I", line = 122)
    ...
    @OriginalMember(owner = "client!oc", name = "<init>", descriptor = "()V", line = 196)
    public class38() {
        super(1, false);
    }

    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IZII)V", line = 216)
