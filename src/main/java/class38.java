...
public class class38 extends class226 {
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "e", descriptor = "()Z", line = 71)
    public final boolean method326() {
        return this.field3327.field1635 && this.field3327.field1645 && this.field3327.field1667;
    }

    @OriginalMember(owner = "client!gh", name = "a", descriptor = "()Z", line = 74)
    public final boolean method327() {
        return this.field596 != null;
    }

    @OriginalMember(owner = "client!gh", name = "b", descriptor = "()Z", line = 90)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILlb;Llb;)V", line = 125)
    ...
    @OriginalMember(owner = "client!gh", name = "d", descriptor = "()I", line = 274)
    public final int method330() {
        return 1;
    }

    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "(Lge;)V", line = 277)
    public class38(class104 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gh", name = "c", descriptor = "()V", line = 284)
    ...
    @OriginalMember(owner = "client!gh", name = "d", descriptor = "(I)V", line = 295)
