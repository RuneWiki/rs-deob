...
public abstract class class38 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIBI)V", line = 14)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIIZI)V", line = 29)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(BIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(B)V", line = 88)
    public static void method264(byte arg0) {
        int var1 = 112 / ((arg0 + 67) / 43);
        field478 = null;
    }

    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(CLjava/lang/String;Z)[Ljava/lang/String;", line = 140)
    ...
    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(IIIIII)V", line = 181)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIILjava/lang/Class;)Lgg;", line = 198)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(ILga;)V", line = 233)
    public class38(int arg0, class277 arg1) {
        this.field468 = arg0;
        this.field471 = arg1;
    }

    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(IIIII)V", line = 246)
    ...
    @OriginalMember(owner = "client!ya", name = "c", descriptor = "(IIIII)V", line = 272)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(ILdr;Lga;Ljava/awt/Canvas;BI)Lya;", line = 388)
    ...
    @OriginalMember(owner = "client!ya", name = "finalize", descriptor = "()V", line = 433)
    protected void finalize() {
        this.method267(-107);
        field470++;
    }

    @OriginalMember(owner = "client!ya", name = "e", descriptor = "(IIIIII)V", line = 448)
