...
public class class38 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(B)V", line = 39)
