...
public class class38 implements class623 {
    ...
    @OriginalMember(owner = "client!uja", name = "b", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!uja", name = "<init>", descriptor = "()V", line = 195)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(IB)I", line = 32)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(Ljava/awt/Component;BIZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(I[I)V", line = 119)
    ...
    @OriginalMember(owner = "client!uja", name = "a", descriptor = "(III)V", line = 150)
