...
public class class281 extends class421 implements class210 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILvc;II)Z")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(ZLvc;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lvc;I)Lep;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BILvc;)Ln;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lvc;B)V")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(IIIIILa;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZILvc;IILuq;I)V")
