...
public class class281 extends class135 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(II)I", line = 35)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lmo;Lmo;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!aa", name = "e", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIIZI)V", line = 101)
    ...
    @OriginalMember(owner = "client!aa", name = "f", descriptor = "(I)V", line = 113)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIB)Lln;", line = 133)
