...
public class class281 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BI)Lds;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lvm;ILol;IIIII)Llg;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILle;)V")
