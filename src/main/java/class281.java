...
public class class281 extends class46 {
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(CB)I", line = 58)
    ...
    @OriginalMember(owner = "client!wja", name = "g", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!wja", name = "h", descriptor = "(I)V", line = 110)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(III)Z", line = 122)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(ILib;I)V", line = 142)
    ...
    @OriginalMember(owner = "client!wja", name = "c", descriptor = "(I)V", line = 205)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(BC)I", line = 241)
    ...
    @OriginalMember(owner = "client!wja", name = "a", descriptor = "(BLib;)V", line = 265)
