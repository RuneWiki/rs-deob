...
public class class281 implements class126 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZIFIII)[I", line = 17)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZZIFII)[F", line = 29)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IB)Llu;", line = 41)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)Z", line = 56)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZFIIII)[I", line = 72)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IZ)Lta;", line = 92)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lvh;Lvh;Lvh;)V", line = 128)
