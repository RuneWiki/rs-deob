...
public class class281 extends class9 implements ImageProducer {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZILjava/lang/String;)I", line = 14)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 41)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 57)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIBLjava/awt/Graphics;II)V", line = 95)
    ...
    @OriginalMember(owner = "client!uf", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 113)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field4075;
        return this.field4076 == arg0;
    }

    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIIII)V", line = 121)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(IIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!uf", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 168)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field4078;
    }

    @OriginalMember(owner = "client!uf", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 175)
    ...
    @OriginalMember(owner = "client!uf", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 188)
    public final void startProduction(ImageConsumer arg0) {
        this.addConsumer(arg0);
        ++field4079;
    }

    @OriginalMember(owner = "client!uf", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 197)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(B)V", line = 210)
