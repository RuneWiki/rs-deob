...
public class class281 {
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(Lgia;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(B)Lgia;", line = 28)
    ...
    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "(I)V", line = 91)
    public class281(int arg0) {
        this.field4319 = arg0;
    }

    @OriginalMember(owner = "client!gia", name = "<init>", descriptor = "(IIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!gia", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!gia", name = "a", descriptor = "(II)I", line = 67)
    public static int method1904(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!gia", name = "c", descriptor = "(B)V", line = 77)
