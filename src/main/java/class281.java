...
public class class281 extends class406 {
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IZ)Z", line = 4)
    ...
    @OriginalMember(owner = "client!bi", name = "b", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(I)Z", line = 31)
    ...
    @OriginalMember(owner = "client!bi", name = "c", descriptor = "(B)Z", line = 43)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(Lon;II)Ljava/lang/String;", line = 55)
    ...
    @OriginalMember(owner = "client!bi", name = "a", descriptor = "(IB)V", line = 78)
    ...
    @OriginalMember(owner = "client!bi", name = "d", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!bi", name = "e", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!bi", name = "<init>", descriptor = "(II)V", line = 119)
    public class281(int arg0, int arg1) {
        this.field3981 = arg0;
        this.field3976 = arg1;
    }

    @OriginalMember(owner = "client!bi", name = "f", descriptor = "(I)V", line = 128)
