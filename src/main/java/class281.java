...
public class class281 extends class42 {
    ...
    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lee;)V", line = 53)
    public final void method286(class404 arg0) {
        this.field582.method888(arg0);
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Z)V", line = 57)
    public final void method288(boolean arg0) {
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "()Z", line = 60)
    public final boolean method287() {
        return true;
    }

    @OriginalMember(owner = "client!ap", name = "b", descriptor = "()V", line = 65)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "()V", line = 122)
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Lig;Lfg;)V", line = 146)
