...
public class class281 extends class336 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ILat;)V", line = 3)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BI[Ljava/lang/Object;[JI)V", line = 38)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IBI)Z", line = 118)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(II[I[I)V", line = 144)
