...
public class class281 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BIILha;)V", line = 32)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZII)Z", line = 105)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "([[ZIIZBI)V", line = 116)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IILha;I)V", line = 302)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BII)Z", line = 374)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 393)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(IILha;I)Z", line = 458)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIII)V", line = 529)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lag;Lal;)V", line = 573)
