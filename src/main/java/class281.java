...
public class class281 extends class82 {
    ...
    @OriginalMember(owner = "client!rd", name = "h", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "()V", line = 53)
    public class281() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rd", name = "i", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(IILos;)V", line = 71)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILjava/util/Random;[[IIIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(I)V", line = 391)
    ...
    @OriginalMember(owner = "client!rd", name = "c", descriptor = "(II)[I", line = 403)
