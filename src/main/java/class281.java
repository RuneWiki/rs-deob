...
public class class281 extends class101 {
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!tia", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!tia", name = "d", descriptor = "(I)Z", line = 44)
    ...
    @OriginalMember(owner = "client!tia", name = "a", descriptor = "(IZ[BIII[BII)V", line = 58)
