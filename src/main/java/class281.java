...
public class class281 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III)Z", line = 38)
    ...
    @OriginalMember(owner = "client!oh", name = "b", descriptor = "(III)Z", line = 50)
