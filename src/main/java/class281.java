...
public class class281 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Leh;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Leh;I)V", line = 56)
