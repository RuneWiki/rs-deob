...
public abstract class class281 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lgp;Lgp;IIZIZ)I")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIBIII)V")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(ILqj;Lqj;)V")
    ...
    @OriginalMember(owner = "client!aa", name = "c", descriptor = "(IIIII)V")
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IILjava/awt/Canvas;Lkq;BLsr;)Laa;")
    ...
    @OriginalMember(owner = "client!aa", name = "f", descriptor = "(IIIIII)V")
