...
public class class281 {
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILat;)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BI)Lgr;")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Lat;II)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Luk;III)V")
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(III)Lth;")
