...
public class class281 extends class354 {
    ...
    @OriginalMember(owner = "client!je", name = "<init>", descriptor = "()V", line = 7)
    public class281() {
        super(1, true);
    }

    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IZ)V", line = 13)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Luo;IBZLuo;)I", line = 29)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(IZIII)V", line = 127)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(BI)[I", line = 149)
    ...
    @OriginalMember(owner = "client!je", name = "a", descriptor = "(Luu;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!je", name = "b", descriptor = "(B)V", line = 211)
