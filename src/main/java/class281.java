...
public class class281 implements class186 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!mm", name = "c", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)Lqia;", line = 36)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)I", line = 50)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(Lnd;)V", line = 64)
