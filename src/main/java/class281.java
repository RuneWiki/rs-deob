...
public class class281 {
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZIILdda;IZI)V", line = 18)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!sb", name = "a", descriptor = "(ZB)C", line = 58)
