...
public class class281 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lya;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II)Lcq;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(IIIIILya;Lfb;Z)Ll;")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lla;IIZZBIIILfb;Lya;Lya;)Ll;")
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(II)Lmo;")
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lkr;IZLpl;Lok;Lok;)V")
