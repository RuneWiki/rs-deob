...
public class class281 extends class424 {
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "()V", line = 6)
    public class281() {
        super(0, true);
    }
    ...
    @OriginalMember(owner = "client!ei", name = "b", descriptor = "(IB)[I", line = 19)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lrg;BI)V", line = 134)
    ...
    @OriginalMember(owner = "client!ei", name = "d", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BI)V", line = 297)
    ...
    @OriginalMember(owner = "client!ei", name = "c", descriptor = "(I)V", line = 326)
