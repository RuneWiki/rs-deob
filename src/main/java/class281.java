...
public class class281 extends class14 {
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IB)[I", line = 33)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "()V", line = 117)
    public class281() {
        super(0, true);
    }
}
