...
public class class281 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Lwu;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)Z", line = 38)
