...
public class class281 {
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(IIB)Z", line = 27)
    ...
    @OriginalMember(owner = "client!vt", name = "<init>", descriptor = "(III)V", line = 37)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "([IIII[J)V", line = 77)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "(Z)V", line = 134)
