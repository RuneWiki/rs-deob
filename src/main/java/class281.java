...
public class class281 extends class502 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lkp;ILkp;I)V")
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljo;B)I")
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lap;)V")
