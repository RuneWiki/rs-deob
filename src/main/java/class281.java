...
public class class281 extends class671 implements class251 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 23)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)Z", line = 35)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILs;)V", line = 47)
    public static final void method1680(int arg0, class339 arg1) {
        class52.field741[arg0] = arg1;
    }

    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IB)V", line = 53)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Z)V", line = 70)
    public final void method1398(boolean arg0) {
        super.method1398(arg0);
        ++field3728;
    }

    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(B)I", line = 86)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(Lsb;Z)V", line = 97)
    public class281(class93 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z", line = 101)
    ...
    @OriginalMember(owner = "client!jw", name = "c", descriptor = "(Z)I", line = 116)
    ...
    @OriginalMember(owner = "client!jw", name = "d", descriptor = "(B)V", line = 127)
