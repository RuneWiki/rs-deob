...
public abstract class class281 extends class53 {
    ...
    @OriginalMember(owner = "client!jo", name = "EA", descriptor = "()I", line = 3)
    public final int method326() {
        return this.field3948 + this.field3943 + this.field3917;
    }

    @OriginalMember(owner = "client!jo", name = "KA", descriptor = "(IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!jo", name = "i", descriptor = "(IIIIIII)V", line = 19)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "()I", line = 68)
    public final int method325() {
        return this.field3943;
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(FFFFFFLpa;II)V", line = 75)
    ...
    @OriginalMember(owner = "client!jo", name = "CA", descriptor = "(FFFFFFIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!jo", name = "la", descriptor = "()I", line = 195)
    public final int method318() {
        return this.field3934;
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(FFFFFF)Z", line = 199)
    ...
    @OriginalMember(owner = "client!jo", name = "ma", descriptor = "()I", line = 353)
    public final int method322() {
        return this.field3935 + this.field3934 + this.field3937;
    }

    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Law;II)V", line = 363)
