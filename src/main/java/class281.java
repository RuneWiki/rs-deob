...
public class class281 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Ljava/lang/Throwable;B)Ljava/lang/String;", line = 8)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IIIIIIIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(B)V", line = 108)
