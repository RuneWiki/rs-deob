...
public class class281 extends class512 {
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 4)
    public class281() {
        super(0, true);
    }

    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!sj", name = "c", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IB)[I", line = 962)
