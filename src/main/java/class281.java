...
public abstract class class281 extends class435 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(CI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IBI)Z", line = 64)
    ...
    @OriginalMember(owner = "client!we", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ICLjava/lang/String;)I", line = 84)
