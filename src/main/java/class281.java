...
public class class281 extends class513 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(IBI)Z", line = 14)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLjava/awt/Canvas;Ld;II)Lha;", line = 29)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(B)J", line = 92)
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!cl", name = "f", descriptor = "(I)I", line = 117)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Throwable;)V", line = 130)
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(IJ)V", line = 203)
