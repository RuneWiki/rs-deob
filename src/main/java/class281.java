...
public class class281 implements class683 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(II)I", line = 90)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZ)I", line = 112)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZII)V", line = 151)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lkba;I)V", line = 182)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BII)V", line = 241)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(III)V", line = 267)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II)I", line = 293)
