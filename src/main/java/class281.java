...
public class class281 {
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(IBLfh;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ZLqn;)V")
    ...
    @OriginalMember(owner = "client!we", name = "a", descriptor = "(ILfh;)V")
