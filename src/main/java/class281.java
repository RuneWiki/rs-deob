...
public abstract class class281 {
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IBI)Z", line = 21)
    ...
    @OriginalMember(owner = "client!wha", name = "a", descriptor = "(IIILlv;Llv;)V", line = 54)
