...
public class class281 {
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(II)Lgea;", line = 31)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IB)Z", line = 97)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lmp;ILla;)V", line = 113)
