...
public abstract class class281 {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 7)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(BII)I", line = 30)
    ...
    @OriginalMember(owner = "client!s", name = "b", descriptor = "(II)Log;", line = 44)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(IIB)I", line = 61)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(I)V", line = 93)
    public static void method1854(int arg0) {
        int var1 = 49 / ((15 - arg0) / 40);
        field3935 = null;
    }

    @OriginalMember(owner = "client!s", name = "<init>", descriptor = "(III[[I)V", line = 103)
