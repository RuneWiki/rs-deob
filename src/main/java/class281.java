...
public class class281 extends class513 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Z[Ljava/lang/String;)[Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(IIIIIII)Z", line = 47)
    ...
    @OriginalMember(owner = "client!ce", name = "<init>", descriptor = "(II)V", line = 112)
