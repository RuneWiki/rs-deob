...
public class class584 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lqa;ILsb;)I", line = 15)
    ...
    @OriginalMember(owner = "client!jc", name = "toString", descriptor = "()Ljava/lang/String;", line = 52)
    public final String toString() {
        field8324++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 60)
