...
public class class584 extends class143 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mda", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mda", name = "d", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Lcea;Lhda;)V", line = 76)
