...
public class class584 extends class66 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BII)Z", line = 39)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II[II)V", line = 74)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ZZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(BZLjava/lang/String;)V", line = 137)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(II[II)V", line = 210)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(IIIIIIIII)V", line = 225)
