...
public class class584 extends class442 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([B[I[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!op", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lnia;Lhw;[Lfm;[I[I)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(CIIIZLaa;II)V")
