...
public class class584 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(BIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IZ)I", line = 147)
