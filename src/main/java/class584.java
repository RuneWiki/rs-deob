...
public class class584 extends class642 {
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lr;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "()V", line = 40)
    public class584() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(II)[I", line = 47)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILgk;B)V", line = 116)
