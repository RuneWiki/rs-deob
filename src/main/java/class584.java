...
public abstract class class584 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(B)V", line = 28)
    public void method182(byte arg0) {
        int var2 = -104 % ((arg0 - 66) / 54);
        field8306++;
    }

    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!or", name = "e", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)V", line = 86)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lfo;)V", line = 128)
