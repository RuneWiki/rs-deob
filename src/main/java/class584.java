...
public class class584 {
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lha;[II)V", line = 136)
    public static final void method3124(class570 arg0, int[] arg1, int arg2) {
        method3127(arg0, arg1, 0, arg1.length, arg2, null, null);
    }

    @OriginalMember(owner = "client!vw", name = "b", descriptor = "(I)Z", line = 140)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "()V", line = 215)
    public static void method3126() {
        field7387 = null;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lha;[IIII[I[I)V", line = 221)
    ...
    @OriginalMember(owner = "client!vw", name = "a", descriptor = "(Lha;[II[I[I)V", line = 257)
    ...
    @OriginalMember(owner = "client!vw", name = "b", descriptor = "()V", line = 260)
    private static final void method3129() {
        field7388 = 0;
    }

    @OriginalMember(owner = "client!vw", name = "a", descriptor = "([III)V", line = 270)
