...
public class class584 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(II[B[BII)I", line = 4)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IIBIIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "([BB[BIII)I", line = 670)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "([B)V", line = 819)
