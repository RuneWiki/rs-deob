...
public class class584 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!pf", name = "finalize", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Lrea;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!pf", name = "<init>", descriptor = "(Lbi;JI)V", line = 68)
