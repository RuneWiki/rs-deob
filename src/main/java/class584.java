...
public class class584 extends class639 {
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(Z)I", line = 26)
    ...
    @OriginalMember(owner = "client!sn", name = "g", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(I)I", line = 55)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(I)J", line = 67)
