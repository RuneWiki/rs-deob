...
public class class584 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIILr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZII[[ZII)V", line = 84)
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(I)Lm;", line = 281)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(II)Z", line = 310)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IZIII)V", line = 321)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILr;II)Z", line = 363)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(BILr;I)V", line = 440)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZLig;)Lsv;", line = 516)
    ...
    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(I)V", line = 541)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lln;Lum;)V", line = 572)
