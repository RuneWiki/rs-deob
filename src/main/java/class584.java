...
public class class584 extends class619 {
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIII[Lkh;Z)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Lkka;B)V")
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(BLfca;)Ljca;")
