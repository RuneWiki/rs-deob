...
public class class584 extends class307 implements class719 {
    ...
    @OriginalMember(owner = "client!dn", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(B)J", line = 15)
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!dn", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!dn", name = "<init>", descriptor = "(Leq;I[BI)V", line = 69)
    public class584(class357 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field8116 = arg1;
    }

    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II[Ljava/lang/Object;I[J)V", line = 81)
    ...
    @OriginalMember(owner = "client!dn", name = "e", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II[BI)V", line = 211)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(I)I", line = 227)
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Ljava/awt/Component;B)Lnt;", line = 238)
