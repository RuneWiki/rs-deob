...
public class class584 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILrg;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!kfa", name = "<init>", descriptor = "(Lqj;)V", line = 143)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(II)Z", line = 51)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ZZIIII)V", line = 67)
