...
public class class584 extends class577 implements class231 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILqa;IB)Z")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lqa;IZIILco;I)V")
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(ILqa;)Lin;")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lqa;Luh;IIIIIZIIIIIII)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BILqa;)Lr;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lqa;I)Lpl;")
