...
public class class584 extends class325 {
    ...
    @OriginalMember(owner = "client!nda", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(IIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(BI)[I", line = 68)
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "()V", line = 90)
    public class584() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Laj;I)I", line = 99)
