...
public class class584 extends class493 {
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(Luv;Lmt;)V")
    public class584(class367 arg0, class399 arg1) {
        super(arg0);
        this.field8177 = arg1;
    }

    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(ILji;Z)V")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IILbl;)V")
