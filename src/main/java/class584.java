...
public class class584 extends class214 {
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "()V", line = 75)
    public class584() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ap", name = "b", descriptor = "(ZII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ap", name = "f", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ap", name = "c", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!ap", name = "d", descriptor = "(II)I", line = 66)
    public static int method3367(int arg0, int arg1) {
        return arg0 ^ arg1;
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(ILofa;I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(IB)[I", line = 146)
