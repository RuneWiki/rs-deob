...
public class class584 extends class626 {
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "([B)V", line = 4)
    public class584(byte[] arg0) {
        this.field8238 = arg0;
    }

    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(B)V", line = 30)
