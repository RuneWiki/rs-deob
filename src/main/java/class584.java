...
public class class584 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ILjava/io/File;I)[B", line = 23)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lmf;I)I", line = 42)
    ...
    @OriginalMember(owner = "client!eb", name = "toString", descriptor = "()Ljava/lang/String;", line = 64)
