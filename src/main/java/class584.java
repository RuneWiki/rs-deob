...
public class class584 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([BI)V", line = 6)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Ljaa;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "(Ljaa;Ljaclib/memory/Buffer;)V", line = 21)
