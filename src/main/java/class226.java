...
public class class226 extends class538 implements class514 {
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "(Llj;I[BIZ)V", line = 4)
    public class226(class565 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field3144 = arg1;
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(III[B)V", line = 12)
    ...
    @OriginalMember(owner = "client!kw", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!kw", name = "d", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!kw", name = "c", descriptor = "(I)J", line = 53)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)I", line = 78)
