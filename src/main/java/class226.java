...
public class class226 extends class604 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IBIZ)I", line = 247)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)V", line = 274)
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(B)V", line = 289)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BJ)V", line = 385)
    ...
    @OriginalMember(owner = "client!qb", name = "e", descriptor = "(I)V", line = 414)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)V", line = 432)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(IIIIIFFF)V", line = 469)
