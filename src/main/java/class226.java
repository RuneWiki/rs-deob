...
public class class226 extends class298 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(II)[[I", line = 4)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IILvt;)V", line = 70)
    ...
    @OriginalMember(owner = "client!lb", name = "b", descriptor = "(II)Z", line = 115)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "()V", line = 218)
    public class226() {
        super(1, false);
    }

    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(I)Z", line = 137)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZI)I", line = 149)
    public static final int method1247(boolean arg0, int arg1) {
        ++field3140;
        return arg0 ? -87 : arg1 & 255;
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IZ)[I", line = 166)
