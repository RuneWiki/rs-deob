...
public class class226 extends class60 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(III)V", line = 11)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(IILep;IIBIIIII)Z", line = 56)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(III)V", line = 412)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(III)V", line = 425)
