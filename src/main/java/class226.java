...
public class class226 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IIIIZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILok;)V", line = 73)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(I)Llq;", line = 87)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Z)Llq;", line = 118)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "()V", line = 138)
    public class226() {
    }

    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lok;)V", line = 143)
