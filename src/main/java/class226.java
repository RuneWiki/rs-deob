...
public abstract class class226 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(FFIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIII)V", line = 13)
    public final void method1498(int arg0, int arg1, int arg2, int arg3) {
        this.method588(arg0, arg1, arg2, arg3, 0, 0, 1);
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(FFII)V", line = 21)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(FFIILep;II)V", line = 24)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)V", line = 27)
    public final void method1501(int arg0, int arg1) {
        this.method587(arg0, arg1, 0, 0, 1);
    }

    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(FFFFIILep;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(FFFFIIIII)V", line = 60)
