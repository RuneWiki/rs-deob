...
public class class226 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lvc;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Ljava/lang/String;)I", line = 95)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "()I", line = 110)
    public final int method1539() {
        return this.field3255 - 1;
    }

    @OriginalMember(owner = "client!ir", name = "b", descriptor = "()I", line = 113)
    public final int method1540() {
        return this.field3250;
    }

    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lvc;IZLjava/awt/Component;)V", line = 172)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lvc;Ljava/lang/String;IIIZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!ir", name = "c", descriptor = "()V", line = 140)
    public static void method1542() {
        field3257 = null;
    }

    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lvc;Ljava/lang/String;[IIIIZ)V", line = 145)
