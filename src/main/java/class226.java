...
public class class226 extends class42 {
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "([B)V", line = 3)
    public class226(byte[] arg0) {
        this.field3407 = arg0;
    }

    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Z)Ltg;", line = 11)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(ILci;I)Lpb;", line = 22)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(I)I", line = 65)
