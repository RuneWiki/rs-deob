...
public class class226 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILnp;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)V", line = 94)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ILnp;)V", line = 111)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)Z", line = 158)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(FB)F", line = 262)
