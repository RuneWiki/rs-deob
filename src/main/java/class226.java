...
public class class226 implements class373 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZIIIFI)[I", line = 27)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(FIZIZI)[I", line = 44)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(JI)V", line = 56)
    ...
    @OriginalMember(owner = "client!pn", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(II)Lnn;", line = 157)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZI)Z", line = 182)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IIIZFI)[F", line = 195)
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lns;Lns;Lns;)V", line = 211)
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IB)Lij;", line = 423)
