...
public class class226 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/lang/Class;B[Ljava/lang/Class;Ljava/lang/String;)Lae;", line = 3)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IILjava/lang/Object;II)Lae;", line = 13)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIIII)Lae;", line = 44)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;B)Lae;", line = 55)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(BLjava/awt/Frame;)Lae;", line = 85)
    public final class254 method1404(byte arg0, Frame arg1) {
        return arg0 == -24 ? this.method1400(7, 0, arg1, arg0 + 24, 0) : null;
    }

    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IILjava/awt/Point;I[ILjava/awt/Component;)Lae;", line = 151)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/io/File;I[B)Z", line = 184)
    ...
    @OriginalMember(owner = "client!ew", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 207)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Ljava/lang/String;I)Lsr;", line = 217)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(Ljava/lang/String;I)Lae;", line = 259)
    ...
    @OriginalMember(owner = "client!ew", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 698)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lae;", line = 284)
    ...
    @OriginalMember(owner = "client!ew", name = "run", descriptor = "()V", line = 300)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;)Lsr;", line = 598)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(ZILjava/lang/String;)Lae;", line = 643)
    ...
    @OriginalMember(owner = "client!ew", name = "b", descriptor = "(I)V", line = 659)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIZLjava/lang/String;)Lae;", line = 680)
