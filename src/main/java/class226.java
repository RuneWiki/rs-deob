...
public class class226 extends class28 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IB)V", line = 39)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(Ljava/lang/String;IZ)V", line = 52)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I[IZ)V", line = 124)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIFII)V", line = 246)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 357)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIII)V", line = 370)
    ...
    @OriginalMember(owner = "client!tw", name = "<init>", descriptor = "(Lle;IIIII)V", line = 392)
