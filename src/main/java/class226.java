...
public class class226 extends class544 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILjava/lang/String;Ljava/io/File;)V", line = 6)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(II)Ldj;", line = 18)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(III[[ZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIIIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(BS)V", line = 328)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(Z[Let;I)V", line = 349)
    ...
    @OriginalMember(owner = "client!jl", name = "<init>", descriptor = "(Lmh;Lae;Lcba;[I)V", line = 441)
