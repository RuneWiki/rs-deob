...
public class class226 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)Lok;", line = 8)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 32)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)Lok;", line = 72)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Z)[Lrd;", line = 97)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lok;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "()V", line = 198)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lvd;IIIII)V", line = 213)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(Z)V", line = 280)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "()V", line = 322)
    public class226() {
        this.field3200.field3360 = this.field3200;
        this.field3200.field3354 = this.field3200;
    }

    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(B)V", line = 308)
