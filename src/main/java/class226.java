...
public class class226 extends class100 implements class448 {
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lza;Ler;IIIIIZIIIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILza;BI)Z", line = 26)
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(BLza;)V", line = 46)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(Ljk;III)V", line = 69)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ILza;)V", line = 101)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)I", line = 114)
    public final int method48(byte arg0) {
        ++field3046;
        return arg0 != -70 ? -71 : this.field3031.field5977;
    }

    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(Z)V", line = 125)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(B)Z", line = 148)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IZIII)V", line = 164)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)I", line = 280)
    ...
    @OriginalMember(owner = "client!jg", name = "f", descriptor = "(I)I", line = 294)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IBLza;)Le;", line = 308)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BLza;)V", line = 325)
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(BLza;)Luc;", line = 338)
