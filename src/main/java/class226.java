...
public class class226 {
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(IIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(B)Lsr;", line = 64)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILvh;B)Z", line = 76)
    ...
    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(I)V", line = 151)
    public class226(int arg0) {
        this.field3170 = arg0;
    }

    @OriginalMember(owner = "client!sr", name = "<init>", descriptor = "(IIIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!sr", name = "a", descriptor = "(ILsr;)V", line = 125)
