...
public class class226 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZILod;I[I)Lwe;", line = 56)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 75)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 137)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(JI)V", line = 206)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Ljava/lang/Object;BJ)V", line = 219)
    ...
    @OriginalMember(owner = "client!ng", name = "d", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(ILgm;)V", line = 257)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(I)V", line = 312)
    ...
    @OriginalMember(owner = "client!ng", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 283)
    ...
    @OriginalMember(owner = "client!ng", name = "f", descriptor = "(I)I", line = 328)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(B)I", line = 339)
    public final int method1547(byte arg0) {
        field3327++;
        return arg0 < 88 ? -27 : this.field3316;
    }

    @OriginalMember(owner = "client!ng", name = "g", descriptor = "(I)V", line = 355)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IJILjava/lang/Object;)V", line = 421)
