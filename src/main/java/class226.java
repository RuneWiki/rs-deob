...
public class class226 extends class305 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 5)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZLtq;Lns;)V", line = 62)
    ...
    @OriginalMember(owner = "client!gq", name = "h", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 101)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILtq;)V", line = 124)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILtq;B)Lns;", line = 147)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BZLtq;Lhm;III)V", line = 161)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ILki;)Z", line = 178)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)I", line = 200)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(Ltq;I)Lcj;", line = 229)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lvg;Lbg;III)V", line = 263)
    ...
    @OriginalMember(owner = "client!gq", name = "g", descriptor = "(I)V", line = 649)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)V", line = 667)
    ...
    @OriginalMember(owner = "client!gq", name = "i", descriptor = "(I)V", line = 680)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IIIII)V", line = 696)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(II)V", line = 736)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ltq;III)Z", line = 801)
    ...
    @OriginalMember(owner = "client!gq", name = "finalize", descriptor = "()V", line = 817)
