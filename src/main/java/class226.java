...
public class class226 {
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(IBLje;)V", line = 205)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(Lkd;Lwaa;Lim;IIIII)V", line = 247)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILla;I)Lwfa;", line = 231)
