...
public class class226 extends class384 {
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(IIZ)V")
    ...
    @OriginalMember(owner = "client!jda", name = "a", descriptor = "(Lke;BI)V")
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "(Lln;)V")
