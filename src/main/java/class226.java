...
public class class226 extends Canvas {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!km", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 32)
    public final void update(Graphics arg0) {
        field3187++;
        this.field3188.update(arg0);
    }

    @OriginalMember(owner = "client!km", name = "b", descriptor = "(III)Z", line = 40)
    ...
    @OriginalMember(owner = "client!km", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 52)
    public final void paint(Graphics arg0) {
        field3185++;
        this.field3188.paint(arg0);
    }

    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 61)
