...
public class class226 extends class28 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lfd;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(Lfd;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IB)Z", line = 48)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(B)V", line = 71)
