...
public class class226 extends class666 {
    ...
    @OriginalMember(owner = "client!kw", name = "h", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!kw", name = "<init>", descriptor = "()V", line = 387)
    public class226() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(II)[I", line = 35)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(ILiaa;Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!kw", name = "a", descriptor = "(B)V", line = 359)
