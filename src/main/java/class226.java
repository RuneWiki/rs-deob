...
public abstract class class226 extends class22 {
    ...
    @OriginalMember(owner = "client!qc", name = "c", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!qc", name = "d", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(IIII)V", line = 81)
