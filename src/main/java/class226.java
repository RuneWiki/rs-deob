...
public class class226 implements class60 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lcu;Z)V")
