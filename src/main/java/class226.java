...
public class class226 extends class278 {
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ng", name = "g", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 263)
    public class226() {
        super(2, false);
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Llh;II)V", line = 288)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)[[I", line = 324)
