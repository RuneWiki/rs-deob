...
public class class226 extends class201 {
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(I)[B", line = 10)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "()V", line = 31)
    ...
    @OriginalMember(owner = "client!ew", name = "a", descriptor = "(IIII)I", line = 47)
    ...
    @OriginalMember(owner = "client!ew", name = "d", descriptor = "(I)I", line = 70)
