...
public abstract class class226 extends class513 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(Lep;)V", line = 52)
    public class226(class371 arg0) {
        this.field3160 = arg0;
    }

    @OriginalMember(owner = "client!gga", name = "f", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!gga", name = "g", descriptor = "(I)I", line = 71)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(B)Z", line = 82)
    ...
    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(III)Z", line = 100)
    ...
    @OriginalMember(owner = "client!gga", name = "c", descriptor = "(III)Z", line = 115)
