...
public class class226 extends class258 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIZI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lim;B)V", line = 37)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLmc;)V", line = 48)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)V", line = 62)
