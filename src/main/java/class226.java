...
public class class226 extends class553 {
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Lps;Lft;IIIIIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(III)Lwj;", line = 16)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIZ)Z", line = 37)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)Llf;", line = 64)
