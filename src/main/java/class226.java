...
public class class226 extends class371 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IZII)I", line = 5)
    ...
    @OriginalMember(owner = "client!id", name = "<init>", descriptor = "()V", line = 38)
    public class226() {
        super(0, false);
    }
    ...
    @OriginalMember(owner = "client!id", name = "g", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!id", name = "c", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(B)I", line = 87)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BI)[[I", line = 100)
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(IBLps;)V", line = 165)
