...
public class class226 extends class249 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "([ILwp;I[I[I)V")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILaj;ILd;Ljava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILgaa;I)Z")
