...
public class class226 extends class446 {
    ...
    @OriginalMember(owner = "client!jg", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(III)V", line = 26)
    ...
    @OriginalMember(owner = "client!jg", name = "<init>", descriptor = "(Lda;Lai;)V", line = 85)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(B)Z", line = 118)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(IILac;)V", line = 131)
    ...
    @OriginalMember(owner = "client!jg", name = "c", descriptor = "(I)V", line = 143)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(ZB)V", line = 154)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(BZ)V", line = 173)
    ...
    @OriginalMember(owner = "client!jg", name = "a", descriptor = "(II)I", line = 190)
