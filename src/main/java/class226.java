...
public class class226 extends class403 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(BILbt;)V", line = 100)
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(Lbt;B)V", line = 166)
    ...
    @OriginalMember(owner = "client!mn", name = "b", descriptor = "(Lbt;B)Lpd;", line = 224)
