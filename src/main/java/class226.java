...
public class class226 {
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IILqa;IZIIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(I[Lsaa;IIII)V", line = 227)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLqa;I)Z", line = 139)
