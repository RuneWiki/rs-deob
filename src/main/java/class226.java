...
public class class226 {
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IILhba;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(II)Lgb;", line = 63)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(II)I", line = 112)
    public static final int method1414(int arg0, int arg1) {
        return class130.field1565 == null ? 0 : class130.field1565[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(IB)V", line = 115)
    ...
    @OriginalMember(owner = "client!aia", name = "a", descriptor = "(III)V", line = 132)
    ...
    @OriginalMember(owner = "client!aia", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!aia", name = "<init>", descriptor = "(Lsaa;ILfp;Lfp;)V", line = 190)
    ...
    @OriginalMember(owner = "client!aia", name = "c", descriptor = "(II)Z", line = 179)
