...
public class class226 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ltk;Z)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Ltk;)Z")
    ...
    @OriginalMember(owner = "client!fo", name = "b", descriptor = "(Ltk;)V")
    public final void method1228(class78 arg0) {
        this.method1224(arg0, true);
    }

    @OriginalMember(owner = "client!fo", name = "<init>", descriptor = "(Lql;)V")
