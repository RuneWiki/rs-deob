...
public class class226 implements Runnable {
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(ILev;)V", line = 10)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B[[BLnd;)V", line = 26)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!rd", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(II)V", line = 117)
    ...
    @OriginalMember(owner = "client!rd", name = "<init>", descriptor = "()V", line = 157)
    public class226() {
        this.field3253.setDaemon(true);
        this.field3253.start();
    }

    @OriginalMember(owner = "client!rd", name = "a", descriptor = "(Ljava/lang/String;I)Lha;", line = 137)
    ...
    @OriginalMember(owner = "client!rd", name = "run", descriptor = "()V", line = 170)
