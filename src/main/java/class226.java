...
public class class226 implements class236 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)Ltca;", line = 3)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lr;B)V", line = 15)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(I)V", line = 110)
    public class226(int arg0) {
        this.field2940 = arg0;
    }

    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(IIIII)V", line = 119)
