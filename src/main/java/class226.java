...
public class class226 extends class675 {
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(BZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IZ)I", line = 27)
    ...
    @OriginalMember(owner = "client!cha", name = "b", descriptor = "(B)Z", line = 128)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(B)V", line = 139)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Liw;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ZI)V", line = 343)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(III)V", line = 356)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(I)V", line = 366)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IIILjava/lang/Class;)V", line = 380)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(Lfia;IZ)V", line = 406)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(ILrv;)V", line = 421)
    ...
    @OriginalMember(owner = "client!cha", name = "<init>", descriptor = "(Lkv;)V", line = 455)
