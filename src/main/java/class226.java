...
public class class226 extends class25 {
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 6)
    public static final boolean method1445(String arg0, byte arg1) {
        field3251++;
        return arg1 == 106 ? class14.method64(10, arg0, true, -123) : true;
    }

    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(IC)C", line = 17)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!gca", name = "a", descriptor = "(Ljava/lang/Throwable;Z)Ljava/lang/String;", line = 66)
    ...
    @OriginalMember(owner = "client!gca", name = "b", descriptor = "(B)V", line = 141)
