...
public class class226 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lec;IZ)V")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IZIIB)Lwk;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Lst;ZI)V")
