...
public class class226 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ILjo;IIILsk;ILdw;)V", line = 43)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IB)Z", line = 133)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 144)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)V", line = 159)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Z)V", line = 171)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(Z)V", line = 189)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BZI)V", line = 203)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lal;ILmg;)V", line = 224)
    public class226(class66 arg0, int arg1, class101 arg2) {
        this.field3215 = arg2;
        this.field3215.method753(1, -108);
    }

    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(IB)Lwv;", line = 239)
