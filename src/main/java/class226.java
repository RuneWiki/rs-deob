...
public class class226 {
    ...
    @OriginalMember(owner = "client!gga", name = "a", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!gga", name = "toString", descriptor = "()Ljava/lang/String;", line = 25)
    public final String toString() {
        field3035++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gga", name = "<init>", descriptor = "(II)V", line = 33)
    public class226(int arg0, int arg1) {
        this.field3032 = arg0;
    }

    @OriginalMember(owner = "client!gga", name = "b", descriptor = "(B)V", line = 44)
