...
public class class226 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Z[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)[B", line = 52)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(IZII)I", line = 112)
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)V", line = 130)
