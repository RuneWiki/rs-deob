...
public class class415 extends class35 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIZLkp;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lfk;[I)V")
    public final void method378(class462 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!ot", name = "SA", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IIIIIII[[ZLkp;[I[I)V")
                ...
                if (arg7[var16 - arg3][var17 - arg4]) {
                    if (this.field6204[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field6780; ++var23) {
                            ...
                            } else if (var21.field6784 != null && var21.field6784[var23] != -1) {
    ...
    @OriginalMember(owner = "client!ot", name = "O", descriptor = "(IILj;)Lj;")
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Lj;IIIIZ)Z")
    public final boolean method369(class377 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IILkp;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lo;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ot", name = "U", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(IIIIIII[[ZLkp;[I[I)V")
