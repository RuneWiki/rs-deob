...
public class class415 extends class400 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!et", name = "fa", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!et", name = "<init>", descriptor = "(Lii;Loq;[Ltba;[I[I)V")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "([B[IIIIIIIIIIILaa;II)V")
    ...
    @OriginalMember(owner = "client!et", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(CIIIZLaa;II)V")
