...
public class class415 extends class397 {
    ...
    @OriginalMember(owner = "client!pe", name = "e", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "()V", line = 24)
    public class415() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(Lae;I)Lra;", line = 34)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIZ)I", line = 45)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(II)[I", line = 60)
