...
public class class415 extends class203 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZLdh;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lac;Z)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BLdh;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ldh;I)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZFIILda;)V")
