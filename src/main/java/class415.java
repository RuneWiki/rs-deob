...
public class class415 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Lwf;II)V", line = 5)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(B)I", line = 195)
    public final int method2641(byte arg0) {
        field6095++;
        return arg0 > -20 ? -125 : this.field6099 & 0x3FFF;
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(II)Lrc;", line = 209)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIB)Z", line = 234)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(II)V", line = 376)
    ...
    @OriginalMember(owner = "client!vr", name = "b", descriptor = "(B)V", line = 387)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(IIIII)V", line = 400)
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(Z)V", line = 420)
