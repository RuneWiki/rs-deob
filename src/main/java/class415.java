...
public class class415 extends class386 {
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ler;II[BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZII)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZB)V", line = 65)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(Z)V", line = 91)
