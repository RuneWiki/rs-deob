...
public class class415 extends class27 {
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(IIIIII[[[BIILpe;IIB)V")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(ILpe;BI)Z")
    ...
    @OriginalMember(owner = "client!ca", name = "a", descriptor = "(Lug;III[Z)Z")
