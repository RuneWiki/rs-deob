...
public class class415 {
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILoea;)V", line = 8)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(Loea;ILoo;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!nv", name = "b", descriptor = "(ILoea;)V", line = 194)
    ...
    @OriginalMember(owner = "client!nv", name = "c", descriptor = "(ILoea;)V", line = 215)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(I)V", line = 232)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILjava/lang/String;)V", line = 245)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(ILoea;I)V", line = 366)
    ...
    @OriginalMember(owner = "client!nv", name = "a", descriptor = "(IBLoea;)V", line = 722)
