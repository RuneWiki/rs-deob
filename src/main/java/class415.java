...
public class class415 extends class544 {
    ...
    @OriginalMember(owner = "client!np", name = "c", descriptor = "(I)Lf;")
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lvi;)V")
    public class415(class459 arg0) {
        this.field5390 = arg0;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Let;III)V")
