...
public class class415 extends class354 {
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lwo;)V")
    public class415(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(ILwo;)V")
    public class415(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILha;I)Liea;")
