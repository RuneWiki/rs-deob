...
public class class415 extends class213 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Ljja;I)V")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "()Lfq;")
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "()Lfq;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIII)Ltia;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(DBI)Ljja;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lha;BLcn;)V")
    ...
    @OriginalMember(owner = "client!hf", name = "h", descriptor = "(I)Ljja;")
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Lla;ZLjava/lang/String;Z)Lkda;")
