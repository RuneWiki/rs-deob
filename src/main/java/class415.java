...
public class class415 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lfia;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILrv;)Lvia;", line = 23)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(Lkv;)V", line = 282)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(III)Z", line = 52)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ZIIZII)V", line = 63)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)Z", line = 123)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(Lnba;B)V", line = 136)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(ILiw;)V", line = 211)
    ...
    @OriginalMember(owner = "client!sg", name = "b", descriptor = "(III)I", line = 256)
