...
public class class415 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(ZZIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(III)Z", line = 96)
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)V", line = 140)
