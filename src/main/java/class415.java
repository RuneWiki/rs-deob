...
public class class415 {
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(Lug;IIBII)Lnq;")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILt;IIII)Lt;")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILfh;)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(ILfh;I)V")
    ...
    @OriginalMember(owner = "client!id", name = "a", descriptor = "(BIIBIIILt;)Lt;")
