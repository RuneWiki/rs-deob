...
public class class415 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(III)Lsp;", line = 9)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!vv", name = "c", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(Z)V", line = 68)
