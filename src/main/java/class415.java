...
public class class415 extends class340 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BI)S", line = 8)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IBIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLfh;)Lrk;", line = 69)
    ...
    @OriginalMember(owner = "client!of", name = "b", descriptor = "(IIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!of", name = "<init>", descriptor = "(Ltt;II[B)V", line = 108)
