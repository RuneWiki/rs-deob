...
public class class415 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILkh;I)V")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IBLko;Ljava/awt/Canvas;Lja;I)Luo;")
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IILkh;I)V")
