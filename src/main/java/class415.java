...
public class class415 implements class205 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)Lww;", line = 15)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ldc;I)Lgm;", line = 32)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(I)V", line = 44)
