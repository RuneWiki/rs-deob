...
public class class415 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IILeo;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ic", name = "<init>", descriptor = "(Lpo;Llo;Lwa;IIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!ic", name = "b", descriptor = "(I)V", line = 40)
