...
public class class415 {
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IIIIIZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 71)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(IB)Lbk;", line = 90)
    ...
    @OriginalMember(owner = "client!lj", name = "a", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!lj", name = "<init>", descriptor = "(ILlt;Llt;)V", line = 146)
