...
public class class415 extends class338 {
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lfu;Ls;)V", line = 53)
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Ltp;)V", line = 85)
    public final void method188(class375 arg0) {
        this.field4685.method303(arg0);
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "()V", line = 90)
    ...
    @OriginalMember(owner = "client!w", name = "b", descriptor = "()Z", line = 97)
    public final boolean method191() {
        return true;
    }

    @OriginalMember(owner = "client!w", name = "a", descriptor = "(Z)V", line = 103)
    public final void method190(boolean arg0) {
    }

    @OriginalMember(owner = "client!w", name = "b", descriptor = "(Z)V", line = 105)
