...
public class class415 implements class378 {
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILg;I)V")
    public final void method2575(int arg0, class433 arg1, int arg2) {
        this.method2576(arg0, arg1, 0, arg2);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILg;II)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILjo;)V")
    public final void method2578(int arg0, class218 arg1) {
        this.method2580(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILvf;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "<init>", descriptor = "(Lql;)V")
    ...
    @OriginalMember(owner = "client!vr", name = "a", descriptor = "(ILjo;I)V")
