...
public class class415 extends class741 {
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(III)V", line = 37)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!sea", name = "d", descriptor = "(I)V", line = 93)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IZ)V", line = 106)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IILml;)V", line = 117)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!sea", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!sea", name = "c", descriptor = "(I)V", line = 164)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Lsga;Lae;Loca;)V", line = 193)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 210)
