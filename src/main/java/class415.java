...
public class class415 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II[III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)Lah;", line = 62)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)Z", line = 110)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IBIIIIILvb;III)Z", line = 122)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(I)V", line = 469)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lod;Lm;)V", line = 486)
