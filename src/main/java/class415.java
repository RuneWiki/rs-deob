...
public class class415 extends InputStream {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IIZ)I")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(III)Lbga;")
    ...
    @OriginalMember(owner = "client!nn", name = "read", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lsr;[II[III)Laba;")
