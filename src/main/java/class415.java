...
public class class415 {
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(Lnf;Lnf;II)Lgo;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(ILnf;Lnf;ZB)Lgo;")
    ...
    @OriginalMember(owner = "client!nd", name = "a", descriptor = "(II)Lap;")
    ...
    @OriginalMember(owner = "client!nd", name = "<init>", descriptor = "(Lpn;Lee;)V")
