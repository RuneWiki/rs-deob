...
public class class415 extends class331 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(CI)I", line = 3)
    ...
    @OriginalMember(owner = "client!oa", name = "e", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IILdg;)V", line = 61)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILtq;)V", line = 127)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IC)I", line = 176)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILdg;)V", line = 204)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIII)V", line = 230)
