...
public class class415 extends class425 {
    ...
    @OriginalMember(owner = "client!oa", name = "o", descriptor = "Lun;")
    public class243 field5916;

    @OriginalMember(owner = "client!oa", name = "z", descriptor = "Lad;")
    public class244 field5927;

    @OriginalMember(owner = "client!oa", name = "x", descriptor = "Lbg;")
    public class272 field5925;

    @OriginalMember(owner = "client!oa", name = "D", descriptor = "Lf;")
    public class452 field5931;

    @OriginalMember(owner = "client!oa", name = "B", descriptor = "[I")
    public static int[] field5929;

    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(Lml;I)V")
    public static final void method2612(class219 arg0, int arg1) {
        field5935++;
        class443 var2 = null;
        try {
            if (arg1 <= 100) {
            ...
            class156 var3 = arg0.method1525(0);
            while (var3.field2298 == 0) {
                class259.method1790((byte) -86, 1L);
            }
            if (var3.field2298 == 1) {
                var2 = (class443) var3.field2295;
                class130 var4 = class101.method589(false);
                var2.method2766(var4.field1851, -7120, 0, var4.field1880);
            }
    ...
    public static final boolean method2614(int arg0) {
        field5934++;
        if (arg0 != 0) {
            field5937 = null;
        }
        return class381.field5412 > 0;
    }

    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V")
    public final void method2615(int arg0) {
        if (arg0 > -54) {
            method2612((class219) null, -117);
        }
        this.field5916 = null;
        field5936++;
        this.field5925 = null;
