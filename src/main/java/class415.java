...
public class class415 implements Runnable {
    ...
    @OriginalMember(owner = "client!pp", name = "e", descriptor = "()J", line = 3)
    public final long method3308() {
        return this.field6575;
    }

    @OriginalMember(owner = "client!pp", name = "a", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "()V", line = 20)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lpha;)V", line = 26)
    ...
    @OriginalMember(owner = "client!pp", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class415(int arg0, class63 arg1) {
        this.field6579 = arg0;
        this.field6576 = arg1;
    }

    @OriginalMember(owner = "client!pp", name = "f", descriptor = "()Z", line = 52)
    public final boolean method3313() {
        return this.field6583 == null || !this.field6580 && this.field6583.method1590(3);
    }

    @OriginalMember(owner = "client!pp", name = "b", descriptor = "()V", line = 56)
