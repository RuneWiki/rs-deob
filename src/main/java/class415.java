...
public abstract class class415 extends class501 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lkda;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!aa", name = "<init>", descriptor = "(Lnba;I)V", line = 66)
    public class415(class249 arg0, int arg1) {
        this.field5631 = arg0;
        this.field5629 = arg1;
    }

    @OriginalMember(owner = "client!aa", name = "h", descriptor = "(I)V", line = 87)
