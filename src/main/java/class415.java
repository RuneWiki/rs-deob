...
public class class415 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(BLjava/lang/String;)I", line = 20)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IIIIIIIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(II)Log;", line = 68)
