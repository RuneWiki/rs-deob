...
public class class415 extends class283 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Lcu;ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(Lac;Ldja;)V", line = 25)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)Z", line = 54)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III)V", line = 70)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZZ)V", line = 102)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(ZI)V", line = 137)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)V", line = 149)
