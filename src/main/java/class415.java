...
public class class415 extends class7 {
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IB)I", line = 3)
    ...
    @OriginalMember(owner = "client!ic", name = "f", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(ILjd;Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!ic", name = "g", descriptor = "(I)V", line = 139)
    ...
    @OriginalMember(owner = "client!ic", name = "a", descriptor = "(IIII)V", line = 295)
    ...
    @OriginalMember(owner = "client!ic", name = "h", descriptor = "(I)V", line = 324)
