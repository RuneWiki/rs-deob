...
public class class415 {
    ...
    @OriginalMember(owner = "client!nk", name = "b", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(IB)V", line = 37)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(BLej;)V", line = 49)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!nk", name = "a", descriptor = "(II)Ldba;", line = 86)
    ...
    @OriginalMember(owner = "client!nk", name = "<init>", descriptor = "(Lrf;ILpl;)V", line = 121)
