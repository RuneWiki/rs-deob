...
public class class415 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "([BI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!sk", name = "<init>", descriptor = "(III)V", line = 47)
