...
public class class415 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(BLza;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Le;IZIILza;IZ)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IILza;ZBZI)Le;")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(III)Lrv;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILfo;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILza;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lza;Ler;IIIIIIZI)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
