...
public class class437 extends class176 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lkw;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(CIZ)C", line = 71)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIILqa;)Z", line = 158)
