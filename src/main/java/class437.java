...
public class class437 extends class403 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(IIILwm;[[[BIBIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!ab", name = "<init>", descriptor = "(Luh;)V", line = 42)
    public class437(class103 arg0) {
        this.field5928 = arg0;
    }

    @OriginalMember(owner = "client!ab", name = "b", descriptor = "(I)V", line = 53)
