...
public class class437 extends class223 {
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "d", descriptor = "()V", line = 9)
    public final void method1495() {
        field6496.method3018(this.field6495, super.field3481);
    }

    @OriginalMember(owner = "client!ji", name = "e", descriptor = "()V", line = 12)
    public static void method2613() {
        field6496 = null;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 16)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "(Llt;I)V", line = 18)
    public class437(class480 arg0, int arg1) {
        field6496 = arg0.method2870(0);
        this.field6495 = arg1;
    }

    @OriginalMember(owner = "client!ji", name = "b", descriptor = "()V", line = 23)
    public final void method1489() {
        field6496.method3020(this.field6495, 739);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 27)
