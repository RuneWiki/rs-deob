...
public class class437 extends class751 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILrv;I)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ILkj;Ljava/lang/String;I)Lrb;")
    ...
    @OriginalMember(owner = "client!mf", name = "c", descriptor = "(II)Llh;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lli;BI)V")
