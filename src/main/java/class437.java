...
public abstract class class437 extends class568 {
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IBI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(IBIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!za", name = "a", descriptor = "(Z)V", line = 35)
