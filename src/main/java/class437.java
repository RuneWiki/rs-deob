...
public class class437 extends class359 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(II)I", line = 5)
    public static final int method2712(int arg0, int arg1) {
        return class41.field481 == null ? 0 : class41.field481[arg0][arg1] & 0xFFFFFF;
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IB)I", line = 8)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Z)V", line = 25)
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Lbk;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(IB)Lbb;", line = 241)
    ...
    @OriginalMember(owner = "client!ql", name = "c", descriptor = "(B)V", line = 271)
    ...
    @OriginalMember(owner = "client!ql", name = "b", descriptor = "(II)V", line = 285)
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(II)V", line = 301)
