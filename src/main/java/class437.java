...
public class class437 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILtl;B)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILtl;)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lap;B)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ltf;[[BI)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
