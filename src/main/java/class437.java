...
public class class437 extends class723 {
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(III[I)V", line = 7)
    ...
    @OriginalMember(owner = "client!uj", name = "g", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!uj", name = "e", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Luha;)V", line = 57)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(FFIFIII)V", line = 81)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(FFFIF[F)V", line = 118)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!uj", name = "c", descriptor = "(III[I)V", line = 189)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!uj", name = "f", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "()V", line = 246)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "()Luha;", line = 255)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(III)V", line = 280)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Z)V", line = 295)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([I)V", line = 317)
    ...
    @OriginalMember(owner = "client!uj", name = "b", descriptor = "(I)V", line = 334)
    ...
    @OriginalMember(owner = "client!uj", name = "d", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)[F", line = 377)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IIIIII)V", line = 400)
    ...
    @OriginalMember(owner = "client!uj", name = "h", descriptor = "(I)[F", line = 436)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Luha;Z)V", line = 460)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(III[I)V", line = 485)
    ...
    @OriginalMember(owner = "client!uj", name = "<init>", descriptor = "()V", line = 498)
    public class437() {
        this.method860();
    }
}
