...
public class class437 implements Runnable {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "()Z", line = 9)
    public final boolean method2625() {
        return this.field6059 == null || !this.field6066 && this.field6059.method3304((byte) -128);
    }

    @OriginalMember(owner = "client!sw", name = "c", descriptor = "()J", line = 13)
    public final long method2626() {
        return this.field6060;
    }

    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lbka;)V", line = 18)
    ...
    @OriginalMember(owner = "client!sw", name = "<init>", descriptor = "(ILha;)V", line = 168)
    public class437(int arg0, class473 arg1) {
        this.field6064 = arg0;
        this.field6062 = arg1;
    }

    @OriginalMember(owner = "client!sw", name = "d", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!sw", name = "e", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!sw", name = "run", descriptor = "()V", line = 142)
    ...
    @OriginalMember(owner = "client!sw", name = "f", descriptor = "()V", line = 158)
