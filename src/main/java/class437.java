...
public class class437 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IBLlc;III)Lda;", line = 7)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIIIII)V", line = 38)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(II)Lav;", line = 615)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)V", line = 640)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIIIIZ)V", line = 659)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 744)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 764)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Lcm;ILlt;)V", line = 785)
    public class437(class491 arg0, int arg1, class458 arg2) {
        this.field6438 = arg2;
        this.field6438.method2726((byte) 113, 29);
    }

    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IB)V", line = 804)
