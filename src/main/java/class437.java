...
public class class437 implements class682 {
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(I[II[JI)V", line = 6)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!vfa", name = "b", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(IZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(B)Z", line = 125)
    ...
    @OriginalMember(owner = "client!vfa", name = "a", descriptor = "(Lfd;I)Lku;", line = 140)
    ...
    @OriginalMember(owner = "client!vfa", name = "<init>", descriptor = "(Lpe;Ldp;)V", line = 174)
