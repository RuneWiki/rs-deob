...
public class class437 extends class403 implements class113 {
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILeq;Z)Lva;", line = 5)
    ...
    @OriginalMember(owner = "client!rg", name = "<init>", descriptor = "(Leq;Lhn;IIIIIZIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Lbn;B)I", line = 30)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(ILeq;BI)Z", line = 103)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(Leq;Z)Lgl;", line = 122)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Z)Z", line = 165)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Leq;I)V", line = 178)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(IIILbp;IZLeq;)V", line = 196)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(B)I", line = 207)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(I)I", line = 218)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(Leq;Z)V", line = 238)
    ...
    @OriginalMember(owner = "client!rg", name = "c", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!rg", name = "a", descriptor = "(BLeq;)V", line = 261)
    ...
    @OriginalMember(owner = "client!rg", name = "f", descriptor = "(I)V", line = 272)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(B)I", line = 285)
    ...
    @OriginalMember(owner = "client!rg", name = "d", descriptor = "(I)Z", line = 296)
    ...
    @OriginalMember(owner = "client!rg", name = "b", descriptor = "(I)V", line = 307)
