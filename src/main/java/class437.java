...
public class class437 extends class481 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIILqo;Lcj;BLcu;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIB)V", line = 127)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(BB)C", line = 138)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZI)V", line = 164)
