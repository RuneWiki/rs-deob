...
public class class437 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(ZII)Z", line = 53)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(II)Lhaa;", line = 73)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(ILri;Lri;)V", line = 129)
