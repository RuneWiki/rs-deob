...
public class class437 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Luc;Z)V")
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Luc;)Z")
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(Luc;)V")
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "(Lmm;)V")
