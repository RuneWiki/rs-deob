...
public class class437 implements Runnable {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BI)V", line = 42)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "()V", line = 120)
    public class437() {
        this.field6241.setDaemon(true);
        this.field6241.start();
    }

    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILjava/lang/String;)Luq;", line = 61)
    ...
    @OriginalMember(owner = "client!km", name = "run", descriptor = "()V", line = 83)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ILs;)V", line = 134)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II)V", line = 148)
