...
public class class437 extends class462 {
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(IIII)[B", line = 16)
    ...
    @OriginalMember(owner = "client!uw", name = "a", descriptor = "(ZIB)V", line = 32)
    ...
    @OriginalMember(owner = "client!uw", name = "e", descriptor = "(I)V", line = 47)
