...
public class class437 implements class66 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILrj;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILjn;)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILai;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILai;)V")
    public final void method2696(int arg0, class355 arg1) {
        this.method2694(arg0, arg1, 0);
    }

    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(ILrj;II)V")
    ...
    @OriginalMember(owner = "client!ql", name = "<init>", descriptor = "(Lsq;)V")
