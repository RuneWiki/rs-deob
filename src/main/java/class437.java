...
public abstract class class437 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IILud;Ljava/awt/Canvas;ILfl;)Lnr;", line = 3)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I)V", line = 57)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZIIIII)V", line = 106)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZI)V", line = 121)
    ...
    @OriginalMember(owner = "client!nr", name = "f", descriptor = "(I)V", line = 132)
    ...
    @OriginalMember(owner = "client!nr", name = "g", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(IIIIII)V", line = 256)
    ...
    @OriginalMember(owner = "client!nr", name = "d", descriptor = "(Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIIIII)V", line = 389)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIBII)V", line = 409)
    ...
    @OriginalMember(owner = "client!nr", name = "finalize", descriptor = "()V", line = 421)
    protected final void finalize() {
        this.method2761(-31586);
        field6413++;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIIB)V", line = 453)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZIIII)V", line = 476)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(ZI)V", line = 487)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIILnr;ILsn;IILro;)V", line = 502)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IIIZII)V", line = 610)
