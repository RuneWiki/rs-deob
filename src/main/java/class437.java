...
public class class437 extends class278 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lwi;[I)V")
    ...
    @OriginalMember(owner = "client!io", name = "fa", descriptor = "(IILr;)Lr;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III[[ZZI)V")
    ...
    @OriginalMember(owner = "client!io", name = "CA", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!io", name = "ka", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!io", name = "wa", descriptor = "(Lr;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Leea;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIIIII[[Z)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(III[[ZZII)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I[[ZIIIZII)V")
    ...
    @OriginalMember(owner = "client!io", name = "YA", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!io", name = "U", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BIILlba;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lr;IIIIZ)Z")
