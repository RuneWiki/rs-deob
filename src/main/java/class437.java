...
public class class437 extends class299 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)[B", line = 7)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "([BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(III)[B", line = 30)
