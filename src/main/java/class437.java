...
public abstract class class437 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ff", name = "<init>", descriptor = "(III)V", line = 76)
