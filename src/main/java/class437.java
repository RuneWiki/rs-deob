...
public class class437 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILha;Ltl;Lfo;)V", line = 9)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 180)
