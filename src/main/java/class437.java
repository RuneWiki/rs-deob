...
public class class437 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lr;Ljava/lang/String;[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!bda", name = "b", descriptor = "()V")
    public static void method2472() {
        field5824 = null;
    }

    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lr;Ljava/lang/String;IIIZ)V")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Lr;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V")
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(Ljava/lang/String;)I")
    ...
    @OriginalMember(owner = "client!bda", name = "<init>", descriptor = "(Lr;IZLjava/awt/Component;)V")
