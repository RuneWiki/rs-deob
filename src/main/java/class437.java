...
public class class437 extends class260 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "([I[Ljava/lang/Object;I)V", line = 21)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(IILya;I)V", line = 44)
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I[Lem;IIIIIIII)V", line = 62)
