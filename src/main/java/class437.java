...
public class class437 extends class692 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ZB)V", line = 3)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ILfga;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(BLgga;)I", line = 26)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;BLjava/lang/String;I)V", line = 96)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(ZI)V", line = 108)
    ...
    @OriginalMember(owner = "client!fg", name = "<init>", descriptor = "(Llea;)V", line = 125)
    public class437(class573 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(IZI)V", line = 128)
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(I)Z", line = 143)
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(B)V", line = 155)
