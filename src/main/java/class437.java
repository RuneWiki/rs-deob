...
public class class437 extends class115 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(I[BLjava/lang/String;ZII)I", line = 8)
    ...
    @OriginalMember(owner = "client!nr", name = "c", descriptor = "(Z)V", line = 144)
    ...
    @OriginalMember(owner = "client!nr", name = "f", descriptor = "(I)I", line = 156)
    ...
    @OriginalMember(owner = "client!nr", name = "b", descriptor = "(Z)Z", line = 171)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(IZ)V", line = 187)
    ...
    @OriginalMember(owner = "client!nr", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 206)
    ...
    @OriginalMember(owner = "client!nr", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 216)
    public class437(Object arg0) {
        this.field6365 = arg0;
    }

    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ILjava/lang/String;)J", line = 228)
