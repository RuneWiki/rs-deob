...
public class class437 extends class667 {
    ...
    @OriginalMember(owner = "client!jc", name = "<init>", descriptor = "()V", line = 3)
    public class437() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ZI)[[I", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lud;II)V", line = 104)
