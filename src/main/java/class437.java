...
public class class437 extends class243 {
    ...
    @OriginalMember(owner = "client!gr", name = "b", descriptor = "(II)[[I", line = 5)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(II)[I", line = 87)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ILji;B)V", line = 140)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "()V", line = 153)
    public class437() {
        super(3, false);
    }
}
