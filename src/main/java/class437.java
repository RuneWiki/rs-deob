...
public abstract class class437 extends Applet implements Runnable, FocusListener, WindowListener {
    ...
    @OriginalMember(owner = "client!te", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!te", name = "windowDeiconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 18)
    public final void windowDeiconified(WindowEvent arg0) {
        field6275++;
    }

    @OriginalMember(owner = "client!te", name = "getParameter", descriptor = "(Ljava/lang/String;)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!te", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 91)
    public final void focusLost(FocusEvent arg0) {
        class290.field3700 = false;
        field6254++;
    }

    @OriginalMember(owner = "client!te", name = "getDocumentBase", descriptor = "()Ljava/net/URL;", line = 100)
    ...
    @OriginalMember(owner = "client!te", name = "getCodeBase", descriptor = "()Ljava/net/URL;", line = 115)
    ...
    @OriginalMember(owner = "client!te", name = "windowOpened", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 131)
    public final void windowOpened(WindowEvent arg0) {
        field6252++;
    }

    @OriginalMember(owner = "client!te", name = "b", descriptor = "(B)V", line = 140)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(B)Z", line = 173)
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!te", name = "getAppletContext", descriptor = "()Ljava/applet/AppletContext;", line = 254)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Z)Ljava/lang/String;", line = 270)
    public String method1235(boolean arg0) {
        field6268++;
        return arg0 ? null : null;
    }

    @OriginalMember(owner = "client!te", name = "c", descriptor = "(I)V", line = 284)
    ...
    @OriginalMember(owner = "client!te", name = "windowIconified", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 317)
    public final void windowIconified(WindowEvent arg0) {
        field6249++;
    }

    @OriginalMember(owner = "client!te", name = "windowClosed", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 324)
    public final void windowClosed(WindowEvent arg0) {
        field6251++;
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIZBIIILjava/lang/String;)V", line = 333)
    ...
    @OriginalMember(owner = "client!te", name = "destroy", descriptor = "()V", line = 374)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IZ)V", line = 389)
    ...
    @OriginalMember(owner = "client!te", name = "stop", descriptor = "()V", line = 468)
    ...
    @OriginalMember(owner = "client!te", name = "windowClosing", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 482)
    public final void windowClosing(WindowEvent arg0) {
        this.destroy();
        field6262++;
    }

    @OriginalMember(owner = "client!te", name = "f", descriptor = "(I)V", line = 493)
    public static void method2570(int arg0) {
        field6263 = null;
        int var1 = -79 / ((-arg0 - 65) / 51);
    }

    @OriginalMember(owner = "client!te", name = "run", descriptor = "()V", line = 502)
    ...
    @OriginalMember(owner = "client!te", name = "start", descriptor = "()V", line = 623)
    ...
    @OriginalMember(owner = "client!te", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 635)
    public final void update(Graphics arg0) {
        field6269++;
        this.paint(arg0);
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 645)
    ...
    @OriginalMember(owner = "client!te", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 670)
    ...
    @OriginalMember(owner = "client!te", name = "providesignlink", descriptor = "(Lpc;)V", line = 699)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IIIII)V", line = 707)
    ...
    @OriginalMember(owner = "client!te", name = "windowActivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 760)
    public final void windowActivated(WindowEvent arg0) {
        field6270++;
    }

    @OriginalMember(owner = "client!te", name = "windowDeactivated", descriptor = "(Ljava/awt/event/WindowEvent;)V", line = 777)
