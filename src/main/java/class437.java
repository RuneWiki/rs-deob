...
public class class437 extends class381 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lqa;Ler;IIIII)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Ltd;B[[B)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(BLic;)I")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(ILqa;Lic;)V")
