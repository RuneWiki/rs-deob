...
public class class437 extends class508 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IZIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(B)V", line = 187)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I[Ljava/lang/String;ZI)Ljava/lang/String;", line = 200)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(S)V", line = 260)
    public class437(short arg0) {
        this.field5990 = arg0;
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)B", line = 311)
