...
public class class437 extends class61 {
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IIILaa;)Z")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Llp;I)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IILaa;)Z")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Laa;I)Lcn;")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(IZIILaa;ILqh;)V")
    ...
    @OriginalMember(owner = "client!ql", name = "a", descriptor = "(Laa;Z)V")
