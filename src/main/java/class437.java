...
public class class437 extends class578 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ILwba;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Lqs;B)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ILqs;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(BZILd;)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(Lqs;I)V")
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(IIILou;Lou;)V")
