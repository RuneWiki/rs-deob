...
public class class437 extends class193 implements class292 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(I[BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "()I", line = 14)
    public final int method34() {
        return 0;
    }

    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lig;I[BI)V", line = 17)
