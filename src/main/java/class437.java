...
public class class437 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BILvo;I)Lvf;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)Leb;")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljp;IZ)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IB)Lmh;")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lle;ILoi;Loi;Loi;)V")
