...
public class class437 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IJ)V", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "(II)V", line = 25)
    public class437(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!bt", name = "toString", descriptor = "()Ljava/lang/String;", line = 36)
