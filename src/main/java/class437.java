...
public class class437 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(ZLwn;)Lel;", line = 3)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IBI)Z", line = 30)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljava/lang/String;ZLul;ZI)V", line = 78)
