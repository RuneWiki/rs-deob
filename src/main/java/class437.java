...
public class class437 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(IIIIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!fp", name = "toString", descriptor = "()Ljava/lang/String;", line = 60)
    public final String toString() {
        field6439++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "(IIII)V", line = 71)
