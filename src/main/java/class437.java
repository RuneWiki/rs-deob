...
public class class437 extends class60 {
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(II)I", line = 4)
    public final int method406(int arg0, int arg1) {
        ++field5750;
        return ~super.field798.method4288(arg0 ^ arg0).method1438(false) > -97 ? 3 : 1;
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "([Ljava/lang/String;I)[Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(ILhd;)V", line = 42)
    public class437(int arg0, class773 arg1) {
        super(arg0, arg1);
        class260.method1564(-122, super.field799);
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IZI)I", line = 50)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(B)V", line = 67)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)I", line = 83)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(BI)V", line = 95)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Z)I", line = 122)
    public final int method405(boolean arg0) {
        ++field5751;
        return ~super.field798.method4288(0).method1438(arg0) > -97 ? 0 : 2;
    }

    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(B)Z", line = 135)
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(Lhd;)V", line = 157)
