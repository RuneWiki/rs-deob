...
public class class437 extends class192 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)Lpo;", line = 3)
    ...
    @OriginalMember(owner = "client!pg", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lms;B)V", line = 41)
