...
public class class437 extends class535 {
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(IIIIIF)V", line = 3)
    public class437(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIII)V", line = 12)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IF)V", line = 26)
    ...
    @OriginalMember(owner = "client!cu", name = "j", descriptor = "(I)V", line = 39)
