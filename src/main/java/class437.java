...
public class class437 extends class55 {
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IIZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IBJI)V", line = 58)
    ...
    @OriginalMember(owner = "client!gr", name = "g", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZB)V", line = 117)
    public final void method197(boolean arg0, byte arg1) {
        ++field5825;
        int var3 = 62 % ((arg1 - -61) / 44);
    }

    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZI)Z", line = 126)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(ZIIIII)V", line = 173)
    ...
    @OriginalMember(owner = "client!gr", name = "<init>", descriptor = "(Ltk;Lnd;Ltn;)V", line = 229)
    ...
    @OriginalMember(owner = "client!gr", name = "a", descriptor = "(IILfe;)V", line = 252)
    ...
    @OriginalMember(owner = "client!gr", name = "f", descriptor = "(I)Z", line = 269)
