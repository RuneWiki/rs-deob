...
public abstract class class437 extends class651 {
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lc;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Le;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I[Lpv;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!qe", name = "z", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!qe", name = "L", descriptor = "(ILfa;II)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ldn;)V")
    public final void method432(class483 arg0) {
    }

    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIZ)Lxa;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Ldn;Ldn;FLdn;)Ldn;")
    ...
    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(IIIIII)Ldn;")
    public final class483 method391(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!qe", name = "b", descriptor = "(Li;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "([IIIII)Lxa;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lkga;[Lpga;Z)Lta;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!qe", name = "x", descriptor = "()Lffa;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIZ)Lxa;")
    ...
    @OriginalMember(owner = "client!qe", name = "f", descriptor = "(I)Li;")
    ...
    @OriginalMember(owner = "client!qe", name = "f", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(Lpga;Z)Lxa;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(II[I[I)Lfa;")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIIIIF)Lpv;")
