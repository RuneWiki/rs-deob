...
public abstract class class437 extends class324 {
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IIIII)V", line = 13)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(III)Z", line = 45)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!bda", name = "a", descriptor = "(IBLkea;)Lcq;", line = 74)
