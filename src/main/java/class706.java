...
public class class706 implements class685 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)Lsaa;", line = 5)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)I", line = 27)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lwu;)V", line = 46)
    public class706(class376 arg0) {
        this.field9784 = arg0;
    }

    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 54)
