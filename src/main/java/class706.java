...
public class class706 extends class363 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IILji;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(III)Z", line = 19)
    ...
    @OriginalMember(owner = "client!sw", name = "d", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(BLji;)V", line = 46)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IIIIII)V", line = 66)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(II)V", line = 89)
    ...
    @OriginalMember(owner = "client!sw", name = "e", descriptor = "(I)V", line = 131)
