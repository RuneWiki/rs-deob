...
public class class706 implements class318 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)V", line = 15)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(Lwr;)V", line = 49)
    public class706(class240 arg0) {
        this.field9942 = arg0;
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZB)V", line = 67)
