...
public class class706 implements class447 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lwc;B)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)Ljw;")
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(ILjg;Ljha;IIIIIIIZ)V")
