...
public class class706 {
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I[Ldba;)I")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(JI)Ldba;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(I)[Lur;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(B)Ldba;")
    ...
    @OriginalMember(owner = "client!ee", name = "c", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!ee", name = "e", descriptor = "(I)Ldba;")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(Ldr;IZ)V")
    ...
    @OriginalMember(owner = "client!ee", name = "a", descriptor = "(JLdba;I)V")
