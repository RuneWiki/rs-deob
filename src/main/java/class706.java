...
public class class706 extends class168 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(ZLiu;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(B)Loc;", line = 23)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "()V", line = 48)
    public class706() {
    }

    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(J)V", line = 50)
    public class706(long arg0) {
        this.field9780 = arg0;
    }

    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)V", line = 62)
