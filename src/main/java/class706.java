...
public class class706 extends class429 {
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(Len;ZI)V", line = 46)
    ...
    @OriginalMember(owner = "client!fda", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(II)Z", line = 68)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(B)Z", line = 79)
    ...
    @OriginalMember(owner = "client!fda", name = "<init>", descriptor = "(Lmj;)V", line = 92)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(II)J", line = 202)
    ...
    @OriginalMember(owner = "client!fda", name = "b", descriptor = "(B)V", line = 215)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(III)V", line = 255)
    ...
    @OriginalMember(owner = "client!fda", name = "a", descriptor = "(IZ)V", line = 277)
