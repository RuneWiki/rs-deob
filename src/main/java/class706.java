...
public class class706 extends class474 {
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(FLnc;Lnc;I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dd", name = "b", descriptor = "(B)Lnc;", line = 205)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(CI)Z", line = 217)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(BIZLjava/lang/String;)V", line = 228)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IIIIIII)V", line = 353)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(I)I", line = 372)
    public final int method4017(int arg0) {
        field9941++;
        return arg0 == 1 ? this.field9947.field245 : -12;
    }

    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(Lwh;I)V", line = 383)
