...
public class class706 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(II)Lmga;", line = 17)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lvv;)V", line = 162)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)V", line = 220)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IZIIZILqi;Lr;Lla;ILr;I)Lf;", line = 239)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(I)V", line = 310)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ZI)V", line = 321)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BI)V", line = 337)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IIIIILr;Lqi;I)Lf;", line = 357)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lci;IZLpa;Lsea;Lsea;)V", line = 394)
