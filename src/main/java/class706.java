...
public class class706 extends class492 implements class281 {
    ...
    @OriginalMember(owner = "client!ki", name = "h", descriptor = "(I)Z", line = 9)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(ILha;)Llca;", line = 22)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILha;)Lka;", line = 38)
    ...
    @OriginalMember(owner = "client!ki", name = "e", descriptor = "(Z)I", line = 59)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILha;)V", line = 91)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(B)I", line = 119)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;B)V", line = 132)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lm;ILaia;Lha;)V", line = 160)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ZLha;Lrr;IIII)V", line = 307)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIZI)V", line = 338)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Z)Z", line = 353)
    public final boolean method1239(boolean arg0) {
        ++field9930;
        return !arg0 ? false : this.field9959;
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BLha;)Llba;", line = 364)
    ...
    @OriginalMember(owner = "client!ki", name = "b", descriptor = "(B)V", line = 390)
    ...
    @OriginalMember(owner = "client!ki", name = "g", descriptor = "(I)Z", line = 406)
    ...
    @OriginalMember(owner = "client!ki", name = "d", descriptor = "(B)I", line = 427)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)Z", line = 438)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;I)V", line = 452)
    public final void method990(class58 arg0, int arg1) {
        int var3 = 55 % ((-2 - arg1) / 62);
        ++field9938;
    }

    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lha;ZZI)Lbt;", line = 464)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(B)I", line = 494)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(BIIII)V", line = 512)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IILha;I)Z", line = 528)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lha;Lvc;IIIIIZIIZ)V", line = 548)
    ...
    @OriginalMember(owner = "client!ki", name = "f", descriptor = "(I)I", line = 582)
