...
public class class706 implements class540 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)Lsaa;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lso;B)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILso;)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lkv;IIIB)V")
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lin;Lti;IIIIIII)V")
