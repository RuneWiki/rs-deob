...
public class class706 implements Runnable {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "()Z", line = 3)
    public final boolean method3948() {
        return this.field9990 == null || !this.field9993 && this.field9990.method2778(true);
    }

    @OriginalMember(owner = "client!gq", name = "b", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "()V", line = 14)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "()V", line = 115)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(ILr;)V", line = 168)
    public class706(int arg0, class98 arg1) {
        this.field9988 = arg0;
        this.field9996 = arg1;
    }

    @OriginalMember(owner = "client!gq", name = "e", descriptor = "()J", line = 124)
    public final long method3952() {
        return this.field9994;
    }

    @OriginalMember(owner = "client!gq", name = "f", descriptor = "()V", line = 127)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Lsu;)V", line = 134)
    ...
    @OriginalMember(owner = "client!gq", name = "run", descriptor = "()V", line = 157)
