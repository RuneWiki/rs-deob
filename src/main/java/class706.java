...
public class class706 extends class529 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IB)[I", line = 4)
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(IBLtn;)V", line = 37)
    ...
    @OriginalMember(owner = "client!oda", name = "f", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "()V", line = 87)
    public class706() {
        super(1, true);
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(BLtn;)Lag;", line = 93)
    ...
    @OriginalMember(owner = "client!oda", name = "g", descriptor = "(I)V", line = 105)
