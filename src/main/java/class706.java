...
public class class706 extends class570 implements class49 {
    ...
    @OriginalMember(owner = "client!jba", name = "<init>", descriptor = "(Lr;Lqp;IIIIIZII)V")
    ...
    @OriginalMember(owner = "client!jba", name = "c", descriptor = "(Lr;I)Lwj;")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lr;III)Z")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(IIIILrb;Lr;Z)V")
    ...
    @OriginalMember(owner = "client!jba", name = "d", descriptor = "(Lr;I)Llf;")
    ...
    @OriginalMember(owner = "client!jba", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!jba", name = "b", descriptor = "(Lr;I)V")
