...
public class class706 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Le;III)I")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;Lfd;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;II)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;IIII)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Le;II)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "c", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(Loa;IIII)Lki;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;Lkq;IIII)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(I)Ldga;")
    public static final class230 method3867(int arg0) {
        return (class230) field9830.method39((long) arg0, 31750);
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "([B[B[SII)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Loa;)Lki;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Lpe;Lmd;Lh;Lhp;Laj;Ltp;Lse;)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(Loa;)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(II)Ldga;")
    ...
    @OriginalMember(owner = "client!dfa", name = "e", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!dfa", name = "b", descriptor = "(II)Lca;")
