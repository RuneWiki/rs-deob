...
public class class706 {
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(ZLfca;)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(I)Ldc;")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lfca;II)V")
    ...
    @OriginalMember(owner = "client!wca", name = "a", descriptor = "(Lct;[[BB)V")
    ...
    @OriginalMember(owner = "client!wca", name = "c", descriptor = "(I)Ldc;")
