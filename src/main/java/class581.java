...
public class class581 {
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)Lvb;", line = 41)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(ILuaa;)Ljava/lang/String;", line = 54)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(IIIIB)V", line = 81)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(IIII)Lsba;", line = 93)
