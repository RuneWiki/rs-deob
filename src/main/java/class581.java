...
public class class581 extends class152 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILqh;)Z")
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(Z)Lke;")
    ...
    @OriginalMember(owner = "client!jw", name = "b", descriptor = "(ILqh;)Z")
