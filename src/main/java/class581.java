...
public class class581 extends class518 {
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "(Lpea;)V", line = 4)
    public class581(class641 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(II)Z", line = 9)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(BLwq;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(ZI)Z", line = 46)
    ...
    @OriginalMember(owner = "client!tb", name = "d", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(III)Lia;", line = 72)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Z)Z", line = 82)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ZB)V", line = 96)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(ZI)V", line = 111)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IZI)V", line = 122)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(IIIIII)V", line = 136)
