...
public class class581 extends class414 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 13)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 35)
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!fs", name = "e", descriptor = "()V", line = 110)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "()I", line = 124)
    public final int method2293() {
        return this.field7906 - (this.field7905.available() >> (class177.field2341 ? 2 : 1));
    }

    @OriginalMember(owner = "client!fs", name = "d", descriptor = "()V", line = 132)
