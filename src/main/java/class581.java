...
public class class581 extends class182 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILgda;I)Lkm;", line = 4)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(IIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!jw", name = "<init>", descriptor = "(I)V", line = 89)
