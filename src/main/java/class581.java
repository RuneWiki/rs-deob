...
public class class581 extends class328 {
    ...
    @OriginalMember(owner = "client!re", name = "f", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I[IB)V", line = 41)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(II)[I", line = 207)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "()V", line = 243)
    public class581() {
        super(0, true);
    }

    @OriginalMember(owner = "client!re", name = "c", descriptor = "(B)V", line = 249)
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(B)V", line = 269)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIIIIII)I", line = 318)
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(B)V", line = 389)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(BILco;)V", line = 428)
