...
public class class581 extends class107 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(II[[I[[IIII)Ld;", line = 5)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/awt/Canvas;)V", line = 14)
    ...
    @OriginalMember(owner = "client!sp", name = "e", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!sp", name = "d", descriptor = "(Z)V", line = 76)
    public final void method387(boolean arg0) {
        this.field8117 = arg0;
        ++field8102;
    }

    @OriginalMember(owner = "client!sp", name = "d", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!sp", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V", line = 106)
    public class581(Canvas arg0, class489 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ljava/lang/Runnable;)Lvd;", line = 109)
    ...
    @OriginalMember(owner = "client!sp", name = "C", descriptor = "()V", line = 131)
    ...
    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(IIIIIIIIII)V", line = 221)
    ...
    @OriginalMember(owner = "client!sp", name = "f", descriptor = "(I)V", line = 262)
    public final void method382(int arg0) {
        super.field1456[arg0].method172((byte) -103, Thread.currentThread());
        ++field8103;
    }

    @OriginalMember(owner = "client!sp", name = "d", descriptor = "(Ljava/awt/Canvas;)V", line = 271)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "([Lba;Lhfa;Lq;[Lrc;I)V", line = 308)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIIIII)V", line = 326)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IIIIIIIIII)V", line = 405)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "([Lba;Lq;[Lrc;I)V", line = 454)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZIIIIII)V", line = 475)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lcq;IIII)V", line = 813)
    ...
    @OriginalMember(owner = "client!sp", name = "j", descriptor = "()Z", line = 858)
    public final boolean method385() {
        ++field8110;
        return true;
    }

    @OriginalMember(owner = "client!sp", name = "b", descriptor = "(I)V", line = 868)
    public final void method394(int arg0) {
        ++field8099;
        super.field1456[arg0].method172((byte) -71, (Runnable) null);
    }

    @OriginalMember(owner = "client!sp", name = "G", descriptor = "()V", line = 877)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Lhn;IIII)Lba;", line = 921)
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(ZLvs;IIIIIIII)V", line = 934)
