...
public class class581 extends class45 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILjd;)V")
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IILbr;I)Lbm;")
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Ljba;IIIII)V")
