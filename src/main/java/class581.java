...
public class class581 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IBILjava/awt/Canvas;Ld;)Lha;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(BIILni;)Lmv;")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILbg;Lbg;I)Llw;")
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(I)Lpca;")
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Ljd;Lpt;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZLbg;ILbg;I)Llw;")
