...
public class class581 extends class198 {
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ZLol;)V", line = 6)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!vaa", name = "a", descriptor = "(ILlm;)V", line = 40)
