...
public class class581 extends class164 {
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIIBI)V", line = 6)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!pda", name = "finalize", descriptor = "()V", line = 46)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(B)J", line = 56)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!pda", name = "<init>", descriptor = "(Lkga;II)V", line = 86)
    ...
    @OriginalMember(owner = "client!pda", name = "a", descriptor = "(IIIIIII)I", line = 98)
