...
public abstract class class581 implements class485 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFII)V", line = 12)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIIIIII)V", line = 21)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(IIII)V", line = 25)
    public final void method4344(int arg0, int arg1, int arg2, int arg3) {
        this.method993(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFFFFFLaa;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFFFFFIII)V", line = 36)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(II)V", line = 39)
    public final void method4347(int arg0, int arg1) {
        this.method999(arg0, arg1, 1, 0, 1);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFFFIILaa;II)V", line = 43)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFIILaa;II)V", line = 68)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIII)V", line = 72)
    public final void method4350(int arg0, int arg1, int arg2, int arg3) {
        this.method998(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(FFFFIIIII)V", line = 75)
