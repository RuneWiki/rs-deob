...
public class class581 implements class48 {
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IILha;)Lhu;")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(B)Lvca;")
    ...
    @OriginalMember(owner = "client!kha", name = "a", descriptor = "(IZLtp;I)V")
    ...
    @OriginalMember(owner = "client!kha", name = "<init>", descriptor = "(Loh;Ljava/lang/String;)V")
