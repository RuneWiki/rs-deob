...
public class class581 extends class691 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(III)[B")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)[B")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I[B)V")
