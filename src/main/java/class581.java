...
public class class581 extends class72 {
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(ILcq;)V", line = 4)
    public class581(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(III)Z", line = 37)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(II)V", line = 50)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(I)Z", line = 82)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lcq;)V", line = 101)
    public class581(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!pm", name = "e", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!pm", name = "f", descriptor = "(I)I", line = 117)
