...
public class class581 extends class489 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!tp", name = "<init>", descriptor = "(Leq;)V", line = 206)
    ...
    @OriginalMember(owner = "client!tp", name = "c", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BLkp;I)V", line = 111)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(B)Z", line = 123)
    public final boolean method7(byte arg0) {
        ++field8068;
        return arg0 <= 95 ? true : true;
    }

    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(IZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(III)V", line = 176)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILjava/io/File;)[B", line = 193)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(I)V", line = 317)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IILjava/lang/String;)Z", line = 327)
