...
public class class581 {
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(II)Len;", line = 6)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(IIIIIIIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!ve", name = "a", descriptor = "(I)V", line = 116)
