...
public abstract class class581 implements class90 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ILpca;Lpca;)V", line = 59)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(BZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)V", line = 112)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(B)Z", line = 130)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lpu;Lpu;Ltfa;)V", line = 156)
