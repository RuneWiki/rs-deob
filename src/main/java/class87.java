...
public class class87 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(II)I", line = 40)
    public static final int method793(int arg0, int arg1) {
        field1585++;
        return arg0 <= 25 ? -25 : arg1 >>> 8;
    }

    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(II)Z", line = 51)
