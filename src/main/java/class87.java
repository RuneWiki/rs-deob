...
public class class87 extends class322 {
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lch;)V", line = 8)
    public class87(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(B)Z", line = 12)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(Z)I", line = 30)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lvaa;I[IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(II)I", line = 133)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Z)V", line = 156)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(B)I", line = 184)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(II)V", line = 195)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(ILch;)V", line = 206)
