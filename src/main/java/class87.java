...
public class class87 extends class12 {
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!g", name = "d", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLaf;I)V", line = 44)
