...
public class class87 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(JI)Ltia;", line = 23)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Loba;B)V", line = 53)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IIIIII)V", line = 126)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(JI)V", line = 148)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Ltia;IJ)V", line = 171)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(I)V", line = 247)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 212)
