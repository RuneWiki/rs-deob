...
public class class87 extends class267 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIILjava/awt/Graphics;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 36)
