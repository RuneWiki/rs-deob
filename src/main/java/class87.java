...
public class class87 implements Runnable {
    ...
    @OriginalMember(owner = "client!kl", name = "e", descriptor = "(I)Lnm;")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(JLnm;Ljava/lang/String;ZI)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lia;B)V")
