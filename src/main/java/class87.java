...
public class class87 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(III)Lmb;", line = 41)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)I", line = 48)
    public static final int method771(int arg0) {
        field1291++;
        return ~class388.field5420 == arg0 ? class65.field982 : 0;
    }

    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(IIIIB)V", line = 62)
