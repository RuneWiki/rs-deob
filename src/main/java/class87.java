...
public class class87 extends class37 implements class358 {
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lai;Lwd;II[FII)V", line = 3)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lai;Lwd;II[BII)V", line = 16)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(FI)F", line = 31)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(B)Z", line = 41)
    public final boolean method600(byte arg0) {
        ++field911;
        return arg0 > -113 ? false : false;
    }

    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IIB[BIIILwd;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lai;II[III)V", line = 77)
    ...
    @OriginalMember(owner = "client!iia", name = "d", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Z)I", line = 102)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(ZZB)V", line = 116)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IIII[IIZI)V", line = 129)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IF)F", line = 153)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(I[IIIIII)V", line = 168)
    ...
    @OriginalMember(owner = "client!iia", name = "<init>", descriptor = "(Lai;Lwd;Ljm;II)V", line = 192)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(I)I", line = 204)
