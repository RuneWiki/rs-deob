...
public class class87 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(IZII)I", line = 5)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(I)Lob;", line = 27)
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!pp", name = "c", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(Lrp;I)[Lub;", line = 121)
    ...
    @OriginalMember(owner = "client!pp", name = "d", descriptor = "(I)Lob;", line = 162)
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "()V", line = 184)
    public class87() {
    }

    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Lvu;)V", line = 189)
