...
public abstract class class87 extends class656 {
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)I", line = 21)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)F", line = 32)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(I)I", line = 58)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(B)I", line = 71)
    public final int method670(byte arg0) {
        field1056++;
        return arg0 >= -68 ? 35 : this.field1054;
    }

    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(Z)I", line = 82)
    ...
    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(I)I", line = 99)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(IIIIIF)V", line = 110)
