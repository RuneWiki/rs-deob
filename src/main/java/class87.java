...
public class class87 extends class46 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(ZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kl", name = "c", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IB)Z", line = 29)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(II)Z", line = 75)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Z)Z", line = 97)
    ...
    @OriginalMember(owner = "client!kl", name = "b", descriptor = "(II)Z", line = 210)
