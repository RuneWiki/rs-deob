...
public class class87 extends class569 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "([FIFIIIIIIIFFI)V", line = 37)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(Ltf;Ltf;Liq;)V", line = 135)
    public class87(class701 arg0, class701 arg1, class202 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IZIZ)V", line = 140)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(III)V", line = 158)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(II)Luca;", line = 176)
