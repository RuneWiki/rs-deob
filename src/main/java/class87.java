...
public class class87 extends class195 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(ZB)V", line = 7)
    ...
    @OriginalMember(owner = "client!dq", name = "<init>", descriptor = "(Lge;II[BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "()V", line = 35)
