...
public class class87 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "([Ljava/lang/Object;BLjava/applet/Applet;Ljava/lang/String;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(BLjava/applet/Applet;Ljava/lang/String;)V", line = 25)
