...
public class class87 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ILdw;IB)V", line = 14)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 93)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BLpq;Lpq;Lpq;Lpq;)V", line = 106)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)V", line = 122)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIIII)V", line = 165)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IJ)V", line = 189)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Z)V", line = 273)
