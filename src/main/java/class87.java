...
public class class87 extends class346 {
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "()V", line = 14)
    public class87() {
        super(1, false);
    }

    @OriginalMember(owner = "client!pj", name = "d", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Lfb;ZI)V", line = 31)
    ...
    @OriginalMember(owner = "client!pj", name = "e", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!pj", name = "f", descriptor = "(I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!pj", name = "c", descriptor = "(II)[[I", line = 126)
