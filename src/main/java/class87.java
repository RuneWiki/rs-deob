...
public class class87 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)V", line = 38)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIIIIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IZ)Ljc;", line = 62)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ltga;Ljava/lang/String;ZZB)V", line = 100)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 131)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 118)
