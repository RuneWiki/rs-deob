...
public class class87 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IILlf;)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(BLhl;)V")
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIILlf;)V")
