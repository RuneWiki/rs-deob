...
public class class87 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZLmm;Lmm;)V", line = 254)
    ...
    @OriginalMember(owner = "client!vf", name = "toString", descriptor = "()Ljava/lang/String;", line = 272)
    public final String toString() {
        field1351++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 283)
