...
public class class87 extends class390 {
    ...
    @OriginalMember(owner = "client!g", name = "c", descriptor = "(B)V", line = 8)
    public static void method618(byte arg0) {
        field1221 = null;
        int var1 = -76 / ((-arg0 - 17) / 54);
    }

    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIJII)V", line = 24)
