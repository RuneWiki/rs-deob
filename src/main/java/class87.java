...
public class class87 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(BLeh;)V", line = 16)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(B[[BLeda;)V", line = 37)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IILeh;)V", line = 94)
    ...
    @OriginalMember(owner = "client!iv", name = "b", descriptor = "(I)V", line = 155)
