...
public class class87 extends class493 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!vga", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(IILbl;)V", line = 29)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(CIB)C", line = 41)
    ...
    @OriginalMember(owner = "client!vga", name = "h", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(IZ)V", line = 181)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(IZ)V", line = 196)
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(B)Z", line = 207)
    public final boolean method634(byte arg0) {
        ++field1196;
        return arg0 == 27;
    }

    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Luv;)V", line = 218)
