...
public class class87 extends class396 {
    ...
    @OriginalMember(owner = "client!dv", name = "f", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lep;IIII[BI)V", line = 36)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lep;IIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IIIIBIII)V", line = 82)
