...
public class class87 {
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(ZIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IIIII)Ldl;", line = 206)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(IZIIIII)V", line = 220)
    ...
    @OriginalMember(owner = "client!dl", name = "a", descriptor = "(III)Z", line = 239)
    ...
    @OriginalMember(owner = "client!dl", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 267)
