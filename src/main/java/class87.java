...
public class class87 extends class588 implements class36 {
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Loe;Ljb;III[B)V", line = 5)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(BLtn;)V", line = 78)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 90)
    public final IDirect3DBaseTexture method650(boolean arg0) {
        return arg0 ? (IDirect3DBaseTexture) null : this.field1295;
    }

    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)V", line = 100)
