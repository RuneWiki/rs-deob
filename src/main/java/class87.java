...
public class class87 extends class307 {
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(III)Lna;", line = 63)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(III)V", line = 70)
    ...
    @OriginalMember(owner = "client!hw", name = "<init>", descriptor = "(IIIIIFFF)V", line = 106)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)V", line = 123)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IBB)V", line = 134)
