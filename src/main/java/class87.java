...
public abstract class class87 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIIZIII[[[BIIILya;I)V", line = 40)
