...
public class class87 extends class416 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IC)Z", line = 8)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)V", line = 54)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)V", line = 69)
