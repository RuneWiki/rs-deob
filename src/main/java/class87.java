...
public class class87 extends class97 {
    ...
    @OriginalMember(owner = "client!jb", name = "b", descriptor = "()Lkc;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lk;III)Ljb;")
    ...
    @OriginalMember(owner = "client!jb", name = "c", descriptor = "()Lkc;")
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(Lk;II)Ljb;")
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lk;II)V")
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lk;III)V")
