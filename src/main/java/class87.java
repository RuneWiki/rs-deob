...
public class class87 extends class194 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILki;)V")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILaq;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IILbg;)V")
