...
public class class87 {
    ...
    @OriginalMember(owner = "client!vga", name = "a", descriptor = "(B)Lcea;")
    ...
    @OriginalMember(owner = "client!vga", name = "c", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vga", name = "b", descriptor = "(II)Ljp;")
    ...
    @OriginalMember(owner = "client!vga", name = "<init>", descriptor = "(Lal;ILnd;)V")
