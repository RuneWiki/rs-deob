...
public class class87 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(BI)V", line = 18)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)Lpc;", line = 32)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(Z)V", line = 63)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(ILgh;IBII)Lbn;", line = 74)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(Z)V", line = 118)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Ljda;ILjo;)V", line = 135)
