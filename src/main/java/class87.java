...
public class class87 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)Lvf;", line = 21)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(BLcd;)V", line = 36)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "()V", line = 68)
