...
public class class87 {
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(IIB)Z", line = 3)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(Ljw;IIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!aha", name = "a", descriptor = "(ZII)Z", line = 106)
