...
public class class87 extends class604 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lsf;IIZ)V")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lsf;II[III)V")
