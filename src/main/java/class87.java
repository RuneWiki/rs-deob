...
public class class87 extends class382 {
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!hw", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hw", name = "b", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!hw", name = "a", descriptor = "(IIIIIII)V", line = 199)
