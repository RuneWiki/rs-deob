...
public class class87 extends class403 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZLr;Lci;ZII)[F")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILci;Lr;)Z")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ZDIILr;ZILci;)[I")
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lbt;)V")
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Lci;Lr;DIZII)[I")
