...
public class class87 extends class45 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lbu;Lbu;Lbu;ZLbu;)V", line = 3)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "()V", line = 811)
    public class87() {
        super(0, true);
    }

    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lgr;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lcu;II)V", line = 648)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(II)[I", line = 711)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(II)I", line = 774)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Z)V", line = 796)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(Z)V", line = 815)
    ...
    @OriginalMember(owner = "client!mc", name = "e", descriptor = "(I)Lkb;", line = 836)
