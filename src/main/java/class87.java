...
public class class87 extends class457 {
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Z)V", line = 86)
    public final void method62(boolean arg0) {
        this.field6752.method1161(260, 8448);
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "()Z", line = 89)
    public final boolean method65() {
        return true;
    }

    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lvo;)V", line = 92)
    public final void method63(class205 arg0) {
    }

    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lks;Lle;)V", line = 101)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "()V", line = 109)
