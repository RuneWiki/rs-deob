...
public class class87 {
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(III)Lbr;", line = 5)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(Lqj;Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!dq", name = "a", descriptor = "(B)V", line = 52)
