...
public class class214 extends class488 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(B)Z", line = 10)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BI)I", line = 32)
    ...
    @OriginalMember(owner = "client!ida", name = "c", descriptor = "(I)I", line = 49)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I)Ldw;", line = 75)
    ...
    @OriginalMember(owner = "client!ida", name = "c", descriptor = "(BI)V", line = 175)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lbd;", line = 205)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(B)I", line = 223)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(III)Ltg;", line = 244)
    ...
    @OriginalMember(owner = "client!ida", name = "c", descriptor = "(B)V", line = 515)
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(ILvp;Lvp;Luh;Lqc;I[BIZ)V", line = 867)
    ...
    @OriginalMember(owner = "client!ida", name = "d", descriptor = "(I)V", line = 543)
    ...
    @OriginalMember(owner = "client!ida", name = "d", descriptor = "(B)I", line = 560)
    ...
    @OriginalMember(owner = "client!ida", name = "e", descriptor = "(I)I", line = 575)
    ...
    @OriginalMember(owner = "client!ida", name = "e", descriptor = "(B)V", line = 593)
    ...
    @OriginalMember(owner = "client!ida", name = "f", descriptor = "(I)V", line = 774)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(BI)[B", line = 820)
