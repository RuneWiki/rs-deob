...
public class class214 extends class648 {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!cea", name = "c", descriptor = "(I)Z", line = 15)
    ...
    @OriginalMember(owner = "client!cea", name = "d", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ZZ)V", line = 39)
    ...
    @OriginalMember(owner = "client!cea", name = "e", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(BII)V", line = 59)
    ...
    @OriginalMember(owner = "client!cea", name = "b", descriptor = "(ZI)Lbh;", line = 69)
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Lbca;II)V", line = 98)
    ...
    @OriginalMember(owner = "client!cea", name = "<init>", descriptor = "(Lwu;)V", line = 114)
    public class214(class373 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(II)I", line = 123)
