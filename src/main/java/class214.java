...
public class class214 {
    ...
    @OriginalMember(owner = "client!hp", name = "toString", descriptor = "()Ljava/lang/String;", line = 9)
    public final String toString() {
        field3046++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(II)V", line = 37)
