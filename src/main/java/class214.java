...
public class class214 implements class617 {
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!ta", name = "b", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IIZI)I", line = 54)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(BZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILjava/lang/String;ZLda;II)I", line = 127)
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "(Leaa;Lnha;)V", line = 137)
