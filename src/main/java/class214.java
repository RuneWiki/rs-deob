...
public abstract class class214 extends class180 {
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(III)[I", line = 74)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(III)V", line = 96)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Llk;II)V", line = 121)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Z)I", line = 136)
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIB)[[I", line = 165)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(IZ)V", line = 196)
    public class214(int arg0, boolean arg1) {
        this.field3026 = new class214[arg0];
        this.field3032 = arg1;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IB)[[I", line = 215)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BI)[I", line = 226)
