...
public class class214 extends class739 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(ZI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "()V", line = 37)
    public class214() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lsl;IB)V", line = 42)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)V", line = 81)
