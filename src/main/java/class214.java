...
public class class214 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "()Lnp;", line = 9)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "()[B", line = 16)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lfp;II)Lsba;", line = 75)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Lee;)V", line = 128)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "()V", line = 149)
    private class214() {
    }

    @OriginalMember(owner = "client!sba", name = "c", descriptor = "()I", line = 86)
