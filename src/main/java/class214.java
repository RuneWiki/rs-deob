...
public class class214 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIFIIF[BFILag;FIF)V", line = 40)
    ...
    @OriginalMember(owner = "client!dh", name = "b", descriptor = "(II)Lso;", line = 62)
    ...
    @OriginalMember(owner = "client!dh", name = "<init>", descriptor = "(Liv;ILuu;)V", line = 110)
