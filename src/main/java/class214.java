...
public class class214 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IC)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(II)V", line = 47)
    public class214(int arg0, int arg1) {
        this.field3020 = arg1;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!ag", name = "toString", descriptor = "()Ljava/lang/String;", line = 72)
