...
public class class214 extends class344 implements class670 {
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(Loa;I)Lok;", line = 18)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Loa;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BB)V", line = 68)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILoa;)Lgr;", line = 109)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IZLoa;I)Lau;", line = 130)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)V", line = 163)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(B)I", line = 178)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(III)Z", line = 193)
    public static final boolean method1276(int arg0, int arg1, int arg2) {
        ++field2574;
        return arg2 != -65537 ? false : false;
    }

    @OriginalMember(owner = "client!ec", name = "f", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Loa;B)V", line = 217)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILoa;)Lba;", line = 245)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)V", line = 259)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Loa;ZI)Lba;", line = 274)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IB)I", line = 295)
    public static final int method1279(int arg0, byte arg1) {
        ++field2592;
        return arg1 < 122 ? -56 : arg0 >>> 10;
    }

    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IILoa;I)Z", line = 309)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZIZIILfl;Loa;)V", line = 339)
    ...
    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(Loa;I)V", line = 359)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Loa;Lbfa;IIIIZIZ)V", line = 369)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(BI)I", line = 402)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(B)I", line = 413)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(B)Z", line = 423)
    public final boolean method449(byte arg0) {
        ++field2573;
        return arg0 != -126 ? false : this.field2587;
    }

    @OriginalMember(owner = "client!ec", name = "c", descriptor = "(B)I", line = 438)
