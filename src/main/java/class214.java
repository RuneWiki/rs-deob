...
public class class214 extends class690 {
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)Lcn;", line = 7)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lpea;IIIIII)V", line = 278)
