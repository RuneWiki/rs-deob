...
public class class214 extends class83 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Lqn;ZILjava/lang/String;)Lal;", line = 26)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(IZI)V", line = 92)
    ...
    @OriginalMember(owner = "client!vv", name = "<init>", descriptor = "(IIIIIII)V", line = 114)
    ...
    @OriginalMember(owner = "client!vv", name = "b", descriptor = "(I)V", line = 125)
