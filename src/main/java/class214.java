...
public class class214 extends class271 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIIF[FIIFII)V", line = 19)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lnu;)V", line = 84)
