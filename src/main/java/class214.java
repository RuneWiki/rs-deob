...
public class class214 extends class106 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZB)V", line = 4)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IILih;)V", line = 14)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IBLqa;Lug;I)V", line = 31)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZI)V", line = 65)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)Z", line = 97)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lvj;Lpo;)V", line = 108)
    ...
    @OriginalMember(owner = "client!hp", name = "f", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lnu;)V", line = 144)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 195)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IBI)V", line = 231)
