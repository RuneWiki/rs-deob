...
public class class214 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "([IJILfq;)Ljava/lang/String;", line = 19)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(ILkha;Lkha;Lgia;)V", line = 105)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)Lrk;", line = 62)
