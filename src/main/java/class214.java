...
public class class214 implements Runnable {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I[FIIIIII[FFIIFF)V", line = 20)
    ...
    @OriginalMember(owner = "client!fq", name = "run", descriptor = "()V", line = 104)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIIIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!fq", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 379)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(B)V", line = 280)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I[BII)V", line = 305)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!fq", name = "c", descriptor = "(B)V", line = 364)
