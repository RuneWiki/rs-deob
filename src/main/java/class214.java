...
public class class214 {
    ...
    @OriginalMember(owner = "client!nn", name = "<init>", descriptor = "(II)V", line = 7)
    public class214(int arg0, int arg1) {
    }

    @OriginalMember(owner = "client!nn", name = "toString", descriptor = "()Ljava/lang/String;", line = 18)
    public final String toString() {
        field3237++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!nn", name = "b", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(II)Lah;", line = 56)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(IILn;BLqa;II)V", line = 96)
