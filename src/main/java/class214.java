...
public class class214 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Luq;[Ltj;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Luu;III)Lvo;", line = 94)
