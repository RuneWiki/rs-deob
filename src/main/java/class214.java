...
public class class214 extends class203 {
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lpq;Lsa;)V", line = 25)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(BZ)V", line = 46)
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(I)Z", line = 81)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)Ljava/lang/String;", line = 93)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IZLwha;)V", line = 116)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(IIZ)V", line = 134)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(ZB)V", line = 174)
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(B)V", line = 184)
