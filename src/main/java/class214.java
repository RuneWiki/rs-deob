...
public class class214 extends class307 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Z)V", line = 7)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIZ)Z", line = 56)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I[BIZII)V", line = 66)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IIIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lql;II)V", line = 527)
