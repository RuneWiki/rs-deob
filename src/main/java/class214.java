...
public class class214 extends class37 {
    ...
    @OriginalMember(owner = "client!ida", name = "DA", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Ltw;[I)V")
    ...
    @OriginalMember(owner = "client!ida", name = "E", descriptor = "(Lha;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(BILwb;I)V")
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Lnv;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(Lha;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ida", name = "v", descriptor = "(IILha;)Lha;")
