...
public class class214 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIIIIZIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "()I", line = 226)
    public int method377() throws Exception {
        field3058++;
        return this.field3074;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "()V", line = 254)
    public void method379() {
        field3050++;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "([II)V", line = 263)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 421)
    public void method380(Component arg0) throws Exception {
        field3041++;
    }

    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)V", line = 444)
    public void method376(int arg0) throws Exception {
        field3060++;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILaf;)V", line = 455)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(I)V", line = 476)
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "(I)V", line = 519)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IZ)V", line = 541)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(B)Llo;", line = 555)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "()V", line = 582)
    public void method378() throws Exception {
        field3063++;
    }

    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IZ[[[Lpm;III)Z", line = 593)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Laf;I)V", line = 913)
    ...
    @OriginalMember(owner = "client!wi", name = "d", descriptor = "()V", line = 946)
