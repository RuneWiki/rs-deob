...
public class class214 {
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(II)Lih;", line = 5)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(II)V", line = 55)
    ...
    @OriginalMember(owner = "client!h", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!h", name = "<init>", descriptor = "(Lvd;ILpe;)V", line = 111)
    public class214(class635 arg0, int arg1, class615 arg2) {
        this.field2751 = arg2;
        this.field2751.method3341(1, -19046);
    }

    @OriginalMember(owner = "client!h", name = "a", descriptor = "(Ljava/awt/Canvas;ILe;)Loa;", line = 89)
    ...
    @OriginalMember(owner = "client!h", name = "b", descriptor = "(I)V", line = 100)
