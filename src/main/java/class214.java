...
public class class214 extends class556 implements class457 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!eq", name = "f", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(ILha;)Lwg;", line = 27)
    public final class428 method750(int arg0, class60 arg1) {
        ++field2820;
        return arg0 > -22 ? null : this.field2830;
    }

    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(I)Z", line = 39)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(Lha;I)Ljk;", line = 50)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(B)V", line = 97)
    ...
    @OriginalMember(owner = "client!eq", name = "i", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!eq", name = "g", descriptor = "(B)Z", line = 126)
    ...
    @OriginalMember(owner = "client!eq", name = "h", descriptor = "(I)I", line = 137)
    ...
    @OriginalMember(owner = "client!eq", name = "f", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!eq", name = "d", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ILha;)V", line = 175)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(B)I", line = 185)
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIIIIIII)V", line = 201)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(ZLtd;)V", line = 211)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(BILha;I)Z", line = 222)
    ...
    @OriginalMember(owner = "client!eq", name = "e", descriptor = "(I)Z", line = 243)
    ...
    @OriginalMember(owner = "client!eq", name = "b", descriptor = "(ILha;)V", line = 254)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(III)Z", line = 266)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 284)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lha;I)V", line = 297)
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Z)I", line = 317)
