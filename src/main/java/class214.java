...
public class class214 extends class446 implements class302 {
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Leea;Z)V")
    public class214(class132 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Ljaclib/memory/Source;IIB)Z")
