...
public class class214 implements class81 {
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(IZ)V", line = 33)
    ...
    @OriginalMember(owner = "client!ph", name = "<init>", descriptor = "(Lsr;Las;)V", line = 64)
    ...
    @OriginalMember(owner = "client!ph", name = "a", descriptor = "(BLda;Ljava/lang/String;III)I", line = 74)
