...
public class class214 {
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(ZLjava/lang/String;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(CI)Z", line = 80)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!vu", name = "a", descriptor = "(II)Lqi;", line = 109)
