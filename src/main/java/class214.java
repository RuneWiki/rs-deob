...
public class class214 extends class243 {
    ...
    @OriginalMember(owner = "client!ta", name = "<init>", descriptor = "()V", line = 5)
    public class214() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(IZII)Ljava/lang/String;", line = 15)
    ...
    @OriginalMember(owner = "client!ta", name = "c", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ta", name = "e", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(ILji;B)V", line = 119)
    ...
    @OriginalMember(owner = "client!ta", name = "a", descriptor = "(II)[I", line = 171)
