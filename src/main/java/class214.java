...
public class class214 extends class185 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILjava/awt/Graphics;BI)V", line = 10)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BLjava/awt/Canvas;)V", line = 28)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILjava/awt/Graphics;)V", line = 50)
