...
public class class214 extends class86 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(I)I", line = 14)
    public final int method73(int arg0) {
        ++field2933;
        return arg0 != 0 ? 43 : 0;
    }

    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(ILsf;)V", line = 52)
    public class214(int arg0, class551 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!cu", name = "c", descriptor = "(I)Z", line = 55)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(II)I", line = 75)
    ...
    @OriginalMember(owner = "client!cu", name = "<init>", descriptor = "(Lsf;)V", line = 92)
