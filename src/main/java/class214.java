...
public class class214 extends class155 {
    ...
    @OriginalMember(owner = "client!oe", name = "g", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "(Loia;Lgj;)V", line = 17)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Lbr;II)V", line = 69)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(ZZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IIB)V", line = 154)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(I)Z", line = 165)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;ZZI)V", line = 211)
    ...
    @OriginalMember(owner = "client!oe", name = "e", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IZ)V", line = 297)
