...
public class class214 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(BLvq;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ldp;B)V")
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IILjh;)V")
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(I)Lon;")
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)Lon;")
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lvq;)V")
