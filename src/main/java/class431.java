...
public class class431 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lkv;ILjn;Lmt;Ljn;Ljn;)Z")
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ZLn;I)V")
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lla;)V")
    public class431(class419 arg0) {
        this.field6188 = arg0;
    }

    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(Lla;Lgda;)V")
