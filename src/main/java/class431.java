...
public class class431 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lgo;Lya;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(ZI)V", line = 40)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(II)Z", line = 72)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IIIIIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IBI)V", line = 134)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(IB)I", line = 192)
