...
public class class431 extends class657 {
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lok;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lok;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!qe", name = "<init>", descriptor = "(Lok;II)V")
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(IIILvg;)V")
