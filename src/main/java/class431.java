...
public class class431 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IBLud;)Z")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Lat;III)V")
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(BILat;)I")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lqo;)V")
