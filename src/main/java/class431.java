...
public class class431 extends class152 implements Runnable {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!pe", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(Ljl;)V", line = 82)
    public class431(class176 arg0) {
        this.field6443 = arg0;
    }

    @OriginalMember(owner = "client!pe", name = "c", descriptor = "(I)V", line = 55)
