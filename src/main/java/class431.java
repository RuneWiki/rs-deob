...
public class class431 extends class585 {
    ...
    @OriginalMember(owner = "client!fr", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(Lso;II)V", line = 73)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 179)
    public class431() {
        super(1, true);
    }

    @OriginalMember(owner = "client!fr", name = "c", descriptor = "(I)V", line = 148)
