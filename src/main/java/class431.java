...
public class class431 extends class70 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(BI)V", line = 53)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(I)V", line = 83)
    ...
    @OriginalMember(owner = "client!hb", name = "b", descriptor = "(Lwe;I)V", line = 105)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BI)V", line = 133)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(IB)V", line = 185)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLrn;)V", line = 214)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Z)V", line = 381)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLwe;)V", line = 392)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Llf;ZFIZ)V", line = 431)
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lwe;I)V", line = 456)
