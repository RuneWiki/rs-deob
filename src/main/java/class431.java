...
public class class431 {
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(II)I", line = 16)
    public final int method2583(int arg0, int arg1) {
        return arg0 >= -96 ? 87 : this.field5996.Present(arg1);
    }

    @OriginalMember(owner = "client!eja", name = "a", descriptor = "(Ljagdx/IDirect3DSurface;BLjagdx/IDirect3DSwapChain;)V", line = 26)
    ...
    @OriginalMember(owner = "client!eja", name = "b", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!eja", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 66)
