...
public class class431 extends Canvas {
    ...
    @OriginalMember(owner = "client!li", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 4)
    public final void update(Graphics arg0) {
        field5757++;
        this.field5761.update(arg0);
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IZ[B)Ljava/lang/Object;", line = 30)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIIIB)V", line = 62)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!li", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 100)
    public final void paint(Graphics arg0) {
        field5756++;
        this.field5761.paint(arg0);
    }

    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 114)
