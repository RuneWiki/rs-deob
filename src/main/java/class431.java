...
public class class431 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Z)Z", line = 6)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lwca;[[BI)V", line = 21)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(B)V", line = 95)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZII)I", line = 105)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIII[[[B[I[I[I[I[IIBIIZZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Z)V", line = 419)
