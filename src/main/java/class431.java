...
public class class431 extends class55 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ZZLgv;)V", line = 3)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IZ)V", line = 156)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IB)V", line = 168)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "([III)V", line = 184)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIII)V", line = 342)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(II)V", line = 357)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIIIF)V", line = 375)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(I)V", line = 495)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILjava/io/File;Z)V", line = 519)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lsi;IIIII)V", line = 545)
