...
public class class431 {
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(Lps;II)I", line = 16)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!vh", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!vh", name = "a", descriptor = "(BII)I", line = 76)
    ...
    @OriginalMember(owner = "client!vh", name = "c", descriptor = "(I)Lur;", line = 102)
