...
public class class431 extends class424 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tj", name = "g", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!tj", name = "b", descriptor = "(II)I", line = 52)
    public static int method2655(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!tj", name = "a", descriptor = "([BZ)Lmc;", line = 59)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Li;IIZII)V", line = 141)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IZ)[[I", line = 205)
    ...
    @OriginalMember(owner = "client!tj", name = "c", descriptor = "(II)I", line = 272)
    ...
    @OriginalMember(owner = "client!tj", name = "f", descriptor = "(I)I", line = 275)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(IIB)I", line = 286)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(Lrg;BI)V", line = 301)
    ...
    @OriginalMember(owner = "client!tj", name = "<init>", descriptor = "()V", line = 357)
    public class431() {
        super(0, false);
    }

    @OriginalMember(owner = "client!tj", name = "h", descriptor = "(I)Z", line = 321)
    ...
    @OriginalMember(owner = "client!tj", name = "a", descriptor = "(BI)I", line = 346)
    ...
    @OriginalMember(owner = "client!tj", name = "i", descriptor = "(I)V", line = 360)
