...
public class class431 extends class578 implements class438 {
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLqa;)Led;", line = 15)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;B)V", line = 25)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(IIIIILlaa;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqa;Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Z)Z", line = 60)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BILqa;)Lr;", line = 72)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(Lqa;B)V", line = 87)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILqa;IB)Z", line = 97)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 108)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(III)I", line = 119)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!ag", name = "c", descriptor = "(I)I", line = 147)
    ...
    @OriginalMember(owner = "client!ag", name = "b", descriptor = "(B)V", line = 161)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Z)I", line = 174)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILqa;IIZLse;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILqa;)Llb;", line = 197)
