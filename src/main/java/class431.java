...
public class class431 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IILfh;)V", line = 9)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Lfh;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(B)V", line = 111)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ZII)B", line = 149)
