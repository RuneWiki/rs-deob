...
public abstract class class431 extends class321 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Ljava/lang/String;IC)I", line = 3)
    ...
    @OriginalMember(owner = "client!gaa", name = "f", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I[IIIIZLuca;B)Lei;", line = 42)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(I)V", line = 64)
