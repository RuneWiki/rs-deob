...
public class class431 implements Runnable {
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!da", name = "b", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(IB[BI)V", line = 40)
    ...
    @OriginalMember(owner = "client!da", name = "a", descriptor = "(BLqa;Ln;)V", line = 84)
    ...
    @OriginalMember(owner = "client!da", name = "c", descriptor = "(B)V", line = 309)
    ...
    @OriginalMember(owner = "client!da", name = "run", descriptor = "()V", line = 319)
    ...
    @OriginalMember(owner = "client!da", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 389)
