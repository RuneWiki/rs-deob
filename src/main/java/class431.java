...
public class class431 extends class621 implements class238 {
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZLha;)Loba;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lha;IIZ)Lwv;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IBILha;)Z")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!rm", name = "i", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lgda;Lha;IIZII)V")
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILha;I)Lka;")
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Lha;Ltba;IIIIIZIIZ)V")
