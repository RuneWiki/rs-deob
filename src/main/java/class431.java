...
public class class431 extends class490 {
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "([Lhu;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ifa", name = "b", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ifa", name = "a", descriptor = "(ILha;IIIB)V", line = 54)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Lrv;II[B)V", line = 87)
    ...
    @OriginalMember(owner = "client!ifa", name = "<init>", descriptor = "(Lrv;II[I)V", line = 99)
