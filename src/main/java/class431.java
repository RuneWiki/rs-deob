...
public class class431 extends class268 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(JJ)J", line = 39)
    public static long method2370(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)Ljd;", line = 48)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILjava/lang/String;)V", line = 59)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(ILtl;Lpd;III)V", line = 176)
