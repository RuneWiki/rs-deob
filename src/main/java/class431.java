...
public class class431 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(FLtq;Ltq;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lrs;)V", line = 114)
