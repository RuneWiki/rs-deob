...
public class class431 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ID)V", line = 6)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(J[I[S[S)V", line = 109)
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "()V", line = 119)
    protected class431() {
    }
