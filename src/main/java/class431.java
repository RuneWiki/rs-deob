...
public class class431 extends class171 {
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Lsm;ZBIF)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(Luk;I)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(ILuk;)V")
    ...
    @OriginalMember(owner = "client!hb", name = "a", descriptor = "(BLuk;)V")
