...
public class class431 extends class227 {
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "()V", line = 3)
    public class431() {
        super(1, false);
    }

    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IIIIILch;)V", line = 7)
    ...
    @OriginalMember(owner = "client!cf", name = "e", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 157)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(FFZF)F", line = 240)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lug;II)V", line = 251)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(II)[I", line = 297)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IZ)[[I", line = 344)
