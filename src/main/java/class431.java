...
public class class431 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILrt;)V", line = 4)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;", line = 26)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZLsp;)Z", line = 55)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Loa;I)Lxa;", line = 117)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ZLoa;I)Lxa;", line = 151)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(ILrt;I)V", line = 190)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)I", line = 377)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(I)V", line = 405)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(Z)V", line = 433)
