...
public abstract class class431 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IIII)Z", line = 20)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;B)V", line = 40)
    ...
    @OriginalMember(owner = "client!pe", name = "b", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IB)V", line = 79)
