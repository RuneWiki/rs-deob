...
public abstract class class431 extends class59 {
    ...
    @OriginalMember(owner = "client!jk", name = "d", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!jk", name = "a", descriptor = "(ILqq;Lps;ZZII)V", line = 18)
    ...
    @OriginalMember(owner = "client!jk", name = "g", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!jk", name = "e", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!jk", name = "h", descriptor = "(I)Lhn;", line = 57)
    ...
    @OriginalMember(owner = "client!jk", name = "<init>", descriptor = "(IIIIIII)V", line = 77)
