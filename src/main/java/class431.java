...
public class class431 extends class71 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(BFFFIIFII[FI)V", line = 5)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)V", line = 95)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(I)V", line = 122)
