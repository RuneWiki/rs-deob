...
public class class431 extends class405 {
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(BIII)V")
    ...
    @OriginalMember(owner = "client!ko", name = "a", descriptor = "(FZ)V")
    ...
    @OriginalMember(owner = "client!ko", name = "<init>", descriptor = "(IIIIIF)V")
