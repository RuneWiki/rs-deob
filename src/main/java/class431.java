...
public abstract class class431 extends class88 {
    ...
    @OriginalMember(owner = "client!ss", name = "d", descriptor = "()I", line = 4)
    public final int method670() {
        return this.field6166 + this.field6146 + this.field6142;
    }

    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(IIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(FFFFFFIIII)V", line = 54)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "()I", line = 152)
    public final int method657() {
        return this.field6154;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "()I", line = 156)
    public final int method656() {
        return this.field6164 + this.field6154 + this.field6156;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(FFFFFFILaa;II)V", line = 164)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(IIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "()I", line = 201)
    public final int method663() {
        return this.field6146;
    }

    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(FFFFFF)Z", line = 215)
    ...
    @OriginalMember(owner = "client!ss", name = "<init>", descriptor = "(Lrea;II)V", line = 371)
