...
public class class431 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "([BIII[BI)I", line = 9)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I[BI[BIZ)I", line = 83)
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(I)V", line = 231)
    ...
    @OriginalMember(owner = "client!taa", name = "<init>", descriptor = "([B)V", line = 250)
