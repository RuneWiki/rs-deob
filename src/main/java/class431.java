...
public abstract class class431 extends class388 {
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(III)Z", line = 8)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(I[[[BIBII)V", line = 21)
    ...
    @OriginalMember(owner = "client!pe", name = "a", descriptor = "(IB[I[[B[BI[I[[B)I", line = 160)
    ...
    @OriginalMember(owner = "client!pe", name = "f", descriptor = "(I)V", line = 222)
    ...
    @OriginalMember(owner = "client!pe", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 233)
