...
public class class431 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Lti;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(II)[I", line = 67)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(III)I", line = 351)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "()V", line = 383)
