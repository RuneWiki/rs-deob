...
public class class431 extends class346 implements class511 {
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lrl;I[BI)V")
    ...
    @OriginalMember(owner = "client!gj", name = "<init>", descriptor = "(Lrl;ILjaggl/memory/NativeBuffer;)V")
    ...
    @OriginalMember(owner = "client!gj", name = "a", descriptor = "(BLae;)Ljava/lang/String;")
