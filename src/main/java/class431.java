...
public class class431 implements class16 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZIIIFI)[I", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BIIFZI)[I", line = 20)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILza;IIIIZII)V", line = 31)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZLwm;)Lcu;", line = 175)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(II)Lqo;", line = 188)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(II)Lbb;", line = 210)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZIZFII)[F", line = 222)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 243)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)Z", line = 381)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(BII)Z", line = 395)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)V", line = 414)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Loi;Loi;Loi;)V", line = 434)
