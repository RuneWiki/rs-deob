...
public class class711 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILtn;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lpg;B)Z")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Ltn;)V")
