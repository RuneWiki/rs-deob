...
public class class711 implements Runnable {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BLjava/io/File;[B)Z", line = 28)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 704)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;II)Lkda;", line = 62)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/awt/Frame;I)Ltj;", line = 103)
    public final class197 method4044(Frame arg0, int arg1) {
        return arg1 < 66 ? null : this.method4051(7, 0, arg0, 1, 0);
    }

    @OriginalMember(owner = "client!ge", name = "run", descriptor = "()V", line = 113)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILjava/lang/Class;Ljava/lang/String;)Ltj;", line = 409)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILjava/lang/String;)Lkda;", line = 418)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILjava/lang/String;ZI)Ltj;", line = 437)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BI)Ltj;", line = 447)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IBIII)Ltj;", line = 458)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 474)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IILjava/lang/Object;II)Ltj;", line = 487)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)V", line = 518)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;I)Ltj;", line = 534)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)Ltj;", line = 553)
    public final class197 method4054(byte arg0) {
        return arg0 > -50 ? null : this.method4051(5, 0, null, 1, 0);
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/net/URL;B)Ltj;", line = 563)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/Runnable;II)Ltj;", line = 592)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;I)Ltj;", line = 602)
    ...
    @OriginalMember(owner = "client!ge", name = "d", descriptor = "(I)V", line = 615)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BLjava/lang/String;)Ltj;", line = 671)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/String;ZB)Ltj;", line = 684)
