...
public class class711 {
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BI)Z", line = 18)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IIIB)Z", line = 41)
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(IB)V", line = 178)
    ...
    @OriginalMember(owner = "client!qf", name = "c", descriptor = "(I)I", line = 197)
