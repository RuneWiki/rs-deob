...
public class class711 implements Runnable {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;B)Ljava/lang/String;", line = 20)
    ...
    @OriginalMember(owner = "client!nj", name = "run", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 98)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Ljava/io/OutputStream;I)V", line = 181)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "([BIII)V", line = 128)
