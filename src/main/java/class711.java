...
public class class711 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(B)Lpja;", line = 19)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lvia;ILvia;)V", line = 61)
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(Lsia;I)I", line = 79)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "(J[I[S[S)V", line = 101)
    ...
    @OriginalMember(owner = "client!jca", name = "<init>", descriptor = "()V", line = 111)
    protected class711() {
    }

    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(IIILjava/lang/String;I)V", line = 118)
