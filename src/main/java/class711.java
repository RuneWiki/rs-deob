...
public class class711 extends class395 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ILha;IB)Z")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IILha;B)Lka;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Lha;B)Liha;")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lka;ZLih;Lha;)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(BLha;ZILuq;II)V")
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Lha;I)Lua;")
