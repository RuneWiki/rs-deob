...
public class class711 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 8)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IBI)V", line = 23)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lbi;BILjava/lang/String;)Lpf;", line = 44)
