...
public class class711 {
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(BI)Lvc;")
    ...
    @OriginalMember(owner = "client!lu", name = "a", descriptor = "(III)Laha;")
    ...
    @OriginalMember(owner = "client!lu", name = "<init>", descriptor = "(Lnb;IZLoh;Loh;)V")
