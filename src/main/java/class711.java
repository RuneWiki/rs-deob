...
public class class711 {
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZLvha;)V", line = 19)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILag;)V", line = 725)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I)Lag;", line = 742)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(I)V", line = 784)
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(IIIIII)V", line = 791)
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(B)V", line = 763)
