...
public class class711 {
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(I)Lkha;")
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(Lkha;I)V")
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(B)Lkha;")
    ...
    @OriginalMember(owner = "client!lga", name = "c", descriptor = "(I)Lkha;")
    ...
    @OriginalMember(owner = "client!lga", name = "a", descriptor = "(IIB)Z")
