...
public class class711 extends class87 {
    ...
    @OriginalMember(owner = "client!mga", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lqda;Z)I", line = 20)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IIII)V", line = 59)
    ...
    @OriginalMember(owner = "client!mga", name = "<init>", descriptor = "(IIIIIF)V", line = 73)
    public class711(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(II)V", line = 78)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(FI)V", line = 92)
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(IZLnba;)V", line = 103)
