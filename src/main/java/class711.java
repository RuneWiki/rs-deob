...
public class class711 extends class667 {
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "()V", line = 14)
    public class711() {
        super(0, false);
    }

    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(III)V", line = 17)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BLwk;)Z", line = 49)
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)I", line = 99)
    ...
    @OriginalMember(owner = "client!nea", name = "c", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Lud;II)V", line = 131)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ZI)[[I", line = 145)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Ld;IILjava/awt/Canvas;)Lha;", line = 211)
