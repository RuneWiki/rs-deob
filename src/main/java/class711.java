...
public class class711 extends class650 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lsk;)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(ILsk;)V")
    ...
    @OriginalMember(owner = "client!ar", name = "b", descriptor = "()Lsk;")
