...
public class class711 {
    ...
    @OriginalMember(owner = "client!ufa", name = "b", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Lufa;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(Z)V", line = 40)
    ...
    @OriginalMember(owner = "client!ufa", name = "a", descriptor = "(I)Lufa;", line = 52)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ufa", name = "<init>", descriptor = "(IIIIII)V", line = 82)
