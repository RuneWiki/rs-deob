...
public class class711 {
    ...
    @OriginalMember(owner = "client!jca", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jca", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!jca", name = "c", descriptor = "(I)V", line = 36)
