...
public class class711 extends class219 {
    ...
    @OriginalMember(owner = "client!qf", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLqh;)I")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(BLar;)Lhba;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!qf", name = "d", descriptor = "(B)Lkb;")
    ...
    @OriginalMember(owner = "client!qf", name = "a", descriptor = "(Les;I)Lns;")
