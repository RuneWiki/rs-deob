...
public class class15 extends class187 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lhf;B)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)Lha;")
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lhf;)V")
