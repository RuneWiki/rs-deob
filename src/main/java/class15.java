...
public class class15 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IBIIZ)V", line = 22)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILmj;)Lmj;", line = 88)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ZI)V", line = 116)
