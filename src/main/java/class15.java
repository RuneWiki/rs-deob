...
public class class15 {
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "c", descriptor = "LCSUKQTYW;")
    public class8 field781 = new class8();

    @OriginalMember(owner = "client!FEPBPONH", name = "d", descriptor = "LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "a", descriptor = "(LCSUKQTYW;)V")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "a", descriptor = "(LCSUKQTYW;Z)V")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "a", descriptor = "()LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "b", descriptor = "()LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "a", descriptor = "(I)LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "b", descriptor = "(I)LCSUKQTYW;")
    ...
    @OriginalMember(owner = "client!FEPBPONH", name = "a", descriptor = "(B)LCSUKQTYW;")
