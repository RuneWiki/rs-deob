...
public class class15 extends class381 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z[III[I)J", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lrm;ZLr;IIILhq;IBI)Lda;", line = 48)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 304)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IIIII)V", line = 341)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Z)V", line = 522)
