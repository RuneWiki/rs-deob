...
@OriginalClass("client!DZSIRBWX")
public class class15 extends class31 {

    @OriginalMember(owner = "client!DZSIRBWX", name = "y", descriptor = "Z")
    private boolean field699 = false;

    @OriginalMember(owner = "client!DZSIRBWX", name = "z", descriptor = "I")
    private int field700 = 540;

    @OriginalMember(owner = "client!DZSIRBWX", name = "A", descriptor = "I")
    private int field701 = 2;

    @OriginalMember(owner = "client!DZSIRBWX", name = "B", descriptor = "Z")
    private boolean field702 = false;

    @OriginalMember(owner = "client!DZSIRBWX", name = "I", descriptor = "I")
    public int field709;

    @OriginalMember(owner = "client!DZSIRBWX", name = "J", descriptor = "I")
    public int field710;

    @OriginalMember(owner = "client!DZSIRBWX", name = "D", descriptor = "[I")
    public int[] field704;

    @OriginalMember(owner = "client!DZSIRBWX", name = "G", descriptor = "I")
    public int field707;

    @OriginalMember(owner = "client!DZSIRBWX", name = "H", descriptor = "I")
    public int field708;

    @OriginalMember(owner = "client!DZSIRBWX", name = "E", descriptor = "I")
    public int field705;

    @OriginalMember(owner = "client!DZSIRBWX", name = "F", descriptor = "I")
    public int field706;

    @OriginalMember(owner = "client!DZSIRBWX", name = "C", descriptor = "[B")
    public byte[] field703;

    @OriginalMember(owner = "client!DZSIRBWX", name = "<init>", descriptor = "(LOTSGNSQM;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "b", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "b", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "a", descriptor = "(IIII)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!DZSIRBWX", name = "a", descriptor = "(II[I[BIIII[II)V")
