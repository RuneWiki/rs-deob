...
public class class15 extends class140 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(B)Lad;", line = 8)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lsd;Lec;IIIIIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Z)V", line = 36)
