...
public class class15 extends class4 {
    ...
    @OriginalMember(owner = "client!EZOFESYN", name = "u", descriptor = "LZKWMIVTX;")
    ...
    @OriginalMember(owner = "client!EZOFESYN", name = "C", descriptor = "Lclient;")
    public static client field712;

    @OriginalMember(owner = "client!EZOFESYN", name = "a", descriptor = "(I)LPZZVQRQI;")
    ...
    @OriginalMember(owner = "client!EZOFESYN", name = "a", descriptor = "(Z)LYABPKWWG;")
