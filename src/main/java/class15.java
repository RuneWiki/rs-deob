...
public class class15 extends class186 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(FB)V")
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(IIIIIF)V")
    public class15(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIIB)V")
