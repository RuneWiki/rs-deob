...
public class class15 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kh", name = "finalize", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILjava/net/Socket;B)Lpi;", line = 37)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lte;II)V", line = 50)
