...
public class class15 extends class743 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Loea;IIZ)V")
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Loea;IIII)V")
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Loea;II[III)V")
