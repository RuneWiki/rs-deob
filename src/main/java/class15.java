...
@OriginalClass("client!FIGUVTWB")
public class class15 {

    @OriginalMember(owner = "client!FIGUVTWB", name = "a", descriptor = "Z")
    private boolean field670 = true;

    @OriginalMember(owner = "client!FIGUVTWB", name = "b", descriptor = "I")
    private int field671 = 8;

    @OriginalMember(owner = "client!FIGUVTWB", name = "c", descriptor = "Z")
    private boolean field672 = true;

    @OriginalMember(owner = "client!FIGUVTWB", name = "d", descriptor = "I")
    private int field673 = -22512;

    @OriginalMember(owner = "client!FIGUVTWB", name = "f", descriptor = "I")
    public int field675;

    @OriginalMember(owner = "client!FIGUVTWB", name = "k", descriptor = "Z")
    private boolean field680;

    @OriginalMember(owner = "client!FIGUVTWB", name = "e", descriptor = "[B")
    public byte[] field674;

    @OriginalMember(owner = "client!FIGUVTWB", name = "g", descriptor = "[I")
    public int[] field676;

    @OriginalMember(owner = "client!FIGUVTWB", name = "h", descriptor = "[I")
    public int[] field677;

    @OriginalMember(owner = "client!FIGUVTWB", name = "i", descriptor = "[I")
    public int[] field678;

    @OriginalMember(owner = "client!FIGUVTWB", name = "j", descriptor = "[I")
    public int[] field679;

    @OriginalMember(owner = "client!FIGUVTWB", name = "<init>", descriptor = "(Z[B)V")
    ...
    @OriginalMember(owner = "client!FIGUVTWB", name = "a", descriptor = "(B[B)V")
    ...
    @OriginalMember(owner = "client!FIGUVTWB", name = "a", descriptor = "(Ljava/lang/String;[B)[B")
