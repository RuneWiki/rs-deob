...
public class class15 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(III)Lg;", line = 6)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZB)V", line = 37)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(I)V", line = 144)
