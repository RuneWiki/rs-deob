...
public class class15 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lsca;IZI)V")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILge;IIII)Ljava/awt/Frame;")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(ILcq;)[I")
