...
public class class15 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIBLqc;I)Lqc;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIIBIILqc;B)Lqc;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILil;)V")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lil;II)V")
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(II)Lof;")
