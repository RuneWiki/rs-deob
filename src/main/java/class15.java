...
public class class15 extends class385 implements class537 {
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(Lcba;I)V", line = 5)
    public final void method166(class516 arg0, int arg1) {
        super.method166(arg0, arg1);
    }

    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lss;IZ[[I)V", line = 12)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 63)
    ...
    @OriginalMember(owner = "client!kh", name = "c", descriptor = "(B)V", line = 73)
