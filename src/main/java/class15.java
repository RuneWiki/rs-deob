...
public class class15 implements class105 {
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "()V", line = 33)
    public final void method115() {
        this.field211 = Thread.currentThread();
        this.method116();
    }

    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(Lqa;II)V", line = 37)
    ...
    @OriginalMember(owner = "client!n", name = "finalize", descriptor = "()V", line = 52)
    protected final void finalize() {
        class438.method2701(-89, this);
    }

    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lda;BIZ)Lt;", line = 57)
