...
public class class15 extends class182 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "([[BILsca;)V")
    ...
    @OriginalMember(owner = "client!de", name = "<init>", descriptor = "(Lag;)V")
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILvfa;B)V")
