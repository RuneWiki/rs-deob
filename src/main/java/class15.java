...
public class class15 {
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(IILjava/awt/Canvas;I)Lwu;", line = 19)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(Lwfa;Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!raa", name = "a", descriptor = "(ILjc;)V", line = 82)
    ...
    @OriginalMember(owner = "client!raa", name = "<init>", descriptor = "(Ljc;)V", line = 180)
