...
public abstract class class15 extends class435 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(ZI[Ljk;)V", line = 11)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(III)Las;", line = 90)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Z)V", line = 116)
