...
public class class15 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lnq;Lnq;I)V", line = 11)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIIIBI)V", line = 153)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "([S[Ljava/lang/String;I)V", line = 280)
