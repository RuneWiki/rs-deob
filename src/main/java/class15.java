...
public class class15 {
    ...
    @OriginalMember(owner = "client!DZFLZLPS", name = "p", descriptor = "LDJKDKZEW;")
    private class13 field688;

    @OriginalMember(owner = "client!DZFLZLPS", name = "c", descriptor = "LENGZWEMK;")
    private class17 field675;

    @OriginalMember(owner = "client!DZFLZLPS", name = "d", descriptor = "LENGZWEMK;")
    private class17 field676;

    @OriginalMember(owner = "client!DZFLZLPS", name = "e", descriptor = "LENGZWEMK;")
    private class17 field677;

    @OriginalMember(owner = "client!DZFLZLPS", name = "f", descriptor = "LENGZWEMK;")
    private class17 field678;

    @OriginalMember(owner = "client!DZFLZLPS", name = "g", descriptor = "LENGZWEMK;")
    private class17 field679;

    @OriginalMember(owner = "client!DZFLZLPS", name = "h", descriptor = "LENGZWEMK;")
    private class17 field680;

    @OriginalMember(owner = "client!DZFLZLPS", name = "i", descriptor = "LENGZWEMK;")
    private class17 field681;

    @OriginalMember(owner = "client!DZFLZLPS", name = "j", descriptor = "LENGZWEMK;")
    private class17 field682;

    @OriginalMember(owner = "client!DZFLZLPS", name = "q", descriptor = "LENGZWEMK;")
    ...
    @OriginalMember(owner = "client!DZFLZLPS", name = "a", descriptor = "(LPKHWFJLM;Z)V")
