...
public class class15 extends class424 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BLpe;I)Lge;", line = 6)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "([BBLhf;[I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "()V", line = 125)
    public class15() {
    }

    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "([B)V", line = 144)
