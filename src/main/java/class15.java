...
public class class15 extends OutputStream {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ldda;Lqa;I)V", line = 88)
    ...
    @OriginalMember(owner = "client!de", name = "write", descriptor = "(I)V", line = 104)
    public final void write(int arg0) throws IOException {
        field138++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BI)Z", line = 123)
