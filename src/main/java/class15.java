...
public class class15 extends class513 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(III)Lwp;", line = 5)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIIIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lam;)V", line = 42)
