...
public class class15 extends class398 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IBIIIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)[I", line = 31)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "()V", line = 72)
    public class15() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qr", name = "c", descriptor = "(Z)V", line = 75)
