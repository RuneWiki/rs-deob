...
public class class15 extends class238 {
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lmh;II)V")
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lmh;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Lmh;IIZ[[I)V")
