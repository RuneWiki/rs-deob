...
public class class15 {
    ...
    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(I)Lgk;")
    ...
    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(B)Lgk;")
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(B)Lgk;")
    ...
    @OriginalMember(owner = "client!vl", name = "d", descriptor = "(B)Lgk;")
