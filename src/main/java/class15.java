...
@OriginalClass("client!EBTORROD")
public class class15 {

    @OriginalMember(owner = "client!EBTORROD", name = "a", descriptor = "B")
    private byte field803 = -111;

    @OriginalMember(owner = "client!EBTORROD", name = "b", descriptor = "Z")
    private boolean field804 = true;

    @OriginalMember(owner = "client!EBTORROD", name = "k", descriptor = "[I")
    private int[] field813 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "l", descriptor = "[I")
    private int[] field814 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "m", descriptor = "[I")
    private int[] field815 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "o", descriptor = "I")
    private int field817 = 100;

    @OriginalMember(owner = "client!EBTORROD", name = "r", descriptor = "I")
    public int field820 = 500;

    @OriginalMember(owner = "client!EBTORROD", name = "w", descriptor = "[I")
    private static int[] field825 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "x", descriptor = "[I")
    private static int[] field826 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "y", descriptor = "[I")
    private static int[] field827 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "z", descriptor = "[I")
    private static int[] field828 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "A", descriptor = "[I")
    private static int[] field829 = new int[5];

    @OriginalMember(owner = "client!EBTORROD", name = "n", descriptor = "I")
    private int field816;

    @OriginalMember(owner = "client!EBTORROD", name = "s", descriptor = "I")
    public int field821;

    @OriginalMember(owner = "client!EBTORROD", name = "p", descriptor = "LTUODRVGB;")
    private class52 field818;

    @OriginalMember(owner = "client!EBTORROD", name = "c", descriptor = "LXCOYGYOS;")
    private class59 field805;

    @OriginalMember(owner = "client!EBTORROD", name = "d", descriptor = "LXCOYGYOS;")
    private class59 field806;

    @OriginalMember(owner = "client!EBTORROD", name = "e", descriptor = "LXCOYGYOS;")
    private class59 field807;

    @OriginalMember(owner = "client!EBTORROD", name = "f", descriptor = "LXCOYGYOS;")
    private class59 field808;

    @OriginalMember(owner = "client!EBTORROD", name = "g", descriptor = "LXCOYGYOS;")
    private class59 field809;

    @OriginalMember(owner = "client!EBTORROD", name = "h", descriptor = "LXCOYGYOS;")
    private class59 field810;

    @OriginalMember(owner = "client!EBTORROD", name = "i", descriptor = "LXCOYGYOS;")
    private class59 field811;

    @OriginalMember(owner = "client!EBTORROD", name = "j", descriptor = "LXCOYGYOS;")
    private class59 field812;

    @OriginalMember(owner = "client!EBTORROD", name = "q", descriptor = "LXCOYGYOS;")
    private class59 field819;

    @OriginalMember(owner = "client!EBTORROD", name = "t", descriptor = "[I")
    private static int[] field822;

    @OriginalMember(owner = "client!EBTORROD", name = "u", descriptor = "[I")
    private static int[] field823;

    @OriginalMember(owner = "client!EBTORROD", name = "v", descriptor = "[I")
    private static int[] field824;

    @OriginalMember(owner = "client!EBTORROD", name = "a", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!EBTORROD", name = "a", descriptor = "(II)[I")
    ...
    @OriginalMember(owner = "client!EBTORROD", name = "a", descriptor = "(IIIB)I")
    ...
    @OriginalMember(owner = "client!EBTORROD", name = "a", descriptor = "(LZOMNSJJM;B)V")
