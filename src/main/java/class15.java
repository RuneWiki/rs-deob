...
public class class15 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZJ)V", line = 3)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Ljava/lang/Object;JI)V", line = 23)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(II)V", line = 48)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(I)Ljava/lang/Object;", line = 119)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lbr;B)V", line = 165)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 198)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)I", line = 230)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(ZJ)Ljava/lang/Object;", line = 270)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)I", line = 315)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)V", line = 327)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(B)V", line = 341)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ILvq;I)Z", line = 356)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(I)V", line = 771)
