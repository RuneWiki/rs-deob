...
public class class15 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(I)Lsq;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(Lsq;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "c", descriptor = "(I)Lsq;")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(BLkg;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "f", descriptor = "(I)Lsq;")
