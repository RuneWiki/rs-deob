...
public class class15 extends class457 {
    ...
    @OriginalMember(owner = "client!kh", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "()V", line = 20)
    public class15() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIB)V", line = 25)
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(IIII)[B", line = 40)
