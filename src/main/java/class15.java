...
public class class15 extends class51 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(FZ)F", line = 3)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lts;I)Lts;", line = 20)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(III)V", line = 64)
    ...
    @OriginalMember(owner = "client!n", name = "<init>", descriptor = "(IIIIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!n", name = "c", descriptor = "(III)V", line = 85)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(III)V", line = 95)
