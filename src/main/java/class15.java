...
public class class15 implements class81 {
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILjava/lang/String;)I", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(B)Lmha;", line = 15)
    public final class419 method112(byte arg0) {
        field212++;
        return arg0 == 62 ? class546.field7216 : null;
    }

    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(I)V", line = 42)
