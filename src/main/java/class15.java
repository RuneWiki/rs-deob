...
public class class15 extends class599 implements class57 {
    ...
    @OriginalMember(owner = "client!qk", name = "f", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qk", name = "h", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IIILva;Loa;ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!qk", name = "c", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Loa;B)Laca;", line = 72)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(I)I", line = 98)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Loa;I)V", line = 109)
    ...
    @OriginalMember(owner = "client!qk", name = "<init>", descriptor = "(Loa;Lqd;IIIIZIIZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IILoa;I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!qk", name = "e", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(I)Z", line = 200)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IZLoa;)Lba;", line = 213)
    ...
    @OriginalMember(owner = "client!qk", name = "d", descriptor = "(I)I", line = 225)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(B)V", line = 235)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(Loa;IBZ)Llo;", line = 251)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(ILoa;)V", line = 285)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(II)Z", line = 315)
    ...
    @OriginalMember(owner = "client!qk", name = "b", descriptor = "(Loa;I)Lew;", line = 326)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(IBLoa;)Lba;", line = 341)
    ...
    @OriginalMember(owner = "client!qk", name = "a", descriptor = "(BLoa;)V", line = 364)
