...
public class class15 {
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lhe;)Z", line = 32)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "()Z", line = 59)
    private final boolean method102() {
        return this.field143.method2079() == this.field149;
    }

    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lpo;)V", line = 361)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(Lhe;)V", line = 65)
    public final void method103(class209 arg0) {
        this.method106(arg0, true);
    }

    @OriginalMember(owner = "client!ub", name = "c", descriptor = "()V", line = 69)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IIII)Z", line = 123)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lhe;Z)V", line = 239)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "()V", line = 272)
