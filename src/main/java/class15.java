...
public class class15 {
    ...
    @OriginalMember(owner = "client!HJEXDJAH", name = "c", descriptor = "LTMLYUVVT;")
    ...
    @OriginalMember(owner = "client!HJEXDJAH", name = "a", descriptor = "[LHJEXDJAH;")
    ...
    @OriginalMember(owner = "client!HJEXDJAH", name = "a", descriptor = "(II)LHJEXDJAH;")
