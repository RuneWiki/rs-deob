...
public class class15 {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(IIILum;ZI)V", line = 9)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(II[B[BIBIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ZZ)Z", line = 77)
    public static boolean method89(boolean arg0, boolean arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILum;)V", line = 94)
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(II)Z", line = 107)
