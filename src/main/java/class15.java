...
public class class15 extends class41 {
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(Lwm;B)Lnf;", line = 7)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIBLwm;)Z", line = 100)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lwm;IILon;III[[[B[I[I[I[I[IIBIIZ)V", line = 137)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lwm;B)V", line = 307)
