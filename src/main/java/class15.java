...
public class class15 {
    ...
    @OriginalMember(owner = "client!vl", name = "toString", descriptor = "()Ljava/lang/String;", line = 34)
    public final String toString() {
        field225++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!vl", name = "b", descriptor = "(I)I", line = 49)
    public final int method85(int arg0) {
        field222++;
        return arg0 >= -109 ? 113 : this.field220;
    }

    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "(II)V", line = 61)
    public class15(int arg0, int arg1) {
        this.field223 = arg1;
        this.field220 = arg0;
    }

    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!vl", name = "d", descriptor = "(I)V", line = 84)
