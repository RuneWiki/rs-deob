...
@OriginalClass("client!DQYHQSPL")
public class class15 {

    @OriginalMember(owner = "client!DQYHQSPL", name = "a", descriptor = "I")
    private int field763 = 41444;

    @OriginalMember(owner = "client!DQYHQSPL", name = "c", descriptor = "[I")
    public int[] field765 = new int[2];

    @OriginalMember(owner = "client!DQYHQSPL", name = "d", descriptor = "[[[I")
    public int[][][] field766 = new int[2][2][4];

    @OriginalMember(owner = "client!DQYHQSPL", name = "e", descriptor = "[[[I")
    public int[][][] field767 = new int[2][2][4];

    @OriginalMember(owner = "client!DQYHQSPL", name = "f", descriptor = "[I")
    public int[] field768 = new int[2];

    @OriginalMember(owner = "client!DQYHQSPL", name = "g", descriptor = "[[F")
    public static float[][] field769 = new float[2][8];

    @OriginalMember(owner = "client!DQYHQSPL", name = "h", descriptor = "[[I")
    public static int[][] field770 = new int[2][8];

    @OriginalMember(owner = "client!DQYHQSPL", name = "i", descriptor = "F")
    public static float field771;

    @OriginalMember(owner = "client!DQYHQSPL", name = "b", descriptor = "I")
    private int field764;

    @OriginalMember(owner = "client!DQYHQSPL", name = "j", descriptor = "I")
    public static int field772;

    @OriginalMember(owner = "client!DQYHQSPL", name = "a", descriptor = "(IIFI)F")
    ...
    @OriginalMember(owner = "client!DQYHQSPL", name = "a", descriptor = "(IF)F")
    ...
    @OriginalMember(owner = "client!DQYHQSPL", name = "a", descriptor = "(ZFII)F")
    ...
    @OriginalMember(owner = "client!DQYHQSPL", name = "a", descriptor = "(IIF)I")
    ...
    @OriginalMember(owner = "client!DQYHQSPL", name = "a", descriptor = "(ILRSNWTZPO;LINLHDAGO;)V")
    ...
    @OriginalMember(owner = "client!DQYHQSPL", name = "<init>", descriptor = "()V")
    public class15() {
        if (class13.field723) {
        }
    }
