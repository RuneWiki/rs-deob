...
public class class15 {
    ...
    @OriginalMember(owner = "client!bd", name = "l", descriptor = "Lbg;")
    public static class18 field286;

    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Llf;Llf;BLbg;)Lkf;")
