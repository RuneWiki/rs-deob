...
public class class15 extends class541 {
    ...
    @OriginalMember(owner = "client!kh", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
