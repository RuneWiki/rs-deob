...
public class class15 extends class110 {
    ...
    @OriginalMember(owner = "client!vl", name = "c", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!vl", name = "<init>", descriptor = "([Lrf;)V", line = 18)
    public class15(class92[] arg0) {
        this.field147 = arg0;
    }

    @OriginalMember(owner = "client!vl", name = "a", descriptor = "(II)V", line = 30)
