...
public abstract class class15 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lul;IIILl;Ljava/awt/Canvas;)Lqa;", line = 25)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(B)Lau;", line = 38)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IIIIIIZII)Z", line = 66)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(IILsv;)Lpr;", line = 115)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(B)V", line = 144)
