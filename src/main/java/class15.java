...
public class class15 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)Lvi;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)Lvi;")
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Ltn;)V")
