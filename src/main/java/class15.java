...
public class class15 {
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(IIIIBIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BII)V", line = 210)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(ZILjava/awt/Component;)Lsv;", line = 234)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(II)V", line = 252)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(BLtn;)V", line = 341)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Ltn;ZI)V", line = 377)
    ...
    @OriginalMember(owner = "client!ds", name = "a", descriptor = "(Z)V", line = 418)
