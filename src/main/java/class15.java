...
public class class15 extends class283 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Lou;II)V", line = 48)
    ...
    @OriginalMember(owner = "client!sq", name = "b", descriptor = "(IZ)V", line = 65)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(I)Z", line = 96)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "(Lkw;Lrb;)V", line = 108)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(Z)V", line = 126)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(ZII)V", line = 141)
