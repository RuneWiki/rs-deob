...
public class class15 extends class147 {
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(III)Z", line = 20)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!rj", name = "b", descriptor = "(III)I", line = 119)
