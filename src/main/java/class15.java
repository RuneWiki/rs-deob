...
public class class15 {
    ...
    @OriginalMember(owner = "client!DNFIVRJB", name = "m", descriptor = "I")
    ...
    @OriginalMember(owner = "client!DNFIVRJB", name = "a", descriptor = "(LCFARFRSG;I)V")
    ...
    @OriginalMember(owner = "client!DNFIVRJB", name = "a", descriptor = "(ILCFARFRSG;)V")
