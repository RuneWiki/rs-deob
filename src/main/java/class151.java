...
public class class151 extends class459 {
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lmj;BZ)V", line = 21)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IILgda;IZLd;ZD)[I", line = 47)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lgda;BLgda;I)V", line = 189)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ld;Lgda;Z)Z", line = 204)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Ld;IZIDLgda;I)[I", line = 259)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZIILgda;ILd;)[F", line = 396)
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "()V", line = 507)
    public class151() {
        try {
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lwq;)V", line = 524)
