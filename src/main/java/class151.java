...
public class class151 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "([J[Ljava/lang/Object;B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(III)Lbt;", line = 16)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILjava/lang/String;Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!wq", name = "finalize", descriptor = "()V", line = 79)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lhp;II)V", line = 89)
