...
public class class151 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIBIII)I", line = 5)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lla;BLjava/lang/String;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IZII)I", line = 93)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(IIIIIIIIII)V", line = 124)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(I)V", line = 148)
