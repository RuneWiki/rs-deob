...
public class class151 extends class631 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BII)Z", line = 4)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BI)I", line = 21)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(CBLjava/lang/String;)I", line = 58)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(I)V", line = 91)
    public class151(int arg0) {
        this.field2072 = arg0;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 99)
