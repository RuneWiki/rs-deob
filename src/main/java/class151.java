...
public class class151 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "([Ljava/lang/String;[SB)V", line = 4)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IIIIIBIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(III)Lqs;", line = 57)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BI)V", line = 74)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(IILtq;)V", line = 116)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ltq;B)V", line = 130)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Z)V", line = 155)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILfd;)V", line = 169)
