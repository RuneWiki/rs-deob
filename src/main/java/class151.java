...
public class class151 extends class489 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(BLkp;I)V", line = 53)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(IZ)V", line = 73)
    ...
    @OriginalMember(owner = "client!mh", name = "b", descriptor = "(B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Leq;Lfaa;)V", line = 99)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZ)V", line = 122)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILjava/lang/String;)V", line = 162)
