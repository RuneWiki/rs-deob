...
public class class151 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILmq;)V", line = 16)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(I)Lmq;", line = 33)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(I)Lmq;", line = 53)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(B)I", line = 76)
    ...
    @OriginalMember(owner = "client!hv", name = "d", descriptor = "(I)Lkj;", line = 97)
    ...
    @OriginalMember(owner = "client!hv", name = "b", descriptor = "(B)Lmq;", line = 126)
    ...
    @OriginalMember(owner = "client!hv", name = "c", descriptor = "(B)Z", line = 149)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "()V", line = 227)
    public class151() {
        this.field1917.field7832 = this.field1917;
        this.field1917.field7829 = this.field1917;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(BII)Z", line = 171)
    ...
    @OriginalMember(owner = "client!hv", name = "e", descriptor = "(I)V", line = 183)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Z)Lmq;", line = 207)
