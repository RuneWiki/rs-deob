...
public class class151 extends class149 {
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(IZI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "()V", line = 15)
    public class151() {
        super(1, false);
    }

    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IBLtl;)V", line = 51)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIILqa;I)V", line = 126)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BI)[[I", line = 231)
    ...
    @OriginalMember(owner = "client!iq", name = "f", descriptor = "(I)V", line = 330)
