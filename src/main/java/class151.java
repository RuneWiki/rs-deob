...
public abstract class class151 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lvd;B)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ldr;II)Z")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lvd;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lvd;ILjaggl/memory/NativeBuffer;IZ)V")
