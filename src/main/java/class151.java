...
public class class151 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(ZLes;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Ld;IZILbt;Ljava/awt/Canvas;)Lha;")
    ...
    @OriginalMember(owner = "client!ls", name = "<init>", descriptor = "(Lbt;)V")
