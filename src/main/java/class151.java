...
public class class151 {
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ZIIIZIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IIII)V", line = 74)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(BIIIIIII)Z", line = 93)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIIII)Z", line = 465)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(I)V", line = 501)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IZI)V", line = 513)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(I)V", line = 526)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(III)V", line = 557)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIBIIIIII)Z", line = 571)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(ILjava/lang/String;ZLrk;)Llq;", line = 664)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IZIZIIIB)V", line = 712)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIZZIII)V", line = 768)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IIIIIIII)Z", line = 1071)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(IZI)V", line = 1265)
    ...
    @OriginalMember(owner = "client!oa", name = "a", descriptor = "(IZIZZII)V", line = 1282)
    ...
    @OriginalMember(owner = "client!oa", name = "b", descriptor = "(III)V", line = 1602)
