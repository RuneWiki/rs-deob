...
public class class151 extends class561 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIIIII)V", line = 15)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(ZIII)V", line = 30)
    ...
    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lwu;Lwu;Luv;)V", line = 62)
    public class151(class557 arg0, class557 arg1, class751 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(IIILjava/lang/Class;)Lgs;", line = 80)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(BZII)V", line = 111)
