...
public class class151 extends class320 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "([B[ILld;I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Ljava/awt/Component;BZ)Lhi;", line = 94)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "()V", line = 113)
    public class151() {
    }

    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "([B)V", line = 115)
