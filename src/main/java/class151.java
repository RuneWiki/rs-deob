...
public class class151 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!io", name = "toString", descriptor = "()Ljava/lang/String;", line = 37)
    public final String toString() {
        field2278++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIIBII)Lkk;", line = 46)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "(IIII)V", line = 73)
