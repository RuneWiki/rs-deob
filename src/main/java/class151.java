...
public class class151 {
    ...
    @OriginalMember(owner = "client!ls", name = "showcursor", descriptor = "(Ljava/awt/Component;Z)V")
    ...
    @OriginalMember(owner = "client!ls", name = "movemouse", descriptor = "(II)V")
    public final void movemouse(int arg0, int arg1) {
        this.field2492.mouseMove(arg0, arg1);
    }

    @OriginalMember(owner = "client!ls", name = "setcustomcursor", descriptor = "(Ljava/awt/Component;[IIILjava/awt/Point;)V")
