...
public abstract class class151 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)I", line = 34)
    public static int method1076(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IIIBIIZII)Z", line = 58)
