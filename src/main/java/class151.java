...
public class class151 {
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(II)Lrt;", line = 5)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(I[Ljava/lang/Object;[I)V", line = 53)
    ...
    @OriginalMember(owner = "client!be", name = "<init>", descriptor = "(ILum;Lum;Lfu;)V", line = 129)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "([IJLsc;I)Ljava/lang/String;", line = 73)
    ...
    @OriginalMember(owner = "client!be", name = "a", descriptor = "(IB)V", line = 100)
