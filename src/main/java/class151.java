...
public class class151 {
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)Lhw;", line = 42)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIII)I", line = 71)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ILhw;)V", line = 95)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "([BI)[B", line = 113)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "()V", line = 197)
    public class151() {
        this.field2492.field1778 = this.field2492;
        this.field2492.field1780 = this.field2492;
    }

    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(I)Lhw;", line = 148)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)V", line = 175)
