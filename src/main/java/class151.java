...
public class class151 implements Runnable {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/lang/String;B)Lum;", line = 62)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIILjava/lang/Object;I)Lum;", line = 74)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZLjava/lang/String;I)Lum;", line = 105)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZLjava/lang/Class;)Lum;", line = 119)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 708)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;)Lum;", line = 141)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(B)Lum;", line = 153)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IILjava/lang/Object;IB)Lum;", line = 166)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIILjava/awt/Component;)Lum;", line = 202)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ZLjava/lang/String;)[B", line = 216)
    ...
    @OriginalMember(owner = "client!nt", name = "run", descriptor = "()V", line = 235)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IB)Ljava/io/File;", line = 355)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(BLjava/lang/Runnable;I)Lum;", line = 449)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IILjava/lang/String;)Lum;", line = 463)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(II)Lum;", line = 474)
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(B)Z", line = 492)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(BLjava/awt/Frame;)Lum;", line = 506)
    public final class370 method962(byte arg0, Frame arg1) {
        return arg0 < 53 ? null : this.method949(0, 0, 0, arg1, 7);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Z)Lmi;", line = 516)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(ZLjava/lang/Class;)Lum;", line = 526)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/lang/Class;B)V", line = 537)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)Lum;", line = 575)
    public final class370 method966(int arg0) {
        return arg0 == 1 ? this.method949(0, 0, 0, null, 5) : null;
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/awt/Component;ZI)Lum;", line = 586)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(B)V", line = 595)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/net/URL;I)Lum;", line = 605)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(BLjava/awt/datatransfer/Transferable;)Lum;", line = 619)
    public final class370 method970(byte arg0, Transferable arg1) {
        int var3 = -43 / ((59 - arg0) / 59);
        return this.method949(0, 0, 0, arg1, 19);
    }

    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIILjava/awt/Point;Ljava/awt/Component;[I)Lum;", line = 628)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(ZLjava/lang/String;)Ljava/io/File;", line = 644)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IIIIB)Lum;", line = 654)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "([Ljava/lang/Class;Ljava/lang/Class;BLjava/lang/String;)Lum;", line = 672)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ljava/lang/String;I)Lum;", line = 689)
