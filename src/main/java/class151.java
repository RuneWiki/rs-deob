...
public class class151 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IZZI)V", line = 6)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(II)Z", line = 46)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IZZ)V", line = 59)
    ...
    @OriginalMember(owner = "client!gf", name = "<init>", descriptor = "(Lig;)V", line = 82)
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(BLee;)Z", line = 101)
