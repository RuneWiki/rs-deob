...
public class class151 {
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(B[[[Lds;)V", line = 23)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(BII)Z", line = 135)
    ...
    @OriginalMember(owner = "client!mg", name = "toString", descriptor = "()Ljava/lang/String;", line = 146)
