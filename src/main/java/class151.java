...
public class class151 extends class69 {
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IZI)V", line = 26)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IB)V", line = 39)
    public void method303(int arg0, byte arg1) {
        ++field1869;
        this.field1868[this.field1858++] = (byte) (class33.method210(arg1 >> 1, 127) + 127);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 49)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Ltq;I)V", line = 112)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Z)V", line = 137)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 163)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(IIIIIF)V", line = 225)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lqf;Lqf;I)V", line = 252)
