...
public class class151 extends class364 {
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lgca;B)I", line = 24)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(II)V", line = 61)
    ...
    @OriginalMember(owner = "client!vc", name = "b", descriptor = "(B)Z", line = 76)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(FIFF)I", line = 88)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(IZI)V", line = 134)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Ljava/lang/String;I)J", line = 220)
    ...
    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(I)Z", line = 246)
    ...
    @OriginalMember(owner = "client!vc", name = "<init>", descriptor = "(Llea;)V", line = 283)
    public class151(class573 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vc", name = "a", descriptor = "(Lwi;ILwi;I)V", line = 286)
    ...
    @OriginalMember(owner = "client!vc", name = "j", descriptor = "(I)Z", line = 444)
