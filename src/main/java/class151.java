...
public class class151 extends class681 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Z)Z", line = 6)
    public final boolean method751(boolean arg0) {
        ++field2213;
        return !arg0 ? false : this.field2206.method2329((byte) -125);
    }

    @OriginalMember(owner = "client!wq", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IZIIIIIII)Z", line = 46)
    ...
    @OriginalMember(owner = "client!wq", name = "g", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!wq", name = "b", descriptor = "(ZI)V", line = 93)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(BII)Ljava/lang/String;", line = 114)
    ...
    @OriginalMember(owner = "client!wq", name = "h", descriptor = "(I)Ljava/lang/String;", line = 157)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(IIB)V", line = 172)
    ...
    @OriginalMember(owner = "client!wq", name = "<init>", descriptor = "(Lnv;Lst;)V", line = 248)
    public class151(class382 arg0, class398 arg1) {
        super(arg0);
        this.field2206 = arg1;
    }

    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(B)V", line = 222)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILrga;I)V", line = 256)
