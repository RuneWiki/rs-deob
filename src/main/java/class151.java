...
public class class151 extends class5 {
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lic;IIIIZ[IZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lic;IIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "()V", line = 65)
    public final void method47() {
        this.field55.field3342.glFramebufferTexture2DEXT(36160, this.field1827, this.field56, 0, 0);
        this.field1827 = -1;
    }

    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lic;IIIIZ[BIZ)V", line = 69)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIII[IIIZ)V", line = 121)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 163)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIIIII)V", line = 168)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lic;IIIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!tr", name = "<init>", descriptor = "(Lic;IIIIZ[FI)V", line = 190)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(IIII[BIIIZ)V", line = 211)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZZ)V", line = 262)
