...
public class class151 extends class356 {
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLiaa;)Luf;")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(IILiaa;)V")
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(Liaa;B)V")
