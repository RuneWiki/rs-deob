...
public class class151 implements class79 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)Ldv;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(Lsc;IIII)V")
    ...
    @OriginalMember(owner = "client!fm", name = "b", descriptor = "(II)Ltv;")
    ...
    @OriginalMember(owner = "client!fm", name = "c", descriptor = "(II)Law;")
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IBII)Lgf;")
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Ldn;Ldn;Ldn;)V")
