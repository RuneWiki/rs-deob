...
public class class151 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B[Lpi;Lur;)Luq;", line = 26)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)Z", line = 96)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZLjava/lang/String;II)Z", line = 111)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIIIZZ)V", line = 191)
