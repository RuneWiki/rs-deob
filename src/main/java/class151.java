...
public class class151 extends class9 implements class317 {
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!dca", name = "c", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!dca", name = "a", descriptor = "(B)V", line = 42)
    ...
    @OriginalMember(owner = "client!dca", name = "finalize", descriptor = "()V", line = 57)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lmh;III)V", line = 90)
    ...
    @OriginalMember(owner = "client!dca", name = "<init>", descriptor = "(Lmh;IIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!dca", name = "f", descriptor = "(I)V", line = 75)
