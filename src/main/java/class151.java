...
public abstract class class151 extends class186 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Llb;IZIBILza;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lat;I)V")
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Ljv;B)V")
