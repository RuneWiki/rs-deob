...
public class class151 extends class35 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lor;[I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLgm;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IBILwg;)V")
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lbo;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ui", name = "U", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ui", name = "SA", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lj;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(FFILv;IIFFIFI)[B")
    ...
    @OriginalMember(owner = "client!ui", name = "O", descriptor = "(IILj;)Lj;")
