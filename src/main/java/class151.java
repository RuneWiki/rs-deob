...
public class class151 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I)V", line = 8)
    public static void method1026(int arg0) {
        int var1 = -97 / ((58 - arg0) / 54);
        field2142 = null;
    }

    @OriginalMember(owner = "client!as", name = "toString", descriptor = "()Ljava/lang/String;", line = 27)
    public final String toString() {
        field2147++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(IIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Lhha;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)Z", line = 64)
