...
public class class151 extends class297 implements class19 {
    ...
    @OriginalMember(owner = "client!he", name = "b", descriptor = "()V", line = 3)
    public final void method513() {
        this.field3955.method2099(this);
    }

    @OriginalMember(owner = "client!he", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "(I[BI)V", line = 9)
    ...
    @OriginalMember(owner = "client!he", name = "<init>", descriptor = "(Lh;I[BIZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!he", name = "a", descriptor = "()I", line = 20)
