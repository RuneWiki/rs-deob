...
public class class151 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "([BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZI)V", line = 192)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "([BI)V", line = 234)
