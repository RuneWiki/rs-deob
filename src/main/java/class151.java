...
public class class151 extends class283 {
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "()Lkp;")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "()Lkp;")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lv;II)V")
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(ILv;III[I)V")
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Luj;)V")
