...
public class class151 extends class593 {
    ...
    @OriginalMember(owner = "client!mha", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(Ljj;)V")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(IBLah;)V")
