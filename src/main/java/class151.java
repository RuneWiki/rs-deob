...
public class class151 extends class82 {
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)Lls;", line = 10)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIIIIIBII)V", line = 37)
    ...
    @OriginalMember(owner = "client!ui", name = "e", descriptor = "(B)J", line = 78)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IIIIZ)V", line = 96)
    ...
    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(B)V", line = 142)
