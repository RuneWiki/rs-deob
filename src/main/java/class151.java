...
public class class151 {
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(II)Ldp;", line = 40)
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(ILpq;Lpq;)V", line = 76)
