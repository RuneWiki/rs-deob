...
public class class151 extends class207 {
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(ILjava/awt/Component;Lwd;II)Lpo;", line = 6)
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(BLnj;)V", line = 127)
    ...
    @OriginalMember(owner = "client!uh", name = "d", descriptor = "(I)V", line = 155)
