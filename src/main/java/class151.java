...
public class class151 extends class117 implements class351 {
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(ILqa;)Lnf;", line = 15)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(Lqa;Lkn;IIIIIZIIIIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!ui", name = "e", descriptor = "(I)I", line = 74)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(IILqa;B)Z", line = 87)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(I)Z", line = 107)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILqa;)V", line = 119)
    ...
    @OriginalMember(owner = "client!ui", name = "d", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLqa;)V", line = 142)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(I)I", line = 158)
    ...
    @OriginalMember(owner = "client!ui", name = "c", descriptor = "(B)Z", line = 171)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZIILer;Lqa;IB)V", line = 207)
    ...
    @OriginalMember(owner = "client!ui", name = "f", descriptor = "(B)V", line = 219)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(Lqa;B)V", line = 233)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ILqa;I)Lc;", line = 246)
