...
public class class151 extends class434 {
    ...
    @OriginalMember(owner = "client!uh", name = "c", descriptor = "(I)Ljava/lang/Object;", line = 5)
    ...
    @OriginalMember(owner = "client!uh", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 15)
    public class151(Object arg0, int arg1) {
        super(arg1);
        this.field2495 = new SoftReference(arg0);
    }

    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(I)Z", line = 25)
