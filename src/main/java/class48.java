...
public class class48 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lob;I)I", line = 7)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)Lqh;", line = 81)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIIIIBIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(I)V", line = 148)
    public class48(int arg0) {
        this.field886 = arg0;
    }

    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(IIIIII)V", line = 156)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lqh;Z)V", line = 133)
