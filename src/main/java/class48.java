...
public abstract class class48 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lmr;BZ)V", line = 11)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lbt;I)V", line = 345)
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Lr;Ljava/lang/String;ZI)Lih;", line = 394)
