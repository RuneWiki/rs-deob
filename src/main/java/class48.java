...
public class class48 {
    ...
    @OriginalMember(owner = "client!pp", name = "a", descriptor = "(ILdh;)V")
    ...
    @OriginalMember(owner = "client!pp", name = "b", descriptor = "(BI)Llr;")
    ...
    @OriginalMember(owner = "client!pp", name = "<init>", descriptor = "(Ldk;ILfc;Lfc;)V")
