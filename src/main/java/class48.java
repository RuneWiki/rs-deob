...
public class class48 implements class716 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Lpfa;B)I", line = 4)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILha;)V", line = 35)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZB)V", line = 129)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)Z", line = 172)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(Lnd;Lkd;)V", line = 184)
    public class48(class547 arg0, class284 arg1) {
        this.field681 = arg1;
        this.field684 = arg0;
    }

    @OriginalMember(owner = "client!kaa", name = "c", descriptor = "(I)V", line = 194)
