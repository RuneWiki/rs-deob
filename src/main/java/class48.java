...
@OriginalClass("client!QWCFKPFT")
public class class48 {

    @OriginalMember(owner = "client!QWCFKPFT", name = "b", descriptor = "I")
    private static int field1301 = 6;

    @OriginalMember(owner = "client!QWCFKPFT", name = "e", descriptor = "I")
    public int field1304;

    @OriginalMember(owner = "client!QWCFKPFT", name = "g", descriptor = "I")
    public int field1306;

    @OriginalMember(owner = "client!QWCFKPFT", name = "f", descriptor = "LOSKYDPYJ;")
    public class40 field1305;

    @OriginalMember(owner = "client!QWCFKPFT", name = "a", descriptor = "Z")
    private static boolean field1300;

    @OriginalMember(owner = "client!QWCFKPFT", name = "c", descriptor = "Z")
    private static boolean field1302;

    @OriginalMember(owner = "client!QWCFKPFT", name = "h", descriptor = "[I")
    public int[] field1307;

    @OriginalMember(owner = "client!QWCFKPFT", name = "i", descriptor = "[I")
    public int[] field1308;

    @OriginalMember(owner = "client!QWCFKPFT", name = "j", descriptor = "[I")
    public int[] field1309;

    @OriginalMember(owner = "client!QWCFKPFT", name = "k", descriptor = "[I")
    public int[] field1310;

    @OriginalMember(owner = "client!QWCFKPFT", name = "d", descriptor = "[LQWCFKPFT;")
    private static class48[] field1303;

    @OriginalMember(owner = "client!QWCFKPFT", name = "l", descriptor = "[Z")
    private static boolean[] field1311;

    @OriginalMember(owner = "client!QWCFKPFT", name = "a", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!QWCFKPFT", name = "a", descriptor = "(Z[B)V")
    ...
    @OriginalMember(owner = "client!QWCFKPFT", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!QWCFKPFT", name = "a", descriptor = "(II)LQWCFKPFT;")
    ...
    @OriginalMember(owner = "client!QWCFKPFT", name = "b", descriptor = "(II)Z")
