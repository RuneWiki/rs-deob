...
public class class48 {
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IILdc;)V", line = 53)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "([Luq;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILdc;)V", line = 129)
