...
public class class48 extends class751 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILrv;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IB)[[I", line = 33)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(III)V", line = 98)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIZI)V", line = 118)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(I)V", line = 214)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 223)
    public static final void method314(String arg0, int arg1) {
        ++field676;
        class422.method2520(0, arg1, arg0, "", "", -117, "");
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ILli;)I", line = 232)
    ...
    @OriginalMember(owner = "client!bt", name = "e", descriptor = "(B)V", line = 314)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)I", line = 328)
    ...
    @OriginalMember(owner = "client!bt", name = "<init>", descriptor = "()V", line = 344)
    public class48() {
        super(0, false);
    }

    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(ZILcb;IBIJ)V", line = 347)
