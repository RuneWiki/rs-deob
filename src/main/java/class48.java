...
public class class48 {
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(FB)F", line = 3)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ILes;I)V", line = 25)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(ZZB)V", line = 79)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(II)V", line = 103)
    ...
    @OriginalMember(owner = "client!gda", name = "a", descriptor = "(Les;I)V", line = 189)
