...
public class class48 extends class452 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I[IIB)Z", line = 40)
    ...
    @OriginalMember(owner = "client!qr", name = "j", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II[III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 235)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IIB)Z", line = 131)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "([IIIZ)Z", line = 157)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(IZBZI)I", line = 182)
