...
public class class48 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Ljava/lang/String;II)Z", line = 10)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(BII)I", line = 59)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(II)Ljava/lang/Integer;", line = 83)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Ljava/lang/String;IJ)V", line = 105)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I)[I", line = 140)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(BIIII)I", line = 172)
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(BLjava/lang/String;J)V", line = 264)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ZIJ)Z", line = 317)
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "(II)V", line = 355)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ZIII)I", line = 392)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IIII)Ljava/lang/Integer;", line = 405)
    ...
    @OriginalMember(owner = "client!hia", name = "c", descriptor = "(II)V", line = 427)
    ...
    @OriginalMember(owner = "client!hia", name = "d", descriptor = "(II)Ljava/lang/Long;", line = 469)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IIIBI)Z", line = 489)
    ...
    @OriginalMember(owner = "client!hia", name = "c", descriptor = "(I)I", line = 536)
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Lgga;)V", line = 928)
    public class48(class511 arg0) {
        this.method408((byte) -90, arg0);
    }

    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "()V", line = 936)
    private class48() {
    }

    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IZ)V", line = 564)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ILjava/lang/String;)I", line = 602)
    ...
    @OriginalMember(owner = "client!hia", name = "e", descriptor = "(II)V", line = 642)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(BLgga;)V", line = 670)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IB)Ljava/lang/String;", line = 826)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Z)V", line = 849)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(III)Z", line = 879)
