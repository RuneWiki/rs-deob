...
public class class48 extends class135 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(ZI)V", line = 14)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(III)V", line = 45)
    ...
    @OriginalMember(owner = "client!tba", name = "d", descriptor = "(I)V", line = 73)
    ...
    @OriginalMember(owner = "client!tba", name = "g", descriptor = "(I)Z", line = 95)
    public final boolean method379(int arg0) {
        return arg0 == -4931 ? this.field633 : false;
    }

    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Loe;Lvo;Lob;)V", line = 149)
    ...
    @OriginalMember(owner = "client!tba", name = "h", descriptor = "(I)V", line = 177)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(B)V", line = 196)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Laj;II)V", line = 220)
    ...
    @OriginalMember(owner = "client!tba", name = "b", descriptor = "(I)V", line = 229)
