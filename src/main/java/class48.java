...
@OriginalClass("client!PIYQORZV")
public class class48 extends class18 {

    @OriginalMember(owner = "client!PIYQORZV", name = "r", descriptor = "I")
    private int field1321 = 41444;

    @OriginalMember(owner = "client!PIYQORZV", name = "s", descriptor = "Z")
    public boolean field1322 = false;

    @OriginalMember(owner = "client!PIYQORZV", name = "u", descriptor = "LYTBPTACV;")
    private class70 field1324;

    @OriginalMember(owner = "client!PIYQORZV", name = "l", descriptor = "I")
    public int field1315;

    @OriginalMember(owner = "client!PIYQORZV", name = "m", descriptor = "I")
    public int field1316;

    @OriginalMember(owner = "client!PIYQORZV", name = "n", descriptor = "I")
    public int field1317;

    @OriginalMember(owner = "client!PIYQORZV", name = "o", descriptor = "I")
    public int field1318;

    @OriginalMember(owner = "client!PIYQORZV", name = "t", descriptor = "I")
    public int field1323;

    @OriginalMember(owner = "client!PIYQORZV", name = "p", descriptor = "I")
    private int field1319;

    @OriginalMember(owner = "client!PIYQORZV", name = "q", descriptor = "I")
    private int field1320;

    @OriginalMember(owner = "client!PIYQORZV", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!PIYQORZV", name = "a", descriptor = "(B)LDHUPIIUL;")
    ...
    @OriginalMember(owner = "client!PIYQORZV", name = "<init>", descriptor = "(IIIIIIZI)V")
