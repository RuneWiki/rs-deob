...
public class class48 {
    ...
    @OriginalMember(owner = "client!SMALAPQM", name = "b", descriptor = "LAUPOWMGG;")
    private class1 field1357;

    @OriginalMember(owner = "client!SMALAPQM", name = "c", descriptor = "LAUPOWMGG;")
    private class1 field1358;

    @OriginalMember(owner = "client!SMALAPQM", name = "d", descriptor = "LAUPOWMGG;")
    private class1 field1359;

    @OriginalMember(owner = "client!SMALAPQM", name = "e", descriptor = "LAUPOWMGG;")
    private class1 field1360;

    @OriginalMember(owner = "client!SMALAPQM", name = "f", descriptor = "LAUPOWMGG;")
    private class1 field1361;

    @OriginalMember(owner = "client!SMALAPQM", name = "g", descriptor = "LAUPOWMGG;")
    private class1 field1362;

    @OriginalMember(owner = "client!SMALAPQM", name = "h", descriptor = "LAUPOWMGG;")
    private class1 field1363;

    @OriginalMember(owner = "client!SMALAPQM", name = "i", descriptor = "LAUPOWMGG;")
    private class1 field1364;

    @OriginalMember(owner = "client!SMALAPQM", name = "p", descriptor = "LAUPOWMGG;")
    private class1 field1371;

    @OriginalMember(owner = "client!SMALAPQM", name = "o", descriptor = "LPKLJDULJ;")
    ...
    @OriginalMember(owner = "client!SMALAPQM", name = "a", descriptor = "(ZLNHEPCMLW;)V")
