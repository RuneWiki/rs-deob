...
public class class48 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(IILju;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILya;IIILga;I)V", line = 731)
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(Lap;III)V", line = 822)
