...
public class class48 extends class15 {
    ...
    @OriginalMember(owner = "client!MTFZASIN", name = "Nb", descriptor = "LDMOAMUBS;")
    ...
    @OriginalMember(owner = "client!MTFZASIN", name = "yb", descriptor = "LKFUEEJVZ;")
    public class33 field1222;

    @OriginalMember(owner = "client!MTFZASIN", name = "Lb", descriptor = "LVYUQHOMO;")
    public class66 field1235;

    @OriginalMember(owner = "client!MTFZASIN", name = "Pb", descriptor = "Ljava/lang/String;")
    public String field1239;

    @OriginalMember(owner = "client!MTFZASIN", name = "b", descriptor = "(Z)LVYUQHOMO;")
    ...
    @OriginalMember(owner = "client!MTFZASIN", name = "a", descriptor = "(BLXGRGMPUQ;)V")
    ...
    @OriginalMember(owner = "client!MTFZASIN", name = "a", descriptor = "(I)LVYUQHOMO;")
    ...
    @OriginalMember(owner = "client!MTFZASIN", name = "a", descriptor = "(B)LVYUQHOMO;")
