...
public abstract class class48 extends class98 {
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!dm", name = "g", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(B)Lqk;", line = 106)
