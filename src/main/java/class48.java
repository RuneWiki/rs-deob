...
public class class48 extends class76 {
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(IIZ)[B", line = 6)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "(B)[B", line = 21)
    ...
    @OriginalMember(owner = "client!cha", name = "a", descriptor = "([BI)V", line = 37)
