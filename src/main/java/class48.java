...
public abstract class class48 extends class29 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lol;III)V")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ZBIILna;ILae;)V")
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BZLjava/awt/Component;)Lfa;")
