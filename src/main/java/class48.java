...
public class class48 {
    ...
    @OriginalMember(owner = "client!PBQQFQEC", name = "e", descriptor = "LXJCNBMKS;")
    ...
    @OriginalMember(owner = "client!PBQQFQEC", name = "a", descriptor = "(ZILXJCNBMKS;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!PBQQFQEC", name = "a", descriptor = "(LXJCNBMKS;ZLjava/lang/String;)V")
