...
@OriginalClass("client!RHHZDAUG")
public class class48 {

    @OriginalMember(owner = "client!RHHZDAUG", name = "a", descriptor = "I")
    private static int field1298 = -454;

    @OriginalMember(owner = "client!RHHZDAUG", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!RHHZDAUG", name = "b", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!RHHZDAUG", name = "a", descriptor = "(IIIIIZI)I")
    ...
    @OriginalMember(owner = "client!RHHZDAUG", name = "a", descriptor = "(IIIIIII)I")
