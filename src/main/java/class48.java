...
public abstract class class48 {
    ...
    @OriginalMember(owner = "client!tba", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!tba", name = "c", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IIB)Z", line = 34)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IB[B)V", line = 47)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(III)Lwca;", line = 71)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lji;I[BIZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Lji;ILjaclib/memory/Buffer;IZ)V", line = 113)
