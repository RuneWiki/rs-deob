...
public class class48 extends class136 implements class141 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(III[[ZZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(Lda;La;II[[I[[IIII)V", line = 145)
    ...
    @OriginalMember(owner = "client!ya", name = "finalize", descriptor = "()V", line = 156)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(II)V", line = 162)
    public final void method280(int arg0, int arg1) {
        this.field708.method429().method3382(this, arg0, arg1);
    }

    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(Lld;[I)V", line = 170)
