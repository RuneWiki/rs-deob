...
public class class48 implements class69 {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLcj;I)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IIILef;I)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ILwr;IB)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Lmk;I)I")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Ldm;Z)Z")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IBILef;)V")
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZILwr;)V")
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lbo;)V")
