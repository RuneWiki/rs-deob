...
public class class48 implements class96 {
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(B)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(II)Lje;", line = 106)
    public final class91 method389(int arg0, int arg1) {
        field708++;
        return arg0 == 9559 ? this.field714[arg1] : null;
    }

    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(II)Z", line = 118)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(B)I", line = 140)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IIIFZI)[F", line = 354)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ZI)Lkt;", line = 366)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(ZFIIII)[I", line = 394)
    ...
    @OriginalMember(owner = "client!qga", name = "b", descriptor = "(I)V", line = 409)
    ...
    @OriginalMember(owner = "client!qga", name = "a", descriptor = "(IFIIIZ)[I", line = 427)
    ...
    @OriginalMember(owner = "client!qga", name = "<init>", descriptor = "(Lkha;Lkha;Lkha;)V", line = 440)
