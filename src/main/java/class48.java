...
public class class48 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lp;IIILof;Lrd;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 129)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III)V", line = 142)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIILso;)V", line = 178)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLjava/lang/Throwable;Ljava/lang/String;)V", line = 219)
