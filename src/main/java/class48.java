...
public class class48 extends class584 {
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(ZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(B)Z", line = 69)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lgb;Ljo;Lie;)V", line = 78)
    ...
    @OriginalMember(owner = "client!dm", name = "d", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(III)V", line = 124)
    ...
    @OriginalMember(owner = "client!dm", name = "f", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ILld;B)V", line = 163)
    ...
    @OriginalMember(owner = "client!dm", name = "c", descriptor = "(I)V", line = 173)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 189)
