...
public class class48 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)Lll;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(ILha;I)V")
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lkp;ILph;)V")
