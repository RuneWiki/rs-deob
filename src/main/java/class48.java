...
public class class48 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lav;Z)I", line = 18)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(CB)Z", line = 55)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(BLjs;)V", line = 67)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(IIIIBIII)V", line = 276)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(I)V", line = 331)
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(I)V", line = 347)
