...
public class class48 {
    ...
    @OriginalMember(owner = "client!wba", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IILha;IIIIILmq;III)V", line = 12)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!wba", name = "a", descriptor = "(IIILha;Ljb;Laa;III)V", line = 49)
    ...
    @OriginalMember(owner = "client!wba", name = "<init>", descriptor = "(Lfha;II)V", line = 228)
