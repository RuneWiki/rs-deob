...
public class class48 extends class55 {
    ...
    @OriginalMember(owner = "client!QGDSNXKJ", name = "tb", descriptor = "LWIUIWDML;")
    ...
    @OriginalMember(owner = "client!QGDSNXKJ", name = "Nb", descriptor = "LPSGMMDJS;")
    public class45 field1287;

    @OriginalMember(owner = "client!QGDSNXKJ", name = "Jb", descriptor = "LYIBRLAQY;")
    public class70 field1283;

    @OriginalMember(owner = "client!QGDSNXKJ", name = "vb", descriptor = "Ljava/lang/String;")
    public String field1269;

    @OriginalMember(owner = "client!QGDSNXKJ", name = "a", descriptor = "(BLPKHWFJLM;)V")
    ...
    @OriginalMember(owner = "client!QGDSNXKJ", name = "a", descriptor = "(I)LPSGMMDJS;")
    ...
    @OriginalMember(owner = "client!QGDSNXKJ", name = "b", descriptor = "(I)LPSGMMDJS;")
    ...
    @OriginalMember(owner = "client!QGDSNXKJ", name = "c", descriptor = "(B)LPSGMMDJS;")
