...
@OriginalClass("client!RPKBYPNF")
public class class48 {

    @OriginalMember(owner = "client!RPKBYPNF", name = "a", descriptor = "I")
    private int field1165 = -261;

    @OriginalMember(owner = "client!RPKBYPNF", name = "b", descriptor = "I")
    private int field1166 = -19755;

    @OriginalMember(owner = "client!RPKBYPNF", name = "c", descriptor = "Z")
    private boolean field1167 = true;

    @OriginalMember(owner = "client!RPKBYPNF", name = "d", descriptor = "Z")
    private boolean field1168 = false;

    @OriginalMember(owner = "client!RPKBYPNF", name = "e", descriptor = "I")
    private int field1169;

    @OriginalMember(owner = "client!RPKBYPNF", name = "h", descriptor = "I")
    public int field1172;

    @OriginalMember(owner = "client!RPKBYPNF", name = "i", descriptor = "I")
    public int field1173;

    @OriginalMember(owner = "client!RPKBYPNF", name = "j", descriptor = "I")
    public int field1174;

    @OriginalMember(owner = "client!RPKBYPNF", name = "k", descriptor = "I")
    private int field1175;

    @OriginalMember(owner = "client!RPKBYPNF", name = "l", descriptor = "I")
    private int field1176;

    @OriginalMember(owner = "client!RPKBYPNF", name = "m", descriptor = "I")
    private int field1177;

    @OriginalMember(owner = "client!RPKBYPNF", name = "n", descriptor = "I")
    private int field1178;

    @OriginalMember(owner = "client!RPKBYPNF", name = "o", descriptor = "I")
    private int field1179;

    @OriginalMember(owner = "client!RPKBYPNF", name = "p", descriptor = "I")
    public static int field1180;

    @OriginalMember(owner = "client!RPKBYPNF", name = "f", descriptor = "[I")
    private int[] field1170;

    @OriginalMember(owner = "client!RPKBYPNF", name = "g", descriptor = "[I")
    private int[] field1171;

    @OriginalMember(owner = "client!RPKBYPNF", name = "a", descriptor = "(LMQZHAILV;I)V")
    ...
    @OriginalMember(owner = "client!RPKBYPNF", name = "a", descriptor = "(LMQZHAILV;B)V")
    ...
    @OriginalMember(owner = "client!RPKBYPNF", name = "a", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!RPKBYPNF", name = "a", descriptor = "(IB)I")
