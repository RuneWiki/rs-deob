...
public class class48 {
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 13)
    protected final void finalize() throws Throwable {
        this.field683.method2135(this.field682);
        super.finalize();
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lih;ILjava/lang/String;)Lha;", line = 18)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Lih;II)V", line = 48)
