...
public class class48 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "()I", line = 7)
    ...
    @OriginalMember(owner = "client!eg", name = "b", descriptor = "()Lmca;", line = 52)
    ...
    @OriginalMember(owner = "client!eg", name = "c", descriptor = "()[B", line = 58)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "(Lps;)V", line = 128)
    ...
    @OriginalMember(owner = "client!eg", name = "<init>", descriptor = "()V", line = 148)
    private class48() {
    }

    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(Ldda;II)Leg;", line = 121)
