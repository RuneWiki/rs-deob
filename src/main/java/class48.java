...
public class class48 extends class216 {
    ...
    @OriginalMember(owner = "client!te", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(Lpaa;IZ)Ljava/lang/String;", line = 21)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(IBI)V", line = 44)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(ZII)V", line = 56)
    ...
    @OriginalMember(owner = "client!te", name = "c", descriptor = "(I)I", line = 66)
    public static final int method329(int arg0) {
        ++field705;
        return arg0 != 1629291756 ? -75 : class673.method3855(-22016, false);
    }

    @OriginalMember(owner = "client!te", name = "a", descriptor = "(III)V", line = 84)
    ...
    @OriginalMember(owner = "client!te", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 112)
    ...
    @OriginalMember(owner = "client!te", name = "a", descriptor = "(B)V", line = 131)
