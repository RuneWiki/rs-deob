...
public class class48 extends class339 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/net/Proxy;I)Ljava/net/Socket;", line = 21)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 42)
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(B)Ljava/net/Socket;", line = 99)
    ...
    @OriginalMember(owner = "client!bt", name = "httpProxyConnect", descriptor = "(Ljava/lang/String;ILjava/lang/String;)Ljava/net/Socket;", line = 171)
