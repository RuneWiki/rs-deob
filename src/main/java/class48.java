...
public class class48 extends class55 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)I", line = 15)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILjava/lang/String;)V", line = 26)
    public static final void method281(int arg0, String arg1) {
        System.exit(arg0);
        field486++;
    }

    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)V", line = 37)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(IIIIIIZ)V", line = 55)
    ...
    @OriginalMember(owner = "client!kaa", name = "<init>", descriptor = "(II)V", line = 105)
