...
public class class48 extends class449 {
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "([I[IIIZ)J", line = 5)
    ...
    @OriginalMember(owner = "client!aa", name = "d", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(Lnl;Lnl;I)V", line = 62)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!aa", name = "a", descriptor = "(IIILqp;IILtj;IZLvc;)Ln;", line = 86)
