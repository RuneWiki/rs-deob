...
public abstract class class48 implements class67 {
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(ILkha;)V")
    ...
    @OriginalMember(owner = "client!gp", name = "a", descriptor = "(BLpf;)[I")
    ...
    @OriginalMember(owner = "client!gp", name = "<init>", descriptor = "(Llaa;ILqda;Lns;IZ)V")
