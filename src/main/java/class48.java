...
public class class48 extends class401 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Ljava/lang/String;IC)[Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(ZILsea;ILjba;BI)V", line = 74)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IIBI)Z", line = 89)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(III)Z", line = 103)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BII)Z", line = 121)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "([IBII)V", line = 147)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(IIIIIIIII)V", line = 162)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "()V", line = 182)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I[III)V", line = 275)
