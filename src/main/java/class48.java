...
public class class48 extends class455 implements class113 {
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ZIILeq;)Luq;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Leq;Z)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Leq;I)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(Leq;IB)Lva;")
    ...
    @OriginalMember(owner = "client!sh", name = "b", descriptor = "(Leq;Z)Lgl;")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILeq;BI)Z")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(ILeq;Z)Lva;")
    ...
    @OriginalMember(owner = "client!sh", name = "<init>", descriptor = "(Leq;Lhn;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!sh", name = "a", descriptor = "(BLeq;)V")
