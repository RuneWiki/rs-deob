...
public abstract class class48 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "Lvg;")
    public static class200 field984 = null;

    @OriginalMember(owner = "client!eg", name = "g", descriptor = "I")
    public static int field990 = 0;

    @OriginalMember(owner = "client!eg", name = "e", descriptor = "Llf;")
    public static class109 field988 = class35.method275("gr-Un:", 2);

    @OriginalMember(owner = "client!eg", name = "j", descriptor = "Llf;")
