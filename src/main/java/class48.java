...
public class class48 {
    ...
    @OriginalMember(owner = "client!OUZUCGGU", name = "a", descriptor = "LICYTWAKR;")
    public class29 field1096 = new class29();

    @OriginalMember(owner = "client!OUZUCGGU", name = "b", descriptor = "LICYTWAKR;")
    ...
    @OriginalMember(owner = "client!OUZUCGGU", name = "a", descriptor = "(LICYTWAKR;)V")
    ...
    @OriginalMember(owner = "client!OUZUCGGU", name = "a", descriptor = "(LICYTWAKR;I)V")
    ...
    @OriginalMember(owner = "client!OUZUCGGU", name = "a", descriptor = "(Z)LICYTWAKR;")
    ...
    @OriginalMember(owner = "client!OUZUCGGU", name = "b", descriptor = "(Z)LICYTWAKR;")
    ...
    @OriginalMember(owner = "client!OUZUCGGU", name = "a", descriptor = "(I)LICYTWAKR;")
