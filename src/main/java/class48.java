...
public class class48 extends class27 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lpe;J[Lds;[Lae;Z)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Lae;Z)V")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lpe;J)Z")
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lpe;[Lds;Z)V")
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "()Lbg;")
