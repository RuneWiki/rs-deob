...
public class class48 {
    ...
    @OriginalMember(owner = "client!qh", name = "g", descriptor = "[Lah;")
    public class260[] field776 = null;

    @OriginalMember(owner = "client!qh", name = "d", descriptor = "Lmi;")
    public class341 field773 = null;

    @OriginalMember(owner = "client!qh", name = "j", descriptor = "[Lah;")
    public class260[] field779 = null;

    @OriginalMember(owner = "client!qh", name = "c", descriptor = "Lmi;")
    public class341 field772 = null;

    @OriginalMember(owner = "client!qh", name = "f", descriptor = "Lmi;")
    public class341 field775 = null;
    ...
    public static byte[] field777 = new byte[520];
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Lod;)V", line = 845)
    public class48(class349 arg0) {
        this.field778 = arg0.field5308;
        class233.method1591(arg0, (byte) -35);
        if (this.field778) {
            byte[] var2 = class137.method915(false, class51.field807, -67);
            this.field775 = new class341(arg0, 6410, 128, 128, 16, var2, 6410);
            byte[] var3 = class137.method915(false, class211.field3091, -43);
            this.field773 = new class341(arg0, 6410, 128, 128, 16, var3, 6410);
            class530 var4 = arg0.field5227;
            if (var4.method3129((byte) 73)) {
                byte[] var5 = class137.method915(false, class325.field4644, -82);
                this.field772 = new class341(arg0, 6408, 128, 128, 16);
                class341 var6 = new class341(arg0, 6409, 128, 128, 16, var5, 6409);
                if (var4.method3132(var6, this.field772, (byte) 33, 2.0F)) {
                    this.field772.method2676(-13523);
                } else {
                    this.field772.method2681(99);
                    this.field772 = null;
                }
                var6.method2681(55);
                return;
            ...
            this.field779 = new class260[16];
            for (int var7 = 0; var7 < 16; var7++) {
                byte[] var10 = class234.method1596(var7 * 256 * 128, 32768, class51.field807, 68);
                this.field779[var7] = new class260(arg0, 3553, 6410, 128, 128, true, var10, 6410, false);
            }
            this.field776 = new class260[16];
            for (int var8 = 0; var8 < 16; var8++) {
                byte[] var9 = class234.method1596(var8 * 32768, 32768, class211.field3091, 56);
                this.field776[var8] = new class260(arg0, 3553, 6410, 128, 128, true, var9, 6410, false);
            }
        }
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 27)
    public static final void method300(int arg0) {
        field770++;
        class4.field56 = new class118(class187.field2775.method2838(false, class143.field2137), "", class195.field2839, 1008, -1, 0L, 0, arg0, true, false);
    }

    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BI)[[[B", line = 35)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 814)
    public static final boolean method302(byte arg0, String arg1) {
        field771++;
        return arg0 > -4 ? true : class230.method1578(arg1, 10, true, -44);
    }
}
