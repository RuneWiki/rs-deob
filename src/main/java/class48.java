...
public class class48 extends class123 {
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lri;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "b", descriptor = "(Lri;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "()Lri;")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lfg;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "a", descriptor = "(Lwk;Lfg;)V")
    ...
    @OriginalMember(owner = "client!bt", name = "d", descriptor = "()Lri;")
