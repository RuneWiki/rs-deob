...
public class class325 extends class610 {
    ...
    @OriginalMember(owner = "client!bga", name = "d", descriptor = "(I)[Ll;")
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(IILit;)V")
    ...
    @OriginalMember(owner = "client!bga", name = "<init>", descriptor = "(Len;Lh;)V")
