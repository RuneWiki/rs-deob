...
public class class325 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZLsl;)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)Lfu;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Z)Lfu;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILha;B)Ltd;")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lsl;II)V")
