...
public class class325 {
    ...
    @OriginalMember(owner = "client!ws", name = "<init>", descriptor = "(IZ)V", line = 127)
    public class325(int arg0, boolean arg1) {
        this.field4796 = arg1;
        this.field4798 = arg0;
    }

    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(II)V", line = 17)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IBLpu;IZJI)V", line = 33)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ZI)I", line = 47)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 77)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(IIIIIIIII)V", line = 96)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 110)
    ...
    @OriginalMember(owner = "client!ws", name = "b", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!ws", name = "a", descriptor = "(ILjava/lang/String;)V", line = 148)
    public final void method2048(int arg0, String arg1) {
        field4803++;
        this.method2044(this.field4801 + arg0, arg1, (byte) -106);
    }

    @OriginalMember(owner = "client!ws", name = "toString", descriptor = "()Ljava/lang/String;", line = 156)
