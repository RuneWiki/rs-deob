...
public class class325 extends class338 {
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "()V", line = 7)
    public static void method1869() {
        field4333 = null;
    }

    @OriginalMember(owner = "client!rq", name = "b", descriptor = "()[I", line = 12)
    public final int[] method1870() {
        return this.field4334;
    }

    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(II[IZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(II)V", line = 161)
