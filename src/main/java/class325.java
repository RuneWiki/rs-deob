...
public abstract class class325 implements class10 {

    @OriginalMember(owner = "client!q", name = "d", descriptor = "Z")
    private boolean field4880 = false;

    @OriginalMember(owner = "client!q", name = "g", descriptor = "Lcg;")
    public class393 field4883;
    ...
    private static int[] field4882 = new int[1];

    @OriginalMember(owner = "client!q", name = "b", descriptor = "()V")
    private final void method1996() {
        opengl var1 = this.field4883.field5783;
        this.field4883.method2460(this);
        if (this.field4880) {
            var1.glTexParameteri(this.field4879, 10241, this.field4884 ? 9987 : 9729);
            var1.glTexParameteri(this.field4879, 10240, 9729);
        } else {
            var1.glTexParameteri(this.field4879, 10241, this.field4884 ? 9984 : 9728);
            var1.glTexParameteri(this.field4879, 10240, 9728);
        }
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V")
    public static final void method1997(opengl arg0, int arg1, int arg2, int arg3, int arg4, int arg5, float[] arg6) {
        if (arg3 > 0 && !class146.method914((byte) -77, arg3)) {
            throw new IllegalArgumentException("");
        } else if (arg4 <= 0 || class146.method914((byte) -127, arg4)) {
            int var7 = method2008(arg5);
            int var8 = 0;
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V")
    public static final void method1998(opengl arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int[] arg7) {
        if (arg3 > 0 && !class146.method914((byte) -99, arg3)) {
            throw new IllegalArgumentException("");
        } else if (arg4 > 0 && !class146.method914((byte) -91, arg4)) {
            throw new IllegalArgumentException("");
        } else if (arg5 == 32993) {
            int var8 = 0;
            int var9 = arg3 < arg4 ? arg3 : arg4;
    ...
    public final boolean method1999() {
        opengl var1 = this.field4883.field5783;
        if (!this.field4883.field5895) {
            return false;
        }
        int var2 = this.method2003();
        this.field4883.method2460(this);
        var1.glGenerateMipmapEXT(this.field4879);
        this.field4884 = true;
        this.method1996();
    ...
    public final void method2002() {
        if (this.field4877 > 0) {
            this.field4883.method2429(this.field4877, this.method2003());
            this.field4877 = 0;
        }
    }

    @OriginalMember(owner = "client!q", name = "e", descriptor = "()I")
    private final int method2003() {
        int var1 = this.field4883.method2494(this.field4878) * this.field4881;
        return this.field4884 ? var1 * 4 / 3 : var1;
    }

    @OriginalMember(owner = "client!q", name = "f", descriptor = "()I")
    public final int method2004() {
        return this.field4877;
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V")
    public static final void method2005(opengl arg0, int arg1, int arg2, int arg3, int arg4, int arg5, byte[] arg6) {
        if (arg3 > 0 && !class146.method914((byte) -81, arg3)) {
            throw new IllegalArgumentException("");
        } else if (arg4 <= 0 || class146.method914((byte) -95, arg4)) {
            int var7 = method2008(arg5);
            int var8 = 0;
            int var9 = arg3 < arg4 ? arg3 : arg4;
            int var10 = arg3 >> 1;
    ...
    public final void method2006(boolean arg0) {
    ...
    public static final int method2007(int arg0) {
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(Lcg;IIIZ)V")
    public class325(class393 arg0, int arg1, int arg2, int arg3, boolean arg4) {
        this.field4883 = arg0;
        this.field4879 = arg1;
        this.field4878 = arg2;
        this.field4884 = arg4;
        this.field4881 = arg3;
        this.field4883.field5783.glGenTextures(1, field4882, 0);
        this.field4877 = field4882[0];
        this.method2000(0);
    }
}
