...
public class class325 extends class406 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;ILjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljava/awt/Canvas;B)Lve;", line = 15)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(S)V", line = 50)
    public class325(short arg0) {
        this.field4623 = arg0;
    }

    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(B)V", line = 62)
