...
public abstract class class325 {
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(III)Z", line = 91)
    ...
    @OriginalMember(owner = "client!nha", name = "a", descriptor = "(I)V", line = 114)
