...
public class class325 {
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljava/net/Socket;II)Lwb;", line = 3)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(Ljava/lang/String;IZILjava/lang/String;BZ)V", line = 24)
    ...
    @OriginalMember(owner = "client!kka", name = "a", descriptor = "(B)V", line = 143)
