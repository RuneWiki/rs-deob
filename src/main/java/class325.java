...
public class class325 extends class190 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IB)Lvq;", line = 177)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lvd;ZZI)V", line = 210)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(ZLjava/lang/Object;B)[B", line = 272)
