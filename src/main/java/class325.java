...
public abstract class class325 extends class316 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!wt", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wt", name = "e", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 81)
