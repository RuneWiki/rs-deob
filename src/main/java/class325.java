...
public class class325 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(I)V", line = 209)
    public class325(int arg0) {
        this.field4437 = arg0;
    }

    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(IIIIII)V", line = 229)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILdk;Lza;)V", line = 40)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Lwk;B)V", line = 173)
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(Z)Z", line = 190)
    ...
    @OriginalMember(owner = "client!wk", name = "b", descriptor = "(I)Lwk;", line = 217)
