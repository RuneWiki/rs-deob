...
public class class325 extends class715 {
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Llt;Leq;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(III)V", line = 89)
    ...
    @OriginalMember(owner = "client!hs", name = "e", descriptor = "(I)V", line = 98)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ZI)V", line = 122)
    ...
    @OriginalMember(owner = "client!hs", name = "d", descriptor = "(I)V", line = 144)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILdu;I)V", line = 186)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)Z", line = 221)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(B)V", line = 234)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)V", line = 276)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 294)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(BZ)V", line = 313)
