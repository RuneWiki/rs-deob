...
public class class325 {
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(ILta;[[ILya;Lta;ILta;)V", line = 7)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(I[Leq;IIIIILsi;II)V", line = 323)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IILsi;[Leq;III)V", line = 497)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IZI)B", line = 574)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([[III)V", line = 597)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lya;B[Leq;[[[I)V", line = 633)
    ...
    @OriginalMember(owner = "client!bg", name = "<init>", descriptor = "(IIIZLks;Lcs;)V", line = 2067)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 740)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIBIII)V", line = 752)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(B)V", line = 854)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(Lta;Lta;Lya;I)V", line = 866)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIZILsi;IIZIII)V", line = 1059)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "(IIIII)V", line = 1182)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([[ILta;Lya;ILta;ZLta;)V", line = 1203)
    ...
    @OriginalMember(owner = "client!bg", name = "a", descriptor = "([[BIILbh;Lya;I[ZLwv;III[[BI[[B)V", line = 2086)
