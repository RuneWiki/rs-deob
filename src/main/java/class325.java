...
public class class325 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Ljava/lang/Object;Lnt;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)V", line = 51)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(CI)C", line = 66)
