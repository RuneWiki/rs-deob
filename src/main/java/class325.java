...
public class class325 extends class436 {
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "()V", line = 6)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Z)V", line = 15)
    public final void method161(boolean arg0) {
    }

    @OriginalMember(owner = "client!rq", name = "c", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Lnf;Lqg;)V", line = 44)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "()Z", line = 198)
    public final boolean method159() {
        return true;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Lme;)V", line = 201)
