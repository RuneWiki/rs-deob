...
public class class325 extends class300 implements class212 {
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lel;Lnh;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III[FILnh;III)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILrr;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lel;Lnh;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lel;Lnh;Ljr;II)V")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Lel;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IIIZIILnh;I[B)V")
