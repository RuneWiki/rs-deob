...
public class class325 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)I", line = 12)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "()V", line = 23)
    public class325() {
    }

    @OriginalMember(owner = "client!np", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(B)I", line = 50)
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Lha;)V", line = 59)
