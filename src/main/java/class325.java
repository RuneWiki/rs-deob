...
public abstract class class325 extends class96 {
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!jb", name = "a", descriptor = "(ILae;)Lg;", line = 23)
    ...
    @OriginalMember(owner = "client!jb", name = "e", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!jb", name = "<init>", descriptor = "(Lqa;I)V", line = 58)
    public class325(class155 arg0, int arg1) {
        this.field4748 = arg1;
        this.field4751 = arg0;
    }

    @OriginalMember(owner = "client!jb", name = "c", descriptor = "(Z)Ldh;", line = 83)
