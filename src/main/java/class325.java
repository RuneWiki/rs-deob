...
public class class325 {
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(BI)V", line = 4)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(ZIIIIII)V", line = 34)
    ...
    @OriginalMember(owner = "client!qe", name = "a", descriptor = "(I)V", line = 64)
