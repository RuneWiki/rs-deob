...
public class class325 extends class143 implements class220 {
    ...
    @OriginalMember(owner = "client!kf", name = "d", descriptor = "(I)Lqba;")
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lkfa;III)V")
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(Lkfa;IIII)V")
