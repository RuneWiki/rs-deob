...
public class class325 {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(II)Lco;")
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Lya;BLfs;)V")
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Ljk;ILfs;Lfs;)V")
