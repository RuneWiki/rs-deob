...
public class class325 extends class122 implements class675 {
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IBILrfa;ZILha;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ILha;ZI)Lni;")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Ljava/awt/Canvas;ILlga;Ld;II)Lha;")
    ...
    @OriginalMember(owner = "client!gea", name = "<init>", descriptor = "(Lha;Lfw;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(IILha;)Lka;")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lha;III)Z")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lrfa;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(ZLha;)V")
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(ZLha;)Lrs;")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Lha;B)Lsba;")
