...
public class class325 {
    ...
    @OriginalMember(owner = "client!le", name = "a", descriptor = "(III)V", line = 23)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "(J[I[S[S)V", line = 46)
    ...
    @OriginalMember(owner = "client!le", name = "<init>", descriptor = "()V", line = 57)
    protected class325() {
    }

    @OriginalMember(owner = "client!le", name = "a", descriptor = "(ILgj;IIIIZ)V", line = 60)
