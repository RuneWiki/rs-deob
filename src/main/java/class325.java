...
public abstract class class325 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZII)V", line = 36)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ZZI)V", line = 87)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(IIIIZIIIF)[[I", line = 198)
    ...
    @OriginalMember(owner = "client!bp", name = "b", descriptor = "(II)Z", line = 233)
