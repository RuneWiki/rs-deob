...
public class class325 extends class627 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lvm;Lkha;Lnl;ILkha;Lkha;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIIIIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B)V", line = 106)
