...
public class class325 extends class125 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(III[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qg", name = "xa", descriptor = "()V", line = 15)
    ...
    @OriginalMember(owner = "client!qg", name = "m", descriptor = "([I)V", line = 27)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "()Lc;", line = 54)
    ...
    @OriginalMember(owner = "client!qg", name = "N", descriptor = "(I)V", line = 81)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Z)[F", line = 93)
    ...
    @OriginalMember(owner = "client!qg", name = "ra", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!qg", name = "ka", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BLuq;)V", line = 160)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILqd;II)Lrg;", line = 193)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BFFFIII)V", line = 268)
    ...
    @OriginalMember(owner = "client!qg", name = "O", descriptor = "(I)V", line = 308)
    ...
    @OriginalMember(owner = "client!qg", name = "o", descriptor = "(III)V", line = 323)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(Z)V", line = 333)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIBIIIII)V", line = 362)
    ...
    @OriginalMember(owner = "client!qg", name = "za", descriptor = "(Lc;)V", line = 535)
    ...
    @OriginalMember(owner = "client!qg", name = "p", descriptor = "(III[I)V", line = 558)
    ...
    @OriginalMember(owner = "client!qg", name = "j", descriptor = "(III)V", line = 568)
    ...
    @OriginalMember(owner = "client!qg", name = "ja", descriptor = "(I)V", line = 581)
    ...
    @OriginalMember(owner = "client!qg", name = "b", descriptor = "(I)[F", line = 608)
    ...
    @OriginalMember(owner = "client!qg", name = "s", descriptor = "(IIIIII)V", line = 631)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BLc;)V", line = 674)
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "()V", line = 702)
    public class325() {
        this.method209();
    }
}
