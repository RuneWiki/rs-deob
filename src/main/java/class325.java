...
public class class325 {
    ...
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(Ld;BLjava/awt/Canvas;Luq;I)Lha;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!dja", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
