...
public class class325 extends class70 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)Lvj;")
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lnha;Ljn;IIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIZIB)Lii;")
