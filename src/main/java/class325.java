...
public class class325 implements Runnable {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIB[B)V", line = 4)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIIZ)I", line = 78)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Z)V", line = 91)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Ljava/net/Socket;Lmr;I)V", line = 322)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 124)
    ...
    @OriginalMember(owner = "client!or", name = "finalize", descriptor = "()V", line = 163)
    protected final void finalize() {
        this.method1903((byte) 120);
        field4181++;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IB[BI)V", line = 174)
    ...
    @OriginalMember(owner = "client!or", name = "run", descriptor = "()V", line = 233)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(Z)I", line = 302)
