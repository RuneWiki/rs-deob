...
public class class325 {
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(B)Lrp;", line = 4)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Lsea;I)V", line = 38)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)Lrp;", line = 69)
    ...
    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "()V", line = 89)
    public class325() {
    }

    @OriginalMember(owner = "client!du", name = "<init>", descriptor = "(Lfaa;)V", line = 94)
