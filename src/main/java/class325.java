...
public class class325 extends class337 {
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lcn;)V", line = 108)
    public class325(class355 arg0) {
        this.field4640 = arg0;
    }

    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)V", line = 26)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIIIIII)V", line = 45)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(III)Z", line = 85)
