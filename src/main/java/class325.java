...
public class class325 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(III)V", line = 193)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(IB)[I", line = 38)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(B)[[I", line = 107)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)V", line = 171)
