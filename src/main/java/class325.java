...
public abstract class class325 implements class657 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)I", line = 28)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(Lvj;IIIZ)V", line = 192)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)V", line = 43)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZIB)I", line = 55)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(B)V", line = 90)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)I", line = 106)
    ...
    @OriginalMember(owner = "client!av", name = "c", descriptor = "(I)Z", line = 125)
    ...
    @OriginalMember(owner = "client!av", name = "d", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!av", name = "e", descriptor = "(I)V", line = 181)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZB)V", line = 210)
    ...
    @OriginalMember(owner = "client!av", name = "finalize", descriptor = "()V", line = 230)
