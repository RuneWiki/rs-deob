...
public class class325 extends class289 {
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lad;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lad;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lad;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lad;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lad;IIII[I)V")
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(Lad;IIIZ[I)V")
