...
public class class325 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Ljava/applet/Applet;BLjava/lang/String;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ILjava/applet/Applet;Ljava/lang/String;)V", line = 13)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;[Ljava/lang/Object;B)Ljava/lang/Object;", line = 24)
