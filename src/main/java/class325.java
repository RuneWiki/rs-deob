...
public class class325 {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Leb;)V", line = 12)
    ...
    @OriginalMember(owner = "client!gh", name = "b", descriptor = "(Leb;)V", line = 21)
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!gh", name = "<init>", descriptor = "()V", line = 56)
    public class325() {
        this.field4440[0] = 0;
