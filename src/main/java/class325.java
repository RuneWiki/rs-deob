...
public class class325 extends class308 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/lang/Object;Lkj;I)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lht;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lht;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lht;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lht;IIII[I)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lht;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(Lht;IIIIZ[BI)V")
