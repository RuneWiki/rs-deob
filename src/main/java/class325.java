...
public class class325 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lri;IIIIIZ)V", line = 14)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Leq;Z)V", line = 72)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZIIF[FIIIIF)V", line = 101)
