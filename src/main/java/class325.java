...
public abstract class class325 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIIIIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IIILqh;Lqh;)V", line = 222)
