...
public class class325 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIIII)Z")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIII)Z")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;I)I")
