...
public class class325 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIB)Z", line = 10)
    ...
    @OriginalMember(owner = "client!hs", name = "toString", descriptor = "()Ljava/lang/String;", line = 21)
    public final String toString() {
        field4150++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILwd;)I", line = 33)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIII)I", line = 68)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(II)V", line = 99)
    public class325(int arg0, int arg1) {
        this.field4147 = arg1;
    }

    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B[B)[B", line = 115)
