...
public class class388 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILcc;)V", line = 12)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "([I)V", line = 45)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ZI)V", line = 85)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(II)I", line = 338)
