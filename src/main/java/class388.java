...
public class class388 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(IZLjava/io/File;)V", line = 5)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(Lnt;II)V", line = 42)
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "(ILkn;Z)V", line = 91)
