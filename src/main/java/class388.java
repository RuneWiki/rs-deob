...
public class class388 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljava/lang/Class;ILjava/lang/String;)Z", line = 5)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(IIIIIIBIZ)Z", line = 79)
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(III)I", line = 120)
