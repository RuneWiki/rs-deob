...
public class class388 extends class278 {
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZLjava/lang/String;)V", line = 28)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "()V", line = 89)
    public class388() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Lvq;Lvq;ZZIII)I", line = 97)
    ...
    @OriginalMember(owner = "client!fs", name = "g", descriptor = "(I)V", line = 135)
