...
public class class388 extends class755 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IBII)[B")
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(ZBI)V")
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(JLha;I)V")
