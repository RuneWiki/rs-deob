...
public class class388 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lbd;I)V")
    ...
    @OriginalMember(owner = "client!pl", name = "b", descriptor = "(Z)Ltf;")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(I)Ltf;")
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Lbd;)V")
