...
public class class388 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(III)I", line = 295)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "()V", line = 319)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lsl;)V", line = 329)
