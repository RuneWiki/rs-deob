...
public class class388 extends class287 {
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Lgda;Lha;IIZII)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IILha;)Z")
    ...
    @OriginalMember(owner = "client!vk", name = "g", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(ILha;)Lrk;")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(Ltd;B)V")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(IBILha;)Z")
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "(ZLha;)Loba;")
