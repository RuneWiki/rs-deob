...
public class class388 implements class698 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIILjava/lang/String;Lda;I)I")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILtn;)Luv;")
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lpia;Ljv;)V")
