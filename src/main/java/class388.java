...
public class class388 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIBIIIIII)V", line = 37)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!fi", name = "toString", descriptor = "()Ljava/lang/String;", line = 67)
    public final String toString() {
        field5840++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(I)V", line = 81)
    public class388(int arg0) {
        this.field5836 = arg0;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILcu;)Lbo;", line = 92)
