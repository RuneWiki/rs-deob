...
public class class388 extends class467 {
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(B)Z", line = 5)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lns;Lns;I)V", line = 17)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Z)I", line = 41)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(I)Z", line = 80)
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(II)V", line = 94)
    public class388(int arg0, int arg1) {
        this.field5891 = arg0;
        this.field5894 = arg1;
    }

    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)Z", line = 104)
