...
public class class388 extends class28 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lft;IIILqq;)V", line = 17)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(IBI)I", line = 52)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(ILqq;)V", line = 67)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(II[I[I)V", line = 201)
