...
public class class388 extends class516 {
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(ILgba;)V")
    ...
    @OriginalMember(owner = "client!rca", name = "a", descriptor = "(Lpb;II)V")
    ...
    @OriginalMember(owner = "client!rca", name = "<init>", descriptor = "(Lag;Lkda;)V")
