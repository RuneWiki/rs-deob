...
public class class388 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lega;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Ltc;I)Ltc;", line = 26)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!ol", name = "toString", descriptor = "()Ljava/lang/String;", line = 114)
    public final String toString() {
        field4975++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "([BII)[B", line = 122)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(II)I", line = 141)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(B)V", line = 155)
