...
public class class388 {
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(B)I", line = 13)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!ij", name = "a", descriptor = "(IB)V", line = 42)
