...
public class class388 implements class23 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lts;I)Z", line = 41)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)I", line = 82)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)J", line = 113)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "([BIII)Ljava/lang/String;", line = 145)
