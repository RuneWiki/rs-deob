...
public class class388 {
    ...
    @OriginalMember(owner = "client!nh", name = "finalize", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "(Ldga;II)V", line = 16)
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(I)V", line = 27)
