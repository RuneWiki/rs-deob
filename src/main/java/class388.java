...
public class class388 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIIIIIB)V", line = 46)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BLbt;)V", line = 77)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lnp;ZLnp;)V", line = 99)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BF)F", line = 123)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILsj;)I", line = 139)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILjava/awt/Frame;Lhs;)V", line = 212)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IILbt;)V", line = 252)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)V", line = 313)
