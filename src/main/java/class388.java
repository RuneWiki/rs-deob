...
public class class388 extends class360 implements class231 {
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(ILqa;)Lkm;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZLqa;)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BLqa;II)Z")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lqa;Ltk;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lqa;II)Lr;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lqa;I)Lbi;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ZIILqa;)Lep;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(ILqa;Z)Lr;")
    public final class519 method254(int arg0, class167 arg1, boolean arg2) {
        ++field5767;
        return arg2 ? null : this.method2352(arg1, arg0, 0);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(BZILqa;IILcea;)V")
