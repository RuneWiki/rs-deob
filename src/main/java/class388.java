...
public class class388 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZLga;Lya;)V")
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BI)Lss;")
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(Lal;ILmg;)V")
