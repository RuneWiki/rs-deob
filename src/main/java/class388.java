...
public class class388 extends class354 {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lnj;II)V", line = 4)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "()V", line = 41)
    public class388() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(BI)[I", line = 44)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(JI)V", line = 101)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(B)I", line = 122)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IB)[[I", line = 135)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(III)V", line = 208)
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(Z)V", line = 223)
