...
public class class388 extends class461 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;[Lfba;Z)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;J)Z")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([Lmb;Z)V")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;J[Lfba;[Lmb;Z)V")
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "()Lhda;")
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(IZ)Lju;")
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lha;)V")
