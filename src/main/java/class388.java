...
public class class388 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IZLcr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 71)
