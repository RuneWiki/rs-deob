...
public class class388 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(IB)Luia;", line = 25)
    ...
    @OriginalMember(owner = "client!fu", name = "b", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!fu", name = "<init>", descriptor = "(Lcw;ILeq;)V", line = 96)
