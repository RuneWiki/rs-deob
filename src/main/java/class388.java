...
public class class388 extends class17 implements class285 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)I", line = 3)
    public final int method356(int arg0) {
        ++field5525;
        return arg0 != 10397 ? 113 : 65535 & this.field5526;
    }

    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(B)I", line = 16)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lvm;II)Ljn;", line = 41)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIILvm;)Z", line = 56)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BLvm;)V", line = 78)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIII)V", line = 105)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(B)Z", line = 160)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(B)V", line = 171)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)V", line = 188)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZILvm;I)Lf;", line = 203)
    ...
    @OriginalMember(owner = "client!cs", name = "h", descriptor = "(I)Z", line = 241)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lvm;I)V", line = 291)
    ...
    @OriginalMember(owner = "client!cs", name = "i", descriptor = "(I)I", line = 301)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lvm;Lds;IIIIIZIIIIIIZ)V", line = 316)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZIIILai;ILvm;)V", line = 350)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lvm;Z)Ldn;", line = 384)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Lvm;II)Ljn;", line = 415)
    ...
    @OriginalMember(owner = "client!cs", name = "e", descriptor = "(I)I", line = 436)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(ZLvm;)V", line = 448)
    ...
    @OriginalMember(owner = "client!cs", name = "f", descriptor = "(B)V", line = 481)
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(B)Z", line = 503)
