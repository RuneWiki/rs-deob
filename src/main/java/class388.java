...
public class class388 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(I)Lps;")
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "(I)Lps;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lps;B)V")
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "(I)Lps;")
    ...
    @OriginalMember(owner = "client!re", name = "e", descriptor = "(I)Lps;")
