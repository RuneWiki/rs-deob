...
public class class388 extends class115 {
    ...
    @OriginalMember(owner = "client!bl", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!bl", name = "c", descriptor = "(II)V", line = 20)
    ...
    @OriginalMember(owner = "client!bl", name = "i", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!bl", name = "d", descriptor = "(I)V", line = 141)
    ...
    @OriginalMember(owner = "client!bl", name = "b", descriptor = "(II)[I", line = 152)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(BLbk;I)V", line = 289)
    ...
    @OriginalMember(owner = "client!bl", name = "a", descriptor = "(IBII)V", line = 351)
    ...
    @OriginalMember(owner = "client!bl", name = "<init>", descriptor = "()V", line = 404)
    public class388() {
        super(0, true);
    }

    @OriginalMember(owner = "client!bl", name = "j", descriptor = "(I)V", line = 376)
