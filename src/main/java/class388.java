...
public class class388 extends class104 {
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "(ILla;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!pa", name = "h", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IIIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(IB)I", line = 101)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "([BI)I", line = 122)
