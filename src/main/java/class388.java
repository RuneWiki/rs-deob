...
public class class388 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIZLvg;)V", line = 5)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIII)I", line = 29)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(ILjava/lang/String;)I", line = 48)
