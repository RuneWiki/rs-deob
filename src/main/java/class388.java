...
public class class388 {
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(ZB)V", line = 4)
    public static final synchronized void method2369(boolean arg0, byte arg1) {
        int var2 = 9 % ((arg1 - 76) / 36);
        field5676 = arg0;
    }

    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!ol", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!ol", name = "a", descriptor = "(Lp;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ol", name = "c", descriptor = "(I)V", line = 74)
