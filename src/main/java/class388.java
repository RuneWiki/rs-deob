...
public class class388 extends class372 {
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lkv;)V", line = 16)
    ...
    @OriginalMember(owner = "client!dv", name = "b", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(III)Z", line = 46)
