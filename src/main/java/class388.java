...
public class class388 extends class55 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILha;BZ)Lda;", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IIILsba;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(I[B)V", line = 59)
