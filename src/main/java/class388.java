...
public abstract class class388 extends class359 {
    ...
    @OriginalMember(owner = "client!kl", name = "ZA", descriptor = "()I", line = 6)
    public final int method200() {
        return this.field5591;
    }

    @OriginalMember(owner = "client!kl", name = "YA", descriptor = "()I", line = 17)
    public final int method205() {
        return this.field5582;
    }

    @OriginalMember(owner = "client!kl", name = "Q", descriptor = "()I", line = 22)
    public final int method207() {
        return this.field5591 + this.field5578 + this.field5599;
    }

    @OriginalMember(owner = "client!kl", name = "la", descriptor = "(IIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!kl", name = "RA", descriptor = "()I", line = 66)
    public final int method204() {
        return this.field5586 + this.field5582 + this.field5597;
    }

    @OriginalMember(owner = "client!kl", name = "ha", descriptor = "(IIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!kl", name = "H", descriptor = "(FFFFFFIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(FFFFFF)V", line = 192)
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(FFFFFFLta;II)V", line = 328)
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(Lms;II)V", line = 345)
