...
public class class388 {
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II[B)[B", line = 3)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Loda;ILdda;)V", line = 116)
    public class388(class559 arg0, int arg1, class597 arg2) {
        this.field5665 = arg2;
        this.field5671 = this.field5665.method3462(4, 104);
    }

    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(II)V", line = 67)
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(II)Lch;", line = 80)
