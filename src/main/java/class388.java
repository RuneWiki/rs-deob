...
public class class388 implements Runnable {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/Runnable;IB)Lba;", line = 4)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)Lrg;", line = 20)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Lba;", line = 62)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/awt/Frame;I)Lba;", line = 133)
    public final class661 method2224(Frame arg0, int arg1) {
        return arg1 > -56 ? null : this.method2234(arg0, 0, 7, 0, 0);
    }

    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/String;B)Lba;", line = 148)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IZ)Lba;", line = 160)
    ...
    @OriginalMember(owner = "client!gba", name = "<init>", descriptor = "(ILjava/lang/String;IZ)V", line = 701)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(B)Z", line = 183)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/awt/Point;ZILjava/awt/Component;I[I)Lba;", line = 201)
    ...
    @OriginalMember(owner = "client!gba", name = "run", descriptor = "()V", line = 212)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/Class;I[Ljava/lang/Class;)Lba;", line = 516)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/Object;IIII)Lba;", line = 579)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(ZZILjava/lang/String;)Lba;", line = 613)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/lang/String;BZ)Lba;", line = 628)
    ...
    @OriginalMember(owner = "client!gba", name = "b", descriptor = "(Ljava/lang/String;B)Lrg;", line = 646)
    public static final class611 method2237(String arg0, byte arg1) {
        return arg1 <= 53 ? null : method2221(25, field5187, arg0, field5190);
    }

    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(Ljava/io/File;I[B)Z", line = 662)
    ...
    @OriginalMember(owner = "client!gba", name = "a", descriptor = "(IIIII)Lba;", line = 685)
