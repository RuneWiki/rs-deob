...
public class class388 {
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILes;)V", line = 5)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IBLes;)V", line = 26)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(ILr;ILhl;III)Lda;", line = 151)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(Lhl;ILr;IIII)Lda;", line = 178)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(I)V", line = 199)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIIIBLi;IZLi;ILr;Lhl;I)Lda;", line = 209)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IB)Z", line = 222)
    ...
    @OriginalMember(owner = "client!iv", name = "a", descriptor = "(IIZIIIILi;BILi;ZLr;Lhl;)Lda;", line = 235)
