...
public class class388 extends class452 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Lhp;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZLcl;)V", line = 77)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(II)V", line = 99)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IC)Z", line = 111)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BLhp;I)V", line = 149)
