...
public abstract class class598 {
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IBLjava/lang/String;)I", line = 6)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(IIBII)V", line = 20)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!nq", name = "c", descriptor = "(I)V", line = 65)
