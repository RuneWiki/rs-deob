...
public class class598 extends class601 {
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "()V", line = 10)
    public class598() {
        this(0);
    }

    @OriginalMember(owner = "client!gt", name = "f", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gt", name = "<init>", descriptor = "(I)V", line = 26)
    private class598(int arg0) {
        super(0, false);
        this.method3233(arg0, (byte) 97);
    }

    @OriginalMember(owner = "client!gt", name = "d", descriptor = "(B)V", line = 34)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(IB)V", line = 46)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(Lmc;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIZIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(II)[[I", line = 132)
