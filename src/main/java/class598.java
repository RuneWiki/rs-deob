...
public class class598 implements Runnable {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lnaa;IZ)Lao;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lnaa;II)Lao;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Lnaa;[BIZ)Lao;")
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(BLao;)V")
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(Lec;)V")
