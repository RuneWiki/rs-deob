...
public class class598 extends class442 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZI)V", line = 7)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!gl", name = "c", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Ljava/lang/String;Z)I", line = 72)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Loh;Lsv;)V", line = 95)
