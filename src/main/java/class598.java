...
public abstract class class598 extends class170 {
    ...
    @OriginalMember(owner = "client!gn", name = "f", descriptor = "(I)V", line = 11)
    ...
    @OriginalMember(owner = "client!gn", name = "d", descriptor = "(B)V", line = 26)
    ...
    @OriginalMember(owner = "client!gn", name = "g", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!gn", name = "h", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 73)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 95)
