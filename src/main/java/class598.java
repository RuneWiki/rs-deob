...
public class class598 extends class260 {
    ...
    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(Lfca;)V")
    public class598(class92 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!im", name = "<init>", descriptor = "(ILfca;)V")
    ...
    @OriginalMember(owner = "client!im", name = "a", descriptor = "(BILbba;II)V")
