...
public class class598 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IILen;I)Lir;", line = 18)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(Lac;[BI)V", line = 101)
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(I[B)[B", line = 140)
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "()V", line = 168)
    public class598() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(III)V", line = 181)
