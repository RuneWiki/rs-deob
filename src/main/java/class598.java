...
public class class598 extends class427 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)Luu;", line = 33)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IIIZ)I", line = 46)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)Lnaa;", line = 71)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(IBI)I", line = 84)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lrj;Lmq;IIIIIIIIIIIIII)V", line = 168)
