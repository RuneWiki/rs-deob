...
public abstract class class598 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(BC)B", line = 9)
    ...
    @OriginalMember(owner = "client!ou", name = "b", descriptor = "(B)V", line = 134)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IB)V", line = 150)
