...
public class class598 extends class132 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IBILrr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(B)I", line = 31)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(I)J", line = 41)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(III)B", line = 52)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)I", line = 72)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)I", line = 84)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(Z)I", line = 98)
