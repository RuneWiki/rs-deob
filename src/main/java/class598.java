...
public class class598 implements Runnable {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(I)Z", line = 32)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILida;)V", line = 56)
    ...
    @OriginalMember(owner = "client!it", name = "run", descriptor = "()V", line = 75)
    ...
    @OriginalMember(owner = "client!it", name = "d", descriptor = "(I)J", line = 169)
    ...
    @OriginalMember(owner = "client!it", name = "e", descriptor = "(I)Lfga;", line = 180)
    public final class229 method3379(int arg0) {
        field8455++;
        return arg0 < 9 ? null : this.field8462;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILvg;BI)V", line = 192)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Lmw;Z)Z", line = 265)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(BI)V", line = 378)
    ...
    @OriginalMember(owner = "client!it", name = "f", descriptor = "(I)V", line = 388)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)V", line = 399)
    public final void method3384(boolean arg0) {
        field8446++;
        this.field8438 = arg0;
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)I", line = 415)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Z)I", line = 428)
    ...
    @OriginalMember(owner = "client!it", name = "g", descriptor = "(I)Ljava/lang/String;", line = 442)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(JLjava/lang/String;ILfga;I)V", line = 462)
