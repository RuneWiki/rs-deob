...
public class class598 extends class337 implements class559 {
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ILha;B)Lka;", line = 4)
    ...
    @OriginalMember(owner = "client!via", name = "e", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IIBLha;)Z", line = 52)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ZILmb;Lha;III)V", line = 76)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ZBLha;I)Lsca;", line = 98)
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(I)I", line = 128)
    public final int method741(int arg0) {
        ++field8303;
        return arg0 <= 65 ? 62 : 22;
    }

    @OriginalMember(owner = "client!via", name = "c", descriptor = "(B)Z", line = 139)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lha;I)Lie;", line = 153)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIZ)V", line = 182)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(Lha;B)Lufa;", line = 215)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(I)I", line = 230)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ZLha;)V", line = 241)
    ...
    @OriginalMember(owner = "client!via", name = "d", descriptor = "(B)Z", line = 252)
    ...
    @OriginalMember(owner = "client!via", name = "e", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!via", name = "k", descriptor = "(I)V", line = 286)
    public static void method3302(int arg0) {
        field8304 = null;
        int var1 = -37 / ((arg0 - 42) / 59);
    }

    @OriginalMember(owner = "client!via", name = "f", descriptor = "(I)I", line = 296)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(B)Z", line = 308)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(Lha;B)V", line = 320)
    ...
    @OriginalMember(owner = "client!via", name = "f", descriptor = "(B)Z", line = 355)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(B)V", line = 371)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(ILha;)V", line = 386)
