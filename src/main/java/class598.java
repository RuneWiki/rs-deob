...
public class class598 extends class276 {
    ...
    @OriginalMember(owner = "client!fk", name = "e", descriptor = "()I", line = 7)
    public final synchronized int method3306() {
        return this.field8291.method1276(69);
    }

    @OriginalMember(owner = "client!fk", name = "c", descriptor = "([III)V", line = 15)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "([III)V", line = 28)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "()Lvw;", line = 124)
    public final class276 method1673() {
        return (class276) this.field8291.method1270((byte) -25);
    }

    @OriginalMember(owner = "client!fk", name = "f", descriptor = "()V", line = 127)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lvw;)V", line = 146)
    public final synchronized void method3309(class276 arg0) {
        arg0.method2971(1);
    }

    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(Lvw;)V", line = 151)
    public final synchronized void method3310(class276 arg0) {
        this.field8291.method1280(arg0, (byte) -128);
    }

    @OriginalMember(owner = "client!fk", name = "b", descriptor = "()I", line = 154)
    public final int method1674() {
        return 0;
    }

    @OriginalMember(owner = "client!fk", name = "c", descriptor = "()Lvw;", line = 160)
    public final class276 method1676() {
        return (class276) this.field8291.method1282(0);
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lia;Lida;)V", line = 163)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lida;)V", line = 181)
