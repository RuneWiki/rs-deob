...
public class class598 extends class392 {
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILha;)V", line = 15)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(III)Z", line = 124)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lw;)V", line = 135)
    public class598(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!as", name = "c", descriptor = "(I)Z", line = 141)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BI)V", line = 154)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(II)I", line = 165)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(ILw;)V", line = 179)
    public class598(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!as", name = "b", descriptor = "(Z)V", line = 184)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)I", line = 203)
