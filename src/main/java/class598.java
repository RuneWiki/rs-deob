...
public class class598 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(BLlga;)Z")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(ILlga;)V")
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lag;)V")
