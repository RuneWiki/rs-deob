...
public class class598 {
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILjava/lang/String;[Lxa;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/lang/String;I[Lxa;B)Ljava/lang/String;", line = 50)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/String;[Lxa;[II)I", line = 175)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(ILjava/lang/String;)I", line = 424)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "([Lxa;BLjava/lang/String;)I", line = 436)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(Ljava/lang/String;[Lxa;ZI)I", line = 540)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(BII[Lxa;Ljava/lang/String;)I", line = 563)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(CII)I", line = 584)
    ...
    @OriginalMember(owner = "client!il", name = "a", descriptor = "(IZ)I", line = 600)
    ...
    @OriginalMember(owner = "client!il", name = "<init>", descriptor = "([B)V", line = 610)
