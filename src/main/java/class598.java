...
public class class598 implements class741 {
    ...
    @OriginalMember(owner = "client!bha", name = "c", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(I)I", line = 15)
    public final int method3453(int arg0) {
        return arg0 == 17816 ? this.field8427 : 59;
    }

    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 29)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(IIILjaclib/memory/Source;)Z", line = 51)
    ...
    @OriginalMember(owner = "client!bha", name = "b", descriptor = "(B)Z", line = 67)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(III)Z", line = 88)
    ...
    @OriginalMember(owner = "client!bha", name = "a", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!bha", name = "<init>", descriptor = "(Lki;Z)V", line = 144)
