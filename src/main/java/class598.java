...
public class class598 extends class113 {
    ...
    @OriginalMember(owner = "client!kr", name = "<init>", descriptor = "(Lha;Lqv;Lta;J)V", line = 421)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(II[[[BIIIIIIIILha;I)V", line = 68)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(BJLha;)V", line = 98)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!kr", name = "a", descriptor = "(Lha;IZJI)V", line = 136)
