...
public class class598 extends class434 {
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(I)V", line = 33)
