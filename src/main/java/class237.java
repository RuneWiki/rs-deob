...
public class class237 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 17)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(B)Ljava/lang/Object;", line = 61)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(BLjava/lang/Object;J)V", line = 93)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III)I", line = 123)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!lg", name = "<init>", descriptor = "(I)V", line = 285)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(JI)Ljava/lang/Object;", line = 173)
    ...
    @OriginalMember(owner = "client!lg", name = "d", descriptor = "(B)V", line = 217)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)V", line = 244)
    ...
    @OriginalMember(owner = "client!lg", name = "e", descriptor = "(B)I", line = 262)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(II)V", line = 301)
    ...
    @OriginalMember(owner = "client!lg", name = "b", descriptor = "(II)Lof;", line = 349)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(JB)V", line = 375)
    ...
    @OriginalMember(owner = "client!lg", name = "f", descriptor = "(B)V", line = 395)
