...
public class class237 {
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(IB)Lqa;", line = 3)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(BII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(II)[I", line = 29)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!aga", name = "a", descriptor = "(B)Z", line = 88)
    ...
    @OriginalMember(owner = "client!aga", name = "b", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!aga", name = "c", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!aga", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 210)
