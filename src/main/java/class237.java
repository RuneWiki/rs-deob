...
public class class237 extends class650 {
    ...
    @OriginalMember(owner = "client!to", name = "a", descriptor = "(Loh;Loh;IF)Z")
    ...
    @OriginalMember(owner = "client!to", name = "<init>", descriptor = "(Llea;I)V")
    ...
    @OriginalMember(owner = "client!to", name = "b", descriptor = "(I)Loh;")
