...
public class class237 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(II)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(I[B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IIIIIII)V", line = 94)
    ...
    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(II)[B", line = 111)
