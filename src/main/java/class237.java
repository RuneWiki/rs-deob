...
public class class237 extends class363 implements class529 {
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IIZ)Z", line = 9)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lya;ZI)Lt;", line = 21)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lsp;B)Z", line = 46)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(B)I", line = 58)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IZILya;)Lmg;", line = 69)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILfi;BZLya;I)V", line = 99)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(Lya;I)V", line = 120)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lya;II)Lt;", line = 131)
    ...
    @OriginalMember(owner = "client!jp", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Lya;I)V", line = 155)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(I)Z", line = 185)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(Z)I", line = 198)
    ...
    @OriginalMember(owner = "client!jp", name = "<init>", descriptor = "(Lya;Lrd;IIIIZIZ)V", line = 209)
    ...
    @OriginalMember(owner = "client!jp", name = "d", descriptor = "(I)V", line = 243)
    ...
    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(IILya;I)Z", line = 258)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(I)I", line = 281)
    ...
    @OriginalMember(owner = "client!jp", name = "e", descriptor = "(B)V", line = 294)
    ...
    @OriginalMember(owner = "client!jp", name = "c", descriptor = "(Lya;I)Lfk;", line = 304)
    ...
    @OriginalMember(owner = "client!jp", name = "d", descriptor = "(B)Z", line = 334)
    public final boolean method32(byte arg0) {
        ++field3488;
        return arg0 < 104 ? true : this.field3473;
    }

    @OriginalMember(owner = "client!jp", name = "a", descriptor = "(ZLya;)V", line = 352)
