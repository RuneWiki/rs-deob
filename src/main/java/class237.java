...
public abstract class class237 extends class274 {
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IJ)V", line = 21)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IILoa;ILcq;ZI)V", line = 41)
    ...
    @OriginalMember(owner = "client!fi", name = "d", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BLjava/lang/String;)V", line = 75)
    ...
    @OriginalMember(owner = "client!fi", name = "e", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(IIIIIII)V", line = 116)
