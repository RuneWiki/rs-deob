...
public class class237 extends OutputStream {
    ...
    @OriginalMember(owner = "client!du", name = "write", descriptor = "(I)V", line = 6)
    public final void write(int arg0) throws IOException {
        field3428++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!du", name = "a", descriptor = "(IZIIFIII)[I", line = 17)
    ...
    @OriginalMember(owner = "client!du", name = "a", descriptor = "(I)V", line = 42)
