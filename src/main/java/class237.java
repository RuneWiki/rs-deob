...
public abstract class class237 implements class175 {
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(I)I", line = 8)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(B)Z", line = 60)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(IIILdq;II)V", line = 83)
    ...
    @OriginalMember(owner = "client!rt", name = "a", descriptor = "(ZZ)V", line = 130)
    ...
    @OriginalMember(owner = "client!rt", name = "<init>", descriptor = "(Lgda;Lgda;Lgm;)V", line = 151)
    ...
    @OriginalMember(owner = "client!rt", name = "b", descriptor = "(B)V", line = 163)
