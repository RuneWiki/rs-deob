...
public class class237 {
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(I)[Lkfa;")
    ...
    @OriginalMember(owner = "client!ln", name = "a", descriptor = "(IB)Ljn;")
    ...
    @OriginalMember(owner = "client!ln", name = "b", descriptor = "(III)Ltd;")
    ...
    @OriginalMember(owner = "client!ln", name = "<init>", descriptor = "(Ldh;ILkha;Lkha;)V")
