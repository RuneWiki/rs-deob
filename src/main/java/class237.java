...
public class class237 extends class452 {
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Lul;ILga;)Z", line = 9)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(ZDLga;IILul;IZ)[I", line = 64)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(DILga;Lul;IZI)[I", line = 208)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIII)V", line = 348)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(Z)V", line = 370)
    ...
    @OriginalMember(owner = "client!rb", name = "a", descriptor = "(IIZBLga;Lul;)[F", line = 388)
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "()V", line = 504)
    public class237() {
    ...
    @OriginalMember(owner = "client!rb", name = "<init>", descriptor = "(Lhp;)V", line = 522)
