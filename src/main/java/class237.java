...
public class class237 {
    ...
    @OriginalMember(owner = "client!fa", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(II)Lfb;", line = 30)
    ...
    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(ILqg;IIIB)Ljava/awt/Frame;", line = 70)
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(ILnd;Lnd;)V", line = 165)
