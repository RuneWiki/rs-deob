...
public class class237 extends InputStream {
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(ZILjava/lang/String;Ljava/lang/String;)V", line = 14)
    ...
    @OriginalMember(owner = "client!s", name = "read", descriptor = "()I", line = 46)
    ...
    @OriginalMember(owner = "client!s", name = "a", descriptor = "(III)Z", line = 58)
