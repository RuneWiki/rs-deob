...
public class class237 extends class14 {
    ...
    @OriginalMember(owner = "client!lr", name = "b", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lbv;II)V", line = 21)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(ZIII)I", line = 39)
    ...
    @OriginalMember(owner = "client!lr", name = "f", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lbv;IIZ[[I)V", line = 74)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(Z)V", line = 105)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IIIII)V", line = 119)
    ...
    @OriginalMember(owner = "client!lr", name = "<init>", descriptor = "(Lbv;IIZ[[BI)V", line = 135)
    ...
    @OriginalMember(owner = "client!lr", name = "a", descriptor = "(IBI)I", line = 157)
