...
public class class237 extends class321 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(Ljava/lang/String;ZIILjava/lang/String;)V", line = 4)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IIIIIIIIIILjw;I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(B)V", line = 457)
