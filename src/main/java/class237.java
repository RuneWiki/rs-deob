...
public class class237 extends class585 {
    ...
    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!jda", name = "<init>", descriptor = "()V", line = 44)
    public class237() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jda", name = "b", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!jda", name = "e", descriptor = "(B)V", line = 62)
