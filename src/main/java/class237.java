...
public class class237 extends class123 {
    ...
    @OriginalMember(owner = "client!km", name = "za", descriptor = "(Lc;)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(II)Lmm;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(BLc;)V")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "()Lc;")
