...
public class class237 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lee;B)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lee;BI)V")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ILha;)Lhu;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(ZLha;)Lhu;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(ILha;)Lhu;")
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(Lha;I)Lhu;")
