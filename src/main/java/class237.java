...
public class class237 {
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(I)Lgda;")
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)Lgda;")
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(Lwr;)V")
