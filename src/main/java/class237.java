...
public class class237 extends class209 {
    ...
    @OriginalMember(owner = "client!ida", name = "g", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Lwh;)V")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(IILaw;Law;)V")
