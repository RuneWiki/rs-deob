...
public class class237 extends class101 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lwc;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(I)V", line = 36)
    public static final void method1532(int arg0) {
        class186.method1293(arg0, -1, 255);
        field3197++;
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Z[Ljava/lang/Object;[J)V", line = 44)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(ZIBI)V", line = 58)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lwea;)V", line = 84)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IIIB)V", line = 93)
    ...
    @OriginalMember(owner = "client!qb", name = "d", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(BI)V", line = 592)
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(FIFF)F", line = 604)
