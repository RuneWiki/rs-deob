...
public class class237 extends class512 {
    ...
    @OriginalMember(owner = "client!qb", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lee;II[B)V", line = 22)
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lee;II[I)V", line = 34)
    public class237(class703 arg0, int arg1, int arg2, int[] arg3) {
        this.field3156 = arg0.method3856(false, arg2, arg1, arg3, false);
        this.field3156.method622(true, false, false);
    }

    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(III)B", line = 47)
