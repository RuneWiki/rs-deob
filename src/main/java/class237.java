...
public class class237 extends class189 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIBILtm;Lrg;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dg", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 59)
    ...
    @OriginalMember(owner = "client!dg", name = "f", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!dg", name = "g", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 98)
    public class237(Object arg0) {
        this.field3224 = arg0;
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "([IILie;IIZI[IIIIIIII)I", line = 109)
    ...
    @OriginalMember(owner = "client!dg", name = "d", descriptor = "(I)Z", line = 281)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILrg;Ljava/lang/String;)Ljava/lang/String;", line = 292)
    ...
    @OriginalMember(owner = "client!dg", name = "h", descriptor = "(I)V", line = 380)
