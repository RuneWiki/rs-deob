...
public class class237 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IJ)Lpp;")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(JILpp;)V")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(II[Lkp;IZI)V")
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)Lpp;")
