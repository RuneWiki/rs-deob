...
public class class237 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ZZ)V", line = 20)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IB)Lei;", line = 60)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "(IB)V", line = 95)
    ...
    @OriginalMember(owner = "client!oba", name = "c", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!oba", name = "d", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(III)Les;", line = 147)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(IC)Z", line = 155)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(BI)V", line = 199)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Ldd;IZLpj;Lpj;)V", line = 248)
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(ILe;ZLjava/awt/Canvas;)Loa;", line = 220)
