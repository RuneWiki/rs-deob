...
public abstract class class237 extends class198 {
    ...
    @OriginalMember(owner = "client!lba", name = "d", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!lba", name = "a", descriptor = "(IIIBLqa;IIIIIII[[[B)V", line = 21)
    ...
    @OriginalMember(owner = "client!lba", name = "f", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!lba", name = "<init>", descriptor = "(IIIIIIIIZB)V", line = 83)
