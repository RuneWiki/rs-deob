...
public class class237 implements class311 {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)[Lbd;", line = 34)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IIB)V", line = 45)
    ...
    @OriginalMember(owner = "client!jj", name = "b", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(III)V", line = 90)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZIFIIIBI)[I", line = 118)
    ...
    @OriginalMember(owner = "client!jj", name = "c", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(ZI)I", line = 172)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)I", line = 214)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(BI)I", line = 226)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IBI)V", line = 252)
