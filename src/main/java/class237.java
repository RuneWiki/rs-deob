...
public class class237 extends class397 {
    ...
    @OriginalMember(owner = "client!vk", name = "<init>", descriptor = "()V", line = 3)
    public class237() {
        super(0, true);
    }

    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(II)[I", line = 11)
    public final int[] method31(int arg0, int arg1) {
        field3320++;
        return arg0 == -780833076 ? class228.field3210 : null;
    }

    @OriginalMember(owner = "client!vk", name = "e", descriptor = "(B)V", line = 23)
