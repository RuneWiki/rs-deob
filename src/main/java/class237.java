...
public class class237 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lgk;I)V", line = 57)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZIII[[[Lms;I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ILjava/lang/String;)Z", line = 398)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(II)Ljava/lang/String;", line = 429)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)V", line = 454)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Lgk;II)V", line = 464)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "()V", line = 521)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(Lgk;I)Lqj;", line = 616)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(II)I", line = 628)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 651)
