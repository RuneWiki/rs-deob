...
public class class237 {
    ...
    @OriginalMember(owner = "client!oba", name = "a", descriptor = "()[B", line = 6)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "(Lac;)V", line = 81)
    ...
    @OriginalMember(owner = "client!oba", name = "<init>", descriptor = "()V", line = 149)
    private class237() {
    }

    @OriginalMember(owner = "client!oba", name = "a", descriptor = "(Lsea;II)Loba;", line = 73)
    ...
    @OriginalMember(owner = "client!oba", name = "b", descriptor = "()Lbu;", line = 103)
    ...
    @OriginalMember(owner = "client!oba", name = "c", descriptor = "()I", line = 108)
