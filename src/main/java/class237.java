...
public class class237 {
    ...
    @OriginalMember(owner = "client!tea", name = "a", descriptor = "(ILda;ILdm;IILjava/lang/String;BILfp;ILaa;)V")
    ...
    @OriginalMember(owner = "client!tea", name = "<init>", descriptor = "(Leea;II)V")
