...
public class class237 extends class245 {
    ...
    @OriginalMember(owner = "client!ak", name = "f", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!ak", name = "h", descriptor = "(I)J", line = 18)
    public final long method1568(int arg0) {
        return arg0 == -14188 ? this.field3349 : 40L;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(I)I", line = 28)
    ...
    @OriginalMember(owner = "client!ak", name = "g", descriptor = "(I)I", line = 39)
    public final int method1570(int arg0) {
        return arg0 == 3 ? this.field3345 : 12;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)I", line = 49)
