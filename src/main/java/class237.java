...
public class class237 extends class188 implements MouseListener, MouseMotionListener, MouseWheelListener {
    ...
    @OriginalMember(owner = "client!rq", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    ...
    @OriginalMember(owner = "client!rq", name = "d", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!rq", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 37)
    public final synchronized void mouseExited(MouseEvent arg0) {
        this.field3450 = -1;
        this.field3448 = -1;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Z)I", line = 47)
    public final int method1192(boolean arg0) {
        return arg0 ? this.field3445 : 87;
    }

    @OriginalMember(owner = "client!rq", name = "f", descriptor = "(I)V", line = 58)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;I)V", line = 80)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(B)Z", line = 99)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(I)I", line = 109)
    ...
    @OriginalMember(owner = "client!rq", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 120)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        this.method1460(arg0, -12127);
    }

    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(Ljava/awt/event/MouseEvent;I)I", line = 133)
    ...
    @OriginalMember(owner = "client!rq", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 168)
    ...
    @OriginalMember(owner = "client!rq", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 194)
    ...
    @OriginalMember(owner = "client!rq", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 328)
    public class237(Component arg0, boolean arg1) {
        this.method1463(arg0, (byte) -15);
        this.field3453 = arg1;
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(B)V", line = 209)
    ...
    @OriginalMember(owner = "client!rq", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 220)
    ...
    @OriginalMember(owner = "client!rq", name = "c", descriptor = "(I)Lke;", line = 245)
    ...
    @OriginalMember(owner = "client!rq", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 256)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method1460(arg0, -12127);
    }

    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(IIIZI)V", line = 264)
    ...
    @OriginalMember(owner = "client!rq", name = "a", descriptor = "(Ljava/awt/Component;B)V", line = 281)
    ...
    @OriginalMember(owner = "client!rq", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 296)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        this.method1460(arg0, -12127);
    }

    @OriginalMember(owner = "client!rq", name = "e", descriptor = "(I)Z", line = 303)
    ...
    @OriginalMember(owner = "client!rq", name = "b", descriptor = "(B)Z", line = 317)
