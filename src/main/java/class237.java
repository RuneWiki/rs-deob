...
public class class237 {
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(ZIIIIILoa;ILba;IIIIILcu;)Lba;", line = 3)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "([BIZII)Z", line = 215)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(Lnh;I)I", line = 334)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I[BII)Z", line = 369)
    ...
    @OriginalMember(owner = "client!kf", name = "<init>", descriptor = "(ILps;Lps;I)V", line = 448)
    ...
    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(I)V", line = 405)
    ...
    @OriginalMember(owner = "client!kf", name = "toString", descriptor = "()Ljava/lang/String;", line = 418)
    public final String toString() {
        field3059++;
        return "Cache:" + this.field3056;
    }

    @OriginalMember(owner = "client!kf", name = "a", descriptor = "(II)[B", line = 461)
