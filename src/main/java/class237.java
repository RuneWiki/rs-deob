...
public class class237 implements class335 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Lai;[Let;I)Ljfa;", line = 37)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)J", line = 126)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(Lon;Z)Z", line = 156)
