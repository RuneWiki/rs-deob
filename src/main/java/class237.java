...
public class class237 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)Lok;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Ltj;Lvc;Lam;ILvc;IZIIIZI)Lrn;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ILvc;ILtj;IBII)Lrn;")
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZIZZI)Lnl;")
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Llo;IZLjo;Lnl;Lnl;)V")
