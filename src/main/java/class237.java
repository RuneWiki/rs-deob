...
public class class237 extends class29 {
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!dg", name = "e", descriptor = "()Z", line = 18)
    public final boolean method1620() {
        return this.field361.field1969 && this.field361.field1988 && this.field361.field1953;
    }

    @OriginalMember(owner = "client!dg", name = "c", descriptor = "()I", line = 28)
    public final int method159() {
        return 1;
    }

    @OriginalMember(owner = "client!dg", name = "d", descriptor = "()Z", line = 35)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILhf;Lhf;)V", line = 78)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "()Z", line = 225)
    public final boolean method157() {
        return this.field3473 != null;
    }

    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "(Lig;)V", line = 233)
    public class237(class132 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(II)V", line = 237)
