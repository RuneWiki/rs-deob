...
public class class237 implements Runnable {
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ltv;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "()V", line = 26)
    public class237() {
        this.field3498.setDaemon(true);
        this.field3498.start();
    }

    @OriginalMember(owner = "client!jj", name = "run", descriptor = "()V", line = 40)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(Ljava/lang/String;I)Lso;", line = 94)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(I)V", line = 122)
