...
public class class237 {
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIILqo;BI)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(IIIBI)Lpca;")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(ZLvo;ZII)V")
    ...
    @OriginalMember(owner = "client!dh", name = "a", descriptor = "(Ldh;B)V")
