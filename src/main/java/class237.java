...
public class class237 {
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ILo;)V")
    ...
    @OriginalMember(owner = "client!mn", name = "a", descriptor = "(ZI)Ltg;")
    ...
    @OriginalMember(owner = "client!mn", name = "<init>", descriptor = "(Lcm;ILlt;)V")
