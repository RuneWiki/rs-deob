...
public class class237 extends class13 {
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ZI)[I", line = 4)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Z)V", line = 213)
    ...
    @OriginalMember(owner = "client!dg", name = "e", descriptor = "(B)V", line = 240)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIIIZ)V", line = 263)
    ...
    @OriginalMember(owner = "client!dg", name = "d", descriptor = "(I)V", line = 397)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(Lkh;BI)V", line = 422)
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "()V", line = 526)
    public class237() {
        super(0, true);
    }

    @OriginalMember(owner = "client!dg", name = "e", descriptor = "(I)V", line = 516)
    ...
    @OriginalMember(owner = "client!dg", name = "f", descriptor = "(I)V", line = 546)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)V", line = 557)
