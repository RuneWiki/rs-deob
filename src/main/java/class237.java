...
public class class237 {
    ...
    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(I)V", line = 78)
    public class237(int arg0) {
        this.field2799 = arg0;
    }

    @OriginalMember(owner = "client!bea", name = "<init>", descriptor = "(IIIIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(BLbea;)V", line = 9)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(I)Lbea;", line = 31)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(II)Lmd;", line = 46)
    ...
    @OriginalMember(owner = "client!bea", name = "a", descriptor = "(B)V", line = 59)
