...
public class class237 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(JZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IBZIZ)V", line = 103)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(ZLrd;)V", line = 176)
