...
public class class237 extends class405 {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kd", name = "c", descriptor = "(B)V", line = 14)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(IIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!kd", name = "b", descriptor = "(III)Luj;", line = 146)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(FZ)V", line = 154)
    ...
    @OriginalMember(owner = "client!kd", name = "a", descriptor = "(BIII)V", line = 166)
    ...
    @OriginalMember(owner = "client!kd", name = "<init>", descriptor = "(IIIIIF)V", line = 178)
