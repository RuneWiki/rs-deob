...
public class class237 extends class476 {
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILjava/lang/String;IIZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!ti", name = "a", descriptor = "(ILbn;)Z", line = 128)
    ...
    @OriginalMember(owner = "client!ti", name = "b", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!ti", name = "<init>", descriptor = "(I)V", line = 184)
