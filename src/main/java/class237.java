...
public class class237 extends class210 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IZI)B", line = 5)
    ...
    @OriginalMember(owner = "client!oe", name = "c", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!oe", name = "b", descriptor = "(IZI)V", line = 33)
    ...
    @OriginalMember(owner = "client!oe", name = "<init>", descriptor = "()V", line = 55)
    public class237() {
        super(0, true);
    }

    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(IB)[I", line = 58)
    ...
    @OriginalMember(owner = "client!oe", name = "d", descriptor = "(III)I", line = 91)
