...
public class class162 extends class786 {
    ...
    @OriginalMember(owner = "client!ib", name = "c", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!ib", name = "b", descriptor = "(B)Lak;", line = 30)
    public final class367 method1274(byte arg0) {
        ++field2381;
        return arg0 != -120 ? null : class10.field228[super.field10804];
    }

    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(II)S", line = 42)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(ILli;IIIILli;III)V", line = 70)
