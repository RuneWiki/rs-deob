...
public class class162 extends class424 {
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(II)Z", line = 17)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(B)Z", line = 39)
    ...
    @OriginalMember(owner = "client!cr", name = "a", descriptor = "(I)I", line = 52)
    ...
    @OriginalMember(owner = "client!cr", name = "b", descriptor = "(I)Z", line = 65)
    ...
    @OriginalMember(owner = "client!cr", name = "c", descriptor = "(I)Z", line = 76)
    ...
    @OriginalMember(owner = "client!cr", name = "<init>", descriptor = "(II)V", line = 98)
