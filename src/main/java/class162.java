...
public class class162 extends class256 {
    ...
    @OriginalMember(owner = "client!ada", name = "<init>", descriptor = "(Ljg;Ljha;IIIIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(I)Ljw;", line = 21)
    public final class551 method930(int arg0) {
        field2399++;
        return arg0 == 17503 ? class601.field8731 : null;
    }

    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IIIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(IILha;)V", line = 59)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(Lvg;II)V", line = 167)
    ...
    @OriginalMember(owner = "client!ada", name = "a", descriptor = "(B)V", line = 198)
