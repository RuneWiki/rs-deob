...
public class class162 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Ltb;[Li;)Ltf;", line = 11)
    ...
    @OriginalMember(owner = "client!tf", name = "finalize", descriptor = "()V", line = 69)
    protected final void finalize() throws Throwable {
        this.field2252.method1576(this.field2251);
        super.finalize();
    }

    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Ltb;I[Li;)V", line = 73)
