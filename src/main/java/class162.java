...
public class class162 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IIIIBI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)V", line = 25)
    public static void method1003(int arg0) {
        int var1 = 5 / ((arg0 + 66) / 43);
        field1804 = null;
    }

    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Lig;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(BLig;)V", line = 56)
