...
public class class162 {
    ...
    @OriginalMember(owner = "client!re", name = "b", descriptor = "Llf;")
    public static class109 field3029 = class35.method275("Verbindung mit Update)2Server)3)3)3", 2);

    @OriginalMember(owner = "client!re", name = "a", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "([BI)Ldb;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIBLbg;)Lkf;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lbg;II)Lkf;")
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Llf;I)V")
