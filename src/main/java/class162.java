...
public class class162 extends class40 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BI)[I", line = 6)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lvq;Z)V", line = 62)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "()V", line = 113)
    public class162() {
        super(1, true);
    }
}
