...
public class class162 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IILjava/lang/String;IIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(IBI)Lgs;", line = 28)
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(I)V", line = 71)
