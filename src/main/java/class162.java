...
public class class162 extends class431 {
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Lkn;)V", line = 78)
    public class162(class523 arg0) {
        this.field2404 = arg0;
    }

    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(III)Z", line = 47)
