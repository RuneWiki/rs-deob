...
public class class162 {
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(Lek;)V", line = 8)
    ...
    @OriginalMember(owner = "client!rc", name = "b", descriptor = "(Lek;)V", line = 24)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!rc", name = "a", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!rc", name = "<init>", descriptor = "()V", line = 56)
    public class162() {
        this.field2645[0] = 0;
