...
public class class162 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lst;Lst;II)Llv;", line = 81)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)I", line = 93)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lvn;Lvl;)V", line = 184)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(ZIZII)Lfs;", line = 204)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lst;ZBILst;)Llv;", line = 233)
