...
public class class162 extends class509 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(BILin;)V")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(ILfh;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(IILfi;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Ltt;Lmm;)V")
