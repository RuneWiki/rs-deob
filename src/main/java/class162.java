...
public class class162 implements class262 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!sia", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(ZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lei;)V", line = 61)
