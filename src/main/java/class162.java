...
public class class162 extends class488 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IBIIIII)I", line = 3)
    ...
    @OriginalMember(owner = "client!or", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 34)
    public final synchronized void keyReleased(KeyEvent arg0) {
        field2243++;
        this.method1098(1, arg0, (byte) 60);
    }

    @OriginalMember(owner = "client!or", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 46)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/awt/Component;)V", line = 64)
    ...
    @OriginalMember(owner = "client!or", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 88)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method1101(0, '\u0000', -1, -1);
        field2230++;
    }

    @OriginalMember(owner = "client!or", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 96)
    public final synchronized void keyPressed(KeyEvent arg0) {
        field2249++;
        this.method1098(0, arg0, (byte) 68);
    }

    @OriginalMember(owner = "client!or", name = "c", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ILjava/awt/event/KeyEvent;B)V", line = 157)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 325)
    public class162(Component arg0) {
        class49.method355(58);
        this.method1096(-27309, arg0);
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I)Lvm;", line = 195)
    ...
    @OriginalMember(owner = "client!or", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 223)
    public final void focusGained(FocusEvent arg0) {
        field2238++;
    }

    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ZI)Z", line = 230)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(ICII)V", line = 246)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(I)V", line = 269)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(I)V", line = 312)
