...
public class class162 extends class52 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(FFFFFFLpa;II)V")
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IILpa;II)V")
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lmh;IIII)V")
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "(Lmh;II[III)V")
