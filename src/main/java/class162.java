...
public class class162 {
    ...
    @OriginalMember(owner = "client!gb", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field2131++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lrj;I)[Lro;", line = 35)
