...
public class class162 implements class309 {
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ILuk;)Z")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BIIIIII)Lts;")
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(BLa;Lwo;Lwo;Lwo;)Z")
