...
public class class162 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(I)V", line = 35)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(I)Lto;", line = 931)
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(B)V", line = 958)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IZ)Llda;", line = 972)
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "(I)Lvi;", line = 1003)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lgp;ILuu;)V", line = 1035)
