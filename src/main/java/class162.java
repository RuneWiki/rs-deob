...
public class class162 extends class326 {
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(ILbt;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!jl", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!jl", name = "a", descriptor = "(IIIIIIILur;Lvi;Lkf;Ljava/lang/String;Lnk;)V", line = 85)
