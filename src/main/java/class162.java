...
public class class162 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ILkk;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BZ)V", line = 307)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(ZLkk;)V", line = 377)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 427)
