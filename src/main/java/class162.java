...
public class class162 extends class227 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!bj", name = "j", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 95)
    public class162() {
        super(1, true);
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lug;II)V", line = 99)
    ...
    @OriginalMember(owner = "client!bj", name = "k", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!bj", name = "e", descriptor = "(I)V", line = 603)
    ...
    @OriginalMember(owner = "client!bj", name = "l", descriptor = "(I)Lql;", line = 614)
    ...
    @OriginalMember(owner = "client!bj", name = "m", descriptor = "(I)V", line = 642)
