...
public class class162 {
    ...
    @OriginalMember(owner = "client!qg", name = "a", descriptor = "(Lks;ILjava/lang/String;)Lqg;", line = 4)
    ...
    @OriginalMember(owner = "client!qg", name = "finalize", descriptor = "()V", line = 43)
    protected final void finalize() throws Throwable {
        this.field2154.method1153(this.field2155);
        super.finalize();
    }

    @OriginalMember(owner = "client!qg", name = "<init>", descriptor = "(Lks;II)V", line = 47)
