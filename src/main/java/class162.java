...
public class class162 implements class535 {
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(B)Lbja;")
    public final class34 method603(byte arg0) {
        return arg0 >= -65 ? (class34) null : this.field2576;
    }

    @OriginalMember(owner = "client!as", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lta;Lbja;Z)V")
