...
public class class162 {
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lgf;B)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Lrs;IIIII)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(BLvl;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(ILvl;)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Ljava/lang/Object;BLvl;I)V")
    ...
    @OriginalMember(owner = "client!uk", name = "a", descriptor = "(Ljava/lang/Object;ILvl;)V")
