...
public class class162 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIIIIIIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIII)Z", line = 51)
    ...
    @OriginalMember(owner = "client!vg", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 76)
