...
public class class162 {
    ...
    @OriginalMember(owner = "client!ei", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field2740++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 32)
