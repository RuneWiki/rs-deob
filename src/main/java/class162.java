...
public class class162 extends class54 {
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(IB)I", line = 5)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(Z)I", line = 29)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Z)V", line = 44)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(Lhia;)V", line = 55)
    public class162(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!as", name = "c", descriptor = "(Z)I", line = 61)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(ILcn;Lfs;ZILaa;II)V", line = 74)
    ...
    @OriginalMember(owner = "client!as", name = "<init>", descriptor = "(ILhia;)V", line = 118)
