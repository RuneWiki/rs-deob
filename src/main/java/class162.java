...
public class class162 implements class91 {
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Lrc;IB)V")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(Loa;Lep;Z)V")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(BLkp;II)V")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IILkp;)V")
    public final void method984(int arg0, int arg1, class446 arg2) {
        field1923++;
        this.method979((byte) -27, arg2, arg0, arg1);
    }

    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(ILng;IZ)V")
    ...
    @OriginalMember(owner = "client!ei", name = "a", descriptor = "(IIILng;I)V")
    ...
    @OriginalMember(owner = "client!ei", name = "<init>", descriptor = "(Lap;)V")
