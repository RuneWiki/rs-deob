...
public class class162 extends class184 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)V", line = 33)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Ljava/util/Random;II)I", line = 45)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IZII)V", line = 76)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lcs;B)I", line = 103)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Llw;IIIII)V", line = 482)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIFB)V", line = 178)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I[II)V", line = 298)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(II)V", line = 457)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(III)V", line = 467)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 503)
