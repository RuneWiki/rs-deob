...
public class class162 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)Lop;", line = 56)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ZI)V", line = 90)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(Lrga;ILni;Lni;)V", line = 115)
