...
public class class162 {
    ...
    @OriginalMember(owner = "client!se", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field2239++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(BI)I", line = 30)
    ...
    @OriginalMember(owner = "client!se", name = "a", descriptor = "(I[BLjava/io/File;I)V", line = 63)
    ...
    @OriginalMember(owner = "client!se", name = "<init>", descriptor = "(II)V", line = 81)
    public class162(int arg0, int arg1) {
        this.field2237 = arg0;
    }

    @OriginalMember(owner = "client!se", name = "a", descriptor = "(B)V", line = 92)
