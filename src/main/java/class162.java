...
public abstract class class162 {
    ...
    @OriginalMember(owner = "client!qa", name = "finalize", descriptor = "()V", line = 11)
    protected void finalize() {
        this.method1001((byte) -126);
        field2301++;
    }

    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLjava/lang/String;)J", line = 20)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(BLjava/lang/Throwable;Ljava/lang/String;)V", line = 102)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(B)V", line = 177)
    ...
    @OriginalMember(owner = "client!qa", name = "b", descriptor = "(IIIII)V", line = 206)
    ...
    @OriginalMember(owner = "client!qa", name = "d", descriptor = "(IIIIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(ILkj;ILjava/awt/Canvas;ILm;)Lqa;", line = 237)
    ...
    @OriginalMember(owner = "client!qa", name = "<init>", descriptor = "(ILm;)V", line = 292)
    public class162(int arg0, class126 arg1) {
        this.field2312 = arg1;
        this.field2310 = arg0;
    }

    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(II)I", line = 317)
    ...
    @OriginalMember(owner = "client!qa", name = "e", descriptor = "(IIIIII)V", line = 353)
    ...
    @OriginalMember(owner = "client!qa", name = "g", descriptor = "(I)V", line = 374)
    ...
    @OriginalMember(owner = "client!qa", name = "a", descriptor = "(IBIIII)V", line = 389)
    ...
    @OriginalMember(owner = "client!qa", name = "c", descriptor = "(IIIII)V", line = 402)
