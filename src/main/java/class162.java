...
public class class162 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I)Ljm;", line = 3)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)Z", line = 27)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(I[II)Leg;", line = 56)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II[IZ)Leg;", line = 80)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I[II)Leg;", line = 134)
    ...
    @OriginalMember(owner = "client!tf", name = "b", descriptor = "(I)I", line = 153)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(BLpn;)V", line = 170)
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III[I)Leg;", line = 224)
    ...
    @OriginalMember(owner = "client!tf", name = "d", descriptor = "(I)V", line = 265)
    ...
    @OriginalMember(owner = "client!tf", name = "<init>", descriptor = "(Lqj;Lqj;)V", line = 315)
