...
public class class162 extends class478 {
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(Ljava/awt/Component;Z)Lwi;")
    ...
    @OriginalMember(owner = "client!un", name = "a", descriptor = "(ILnp;I)V")
    ...
    @OriginalMember(owner = "client!un", name = "c", descriptor = "(I)Lpj;")
