...
public class class162 extends class532 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IILua;II)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(FFFFFFILua;II)V")
    ...
    @OriginalMember(owner = "client!af", name = "d", descriptor = "(II)Lrb;")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lag;IIZ)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lag;IIII)V")
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lag;II[III)V")
