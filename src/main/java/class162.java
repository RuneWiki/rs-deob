...
public class class162 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(B)Lvi;", line = 3)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Ljm;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ILvi;)V", line = 36)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(B)Lvi;", line = 57)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lvi;ZLjm;)V", line = 78)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Z)Lvi;", line = 102)
    ...
    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(I)Z", line = 136)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lvi;Z)V", line = 181)
    ...
    @OriginalMember(owner = "client!jm", name = "b", descriptor = "(Z)I", line = 199)
    ...
    @OriginalMember(owner = "client!jm", name = "<init>", descriptor = "()V", line = 288)
    public class162() {
        this.field2296.field4225 = this.field2296;
        this.field2296.field4223 = this.field2296;
    }

    @OriginalMember(owner = "client!jm", name = "c", descriptor = "(I)Lvi;", line = 230)
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(ZBI)I", line = 253)
    ...
    @OriginalMember(owner = "client!jm", name = "d", descriptor = "(I)Lvi;", line = 303)
