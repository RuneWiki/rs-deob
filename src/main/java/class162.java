...
public class class162 extends class161 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(IIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 50)
    ...
    @OriginalMember(owner = "client!eo", name = "b", descriptor = "(B)V", line = 65)
