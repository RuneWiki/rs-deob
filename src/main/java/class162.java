...
public class class162 extends class361 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLjava/awt/Component;)Ldf;", line = 5)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!dt", name = "g", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(Z)I", line = 65)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(II)V", line = 155)
    ...
    @OriginalMember(owner = "client!dt", name = "h", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BLwm;I)V", line = 228)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZLwm;)V", line = 292)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(BC)I", line = 313)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(CI)I", line = 354)
