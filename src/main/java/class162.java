...
public class class162 extends class276 {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 36)
    ...
    @OriginalMember(owner = "client!pl", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIIJIIZZ)V", line = 101)
