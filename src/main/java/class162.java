...
public class class162 {
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(IBIIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(Z)V", line = 26)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(BLm;Lm;)V", line = 53)
    ...
    @OriginalMember(owner = "client!pha", name = "a", descriptor = "(B)V", line = 73)
