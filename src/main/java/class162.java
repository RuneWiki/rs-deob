...
public class class162 extends class126 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(BLqa;Lm;)V")
    ...
    @OriginalMember(owner = "client!pl", name = "d", descriptor = "(I)Luj;")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(Lho;I)V")
    ...
    @OriginalMember(owner = "client!pl", name = "a", descriptor = "(ILwq;IIIIIIZIII)Z")
