...
public class class162 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)Lie;", line = 4)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)Lie;", line = 24)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILps;)V", line = 47)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 59)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "()V", line = 83)
    public class162() {
    }

    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lps;)V", line = 93)
