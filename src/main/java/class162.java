...
public class class162 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(IIBLria;)V", line = 53)
