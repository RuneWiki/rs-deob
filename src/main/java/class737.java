...
public class class737 extends class187 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Lfe;Z)Z")
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(Lhk;Lol;)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IBLqk;)V")
