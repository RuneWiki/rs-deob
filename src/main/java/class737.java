...
public class class737 extends class460 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lph;")
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lrda;IIII)V")
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lrda;IIIII)V")
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lrda;IIIIZ[IIIZ)V")
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lrda;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!sia", name = "<init>", descriptor = "(Lrda;IIIIZ[FI)V")
