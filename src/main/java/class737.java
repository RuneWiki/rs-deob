...
public class class737 {
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lmc;[BZ)V", line = 12)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 53)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Z[B)[B", line = 104)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(III)V", line = 136)
