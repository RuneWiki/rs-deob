...
public abstract class class737 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(Ldga;I[[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IBI)Z", line = 53)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIBIIII)Ldn;", line = 70)
