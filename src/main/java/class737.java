...
public class class737 extends class294 {
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(IIILhe;Lhe;)V")
    ...
    @OriginalMember(owner = "client!sia", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!sia", name = "a", descriptor = "(Llk;I)V")
