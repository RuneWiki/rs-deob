...
public class class737 extends class299 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(IZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(ILes;)V", line = 16)
    public class737(int arg0, class404 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(I)I", line = 39)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(BIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(B)V", line = 69)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(II)I", line = 81)
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(III)V", line = 92)
    ...
    @OriginalMember(owner = "client!pw", name = "b", descriptor = "(Z)I", line = 117)
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Les;)V", line = 132)
