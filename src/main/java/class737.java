...
public class class737 implements Runnable {
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Lsf;III)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Ldn;I)V")
    ...
    @OriginalMember(owner = "client!mga", name = "a", descriptor = "(Ljava/lang/String;I)Lle;")
