...
public class class737 extends class164 {
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lfp;Lfp;Luha;)V", line = 21)
    public class737(class323 arg0, class323 arg1, class242 arg2) {
        super(arg0, arg1, arg2);
    }

    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIZB)V", line = 33)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZIJBIILfp;)V", line = 52)
    ...
    @OriginalMember(owner = "client!ob", name = "d", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ZIBI)V", line = 84)
