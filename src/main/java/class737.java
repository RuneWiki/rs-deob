...
public class class737 extends class429 {
    ...
    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(FIFIF[BIIBIIFFLlt;)V")
    ...
    @OriginalMember(owner = "client!oda", name = "h", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!oda", name = "<init>", descriptor = "(Lmj;)V")
    public class737(class114 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!oda", name = "a", descriptor = "(Len;ZI)V")
