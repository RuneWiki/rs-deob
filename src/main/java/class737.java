...
public class class737 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IBILjava/lang/Object;)[B", line = 31)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lmaa;)V", line = 80)
