...
public class class216 extends class613 implements class484 {
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lha;I)Lmaa;")
    ...
    @OriginalMember(owner = "client!sa", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZLje;IIILha;I)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!sa", name = "l", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(Lvn;Z)V")
    ...
    @OriginalMember(owner = "client!sa", name = "b", descriptor = "(Lha;I)Lrn;")
    ...
    @OriginalMember(owner = "client!sa", name = "c", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ZLmi;)V")
    ...
    @OriginalMember(owner = "client!sa", name = "a", descriptor = "(ILha;)V")
