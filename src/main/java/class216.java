...
public class class216 extends class31 implements class349 {
    ...
    @OriginalMember(owner = "client!sba", name = "<init>", descriptor = "(Lhl;Lwd;III[B)V", line = 3)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(Lqo;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!sba", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!sba", name = "b", descriptor = "(Z)Ljagdx/IDirect3DBaseTexture;", line = 97)
