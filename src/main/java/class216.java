...
public class class216 extends class56 implements class92 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Ljh;")
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILqs;IB)Lqm;")
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Lih;ILjaggl/memory/NativeBuffer;)V")
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Lih;I[BI)V")
