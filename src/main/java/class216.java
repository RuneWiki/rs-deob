...
public class class216 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lbg;I)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lbg;ILjava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILlk;)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lbg;B)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILjava/lang/Object;Lbg;)V")
