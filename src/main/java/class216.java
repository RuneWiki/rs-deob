...
public class class216 extends class146 implements class46 {
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lbv;ILjaggl/memory/NativeBuffer;IZ)V")
    ...
    @OriginalMember(owner = "client!hc", name = "<init>", descriptor = "(Lbv;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ILjb;B)I")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(ZZLhu;ZLjava/lang/String;)V")
