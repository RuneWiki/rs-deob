...
public class class216 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B)Llt;", line = 4)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(B[IIZLjaa;I)Lhq;", line = 22)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!jd", name = "toString", descriptor = "()Ljava/lang/String;", line = 56)
    public final String toString() {
        field2532++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(II)V", line = 74)
