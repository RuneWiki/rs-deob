...
public class class216 {
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ILjfa;)Lat;")
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Lri;Lri;)V")
    public class216(class97 arg0, class97 arg1) {
        this.field3554 = arg0;
        this.field3557 = arg1;
    }

    @OriginalMember(owner = "client!ida", name = "b", descriptor = "(I)Lpa;")
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ILpn;BLqg;)V")
