...
public class class216 extends class392 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(II)I", line = 20)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Lw;)V", line = 35)
    public class216(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(III)Z", line = 48)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(II[Ljava/awt/Rectangle;)V", line = 60)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(ILw;)V", line = 81)
    public class216(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(Z)V", line = 85)
    ...
    @OriginalMember(owner = "client!afa", name = "b", descriptor = "(I)Z", line = 104)
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(Z)I", line = 119)
    ...
    @OriginalMember(owner = "client!afa", name = "c", descriptor = "(I)I", line = 145)
