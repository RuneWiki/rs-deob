...
public class class216 {
    ...
    @OriginalMember(owner = "client!pc", name = "finalize", descriptor = "()V", line = 4)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!pc", name = "a", descriptor = "(IIB)Z", line = 36)
    ...
    @OriginalMember(owner = "client!pc", name = "<init>", descriptor = "(Lpea;JI)V", line = 46)
