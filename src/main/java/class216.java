...
public class class216 {
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IIII)Z", line = 18)
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(ZII)V", line = 97)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 143)
