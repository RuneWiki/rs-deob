...
public class class216 {
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(B)Lvt;", line = 13)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILoj;Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!rr", name = "b", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(ZLws;)I", line = 90)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IILvt;)V", line = 161)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(Lvt;I)V", line = 180)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IB)V", line = 201)
    ...
    @OriginalMember(owner = "client!rr", name = "a", descriptor = "(IIIII)Z", line = 225)
