...
public class class216 extends class531 {
    ...
    @OriginalMember(owner = "client!tw", name = "b", descriptor = "(I)[B", line = 6)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "([BI)V", line = 19)
    ...
    @OriginalMember(owner = "client!tw", name = "a", descriptor = "(III)[B", line = 36)
