...
public class class216 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)Lta;", line = 3)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIILbn;II)V", line = 36)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Z)V", line = 60)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Leq;IIIILhn;)V", line = 74)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 125)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IIIZZ)Lhe;", line = 148)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(BI)V", line = 173)
    ...
    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(I)V", line = 185)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Lci;ILhe;)V", line = 200)
