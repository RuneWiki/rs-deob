...
public class class216 extends class306 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lvq;IIB)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(IILvq;)Lni;", line = 15)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lvq;Lni;I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ah", name = "c", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLvq;)Lbf;", line = 87)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(IIIIIIIIIII)V", line = 188)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(II)V", line = 120)
    ...
    @OriginalMember(owner = "client!ah", name = "d", descriptor = "(I)Z", line = 152)
    ...
    @OriginalMember(owner = "client!ah", name = "finalize", descriptor = "()V", line = 163)
    ...
    @OriginalMember(owner = "client!ah", name = "e", descriptor = "(I)I", line = 177)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(B)V", line = 220)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lvq;ZLkm;IIBI)V", line = 233)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Lvq;B)V", line = 270)
