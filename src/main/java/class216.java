...
public class class216 {
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Ldn;ILr;)V")
    ...
    @OriginalMember(owner = "client!km", name = "c", descriptor = "(II)Lla;")
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(ZLnh;I)V")
