...
public class class216 extends class578 {
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!gb", name = "<init>", descriptor = "(IIIIIII)V", line = 44)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ZLjava/lang/Object;I)[B", line = 85)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(BI)C", line = 127)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(Lwm;Z)[I", line = 175)
