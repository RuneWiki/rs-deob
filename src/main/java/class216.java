...
public class class216 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(ILrv;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IBLrv;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IZLiw;)Z")
