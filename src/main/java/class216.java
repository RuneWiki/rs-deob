...
public class class216 extends class354 {
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(BI)[I", line = 5)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Lnj;II)V", line = 58)
    ...
    @OriginalMember(owner = "client!fp", name = "b", descriptor = "(Z)V", line = 78)
    ...
    @OriginalMember(owner = "client!fp", name = "<init>", descriptor = "()V", line = 93)
    public class216() {
        super(1, true);
    }
}
