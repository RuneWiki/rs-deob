...
public class class216 extends class162 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIIZ)Lf;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ltl;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II[I[I)Lea;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([Lc;Lpo;Lia;[Lvk;I)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(II[[I[[IIII)Lna;")
    ...
    @OriginalMember(owner = "client!js", name = "j", descriptor = "(ILea;II)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIIIF)Lkt;")
    public final class107 method1084(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        return null;
    }

    @OriginalMember(owner = "client!js", name = "b", descriptor = "(IIIIII)Ltl;")
    public final class436 method1065(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        return null;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lar;III)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([Lc;Lia;[Lvk;I)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lpo;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ll;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I[Lkt;)V")
    public final void method1068(int arg0, class107[] arg1) {
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)Ll;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/lang/Runnable;)Lpa;")
    ...
    @OriginalMember(owner = "client!js", name = "m", descriptor = "(Lia;)V")
    public final void method1082(class414 arg0) {
        this.field3133 = (class510) arg0;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lje;[Lgu;Z)Loa;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lgu;Z)Lf;")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(ILjava/awt/Canvas;Lm;)V")
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(ILm;)V")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "([IIIII)Lf;")
    ...
    @OriginalMember(owner = "client!js", name = "C", descriptor = "()Lia;")
    ...
    @OriginalMember(owner = "client!js", name = "x", descriptor = "()Lia;")
    public final class414 method1115() {
        class248 var1 = this.method1504(Thread.currentThread());
        return var1.field3638;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ltl;Ltl;FLtl;)Ltl;")
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Lqc;IIII)Lc;")
