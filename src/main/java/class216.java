...
public class class216 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(ILcg;)Z", line = 37)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(Lfd;)V", line = 524)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!wb", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(B)Z", line = 149)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(ILcg;)V", line = 283)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIIII)Z", line = 305)
    ...
    @OriginalMember(owner = "client!wb", name = "d", descriptor = "(I)Z", line = 358)
    ...
    @OriginalMember(owner = "client!wb", name = "b", descriptor = "(B)V", line = 378)
