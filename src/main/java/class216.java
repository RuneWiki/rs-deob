...
public abstract class class216 extends class501 {
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(I)V", line = 6)
    public class216(int arg0) {
        this.field3169 = arg0;
    }

    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IC)Z", line = 21)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(B)V", line = 41)
