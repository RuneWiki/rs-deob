...
public class class216 extends class360 {
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lnf;IIII)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lnf;IIIIZ[IZ)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIII[IIIZ)V")
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(IIII[BIIIZ)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lnf;IIIIZ[FI)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lnf;IIIIZ[BIZ)V")
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(Lnf;IIIII)V")
