...
public class class216 extends class309 {
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(III)Z", line = 6)
    ...
    @OriginalMember(owner = "client!lg", name = "c", descriptor = "(I)I", line = 23)
    ...
    @OriginalMember(owner = "client!lg", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 195)
