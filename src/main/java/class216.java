...
public class class216 {
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(ILuh;)V", line = 3)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Ltq;)V", line = 33)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)V", line = 121)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(BIIIIII)I", line = 132)
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)V", line = 165)
