...
public class class216 extends class611 {
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Ldv;[III)V", line = 14)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(II)I", line = 104)
    public static int method1308(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Lha;ILkha;)V", line = 154)
