...
public class class216 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 23)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZI)V", line = 39)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IB)Lfb;", line = 54)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BI)V", line = 131)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lob;I)Ljava/lang/String;", line = 149)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)V", line = 168)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lae;IZLqn;Lqn;)V", line = 202)
