...
public class class216 {
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BLkp;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BLkp;I)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(ILsn;I)V")
