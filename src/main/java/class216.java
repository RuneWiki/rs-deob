...
public class class216 implements Runnable {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IIIII)Ljk;", line = 7)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjava/lang/String;ZLjava/lang/String;)Ljava/io/File;", line = 20)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILjava/lang/Runnable;)Ljk;", line = 111)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjava/awt/Component;II)Ljk;", line = 121)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ZLjava/lang/Class;)Ljk;", line = 136)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjava/lang/String;)Ljk;", line = 146)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BI)Ljk;", line = 156)
    public final class446 method1357(byte arg0, int arg1) {
        return arg0 == -33 ? this.method1358(null, arg1, (byte) 102, 3, 0) : null;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/lang/Object;IBII)Ljk;", line = 171)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)Z", line = 201)
    public final boolean method1359(int arg0) {
        return arg0 != -5;
    }

    @OriginalMember(owner = "client!js", name = "b", descriptor = "(I)Ljk;", line = 216)
    public final class446 method1360(int arg0) {
        return arg0 == 0 ? this.method1358(null, 0, (byte) 102, 5, 0) : null;
    }

    @OriginalMember(owner = "client!js", name = "c", descriptor = "(I)V", line = 228)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjava/awt/Frame;)Ljk;", line = 239)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Z)Ljk;", line = 249)
    public final class446 method1363(boolean arg0) {
        return arg0 ? this.method1358(null, 0, (byte) 102, 18, 0) : null;
    }

    @OriginalMember(owner = "client!js", name = "run", descriptor = "()V", line = 259)
    ...
    @OriginalMember(owner = "client!js", name = "d", descriptor = "(I)V", line = 379)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(ILjava/lang/String;)Ljk;", line = 438)
    ...
    @OriginalMember(owner = "client!js", name = "c", descriptor = "(ILjava/lang/String;)Ljk;", line = 449)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;I)V", line = 695)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/net/URL;I)Ljk;", line = 463)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/lang/Class;B)Ljk;", line = 474)
    public final class446 method1368(Class arg0, byte arg1) {
        return arg1 == -27 ? this.method1358(arg0, 0, (byte) 102, 20, 0) : null;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Ljk;", line = 494)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/awt/Component;Ljava/awt/Point;[IIII)Ljk;", line = 507)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/lang/Object;IIBI)Ljk;", line = 517)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZLjava/awt/Component;)Ljk;", line = 563)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(BLjava/lang/String;)Ljava/io/File;", line = 578)
    ...
    @OriginalMember(owner = "client!js", name = "b", descriptor = "(Z)Lcq;", line = 590)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;Z)Ljk;", line = 600)
    public final class446 method1375(Transferable arg0, boolean arg1) {
        return arg1 ? null : this.method1358(arg0, 0, (byte) 102, 19, 0);
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IILjava/lang/String;)Ljk;", line = 611)
    public final class446 method1376(int arg0, int arg1, String arg2) {
        return arg0 == 1 ? this.method1358(arg2, arg1, (byte) 102, 1, 0) : null;
    }

    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;[Ljava/lang/Class;)Ljk;", line = 628)
    ...
    @OriginalMember(owner = "client!js", name = "d", descriptor = "(ILjava/lang/String;)[B", line = 641)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(ILjava/lang/Class;)V", line = 652)
