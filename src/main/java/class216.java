...
public class class216 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lgba;ZLjava/awt/Frame;)V")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(II)Lco;")
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lag;IIBII)Lck;")
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(ILga;Lga;)V")
