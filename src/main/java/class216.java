...
public class class216 {
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILkw;ZLjava/lang/String;)Lft;")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(ILsl;)Lwr;")
