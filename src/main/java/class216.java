...
public class class216 extends class338 {
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Lam;Z)I", line = 15)
    ...
    @OriginalMember(owner = "client!ir", name = "d", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ir", name = "a", descriptor = "(Z)V", line = 57)
    ...
    @OriginalMember(owner = "client!ir", name = "<init>", descriptor = "(I)V", line = 128)
