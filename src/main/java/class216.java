...
public class class216 extends class251 {
    ...
    @OriginalMember(owner = "client!gd", name = "d", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(Z)V", line = 48)
    public static final void method1330(boolean arg0) {
        field3337++;
        class279.field4243 = arg0;
    }

    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Lpu;)V", line = 58)
