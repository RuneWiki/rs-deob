...
public class class216 {
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "()I", line = 3)
    public final int method1472() {
        return this.field2987 - 1;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lpe;Ljava/lang/String;[IIIIZ)V", line = 7)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "()I", line = 29)
    public final int method1474() {
        return this.field2986;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lpe;Ljava/lang/String;IIIZ)V", line = 36)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Ljava/lang/String;)I", line = 56)
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lpe;IZLjava/awt/Component;)V", line = 176)
    ...
    @OriginalMember(owner = "client!ac", name = "c", descriptor = "()V", line = 77)
    public static void method1477() {
        field2992 = null;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(Lpe;Ljava/awt/Font;Ljava/awt/FontMetrics;CIZ)V", line = 88)
