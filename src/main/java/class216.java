...
public class class216 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)Lwk;", line = 4)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(IIILrj;)J", line = 34)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Z)V", line = 65)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(II)V", line = 123)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lph;I)I", line = 140)
    ...
    @OriginalMember(owner = "client!hs", name = "c", descriptor = "(II)Lrp;", line = 167)
    ...
    @OriginalMember(owner = "client!hs", name = "<init>", descriptor = "(Lkp;ILph;)V", line = 200)
