...
public class class393 {
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "([I[IBII)V", line = 6)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!gka", name = "a", descriptor = "(BI)V", line = 97)
