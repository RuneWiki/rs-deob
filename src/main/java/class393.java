...
public class class393 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(I)Ljd;", line = 6)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IIIB)I", line = 24)
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!hea", name = "<init>", descriptor = "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V", line = 91)
