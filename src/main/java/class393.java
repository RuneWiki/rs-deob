...
public class class393 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIZI)I", line = 3)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)Z", line = 35)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(II)Lfq;", line = 179)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lep;Ld;)V", line = 231)
    public class393(class371 arg0, class268 arg1) {
        this.field5470 = arg1;
        this.field5468 = arg0;
    }

    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(I)V", line = 253)
