...
public class class393 extends class7 implements class422 {
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lag;Laq;II[FII)V", line = 3)
    ...
    @OriginalMember(owner = "client!nq", name = "e", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(ZZZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!nq", name = "b", descriptor = "(B)I", line = 56)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(III)Z", line = 67)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lag;Laq;II[BII)V", line = 78)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 93)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lag;Laq;Lui;II)V", line = 140)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(III[IIIIZ)V", line = 151)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(FI)F", line = 175)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(FB)F", line = 186)
    ...
    @OriginalMember(owner = "client!nq", name = "f", descriptor = "(I)I", line = 199)
    ...
    @OriginalMember(owner = "client!nq", name = "<init>", descriptor = "(Lag;II[III)V", line = 215)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(II[BIIILaq;IB)V", line = 229)
    ...
    @OriginalMember(owner = "client!nq", name = "a", descriptor = "(I)I", line = 253)
