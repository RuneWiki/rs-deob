...
public class class393 extends class108 {
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(B)V", line = 10)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIIIFFLvo;IFII[BFF)V", line = 34)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(IIIII)I", line = 92)
    ...
    @OriginalMember(owner = "client!sg", name = "<init>", descriptor = "(I[B)V", line = 109)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(I)V", line = 168)
    ...
    @OriginalMember(owner = "client!sg", name = "a", descriptor = "(II)Z", line = 180)
