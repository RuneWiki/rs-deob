...
public class class393 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)Lhg;")
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(B)Lhg;")
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILhg;)V")
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(B)Lhg;")
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(I)Lhg;")
