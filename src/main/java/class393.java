...
public class class393 extends class401 {
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(ILlj;Ljava/lang/String;I)Lnj;", line = 7)
    ...
    @OriginalMember(owner = "client!li", name = "b", descriptor = "(Z)V", line = 34)
    ...
    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IILin;ZI)V", line = 50)
    ...
    @OriginalMember(owner = "client!li", name = "<init>", descriptor = "(Lqh;)V", line = 130)
    public class393(class61 arg0) {
        this.field5552 = arg0;
    }

    @OriginalMember(owner = "client!li", name = "a", descriptor = "(IIZII)I", line = 139)
