...
public abstract class class393 extends class130 {
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!n", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(Lfh;Z)Ljava/lang/String;", line = 50)
    public static final String method2472(class194 arg0, boolean arg1) {
        field5733++;
        return arg1 ? null : class162.method1157(32767, arg0, -99);
    }

    @OriginalMember(owner = "client!n", name = "f", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!n", name = "a", descriptor = "(BIIILwl;)V", line = 73)
