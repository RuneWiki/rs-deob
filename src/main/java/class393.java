...
public class class393 extends class283 {
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "()I", line = 7)
    public final int method1067() {
        return 0;
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "()Lkp;", line = 12)
    public final class283 method1066() {
        return (class283) this.field5897.method253((byte) -6);
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Lkp;)V", line = 15)
    public final synchronized void method2479(class283 arg0) {
        arg0.method1120(82);
    }

    @OriginalMember(owner = "client!pb", name = "e", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ltf;Ldb;)V", line = 29)
    ...
    @OriginalMember(owner = "client!pb", name = "d", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(Lkp;)V", line = 87)
    public final synchronized void method2482(class283 arg0) {
        this.field5897.method250(arg0, 27);
    }

    @OriginalMember(owner = "client!pb", name = "b", descriptor = "()Lkp;", line = 94)
    public final class283 method1064() {
        return (class283) this.field5897.method247((byte) -126);
    }

    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ldb;)V", line = 97)
    ...
    @OriginalMember(owner = "client!pb", name = "c", descriptor = "([III)V", line = 115)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "([III)V", line = 132)
    ...
    @OriginalMember(owner = "client!pb", name = "e", descriptor = "()V", line = 176)
