...
public class class393 extends class238 {
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lfp;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!ss", name = "a", descriptor = "(Lfu;)V", line = 34)
    ...
    @OriginalMember(owner = "client!ss", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!ss", name = "c", descriptor = "(I)V", line = 127)
