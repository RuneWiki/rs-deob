...
public class class393 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B)Leq;", line = 10)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(IIII)Lfi;", line = 27)
    ...
    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(B)V", line = 39)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(IIIIB)V", line = 54)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Lfi;I)V", line = 70)
