...
public class class393 extends class189 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ILfp;II)Lie;")
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(ZLee;)V")
    ...
    @OriginalMember(owner = "client!br", name = "<init>", descriptor = "(ZLvc;)V")
