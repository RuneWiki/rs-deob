...
public class class393 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(ILlk;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Llk;Z)V", line = 57)
