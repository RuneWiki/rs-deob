...
public class class393 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(BI)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 21)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)V", line = 77)
