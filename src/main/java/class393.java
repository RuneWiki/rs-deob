...
public class class393 {
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/lang/String;ILjava/applet/Applet;)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/applet/Applet;ILjava/lang/String;)V", line = 12)
    ...
    @OriginalMember(owner = "client!br", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;[Ljava/lang/Object;B)Ljava/lang/Object;", line = 24)
