...
public class class393 extends class40 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IILlf;)V", line = 7)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZZBII)V", line = 50)
    ...
    @OriginalMember(owner = "client!fk", name = "h", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "()V", line = 83)
    public class393() {
        super(1, false);
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ILvq;Ltj;)V", line = 87)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BI)[I", line = 112)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)[[I", line = 154)
    ...
    @OriginalMember(owner = "client!fk", name = "g", descriptor = "(B)V", line = 203)
