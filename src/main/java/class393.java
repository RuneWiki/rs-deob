...
public abstract class class393 {
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 4)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(II)Llp;", line = 22)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!pb", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!pb", name = "b", descriptor = "(II)V", line = 107)
