...
public class class393 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!wu", name = "b", descriptor = "(Z)V", line = 16)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lafa;Z)V", line = 222)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lvja;I)V", line = 234)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lgda;B)V", line = 257)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(B)Lqha;", line = 280)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 328)
    public class393(String arg0) {
        this.field5085 = arg0;
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lgda;I)V", line = 307)
