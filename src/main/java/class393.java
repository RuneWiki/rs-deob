...
public class class393 extends class489 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lr;)Lgu;", line = 4)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
