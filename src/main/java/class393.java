...
public class class393 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IIIIIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)V", line = 582)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I[BIZ)V", line = 603)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Z)Ljava/io/File;", line = 622)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I[BII)I", line = 634)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(IJ)V", line = 653)
    ...
    @OriginalMember(owner = "client!wr", name = "finalize", descriptor = "()V", line = 668)
    ...
    @OriginalMember(owner = "client!wr", name = "b", descriptor = "(B)J", line = 682)
    public final long method2533(byte arg0) throws IOException {
        field6017++;
        return arg0 < 5 ? -63L : this.field6011.length();
    }

    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 699)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(I)V", line = 731)
