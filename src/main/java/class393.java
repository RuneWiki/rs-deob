...
public class class393 extends class211 {
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "()V", line = 4)
    public class393() {
        super(1, false);
    }

    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(II)[[I", line = 14)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(BILib;)V", line = 82)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(Lcn;III)V", line = 117)
    ...
    @OriginalMember(owner = "client!mv", name = "b", descriptor = "(II)[I", line = 140)
