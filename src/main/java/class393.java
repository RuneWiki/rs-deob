...
public class class393 extends class601 {
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(II)V", line = 18)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IZI)V", line = 30)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(I)I", line = 41)
    ...
    @OriginalMember(owner = "client!ica", name = "a", descriptor = "(IB)I", line = 55)
    ...
    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(Lqea;)V", line = 66)
    public class393(class339 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ica", name = "<init>", descriptor = "(ILqea;)V", line = 69)
    public class393(int arg0, class339 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ica", name = "b", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!ica", name = "c", descriptor = "(I)V", line = 87)
