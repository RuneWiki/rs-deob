...
public class class393 extends class43 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lir;IIB)Ld;", line = 5)
    ...
    @OriginalMember(owner = "client!bk", name = "e", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!bk", name = "e", descriptor = "(B)Z", line = 32)
    ...
    @OriginalMember(owner = "client!bk", name = "f", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!bk", name = "d", descriptor = "(B)Ljava/lang/Object;", line = 58)
    ...
    @OriginalMember(owner = "client!bk", name = "b", descriptor = "(IIIIII)V", line = 71)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(Lso;IIB)V", line = 120)
    ...
    @OriginalMember(owner = "client!bk", name = "<init>", descriptor = "(Ljava/lang/Object;)V", line = 142)
