...
public class class393 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "([BII[BIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(BII)Z", line = 61)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(B)V", line = 83)
