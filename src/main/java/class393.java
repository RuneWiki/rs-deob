...
public class class393 extends class184 {
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lega;)V")
    public final synchronized void method2236(class184 arg0) {
        arg0.method2438((byte) 116);
    }

    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Leda;)V")
    ...
    @OriginalMember(owner = "client!fg", name = "d", descriptor = "()Lega;")
    ...
    @OriginalMember(owner = "client!fg", name = "a", descriptor = "(Lfaa;Leda;)V")
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "(Lega;)V")
    ...
    @OriginalMember(owner = "client!fg", name = "b", descriptor = "()Lega;")
