...
public class class393 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ILwf;ILwf;Z)Lfq;", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(Z)Z", line = 81)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IILwf;Lwf;)Lfq;", line = 111)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(I[SI)[S", line = 122)
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)V", line = 149)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Loi;Lum;)V", line = 186)
