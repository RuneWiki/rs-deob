...
public class class393 extends class86 {
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(Lsf;)V")
    ...
    @OriginalMember(owner = "client!dp", name = "<init>", descriptor = "(ILsf;)V")
    ...
    @OriginalMember(owner = "client!dp", name = "a", descriptor = "(ILfda;I)V")
