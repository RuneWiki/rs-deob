...
public class class393 extends class168 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ZILnd;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "()V", line = 29)
    public class393() {
    }

    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(I)V", line = 31)
