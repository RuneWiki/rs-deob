...
public class class393 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Luq;II)Ljava/lang/String;", line = 3)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(III)Lsr;", line = 28)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIIIB)V", line = 42)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "([BB)[B", line = 58)
