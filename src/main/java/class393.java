...
public class class393 {
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIIIILha;)V", line = 38)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(BLee;Ljava/lang/String;)I", line = 153)
