...
public class class393 {
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(Lqa;BIZLc;IIIIIIILhi;II)Lc;", line = 5)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(B)V", line = 230)
    ...
    @OriginalMember(owner = "client!ff", name = "b", descriptor = "(B)V", line = 251)
    ...
    @OriginalMember(owner = "client!ff", name = "a", descriptor = "(I)V", line = 399)
