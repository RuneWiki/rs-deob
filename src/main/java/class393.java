...
public class class393 extends class249 {
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ZIC)C", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(IIII)I", line = 96)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(ILjava/lang/String;IZIILjava/lang/String;IJZI)V", line = 115)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(II[I[I)V", line = 177)
