...
public class class393 extends class14 {
    ...
    @OriginalMember(owner = "client!pu", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pu", name = "<init>", descriptor = "()V", line = 34)
    public class393() {
        super(1, true);
    }

    @OriginalMember(owner = "client!pu", name = "f", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Lhq;IB)V", line = 132)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IBLmd;)V", line = 155)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IB)[I", line = 202)
    ...
    @OriginalMember(owner = "client!pu", name = "g", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!pu", name = "b", descriptor = "(B)V", line = 291)
