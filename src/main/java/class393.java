...
public class class393 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)Lpn;", line = 11)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lpn;Z)V", line = 45)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZIZIFIII)[I", line = 65)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIII)I", line = 99)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(B)Lpn;", line = 123)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)Lpn;", line = 142)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 166)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(II)Lwh;", line = 179)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "()V", line = 291)
    public class393() {
        this.field5625.field6254 = this.field5625;
        this.field5625.field6251 = this.field5625;
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIILko;II)Ljava/awt/Frame;", line = 214)
    ...
    @OriginalMember(owner = "client!fk", name = "c", descriptor = "(I)V", line = 300)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(II)I", line = 322)
    public static int method2487(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IILnq;IZIB)V", line = 329)
    ...
    @OriginalMember(owner = "client!fk", name = "d", descriptor = "(I)I", line = 349)
