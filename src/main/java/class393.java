...
public class class393 {
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(ZLiv;)V", line = 87)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(B)V", line = 115)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IBLiv;)V", line = 126)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(III)V", line = 162)
    ...
    @OriginalMember(owner = "client!pu", name = "a", descriptor = "(IZ)Lsp;", line = 181)
