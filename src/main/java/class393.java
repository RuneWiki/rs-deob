...
public class class393 extends class512 {
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "()Lc;", line = 11)
    ...
    @OriginalMember(owner = "client!ii", name = "K", descriptor = "(III[I)V", line = 27)
    ...
    @OriginalMember(owner = "client!ii", name = "ca", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!ii", name = "wa", descriptor = "([I)V", line = 42)
    ...
    @OriginalMember(owner = "client!ii", name = "ea", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ii", name = "ha", descriptor = "(Lc;)V", line = 82)
    ...
    @OriginalMember(owner = "client!ii", name = "YA", descriptor = "(IIIIII)V", line = 98)
    ...
    @OriginalMember(owner = "client!ii", name = "W", descriptor = "(III)V", line = 127)
    ...
    @OriginalMember(owner = "client!ii", name = "EA", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!ii", name = "g", descriptor = "(I)V", line = 157)
    ...
    @OriginalMember(owner = "client!ii", name = "v", descriptor = "()V", line = 164)
    ...
    @OriginalMember(owner = "client!ii", name = "U", descriptor = "(III)V", line = 170)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(III[I)V", line = 177)
    ...
    @OriginalMember(owner = "client!ii", name = "<init>", descriptor = "()V", line = 183)
    public class393() {
        this.method954();
    }
}
