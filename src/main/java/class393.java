...
public class class393 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(Ljg;Ljg;IIIIIBII)V", line = 9)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BI)V", line = 71)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(I)I", line = 112)
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BIZ)V", line = 138)
