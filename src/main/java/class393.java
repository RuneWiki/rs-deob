...
public class class393 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZLii;)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZIBLjava/lang/String;)Z")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(ZZLjava/lang/Object;)[B")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(IILvm;BII)Ljn;")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BLtq;)V")
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(BILtq;)V")
