...
public class class393 extends class232 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILwq;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!wu", name = "d", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!wu", name = "c", descriptor = "(B)V", line = 65)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "()V", line = 98)
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "()V", line = 182)
    public class393() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIIIII)V", line = 194)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IB)[I", line = 221)
