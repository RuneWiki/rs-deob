...
public class class393 extends class14 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIILjo;Ljo;)V", line = 8)
    ...
    @OriginalMember(owner = "client!wg", name = "f", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbv;IIIIZ[FI)V", line = 33)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbv;IIIIZ[BIZ)V", line = 88)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbv;IIIIZ[IZ)V", line = 141)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbv;IIII)V", line = 191)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lbv;IIIII)V", line = 233)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(III)Z", line = 57)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ZZZ)V", line = 68)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIII)V", line = 203)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIIIIII)V", line = 219)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Ljb;I)V", line = 251)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Z)V", line = 289)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIZI[IIIBI)V", line = 303)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I[BIIIIIZZI)V", line = 356)
