...
public class class651 extends class314 {
    ...
    @OriginalMember(owner = "client!gn", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 16)
    ...
    @OriginalMember(owner = "client!gn", name = "a", descriptor = "(II)[I", line = 39)
    ...
    @OriginalMember(owner = "client!gn", name = "<init>", descriptor = "()V", line = 81)
    public class651() {
        super(1, true);
    }

    @OriginalMember(owner = "client!gn", name = "b", descriptor = "(Z)V", line = 85)
