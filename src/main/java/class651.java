...
public class class651 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(III)V", line = 8)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(II)Liea;", line = 31)
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(I)V", line = 60)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(II)V", line = 76)
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lmja;ILbt;)V", line = 125)
