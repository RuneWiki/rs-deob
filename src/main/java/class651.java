...
public class class651 extends class525 implements class559 {
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(Lha;B)Lufa;", line = 3)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(B)Z", line = 17)
    ...
    @OriginalMember(owner = "client!fea", name = "d", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Lha;Lqg;IIIIIZIIZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lha;ZI)Lka;", line = 81)
    ...
    @OriginalMember(owner = "client!fea", name = "f", descriptor = "(I)I", line = 101)
    ...
    @OriginalMember(owner = "client!fea", name = "f", descriptor = "(B)Z", line = 113)
    ...
    @OriginalMember(owner = "client!fea", name = "e", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(III)V", line = 143)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ILha;)V", line = 159)
    ...
    @OriginalMember(owner = "client!fea", name = "b", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ZZZ)V", line = 201)
    ...
    @OriginalMember(owner = "client!fea", name = "c", descriptor = "(B)Z", line = 224)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(B)V", line = 239)
    ...
    @OriginalMember(owner = "client!fea", name = "e", descriptor = "(B)I", line = 253)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ZILmb;Lha;III)V", line = 265)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lha;I)Lie;", line = 297)
    ...
    @OriginalMember(owner = "client!fea", name = "c", descriptor = "(I)I", line = 329)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(I)I", line = 341)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(IIBLha;)Z", line = 352)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Lha;B)V", line = 375)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ZZLha;I)Lsca;", line = 406)
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ZLha;)V", line = 436)
