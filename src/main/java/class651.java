...
public class class651 {
    ...
    @OriginalMember(owner = "client!dda", name = "a", descriptor = "(B)Lwl;")
    ...
    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lla;)V")
    public class651(class413 arg0) {
        this.field9146 = arg0;
    }

    @OriginalMember(owner = "client!dda", name = "<init>", descriptor = "(Lla;Lho;)V")
