...
public class class651 extends class583 {
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(BLbda;)I")
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIIIIILha;)V")
    ...
    @OriginalMember(owner = "client!rs", name = "<init>", descriptor = "(Lqga;)V")
