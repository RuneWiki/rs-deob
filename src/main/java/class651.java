...
public class class651 {
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!jh", name = "a", descriptor = "(BI)[[I", line = 27)
    ...
    @OriginalMember(owner = "client!jh", name = "b", descriptor = "(B)[[[I", line = 94)
    ...
    @OriginalMember(owner = "client!jh", name = "<init>", descriptor = "(III)V", line = 188)
    ...
    @OriginalMember(owner = "client!jh", name = "c", descriptor = "(B)V", line = 147)
