...
public class class651 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([Lhh;ILjava/lang/String;I)I", line = 5)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([Lhh;IBILjava/lang/String;)I", line = 16)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(I[Lhh;ILjava/lang/String;)Ljava/lang/String;", line = 37)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IIIIZ)V", line = 163)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BLjava/lang/String;)I", line = 178)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ZZLtga;)V", line = 190)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([Lhh;[I[Ljava/lang/String;Ljava/lang/String;B)I", line = 206)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(II)Z", line = 457)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(BI)I", line = 469)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Z)V", line = 480)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(ICI)I", line = 493)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "([Lhh;Ljava/lang/String;ZI)I", line = 519)
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Ljava/lang/String;[Lhh;I)I", line = 552)
    ...
    @OriginalMember(owner = "client!eb", name = "<init>", descriptor = "([B)V", line = 658)
