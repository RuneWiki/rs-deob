...
public class class651 {
    ...
    @OriginalMember(owner = "client!sga", name = "toString", descriptor = "()Ljava/lang/String;", line = 3)
    public final String toString() {
        field8725++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(BI)V", line = 15)
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([Lie;Ldw;B)Lcba;", line = 68)
