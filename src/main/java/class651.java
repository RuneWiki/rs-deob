...
public class class651 extends class430 {
    ...
    @OriginalMember(owner = "client!aba", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!aba", name = "b", descriptor = "(I)V", line = 14)
    public static void method3750(int arg0) {
        int var1 = -88 % ((arg0 + 67) / 33);
        field9345 = null;
    }

    @OriginalMember(owner = "client!aba", name = "<init>", descriptor = "(II)V", line = 27)
