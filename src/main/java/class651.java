...
public class class651 {
    ...
    @OriginalMember(owner = "client!vk", name = "e", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vk", name = "a", descriptor = "([BZI)I", line = 21)
    ...
    @OriginalMember(owner = "client!vk", name = "d", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!vk", name = "b", descriptor = "(ILha;)V", line = 54)
