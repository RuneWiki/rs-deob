...
public class class651 extends InputStream {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mj", name = "read", descriptor = "()I", line = 14)
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(IB)V", line = 26)
