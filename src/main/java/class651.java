...
public class class651 extends class203 implements class226 {
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;II)Lka;")
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "b", descriptor = "(BLha;)Lmg;")
    ...
    @OriginalMember(owner = "client!paa", name = "<init>", descriptor = "(Lha;Lsea;IIIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BIILha;)Z")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(BILha;Z)Liu;")
    ...
    @OriginalMember(owner = "client!paa", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lgga;[IILgga;)V")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(Lha;I)Luh;")
    ...
    @OriginalMember(owner = "client!paa", name = "a", descriptor = "(IIILha;Lnfa;ZI)V")
    ...
    @OriginalMember(owner = "client!paa", name = "c", descriptor = "(ILha;)V")
