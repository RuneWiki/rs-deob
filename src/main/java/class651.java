...
public class class651 {
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(Lwq;B)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(IBLwq;)V")
    ...
    @OriginalMember(owner = "client!sk", name = "a", descriptor = "(B)[Ljca;")
