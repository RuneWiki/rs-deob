...
public class class58 extends class59 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(II)V", line = 28)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lnr;III)V", line = 44)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(II)V", line = 494)
    public static final void method393(int arg0, int arg1) {
        class392.field5886.method215(arg1 ^ arg1, arg0);
        field834++;
    }

    @OriginalMember(owner = "client!ea", name = "f", descriptor = "(I)V", line = 502)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lim;Z)Z", line = 528)
