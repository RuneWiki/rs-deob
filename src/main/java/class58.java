...
public class class58 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)Z", line = 212)
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Z)V", line = 223)
    public class58(boolean arg0) {
        this.field788 = arg0;
    }

    @OriginalMember(owner = "client!dm", name = "b", descriptor = "(I)V", line = 231)
