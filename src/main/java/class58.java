...
public class class58 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILkg;ILqa;Lrn;IZLjr;ILgj;ILjc;IILts;Lkg;[Lar;ILpa;)Lka;")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lpa;IILts;Ljc;Ljr;Lqa;IIILkg;Lgj;)Lka;")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IILjava/net/Socket;)Lkd;")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ljr;IIB)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILqa;IBLgj;ILkg;ILjr;III)Lka;")
