...
public class class58 {
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IILvaa;)Z", line = 4)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!rga", name = "<init>", descriptor = "(Luca;)V", line = 133)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(B)V", line = 44)
    ...
    @OriginalMember(owner = "client!rga", name = "a", descriptor = "(IIIZZI)V", line = 73)
