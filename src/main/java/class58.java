...
public class class58 extends class373 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lcm;[Lwg;)Lwg;")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lfg;)V")
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BIZ)Lr;")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lfg;Lbt;IIII)V")
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lfg;[Lwg;)V")
