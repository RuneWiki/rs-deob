...
public class class58 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ZLns;Lns;)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILgaa;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIILvl;)V")
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILdfa;)I")
