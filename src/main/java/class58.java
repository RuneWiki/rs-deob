...
public class class58 {
    ...
    @OriginalMember(owner = "client!db", name = "a", descriptor = "([BI)V", line = 7)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lfu;[BI)V", line = 17)
    ...
    @OriginalMember(owner = "client!db", name = "<init>", descriptor = "(Lfu;Ljava/nio/ByteBuffer;)V", line = 28)
