...
public class class58 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBII)V", line = 6)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILjava/io/File;I)[B", line = 54)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(B)V", line = 77)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIZILuf;)V", line = 124)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBILkja;Lea;)V", line = 202)
