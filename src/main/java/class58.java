...
public class class58 extends class487 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IBI)V", line = 9)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(III)V", line = 36)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "([II)Ljava/lang/String;", line = 48)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 100)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lln;Lck;III)V", line = 118)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIZ)V", line = 451)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(B)V", line = 469)
