...
public class class58 {
    ...
    @OriginalMember(owner = "client!UVDKTGZK", name = "t", descriptor = "I")
    ...
    @OriginalMember(owner = "client!UVDKTGZK", name = "d", descriptor = "[LUVDKTGZK;")
    public static class58[] field1570;

    @OriginalMember(owner = "client!UVDKTGZK", name = "a", descriptor = "(LGWOEELWB;B)V")
    ...
    @OriginalMember(owner = "client!UVDKTGZK", name = "a", descriptor = "(LMLYYHULT;B)V")
