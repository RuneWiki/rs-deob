...
public class class58 {
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IZ)Lrf;", line = 36)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "(Lrf;)V", line = 48)
    public class58(class109 arg0) {
        this.field830 = 1;
        this.field829 = arg0.field1812;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(Lrf;I)V", line = 58)
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "([Lrf;)V", line = 68)
    public class58(class109[] arg0) {
