...
public class class58 extends class665 {
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "([III)V", line = 5)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(III[II)V", line = 164)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(II)V", line = 196)
    ...
    @OriginalMember(owner = "client!qn", name = "b", descriptor = "(II)V", line = 215)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(I)V", line = 230)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIFII)V", line = 247)
    ...
    @OriginalMember(owner = "client!qn", name = "c", descriptor = "(II)V", line = 364)
    ...
    @OriginalMember(owner = "client!qn", name = "a", descriptor = "(IIZI)V", line = 377)
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Lni;IIIII)V", line = 396)
