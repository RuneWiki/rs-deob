...
public class class58 extends class5 {
    ...
    @OriginalMember(owner = "client!wg", name = "<init>", descriptor = "()V", line = 6)
    public class58() {
        super(0, true);
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(IIZ)Z", line = 14)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(BLkp;II)V", line = 26)
    ...
    @OriginalMember(owner = "client!wg", name = "i", descriptor = "(I)V", line = 40)
    public static void method367(int arg0) {
        int var1 = -94 % ((-62 - arg0) / 34);
        field817 = null;
    }

    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(ILes;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!wg", name = "a", descriptor = "(II)[I", line = 115)
