...
public class class58 extends class241 implements class269 {
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILqa;II)Z")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ILqa;Z)Lr;")
    ...
    @OriginalMember(owner = "client!wc", name = "<init>", descriptor = "(IIIIILbq;)V")
    ...
    @OriginalMember(owner = "client!wc", name = "b", descriptor = "(ILqa;)Lso;")
    ...
    @OriginalMember(owner = "client!wc", name = "a", descriptor = "(ZLoe;ILqa;III)V")
    ...
    @OriginalMember(owner = "client!wc", name = "c", descriptor = "(ILqa;)Loj;")
