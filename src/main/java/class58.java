...
public class class58 extends class40 {
    ...
    @OriginalMember(owner = "client!jr", name = "h", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILlf;)V")
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(IB)Lvi;")
