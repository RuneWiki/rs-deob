...
public class class58 extends class67 {
    ...
    @OriginalMember(owner = "client!ea", name = "b", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "e", descriptor = "()V", line = 33)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(III)V", line = 43)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIIII)V", line = 63)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IILud;II)V", line = 165)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(FFFFFFLud;II)V", line = 225)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIIII)V", line = 308)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lnf;IIII)V", line = 594)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Lnf;II[III)V", line = 600)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(FFFFFFIII)V", line = 316)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIIII)V", line = 380)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "()I", line = 427)
    public final int method408() {
        return this.field788.field2555;
    }

    @OriginalMember(owner = "client!ea", name = "d", descriptor = "()I", line = 433)
    public final int method409() {
        return this.field788.field2556 + this.field789 + this.field783;
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IIII)V", line = 443)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "()I", line = 450)
    public final int method411() {
        return this.field788.field2555 + this.field785 + this.field791;
    }

    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(IIIIIII)V", line = 458)
