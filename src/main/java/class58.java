...
public abstract class class58 {
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 10)
    protected void finalize() {
        field716++;
        this.method474(1);
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Ljava/awt/Rectangle;II)V", line = 32)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 46)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIIII)V", line = 61)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 82)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLoia;)V", line = 94)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(IIIIII)V", line = 118)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;IILjava/lang/String;Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIBII)V", line = 146)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIBI)V", line = 168)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[IIII)Loia;", line = 180)
    ...
    @OriginalMember(owner = "client!ha", name = "h", descriptor = "(I)V", line = 228)
    public final void method452(int arg0) throws class76 {
        this.method435(0, arg0);
        field713++;
    }

    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 241)
    ...
    @OriginalMember(owner = "client!ha", name = "j", descriptor = "(I)V", line = 270)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ILfp;ILjava/awt/Canvas;IILd;I)Lha;", line = 300)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 338)
