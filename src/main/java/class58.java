...
public class class58 extends class327 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IILmm;)Lmm;")
    public final class152 method329(int arg0, int arg1, class152 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(Lmm;IIIIZ)V")
    public final void method330(class152 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lqp;[I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Lmm;IIIIZ)Z")
    public final boolean method333(class152 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(III[[ZZ)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[IIIZ)V")
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lpk;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIIIIII[[ZLmp;[I[I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(IIIIIII[[ZLmp;[I[I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(Lmm;IIIIZ)V")
    public final void method339(class152 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IILmp;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIIIIII[[Z)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IIZLmp;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II[I[I[I[I[I[I[IIIZ)V")
