...
public class class58 extends class149 {
    ...
    @OriginalMember(owner = "client!kt", name = "e", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kt", name = "d", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(BI)[[I", line = 42)
    ...
    @OriginalMember(owner = "client!kt", name = "a", descriptor = "(IBLtl;)V", line = 112)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!kt", name = "b", descriptor = "(B)V", line = 138)
    ...
    @OriginalMember(owner = "client!kt", name = "<init>", descriptor = "()V", line = 155)
    public class58() {
        super(0, false);
    }
}
