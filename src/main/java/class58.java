...
public class class58 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(B)V", line = 113)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lkk;I)V", line = 177)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(IIIBI)Z", line = 192)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(I)Z", line = 236)
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Lef;)V", line = 533)
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(B)Z", line = 284)
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lkk;Z)Z", line = 419)
    ...
    @OriginalMember(owner = "client!rf", name = "d", descriptor = "(I)V", line = 464)
