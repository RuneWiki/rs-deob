...
public class class58 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(BI)V", line = 8)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILwd;Lqs;BILeq;)Z", line = 59)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IILts;I)V", line = 277)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(B)I", line = 359)
