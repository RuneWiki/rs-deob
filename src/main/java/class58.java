...
public class class58 implements class637 {
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I)Lhda;", line = 3)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(I)V", line = 41)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(ZZLjava/lang/String;ZLfl;)V", line = 56)
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(Ljava/lang/String;Lee;Lhaa;IIIIIIIIII)V", line = 132)
