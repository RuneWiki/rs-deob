...
public class class58 extends class12 {
    ...
    @OriginalMember(owner = "client!TTFRDWZK", name = "<init>", descriptor = "(LTXPLZUUI;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!TTFRDWZK", name = "a", descriptor = "(ZIILSFAIBATY;)V")
