...
public class class58 extends class260 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IZLha;Z)Ljm;")
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(Lwia;JIIIIZI)V")
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(ILgn;)V")
    ...
    @OriginalMember(owner = "client!dm", name = "<init>", descriptor = "(Lgn;)V")
