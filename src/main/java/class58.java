...
public class class58 extends class117 {
    ...
    @OriginalMember(owner = "client!tn", name = "g", descriptor = "(I)Z", line = 3)
    public final boolean method213(int arg0) {
        field786++;
        return arg0 == 10535 ? false : false;
    }

    @OriginalMember(owner = "client!tn", name = "i", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BLjava/lang/String;)V", line = 39)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 82)
    public class58(Object arg0, int arg1) {
        super(arg1);
        this.field784 = arg0;
    }

    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Z)Ljava/lang/Object;", line = 98)
