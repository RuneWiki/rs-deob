...
@OriginalClass("client!TLXFHCOO")
public class class58 {

    @OriginalMember(owner = "client!TLXFHCOO", name = "b", descriptor = "Z")
    private boolean field1451 = true;

    @OriginalMember(owner = "client!TLXFHCOO", name = "i", descriptor = "I")
    public int field1458 = -1;

    @OriginalMember(owner = "client!TLXFHCOO", name = "k", descriptor = "Z")
    public boolean field1460 = false;

    @OriginalMember(owner = "client!TLXFHCOO", name = "l", descriptor = "I")
    public int field1461 = 5;

    @OriginalMember(owner = "client!TLXFHCOO", name = "m", descriptor = "I")
    public int field1462 = -1;

    @OriginalMember(owner = "client!TLXFHCOO", name = "n", descriptor = "I")
    public int field1463 = -1;

    @OriginalMember(owner = "client!TLXFHCOO", name = "o", descriptor = "I")
    public int field1464 = 99;

    @OriginalMember(owner = "client!TLXFHCOO", name = "p", descriptor = "I")
    public int field1465 = -1;

    @OriginalMember(owner = "client!TLXFHCOO", name = "q", descriptor = "I")
    public int field1466 = -1;

    @OriginalMember(owner = "client!TLXFHCOO", name = "r", descriptor = "I")
    public int field1467 = 2;

    @OriginalMember(owner = "client!TLXFHCOO", name = "a", descriptor = "I")
    private static int field1450 = 8;

    @OriginalMember(owner = "client!TLXFHCOO", name = "c", descriptor = "I")
    public static int field1452;

    @OriginalMember(owner = "client!TLXFHCOO", name = "e", descriptor = "I")
    public int field1454;

    @OriginalMember(owner = "client!TLXFHCOO", name = "s", descriptor = "I")
    public int field1468;

    @OriginalMember(owner = "client!TLXFHCOO", name = "t", descriptor = "I")
    public static int field1469;

    @OriginalMember(owner = "client!TLXFHCOO", name = "f", descriptor = "[I")
    public int[] field1455;

    @OriginalMember(owner = "client!TLXFHCOO", name = "g", descriptor = "[I")
    public int[] field1456;

    @OriginalMember(owner = "client!TLXFHCOO", name = "h", descriptor = "[I")
    private int[] field1457;

    @OriginalMember(owner = "client!TLXFHCOO", name = "j", descriptor = "[I")
    public int[] field1459;

    @OriginalMember(owner = "client!TLXFHCOO", name = "d", descriptor = "[LTLXFHCOO;")
    public static class58[] field1453;

    @OriginalMember(owner = "client!TLXFHCOO", name = "a", descriptor = "(LFIGUVTWB;Z)V")
    ...
    @OriginalMember(owner = "client!TLXFHCOO", name = "a", descriptor = "(IB)I")
    ...
    @OriginalMember(owner = "client!TLXFHCOO", name = "a", descriptor = "(LMUKVLYLC;Z)V")
