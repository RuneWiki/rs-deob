...
public class class58 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lmg;I)V")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)Luj;")
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)Luj;")
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Lmg;)V")
