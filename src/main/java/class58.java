...
public abstract class class58 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Ljava/awt/Rectangle;II)V", line = 38)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIIII)V", line = 49)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 74)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Lkr;B)V", line = 181)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 194)
    protected void finalize() {
        field1068++;
        this.method623(-1);
    }

    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(IIIIII)V", line = 202)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I[IIIII)Lkr;", line = 285)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZIIII)V", line = 307)
    ...
    @OriginalMember(owner = "client!ha", name = "h", descriptor = "(I)V", line = 332)
    ...
    @OriginalMember(owner = "client!ha", name = "d", descriptor = "(IIIIII)V", line = 347)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(ZLd;IILjava/awt/Canvas;Leq;II)Lha;", line = 375)
    ...
    @OriginalMember(owner = "client!ha", name = "k", descriptor = "(I)V", line = 454)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IZIIII)V", line = 474)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 490)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLud;)V", line = 514)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 556)
