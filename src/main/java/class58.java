...
public abstract class class58 extends class369 {
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(Lwm;ILlga;Llga;Lng;Llga;)Z", line = 17)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "([FBI)[F", line = 40)
