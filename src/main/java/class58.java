...
public class class58 {
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "c", descriptor = "LZYLCKQCD;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "O", descriptor = "LPGNBHFUF;")
    private static class42 field1529;

    @OriginalMember(owner = "client!WZSDIPBR", name = "a", descriptor = "Lclient;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "G", descriptor = "[LWZSDIPBR;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "a", descriptor = "(I)LWZSDIPBR;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "a", descriptor = "(B)LWZSDIPBR;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "a", descriptor = "(I[III)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "b", descriptor = "(B)LPOJFANDE;")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "a", descriptor = "(LPGNBHFUF;I)V")
    ...
    @OriginalMember(owner = "client!WZSDIPBR", name = "a", descriptor = "(LQDHHNYHL;)V")
