...
public class class58 {
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(BLjava/lang/String;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(B)V", line = 72)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!dm", name = "a", descriptor = "(IILha;)Z", line = 110)
