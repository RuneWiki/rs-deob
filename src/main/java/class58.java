...
public class class58 {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lha;B)V")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(Lee;I)Lml;")
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(BLee;)Lbv;")
