...
public class class58 {
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "f", descriptor = "LOKDOXVFL;")
    public class40 field1511 = new class40();

    @OriginalMember(owner = "client!URASIGRB", name = "g", descriptor = "LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "a", descriptor = "(LOKDOXVFL;)V")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "a", descriptor = "(ILOKDOXVFL;)V")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "a", descriptor = "()LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "b", descriptor = "()LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "a", descriptor = "(B)LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "a", descriptor = "(Z)LOKDOXVFL;")
    ...
    @OriginalMember(owner = "client!URASIGRB", name = "b", descriptor = "(Z)LOKDOXVFL;")
