...
public class class58 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)Lsja;")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(IIIILns;)V")
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(B)Lsja;")
    ...
    @OriginalMember(owner = "client!tba", name = "<init>", descriptor = "(Llk;)V")
