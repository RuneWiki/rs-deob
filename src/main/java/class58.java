...
public class class58 extends class523 {
    ...
    @OriginalMember(owner = "client!tga", name = "b", descriptor = "(III)Lkv;", line = 11)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(I)Lkk;", line = 26)
    ...
    @OriginalMember(owner = "client!tga", name = "c", descriptor = "(III)Z", line = 85)
    ...
    @OriginalMember(owner = "client!tga", name = "<init>", descriptor = "(Lbi;IIIIII)V", line = 102)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(IIIIII)Z", line = 116)
    ...
    @OriginalMember(owner = "client!tga", name = "a", descriptor = "(Z)V", line = 153)
