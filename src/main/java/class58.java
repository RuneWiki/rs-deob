...
public class class58 {
    ...
    @OriginalMember(owner = "client!VYCKCNXO", name = "r", descriptor = "I")
    ...
    @OriginalMember(owner = "client!VYCKCNXO", name = "b", descriptor = "[LVYCKCNXO;")
    public static class58[] field1560;

    @OriginalMember(owner = "client!VYCKCNXO", name = "a", descriptor = "(LDTIATKJO;I)V")
    ...
    @OriginalMember(owner = "client!VYCKCNXO", name = "a", descriptor = "(LGHHPHSRU;I)V")
