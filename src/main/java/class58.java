...
public class class58 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)[Lqr;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BIBILks;)V")
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(IILui;)V")
