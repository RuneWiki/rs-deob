...
public class class58 extends class331 implements class289 {
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Lbo;ILoa;IIIZ)V", line = 15)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(BLoa;)Lvg;", line = 39)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILoa;)V", line = 55)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IZIBZII)V", line = 83)
    ...
    @OriginalMember(owner = "client!eda", name = "c", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Loa;ZZI)Ltaa;", line = 141)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(BLoa;)V", line = 175)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(Loa;B)Llt;", line = 188)
    ...
    @OriginalMember(owner = "client!eda", name = "g", descriptor = "(I)V", line = 215)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(I)I", line = 227)
    public final int method126(int arg0) {
        ++field795;
        return arg0 != 20377 ? 12 : this.field809;
    }

    @OriginalMember(owner = "client!eda", name = "e", descriptor = "(I)Z", line = 238)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IIILoa;)Z", line = 251)
    ...
    @OriginalMember(owner = "client!eda", name = "<init>", descriptor = "(Loa;Luca;IIIIZIZ)V", line = 276)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(B)I", line = 311)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(B)Ldf;", line = 333)
    public static final class544 method363(byte arg0) {
        ++field807;
        return arg0 <= 3 ? null : class413.method2419(-53, 1);
    }

    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(IILoa;)Lba;", line = 345)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(ILoa;)V", line = 356)
    ...
    @OriginalMember(owner = "client!eda", name = "a", descriptor = "(ILoa;Z)Lba;", line = 384)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(Z)V", line = 402)
    ...
    @OriginalMember(owner = "client!eda", name = "b", descriptor = "(I)I", line = 417)
