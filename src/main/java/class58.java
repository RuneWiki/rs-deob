...
public class class58 {
    ...
    @OriginalMember(owner = "client!UHNEGZAI", name = "c", descriptor = "LGJKLDIZT;")
    private class15 field1467;

    @OriginalMember(owner = "client!UHNEGZAI", name = "d", descriptor = "LGJKLDIZT;")
    private class15 field1468;

    @OriginalMember(owner = "client!UHNEGZAI", name = "e", descriptor = "LGJKLDIZT;")
    private class15 field1469;

    @OriginalMember(owner = "client!UHNEGZAI", name = "f", descriptor = "LGJKLDIZT;")
    private class15 field1470;

    @OriginalMember(owner = "client!UHNEGZAI", name = "g", descriptor = "LGJKLDIZT;")
    private class15 field1471;

    @OriginalMember(owner = "client!UHNEGZAI", name = "h", descriptor = "LGJKLDIZT;")
    private class15 field1472;

    @OriginalMember(owner = "client!UHNEGZAI", name = "i", descriptor = "LGJKLDIZT;")
    private class15 field1473;

    @OriginalMember(owner = "client!UHNEGZAI", name = "j", descriptor = "LGJKLDIZT;")
    private class15 field1474;

    @OriginalMember(owner = "client!UHNEGZAI", name = "q", descriptor = "LGJKLDIZT;")
    private class15 field1481;

    @OriginalMember(owner = "client!UHNEGZAI", name = "p", descriptor = "LGLZZOSSI;")
    ...
    @OriginalMember(owner = "client!UHNEGZAI", name = "a", descriptor = "(LDNRIFKTO;I)V")
    ...
    @OriginalMember(owner = "client!UHNEGZAI", name = "<init>", descriptor = "()V")
    public class58() {
        if (class2.field14) {
        }
    }
