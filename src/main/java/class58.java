...
public class class58 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(III)Z", line = 12)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!qr", name = "b", descriptor = "(I)Z", line = 46)
