...
public class class58 extends class386 {
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Ler;IIZ[[BI)V")
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Ler;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!qn", name = "<init>", descriptor = "(Ler;II)V")
