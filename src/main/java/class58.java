...
public class class58 extends class179 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)Z", line = 11)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ZIIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IBI[I)V", line = 48)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IBI)Z", line = 61)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIB[I)V", line = 82)
    ...
    @OriginalMember(owner = "client!sd", name = "d", descriptor = "(I)V", line = 104)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILha;)V", line = 118)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(IIII)Z", line = 165)
    ...
    @OriginalMember(owner = "client!sd", name = "<init>", descriptor = "(IIIIIIIII)V", line = 180)
