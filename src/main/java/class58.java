...
@OriginalClass("client!UYLEXXVQ")
public class class58 extends class1 {

    @OriginalMember(owner = "client!UYLEXXVQ", name = "l", descriptor = "Z")
    private boolean field1372 = true;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "z", descriptor = "I")
    private int field1386 = -723;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "v", descriptor = "I")
    private int field1382;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "w", descriptor = "I")
    private int field1383;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "x", descriptor = "I")
    private int field1384;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "m", descriptor = "I")
    private int field1373;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "n", descriptor = "I")
    private int field1374;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "o", descriptor = "I")
    private int field1375;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "p", descriptor = "I")
    private int field1376;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "t", descriptor = "LJFYFSKVR;")
    private class22 field1380;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "s", descriptor = "I")
    private int field1379;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "u", descriptor = "I")
    private int field1381;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "q", descriptor = "I")
    public int field1377;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "r", descriptor = "I")
    public int field1378;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "k", descriptor = "[I")
    public int[] field1371;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "y", descriptor = "Lclient;")
    public static client field1385;

    @OriginalMember(owner = "client!UYLEXXVQ", name = "<init>", descriptor = "(IIIIIIIIZI)V")
    ...
    @OriginalMember(owner = "client!UYLEXXVQ", name = "a", descriptor = "(Z)LYYHPBDED;")
    ...
    @OriginalMember(owner = "client!UYLEXXVQ", name = "a", descriptor = "(I)LZXOFSHYE;")
