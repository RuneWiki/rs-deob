...
public class class58 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ljp;ILir;II)V", line = 15)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIIIIIIIII)V", line = 357)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "([I[BB[[BI[II[[B)I", line = 388)
