...
public abstract class class58 {
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(BLhu;)V", line = 44)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IILoh;Ld;IIILjava/awt/Canvas;)Lha;", line = 69)
    ...
    @OriginalMember(owner = "client!ha", name = "finalize", descriptor = "()V", line = 117)
    protected void finalize() {
        this.method336(-113);
        field588++;
    }

    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(Ljava/lang/String;Z)Ljava/lang/String;", line = 128)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIIII)V", line = 237)
    ...
    @OriginalMember(owner = "client!ha", name = "b", descriptor = "(IIIII)V", line = 249)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(III)V", line = 264)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "([Ljava/awt/Rectangle;IZ)V", line = 292)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(B)V", line = 303)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(IBIIII)V", line = 322)
    ...
    @OriginalMember(owner = "client!ha", name = "<init>", descriptor = "(Ld;)V", line = 349)
    ...
    @OriginalMember(owner = "client!ha", name = "e", descriptor = "(IIIIII)V", line = 379)
    ...
    @OriginalMember(owner = "client!ha", name = "c", descriptor = "(IIIII)V", line = 392)
    ...
    @OriginalMember(owner = "client!ha", name = "i", descriptor = "(I)V", line = 421)
    ...
    @OriginalMember(owner = "client!ha", name = "a", descriptor = "(II[IIII)Lhu;", line = 433)
