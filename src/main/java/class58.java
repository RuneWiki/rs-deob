...
@OriginalClass("client!WNPVPVVL")
public class class58 extends class69 implements Runnable {

    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "LLVGEETWD;")
    private class38 field1438 = new class38((byte) 17);

    @OriginalMember(owner = "client!WNPVPVVL", name = "b", descriptor = "LFOKYUBQV;")
    private class16 field1439 = new class16(false);

    @OriginalMember(owner = "client!WNPVPVVL", name = "d", descriptor = "[[B")
    private byte[][] field1441 = new byte[4][];

    @OriginalMember(owner = "client!WNPVPVVL", name = "e", descriptor = "[B")
    private byte[] field1442 = new byte[65000];

    @OriginalMember(owner = "client!WNPVPVVL", name = "i", descriptor = "I")
    private int field1446 = -670;

    @OriginalMember(owner = "client!WNPVPVVL", name = "j", descriptor = "I")
    private int field1447 = -822;

    @OriginalMember(owner = "client!WNPVPVVL", name = "o", descriptor = "I")
    private int field1452 = -8221;

    @OriginalMember(owner = "client!WNPVPVVL", name = "w", descriptor = "LFOKYUBQV;")
    private class16 field1460 = new class16(false);

    @OriginalMember(owner = "client!WNPVPVVL", name = "x", descriptor = "[B")
    private byte[] field1461 = new byte[500];

    @OriginalMember(owner = "client!WNPVPVVL", name = "z", descriptor = "LFOKYUBQV;")
    private class16 field1463 = new class16(false);

    @OriginalMember(owner = "client!WNPVPVVL", name = "A", descriptor = "Ljava/util/zip/CRC32;")
    private CRC32 field1464 = new CRC32();

    @OriginalMember(owner = "client!WNPVPVVL", name = "B", descriptor = "LFOKYUBQV;")
    private class16 field1465 = new class16(false);

    @OriginalMember(owner = "client!WNPVPVVL", name = "H", descriptor = "Z")
    private boolean field1471 = true;

    @OriginalMember(owner = "client!WNPVPVVL", name = "K", descriptor = "Z")
    private boolean field1474 = true;

    @OriginalMember(owner = "client!WNPVPVVL", name = "L", descriptor = "[[I")
    private int[][] field1475 = new int[4][];

    @OriginalMember(owner = "client!WNPVPVVL", name = "M", descriptor = "I")
    private int field1476 = -661;

    @OriginalMember(owner = "client!WNPVPVVL", name = "N", descriptor = "LFOKYUBQV;")
    private class16 field1477 = new class16(false);

    @OriginalMember(owner = "client!WNPVPVVL", name = "O", descriptor = "[[I")
    private int[][] field1478 = new int[4][];

    @OriginalMember(owner = "client!WNPVPVVL", name = "Q", descriptor = "Z")
    private boolean field1480 = false;

    @OriginalMember(owner = "client!WNPVPVVL", name = "R", descriptor = "Z")
    private boolean field1481 = true;

    @OriginalMember(owner = "client!WNPVPVVL", name = "S", descriptor = "Ljava/lang/String;")
    public String field1482 = "";

    @OriginalMember(owner = "client!WNPVPVVL", name = "c", descriptor = "I")
    private int field1440;

    @OriginalMember(owner = "client!WNPVPVVL", name = "k", descriptor = "I")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "q", descriptor = "I")
    public int field1454;

    @OriginalMember(owner = "client!WNPVPVVL", name = "t", descriptor = "I")
    private int field1457;

    @OriginalMember(owner = "client!WNPVPVVL", name = "v", descriptor = "I")
    public int field1459;

    @OriginalMember(owner = "client!WNPVPVVL", name = "D", descriptor = "I")
    private int field1467;

    @OriginalMember(owner = "client!WNPVPVVL", name = "E", descriptor = "I")
    private int field1468;

    @OriginalMember(owner = "client!WNPVPVVL", name = "G", descriptor = "I")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "f", descriptor = "J")
    private long field1443;

    @OriginalMember(owner = "client!WNPVPVVL", name = "s", descriptor = "LWHTATTJS;")
    private class56 field1456;

    @OriginalMember(owner = "client!WNPVPVVL", name = "T", descriptor = "Lclient;")
    private client field1483;

    @OriginalMember(owner = "client!WNPVPVVL", name = "y", descriptor = "Ljava/io/InputStream;")
    private InputStream field1462;

    @OriginalMember(owner = "client!WNPVPVVL", name = "u", descriptor = "Ljava/io/OutputStream;")
    private OutputStream field1458;

    @OriginalMember(owner = "client!WNPVPVVL", name = "h", descriptor = "Ljava/net/Socket;")
    private Socket field1445;

    @OriginalMember(owner = "client!WNPVPVVL", name = "C", descriptor = "[B")
    private byte[] field1466;

    @OriginalMember(owner = "client!WNPVPVVL", name = "g", descriptor = "[I")
    private int[] field1444;

    @OriginalMember(owner = "client!WNPVPVVL", name = "n", descriptor = "[I")
    private int[] field1451;

    @OriginalMember(owner = "client!WNPVPVVL", name = "p", descriptor = "[I")
    private int[] field1453;

    @OriginalMember(owner = "client!WNPVPVVL", name = "r", descriptor = "[I")
    private int[] field1455;

    @OriginalMember(owner = "client!WNPVPVVL", name = "F", descriptor = "[I")
    private int[] field1469;

    @OriginalMember(owner = "client!WNPVPVVL", name = "P", descriptor = "[I")
    private int[] field1479;

    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(IB)I")
    public final int method439(int arg0, byte arg1) {
        return arg1 == 4 ? this.field1478[arg0].length : this.field1447;
    }

    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(IIZ[B)Z")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "()LWHTATTJS;")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "run", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(LXMRRKSSB;Lclient;)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(B)I")
    public final int method443(byte arg0) {
        return arg0 == 3 ? this.field1469.length : 2;
    }

    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(I)V")
    public final void method444(int arg0) {
        this.method451(0, arg0);
    }

    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(IZ)Z")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "b", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(IIIB)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(IIII)I")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "c", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "b", descriptor = "(II)Z")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(ILWHTATTJS;)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "d", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "a", descriptor = "(ZZ)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "b", descriptor = "()I")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "c", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!WNPVPVVL", name = "c", descriptor = "()V")
    public final void method459() {
        this.field1471 = false;
    }

    @OriginalMember(owner = "client!WNPVPVVL", name = "f", descriptor = "(I)V")
