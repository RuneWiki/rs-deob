...
public abstract class class58 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZLjava/lang/String;ZILfq;)V", line = 5)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILjava/lang/String;)V", line = 88)
    ...
    @OriginalMember(owner = "client!gv", name = "e", descriptor = "(I)Z", line = 139)
    ...
    @OriginalMember(owner = "client!gv", name = "f", descriptor = "(I)V", line = 152)
