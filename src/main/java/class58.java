...
public class class58 {
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(JB)Lgl;", line = 38)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(B)V", line = 71)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(I)Lgl;", line = 83)
    ...
    @OriginalMember(owner = "client!uc", name = "b", descriptor = "(I)I", line = 116)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(I)Lgl;", line = 149)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(Lvm;ILam;)V", line = 179)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "(JLgl;I)V", line = 307)
    ...
    @OriginalMember(owner = "client!uc", name = "c", descriptor = "(B)Lgl;", line = 329)
    ...
    @OriginalMember(owner = "client!uc", name = "d", descriptor = "(B)V", line = 356)
    ...
    @OriginalMember(owner = "client!uc", name = "e", descriptor = "(B)I", line = 391)
    ...
    @OriginalMember(owner = "client!uc", name = "<init>", descriptor = "(I)V", line = 402)
    ...
    @OriginalMember(owner = "client!uc", name = "a", descriptor = "([Lgl;B)I", line = 424)
