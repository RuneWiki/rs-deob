...
public class class583 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(ILjava/lang/String;)Ljava/io/File;", line = 4)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BILjava/lang/String;)V", line = 17)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Ljava/lang/String;BLjava/lang/String;I)Ljava/io/File;", line = 42)
