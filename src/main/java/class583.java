...
public class class583 extends class207 {
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(ILrd;)V")
    ...
    @OriginalMember(owner = "client!nda", name = "<init>", descriptor = "(Lrd;)V")
    public class583(class355 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nda", name = "a", descriptor = "(Ldt;I)Ldk;")
