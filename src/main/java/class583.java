...
public class class583 {
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(II)V", line = 5)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!av", name = "toString", descriptor = "()Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(ZI)V", line = 61)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(JI)V", line = 135)
    ...
    @OriginalMember(owner = "client!av", name = "<init>", descriptor = "(IZ)V", line = 437)
    public class583(int arg0, boolean arg1) {
        this.field8281 = arg0;
        this.field8283 = arg1;
    }

    @OriginalMember(owner = "client!av", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 157)
    ...
    @OriginalMember(owner = "client!av", name = "b", descriptor = "(II)I", line = 185)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(IIILaj;II)V", line = 216)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(B)V", line = 422)
    ...
    @OriginalMember(owner = "client!av", name = "a", descriptor = "(I)[Ljava/lang/String;", line = 446)
