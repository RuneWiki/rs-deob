...
public class class583 {
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I)Ljava/io/File;", line = 3)
    public final File method3346(int arg0) {
        field8247++;
        return arg0 == 0 ? this.field8253 : null;
    }

    @OriginalMember(owner = "client!fi", name = "b", descriptor = "(I)J", line = 15)
    public final long method3347(int arg0) throws IOException {
        field8249++;
        return arg0 == 0 ? this.field8252.length() : 96L;
    }

    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(I[BII)V", line = 28)
    ...
    @OriginalMember(owner = "client!fi", name = "c", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(ZJ)V", line = 68)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(B[BII)I", line = 80)
    ...
    @OriginalMember(owner = "client!fi", name = "a", descriptor = "(Z)V", line = 96)
    ...
    @OriginalMember(owner = "client!fi", name = "finalize", descriptor = "()V", line = 114)
    ...
    @OriginalMember(owner = "client!fi", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 129)
