...
public class class583 implements class137 {
    ...
    @OriginalMember(owner = "client!t", name = "a", descriptor = "()V", line = 15)
    public final void method3387() {
        this.field8390 = Thread.currentThread();
        this.method3396();
    }

    @OriginalMember(owner = "client!t", name = "b", descriptor = "()V", line = 31)
    public final void method3392() {
        this.field8390 = null;
        this.method3383();
    }

    @OriginalMember(owner = "client!t", name = "a", descriptor = "(Lj;BIZ)Lba;", line = 40)
    ...
    @OriginalMember(owner = "client!t", name = "<init>", descriptor = "(Lda;II)V", line = 91)
