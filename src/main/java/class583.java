...
public class class583 implements class90 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lnca;Z)V")
