...
public class class583 extends class83 {
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(BZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)V", line = 32)
    public final void method435(int arg0, int arg1, int arg2) {
        ++field8280;
        int var4 = 127 % ((arg2 - -60) / 33);
    }

    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(FIIIZIII)[I", line = 42)
    ...
    @OriginalMember(owner = "client!nl", name = "d", descriptor = "(I)V", line = 66)
    ...
    @OriginalMember(owner = "client!nl", name = "c", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZI)V", line = 99)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(IILav;)V", line = 113)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(Lvj;)V", line = 125)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(B)Z", line = 172)
