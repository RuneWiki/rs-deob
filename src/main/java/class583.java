...
public class class583 extends class150 {
    ...
    @OriginalMember(owner = "client!ht", name = "e", descriptor = "(I)V", line = 8)
    public static void method3320(int arg0) {
        int var1 = -125 / ((69 - arg0) / 43);
        field8162 = null;
    }

    @OriginalMember(owner = "client!ht", name = "d", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IBI)V", line = 33)
    ...
    @OriginalMember(owner = "client!ht", name = "f", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(IIIIIFFF)V", line = 62)
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(III)V", line = 97)
