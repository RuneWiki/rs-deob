...
public class class583 {
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(Z)Lns;")
    ...
    @OriginalMember(owner = "client!sga", name = "b", descriptor = "(B)Lns;")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(JI)Lns;")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(JLns;B)V")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "([Lns;I)I")
    ...
    @OriginalMember(owner = "client!sga", name = "a", descriptor = "(I)Lns;")
