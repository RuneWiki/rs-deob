...
public class class583 extends class26 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([Lpaa;IIIIIIIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B[I)V", line = 854)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "([[BI[BB[II[I[[B)I", line = 867)
    ...
    @OriginalMember(owner = "client!wn", name = "h", descriptor = "(BI)V", line = 927)
    ...
    @OriginalMember(owner = "client!wn", name = "k", descriptor = "(B)V", line = 938)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lhaa;I)V", line = 952)
    ...
    @OriginalMember(owner = "client!wn", name = "k", descriptor = "(II)I", line = 963)
    ...
    @OriginalMember(owner = "client!wn", name = "w", descriptor = "(I)I", line = 973)
    ...
    @OriginalMember(owner = "client!wn", name = "b", descriptor = "(II[BI)V", line = 992)
    ...
    @OriginalMember(owner = "client!wn", name = "x", descriptor = "(I)Z", line = 1007)
    ...
    @OriginalMember(owner = "client!wn", name = "<init>", descriptor = "(I)V", line = 1028)
    public class583(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wn", name = "y", descriptor = "(I)V", line = 1034)
    public final void method3464(int arg0) {
        this.field8290 = super.field330 * arg0;
        ++field8293;
    }

    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(B[B)V", line = 1043)
    ...
    @OriginalMember(owner = "client!wn", name = "l", descriptor = "(B)V", line = 1124)
    ...
    @OriginalMember(owner = "client!wn", name = "l", descriptor = "(II)I", line = 1143)
    ...
    @OriginalMember(owner = "client!wn", name = "h", descriptor = "(Z)V", line = 1174)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIIIILjm;ILha;III)V", line = 1187)
