...
public class class583 extends class656 {
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ILfa;)I", line = 38)
    ...
    @OriginalMember(owner = "client!pf", name = "c", descriptor = "(I)V", line = 52)
