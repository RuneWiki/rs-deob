...
public class class583 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IFLlh;Llh;)Z", line = 44)
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIB)Z", line = 111)
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lmh;)V", line = 123)
