...
public class class583 extends class268 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(IF)V", line = 8)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(I)V", line = 25)
    public class583(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(FI)V", line = 30)
    ...
    @OriginalMember(owner = "client!jv", name = "x", descriptor = "(I)V", line = 53)
