...
public class class583 extends class395 {
    ...
    @OriginalMember(owner = "client!fs", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(Ljha;I)V", line = 16)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IBI)V", line = 41)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IZI)V", line = 51)
    ...
    @OriginalMember(owner = "client!fs", name = "e", descriptor = "(I)V", line = 85)
    ...
    @OriginalMember(owner = "client!fs", name = "c", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(IIIIIFFF)V", line = 122)
