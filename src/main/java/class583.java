...
public class class583 extends class111 implements class629 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILfw;)V")
    ...
    @OriginalMember(owner = "client!mh", name = "c", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!mh", name = "<init>", descriptor = "(Lkaa;IZ[[I)V")
