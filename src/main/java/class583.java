...
public class class583 extends class363 implements class599 {
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BLr;ZI)Lht;")
    ...
    @OriginalMember(owner = "client!at", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lwv;BZ)V")
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lr;Ltc;IIIIIZIIII)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(BLr;)Lqw;")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lr;I)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lr;Z)V")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(ZLr;II)Z")
    ...
    @OriginalMember(owner = "client!at", name = "b", descriptor = "(Lr;I)Lcu;")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lr;IB)Lda;")
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Lr;B)V")
