...
public class class583 extends class204 {
    ...
    @OriginalMember(owner = "client!va", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!va", name = "d", descriptor = "(I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(II)I", line = 55)
    ...
    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(Lfs;)V", line = 90)
    public class583(class607 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!va", name = "<init>", descriptor = "(ILfs;)V", line = 94)
    public class583(int arg0, class607 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!va", name = "b", descriptor = "(B)I", line = 97)
    ...
    @OriginalMember(owner = "client!va", name = "d", descriptor = "(II)V", line = 111)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(Ljava/awt/Canvas;ILd;IB)Lha;", line = 122)
    ...
    @OriginalMember(owner = "client!va", name = "a", descriptor = "(B)I", line = 132)
