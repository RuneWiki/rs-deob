...
public class class583 extends class392 {
    ...
    @OriginalMember(owner = "client!lv", name = "c", descriptor = "(Z)[Lpd;")
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(Lw;)V")
    ...
    @OriginalMember(owner = "client!lv", name = "<init>", descriptor = "(ILw;)V")
