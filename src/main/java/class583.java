...
public class class583 extends class245 {
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IBI)Z", line = 15)
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Leq;Lgu;)V", line = 28)
    public class583(class209 arg0, class577 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!nw", name = "c", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ZI)V", line = 119)
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(ILjava/lang/String;)V", line = 135)
