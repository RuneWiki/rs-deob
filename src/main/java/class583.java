...
public class class583 extends class399 implements class484 {
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!po", name = "e", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!po", name = "d", descriptor = "(Z)Z", line = 34)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lmi;B)V", line = 45)
    ...
    @OriginalMember(owner = "client!po", name = "f", descriptor = "(I)Z", line = 57)
    ...
    @OriginalMember(owner = "client!po", name = "k", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!po", name = "g", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(IIILha;)Z", line = 106)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ILha;)V", line = 127)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(Z)I", line = 137)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Z)I", line = 149)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(Z)Z", line = 161)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(Lha;I)Lmaa;", line = 174)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!po", name = "c", descriptor = "(ILha;)V", line = 236)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(B)Z", line = 262)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BB)C", line = 273)
    ...
    @OriginalMember(owner = "client!po", name = "<init>", descriptor = "(Lha;Lkv;IIIIIZII)V", line = 308)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(ZLje;IIILha;I)V", line = 320)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(B)I", line = 332)
    ...
    @OriginalMember(owner = "client!po", name = "b", descriptor = "(Lha;I)Lrn;", line = 348)
    ...
    @OriginalMember(owner = "client!po", name = "a", descriptor = "(BLha;)V", line = 359)
