...
public class class583 {
    ...
    @OriginalMember(owner = "client!sn", name = "toString", descriptor = "()Ljava/lang/String;", line = 11)
    public final String toString() {
        field8196++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Lmw;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 82)
