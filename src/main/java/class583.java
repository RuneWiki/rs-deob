...
public class class583 extends class71 {
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!kaa", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ILmga;)Z", line = 38)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(ZII)I", line = 49)
    ...
    @OriginalMember(owner = "client!kaa", name = "a", descriptor = "(BILuv;I)V", line = 79)
