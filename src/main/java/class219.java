...
public class class219 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ZI)V", line = 35)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(B)I", line = 78)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IB)Las;", line = 91)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(B)V", line = 133)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Llo;ILnl;)V", line = 345)
    public class219(class280 arg0, int arg1, class435 arg2) {
        this.field3166 = arg2;
        this.field3166.method2638(1, 30);
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)V", line = 153)
