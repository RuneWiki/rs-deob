...
public class class219 extends class422 {
    ...
    @OriginalMember(owner = "client!hf", name = "c", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(ZII)I", line = 21)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IIILjk;Ljk;)V", line = 60)
