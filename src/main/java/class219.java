...
public class class219 extends class115 {
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)Z", line = 26)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(IB)V", line = 44)
    ...
    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(I)V", line = 98)
