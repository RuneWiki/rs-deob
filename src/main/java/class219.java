...
public class class219 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIIIIF[FIIFFIB[F)V", line = 31)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIILlp;ILha;)V", line = 120)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IIIJZ)Ljava/lang/String;", line = 181)
