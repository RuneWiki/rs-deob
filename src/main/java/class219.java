...
public class class219 extends class320 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IILck;)V", line = 9)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)V", line = 30)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IBIIIZ)V", line = 82)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(FIBII)V", line = 275)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IB)V", line = 388)
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(I)V", line = 406)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "([III)V", line = 417)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIIIIIIBI)V", line = 541)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(IB)V", line = 558)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(II)V", line = 573)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIIB)V", line = 585)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lsi;IIIII)V", line = 594)
