...
public class class219 extends class385 {
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(I)V", line = 133)
    ...
    @OriginalMember(owner = "client!al", name = "c", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(FIFIF[FIIFII)V", line = 40)
