...
public class class219 extends class721 implements class274 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!lh", name = "j", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lha;Lih;IIIIIZIII)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lmea;B)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(ILha;)Lid;")
