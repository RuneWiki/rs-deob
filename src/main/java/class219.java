...
public class class219 implements Runnable {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)Ljs;")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILqo;)V")
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(Ljava/net/Socket;Lvj;)V")
