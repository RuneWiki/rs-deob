...
public class class219 extends class241 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(FFFFFFILaa;II)V")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lqfa;IIZ)V")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lqfa;IIII)V")
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(Lqfa;II[III)V")
