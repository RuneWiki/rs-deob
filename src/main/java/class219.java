...
public class class219 extends class540 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)V", line = 10)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lkv;B)V", line = 42)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(B)Z", line = 84)
