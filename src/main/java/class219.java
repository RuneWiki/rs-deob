...
public class class219 implements Runnable {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLjava/awt/datatransfer/Transferable;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIBLjava/awt/Component;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IIIII)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/String;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)Lsb;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/Class;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/Object;IIB)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)Lsm;")
    public final class156 method1530(int arg0, int arg1) {
        return arg1 == 3 ? this.method1529(0, (Object) null, 3, arg0, (byte) 121) : null;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZLjava/awt/Frame;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)Lsm;")
    public final class156 method1532(byte arg0) {
        return arg0 == 85 ? this.method1529(0, (Object) null, 5, 0, (byte) 125) : null;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IZLjava/awt/Component;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/awt/Point;IILjava/awt/Component;[II)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "c", descriptor = "(I)Lsm;")
    public final class156 method1535(int arg0) {
        return arg0 == 12 ? this.method1529(0, (Object) null, 13, 0, (byte) 122) : null;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/String;I)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/Class;I)Lsm;")
    public final class156 method1537(Class arg0, int arg1) {
        int var3 = 103 % ((arg1 - 84) / 37);
        return this.method1529(0, arg0, 11, 0, (byte) 121);
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IILjava/lang/Runnable;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/Class;[Ljava/lang/Class;)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/net/URL;)Lsm;")
    public final class156 method1541(int arg0, URL arg1) {
        int var3 = -51 / ((30 - arg0) / 37);
        return this.method1529(0, arg1, 4, 0, (byte) 126);
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/Object;IBII)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "e", descriptor = "(I)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(ZLjava/lang/String;)Lsm;")
    public final class156 method1544(boolean arg0, String arg1) {
        return arg0 ? this.method1529(0, arg1, 21, 0, (byte) 118) : null;
    }

    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Ljava/lang/Class;B)Lsm;")
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILjava/lang/Class;)Lsm;")
