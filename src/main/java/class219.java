...
public class class219 extends class79 {
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!vv", name = "f", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!vv", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!vv", name = "g", descriptor = "(I)Lrc;", line = 112)
