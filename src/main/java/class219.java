...
public class class219 extends class330 {
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IIIIIILoe;ILada;IIB)V", line = 4)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IZ)[I", line = 30)
    ...
    @OriginalMember(owner = "client!sq", name = "a", descriptor = "(IBLns;)V", line = 69)
    ...
    @OriginalMember(owner = "client!sq", name = "e", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!sq", name = "<init>", descriptor = "()V", line = 166)
    public class219() {
        super(1, true);
    }
}
