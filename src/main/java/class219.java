...
public class class219 extends class452 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lfg;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(I)V", line = 76)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IZI)V", line = 102)
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(III)V", line = 134)
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Ljava/awt/Canvas;B)Le;", line = 155)
