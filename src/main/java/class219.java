...
public class class219 extends class269 {
    ...
    @OriginalMember(owner = "client!ida", name = "<init>", descriptor = "(Lbi;Lmaa;)V", line = 5)
    public class219(class449 arg0, class440 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ida", name = "c", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(ZI)V", line = 28)
    ...
    @OriginalMember(owner = "client!ida", name = "a", descriptor = "(III)Ldk;", line = 45)
