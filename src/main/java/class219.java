...
public class class219 {
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II)V", line = 6)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(II)Lwn;", line = 30)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(B)V", line = 80)
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Z)V", line = 94)
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lok;Lfa;)V", line = 108)
