...
public class class219 {
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lvo;I)V", line = 12)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lek;I)V", line = 23)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(IILek;)V", line = 45)
