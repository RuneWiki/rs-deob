...
public class class219 {
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lvv;II)V")
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Lss;III)Ljn;")
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "(Lmj;Lkda;Lsl;IIIII)V")
