...
public class class219 extends class90 {
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ZLre;)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(ILre;I)V")
    ...
    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(II)Lbu;")
