...
public class class219 extends class239 {
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIIII[BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIIIZ[BI)V", line = 41)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIII[I)V", line = 62)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(BLe;Ljava/awt/Canvas;Z)Loa;", line = 76)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIIZ[I)V", line = 91)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIIIIIZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIIIIZ)V", line = 129)
    ...
    @OriginalMember(owner = "client!ch", name = "<init>", descriptor = "(Lji;IIIII)V", line = 154)
    public class219(class622 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        super(arg0, 3553, arg1, arg4, arg5);
        this.field2874 = (float) arg2 / (float) arg4;
        this.field2872 = (float) arg3 / (float) arg5;
    ...
    @OriginalMember(owner = "client!ch", name = "e", descriptor = "(I)V", line = 167)
