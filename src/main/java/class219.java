...
public class class219 extends class211 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IILmca;ZLjava/awt/Component;)Ljq;")
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(BILib;)V")
    ...
    @OriginalMember(owner = "client!rea", name = "c", descriptor = "(II)I")
