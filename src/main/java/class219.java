...
public class class219 extends class583 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(BIFI[FIII[FIIF)V")
    ...
    @OriginalMember(owner = "client!rha", name = "c", descriptor = "(III)I")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Ljava/lang/String;II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(BLee;I)V")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(ILee;)V")
