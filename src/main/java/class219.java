...
public class class219 extends class266 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lmc;Lpj;)V", line = 15)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!bj", name = "d", descriptor = "(I)Z", line = 92)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Lek;IB)V", line = 104)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ZI)V", line = 115)
    ...
    @OriginalMember(owner = "client!bj", name = "f", descriptor = "(I)V", line = 129)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(IZ)V", line = 142)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILpj;)V", line = 153)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IILjava/lang/String;)V", line = 172)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(Z)V", line = 189)
