...
public class class219 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(IILoa;IIIILph;)Lxa;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(II)Lfs;")
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lta;Lph;Loa;Loa;IZIZZIII)Lxa;")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Luea;IZLtn;Lpq;Lpq;)V")
