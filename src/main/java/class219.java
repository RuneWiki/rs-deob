...
public class class219 {
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "([IIIIIIII)V", line = 31)
    ...
    @OriginalMember(owner = "client!fu", name = "a", descriptor = "(B)V", line = 143)
