...
public class class219 extends class87 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(ZILae;)V")
    ...
    @OriginalMember(owner = "client!rha", name = "<init>", descriptor = "(Loea;II[BI)V")
    ...
    @OriginalMember(owner = "client!rha", name = "b", descriptor = "(Z)V")
