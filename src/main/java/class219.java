...
public class class219 extends class47 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 12)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 29)
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 39)
