...
public class class219 extends class430 {
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(I)Leg;", line = 3)
    ...
    @OriginalMember(owner = "client!go", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!go", name = "a", descriptor = "(ZIILla;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "()V", line = 38)
    public class219() {
    }

    @OriginalMember(owner = "client!go", name = "<init>", descriptor = "(S)V", line = 44)
