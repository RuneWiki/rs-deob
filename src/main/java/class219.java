...
public class class219 extends class82 {
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Ldn;Ldn;Lqa;I)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lpq;ILdn;)V")
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILos;)V")
