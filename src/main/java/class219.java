...
public class class219 {
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(IZ)I", line = 16)
    ...
    @OriginalMember(owner = "client!js", name = "<init>", descriptor = "([I)V", line = 44)
    ...
    @OriginalMember(owner = "client!js", name = "a", descriptor = "(I)V", line = 80)
