...
public class class219 {
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(ZII)I", line = 7)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(Z)V", line = 37)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(BLjava/lang/String;)I", line = 53)
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!cu", name = "toString", descriptor = "()Ljava/lang/String;", line = 85)
