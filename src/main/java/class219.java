...
public abstract class class219 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILck;)V")
    public static final void method1281(int arg0, class351 arg1) {
        class12.field205[arg0] = arg1;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lur;Lur;IZIZI)I")
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lfh;BLlm;)V")
