...
public class class219 extends class185 implements class351 {
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZIILer;Lqa;IB)V")
    ...
    @OriginalMember(owner = "client!jo", name = "g", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(Lqa;Lkn;IIIIZIZ)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(BLqa;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IILqa;B)Z")
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(ILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lqa;B)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILqa;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(ILqa;)Lnf;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ILqa;I)Lc;")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IZLqa;I)Llp;")
