...
public abstract class class219 extends class379 {
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(I[BIIIII)Z", line = 5)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V", line = 56)
    ...
    @OriginalMember(owner = "client!hi", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!hi", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 81)
