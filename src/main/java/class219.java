...
public class class219 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILr;II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(III[[ZZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIZLr;)V", line = 307)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(BLr;II)V", line = 377)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIIII)V", line = 454)
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Lrl;Leha;)V", line = 502)
