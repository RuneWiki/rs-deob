...
public class class219 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 3)
    public static void method1466(int arg0) {
        int var1 = -1 % ((16 - arg0) / 59);
        field3091 = null;
    }

    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(III)I", line = 12)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Lae;Lna;III)V", line = 64)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)Z", line = 110)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 126)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILdg;)Lnf;", line = 199)
