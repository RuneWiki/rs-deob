...
public class class220 extends class86 {
    ...
    @OriginalMember(owner = "client!on", name = "e", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 12)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 34)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "()V", line = 71)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "()V", line = 105)
    ...
    @OriginalMember(owner = "client!on", name = "d", descriptor = "()V", line = 117)
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "()I", line = 140)
