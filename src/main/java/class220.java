...
public class class220 extends class235 implements class529 {
    ...
    @OriginalMember(owner = "client!jo", name = "c", descriptor = "(Lya;I)Lfk;")
    public final class462 method38(class38 arg0, int arg1) {
        field3170++;
        return arg1 >= -87 ? null : null;
    }

    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IILya;I)Z")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lya;II)Lt;")
    ...
    @OriginalMember(owner = "client!jo", name = "b", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(IILfi;BZLya;I)V")
    ...
    @OriginalMember(owner = "client!jo", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(Lya;I)V")
    ...
    @OriginalMember(owner = "client!jo", name = "<init>", descriptor = "(IIIIILrb;)V")
    ...
    @OriginalMember(owner = "client!jo", name = "a", descriptor = "(ZLya;)V")
