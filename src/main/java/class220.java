...
public abstract class class220 extends class393 {
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)I", line = 8)
    public int method1362(int arg0) {
        field3137++;
        return arg0 == -3 ? -1 : -51;
    }

    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBLil;)V", line = 27)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(B)I", line = 48)
    public int method1363(byte arg0) {
        field3122++;
        return arg0 < 96 ? -75 : -1;
    }

    @OriginalMember(owner = "client!ak", name = "d", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IZ)V", line = 129)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(IBI)[I", line = 165)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(III)V", line = 215)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(II)[[I", line = 238)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(IBI)[[I", line = 255)
    ...
    @OriginalMember(owner = "client!ak", name = "e", descriptor = "(B)V", line = 287)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BLro;)Lro;", line = 300)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(II)[I", line = 317)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lnr;I)V", line = 328)
    ...
    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(IBI)I", line = 413)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqj;I)V", line = 437)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(BI)V", line = 452)
    ...
    @OriginalMember(owner = "client!ak", name = "d", descriptor = "(I)V", line = 464)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "(IZ)V", line = 479)
