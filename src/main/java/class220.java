...
public class class220 extends class3 {
    ...
    @OriginalMember(owner = "client!tf", name = "c", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III)I", line = 31)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(B)[B", line = 47)
