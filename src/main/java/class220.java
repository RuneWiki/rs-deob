...
public class class220 {
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(IZBII)V", line = 3)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!hm", name = "a", descriptor = "(I)V", line = 33)
