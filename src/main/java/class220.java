...
public abstract class class220 implements class194 {
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljaggl/opengl;IIIII[F)V", line = 7)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(I)I", line = 97)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljaggl/opengl;IIIII[B)V", line = 123)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(I)V", line = 212)
    private final void method1475(int arg0) {
        this.field3101.field1937 -= arg0;
        this.field3101.field1937 += this.method1480();
    }

    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Z)V", line = 218)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "()V", line = 228)
    ...
    @OriginalMember(owner = "client!lp", name = "c", descriptor = "()V", line = 243)
    ...
    @OriginalMember(owner = "client!lp", name = "a", descriptor = "(Ljaggl/opengl;IIIIII[I)V", line = 252)
    ...
    @OriginalMember(owner = "client!lp", name = "d", descriptor = "()I", line = 353)
    ...
    @OriginalMember(owner = "client!lp", name = "finalize", descriptor = "()V", line = 358)
    protected final void finalize() throws Throwable {
        this.method1478();
        super.finalize();
    }

    @OriginalMember(owner = "client!lp", name = "e", descriptor = "()Z", line = 365)
    ...
    @OriginalMember(owner = "client!lp", name = "f", descriptor = "()I", line = 384)
    public final int method1482() {
        return this.field3097;
    }

    @OriginalMember(owner = "client!lp", name = "c", descriptor = "(I)I", line = 389)
    ...
    @OriginalMember(owner = "client!lp", name = "<init>", descriptor = "(Lao;IIIZ)V", line = 426)
    ...
    @OriginalMember(owner = "client!lp", name = "b", descriptor = "(Z)V", line = 414)
