...
public class class220 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(I)Ltq;", line = 6)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Z)Ltq;", line = 24)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(B)Ltq;", line = 49)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILtq;)V", line = 69)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Ltq;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!nt", name = "b", descriptor = "(B)Ltq;", line = 121)
    ...
    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(ILnt;)V", line = 159)
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "()V", line = 243)
    public class220() {
        this.field3131.field8989 = this.field3131;
        this.field3131.field8990 = this.field3131;
    }

    @OriginalMember(owner = "client!nt", name = "c", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(I)I", line = 197)
    ...
    @OriginalMember(owner = "client!nt", name = "d", descriptor = "(B)Ltq;", line = 224)
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Lnt;Ltq;I)V", line = 256)
