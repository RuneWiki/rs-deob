...
public class class220 extends class776 {
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(Lrv;I)Ltp;")
    ...
    @OriginalMember(owner = "client!eq", name = "i", descriptor = "(I)Lib;")
    ...
    @OriginalMember(owner = "client!eq", name = "<init>", descriptor = "(ILcb;I)V")
    ...
    @OriginalMember(owner = "client!eq", name = "a", descriptor = "(IILkj;BII)Ljava/awt/Frame;")
