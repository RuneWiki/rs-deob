...
public class class220 extends class185 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ZI)V", line = 4)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIILha;)Z", line = 36)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 177)
    ...
    @OriginalMember(owner = "client!su", name = "finalize", descriptor = "()V", line = 74)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Lha;B)Lkv;", line = 85)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIIIII)V", line = 132)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(Lha;B)Lrga;", line = 211)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ILsj;Lha;Lka;)V", line = 223)
    ...
    @OriginalMember(owner = "client!su", name = "g", descriptor = "(I)I", line = 262)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IILha;Z)Lka;", line = 274)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(B)I", line = 291)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIIB[B)V", line = 307)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(ZILha;ILrda;II)V", line = 341)
    ...
    @OriginalMember(owner = "client!su", name = "d", descriptor = "(B)V", line = 353)
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(I)Z", line = 364)
    ...
    @OriginalMember(owner = "client!su", name = "e", descriptor = "(I)Z", line = 382)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BLha;)V", line = 396)
    ...
    @OriginalMember(owner = "client!su", name = "f", descriptor = "(B)Z", line = 416)
