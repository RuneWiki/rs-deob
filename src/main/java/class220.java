...
public class class220 extends class418 {
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IZI)V", line = 19)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lph;I)V", line = 40)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(III)V", line = 51)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BII)V", line = 69)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(II)Leq;", line = 91)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BIIIIII)V", line = 129)
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(IIIIIII)V", line = 183)
