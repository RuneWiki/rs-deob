...
public class class220 extends class223 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BLcr;)V", line = 4)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(III)V", line = 16)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(IIIIIII)V", line = 32)
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "(III)V", line = 44)
    ...
    @OriginalMember(owner = "client!on", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(III)V", line = 82)
