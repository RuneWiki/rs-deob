...
public class class220 extends class318 {
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lkd;)V", line = 75)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(Lav;IB)V", line = 190)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(B)V", line = 203)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IZ)V", line = 235)
    ...
    @OriginalMember(owner = "client!bb", name = "c", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!bb", name = "d", descriptor = "(I)V", line = 260)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(I)Z", line = 270)
    public final boolean method721(int arg0) {
        ++field3604;
        return arg0 != 0 ? true : true;
    }

    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(ZZ)V", line = 281)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(III)V", line = 306)
    ...
    @OriginalMember(owner = "client!bb", name = "b", descriptor = "(III)Z", line = 325)
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(IIB)V", line = 338)
