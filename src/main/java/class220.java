...
public abstract class class220 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(ILeb;I)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(IILb;Laa;IILu;Lne;)V")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)[Lqi;")
