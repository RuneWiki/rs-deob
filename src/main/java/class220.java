...
public class class220 extends class465 {
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!lf", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!lf", name = "d", descriptor = "(I)Z", line = 47)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(II)I", line = 61)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(BZ)V", line = 81)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IZ)V", line = 92)
    ...
    @OriginalMember(owner = "client!lf", name = "a", descriptor = "(IILhf;)V", line = 119)
    ...
    @OriginalMember(owner = "client!lf", name = "<init>", descriptor = "(Lno;)V", line = 151)
    ...
    @OriginalMember(owner = "client!lf", name = "c", descriptor = "(I)Z", line = 140)
