...
public class class220 implements class257 {
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(Z)Lg;")
    ...
    @OriginalMember(owner = "client!nt", name = "a", descriptor = "(IZIIIII)V")
    ...
    @OriginalMember(owner = "client!nt", name = "<init>", descriptor = "(Ldp;Lfv;IIIIIII)V")
