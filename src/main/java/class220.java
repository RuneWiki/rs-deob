...
public class class220 extends class86 {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Leq;BIIIZILwb;ILjl;)Lva;", line = 8)
    ...
    @OriginalMember(owner = "client!sc", name = "d", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!sc", name = "e", descriptor = "(B)V", line = 266)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "([IZII[I)J", line = 320)
