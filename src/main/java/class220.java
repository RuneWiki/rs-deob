...
public class class220 {
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(I)[[I", line = 25)
    ...
    @OriginalMember(owner = "client!pj", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II[BI)I", line = 62)
    ...
    @OriginalMember(owner = "client!pj", name = "<init>", descriptor = "(III)V", line = 180)
    ...
    @OriginalMember(owner = "client!pj", name = "a", descriptor = "(II)[I", line = 96)
