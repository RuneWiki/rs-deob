...
public class class220 extends class362 {
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "()V", line = 56)
    public class220() {
        super(3, false);
    }

    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(II)[I", line = 8)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 60)
    ...
    @OriginalMember(owner = "client!dga", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Lfca;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(Ljava/lang/String;ZC)I", line = 145)
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(IB)[[I", line = 171)
