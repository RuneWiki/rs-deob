...
public class class220 extends OutputStream {
    ...
    @OriginalMember(owner = "client!ch", name = "write", descriptor = "(I)V", line = 7)
    public final void write(int arg0) throws IOException {
        field2622++;
        throw new IOException();
    }

    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(Lrb;)V", line = 15)
    ...
    @OriginalMember(owner = "client!ch", name = "a", descriptor = "(I)V", line = 77)
