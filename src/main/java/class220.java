...
public class class220 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(I)V", line = 32)
