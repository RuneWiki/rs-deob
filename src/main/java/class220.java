...
public abstract class class220 {
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!ya", name = "a", descriptor = "(ZLjava/lang/String;)Ljava/lang/Class;", line = 42)
    ...
    @OriginalMember(owner = "client!ya", name = "<init>", descriptor = "(III)V", line = 79)
