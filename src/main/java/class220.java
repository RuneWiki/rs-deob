...
public class class220 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/Object;Ltp;I)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Lac;I)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(ILtp;Ljava/lang/Object;I)V")
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ltp;I)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!hs", name = "b", descriptor = "(Ltp;I)V")
