...
public class class220 extends class167 implements class241 {
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(Lh;Lba;Lov;[Lne;[Lf;)V", line = 4)
    ...
    @OriginalMember(owner = "client!ja", name = "finalize", descriptor = "()V", line = 34)
    protected final void finalize() {
        class313.method1863(this, -63);
    }

    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(CIIIZLea;II)V", line = 37)
