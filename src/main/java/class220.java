...
public class class220 extends class17 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IB)[[I", line = 24)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(Lwm;II)V", line = 119)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IIIZ)I", line = 184)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(IBI)Z", line = 203)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "()V", line = 216)
    public class220() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wb", name = "h", descriptor = "(I)V", line = 221)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "([BI)[B", line = 233)
