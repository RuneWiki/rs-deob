...
public class class220 extends class455 implements class185 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BLqq;)Lkm;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILqq;Lps;ZZII)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lqq;BII)Z")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lqq;I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(ZLqq;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(IIIIILab;)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lqq;ZI)Lcd;")
