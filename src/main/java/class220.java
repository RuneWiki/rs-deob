...
public class class220 extends class362 implements class532 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 11)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!p", name = "finalize", descriptor = "()V", line = 49)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Loa;Ljava/awt/Canvas;II)V", line = 53)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 60)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 84)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()V", line = 89)
