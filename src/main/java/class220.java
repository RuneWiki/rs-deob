...
public class class220 {
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Z)[Ldl;")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(Lj;III[Z)V")
    ...
    @OriginalMember(owner = "client!am", name = "a", descriptor = "(IB)Lam;")
