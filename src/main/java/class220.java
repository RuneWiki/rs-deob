...
public class class220 {
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lds;I)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lds;)V")
    ...
    @OriginalMember(owner = "client!dea", name = "a", descriptor = "(Lmp;I)V")
