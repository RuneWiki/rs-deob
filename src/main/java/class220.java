...
public class class220 extends class35 {
    ...
    @OriginalMember(owner = "client!on", name = "U", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!on", name = "SA", descriptor = "(Lj;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "(Lod;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lkt;[I)V")
    ...
    @OriginalMember(owner = "client!on", name = "O", descriptor = "(IILj;)Lj;")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lqf;IZI)V")
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(Lj;IIIIZ)Z")
