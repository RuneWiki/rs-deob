...
public class class220 {
    ...
    @OriginalMember(owner = "client!dr", name = "a", descriptor = "(Lks;ILjava/lang/String;)Ldr;", line = 5)
    ...
    @OriginalMember(owner = "client!dr", name = "finalize", descriptor = "()V", line = 25)
    protected final void finalize() throws Throwable {
        this.field3194.method1141(this.field3192);
        super.finalize();
    }

    @OriginalMember(owner = "client!dr", name = "<init>", descriptor = "(Lks;II)V", line = 34)
