...
public abstract class class220 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljava/lang/String;IIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ZLjava/lang/String;ILjava/util/Random;II[IIII[Lof;II[II)I", line = 28)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BI[IILjava/lang/String;II[Lof;)V", line = 107)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 132)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 164)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 179)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILjava/lang/String;)V", line = 215)
    ...
    @OriginalMember(owner = "client!pi", name = "<init>", descriptor = "(Lja;Lbs;)V", line = 260)
    public class220(class90 arg0, class186 arg1) {
        this.field3263 = arg0;
        this.field3274 = arg1;
    }

    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 270)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II[Lof;II[IIIIILrn;Ljava/lang/String;BIII)I", line = 286)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(B)V", line = 373)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lqo;I)I", line = 386)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIBILjava/lang/String;I)V", line = 414)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I[Lof;ILjava/lang/String;[IIIB)V", line = 430)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(BI)Lej;", line = 445)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(II[Lmb;)V", line = 475)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIII[I[Lof;Ljava/util/Random;ILjava/lang/String;I)I", line = 542)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "([III[Lof;IILjava/lang/String;Z)V", line = 581)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(III)V", line = 598)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IBLrn;[IILjava/lang/String;I[Lof;I)V", line = 615)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 762)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IILjava/lang/String;[I[I[Lof;I[I)V", line = 838)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(I)V", line = 1005)
