...
public class class220 extends Canvas {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "([Laf;Lqj;I)Llaa;", line = 5)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 69)
    public class220(Component arg0) {
        this.field2685 = arg0;
    }

    @OriginalMember(owner = "client!kea", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 80)
    public final void update(Graphics arg0) {
        this.field2685.update(arg0);
        field2687++;
    }

    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ZBIII)V", line = 88)
    ...
    @OriginalMember(owner = "client!kea", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 110)
    public final void paint(Graphics arg0) {
        this.field2685.paint(arg0);
        field2688++;
    }

    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)V", line = 118)
