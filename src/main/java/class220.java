...
public class class220 {
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(IJ)Lww;")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(FFIIBIIFLgaa;FFII[B)V")
    ...
    @OriginalMember(owner = "client!ts", name = "a", descriptor = "(BLww;J)V")
    ...
    @OriginalMember(owner = "client!ts", name = "c", descriptor = "(I)[Leaa;")
    ...
    @OriginalMember(owner = "client!ts", name = "d", descriptor = "(I)Lww;")
