...
public abstract class class220 extends class408 {
    ...
    @OriginalMember(owner = "client!cu", name = "b", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(JI)Ljava/lang/String;", line = 23)
    ...
    @OriginalMember(owner = "client!cu", name = "a", descriptor = "(IIIILiq;)V", line = 78)
