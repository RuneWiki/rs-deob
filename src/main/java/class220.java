...
public class class220 {
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(II)Lrea;", line = 3)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I[BI)I", line = 29)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!rea", name = "b", descriptor = "(I)Lqf;", line = 53)
    public final class708 method1408(int arg0) {
        field2852++;
        return arg0 <= 13 ? null : class482.method2834(this.field2843, false);
    }

    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(IIIIIBI)V", line = 69)
    ...
    @OriginalMember(owner = "client!rea", name = "a", descriptor = "(III)Z", line = 100)
    ...
    @OriginalMember(owner = "client!rea", name = "<init>", descriptor = "(II)V", line = 112)
