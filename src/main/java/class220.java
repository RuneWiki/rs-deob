...
public class class220 {
    ...
    @OriginalMember(owner = "client!ig", name = "b", descriptor = "(I)[Lrg;")
    ...
    @OriginalMember(owner = "client!ig", name = "<init>", descriptor = "(Len;)V")
    public class220(class289 arg0) {
        this.field3195 = arg0;
    }

    @OriginalMember(owner = "client!ig", name = "a", descriptor = "(FBLrb;Lrb;)Z")
