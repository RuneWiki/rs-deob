...
public class class220 extends class427 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "()Lps;")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IILpc;)V")
    ...
    @OriginalMember(owner = "client!sca", name = "d", descriptor = "()Lps;")
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(IIZ[ILpc;I)V")
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Ltda;)V")
