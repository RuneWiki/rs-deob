...
public class class220 extends class11 {
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ZZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/String;", line = 18)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IIB)V", line = 68)
    ...
    @OriginalMember(owner = "client!fc", name = "<init>", descriptor = "(Lad;)V", line = 79)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IZ)V", line = 118)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(IILpm;)V", line = 149)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(I)V", line = 172)
    ...
    @OriginalMember(owner = "client!fc", name = "a", descriptor = "(B)Z", line = 194)
