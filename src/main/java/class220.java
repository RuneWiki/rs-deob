...
public class class220 {
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!bj", name = "<init>", descriptor = "(Lifa;Lfa;)V", line = 121)
    public class220(class393 arg0, class212 arg1) {
        this.field2844 = arg1;
        this.field2845 = arg0;
    }

    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(IIIIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(BI)Lco;", line = 80)
    ...
    @OriginalMember(owner = "client!bj", name = "b", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!bj", name = "a", descriptor = "(ILjava/net/Socket;I)Lob;", line = 142)
