...
public class class757 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IB)V", line = 12)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)I", line = 26)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIIILkw;)Lof;", line = 58)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Lo;I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(Z)[Ljava/lang/String;", line = 95)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BIIII)V", line = 110)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)I", line = 143)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BILjava/lang/String;)V", line = 311)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(B)V", line = 333)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(IZ)V", line = 397)
    public class757(int arg0, boolean arg1) {
        this.field10538 = arg1;
        this.field10542 = arg0;
    }

    @OriginalMember(owner = "client!ra", name = "toString", descriptor = "()Ljava/lang/String;", line = 348)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(BLjava/lang/String;)V", line = 382)
