...
public class class757 {
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(ILdd;)[I")
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(Lrv;I)V")
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(ILrv;Z)V")
    ...
    @OriginalMember(owner = "client!sha", name = "a", descriptor = "(ZLli;)V")
