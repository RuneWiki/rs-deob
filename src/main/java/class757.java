...
public class class757 implements class58 {
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ZZ)V", line = 30)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)Z", line = 75)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILjava/lang/String;)V", line = 91)
    ...
    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(Lla;Ljr;)V", line = 123)
