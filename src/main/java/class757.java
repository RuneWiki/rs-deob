...
public class class757 {
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(IZIIB)Lue;", line = 5)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(I)Z", line = 49)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(II)V", line = 92)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(I)V", line = 105)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!sw", name = "b", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(Lvj;IZ)V", line = 146)
    ...
    @OriginalMember(owner = "client!sw", name = "c", descriptor = "(B)I", line = 214)
    ...
    @OriginalMember(owner = "client!sw", name = "d", descriptor = "(B)Z", line = 225)
    ...
    @OriginalMember(owner = "client!sw", name = "d", descriptor = "(I)I", line = 237)
    ...
    @OriginalMember(owner = "client!sw", name = "e", descriptor = "(I)Z", line = 251)
    ...
    @OriginalMember(owner = "client!sw", name = "f", descriptor = "(I)V", line = 523)
    ...
    @OriginalMember(owner = "client!sw", name = "g", descriptor = "(I)V", line = 561)
    ...
    @OriginalMember(owner = "client!sw", name = "a", descriptor = "(ZI)V", line = 588)
