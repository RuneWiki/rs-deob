...
public abstract class class757 extends class513 {
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(I)I", line = 5)
    public final int method4203(int arg0) {
        field10522++;
        return arg0 == 20918 ? this.field10513 : -73;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(Lhg;ZIILhg;IIIII)V", line = 16)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(B)I", line = 70)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(B)I", line = 82)
    ...
    @OriginalMember(owner = "client!kb", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(ILjava/lang/String;)I", line = 112)
    ...
    @OriginalMember(owner = "client!kb", name = "d", descriptor = "(B)I", line = 134)
    public final int method4209(byte arg0) {
        field10521++;
        return arg0 == -66 ? this.field10511 : 47;
    }

    @OriginalMember(owner = "client!kb", name = "a", descriptor = "(IIBZZ)V", line = 150)
    ...
    @OriginalMember(owner = "client!kb", name = "e", descriptor = "(B)F", line = 170)
    ...
    @OriginalMember(owner = "client!kb", name = "f", descriptor = "(I)I", line = 180)
    public final int method4212(int arg0) {
        field10526++;
        return arg0 == -54 ? this.field10528 : -114;
    }

    @OriginalMember(owner = "client!kb", name = "<init>", descriptor = "(IIIIIF)V", line = 201)
