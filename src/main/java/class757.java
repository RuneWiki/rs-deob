...
public class class757 extends class460 implements class749 {
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(B)Z", line = 5)
    public final boolean method2156(byte arg0) {
        ++field10527;
        return arg0 < 104 ? false : super.method2733((byte) 100, super.field6494.field5403);
    }

    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(I)V", line = 17)
    public final void method1059(int arg0) {
        ++field10520;
        super.method1059(arg0);
    }

    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IB)V", line = 25)
    ...
    @OriginalMember(owner = "client!wia", name = "<init>", descriptor = "(Lfha;Lwt;Z)V", line = 37)
    public class757(class378 arg0, class309 arg1, boolean arg2) {
        super(arg0, 34963, arg2);
        this.field10525 = arg1;
    }

    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(I)Lwt;", line = 50)
    ...
    @OriginalMember(owner = "client!wia", name = "b", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(Z)I", line = 79)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 97)
    ...
    @OriginalMember(owner = "client!wia", name = "a", descriptor = "(BII)Z", line = 108)
