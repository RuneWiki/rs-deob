...
public class class757 {
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILoga;)V", line = 23)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(Z)V", line = 51)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ZLpc;)V", line = 67)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILbt;JIIIZI)V", line = 106)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(ILes;)V", line = 129)
    ...
    @OriginalMember(owner = "client!aca", name = "a", descriptor = "(IIII)I", line = 210)
    ...
    @OriginalMember(owner = "client!aca", name = "<init>", descriptor = "(Les;)V", line = 239)
