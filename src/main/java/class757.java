...
public class class757 extends class179 {
    ...
    @OriginalMember(owner = "client!dfa", name = "p", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!dfa", name = "k", descriptor = "(B)Z", line = 35)
    ...
    @OriginalMember(owner = "client!dfa", name = "c", descriptor = "(IB)I", line = 51)
    public final int method4208(int arg0, byte arg1) {
        ++field10547;
        return arg1 != 37 ? 78 : arg0 * 8 + -this.field10549;
    }

    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(B[I)V", line = 64)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(BLrr;)V", line = 76)
    ...
    @OriginalMember(owner = "client!dfa", name = "<init>", descriptor = "(I)V", line = 99)
    public class757(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dfa", name = "w", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!dfa", name = "l", descriptor = "(B)V", line = 123)
    ...
    @OriginalMember(owner = "client!dfa", name = "a", descriptor = "(I[BII)V", line = 134)
    ...
    @OriginalMember(owner = "client!dfa", name = "g", descriptor = "(Z)V", line = 154)
    ...
    @OriginalMember(owner = "client!dfa", name = "e", descriptor = "(BI)V", line = 167)
