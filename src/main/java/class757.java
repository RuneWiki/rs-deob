...
public abstract class class757 extends class337 {
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ILjava/awt/Component;)Lnl;", line = 3)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)Lrca;", line = 18)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 29)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Z)I", line = 56)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(Z)V", line = 67)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "()V", line = 81)
    public static final void method4119() {
        class106.method632(1, class78.field1121);
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)F", line = 85)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(B)I", line = 96)
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)I", line = 112)
    ...
    @OriginalMember(owner = "client!gu", name = "e", descriptor = "(I)I", line = 126)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(Z)I", line = 138)
    ...
    @OriginalMember(owner = "client!gu", name = "d", descriptor = "(B)V", line = 152)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(IIIIIF)V", line = 208)
