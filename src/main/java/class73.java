...
public class class73 {
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IBIIILka;II)Lka;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(IIIILka;I)Lka;")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(ILgga;I)V")
    ...
    @OriginalMember(owner = "client!gf", name = "a", descriptor = "(Lgga;B)V")
