...
public class class73 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)Lbo;", line = 9)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)V", line = 52)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(IB)V", line = 65)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ZI)V", line = 126)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 147)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(BI)V", line = 169)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)V", line = 179)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(BZ)V", line = 216)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lmt;IZLhh;Lhh;)V", line = 273)
