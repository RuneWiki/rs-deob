...
public class class73 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Lvp;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIC)I", line = 136)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B)V", line = 168)
