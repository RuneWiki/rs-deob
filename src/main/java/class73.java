...
public class class73 {
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(BI)Lku;")
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIII[[[BIBILqa;III)V")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lsn;IZLci;Lci;)V")
