...
public class class73 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(IILes;I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Les;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ILjava/lang/String;)I", line = 110)
