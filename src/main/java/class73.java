...
public class class73 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)Lmo;", line = 6)
    ...
    @OriginalMember(owner = "client!ri", name = "toString", descriptor = "()Ljava/lang/String;", line = 30)
    public final String toString() {
        field1081++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)I", line = 51)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(II)V", line = 62)
