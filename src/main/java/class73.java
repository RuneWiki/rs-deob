...
public class class73 extends class467 implements class297 {
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IF)F", line = 4)
    public final float method591(int arg0, float arg1) {
        return arg0 == -2092 ? arg1 / (float) this.field899 : -0.25645807F;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)I", line = 15)
    public final int method592(byte arg0) {
        int var2 = -126 % ((60 - arg0) / 54);
        return this.field899;
    }

    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lmh;Lqda;IIZ[BII)V", line = 22)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILqda;IBIIII[B)V", line = 81)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(II[IIIII)V", line = 122)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IZZ)V", line = 161)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;", line = 172)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lmh;Lqda;Lns;II)V", line = 183)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIIII[IIB)V", line = 203)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lmh;IIZ[III)V", line = 241)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(FI)F", line = 299)
    public final float method597(float arg0, int arg1) {
        int var3 = -83 % ((arg1 + 25) / 45);
        return arg0 / (float) this.field897;
    }

    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(I)V", line = 309)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ILkha;)V", line = 320)
    public final void method340(int arg0, class584 arg1) {
        super.method340(arg0, arg1);
    }

    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)I", line = 327)
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(B)Z", line = 338)
