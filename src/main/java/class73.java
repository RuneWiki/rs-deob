...
public class class73 {
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(I)Lg;")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IILjg;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(BLjg;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Z)Lg;")
