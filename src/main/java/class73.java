...
public class class73 {
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "()V", line = 389)
    public class73() {
        this(-1, 1000000, 1000000);
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(Ltj;I)V", line = 396)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(CB)B", line = 415)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(I)V", line = 546)
    public static void method442(int arg0) {
        int var1 = 73 / ((arg0 - 3) / 42);
        field953 = null;
    }

    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(BLpn;)V", line = 555)
    ...
    @OriginalMember(owner = "client!fn", name = "a", descriptor = "(ILlf;[B)V", line = 711)
    ...
    @OriginalMember(owner = "client!fn", name = "<init>", descriptor = "(III)V", line = 742)
