...
public class class73 extends class270 implements class323 {
    ...
    @OriginalMember(owner = "client!ok", name = "e", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(I)I", line = 16)
    ...
    @OriginalMember(owner = "client!ok", name = "<init>", descriptor = "(Lqa;Ljt;IIIIIZIII)V", line = 27)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLrn;ZIILqa;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!ok", name = "d", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lqa;I)V", line = 73)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(B)V", line = 85)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Z)Z", line = 96)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IZILqa;)Z", line = 107)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(BLqa;)V", line = 123)
    ...
    @OriginalMember(owner = "client!ok", name = "c", descriptor = "(I)V", line = 145)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(IILqa;)Lc;", line = 159)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(B)V", line = 173)
    ...
    @OriginalMember(owner = "client!ok", name = "a", descriptor = "(Lqa;B)V", line = 189)
    ...
    @OriginalMember(owner = "client!ok", name = "b", descriptor = "(Lqa;B)Lvs;", line = 202)
