...
public class class73 extends class232 {
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "(Log;Lcb;Llo;)V")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(ILdr;I)V")
    ...
    @OriginalMember(owner = "client!hia", name = "f", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Lli;B)V")
    ...
    @OriginalMember(owner = "client!hia", name = "g", descriptor = "(I)[Lgq;")
