...
public class class73 {
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wd", name = "b", descriptor = "(II)Lmd;", line = 19)
    ...
    @OriginalMember(owner = "client!wd", name = "a", descriptor = "(I)V", line = 53)
