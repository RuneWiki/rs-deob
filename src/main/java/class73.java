...
public class class73 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(Lku;Z)V")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(B)Lku;")
    ...
    @OriginalMember(owner = "client!mf", name = "b", descriptor = "(Z)Lku;")
