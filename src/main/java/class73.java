...
public class class73 extends class201 implements class526 {
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(I)Z", line = 4)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lr;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(Lr;I)Lbca;", line = 50)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(Z)Z", line = 105)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lr;Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!gv", name = "d", descriptor = "(I)I", line = 141)
    public final int method226(int arg0) {
        ++field984;
        return arg0 != 6329 ? -107 : this.field973.method2802(0);
    }

    @OriginalMember(owner = "client!gv", name = "i", descriptor = "(I)V", line = 152)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lvv;IIZLr;II)V", line = 168)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(CB)Z", line = 184)
    ...
    @OriginalMember(owner = "client!gv", name = "f", descriptor = "(I)I", line = 195)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BLr;)V", line = 206)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)I", line = 217)
    public final int method213(byte arg0) {
        ++field977;
        return arg0 <= 39 ? 2 : this.field973.field6804;
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILr;)Lcr;", line = 228)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lr;Ljs;IIIIIZIII)V", line = 243)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(BII)Z", line = 255)
    ...
    @OriginalMember(owner = "client!gv", name = "g", descriptor = "(I)Z", line = 266)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIILr;)Z", line = 277)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(B)I", line = 298)
    ...
    @OriginalMember(owner = "client!gv", name = "g", descriptor = "(B)Lqea;", line = 309)
    ...
    @OriginalMember(owner = "client!gv", name = "e", descriptor = "(B)Z", line = 322)
