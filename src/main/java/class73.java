...
public class class73 extends class199 implements MouseWheelListener {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 4)
    public final void method490(Component arg0, int arg1) {
        arg0.removeMouseWheelListener(this);
        int var3 = -36 / ((arg1 + 30) / 41);
    }

    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 13)
    ...
    @OriginalMember(owner = "client!fv", name = "mouseWheelMoved", descriptor = "(Ljava/awt/event/MouseWheelEvent;)V", line = 23)
    public final synchronized void mouseWheelMoved(MouseWheelEvent arg0) {
        this.field1059 += arg0.getWheelRotation();
    }

    @OriginalMember(owner = "client!fv", name = "b", descriptor = "(I)I", line = 31)
