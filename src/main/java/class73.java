...
public class class73 extends class98 {
    ...
    @OriginalMember(owner = "client!ls", name = "g", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(IIILmj;Lmj;)V")
    ...
    @OriginalMember(owner = "client!ls", name = "a", descriptor = "(Lgk;B)V")
