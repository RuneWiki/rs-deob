...
public class class73 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IC)C", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "toString", descriptor = "()Ljava/lang/String;", line = 412)
    public final String toString() {
        field939++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IB)I", line = 423)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 437)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(ILlj;Llj;)V", line = 448)
