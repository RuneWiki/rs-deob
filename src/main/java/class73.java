...
public class class73 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Z)Lvf;")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(II)Lhaa;")
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lhaa;I)V")
