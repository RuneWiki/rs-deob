...
public class class73 extends class71 {
    ...
    @OriginalMember(owner = "client!hd", name = "p", descriptor = "Llf;")
    private static class109 field1408 = class35.method275("Location", 2);

    @OriginalMember(owner = "client!hd", name = "n", descriptor = "Llf;")
    public static class109 field1406 = class35.method275("Diese Betatest)2Welt ist nur f-Ur eingeladene", 2);

    @OriginalMember(owner = "client!hd", name = "q", descriptor = "Llf;")
    public static class109 field1409 = field1408;

    @OriginalMember(owner = "client!hd", name = "v", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!hd", name = "r", descriptor = "Loh;")
    ...
    @OriginalMember(owner = "client!hd", name = "c", descriptor = "(B)Lkf;")
