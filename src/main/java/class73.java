...
public class class73 extends class396 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "()Lq;")
    ...
    @OriginalMember(owner = "client!kl", name = "la", descriptor = "(Lq;)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lpv;Lqs;)V")
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(Lq;Z)V")
