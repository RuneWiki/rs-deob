...
public abstract class class73 extends class419 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIZILot;Lza;)V", line = 6)
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(B)Z", line = 27)
    ...
    @OriginalMember(owner = "client!rv", name = "d", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIII)I", line = 51)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lkh;B)V", line = 83)
