...
public class class73 extends class424 {
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "([I)Lbp;", line = 3)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lpe;II)Lgw;", line = 61)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "([B)V", line = 80)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(I)I", line = 232)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "([BI)V", line = 265)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "()V", line = 274)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lpe;)Z", line = 296)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "([B)V", line = 313)
    ...
    @OriginalMember(owner = "client!gw", name = "a", descriptor = "(Lpe;I)Lgw;", line = 355)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "(I)[F", line = 376)
    ...
    @OriginalMember(owner = "client!gw", name = "b", descriptor = "()I", line = 789)
    ...
    @OriginalMember(owner = "client!gw", name = "c", descriptor = "(I)F", line = 802)
    ...
    @OriginalMember(owner = "client!gw", name = "<init>", descriptor = "([B)V", line = 816)
