...
public class class73 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(III)Lgq;", line = 7)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Z)V", line = 14)
    ...
    @OriginalMember(owner = "client!rv", name = "toString", descriptor = "()Ljava/lang/String;", line = 26)
    public final String toString() {
        field891++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!rv", name = "a", descriptor = "([[BLnd;I)V", line = 35)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BII)Z", line = 109)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(I)V", line = 120)
