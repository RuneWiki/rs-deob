...
public class class73 extends class452 {
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(III)I", line = 6)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!rv", name = "d", descriptor = "(III)I", line = 44)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(IIIBII[F)V", line = 67)
    ...
    @OriginalMember(owner = "client!rv", name = "j", descriptor = "(I)V", line = 166)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Ldv;Lmq;)V", line = 187)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(II)V", line = 200)
    ...
    @OriginalMember(owner = "client!rv", name = "k", descriptor = "(I)V", line = 239)
