...
public class class73 {
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(Lud;I)Lk;", line = 5)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!u", name = "a", descriptor = "(IIIBI)V", line = 40)
