...
public class class73 extends class309 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II[[I[[IIII)Lsa;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Ljava/lang/Runnable;)Lkw;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([Lr;Lsh;Lm;[Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Lld;IIII)Lr;")
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "([Lr;Lm;[Lpaa;I)V")
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Ljava/awt/Canvas;Ln;)V")
