...
public class class73 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;Lcs;IIII)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(II)Lef;")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;Lcs;Lup;)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lnd;Lls;Lpg;Lrj;Ltp;Ldl;Leia;)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;Lsl;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(Lha;)Lfh;")
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(Lha;IIII)Lfh;")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(I)Lef;")
    public static final class490 method666(int arg0) {
        return (class490) field1013.method1160((long) arg0, 125);
    }

    @OriginalMember(owner = "client!naa", name = "e", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!naa", name = "b", descriptor = "(II)Lqk;")
