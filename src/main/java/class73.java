...
public class class73 {
    ...
    @OriginalMember(owner = "client!is", name = "a", descriptor = "(IIIFI[FIIIBF)V", line = 18)
    ...
    @OriginalMember(owner = "client!is", name = "b", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!is", name = "<init>", descriptor = "(I)V", line = 101)
