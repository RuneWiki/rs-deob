...
public abstract class class73 {
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIII)I", line = 7)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(III)V", line = 96)
