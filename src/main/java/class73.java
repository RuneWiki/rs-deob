...
public class class73 extends class136 {
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIIIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "()V", line = 73)
    public class73() {
        super(1, true);
    }

    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(Z)V", line = 76)
    ...
    @OriginalMember(owner = "client!jr", name = "f", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILiv;)V", line = 124)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BLji;)V", line = 171)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I[J[Ljava/lang/Object;II)V", line = 190)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)[I", line = 254)
