...
public class class73 {
    ...
    @OriginalMember(owner = "client!kca", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field781++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IIIII)V", line = 14)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(Ljava/lang/String;ZB)V", line = 88)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(B)I", line = 190)
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(I)V", line = 201)
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(II)V", line = 219)
