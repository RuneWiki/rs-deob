...
public class class73 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(III)I", line = 36)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([Ljava/lang/String;I[SZI)V", line = 54)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([[BLuq;B)V", line = 109)
