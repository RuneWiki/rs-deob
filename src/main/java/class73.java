...
public class class73 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IIILh;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(ILh;II)Z")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(IBLh;I)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lbl;Ltn;)V")
