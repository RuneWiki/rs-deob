...
public class class73 implements class489 {
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(Lpj;Lpj;Lpj;)V")
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(II)Lgaa;")
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(II)Lgp;")
