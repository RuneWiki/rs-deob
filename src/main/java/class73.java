...
public class class73 extends class383 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZII)V", line = 3)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!jr", name = "e", descriptor = "(I)I", line = 111)
    ...
    @OriginalMember(owner = "client!jr", name = "f", descriptor = "(I)[Ldq;", line = 122)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(I[FIIIIB)V", line = 134)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(B)Z", line = 231)
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(II)V", line = 241)
    public class73(int arg0, int arg1) {
        this.field937 = arg1;
        this.field942 = arg0;
    }

    @OriginalMember(owner = "client!jr", name = "g", descriptor = "(I)Z", line = 250)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(II)Z", line = 263)
    ...
    @OriginalMember(owner = "client!jr", name = "h", descriptor = "(I)Z", line = 275)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(B)I", line = 287)
