...
public class class73 extends class366 {
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIIZIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "([Lab;II)V", line = 35)
    ...
    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(I)V", line = 134)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "(IIIIIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZII)V", line = 161)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(BII)V", line = 180)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(IIIII)V", line = 200)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 220)
