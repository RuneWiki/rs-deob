...
public class class311 extends class153 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IILqt;IIIIIIII)Z")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "([I[I[IILee;II)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILet;IZI)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(II[IIIII[[ZILee;[II)V")
    ...
    @OriginalMember(owner = "client!wu", name = "<init>", descriptor = "(Lhr;IIII[[I[[II)V")
    public class311(class446 arg0, int arg1, int arg2, int arg3, int arg4, int[][] arg5, int[][] arg6, int arg7) {
        super(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }

    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Lee;[IIIZI[I[I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(I[IIIILee;II[[ZII[I)V")
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(IIILcn;I)V")
