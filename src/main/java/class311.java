...
public class class311 {
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILss;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(I)V", line = 611)
    public static void method1926(int arg0) {
        int var1 = 53 % ((-arg0 - 18) / 62);
        field4556 = null;
    }

    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(B)V", line = 624)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(Z)V", line = 637)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(ILg;Lg;)V", line = 652)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(II)Lug;", line = 664)
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(II)V", line = 695)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "(Lci;ILg;)V", line = 714)
