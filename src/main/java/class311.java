...
public class class311 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(B)I", line = 67)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIZ)Z", line = 92)
    ...
    @OriginalMember(owner = "client!haa", name = "c", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(II)V", line = 169)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(Z)V", line = 185)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "()V", line = 333)
    private class311() {
    }

    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "([I)V", line = 335)
