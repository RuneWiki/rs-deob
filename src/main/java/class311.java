...
public class class311 extends class86 {
    ...
    @OriginalMember(owner = "client!cq", name = "d", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II[BI)Ljava/lang/String;", line = 16)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(I)[Lpj;", line = 63)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(III)Z", line = 75)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(Lis;IIIII)V", line = 87)
