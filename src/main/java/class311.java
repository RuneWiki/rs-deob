...
public class class311 extends class206 {
    ...
    @OriginalMember(owner = "client!nj", name = "O", descriptor = "(IILj;)Lj;")
    public final class229 method857(int arg0, int arg1, class229 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IILor;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Lj;IIIIZ)Z")
    public final boolean method847(class229 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(Ldd;[I)V")
    public final void method854(class471 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!nj", name = "va", descriptor = "(II)I")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(III[[ZZ)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIZLor;[I[I[I)V")
    ...
    @OriginalMember(owner = "client!nj", name = "QA", descriptor = "(III)V")
    ...
    @OriginalMember(owner = "client!nj", name = "I", descriptor = "(II)I")
    public final int method849(int arg0, int arg1) {
        return this.field4660[arg0][arg1];
    }

    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIII[[ZLor;[I[I)V")
    ...
    @OriginalMember(owner = "client!nj", name = "SA", descriptor = "(Lj;IIIIZ)V")
    public final void method844(class229 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!nj", name = "b", descriptor = "(IIIIIII[[ZLor;[I[I)V")
                    ...
                    if (this.field4656[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field1528; ++var23) {
                            ...
                            if (var21.field1531 == null || var21.field1531[var23] == 0 || var21.field1526 != null && (var21.field1526 == null || var21.field1526[var23] != -1)) {
                                if (var21.field1526 != null && var21.field1526[var23] != -1) {
    ...
    @OriginalMember(owner = "client!nj", name = "<init>", descriptor = "(Lrh;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!nj", name = "JA", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V")
    ...
    @OriginalMember(owner = "client!nj", name = "a", descriptor = "(IIIIIII[[Z)V")
    ...
    @OriginalMember(owner = "client!nj", name = "U", descriptor = "(Lj;IIIIZ)V")
