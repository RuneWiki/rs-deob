...
public abstract class class311 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)I", line = 7)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIIIIIIIII)V", line = 101)
