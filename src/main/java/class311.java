...
public class class311 extends class458 {
    ...
    @OriginalMember(owner = "client!ci", name = "d", descriptor = "()Lbl;")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lbl;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "(Lbl;)V")
    public final synchronized void method2039(class458 arg0) {
        this.field4729.method2428((byte) 123, arg0);
    }

    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lqg;Lhe;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lhe;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "b", descriptor = "()Lbl;")
