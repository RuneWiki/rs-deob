...
public abstract class class311 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZII)V", line = 12)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IBI)V", line = 29)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IB)Z", line = 67)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Ljava/lang/String;CI)I", line = 99)
    ...
    @OriginalMember(owner = "client!qd", name = "b", descriptor = "(IB)I", line = 164)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)V", line = 214)
