...
public class class311 extends class633 implements class305 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Llea;ILjaclib/memory/Buffer;)V", line = 17)
    public class311(class573 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field4411 = arg1;
    }

    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "(Llea;I[BI)V", line = 27)
    public class311(class573 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4411 = arg1;
    }

    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(I)V", line = 36)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "([BIII)V", line = 48)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(B)J", line = 60)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(I)I", line = 80)
