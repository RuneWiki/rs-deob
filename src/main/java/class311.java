...
public class class311 extends class581 {
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dj", name = "c", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IZII)V", line = 92)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IILjava/util/Random;)I", line = 127)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)V", line = 158)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Lpu;Lpu;Lnaa;)V", line = 195)
