...
public class class311 implements class373 {
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(IIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lza;Lps;IIIII)V", line = 55)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Ljava/lang/String;CB)I", line = 144)
    ...
    @OriginalMember(owner = "client!ct", name = "a", descriptor = "(Lsc;JI[I)Ljava/lang/String;", line = 170)
