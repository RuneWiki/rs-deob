...
public class class311 extends class474 {
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(Lcw;IILcw;)V", line = 4)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(II)V", line = 158)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(I)V", line = 171)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(B)I", line = 190)
    ...
    @OriginalMember(owner = "client!cs", name = "c", descriptor = "(I)Z", line = 205)
    ...
    @OriginalMember(owner = "client!cs", name = "a", descriptor = "(III)V", line = 248)
    ...
    @OriginalMember(owner = "client!cs", name = "e", descriptor = "(B)V", line = 324)
    public static void method1887(byte arg0) {
        int var1 = -90 / ((26 - arg0) / 40);
        field4304 = null;
    }

    @OriginalMember(owner = "client!cs", name = "<init>", descriptor = "(Llj;)V", line = 337)
    public class311(class565 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!cs", name = "b", descriptor = "(Z)Z", line = 342)
    ...
    @OriginalMember(owner = "client!cs", name = "d", descriptor = "(I)Z", line = 353)
