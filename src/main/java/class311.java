...
public class class311 extends class236 {
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(ILrb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BLrb;)V", line = 28)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Log;I)V", line = 50)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Z)V", line = 216)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)V", line = 227)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(II)V", line = 250)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILhm;Lza;)V", line = 295)
    ...
    @OriginalMember(owner = "client!os", name = "c", descriptor = "(II)V", line = 310)
    ...
    @OriginalMember(owner = "client!os", name = "d", descriptor = "(II)Z", line = 336)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILrb;)V", line = 347)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZZI)V", line = 384)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZILya;FI)V", line = 413)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BI)V", line = 436)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)V", line = 457)
