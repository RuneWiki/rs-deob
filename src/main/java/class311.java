...
public class class311 extends class72 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(Lcq;)V", line = 16)
    public class311(class464 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!vn", name = "d", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 48)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)V", line = 77)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(II)V", line = 88)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(II)I", line = 99)
    public final int method58(int arg0, int arg1) {
        ++field4392;
        return arg1 != 11260 ? -102 : 3;
    }

    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "(ILcq;)V", line = 113)
    public class311(int arg0, class464 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lvk;ILjava/lang/String;I)Lav;", line = 116)
