...
public class class311 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BLfg;)V", line = 8)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 68)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(Lqj;Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "()V", line = 113)
