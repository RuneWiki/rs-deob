...
public class class311 {
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(BIILeb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!de", name = "b", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(Leb;II)V", line = 127)
    ...
    @OriginalMember(owner = "client!de", name = "a", descriptor = "(II)I", line = 159)
