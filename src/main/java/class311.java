...
public class class311 extends class140 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIBLqa;)Lka;", line = 4)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(Z)Z", line = 23)
    ...
    @OriginalMember(owner = "client!os", name = "finalize", descriptor = "()V", line = 34)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(BIILqa;)Z", line = 45)
    ...
    @OriginalMember(owner = "client!os", name = "<init>", descriptor = "(IIIIIIIIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(ZLqa;)V", line = 97)
    ...
    @OriginalMember(owner = "client!os", name = "f", descriptor = "(I)V", line = 119)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(II)I", line = 131)
    public static int method1956(int arg0, int arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIII)V", line = 155)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ZLka;Lqa;)V", line = 181)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILa;IIILqa;Z)V", line = 210)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(B)I", line = 221)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(ILqa;)Lou;", line = 232)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIIIIB)V", line = 265)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIIII)V", line = 453)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(BI)V", line = 469)
    ...
    @OriginalMember(owner = "client!os", name = "b", descriptor = "(I)V", line = 499)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(Lub;IBI)V", line = 513)
