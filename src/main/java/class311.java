...
public class class311 extends class19 implements class324 {
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!haa", name = "j", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ILjw;Lha;BIZI)V", line = 55)
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(I)Z", line = 89)
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(B)I", line = 100)
    ...
    @OriginalMember(owner = "client!haa", name = "e", descriptor = "(B)Z", line = 112)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IZLha;I)Lmg;", line = 129)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(B)I", line = 163)
    ...
    @OriginalMember(owner = "client!haa", name = "c", descriptor = "(B)V", line = 175)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(B)I", line = 189)
    public final int method604(byte arg0) {
        ++field4222;
        return arg0 != 94 ? -120 : this.field4204;
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BLha;)Lqs;", line = 200)
    ...
    @OriginalMember(owner = "client!haa", name = "g", descriptor = "(I)I", line = 233)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IIILha;)Z", line = 253)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)Z", line = 274)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;II)Lka;", line = 288)
    ...
    @OriginalMember(owner = "client!haa", name = "g", descriptor = "(B)Z", line = 308)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lha;Lrq;IIIIIZIIZ)V", line = 322)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lha;I)V", line = 357)
    ...
    @OriginalMember(owner = "client!haa", name = "e", descriptor = "(I)V", line = 387)
    ...
    @OriginalMember(owner = "client!haa", name = "c", descriptor = "(BLha;)Lro;", line = 402)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(BLha;)V", line = 422)
