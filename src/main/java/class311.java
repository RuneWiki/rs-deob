...
public class class311 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(III)Z", line = 18)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIIIII[II)Z", line = 32)
