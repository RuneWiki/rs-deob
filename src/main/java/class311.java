...
public class class311 {
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(BII[I[ILsv;)Lap;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(II)Lgj;")
    ...
    @OriginalMember(owner = "client!lq", name = "a", descriptor = "(IIBZILfq;I)V")
    ...
    @OriginalMember(owner = "client!lq", name = "<init>", descriptor = "(Luea;ILpq;)V")
