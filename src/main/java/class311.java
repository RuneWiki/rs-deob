...
public class class311 extends class292 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "([[BILja;[[BIBIII[[BI[ZLml;Lsb;)V", line = 11)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Lrn;Lmb;IIIBLja;II)V", line = 491)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(II)Lga;", line = 591)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IB)V", line = 617)
    ...
    @OriginalMember(owner = "client!gg", name = "c", descriptor = "(I)V", line = 639)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(ZI)V", line = 650)
