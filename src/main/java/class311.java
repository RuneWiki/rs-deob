...
public class class311 extends class221 implements class19 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "()I", line = 4)
    public final int method139() {
        return super.method139();
    }

    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(III)V", line = 7)
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(Lnf;I[BIZ)V", line = 10)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I[BI)V", line = 15)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "()V", line = 21)
