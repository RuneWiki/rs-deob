...
public abstract class class311 extends class41 {
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(IIIZZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lat;III)V", line = 20)
    ...
    @OriginalMember(owner = "client!qd", name = "h", descriptor = "(I)V", line = 50)
