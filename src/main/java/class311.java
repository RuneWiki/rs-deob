...
public class class311 extends class218 {
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gaa", name = "e", descriptor = "(B)I", line = 18)
    public final int method1511(byte arg0) {
        field4618++;
        return arg0 <= 103 ? 58 : this.field4623;
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)I", line = 29)
    ...
    @OriginalMember(owner = "client!gaa", name = "d", descriptor = "(B)I", line = 49)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(B)J", line = 61)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)I", line = 71)
