...
public class class311 extends class489 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(CIIIZLea;II)V")
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Ljs;Lje;[Lgu;[I[I)V")
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V")
