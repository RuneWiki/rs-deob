...
public class class311 extends class281 {
    ...
    @OriginalMember(owner = "client!tr", name = "d", descriptor = "(B)I", line = 35)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljp;II)V", line = 49)
    ...
    @OriginalMember(owner = "client!tr", name = "e", descriptor = "(I)Ljava/lang/String;", line = 124)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljp;I)Ljava/lang/String;", line = 149)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(III)I", line = 177)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ljp;[II)V", line = 195)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Ljp;I)V", line = 227)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)Lmt;", line = 251)
