...
public class class311 extends class478 {
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ZI)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!bca", name = "c", descriptor = "(I)V", line = 86)
    ...
    @OriginalMember(owner = "client!bca", name = "a", descriptor = "(ILnp;I)V", line = 103)
    ...
    @OriginalMember(owner = "client!bca", name = "<init>", descriptor = "()V", line = 147)
    public class311() {
        super(1, false);
    }

    @OriginalMember(owner = "client!bca", name = "f", descriptor = "(I)I", line = 161)
    ...
    @OriginalMember(owner = "client!bca", name = "b", descriptor = "(II)[I", line = 176)
