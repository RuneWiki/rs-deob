...
public class class311 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BLba;II)Z", line = 9)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZII[[ZIZ)V", line = 80)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIIII)V", line = 262)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILba;B)V", line = 335)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IIILba;)V", line = 411)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)V", line = 483)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lfd;Loq;)V", line = 500)
