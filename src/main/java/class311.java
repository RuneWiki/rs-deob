...
public class class311 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!dj", name = "toString", descriptor = "()Ljava/lang/String;", line = 41)
    public final String toString() {
        field4024++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(I)V", line = 49)
