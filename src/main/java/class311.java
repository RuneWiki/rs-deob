...
public class class311 extends class139 {
    ...
    @OriginalMember(owner = "client!bb", name = "<init>", descriptor = "(Lel;Lpfa;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BILgl;)V")
    ...
    @OriginalMember(owner = "client!bb", name = "a", descriptor = "(BLwv;)V")
