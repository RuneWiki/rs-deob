...
public class class311 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IZLjava/lang/String;)V", line = 22)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I[III)Lep;", line = 39)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BI[I)Lep;", line = 91)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(II)I", line = 111)
    public static final int method1829(int arg0, int arg1) {
        return class285.field3860 == null ? 0 : class285.field3860[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I[III)Lep;", line = 119)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "(Ljn;Ljn;)V", line = 184)
    public class311(class668 arg0, class668 arg1) {
        this.field4105 = arg0;
        this.field4109 = arg1;
    }

    @OriginalMember(owner = "client!gd", name = "a", descriptor = "([IBI)Lep;", line = 165)
