...
public abstract class class311 extends class331 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IBIZZILp;IIILae;II)V")
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lmn;)V")
    public class311(class205 arg0) {
        this.field4391 = arg0;
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Ljava/awt/Canvas;Lul;IIBLrd;)Lae;")
