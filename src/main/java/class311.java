...
public class class311 extends class94 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(J)V", line = 4)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "()V", line = 132)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "()V", line = 141)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(JI)V", line = 151)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lll;IIIIIIIIIIIZZ)V", line = 553)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lll;IIIIIIIIIIIZZ)V", line = 571)
