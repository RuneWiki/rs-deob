...
public class class311 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IILgr;III)V", line = 21)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIIIII)Llf;", line = 146)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z)I", line = 169)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V", line = 188)
