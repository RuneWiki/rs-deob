...
public class class311 extends class172 implements class339 {
    ...
    @OriginalMember(owner = "client!mb", name = "i", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!mb", name = "j", descriptor = "(I)I", line = 14)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILr;I)Z", line = 110)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(BLr;)V", line = 132)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIZII)V", line = 161)
    ...
    @OriginalMember(owner = "client!mb", name = "h", descriptor = "(B)Z", line = 176)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(I)I", line = 187)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(BLr;)V", line = 197)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(ZLr;)V", line = 224)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IILr;)Lda;", line = 235)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZIBLr;Llo;II)V", line = 257)
    ...
    @OriginalMember(owner = "client!mb", name = "b", descriptor = "(B)I", line = 288)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(B)I", line = 302)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Lr;I)Lsd;", line = 312)
    ...
    @OriginalMember(owner = "client!mb", name = "d", descriptor = "(I)V", line = 329)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(B)I", line = 347)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(ZLr;)Log;", line = 359)
    ...
    @OriginalMember(owner = "client!mb", name = "c", descriptor = "(I)I", line = 392)
    ...
    @OriginalMember(owner = "client!mb", name = "g", descriptor = "(B)Z", line = 403)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(I)Z", line = 415)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(IIZLr;)Lkj;", line = 437)
    ...
    @OriginalMember(owner = "client!mb", name = "i", descriptor = "(B)V", line = 469)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Z)V", line = 482)
    ...
    @OriginalMember(owner = "client!mb", name = "e", descriptor = "(B)Z", line = 497)
    ...
    @OriginalMember(owner = "client!mb", name = "a", descriptor = "(Les;ZI)V", line = 512)
    ...
    @OriginalMember(owner = "client!mb", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZIIIIIIZ)V", line = 534)
