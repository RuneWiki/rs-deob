...
public class class311 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIIIII)Z", line = 9)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(ILjf;IB)V", line = 71)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z)Z", line = 89)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Lre;I)I", line = 122)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BI)V", line = 160)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Loj;I)V", line = 174)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 199)
