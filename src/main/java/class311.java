...
public class class311 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ILjo;)Lug;", line = 15)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lbfa;[I[II[I)V", line = 154)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "([BB)Ljava/lang/String;", line = 258)
    public static final String method2051(byte[] arg0, byte arg1) {
        field4696++;
        return arg1 == 15 ? class33.method168(true, arg0, 0, arg0.length) : null;
    }

    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(Lla;Lla;)V", line = 272)
    public class311(class422 arg0, class422 arg1) {
        this.field4691 = arg0;
        this.field4690 = arg1;
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)Lbga;", line = 286)
