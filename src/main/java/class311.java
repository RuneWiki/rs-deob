...
public class class311 extends class206 {
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(ILcn;)Lcn;", line = 28)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(Ljava/lang/String;Z[BI)I", line = 58)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(BLeu;)I", line = 102)
    ...
    @OriginalMember(owner = "client!pfa", name = "a", descriptor = "(IILha;Z)Ldaa;", line = 138)
    ...
    @OriginalMember(owner = "client!pfa", name = "<init>", descriptor = "(I[B)V", line = 206)
