...
public class class587 extends class60 {
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(B)Z", line = 24)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)I", line = 47)
    public final int method405(boolean arg0) {
        ++field7991;
        return arg0 ? -85 : 1;
    }

    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(ILhd;)V", line = 58)
    public class587(int arg0, class773 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BI)V", line = 63)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(II)I", line = 74)
    public final int method406(int arg0, int arg1) {
        ++field7993;
        return arg0 != arg1 && super.field798.field10677.method3451(0) != 1 ? 2 : 1;
    }

    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lhd;)V", line = 87)
    public class587(class773 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)V", line = 101)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(B)V", line = 130)
