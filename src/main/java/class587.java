...
public class class587 {
    ...
    @OriginalMember(owner = "client!saa", name = "a", descriptor = "(ZLjagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
    ...
    @OriginalMember(owner = "client!saa", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V")
