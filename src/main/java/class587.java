...
public class class587 {
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(Lff;JZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(JI)Lff;", line = 51)
    ...
    @OriginalMember(owner = "client!bs", name = "a", descriptor = "(I)Lff;", line = 88)
    ...
    @OriginalMember(owner = "client!bs", name = "<init>", descriptor = "(I)V", line = 123)
