...
public class class587 extends class25 {
    ...
    @OriginalMember(owner = "client!at", name = "d", descriptor = "(B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IIILjava/lang/String;Ljava/lang/String;BLjava/lang/String;)V", line = 15)
    ...
    @OriginalMember(owner = "client!at", name = "i", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 56)
    ...
    @OriginalMember(owner = "client!at", name = "f", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IB)Z", line = 82)
    ...
    @OriginalMember(owner = "client!at", name = "<init>", descriptor = "(Lgj;Ljava/lang/Object;I)V", line = 96)
    public class587(class96 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field8251 = arg1;
    }

    @OriginalMember(owner = "client!at", name = "a", descriptor = "(IIILdfa;)V", line = 106)
