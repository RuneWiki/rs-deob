...
public class class587 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(II)V", line = 4)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BI)Laaa;", line = 25)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IB)V", line = 54)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 75)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILhw;IIII)Lin;", line = 92)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!tv", name = "<init>", descriptor = "(Lpo;ILgda;)V", line = 142)
