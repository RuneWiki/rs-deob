...
public class class587 extends class288 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B)Los;", line = 3)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIIILdd;Lba;)V", line = 15)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(B[BI)[B", line = 29)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(ZI)I", line = 45)
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lrt;Lcp;IIIIIIIII)V", line = 62)
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(I)V", line = 71)
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)V", line = 88)
    ...
    @OriginalMember(owner = "client!tq", name = "c", descriptor = "(I)V", line = 132)
