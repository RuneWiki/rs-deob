...
public class class587 extends class497 {
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(ILpp;)V")
    ...
    @OriginalMember(owner = "client!fa", name = "<init>", descriptor = "(Lpp;)V")
    public class587(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!fa", name = "a", descriptor = "(Lvo;BLha;)V")
