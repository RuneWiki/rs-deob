...
public class class587 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(IILjava/lang/String;Ljava/lang/String;)Ljava/io/File;", line = 32)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILjava/lang/String;)Ljava/io/File;", line = 137)
