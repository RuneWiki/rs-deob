...
public class class587 implements class749 {
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(IIZB)V")
    ...
    @OriginalMember(owner = "client!nw", name = "b", descriptor = "(I)Z")
    ...
    @OriginalMember(owner = "client!nw", name = "a", descriptor = "(I)Lmk;")
    ...
    @OriginalMember(owner = "client!nw", name = "<init>", descriptor = "(Lni;Ljava/lang/String;)V")
