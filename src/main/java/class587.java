...
public class class587 {
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(BLbv;Lbv;F)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!ug", name = "a", descriptor = "(ILcca;IILka;I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ug", name = "b", descriptor = "(I)Z", line = 108)
    ...
    @OriginalMember(owner = "client!ug", name = "<init>", descriptor = "(Lffa;)V", line = 133)
