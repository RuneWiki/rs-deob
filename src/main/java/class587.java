...
public class class587 extends class20 {
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(ZBI)V", line = 12)
    ...
    @OriginalMember(owner = "client!lk", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!lk", name = "a", descriptor = "(IIIZ)[B", line = 42)
    ...
    @OriginalMember(owner = "client!lk", name = "<init>", descriptor = "()V", line = 54)
    public class587() {
