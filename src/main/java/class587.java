...
public class class587 {
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Z)V", line = 104)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(B)Z", line = 136)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(Lqk;BZ)V", line = 153)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ILss;)I", line = 223)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(I)V", line = 250)
    ...
    @OriginalMember(owner = "client!tv", name = "b", descriptor = "(Z)I", line = 277)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(B)V", line = 288)
    ...
    @OriginalMember(owner = "client!tv", name = "c", descriptor = "(Z)V", line = 301)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(I)Z", line = 329)
    ...
    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(BIZII)Lfea;", line = 605)
    ...
    @OriginalMember(owner = "client!tv", name = "d", descriptor = "(Z)Z", line = 648)
    ...
    @OriginalMember(owner = "client!tv", name = "e", descriptor = "(I)I", line = 659)
    public final int method3276(int arg0) {
        field7829++;
        return arg0 == 0 ? this.field7817.method696(arg0 - 14980) + this.field7836.method696(-14980) : -69;
    }

    @OriginalMember(owner = "client!tv", name = "a", descriptor = "(ZI)V", line = 670)
