...
public class class587 {
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Lnp;Z)Lkh;", line = 6)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!nc", name = "a", descriptor = "(BIIIIIII)V", line = 38)
