...
public class class587 {
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "([[[Laf;IIBZI)Z", line = 8)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(B)V", line = 326)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(II)I", line = 337)
    ...
    @OriginalMember(owner = "client!eg", name = "a", descriptor = "(IIIIZ)V", line = 362)
