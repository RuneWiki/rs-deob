...
public class class587 implements class149 {
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(Z)I", line = 3)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IB)Lrba;", line = 31)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)Llba;", line = 55)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(II)Z", line = 66)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(FIZIII)[I", line = 85)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(IZIBFI)[I", line = 102)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(ZIZFII)[F", line = 117)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Leq;Leq;Leq;)V", line = 131)
