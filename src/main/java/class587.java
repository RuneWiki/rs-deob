...
public class class587 {
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(I)Lqm;")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(B)[Ldj;")
    ...
    @OriginalMember(owner = "client!rha", name = "b", descriptor = "(I)Lqm;")
    ...
    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(Ljc;II)Z")
    ...
    @OriginalMember(owner = "client!rha", name = "<init>", descriptor = "(Lmr;)V")
    public class587(class611 arg0) {
        this.field8361 = arg0;
    }

    @OriginalMember(owner = "client!rha", name = "a", descriptor = "(ILmr;)V")
