...
public class class587 {
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILoa;ILq;IIZLba;I)V", line = 19)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(IZ)V", line = 57)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Lmca;Z)Z", line = 70)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(B)V", line = 186)
    ...
    @OriginalMember(owner = "client!mda", name = "finalize", descriptor = "()V", line = 199)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ILoa;)V", line = 211)
    ...
    @OriginalMember(owner = "client!mda", name = "<init>", descriptor = "(Loa;Lsa;IIIIIIZI)V", line = 647)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(II)V", line = 231)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(Loa;IZIZII)Lba;", line = 350)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(III)V", line = 488)
    ...
    @OriginalMember(owner = "client!mda", name = "b", descriptor = "(B)I", line = 610)
    ...
    @OriginalMember(owner = "client!mda", name = "a", descriptor = "(ZLoa;)V", line = 621)
