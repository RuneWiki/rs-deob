...
public class class587 extends class642 {
    ...
    @OriginalMember(owner = "client!pa", name = "b", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILgk;)Lvt;", line = 52)
    ...
    @OriginalMember(owner = "client!pa", name = "<init>", descriptor = "()V", line = 67)
    public class587() {
        super(3, false);
    }
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(ILgk;B)V", line = 84)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(II)[[I", line = 120)
    ...
    @OriginalMember(owner = "client!pa", name = "a", descriptor = "(Z)V", line = 183)
