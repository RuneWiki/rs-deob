...
public class class587 extends class498 {
    ...
    @OriginalMember(owner = "client!via", name = "c", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(BII[I[J)V", line = 17)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(III)V", line = 81)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(II)I", line = 93)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(IIZLjava/lang/String;I)V", line = 104)
    ...
    @OriginalMember(owner = "client!via", name = "b", descriptor = "(III)V", line = 239)
    ...
    @OriginalMember(owner = "client!via", name = "<init>", descriptor = "(IIIIII)V", line = 258)
    ...
    @OriginalMember(owner = "client!via", name = "a", descriptor = "(BII)V", line = 270)
    public final void method157(byte arg0, int arg1, int arg2) {
        int var4 = -67 % ((arg0 - 53) / 49);
        ++field8310;
    }

    @OriginalMember(owner = "client!via", name = "a", descriptor = "(B)V", line = 281)
