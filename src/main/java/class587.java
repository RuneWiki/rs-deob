...
public class class587 extends class283 {
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!oea", name = "f", descriptor = "(I)I", line = 60)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(ZI)I", line = 75)
    ...
    @OriginalMember(owner = "client!oea", name = "e", descriptor = "(I)J", line = 87)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(IIB)Z", line = 98)
    ...
    @OriginalMember(owner = "client!oea", name = "a", descriptor = "(Z)I", line = 109)
    ...
    @OriginalMember(owner = "client!oea", name = "b", descriptor = "(B)V", line = 121)
