...
public class class587 extends class444 {
    ...
    @OriginalMember(owner = "client!ag", name = "<init>", descriptor = "(Ljaggl/OpenGL;Ljava/awt/Canvas;JLn;Lkda;I)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(I[Lwj;)Lsk;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZZ)Laf;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lgf;III)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZLsk;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLgf;IIIILaf;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZI)Lql;")
    ...
    @OriginalMember(owner = "client!ag", name = "f", descriptor = "(II)Lgl;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lqba;Lqba;FLqba;)Lqba;")
    public final class345 method439(class345 arg0, class345 arg1, float arg2, class345 arg3) {
        ++field8634;
        return !(arg2 < 0.5F) ? arg1 : arg0;
    }

    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIZ[[I)Lwv;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIB[FIIZLaq;)Ljb;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "([BLaq;ZIIIIZ)Ljb;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ZIBZLhm;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Laq;IIII[B)Lvi;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(Lql;IB)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IIII[IZI)Ljb;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IFII[BFIIFILmba;IFF)V")
    ...
    @OriginalMember(owner = "client!ag", name = "o", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLee;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IILui;ILaq;)Ljb;")
    ...
    @OriginalMember(owner = "client!ag", name = "y", descriptor = "()Lcr;")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(IZILhm;)V")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(ILaq;Lui;)Z")
    ...
    @OriginalMember(owner = "client!ag", name = "a", descriptor = "(BLui;Laq;)Z")
