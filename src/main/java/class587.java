...
public class class587 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(IZLbr;Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(III)Z", line = 64)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(ZZZ)V", line = 87)
    ...
    @OriginalMember(owner = "client!pf", name = "b", descriptor = "(I)V", line = 114)
