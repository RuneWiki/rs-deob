...
public class class587 extends class242 {
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lpfa;B)V")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIILld;IIIIIII)Z")
    ...
    @OriginalMember(owner = "client!tq", name = "b", descriptor = "(I)Lqca;")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(IIZZLsaa;Lsaa;B)I")
    ...
    @OriginalMember(owner = "client!tq", name = "a", descriptor = "(Lpv;IIII)V")
    ...
    @OriginalMember(owner = "client!tq", name = "<init>", descriptor = "(Lkea;IIIIII)V")
