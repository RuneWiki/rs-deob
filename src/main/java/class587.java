...
public class class587 {
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!dw", name = "a", descriptor = "(II)Lrn;", line = 39)
    ...
    @OriginalMember(owner = "client!dw", name = "<init>", descriptor = "(ILae;Lae;)V", line = 71)
