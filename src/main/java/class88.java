...
public class class88 extends class46 {
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 27)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(B)Ljava/lang/Object;", line = 84)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZII)V", line = 95)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lwm;ILjava/lang/String;Z)V", line = 124)
    ...
    @OriginalMember(owner = "client!kq", name = "g", descriptor = "(I)V", line = 153)
    ...
    @OriginalMember(owner = "client!kq", name = "f", descriptor = "(I)Z", line = 181)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "(Lwa;Ljava/lang/Object;)V", line = 192)
    public class88(class407 arg0, Object arg1) {
        super(arg0);
        this.field1001 = arg1;
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Lal;Llh;BILjava/awt/Canvas;I)Lvm;", line = 205)
    ...
    @OriginalMember(owner = "client!kq", name = "h", descriptor = "(I)V", line = 248)
