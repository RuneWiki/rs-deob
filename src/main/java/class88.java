...
public class class88 extends class328 implements class191 {
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lrda;Leu;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(II[FILeu;IIII)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I[BIIIIILeu;I)V")
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lla;ILha;)V")
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lrda;Leu;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lrda;Leu;Lpj;II)V")
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(Lrda;IIZ[III)V")
