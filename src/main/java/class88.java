...
public abstract class class88 implements class717 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFFFIIIII)V")
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(IIIIIII)V")
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFFFFFIII)V")
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFII)V")
    ...
    @OriginalMember(owner = "client!oia", name = "b", descriptor = "(IIII)V")
    public final void method666(int arg0, int arg1, int arg2, int arg3) {
        this.method673(arg0, arg1, arg2, arg3, 1, 0, 1);
    }

    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFFFFFLaa;II)V")
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "(IIII)V")
    public final void method668(int arg0, int arg1, int arg2, int arg3) {
        this.method674(arg0, arg1, arg2, arg3, 1, 0, 1, 1);
    }

    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFIIIII)V")
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFIILaa;II)V")
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(FFFFIILaa;II)V")
