...
public class class88 extends class62 {
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(II)[I", line = 18)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IB)[[I", line = 51)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lmw;)V", line = 99)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lgw;II)V", line = 191)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "()V", line = 211)
    public class88() {
        super(1, false);
    }

    @OriginalMember(owner = "client!jt", name = "h", descriptor = "(I)V", line = 214)
