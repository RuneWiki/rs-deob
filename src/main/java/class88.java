...
public class class88 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)V", line = 8)
    public static void method525(int arg0) {
        int var1 = 14 / ((25 - arg0) / 41);
        field1155 = null;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIILvq;I)V", line = 60)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(IIIIB)V", line = 175)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(Lhq;I)V", line = 186)
