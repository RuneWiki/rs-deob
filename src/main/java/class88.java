...
public class class88 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(B)Lbo;", line = 18)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 29)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(I)V", line = 66)
