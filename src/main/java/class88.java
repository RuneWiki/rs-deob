...
public class class88 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(I)Lvba;", line = 5)
    public final class40 method609(int arg0) {
        field926++;
        return arg0 == 0 ? class299.method1770(true, this.field924) : null;
    }

    @OriginalMember(owner = "client!oia", name = "b", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(IB)Loia;", line = 29)
    ...
    @OriginalMember(owner = "client!oia", name = "<init>", descriptor = "(II)V", line = 45)
