...
public class class88 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)Lmt;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(B)Lmt;")
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(B)Lmt;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(ILmt;)V")
