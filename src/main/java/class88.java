...
public class class88 extends class525 {
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(IB)I", line = 23)
    public static final int method657(int arg0, byte arg1) {
        field1419++;
        return arg1 == 97 ? arg0 & 0xFF : 91;
    }

    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IZ)Z", line = 35)
