...
public class class88 extends InputStream {
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(III)Z", line = 22)
    ...
    @OriginalMember(owner = "client!nf", name = "read", descriptor = "()I", line = 33)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(IIIBI[ILir;IIIIIZ[II)I", line = 42)
    ...
    @OriginalMember(owner = "client!nf", name = "a", descriptor = "(CI)Z", line = 218)
