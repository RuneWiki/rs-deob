...
public class class88 extends class656 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(III)Lcj;")
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Lrc;Lda;Lha;BZLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!iia", name = "c", descriptor = "(Z)V")
