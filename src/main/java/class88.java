...
public class class88 extends class359 {
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIZII)I", line = 33)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IZZII)Lra;", line = 105)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(II)V", line = 136)
    ...
    @OriginalMember(owner = "client!hq", name = "<init>", descriptor = "(I[B)V", line = 150)
