...
public class class88 extends class440 {
    ...
    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!qda", name = "g", descriptor = "(I)Lvd;", line = 16)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(II)[[I", line = 30)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(ILmo;I)V", line = 164)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)V", line = 202)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IB)V", line = 214)
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "()V", line = 236)
    public class88() {
        super(3, false);
    }

    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(BI)[I", line = 246)
