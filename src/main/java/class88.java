...
public class class88 extends class266 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IILaa;II)V")
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(IIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "([I[III)V")
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIIII)V")
    ...
    @OriginalMember(owner = "client!ev", name = "b", descriptor = "(II)V")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Led;[IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Led;[III)V")
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Led;II)V")
    public class88(class59 arg0, int arg1, int arg2) {
        super(arg0, arg1, arg2);
        this.field1232 = new int[arg1 * arg2];
    }

    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IIIIIIIII)V")
