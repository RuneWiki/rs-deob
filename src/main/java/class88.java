...
public class class88 {
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IZILbu;)Let;")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(IILvj;Ljava/lang/String;)Lhq;")
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lvj;J[Lhq;)V")
