...
public class class88 extends class298 {
    ...
    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IILvt;)V", line = 3)
    ...
    @OriginalMember(owner = "client!nh", name = "e", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!nh", name = "d", descriptor = "(III)Lqa;", line = 44)
    ...
    @OriginalMember(owner = "client!nh", name = "<init>", descriptor = "()V", line = 71)
    public class88() {
        super(0, true);
    }

    @OriginalMember(owner = "client!nh", name = "a", descriptor = "(IZ)[I", line = 75)
