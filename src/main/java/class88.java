...
public class class88 extends class282 {
    ...
    @OriginalMember(owner = "client!wf", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!wf", name = "g", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(I)[B", line = 49)
