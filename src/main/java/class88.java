...
public class class88 {
    ...
    @OriginalMember(owner = "client!wf", name = "<init>", descriptor = "(Lmt;ILhh;)V")
    ...
    @OriginalMember(owner = "client!wf", name = "a", descriptor = "(Ldb;I)Z")
    ...
    @OriginalMember(owner = "client!wf", name = "b", descriptor = "(II)Loi;")
