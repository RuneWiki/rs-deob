...
public class class88 implements class291 {
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IB)V", line = 17)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!er", name = "e", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILrr;I)V", line = 87)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IILdca;)V", line = 118)
    ...
    @OriginalMember(owner = "client!er", name = "<init>", descriptor = "(Lmh;)V", line = 404)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(Z)V", line = 153)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BI)V", line = 166)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIIZ[BI)V", line = 184)
    ...
    @OriginalMember(owner = "client!er", name = "c", descriptor = "(B)I", line = 217)
    public final int method521(byte arg0) {
        field1065++;
        return arg0 == -26 ? this.field1064 : 69;
    }

    @OriginalMember(owner = "client!er", name = "f", descriptor = "(I)Z", line = 232)
    ...
    @OriginalMember(owner = "client!er", name = "d", descriptor = "(I)V", line = 253)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(ILrr;I)V", line = 268)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(IIILkh;I)V", line = 281)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(II)V", line = 314)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BIILkh;)V", line = 332)
    ...
    @OriginalMember(owner = "client!er", name = "finalize", descriptor = "()V", line = 344)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(BLjava/lang/String;)I", line = 356)
    ...
    @OriginalMember(owner = "client!er", name = "a", descriptor = "(I)V", line = 376)
    ...
    @OriginalMember(owner = "client!er", name = "b", descriptor = "(I)V", line = 389)
