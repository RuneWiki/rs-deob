...
public class class88 extends class354 {
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!kc", name = "<init>", descriptor = "()V", line = 91)
    public class88() {
        super(0, true);
    }

    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lnj;II)V", line = 94)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(BI)[I", line = 143)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)V", line = 264)
    ...
    @OriginalMember(owner = "client!kc", name = "g", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!kc", name = "c", descriptor = "(B)V", line = 291)
