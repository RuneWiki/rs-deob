...
public class class88 extends class330 {
    ...
    @OriginalMember(owner = "client!fj", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "d", descriptor = "(B)V", line = 13)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IZ)[I", line = 24)
    ...
    @OriginalMember(owner = "client!fj", name = "b", descriptor = "(Z)V", line = 158)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 183)
    public class88() {
        super(0, true);
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lsha;III)V", line = 189)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Lgga;IB)V", line = 222)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Loq;IIIII)V", line = 283)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Loq;Z[[[BIB)Z", line = 372)
