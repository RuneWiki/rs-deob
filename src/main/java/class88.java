...
public class class88 extends class318 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lya;IILjt;II)V")
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lkd;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lav;IB)V")
