...
public class class88 {
    ...
    @OriginalMember(owner = "client!oia", name = "a", descriptor = "(Leq;II)Loia;")
    ...
    @OriginalMember(owner = "client!oia", name = "c", descriptor = "()Lcj;")
    ...
    @OriginalMember(owner = "client!oia", name = "<init>", descriptor = "(Lud;)V")
