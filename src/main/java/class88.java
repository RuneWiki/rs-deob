...
public class class88 extends class398 {
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZLii;Llm;)V", line = 4)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lwd;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "()V", line = 114)
    public class88() {
        super(0, true);
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IIIB)I", line = 118)
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(B)V", line = 143)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(II)[I", line = 187)
    public final int[] method95(int arg0, int arg1) {
        field1235++;
        return arg1 == 0 ? class375.field5448 : null;
    }

    @OriginalMember(owner = "client!hp", name = "f", descriptor = "(I)V", line = 207)
