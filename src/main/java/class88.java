...
public class class88 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(BZIIIIZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(IFFF)F", line = 86)
