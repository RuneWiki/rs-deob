...
public class class88 extends class71 {
    ...
    @OriginalMember(owner = "client!jc", name = "o", descriptor = "Llf;")
    public static class109 field1825 = class35.method275("<)4col>", 2);

    @OriginalMember(owner = "client!jc", name = "u", descriptor = "Llf;")
    private static class109 field1831 = class35.method275("RuneScape has been updated(Q", 2);

    @OriginalMember(owner = "client!jc", name = "A", descriptor = "Llf;")
    public static class109 field1837 = class35.method275(")1", 2);

    @OriginalMember(owner = "client!jc", name = "w", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!jc", name = "D", descriptor = "Llf;")
    private static class109 field1840 = class35.method275(" from your ignore list first)3", 2);

    @OriginalMember(owner = "client!jc", name = "y", descriptor = "Llf;")
    public static class109 field1835 = class35.method275("Fallen lassen", 2);

    @OriginalMember(owner = "client!jc", name = "x", descriptor = "Llf;")
    public static class109 field1834 = field1840;

    @OriginalMember(owner = "client!jc", name = "E", descriptor = "[Llf;")
    ...
    @OriginalMember(owner = "client!jc", name = "p", descriptor = "Llf;")
