...
public class class88 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IIIII[III)V", line = 192)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)[B", line = 296)
