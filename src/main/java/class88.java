...
public class class88 extends class449 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wl", name = "<init>", descriptor = "(Lid;)V", line = 120)
    public class88(class266 arg0) {
        this.field1234 = arg0;
    }

    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(Lnl;ILnl;)V", line = 34)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(II)I", line = 46)
    public static int method739(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(II)Lha;", line = 54)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(B)V", line = 105)
