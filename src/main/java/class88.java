...
public class class88 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIILfs;)Lgt;", line = 5)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lti;I)V", line = 22)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIIIIIIB)V", line = 47)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Ljava/lang/String;Z)Z", line = 258)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(I)V", line = 290)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IB)V", line = 307)
