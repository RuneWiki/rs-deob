...
public class class88 extends class60 {
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ie", name = "<init>", descriptor = "(IIIIII)V", line = 20)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ie", name = "a", descriptor = "()V", line = 45)
    ...
    @OriginalMember(owner = "client!ie", name = "b", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!ie", name = "c", descriptor = "(III)V", line = 236)
