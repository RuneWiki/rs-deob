...
public class class88 extends class141 {
    ...
    @OriginalMember(owner = "client!d", name = "j", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!d", name = "m", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I[ILd;[I[I)V", line = 28)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lr;I)Lej;", line = 129)
    ...
    @OriginalMember(owner = "client!d", name = "d", descriptor = "(B)Z", line = 258)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IILr;)Z", line = 275)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(Z)I", line = 443)
    ...
    @OriginalMember(owner = "client!d", name = "c", descriptor = "(ILr;)V", line = 464)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(ILjava/lang/String;)I", line = 492)
    ...
    @OriginalMember(owner = "client!d", name = "d", descriptor = "(Z)I", line = 517)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(II[B)[B", line = 540)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIZIII)V", line = 554)
    ...
    @OriginalMember(owner = "client!d", name = "c", descriptor = "(I)I", line = 639)
    ...
    @OriginalMember(owner = "client!d", name = "g", descriptor = "(I)Z", line = 661)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lvj;IZLr;IIB)V", line = 672)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ZLce;)V", line = 688)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(ILr;)Leh;", line = 703)
    public final class203 method631(int arg0, class98 arg1) {
        ++field1312;
        return arg0 != 1 ? null : null;
    }

    @OriginalMember(owner = "client!d", name = "n", descriptor = "(I)Z", line = 723)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IILr;B)Z", line = 734)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(III)V", line = 789)
