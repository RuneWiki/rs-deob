...
public class class88 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILmea;B)Ljava/lang/String;", line = 31)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILd;BILjava/awt/Canvas;)Lha;", line = 55)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IIII)Lgv;", line = 68)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(BIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)Llu;", line = 113)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(IIIIB)V", line = 139)
