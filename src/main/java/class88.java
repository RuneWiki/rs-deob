...
public class class88 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIIIILya;I)Lt;", line = 6)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(B)V", line = 53)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IIB)Z", line = 117)
