...
public class class88 extends class57 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Ljava/awt/Canvas;B)V", line = 11)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIIILjava/awt/Graphics;I)V", line = 33)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IBLjava/awt/Graphics;I)V", line = 49)
