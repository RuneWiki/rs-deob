...
public class class88 extends class379 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILes;)Lta;", line = 6)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "([Lgda;II)V", line = 29)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ILmh;III)V", line = 67)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)V", line = 122)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(Z)V", line = 176)
