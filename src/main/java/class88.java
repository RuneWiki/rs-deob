...
public class class88 extends class184 implements class204 {
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IIIIBLha;I)Lka;", line = 47)
    ...
    @OriginalMember(owner = "client!iia", name = "e", descriptor = "(I)V", line = 95)
    ...
    @OriginalMember(owner = "client!iia", name = "c", descriptor = "(I)I", line = 106)
    public final int method711(int arg0) {
        field1254++;
        return arg0 == 10196 ? this.field1250 : -30;
    }

    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(B)C", line = 117)
    public final char method712(byte arg0) {
        field1251++;
        return arg0 == -92 ? this.field1252 : '\u0006';
    }

    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(II)Z", line = 130)
    ...
    @OriginalMember(owner = "client!iia", name = "b", descriptor = "(I)I", line = 149)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(I)I", line = 161)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(B)J", line = 178)
    ...
    @OriginalMember(owner = "client!iia", name = "a", descriptor = "(IIIBIII)V", line = 196)
