...
public class class88 {
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Luo;[IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Luo;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!oe", name = "a", descriptor = "(Luo;[II)V")
