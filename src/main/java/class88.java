...
public class class88 extends class361 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lwm;II)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "([ILwm;B)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "([SB[Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)Lmt;")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(Lwm;I)V")
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(BLwm;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!hu", name = "e", descriptor = "(B)V")
