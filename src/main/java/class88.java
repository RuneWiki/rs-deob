...
public class class88 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BLya;ILza;IZIILvm;Lya;III)Le;", line = 5)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILvm;IILza;I)Le;", line = 18)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILya;IILya;IZLvm;BLza;IIII)Le;", line = 40)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IIZII)V", line = 158)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 193)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(IILug;)V", line = 203)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(Lvm;IIILza;II)Le;", line = 325)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(ILug;)V", line = 355)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)V", line = 389)
