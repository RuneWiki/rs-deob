...
public class class88 extends class403 implements class223 {
    ...
    @OriginalMember(owner = "client!hp", name = "c", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(ILea;)Lms;", line = 17)
    ...
    @OriginalMember(owner = "client!hp", name = "d", descriptor = "(I)Z", line = 58)
    public final boolean method697(int arg0) {
        ++field1240;
        return arg0 < 115;
    }

    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(BLea;)V", line = 69)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(IILea;Lac;ZII)V", line = 79)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(B)V", line = 104)
    ...
    @OriginalMember(owner = "client!hp", name = "<init>", descriptor = "(Lea;Lp;IIIIIIIZI)V", line = 116)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(B)V", line = 125)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lij;B)V", line = 136)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ILea;)V", line = 150)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lea;BI)Lts;", line = 165)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Z)Z", line = 176)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(Lea;I)V", line = 187)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(I)V", line = 206)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(I)I", line = 217)
    ...
    @OriginalMember(owner = "client!hp", name = "a", descriptor = "(ZILea;I)Z", line = 230)
    ...
    @OriginalMember(owner = "client!hp", name = "b", descriptor = "(Z)I", line = 250)
