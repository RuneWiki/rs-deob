...
public class class88 {
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)Z", line = 9)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lij;)V", line = 208)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Z)Z", line = 31)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(Z)V", line = 106)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I[[BLsa;)V", line = 121)
