...
public abstract class class88 {
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(B)Z", line = 48)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(III)Lrq;", line = 105)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(B)D", line = 117)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(ZB)V", line = 138)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(I)Lqb;", line = 164)
    ...
    @OriginalMember(owner = "client!jv", name = "d", descriptor = "(I)V", line = 288)
    ...
    @OriginalMember(owner = "client!jv", name = "c", descriptor = "(B)Llr;", line = 318)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 329)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Z)V", line = 381)
    ...
    @OriginalMember(owner = "client!jv", name = "e", descriptor = "(I)V", line = 501)
    ...
    @OriginalMember(owner = "client!jv", name = "f", descriptor = "(I)V", line = 516)
    ...
    @OriginalMember(owner = "client!jv", name = "g", descriptor = "(I)Lbd;", line = 546)
    ...
    @OriginalMember(owner = "client!jv", name = "d", descriptor = "(B)Z", line = 559)
    ...
    @OriginalMember(owner = "client!jv", name = "<init>", descriptor = "(I)V", line = 588)
    ...
    @OriginalMember(owner = "client!jv", name = "h", descriptor = "(I)Ldfa;", line = 603)
