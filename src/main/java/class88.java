...
public class class88 extends class35 {
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(ILgu;)Z")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(IIILcp;ZLtq;I)V")
    ...
    @OriginalMember(owner = "client!ud", name = "a", descriptor = "(Lre;B)Lub;")
