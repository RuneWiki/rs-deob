...
public class class88 extends class461 {
    ...
    @OriginalMember(owner = "client!qfa", name = "<init>", descriptor = "(IIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!qfa", name = "b", descriptor = "(I)V", line = 23)
    public static void method702(int arg0) {
        int var1 = 45 % ((arg0 - 38) / 57);
        field1335 = null;
    }

    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(III)V", line = 35)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(BII)V", line = 54)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(IIB)V", line = 64)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Ljava/lang/String;ZIZ)I", line = 77)
