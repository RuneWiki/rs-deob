...
public class class645 {
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIII)Lkda;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(II)Lwia;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIIILhq;I)Lwr;")
    ...
    @OriginalMember(owner = "client!lca", name = "a", descriptor = "(IIIIIILha;)V")
    ...
    @OriginalMember(owner = "client!lca", name = "<init>", descriptor = "(Lsj;ILin;)V")
