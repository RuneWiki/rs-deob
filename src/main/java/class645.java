...
public class class645 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILso;I)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IILjs;)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Lso;I)V")
