...
public class class645 {
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lig;Z)V")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(Lha;ZIZ)Lhu;")
    ...
    @OriginalMember(owner = "client!lc", name = "a", descriptor = "(IILig;)V")
