...
public class class645 extends class30 {
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(II)[I", line = 3)
    ...
    @OriginalMember(owner = "client!cj", name = "d", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BII)Z", line = 168)
    ...
    @OriginalMember(owner = "client!cj", name = "b", descriptor = "(B)V", line = 182)
    ...
    @OriginalMember(owner = "client!cj", name = "c", descriptor = "(B)V", line = 198)
    ...
    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(IIZ)Z", line = 215)
    ...
    @OriginalMember(owner = "client!cj", name = "<init>", descriptor = "()V", line = 236)
    public class645() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cj", name = "a", descriptor = "(BILac;)V", line = 249)
