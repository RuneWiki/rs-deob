...
public class class645 extends class334 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)[I", line = 5)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "()V", line = 93)
    public class645() {
        super(1, false);
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILof;)Lof;", line = 103)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ZI)[[I", line = 118)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IZLol;)V", line = 253)
    ...
    @OriginalMember(owner = "client!gl", name = "b", descriptor = "(BI)V", line = 299)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIII)I", line = 351)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)V", line = 367)
