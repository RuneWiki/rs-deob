...
public class class645 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLqc;Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(ZBLpaa;)V", line = 85)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(II)V", line = 112)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Z)V", line = 132)
