...
public class class645 {
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 14)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(B)V", line = 27)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BILfca;I)V", line = 41)
