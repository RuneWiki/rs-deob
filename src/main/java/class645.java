...
public class class645 extends class62 {
    ...
    @OriginalMember(owner = "client!rw", name = "h", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!rw", name = "c", descriptor = "(II)[I", line = 26)
    ...
    @OriginalMember(owner = "client!rw", name = "a", descriptor = "(Lgw;II)V", line = 60)
    ...
    @OriginalMember(owner = "client!rw", name = "b", descriptor = "(III)I", line = 96)
    ...
    @OriginalMember(owner = "client!rw", name = "i", descriptor = "(I)V", line = 112)
    ...
    @OriginalMember(owner = "client!rw", name = "<init>", descriptor = "()V", line = 131)
    public class645() {
        super(1, true);
    }
}
