...
public class class645 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II)V", line = 14)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(II)Lg;", line = 30)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IB)Lgf;", line = 51)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(I)V", line = 121)
    public static void method3698(int arg0) {
        int var1 = -31 / ((arg0 + 49) / 61);
        field9029 = null;
    }

    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(Ljk;ILae;Lae;Lae;)V", line = 136)
