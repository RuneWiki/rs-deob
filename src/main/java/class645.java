...
public class class645 {
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(ZILes;)V")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(BLes;)V")
    ...
    @OriginalMember(owner = "client!iga", name = "a", descriptor = "(Ljava/awt/Frame;Lrj;Z)V")
