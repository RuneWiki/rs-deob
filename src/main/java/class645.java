...
public class class645 extends class449 {
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IZLha;I)Z", line = 5)
    ...
    @OriginalMember(owner = "client!kia", name = "k", descriptor = "(I)I", line = 61)
    ...
    @OriginalMember(owner = "client!kia", name = "i", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!kia", name = "c", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Lha;B)Lhq;", line = 110)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIZIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(BI)V", line = 323)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Lha;I)V", line = 345)
    ...
    @OriginalMember(owner = "client!kia", name = "f", descriptor = "(B)I", line = 378)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(I)I", line = 399)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(III)V", line = 421)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(Lrn;B)V", line = 523)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ZLjava/lang/String;)I", line = 550)
    ...
    @OriginalMember(owner = "client!kia", name = "o", descriptor = "(I)Z", line = 562)
    ...
    @OriginalMember(owner = "client!kia", name = "p", descriptor = "(I)Z", line = 591)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ILsf;Lha;BIIZ)V", line = 605)
    ...
    @OriginalMember(owner = "client!kia", name = "h", descriptor = "(I)Z", line = 616)
    ...
    @OriginalMember(owner = "client!kia", name = "c", descriptor = "(II)Z", line = 626)
    ...
    @OriginalMember(owner = "client!kia", name = "b", descriptor = "(Lha;B)Lpw;", line = 653)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(ZILha;)Z", line = 663)
    ...
    @OriginalMember(owner = "client!kia", name = "a", descriptor = "(IIIIIIII)V", line = 739)
