...
public class class645 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I[Lxa;Ljava/lang/String;I)Ljava/lang/String;", line = 7)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILjava/lang/String;I[Lxa;)I", line = 126)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([Lxa;IILjava/lang/String;)I", line = 152)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)I", line = 163)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(B)[Llc;", line = 182)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Ljava/lang/String;[Lxa;I[Ljava/lang/String;[I)I", line = 199)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILjava/lang/String;)I", line = 448)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(FIIIFFBI)[F", line = 462)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILjava/lang/String;[Lxa;)I", line = 545)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ILjava/lang/String;I[Lxa;I)I", line = 649)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(ICB)I", line = 668)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "([B)V", line = 683)
    ...
    @OriginalMember(owner = "client!ed", name = "b", descriptor = "(B)V", line = 807)
