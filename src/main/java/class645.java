...
public class class645 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(III)I", line = 13)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)[I", line = 40)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lps;)V", line = 325)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "()V", line = 399)
