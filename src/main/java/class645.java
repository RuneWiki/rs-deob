...
public class class645 {
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(IILkj;)V", line = 20)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!ms", name = "a", descriptor = "(BIIIIZ)V", line = 227)
