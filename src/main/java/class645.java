...
public class class645 {
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IIIIILlb;IBIIILda;ILr;)Lda;", line = 11)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(Lr;JZ)V", line = 180)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 214)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!ww", name = "a", descriptor = "(ZI)Lwe;", line = 264)
