...
public class class645 {
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IIIZ)Z", line = 32)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(II)V", line = 167)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(B)V", line = 180)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IB)Leca;", line = 194)
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(Liaa;IIIIIIIIII)Z", line = 515)
