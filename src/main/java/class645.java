...
public class class645 {
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(B)V", line = 8)
    ...
    @OriginalMember(owner = "client!fh", name = "a", descriptor = "(FFFZ)F", line = 26)
    ...
    @OriginalMember(owner = "client!fh", name = "b", descriptor = "(B)V", line = 42)
