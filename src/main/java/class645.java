...
public class class645 extends class206 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Ldf;)V", line = 15)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIIII)V", line = 95)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IB)V", line = 110)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(II)V", line = 126)
