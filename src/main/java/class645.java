...
public class class645 implements class536 {
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IB)I", line = 31)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(Ljava/lang/String;I)I", line = 52)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZI)I", line = 85)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(IIZ)V", line = 97)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(IIZ)V", line = 120)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(B)V", line = 148)
    ...
    @OriginalMember(owner = "client!qo", name = "b", descriptor = "(I)V", line = 174)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(BII)V", line = 187)
    ...
    @OriginalMember(owner = "client!qo", name = "a", descriptor = "(ZB)I", line = 233)
