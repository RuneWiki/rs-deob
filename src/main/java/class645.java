...
public class class645 extends class322 {
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Ljava/lang/String;ZIII)V", line = 18)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!it", name = "c", descriptor = "(I)I", line = 46)
    ...
    @OriginalMember(owner = "client!it", name = "b", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(Lch;)V", line = 119)
    public class645(class463 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(B)I", line = 122)
    ...
    @OriginalMember(owner = "client!it", name = "a", descriptor = "(Z)V", line = 135)
    ...
    @OriginalMember(owner = "client!it", name = "<init>", descriptor = "(ILch;)V", line = 152)
    public class645(int arg0, class463 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!it", name = "a", descriptor = "(II)I", line = 155)
