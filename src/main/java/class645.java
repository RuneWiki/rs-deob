...
public class class645 {
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "()V", line = 18)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(I)V", line = 189)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(BI)Lmh;", line = 204)
    ...
    @OriginalMember(owner = "client!hf", name = "b", descriptor = "(I)V", line = 237)
    ...
    @OriginalMember(owner = "client!hf", name = "a", descriptor = "(IZ)V", line = 252)
    ...
    @OriginalMember(owner = "client!hf", name = "<init>", descriptor = "(Lcr;ILla;)V", line = 272)
