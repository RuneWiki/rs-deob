...
public class class645 extends class159 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(II)V", line = 42)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(IIIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!tl", name = "b", descriptor = "(I)V", line = 240)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(III[[ZI)V", line = 256)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(SB)V", line = 315)
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(B)V", line = 336)
    ...
    @OriginalMember(owner = "client!tl", name = "<init>", descriptor = "(Lee;Lqq;Luaa;[I)V", line = 370)
