...
public class class645 extends class471 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Lha;B)Lkv;")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IIILha;)Z")
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(Lha;B)Lrga;")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(ILjava/lang/String;I)Lhha;")
