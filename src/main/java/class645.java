...
public class class645 extends class439 implements class542 {
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Los;Lhh;III[B)V")
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(I)Ljagdx/IDirect3DBaseTexture;")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Ltd;I)V")
