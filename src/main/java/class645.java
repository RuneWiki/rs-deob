...
public class class645 implements class762 {
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(Z)V", line = 18)
    ...
    @OriginalMember(owner = "client!jia", name = "c", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!jia", name = "b", descriptor = "(I)Z", line = 48)
    ...
    @OriginalMember(owner = "client!jia", name = "d", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!jia", name = "a", descriptor = "(IZ)V", line = 85)
    ...
    @OriginalMember(owner = "client!jia", name = "<init>", descriptor = "(Laj;Lmo;)V", line = 103)
