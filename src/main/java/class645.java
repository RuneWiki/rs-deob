...
public class class645 extends class173 {
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(II)S", line = 4)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lmc;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(Lmc;I)V", line = 47)
    ...
    @OriginalMember(owner = "client!jv", name = "b", descriptor = "(III)Z", line = 84)
    ...
    @OriginalMember(owner = "client!jv", name = "a", descriptor = "(I)V", line = 98)
