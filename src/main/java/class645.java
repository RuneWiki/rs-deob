...
public abstract class class645 implements class101 {
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(ZLui;)V")
    ...
    @OriginalMember(owner = "client!fia", name = "<init>", descriptor = "(Lmba;ILkca;Lwq;IZ)V")
    ...
    @OriginalMember(owner = "client!fia", name = "a", descriptor = "(IIILcs;IIIIILcs;)V")
