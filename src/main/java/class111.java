...
public class class111 extends class237 {
    ...
    @OriginalMember(owner = "client!qha", name = "b", descriptor = "(B)V", line = 30)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(II)I", line = 48)
    public static int method773(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!qha", name = "<init>", descriptor = "(IIIIIFFF)V", line = 59)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(III)V", line = 73)
    ...
    @OriginalMember(owner = "client!qha", name = "c", descriptor = "(I)V", line = 109)
    ...
    @OriginalMember(owner = "client!qha", name = "a", descriptor = "(IBI)V", line = 120)
