...
public class class111 extends class147 {
    ...
    @OriginalMember(owner = "client!lh", name = "H", descriptor = "Llf;")
    public static class109 field2189 = class35.method275("<col=ffff00>", 2);

    @OriginalMember(owner = "client!lh", name = "G", descriptor = "Llf;")
    public static class109 field2188 = class35.method275("<col=ff0000>", 2);

    @OriginalMember(owner = "client!lh", name = "cb", descriptor = "Llf;")
    private static class109 field2210 = class35.method275("Free world", 2);

    @OriginalMember(owner = "client!lh", name = "U", descriptor = "Llf;")
    public static class109 field2202 = field2210;

    @OriginalMember(owner = "client!lh", name = "eb", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)Lue;")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Luc;I)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(Lja;Z)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(ILoh;Lwb;B)V")
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IILja;)V")
