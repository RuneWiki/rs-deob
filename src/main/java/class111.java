...
public class class111 {
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Ljava/lang/String;Ljava/lang/String;IZ)V", line = 4)
    ...
    @OriginalMember(owner = "client!su", name = "toString", descriptor = "()Ljava/lang/String;", line = 50)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(I)V", line = 77)
