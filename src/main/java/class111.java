...
public class class111 implements Runnable {
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(IIBI)Lfp;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(II)Lwfa;")
    ...
    @OriginalMember(owner = "client!ut", name = "a", descriptor = "(ZILag;)V")
