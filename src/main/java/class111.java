...
public class class111 extends class359 {
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(II)Z", line = 43)
    ...
    @OriginalMember(owner = "client!fq", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!fq", name = "a", descriptor = "(IIIBI)V", line = 81)
