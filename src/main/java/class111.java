...
public class class111 extends class313 {
    ...
    @OriginalMember(owner = "client!gb", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!gb", name = "c", descriptor = "(I)Z", line = 17)
    ...
    @OriginalMember(owner = "client!gb", name = "a", descriptor = "(ILre;)V", line = 2903)
