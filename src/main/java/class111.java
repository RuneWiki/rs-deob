...
public class class111 implements Runnable {
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "([IILjava/awt/Component;ILjava/awt/Point;B)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/String;ZI)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/String;B)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(I)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILjava/awt/Frame;)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)Lji;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/Class;[Ljava/lang/Class;Ljava/lang/String;I)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/Class;BLjava/lang/String;)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/String;BIZ)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IILjava/lang/Runnable;)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILjava/lang/String;)Lji;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(BI)Lot;")
    public final class746 method921(byte arg0, int arg1) {
        return arg0 <= 33 ? null : this.method924(0, arg1, -6, null, 3);
    }

    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(ILjava/net/URL;)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIIII)Lot;")
    ...
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(IIILjava/lang/Object;I)Lot;")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!cea", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
