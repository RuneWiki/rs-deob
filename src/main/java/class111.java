...
public abstract class class111 {
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IIII[FII)V", line = 3)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "()V", line = 103)
    public static final void method795() {
        class218.method1337(1, class483.field7381);
    }

    @OriginalMember(owner = "client!gg", name = "b", descriptor = "()V", line = 107)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(I)V", line = 249)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(I)V", line = 267)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(III)Z", line = 285)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 296)
