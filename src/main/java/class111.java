...
public class class111 {
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(B)I", line = 18)
    public static final int method786(byte arg0) {
        field1368++;
        return arg0 == 81 ? class530.field7471 : 96;
    }

    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(B)V", line = 32)
    ...
    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!ri", name = "c", descriptor = "(B)V", line = 62)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(ILjava/util/Random;B)I", line = 79)
    ...
    @OriginalMember(owner = "client!ri", name = "a", descriptor = "(II)V", line = 108)
    ...
    @OriginalMember(owner = "client!ri", name = "<init>", descriptor = "(Lsaa;ILfp;)V", line = 163)
    public class111(class326 arg0, int arg1, class323 arg2) {
        this.field1362 = arg2;
        this.field1367 = this.field1362.method2084(4, 0);
    }

    @OriginalMember(owner = "client!ri", name = "b", descriptor = "(II)Lme;", line = 127)
