...
public class class111 extends class274 implements class285 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lvm;II)Ljn;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lvm;I)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIILhs;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ZLvm;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(BLvm;)V")
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lvm;Lds;IIIIZIIIII)V")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lhd;Z)Z")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILvm;Z)Ljn;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IZLvm;I)Lf;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Lvm;Z)Ldn;")
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIILvm;)Z")
