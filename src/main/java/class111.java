...
public class class111 extends class169 {
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Ltt;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!fd", name = "<init>", descriptor = "(Ltt;IIII[BI)V", line = 20)
    ...
    @OriginalMember(owner = "client!fd", name = "e", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(BIIIIIII)V", line = 50)
    ...
    @OriginalMember(owner = "client!fd", name = "a", descriptor = "(I)V", line = 67)
