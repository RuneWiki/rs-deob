...
public class class111 implements class419 {
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(I)I", line = 4)
    ...
    @OriginalMember(owner = "client!hu", name = "b", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!hu", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;", line = 66)
    ...
    @OriginalMember(owner = "client!hu", name = "<init>", descriptor = "(Lhg;Lvp;Z)V", line = 88)
    ...
    @OriginalMember(owner = "client!hu", name = "c", descriptor = "(I)Lvp;", line = 99)
    ...
    @OriginalMember(owner = "client!hu", name = "d", descriptor = "(I)Z", line = 110)
