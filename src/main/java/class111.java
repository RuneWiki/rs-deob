...
public class class111 extends class337 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(BILhp;)V")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(IIZIIILsm;Lya;IIILt;IZI)Lt;")
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(ILul;)V")
