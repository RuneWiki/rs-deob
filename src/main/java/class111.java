...
public class class111 extends class245 {
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(IIIZ)Ljd;")
    ...
    @OriginalMember(owner = "client!oc", name = "c", descriptor = "(I)Loh;")
    ...
    @OriginalMember(owner = "client!oc", name = "a", descriptor = "(Lwg;Lmo;ILmo;)V")
