...
public class class111 extends class465 implements class36 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(IIBIIIIILr;[[[BIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Z)I", line = 40)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B[BII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ZILcw;II)V", line = 63)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)I", line = 76)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Ler;I[BI)V", line = 87)
    public class111(class92 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field1773 = arg1;
    }

    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(Ler;ILjaclib/memory/Buffer;)V", line = 96)
    public class111(class92 arg0, int arg1, Buffer arg2) {
        super(arg0, arg2);
        this.field1773 = arg1;
    }

    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(Z)I", line = 106)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(Z)J", line = 119)
