...
public class class111 extends class271 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)I", line = 19)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(B)J", line = 54)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)J", line = 65)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "()V", line = 103)
    public class111() {
