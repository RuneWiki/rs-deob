...
public class class111 extends class539 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([B)V", line = 12)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "()I", line = 177)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)[F", line = 188)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lpj;II)Lju;", line = 603)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([I)Lqr;", line = 619)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "([B)V", line = 678)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lpj;)Z", line = 723)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)F", line = 738)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(Lpj;I)Lju;", line = 749)
    ...
    @OriginalMember(owner = "client!ju", name = "f", descriptor = "(I)I", line = 764)
    ...
    @OriginalMember(owner = "client!ju", name = "b", descriptor = "()V", line = 792)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "([BI)V", line = 811)
    ...
    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "([B)V", line = 816)
