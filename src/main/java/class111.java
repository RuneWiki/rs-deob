...
public class class111 {
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lfc;IZI)V", line = 5)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(IIZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Z)V", line = 39)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lat;II)V", line = 57)
    ...
    @OriginalMember(owner = "client!vg", name = "a", descriptor = "(Lat;III)V", line = 83)
