...
public class class111 extends class585 {
    ...
    @OriginalMember(owner = "client!qda", name = "<init>", descriptor = "()V", line = 4)
    public class111() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qda", name = "b", descriptor = "(II)[I", line = 7)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!qda", name = "c", descriptor = "(I)V", line = 226)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "([FIIIIII)V", line = 239)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(Lso;II)V", line = 365)
    ...
    @OriginalMember(owner = "client!qda", name = "a", descriptor = "(IZILph;I)V", line = 444)
    ...
    @OriginalMember(owner = "client!qda", name = "e", descriptor = "(B)V", line = 506)
