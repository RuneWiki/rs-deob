...
public class class111 {
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!iaa", name = "a", descriptor = "(IB)V", line = 20)
    ...
    @OriginalMember(owner = "client!iaa", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 49)
