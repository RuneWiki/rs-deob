...
public class class111 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(I)I", line = 5)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(B)Lri;", line = 19)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(B)Lrg;", line = 80)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BI[Lvg;)V", line = 127)
    ...
    @OriginalMember(owner = "client!gd", name = "c", descriptor = "(B)Lri;", line = 198)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(ZILrg;)V", line = 264)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(III)Lje;", line = 358)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(I)V", line = 373)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)Z", line = 384)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Lrg;I)V", line = 414)
    ...
    @OriginalMember(owner = "client!gd", name = "b", descriptor = "(Z)Z", line = 437)
