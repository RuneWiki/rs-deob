...
public class class111 extends class180 {
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIIIF)V", line = 5)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(IIII)V", line = 113)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(ZI)V", line = 123)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(I[IB)V", line = 139)
    ...
    @OriginalMember(owner = "client!tt", name = "a", descriptor = "(II)V", line = 265)
    ...
    @OriginalMember(owner = "client!tt", name = "b", descriptor = "(II)V", line = 277)
    public final void method694(int arg0, int arg1) {
        this.field1571.position(arg0 * arg1 + 3);
        this.field1571.put((byte) -1);
    }

    @OriginalMember(owner = "client!tt", name = "<init>", descriptor = "(Lch;IIIII)V", line = 290)
