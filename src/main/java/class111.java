...
public class class111 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(I)Lsq;", line = 4)
    ...
    @OriginalMember(owner = "client!uq", name = "b", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!uq", name = "c", descriptor = "(I)Lsq;", line = 45)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(II)I", line = 66)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIII)V", line = 84)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Lsq;I)V", line = 102)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(Z)Lsq;", line = 120)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIB)Z", line = 142)
    ...
    @OriginalMember(owner = "client!uq", name = "d", descriptor = "(I)V", line = 186)
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(IIIIIIB)V", line = 269)
    ...
    @OriginalMember(owner = "client!uq", name = "e", descriptor = "(I)V", line = 292)
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "()V", line = 340)
    public class111() {
        this.field1762.field1845 = this.field1762;
        this.field1762.field1843 = this.field1762;
    }

    @OriginalMember(owner = "client!uq", name = "f", descriptor = "(I)I", line = 323)
