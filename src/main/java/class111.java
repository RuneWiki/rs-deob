...
public class class111 extends class325 implements class210 {
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(I)Z", line = 19)
    ...
    @OriginalMember(owner = "client!tn", name = "c", descriptor = "(B)Z", line = 29)
    ...
    @OriginalMember(owner = "client!tn", name = "d", descriptor = "(B)V", line = 40)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ZILvc;IILuq;I)V", line = 52)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(ZLvc;)V", line = 64)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(B)I", line = 84)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ILvc;II)Z", line = 100)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lfo;I)V", line = 120)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IIIIII)V", line = 151)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(BILvc;)Ln;", line = 175)
    ...
    @OriginalMember(owner = "client!tn", name = "<init>", descriptor = "(Lvc;Lnm;IIIIIZIIIIIII)V", line = 186)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lvc;I)Lep;", line = 201)
    ...
    @OriginalMember(owner = "client!tn", name = "e", descriptor = "(B)I", line = 237)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(IBI)V", line = 248)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(ZLvc;)V", line = 281)
    ...
    @OriginalMember(owner = "client!tn", name = "f", descriptor = "(I)V", line = 293)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(I)I", line = 307)
    ...
    @OriginalMember(owner = "client!tn", name = "a", descriptor = "(Lvc;B)V", line = 319)
    ...
    @OriginalMember(owner = "client!tn", name = "b", descriptor = "(I)V", line = 336)
