...
public class class111 extends class223 {
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIILrb;Lrb;)V", line = 4)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIBIII)I", line = 18)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIII[BII)Z", line = 64)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILlh;ZI)V", line = 112)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "(I)V", line = 180)
