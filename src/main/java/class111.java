...
public class class111 extends class446 {
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "([I[I[ILpp;I)V")
    ...
    @OriginalMember(owner = "client!fv", name = "a", descriptor = "(BLjr;)I")
    ...
    @OriginalMember(owner = "client!fv", name = "<init>", descriptor = "(Lpfa;Lpfa;Loq;)V")
