...
public class class111 extends class270 {
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(IIIZIIIBZIILja;Lc;)V", line = 7)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BLec;I)V", line = 620)
    ...
    @OriginalMember(owner = "client!gd", name = "<init>", descriptor = "()V", line = 743)
    public class111() {
        super(0, true);
    }

    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(BI)[I", line = 674)
    ...
    @OriginalMember(owner = "client!gd", name = "a", descriptor = "(Z)V", line = 749)
