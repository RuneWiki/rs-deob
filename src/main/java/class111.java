...
public class class111 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(ZBLjava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(II)Low;")
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Lsj;ILin;)V")
