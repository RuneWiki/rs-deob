...
public class class111 extends class770 implements class466 {
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lns;IILns;BIIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!sm", name = "<init>", descriptor = "(Lha;Lro;IIIIIZIIII)V", line = 53)
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lha;I)V", line = 90)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(Z)V", line = 117)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(B)Z", line = 131)
    public final boolean method755(byte arg0) {
        ++field1345;
        return arg0 != -111 ? false : this.field1352;
    }

    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILha;)Lrk;", line = 143)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lha;Z)V", line = 170)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(BII)I", line = 200)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(I)I", line = 216)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Z)I", line = 227)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ZBLha;I)Luaa;", line = 240)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILha;II)Z", line = 271)
    ...
    @OriginalMember(owner = "client!sm", name = "e", descriptor = "(I)Z", line = 293)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lha;BI)Lka;", line = 309)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(I)I", line = 335)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(B)I", line = 346)
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(III)I", line = 362)
    ...
    @OriginalMember(owner = "client!sm", name = "d", descriptor = "(I)Z", line = 377)
    ...
    @OriginalMember(owner = "client!sm", name = "e", descriptor = "(Z)V", line = 394)
    ...
    @OriginalMember(owner = "client!sm", name = "j", descriptor = "(I)V", line = 408)
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(Lha;I)Ltja;", line = 418)
    ...
    @OriginalMember(owner = "client!sm", name = "b", descriptor = "(Lha;I)V", line = 461)
