...
public class class111 extends class11 {
    ...
    @OriginalMember(owner = "client!aq", name = "b", descriptor = "(IIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!aq", name = "f", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lmg;ILmg;)V", line = 91)
    ...
    @OriginalMember(owner = "client!aq", name = "d", descriptor = "(II)[I", line = 103)
    ...
    @OriginalMember(owner = "client!aq", name = "<init>", descriptor = "()V", line = 137)
    public class111() {
        super(1, false);
    }

    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(Lsi;II)V", line = 141)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIIIIIIIII)V", line = 158)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 177)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(IIZ)V", line = 190)
    ...
    @OriginalMember(owner = "client!aq", name = "a", descriptor = "(II)[[I", line = 218)
    ...
    @OriginalMember(owner = "client!aq", name = "g", descriptor = "(I)V", line = 265)
