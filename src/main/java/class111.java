...
public abstract class class111 {
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(Lua;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(I)V", line = 78)
    public static void method661(int arg0) {
        int var1 = -84 % ((77 - arg0) / 33);
        field1407 = null;
    }

    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IB)V", line = 100)
