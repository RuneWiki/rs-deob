...
public class class111 extends class134 {
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(B)I", line = 7)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(II)V", line = 19)
    ...
    @OriginalMember(owner = "client!ra", name = "b", descriptor = "(III)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(I)I", line = 44)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lkda;)V", line = 55)
    public class111(class391 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(ILkda;)V", line = 59)
    public class111(int arg0, class391 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ra", name = "c", descriptor = "(II)I", line = 62)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(IIBIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(B)V", line = 111)
