...
public class class111 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(II)Lcp;", line = 5)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZI)V", line = 53)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(B)Ljj;", line = 66)
    ...
    @OriginalMember(owner = "client!hh", name = "b", descriptor = "(I)V", line = 100)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(IBI)Z", line = 123)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(Z)V", line = 142)
    ...
    @OriginalMember(owner = "client!hh", name = "<init>", descriptor = "(Lbt;ILkda;)V", line = 163)
