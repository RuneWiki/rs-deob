...
public class class111 extends class397 {
    ...
    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "()V", line = 4)
    public class111() {
        this(4096);
    }

    @OriginalMember(owner = "client!gg", name = "<init>", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!gg", name = "a", descriptor = "(IBLae;)V", line = 16)
    ...
    @OriginalMember(owner = "client!gg", name = "b", descriptor = "(II)[I", line = 52)
    ...
    @OriginalMember(owner = "client!gg", name = "e", descriptor = "(I)V", line = 74)
