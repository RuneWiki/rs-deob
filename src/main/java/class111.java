...
public class class111 extends class190 {
    ...
    @OriginalMember(owner = "client!np", name = "<init>", descriptor = "(Ljj;Llm;)V")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(IB)Leg;")
    ...
    @OriginalMember(owner = "client!np", name = "a", descriptor = "(ILaba;I)V")
