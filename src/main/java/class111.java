...
public abstract class class111 extends class22 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILka;IIILgp;)V", line = 3)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(BLhd;)I", line = 40)
