...
public class class546 implements Runnable {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(I)I", line = 28)
    public final int method3089(int arg0) {
        field7793++;
        return arg0 < 68 ? 62 : this.field7795;
    }

    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(B)Ljava/lang/String;", line = 41)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(II)I", line = 53)
    ...
    @OriginalMember(owner = "client!qj", name = "run", descriptor = "()V", line = 70)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(I)I", line = 163)
    ...
    @OriginalMember(owner = "client!qj", name = "c", descriptor = "(B)J", line = 188)
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(I)Lir;", line = 198)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Ljava/lang/String;JBILir;)V", line = 210)
    ...
    @OriginalMember(owner = "client!qj", name = "b", descriptor = "(II)Z", line = 226)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Z)I", line = 237)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(Lno;Z)V", line = 251)
    ...
    @OriginalMember(owner = "client!qj", name = "d", descriptor = "(B)V", line = 271)
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(IIIIIIII)V", line = 284)
