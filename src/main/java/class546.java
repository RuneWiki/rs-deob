...
public class class546 {
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(BILso;)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lso;I)V")
    ...
    @OriginalMember(owner = "client!ni", name = "a", descriptor = "(Lka;ILrn;III)V")
