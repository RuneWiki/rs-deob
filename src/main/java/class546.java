...
public class class546 extends class398 {
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IBI)V", line = 19)
    ...
    @OriginalMember(owner = "client!kea", name = "b", descriptor = "(I)V", line = 89)
    ...
    @OriginalMember(owner = "client!kea", name = "<init>", descriptor = "(Luca;Lal;)V", line = 107)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(IZ)V", line = 158)
    ...
    @OriginalMember(owner = "client!kea", name = "c", descriptor = "(I)V", line = 170)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ZI)V", line = 181)
    ...
    @OriginalMember(owner = "client!kea", name = "d", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!kea", name = "a", descriptor = "(ILvaa;B)V", line = 260)
