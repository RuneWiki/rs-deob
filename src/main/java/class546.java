...
public class class546 extends class108 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!df", name = "b", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(II)Z", line = 69)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(II)V", line = 80)
    public class546(int arg0, int arg1) {
        this.field7595 = arg0;
        this.field7587 = arg1;
    }

    @OriginalMember(owner = "client!df", name = "f", descriptor = "(I)Z", line = 89)
