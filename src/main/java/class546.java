...
public class class546 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(DB)V", line = 23)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Lhk;JI)V", line = 35)
    public class546(class111 arg0, long arg1, int arg2) {
        this.field7421 = arg1;
        this.field7420 = arg0;
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II[[[BLha;IIIIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!hv", name = "finalize", descriptor = "()V", line = 81)
