...
public class class546 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Ljava/lang/String;IZI)V", line = 15)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(I)V", line = 56)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Ljava/lang/String;B)Z", line = 74)
    ...
    @OriginalMember(owner = "client!cb", name = "<init>", descriptor = "(Z)V", line = 87)
    public class546(boolean arg0) {
        this.field7547 = arg0;
    }

    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(B)[Lgm;", line = 95)
