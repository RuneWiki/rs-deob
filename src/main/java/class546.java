...
public class class546 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I[Ljca;)I")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(B)Ljca;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "([IBI[ILag;I)Lpo;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(I)Ljca;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IJ)Ljca;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILag;ZII[I)Lck;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IJLjca;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(I)Ljca;")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(III)Lwv;")
