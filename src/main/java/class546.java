...
public class class546 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(Lw;BII)Z")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILw;BI)V")
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lej;Lan;)V")
