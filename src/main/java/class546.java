...
public class class546 extends class392 {
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(III)V", line = 28)
    ...
    @OriginalMember(owner = "client!su", name = "c", descriptor = "(Z)V", line = 46)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(Z)I", line = 160)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(Lw;)V", line = 175)
    public class546(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!su", name = "b", descriptor = "(II)I", line = 180)
    public final int method290(int arg0, int arg1) {
        ++field7569;
        return arg1 > -124 ? 58 : 3;
    }

    @OriginalMember(owner = "client!su", name = "a", descriptor = "(IIIIIIIIII)V", line = 191)
    ...
    @OriginalMember(owner = "client!su", name = "b", descriptor = "(Z)V", line = 208)
    ...
    @OriginalMember(owner = "client!su", name = "a", descriptor = "(BI)V", line = 220)
    ...
    @OriginalMember(owner = "client!su", name = "<init>", descriptor = "(ILw;)V", line = 231)
