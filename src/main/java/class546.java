...
public class class546 extends class756 {
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(BLib;)V", line = 8)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(IIIIIII)Z", line = 22)
    ...
    @OriginalMember(owner = "client!cb", name = "b", descriptor = "(B)V", line = 88)
    ...
    @OriginalMember(owner = "client!cb", name = "a", descriptor = "(Lkp;I)V", line = 100)
