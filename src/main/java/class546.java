...
public abstract class class546 {
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BZ)V", line = 29)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(I)V", line = 92)
    ...
    @OriginalMember(owner = "client!ia", name = "<init>", descriptor = "(Lrr;)V", line = 102)
    public class546(class332 arg0) {
        this.field7937 = arg0;
    }

    @OriginalMember(owner = "client!ia", name = "a", descriptor = "(BI)I", line = 111)
    public static final int method3299(byte arg0, int arg1) {
        field7945++;
        return arg0 == -3 ? arg1 & 0xFF : 10;
    }

    @OriginalMember(owner = "client!ia", name = "c", descriptor = "(I)V", line = 124)
    ...
    @OriginalMember(owner = "client!ia", name = "d", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!ia", name = "e", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!ia", name = "b", descriptor = "(B)V", line = 162)
    ...
    @OriginalMember(owner = "client!ia", name = "g", descriptor = "(I)V", line = 177)
