...
public class class546 extends class561 implements class391 {
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lqba;IIZ[III)V")
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lqba;Ljt;IIZ[BII)V")
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lqba;Ljt;IIZ[FII)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(ILjt;I[BIIIII)V")
    ...
    @OriginalMember(owner = "client!ou", name = "e", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!ou", name = "<init>", descriptor = "(Lqba;Ljt;Llc;II)V")
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IBILjt;III[FI)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
