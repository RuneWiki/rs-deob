...
public class class546 implements Runnable {
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;B)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(B)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZBLjava/lang/String;)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IIILjava/awt/Component;[ILjava/awt/Point;)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZLjava/lang/String;Ljava/lang/String;I)Lww;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(IZLjava/lang/String;Z)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILjava/lang/Object;III)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ZLjava/awt/Frame;)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILjava/lang/String;)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;B)Lsb;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(BLjava/lang/String;)Lww;")
    ...
    @OriginalMember(owner = "client!gh", name = "a", descriptor = "(ILjava/lang/Runnable;I)Lsb;")
