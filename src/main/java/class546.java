...
public class class546 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(II)I", line = 28)
    public static final int method3073(int arg0, int arg1) {
        field7478++;
        return arg0 == 255 ? arg1 & 0xFF : 67;
    }

    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lbu;FLbu;B)Z", line = 45)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)Z", line = 115)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(Lpea;)V", line = 142)
