...
public class class546 extends class539 implements class109 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)Z", line = 7)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)C", line = 26)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IILkw;I)V", line = 49)
    ...
    @OriginalMember(owner = "client!th", name = "b", descriptor = "(B)I", line = 110)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I[Lxa;)V", line = 121)
    ...
    @OriginalMember(owner = "client!th", name = "d", descriptor = "(B)V", line = 147)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(I)I", line = 160)
    ...
    @OriginalMember(owner = "client!th", name = "c", descriptor = "(B)J", line = 171)
