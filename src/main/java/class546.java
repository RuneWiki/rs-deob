...
public class class546 {
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!hha", name = "a", descriptor = "(I)V", line = 72)
    ...
    @OriginalMember(owner = "client!hha", name = "b", descriptor = "(I)V", line = 95)
