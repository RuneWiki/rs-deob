...
public class class546 {
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(I)Lwca;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(III)Luo;")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(ILwca;)V")
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "(IIZ)Lfc;")
    ...
    @OriginalMember(owner = "client!pm", name = "b", descriptor = "(I)Lwca;")
