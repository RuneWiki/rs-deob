...
public class class546 extends class143 {
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(ILek;I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(Lek;I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(II)Ldc;")
    ...
    @OriginalMember(owner = "client!dn", name = "b", descriptor = "(IB)Luea;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ILek;[I)V")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(ZLek;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!dn", name = "a", descriptor = "(JZIZIILvo;I)V")
