...
public class class546 {
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(B)[Lve;", line = 4)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IZI)I", line = 30)
    ...
    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(JJ)J", line = 54)
    public static long method3179(long arg0, long arg1) {
        return arg0 | arg1;
    }

    @OriginalMember(owner = "client!baa", name = "a", descriptor = "(IIIIBILjava/lang/String;I)V", line = 64)
