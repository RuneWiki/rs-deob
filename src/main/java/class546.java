...
public class class546 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(ILha;)V", line = 6)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!kga", name = "finalize", descriptor = "()V", line = 67)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Llaa;J[Llf;)V", line = 77)
