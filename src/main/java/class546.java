...
public class class546 {
    ...
    @OriginalMember(owner = "client!hv", name = "toString", descriptor = "()Ljava/lang/String;", line = 17)
    public final String toString() {
        field7396++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIILor;Laa;Lvr;II)V", line = 30)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(IIIILbba;BI)V", line = 74)
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II)I", line = 86)
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(II)V", line = 195)
