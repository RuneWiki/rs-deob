...
public class class546 extends class673 {
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIIIZ[BI)V", line = 26)
    ...
    @OriginalMember(owner = "client!ot", name = "c", descriptor = "(B)V", line = 47)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIII[I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIIIIIZ)V", line = 77)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIIIIZ)V", line = 94)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIIII[BI)V", line = 115)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIIII)V", line = 131)
    public class546(class228 arg0, int arg1, int arg2, int arg3, int arg4, int arg5) {
        super(arg0, 3553, arg1, arg4, arg5);
        this.field7682 = (float) arg3 / (float) arg5;
        this.field7680 = false;
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BIIILut;ILgi;IIIII)V", line = 144)
    ...
    @OriginalMember(owner = "client!ot", name = "b", descriptor = "(II)V", line = 170)
    ...
    @OriginalMember(owner = "client!ot", name = "<init>", descriptor = "(Lok;IIIZ[I)V", line = 186)
    ...
    @OriginalMember(owner = "client!ot", name = "a", descriptor = "(BI)Lsk;", line = 208)
