...
public class class546 implements Runnable {
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Lda;)V", line = 18)
    public static final void method3161(class59 arg0) {
        class658.field9020 = arg0;
    }

    @OriginalMember(owner = "client!ea", name = "b", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Ljava/lang/Object;Lvc;I)V", line = 41)
    ...
    @OriginalMember(owner = "client!ea", name = "c", descriptor = "(I)V", line = 65)
    public static void method3164(int arg0) {
        field7606 = null;
        int var1 = 59 % ((arg0 + 52) / 34);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(II[BB)V", line = 76)
    ...
    @OriginalMember(owner = "client!ea", name = "run", descriptor = "()V", line = 127)
    ...
    @OriginalMember(owner = "client!ea", name = "<init>", descriptor = "(Ljava/net/Socket;Lvc;I)V", line = 334)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(I[BII)V", line = 215)
    ...
    @OriginalMember(owner = "client!ea", name = "finalize", descriptor = "()V", line = 240)
    protected final void finalize() {
        field7610++;
        this.method3167((byte) 78);
    }

    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(B)V", line = 253)
    ...
    @OriginalMember(owner = "client!ea", name = "d", descriptor = "(I)V", line = 291)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(Z)V", line = 317)
    ...
    @OriginalMember(owner = "client!ea", name = "a", descriptor = "(IZ)V", line = 348)
