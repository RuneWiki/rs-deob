...
public class class546 {
    ...
    @OriginalMember(owner = "client!tda", name = "a", descriptor = "(ILaq;)I", line = 11)
    ...
    @OriginalMember(owner = "client!tda", name = "<init>", descriptor = "(IIII)V", line = 52)
    ...
    @OriginalMember(owner = "client!tda", name = "toString", descriptor = "()Ljava/lang/String;", line = 63)
