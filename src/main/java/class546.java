...
public class class546 extends class544 {
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B[II)V", line = 19)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(B)V", line = 142)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(I[[[Ldg;)V", line = 160)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IZIIIIIIZ)Z", line = 233)
    ...
    @OriginalMember(owner = "client!or", name = "b", descriptor = "(II)V", line = 265)
    ...
    @OriginalMember(owner = "client!or", name = "c", descriptor = "(II)V", line = 285)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(IIZI)V", line = 297)
    ...
    @OriginalMember(owner = "client!or", name = "a", descriptor = "(FIIII)V", line = 311)
    ...
    @OriginalMember(owner = "client!or", name = "d", descriptor = "(II)V", line = 420)
    ...
    @OriginalMember(owner = "client!or", name = "<init>", descriptor = "(Lae;IIIII)V", line = 435)
