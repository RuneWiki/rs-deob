...
public class class546 {
    ...
    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!vs", name = "<init>", descriptor = "(Z)V", line = 24)
    public class546(boolean arg0) {
        this.field7929 = arg0;
    }

    @OriginalMember(owner = "client!vs", name = "a", descriptor = "(I)Z", line = 32)
