...
public class class546 {
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(B)V", line = 9)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)Z", line = 25)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)[Lai;", line = 59)
    ...
    @OriginalMember(owner = "client!ai", name = "toString", descriptor = "()Ljava/lang/String;", line = 70)
    public final String toString() {
        field7807++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(IILnb;)V", line = 78)
