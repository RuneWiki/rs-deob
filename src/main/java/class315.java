...
public class class315 extends class447 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Leb;B)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Leb;II)V")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(III)Lrg;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILaa;Z[[II)V")
