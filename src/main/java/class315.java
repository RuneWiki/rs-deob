...
public class class315 {
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(IIIBZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Ll;ILuu;)V", line = 202)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(I)V", line = 213)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(FFFZ)F", line = 243)
