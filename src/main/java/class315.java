...
public class class315 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ZZ)V", line = 18)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(IIILjf;)V", line = 97)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)V", line = 122)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(II)I", line = 133)
