...
public class class315 extends class255 {
    ...
    @OriginalMember(owner = "client!ur", name = "g", descriptor = "(I)[B", line = 11)
    ...
    @OriginalMember(owner = "client!ur", name = "i", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ur", name = "f", descriptor = "(I)I", line = 47)
