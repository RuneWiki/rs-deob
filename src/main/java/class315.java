...
public class class315 extends class376 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lor;I)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lw;I)V")
    ...
    @OriginalMember(owner = "client!gaa", name = "o", descriptor = "(B)V")
