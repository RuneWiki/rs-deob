...
public class class315 extends class17 {
    ...
    @OriginalMember(owner = "client!pr", name = "<init>", descriptor = "()V", line = 5)
    public class315() {
        super(0, true);
    }

    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(III[[ILjava/util/Random;II)V", line = 13)
    ...
    @OriginalMember(owner = "client!pr", name = "b", descriptor = "(IB)V", line = 209)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(ZI)V", line = 247)
    ...
    @OriginalMember(owner = "client!pr", name = "h", descriptor = "(I)V", line = 295)
    ...
    @OriginalMember(owner = "client!pr", name = "g", descriptor = "(I)V", line = 307)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(II)[I", line = 339)
    ...
    @OriginalMember(owner = "client!pr", name = "a", descriptor = "(Lwm;II)V", line = 589)
