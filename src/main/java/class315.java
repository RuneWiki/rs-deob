...
public class class315 implements Runnable {
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lqn;II)Lwh;", line = 3)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lpi;ZI)V", line = 57)
    ...
    @OriginalMember(owner = "client!sc", name = "run", descriptor = "()V", line = 213)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lqn;IB)Lwh;", line = 260)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Z)V", line = 280)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(B[BLqn;I)Lwh;", line = 317)
    ...
    @OriginalMember(owner = "client!sc", name = "<init>", descriptor = "(Lpe;)V", line = 463)
    ...
    @OriginalMember(owner = "client!sc", name = "b", descriptor = "(B)V", line = 344)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(II)Z", line = 354)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(ILiaa;)V", line = 414)
    ...
    @OriginalMember(owner = "client!sc", name = "a", descriptor = "(Lwh;I)V", line = 486)
