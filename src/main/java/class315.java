...
public class class315 extends class321 {
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "([II[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "([IIIII)V", line = 39)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILce;)V", line = 68)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(ILr;IB)Z", line = 270)
    ...
    @OriginalMember(owner = "client!wj", name = "a", descriptor = "(I)V", line = 301)
