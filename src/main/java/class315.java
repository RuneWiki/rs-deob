...
public class class315 extends class40 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(BF)V", line = 4)
    ...
    @OriginalMember(owner = "client!ka", name = "<init>", descriptor = "(I)V", line = 19)
    public class315(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ka", name = "a", descriptor = "([Ljava/lang/Object;[II)V", line = 25)
    public static final void method1879(Object[] arg0, int[] arg1, int arg2) {
        class175.method1100(arg0, 0, arg1.length + arg2, arg1, 14677);
        ++field4747;
    }

    @OriginalMember(owner = "client!ka", name = "l", descriptor = "(B)V", line = 33)
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(BF)V", line = 55)
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IJ)V", line = 72)
