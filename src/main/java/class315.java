...
public abstract class class315 extends class513 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(II)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(III)V", line = 24)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)Ljava/lang/String;", line = 71)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IZ)I", line = 102)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IILjava/lang/String;)V", line = 123)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BLun;)V", line = 250)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BZI)V", line = 304)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(BLec;)V", line = 389)
