...
public abstract class class315 implements class391 {
    ...
    @OriginalMember(owner = "client!cl", name = "finalize", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II[IZI)V", line = 32)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZZ)V", line = 139)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(B)I", line = 162)
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(I)V", line = 262)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIII[B)V", line = 285)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLjava/lang/String;)Ljava/lang/String;", line = 412)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lgv;I)V", line = 477)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lia;ILpw;Llj;IZ)V", line = 644)
    ...
    @OriginalMember(owner = "client!cl", name = "e", descriptor = "(I)V", line = 502)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II)V", line = 525)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(II[FIB)V", line = 536)
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(B)I", line = 631)
