...
public class class315 extends class202 {
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(Lya;I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!mc", name = "b", descriptor = "(Lya;I)Lmo;", line = 34)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(ILya;II)Z", line = 79)
