...
public class class315 extends class200 {
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lbu;BLm;)Z", line = 16)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!wr", name = "d", descriptor = "(B)J", line = 81)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(ZDZLm;ZLbu;II)[I", line = 97)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(BI)Lef;", line = 233)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lbu;ZILm;II)[F", line = 262)
    ...
    @OriginalMember(owner = "client!wr", name = "a", descriptor = "(Lbu;IBIDZLm;)[I", line = 378)
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "()V", line = 518)
    public class315() {
    ...
    @OriginalMember(owner = "client!wr", name = "<init>", descriptor = "(Lcu;)V", line = 536)
