...
public class class315 extends class540 {
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(II)Z", line = 126)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(I)Z", line = 160)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(II)Z", line = 171)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)V", line = 187)
