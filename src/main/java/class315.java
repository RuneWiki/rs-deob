...
public class class315 extends class422 implements class498 {
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lko;Lvea;Lbja;II)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lko;Lvea;II[FII)V")
    ...
    @OriginalMember(owner = "client!w", name = "a", descriptor = "(IILvea;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lko;II[III)V")
    ...
    @OriginalMember(owner = "client!w", name = "<init>", descriptor = "(Lko;Lvea;II[BII)V")
