...
public class class315 {
    ...
    @OriginalMember(owner = "client!gt", name = "b", descriptor = "(I)Lnp;")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILic;)V")
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILic;II)Luq;")
