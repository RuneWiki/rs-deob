...
public class class315 extends class426 implements class205 {
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lmm;ILjava/nio/ByteBuffer;)V")
    public class315(class357 arg0, int arg1, ByteBuffer arg2) {
        super(arg0, arg2);
        this.field4263 = arg1;
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lvl;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "d", descriptor = "(Lvl;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(Lvl;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lmm;I[BI)V")
    public class315(class357 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field4263 = arg1;
    }

    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(Lvl;)V")
