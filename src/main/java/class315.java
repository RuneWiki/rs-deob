...
public class class315 extends class34 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lza;B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IB)[I", line = 106)
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!ob", name = "e", descriptor = "(I)V", line = 161)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I[II)V", line = 197)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lsv;II)V", line = 355)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "()V", line = 582)
    public class315() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BZ)V", line = 455)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(IIIIIII)I", line = 508)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(Z)V", line = 587)
