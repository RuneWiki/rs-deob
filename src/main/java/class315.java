...
public class class315 {
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(I)Lhs;", line = 4)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Z)I", line = 33)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(B)V", line = 56)
    ...
    @OriginalMember(owner = "client!vn", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(IIZ)Z", line = 108)
    ...
    @OriginalMember(owner = "client!vn", name = "c", descriptor = "(B)Lhs;", line = 128)
    ...
    @OriginalMember(owner = "client!vn", name = "a", descriptor = "(Lhs;I)V", line = 148)
    ...
    @OriginalMember(owner = "client!vn", name = "<init>", descriptor = "()V", line = 189)
    public class315() {
