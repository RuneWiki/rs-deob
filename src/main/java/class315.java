...
public class class315 extends class12 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(ILha;)Lhu;")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IIIILha;I)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Lbg;I)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IILaa;JLtp;IIIB)V")
    ...
    @OriginalMember(owner = "client!uea", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    public class315(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!uea", name = "k", descriptor = "(I)Lgp;")
