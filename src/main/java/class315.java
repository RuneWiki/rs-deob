...
public class class315 {
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIIIIIIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(IIII)V", line = 97)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(II)V", line = 113)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)V", line = 127)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(II)V", line = 137)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(II)Lju;", line = 149)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(Z[[[BIB)V", line = 198)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lsea;ILmv;)V", line = 481)
