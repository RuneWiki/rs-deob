...
public class class315 {
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(IILru;)V")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(III)Lvl;")
    ...
    @OriginalMember(owner = "client!pn", name = "a", descriptor = "(ZLha;IIII)V")
    ...
    @OriginalMember(owner = "client!pn", name = "<init>", descriptor = "(Lbm;Ljga;Lup;IIIII)V")
