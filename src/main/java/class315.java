...
public abstract class class315 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[I[Ll;Ljava/lang/String;IBI)V", line = 4)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;II)V", line = 22)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[Ll;Ljava/util/Random;ILjava/lang/String;[IIII)I", line = 57)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[II[ILjava/lang/String;I[Ll;ILjava/util/Random;IIIIII)I", line = 94)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIBILjava/lang/String;I)V", line = 170)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILma;IIIILjava/lang/String;IIIII[Ll;I[II)I", line = 187)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIII)V", line = 198)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 220)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILma;ILl;IILem;)V", line = 252)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B)V", line = 300)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Leo;Lhg;)V", line = 313)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[ILjava/lang/String;I[I[I[Ll;I)V", line = 1432)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIIILjava/lang/String;I)V", line = 1594)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lya;Ldq;)V", line = 1624)
    public class315(class38 arg0, class490 arg1) {
        this.field4299 = arg1;
        this.field4305 = arg0;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZLjava/lang/String;III)V", line = 1635)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([IZIIIIIIILma;I[Ll;Ljava/lang/String;IIII)I", line = 1653)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 1759)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 1777)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 1822)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[Ll;ILma;ILjava/lang/String;I[II)V", line = 1896)
