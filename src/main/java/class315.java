...
public class class315 {
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(BJLkha;)V")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(II)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(Ljb;Z)Ljb;")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(IJ)Lkha;")
    ...
    @OriginalMember(owner = "client!uea", name = "a", descriptor = "(I)Lkha;")
