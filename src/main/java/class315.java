...
public class class315 {
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(III)Z", line = 5)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILjava/awt/Frame;Llu;)V", line = 19)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!gaa", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(B)V", line = 74)
    ...
    @OriginalMember(owner = "client!gaa", name = "<init>", descriptor = "(Lhk;Ld;)V", line = 87)
    public class315(class111 arg0, class162 arg1) {
        this.field4314 = arg1;
        this.field4309 = arg0;
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(BI)Lkf;", line = 99)
