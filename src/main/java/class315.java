...
public class class315 extends Canvas {
    ...
    @OriginalMember(owner = "client!sea", name = "update", descriptor = "(Ljava/awt/Graphics;)V", line = 3)
    public final void update(Graphics arg0) {
        field4220++;
        this.field4222.update(arg0);
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(IILwv;I)V", line = 14)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(BLr;J)V", line = 47)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(II[FIFIIIIB)V", line = 80)
    ...
    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(I)V", line = 136)
    ...
    @OriginalMember(owner = "client!sea", name = "paint", descriptor = "(Ljava/awt/Graphics;)V", line = 151)
    public final void paint(Graphics arg0) {
        field4227++;
        this.field4222.paint(arg0);
    }

    @OriginalMember(owner = "client!sea", name = "a", descriptor = "(FFBIIIFFI[BLhc;IF)V", line = 160)
    ...
    @OriginalMember(owner = "client!sea", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 185)
