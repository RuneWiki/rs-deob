...
public class class315 extends RuntimeException {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(Lvh;Lev;)V")
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)V")
