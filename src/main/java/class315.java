...
public abstract class class315 {
    ...
    @OriginalMember(owner = "client!wv", name = "b", descriptor = "(B)V", line = 20)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(ILm;Lhs;ILjava/awt/Canvas;)Lqa;", line = 35)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(IIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!wv", name = "a", descriptor = "(Ldn;I)V", line = 84)
