...
public class class315 extends class659 {
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I[I[Ljava/lang/String;IB)V", line = 5)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(ILha;)V", line = 60)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 129)
