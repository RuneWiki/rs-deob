...
public class class315 implements class496 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lya;ILuq;)V", line = 24)
    ...
    @OriginalMember(owner = "client!qd", name = "toString", descriptor = "()Ljava/lang/String;", line = 45)
    public final String toString() {
        field4749++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 59)
