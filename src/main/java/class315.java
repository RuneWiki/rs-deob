...
public class class315 extends class39 implements class147 {
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILoa;)Lba;", line = 23)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(BLoa;)V", line = 36)
    ...
    @OriginalMember(owner = "client!ow", name = "e", descriptor = "(I)I", line = 64)
    ...
    @OriginalMember(owner = "client!ow", name = "g", descriptor = "(I)Z", line = 77)
    ...
    @OriginalMember(owner = "client!ow", name = "<init>", descriptor = "(Loa;Llt;IIIIIZIIIIIIZ)V", line = 90)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ILoa;)Lwc;", line = 124)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILoa;I)Z", line = 152)
    ...
    @OriginalMember(owner = "client!ow", name = "i", descriptor = "(I)I", line = 177)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(BLoa;)V", line = 189)
    ...
    @OriginalMember(owner = "client!ow", name = "k", descriptor = "(I)V", line = 217)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IIIII[B)Z", line = 228)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Z)V", line = 314)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IIII)I", line = 327)
    ...
    @OriginalMember(owner = "client!ow", name = "d", descriptor = "(I)I", line = 351)
    ...
    @OriginalMember(owner = "client!ow", name = "c", descriptor = "(I)Z", line = 362)
    public final boolean method562(int arg0) {
        ++field4665;
        return arg0 != 29008 ? true : this.field4689;
    }

    @OriginalMember(owner = "client!ow", name = "l", descriptor = "(I)I", line = 373)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 384)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(ZLoa;)V", line = 417)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Loa;IIZ)Lcda;", line = 427)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(Loa;B)Lac;", line = 458)
    ...
    @OriginalMember(owner = "client!ow", name = "b", descriptor = "(IILoa;)Lba;", line = 473)
    ...
    @OriginalMember(owner = "client!ow", name = "a", descriptor = "(I)I", line = 499)
