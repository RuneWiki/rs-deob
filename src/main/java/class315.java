...
public class class315 extends class82 {
    ...
    @OriginalMember(owner = "client!ku", name = "<init>", descriptor = "()V", line = 4)
    public class315() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ku", name = "h", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 28)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(IILos;)V", line = 83)
    ...
    @OriginalMember(owner = "client!ku", name = "c", descriptor = "(II)[I", line = 132)
    ...
    @OriginalMember(owner = "client!ku", name = "a", descriptor = "(B[J[I)V", line = 227)
