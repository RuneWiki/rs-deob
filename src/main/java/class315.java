...
public class class315 {
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ZB)V", line = 37)
    ...
    @OriginalMember(owner = "client!jha", name = "b", descriptor = "(B)V", line = 100)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(ZI)V", line = 117)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(IZ)Luja;", line = 134)
    ...
    @OriginalMember(owner = "client!jha", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!jha", name = "<init>", descriptor = "(Lfs;ILlga;Llga;)V", line = 194)
