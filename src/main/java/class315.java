...
public class class315 extends class298 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)[I", line = 14)
    ...
    @OriginalMember(owner = "client!es", name = "c", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IILvt;)V", line = 129)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "()V", line = 262)
    public class315() {
        super(0, true);
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILg;)V", line = 232)
    ...
    @OriginalMember(owner = "client!es", name = "d", descriptor = "(I)V", line = 273)
