...
public class class315 {
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!mv", name = "a", descriptor = "(ZIIII)Lmv;", line = 32)
    ...
    @OriginalMember(owner = "client!mv", name = "<init>", descriptor = "(IIIIIIIIIZ)V", line = 50)
