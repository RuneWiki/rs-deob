...
public class class315 extends class520 implements class439 {
    ...
    @OriginalMember(owner = "client!ma", name = "finalize", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IIII)V", line = 14)
    public final void method1949(int arg0, int arg1, int arg2, int arg3) {
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(BIZ)Lr;", line = 18)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lr;IIIZ)V", line = 23)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(ILm;)V", line = 29)
    ...
    @OriginalMember(owner = "client!ma", name = "a", descriptor = "()V", line = 88)
    public final void method1961() {
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(IILm;Z)Z", line = 92)
    ...
    @OriginalMember(owner = "client!ma", name = "d", descriptor = "()[Lmm;", line = 95)
    public final class26[] method1964() {
        return this.field4728;
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lgr;I)V", line = 98)
    ...
    @OriginalMember(owner = "client!ma", name = "b", descriptor = "()[Lkv;", line = 119)
    public final class200[] method1970() {
        return this.field4727;
    }

    @OriginalMember(owner = "client!ma", name = "a", descriptor = "(Lm;Lgr;II)V", line = 128)
    ...
    @OriginalMember(owner = "client!ma", name = "<init>", descriptor = "(La;Lc;Lbt;IIII)V", line = 160)
