...
public class class314 {
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(BLgw;)V")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(B)Lfd;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Z)Lfd;")
    ...
    @OriginalMember(owner = "client!om", name = "a", descriptor = "(Lgw;IB)V")
