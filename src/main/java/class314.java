...
public class class314 extends class287 {
    ...
    @OriginalMember(owner = "client!mc", name = "f", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!mc", name = "g", descriptor = "(I)I", line = 33)
    public final int method1806(int arg0) {
        ++field4254;
        return arg0 != 0 ? 100 : (int) super.field6883;
    }

    @OriginalMember(owner = "client!mc", name = "h", descriptor = "(I)J", line = 48)
    ...
    @OriginalMember(owner = "client!mc", name = "i", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!mc", name = "j", descriptor = "(I)I", line = 80)
    ...
    @OriginalMember(owner = "client!mc", name = "a", descriptor = "(IBI)Z", line = 91)
    ...
    @OriginalMember(owner = "client!mc", name = "c", descriptor = "(B)V", line = 110)
    ...
    @OriginalMember(owner = "client!mc", name = "d", descriptor = "(B)V", line = 135)
    ...
    @OriginalMember(owner = "client!mc", name = "<init>", descriptor = "(II)V", line = 146)
