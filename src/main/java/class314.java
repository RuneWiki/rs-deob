...
public class class314 extends class170 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IILrg;)V", line = 11)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(B)V", line = 57)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(BII)I", line = 70)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(JB)Ljava/lang/String;", line = 94)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILrg;)V", line = 120)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Ljava/lang/String;BI)Ljava/lang/String;", line = 142)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILjava/lang/String;)V", line = 164)
