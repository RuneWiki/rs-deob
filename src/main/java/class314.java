...
public class class314 extends class423 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "([Ljo;Z)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lfp;J[Lai;[Ljo;Z)V")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lfp;[Lai;Z)V")
    ...
    @OriginalMember(owner = "client!dj", name = "g", descriptor = "()V")
    public static void method2080() {
        field4604 = null;
        field4597 = null;
    }

    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Lfp;J)Z")
