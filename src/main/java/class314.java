...
public abstract class class314 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!cl", name = "b", descriptor = "(IIIII)V", line = 80)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IZI)Z", line = 114)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lmv;IZIIIZ)V", line = 127)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(I[S[Ljava/lang/String;II)V", line = 159)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lr;I)V", line = 214)
