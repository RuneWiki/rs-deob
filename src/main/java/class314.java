...
public class class314 extends class333 {
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(I)Z", line = 33)
    ...
    @OriginalMember(owner = "client!nb", name = "c", descriptor = "(I)I", line = 43)
    ...
    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(II)Z", line = 57)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(B)Z", line = 68)
    ...
    @OriginalMember(owner = "client!nb", name = "<init>", descriptor = "(II)V", line = 79)
    public class314(int arg0, int arg1) {
        this.field3898 = arg0;
        this.field3897 = arg1;
    }

    @OriginalMember(owner = "client!nb", name = "b", descriptor = "(B)Z", line = 94)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Lki;Lki;I)V", line = 107)
    ...
    @OriginalMember(owner = "client!nb", name = "a", descriptor = "(Z)I", line = 125)
