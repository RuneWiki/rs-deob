...
public class class314 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)Lrp;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(II)Lmr;")
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(Lhp;I)Lcv;")
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lee;ILul;)V")
