...
public class class314 extends class219 {
    ...
    @OriginalMember(owner = "client!eo", name = "a", descriptor = "(ILjagtheora/ogg/OggPacket;)V")
    ...
    @OriginalMember(owner = "client!eo", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
