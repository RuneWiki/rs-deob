...
public class class314 extends class277 {
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(IILrg;)V")
    ...
    @OriginalMember(owner = "client!jga", name = "a", descriptor = "(Lrga;Lhr;B)Ltba;")
    ...
    @OriginalMember(owner = "client!jga", name = "<init>", descriptor = "(Lqj;Lpea;)V")
