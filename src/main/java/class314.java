...
public class class314 extends class446 {
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(BZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(IILac;)V", line = 14)
    ...
    @OriginalMember(owner = "client!uf", name = "c", descriptor = "(I)V", line = 30)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(III)V", line = 67)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(B)Z", line = 134)
    ...
    @OriginalMember(owner = "client!uf", name = "d", descriptor = "(I)V", line = 149)
    ...
    @OriginalMember(owner = "client!uf", name = "b", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!uf", name = "a", descriptor = "(ZB)V", line = 180)
    ...
    @OriginalMember(owner = "client!uf", name = "<init>", descriptor = "(Lda;Lai;)V", line = 234)
