...
public class class314 extends InputStream {
    ...
    @OriginalMember(owner = "client!tp", name = "read", descriptor = "()I", line = 3)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ZLjava/lang/String;Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)V", line = 217)
