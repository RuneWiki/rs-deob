...
public class class314 extends class304 {
    ...
    @OriginalMember(owner = "client!kp", name = "c", descriptor = "()V", line = 8)
    ...
    @OriginalMember(owner = "client!kp", name = "b", descriptor = "()Z", line = 32)
    public final boolean method628() {
        return true;
    }

    @OriginalMember(owner = "client!kp", name = "a", descriptor = "()V", line = 36)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)V", line = 47)
    public final void method624(boolean arg0) {
    }

    @OriginalMember(owner = "client!kp", name = "b", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!kp", name = "<init>", descriptor = "(Lse;Ltk;)V", line = 95)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lgd;)V", line = 202)
