...
public class class314 extends class305 {
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(B)I", line = 3)
    public final int method305(byte arg0) {
        ++field4458;
        return arg0 != 68 ? 1 : 1;
    }

    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(ZI)Lfa;", line = 29)
    ...
    @OriginalMember(owner = "client!aj", name = "a", descriptor = "(BLefa;Lefa;)V", line = 55)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(II)V", line = 80)
    ...
    @OriginalMember(owner = "client!aj", name = "b", descriptor = "(I)I", line = 91)
    ...
    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(ILhb;)V", line = 102)
    public class314(int arg0, class728 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!aj", name = "<init>", descriptor = "(Lhb;)V", line = 107)
    public class314(class728 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!aj", name = "c", descriptor = "(II)I", line = 110)
    ...
    @OriginalMember(owner = "client!aj", name = "d", descriptor = "(B)V", line = 125)
