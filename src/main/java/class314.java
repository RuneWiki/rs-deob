...
public class class314 implements class126 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)Ljv;", line = 13)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(I)V", line = 23)
    public class314(int arg0) {
        this.field4511 = arg0;
    }

    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)V", line = 44)
