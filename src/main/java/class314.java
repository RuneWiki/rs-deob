...
public class class314 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)V", line = 26)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IILgp;Ln;Ljava/awt/Canvas;)Lqa;", line = 226)
