...
public class class314 extends class75 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(I)J", line = 4)
    ...
    @OriginalMember(owner = "client!tp", name = "d", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!tp", name = "b", descriptor = "(B)J", line = 36)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(BI)I", line = 73)
