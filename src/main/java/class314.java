...
public class class314 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BI)V", line = 38)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(B)V", line = 64)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(BLjava/awt/Component;)Lln;", line = 77)
