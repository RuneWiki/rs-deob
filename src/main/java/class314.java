...
public class class314 extends class497 {
    ...
    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(BLjka;)V")
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(Lpp;)V")
    ...
    @OriginalMember(owner = "client!fr", name = "<init>", descriptor = "(ILpp;)V")
    public class314(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!fr", name = "a", descriptor = "(ILqo;)V")
