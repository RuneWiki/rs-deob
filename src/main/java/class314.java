...
public abstract class class314 extends class117 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(IBII)I", line = 19)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(B)V", line = 41)
    ...
    @OriginalMember(owner = "client!qd", name = "c", descriptor = "(Z)V", line = 70)
    ...
    @OriginalMember(owner = "client!qd", name = "e", descriptor = "(I)V", line = 80)
    ...
    @OriginalMember(owner = "client!qd", name = "<init>", descriptor = "(IIII)V", line = 138)
