...
public class class314 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(I)V", line = 19)
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(I)V", line = 42)
