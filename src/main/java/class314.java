...
public class class314 extends class334 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(II)I", line = 18)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "()V", line = 83)
    public class314() {
        super(1, true);
    }

    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(II)[I", line = 86)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(JILha;)V", line = 127)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IZLol;)V", line = 157)
    ...
    @OriginalMember(owner = "client!qu", name = "b", descriptor = "(BI)S", line = 192)
