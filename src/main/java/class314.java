...
public class class314 extends class194 {
    ...
    @OriginalMember(owner = "client!jr", name = "h", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(II)[[I", line = 16)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ZIIIZBII)V", line = 81)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(ILaq;)V", line = 296)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IILbg;)V", line = 320)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(BD)V", line = 334)
    ...
    @OriginalMember(owner = "client!jr", name = "g", descriptor = "(I)V", line = 371)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(III)V", line = 381)
    ...
    @OriginalMember(owner = "client!jr", name = "d", descriptor = "(I)I", line = 399)
    public final int method1199(int arg0) {
        ++field4227;
        return arg0 != -1 ? -13 : this.field4236;
    }

    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "()V", line = 413)
    public class314() {
        super(0, false);
    }
}
