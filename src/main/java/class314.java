...
public class class314 extends class319 {
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lwc;Lul;[Ldd;[I[I)V", line = 5)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([B[IIIIIIIIIIILta;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!qv", name = "B", descriptor = "(CIIIZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(CIIIZLta;II)V", line = 176)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([B[I[IIIIIII)V", line = 244)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([B[I[IIIIIIIIIIILta;II)V", line = 303)
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "([B[IIIIIIII)V", line = 393)
