...
public class class314 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Leq;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Leq;Lka;)Z")
    public final boolean method1891(class134 arg0, class314 arg1) {
        return this.field4606 != null || this.method1897(arg0, arg1);
    }

    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(Leq;Lka;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "c", descriptor = "(Leq;Lka;)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Leq;IIIIII)V")
    ...
    @OriginalMember(owner = "client!ka", name = "d", descriptor = "(Leq;Lka;)Z")
    ...
    @OriginalMember(owner = "client!ka", name = "b", descriptor = "(Leq;)V")
