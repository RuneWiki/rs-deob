...
public class class314 extends class217 implements class649 {
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(I)I", line = 3)
    ...
    @OriginalMember(owner = "client!qca", name = "e", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(ILha;)V", line = 41)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Lha;III)Z", line = 65)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(ILha;)Lgp;", line = 84)
    ...
    @OriginalMember(owner = "client!qca", name = "g", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(Lha;I)Ljl;", line = 106)
    ...
    @OriginalMember(owner = "client!qca", name = "m", descriptor = "(I)V", line = 159)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z)Z", line = 171)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lha;Lkha;IIIIIZIII)V", line = 277)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Lha;I)V", line = 190)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(ILha;)V", line = 202)
    ...
    @OriginalMember(owner = "client!qca", name = "j", descriptor = "(I)Z", line = 213)
    public final boolean method277(int arg0) {
        ++field4039;
        return arg0 != 3;
    }

    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(B)Z", line = 224)
    public final boolean method373(byte arg0) {
        ++field4047;
        return arg0 != -57;
    }

    @OriginalMember(owner = "client!qca", name = "f", descriptor = "(I)I", line = 236)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(B)V", line = 252)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(I)I", line = 265)
    ...
    @OriginalMember(owner = "client!qca", name = "n", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!qca", name = "d", descriptor = "(B)Z", line = 316)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IBZILha;ILig;)V", line = 339)
