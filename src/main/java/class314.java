...
public class class314 extends class728 {
    ...
    @OriginalMember(owner = "client!nba", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V", line = 3)
    public class314(OggStreamState arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;I)V", line = 16)
    public final void method1417(OggPacket arg0, int arg1) {
        field4468++;
        int var3 = 87 / ((arg1 - 34) / 54);
    }

    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(II)V", line = 35)
    ...
    @OriginalMember(owner = "client!nba", name = "b", descriptor = "(I)V", line = 45)
    ...
    @OriginalMember(owner = "client!nba", name = "a", descriptor = "(IIIZ)V", line = 59)
