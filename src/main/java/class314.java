...
public class class314 {
    ...
    @OriginalMember(owner = "client!afa", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!afa", name = "finalize", descriptor = "()V", line = 19)
    ...
    @OriginalMember(owner = "client!afa", name = "<init>", descriptor = "(Len;II)V", line = 28)
