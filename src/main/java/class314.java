...
public class class314 extends class220 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILjava/lang/String;B)V", line = 8)
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "()V", line = 87)
    public class314() {
        super(0, true);
    }

    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lud;Ljava/awt/Frame;Z)V", line = 98)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLro;I)Ljava/lang/String;", line = 132)
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IBLil;)V", line = 156)
    ...
    @OriginalMember(owner = "client!cl", name = "f", descriptor = "(B)V", line = 211)
    ...
    @OriginalMember(owner = "client!cl", name = "c", descriptor = "(II)[I", line = 239)
