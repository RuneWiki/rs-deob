...
public class class314 extends class204 {
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!td", name = "b", descriptor = "(I)[Lao;", line = 27)
    ...
    @OriginalMember(owner = "client!td", name = "c", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(IZIB)I", line = 65)
    ...
    @OriginalMember(owner = "client!td", name = "a", descriptor = "(Z)V", line = 102)
