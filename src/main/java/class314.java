...
public class class314 extends class599 {
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lkv;IIZ[[I)V")
    ...
    @OriginalMember(owner = "client!mu", name = "a", descriptor = "(Lcb;BLd;Ljava/awt/Canvas;I)Lha;")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lkv;II)V")
    ...
    @OriginalMember(owner = "client!mu", name = "<init>", descriptor = "(Lkv;IIZ[[BI)V")
