...
public class class314 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Luu;II)Lqv;", line = 48)
    ...
    @OriginalMember(owner = "client!qv", name = "b", descriptor = "()Ljp;", line = 58)
    ...
    @OriginalMember(owner = "client!qv", name = "c", descriptor = "()[B", line = 68)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lnj;)V", line = 129)
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "()V", line = 149)
    private class314() {
    }
}
