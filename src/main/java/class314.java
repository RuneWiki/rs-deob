...
public class class314 {
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!bk", name = "toString", descriptor = "()Ljava/lang/String;", line = 118)
    public final String toString() {
        field4007++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(II)Lil;", line = 136)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(BLos;I)V", line = 166)
    ...
    @OriginalMember(owner = "client!bk", name = "a", descriptor = "(III)V", line = 186)
