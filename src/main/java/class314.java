...
public class class314 extends class629 {
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "(III)I")
    ...
    @OriginalMember(owner = "client!iw", name = "d", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(ILqba;I)V")
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(I[IIILqba;I)V")
    ...
    @OriginalMember(owner = "client!iw", name = "b", descriptor = "()Lpda;")
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lem;)V")
