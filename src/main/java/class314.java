...
public abstract class class314 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III[I[Ll;ILjava/util/Random;Ljava/lang/String;IIIII[II)I", line = 39)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III[Ll;[IZIIIIILjava/lang/String;IILma;II)I", line = 115)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 216)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 230)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([IIIILjava/lang/String;[I[Ll;[I)V", line = 259)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/util/Random;[Ll;I[IILjava/lang/String;IIII)I", line = 428)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IBI)V", line = 463)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;)V", line = 486)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;)V", line = 561)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(B[II[Ll;ILjava/lang/String;II)V", line = 575)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IILjava/lang/String;III)V", line = 591)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZLjava/lang/String;III)V", line = 603)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;IB)V", line = 617)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II)I", line = 658)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I[II[Ll;IZLma;I)V", line = 681)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[Ll;IILma;IIIIIIIILjava/lang/String;[I)I", line = 841)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lya;Lgt;)V", line = 854)
    public class314(class38 arg0, class316 arg1) {
        this.field4457 = arg1;
        this.field4476 = arg0;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;IIII)V", line = 868)
