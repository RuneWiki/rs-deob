...
public class class314 extends class205 implements class619 {
    ...
    @OriginalMember(owner = "client!qca", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lrs;III)V", line = 122)
    ...
    @OriginalMember(owner = "client!qca", name = "<init>", descriptor = "(Lrs;IIII)V", line = 148)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IIB)Z", line = 26)
    ...
    @OriginalMember(owner = "client!qca", name = "finalize", descriptor = "()V", line = 38)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Z[S)[S", line = 47)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(IZI)V", line = 70)
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(B)V", line = 83)
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "(II)V", line = 104)
    ...
    @OriginalMember(owner = "client!qca", name = "f", descriptor = "(B)V", line = 139)
