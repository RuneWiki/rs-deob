...
public class class314 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I[SZ[Ljava/lang/String;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(I)Z", line = 84)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(Lr;ILfa;)V", line = 163)
    ...
    @OriginalMember(owner = "client!fk", name = "b", descriptor = "(I)V", line = 392)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IILvm;Lvm;)Lo;", line = 432)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BLek;)Lbca;", line = 443)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(ZLvm;Lvm;IB)Lo;", line = 455)
    ...
    @OriginalMember(owner = "client!fk", name = "<init>", descriptor = "(Ldga;Lms;Ljava/math/BigInteger;Ljava/math/BigInteger;)V", line = 496)
