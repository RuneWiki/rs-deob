...
public class class314 {
    ...
    @OriginalMember(owner = "client!dj", name = "b", descriptor = "(II)Lkc;")
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(IIIBIII)Lrp;")
    ...
    @OriginalMember(owner = "client!dj", name = "<init>", descriptor = "(Llo;IZLnl;Lnl;)V")
