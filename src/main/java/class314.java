...
public class class314 extends class46 {
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 9)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 21)
    ...
    @OriginalMember(owner = "client!gt", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 42)
