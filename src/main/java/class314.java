...
public class class314 {
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(II)I", line = 4)
    ...
    @OriginalMember(owner = "client!bf", name = "a", descriptor = "(ILjagdx/IDirect3DSurface;Ljagdx/IDirect3DSwapChain;)V", line = 43)
    ...
    @OriginalMember(owner = "client!bf", name = "b", descriptor = "(I)Z", line = 53)
    public final boolean method2053(int arg0) {
        int var2 = 19 % ((-arg0 - 34) / 60);
        return this.field4355 != null;
    }

    @OriginalMember(owner = "client!bf", name = "<init>", descriptor = "(Ljagdx/IDirect3DSwapChain;Ljagdx/IDirect3DSurface;)V", line = 60)
