...
public abstract class class314 {
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IBI)V", line = 14)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(ILen;)V", line = 32)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IIBI[[B[[BLen;ILng;[Z[[BLgf;II)V", line = 113)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(IB[I)[I", line = 602)
    ...
    @OriginalMember(owner = "client!tp", name = "a", descriptor = "(III)Lmf;", line = 665)
