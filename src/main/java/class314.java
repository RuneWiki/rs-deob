...
public class class314 extends class117 {
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(ILfc;ZLjava/lang/String;)Lnf;", line = 18)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IIIIILkm;)V", line = 68)
    ...
    @OriginalMember(owner = "client!pg", name = "<init>", descriptor = "(Lao;)V", line = 167)
    public class314(class288 arg0) {
        this.field4257 = arg0;
    }

    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(II)S", line = 175)
    ...
    @OriginalMember(owner = "client!pg", name = "a", descriptor = "(IILjava/lang/String;)V", line = 203)
