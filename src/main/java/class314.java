...
public class class314 {
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(IIILwq;BLza;II)Lo;")
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(ILza;ILza;ZIZILwq;ILla;I)Lo;")
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(II)Lcs;")
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(Lpt;IZLcg;Lum;Lum;)V")
