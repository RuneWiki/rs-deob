...
public class class314 extends class134 {
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIBI[[Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(IIIIZII)V", line = 59)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(SI)V", line = 238)
    ...
    @OriginalMember(owner = "client!iw", name = "a", descriptor = "(B)V", line = 255)
    ...
    @OriginalMember(owner = "client!iw", name = "<init>", descriptor = "(Lnv;Leo;Lada;[I)V", line = 290)
