...
public class class314 extends class164 {
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(BLun;)V", line = 3)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Ln;Z)V", line = 24)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ZII)Z", line = 42)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(ILun;B)V", line = 54)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(B)V", line = 76)
    ...
    @OriginalMember(owner = "client!dj", name = "a", descriptor = "(Ln;I)V", line = 104)
