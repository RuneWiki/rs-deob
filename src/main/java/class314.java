...
public abstract class class314 extends class66 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(III)[I", line = 6)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(BLie;I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(III)V", line = 76)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IIB)[[I", line = 100)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IB)[[I", line = 133)
    ...
    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(I)I", line = 144)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(I)I", line = 162)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(II)[I", line = 173)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Z)V", line = 186)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "(IZ)V", line = 238)
    public class314(int arg0, boolean arg1) {
        this.field4936 = arg1;
        this.field4927 = new class314[arg0];
    }

    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(IZI)V", line = 249)
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(B)V", line = 274)
    ...
    @OriginalMember(owner = "client!ng", name = "g", descriptor = "(I)V", line = 288)
