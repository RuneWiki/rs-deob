...
public class class314 {
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IB)Lhm;", line = 20)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(IIZ)Z", line = 47)
    ...
    @OriginalMember(owner = "client!fk", name = "a", descriptor = "(BLoa;I)Z", line = 66)
