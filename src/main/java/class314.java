...
public class class314 {
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(I)Lcca;", line = 18)
    ...
    @OriginalMember(owner = "client!wo", name = "c", descriptor = "(I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!wo", name = "<init>", descriptor = "()V", line = 220)
    public class314() {
        this.field4019.field9860 = this.field4019;
        this.field4019.field9862 = this.field4019;
    }

    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(B)Lcca;", line = 55)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(Lus;ZLrr;)Lida;", line = 79)
    ...
    @OriginalMember(owner = "client!wo", name = "b", descriptor = "(B)V", line = 117)
    ...
    @OriginalMember(owner = "client!wo", name = "d", descriptor = "(I)Lcca;", line = 143)
    ...
    @OriginalMember(owner = "client!wo", name = "a", descriptor = "(ILcca;)V", line = 164)
    ...
    @OriginalMember(owner = "client!wo", name = "e", descriptor = "(I)Lcca;", line = 182)
    ...
    @OriginalMember(owner = "client!wo", name = "f", descriptor = "(I)I", line = 202)
