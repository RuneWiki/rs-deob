...
public class class314 {
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ljava/applet/Applet;[Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/Object;", line = 3)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(ILjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!wu", name = "a", descriptor = "(Ljava/lang/String;ZLjava/applet/Applet;)V", line = 23)
