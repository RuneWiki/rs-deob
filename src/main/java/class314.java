...
public class class314 {
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(BI)Lkb;")
    ...
    @OriginalMember(owner = "client!uq", name = "<init>", descriptor = "(Lkb;)V")
    ...
    @OriginalMember(owner = "client!uq", name = "a", descriptor = "(ZLkb;)V")
