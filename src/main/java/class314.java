...
public class class314 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Lnk;III)V", line = 3)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IIILje;Lwm;Ljg;Lnp;I)V", line = 24)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(BI)Lje;", line = 87)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(IZLac;Lac;IBZ)I", line = 167)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(II)Lte;", line = 201)
    ...
    @OriginalMember(owner = "client!mi", name = "b", descriptor = "(I)V", line = 266)
    public static void method1732(int arg0) {
        int var1 = -85 / ((1 - arg0) / 60);
        field4171 = null;
    }

    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(Ldn;ILr;Lr;)V", line = 285)
