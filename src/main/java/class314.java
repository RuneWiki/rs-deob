...
public class class314 extends class339 implements class111 {
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ZILhh;Lpe;III)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IILpe;)Lsj;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lpe;II)Lsj;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(ILpe;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(IILpe;I)Z")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lpe;B)Lca;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lpe;I)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(III)Lbe;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lpg;ILjava/awt/Canvas;ZLbd;I)Lpe;")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(BLpe;)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lpe;IIZ)Lil;")
    ...
    @OriginalMember(owner = "client!cl", name = "<init>", descriptor = "(Lpe;Lkk;IIIIZIIZ)V")
    ...
    @OriginalMember(owner = "client!cl", name = "a", descriptor = "(Lr;I)I")
