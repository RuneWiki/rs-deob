...
public class class314 extends class712 {
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Z)Ljc;", line = 53)
    ...
    @OriginalMember(owner = "client!wt", name = "<init>", descriptor = "(Lrda;IIIIII)V", line = 112)
