...
public class class432 implements Runnable {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/Class;Ljava/lang/String;I[Ljava/lang/Class;)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BI)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/Class;I)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILjava/lang/Object;III)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIILjava/awt/Component;)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZZLjava/awt/Component;)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZLjava/lang/String;)Lrm;")
    public final class281 method2580(boolean arg0, String arg1) {
        return arg0 ? this.method2573(0, arg1, 102, 21, 0) : null;
    }

    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "c", descriptor = "(I)Laf;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ILjava/awt/Point;Ljava/awt/Component;[III)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BLjava/lang/String;Ljava/lang/Class;)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/net/URL;I)Lrm;")
    public final class281 method2586(URL arg0, int arg1) {
        return arg1 == 19 ? this.method2573(0, arg0, 124, 4, 0) : null;
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/Object;BIII)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/awt/datatransfer/Transferable;I)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/String;Z)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/awt/Frame;B)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/Class;Z)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Z)Lrm;")
    public final class281 method2594(boolean arg0) {
        return arg0 ? null : this.method2573(0, null, 75, 5, 0);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/Runnable;II)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIII)Lrm;")
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/String;I)Lrm;")
    public final class281 method2597(String arg0, int arg1) {
        int var3 = -93 % ((arg1 + 33) / 58);
        return this.method2573(0, arg0, 12, 16, 0);
    }

    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(Ljava/lang/String;IB)Lrm;")
