...
public class class432 extends class504 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(BIZ)V", line = 38)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lqc;Z)V", line = 54)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ILmc;)V", line = 84)
