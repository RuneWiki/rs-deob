...
public class class432 extends class354 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lwo;)V", line = 21)
    public class432(class746 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(CLjava/lang/String;Ljava/lang/String;B)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(B)I", line = 79)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(II)I", line = 89)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(B)I", line = 107)
    ...
    @OriginalMember(owner = "client!mea", name = "c", descriptor = "(I)Z", line = 117)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(ILwo;)V", line = 133)
    public class432(int arg0, class746 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mea", name = "c", descriptor = "(II)V", line = 137)
    ...
    @OriginalMember(owner = "client!mea", name = "d", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!mea", name = "c", descriptor = "(B)V", line = 174)
