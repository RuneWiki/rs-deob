...
public class class432 extends class446 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(IILac;)V")
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Lig;B)V")
    ...
    @OriginalMember(owner = "client!cf", name = "c", descriptor = "(I)[Llb;")
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lda;Lai;)V")
