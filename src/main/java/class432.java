...
public class class432 implements class347 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(ILea;Ljb;Lf;IIII)V", line = 17)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(II)I", line = 66)
    public static final int method2586(int arg0, int arg1) {
        return class518.field7684 == null ? 0 : (class518.field7684[arg0][arg1] & 0xFF) << 3;
    }

    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IIILjava/lang/Class;)Lvj;", line = 70)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(IB)V", line = 98)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 115)
    public class432(String arg0, int arg1) {
        this.field6407 = arg1;
    }

    @OriginalMember(owner = "client!gl", name = "toString", descriptor = "()Ljava/lang/String;", line = 125)
