...
public class class432 {
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(ILfs;J)V")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(JI)Lfs;")
    ...
    @OriginalMember(owner = "client!tl", name = "a", descriptor = "(Z)Lfs;")
