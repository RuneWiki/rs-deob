...
public abstract class class432 extends class320 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIILmq;ILea;IJI)V", line = 3)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(ZII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ji", name = "e", descriptor = "(I)V", line = 82)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIZ)V", line = 99)
