...
public class class432 {
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BLbt;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(BILbt;I)V", line = 36)
    ...
    @OriginalMember(owner = "client!fp", name = "a", descriptor = "(Ljava/lang/String;B)[B", line = 96)
