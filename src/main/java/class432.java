...
public class class432 extends class511 {
    ...
    @OriginalMember(owner = "client!gs", name = "<init>", descriptor = "(I)V", line = 5)
    public class432(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!gs", name = "A", descriptor = "(I)I", line = 12)
    ...
    @OriginalMember(owner = "client!gs", name = "o", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!gs", name = "B", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "([BIII)V", line = 628)
    ...
    @OriginalMember(owner = "client!gs", name = "l", descriptor = "(B)V", line = 644)
    ...
    @OriginalMember(owner = "client!gs", name = "p", descriptor = "(II)I", line = 661)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(Laia;I)V", line = 691)
    ...
    @OriginalMember(owner = "client!gs", name = "a", descriptor = "(B[I)V", line = 704)
    ...
    @OriginalMember(owner = "client!gs", name = "C", descriptor = "(I)Z", line = 720)
    ...
    @OriginalMember(owner = "client!gs", name = "q", descriptor = "(II)I", line = 740)
    public final int method2595(int arg0, int arg1) {
        ++field5998;
        return arg1 < 21 ? 46 : arg0 * 8 + -this.field6008;
    }

    @OriginalMember(owner = "client!gs", name = "m", descriptor = "(B)V", line = 751)
    ...
    @OriginalMember(owner = "client!gs", name = "D", descriptor = "(I)V", line = 766)
