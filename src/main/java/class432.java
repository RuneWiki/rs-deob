...
public class class432 extends class530 {
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(I)I", line = 20)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!sca", name = "c", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!sca", name = "a", descriptor = "(II)I", line = 70)
    ...
    @OriginalMember(owner = "client!sca", name = "b", descriptor = "(Z)Z", line = 88)
    ...
    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(Lah;)V", line = 104)
    public class432(class374 arg0) {
        super(arg0);
        class8.method37(true, super.field7419);
    }

    @OriginalMember(owner = "client!sca", name = "<init>", descriptor = "(ILah;)V", line = 117)
