...
public class class432 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lpf;ZI)Lwd;", line = 5)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIBI)Leq;", line = 44)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(IIZZIIIIIILec;I)V", line = 115)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(BJ)V", line = 244)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 328)
