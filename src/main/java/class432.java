...
public class class432 extends class90 {
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "(CIIIZLpa;II)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([B[I[IIIIIIIIIIILpa;II)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!qj", name = "HA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!qj", name = "<init>", descriptor = "(Lhr;Lfc;[Ldp;[I[I)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([B[IIIIIIIIIIILpa;II)V")
    ...
    @OriginalMember(owner = "client!qj", name = "a", descriptor = "([B[IIIIIIII)V")
