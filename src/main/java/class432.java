...
public class class432 extends class211 {
    ...
    @OriginalMember(owner = "client!dg", name = "<init>", descriptor = "()V", line = 137)
    public class432() {
        super(1, false);
    }

    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(IIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(II)Z", line = 231)
    ...
    @OriginalMember(owner = "client!dg", name = "b", descriptor = "(II)[I", line = 242)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(BILib;)V", line = 331)
    ...
    @OriginalMember(owner = "client!dg", name = "a", descriptor = "(ILha;IILcn;IIILaa;)V", line = 385)
    ...
    @OriginalMember(owner = "client!dg", name = "c", descriptor = "(I)V", line = 560)
