...
public class class432 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(Lfj;II)V", line = 6)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IIILfj;IILfj;IIB)V", line = 67)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)V", line = 116)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)V", line = 126)
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(IBZII)V", line = 142)
