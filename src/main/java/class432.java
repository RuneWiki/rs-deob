...
public class class432 {
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(IIZILha;Lmk;IIIIII)V", line = 40)
    ...
    @OriginalMember(owner = "client!wl", name = "a", descriptor = "(FIIIIIZII)[[I", line = 115)
    ...
    @OriginalMember(owner = "client!wl", name = "b", descriptor = "(I)V", line = 160)
