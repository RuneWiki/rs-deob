...
public class class432 extends class354 {
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(B)V", line = 19)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 109)
    public class432() {
        super(1, true);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILti;I)V", line = 37)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IB)[I", line = 71)
