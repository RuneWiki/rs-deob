...
public class class432 extends class354 {
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Lnj;II)V", line = 27)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(ZII)V", line = 41)
    ...
    @OriginalMember(owner = "client!ai", name = "b", descriptor = "(BI)[I", line = 116)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(IB)[[I", line = 162)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "()V", line = 204)
    public class432() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ai", name = "h", descriptor = "(I)V", line = 207)
