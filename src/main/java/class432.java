...
public class class432 extends class404 {
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!pd", name = "b", descriptor = "(III)V", line = 18)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(IBI)V", line = 36)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)V", line = 55)
    ...
    @OriginalMember(owner = "client!pd", name = "<init>", descriptor = "(IIIIIII)V", line = 74)
