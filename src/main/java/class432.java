...
public class class432 {
    ...
    @OriginalMember(owner = "client!wi", name = "b", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!wi", name = "c", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(Z[B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!wi", name = "a", descriptor = "(IIIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "()V", line = 128)
    public class432() {
    }

    @OriginalMember(owner = "client!wi", name = "<init>", descriptor = "(Lun;)V", line = 137)
