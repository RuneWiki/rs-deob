...
public class class432 extends class184 {
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(II)I", line = 5)
    ...
    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(Z)V", line = 22)
    ...
    @OriginalMember(owner = "client!uba", name = "<init>", descriptor = "(Lkd;)V", line = 35)
    public class432(class282 arg0) {
        this.field6439 = arg0;
    }

    @OriginalMember(owner = "client!uba", name = "a", descriptor = "(ZII)I", line = 48)
