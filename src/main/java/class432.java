...
public class class432 extends class86 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "([III)V", line = 10)
    ...
    @OriginalMember(owner = "client!iq", name = "c", descriptor = "([III)V", line = 59)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lnd;Lno;)V", line = 68)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lno;)V", line = 77)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lhu;)V", line = 92)
    public final synchronized void method2530(class86 arg0) {
        this.field6126.method164(arg0, (byte) -91);
    }

    @OriginalMember(owner = "client!iq", name = "e", descriptor = "()I", line = 96)
    public final synchronized int method2531() {
        return this.field6126.method156(-128);
    }

    @OriginalMember(owner = "client!iq", name = "c", descriptor = "()I", line = 99)
    public final int method691() {
        return 0;
    }

    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(I)V", line = 107)
    ...
    @OriginalMember(owner = "client!iq", name = "d", descriptor = "()Lhu;", line = 152)
    public final class86 method692() {
        return (class86) this.field6126.method161(-121);
    }

    @OriginalMember(owner = "client!iq", name = "b", descriptor = "(Lhu;)V", line = 156)
    public final synchronized void method2532(class86 arg0) {
        arg0.method2165(16225);
    }

    @OriginalMember(owner = "client!iq", name = "e", descriptor = "(I)V", line = 162)
    ...
    @OriginalMember(owner = "client!iq", name = "f", descriptor = "()V", line = 180)
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "()Lhu;", line = 198)
