...
public class class432 extends class181 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "([B[IIIIIIIIIIILfa;II)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "<init>", descriptor = "(Lfk;Lcq;[Laf;[I[I)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(CIIIZLfa;II)V")
    ...
    @OriginalMember(owner = "client!eaa", name = "q", descriptor = "(CIIIZ)V")
