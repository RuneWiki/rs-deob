...
public class class432 extends class589 {
    ...
    @OriginalMember(owner = "client!qm", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!qm", name = "c", descriptor = "(IIII)[B", line = 21)
    ...
    @OriginalMember(owner = "client!qm", name = "a", descriptor = "(BII)V", line = 37)
    ...
    @OriginalMember(owner = "client!qm", name = "<init>", descriptor = "()V", line = 55)
    public class432() {
