...
public class class432 extends class210 {
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(II)Lfo;")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IILat;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "([II[ILwc;[I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lgk;Lgk;I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IIILkg;)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BI)Lkg;")
