...
public class class432 {
    ...
    @OriginalMember(owner = "client!gaa", name = "toString", descriptor = "()Ljava/lang/String;")
    public final String toString() {
        field5576++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(Lfd;B)Lqga;")
    ...
    @OriginalMember(owner = "client!gaa", name = "a", descriptor = "(ILe;Ljava/awt/Canvas;ILpe;)Loa;")
