...
public class class432 {
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(ILam;)V", line = 20)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(Lii;I)I", line = 64)
    ...
    @OriginalMember(owner = "client!dk", name = "a", descriptor = "(B)V", line = 106)
