...
public class class432 {
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(B)Lpt;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(I)Lpt;")
    ...
    @OriginalMember(owner = "client!cp", name = "a", descriptor = "(BLvf;)V")
    ...
    @OriginalMember(owner = "client!cp", name = "<init>", descriptor = "(Lvf;)V")
