...
public class class432 extends class399 {
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(IIII)[B", line = 4)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(II)Lrda;", line = 21)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "([BZ)Ljava/lang/String;", line = 34)
    ...
    @OriginalMember(owner = "client!cq", name = "a", descriptor = "(ZBI)V", line = 47)
    ...
    @OriginalMember(owner = "client!cq", name = "b", descriptor = "(II)V", line = 66)
    ...
    @OriginalMember(owner = "client!cq", name = "<init>", descriptor = "()V", line = 82)
    public class432() {
        super(8, 5, 8, 8, 2, 0.1F, 0.55F, 3.0F);
    }

    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(IIII)V", line = 90)
    ...
    @OriginalMember(owner = "client!cq", name = "c", descriptor = "(I)V", line = 106)
