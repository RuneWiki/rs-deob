...
public class class432 {
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "([BI[BIII)I", line = 102)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIII)V", line = 248)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "([BIBI[BI)I", line = 270)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(I)V", line = 342)
    ...
    @OriginalMember(owner = "client!ji", name = "b", descriptor = "(I)Laq;", line = 356)
    ...
    @OriginalMember(owner = "client!ji", name = "a", descriptor = "(IIIIIII)I", line = 385)
    ...
    @OriginalMember(owner = "client!ji", name = "<init>", descriptor = "([B)V", line = 419)
