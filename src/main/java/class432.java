...
public class class432 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Ljava/lang/String;Ljava/applet/Applet;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(Ljava/lang/String;[Ljava/lang/Object;ILjava/applet/Applet;)Ljava/lang/Object;", line = 15)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(ILjava/lang/String;Ljava/applet/Applet;)Ljava/lang/Object;", line = 25)
