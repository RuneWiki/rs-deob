...
public class class432 {
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(B)V", line = 18)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(II)V", line = 31)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Z)V", line = 53)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(Lrb;III)V", line = 75)
    ...
    @OriginalMember(owner = "client!pd", name = "a", descriptor = "(I)V", line = 127)
