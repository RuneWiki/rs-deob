...
public class class432 extends class376 {
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IIB)V", line = 8)
    ...
    @OriginalMember(owner = "client!cm", name = "c", descriptor = "(B)V", line = 24)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IZ)V", line = 44)
    ...
    @OriginalMember(owner = "client!cm", name = "a", descriptor = "(IBZI)Ljava/lang/String;", line = 151)
