...
public class class405 extends class81 {
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(Lbm;IIIIIZIIIILea;Z)V")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(II[ILbm;I[IIIIZIBIII)I")
    ...
    @OriginalMember(owner = "client!fe", name = "a", descriptor = "(IZLok;Ljava/lang/String;)V")
    ...
    @OriginalMember(owner = "client!fe", name = "b", descriptor = "(IB)Lrr;")
