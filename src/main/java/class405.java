...
public class class405 {
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(IILol;)V", line = 17)
    ...
    @OriginalMember(owner = "client!hca", name = "a", descriptor = "(Lol;B)V", line = 87)
    ...
    @OriginalMember(owner = "client!hca", name = "b", descriptor = "(B)V", line = 112)
