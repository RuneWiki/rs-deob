...
public class class405 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILhp;III)V", line = 5)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(Z)V", line = 58)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(B)[Leaa;", line = 69)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(BCI)I", line = 81)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZZLwda;)V", line = 100)
    ...
    @OriginalMember(owner = "client!es", name = "b", descriptor = "(Z)V", line = 263)
