...
public class class405 {
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([Ljava/lang/Object;I[Ljava/lang/Object;II)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([JI[JII)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([FI[FII)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([BI[BII)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([SI[SII)V")
    ...
    @OriginalMember(owner = "client!uj", name = "a", descriptor = "([II[III)V")
