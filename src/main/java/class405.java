...
public class class405 {
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(I)V", line = 15)
    public final void method2277(int arg0) {
        this.field5226.method1222(arg0 ^ 0x38E1, arg0);
        field5225++;
    }

    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!rp", name = "a", descriptor = "(ZI)Lem;", line = 42)
    ...
    @OriginalMember(owner = "client!rp", name = "<init>", descriptor = "(Lkea;Le;)V", line = 81)
