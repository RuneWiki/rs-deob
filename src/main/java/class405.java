...
public class class405 extends class115 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)Z", line = 4)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(I)V", line = 22)
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(I)V", line = 32)
