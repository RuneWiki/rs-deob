...
public class class405 extends class325 {
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(Lnha;Ljn;IIIIIIIIIIIIII)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)Lvj;")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILfc;Ljava/lang/String;ZZ)V")
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Lla;Ljava/awt/Canvas;IIBLd;)Lha;")
