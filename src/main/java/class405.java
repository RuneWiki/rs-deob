...
public class class405 {
    ...
    @OriginalMember(owner = "client!ii", name = "b", descriptor = "(B)V", line = 28)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(IIIIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ii", name = "a", descriptor = "(II)Ljr;", line = 609)
