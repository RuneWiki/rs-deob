...
public class class405 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BLe;)V", line = 24)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Z)V", line = 55)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ZB)V", line = 88)
