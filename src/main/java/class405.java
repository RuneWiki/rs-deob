...
public abstract class class405 {
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(Lha;IIIIIIZZ)V", line = 6)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "(I)V", line = 126)
    ...
    @OriginalMember(owner = "client!df", name = "a", descriptor = "([ILfs;[II[I)V", line = 139)
    ...
    @OriginalMember(owner = "client!df", name = "<init>", descriptor = "(III)V", line = 242)
