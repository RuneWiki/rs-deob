...
public class class405 extends class354 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Z)V", line = 12)
    public final void method771(boolean arg0) {
        ++field5968;
        class291.method1807(arg0);
    }

    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "()V", line = 28)
    public class405() {
        super(0, true);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BII)Z", line = 35)
    ...
    @OriginalMember(owner = "client!iu", name = "e", descriptor = "(I)V", line = 53)
    ...
    @OriginalMember(owner = "client!iu", name = "b", descriptor = "(IIB)Z", line = 68)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IB)[I", line = 86)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(ILti;I)V", line = 151)
