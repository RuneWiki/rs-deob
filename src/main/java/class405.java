...
public class class405 extends class352 {
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(JI)V", line = 3)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Lah;Ljava/lang/Object;I)V", line = 20)
    public class405(class250 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5893 = arg1;
    }

    @OriginalMember(owner = "client!rj", name = "f", descriptor = "(I)V", line = 28)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(B)Z", line = 40)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(IIBI)I", line = 58)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(B)Ljava/lang/Object;", line = 82)
