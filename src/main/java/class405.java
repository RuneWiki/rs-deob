...
public class class405 extends class189 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(B)V", line = 48)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(I)V", line = 70)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(B)V", line = 97)
