...
public class class405 {
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Loi;ZLoi;)V", line = 18)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 49)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(B)V", line = 60)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(II)Lgu;", line = 79)
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(Lih;Ll;)V", line = 138)
