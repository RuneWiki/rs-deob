...
public class class405 extends class642 {
    ...
    @OriginalMember(owner = "client!daa", name = "f", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!daa", name = "g", descriptor = "(I)V", line = 14)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(II)[[I", line = 26)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "()V", line = 92)
    public class405() {
        super(1, false);
    }

    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(II)[I", line = 95)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(BI)V", line = 133)
    ...
    @OriginalMember(owner = "client!daa", name = "c", descriptor = "(II)I", line = 150)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Lhg;)V", line = 162)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(ILgk;B)V", line = 261)
