...
public class class405 extends class346 {
    ...
    @OriginalMember(owner = "client!ng", name = "a", descriptor = "(Lfb;ZI)V", line = 12)
    ...
    @OriginalMember(owner = "client!ng", name = "<init>", descriptor = "()V", line = 56)
    public class405() {
        super(1, false);
    }

    @OriginalMember(owner = "client!ng", name = "b", descriptor = "(II)[I", line = 62)
    ...
    @OriginalMember(owner = "client!ng", name = "c", descriptor = "(II)[[I", line = 158)
