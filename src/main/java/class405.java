...
public class class405 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lmd;II)Z")
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)[Lph;")
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lrl;II)V")
