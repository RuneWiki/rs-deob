...
public class class405 extends class600 {
    ...
    @OriginalMember(owner = "client!ao", name = "a", descriptor = "(ZILr;I)Lla;")
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Len;II[B)V")
    ...
    @OriginalMember(owner = "client!ao", name = "<init>", descriptor = "(Len;II[I)V")
