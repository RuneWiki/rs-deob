...
public class class405 {
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(II)I", line = 83)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(B)V", line = 101)
    ...
    @OriginalMember(owner = "client!vj", name = "a", descriptor = "(BLkj;)I", line = 115)
    ...
    @OriginalMember(owner = "client!vj", name = "toString", descriptor = "()Ljava/lang/String;", line = 142)
