...
public class class405 {
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(Los;I)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(ILos;Z)V")
    ...
    @OriginalMember(owner = "client!eu", name = "a", descriptor = "(IIB)B")
