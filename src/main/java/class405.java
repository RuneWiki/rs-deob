...
public class class405 extends class7 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IILne;I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(IIIIIIILfn;III)Z")
    ...
    @OriginalMember(owner = "client!ar", name = "<init>", descriptor = "(Lle;)V")
