...
public class class405 extends class22 {
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(B)I", line = 3)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IILco;ILqa;ZZ)V", line = 28)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Z)Z", line = 43)
    ...
    @OriginalMember(owner = "client!uo", name = "i", descriptor = "(I)I", line = 56)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIIIIZLid;II)Z", line = 77)
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(B)Z", line = 328)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(I)I", line = 344)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IILqa;)Z", line = 366)
    ...
    @OriginalMember(owner = "client!uo", name = "f", descriptor = "(I)I", line = 556)
    public final int method215(int arg0) {
        ++field5625;
        return arg0 != 0 ? -95 : super.field272;
    }

    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lqa;III)Z", line = 572)
    ...
    @OriginalMember(owner = "client!uo", name = "e", descriptor = "(I)V", line = 606)
    ...
    @OriginalMember(owner = "client!uo", name = "c", descriptor = "(ILqa;)V", line = 617)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIZZII)V", line = 637)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lef;I)V", line = 716)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIILtf;IILuo;Lpk;)V", line = 731)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BII)V", line = 825)
    ...
    @OriginalMember(owner = "client!uo", name = "j", descriptor = "(I)V", line = 920)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lqa;I)Lip;", line = 934)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(Z)Z", line = 1050)
