...
public class class405 extends class11 {
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZZ)V", line = 25)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IIB)V", line = 35)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(ZIIIILhi;I)V", line = 74)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(B)Z", line = 132)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "(Lad;Lme;)V", line = 168)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IILpm;)V", line = 150)
    ...
    @OriginalMember(owner = "client!so", name = "c", descriptor = "(I)V", line = 187)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(IZ)V", line = 200)
