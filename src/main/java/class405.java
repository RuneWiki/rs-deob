...
public class class405 extends class98 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IIIII)Lbg;")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lqr;I)V")
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILdg;I)V")
