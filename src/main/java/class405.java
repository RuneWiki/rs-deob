...
public class class405 extends class188 {
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(I)Z", line = 3)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!es", name = "<init>", descriptor = "(Lpa;Laj;Llja;)V", line = 34)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IIZ)V", line = 50)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(ILjava/lang/String;BLdia;)Ltd;", line = 78)
    ...
    @OriginalMember(owner = "client!es", name = "f", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IBLbm;)V", line = 129)
    public final void method959(int arg0, byte arg1, class123 arg2) {
        ++field5878;
        int var4 = -85 % ((60 - arg1) / 61);
    }

    @OriginalMember(owner = "client!es", name = "a", descriptor = "(IZ)V", line = 139)
