...
public class class405 implements class389 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILjava/lang/String;Lla;III)I", line = 4)
    ...
    @OriginalMember(owner = "client!lo", name = "c", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 39)
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(I)Z", line = 50)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)[Lvn;", line = 63)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ZZ)V", line = 78)
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lcv;Lgaa;)V", line = 111)
