...
public class class405 extends class739 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ZI)[I", line = 11)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(ILhga;Ljava/awt/Component;BI)Lmda;", line = 50)
    ...
    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "()V", line = 132)
    public class405() {
        super(1, true);
    }

    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(II[B)[B", line = 137)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I[B)V", line = 154)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(BI)V", line = 229)
    ...
    @OriginalMember(owner = "client!ge", name = "c", descriptor = "(I)V", line = 249)
