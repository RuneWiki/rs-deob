...
public class class405 extends class89 {
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Ldr;Ljava/lang/Object;I)V", line = 4)
    public class405(class750 arg0, Object arg1, int arg2) {
        super(arg0, arg2);
        this.field5534 = new SoftReference(arg1);
    }

    @OriginalMember(owner = "client!bp", name = "e", descriptor = "(I)Ljava/lang/Object;", line = 13)
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(I)Z", line = 24)
