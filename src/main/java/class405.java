...
public class class405 extends class384 {
    ...
    @OriginalMember(owner = "client!mha", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!mha", name = "<init>", descriptor = "(Lck;Lkha;)V")
    ...
    @OriginalMember(owner = "client!mha", name = "a", descriptor = "(Lbia;BI)V")
