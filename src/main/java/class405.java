...
public class class405 extends class441 implements class143 {
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(ILvq;)V", line = 3)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!gi", name = "e", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Z)Z", line = 277)
    public final boolean method608(boolean arg0) {
        ++field5669;
        return arg0 ? true : this.field5677.method1706(102);
    }

    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(IILvq;)Lni;", line = 288)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lvq;IIB)Z", line = 300)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lvq;I)V", line = 319)
    ...
    @OriginalMember(owner = "client!gi", name = "<init>", descriptor = "(Lvq;Lbi;IIIIIIIZIIII)V", line = 329)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(B)I", line = 339)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(B)I", line = 351)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(I)V", line = 363)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(Lvq;B)V", line = 373)
    ...
    @OriginalMember(owner = "client!gi", name = "b", descriptor = "(I)I", line = 396)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLvq;)Lbf;", line = 407)
    ...
    @OriginalMember(owner = "client!gi", name = "f", descriptor = "(B)V", line = 444)
    ...
    @OriginalMember(owner = "client!gi", name = "a", descriptor = "(BLsp;)V", line = 459)
    ...
    @OriginalMember(owner = "client!gi", name = "d", descriptor = "(B)I", line = 475)
