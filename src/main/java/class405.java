...
public class class405 extends class143 {
    ...
    @OriginalMember(owner = "client!ul", name = "k", descriptor = "(IILba;)Lba;")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lku;[I)V")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(Lba;IIIIZ)Z")
    ...
    @OriginalMember(owner = "client!ul", name = "a", descriptor = "(IILua;I)V")
    ...
    @OriginalMember(owner = "client!ul", name = "<init>", descriptor = "(Lug;IIII[[I[[II)V")
    ...
    @OriginalMember(owner = "client!ul", name = "b", descriptor = "(Lba;IIIIZ)V")
    ...
    @OriginalMember(owner = "client!ul", name = "p", descriptor = "(Lba;IIIIZ)V")
