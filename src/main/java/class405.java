...
public class class405 extends class551 {
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lps;IB)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "(Lps;B)V")
    ...
    @OriginalMember(owner = "client!ce", name = "a", descriptor = "([JB[I)V")
