...
public abstract class class405 extends class417 {
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(I)F", line = 6)
    public final float method2382(int arg0) {
        field5545++;
        return arg0 == 0 ? this.field5546 : 0.29109082F;
    }

    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(I)I", line = 24)
    ...
    @OriginalMember(owner = "client!nm", name = "c", descriptor = "(I)I", line = 35)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(B)Z", line = 49)
    ...
    @OriginalMember(owner = "client!nm", name = "a", descriptor = "(IIIIIII)V", line = 150)
    ...
    @OriginalMember(owner = "client!nm", name = "g", descriptor = "(I)V", line = 340)
    ...
    @OriginalMember(owner = "client!nm", name = "<init>", descriptor = "(IIIIIF)V", line = 352)
    ...
    @OriginalMember(owner = "client!nm", name = "b", descriptor = "(B)I", line = 365)
    ...
    @OriginalMember(owner = "client!nm", name = "h", descriptor = "(I)I", line = 381)
    public final int method2389(int arg0) {
        field5544++;
        return arg0 == -10161 ? this.field5536 : 103;
    }

    @OriginalMember(owner = "client!nm", name = "i", descriptor = "(I)I", line = 392)
