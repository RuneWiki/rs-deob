...
public class class405 extends class623 {
    ...
    @OriginalMember(owner = "client!jc", name = "e", descriptor = "(B)Llp;", line = 8)
    ...
    @OriginalMember(owner = "client!jc", name = "d", descriptor = "(B)I", line = 25)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Lk;ILjava/awt/Frame;)V", line = 36)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Z)I", line = 64)
    ...
    @OriginalMember(owner = "client!jc", name = "c", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(I)J", line = 91)
    ...
    @OriginalMember(owner = "client!jc", name = "b", descriptor = "(Z)I", line = 105)
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(I)I", line = 116)
