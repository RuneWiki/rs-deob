...
public class class405 extends class384 {
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(IIZ)V", line = 34)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!qba", name = "d", descriptor = "(B)V", line = 96)
    ...
    @OriginalMember(owner = "client!qba", name = "e", descriptor = "(B)V", line = 114)
    ...
    @OriginalMember(owner = "client!qba", name = "f", descriptor = "(B)V", line = 132)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lhl;Loh;)V", line = 284)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ZB)V", line = 183)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Lke;BI)V", line = 192)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(B)V", line = 229)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(ZI)V", line = 267)
    ...
    @OriginalMember(owner = "client!qba", name = "c", descriptor = "(I)Z", line = 315)
