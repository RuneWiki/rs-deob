...
public class class793 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(III[I)Lks;")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(BZI)V")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([IIB)Lks;")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IBI[I)Lks;")
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B[II)Lks;")
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Laj;Laj;)V")
