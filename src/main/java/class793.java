...
public abstract class class793 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "([BII)V", line = 4)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lr;III[Z)Z", line = 30)
    ...
    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(I)V", line = 67)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(B)I", line = 555)
    ...
    @OriginalMember(owner = "client!mp", name = "finalize", descriptor = "()V", line = 574)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(ILjava/lang/String;)V", line = 586)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lpc;I[BIZ)V", line = 646)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lpc;ILjaclib/memory/Buffer;IZ)V", line = 665)
