...
public class class793 extends class741 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IZ)V", line = 19)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(Llba;)V", line = 30)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IILml;)V", line = 143)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)Z", line = 172)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(III)Z", line = 184)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BZ)V", line = 199)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(I)V", line = 251)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 292)
