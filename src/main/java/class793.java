...
public class class793 extends class363 implements class94 {
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(B)Ljagdx/IDirect3DBaseTexture;", line = 6)
    public final IDirect3DBaseTexture method2032(byte arg0) {
        return arg0 > -65 ? (IDirect3DBaseTexture) null : this.field10859;
    }

    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(Lws;B)V", line = 27)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Laia;Lul;III[B)V", line = 39)
