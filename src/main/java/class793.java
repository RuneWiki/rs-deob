...
public class class793 extends class260 {
    ...
    @OriginalMember(owner = "client!mp", name = "a", descriptor = "(IB)V", line = 18)
    ...
    @OriginalMember(owner = "client!mp", name = "d", descriptor = "(I)I", line = 64)
    public final int method4366(int arg0) {
        ++field10897;
        return arg0 >= -14 ? 34 : super.field3828;
    }

    @OriginalMember(owner = "client!mp", name = "c", descriptor = "(II)I", line = 75)
    ...
    @OriginalMember(owner = "client!mp", name = "b", descriptor = "(I)I", line = 86)
    ...
    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(ILgn;)V", line = 101)
    public class793(int arg0, class729 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mp", name = "<init>", descriptor = "(Lgn;)V", line = 106)
