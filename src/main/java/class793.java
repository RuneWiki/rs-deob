...
public abstract class class793 extends class337 {
    ...
    @OriginalMember(owner = "client!vt", name = "f", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!vt", name = "a", descriptor = "([IB[Ljava/lang/String;II)V", line = 31)
    ...
    @OriginalMember(owner = "client!vt", name = "b", descriptor = "(B)V", line = 86)
