...
public class class152 extends class687 {
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(IDLd;ILlga;IZZ)[I")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(DIZLd;ZLlga;I)[I")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(ZILd;IILlga;)[F")
    ...
    @OriginalMember(owner = "client!oq", name = "a", descriptor = "(Llga;ILd;)Z")
    ...
    @OriginalMember(owner = "client!oq", name = "<init>", descriptor = "(Ljc;)V")
