...
public abstract class class152 extends class274 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(JI)V", line = 61)
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 127)
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(IIIIZZ)V", line = 218)
    ...
    @OriginalMember(owner = "client!pga", name = "e", descriptor = "(B)V", line = 203)
