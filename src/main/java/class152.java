...
public class class152 {
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(Lkk;)V", line = 7)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(III)I", line = 85)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "(II)[I", line = 117)
    ...
    @OriginalMember(owner = "client!tf", name = "a", descriptor = "()V", line = 400)
