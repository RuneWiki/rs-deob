...
public class class152 extends class601 {
    ...
    @OriginalMember(owner = "client!iq", name = "a", descriptor = "(Lhj;II[B)Ljfa;")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(ILqea;)V")
    ...
    @OriginalMember(owner = "client!iq", name = "<init>", descriptor = "(Lqea;)V")
