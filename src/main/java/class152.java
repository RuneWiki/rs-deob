...
public class class152 extends class106 implements KeyListener, FocusListener {
    ...
    @OriginalMember(owner = "client!eh", name = "keyPressed", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 5)
    public final synchronized void keyPressed(KeyEvent arg0) {
        this.method994(arg0, 0, -42);
        field2199++;
    }

    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!eh", name = "d", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!eh", name = "keyTyped", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 65)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BI)Z", line = 81)
    ...
    @OriginalMember(owner = "client!eh", name = "keyReleased", descriptor = "(Ljava/awt/event/KeyEvent;)V", line = 95)
    public final synchronized void keyReleased(KeyEvent arg0) {
        this.method994(arg0, 1, -48);
        field2193++;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(II)I", line = 107)
    ...
    @OriginalMember(owner = "client!eh", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 118)
    public final synchronized void focusLost(FocusEvent arg0) {
        this.method997(-1, 65, 0, '\u0000');
        field2201++;
    }

    @OriginalMember(owner = "client!eh", name = "<init>", descriptor = "(Ljava/awt/Component;)V", line = 333)
    public class152(Component arg0) {
        class35.method261(-114);
        this.method996((byte) -117, arg0);
    }

    @OriginalMember(owner = "client!eh", name = "e", descriptor = "(I)V", line = 130)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(Ljava/awt/event/KeyEvent;II)V", line = 142)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(ZB)V", line = 178)
    ...
    @OriginalMember(owner = "client!eh", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 251)
    public final void focusGained(FocusEvent arg0) {
        field2184++;
    }

    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(I)Lsk;", line = 259)
    ...
    @OriginalMember(owner = "client!eh", name = "b", descriptor = "(B)V", line = 279)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(BLjava/awt/Component;)V", line = 344)
    ...
    @OriginalMember(owner = "client!eh", name = "a", descriptor = "(IIIC)V", line = 372)
