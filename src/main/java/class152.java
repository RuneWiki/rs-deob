...
public class class152 implements class467 {
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(Ljaclib/memory/Source;III)Z")
    ...
    @OriginalMember(owner = "client!mj", name = "a", descriptor = "(ZB)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!mj", name = "<init>", descriptor = "(Lui;Z)V")
