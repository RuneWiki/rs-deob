...
public class class152 {
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(B)V", line = 8)
    public static void method941(byte arg0) {
        field1827 = null;
        int var1 = 124 % ((arg0 - 55) / 43);
    }

    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Lqj;IIIII)Ljava/awt/Frame;", line = 19)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(I)Luj;", line = 87)
    ...
    @OriginalMember(owner = "client!tba", name = "a", descriptor = "(Z)V", line = 101)
