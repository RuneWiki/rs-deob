...
public class class152 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IBI)I", line = 11)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(IZIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(I)V", line = 63)
    ...
    @OriginalMember(owner = "client!ci", name = "<init>", descriptor = "(IIIIIIIIIIIIII)V", line = 79)
