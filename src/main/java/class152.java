...
public class class152 {
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II)Lwd;")
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lfg;IJ[I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "(ILuu;Luu;Lan;)V")
