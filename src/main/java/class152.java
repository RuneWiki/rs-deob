...
public class class152 extends class384 implements class436 {
    ...
    @OriginalMember(owner = "client!nea", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Ljf;Z)V", line = 30)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(B)Z", line = 80)
    ...
    @OriginalMember(owner = "client!nea", name = "<init>", descriptor = "(Lmba;Z)V", line = 91)
    public class152(class643 arg0, boolean arg1) {
        super(arg0, 34962, arg1);
    }

    @OriginalMember(owner = "client!nea", name = "f", descriptor = "(I)I", line = 95)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(III)Z", line = 108)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(ILjaclib/memory/Source;II)Z", line = 123)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(BZ)Ljaclib/memory/Buffer;", line = 139)
    ...
    @OriginalMember(owner = "client!nea", name = "c", descriptor = "(B)V", line = 153)
    ...
    @OriginalMember(owner = "client!nea", name = "a", descriptor = "(Z)I", line = 164)
