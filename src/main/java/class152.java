...
public class class152 extends class303 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Ljk;IIIII)V", line = 7)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(BI)V", line = 72)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IZI)V", line = 91)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(B)V", line = 166)
