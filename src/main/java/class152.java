...
public class class152 implements class127 {
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(II)Z", line = 16)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IZFIIZ)[I", line = 33)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZI)Lmj;", line = 44)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(ZIZIIF)[F", line = 56)
    ...
    @OriginalMember(owner = "client!fm", name = "<init>", descriptor = "(Ldk;Ldk;Ldk;)V", line = 72)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(IIFBZI)[I", line = 278)
    ...
    @OriginalMember(owner = "client!fm", name = "a", descriptor = "(BI)Lpr;", line = 289)
