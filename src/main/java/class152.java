...
public class class152 extends class67 {
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(IIIIIILbm;IIII)Z")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(ZLjq;)V")
    ...
    @OriginalMember(owner = "client!pk", name = "a", descriptor = "(Lea;IILts;IIIIIII)Lts;")
