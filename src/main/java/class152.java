...
public class class152 extends class19 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(II[[[Lsk;ZIB)Z", line = 6)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZI)[[I", line = 331)
    ...
    @OriginalMember(owner = "client!vf", name = "k", descriptor = "(I)V", line = 381)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(IBIIZ[Lmb;)V", line = 400)
