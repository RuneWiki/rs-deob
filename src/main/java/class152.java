...
public class class152 {
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(ILha;II)V")
    ...
    @OriginalMember(owner = "client!pga", name = "b", descriptor = "(ILha;II)Z")
    ...
    @OriginalMember(owner = "client!pga", name = "<init>", descriptor = "(Luca;Lvfa;)V")
    ...
    @OriginalMember(owner = "client!pga", name = "a", descriptor = "(IILha;B)V")
