...
public class class152 {
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(Ld;Lla;I)V")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(ZLib;)Llr;")
    ...
    @OriginalMember(owner = "client!fea", name = "a", descriptor = "(II)Lcea;")
    ...
    @OriginalMember(owner = "client!fea", name = "<init>", descriptor = "(Lto;ILla;)V")
