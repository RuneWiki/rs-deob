...
public class class152 extends class217 {
    ...
    @OriginalMember(owner = "client!kl", name = "a", descriptor = "(IF)V")
    ...
    @OriginalMember(owner = "client!kl", name = "f", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!kl", name = "<init>", descriptor = "(IIIIIF)V")
