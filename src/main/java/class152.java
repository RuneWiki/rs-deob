...
public class class152 extends class379 {
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(BZ)I", line = 5)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(Ljava/lang/String;II)I", line = 48)
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)V", line = 64)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(B)V", line = 84)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(III[Ljava/lang/String;)Ljava/lang/String;", line = 99)
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(II)Z", line = 157)
    ...
    @OriginalMember(owner = "client!hc", name = "c", descriptor = "(I)Z", line = 176)
