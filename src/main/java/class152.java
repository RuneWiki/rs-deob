...
public class class152 extends class157 {
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "(I)I", line = 7)
    ...
    @OriginalMember(owner = "client!jd", name = "c", descriptor = "(Z)V", line = 17)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(II)V", line = 30)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IIZ)I", line = 41)
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(B)J", line = 57)
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Z)I", line = 70)
    public final int method1102(boolean arg0) {
        field2330++;
        return arg0 ? this.field2327 : 43;
    }

    @OriginalMember(owner = "client!jd", name = "d", descriptor = "(I)I", line = 83)
