...
public class class152 extends class224 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IILjava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!mm", name = "<init>", descriptor = "(IIIIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(III)V", line = 39)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(ILe;)V", line = 58)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(III)V", line = 136)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIZ)V", line = 157)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIII)V", line = 176)
