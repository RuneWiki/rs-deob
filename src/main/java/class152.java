...
public class class152 extends class189 {
    ...
    @OriginalMember(owner = "client!qb", name = "a", descriptor = "(Lsv;IB)V")
    ...
    @OriginalMember(owner = "client!qb", name = "b", descriptor = "(ZI)V")
    ...
    @OriginalMember(owner = "client!qb", name = "<init>", descriptor = "(Lih;)V")
