...
public class class152 extends class396 {
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(BI)Lc;", line = 4)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IIIZIBZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IB)Z", line = 90)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IZII)I", line = 101)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(Lam;I)V", line = 131)
    ...
    @OriginalMember(owner = "client!ja", name = "<init>", descriptor = "(I)V", line = 219)
    public class152(int arg0) {
        this.field2140 = arg0;
    }

    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!ja", name = "e", descriptor = "(I)Z", line = 250)
    ...
    @OriginalMember(owner = "client!ja", name = "d", descriptor = "(B)V", line = 345)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(II)Z", line = 398)
    ...
    @OriginalMember(owner = "client!ja", name = "a", descriptor = "(IILdl;IIIIIIII)Z", line = 409)
    ...
    @OriginalMember(owner = "client!ja", name = "b", descriptor = "(Z)V", line = 760)
