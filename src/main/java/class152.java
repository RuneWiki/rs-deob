...
public class class152 extends class492 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BIIIIILbr;IIIII)Z")
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lvj;IIII[BI)V")
    ...
    @OriginalMember(owner = "client!jd", name = "<init>", descriptor = "(Lvj;IIII)V")
    ...
    @OriginalMember(owner = "client!jd", name = "e", descriptor = "(I)[Liv;")
