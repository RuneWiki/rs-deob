...
public class class152 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(ZLsi;I)V")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)Lft;")
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(BLsi;)V")
