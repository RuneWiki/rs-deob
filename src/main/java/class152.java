...
public class class152 extends class263 {
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(Lce;IZ)V", line = 45)
    ...
    @OriginalMember(owner = "client!dt", name = "<init>", descriptor = "(Lbl;)V", line = 60)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(III)V", line = 176)
    ...
    @OriginalMember(owner = "client!dt", name = "b", descriptor = "(I)V", line = 194)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(ZB)V", line = 206)
    ...
    @OriginalMember(owner = "client!dt", name = "a", descriptor = "(IZ)V", line = 233)
    ...
    @OriginalMember(owner = "client!dt", name = "c", descriptor = "(I)V", line = 247)
