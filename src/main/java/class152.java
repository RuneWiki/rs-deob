...
public abstract class class152 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(BIIII)V", line = 23)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)I", line = 45)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I)V", line = 52)
    ...
    @OriginalMember(owner = "client!q", name = "b", descriptor = "(I)I", line = 76)
