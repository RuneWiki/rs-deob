...
public class class152 {
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Lgs;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIB)Z", line = 57)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(IIII)V", line = 70)
    ...
    @OriginalMember(owner = "client!ib", name = "a", descriptor = "(Z)V", line = 163)
    ...
    @OriginalMember(owner = "client!ib", name = "finalize", descriptor = "()V", line = 185)
    ...
    @OriginalMember(owner = "client!ib", name = "<init>", descriptor = "(Leea;JI)V", line = 200)
