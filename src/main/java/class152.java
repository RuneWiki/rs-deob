...
public class class152 {
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(IB)Liq;")
    ...
    @OriginalMember(owner = "client!wk", name = "<init>", descriptor = "(Liq;)V")
    ...
    @OriginalMember(owner = "client!wk", name = "a", descriptor = "(ILiq;)V")
