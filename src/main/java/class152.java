...
public class class152 extends Callback {
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!nr", name = "callback", descriptor = "(IIII)I", line = 17)
    ...
    @OriginalMember(owner = "client!nr", name = "a", descriptor = "(ZLjava/awt/Component;I)V", line = 56)
