...
public class class152 extends class179 {
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lbg;II)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Luo;B)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(Lwo;B)V")
    ...
    @OriginalMember(owner = "client!wn", name = "a", descriptor = "(ILbg;)V")
