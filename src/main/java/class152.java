...
public class class152 extends class361 {
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lmk;I)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lht;I)V")
    ...
    @OriginalMember(owner = "client!jd", name = "b", descriptor = "(ILht;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(BLsq;Z)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(ILht;)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(IFZLna;I)V")
    ...
    @OriginalMember(owner = "client!jd", name = "a", descriptor = "(Lue;I)V")
