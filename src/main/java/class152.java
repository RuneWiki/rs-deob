...
public class class152 extends class49 {
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!cf", name = "<init>", descriptor = "(Lmb;Lju;)V", line = 39)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(BLjava/lang/String;)V", line = 67)
