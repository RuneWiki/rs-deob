...
public class class152 extends class227 {
    ...
    @OriginalMember(owner = "client!em", name = "b", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!em", name = "a", descriptor = "(II)[I", line = 19)
    ...
    @OriginalMember(owner = "client!em", name = "<init>", descriptor = "()V", line = 142)
    public class152() {
        super(0, true);
    }

    @OriginalMember(owner = "client!em", name = "a", descriptor = "(Lug;II)V", line = 88)
    ...
    @OriginalMember(owner = "client!em", name = "c", descriptor = "(II)I", line = 145)
