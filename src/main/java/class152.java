...
public class class152 {
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(ILjr;)V", line = 3)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!wq", name = "a", descriptor = "(Lhs;Ljr;I)Lms;", line = 60)
