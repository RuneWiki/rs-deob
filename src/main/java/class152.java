...
public abstract class class152 extends class331 {
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(IIIIII)Z", line = 8)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(IIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(III)V", line = 66)
    ...
    @OriginalMember(owner = "client!mm", name = "b", descriptor = "(Z)V", line = 83)
    ...
    @OriginalMember(owner = "client!mm", name = "a", descriptor = "(BI)Ljj;", line = 98)
