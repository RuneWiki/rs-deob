...
public class class152 implements MouseListener, MouseMotionListener, FocusListener {
    ...
    @OriginalMember(owner = "client!uh", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 3)
    ...
    @OriginalMember(owner = "client!uh", name = "focusLost", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 23)
    ...
    @OriginalMember(owner = "client!uh", name = "focusGained", descriptor = "(Ljava/awt/event/FocusEvent;)V", line = 35)
    public final void focusGained(FocusEvent arg0) {
        field1992++;
    }

    @OriginalMember(owner = "client!uh", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 44)
    ...
    @OriginalMember(owner = "client!uh", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 81)
    ...
    @OriginalMember(owner = "client!uh", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 99)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(B)V", line = 157)
    ...
    @OriginalMember(owner = "client!uh", name = "a", descriptor = "(Ljava/lang/String;IZI)I", line = 195)
    ...
    @OriginalMember(owner = "client!uh", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 276)
    ...
    @OriginalMember(owner = "client!uh", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 286)
    ...
    @OriginalMember(owner = "client!uh", name = "b", descriptor = "(B)V", line = 303)
    ...
    @OriginalMember(owner = "client!uh", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 315)
