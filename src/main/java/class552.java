...
public class class552 extends class39 {
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ZLoa;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Loa;B)Lac;")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILoa;)Lwc;")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILoa;I)Z")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(ILoa;II)Lba;")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(IILgfa;IIZLoa;)V")
    ...
    @OriginalMember(owner = "client!qs", name = "a", descriptor = "(Lq;Loa;Lba;I)V")
