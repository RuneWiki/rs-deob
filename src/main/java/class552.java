...
public class class552 extends class179 {
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(BLjava/lang/String;)I", line = 5)
    public static final int method3141(byte arg0, String arg1) {
        ++field7757;
        return arg0 < 117 ? 43 : 2 + arg1.length();
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(III)Z", line = 17)
    ...
    @OriginalMember(owner = "client!wb", name = "w", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(FZ)V", line = 47)
    ...
    @OriginalMember(owner = "client!wb", name = "<init>", descriptor = "(I)V", line = 63)
    public class552(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!wb", name = "a", descriptor = "(FI)V", line = 66)
