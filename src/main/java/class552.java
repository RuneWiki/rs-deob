...
public class class552 {
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(Lig;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(BLig;I)V", line = 26)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(B)Lg;", line = 49)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(ILjt;IZ)Lvga;", line = 69)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(III)I", line = 152)
    ...
    @OriginalMember(owner = "client!jw", name = "a", descriptor = "(I)V", line = 171)
