...
public class class552 extends class184 {
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(I)[F")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lvd;II)Lcba;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "([I)Lut;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lvd;I)Lcba;")
    ...
    @OriginalMember(owner = "client!cba", name = "a", descriptor = "(Lvd;)Z")
