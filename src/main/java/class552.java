...
public class class552 extends class95 {
    ...
    @OriginalMember(owner = "client!rj", name = "g", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(ILac;)Lcca;", line = 17)
    ...
    @OriginalMember(owner = "client!rj", name = "d", descriptor = "(I)Ljava/lang/Object;", line = 54)
    ...
    @OriginalMember(owner = "client!rj", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 64)
    public class552(Object arg0, int arg1) {
        super(arg1);
        this.field7449 = arg0;
    }

    @OriginalMember(owner = "client!rj", name = "a", descriptor = "(II)V", line = 74)
    ...
    @OriginalMember(owner = "client!rj", name = "c", descriptor = "(B)Z", line = 132)
