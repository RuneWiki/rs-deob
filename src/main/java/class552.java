...
public class class552 {
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(Lr;I)V", line = 3)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(B)V", line = 22)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(II)V", line = 47)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ILqv;IIII)Lkt;", line = 67)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IZIII[[[Lbt;)Z", line = 102)
    ...
    @OriginalMember(owner = "client!th", name = "<init>", descriptor = "(Lkr;ILpu;)V", line = 551)
    public class552(class693 arg0, int arg1, class522 arg2) {
        this.field7826 = arg2;
        this.field7826.method2988(94, 29);
    }

    @OriginalMember(owner = "client!th", name = "b", descriptor = "(I)V", line = 439)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(IIIIII)V", line = 450)
    ...
    @OriginalMember(owner = "client!th", name = "a", descriptor = "(ZI)Ltp;", line = 566)
