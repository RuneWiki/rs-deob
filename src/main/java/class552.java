...
public class class552 {
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BI)V", line = 13)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLud;)Lcn;", line = 36)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(BLjava/lang/String;)I", line = 80)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(ZJ)V", line = 104)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(JB)Ljda;", line = 124)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(JLjda;I)V", line = 149)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(III)Z", line = 185)
    ...
    @OriginalMember(owner = "client!fs", name = "a", descriptor = "(IIB[BLjava/lang/String;I)I", line = 196)
    ...
    @OriginalMember(owner = "client!fs", name = "<init>", descriptor = "(I)V", line = 343)
