...
public class class552 {
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(Lsf;B)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILsf;ILmf;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(BILsf;)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILsf;I)V")
    ...
    @OriginalMember(owner = "client!um", name = "a", descriptor = "(ILsf;)V")
    ...
    @OriginalMember(owner = "client!um", name = "<init>", descriptor = "(Lsf;)V")
    ...
    @OriginalMember(owner = "client!um", name = "b", descriptor = "(ILsf;)V")
