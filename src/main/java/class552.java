...
public class class552 extends class264 {
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(Lmfa;)V", line = 5)
    public class552(class640 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(B)I", line = 9)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(I)V", line = 22)
    public static void method3210(int arg0) {
        field7866 = null;
        int var1 = -57 / ((71 - arg0) / 42);
    }

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(B)V", line = 31)
    ...
    @OriginalMember(owner = "client!hl", name = "<init>", descriptor = "(ILmfa;)V", line = 43)
    public class552(int arg0, class640 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(BI)V", line = 47)
    ...
    @OriginalMember(owner = "client!hl", name = "c", descriptor = "(B)I", line = 58)
    ...
    @OriginalMember(owner = "client!hl", name = "d", descriptor = "(I)Z", line = 69)
    ...
    @OriginalMember(owner = "client!hl", name = "a", descriptor = "(BI)I", line = 88)
    ...
    @OriginalMember(owner = "client!hl", name = "b", descriptor = "(I)V", line = 112)
