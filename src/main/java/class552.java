...
public abstract class class552 extends class256 {
    ...
    @OriginalMember(owner = "client!nl", name = "b", descriptor = "(Lha;B)Z", line = 3)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(ZI)Lfk;", line = 15)
    ...
    @OriginalMember(owner = "client!nl", name = "i", descriptor = "(I)V", line = 31)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(III)Z", line = 41)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "(II)V", line = 110)
    ...
    @OriginalMember(owner = "client!nl", name = "a", descriptor = "([Ltn;B)I", line = 129)
    ...
    @OriginalMember(owner = "client!nl", name = "e", descriptor = "(I)Z", line = 141)
    ...
    @OriginalMember(owner = "client!nl", name = "<init>", descriptor = "(IIIIII)V", line = 151)
