...
public class class552 {
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(I)I", line = 19)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Leg;II)V", line = 40)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Leg;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "()V", line = 72)
    public void method2921() throws Exception {
        field7531++;
    }

    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "(B)V", line = 130)
    ...
    @OriginalMember(owner = "client!hq", name = "a", descriptor = "([II)V", line = 246)
    ...
    @OriginalMember(owner = "client!hq", name = "b", descriptor = "()I", line = 404)
    public int method2922() throws Exception {
        field7532++;
        return this.field7554;
    }

    @OriginalMember(owner = "client!hq", name = "c", descriptor = "(I)V", line = 413)
    public void method2923(int arg0) throws Exception {
        field7534++;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Ljava/awt/Component;)V", line = 420)
    public void method2926(Component arg0) throws Exception {
        field7544++;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(II)V", line = 427)
    ...
    @OriginalMember(owner = "client!hq", name = "c", descriptor = "()V", line = 446)
    public void method2925() throws Exception {
        field7524++;
    }

    @OriginalMember(owner = "client!hq", name = "a", descriptor = "(Lwv;I)V", line = 457)
    ...
    @OriginalMember(owner = "client!hq", name = "d", descriptor = "()V", line = 473)
    public void method2924() {
        field7529++;
    }

    @OriginalMember(owner = "client!hq", name = "d", descriptor = "(I)V", line = 485)
