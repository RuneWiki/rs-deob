...
public class class552 {
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Loa;)V", line = 11)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(Z)V", line = 87)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!ou", name = "a", descriptor = "(IIIIIIIIIIIIII)V", line = 116)
