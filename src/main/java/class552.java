...
public class class552 extends class334 {
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!rfa", name = "c", descriptor = "(B)Lvi;", line = 16)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(II)[I", line = 32)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(Lnfa;)V", line = 71)
    ...
    @OriginalMember(owner = "client!rfa", name = "a", descriptor = "(I[Lmq;)V", line = 80)
    ...
    @OriginalMember(owner = "client!rfa", name = "<init>", descriptor = "()V", line = 112)
    public class552() {
        super(1, true);
    }
}
