...
public class class552 implements class703 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(II)I", line = 22)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "()V", line = 196)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(IIZLjava/awt/Component;)V", line = 64)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)V", line = 99)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(I[I)V", line = 152)
