...
public class class552 implements class318 {
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I[BIIII)V", line = 3)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(B)Lib;", line = 32)
    public final class14 method203(byte arg0) {
        field7886++;
        return arg0 == -92 ? class652.field9152 : null;
    }

    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(I)V", line = 47)
    ...
    @OriginalMember(owner = "client!eba", name = "a", descriptor = "(IIIIII)V", line = 58)
    ...
    @OriginalMember(owner = "client!eba", name = "<init>", descriptor = "(I)V", line = 105)
