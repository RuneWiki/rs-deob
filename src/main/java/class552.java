...
public class class552 {
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Les;Z)V", line = 12)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILes;B)V", line = 35)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IBLha;Z)Llt;", line = 106)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(B)V", line = 170)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(II)V", line = 212)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(I)[Lpn;", line = 227)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lha;B)V", line = 242)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lbt;B)V", line = 313)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(Lha;I)Ltf;", line = 325)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(I)V", line = 348)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(IZ)Ljava/lang/String;", line = 359)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(ILha;)Ltf;", line = 390)
    ...
    @OriginalMember(owner = "client!hr", name = "a", descriptor = "(BLha;)Ltf;", line = 430)
    ...
    @OriginalMember(owner = "client!hr", name = "b", descriptor = "(Lha;I)Ltf;", line = 461)
