...
public class class552 extends class649 {
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(II)I", line = 3)
    public final int method133(int arg0, int arg1) {
        ++field7861;
        return arg0 != 18648 ? 61 : 1;
    }

    @OriginalMember(owner = "client!kga", name = "c", descriptor = "(I)[Lbu;", line = 14)
    ...
    @OriginalMember(owner = "client!kga", name = "d", descriptor = "(I)I", line = 25)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(B)V", line = 37)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IBILla;)Lpia;", line = 65)
    ...
    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(IB)V", line = 81)
    ...
    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(Lhs;)V", line = 93)
    public class552(class358 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!kga", name = "<init>", descriptor = "(ILhs;)V", line = 96)
    public class552(int arg0, class358 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!kga", name = "a", descriptor = "(I)I", line = 110)
    ...
    @OriginalMember(owner = "client!kga", name = "b", descriptor = "(II)V", line = 123)
