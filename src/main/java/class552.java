...
public class class552 {
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IBII)I", line = 8)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)V", line = 61)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(II)V", line = 86)
