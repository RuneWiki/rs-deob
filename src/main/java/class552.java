...
public class class552 {
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Ljava/lang/String;Z)J", line = 25)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(ILvj;I)V", line = 61)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(I)V", line = 131)
    ...
    @OriginalMember(owner = "client!bd", name = "a", descriptor = "(Lvj;I)V", line = 164)
