...
public class class552 extends class620 implements class274 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ZIBLlq;Lha;II)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILha;)V")
    ...
    @OriginalMember(owner = "client!wp", name = "c", descriptor = "(ILha;)Lid;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILha;I)Z")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lha;BI)Lka;")
    ...
    @OriginalMember(owner = "client!wp", name = "<init>", descriptor = "(Lha;Lih;IIIIIZIIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lha;IZB)Lsa;")
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Lha;I)V")
