...
public class class552 {
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(II)V", line = 21)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(BI)Lnea;", line = 52)
    ...
    @OriginalMember(owner = "client!lh", name = "b", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!lh", name = "c", descriptor = "(I)V", line = 103)
    ...
    @OriginalMember(owner = "client!lh", name = "a", descriptor = "(III)V", line = 118)
    ...
    @OriginalMember(owner = "client!lh", name = "<init>", descriptor = "(Lkw;ILuq;Luq;)V", line = 152)
