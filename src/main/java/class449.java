...
public class class449 {
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IILlh;)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Llh;I)V")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(IZII[[[Lsd;I)Z")
    ...
    @OriginalMember(owner = "client!sp", name = "a", descriptor = "(Ltf;B)V")
