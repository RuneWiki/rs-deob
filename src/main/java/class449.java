...
public class class449 extends class163 implements class233 {
    ...
    @OriginalMember(owner = "client!sn", name = "b", descriptor = "(Ljm;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lge;I[BIZ)V")
    public class449(class104 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34962, arg2, arg3, arg4);
        this.field6530 = arg1;
    }

    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(ILjm;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "c", descriptor = "(Ljm;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(Ljm;)V")
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(Lge;ILjava/nio/ByteBuffer;Z)V")
