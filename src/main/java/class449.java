...
public class class449 extends class143 {
    ...
    @OriginalMember(owner = "client!ep", name = "e", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!ep", name = "a", descriptor = "(I)V", line = 13)
    ...
    @OriginalMember(owner = "client!ep", name = "f", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!ep", name = "c", descriptor = "(I)I", line = 47)
    ...
    @OriginalMember(owner = "client!ep", name = "d", descriptor = "(I)J", line = 58)
    ...
    @OriginalMember(owner = "client!ep", name = "f", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!ep", name = "<init>", descriptor = "(II)V", line = 85)
