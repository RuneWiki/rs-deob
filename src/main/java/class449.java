...
public class class449 extends class173 {
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "([Lba;Lq;[Lht;I)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lxa;Z)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lfu;IIII)V")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Ljava/lang/Runnable;)Ltv;")
    ...
    @OriginalMember(owner = "client!ap", name = "a", descriptor = "(Lfca;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!ap", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    public class449(Canvas arg0, class702 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!ap", name = "a", descriptor = "([Lba;Lqu;Lq;[Lht;I)V")
