...
public class class449 extends class194 {
    ...
    @OriginalMember(owner = "client!mg", name = "<init>", descriptor = "()V", line = 161)
    public class449() {
        super(3, false);
    }

    @OriginalMember(owner = "client!mg", name = "c", descriptor = "(II)Ljava/lang/String;", line = 14)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IIII)Z", line = 42)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(II)[[I", line = 55)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IILbg;)V", line = 111)
    ...
    @OriginalMember(owner = "client!mg", name = "b", descriptor = "(Z)V", line = 147)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(II)[I", line = 168)
    ...
    @OriginalMember(owner = "client!mg", name = "a", descriptor = "(IBI)Z", line = 216)
    ...
    @OriginalMember(owner = "client!mg", name = "f", descriptor = "(I)V", line = 231)
