...
public class class449 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lnp;)V", line = 3)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "(Lnp;)V", line = 21)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(I)I", line = 36)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "()V", line = 56)
    public class449() {
        this.field6300[0] = 0;
