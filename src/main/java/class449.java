...
public class class449 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([BIBII[B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "([BI[BIIB)I", line = 159)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(Lbc;Lfc;I)V", line = 228)
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(I)V", line = 241)
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "([B)V", line = 251)
