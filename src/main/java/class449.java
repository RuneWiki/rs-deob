...
public class class449 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IILlg;I)V")
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Llg;III)V")
    ...
    @OriginalMember(owner = "client!lo", name = "b", descriptor = "(Llg;III)Z")
    ...
    @OriginalMember(owner = "client!lo", name = "<init>", descriptor = "(Lpo;Lwa;)V")
