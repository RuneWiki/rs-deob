...
public class class449 {
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(IB)V", line = 4)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(I)I", line = 37)
    ...
    @OriginalMember(owner = "client!ge", name = "b", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/lang/String;IIII)V", line = 174)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(III)Z", line = 291)
    ...
    @OriginalMember(owner = "client!ge", name = "a", descriptor = "(Ljava/awt/Component;I)Les;", line = 304)
    public static final class472 method2665(Component arg0, int arg1) {
        field6256++;
        return arg1 == -5 ? new class234(arg0) : null;
    }

    @OriginalMember(owner = "client!ge", name = "<init>", descriptor = "(BIIIII)V", line = 316)
