...
public class class449 {
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILsea;)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(Llda;I)V")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(ILr;B)Z")
    ...
    @OriginalMember(owner = "client!lda", name = "a", descriptor = "(B)Llda;")
