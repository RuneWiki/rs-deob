...
public class class449 extends class569 {
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(II[[I[[IIII)Ld;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "([Lba;Lq;[Lsda;I)V")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(ILoa;IIILqf;ILfa;I)V")
    ...
    @OriginalMember(owner = "client!hv", name = "<init>", descriptor = "(Ljava/awt/Canvas;Le;)V")
    public class449(Canvas arg0, class462 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Ljava/lang/Runnable;)Lnw;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "(Lor;IIII)Lba;")
    ...
    @OriginalMember(owner = "client!hv", name = "a", descriptor = "([Lba;Lbe;Lq;[Lsda;I)V")
