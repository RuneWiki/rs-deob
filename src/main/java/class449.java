...
public class class449 extends class348 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(BLjava/awt/Canvas;)V", line = 10)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILjava/awt/Graphics;IIII)V", line = 33)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IILjava/awt/Graphics;I)V", line = 50)
