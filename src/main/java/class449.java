...
public abstract class class449 {
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(IZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(ILlt;Ljava/lang/String;B)Lwp;", line = 15)
    ...
    @OriginalMember(owner = "client!mh", name = "a", descriptor = "(I)V", line = 91)
