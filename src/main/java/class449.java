...
public class class449 {
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Lmh;IIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ZLkw;)I", line = 63)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(Z)V", line = 108)
    ...
    @OriginalMember(owner = "client!kp", name = "a", descriptor = "(ILfaa;)V", line = 119)
