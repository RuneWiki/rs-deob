...
public class class449 extends class747 {
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(ILjm;)V", line = 3)
    ...
    @OriginalMember(owner = "client!rda", name = "<init>", descriptor = "()V", line = 68)
    public class449() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rda", name = "c", descriptor = "(I)V", line = 55)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(BI)I", line = 71)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(IB)Z", line = 135)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(II)[I", line = 149)
    ...
    @OriginalMember(owner = "client!rda", name = "a", descriptor = "(Ldc;II)V", line = 230)
