...
public class class449 extends class438 {
    ...
    @OriginalMember(owner = "client!mo", name = "c", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lao;I)V", line = 15)
    public class449(class157 arg0, int arg1) {
        this.field6443 = arg0;
        this.field6441 = new class206(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(Lvk;Lvk;FB)V", line = 26)
    ...
    @OriginalMember(owner = "client!mo", name = "b", descriptor = "(B)Lvk;", line = 111)
