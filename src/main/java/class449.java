...
public class class449 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Leb;II)V", line = 40)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BLeb;)V", line = 198)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BIIIILhc;II)Lhc;", line = 229)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(IBZI)I", line = 296)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(Lhc;IIIBI)Lhc;", line = 425)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)Lwd;", line = 555)
