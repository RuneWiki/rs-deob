...
public class class449 extends class264 {
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(SI)V", line = 4)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(I[[ZIII)V", line = 29)
    ...
    @OriginalMember(owner = "client!km", name = "a", descriptor = "(IIIBIII)V", line = 85)
    ...
    @OriginalMember(owner = "client!km", name = "<init>", descriptor = "(Lks;Ldl;Lap;[I)V", line = 259)
