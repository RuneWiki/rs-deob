...
public class class449 extends class634 {
    ...
    @OriginalMember(owner = "client!jea", name = "f", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(BI)[I", line = 20)
    ...
    @OriginalMember(owner = "client!jea", name = "b", descriptor = "(III)Z", line = 71)
    ...
    @OriginalMember(owner = "client!jea", name = "<init>", descriptor = "()V", line = 89)
    public class449() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(ILig;Z)V", line = 93)
    ...
    @OriginalMember(owner = "client!jea", name = "a", descriptor = "(IBI)Z", line = 174)
    ...
    @OriginalMember(owner = "client!jea", name = "c", descriptor = "(B)V", line = 207)
