...
public abstract class class449 extends class128 {
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IIIBII)V", line = 4)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "(IB)I", line = 39)
    ...
    @OriginalMember(owner = "client!sn", name = "a", descriptor = "([[II)V", line = 63)
    ...
    @OriginalMember(owner = "client!sn", name = "d", descriptor = "(I)V", line = 74)
    ...
    @OriginalMember(owner = "client!sn", name = "<init>", descriptor = "(IIII)V", line = 94)
