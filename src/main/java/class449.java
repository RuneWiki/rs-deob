...
public abstract class class449 {
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(B)V", line = 5)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Ljava/lang/String;B)I", line = 21)
    ...
    @OriginalMember(owner = "client!hs", name = "a", descriptor = "(Z)V", line = 52)
