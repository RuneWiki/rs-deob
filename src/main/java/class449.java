...
public class class449 extends class583 {
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "([Ljb;BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILee;)V", line = 98)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(BILee;)V", line = 119)
    ...
    @OriginalMember(owner = "client!ci", name = "c", descriptor = "(B)V", line = 136)
    ...
    @OriginalMember(owner = "client!ci", name = "a", descriptor = "(ILha;)V", line = 149)
