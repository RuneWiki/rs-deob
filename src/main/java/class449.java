...
public class class449 extends class357 {
    ...
    @OriginalMember(owner = "client!mo", name = "<init>", descriptor = "(Lma;Lk;[Llg;[I[I)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([B[IIIIIIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([B[IIIIIIIIIIILep;II)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(CIIIZLep;II)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([B[I[IIIIIII)V")
    ...
    @OriginalMember(owner = "client!mo", name = "a", descriptor = "([B[I[IIIIIIIIIIILep;II)V")
