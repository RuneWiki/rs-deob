...
public class class449 {
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(Lpaa;B)V", line = 5)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!wt", name = "b", descriptor = "(B)V", line = 49)
    ...
    @OriginalMember(owner = "client!wt", name = "a", descriptor = "(IILwu;IZIIJ)V", line = 135)
