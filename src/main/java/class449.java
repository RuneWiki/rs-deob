...
public class class449 extends class406 {
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(Lfca;Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(ZLgca;)V", line = 23)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!ika", name = "c", descriptor = "(B)V", line = 58)
    ...
    @OriginalMember(owner = "client!ika", name = "a", descriptor = "(ZIIZIBI)V", line = 71)
