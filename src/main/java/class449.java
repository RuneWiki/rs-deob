...
public class class449 extends class590 {
    ...
    @OriginalMember(owner = "client!aw", name = "b", descriptor = "(ILha;)Lpi;")
    ...
    @OriginalMember(owner = "client!aw", name = "c", descriptor = "(ILha;)Lid;")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(Lha;I)V")
    ...
    @OriginalMember(owner = "client!aw", name = "a", descriptor = "(IILha;I)Z")
