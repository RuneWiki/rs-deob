...
public class class449 {
    ...
    @OriginalMember(owner = "client!rs", name = "b", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!rs", name = "c", descriptor = "(I)Z", line = 42)
    ...
    @OriginalMember(owner = "client!rs", name = "a", descriptor = "(IIIB)V", line = 60)
