...
public class class449 {
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILe;IIBIB)Le;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lwm;II)V")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(IILe;III)Le;")
    ...
    @OriginalMember(owner = "client!eb", name = "a", descriptor = "(Lwm;B)V")
