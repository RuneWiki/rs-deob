...
public class class449 extends class322 implements class52 {
    ...
    @OriginalMember(owner = "client!qt", name = "d", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILmq;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qt", name = "a", descriptor = "(ILcu;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!qt", name = "<init>", descriptor = "(Lvj;I[BIZ)V")
