...
public class class449 {
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(BZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(I)V", line = 25)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(ILup;II)J", line = 39)
    ...
    @OriginalMember(owner = "client!lo", name = "a", descriptor = "(B)V", line = 81)
