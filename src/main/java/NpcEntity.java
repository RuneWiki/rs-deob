...
public class NpcEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!y", name = "jb", descriptor = "Lbc;")
    public NpcType field357;

    @OriginalMember(owner = "client!y", name = "a", descriptor = "(I)Leb;")
    ...
    @OriginalMember(owner = "client!y", name = "b", descriptor = "(Z)Leb;")
