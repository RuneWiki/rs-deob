...
public class NpcEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!x", name = "fb", descriptor = "Lxb;")
    public NpcType field331;

    @OriginalMember(owner = "client!x", name = "a", descriptor = "(I)Ldb;")
    ...
    @OriginalMember(owner = "client!x", name = "b", descriptor = "(I)Ldb;")
