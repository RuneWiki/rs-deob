...
public class NpcEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "nb", descriptor = "Lfc;")
    public NpcType field450;

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(I)Lfb;")
    ...
    @OriginalMember(owner = "client!ab", name = "c", descriptor = "(I)Lfb;")
