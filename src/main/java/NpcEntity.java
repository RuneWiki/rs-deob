...
public class NpcEntity extends PathingEntity {
    ...
    @OriginalMember(owner = "client!ab", name = "pb", descriptor = "Lfc;")
    public NpcType field456;

    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(Z)Lfb;")
    ...
    @OriginalMember(owner = "client!ab", name = "a", descriptor = "(B)Lfb;")
