...
@OriginalClass("CWNCPMLX")
public class NpcEntity extends PathingEntity {

    @OriginalMember(owner = "CWNCPMLX", name = "tb", descriptor = "Z")
    private boolean _flowObfuscator10 = false;

    @OriginalMember(owner = "CWNCPMLX", name = "ub", descriptor = "I")
    private int _flowObfuscator11 = 9;

    @OriginalMember(owner = "CWNCPMLX", name = "sb", descriptor = "I")
    private int _flowObfuscator9;

    @OriginalMember(owner = "CWNCPMLX", name = "vb", descriptor = "LCKDEJADD;")
    public NpcType type;

    @OriginalMember(owner = "CWNCPMLX", name = "b", descriptor = "(I)LZKARKDQW;")
    private final Model getAnimatedModel(int arg0) {
        ...
        if (super.primarySeqId >= 0 && super.primarySeqDelay == 0) {
            ...
            return this.type.getModel(0, -1, var5, (int[]) null);
        }
    }

    @OriginalMember(owner = "CWNCPMLX", name = "a", descriptor = "(I)LZKARKDQW;")
    ...
    @OriginalMember(owner = "CWNCPMLX", name = "b", descriptor = "(Z)Z")
