...
public class class84 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lip;Z)Z", line = 3)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(II[Ljava/lang/String;I)Ljava/lang/String;", line = 33)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(B)V", line = 99)
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lha;B)V", line = 127)
