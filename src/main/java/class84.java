...
public class class84 extends class439 {
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(JJ)J", line = 3)
    public static long method495(long arg0, long arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BLkj;)V", line = 10)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(B)V", line = 213)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(III)V", line = 318)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(II)V", line = 351)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(BII)V", line = 363)
    public final void method500(byte arg0, int arg1, int arg2) {
        int var4 = 95 % ((arg0 - -75) / 49);
        ++field1034;
    }

    @OriginalMember(owner = "client!hk", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 378)
    ...
    @OriginalMember(owner = "client!hk", name = "a", descriptor = "(IBI)V", line = 401)
