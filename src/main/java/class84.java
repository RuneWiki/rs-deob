...
public class class84 {
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(III)Z", line = 7)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(Z)V", line = 19)
    ...
    @OriginalMember(owner = "client!sd", name = "a", descriptor = "(ILjava/lang/String;Lbi;Z)Ldca;", line = 32)
