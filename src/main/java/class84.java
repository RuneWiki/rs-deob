...
public class class84 extends class52 {
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(BILha;Lgs;ZII)V")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lha;IZI)Z")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(ZLha;I)Z")
    ...
    @OriginalMember(owner = "client!fca", name = "b", descriptor = "(BLha;)Lvw;")
    ...
    @OriginalMember(owner = "client!fca", name = "c", descriptor = "(BLha;)V")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lnp;I)V")
    ...
    @OriginalMember(owner = "client!fca", name = "a", descriptor = "(Lha;Z)Ltb;")
