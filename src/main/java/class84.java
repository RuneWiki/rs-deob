...
public class class84 implements Runnable {
    ...
    @OriginalMember(owner = "client!mr", name = "b", descriptor = "(B)V", line = 15)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(IBIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!mr", name = "run", descriptor = "()V", line = 54)
