...
public class class84 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;Ltl;IIII)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(I)Ljj;")
    public static final class120 method672(int arg0) {
        return (class120) field1173.method2287((long) arg0, (byte) -117);
    }

    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lvd;Lhl;Ltfa;Lmk;Luaa;Lsha;Lvi;)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;IIII)Lada;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;IIIIIII[S[BZ)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Ld;III)I")
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(Lha;IIII)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(II)Ljj;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;II)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Ld;II)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;IIII[S[B)V")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;Lrg;IIII[I[I)V")
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(Lha;)Lada;")
    ...
    @OriginalMember(owner = "client!rf", name = "b", descriptor = "(II)Lre;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lha;Ltl;Lfo;)V")
