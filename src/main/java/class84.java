...
public class class84 extends class170 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ZIILgf;DLij;Z)[I")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lij;DLgf;ZIIZI)[I")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lij;IIBZLgf;)[F")
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lij;Lgf;I)Z")
    ...
    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(Lrg;)V")
