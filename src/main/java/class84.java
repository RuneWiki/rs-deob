...
public class class84 extends class141 {
    ...
    @OriginalMember(owner = "client!di", name = "<init>", descriptor = "(Lbt;Lpt;)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(IIIIILqa;BII)V")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lei;II)V")
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;")
