...
public abstract class class84 implements class572 {
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(ILcg;)V")
    ...
    @OriginalMember(owner = "client!kca", name = "a", descriptor = "(IIIIILje;BIIII)Z")
    ...
    @OriginalMember(owner = "client!kca", name = "<init>", descriptor = "(Ltk;ILet;Lwha;IZ)V")
