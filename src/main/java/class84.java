...
public class class84 {
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "()V", line = 5)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(IZIIJ)Ljava/lang/String;", line = 91)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!mq", name = "a", descriptor = "(B[B)Lho;", line = 179)
