...
public class class84 {
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(III)V", line = 21)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(ZLir;)V", line = 37)
    ...
    @OriginalMember(owner = "client!hh", name = "a", descriptor = "(JLjava/lang/String;IZIIZLjava/lang/String;IZI)V", line = 487)
