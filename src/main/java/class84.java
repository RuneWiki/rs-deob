...
public class class84 {
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lul;I)Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "([B)[Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "a", descriptor = "(Lul;II)[Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(Lul;II)Ldi;")
    ...
    @OriginalMember(owner = "client!di", name = "b", descriptor = "(Lul;I)[Ldi;")
