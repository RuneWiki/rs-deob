...
public class class84 extends class147 {
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)I", line = 6)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)I", line = 16)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(B)J", line = 27)
    public final long method477(byte arg0) {
        return arg0 == 55 ? this.field1325 : -91L;
    }

    @OriginalMember(owner = "client!sl", name = "d", descriptor = "(I)I", line = 38)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(B)I", line = 51)
