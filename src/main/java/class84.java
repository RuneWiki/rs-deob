...
public class class84 implements class589 {
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(I)J", line = 6)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lqt;I)Z", line = 40)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(BLpaa;)V", line = 79)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Z)V", line = 114)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(Lmo;Z)Lon;", line = 132)
    ...
    @OriginalMember(owner = "client!qfa", name = "a", descriptor = "(B)V", line = 147)
