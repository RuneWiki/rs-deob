...
public class class84 extends class213 {
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lvda;)V")
    public class84(class309 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lvda;[Lbp;)V")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(Ljca;[Lbp;)Lbp;")
    ...
    @OriginalMember(owner = "client!bp", name = "a", descriptor = "(BIZ)Lr;")
    ...
    @OriginalMember(owner = "client!bp", name = "<init>", descriptor = "(Lvda;Lld;IIII)V")
