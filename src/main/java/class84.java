...
public class class84 extends class393 {
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(ILbi;IIIIIIIIB)Z", line = 5)
    ...
    @OriginalMember(owner = "client!mr", name = "a", descriptor = "(Lme;Z)Z", line = 253)
    ...
    @OriginalMember(owner = "client!mr", name = "c", descriptor = "(B)V", line = 346)
    public static void method525(byte arg0) {
        int var1 = -36 % ((arg0 + 9) / 39);
        field1175 = null;
    }

    @OriginalMember(owner = "client!mr", name = "<init>", descriptor = "(IIIIIZ)V", line = 368)
