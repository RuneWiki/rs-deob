...
public class class84 extends class695 {
    ...
    @OriginalMember(owner = "client!sl", name = "<init>", descriptor = "(Lfc;)V", line = 3)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(IJ)Ljava/lang/String;", line = 148)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(ZB)V", line = 185)
    ...
    @OriginalMember(owner = "client!sl", name = "b", descriptor = "(I)V", line = 227)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(BIILkq;Loa;Ldt;)Z", line = 268)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Lnm;ZI)V", line = 487)
    ...
    @OriginalMember(owner = "client!sl", name = "a", descriptor = "(Z)Z", line = 508)
