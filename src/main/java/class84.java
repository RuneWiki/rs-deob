...
public class class84 {
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(FFFZ)F", line = 4)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(I)Lds;", line = 17)
    ...
    @OriginalMember(owner = "client!dv", name = "a", descriptor = "(B)Lds;", line = 52)
    ...
    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "()V", line = 73)
    public class84() {
    }

    @OriginalMember(owner = "client!dv", name = "<init>", descriptor = "(Lpl;)V", line = 76)
