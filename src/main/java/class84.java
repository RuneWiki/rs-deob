...
public class class84 {
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(III)Lkb;")
    ...
    @OriginalMember(owner = "client!rf", name = "c", descriptor = "(I)[Lhda;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(ZILmi;BLmi;)Lpv;")
    ...
    @OriginalMember(owner = "client!rf", name = "a", descriptor = "(Lmi;ILmi;Z)Lpv;")
    ...
    @OriginalMember(owner = "client!rf", name = "<init>", descriptor = "(Ltk;Leia;Ljava/math/BigInteger;Ljava/math/BigInteger;)V")
