...
public class class84 {
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(B)J", line = 5)
    ...
    @OriginalMember(owner = "client!al", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!al", name = "b", descriptor = "(I)V", line = 37)
