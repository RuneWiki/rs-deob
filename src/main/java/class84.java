...
public class class84 extends class294 {
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(Z)I", line = 4)
    ...
    @OriginalMember(owner = "client!gea", name = "b", descriptor = "(B)I", line = 15)
    ...
    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(Z)I", line = 25)
    ...
    @OriginalMember(owner = "client!gea", name = "c", descriptor = "(B)J", line = 35)
    public final long method453(byte arg0) {
        return arg0 == -61 ? this.field1009 : 114L;
    }

    @OriginalMember(owner = "client!gea", name = "a", descriptor = "(I)I", line = 48)
