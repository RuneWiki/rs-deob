...
public class class84 extends class550 {
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(Lrn;Lhv;IIIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(B)Ljv;", line = 17)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III)V", line = 31)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ICI)C", line = 47)
