...
public class class84 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BLmg;Lqw;)V", line = 4)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Z)Lmg;", line = 26)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)Lmg;", line = 50)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IIB)Z", line = 72)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)Lmg;", line = 90)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lqw;I)V", line = 110)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(B)V", line = 127)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(I)I", line = 140)
    ...
    @OriginalMember(owner = "client!qw", name = "c", descriptor = "(I)Lmg;", line = 163)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILmg;)V", line = 183)
    ...
    @OriginalMember(owner = "client!qw", name = "c", descriptor = "(B)Lmg;", line = 201)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "()V", line = 287)
    public class84() {
        this.field1194.field2144 = this.field1194;
        this.field1194.field2139 = this.field1194;
    }

    @OriginalMember(owner = "client!qw", name = "d", descriptor = "(I)Z", line = 225)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lmg;I)V", line = 235)
    ...
    @OriginalMember(owner = "client!qw", name = "e", descriptor = "(I)V", line = 255)
