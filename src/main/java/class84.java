...
public class class84 extends class392 {
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!mba", name = "c", descriptor = "(I)I", line = 18)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(IZLjava/lang/String;Ljava/lang/String;B)V", line = 29)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BLol;)Lfaa;", line = 80)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Luf;Lha;III)V", line = 102)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(Z)V", line = 416)
    ...
    @OriginalMember(owner = "client!mba", name = "b", descriptor = "(II)I", line = 434)
    ...
    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(Z)I", line = 451)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(Lw;)V", line = 462)
    public class84(class675 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mba", name = "a", descriptor = "(BI)V", line = 465)
    ...
    @OriginalMember(owner = "client!mba", name = "<init>", descriptor = "(ILw;)V", line = 475)
    public class84(int arg0, class675 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!mba", name = "d", descriptor = "(I)Z", line = 484)
