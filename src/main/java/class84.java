...
public class class84 extends class522 {
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(BI)V", line = 3)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(BI)V", line = 29)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(B)V", line = 55)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ILdr;)V", line = 67)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lna;ZFIZ)V", line = 91)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZI)V", line = 116)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(ZIIIII)V", line = 140)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(Ldr;B)V", line = 257)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(I)V", line = 286)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(II)V", line = 309)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Lls;B)V", line = 358)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(Ldr;B)V", line = 526)
    ...
    @OriginalMember(owner = "client!tr", name = "b", descriptor = "(II)Z", line = 561)
    ...
    @OriginalMember(owner = "client!tr", name = "a", descriptor = "(B)V", line = 588)
