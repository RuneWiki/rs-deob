...
public class class84 {
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(ILtia;)V", line = 4)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(I)I", line = 22)
    ...
    @OriginalMember(owner = "client!dha", name = "<init>", descriptor = "()V", line = 141)
    public class84() {
        this.field1176.field4145 = this.field1176;
        this.field1176.field4146 = this.field1176;
    }

    @OriginalMember(owner = "client!dha", name = "b", descriptor = "(I)Ltia;", line = 61)
    ...
    @OriginalMember(owner = "client!dha", name = "c", descriptor = "(I)Ltia;", line = 81)
    ...
    @OriginalMember(owner = "client!dha", name = "a", descriptor = "(Z)Ltia;", line = 99)
    ...
    @OriginalMember(owner = "client!dha", name = "d", descriptor = "(I)V", line = 120)
