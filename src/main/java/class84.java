...
public class class84 extends class513 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(III)V", line = 4)
    ...
    @OriginalMember(owner = "client!qu", name = "c", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!qu", name = "e", descriptor = "(I)V", line = 44)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IBB)V", line = 57)
    ...
    @OriginalMember(owner = "client!qu", name = "<init>", descriptor = "(IIIIIF)V", line = 68)
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIIBI)V", line = 98)
