...
public class class84 {
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(IILbp;IBI)Lbt;")
    ...
    @OriginalMember(owner = "client!ed", name = "a", descriptor = "(II)Lqj;")
    ...
    @OriginalMember(owner = "client!ed", name = "<init>", descriptor = "(Lgp;ILui;)V")
