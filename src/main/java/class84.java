...
public class class84 implements class446 {
    ...
    @OriginalMember(owner = "client!vf", name = "b", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "()V", line = 22)
    public final void method460() {
        this.field940.field4752.glFramebufferRenderbufferEXT(36160, this.field945, 36161, 0);
        this.field945 = -1;
    }

    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lpo;III)V", line = 36)
