...
public class class84 {
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lfca;I)V", line = 27)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(I)V", line = 48)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BI)I", line = 59)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lfca;II)V", line = 78)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(II)Ljava/lang/String;", line = 133)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(BLjava/lang/String;)Z", line = 161)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Z)V", line = 195)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(II)Z", line = 230)
