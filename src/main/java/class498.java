...
public class class498 extends class448 {
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;I)I", line = 4)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(II)V", line = 129)
    ...
    @OriginalMember(owner = "client!ip", name = "b", descriptor = "(I)V", line = 142)
    ...
    @OriginalMember(owner = "client!ip", name = "a", descriptor = "(IIBLqa;)Z", line = 155)
    ...
    @OriginalMember(owner = "client!ip", name = "c", descriptor = "(I)V", line = 184)
