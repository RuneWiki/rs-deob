...
public class class498 {
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(II)V", line = 13)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ZI[B)V", line = 25)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(IIII)Z", line = 66)
    ...
    @OriginalMember(owner = "client!eaa", name = "b", descriptor = "(I)V", line = 225)
    public final void method2998(int arg0) {
        this.field7100 &= arg0;
        field7102++;
    }

    @OriginalMember(owner = "client!eaa", name = "c", descriptor = "(I)I", line = 234)
    ...
    @OriginalMember(owner = "client!eaa", name = "a", descriptor = "(ZIII)I", line = 247)
