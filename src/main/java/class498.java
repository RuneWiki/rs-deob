...
public class class498 {
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(Z[B)[B")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(BI)Lvl;")
    ...
    @OriginalMember(owner = "client!bia", name = "a", descriptor = "(I[S)[S")
    ...
    @OriginalMember(owner = "client!bia", name = "<init>", descriptor = "(II)V")
