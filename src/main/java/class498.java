...
public class class498 extends class49 {
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BLpja;)Z")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(ILpja;)Z")
    ...
    @OriginalMember(owner = "client!laa", name = "a", descriptor = "(BILoaa;[B)Lsu;")
