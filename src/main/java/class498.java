...
public class class498 extends class222 {
    ...
    @OriginalMember(owner = "client!oj", name = "e", descriptor = "(B)V", line = 6)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(I)V", line = 20)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Ljj;IIZ[[I)V", line = 34)
    ...
    @OriginalMember(owner = "client!oj", name = "a", descriptor = "(IIIBI)V", line = 68)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Ljj;II)V", line = 81)
    ...
    @OriginalMember(owner = "client!oj", name = "b", descriptor = "(II)V", line = 101)
    ...
    @OriginalMember(owner = "client!oj", name = "<init>", descriptor = "(Ljj;IIZ[[BI)V", line = 114)
