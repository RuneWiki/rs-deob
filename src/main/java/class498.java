...
public class class498 {
    ...
    @OriginalMember(owner = "client!ob", name = "c", descriptor = "(I)Le;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(B)Le;")
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Le;B)V")
