...
public class class498 {
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "(II)Lak;")
    ...
    @OriginalMember(owner = "client!cd", name = "a", descriptor = "([IJLlp;Z)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!cd", name = "<init>", descriptor = "(ILpq;Lpq;Lag;)V")
