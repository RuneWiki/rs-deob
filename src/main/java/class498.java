...
public class class498 {
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(Z)Lmi;", line = 18)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!mi", name = "a", descriptor = "(ILmi;)V", line = 42)
    ...
    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(I)V", line = 77)
    public class498(int arg0) {
        this.field7013 = arg0;
    }

    @OriginalMember(owner = "client!mi", name = "<init>", descriptor = "(IIIIII)V", line = 84)
