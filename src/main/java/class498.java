...
public abstract class class498 {
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!gk", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!gk", name = "a", descriptor = "(Z)V", line = 52)
    ...
    @OriginalMember(owner = "client!gk", name = "<init>", descriptor = "(III)V", line = 97)
