...
public class class498 extends class698 {
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(CI)C", line = 6)
    ...
    @OriginalMember(owner = "client!ui", name = "<init>", descriptor = "(I)V", line = 35)
    public class498(int arg0) {
        this.field7409 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(III)I", line = 54)
    ...
    @OriginalMember(owner = "client!ui", name = "b", descriptor = "(Z)V", line = 84)
    ...
    @OriginalMember(owner = "client!ui", name = "a", descriptor = "(I)V", line = 96)
