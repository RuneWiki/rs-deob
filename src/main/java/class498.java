...
public class class498 extends class320 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IZII)I", line = 4)
    ...
    @OriginalMember(owner = "client!ki", name = "c", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IIIIIIII)V", line = 46)
    ...
    @OriginalMember(owner = "client!ki", name = "<init>", descriptor = "(I[B)V", line = 92)
