...
public class class498 extends class271 {
    ...
    @OriginalMember(owner = "client!lb", name = "c", descriptor = "(Z)V", line = 8)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IBIIIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!lb", name = "f", descriptor = "(I)V", line = 472)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIIII)V", line = 504)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(IIB)Z", line = 523)
    ...
    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(Ljava/lang/String;ILjava/lang/String;)V", line = 536)
    ...
    @OriginalMember(owner = "client!lb", name = "<init>", descriptor = "(Lgj;II)V", line = 548)
    public class498(class580 arg0, int arg1, int arg2) {
        this.field6844 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!lb", name = "a", descriptor = "(ZIII)V", line = 558)
