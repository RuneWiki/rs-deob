...
public class class498 {
    ...
    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(I)I", line = 3)
    public static final int method2764(int arg0) {
        field6392++;
        return arg0 == -2 ? class11.field99 : 103;
    }

    @OriginalMember(owner = "client!dga", name = "a", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(B)V", line = 38)
    ...
    @OriginalMember(owner = "client!dga", name = "b", descriptor = "(I)V", line = 50)
    ...
    @OriginalMember(owner = "client!dga", name = "<init>", descriptor = "(IIIIIIIIIZI)V", line = 72)
