...
public abstract class class498 extends class383 {
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(I[Leq;)I")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(Lsp;B)V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIIILrb;Lr;Z)V")
    ...
    @OriginalMember(owner = "client!iba", name = "a", descriptor = "(IIILr;)V")
