...
public class class498 {
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(B)I", line = 4)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Z)Lwfa;", line = 25)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(Z)Lwfa;", line = 47)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(Lqk;B)V", line = 67)
    ...
    @OriginalMember(owner = "client!ak", name = "a", descriptor = "(ILwfa;)V", line = 118)
    ...
    @OriginalMember(owner = "client!ak", name = "b", descriptor = "(I)Lwfa;", line = 142)
    ...
    @OriginalMember(owner = "client!ak", name = "<init>", descriptor = "()V", line = 178)
    public class498() {
        this.field7165.field5596 = this.field7165;
        this.field7165.field5597 = this.field7165;
    }

    @OriginalMember(owner = "client!ak", name = "c", descriptor = "(I)V", line = 187)
