...
public class class498 extends class470 {
    ...
    @OriginalMember(owner = "client!no", name = "<init>", descriptor = "(IIIIIF)V")
    public class498(int arg0, int arg1, int arg2, int arg3, int arg4, float arg5) {
        super(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IF)V")
    ...
    @OriginalMember(owner = "client!no", name = "a", descriptor = "(IZII)V")
