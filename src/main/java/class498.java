...
public class class498 extends class115 {
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IBIIZ)V", line = 17)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "([I[ILsr;[IB)V", line = 241)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIII)V", line = 335)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(IIIBILdn;)V", line = 349)
    ...
    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(II)I", line = 475)
    public static final int method2967(int arg0, int arg1) {
        return class364.field5563 == null ? 0 : class364.field5563[arg0][arg1] & 0xFFFF;
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(III)V", line = 479)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "()V", line = 496)
    public class498() {
    }

    @OriginalMember(owner = "client!fj", name = "a", descriptor = "(Ljava/lang/Throwable;I)Ljava/lang/String;", line = 499)
    ...
    @OriginalMember(owner = "client!fj", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 571)
