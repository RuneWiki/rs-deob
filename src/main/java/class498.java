...
public class class498 extends class30 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(II)[I", line = 4)
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(ILlaa;IBLjava/awt/Component;)Ljca;", line = 26)
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "()V", line = 115)
    public class498() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ur", name = "b", descriptor = "(IB)V", line = 122)
    ...
    @OriginalMember(owner = "client!ur", name = "d", descriptor = "(I)V", line = 137)
