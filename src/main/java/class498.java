...
public class class498 extends class77 {
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(II)Z", line = 5)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(B)V", line = 16)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lsl;BLsl;F)Z", line = 68)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "([[BBLq;)V", line = 207)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(BFFF)F", line = 297)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(I)Lsl;", line = 308)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Z)V", line = 319)
    ...
    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(Lia;B)V", line = 330)
    ...
    @OriginalMember(owner = "client!ob", name = "b", descriptor = "(I)I", line = 530)
    ...
    @OriginalMember(owner = "client!ob", name = "<init>", descriptor = "(Lbl;I)V", line = 541)
    public class498(class442 arg0, int arg1) {
        this.field7551 = arg0;
        this.field7559 = new class304(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ob", name = "a", descriptor = "(ILbl;IIIB)Ljs;", line = 554)
