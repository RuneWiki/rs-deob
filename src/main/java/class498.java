...
public class class498 extends class56 implements class43 {
    ...
    @OriginalMember(owner = "client!ac", name = "<init>", descriptor = "(Lih;I[BI)V", line = 17)
    public class498(class214 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field7301 = arg1;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(II[BI)V", line = 25)
    ...
    @OriginalMember(owner = "client!ac", name = "b", descriptor = "(B)I", line = 38)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(B)I", line = 55)
    public final int method315(byte arg0) {
        ++field7306;
        return arg0 != -21 ? -40 : 0;
    }

    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(IILec;I)V", line = 66)
    ...
    @OriginalMember(owner = "client!ac", name = "a", descriptor = "(I)J", line = 92)
