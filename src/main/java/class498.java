...
public class class498 extends class141 {
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(BC)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZBIZI)Lci;", line = 17)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(ZI)V", line = 38)
    ...
    @OriginalMember(owner = "client!ev", name = "c", descriptor = "(I)Z", line = 49)
    public final boolean method55(int arg0) {
        ++field7216;
        return arg0 == 0;
    }

    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(Lei;II)V", line = 61)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(III)V", line = 74)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I)V", line = 84)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(I[FI)[F", line = 94)
    ...
    @OriginalMember(owner = "client!ev", name = "<init>", descriptor = "(Lbt;)V", line = 110)
    public class498(class33 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(IZ)V", line = 113)
    ...
    @OriginalMember(owner = "client!ev", name = "a", descriptor = "(II)Z", line = 125)
