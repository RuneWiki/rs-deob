...
public abstract class class498 extends class362 {
    ...
    @OriginalMember(owner = "client!pi", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIIBIIII)V", line = 35)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IIIIIBII)V", line = 124)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(IZ)I", line = 296)
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lcea;B)V", line = 308)
