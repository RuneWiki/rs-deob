...
public class class498 {
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ltn;BI)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(ILgaa;)V")
    ...
    @OriginalMember(owner = "client!jc", name = "a", descriptor = "(Ltn;B)V")
