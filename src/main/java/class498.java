...
public class class498 extends class463 {
    ...
    @OriginalMember(owner = "client!dd", name = "t", descriptor = "(I)V", line = 6)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(FI)V", line = 22)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "(IF)V", line = 38)
    ...
    @OriginalMember(owner = "client!dd", name = "u", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!dd", name = "<init>", descriptor = "(I)V", line = 68)
    public class498(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!dd", name = "o", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!dd", name = "a", descriptor = "([[BI[B[I[III[[B)I", line = 157)
