...
public class class498 {
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(Liv;B)V")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(IB)Lkf;")
    ...
    @OriginalMember(owner = "client!ki", name = "a", descriptor = "(ILiv;I)V")
