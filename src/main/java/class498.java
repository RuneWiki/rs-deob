...
public class class498 extends class443 {
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(BIB)V", line = 3)
    ...
    @OriginalMember(owner = "client!on", name = "a", descriptor = "(IFFF)I", line = 18)
    ...
    @OriginalMember(owner = "client!on", name = "c", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!on", name = "<init>", descriptor = "()V", line = 76)
    public class498() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!on", name = "b", descriptor = "(IIII)[B", line = 79)
