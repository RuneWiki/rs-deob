...
public class class498 {
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lje;)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lje;I)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lgm;II)V")
    ...
    @OriginalMember(owner = "client!pi", name = "a", descriptor = "(Lch;I)V")
