...
public class class498 extends class702 {
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Lun;B)Lpv;")
    ...
    @OriginalMember(owner = "client!ur", name = "a", descriptor = "(Ljf;II)V")
    ...
    @OriginalMember(owner = "client!ur", name = "<init>", descriptor = "(Lkga;Lwca;)V")
