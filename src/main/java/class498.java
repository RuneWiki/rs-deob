...
public class class498 {
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(ILqa;ZI)Lf;")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ltl;II)V")
    ...
    @OriginalMember(owner = "client!et", name = "a", descriptor = "(Ltl;B)V")
