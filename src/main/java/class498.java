...
public abstract class class498 extends class623 {
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(III)Z", line = 9)
    ...
    @OriginalMember(owner = "client!lm", name = "<init>", descriptor = "(I)V", line = 20)
    public class498(int arg0) {
        this.field7027 = arg0;
    }

    @OriginalMember(owner = "client!lm", name = "f", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!lm", name = "a", descriptor = "(IIILjb;Ljb;)V", line = 43)
