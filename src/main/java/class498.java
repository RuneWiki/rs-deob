...
public abstract class class498 {
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "([IIZI[ZILov;ILof;ZLof;I)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(Lne;IB)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IILne;ZIILne;II)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIILne;IIIZLne;ILne;Lne;II[Z)V")
    ...
    @OriginalMember(owner = "client!ka", name = "a", descriptor = "(IIIIIIZLne;[IILne;)V")
