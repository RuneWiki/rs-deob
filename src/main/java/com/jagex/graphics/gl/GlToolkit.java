...
public class GlToolkit extends Toolkit {
        ...
        try {
            ...
            if (this.isAmd || var19) {
                if (!var19) {
                    ...
                    this.field9965 &= this.field10022.method1("GL_ARB_half_float_pixel");
    ...
    public int method15861() {
        ...
        if (!this.field10022.method1("GL_ARB_multitexture")) {
            var1 |= 0x8;
        }
        if (!this.field10022.method1("GL_ARB_texture_env_combine")) {
            var1 |= 0x20;
        }
        int[] var7 = new int[1];
        ...
        this.field10017 = Stream.method62();
        this.field9990 = this.field10022.method1("GL_ARB_vertex_buffer_object");
        this.field9988 = this.field10022.method1("GL_ARB_multisample");
        this.field9999 = this.field10022.method1("GL_ARB_vertex_program");
        this.field10001 = this.field10022.method1("GL_ARB_fragment_program");
        this.field10000 = this.field10022.method1("GL_ARB_vertex_shader");
        this.field10002 = this.field10022.method1("GL_ARB_fragment_shader");
        this.field9889 = this.field10022.method1("GL_EXT_texture3D");
        this.field9965 = this.field10022.method1("GL_ARB_texture_rectangle");
        this.field9952 = this.field10022.method1("GL_ARB_texture_cube_map");
        this.field9995 = this.field10022.method1("GL_ARB_seamless_cube_map");
        this.field9997 = this.field10022.method1("GL_ARB_texture_float");
        this.field9998 = this.field10022.method1("GL_ARB_texture_non_power_of_two");
        this.field9985 = this.field10022.method1("GL_EXT_framebuffer_object");
        this.field9901 = this.field10022.method1("GL_EXT_framebuffer_blit");
        this.field9987 = this.field10022.method1("GL_EXT_framebuffer_multisample");
        this.field9989 = this.field9901 & this.field9987;
        this.field10004 = this.field10022.method1("GL_EXT_blend_func_separate");
        this.field9992 = this.field9878 != null && (this.field9979 >= 32 || this.field10022.method1("GL_ARB_sync"));
