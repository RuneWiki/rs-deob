...
public class GlFloorModel extends FloorModel {
    ...
    public void method1555() {
        if (this.field9477 > 0) {
            ...
            NativeHeapBuffer var6 = this.field9453.field9876.method93(this.field9477 * var5, false);
                        ...
                        for (int var42 = 0; var42 < var18.length; var42++) {
                            ...
                            if (var73 == null) {
                                ...
                                if (this.field9453.field10017) {
                                    ...
                                    var7.method58((byte) (var75 >> 16));
                                    var7.method58((byte) (var75 >> 8));
                                    var7.method58((byte) var75);
                                    var7.method58(-1);
                                    var7.method59((float) var43);
                                    var7.method59((float) var44);
                                    if (this.field9467 != null) {
                                    ...
                                    var7.method60((float) var43);
                                    var7.method60((float) (this.getFineHeight(var43, var44) + var49));
                                    var7.method60((float) var44);
                                    var7.method58((byte) (var75 >> 16));
                                    var7.method58((byte) (var75 >> 8));
                                    var7.method58((byte) var75);
                                    var7.method58(-1);
                                    ...
                                    var7.method60((float) var44);
                                    if (this.field9467 != null) {
                                        var7.method60(var20 == null ? 0.0F : (float) (var20[var42] - 1));
                                    }
                                    if ((this.field9457 & 0x7) != 0) {
                                        var7.method60(var57);
                                        var7.method60(var58);
            ...
            var7.method61();
            this.field9472 = this.field9453.method15804(var5, var6, var7.method56(), false);
