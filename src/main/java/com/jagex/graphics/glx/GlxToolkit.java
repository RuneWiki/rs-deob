...
public class GlxToolkit extends GpuToolkit {
    ...
    public GlxToolkit(OpenGL arg0, Canvas arg1, long arg2, MaterialList arg3, TextureList arg4, BillboardTypeList arg5, ParticleEmitterTypeList arg6, ParticleEffectorTypeList arg7, Js5 arg8, int arg9) {
        ...
        try {
            ...
            this.hasVertexBufferObject = this.opengl.method1("GL_ARB_vertex_buffer_object");
            this.hasMultiSample = this.opengl.method1("GL_ARB_multisample");
            this.hasBlendFuncSeparate = this.opengl.method1("GL_EXT_blend_func_separate");
            this.hasTextureRectangle = this.opengl.method1("GL_ARB_texture_rectangle");
            this.hasTextureCubeMap = this.opengl.method1("GL_ARB_texture_cube_map");
            this.hasTextureNonPowerOfTwo = this.opengl.method1("GL_ARB_texture_non_power_of_two");
            this.field10125 = true;
            this.hasVertexShader = this.opengl.method1("GL_ARB_vertex_shader");
            this.hasVertexProgram = this.opengl.method1("GL_ARB_vertex_program");
            this.hasFragmentShader = this.opengl.method1("GL_ARB_fragment_shader");
            this.hasFragmentProgram = this.opengl.method1("GL_ARB_fragment_program");
            this.hasFramebufferObject = this.opengl.method1("GL_EXT_framebuffer_object");
            this.field10116 = this.hasFramebufferObject;
            this.hasFramebufferBlit = this.opengl.method1("GL_EXT_framebuffer_blit");
            this.hasFramebufferMultisample = this.opengl.method1("GL_EXT_framebuffer_multisample");
            this.field12028 = this.field10110 != null && (this.field11999 >= 32 || this.opengl.method1("GL_ARB_sync"));
            this.field12014 = new int[this.maxSimutaneousTextures];
            if (!this.hasVertexShader() || !this.hasFragmentShader()) {
                if (!this.opengl.method1("GL_ARB_multitexture")) {
                    throw new RuntimeException("");
                }
                if (!this.opengl.method1("GL_ARB_texture_env_combine")) {
                    throw new RuntimeException("");
                }
            }
            NativeLibraryConfig.osName.startsWith("mac");
            this.field12027 = Stream.method62() ? 33639 : 5121;
            if (this.field12001.indexOf("radeon") != -1 || this.field12037.indexOf("intel") != -1) {
                ...
                if (!var19) {
                    ...
                    this.hasTextureRectangle &= this.opengl.method1("GL_ARB_half_float_pixel");
