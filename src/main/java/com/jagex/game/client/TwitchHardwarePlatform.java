...
public class TwitchHardwarePlatform {
        ...
        if (var6 != null) {
            for (int var7 = 0; var7 < var6.length; var7++) {
                ...
                if (var8 != null && method6878(var8, arg1)) {
                    TwitchEventSubject var9 = var8.method12();
                    if (var9 != null) {
    ...
    public static void method10361(int arg0, int arg1) {
        ...
        TwitchEventSubject var3 = var2.method12();
        if (var3 != null) {
    ...
    public static int startWebcamDevice(int arg0, int arg1) {
        ...
        return arg0 >= 0 && arg0 < webcamDevices.length ? twitchTV.StartWebcamDevice(webcamDevices[arg0].field240, arg1) : -1;
    }
    ...
    public static int stopWebcamDevice(int arg0) {
        field7391 = null;
        field7397 = null;
        return arg0 >= 0 && arg0 < webcamDevices.length ? twitchTV.StopWebcamDevice(webcamDevices[arg0].field240) : -1;
    }
    ...
    public static TwitchWebcamDevice getWebcamDeviceByIndex(int arg0) {
        ...
        for (int var1 = 0; var1 < webcamDevices.length; var1++) {
            if (webcamDevices[var1].field239 == arg0) {
    ...
    public static TwitchWebcamDevice getWebcamDeviceByName(String arg0) {
        ...
        for (int var1 = 0; var1 < webcamDevices.length; var1++) {
            if (webcamDevices[var1].field237.equals(arg0)) {
                return webcamDevices[var1];
            }
        }
        return null;
