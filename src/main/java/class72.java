...
public class class72 implements class268 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(IZ)Ljaclib/memory/Buffer;")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(B)Lns;")
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Lmh;Lns;Z)V")
