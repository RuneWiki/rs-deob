...
@OriginalClass("client!ZTSFQLLW")
public class class72 {

    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "B")
    private byte field1704 = 4;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "c", descriptor = "Z")
    private boolean field1706 = false;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "h", descriptor = "[LACLAPANL;")
    private class2[] field1711 = new class2[10];

    @OriginalMember(owner = "client!ZTSFQLLW", name = "b", descriptor = "I")
    private static int field1705 = 1;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "d", descriptor = "[LZTSFQLLW;")
    private static class72[] field1707 = new class72[5000];

    @OriginalMember(owner = "client!ZTSFQLLW", name = "e", descriptor = "[I")
    public static int[] field1708 = new int[5000];

    @OriginalMember(owner = "client!ZTSFQLLW", name = "i", descriptor = "I")
    private int field1712;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "j", descriptor = "I")
    private int field1713;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "g", descriptor = "LXOUQUKZW;")
    private static class62 field1710;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "f", descriptor = "[B")
    private static byte[] field1709;

    @OriginalMember(owner = "client!ZTSFQLLW", name = "<init>", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "(ILXOUQUKZW;)V")
    ...
    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "(IBI)LXOUQUKZW;")
    ...
    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "(BLXOUQUKZW;)V")
    ...
    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "(B)I")
    ...
    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "(II)LXOUQUKZW;")
    ...
    @OriginalMember(owner = "client!ZTSFQLLW", name = "a", descriptor = "(I)I")
