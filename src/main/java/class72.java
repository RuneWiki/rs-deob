...
public class class72 extends class376 {
    ...
    @OriginalMember(owner = "client!cg", name = "c", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!cg", name = "d", descriptor = "(B)Lkr;", line = 25)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(BI)Z", line = 43)
    ...
    @OriginalMember(owner = "client!cg", name = "<init>", descriptor = "(IIIIIZ)V", line = 101)
