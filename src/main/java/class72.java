...
public class class72 extends class56 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BILes;)V", line = 3)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(BI)[[I", line = 40)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Ljava/lang/String;I)[B", line = 97)
    ...
    @OriginalMember(owner = "client!qr", name = "d", descriptor = "(Z)V", line = 235)
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(B)V", line = 247)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "()V", line = 262)
    public class72() {
        super(3, false);
    }

    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)[I", line = 267)
