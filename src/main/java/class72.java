...
public class class72 {
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIIIZII)V", line = 12)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(B)V", line = 63)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(I)I", line = 79)
    ...
    @OriginalMember(owner = "client!sj", name = "b", descriptor = "(I)I", line = 93)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(Ljava/lang/String;CI)I", line = 112)
    ...
    @OriginalMember(owner = "client!sj", name = "a", descriptor = "(IIIIB)V", line = 142)
    ...
    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "()V", line = 163)
    public class72() {
    }

    @OriginalMember(owner = "client!sj", name = "<init>", descriptor = "(Ltq;)V", line = 165)
