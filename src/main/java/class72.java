...
public class class72 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ILrb;)I")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lrb;)V")
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(Lrb;)V")
    ...
    @OriginalMember(owner = "client!a", name = "c", descriptor = "(Lrb;)B")
    private static final byte method622(class424 arg0) {
        return (byte) method617(8, arg0);
    }

    @OriginalMember(owner = "client!a", name = "d", descriptor = "(Lrb;)V")
    ...
    @OriginalMember(owner = "client!a", name = "e", descriptor = "(Lrb;)B")
