...
public class class72 extends class739 {
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(IILqk;ILqt;ILaa;ILjava/lang/String;Lda;II)V")
    ...
    @OriginalMember(owner = "client!hea", name = "a", descriptor = "(Lsl;IB)V")
