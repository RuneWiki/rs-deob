...
public class class72 extends class330 {
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lgga;IB)V")
    ...
    @OriginalMember(owner = "client!nn", name = "a", descriptor = "(Lws;)V")
    ...
    @OriginalMember(owner = "client!nn", name = "c", descriptor = "(I)[Ljn;")
