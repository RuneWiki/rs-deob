...
public class class72 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Lwd;Z)[Lpc;", line = 3)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Ljn;I)V", line = 46)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(CZLjava/lang/String;)[Ljava/lang/String;", line = 59)
    ...
    @OriginalMember(owner = "client!gv", name = "toString", descriptor = "()Ljava/lang/String;", line = 97)
    public final String toString() {
        field1086++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)Z", line = 106)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZII)I", line = 121)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(FBZIIIIII)[[I", line = 156)
