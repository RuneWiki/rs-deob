...
public class class72 extends class339 implements class412 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Luq;Luq;I)V")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lag;III)V")
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lag;IIII)V")
