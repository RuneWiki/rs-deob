...
public class class72 {
    ...
    @OriginalMember(owner = "client!ZIUDVZAI", name = "b", descriptor = "[LZIUDVZAI;")
    public static class72[] field1710;

    @OriginalMember(owner = "client!ZIUDVZAI", name = "a", descriptor = "(ZLXRWUKRPO;)V")
    ...
    @OriginalMember(owner = "client!ZIUDVZAI", name = "a", descriptor = "(ZILGLMIQHJI;)V")
