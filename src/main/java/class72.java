...
public class class72 extends class98 {
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Lie;BI)V")
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(B)V")
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BLie;)V")
