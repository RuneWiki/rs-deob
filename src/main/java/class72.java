...
public class class72 {
    ...
    @OriginalMember(owner = "client!rv", name = "c", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BJ)V", line = 16)
    ...
    @OriginalMember(owner = "client!rv", name = "finalize", descriptor = "()V", line = 28)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I[BII)V", line = 42)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Lha;IZI)Lda;", line = 66)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(II)V", line = 83)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(B)Ljava/io/File;", line = 136)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 150)
    ...
    @OriginalMember(owner = "client!rv", name = "b", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(Ld;Ljava/awt/Canvas;III)Lha;", line = 177)
    ...
    @OriginalMember(owner = "client!rv", name = "<init>", descriptor = "(Ljava/io/File;Ljava/lang/String;J)V", line = 193)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I[BIB)I", line = 227)
