...
public class class72 implements Runnable {
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(B[BLdca;I)Llba;", line = 3)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(ZI)Z", line = 23)
    ...
    @OriginalMember(owner = "client!qh", name = "b", descriptor = "(IILdca;)Llba;", line = 37)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(Llba;B)V", line = 61)
    ...
    @OriginalMember(owner = "client!qh", name = "run", descriptor = "()V", line = 77)
    ...
    @OriginalMember(owner = "client!qh", name = "<init>", descriptor = "(Ltga;)V", line = 193)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(IILdca;)Llba;", line = 134)
    ...
    @OriginalMember(owner = "client!qh", name = "a", descriptor = "(I)V", line = 168)
