...
public class class72 extends class456 {
    ...
    @OriginalMember(owner = "client!kq", name = "c", descriptor = "(II)[B", line = 4)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IBLre;)V", line = 54)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(II)[[I", line = 68)
    ...
    @OriginalMember(owner = "client!kq", name = "<init>", descriptor = "()V", line = 135)
    public class72() {
        super(0, false);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BI)Z", line = 140)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(Z)Z", line = 153)
    ...
    @OriginalMember(owner = "client!kq", name = "d", descriptor = "(I)I", line = 266)
    ...
    @OriginalMember(owner = "client!kq", name = "h", descriptor = "(I)V", line = 277)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BII)V", line = 292)
    ...
    @OriginalMember(owner = "client!kq", name = "g", descriptor = "(I)V", line = 315)
