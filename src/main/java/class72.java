...
public class class72 {
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(BLje;)V", line = 6)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(B)I", line = 26)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(Z)Lje;", line = 51)
    ...
    @OriginalMember(owner = "client!hia", name = "a", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!hia", name = "b", descriptor = "(I)V", line = 97)
    ...
    @OriginalMember(owner = "client!hia", name = "<init>", descriptor = "()V", line = 133)
    public class72() {
        this.field1011.field6052 = this.field1011;
        this.field1011.field6051 = this.field1011;
    }

    @OriginalMember(owner = "client!hia", name = "c", descriptor = "(I)Lje;", line = 112)
