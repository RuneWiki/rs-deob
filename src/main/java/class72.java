...
public class class72 {
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I[J[I)V", line = 6)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(I)V", line = 29)
    ...
    @OriginalMember(owner = "client!rv", name = "a", descriptor = "(BIII)V", line = 48)
