...
public abstract class class72 {
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(BILuf;I)V", line = 6)
    ...
    @OriginalMember(owner = "client!kc", name = "a", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!kc", name = "b", descriptor = "(B)V", line = 107)
