...
public abstract class class72 extends class204 {
    ...
    @OriginalMember(owner = "client!kj", name = "<init>", descriptor = "(IIIII)V", line = 4)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Ljava/awt/Canvas;IILfa;)Lr;", line = 16)
    ...
    @OriginalMember(owner = "client!kj", name = "j", descriptor = "(I)V", line = 27)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "([Ljava/lang/String;B)V", line = 39)
    ...
    @OriginalMember(owner = "client!kj", name = "b", descriptor = "(B)Z", line = 83)
    ...
    @OriginalMember(owner = "client!kj", name = "f", descriptor = "(I)Z", line = 94)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I)V", line = 111)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(Lvj;IZLr;IIB)V", line = 124)
    ...
    @OriginalMember(owner = "client!kj", name = "a", descriptor = "(I[Lam;)I", line = 139)
    ...
    @OriginalMember(owner = "client!kj", name = "g", descriptor = "(I)Z", line = 153)
