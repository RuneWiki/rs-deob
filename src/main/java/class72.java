...
public class class72 extends class274 {
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(III[[ZZ)V", line = 5)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ILog;ZI)V", line = 13)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IIIIIII[[Z)V", line = 79)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(III)V", line = 249)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(III[[ZZI)V", line = 260)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Leq;[I)V", line = 269)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(ILjava/lang/String;)I", line = 285)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(II)V", line = 300)
    public final void method383(int arg0, int arg1) {
        ++field718;
    }

    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZIIIIII)V", line = 308)
    ...
    @OriginalMember(owner = "client!mea", name = "DA", descriptor = "(Lha;IIIIZ)V", line = 332)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(IZIIII[[Z)V", line = 354)
    ...
    @OriginalMember(owner = "client!mea", name = "O", descriptor = "(II[I[I[I[I[I[I[I[IIIIZ)V", line = 500)
    ...
    @OriginalMember(owner = "client!mea", name = "<init>", descriptor = "(Lvj;IIII[[I[[II)V", line = 567)
    ...
    @OriginalMember(owner = "client!mea", name = "v", descriptor = "(IILha;)Lha;", line = 623)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(Lha;IIIIZ)Z", line = 654)
    ...
    @OriginalMember(owner = "client!mea", name = "E", descriptor = "(Lha;IIIIZ)V", line = 681)
    ...
    @OriginalMember(owner = "client!mea", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[I[IIIIZ)V", line = 704)
    ...
    @OriginalMember(owner = "client!mea", name = "BA", descriptor = "()V", line = 789)
    ...
    @OriginalMember(owner = "client!mea", name = "b", descriptor = "(I)V", line = 1388)
