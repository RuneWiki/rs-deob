...
public class class72 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIIZILhh;)V", line = 20)
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(IIB)Z", line = 40)
    ...
    @OriginalMember(owner = "client!jr", name = "b", descriptor = "(I)V", line = 80)
