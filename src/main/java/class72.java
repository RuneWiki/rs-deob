...
public class class72 extends class95 {
    ...
    @OriginalMember(owner = "client!hc", name = "mb", descriptor = "Llf;")
    public static class109 field1402 = class35.method275("<)4col>", 2);

    @OriginalMember(owner = "client!hc", name = "fb", descriptor = "Ltf;")
    ...
    @OriginalMember(owner = "client!hc", name = "b", descriptor = "(I)Lue;")
    ...
    @OriginalMember(owner = "client!hc", name = "a", descriptor = "(II)Lac;")
