...
public class class72 extends class447 {
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(ILjava/lang/String;)Ljava/lang/Class;", line = 3)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(IIII)V", line = 41)
    ...
    @OriginalMember(owner = "client!me", name = "b", descriptor = "(Z)V", line = 59)
    ...
    @OriginalMember(owner = "client!me", name = "a", descriptor = "(BF)V", line = 87)
    ...
    @OriginalMember(owner = "client!me", name = "<init>", descriptor = "(IIIIIF)V", line = 100)
