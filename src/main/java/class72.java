...
public class class72 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "([BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lkv;[BI)V", line = 12)
    ...
    @OriginalMember(owner = "client!qr", name = "<init>", descriptor = "(Lkv;Ljaclib/memory/Buffer;)V", line = 21)
