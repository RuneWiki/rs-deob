...
public class class72 {
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Lda;)V")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(Z)Lom;")
    ...
    @OriginalMember(owner = "client!qr", name = "a", descriptor = "(II)Lqr;")
