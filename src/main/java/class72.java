...
public class class72 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!a", name = "b", descriptor = "(B)V", line = 17)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(III)V", line = 93)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BLjava/lang/Runnable;)V", line = 116)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Z)V", line = 129)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(BLea;)V", line = 142)
    ...
    @OriginalMember(owner = "client!a", name = "<init>", descriptor = "(Lsq;)V", line = 521)
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZLms;)V", line = 407)
