...
public class class72 extends class384 {
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(I)Z", line = 20)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ZB)V", line = 32)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(I)V", line = 42)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(ZI)V", line = 60)
    ...
    @OriginalMember(owner = "client!oi", name = "d", descriptor = "(B)V", line = 78)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(B)V", line = 105)
    ...
    @OriginalMember(owner = "client!oi", name = "e", descriptor = "(B)V", line = 120)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(Lke;BI)V", line = 140)
    ...
    @OriginalMember(owner = "client!oi", name = "a", descriptor = "(IIZ)V", line = 155)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lhl;Loh;Lwt;)V", line = 179)
    ...
    @OriginalMember(owner = "client!oi", name = "b", descriptor = "(B)V", line = 196)
