...
public class class72 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I)V", line = 8)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(FIFIF)F", line = 20)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ZI)I", line = 37)
