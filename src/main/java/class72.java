...
public class class72 extends class734 {
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(Lha;I)Lmi;")
    ...
    @OriginalMember(owner = "client!naa", name = "<init>", descriptor = "(Ljagtheora/ogg/OggStreamState;)V")
    ...
    @OriginalMember(owner = "client!naa", name = "a", descriptor = "(BLjagtheora/ogg/OggPacket;)V")
