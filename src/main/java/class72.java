...
public class class72 {
    ...
    @OriginalMember(owner = "client!ZWYXHQWS", name = "d", descriptor = "[LZWYXHQWS;")
    public static class72[] field1755;

    @OriginalMember(owner = "client!ZWYXHQWS", name = "a", descriptor = "(ILTKEGJSFV;)V")
    ...
    @OriginalMember(owner = "client!ZWYXHQWS", name = "a", descriptor = "(LEGCCHUZS;Z)V")
    ...
    @OriginalMember(owner = "client!ZWYXHQWS", name = "b", descriptor = "(B)LIGXVZOHI;")
    ...
    @OriginalMember(owner = "client!ZWYXHQWS", name = "b", descriptor = "(Z)LIGXVZOHI;")
