...
public class class72 {
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(B)V", line = 36)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(IB)I", line = 64)
    ...
    @OriginalMember(owner = "client!cg", name = "a", descriptor = "(I[I[IBI)V", line = 88)
    ...
    @OriginalMember(owner = "client!cg", name = "b", descriptor = "(I)V", line = 173)
