...
public class class72 extends class251 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IBI[II)Z", line = 4)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "([IIII)Z", line = 38)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(CB)Z", line = 68)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIIIII)Z", line = 89)
    ...
    @OriginalMember(owner = "client!co", name = "<init>", descriptor = "(ILjava/lang/String;Ljava/lang/String;IIZII)V", line = 385)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IBI)Z", line = 157)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(I[III)Z", line = 184)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(B)V", line = 216)
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(B)V", line = 228)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(Lqh;ILuj;IIIZLin;)V", line = 265)
    ...
    @OriginalMember(owner = "client!co", name = "f", descriptor = "(I)[Lqi;", line = 359)
