...
public class class72 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IZLr;ILkn;ZILr;ILla;II)Lf;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(I)Ltba;")
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(IILkn;Lr;IIII)Lf;")
    ...
    @OriginalMember(owner = "client!mf", name = "d", descriptor = "(II)Luv;")
    ...
    @OriginalMember(owner = "client!mf", name = "<init>", descriptor = "(Lrf;IZLdp;Lpl;Lpl;)V")
