...
public class class72 {
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "d", descriptor = "LOYTUMBCI;")
    public class38 field1751 = new class38();

    @OriginalMember(owner = "client!ZWZXPJNQ", name = "e", descriptor = "LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "a", descriptor = "(LOYTUMBCI;)V")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "a", descriptor = "(ILOYTUMBCI;)V")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "a", descriptor = "()LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "b", descriptor = "()LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "a", descriptor = "(I)LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "a", descriptor = "(B)LOYTUMBCI;")
    ...
    @OriginalMember(owner = "client!ZWZXPJNQ", name = "b", descriptor = "(B)LOYTUMBCI;")
