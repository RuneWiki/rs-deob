...
public class class72 extends class348 implements class147 {

    @OriginalMember(owner = "client!haa", name = "I", descriptor = "Les;")
    public class348 field996;
    ...
    @OriginalMember(owner = "client!haa", name = "x", descriptor = "[Lxa;")
    public static class461[] field985;

    @OriginalMember(owner = "client!haa", name = "y", descriptor = "[Ljava/lang/String;")
    public static String[] field986;

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IILoa;I)Z", line = 6)
    ...
    @OriginalMember(owner = "client!haa", name = "c", descriptor = "(I)Z", line = 18)
    ...
    @OriginalMember(owner = "client!haa", name = "e", descriptor = "(I)I", line = 29)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(I)V", line = 40)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ILoa;)Lwc;", line = 51)
    public final class60 method555(int arg0, class638 arg1) {
        if (arg0 != 0) {
            this.method555(87, null);
        }
        field998++;
        return null;
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IILoa;)Lba;", line = 62)
    public final class352 method548(int arg0, int arg1, class638 arg2) {
        if (arg0 != -585) {
            this.method555(58, null);
        }
        field984++;
        return null;
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(I)I", line = 73)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(BLoa;)V", line = 84)
    ...
    @OriginalMember(owner = "client!haa", name = "d", descriptor = "(I)I", line = 94)
    ...
    @OriginalMember(owner = "client!haa", name = "k", descriptor = "(I)V", line = 106)
    ...
    @OriginalMember(owner = "client!haa", name = "b", descriptor = "(Z)V", line = 123)
    public static final void method580(boolean arg0) {
        field1000++;
        if (arg0) {
            class315.field4697 = 0;
            class487.field6761.method1269((byte) 87);
            class487.field6761.method1273(class586.field8201, (byte) 122);
            class315.field4697++;
        }
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(IILgfa;IIZLoa;)V", line = 137)
    public final void method143(int arg0, int arg1, class687 arg2, int arg3, int arg4, boolean arg5, class638 arg6) {
        field982++;
        int var8 = -120 / (-arg3 / 54);
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Z)V", line = 148)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(BLoa;)V", line = 162)
    ...
    @OriginalMember(owner = "client!haa", name = "<init>", descriptor = "(IIILes;)V", line = 178)
    public class72(int arg0, int arg1, int arg2, class348 arg3) {
        super(arg0, arg1, arg2, arg3.field5008, false, false);
        this.field996 = arg3;
    }

    @OriginalMember(owner = "client!haa", name = "g", descriptor = "(I)Z", line = 186)
    ...
    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(Loa;B)Lac;", line = 201)
    public final class496 method551(class638 arg0, byte arg1) {
        if (arg1 > -62) {
            this.method549(-9);
        }
        field1002++;
        return this.field996.method551(arg0, (byte) -82);
    }

    @OriginalMember(owner = "client!haa", name = "a", descriptor = "(ZLoa;)V", line = 213)
