...
public class class72 extends class292 {
    ...
    @OriginalMember(owner = "client!so", name = "d", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!so", name = "<init>", descriptor = "()V", line = 24)
    public class72() {
        super(12, 5, 16, 2, 2, 0.45F);
    }

    @OriginalMember(owner = "client!so", name = "b", descriptor = "(IIII)[B", line = 27)
    ...
    @OriginalMember(owner = "client!so", name = "a", descriptor = "(BIZ)V", line = 43)
    ...
    @OriginalMember(owner = "client!so", name = "b", descriptor = "(III)Z", line = 59)
