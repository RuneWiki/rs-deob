...
public abstract class class72 {
    ...
    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(II)V", line = 8)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(Lcq;)V", line = 34)
    public class72(class464 arg0) {
        this.field1286 = arg0;
        this.field1282 = this.method60(-3271);
    }

    @OriginalMember(owner = "client!oi", name = "c", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!oi", name = "<init>", descriptor = "(ILcq;)V", line = 57)
