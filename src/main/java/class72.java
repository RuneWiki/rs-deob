...
public class class72 extends class324 {
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ILua;)I", line = 10)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(ZI[II)V", line = 40)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(IZII)Z", line = 55)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(III)Z", line = 71)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I)V", line = 87)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(I[III)V", line = 104)
    ...
    @OriginalMember(owner = "client!gv", name = "<init>", descriptor = "(IIIIIIIII)V", line = 115)
    ...
    @OriginalMember(owner = "client!gv", name = "b", descriptor = "(III)Z", line = 132)
    ...
    @OriginalMember(owner = "client!gv", name = "a", descriptor = "(B)V", line = 147)
