...
public class class72 extends class326 {
    ...
    @OriginalMember(owner = "client!ju", name = "f", descriptor = "(I)V", line = 120)
    ...
    @OriginalMember(owner = "client!ju", name = "c", descriptor = "(B)Lhi;", line = 397)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILbt;I)V", line = 414)
