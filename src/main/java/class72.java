...
public class class72 extends class36 {
    ...
    @OriginalMember(owner = "client!ZWUMKFUX", name = "<init>", descriptor = "(LINOFEYKQ;Ljava/lang/String;I)V")
    ...
    @OriginalMember(owner = "client!ZWUMKFUX", name = "a", descriptor = "(IBILRZWMPYWU;)V")
