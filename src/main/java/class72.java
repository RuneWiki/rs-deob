...
public class class72 extends class45 {
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(Lfb;Lfb;I)V")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(II)Lil;")
    ...
    @OriginalMember(owner = "client!a", name = "a", descriptor = "(ZLrj;IIILii;ILls;II)Ldc;")
