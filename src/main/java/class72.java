...
public class class72 extends class316 implements class350 {
    ...
    @OriginalMember(owner = "client!ra", name = "a", descriptor = "(CIIIZLta;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!ra", name = "finalize", descriptor = "()V", line = 9)
    ...
    @OriginalMember(owner = "client!ra", name = "<init>", descriptor = "(Lw;Lg;Lgf;[Lev;[Lo;)V", line = 17)
