...
public class class72 extends class490 {
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "([B[IIIIIIIIIIILea;II)V")
    ...
    @OriginalMember(owner = "client!jr", name = "<init>", descriptor = "(Lra;Lgv;[Lmp;[I[I)V")
    ...
    @OriginalMember(owner = "client!jr", name = "a", descriptor = "(CIIIZLea;II)V")
