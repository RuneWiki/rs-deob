...
@OriginalClass("client!ZESTMKXA")
public class class72 {

    @OriginalMember(owner = "client!ZESTMKXA", name = "h", descriptor = "Z")
    public boolean field1720 = false;

    @OriginalMember(owner = "client!ZESTMKXA", name = "i", descriptor = "I")
    public int field1721 = -1;

    @OriginalMember(owner = "client!ZESTMKXA", name = "a", descriptor = "I")
    private static int field1713 = -113;

    @OriginalMember(owner = "client!ZESTMKXA", name = "b", descriptor = "I")
    public static int field1714;

    @OriginalMember(owner = "client!ZESTMKXA", name = "e", descriptor = "I")
    public int field1717;

    @OriginalMember(owner = "client!ZESTMKXA", name = "f", descriptor = "I")
    public int field1718;

    @OriginalMember(owner = "client!ZESTMKXA", name = "g", descriptor = "I")
    public int field1719;

    @OriginalMember(owner = "client!ZESTMKXA", name = "j", descriptor = "I")
    public int field1722;

    @OriginalMember(owner = "client!ZESTMKXA", name = "d", descriptor = "Ljava/lang/String;")
    public String field1716;

    @OriginalMember(owner = "client!ZESTMKXA", name = "c", descriptor = "[LZESTMKXA;")
    public static class72[] field1715;

    @OriginalMember(owner = "client!ZESTMKXA", name = "a", descriptor = "(ZLEAXVDNXA;)V")
    ...
    @OriginalMember(owner = "client!ZESTMKXA", name = "a", descriptor = "(IILCKBTFRZM;)V")
