...
public class class72 extends class377 {
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(III)Z", line = 4)
    ...
    @OriginalMember(owner = "client!qw", name = "<init>", descriptor = "()V", line = 17)
    public class72() {
        super(0, true);
    }

    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(Lpw;III)Ljg;", line = 20)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IBIIII)V", line = 89)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILjava/lang/String;I[B)I", line = 192)
    ...
    @OriginalMember(owner = "client!qw", name = "f", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(ILqf;)V", line = 249)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(II)Lrba;", line = 325)
    ...
    @OriginalMember(owner = "client!qw", name = "e", descriptor = "(B)V", line = 354)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(IBZILrr;)V", line = 375)
    ...
    @OriginalMember(owner = "client!qw", name = "a", descriptor = "(II)[I", line = 454)
    ...
    @OriginalMember(owner = "client!qw", name = "b", descriptor = "(BLjava/lang/String;)V", line = 479)
    ...
    @OriginalMember(owner = "client!qw", name = "c", descriptor = "(II)V", line = 498)
