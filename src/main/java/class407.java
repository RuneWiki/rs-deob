...
public class class407 extends class5 {
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IB)V", line = 11)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIIZ)I", line = 29)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(II)V", line = 64)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(IIFII)V", line = 92)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(BI[I)V", line = 204)
    ...
    @OriginalMember(owner = "client!hj", name = "a", descriptor = "(I)V", line = 327)
    ...
    @OriginalMember(owner = "client!hj", name = "<init>", descriptor = "(Le;IIIII)V", line = 348)
    ...
    @OriginalMember(owner = "client!hj", name = "b", descriptor = "(II)V", line = 366)
