...
public class class407 extends class223 {
    ...
    @OriginalMember(owner = "client!cv", name = "a", descriptor = "(Luj;)Lcv;", line = 7)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(I[BII)V", line = 25)
    ...
    @OriginalMember(owner = "client!cv", name = "<init>", descriptor = "(I[BIIZ)V", line = 31)
