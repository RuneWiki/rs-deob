...
public class class407 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Ldh;Z)V", line = 15)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(II)V", line = 37)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IZIIB)V", line = 53)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZILdh;)V", line = 74)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(I)V", line = 99)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lvg;Lqa;I)V", line = 113)
