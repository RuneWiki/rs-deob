...
public class class407 extends class45 {
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(II)V", line = 3)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(IIIZI)V", line = 21)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(II)[[I", line = 50)
    ...
    @OriginalMember(owner = "client!v", name = "f", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(I)V", line = 102)
    ...
    @OriginalMember(owner = "client!v", name = "e", descriptor = "(I)V", line = 118)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(Lcu;II)V", line = 136)
