...
public class class407 implements class749 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lfl;ILjava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lbi;I)V")
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)Lmk;")
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lni;)V")
