...
public class class407 {
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(JI)Ljp;", line = 8)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Ljp;JB)V", line = 35)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I)Ljp;", line = 58)
    ...
    @OriginalMember(owner = "client!bu", name = "b", descriptor = "(I)I", line = 72)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(ILih;Z[IIZ)Lgq;", line = 85)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(B)I", line = 106)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(Z)V", line = 138)
    ...
    @OriginalMember(owner = "client!bu", name = "a", descriptor = "(I[Ljp;)I", line = 150)
    ...
    @OriginalMember(owner = "client!bu", name = "c", descriptor = "(I)Ljp;", line = 182)
    ...
    @OriginalMember(owner = "client!bu", name = "d", descriptor = "(I)V", line = 212)
    ...
    @OriginalMember(owner = "client!bu", name = "e", descriptor = "(I)Ljp;", line = 242)
    ...
    @OriginalMember(owner = "client!bu", name = "<init>", descriptor = "(I)V", line = 281)
