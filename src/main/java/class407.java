...
public class class407 extends class667 {
    ...
    @OriginalMember(owner = "client!rm", name = "b", descriptor = "(Z)V", line = 5)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(BI)[I", line = 16)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Lud;II)V", line = 150)
    ...
    @OriginalMember(owner = "client!rm", name = "d", descriptor = "(Z)V", line = 214)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "()V", line = 226)
    public class407() {
        super(0, true);
    }

    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIIIII)V", line = 259)
