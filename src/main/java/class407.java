...
public class class407 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lvh;I)V", line = 5)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lkj;ILjava/lang/String;I)Lgu;", line = 16)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)I", line = 94)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIILss;)V", line = 111)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(I)V", line = 182)
