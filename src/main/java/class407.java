...
public class class407 {
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(I)Luu;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(B)Luu;")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lbt;B)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Lbt;II)V")
    ...
    @OriginalMember(owner = "client!of", name = "a", descriptor = "(Ltn;ZLqa;Lcc;)V")
