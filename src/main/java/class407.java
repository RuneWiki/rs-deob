...
public class class407 extends class230 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!jt", name = "mouseExited", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 4)
    ...
    @OriginalMember(owner = "client!jt", name = "mouseDragged", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 15)
    public final synchronized void mouseDragged(MouseEvent arg0) {
        this.method2441(arg0, (byte) -126);
        field5560++;
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Lup;IIIII)V", line = 28)
    ...
    @OriginalMember(owner = "client!jt", name = "mousePressed", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 94)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IIII)V", line = 120)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(I)V", line = 138)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Ljava/awt/event/MouseEvent;B)I", line = 160)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Ljava/awt/Component;I)V", line = 196)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(B)V", line = 210)
    ...
    @OriginalMember(owner = "client!jt", name = "d", descriptor = "(Z)V", line = 223)
    ...
    @OriginalMember(owner = "client!jt", name = "f", descriptor = "(I)V", line = 238)
    ...
    @OriginalMember(owner = "client!jt", name = "mouseEntered", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 259)
    public final synchronized void mouseEntered(MouseEvent arg0) {
        field5550++;
        this.method2441(arg0, (byte) -126);
    }

    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(IIII)I", line = 267)
    ...
    @OriginalMember(owner = "client!jt", name = "mouseReleased", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 295)
    ...
    @OriginalMember(owner = "client!jt", name = "mouseClicked", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 328)
    ...
    @OriginalMember(owner = "client!jt", name = "d", descriptor = "(I)Z", line = 338)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(B)I", line = 354)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)Z", line = 371)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(Ljava/awt/event/MouseEvent;B)V", line = 385)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(Ljava/awt/Component;Z)V", line = 452)
    public class407(Component arg0, boolean arg1) {
        this.method2437(arg0, -105);
        this.field5580 = arg1;
    }

    @OriginalMember(owner = "client!jt", name = "c", descriptor = "(Z)Ljm;", line = 409)
    ...
    @OriginalMember(owner = "client!jt", name = "mouseMoved", descriptor = "(Ljava/awt/event/MouseEvent;)V", line = 425)
    public final synchronized void mouseMoved(MouseEvent arg0) {
        field5572++;
        this.method2441(arg0, (byte) -126);
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)I", line = 433)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(Z)Z", line = 461)
