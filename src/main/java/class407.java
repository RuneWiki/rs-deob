...
public class class407 extends class51 implements class212 {
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(B)I", line = 6)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I)J", line = 17)
    ...
    @OriginalMember(owner = "client!daa", name = "<init>", descriptor = "(Lkfa;I[BIZ)V", line = 33)
    public class407(class382 arg0, int arg1, byte[] arg2, int arg3, boolean arg4) {
        super(arg0, 34963, arg2, arg3, arg4);
        this.field5841 = arg1;
    }

    @OriginalMember(owner = "client!daa", name = "c", descriptor = "(I)V", line = 41)
    public final void method406(int arg0) {
        ++field5840;
        super.field670.method2324(arg0, this);
    }

    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(Z)I", line = 56)
    ...
    @OriginalMember(owner = "client!daa", name = "b", descriptor = "(I)V", line = 69)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "([BIII)V", line = 83)
    ...
    @OriginalMember(owner = "client!daa", name = "a", descriptor = "(I[BBLjava/io/File;)V", line = 96)
