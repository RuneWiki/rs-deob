...
public class class407 {
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(I)[Lo;", line = 7)
    ...
    @OriginalMember(owner = "client!en", name = "b", descriptor = "(I)V", line = 20)
    public static final void method2489(int arg0) {
        class641.field9014 = class350.method2209(4, 8, 0.4F, 2048, true, -8289, arg0, 8);
        field5732++;
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(II)I", line = 30)
    public static int method2490(int arg0, int arg1) {
        return arg0 & arg1;
    }

    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ZIZLvt;Ljava/lang/String;)V", line = 42)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(ILtja;IIIII)Z", line = 109)
    ...
    @OriginalMember(owner = "client!en", name = "a", descriptor = "(B)V", line = 168)
