...
public class class407 extends class56 {
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IIIIIIB)I")
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(IZ)[I")
    ...
    @OriginalMember(owner = "client!taa", name = "e", descriptor = "(I)V")
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ZI[I)V")
    ...
    @OriginalMember(owner = "client!taa", name = "a", descriptor = "(ILee;I)V")
