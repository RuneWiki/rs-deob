...
public class class407 {
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(B)I", line = 5)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(B)I", line = 22)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(Z)V", line = 35)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)V", line = 50)
