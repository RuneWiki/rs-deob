...
public class class407 extends class374 implements class457 {
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Lha;I)V", line = 10)
    ...
    @OriginalMember(owner = "client!ns", name = "<init>", descriptor = "(Lha;Lac;IIIIIZIIZ)V", line = 26)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(I)Z", line = 62)
    public final boolean method759(int arg0) {
        ++field5165;
        return arg0 != 0 ? false : this.field5173;
    }

    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ZIBLha;)Lok;", line = 74)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(IILrba;Lha;ZII)V", line = 105)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(Lha;I)Ljk;", line = 138)
    ...
    @OriginalMember(owner = "client!ns", name = "e", descriptor = "(I)Z", line = 164)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(Z)I", line = 180)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(I)Z", line = 191)
    ...
    @OriginalMember(owner = "client!ns", name = "h", descriptor = "(I)I", line = 202)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(CI)Z", line = 213)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(ILha;)V", line = 225)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(BILha;I)Z", line = 254)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(B)I", line = 276)
    ...
    @OriginalMember(owner = "client!ns", name = "d", descriptor = "(B)I", line = 286)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILha;)V", line = 297)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(ILha;I)Lka;", line = 333)
    ...
    @OriginalMember(owner = "client!ns", name = "j", descriptor = "(I)V", line = 353)
    ...
    @OriginalMember(owner = "client!ns", name = "d", descriptor = "(ILha;)Lwg;", line = 364)
    ...
    @OriginalMember(owner = "client!ns", name = "g", descriptor = "(B)Z", line = 378)
    ...
    @OriginalMember(owner = "client!ns", name = "f", descriptor = "(B)V", line = 394)
    ...
    @OriginalMember(owner = "client!ns", name = "b", descriptor = "(B)V", line = 408)
    ...
    @OriginalMember(owner = "client!ns", name = "a", descriptor = "(I)I", line = 428)
