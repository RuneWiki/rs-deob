...
public class class407 {
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(II)Lmv;", line = 3)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IBIIIII)V", line = 25)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(ILoa;Lpe;)V", line = 154)
    ...
    @OriginalMember(owner = "client!wp", name = "b", descriptor = "(II)V", line = 295)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(IIIB)Z", line = 304)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(Z)I", line = 442)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(I)V", line = 455)
    ...
    @OriginalMember(owner = "client!wp", name = "a", descriptor = "(B)V", line = 469)
