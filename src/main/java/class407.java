...
public class class407 extends class467 {
    ...
    @OriginalMember(owner = "client!as", name = "b", descriptor = "(B)V", line = 11)
    ...
    @OriginalMember(owner = "client!as", name = "c", descriptor = "(B)V", line = 29)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(I[B)Z", line = 50)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(IBIII)V", line = 75)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(III[B)[B", line = 101)
    ...
    @OriginalMember(owner = "client!as", name = "a", descriptor = "(Ljb;IIZ)V", line = 115)
