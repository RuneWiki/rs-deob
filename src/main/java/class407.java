...
public class class407 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(Ljava/lang/String;B[BI)I", line = 9)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 61)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)V", line = 75)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "(J[I[S[S)V", line = 110)
    ...
    @OriginalMember(owner = "client!ah", name = "<init>", descriptor = "()V", line = 120)
    protected class407() {
    }
}
