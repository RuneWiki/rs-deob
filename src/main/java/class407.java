...
public class class407 {
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lae;[II[I[I)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lae;[II)V")
    ...
    @OriginalMember(owner = "client!ar", name = "a", descriptor = "(Lae;[IIII[I[I)V")
