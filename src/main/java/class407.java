...
public class class407 extends class270 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IB)V", line = 3)
    ...
    @OriginalMember(owner = "client!wa", name = "e", descriptor = "(B)V", line = 35)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLec;I)V", line = 48)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(II)Z", line = 85)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "()V", line = 115)
    public class407() {
        super(1, false);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZI)[[I", line = 124)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(Z)V", line = 205)
