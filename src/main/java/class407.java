...
public class class407 extends class464 {
    ...
    @OriginalMember(owner = "client!sm", name = "c", descriptor = "(Z)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(ILha;)Lpu;")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Ljagtheora/ogg/OggPacket;Z)V")
    ...
    @OriginalMember(owner = "client!sm", name = "a", descriptor = "(Lr;III[Z)V")
