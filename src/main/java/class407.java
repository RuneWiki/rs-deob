...
public class class407 {
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(III)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(B)Lon;", line = 19)
    ...
    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(IIB)I", line = 37)
    ...
    @OriginalMember(owner = "client!kfa", name = "b", descriptor = "(B)V", line = 68)
    ...
    @OriginalMember(owner = "client!kfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 78)
    public final String toString() {
        field5738++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!kfa", name = "a", descriptor = "(ILjava/lang/String;I)V", line = 87)
