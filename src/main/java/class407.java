...
public class class407 extends class45 {
    ...
    @OriginalMember(owner = "client!pt", name = "<init>", descriptor = "(Lnu;)V", line = 16)
    public class407(class351 arg0) {
        this.field5354 = arg0;
    }

    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ldp;I)V", line = 29)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(IIIII)V", line = 72)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(Ljava/lang/Throwable;Ljava/lang/String;)Lij;", line = 105)
    ...
    @OriginalMember(owner = "client!pt", name = "a", descriptor = "(ILhca;I)V", line = 122)
