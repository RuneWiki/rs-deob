...
public abstract class class407 implements class331 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(III)I", line = 4)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(B)Z", line = 31)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(I)I", line = 59)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ZZ)V", line = 114)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(I)V", line = 137)
    ...
    @OriginalMember(owner = "client!ml", name = "<init>", descriptor = "(Lwia;Lwia;Lgi;)V", line = 150)
    ...
    @OriginalMember(owner = "client!ml", name = "b", descriptor = "(B)V", line = 164)
