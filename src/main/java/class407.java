...
public abstract class class407 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(II)V", line = 9)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(III)I", line = 22)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIIIII)V", line = 81)
