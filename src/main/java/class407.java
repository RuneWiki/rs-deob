...
public class class407 {
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "([Lol;Z)I")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(B)Lco;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(ZJ)Lol;")
    ...
    @OriginalMember(owner = "client!ke", name = "b", descriptor = "(B)Lol;")
    ...
    @OriginalMember(owner = "client!ke", name = "a", descriptor = "(JILol;)V")
    ...
    @OriginalMember(owner = "client!ke", name = "d", descriptor = "(B)Lol;")
    ...
    @OriginalMember(owner = "client!ke", name = "e", descriptor = "(B)Lol;")
