...
public class class407 {
    ...
    @OriginalMember(owner = "client!mfa", name = "toString", descriptor = "()Ljava/lang/String;", line = 5)
    public final String toString() {
        field5802++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(I)V", line = 15)
    public class407(int arg0) {
        this.field5801 = arg0;
    }

    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Z)V", line = 23)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IIIIIII)V", line = 45)
