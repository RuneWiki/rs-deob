...
public class class407 extends class435 {
    ...
    @OriginalMember(owner = "client!ai", name = "d", descriptor = "(Z)Z", line = 7)
    ...
    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(Ljava/lang/String;Z)V", line = 20)
    ...
    @OriginalMember(owner = "client!ai", name = "e", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!ai", name = "<init>", descriptor = "(Ljava/lang/Object;I)V", line = 46)
    public class407(Object arg0, int arg1) {
        super(arg1);
        this.field5977 = arg0;
    }

    @OriginalMember(owner = "client!ai", name = "a", descriptor = "(I)Ljava/lang/Object;", line = 60)
