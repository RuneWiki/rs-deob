...
public class class407 extends class391 implements class339 {
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(B)I", line = 10)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Z)V", line = 21)
    ...
    @OriginalMember(owner = "client!ub", name = "<init>", descriptor = "(Lr;Lbda;IIIIIZIZ)V", line = 40)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IZZLr;)Lkj;", line = 75)
    ...
    @OriginalMember(owner = "client!ub", name = "g", descriptor = "(I)I", line = 105)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(I)I", line = 117)
    ...
    @OriginalMember(owner = "client!ub", name = "h", descriptor = "(B)Z", line = 133)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IILr;I)Z", line = 145)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZIBLr;Llo;II)V", line = 166)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(Lr;I)Lsd;", line = 185)
    ...
    @OriginalMember(owner = "client!ub", name = "d", descriptor = "(I)V", line = 200)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZLr;)Log;", line = 228)
    ...
    @OriginalMember(owner = "client!ub", name = "k", descriptor = "(B)V", line = 259)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(B)I", line = 272)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(IZLr;)Lda;", line = 283)
    ...
    @OriginalMember(owner = "client!ub", name = "c", descriptor = "(B)I", line = 304)
    ...
    @OriginalMember(owner = "client!ub", name = "g", descriptor = "(B)Z", line = 314)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(I)Z", line = 325)
    public final boolean method64(int arg0) {
        ++field5112;
        return arg0 != 3755 ? false : this.field5106;
    }

    @OriginalMember(owner = "client!ub", name = "e", descriptor = "(B)Z", line = 342)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(ZLr;)V", line = 357)
    ...
    @OriginalMember(owner = "client!ub", name = "b", descriptor = "(BLr;)V", line = 367)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(BLr;)V", line = 394)
    ...
    @OriginalMember(owner = "client!ub", name = "a", descriptor = "(ZIIIZII)V", line = 421)
