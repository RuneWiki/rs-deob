...
public abstract class class407 implements class467 {
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(I[FIIB)V", line = 5)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(B)V", line = 103)
    ...
    @OriginalMember(owner = "client!bn", name = "finalize", descriptor = "()V", line = 134)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IIII[B)V", line = 147)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(I)V", line = 248)
    ...
    @OriginalMember(owner = "client!bn", name = "c", descriptor = "(I)V", line = 264)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(IFII[FFIIBIIIF)V", line = 350)
    ...
    @OriginalMember(owner = "client!bn", name = "b", descriptor = "(Z)I", line = 436)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(III[II)V", line = 532)
    ...
    @OriginalMember(owner = "client!bn", name = "d", descriptor = "(I)I", line = 637)
    ...
    @OriginalMember(owner = "client!bn", name = "<init>", descriptor = "(Lmc;ILkf;Lps;IZ)V", line = 735)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(BLqaa;)V", line = 658)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(ZLfaa;Lfaa;)V", line = 675)
    ...
    @OriginalMember(owner = "client!bn", name = "a", descriptor = "(II)V", line = 693)
    ...
    @OriginalMember(owner = "client!bn", name = "e", descriptor = "(I)V", line = 711)
