...
public class class407 {
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(Z)Lbha;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(IILdia;I)Ltia;")
    ...
    @OriginalMember(owner = "client!ga", name = "a", descriptor = "(ILli;)Ljava/lang/String;")
