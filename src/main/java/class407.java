...
public class class407 extends class513 {
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I[B)Lcw;", line = 5)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(B)V", line = 45)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IIIZZ)I", line = 55)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "()V", line = 97)
    public class407() {
    }

    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(Ljava/lang/String;)V", line = 99)
