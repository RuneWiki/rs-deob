...
public class class407 {
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(ILgj;Ld;IILjava/awt/Canvas;)Lha;", line = 31)
    ...
    @OriginalMember(owner = "client!ah", name = "a", descriptor = "(BIIII)V", line = 51)
    ...
    @OriginalMember(owner = "client!ah", name = "b", descriptor = "(I)V", line = 69)
