...
public class class407 {
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IB[Lms;)V", line = 3)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(B)V", line = 75)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(Ljava/lang/String;I)Ljava/lang/String;", line = 107)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)V", line = 165)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IIIII)V", line = 183)
