...
public class class407 {
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BI)V", line = 5)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(BLjava/lang/String;)V", line = 24)
    ...
    @OriginalMember(owner = "client!v", name = "a", descriptor = "(ZI)Lmp;", line = 49)
    ...
    @OriginalMember(owner = "client!v", name = "b", descriptor = "(I)V", line = 79)
    ...
    @OriginalMember(owner = "client!v", name = "c", descriptor = "(I)V", line = 90)
    ...
    @OriginalMember(owner = "client!v", name = "<init>", descriptor = "(Ljk;ILfs;)V", line = 116)
