...
public class class407 extends class747 implements class26 {
    ...
    @OriginalMember(owner = "client!qba", name = "<init>", descriptor = "(Lbga;Lwq;III[B)V", line = 6)
    ...
    @OriginalMember(owner = "client!qba", name = "a", descriptor = "(I)Ldh;", line = 21)
    ...
    @OriginalMember(owner = "client!qba", name = "b", descriptor = "(I)[Lmu;", line = 78)
    ...
    @OriginalMember(owner = "client!qba", name = "f", descriptor = "(I)V", line = 94)
