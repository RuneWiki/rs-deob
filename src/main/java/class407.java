...
public class class407 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)Lms;")
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)Lho;")
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lkv;Ld;)V")
