...
public class class407 extends class11 {
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(II)[[I", line = 3)
    ...
    @OriginalMember(owner = "client!iu", name = "c", descriptor = "(Z)V", line = 49)
    ...
    @OriginalMember(owner = "client!iu", name = "d", descriptor = "(II)[I", line = 63)
    ...
    @OriginalMember(owner = "client!iu", name = "e", descriptor = "(II)I", line = 95)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(IIZJLjava/lang/String;ILjava/lang/String;IIZI)V", line = 107)
    ...
    @OriginalMember(owner = "client!iu", name = "<init>", descriptor = "()V", line = 130)
    public class407() {
        super(1, false);
    }

    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(BZ[B)Ljava/lang/Object;", line = 138)
    ...
    @OriginalMember(owner = "client!iu", name = "a", descriptor = "(Lsi;II)V", line = 180)
