...
public class class407 extends class240 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(IIZLen;)Z")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILen;)Lir;")
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(Len;I)V")
