...
public class class409 extends class368 {
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(III)V", line = 5)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(IIB)V", line = 40)
    ...
    @OriginalMember(owner = "client!cga", name = "g", descriptor = "(I)V", line = 51)
    ...
    @OriginalMember(owner = "client!cga", name = "<init>", descriptor = "(IIIIIFFF)V", line = 61)
    ...
    @OriginalMember(owner = "client!cga", name = "a", descriptor = "(Ltn;I)V", line = 72)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(III)V", line = 122)
    ...
    @OriginalMember(owner = "client!cga", name = "b", descriptor = "(I)V", line = 160)
    ...
    @OriginalMember(owner = "client!cga", name = "d", descriptor = "(I)V", line = 185)
