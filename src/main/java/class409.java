...
public class class409 extends class265 {
    ...
    @OriginalMember(owner = "client!ht", name = "b", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)Lim;", line = 18)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Lim;FLim;I)Z", line = 30)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)V", line = 169)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(Lfd;I)V", line = 181)
    public class409(class365 arg0, int arg1) {
        this.field6083 = arg0;
        this.field6086 = new class401(arg0, 6408, arg1);
    }

    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(Z)I", line = 191)
