...
public class class409 extends class187 {
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "([ILtq;B)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ltq;I)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!ik", name = "b", descriptor = "(Ltq;I)V")
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Ltq;IB)V")
