...
public class class409 extends class148 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IIIIIII)I", line = 12)
    ...
    @OriginalMember(owner = "client!ht", name = "e", descriptor = "(B)V", line = 86)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "()V", line = 131)
    public class409() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(ILdh;I)V", line = 140)
    ...
    @OriginalMember(owner = "client!ht", name = "f", descriptor = "(B)V", line = 254)
    public static void method2468(byte arg0) {
        field6169 = null;
        int var1 = -94 % ((24 - arg0) / 58);
    }

    @OriginalMember(owner = "client!ht", name = "a", descriptor = "([III)V", line = 263)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(II)[I", line = 424)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(I)V", line = 450)
