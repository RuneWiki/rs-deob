...
public class class409 extends Canvas {
    ...
    @OriginalMember(owner = "client!vi", name = "paint", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "update", descriptor = "(Ljava/awt/Graphics;)V")
    ...
    @OriginalMember(owner = "client!vi", name = "<init>", descriptor = "(Ljava/awt/Component;)V")
