...
public class class409 extends class285 implements class186 {
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(I)J", line = 3)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(B)I", line = 20)
    ...
    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lbl;I[BI)V", line = 32)
    public class409(class442 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5938 = arg1;
    }

    @OriginalMember(owner = "client!gl", name = "<init>", descriptor = "(Lbl;ILjaggl/memory/NativeBuffer;)V", line = 40)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "(Z)I", line = 63)
    ...
    @OriginalMember(owner = "client!gl", name = "a", descriptor = "([BIII)V", line = 75)
