...
public class class409 extends class201 {
    ...
    @OriginalMember(owner = "client!rm", name = "c", descriptor = "(B)V", line = 12)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZIII)V", line = 26)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ZIIZ)V", line = 37)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)Z", line = 55)
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Loh;Loh;Lvv;)V", line = 70)
