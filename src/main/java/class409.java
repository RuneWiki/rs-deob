...
public class class409 extends class63 {
    ...
    @OriginalMember(owner = "client!mfa", name = "k", descriptor = "(B)Z", line = 7)
    ...
    @OriginalMember(owner = "client!mfa", name = "o", descriptor = "(II)I", line = 24)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(I[I)V", line = 59)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IZ)I", line = 70)
    ...
    @OriginalMember(owner = "client!mfa", name = "l", descriptor = "(B)V", line = 81)
    ...
    @OriginalMember(owner = "client!mfa", name = "w", descriptor = "(I)V", line = 96)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(IIII)Z", line = 115)
    ...
    @OriginalMember(owner = "client!mfa", name = "b", descriptor = "([BIII)V", line = 170)
    ...
    @OriginalMember(owner = "client!mfa", name = "x", descriptor = "(I)V", line = 193)
    ...
    @OriginalMember(owner = "client!mfa", name = "a", descriptor = "(Laq;B)V", line = 204)
    ...
    @OriginalMember(owner = "client!mfa", name = "m", descriptor = "(B)I", line = 221)
    ...
    @OriginalMember(owner = "client!mfa", name = "<init>", descriptor = "(I)V", line = 260)
    public class409(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!mfa", name = "g", descriptor = "(IB)V", line = 263)
