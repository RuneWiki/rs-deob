...
public class class409 extends class270 {
    ...
    @OriginalMember(owner = "client!ik", name = "e", descriptor = "(B)V", line = 7)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BLec;I)V", line = 20)
    ...
    @OriginalMember(owner = "client!ik", name = "f", descriptor = "(I)V", line = 65)
    ...
    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(BI)[I", line = 95)
    ...
    @OriginalMember(owner = "client!ik", name = "<init>", descriptor = "()V", line = 243)
    public class409() {
        super(0, true);
    }

    @OriginalMember(owner = "client!ik", name = "a", descriptor = "(Z)V", line = 218)
