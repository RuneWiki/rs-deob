...
public class class409 extends class34 {
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(I)V", line = 4)
    ...
    @OriginalMember(owner = "client!f", name = "<init>", descriptor = "()V", line = 18)
    public class409() {
        super(0, true);
    }

    @OriginalMember(owner = "client!f", name = "d", descriptor = "(B)V", line = 23)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(ZIII)I", line = 34)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IIC)C", line = 57)
    ...
    @OriginalMember(owner = "client!f", name = "f", descriptor = "(I)V", line = 148)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(II)V", line = 170)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(Lsv;II)V", line = 184)
    ...
    @OriginalMember(owner = "client!f", name = "e", descriptor = "(B)V", line = 245)
    ...
    @OriginalMember(owner = "client!f", name = "a", descriptor = "(IB)[I", line = 292)
