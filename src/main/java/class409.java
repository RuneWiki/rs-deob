...
public class class409 {
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(BI)Luca;")
    ...
    @OriginalMember(owner = "client!qv", name = "a", descriptor = "(Lha;III[Z)Z")
    ...
    @OriginalMember(owner = "client!qv", name = "<init>", descriptor = "(Lkr;ILpu;)V")
