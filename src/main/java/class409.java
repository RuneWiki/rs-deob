...
public abstract class class409 {
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(BLu;)Z")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lek;III[Z)Z")
    ...
    @OriginalMember(owner = "client!jm", name = "a", descriptor = "(Lqj;Lqj;I)V")
