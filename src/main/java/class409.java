...
public class class409 extends class54 {
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(II)V", line = 16)
    ...
    @OriginalMember(owner = "client!tm", name = "a", descriptor = "(Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(ILhia;)V", line = 46)
    public class409(int arg0, class73 arg1) {
        super(arg0, arg1);
    }

    @OriginalMember(owner = "client!tm", name = "<init>", descriptor = "(Lhia;)V", line = 51)
    public class409(class73 arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(IB)I", line = 56)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(II)[I", line = 72)
    ...
    @OriginalMember(owner = "client!tm", name = "c", descriptor = "(Z)I", line = 89)
    ...
    @OriginalMember(owner = "client!tm", name = "d", descriptor = "(I)Z", line = 101)
    ...
    @OriginalMember(owner = "client!tm", name = "b", descriptor = "(Z)I", line = 123)
    ...
    @OriginalMember(owner = "client!tm", name = "e", descriptor = "(I)[Lkia;", line = 144)
