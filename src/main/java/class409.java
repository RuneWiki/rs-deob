...
public class class409 {
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "()V", line = 3)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lir;)V", line = 81)
    public final void method2536(class16 arg0) {
        this.method2541(arg0, true);
    }

    @OriginalMember(owner = "client!re", name = "b", descriptor = "()Z", line = 87)
    private final boolean method2537() {
        return this.field5639.method2084() == this.field5641;
    }

    @OriginalMember(owner = "client!re", name = "b", descriptor = "(Lir;)Z", line = 91)
    ...
    @OriginalMember(owner = "client!re", name = "<init>", descriptor = "(Lh;)V", line = 361)
    ...
    @OriginalMember(owner = "client!re", name = "c", descriptor = "()V", line = 121)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(IIII)Z", line = 175)
    ...
    @OriginalMember(owner = "client!re", name = "a", descriptor = "(Lir;Z)V", line = 290)
    ...
    @OriginalMember(owner = "client!re", name = "d", descriptor = "()V", line = 298)
