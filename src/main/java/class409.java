...
public class class409 extends class208 implements MouseListener, MouseMotionListener {
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(Lld;BZ)V")
    ...
    @OriginalMember(owner = "client!fo", name = "a", descriptor = "(ILms;I)I")
    ...
    @OriginalMember(owner = "client!fo", name = "e", descriptor = "(I)Lwc;")
