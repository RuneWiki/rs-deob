...
public class class409 extends class470 {
    ...
    @OriginalMember(owner = "client!pf", name = "a", descriptor = "(Z)I", line = 5)
    ...
    @OriginalMember(owner = "client!pf", name = "g", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!pf", name = "f", descriptor = "(I)[B", line = 37)
