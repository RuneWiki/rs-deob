...
public class class409 {
    ...
    @OriginalMember(owner = "client!rm", name = "<init>", descriptor = "(Leea;)V", line = 419)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(Z[[[BIBIIZ)V", line = 8)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(ILta;I)Z", line = 312)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(II)Z", line = 329)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(IIZZII)V", line = 346)
    ...
    @OriginalMember(owner = "client!rm", name = "a", descriptor = "(B)V", line = 410)
