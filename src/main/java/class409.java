...
public class class409 {
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(IIZIIZI)V", line = 3)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "(I)V", line = 33)
    ...
    @OriginalMember(owner = "client!os", name = "a", descriptor = "([BIIIIZ)V", line = 44)
