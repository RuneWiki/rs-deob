...
public class class409 {
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(BLqi;I)La;", line = 7)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(Lnn;BI)V", line = 33)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(ILnn;)V", line = 101)
    ...
    @OriginalMember(owner = "client!uo", name = "a", descriptor = "(I)Lef;", line = 130)
    ...
    @OriginalMember(owner = "client!uo", name = "b", descriptor = "(ILnn;)Ljava/lang/String;", line = 148)
