...
public class class409 extends class598 {
    ...
    @OriginalMember(owner = "client!tk", name = "b", descriptor = "(I)V", line = 18)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIB)Z", line = 169)
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(II[I[I)V", line = 181)
