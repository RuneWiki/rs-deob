...
public abstract class class409 implements class167 {
    ...
    @OriginalMember(owner = "client!kda", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IZ)V", line = 16)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(IIIIIBI)J", line = 38)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(Z)V", line = 50)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(I)Z", line = 66)
    ...
    @OriginalMember(owner = "client!kda", name = "a", descriptor = "(B)I", line = 89)
    ...
    @OriginalMember(owner = "client!kda", name = "<init>", descriptor = "(Lbt;Lbt;Llh;)V", line = 152)
