...
public class class409 {
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ZBLya;I)Ll;")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(BLgk;)V")
    ...
    @OriginalMember(owner = "client!jn", name = "a", descriptor = "(ILgk;I)V")
