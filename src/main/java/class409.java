...
public class class409 extends class145 {
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(IF)V", line = 3)
    ...
    @OriginalMember(owner = "client!ht", name = "q", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!ht", name = "<init>", descriptor = "(I)V", line = 32)
    public class409(int arg0) {
        super(arg0);
    }

    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(FI)V", line = 38)
    ...
    @OriginalMember(owner = "client!ht", name = "a", descriptor = "(Lqf;IIIII)V", line = 64)
    ...
    @OriginalMember(owner = "client!ht", name = "c", descriptor = "(IZ)V", line = 133)
