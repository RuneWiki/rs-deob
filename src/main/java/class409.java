...
public class class409 extends class413 {
    ...
    @OriginalMember(owner = "client!tk", name = "OA", descriptor = "(CIIIZ)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "([B[IIIIIIIIIIILua;II)V")
    ...
    @OriginalMember(owner = "client!tk", name = "<init>", descriptor = "(Lnga;Lsa;[Laga;[I[I)V")
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(CIIIZLua;II)V")
