...
public class class409 {
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(ZIIIII)V", line = 24)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(BI)C", line = 126)
    ...
    @OriginalMember(owner = "client!mf", name = "a", descriptor = "(III)I", line = 157)
    ...
    @OriginalMember(owner = "client!mf", name = "toString", descriptor = "()Ljava/lang/String;", line = 181)
