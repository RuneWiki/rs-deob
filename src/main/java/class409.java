...
public class class409 extends InputStream {
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!lv", name = "read", descriptor = "()I", line = 16)
    ...
    @OriginalMember(owner = "client!lv", name = "b", descriptor = "(I)I", line = 31)
    ...
    @OriginalMember(owner = "client!lv", name = "a", descriptor = "(IB)V", line = 54)
