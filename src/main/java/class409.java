...
public class class409 {
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILtq;Lul;)V", line = 16)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(I[B)[B", line = 29)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(B)I", line = 47)
    ...
    @OriginalMember(owner = "client!vm", name = "b", descriptor = "(I)V", line = 91)
    ...
    @OriginalMember(owner = "client!vm", name = "a", descriptor = "(ILjava/lang/String;C)[Ljava/lang/String;", line = 104)
