...
public abstract class class409 {
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(B)Z", line = 6)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(I)Z", line = 23)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(I)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ek", name = "b", descriptor = "(B)Z", line = 45)
    ...
    @OriginalMember(owner = "client!ek", name = "a", descriptor = "(Lqr;IILtj;II)V", line = 62)
