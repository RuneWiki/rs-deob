...
public class class409 {
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Lha;III)V", line = 4)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(Llm;Llm;I)V", line = 553)
    ...
    @OriginalMember(owner = "client!bga", name = "a", descriptor = "(I)V", line = 580)
