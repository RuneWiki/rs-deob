...
public class class409 extends class5 implements class223 {
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Z)Z", line = 7)
    public final boolean method706(boolean arg0) {
        ++field5716;
        return !arg0 ? true : this.field5704.method1222((byte) -94);
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IILea;Lac;ZII)V", line = 18)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ILea;)V", line = 29)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(BLea;)V", line = 47)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lea;BI)Lts;", line = 58)
    ...
    @OriginalMember(owner = "client!wa", name = "f", descriptor = "(I)I", line = 70)
    public final int method23(int arg0) {
        ++field5715;
        return arg0 > -84 ? -83 : this.field5704.method1217(-12);
    }

    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(ILea;)Lms;", line = 81)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(Z)I", line = 119)
    public final int method711(boolean arg0) {
        ++field5712;
        return !arg0 ? 67 : this.field5704.field2445;
    }

    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(B)V", line = 131)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(Lea;I)V", line = 142)
    ...
    @OriginalMember(owner = "client!wa", name = "h", descriptor = "(I)V", line = 158)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(I)V", line = 169)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(I)I", line = 181)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(ZILea;I)Z", line = 192)
    ...
    @OriginalMember(owner = "client!wa", name = "d", descriptor = "(I)Z", line = 211)
    ...
    @OriginalMember(owner = "client!wa", name = "<init>", descriptor = "(Lea;Lp;IIIIIIIZIIIII)V", line = 222)
    ...
    @OriginalMember(owner = "client!wa", name = "c", descriptor = "(B)V", line = 231)
    ...
    @OriginalMember(owner = "client!wa", name = "a", descriptor = "(IIII)V", line = 250)
    ...
    @OriginalMember(owner = "client!wa", name = "b", descriptor = "(I)I", line = 264)
