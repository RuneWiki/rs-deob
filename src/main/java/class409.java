...
public class class409 {
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(IBI)Z", line = 4)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(II)V", line = 40)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(Z)Z", line = 51)
    ...
    @OriginalMember(owner = "client!ml", name = "a", descriptor = "(ILeg;)Leg;", line = 65)
