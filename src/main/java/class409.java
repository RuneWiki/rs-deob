...
public class class409 {
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Z)V", line = 3)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(ZI)V", line = 25)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(I)V", line = 38)
    ...
    @OriginalMember(owner = "client!qd", name = "a", descriptor = "(Lg;B)V", line = 68)
