...
public class class409 extends class476 {
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Lwu;Lwu;Lft;ILwu;Luu;)Z", line = 6)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(II)V", line = 34)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(B)Lmha;", line = 56)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(Z)V", line = 68)
    ...
    @OriginalMember(owner = "client!oh", name = "a", descriptor = "(I)V", line = 108)
    ...
    @OriginalMember(owner = "client!oh", name = "<init>", descriptor = "(Lle;Lqj;IIIIIIIII)V", line = 118)
