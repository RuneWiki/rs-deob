...
public abstract class class409 {
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIILjava/lang/String;II)V", line = 3)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IBII[I[Lf;ILjava/lang/String;)V", line = 16)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[Lf;IIIII[ILjava/lang/String;III[ILjava/util/Random;)I", line = 34)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(III)V", line = 113)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IZ)I", line = 134)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;I)V", line = 168)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(ILjava/lang/String;IIIII)V", line = 245)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIILjava/lang/String;I)V", line = 277)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIBLjava/lang/String;II)V", line = 299)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I[IIIIZLjava/lang/String;I[Lf;IILua;IIIII)I", line = 316)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(I)V", line = 415)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[Lf;Lua;Ljava/lang/String;III[I)V", line = 428)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "([Lf;I[ILjava/lang/String;ILjava/util/Random;IIII)I", line = 574)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;II)V", line = 614)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;BI)V", line = 647)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(IIIIILjava/lang/String;I)V", line = 692)
    ...
    @OriginalMember(owner = "client!la", name = "a", descriptor = "(II[IILjava/lang/String;Lua;IIIIII[Lf;III)I", line = 724)
    ...
    @OriginalMember(owner = "client!la", name = "<init>", descriptor = "(Lr;Laga;)V", line = 742)
    public class409(class562 arg0, class658 arg1) {
        this.field5382 = arg0;
        this.field5388 = arg1;
    }

    @OriginalMember(owner = "client!la", name = "a", descriptor = "(Ljava/lang/String;[I[III[I[Lf;I)V", line = 760)
