...
public class class409 extends class130 implements class151 {
    ...
    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(I)V", line = 16)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(B)V", line = 43)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I[BIB)V", line = 73)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(CB)C", line = 90)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(ZI)I", line = 489)
    ...
    @OriginalMember(owner = "client!gu", name = "<init>", descriptor = "(Lef;I[BI)V", line = 500)
    public class409(class338 arg0, int arg1, byte[] arg2, int arg3) {
        super(arg0, arg2, arg3);
        this.field5978 = arg1;
    }

    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(III)I", line = 508)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(Lem;IILya;ILma;III)V", line = 532)
    ...
    @OriginalMember(owner = "client!gu", name = "a", descriptor = "(I)J", line = 632)
    public final long method1015(int arg0) {
        ++field5974;
        return arg0 != -6936 ? -37L : super.field1915.method2592();
    }

    @OriginalMember(owner = "client!gu", name = "b", descriptor = "(Z)I", line = 646)
    ...
    @OriginalMember(owner = "client!gu", name = "c", descriptor = "(Z)V", line = 657)
