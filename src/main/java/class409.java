...
public class class409 extends class601 {
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IB)[I", line = 8)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(Lmc;II)V", line = 64)
    ...
    @OriginalMember(owner = "client!tk", name = "a", descriptor = "(IIBII)V", line = 86)
    ...
    @OriginalMember(owner = "client!tk", name = "f", descriptor = "(I)V", line = 140)
    ...
    @OriginalMember(owner = "client!tk", name = "d", descriptor = "(B)V", line = 167)
