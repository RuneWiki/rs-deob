...
public class class102 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(ZII)Z", line = 3)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)V", line = 24)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IJ)V", line = 45)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IIJ)Ljava/lang/String;", line = 134)
