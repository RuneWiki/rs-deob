...
public class class102 extends class98 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(IIILfj;Z)V", line = 4)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(II)[I", line = 169)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(II)[[I", line = 259)
    ...
    @OriginalMember(owner = "client!kk", name = "<init>", descriptor = "()V", line = 390)
    public class102() {
        super(1, false);
    }

    @OriginalMember(owner = "client!kk", name = "f", descriptor = "(B)V", line = 393)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(Lae;Lul;I)V", line = 405)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(BII)V", line = 630)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(II)V", line = 663)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILdg;I)V", line = 680)
