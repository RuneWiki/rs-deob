...
public abstract class class102 {
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(B)V", line = 3)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(B)Z", line = 119)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Z)Lsm;", line = 140)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(I)V", line = 154)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(BLmc;)Lbo;", line = 201)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(ZILfda;)V", line = 216)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(I)D", line = 299)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Ljava/lang/String;B)V", line = 322)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(B)Lbk;", line = 383)
    ...
    @OriginalMember(owner = "client!gq", name = "c", descriptor = "(I)V", line = 500)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(B)Let;", line = 530)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(B)Z", line = 545)
    ...
    @OriginalMember(owner = "client!gq", name = "f", descriptor = "(B)V", line = 564)
    ...
    @OriginalMember(owner = "client!gq", name = "b", descriptor = "(Z)Luh;", line = 604)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(Luaa;III)V", line = 616)
    ...
    @OriginalMember(owner = "client!gq", name = "d", descriptor = "(I)V", line = 690)
    ...
    @OriginalMember(owner = "client!gq", name = "e", descriptor = "(I)V", line = 719)
    ...
    @OriginalMember(owner = "client!gq", name = "a", descriptor = "(IZ)V", line = 730)
    ...
    @OriginalMember(owner = "client!gq", name = "<init>", descriptor = "(I)V", line = 752)
