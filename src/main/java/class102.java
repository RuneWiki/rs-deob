...
public class class102 extends class122 {
    ...
    @OriginalMember(owner = "client!qca", name = "d", descriptor = "()V")
    ...
    @OriginalMember(owner = "client!qca", name = "a", descriptor = "(Ljava/awt/Component;)V")
    ...
    @OriginalMember(owner = "client!qca", name = "c", descriptor = "()V")
