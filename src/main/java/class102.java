...
public class class102 extends class417 {
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lih;IIIZ[I)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lih;IIIII[BI)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lih;IIIIZ[BI)V")
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ZLhm;)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lih;IIIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lih;IIIIIZ)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lih;IIII[I)V")
