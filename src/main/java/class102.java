...
public class class102 {
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(Lrba;B)Z", line = 58)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(I)V", line = 78)
    ...
    @OriginalMember(owner = "client!rba", name = "b", descriptor = "(B)V", line = 94)
    ...
    @OriginalMember(owner = "client!rba", name = "a", descriptor = "(ILew;)Lae;", line = 119)
