...
public class class102 {
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(BLgj;)Ljava/lang/Object;")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Las;I)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(Ljava/lang/Object;Lgj;B)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(IBLgj;Ljava/lang/Object;)V")
    ...
    @OriginalMember(owner = "client!aaa", name = "a", descriptor = "(ZLgj;)V")
