...
public class class102 extends class368 {
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(IBI)V", line = 20)
    ...
    @OriginalMember(owner = "client!ec", name = "d", descriptor = "(I)V", line = 32)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(II)Lgaa;", line = 54)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(II)V", line = 78)
    ...
    @OriginalMember(owner = "client!ec", name = "b", descriptor = "(B)V", line = 91)
    ...
    @OriginalMember(owner = "client!ec", name = "a", descriptor = "(III)V", line = 103)
    ...
    @OriginalMember(owner = "client!ec", name = "<init>", descriptor = "(IIIIIF)V", line = 120)
