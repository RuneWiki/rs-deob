...
public class class102 extends class206 {
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "([B[IIIIIIII)V", line = 5)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "([B[IIIIIIIIIIILhg;II)V", line = 39)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(CIIIZLhg;II)V", line = 133)
    ...
    @OriginalMember(owner = "client!qc", name = "a", descriptor = "(CIIIZ)V", line = 198)
    ...
    @OriginalMember(owner = "client!qc", name = "<init>", descriptor = "(Ld;Lbg;[Lkm;[I[I)V", line = 258)
