...
public class class102 extends class194 {
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(B)J", line = 4)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(II)[I", line = 16)
    ...
    @OriginalMember(owner = "client!io", name = "<init>", descriptor = "()V", line = 94)
    public class102() {
        super(1, true);
    }

    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IILbg;)V", line = 77)
    ...
    @OriginalMember(owner = "client!io", name = "b", descriptor = "(Z)V", line = 97)
    ...
    @OriginalMember(owner = "client!io", name = "a", descriptor = "(IZ)V", line = 929)
    ...
    @OriginalMember(owner = "client!io", name = "h", descriptor = "(I)V", line = 972)
