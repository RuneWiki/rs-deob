...
public abstract class class102 {
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(I)V", line = 7)
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(B)Ldn;", line = 18)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILgba;I)Z", line = 38)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(III)V", line = 199)
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(III)V", line = 218)
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IIII)I", line = 238)
