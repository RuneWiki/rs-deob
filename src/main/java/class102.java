...
public class class102 extends class455 {
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(III)V", line = 3)
    ...
    @OriginalMember(owner = "client!jt", name = "b", descriptor = "(I)V", line = 17)
    ...
    @OriginalMember(owner = "client!jt", name = "e", descriptor = "(I)V", line = 34)
    ...
    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(IB)V", line = 47)
    public void method504(int arg0, byte arg1) {
        this.field1455[this.field1454++] = (byte) ((class347.method2074(arg1, 255) >> 1) + 127);
        ++field1449;
    }

    @OriginalMember(owner = "client!jt", name = "a", descriptor = "(Z)V", line = 66)
    ...
    @OriginalMember(owner = "client!jt", name = "<init>", descriptor = "(IIIIIF)V", line = 78)
