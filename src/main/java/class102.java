...
public abstract class class102 {
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IILjava/lang/Object;B)[B", line = 5)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(Z)V", line = 38)
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(Z)V", line = 61)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B)V", line = 73)
