...
public class class102 {
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(ZILta;)V", line = 4)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(IIIIIIZIII)V", line = 341)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(Z)V", line = 364)
