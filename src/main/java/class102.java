...
public class class102 extends class49 {
    ...
    @OriginalMember(owner = "client!pw", name = "a", descriptor = "(ZILae;IIII)V")
    ...
    @OriginalMember(owner = "client!pw", name = "<init>", descriptor = "(Llga;)V")
    public class102(class20 arg0) {
        this.field1179 = arg0;
    }

    @OriginalMember(owner = "client!pw", name = "a", descriptor = "([ILae;Lae;I)V")
    ...
    @OriginalMember(owner = "client!pw", name = "d", descriptor = "(B)V")
