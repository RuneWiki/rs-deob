...
public class class102 extends class271 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 12)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IBI)Z", line = 24)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lgq;)V", line = 34)
    public class102(class354 arg0) {
        this.field1475 = arg0;
    }

    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIIII)V", line = 42)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lkn;Loq;IILse;BII)V", line = 70)
