...
public abstract class class102 {
    ...
    @OriginalMember(owner = "client!pm", name = "finalize", descriptor = "()V", line = 7)
    ...
    @OriginalMember(owner = "client!pm", name = "d", descriptor = "(I)V", line = 21)
    ...
    @OriginalMember(owner = "client!pm", name = "a", descriptor = "([BIB)V", line = 34)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lgk;I[BIZ)V", line = 60)
    ...
    @OriginalMember(owner = "client!pm", name = "<init>", descriptor = "(Lgk;ILjaggl/memory/NativeBuffer;IZ)V", line = 79)
