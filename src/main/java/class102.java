...
public class class102 {
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(II)[B", line = 9)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(I[BII)Z", line = 87)
    ...
    @OriginalMember(owner = "client!q", name = "<init>", descriptor = "(ILjs;Ljs;I)V", line = 287)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(IB)V", line = 120)
    ...
    @OriginalMember(owner = "client!q", name = "toString", descriptor = "()Ljava/lang/String;", line = 135)
    public final String toString() {
        field1426++;
        return "Cache:" + this.field1428;
    }

    @OriginalMember(owner = "client!q", name = "a", descriptor = "([BZIZI)Z", line = 143)
    ...
    @OriginalMember(owner = "client!q", name = "a", descriptor = "(B)V", line = 262)
