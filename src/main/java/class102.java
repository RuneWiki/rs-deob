...
public class class102 {
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B[[I)V", line = 3)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(I)V", line = 17)
    public static void method688(int arg0) {
        int var1 = -125 % ((-arg0 - 26) / 36);
        field1464 = null;
    }

    @OriginalMember(owner = "client!ju", name = "b", descriptor = "(I)I", line = 30)
    ...
    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(ILjava/lang/String;)I", line = 42)
    ...
    @OriginalMember(owner = "client!ju", name = "toString", descriptor = "()Ljava/lang/String;", line = 64)
    public final String toString() {
        field1463++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ju", name = "<init>", descriptor = "(II)V", line = 78)
    public class102(int arg0, int arg1) {
        this.field1455 = arg0;
        this.field1461 = arg1;
    }

    @OriginalMember(owner = "client!ju", name = "a", descriptor = "(B)I", line = 90)
