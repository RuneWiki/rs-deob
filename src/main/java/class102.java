...
public class class102 {
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;ILjava/lang/String;)V", line = 6)
    ...
    @OriginalMember(owner = "client!kk", name = "a", descriptor = "(I)V", line = 46)
    ...
    @OriginalMember(owner = "client!kk", name = "b", descriptor = "(I)V", line = 62)
    ...
    @OriginalMember(owner = "client!kk", name = "c", descriptor = "(I)V", line = 79)
