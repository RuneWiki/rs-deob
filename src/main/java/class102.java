...
public class class102 extends class386 {
    ...
    @OriginalMember(owner = "client!jj", name = "e", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(II)[I", line = 21)
    ...
    @OriginalMember(owner = "client!jj", name = "<init>", descriptor = "()V", line = 80)
    public class102() {
        super(0, true);
    }

    @OriginalMember(owner = "client!jj", name = "a", descriptor = "(IBLun;)V", line = 100)
