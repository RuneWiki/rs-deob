...
public class class102 {
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(I)V", line = 9)
    ...
    @OriginalMember(owner = "client!ho", name = "toString", descriptor = "()Ljava/lang/String;", line = 27)
    public final String toString() {
        field1429++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(IIII)V", line = 40)
