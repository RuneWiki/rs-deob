...
public class class102 extends class51 {
    ...
    @OriginalMember(owner = "client!g", name = "b", descriptor = "(III)V", line = 6)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(I)V", line = 26)
    public static void method612(int arg0) {
        field1378 = null;
        int var1 = -79 / ((59 - arg0) / 40);
    }

    @OriginalMember(owner = "client!g", name = "c", descriptor = "(III)V", line = 38)
    ...
    @OriginalMember(owner = "client!g", name = "<init>", descriptor = "(IIIIIII)V", line = 57)
    ...
    @OriginalMember(owner = "client!g", name = "a", descriptor = "(III)V", line = 72)
