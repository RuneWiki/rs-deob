...
public class class102 implements class500 {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "([ILra;IJ)Ljava/lang/String;", line = 25)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(III)I", line = 59)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 73)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(IIBI)I", line = 84)
