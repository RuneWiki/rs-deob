...
public class class102 extends class53 {
    ...
    @OriginalMember(owner = "client!ho", name = "c", descriptor = "(B)V", line = 4)
    ...
    @OriginalMember(owner = "client!ho", name = "d", descriptor = "(I)V", line = 15)
    ...
    @OriginalMember(owner = "client!ho", name = "<init>", descriptor = "(I)V", line = 26)
    public class102(int arg0) {
        this.field1542 = new NativeHeap(arg0);
    }

    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(III)Z", line = 34)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(IIBLbf;)V", line = 45)
    ...
    @OriginalMember(owner = "client!ho", name = "a", descriptor = "(Leo;IIII)V", line = 56)
    ...
    @OriginalMember(owner = "client!ho", name = "e", descriptor = "(I)V", line = 108)
