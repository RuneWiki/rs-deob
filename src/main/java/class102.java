...
public class class102 extends class47 implements ImageProducer {
    ...
    // $FF: synthetic method
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(Ljava/lang/String;)Ljava/lang/Class;", line = 1)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/Class;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!kq", name = "addConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 70)
    ...
    @OriginalMember(owner = "client!kq", name = "requestTopDownLeftRightResend", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 82)
    public final void requestTopDownLeftRightResend(ImageConsumer arg0) {
        ++field1297;
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(BILjava/awt/Canvas;Ln;)Lqa;", line = 99)
    ...
    @OriginalMember(owner = "client!kq", name = "isConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)Z", line = 110)
    public final synchronized boolean isConsumer(ImageConsumer arg0) {
        ++field1288;
        return this.field1291 == arg0;
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIB)V", line = 118)
    ...
    @OriginalMember(owner = "client!kq", name = "startProduction", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 135)
    public final void startProduction(ImageConsumer arg0) {
        ++field1296;
        this.addConsumer(arg0);
    }

    @OriginalMember(owner = "client!kq", name = "a", descriptor = "([[B[BII[[B[II[I)I", line = 144)
    ...
    @OriginalMember(owner = "client!kq", name = "removeConsumer", descriptor = "(Ljava/awt/image/ImageConsumer;)V", line = 200)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILjava/awt/Graphics;II)V", line = 216)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(IIIIILjava/awt/Graphics;)V", line = 228)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ILjava/awt/Canvas;)V", line = 245)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(B)V", line = 267)
    ...
    @OriginalMember(owner = "client!kq", name = "b", descriptor = "(B)V", line = 277)
    ...
    @OriginalMember(owner = "client!kq", name = "a", descriptor = "(ZIIII)V", line = 296)
