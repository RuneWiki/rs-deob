...
public class class102 implements Runnable {
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILbb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ILsk;B)Lbb;", line = 19)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(ZLsk;[BI)Lbb;", line = 37)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(I)V", line = 54)
    ...
    @OriginalMember(owner = "client!d", name = "run", descriptor = "()V", line = 73)
    ...
    @OriginalMember(owner = "client!d", name = "b", descriptor = "(I)V", line = 117)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Z)V", line = 130)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(Lsk;II)Lbb;", line = 149)
    ...
    @OriginalMember(owner = "client!d", name = "a", descriptor = "(B)V", line = 181)
    ...
    @OriginalMember(owner = "client!d", name = "<init>", descriptor = "(Lli;)V", line = 236)
