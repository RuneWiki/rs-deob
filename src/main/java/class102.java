...
public class class102 extends class338 {
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lam;)Z", line = 3)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "(Lam;II)Ltb;", line = 20)
    ...
    @OriginalMember(owner = "client!tb", name = "d", descriptor = "(I)[F", line = 35)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "()V", line = 447)
    ...
    @OriginalMember(owner = "client!tb", name = "e", descriptor = "(I)F", line = 472)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "([I)Lwo;", line = 487)
    ...
    @OriginalMember(owner = "client!tb", name = "f", descriptor = "(I)I", line = 554)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "()I", line = 582)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "([BI)V", line = 590)
    ...
    @OriginalMember(owner = "client!tb", name = "a", descriptor = "([B)V", line = 598)
    ...
    @OriginalMember(owner = "client!tb", name = "b", descriptor = "([B)V", line = 752)
    ...
    @OriginalMember(owner = "client!tb", name = "<init>", descriptor = "([B)V", line = 798)
