...
public class class102 extends class311 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIIIII)V", line = 6)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "([BB)Z", line = 22)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 52)
    public class102() {
    }

    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(S)V", line = 55)
