...
public class class102 extends class407 implements class483 {
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lmc;Lkf;II[FII)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "a", descriptor = "([BIIILkf;ZIII)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lmc;II[III)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lmc;Lkf;II[BII)V")
    ...
    @OriginalMember(owner = "client!uaa", name = "<init>", descriptor = "(Lmc;Lkf;Lps;II)V")
