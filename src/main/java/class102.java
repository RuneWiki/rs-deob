...
public class class102 extends class503 {
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(II)I", line = 3)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IIB)V", line = 15)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(Z)V", line = 28)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(ILjava/lang/String;Ljava/lang/String;IZIIJZIZZ)V", line = 41)
    ...
    @OriginalMember(owner = "client!wh", name = "a", descriptor = "(IBI)V", line = 128)
    ...
    @OriginalMember(owner = "client!wh", name = "c", descriptor = "(III)V", line = 155)
    ...
    @OriginalMember(owner = "client!wh", name = "b", descriptor = "(IIB)V", line = 168)
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(IIIIIIIIII)V", line = 186)
