...
public class class102 extends class65 implements class2 {
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/lang/Exception;)V", line = 8)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "(Ljava/awt/Canvas;II)V", line = 28)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "()V", line = 37)
    ...
    @OriginalMember(owner = "client!p", name = "a", descriptor = "([Ljava/awt/Rectangle;III)V", line = 46)
    ...
    @OriginalMember(owner = "client!p", name = "c", descriptor = "(II)V", line = 71)
    ...
    @OriginalMember(owner = "client!p", name = "<init>", descriptor = "(Loa;Ljava/awt/Canvas;II)V", line = 82)
