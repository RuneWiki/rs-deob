...
public class class102 extends class295 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILap;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IILap;)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "([ILap;I)V")
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lap;B)V")
