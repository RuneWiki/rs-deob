...
public class class102 {
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "()Lrm;", line = 5)
    ...
    @OriginalMember(owner = "client!gm", name = "b", descriptor = "()[B", line = 11)
    ...
    @OriginalMember(owner = "client!gm", name = "c", descriptor = "()I", line = 72)
    ...
    @OriginalMember(owner = "client!gm", name = "a", descriptor = "(Lum;II)Lgm;", line = 116)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "(Lfh;)V", line = 129)
    ...
    @OriginalMember(owner = "client!gm", name = "<init>", descriptor = "()V", line = 149)
    private class102() {
    }
}
