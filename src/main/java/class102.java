...
public class class102 extends class36 {
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(IILrt;)V")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "(ILrt;)Ljava/lang/String;")
    ...
    @OriginalMember(owner = "client!co", name = "a", descriptor = "([ILrt;I)V")
    ...
    @OriginalMember(owner = "client!co", name = "b", descriptor = "(ILrt;)V")
    ...
    @OriginalMember(owner = "client!co", name = "d", descriptor = "(II)Ldb;")
