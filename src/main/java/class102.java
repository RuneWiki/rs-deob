...
public class class102 implements class167 {
    ...
    @OriginalMember(owner = "client!dba", name = "b", descriptor = "(I)V", line = 5)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(I)Z", line = 16)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(IZ)V", line = 27)
    ...
    @OriginalMember(owner = "client!dba", name = "a", descriptor = "(B)V", line = 68)
    public static void method850(byte arg0) {
        field1321 = null;
        int var1 = -22 / ((56 - arg0) / 36);
    }

    @OriginalMember(owner = "client!dba", name = "<init>", descriptor = "(Lbt;Ltda;)V", line = 80)
