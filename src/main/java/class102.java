...
public class class102 extends class698 {
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(BLgda;Ljava/awt/Canvas;Ld;I)Lha;")
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(IIIIIILoi;)V")
    ...
    @OriginalMember(owner = "client!qu", name = "a", descriptor = "(ILjava/lang/String;ILvf;)Llo;")
