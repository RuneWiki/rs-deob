...
public class class102 extends class120 {
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIIIII)V", line = 8)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(III)Z", line = 449)
    ...
    @OriginalMember(owner = "client!og", name = "g", descriptor = "(I)V", line = 461)
    ...
    @OriginalMember(owner = "client!og", name = "f", descriptor = "(B)V", line = 475)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(Lpi;Ltf;I)V", line = 506)
    ...
    @OriginalMember(owner = "client!og", name = "<init>", descriptor = "(Lvj;II)V", line = 553)
    public class102(class422 arg0, int arg1, int arg2) {
        this.field1095 = new byte[arg1 * arg2];
    }

    @OriginalMember(owner = "client!og", name = "b", descriptor = "(III)Z", line = 565)
    ...
    @OriginalMember(owner = "client!og", name = "a", descriptor = "(IIIII)V", line = 587)
