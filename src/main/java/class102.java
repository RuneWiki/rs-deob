...
public class class102 implements class666 {
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(Z)V", line = 6)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(ZLfm;I)V", line = 18)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(B)Lpw;", line = 48)
    ...
    @OriginalMember(owner = "client!vf", name = "a", descriptor = "(I)I", line = 66)
    ...
    @OriginalMember(owner = "client!vf", name = "<init>", descriptor = "(Lgga;Ljava/lang/String;)V", line = 89)
