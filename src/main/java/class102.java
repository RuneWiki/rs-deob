...
public class class102 {
    ...
    @OriginalMember(owner = "client!al", name = "toString", descriptor = "()Ljava/lang/String;", line = 4)
    public final String toString() {
        field1417++;
        throw new IllegalStateException();
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(IB)Z", line = 14)
    ...
    @OriginalMember(owner = "client!al", name = "<init>", descriptor = "(Ljava/lang/String;I)V", line = 32)
    public class102(String arg0, int arg1) {
        this.field1416 = arg1;
        this.field1418 = arg0;
    }

    @OriginalMember(owner = "client!al", name = "a", descriptor = "(II)V", line = 42)
