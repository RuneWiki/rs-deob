...
public class class102 extends class242 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II[I[I[I[I[I[I[IIIZ)V", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIIII[[ZLoe;[I[I)V", line = 518)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "()V", line = 649)
    public final void method722() {
        this.field1411 = null;
        this.field1398 = null;
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIIIII[[Z)V", line = 656)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIZLoe;[I[I[I)V", line = 673)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(II)I", line = 1240)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lmc;IIIIZ)Z", line = 1259)
    public final boolean method726(class69 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
        return false;
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Lbh;[I)V", line = 1261)
    public final void method727(class24 arg0, int[] arg1) {
    }

    @OriginalMember(owner = "client!op", name = "b", descriptor = "(IIIIIII[[ZLoe;[I[I)V", line = 1265)
                    ...
                    if (this.field1410[var16][var17] != null) {
                        ...
                        for (int var23 = 0; var23 < var21.field5508; ++var23) {
                            ...
                            if (var21.field5517 == null || var21.field5517[var23] == 0 || var21.field5513 != null && (var21.field5513 == null || var21.field5513[var23] != -1)) {
                                if (var21.field5513 != null && var21.field5513[var23] != -1) {
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)Z", line = 1394)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(II)V", line = 1408)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(III[[ZZ)V", line = 1421)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II[I[I[I[I[I[I[I[I[I[IIIZ)V", line = 1436)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILmc;)Lmc;", line = 1665)
    public final class69 method733(int arg0, int arg1, class69 arg2) {
        return null;
    }

    @OriginalMember(owner = "client!op", name = "d", descriptor = "(II)I", line = 1669)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IILoe;[I[I[I)V", line = 1701)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lma;IIII[[I[[II)V", line = 2017)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(Lmc;IIIIZ)V", line = 2078)
    public final void method736(class69 arg0, int arg1, int arg2, int arg3, int arg4, boolean arg5) {
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(II)I", line = 2082)
    public final int method737(int arg0, int arg1) {
        return this.field1405[arg0][arg1];
    }

    @OriginalMember(owner = "client!op", name = "a", descriptor = "(III)V", line = 2085)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(Lmc;IIIIZ)V", line = 2089)
