...
public class class102 {
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(Z)V", line = 9)
    ...
    @OriginalMember(owner = "client!cf", name = "a", descriptor = "(I)V", line = 43)
    ...
    @OriginalMember(owner = "client!cf", name = "b", descriptor = "(I)V", line = 56)
