...
public abstract class class102 {
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lda;I[BIZ)V")
    ...
    @OriginalMember(owner = "client!wh", name = "<init>", descriptor = "(Lda;ILjaggl/memory/NativeBuffer;IZ)V")
