...
public class class102 extends class85 {
    ...
    @OriginalMember(owner = "client!kh", name = "R", descriptor = "Lrc;")
    public static class160 field2016 = new class160(64);

    @OriginalMember(owner = "client!kh", name = "W", descriptor = "Llf;")
    ...
    @OriginalMember(owner = "client!kh", name = "a", descriptor = "(BILja;)V")
