...
public class class102 extends class179 {
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIIIIIII)V", line = 9)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lcj;IZIDIZLdp;)[I", line = 20)
    ...
    @OriginalMember(owner = "client!af", name = "b", descriptor = "(II)V", line = 162)
    ...
    @OriginalMember(owner = "client!af", name = "c", descriptor = "(II)I", line = 184)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lcj;Ldp;I)Z", line = 196)
    ...
    @OriginalMember(owner = "client!af", name = "e", descriptor = "(I)Laj;", line = 248)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(IIII)I", line = 274)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(ILcj;ILdp;DZB)[I", line = 289)
    ...
    @OriginalMember(owner = "client!af", name = "f", descriptor = "(I)V", line = 427)
    ...
    @OriginalMember(owner = "client!af", name = "g", descriptor = "(I)V", line = 457)
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "()V", line = 596)
    public class102() {
    ...
    @OriginalMember(owner = "client!af", name = "<init>", descriptor = "(Lec;)V", line = 612)
    ...
    @OriginalMember(owner = "client!af", name = "h", descriptor = "(I)V", line = 701)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(Lcj;IZLdp;BI)[F", line = 712)
    ...
    @OriginalMember(owner = "client!af", name = "a", descriptor = "(BII)Lmb;", line = 826)
