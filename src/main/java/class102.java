...
public class class102 extends class376 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IS)V", line = 12)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIII[[Z)V", line = 27)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IBIIIII)V", line = 87)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(Lhj;Ldl;Lvb;[I)V", line = 256)
