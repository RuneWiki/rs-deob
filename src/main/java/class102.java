...
public class class102 extends class30 {
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIILmb;Lmb;)V", line = 3)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(I)V", line = 10)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIIBII)V", line = 31)
    ...
    @OriginalMember(owner = "client!op", name = "<init>", descriptor = "(IIIIIII)V", line = 135)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(I)V", line = 151)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(III)V", line = 165)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(IIB)V", line = 185)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(IIB)V", line = 199)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(B[B)[B", line = 219)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(ZLen;Lra;)V", line = 274)
    ...
    @OriginalMember(owner = "client!op", name = "b", descriptor = "(III)V", line = 301)
    ...
    @OriginalMember(owner = "client!op", name = "c", descriptor = "(I)V", line = 315)
    ...
    @OriginalMember(owner = "client!op", name = "a", descriptor = "(Llj;Ldn;)V", line = 331)
