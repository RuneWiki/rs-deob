...
public class JString {
    ...
    private static int field878 = 33070;

    @OriginalMember(owner = "yb", name = "b", descriptor = "I")
    private static int field879 = 942;

    @OriginalMember(owner = "yb", name = "c", descriptor = "I")
    private static int field880 = 9;
    ...
    public static String method301(long arg0, int arg1) {
        if (arg0 <= 0L || arg0 >= 6582952005840035281L) {
            ...
            while (arg0 != 0L) {
                long var5 = arg0;
                arg0 /= 37L;
                var4[11 - var3++] = field882[(int) (var5 - arg0 * 37L)];
            }
            return new String(var4, 12 - var3, var3);
        }
    }

    @OriginalMember(owner = "yb", name = "a", descriptor = "(BLjava/lang/String;)J")
